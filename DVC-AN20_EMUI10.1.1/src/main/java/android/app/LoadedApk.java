...
public final class LoadedApk {
    ...
    private void updateSystemClassLoaderLocked() {
        ...
        if (activityThread != null) {
            String instrumentationPackageName = activityThread.mInstrumentationPackageName;
            if (!this.mActivityThread.mInstrumentedAppDir.equals(this.mActivityThread.mInstrumentationAppDir) && (instrumentationLibs = getLibrariesFor(instrumentationPackageName)) != null && instrumentationLibs.length > 0) {
                for (String lib2 : instrumentationLibs) {

...
public final class PendingIntent implements Parcelable {
    ...
    public static PendingIntent getActivity(Context context, int requestCode, Intent intent, int flags, Bundle options) {
        ...
        Bundle options2 = HwPCUtils.hookStartActivityOptions(context, options);
        try {
    ...
    public static PendingIntent getActivities(Context context, int requestCode, Intent[] intents, int flags, Bundle options) {
        ...
        try {
            IIntentSender target = ActivityManager.getService().getIntentSender(2, packageName, null, null, requestCode, intents, resolvedTypes, flags, HwPCUtils.hookStartActivityOptions(context, options), context.getUserId());
            if (target != null) {
                return new PendingIntent(target);
            }
            return null;
    ...
    public static PendingIntent getActivitiesAsUser(Context context, int requestCode, Intent[] intents, int flags, Bundle options, UserHandle user) {
        ...
        try {
            IIntentSender target = ActivityManager.getService().getIntentSender(2, packageName, null, null, requestCode, intents, resolvedTypes, flags, HwPCUtils.hookStartActivityOptions(context, options), user.getIdentifier());
            if (target != null) {
                return new PendingIntent(target);
            }
            return null;

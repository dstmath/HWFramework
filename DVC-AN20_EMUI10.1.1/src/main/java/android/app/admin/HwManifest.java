...
public class HwManifest {
    ...
    public static final String PERMISSION_INSTALL_SYS_APP = "com.huawei.permission.sec.MDM_INSTALL_SYS_APP";
    public static final String PERMISSION_INSTALL_UNDETACHABLE_SYS_APP = "com.huawei.permission.sec.MDM_INSTALL_UNDETACHABLE_APP";
    ...
    public static final String PERMISSION_MDM_FIREWALL = "com.huawei.permission.sec.MDM_FIREWALL";
    ...
    public static final String PERMISSION_MDM_SETTINGS_RESTRICTION = "com.huawei.permission.sec.MDM_SETTINGS_RESTRICTION";
    public static final String PERMISSION_MDM_TELEPHONY = "com.huawei.permission.sec.MDM_TELEPHONY";
    ...
    public static final String PERMISSION_MDM_VPN = "com.huawei.permission.sec.MDM_VPN";
    ...
    public static final String PERMISSION__ACCESS_INTERFACE = "com.huawei.systemmanager.permission.ACCESS_INTERFACE";

    static {
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_APP_MANAGEMENT");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_CAMERA");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_BLUETOOTH");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_FINGERPRINT");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_PHONE_MANAGER");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_WIFI");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_EMAIL");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_USB");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_SDCARD");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_PHONE");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_MMS");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_DEVICE_MANAGER");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_NFC");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_CONNECTIVITY");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_KEYGUARD");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_APN");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_LOCATION");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_CAPTURE_SCREEN");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_NETWORK_MANAGER");
        PERMIISONS_LIST.add("com.huawei.permission.sec.SDK_LAUNCHER");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_CLIPBOARD");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_GOOGLE_ACCOUNT");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_UPDATESTATE_MANAGER");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_VPN");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_FIREWALL");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_SETTINGS_RESTRICTION");
        PERMIISONS_LIST.add("com.huawei.permission.sec.MDM_TELEPHONY");
        PERMIISONS_LIST.add(PERMISSION__ACCESS_INTERFACE);
        PERMIISONS_LIST.add(PERMISSION_INSTALL_SYS_APP);
        PERMIISONS_LIST.add(PERMISSION_INSTALL_UNDETACHABLE_SYS_APP);
    }
}

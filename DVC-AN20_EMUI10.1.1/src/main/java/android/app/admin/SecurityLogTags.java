...
public class SecurityLogTags {
    ...
    public static final int SECURITY_APP_UNINSTALL_PERMIT = 210036;
    public static final int SECURITY_APP_UNINSTALL_REJECT = 210037;
    ...
    public static final int SECURITY_CRYPTO_SELF_TEST_INIT = 210038;
    ...
    public static void writeSecurityAppUninstallPermit(int pid, int success) {
        EventLog.writeEvent(210036, Integer.valueOf(pid), Integer.valueOf(success));
    }

    public static void writeSecurityAppUninstallReject(int pid, int success) {
        EventLog.writeEvent(210037, Integer.valueOf(pid), Integer.valueOf(success));
    }

    public static void writeSecurityCryptoSelfTestInit() {
        EventLog.writeEvent(210038, new Object[0]);
    }
}

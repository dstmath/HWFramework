...
public class AppMngConstant {
    ...
    public static final String APPSTART_ZFLAGKEY = "Z";
    public static final String APPSTART_ZFLAGVALUE = "1";
    ...
    public enum AppMngFeature implements EnumWithDesc {
        ...
        APP_ALARM("app_alarm"),
        BROADCAST(DataContract.Apps.LaunchMode.BROADCAST),
    ...
    public enum AppCleanSource implements EnumWithDesc {
        ...
        CRASH(DataContract.Apps.ExitMode.CRASH),
        COMPACT("compact"),
    ...
    public enum AppStartSource implements EnumWithDesc {
        ...
        public static EnumWithDesc fromString(String desc) {
            if (desc == null || desc.equals("all") || desc.equals("allbroad")) {
                return null;
            }
            try {
                return valueOf(desc.toUpperCase(Locale.US));

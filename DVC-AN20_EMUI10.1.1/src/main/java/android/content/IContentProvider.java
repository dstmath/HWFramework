...
public interface IContentProvider extends IInterface {
    ...
    ContentProviderResult[] applyBatch(String str, String str2, ArrayList<ContentProviderOperation> arrayList) throws RemoteException, OperationApplicationException;

    @UnsupportedAppUsage
    int bulkInsert(String str, Uri uri, ContentValues[] contentValuesArr) throws RemoteException;

    Bundle call(String str, String str2, String str3, String str4, Bundle bundle) throws RemoteException;
    ...
    Cursor query(String str, Uri uri, String[] strArr, Bundle bundle, ICancellationSignal iCancellationSignal) throws RemoteException;

    boolean refresh(String str, Uri uri, Bundle bundle, ICancellationSignal iCancellationSignal) throws RemoteException;

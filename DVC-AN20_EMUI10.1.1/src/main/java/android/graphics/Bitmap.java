...
public final class Bitmap implements Parcelable {
    ...
    public static final class Config extends Enum<Config> {
        ...
        public static final Config YCRCB_420_SP = new Config("YCRCB_420_SP", 6, 8);
        ...
        static {
            ...
            Config config7 = YCRCB_420_SP;
            $VALUES = new Config[]{config, config2, config3, config4, config5, config6, config7};

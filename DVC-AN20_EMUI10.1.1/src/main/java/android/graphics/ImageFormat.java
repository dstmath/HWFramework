...
public class ImageFormat {
    ...
    public static boolean isPublicFormat(int format) {
        ...
        switch (format) {
            ...
            case 32:
            case 4098:
            case Y8 /*{ENCODED_INT: 538982489}*/:
            case YV12 /*{ENCODED_INT: 842094169}*/:
            case DEPTH16 /*{ENCODED_INT: 1144402265}*/:
            case HEIC /*{ENCODED_INT: 1212500294}*/:
            case DEPTH_JPEG /*{ENCODED_INT: 1768253795}*/:
                return true;
            default:
                switch (format) {
                    case 34:

...
public class ParameterUtils {
    ...
    /* JADX INFO: Multiple debug info for r7v2 android.graphics.Rect: [D('reportedMetering' android.graphics.Rect), D('reportedMeteringRect' android.hardware.camera2.legacy.ParameterUtils$WeightedRectangle)] */

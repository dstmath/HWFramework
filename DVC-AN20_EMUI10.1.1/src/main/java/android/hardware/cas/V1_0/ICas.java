...
public interface ICas extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements ICas {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{BluetoothHidDevice.ERROR_RSP_UNKNOWN, 101, 107, -95, -70, -63, 20, 97, -95, 112, -106, -17, 117, 43, 105, -46, 75, 0, 13, -126, BluetoothHidDevice.ERROR_RSP_UNKNOWN, -11, 101, 47, 1, 80, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, -7, 115, 29, 84, -62}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }

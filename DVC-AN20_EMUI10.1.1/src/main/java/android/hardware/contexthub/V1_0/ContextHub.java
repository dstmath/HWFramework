...
public final class ContextHub {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.f1vendor = _hidl_blob.getString(_hidl_offset + 16);
        parcel.readEmbeddedBuffer((long) (this.f1vendor.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 16 + 0, false);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putString(16 + _hidl_offset, this.f1vendor);

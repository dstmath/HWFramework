...
public final class PhysicalSensor {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.sensorType == other.sensorType && HidlSupport.deepEquals(this.type, other.type) && HidlSupport.deepEquals(this.name, other.name) && HidlSupport.deepEquals(this.f2vendor, other.f2vendor) && this.version == other.version && this.fifoReservedCount == other.fifoReservedCount && this.fifoMaxCount == other.fifoMaxCount && this.minDelayMs == other.minDelayMs && this.maxDelayMs == other.maxDelayMs && this.peakPowerMw == other.peakPowerMw) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        return "{" + ".sensorType = " + SensorType.toString(this.sensorType) + ", .type = " + this.type + ", .name = " + this.name + ", .vendor = " + this.f2vendor + ", .version = " + this.version + ", .fifoReservedCount = " + this.fifoReservedCount + ", .fifoMaxCount = " + this.fifoMaxCount + ", .minDelayMs = " + this.minDelayMs + ", .maxDelayMs = " + this.maxDelayMs + ", .peakPowerMw = " + this.peakPowerMw + "}";
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.f2vendor = _hidl_blob.getString(_hidl_offset + 40);
        parcel.readEmbeddedBuffer((long) (this.f2vendor.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 40 + 0, false);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putString(40 + _hidl_offset, this.f2vendor);

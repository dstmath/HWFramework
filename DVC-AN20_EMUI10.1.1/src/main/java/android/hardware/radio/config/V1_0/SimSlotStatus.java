...
public final class SimSlotStatus {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.slotState = _hidl_blob.getInt32(_hidl_offset + 4);
        this.atr = _hidl_blob.getString(_hidl_offset + 8);
        parcel.readEmbeddedBuffer((long) (this.atr.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 8 + 0, false);
        this.logicalSlotId = _hidl_blob.getInt32(_hidl_offset + 24);
        this.iccid = _hidl_blob.getString(_hidl_offset + 32);

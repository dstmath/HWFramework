...
public final class ModemsConfig {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject != null && otherObject.getClass() == ModemsConfig.class && this.numOfLiveModems == ((ModemsConfig) otherObject).numOfLiveModems) {
            return true;
        }
        return false;
    }
    ...
    public static final ArrayList<ModemsConfig> readVectorFromParcel(HwParcel parcel) {
        ArrayList<ModemsConfig> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 1), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ModemsConfig _hidl_vec_element = new ModemsConfig();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.numOfLiveModems = _hidl_blob.getInt8(0 + _hidl_offset);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<ModemsConfig> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        _hidl_blob.putInt8(0 + _hidl_offset, this.numOfLiveModems);
    }
}

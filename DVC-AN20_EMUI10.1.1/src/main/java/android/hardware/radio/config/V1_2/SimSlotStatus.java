...
public final class SimSlotStatus {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.eid = _hidl_blob.getString(_hidl_offset + 48);
        parcel.readEmbeddedBuffer((long) (this.eid.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 48 + 0, false);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putString(48 + _hidl_offset, this.eid);
    }
}

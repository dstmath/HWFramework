...
public interface IOemHook extends IBase {
    ...
    public static final class Proxy implements IOemHook {
        ...
        @Override // android.hardware.radio.deprecated.V1_0.IOemHook
    ...
    public static abstract class Stub extends HwBinder implements IOemHook {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IOemHook.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{0, -9, 0, -123, -42, -6, -31, -44, -126, -5, 112, 10, AnswerToReset.INVERSE_CONVENTION, -44, 46, -44, 117, 56, 76, -107, -75, 28, -110, 105, -71, -82, 80, 55, -73, 74, -44, -35}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, AnswerToReset.DIRECT_CONVENTION, 24, -54, 76}));
        }

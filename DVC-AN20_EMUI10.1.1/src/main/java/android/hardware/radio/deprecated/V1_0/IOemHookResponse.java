...
public interface IOemHookResponse extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IOemHookResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IOemHookResponse.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{111, -44, -121, 79, 14, -35, -44, 98, 106, 39, 101, -113, -39, 79, -83, 82, 108, 49, Byte.MAX_VALUE, 53, 99, 67, -98, 121, 113, -117, -37, 26, 58, 35, 9, -43}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, AnswerToReset.DIRECT_CONVENTION, 24, -54, 76}));
        }

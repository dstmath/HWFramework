...
public interface IUsbGadget extends IBase {
    ...
    public static final class Proxy implements IUsbGadget {
        ...
        @Override // android.os.IHwInterface, android.hardware.usb.gadget.V1_0.IUsbGadget, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IUsbGadget {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-115, -33, -89, 84, 39, 114, -52, 123, -54, 25, -105, 43, 45, -123, 98, 100, -17, -93, 25, 20, -65, MidiConstants.STATUS_CHANNEL_PRESSURE, -104, -82, -73, -62, 7, -99, -107, 1, -108, -53}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        @Override // android.os.IHwBinder, android.hardware.usb.gadget.V1_0.IUsbGadget, android.internal.hidl.base.V1_0.IBase

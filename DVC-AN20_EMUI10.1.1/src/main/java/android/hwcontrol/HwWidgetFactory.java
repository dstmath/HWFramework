...
public class HwWidgetFactory {
    ...
    public static IHwWechatOptimize getHwWechatOptimize() {
        Factory implObject = getImplObject();
        return implObject == null ? new HwWechatOptimizeImplDummy() : implObject.getHwWechatOptimizeImpl();
    }
    ...
    public static boolean checkIsFullScreen(Context context, int width, int height) {
        return false;
    }
    ...
    public static HwSpringBackHelper getHwSpringBackHelper() {
        ...
        return obj2 == null ? new HwSpringBackHelperDummy() : obj2.getHwSpringBackHelperImpl();
    }
    ...
    private static Factory getImplObject() {
        synchronized (mLock) {
            ...
            try {
                ...
                Log.e(TAG, ": reflection exception is ");
            }
            if (obj != null) {
    ...
    public static HwWidgetColumn getHwWidgetColumn(Context context) {
        ...
        if (factory == null) {
            return new HwWidgetColumnDummy();
        }
        return factory.getHwWidgetColumnImpl(context);
    }

    public static HwWidgetAppAttrsHelper getHwWidgetAppAttrsHelper(Context context) {
        Factory factory = getImplObject();
        if (factory == null) {
            return new HwWidgetAppAttrsHelperDummy();
        }
        return factory.getHwWidgetAppAttrsHelperImpl(context);
    }
    ...
    public static class PermissionInformation {
        public static AppSecurityPermissions.PermissionItemView getHwPermItemView(boolean isShowMoneyItemLayout, LayoutInflater inflater) {
            ...
            return (AppSecurityPermissions.PermissionItemView) inflater.inflate(i, (ViewGroup) null);
        }

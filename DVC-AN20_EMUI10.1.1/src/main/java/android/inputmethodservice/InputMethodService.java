...
public class InputMethodService extends AbstractInputMethodService {
    ...
    private String THP_COMMAND = "THP_InformTypingStatus";
    ...
    public void onStartInputView(EditorInfo info, boolean restarting) {
        try {
            ...
            Log.w(TAG, "onStartInputView runHwTHPCommand error occured: the package has no permission");
        }
    }
    ...
    public void onFinishInputView(boolean finishingInput) {
        InputConnection ic;
        try {
            HwInputManager.runHwTHPCommand(this.THP_COMMAND, WifiEnterpriseConfig.ENGINE_DISABLE);
        } catch (SecurityException e) {
            Log.w(TAG, "onFinishInputView runHwTHPCommand error occured: the package has no permission");
        }

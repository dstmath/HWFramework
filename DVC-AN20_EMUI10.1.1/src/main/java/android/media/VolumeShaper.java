...
public final class VolumeShaper implements AutoCloseable {
    ...
    /* JADX INFO: Multiple debug info for r0v4 int: [D('player' android.media.PlayerBase), D('id' int)] */
    ...
    public static final class Configuration implements Parcelable {
        ...
        public static final class Builder {
            ...
            /* JADX INFO: Multiple debug info for r2v3 float: [D('maxmin' float), D('i' int)] */

...
public final class HwMtpConstants {
    ...
    public static boolean isAbstractObject(int format) {
        ...
        switch (format) {
            case FORMAT_ABSTRACT_MULTIMEDIA_ALBUM /*{ENCODED_INT: 47617}*/:
            case FORMAT_ABSTRACT_IMAGE_ALBUM /*{ENCODED_INT: 47618}*/:
            case FORMAT_ABSTRACT_AUDIO_ALBUM /*{ENCODED_INT: 47619}*/:
            case FORMAT_ABSTRACT_VIDEO_ALBUM /*{ENCODED_INT: 47620}*/:
            case FORMAT_ABSTRACT_AV_PLAYLIST /*{ENCODED_INT: 47621}*/:
                return true;
            default:
                switch (format) {
                    case FORMAT_ABSTRACT_AUDIO_PLAYLIST /*{ENCODED_INT: 47625}*/:
                    case FORMAT_ABSTRACT_VIDEO_PLAYLIST /*{ENCODED_INT: 47626}*/:
                    case FORMAT_ABSTRACT_MEDIACAST /*{ENCODED_INT: 47627}*/:
                        return true;
                    default:
                        return false;
                }

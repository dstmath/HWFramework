...
public class ConnectivityManager implements HwConnectivityManagerConstants {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x007d, code lost:
        android.util.Log.i(android.net.ConnectivityManager.TAG, "starting startUsingNetworkFeature for request " + r6);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0095, code lost:
        android.util.Log.i(android.net.ConnectivityManager.TAG, " request Failed");
     */
    ...
    public static String getCallbackName(int whichCallback) {
        switch (whichCallback) {
            case CALLBACK_PRECHECK /*{ENCODED_INT: 524289}*/:

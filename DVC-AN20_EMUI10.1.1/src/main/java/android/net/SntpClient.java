...
public class SntpClient {
    ...
    /* JADX INFO: Multiple debug info for r11v7 'transmitTime'  long: [D('clockOffset' long), D('transmitTime' long)] */
    public boolean requestTime(InetAddress address, int port, int timeout, Network network) {
        ...
        try {
            ...
            checkValidServerReply((byte) ((buffer[0] >> 6) & 3), (byte) (buffer[0] & 7), buffer[1] & 255, transmitTime2);
            ...
            Log.i(TAG, "round trip: " + roundTripTime + "ms, clock offset: " + transmitTime + "ms");

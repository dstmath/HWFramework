...
public class SipErrorCode {
    ...
    public static String toString(int errorCode) {
        switch (errorCode) {
            case SERVER_UNREACHABLE /*{ENCODED_INT: -12}*/:
                return "SERVER_UNREACHABLE";
            case CROSS_DOMAIN_AUTHENTICATION /*{ENCODED_INT: -11}*/:
                return "CROSS_DOMAIN_AUTHENTICATION";
            case DATA_CONNECTION_LOST /*{ENCODED_INT: -10}*/:
                return "DATA_CONNECTION_LOST";
            case IN_PROGRESS /*{ENCODED_INT: -9}*/:
                return "IN_PROGRESS";
            case INVALID_CREDENTIALS /*{ENCODED_INT: -8}*/:
                return "INVALID_CREDENTIALS";
            case PEER_NOT_REACHABLE /*{ENCODED_INT: -7}*/:
                return "PEER_NOT_REACHABLE";
            case INVALID_REMOTE_URI /*{ENCODED_INT: -6}*/:
                return "INVALID_REMOTE_URI";
            case TIME_OUT /*{ENCODED_INT: -5}*/:
                return "TIME_OUT";
            case CLIENT_ERROR /*{ENCODED_INT: -4}*/:
                return "CLIENT_ERROR";
            case TRANSACTION_TERMINTED /*{ENCODED_INT: -3}*/:
                return "TRANSACTION_TERMINTED";
            case SERVER_ERROR /*{ENCODED_INT: -2}*/:
                return "SERVER_ERROR";
            case SOCKET_ERROR /*{ENCODED_INT: -1}*/:
                return "SOCKET_ERROR";
            case 0:
                return "NO_ERROR";
            default:

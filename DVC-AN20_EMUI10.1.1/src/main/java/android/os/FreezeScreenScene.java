...
public class FreezeScreenScene {
    ...
    public synchronized void scheduleCheckFreezeScreen(ArrayMap<String, Object> params) {
        int checkFreezeScreenDelayTime;
        int checkFreezeScreenDelayTime2;
        int checkFreezeScreenDelayTime3 = CHECK_FREEZE_SCREEN_DELAY_TIME;
        if (checkParamsValid(params)) {
            if (this.mHandler == null) {
                ...
                checkFreezeScreenDelayTime3 = CHECK_FREEZE_SCREEN_DELAY_TIME;
            }
                ...
                if (this.mHungConfigTransWindow != null) {
                    ...
                    if (value2 != null) {
                        try {
                            ...
                            checkFreezeScreenDelayTime2 = CHECK_FREEZE_SCREEN_DELAY_TIME;
                        }
                    }
                    checkFreezeScreenDelayTime2 = i;
    ...
    public static class IMonitorRadar extends FreezeScreenRadar {
        ...
        public void upload(ArrayMap<String, Object> params) {
            ...
            if (params != null && (params.get(FreezeScreenScene.CHECK_TYPE_PARAM) instanceof Integer)) {
                ...
                switch (checkType) {
                    case FreezeScreenScene.TRANSPARENT_ACTIVITY_SCENE /*{ENCODED_INT: 907400009}*/:
                        ...
                        break;
                    case FreezeScreenScene.HIGH_WINDOW_LAYER_SCENE /*{ENCODED_INT: 907400011}*/:
                        ...
                        break;
                    case FreezeScreenScene.DISPLAY_EVENT_LOST_SCENE /*{ENCODED_INT: 907400012}*/:
                        eStream.setParam((short) 0, MonitorHelper.getPackageName()).setParam((short) 1, MonitorHelper.getVersionName()).setParam((short) 2, ((Integer) params.get("pid")).intValue()).setParam((short) 3, (String) params.get("processName"));
                        break;
                    case FreezeScreenScene.FOCUS_WINDOW_NULL_SCENE /*{ENCODED_INT: 907400013}*/:
    ...
    public static class MonitorHelper {
        ...
        public static Field getReflectPrivateField(String className, String fieldName) {
            try {
                ...
                Log.e(FreezeScreenScene.TAG, "getReflectPrivateField : not found " + className + " catch : " + e.toString());
                return null;
            } catch (NoSuchFieldException e2) {
                Log.e(FreezeScreenScene.TAG, "getReflectPrivateField catch NoSuchFieldException : " + e2.toString());
                return null;
            }
        }
        ...
        public static String getVersionName() {
            ...
            return getVersionCode() + BuildConfig.FLAVOR;
        }
    }
}

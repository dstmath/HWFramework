            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        acquireWakeLock(_arg010, _arg14, _arg23, _arg3, _arg4, data.readString());
                    ...
                    case 6:
                        ...
                        updateWakeLockWorkSource(_arg011, _arg1, data.readString());
                        reply.writeNoException();
                        return true;
                    case 7:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 16:
                        ...
                        boolean dynamicPowerSaveHint = setDynamicPowerSaveHint(_arg09, data.readInt());
                        reply.writeNoException();
                    ...
                    case 18:
                        ...
                        boolean adaptivePowerSaveEnabled = setAdaptivePowerSaveEnabled(_arg08);
                        reply.writeNoException();
                    ...
                    case 33:
                        ...
                        setAttentionLight(_arg07, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 34:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 40:
                        ...
                        setBrightnessAnimationTime(_arg06, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 41:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 45:
                        ...
                        setModeToAutoNoClearOffsetEnable(_arg04);
                        reply.writeNoException();
                        return true;
                    case 46:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        int _result9 = hwBrightnessSetData(_arg015, _arg12);
                        reply.writeNoException();
                    ...
                    case 47:
                        ...
                        int _result10 = hwBrightnessGetData(_arg016, _arg17);
                        reply.writeNoException();

    ...
    public static abstract class Stub extends Binder implements IVold {
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 78:
                    return "addUserKeyAuthIsec";
                case 79:
                    return "fixateNewestUserKeyAuthIsec";
                case 80:
                    return "lockUserScreenIsec";
                case 81:
                    return "unlockUserScreenIsec";
                case 82:
                    return "lockScreenPrepare";
                case 83:
                    return "getKeyDesc";
                case 84:
                    return "getPrepareFlag";
                case 85:
                    return "sendBlockUserId";
                case 86:
                ...
                case 92:
                    return "sdlockGetCid";
                case 93:
                    return "sdlockReadPassword";
                case 94:
                    return "sdlockWritePassword";
                case 95:
                    return "sdbackupGetDevStat";
                case 96:
                    return "sdbackupGetCid";
                case 97:
                    return "sdbackupCheckRW";
                case 98:
                    return "openAppFuseFile";
                case 99:
                    return "cryptsdEnable";
                case 100:
                    return "cryptsdDisable";
                case 101:
                    return "cryptsdAddKeyAuth";
                case 102:
                    return "cryptsdUnlockKey";
                case 103:
                    return "cryptsdBackupInfo";
                default:
                    return null;
            }
        }

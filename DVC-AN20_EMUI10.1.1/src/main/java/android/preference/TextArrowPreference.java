...
public class TextArrowPreference extends Preference {
    ...
    public View onCreateView(ViewGroup parent) {
        ...
        ViewGroup widgetFrame = (ViewGroup) layoutView.findViewById(16908312);
        if (widgetFrame != null) {
    ...
    private void adjustLayoutPadding(View view) {
        ...
        if (titleView != null && !TextUtils.isEmpty(getTitle()) && (viewParent = titleView.getParent()) != null && (viewParent instanceof RelativeLayout)) {

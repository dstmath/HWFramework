...
public final class HwSysResManager {
    ...
    public void recordResourceOverloadStatus(Map<String, Object> overloadStatus) {
        if (overloadStatus != null) {
            ...
            if (service != null) {
                try {
                    service.recordResourceOverloadStatus(getInt(overloadStatus, DataContract.BaseProperty.UID), getString(overloadStatus, "pkg"), getInt(overloadStatus, "resourceType"), getInt(overloadStatus, "overloadNum"), getInt(overloadStatus, "speedOverLoadPeriod"), getInt(overloadStatus, "totalNum"), getBundle(overloadStatus, "bundleArgs"));
                } catch (RemoteException e) {
                    if (Log.HWINFO) {
    ...
    public void noteProcessStart(Map<String, Object> processParams) {
        if (processParams != null) {
            ...
            if (service != null) {
                try {
                    service.noteProcessStart(getString(processParams, DataContract.BaseProperty.PACKAGE_NAME), getString(processParams, "processName"), getInt(processParams, "pid"), getInt(processParams, DataContract.BaseProperty.UID), getBoolean(processParams, "started"), getString(processParams, "launcherMode"), getString(processParams, "reason"));
                } catch (RemoteException e) {
                    if (Log.HWINFO) {
    ...
    public String fetchBigDataByVersion(int iawareVer, int featureId, boolean isBeta, boolean isClear) {
        IHwSysResManager service = getService();
        if (service == null) {
            if (Log.HWINFO) {
        ...
        try {
            return service.fetchBigDataByVersion(iawareVer, featureId, isBeta, isClear);
        } catch (RemoteException e) {
            if (!Log.HWINFO) {
                return null;
            }

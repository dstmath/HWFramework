...
public interface HwSysResource {
    ...
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_ALARM = 5;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_ALL = 255;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_BANK = 16;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_BIKE = 23;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_BROWSER = 18;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_BUS = 24;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_BUSINESS = 11;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_CALLCAB = 22;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_CAMERA = 17;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_EMAIL = 1;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_FORUM = 20;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_GAME = 9;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_IM = 0;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_IME = 19;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_LEXICON = 10;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_LIVE = 21;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_MUSIC = 7;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_NAVI = 3;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_OFFICE = 12;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_READING = 6;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_SHOPPING = 14;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_SPORT = 2;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_STOCKS = 4;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_THEME = 13;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_THIRD_GUARD = 25;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_TOOL = 15;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_UNKNOWN = -1;
    public static final int HIGH_SYSYEMLOAD_APP_TYPE_VIDEO = 8;
    public static final int HIGH_SYSYEMLOAD_SCENE_ALL = 1;
    public static final int HIGH_SYSYEMLOAD_SCENE_GAME = 2;
    public static final int HIGH_SYSYEMLOAD_SCENE_VIDEO = 4;
    ...
    public static final int TELEPHONY = 34;

...
public class AwareAppDataBiz implements AwareAppDataService.IAwareDataCallBack {
    ...
    private static final boolean LOG_SWITCH = SystemProperties.getBoolean("persist.sys.iaware.appscenerecog.log.switch", false);
    ...
    private IAwareAppSceneBiz mIAppSceneBiz;
    ...
    public void onInitDataSuccess(ArrayList<String> data) {
        ...
        synchronized (this.mAppSceneData) {
            ...
            if (this.mIAppSceneBiz != null) {
                if (this.mAppSceneData.isEmpty()) {
                    this.mIAppSceneBiz.disable();
                } else {
                    this.mIAppSceneBiz.enable();
                }
            }
        }
    }
    ...
    public void onInitDataFailure() {
        ...
        IAwareAppSceneBiz iAwareAppSceneBiz = this.mIAppSceneBiz;

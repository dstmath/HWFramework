...
public abstract class KeyProperties {
    ...
    public static abstract class KeyAlgorithm {
        ...
        public static int toKeymasterAsymmetricKeyAlgorithm(String algorithm) {
            if (KeyProperties.KEY_ALGORITHM_EC.equalsIgnoreCase(algorithm) == 1) {
                return 3;
            }
            if (KeyProperties.KEY_ALGORITHM_RSA.equalsIgnoreCase(algorithm) == 1) {
                return 1;
            }
        ...
        public static int toKeymasterSecretKeyAlgorithm(String algorithm) {
            if (KeyProperties.KEY_ALGORITHM_AES.equalsIgnoreCase(algorithm) == 1) {
                return 32;
            }
            if (KeyProperties.KEY_ALGORITHM_3DES.equalsIgnoreCase(algorithm) == 1) {
                return 33;
            }
            if (algorithm.toUpperCase(Locale.US).startsWith("HMAC") == 1) {
                return 128;
            }
        ...
        public static int toKeymasterDigest(String algorithm) {
            ...
            char c = 65535;
            if (algorithmUpper.startsWith("HMAC") != 1) {
                return -1;
            }
            String digestUpper = algorithmUpper.substring("HMAC".length());
            switch (digestUpper.hashCode()) {
                case -1850268184:
                    if (digestUpper.equals("SHA224") == 1) {
                        c = 1;
                        break;
                    }
                    break;
                case -1850268089:
                    if (digestUpper.equals("SHA256") == 1) {
                        c = 2;
                        break;
                    }
                    break;
                case -1850267037:
                    if (digestUpper.equals("SHA384") == 1) {
                        c = 3;
                        break;
                    }
                    break;
                case -1850265334:
                    if (digestUpper.equals("SHA512") == 1) {
                        c = 4;
                        break;
                    }
                    break;
                case 2543909:
                    if (digestUpper.equals("SHA1") == 1) {
                        c = 0;
                        break;
                    }
                    break;
    ...
    public static abstract class BlockMode {
        ...
        public static int toKeymaster(String blockMode) {
            if (KeyProperties.BLOCK_MODE_ECB.equalsIgnoreCase(blockMode) == 1) {
                return 1;
            }
            if (KeyProperties.BLOCK_MODE_CBC.equalsIgnoreCase(blockMode) == 1) {
                return 2;
            }
            if (KeyProperties.BLOCK_MODE_CTR.equalsIgnoreCase(blockMode) == 1) {
                return 3;
            }
            if (KeyProperties.BLOCK_MODE_GCM.equalsIgnoreCase(blockMode) == 1) {
                return 32;
            }
        ...
        public static String[] allFromKeymaster(Collection<Integer> blockModes) {
            if (blockModes == null || blockModes.isEmpty() == 1) {
    ...
    public static abstract class EncryptionPadding {
        ...
        public static int toKeymaster(String padding) {
            if (KeyProperties.ENCRYPTION_PADDING_NONE.equalsIgnoreCase(padding) == 1) {
                return 1;
            }
            if (KeyProperties.ENCRYPTION_PADDING_PKCS7.equalsIgnoreCase(padding) == 1) {
                return 64;
            }
            if (KeyProperties.ENCRYPTION_PADDING_RSA_PKCS1.equalsIgnoreCase(padding) == 1) {
                return 4;
            }
            if (KeyProperties.ENCRYPTION_PADDING_RSA_OAEP.equalsIgnoreCase(padding) == 1) {
                return 2;
            }
    ...
    static abstract class SignaturePadding {
        ...
        static int toKeymaster(String padding) {
            ...
            if (hashCode != 79536) {
                if (hashCode == 76183014 && upperCase.equals(KeyProperties.SIGNATURE_PADDING_RSA_PKCS1) == 1) {
                    c = 0;
                    if (c == 0) {
                        return 5;
                    }
            ...
            } else if (upperCase.equals(KeyProperties.SIGNATURE_PADDING_RSA_PSS) == 1) {
                c = 1;
                if (c == 0) {
                }
            }
    ...
    public static abstract class Digest {
        ...
        public static int toKeymaster(String digest) {
            ...
            switch (upperCase.hashCode()) {
                case -1523887821:
                    if (upperCase.equals(KeyProperties.DIGEST_SHA224) == 1) {
                        c = 1;
                        break;
                    }
                    c = 65535;
                    break;
                case -1523887726:
                    if (upperCase.equals(KeyProperties.DIGEST_SHA256) == 1) {
                        c = 2;
                        break;
                    }
                    c = 65535;
                    break;
                case -1523886674:
                    if (upperCase.equals(KeyProperties.DIGEST_SHA384) == 1) {
                        c = 3;
                        break;
                    }
                    c = 65535;
                    break;
                case -1523884971:
                    if (upperCase.equals(KeyProperties.DIGEST_SHA512) == 1) {
                        c = 4;
                        break;
                    }
                    c = 65535;
                    break;
                case 76158:
                    if (upperCase.equals(KeyProperties.DIGEST_MD5) == 1) {
                        c = 6;
                        break;
                    }
                    c = 65535;
                    break;
                case 2402104:
                    if (upperCase.equals(KeyProperties.DIGEST_NONE) == 1) {
                        c = 5;
                        break;
                    }
                    c = 65535;
                    break;
                case 78861104:
                    if (upperCase.equals(KeyProperties.DIGEST_SHA1) == 1) {
                        c = 0;
                        break;
                    }
                    c = 65535;

...
public abstract class Connection extends Conferenceable {
    ...
    public static abstract class VideoProvider {
        ...
        private final class VideoProviderBinder extends IVideoProvider.Stub {
            ...
            public void sendSessionModifyRequest(VideoProfile fromProfile, VideoProfile toProfile) {
                Log.d(this, "sendSessionModifyRequest CallingUid: %d", Integer.valueOf(Binder.getCallingUid()));
                SomeArgs args = SomeArgs.obtain();
    ...
    public final void setAddress(Uri address, int presentation) {
        checkImmutable();
        Log.d(this, "setAddress %s", "xxxxxx");
    ...
    public final void setSsNotificationData(int type, int code) {
        Log.d(this, "setSsNotificationData = " + type + WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER + code, new Object[0]);
        for (Listener l : this.mListeners) {

...
public class MSimSmsManager {
    ...
    public String getSmscAddrOnSubscription(int subscription) {
        return HwUiccSmsManager.getSmscAddrForSubscriber(subscription);
    }

    public boolean setSmscAddrOnSubscription(String smsc, int subscription) {
        return HwUiccSmsManager.setSmscAddrForSubscriber(subscription, smsc);
    }

    public boolean setCellBroadcastRangeList(int subId, int[] messageIds, int ranType) {
        return HwUiccSmsManager.setCellBroadcastRangeListForSubscriber(subId, messageIds, ranType);
    }
}

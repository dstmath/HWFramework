...
public class TelephonyManager {
    ...
    public CellLocation getCellLocation() {
        try {
            ...
            Log.i(TAG, "getCellLocation calling app is " + getOpPackageName());
    ...
    public List<NeighboringCellInfo> getNeighboringCellInfo() {
        ...
        Log.i(TAG, "getNeighboringCellInfo calling app is " + callingAppName);
        try {
            ITelephony telephony = getITelephony();
            if (telephony == null) {
                return null;
    ...
    public int getNetworkType(int subId) {
        try {
            ...
            Log.e(TAG, "Error in getNetworkType: unable to connect to Telephony service.");
            return 0;
        } catch (RemoteException e) {
    ...
    public List<CellInfo> getAllCellInfo() {
        try {
            ...
            Log.i(TAG, "getAllCellInfo calling app is " + getOpPackageName());
    ...
    public void setDataEnabled(int subId, boolean enable) {
        try {
            Log.i(TAG, "setDataEnabled: enabled=" + enable);
            ITelephony telephony = getITelephony();
            if (telephony != null) {
    ...
    public void setDataEnabledProperties(String appName, boolean enable) {
        Log.i(TAG, "setDataEnabledProperties: appName=" + appName + " enable=" + enable);
        try {
            ITelephony telephony = getITelephony();
            if (telephony != null) {
    ...
    public void factoryReset(int subId) {
        try {
            Log.i(TAG, "factoryReset: subId=" + subId);
            ITelephony telephony = getITelephony();
            if (telephony != null) {
    ...
    public void requestModemActivityInfo(ResultReceiver result) {
        try {
            ITelephony service = getITelephony();
            Log.i(TAG, "requestModemActivityInfo calling app is " + getOpPackageName());
            if (service != null) {

...
public class MbmsStreamingServiceBase extends IMbmsStreamingService.Stub {
    ...
    @Override // android.os.IInterface, android.telephony.mbms.vendor.IMbmsStreamingService.Stub
    @SystemApi
    public IBinder asBinder() {
        return super.asBinder();
    }

    @Override // android.os.Binder, android.telephony.mbms.vendor.IMbmsStreamingService.Stub
    @SystemApi

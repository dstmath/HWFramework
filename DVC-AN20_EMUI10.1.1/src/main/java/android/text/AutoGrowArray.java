...
public final class AutoGrowArray {
    ...
    public static class ByteArray {
        ...
        private void ensureCapacity(int count) {
            ...
            if (requestedSize >= this.mValues.length) {
                byte[] newValues = ArrayUtils.newUnpaddedByteArray(AutoGrowArray.computeNewCapacity(i, requestedSize));
    ...
    public static class IntArray {
        ...
        private void ensureCapacity(int count) {
            ...
            int requestedSize = i + count;
            if (requestedSize >= this.mValues.length) {
                int[] newValues = ArrayUtils.newUnpaddedIntArray(AutoGrowArray.computeNewCapacity(i, requestedSize));
                System.arraycopy(this.mValues, 0, newValues, 0, this.mSize);
                this.mValues = newValues;
            }
        }
    ...
    public static class FloatArray {
        ...
        private void ensureCapacity(int count) {
            ...
            int requestedSize = i + count;
            if (requestedSize >= this.mValues.length) {
                float[] newValues = ArrayUtils.newUnpaddedFloatArray(AutoGrowArray.computeNewCapacity(i, requestedSize));
                System.arraycopy(this.mValues, 0, newValues, 0, this.mSize);
                this.mValues = newValues;
            }
        }

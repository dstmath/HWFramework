...
public class BoostFramework {
    ...
    public BoostFramework() {
        ...
        if (!mIsLoaded) {
            try {
                ...
                mAcquireFunc = perfClass.getDeclaredMethod("perfLockAcquire", Integer.TYPE, int[].class);
                ...
                mAcquireTouchFunc = perfClass.getDeclaredMethod("perfLockAcquireTouch", MotionEvent.class, DisplayMetrics.class, Integer.TYPE, int[].class);
                Log.v(TAG, "mAcquireTouchFunc method = " + mAcquireTouchFunc);
                mIOPStart = perfClass.getDeclaredMethod("perfIOPrefetchStart", Integer.TYPE, String.class);
    ...
    public int perfLockAcquire(int duration, int... list) {
        try {
            return ((Integer) mAcquireFunc.invoke(this.mPerf, Integer.valueOf(duration), list)).intValue();
        } catch (Exception e) {
    ...
    public int perfLockAcquireTouch(MotionEvent ev, DisplayMetrics metrics, int duration, int... list) {
        try {
            return ((Integer) mAcquireTouchFunc.invoke(this.mPerf, ev, metrics, Integer.valueOf(duration), list)).intValue();
        } catch (Exception e) {
            Log.e(TAG, "Exception " + e);
            return -1;
        }
    ...
    public int perfIOPrefetchStart(int pid, String pkg_name) {
        try {
            return ((Integer) mIOPStart.invoke(this.mPerf, Integer.valueOf(pid), pkg_name)).intValue();
        } catch (Exception e) {
            Log.e(TAG, "Exception " + e);
            return -1;
        }

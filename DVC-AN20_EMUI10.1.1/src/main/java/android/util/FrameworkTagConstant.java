    ...
    public static final String getModuleTagStr(int module_tag) {
        ...
        switch (FWK_MODULE.values()[module_tag / 100]) {
            ...
            case AM:
                ...
                if (subModule_index < strArr.length) {
                    return strArr[subModule_index];
                }
                return null;
            case PM:
                String[] strArr2 = PM_MODULE_TAG;
                if (subModule_index < strArr2.length) {
                    return strArr2[subModule_index];
                }
                return null;
            case WM:
                String[] strArr3 = WM_MODULE_TAG;
                if (subModule_index < strArr3.length) {
                    return strArr3[subModule_index];
                }
                return null;
            case NM:
                String[] strArr4 = NM_MODULE_TAG;
                if (subModule_index < strArr4.length) {
                    return strArr4[subModule_index];
                }
                return null;
            case ALARM:
                String[] strArr5 = ALARM_MODULE_TAG;
                if (subModule_index < strArr5.length) {
                    return strArr5[subModule_index];
                }
                return null;
            case POWER:
                String[] strArr6 = POWER_MODULE_TAG;
                if (subModule_index < strArr6.length) {
                    return strArr6[subModule_index];
                }
                return null;
            case DEAMON:
                String[] strArr7 = DEAMON_MODULE_TAG;
                if (subModule_index < strArr7.length) {
                    return strArr7[subModule_index];
                }
                return null;
            case SERVICES:
                String[] strArr8 = SERVICES_MODULE_TAG;
                if (subModule_index < strArr8.length) {
                    return strArr8[subModule_index];
                }
                return null;
            case USERS:
                String[] strArr9 = USERS_MODULE_TAG;
                if (subModule_index < strArr9.length) {
                    return strArr9[subModule_index];
                }
                return null;
            case STORAGE:
                String[] strArr10 = STORAGE_MODULE_TAG;
                if (subModule_index < strArr10.length) {
                    return strArr10[subModule_index];
                }
                return null;
            case SENSOR:
                String[] strArr11 = SENSOR_MODULE_TAG;
                if (subModule_index < strArr11.length) {
                    return strArr11[subModule_index];
                }
                return null;
            case VIEW:
                String[] strArr12 = VIEW_MODULE_TAG;
                if (subModule_index < strArr12.length) {
                    return strArr12[subModule_index];
                }
                return null;
            case SECURITY:
                String[] strArr13 = SECURITY_MODULE_TAG;
                if (subModule_index < strArr13.length) {
                    return strArr13[subModule_index];
                }
                return null;
            case ANIMATION:
                String[] strArr14 = ANIMATION_MODULE_TAG;
                if (subModule_index < strArr14.length) {
                    return strArr14[subModule_index];
                }
                return null;
            case INPUT:
                String[] strArr15 = INPUT_MODULE_TAG;
                if (subModule_index < strArr15.length) {
                    return strArr15[subModule_index];
                }
                return null;
            case POWERONOFF:
                String[] strArr16 = POWERONOFF_MODULE_TAG;
                if (subModule_index < strArr16.length) {
                    return strArr16[subModule_index];
                }
                return null;
            case USM:
                String[] strArr17 = USM_MODULE_TAG;
                if (subModule_index < strArr17.length) {
                    return strArr17[subModule_index];
                }
                return null;
            default:
                return null;

...
public final class HiLogFormatter implements Closeable, Flushable {
    ...
    public class FormatSpecifierParser {
        ...
        public FormatSpecifierParser(String format2, int startIdx) {
            ...
            if (format2.charAt(this.cursor) == '{' && -1 != (flagEndIndex = format2.indexOf(125, this.cursor))) {
                    ...
                    if (c2 != 's') {
                        if (c2 != 'x') {
                            if (c2 == 'n') {
                                ...
                                switch (c2) {
                                    case 'a':
                                    case BastetParameters.HONGBAO_SPEEDUP_STOP /*{ENCODED_INT: 101}*/:
                                    case 'f':
                                    case 'g':
                                        printFloat(arg, l);
                                        return;
            ...
            if (c2 != 'F') {
                if (c2 != 'h') {
                    if (c2 != 'p') {
                                                            ...
                                                            default:
                                                                switch (c2) {
                                                                    ...
                                                                    case BastetParameters.HONGBAO_SPEEDUP_STOP /*{ENCODED_INT: 101}*/:
                                                                        ...
                                                                        sb2.append((CharSequence) localizedMagnitude((StringBuilder) null, (long) i6, flags2, 2, l));
                                                                        break;
                                                                    default:
                                                                        switch (c2) {
                                                                            case 'j':
                        ...
                        sb2.append((CharSequence) localizedMagnitude((StringBuilder) null, (long) i, flags, 2, l));
                    } else {
                        String[] ampm = {"AM", "PM"};
                ...
                if (c2 == 'B') {
                    sb2.append(dfs2.getMonths()[i10]);
                } else {
                    sb2.append(dfs2.getShortMonths()[i10]);
                }
            } else {

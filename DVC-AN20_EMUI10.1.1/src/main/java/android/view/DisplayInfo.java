...
public final class DisplayInfo implements Parcelable {
    ...
    private static final String mSideProp = SystemProperties.get("ro.config.hw_curved_side_disp", "");
    ...
    private void getMetricsWithSize(DisplayMetrics outMetrics, CompatibilityInfo compatInfo, Configuration configuration, int width, int height) {
        ...
        if (!TextUtils.isEmpty(mSideProp)) {
            ...
            if (!(packagename == null || appInfoFlags == -1)) {
                ...
                } else if (outMetrics.widthPixels > outMetrics.heightPixels && isSystem == 0) {

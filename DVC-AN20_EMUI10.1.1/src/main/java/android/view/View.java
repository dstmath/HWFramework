...
public class View implements Drawable.Callback, KeyEvent.Callback, AccessibilityEventSource {
    ...
    private void rebuildOutline() {
        if (this.mAttachInfo != null) {
            ...
            if (viewOutlineProvider == ViewOutlineProvider.HW_MULTIWINDOW_FREEFORM_OUTLINE_PROVIDER || this.mOutlineProvider == ViewOutlineProvider.HW_MULTIWINDOW_SPLITSCREEN_OUTLINE_PROVIDER) {
    ...
    /* JADX INFO: Multiple debug info for r9v1 android.view.View$ScrollabilityCache: [D('viewFlags' int), D('scrollabilityCache' android.view.View$ScrollabilityCache)] */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:84:0x01b1, code lost:
        r12 = r2;
        r25 = r2;
        r26 = android.view.View.VIEW_LOG_TAG;
        r21 = false;
     */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:89:0x01d5 A[ExcHandler: all (th java.lang.Throwable), Splitter:B:34:0x00c8] */
    ...
    public final boolean startDragAndDrop(ClipData data, DragShadowBuilder shadowBuilder, Object myLocalState, int flags) {
        ...
        if (attachInfo == null) {
            ...
            try {
                ...
                if ((flags & 1073741824) != 0 && (myLocalState instanceof Point)) {
                ...
                try {
                    ...
                    if ((flags & 1073741824) == 0 || Process.myUid() != 1000) {
                        session.kill();
                    }
                    return z2;
                } catch (Exception e3) {

...
public class Editor {
    ...
    public class EasyEditPopupWindow extends PinnedPopupWindow implements View.OnClickListener {
        private static final int POPUP_TEXT_LAYOUT = 17367315;
        ...
        public void initContentView() {
            ...
            this.mDeleteTextView = (TextView) ((LayoutInflater) Editor.this.mTextView.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(17367315, (ViewGroup) null);
    ...
    public class SuggestionHelper {
        ...
        /* JADX INFO: Multiple debug info for r1v5 android.widget.Editor$SuggestionInfo: [D('i' int), D('suggestionInfo' android.widget.Editor$SuggestionInfo)] */

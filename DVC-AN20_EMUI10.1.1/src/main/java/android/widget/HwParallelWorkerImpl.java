...
public class HwParallelWorkerImpl implements HwParallelWorker, Runnable {
    ...
    public final class PrefetchViewPredictor {
        ...
        private boolean isPrefetchCanFinish() {
            ...
            double predictFrameCompleteTime = uiTimeDelay + getObtainViewTimeDelay();
            if (uiTimeDelay > UI_TIME_DELAY_THRESHOLD || predictFrameCompleteTime > TOTAL_TIME_DELAY_THRESHOLD) {
                return false;
            }
            return true;
        }

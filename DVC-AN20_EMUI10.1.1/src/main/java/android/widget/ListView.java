...
public class ListView extends HwAbsListView {
                    ...
                    if ((headerDividers || !isHeader2) && (footerDividers2 || !isFooter2)) {
                        ...
                        if (drawDividers2) {
                            ...
                            if (top > effectivePaddingTop2) {
                                ...
                                if (!checkIsEnabled(adapter, itemIndex2)) {
                                    footerDividers = footerDividers2;
                                } else if (!headerDividers && (isHeader2 || previousIndex < headerCount)) {
                                    footerDividers = footerDividers2;
                                } else if (isFirstItem || (checkIsEnabled(adapter, previousIndex) && (footerDividers2 || (!isFooter2 && previousIndex < footerLimit)))) {
                                    footerDividers = footerDividers2;
    ...
    public <T extends View> T findViewTraversal(int id) {
        T t;
        T t2 = (T) super.findViewTraversal(id);
        if (t2 == null) {
            T t3 = (T) findViewInHeadersOrFooters(this.mHeaderViewInfos, id);
            if (t3 != null) {
                return t3;
            }
            t2 = (T) findViewInHeadersOrFooters(this.mFooterViewInfos, id);
            if (t2 != null) {
                return t2;
            }
        }
    ...
    public <T extends View> T findViewWithTagTraversal(Object tag) {
        T t;
        T t2 = (T) super.findViewWithTagTraversal(tag);
        if (t2 == null) {
            T t3 = (T) findViewWithTagInHeadersOrFooters(this.mHeaderViewInfos, tag);
            if (t3 != null) {
                return t3;
            }
            t2 = (T) findViewWithTagInHeadersOrFooters(this.mFooterViewInfos, tag);
            if (t2 != null) {
                return t2;
            }
        }
    ...
    public <T extends View> T findViewByPredicateTraversal(Predicate<View> predicate, View childToSkip) {
        T t;
        T t2 = (T) super.findViewByPredicateTraversal(predicate, childToSkip);
        if (t2 == null) {
            T t3 = (T) findViewByPredicateInHeadersOrFooters(this.mHeaderViewInfos, predicate, childToSkip);
            if (t3 != null) {
                return t3;
            }
            t2 = (T) findViewByPredicateInHeadersOrFooters(this.mFooterViewInfos, predicate, childToSkip);
            if (t2 != null) {
                return t2;
            }
        }
    ...
    /* JADX INFO: Multiple debug info for r2v2 android.widget.ListAdapter: [D('adapter' android.widget.ListAdapter), D('dividerHeight' int)] */
    /* JADX INFO: Multiple debug info for r3v3 int: [D('start' int), D('previousIndex' int)] */
    ...
    private boolean shouldAdjustHeightForDivider(int itemIndex) {
        ...
        if (!checkIsEnabled(adapter, itemIndex)) {
            ...
            if (checkIsEnabled(adapter, previousIndex)) {
                if (footerDividers) {
                    return true;
                }

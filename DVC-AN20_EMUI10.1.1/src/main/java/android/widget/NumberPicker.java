...
public class NumberPicker extends LinearLayout {
    private static final int DEFAULT_LAYOUT_RESOURCE_ID = 17367218;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r20v0, resolved type: android.widget.NumberPicker */
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int layoutResId = attributesArray.getResourceId(3, 17367218);
        this.mHasSelectorWheel = layoutResId != 17367218;

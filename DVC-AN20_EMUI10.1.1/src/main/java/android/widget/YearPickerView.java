...
public class YearPickerView extends ListView {
    ...
    public static class YearAdapter extends BaseAdapter {
        private static final int ITEM_LAYOUT = 17367350;
        private static final int ITEM_TEXT_ACTIVATED_APPEARANCE = 16974769;
        private static final int ITEM_TEXT_APPEARANCE = 16974768;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (hasNewView) {
                v = (TextView) this.mInflater.inflate(17367350, parent, false);
            } else {

            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 2:
                        ...
                        return true;
                    case TRANSACTION_updateCallForwardUncondTimer /*{ENCODED_INT: 3}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_updateCallBarringOption /*{ENCODED_INT: 4}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_queryCallForwardForServiceClass /*{ENCODED_INT: 5}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result3 = queryCallForwardForServiceClass(data.readInt(), data.readInt(), data.readString(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case TRANSACTION_processECT /*{ENCODED_INT: 6}*/:
                        data.enforceInterface(DESCRIPTOR);
                        processECT(data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getUtIMPUFromNetwork /*{ENCODED_INT: 7}*/:
                        data.enforceInterface(DESCRIPTOR);

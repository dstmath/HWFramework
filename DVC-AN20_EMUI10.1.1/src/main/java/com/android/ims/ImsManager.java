...
public class ImsManager {
    ...
    public boolean isVolteEnabledByPlatform() {
        ...
        if (!SystemProperties.getBoolean(PROP_VOLTE_ENABLE, false)) {
            ...
            return false;
        } else if (!this.mContext.getResources().getBoolean(17891403) || !getBooleanCarrierConfig("carrier_volte_available_bool") || !isGbaValid()) {
            return false;
        } else {
            return DBG;
        }
    ...
    public boolean isVtEnabledByPlatform() {
        ...
        if (!SystemProperties.getBoolean(PROP_VILTE_ENABLE, false)) {
            ...
            return false;
        } else if (!this.mContext.getResources().getBoolean(17891404) || !getBooleanCarrierConfig("carrier_vt_available_bool") || !isGbaValid()) {
            return false;
        } else {
            return DBG;
        }
    ...
    public int getWfcMode(boolean roaming) {
        ...
        if (!checkCarrierConfigKeyExist(this.mContext, "carrier_default_wfc_ims_roaming_mode_int").booleanValue() || !roaming) {
            if (SubscriptionManager.getIntegerSubscriptionProperty(getSubId(), "wfc_ims_mode", -1, this.mContext) == -1) {
                setting2 = getIntCarrierConfig("carrier_default_wfc_ims_mode_int");
            } else {
                setting2 = getSettingFromSubscriptionManager("wfc_ims_mode", "carrier_default_wfc_ims_mode_int");
            }
    ...
    public boolean isWfcEnabledByPlatform() {
        ...
        if (SystemProperties.getBoolean(PROP_VOWIFI_ENABLE, false) && this.mContext.getResources().getBoolean(17891405) && getBooleanCarrierConfig("carrier_wfc_ims_available_bool") && isGbaValid()) {
            return DBG;
        }
        return false;
    }

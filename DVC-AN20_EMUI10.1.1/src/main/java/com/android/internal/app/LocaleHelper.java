...
public class LocaleHelper {
    ...
    public static String getDisplayName(Locale locale, Locale displayLocale, boolean sentenceCase) {
        ...
        String result2 = HwFrameworkFactory.getHwLocaleHelperEx().replaceDisplayName(locale, displayLocale, result);
        if (result2 != null) {
    ...
    public static String getDisplayCountry(Locale locale, Locale displayLocale) {
        ...
        String country2 = HwFrameworkFactory.getHwLocaleHelperEx().replaceCountryName(locale, displayLocale, country);
        if (numberingSystem == null) {
            return country2;
        }
        return String.format("%s (%s)", country2, ULocale.getDisplayKeywordValue(languageTag, "numbers", uDisplayLocale));
    }

...
public class ResolverActivity extends Activity {
    ...
    public enum ActionTitle {
        ...
        public static final int BROWSABLE_APP_TITLE_RES = 17041516;
        public static final int BROWSABLE_HOST_APP_TITLE_RES = 17041514;
        public static final int BROWSABLE_HOST_TITLE_RES = 17041513;
        public static final int BROWSABLE_TITLE_RES = 17041515;
    ...
    public CharSequence getTitleForAction(Intent intent, int defaultTitleRes) {
        ...
        if (isHttpSchemeAndViewAction(intent)) {
            if (named && !this.mUseLayoutForBrowsables) {
                return getString(17041516, this.mAdapter.getFilteredItem().getDisplayLabel());
            } else if (named && this.mUseLayoutForBrowsables) {
                return getString(17041514, intent.getData().getHost(), this.mAdapter.getFilteredItem().getDisplayLabel());
            } else if (this.mAdapter.areAllTargetsBrowsers()) {
                return getString(17041515);
            } else {
                return getString(17041513, intent.getData().getHost());
            }
        } else if (!named) {

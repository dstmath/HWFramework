...
public class DecorView extends FrameLayout implements RootViewSurfaceTaker, WindowCallbacks {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:177:0x0263  */
    /* JADX WARNING: Removed duplicated region for block: B:180:0x026e  */
    ...
    private void updateDecorCaptionStatus(Configuration config) {
        ...
        if (!IS_HW_MULTIWINDOW_SUPPORTED || !this.mIsHideCaptionView) {
            ...
            boolean displayWindowDecor = ((!config.windowConfiguration.hasWindowDecorCaption() && (i2 = this.mWindowMode) != 5 && !WindowConfiguration.isHwMultiStackWindowingMode(i2)) || (i = this.mWindowMode) == 1 || i == 103) ? false : true;
            ...
            } else if (!displayWindowDecor && getOutlineProvider() != null) {
    ...
    private DecorCaptionView createDecorCaptionView(LayoutInflater inflater) {
        ...
        WindowManager.LayoutParams attrs = this.mWindow.getAttributes();
        if (!this.mWindow.isFloating() && (attrs.type == 1 || attrs.type == 2 || attrs.type == 4) && ((getResources().getConfiguration().windowConfiguration.hasWindowDecorCaption() || (i2 = this.mWindowMode) == 5 || WindowConfiguration.isHwMultiStackWindowingMode(i2)) && (i = this.mWindowMode) != 1 && i != 103)) {
    ...
    private void updateElevation() {
        ...
        if ((windowingMode == 5 || this.mWindowMode == 5) && !isResizing()) {
            ...
            elevation = dipToPx(5.0f);
            this.mElevationAdjustedForStack = true;
        } else if (!WindowConfiguration.isHwFreeFormWindowingMode(this.mWindowMode) || this.isSlashScreen) {
            this.mElevationAdjustedForStack = false;
        } else {
    ...
    public void showOrHideHighlightView(boolean isHasFocus) {
        ...
        if (WindowConfiguration.isHwMultiStackWindowingMode(this.mWindowMode) && (getParent() instanceof ViewRootImpl)) {
            PhoneWindow phoneWindow = this.mWindow;
            if (phoneWindow == null || !phoneWindow.isFloating()) {
                ...
                if (HighlightViewMgr.isGestureNavigation(this.mContext.getContentResolver())) {
                    HighlightViewMgr highlightViewMgr = this.mHighlightViewMgr;
                    if (highlightViewMgr != null) {
                        if (!isHasFocus) {
    ...
    private boolean isFloatingWindowMode(int windowingMode) {
        return windowingMode == 5 || windowingMode == 102;
    }
}

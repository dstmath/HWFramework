...
public class GsmCdmaPhone extends Phone implements IHwGsmCdmaPhoneInner {
    ...
    public GsmCdmaPhone(Context context, CommandsInterface ci, PhoneNotifier notifier, boolean unitTestMode, int phoneId, int precisePhoneType, TelephonyComponentFactory telephonyComponentFactory) {
        ...
        this.mHwGsmCdmaPhoneEx = HwTelephonyFactory.getHwPhoneManager().createHwGsmCdmaPhoneEx(this, phoneExt);
    ...
    public Connection dial(String dialString, PhoneInternalInterface.DialArgs dialArgs) throws CallStateException {
        ...
        if (isPhoneTypeGsm() || dialArgs.uusInfo == null) {
            ...
            boolean useImsForEmergency3 = imsPhone != null && isEmergency && alwaysTryImsForEmergencyCarrierConfig && ImsManager.getInstance(this.mContext, this.mPhoneId).isNonTtyOrTtyOnVolteEnabled() && imsPhone.isImsAvailable() && this.mCT.mForegroundCall.getState() != Call.State.ACTIVE;
    ...
    @Override // com.android.internal.telephony.PhoneInternalInterface, com.android.internal.telephony.AbstractPhoneBase, com.android.internal.telephony.AbstractPhoneInternalInterface
    ...
    public String getLine1Number() {
        ...
        boolean use_usim = ((CarrierConfigManager) this.mContext.getSystemService("carrier_config")).getConfigForSubId(getSubId()).getBoolean("use_usim_bool");
    ...
    private void handleRadioPowerStateChange() {
        String str = this.LOG_TAG;
        Rlog.d(str, "handleRadioPowerStateChange, state= " + this.mCi.getRadioState());
    ...
    private boolean isManualSelProhibitedInGlobalMode() {
        ...
        String configString = getContext().getResources().getString(17041082);

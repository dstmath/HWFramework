...
public class HuaweiTelephonyConfigs {
    ...
    public static boolean isHisiPlatform() {
        return definedChipPlatformValue.startsWith("hi363") || definedChipPlatformValue.startsWith("hi6210") || definedChipPlatformValue.startsWith("hi365") || definedChipPlatformValue.startsWith("hi6250") || definedChipPlatformValue.startsWith("hi366") || definedChipPlatformValue.startsWith("kirin9") || (!HwModemCapability.isCapabilitySupport(9) && !HwModemCapability.isCapabilitySupport(28));
    }

    public static boolean isQcomPlatform() {
        return definedChipPlatformValue.startsWith("msm") || (HwModemCapability.isCapabilitySupport(9) && !HwModemCapability.isCapabilitySupport(28));
    }

    public static boolean isMTKPlatform() {
        return definedChipPlatformValue.startsWith("mt") || (HwModemCapability.isCapabilitySupport(28) && !HwModemCapability.isCapabilitySupport(9));
    }

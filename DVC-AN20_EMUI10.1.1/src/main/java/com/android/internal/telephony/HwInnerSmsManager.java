...
public interface HwInnerSmsManager {
    ...
    void dispatchCTAutoRegSmsPdu(Context context, SmsMessageBase smsMessageBase, int i, Handler handler);
    ...
    int handleExtendTeleService(int i, CdmaSMSDispatcher cdmaSMSDispatcher, SmsMessageBase smsMessageBase);

    boolean handleWapPushExtraMimeType(String str);

    boolean hasSameSmsPdu(byte[] bArr, int i);

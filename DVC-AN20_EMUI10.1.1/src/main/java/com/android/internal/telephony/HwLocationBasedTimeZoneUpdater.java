...
public class HwLocationBasedTimeZoneUpdater extends StateMachineEx {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 4) {
                ...
                if (ar.getResult() == null || !(ar.getResult() instanceof String)) {
                    HwLocationBasedTimeZoneUpdater.this.rplmn = SystemPropertiesEx.get(HwLocationBasedTimeZoneUpdater.PROPERTY_GLOBAL_OPERATOR_NUMERIC, "");
                } else {
            ...
            if (intent != null) {
                ...
                if ("android.intent.action.SCREEN_ON".equals(action)) {
                    ...
                    if (Settings.Global.getInt(HwLocationBasedTimeZoneUpdater.this.mCr, "airplane_mode_on", 0) > 0) {
                        ...
                        HwLocationBasedTimeZoneUpdater.this.mCurrentLocation = null;
                        HwLocationBasedTimeZoneUpdater.this.mLastValidNetIso = "";
                    }
    ...
    private void registerRplmnChange() {
        for (int i = 0; i < PHONE_NUM; i++) {
            ...
            if (!(phone == null || phone.getCi() == null)) {
                phone.getCi().registerForRplmnsStateChanged(this.mMyHandler, 4, Integer.valueOf(i));
            }
        }
    }
    ...
    private void registerEventsForMultiTimeZoneCountry() {
        ...
        handler.sendMessageDelayed(handler.obtainMessage(7), SEND_NOTIFY_WHEN_NO_NITZ_MS);
        ...
        if (isScreenOn()) {
            ...
            handler2.sendMessage(handler2.obtainMessage(5, false));
        }
    }
    ...
    private void showLocationAccessNotification() {
        ...
        if (this.mContext != null) {
            ...
            Notification.Builder builder = new Notification.Builder(this.mContext).setSmallIcon(33751759).setWhen(System.currentTimeMillis()).setShowWhen(true).setAutoCancel(true).setDefaults(-1).setContentTitle(this.mContext.getString(33686046)).setContentText(this.mContext.getString(33686047)).setContentIntent(resultPendingIntent).setStyle(new Notification.BigTextStyle()).setChannelId(TIME_UPDATE_NOTIFY_CHANNEL).addAction(getEnableLocationAction());

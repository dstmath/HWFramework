...
public interface HwPhoneManager {
    ...
    IHwGsmCdmaPhoneEx createHwGsmCdmaPhoneEx(IHwGsmCdmaPhoneInner iHwGsmCdmaPhoneInner, PhoneExt phoneExt);
    ...
    void loadHuaweiPhoneService(PhoneExt[] phoneExtArr, Context context);

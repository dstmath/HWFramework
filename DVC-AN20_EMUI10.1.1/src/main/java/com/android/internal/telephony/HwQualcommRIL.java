...
public class HwQualcommRIL extends RIL {
    ...
    public static synchronized Class getHWNV() {
        ...
        synchronized (HwQualcommRIL.class) {
            RlogEx.i(RILJ_LOG_TAG, "Enter HwQualcommRIL getClass");
            if (hwNv == null) {
                try {
                    ...
                    RlogEx.e(RILJ_LOG_TAG, "Can not find class.");
                } catch (RuntimeException e2) {
                    RlogEx.e(RILJ_LOG_TAG, "Other exception.");
                }
            }
            cls = hwNv;
        }
    ...
    private synchronized void getQcRilHook(Context context) {
        ...
        if (qcRilHook == null) {
            try {
                ...
                setQcRilHook(new PathClassLoader("system/framework/qcrilhook.jar", null, ClassLoader.getSystemClassLoader()).loadClass("com.qualcomm.qcrilhook.QcRilHook").getConstructor(Context.class).newInstance(params));
            } catch (ClassNotFoundException e) {

...
public class HwRILReferenceImpl extends Handler implements AbstractRIL.HwRILReference {
                ...
                if (HwImsManagerInner.isDualImsAvailable() || HwRILReferenceImpl.this.mHwRilReferenceInstanceId.intValue() == subId) {
                    ...
                    if ("android.telephony.action.CARRIER_CONFIG_CHANGED".equals(action)) {
                        ...
                        if (!HwImsManagerInner.isDualImsAvailable() && HwRILReferenceImpl.this.mRil != null) {
                            ...
                            if (hwRILReferenceImpl2.mRil.getRadioState() == 1) {
                                z = true;
                            }
                            hwRILReferenceImpl2.handleUnsolicitedRadioStateChanged(z, HwRILReferenceImpl.this.mContext);
                        }
                        ...
                        if (curSubId == HwRILReferenceImpl.this.mHwRilReferenceInstanceId.intValue()) {
                            ...
                            if ((!HwRILReferenceImpl.FEATURE_VOLTE_DYN || HwRILReferenceImpl.this.mIsCarrierConfigLoaded) && HwRILReferenceImpl.this.mIsImsRegistered && !isSupportVolte) {
                                ...
                                hwRILReferenceImpl3.handleImsSwitch(hwRILReferenceImpl3.mIsImsRegistered);
                            }
                        }
                        ...
                        if (intent.getIntExtra(HwRILReferenceImpl.IMS_STATE_CHANGE_SUBID, -1) == HwRILReferenceImpl.this.mHwRilReferenceInstanceId.intValue()) {
                            ...
                            if (hwRILReferenceImpl4.mRil.getRadioState() == 1) {
                                z = true;
                            }
                            hwRILReferenceImpl4.handleUnsolicitedRadioStateChanged(z, HwRILReferenceImpl.this.mContext);
                        }
                    }
                } else {
    ...
    public void setNrSwitch(boolean on, Message onComplete) {
        ...
        if (context == null) {
            ...
            if (this.mIsCarrierConfigLoaded) {
                if (HwImsManagerInner.isVolteEnabledByPlatform(this.mContext, this.mHwRilReferenceInstanceId.intValue())) {
                    if (on) {
    ...
    public void handleRequestGetImsiMessage(RILRequest rr, Object ret, Context context) {
        ...
        if (rr.mRequest == 11) {
            ...
            if (ret != null && !((String) ret).equals("")) {
                ...
                if (mMcc == null && temp_mcc != null && (str = this.mcc_operator) != null && !str.equals(temp_mcc) && temp_mcc.equals("460") && this.shouldReportRoamingPlusInfo) {
                    Intent intent = new Intent();
                    intent.setAction(ACTION_HW_EXIST_NETWORK_INFO_ROAMING_PLUS);
                    intent.putExtra("current_mcc", this.mcc_operator);
                    context.sendBroadcast(intent);
                    Rlog.i(RILJ_LOG_TAG, "sendBroadcast:ACTION_HW_EXIST_NETWORK_INFO_ROAMING_PLUS with extra: mcc=" + this.mcc_operator + "when handleRequestGetImsiMessage");
    ...
    public void sendHWBufferSolicited(Message result, int event, byte[] reqData) {
        ...
        try {
            ...
            Rlog.i(RILJ_LOG_TAG, "sendHWBufferSolicited failed, UnsupportedEncodingException");
        }
    }
    ...
    public void existNetworkInfo(String state) {
        ...
        Rlog.i(RILJ_LOG_TAG, "recieved RIL_UNSOL_HW_EXIST_NETWORK_INFO with mcc_operator =" + this.mcc_operator + "and mMcc =" + mMcc);
        String str = this.mcc_operator;
        if (str == null || !str.equals(mMcc)) {
            String str2 = mMcc;
            if ((str2 == null || str2.equals("460")) && mMcc != null && this.shouldReportRoamingPlusInfo) {
                Intent intent = new Intent();
                intent.setAction(ACTION_HW_EXIST_NETWORK_INFO_ROAMING_PLUS);
                intent.putExtra("current_mcc", this.mcc_operator);
                this.existNetworkContext.sendBroadcast(intent);
                Rlog.i(RILJ_LOG_TAG, "sendBroadcast:ACTION_HW_EXIST_NETWORK_INFO_ROAMING_PLUS with extra: mcc_operator=" + this.mcc_operator);
                this.shouldReportRoamingPlusInfo = false;
            }
        }
    }
    ...
    private boolean isQcUnsolOemHookResp(ByteBuffer oemHookResponse) {
        ...
        RIL ril2 = this.mRil;
        if (!"QOEMHOOK".equals(oemIdString)) {
            return false;
        }
        return true;
    }
    ...
    private void handleUnsolOemhookResponseByEventId(int responseId, byte[] responseData, byte[] ret) {
        switch (responseId) {
            case QCRIL_EVT_HOOK_UNSOL_MODEM_CAPABILITY /*{ENCODED_INT: 525308}*/:
                notifyModemCap(responseData, this.mRil.mPhoneId);
                return;
            case 525341:
                sendRacChangeBroadcast(responseData);
                return;
            case RIL_UNSOL_HOOK_HW_VP_STATUS /*{ENCODED_INT: 598029}*/:
            ...
            case 598035:
                ...
                return;
            case RILHOOK_UNSOL_HW_REPORT_BUFFER /*{ENCODED_INT: 598044}*/:

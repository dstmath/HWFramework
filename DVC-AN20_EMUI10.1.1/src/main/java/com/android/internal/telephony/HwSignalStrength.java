...
public class HwSignalStrength {
    ...
    private void loadCustInfo(SignalType signalType) {
        ...
        switch (signalType) {
            case GSM:
                configItem = SystemPropertiesEx.get(this.PROPERTY_SIGNAL_CUST_GSM, "");
                defaultValue = DEFAULT_SIGNAL_CUST_GSM;
                break;
            case UMTS:
                configItem = SystemPropertiesEx.get(this.PROPERTY_SIGNAL_CUST_UMTS, "");
                defaultValue = DEFAULT_SIGNAL_CUST_UMTS;
                break;
            case CDMA:
                configItem = SystemPropertiesEx.get(this.PROPERTY_SIGNAL_CUST_CDMA, "");
                defaultValue = "5,false,-112,-106,-99,-92,-85";
                break;
            case EVDO:
                configItem = SystemPropertiesEx.get(this.PROPERTY_SIGNAL_CUST_EVDO, "");
                defaultValue = "5,false,-112,-106,-99,-92,-85";
                break;
            case LTE:
                ...
                if (TextUtils.isEmpty(configItem)) {
                    configItem = SystemPropertiesEx.get(this.PROPERTY_SIGNAL_CUST_LTE, "");
                }
                RlogEx.i(LOG_TAG, "configItem: " + configItem + "  mPhoneId: " + this.mPhoneId);
                defaultValue = "5,false,-120,-115,-110,-105,-97";
                break;
            case CDMALTE:
                configItem = SystemPropertiesEx.get(this.PROPERTY_SIGNAL_CUST_CDMALTE, "");
                defaultValue = "5,false,-120,-115,-110,-105,-97";
                break;
            case NR:
                configItem = SystemPropertiesEx.get(this.PROPERTY_SIGNAL_CUST_NR, "");
                defaultValue = "5,false,-120,-115,-110,-105,-97";
                break;
            default:

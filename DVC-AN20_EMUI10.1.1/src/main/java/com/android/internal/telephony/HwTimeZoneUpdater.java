...
public class HwTimeZoneUpdater {
    ...
    private void init() {
        ...
        PhoneExt phone2 = PhoneFactoryExt.getPhone(0);
    ...
    private void setTimeZoneByRplmn(String zoneId) {
        ...
        HwPartTelephonyFactory.loadFactory("android.telephony.HwPartTelephonyFactoryImpl").getHwReportManager().reportSetTimeZoneByIso(PhoneFactoryExt.getPhone(0), zoneId, false, "RplmnIso");
    }

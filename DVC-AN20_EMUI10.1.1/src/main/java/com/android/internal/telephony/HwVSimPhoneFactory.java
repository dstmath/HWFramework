...
public class HwVSimPhoneFactory {
    ...
    public static void setVSimSavedNetworkMode(int modemId, int mode) {
        Settings.System.putInt(sContext.getContentResolver(), VALUE_VSIM_SAVED_NETWORK_MODE + modemId, mode);
        slogd("setVSimSavedNetworkMode: " + mode + ", for modemId:" + modemId);
    }

    public static int getVSimSavedNetworkMode(int modemId) {
        try {
            return Settings.System.getInt(sContext.getContentResolver(), VALUE_VSIM_SAVED_NETWORK_MODE + modemId);
        } catch (Settings.SettingNotFoundException e) {
    ...
    public static int getVSimUserReservedSubId() {
        ...
        try {
            return Settings.System.getInt(sContext.getContentResolver(), VALUE_VSIM_USER_RESERVED_SUBID);
        } catch (Settings.SettingNotFoundException e) {
    ...
    public static boolean isVSimPhone(PhoneExt phone) {
    ...
    public static String getPendingDeviceInfoFromSP(String prefKey, int phoneId) {
        ...
        String result = PreferenceManager.getDefaultSharedPreferences(sContext).getString(prefKey + phoneId, null);
        try {

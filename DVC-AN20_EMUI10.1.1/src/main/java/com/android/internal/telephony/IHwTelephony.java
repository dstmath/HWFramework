            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 9:
                        ...
                        setDataEnabledWithoutPromp(_arg08);
                        reply.writeNoException();
                        return true;
                    case 10:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        setDataRoamingEnabledWithoutPromp(_arg07);
                        reply.writeNoException();
                        return true;
                    case 11:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 23:
                        ...
                        setImsRegistrationStateForSubId(_arg09, _arg17);
                        reply.writeNoException();
                        return true;
                    case 24:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 35:
                        ...
                        setDefault4GSlotId(_arg010, _arg1);
                        reply.writeNoException();
                        return true;
                    case 36:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 37:
                        ...
                        waitingSetDefault4GSlotDone(_arg06);
                        reply.writeNoException();
                        return true;
                    case 38:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 53:
                        ...
                        return true;
                    case TRANSACTION_unregisterForRadioAvailable /*{ENCODED_INT: 54}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_registerForRadioNotAvailable /*{ENCODED_INT: 55}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_unregisterForRadioNotAvailable /*{ENCODED_INT: 56}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_registerCommonImsaToMapconInfo /*{ENCODED_INT: 57}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_unregisterCommonImsaToMapconInfo /*{ENCODED_INT: 58}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_isRadioAvailable /*{ENCODED_INT: 59}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isRadioAvailable = isRadioAvailable();
                        reply.writeNoException();
                        reply.writeInt(isRadioAvailable ? 1 : 0);
                        return true;
                    case TRANSACTION_setImsSwitch /*{ENCODED_INT: 60}*/:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg05 = true;
                        }
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getImsSwitch /*{ENCODED_INT: 61}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean imsSwitch = getImsSwitch();
                        reply.writeNoException();
                        reply.writeInt(imsSwitch ? 1 : 0);
                        return true;
                    case TRANSACTION_setNrSwitch /*{ENCODED_INT: 62}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _arg011 = data.readInt();
                        if (data.readInt() != 0) {
                            _arg16 = true;
                        }
                        setNrSwitch(_arg011, _arg16);
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setImsDomainConfig /*{ENCODED_INT: 63}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 68:
                        ...
                        return true;
                    case TRANSACTION_unregisterForPhoneEvent /*{ENCODED_INT: 69}*/:
                        data.enforceInterface(DESCRIPTOR);
                        unregisterForPhoneEvent(IPhoneCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_isRadioAvailableByPhoneId /*{ENCODED_INT: 70}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isRadioAvailableByPhoneId = isRadioAvailableByPhoneId(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(isRadioAvailableByPhoneId ? 1 : 0);
                        return true;
                    case TRANSACTION_setImsSwitchByPhoneId /*{ENCODED_INT: 71}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _arg012 = data.readInt();
                        if (data.readInt() != 0) {
                            _arg15 = true;
                        }
                        setImsSwitchByPhoneId(_arg012, _arg15);
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getImsSwitchByPhoneId /*{ENCODED_INT: 72}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean imsSwitchByPhoneId = getImsSwitchByPhoneId(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(imsSwitchByPhoneId ? 1 : 0);
                        return true;
                    case TRANSACTION_setImsDomainConfigByPhoneId /*{ENCODED_INT: 73}*/:
                        data.enforceInterface(DESCRIPTOR);
                        setImsDomainConfigByPhoneId(data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_handleMapconImsaReqByPhoneId /*{ENCODED_INT: 74}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 75:
                        ...
                        return true;
                    case TRANSACTION_getImsDomainByPhoneId /*{ENCODED_INT: 76}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result26 = getImsDomainByPhoneId(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result26);
                        return true;
                    case TRANSACTION_handleUiccAuthByPhoneId /*{ENCODED_INT: 77}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_registerForWirelessState /*{ENCODED_INT: 78}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_unregisterForWirelessState /*{ENCODED_INT: 79}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_notifyDeviceState /*{ENCODED_INT: 84}*/:
                        ...
                        return true;
                    case TRANSACTION_notifyCellularCommParaReady /*{ENCODED_INT: 85}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        notifyCellularCommParaReady(_arg014, _arg19, _arg2);
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setPinLockEnabled /*{ENCODED_INT: 86}*/:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg04 = true;
                        }
                        boolean pinLockEnabled = setPinLockEnabled(_arg04, data.readString(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(pinLockEnabled ? 1 : 0);
                        return true;
                    case TRANSACTION_changeSimPinCode /*{ENCODED_INT: 87}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_sendPseudocellCellInfo /*{ENCODED_INT: 88}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_sendLaaCmd /*{ENCODED_INT: 89}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        boolean sendLaaCmd = sendLaaCmd(_arg015, _arg110, _arg22);
                        reply.writeNoException();
                        reply.writeInt(sendLaaCmd ? 1 : 0);
                        return true;
                    case TRANSACTION_getLaaDetailedState /*{ENCODED_INT: 90}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        boolean laaDetailedState = getLaaDetailedState(_arg016, _arg12);
                        reply.writeNoException();
                        reply.writeInt(laaDetailedState ? 1 : 0);
                        return true;
                    case TRANSACTION_registerForCallAltSrv /*{ENCODED_INT: 91}*/:
                        data.enforceInterface(DESCRIPTOR);
                        registerForCallAltSrv(data.readInt(), IPhoneCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_unregisterForCallAltSrv /*{ENCODED_INT: 92}*/:
                        data.enforceInterface(DESCRIPTOR);
                        unregisterForCallAltSrv(data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_invokeOemRilRequestRaw /*{ENCODED_INT: 93}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _arg017 = data.readInt();
                        byte[] _arg111 = data.createByteArray();
                        byte[] _arg26 = data.createByteArray();
                        int _result28 = invokeOemRilRequestRaw(_arg017, _arg111, _arg26);
                        reply.writeNoException();
                        reply.writeInt(_result28);
                        reply.writeByteArray(_arg26);
                        return true;
                    case TRANSACTION_isCspPlmnEnabled /*{ENCODED_INT: 94}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isCspPlmnEnabled = isCspPlmnEnabled(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(isCspPlmnEnabled ? 1 : 0);
                        return true;
                    case TRANSACTION_setCallForwardingOption /*{ENCODED_INT: 95}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        setCallForwardingOption(_arg018, _arg112, _arg27, _arg33, _arg4, _arg5);
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getCallForwardingOption /*{ENCODED_INT: 96}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        getCallForwardingOption(_arg019, _arg113, _arg23);
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setSubscription /*{ENCODED_INT: 97}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        boolean subscription = setSubscription(_arg020, _arg14, _arg24);
                        reply.writeNoException();
                        reply.writeInt(subscription ? 1 : 0);
                        return true;
                    case TRANSACTION_getImsImpu /*{ENCODED_INT: 98}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String _result29 = getImsImpu(data.readInt());
                        reply.writeNoException();
                        reply.writeString(_result29);
                        return true;
                    case TRANSACTION_getLine1NumberFromImpu /*{ENCODED_INT: 99}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 101:
                        ...
                        return true;
                    case TRANSACTION_getCdmaGsmImsiForSubId /*{ENCODED_INT: 102}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String _result31 = getCdmaGsmImsiForSubId(data.readInt());
                        reply.writeNoException();
                        reply.writeString(_result31);
                        return true;
                    case TRANSACTION_setLine1Number /*{ENCODED_INT: 103}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        boolean line1Number = setLine1Number(_arg021, _arg114, _arg28, _arg3);
                        reply.writeNoException();
                        reply.writeInt(line1Number ? 1 : 0);
                        return true;
                    case TRANSACTION_setDeepNoDisturbState /*{ENCODED_INT: 104}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean deepNoDisturbState = setDeepNoDisturbState(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(deepNoDisturbState ? 1 : 0);
                        return true;
                    case TRANSACTION_setUplinkFreqBandwidthReportState /*{ENCODED_INT: 105}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_informModemTetherStatusToChangeGRO /*{ENCODED_INT: 106}*/:
                        data.enforceInterface(DESCRIPTOR);
                        informModemTetherStatusToChangeGRO(data.readInt(), data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_sendSimMatchedOperatorInfo /*{ENCODED_INT: 107}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_getMobilePhysicsLayerStatus /*{ENCODED_INT: 108}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean[] _result32 = getMobilePhysicsLayerStatus(data.readInt());
                        reply.writeNoException();
                        reply.writeBooleanArray(_result32);
                        return true;
                    case TRANSACTION_getAntiFakeBaseStation /*{ENCODED_INT: 109}*/:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        return true;
                    case TRANSACTION_registerForAntiFakeBaseStation /*{ENCODED_INT: 110}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_unregisterForAntiFakeBaseStation /*{ENCODED_INT: 111}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_getCardTrayInfo /*{ENCODED_INT: 112}*/:
                        data.enforceInterface(DESCRIPTOR);
                        byte[] _result33 = getCardTrayInfo();
                        reply.writeNoException();
                        reply.writeByteArray(_result33);
                        return true;
                    case TRANSACTION_setCsconEnabled /*{ENCODED_INT: 113}*/:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg03 = true;
                        }
                        boolean csconEnabled = setCsconEnabled(_arg03);
                        reply.writeNoException();
                        reply.writeInt(csconEnabled ? 1 : 0);
                        return true;
                    case TRANSACTION_getCsconEnabled /*{ENCODED_INT: 114}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int[] _result34 = getCsconEnabled();
                        reply.writeNoException();
                        reply.writeIntArray(_result34);
                        return true;
                    case TRANSACTION_getLevel /*{ENCODED_INT: 115}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result35 = getLevel(data.readInt(), data.readInt(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result35);
                        return true;
                    case TRANSACTION_getDataRegisteredState /*{ENCODED_INT: 116}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result36 = getDataRegisteredState(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result36);
                        return true;
                    case TRANSACTION_getVoiceRegisteredState /*{ENCODED_INT: 117}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result37 = getVoiceRegisteredState(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result37);
                        return true;
                    case TRANSACTION_getNetworkModeFromDB /*{ENCODED_INT: 118}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result38 = getNetworkModeFromDB(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result38);
                        return true;
                    case TRANSACTION_saveNetworkModeToDB /*{ENCODED_INT: 119}*/:
                        data.enforceInterface(DESCRIPTOR);
                        saveNetworkModeToDB(data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setTemperatureControlToModem /*{ENCODED_INT: 120}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        boolean temperatureControlToModem = setTemperatureControlToModem(_arg022, _arg115, _arg29, _arg32);
                        reply.writeNoException();
                        reply.writeInt(temperatureControlToModem ? 1 : 0);
                        return true;
                    case TRANSACTION_blockingGetIccATR /*{ENCODED_INT: 121}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String _result39 = blockingGetIccATR(data.readInt());
                        reply.writeNoException();
                        reply.writeString(_result39);
                        return true;
                    case TRANSACTION_isEuicc /*{ENCODED_INT: 122}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isEuicc = isEuicc(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(isEuicc ? 1 : 0);
                        return true;
                    case TRANSACTION_setNrOptionMode /*{ENCODED_INT: 123}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        boolean nrOptionMode = setNrOptionMode(_arg023, _arg13);
                        reply.writeNoException();
                        reply.writeInt(nrOptionMode ? 1 : 0);
                        return true;
                    case TRANSACTION_getNrOptionMode /*{ENCODED_INT: 124}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result40 = getNrOptionMode();
                        reply.writeNoException();
                        reply.writeInt(_result40);
                        return true;
                    case TRANSACTION_isNsaState /*{ENCODED_INT: 125}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isNsaState = isNsaState(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(isNsaState ? 1 : 0);
                        return true;
                    case TRANSACTION_getNrCellSsbId /*{ENCODED_INT: 126}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 128:
                        ...
                        return true;
                    case TRANSACTION_getCTOperator /*{ENCODED_INT: 129}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String _result42 = getCTOperator(data.readInt(), data.readString());
                        reply.writeNoException();
                        reply.writeString(_result42);
                        return true;
                    case TRANSACTION_getHwInnerService /*{ENCODED_INT: 130}*/:
                        data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements IHwTelephony {
            ...
            public boolean unregisterForRadioAvailable(IPhoneCallback callback) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(callback != null ? callback.asBinder() : null);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_unregisterForRadioAvailable, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean registerForRadioNotAvailable(IPhoneCallback callback) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(callback != null ? callback.asBinder() : null);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_registerForRadioNotAvailable, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean unregisterForRadioNotAvailable(IPhoneCallback callback) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(callback != null ? callback.asBinder() : null);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_unregisterForRadioNotAvailable, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean registerCommonImsaToMapconInfo(IPhoneCallback callback) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(callback != null ? callback.asBinder() : null);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_registerCommonImsaToMapconInfo, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean unregisterCommonImsaToMapconInfo(IPhoneCallback callback) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(callback != null ? callback.asBinder() : null);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_unregisterCommonImsaToMapconInfo, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean isRadioAvailable() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_isRadioAvailable, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public void setImsSwitch(boolean value) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_setImsSwitch, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public boolean getImsSwitch() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_getImsSwitch, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public void setNrSwitch(int phoneId, boolean value) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(value ? 1 : 0);
                    if (this.mRemote.transact(Stub.TRANSACTION_setNrSwitch, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public void setImsDomainConfig(int domainType) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_setImsDomainConfig, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public String getCdmaGsmImsiForSubId(int subId) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(subId);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getCdmaGsmImsiForSubId, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean setLine1Number(int subId, String alphaTag, String number, Message onComplete) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(Stub.TRANSACTION_setLine1Number, _data, _reply, 0) && Stub.getDefaultImpl() != null) {

...
public abstract class InboundSmsHandler extends StateMachine {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r28v0, resolved type: com.android.internal.telephony.InboundSmsHandler */
    ...
    /* JADX WARN: Type inference failed for: r13v1, types: [java.lang.Object[], byte[][], java.io.Serializable] */
    /* JADX WARN: Type inference failed for: r13v11 */
    /* JADX WARN: Type inference failed for: r13v12 */
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    /* JADX WARNING: Removed duplicated region for block: B:113:0x0372 A[RETURN] */
    /* JADX WARNING: Removed duplicated region for block: B:114:0x0374  */
    /* JADX WARNING: Removed duplicated region for block: B:159:0x04d5  */
    /* JADX WARNING: Removed duplicated region for block: B:162:0x04dd  */
    ...
    private void showNewMessageNotification() {
        if (StorageManager.isFileEncryptedNativeOrEmulated()) {
            ...
            ((NotificationManager) this.mContext.getSystemService("notification")).notify(NOTIFICATION_TAG, 1, new Notification.Builder(this.mContext).setSmallIcon(17301646).setAutoCancel(true).setVisibility(1).setDefaults(-1).setContentTitle(this.mContext.getString(17040645)).setContentText(this.mContext.getString(17040644)).setContentIntent(PendingIntent.getBroadcast(this.mContext, 0, new Intent(ACTION_OPEN_SMS_APP), 1073741824)).setChannelId(NotificationChannelController.CHANNEL_ID_SMS).build());
        }
    }
    ...
    static int getBroadcastCompleteEventHw() {
        return 3;
    }
    ...
    public String getNumberIfWapPushDeliverActionAndMmsMessage(Intent intent) {
        ...
        if (intent == null || (pdu = new PduParser(intent.getByteArrayExtra("data"), false).parse()) == null || pdu.getMessageType() != 130 || (fromValue = pdu.getFrom()) == null) {
            return null;
        }

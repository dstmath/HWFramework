...
public class RIL extends AbstractRIL implements CommandsInterface {
        ...
        if (!this.mIsMobileNetworkSupported) {
            ...
            try {
                if (this.mDisabledRadioServices.contains(this.mPhoneId)) {
                    ...
                    try {
                        this.mRadioProxy = android.hardware.radio.V1_4.IRadio.getService(HIDL_SERVICE_NAME[phoneId.intValue()], true);
                        this.mRadioVersion = RADIO_HAL_VERSION_1_4;
                    } catch (NoSuchElementException e) {
                    }
                    if (this.mRadioProxy == null) {
                        try {
                            this.mRadioProxy = android.hardware.radio.V1_3.IRadio.getService(HIDL_SERVICE_NAME[phoneId.intValue()], true);
                    ...
                    if (this.mRadioProxy == null) {
                        try {
                            this.mRadioProxy = android.hardware.radio.V1_2.IRadio.getService(HIDL_SERVICE_NAME[phoneId.intValue()], true);
                    ...
                    if (this.mRadioProxy == null) {
                        try {
                            this.mRadioProxy = android.hardware.radio.V1_1.IRadio.getService(HIDL_SERVICE_NAME[phoneId.intValue()], true);
                    ...
                    if (this.mRadioProxy == null) {
                        try {
                            this.mRadioProxy = IRadio.getService(HIDL_SERVICE_NAME[phoneId.intValue()], true);
    ...
    public RadioCapability makeStaticRadioCapability() {
        int raf = 0;
        String rafString = this.mContext.getResources().getString(17039886);
    ...
    static String requestToString(int request) {
        ...
        switch (request) {
            ...
            case RadioNVItems.RIL_NV_LTE_HIDDEN_BAND_PRIORITY_25 /*{ENCODED_INT: 77}*/:
    ...
    private void checkFirstRequest() {
        ...
        if (size != 0) {
            HwTelephonyFactory.getHwTelephonyChrManager().checkFirstRequest(size, RILRequestEx.from(this.mRequestList.valueAt(0)), this.mPhoneId.intValue());
        }
    }
}

...
public class ServiceStateTracker extends Handler implements IServiceStateTrackerInner {
    ...
    public ServiceStateTracker(GsmCdmaPhone phone, CommandsInterface ci) {
        ...
        registerForDataConnectionDetached(1, this.mCSST, AbstractPhoneBase.EVENT_ECC_NUM, null);
        registerForImsCapabilityChanged(this.mCSST, AbstractPhoneBase.EVENT_GET_IMSI_DONE, null);
        initDisplay();
    }
    ...
    private void notifySpnDisplayUpdate(CarrierDisplayNameData data, boolean showWifi, String wifi, String regplmn) {
        ...
        if (this.mSubId != subId || isOperatorChanged(data, showWifi, wifi, regplmn) || ((hwCustGsmServiceStateTracker = this.mHwCustGsmServiceStateTracker) != null && hwCustGsmServiceStateTracker.isInServiceState(combinedRegState))) {
            ...
            if (VSimUtilsInner.isVSimSub(this.mPhone.mPhoneId)) {
    ...
    private void updateSpnDisplayLegacy() {
        ...
        if (this.mPhone.getImsPhone() == null || !this.mPhone.getImsPhone().isWifiCallingEnabled() || combinedRegState != 0) {
            ...
            showSpn = false;
            String[] wfcSpnFormats = SubscriptionManager.getResourcesForSubId(this.mPhone.getContext(), this.mPhone.getSubId(), bundle.getBoolean("wfc_spn_use_root_locale")).getStringArray(17236119);
        ...
        if (this.mPhone.isPhoneTypeGsm()) {
            ...
            if (combinedRegState == 1 || combinedRegState == 2) {
                ...
                if (!this.mEmergencyOnly || forceDisplayNoService) {
                    plmn4 = Resources.getSystem().getText(17040418).toString();
                    noService2 = true;
                } else {
                    plmn4 = Resources.getSystem().getText(17040029).toString();
                ...
                showPlmn2 = true;
                plmn2 = Resources.getSystem().getText(17040418).toString();
            ...
            String plmn7 = onsDispalyParams3.mPlmn;
            showPlmn = onsDispalyParams3.mShowPlmn;
            showWifi = onsDispalyParams3.mShowWifi;
            wifi = onsDispalyParams3.mWifi;
            log("updateSpnDisplay: cdma rawPlmn = " + plmn7);
            if (!TextUtils.isEmpty(plmn7)) {
                TextUtils.isEmpty(wfcVoiceSpnFormat);
            }
            if (!display_blank_ons || (plmn7 == null && this.mSS.getState() != 0)) {
                plmn = plmn7;
            } else {
                log("In service , display blank ons for tracfone");
                plmn = " ";
            ...
            if (combinedRegState == 1) {
                plmn = Resources.getSystem().getText(17040418).toString();
    ...
    /* JADX INFO: Multiple debug info for r1v31 int: [D('hasRegistered' boolean), D('transport' int)] */
    /* JADX WARNING: Code restructure failed: missing block: B:193:0x039a, code lost:
        if (r43.mNewSS.getRilDataRadioTechnology() == 13) goto L_0x039f;
     */
    private void pollStateDone() {
        ...
        boolean hasOperatorNumericChanged2 = false;
        if (this.mNewSS.getOperatorNumeric() != null) {
            hasOperatorNumericChanged2 = !this.mNewSS.getOperatorNumeric().equals(this.mSS.getOperatorNumeric());
        }
        boolean hasNrFrequencyRangeChanged = this.mSS.getNrFrequencyRange() != this.mNewSS.getNrFrequencyRange();
        boolean hasNrStateChanged = isNrStateChanged(this.mSS.getNetworkRegistrationInfoHw(2, 3), this.mNewSS.getNetworkRegistrationInfoHw(2, 3));
        ...
        boolean hasMultiApnSupport2 = false;
        if (this.mPhone.isPhoneTypeCdmaLte()) {
            ...
            if (!ServiceState.isLte(this.mSS.getRilDataRadioTechnology()) && this.mSS.getRilDataRadioTechnology() != 13) {
                ...
                hasMultiApnSupport2 = hasMultiApnSupport;
            }
        ...
        while (i3 < length2) {
            ...
            i3++;
            length2 = length2;
            availableTransports2 = iArr2;
            hasDataRoamingOff2 = hasDataRoamingOff;
        }
        log("pollStateDone: hasRegistered = " + hasRegistered + " hasDeregistered = " + hasDeregistered2 + " hasDataAttached = " + hasDataAttached + " hasDataDetached = " + hasDataDetached + " hasDataRegStateChanged = " + hasDataRegStateChanged + " hasRilVoiceRadioTechnologyChanged = " + hasRilVoiceRadioTechnologyChanged + " hasRilDataRadioTechnologyChanged = " + hasRilDataRadioTechnologyChanged + " hasChanged = " + hasChanged + " hasVoiceRoamingOn = " + hasVoiceRoamingOn2 + " hasVoiceRoamingOff = " + hasVoiceRoamingOff2 + " hasDataRoamingOn =" + hasDataRoamingOn2 + " hasDataRoamingOff = " + hasDataRoamingOff2 + " hasLocationChanged = " + hasLocationChanged + " has4gHandoff = " + has4gHandoff + " hasMultiApnSupport = " + hasMultiApnSupport2 + " hasLostMultiApnSupport = " + hasLostMultiApnSupport + " hasCssIndicatorChanged = " + hasCssIndicatorChanged + " hasNrFrequencyRangeChanged = " + hasNrFrequencyRangeChanged + " hasNrStateChanged = " + hasNrStateChanged + " hasAirplaneModeOnlChanged = " + hasAirplaneModeOnChanged + " hasOperatorNumericChanged" + hasOperatorNumericChanged2);
        ...
        if (hasRegistered || hasOperatorNumericChanged2) {
            ...
            if (CLEAR_NITZ_WHEN_REG) {
                hasOperatorNumericChanged = hasOperatorNumericChanged2;
        ...
        if (this.mPhone.isPhoneTypeCdma()) {
            ...
            if (!((this.mUiccController.getUiccCard(getPhoneId()) == null || this.mUiccController.getUiccCard(getPhoneId()).getOperatorBrandOverride() == null) ? false : true) && this.mCi.getRadioState() == 1 && this.mEriManager.isEriFileLoaded() && ((!ServiceState.isLte(this.mSS.getRilVoiceRadioTechnology()) || this.mPhone.getContext().getResources().getBoolean(17891336)) && !this.mIsSubscriptionFromRuim)) {
                ...
                if (this.mSS.getVoiceRegState() == 0) {
                    ...
                    eriText = this.mPhone.getContext().getText(17041155).toString();
                }
            }
            UiccCardApplication uiccCardApplication = this.mUiccApplcation;
    ...
    private int selectResourceForRejectCode(int rejCode, boolean multipleSubscriptions) {
        ...
        if (rejCode == 1) {
            if (multipleSubscriptions) {
                rejResourceId = 17040609;
            } else {
                rejResourceId = 17040608;
            }
            return rejResourceId;
        } else if (rejCode == 2) {
            if (multipleSubscriptions) {
                rejResourceId2 = 17040615;
            } else {
                rejResourceId2 = 17040614;
            }
            return rejResourceId2;
        } else if (rejCode == 3) {
            if (multipleSubscriptions) {
                rejResourceId3 = 17040613;
            } else {
                rejResourceId3 = 17040612;
            }
            ...
            if (multipleSubscriptions) {
                rejResourceId4 = 17040611;
            } else {
                rejResourceId4 = 17040610;
            }

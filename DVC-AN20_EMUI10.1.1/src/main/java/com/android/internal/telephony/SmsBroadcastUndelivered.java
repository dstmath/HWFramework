...
public class SmsBroadcastUndelivered {
    ...
    /* JADX INFO: Multiple debug info for r1v9 'phoneId'  int: [D('contentResolver' android.content.ContentResolver), D('phoneId' int)] */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v1, resolved type: com.android.internal.telephony.cdma.CdmaInboundSmsHandler */
    /* JADX DEBUG: Multi-variable search result rejected for r0v2, resolved type: com.android.internal.telephony.cdma.CdmaInboundSmsHandler */
    /* JADX DEBUG: Multi-variable search result rejected for r0v3, resolved type: com.android.internal.telephony.cdma.CdmaInboundSmsHandler */

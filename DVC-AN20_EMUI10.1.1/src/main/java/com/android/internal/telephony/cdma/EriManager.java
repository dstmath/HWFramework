...
public class EriManager {
    ...
    private EriDisplayInformation getEriDisplayInformation(int roamInd, int defRoamInd) {
        ...
        switch (roamInd) {
            case 0:
                return new EriDisplayInformation(0, 0, this.mContext.getText(17041142).toString());
            case 1:
                return new EriDisplayInformation(1, 0, this.mContext.getText(17041143).toString());
            case 2:
                return new EriDisplayInformation(2, 1, this.mContext.getText(17041147).toString());
            case 3:
            ...
            case 5:
                return new EriDisplayInformation(roamInd, 0, this.mContext.getText(17041150).toString());
            case 6:
            ...
            case 10:
                return new EriDisplayInformation(roamInd, 0, this.mContext.getText(17041144).toString());
            case 11:
                return new EriDisplayInformation(roamInd, 0, this.mContext.getText(17041145).toString());
            case 12:
                return new EriDisplayInformation(roamInd, 0, this.mContext.getText(17041146).toString());
            default:

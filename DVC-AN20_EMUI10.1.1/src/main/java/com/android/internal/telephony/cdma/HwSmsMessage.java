...
public class HwSmsMessage {
    ...
    private static SmsMessageEx.SubmitPduEx privateGetSubmitDeliverPdu(boolean isSubmitPdu, String origAddrStr, String mcTimestamp, UserDataEx userData) {
        ...
        if (PLUS_TRANFER_IN_AP) {
            CdmaSmsAddressEx destAddr2 = SmsMessageEx.parseAddrForSMSMO(origAddrStr);
            if (destAddr2 == null) {
        ...
        if (isSubmitPdu) {
            ...
            try {
                ...
                RlogEx.i(LOG_TAG, "msgTimeStamp set error ");
                msgTimeStamp.set(0);
            }
        ...
        try {
            ...
            while (i < length) {
                ...
                RlogEx.e(LOG_TAG, "pdu is" + ((int) content));
                i++;
                outputLen = outputLen;
            }
            ...
            RlogEx.e(LOG_TAG, "creating SubmitPdu failed: " + ex);
            return null;
        }
    }
    ...
    public static int getCdmaSub() {
        if (HwTelephonyManagerInner.getDefault().isFullNetworkSupported()) {
            ...
            for (int i = 0; i < phoneCount; i++) {
                ...
                if (2 == TelephonyManagerEx.getCurrentPhoneType(cdmaSubId) && 5 == TelephonyManagerEx.getDefault().getSimState(i)) {

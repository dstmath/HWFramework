...
public final class BearerData {
    ...
    private static void encodeEmsUserDataPayload(UserData uData) throws CodingException {
        ...
        if (headerData == null) {
            ...
            try {
                UserDataEx userDataEx = new UserDataEx();
                userDataEx.setUserData(uData);
                if (!HwFrameworkFactory.getHwBaseInnerSmsManager().encode7bitMultiSms(userDataEx, headerData, false)) {
            ...
            UserDataEx userDataEx2 = new UserDataEx();
            userDataEx2.setUserData(uData);
            HwFrameworkFactory.getHwBaseInnerSmsManager().encode7bitMultiSms(userDataEx2, headerData, true);
    ...
    public static byte[] encode(BearerData bData) {
        ...
        try {
            ...
            BearerDataEx bearerDataEx = new BearerDataEx();
            bearerDataEx.setBearerData(bData);
            try {
                BitwiseOutputStreamEx outStreamEx = new BitwiseOutputStreamEx();
                outStreamEx.setBitwiseOutputStream(outStream);
                HwFrameworkFactory.getHwBaseInnerSmsManager().encodeMsgCenterTimeStampCheck(bearerDataEx, outStreamEx);
                return outStream.toByteArray();
            } catch (BitwiseOutputStreamEx.AccessExceptionEx e) {
                throw new BitwiseOutputStream.AccessException("AccessException");
            }
        } catch (BitwiseOutputStream.AccessException ex) {
    ...
    public static byte[] encode7bitAsciiHw(String msg, int septetOffset, boolean force) throws CodingException {
        return encode7bitAscii(msg, septetOffset, force);
    }

    private static byte[] encode7bitAscii(String msg, int septetOffset, boolean force) throws CodingException {
        try {

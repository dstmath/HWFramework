...
public class EuiccConnector extends StateMachine implements ServiceConnection, IHwEuiccConnectorInner {
                ...
                try {
                    switch (message.what) {
                        ...
                        case 102:
                            ...
                            break;
                        case EuiccConnector.CMD_GET_EUICC_PROFILE_INFO_LIST /*{ENCODED_INT: 103}*/:
    ...
    public static BaseEuiccCommandCallback getCallback(Message message) {
        switch (message.what) {
            case 100:
            case CMD_GET_EUICC_PROFILE_INFO_LIST /*{ENCODED_INT: 103}*/:
            case 105:
            case 109:
            ...
            default:
                return HwTelephonyFactory.getHwUiccManager().getEuiccConnectorCallback(message);
        }
    }

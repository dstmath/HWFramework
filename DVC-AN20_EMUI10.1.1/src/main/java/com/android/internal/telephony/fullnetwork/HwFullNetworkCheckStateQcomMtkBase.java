...
public abstract class HwFullNetworkCheckStateQcomMtkBase extends HwFullNetworkCheckStateBase {
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            case HwFullNetworkConstantsInner.EVENT_GET_PREF_NETWORK_DONE:
                int subId = msg.arg1;
    ...
    public boolean processSimStateChanged() {
        ...
        if (isSetDefault4GNeed) {
            ...
            if (this.mChipCommon.isSet4GSlotInProgress) {
                ...
                this.mCheckStateHandler.obtainMessage(HwFullNetworkConstantsInner.EVENT_SET_MAIN_SLOT, new4GSlotId, 0).sendToTarget();
            }
        } else {

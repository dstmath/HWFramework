...
public class HwFullNetworkInitStateQcomMtkBase extends HwFullNetworkInitStateBase {
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            case HwFullNetworkConstantsInner.EVENT_SIM_HOTPLUG:
                ...
                return;
            case HwFullNetworkConstantsInner.EVENT_RADIO_ON_PROCESS_SIM_STATE:
    ...
    private void processSubInfoRecordUpdated(Intent intent) {
        ...
        if (status != -1) {
            if (4 != status) {
                ...
                this.mStateHandler.obtainMessage(HwFullNetworkConstantsInner.EVENT_CHECK_MAIN_SLOT, status, 0, "android.intent.action.ACTION_SUBINFO_RECORD_UPDATED").sendToTarget();
                return;
            }
    ...
    private void processSimStateChanged(String simState, int slotId) {
        ...
        this.mStateHandler.obtainMessage(HwFullNetworkConstantsInner.EVENT_CHECK_MAIN_SLOT, "android.intent.action.SIM_STATE_CHANGED").sendToTarget();
    }

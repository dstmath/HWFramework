...
public class GsmCellBroadcastHandler extends CellBroadcastHandler {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:19:0x0068 A[Catch:{ RuntimeException -> 0x00fd }] */
    /* JADX WARNING: Removed duplicated region for block: B:30:0x009e A[Catch:{ RuntimeException -> 0x00fd }] */
    /* JADX WARNING: Removed duplicated region for block: B:34:0x00b4 A[Catch:{ RuntimeException -> 0x00fd }] */
    /* JADX WARNING: Removed duplicated region for block: B:40:0x00d7 A[Catch:{ RuntimeException -> 0x00fd }] */
    /* JADX WARNING: Removed duplicated region for block: B:41:0x00da A[Catch:{ RuntimeException -> 0x00fd }] */
    /* JADX WARNING: Removed duplicated region for block: B:44:0x00f0 A[Catch:{ RuntimeException -> 0x00fd }] */
    /* JADX WARNING: Removed duplicated region for block: B:46:0x00f7 A[Catch:{ RuntimeException -> 0x00fd }] */

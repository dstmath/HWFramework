...
public class ImsPhone extends ImsPhoneBase {
    ...
    @Override // com.android.internal.telephony.PhoneInternalInterface, com.android.internal.telephony.AbstractPhoneBase, com.android.internal.telephony.imsphone.ImsPhoneBase, com.android.internal.telephony.AbstractPhoneInternalInterface
    ...
    public void setServiceState(int state) {
        ...
        Rlog.i(LOG_TAG, "hasChange:" + hasChange + " mOldSS=" + this.mOldSS + " mSS=" + this.mSS);
        if (hasChange) {
    ...
    @Override // com.android.internal.telephony.AbstractPhoneBase, com.android.internal.telephony.Phone
    ...
    private void updateDataServiceState() {
        if (!(this.mSS == null || this.mDefaultPhone.getServiceStateTracker() == null || this.mDefaultPhone.getServiceStateTracker().mSS == null)) {
            ...
            logi("updateDataServiceState: defSs = " + ss + " imsSs = " + this.mSS);
        }
    }
    ...
    private void processWfcDisconnectForNotification(ImsReasonInfo imsReasonInfo) {
        ...
        if (wfcOperatorErrorCodes != null) {
            String[] wfcOperatorErrorAlertMessages = this.mContext.getResources().getStringArray(17236117);
            String[] wfcOperatorErrorNotificationMessages = this.mContext.getResources().getStringArray(17236118);
            int i = 0;
            while (i < wfcOperatorErrorCodes.length) {
                ...
                if (codes.length != 2) {
                    ...
                    if (!Character.isLetterOrDigit(codes[0].charAt(codeStringLength - 1)) || imsReasonInfo.mExtraMessage.length() <= codeStringLength || !Character.isLetterOrDigit(imsReasonInfo.mExtraMessage.charAt(codeStringLength))) {
                        CharSequence title = this.mContext.getText(17041483);
                        int idx = -1;
                        try {

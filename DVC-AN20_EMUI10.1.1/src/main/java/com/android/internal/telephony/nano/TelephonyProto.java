            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 16:
                        ...
                        break;
                    case RilErrno.RIL_E_USSD_MODIFIED_TO_USSD /*{ENCODED_INT: 24}*/:
                    ...
                    if (tag == 8) {
                        ...
                        if (!(value == 8 || value == 14 || value == 48 || value == 81 || value == 65535 || value == 65 || value == 66 || value == 127 || value == 128)) {
                            switch (value) {
                                ...
                                case RilDataCallFailCause.PDP_FAIL_TETHERED_CALL_ACTIVE /*{ENCODED_INT: -6}*/:
                                case RilDataCallFailCause.PDP_FAIL_RADIO_POWER_OFF /*{ENCODED_INT: -5}*/:
                                case RilDataCallFailCause.PDP_FAIL_PREF_RADIO_TECH_CHANGED /*{ENCODED_INT: -4}*/:
                                case RilDataCallFailCause.PDP_FAIL_SIGNAL_LOST /*{ENCODED_INT: -3}*/:
                                case -2:
                                case -1:
                                case 0:
                                case 1:
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 96:
                        ...
                        break;
                    case AbstractPhoneBase.EVENT_ECC_NUM:
                        int arrayLength3 = WireFormatNano.getRepeatedFieldArrayLength(input, AbstractPhoneBase.EVENT_ECC_NUM);
                        long[] jArr3 = this.timeInRatMs;

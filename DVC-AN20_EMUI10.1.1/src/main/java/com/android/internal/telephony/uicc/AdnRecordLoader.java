...
public class AdnRecordLoader extends Handler implements IHwAdnRecordLoaderInner {
    ...
    AdnRecordLoader(IccFileHandler fh) {
        ...
        this.mFh = fh;
        this.mIHwAdnRecordLoaderEx = HwTelephonyFactory.getHwUiccManager().createHwAdnRecordLoaderEx(this, fh);
    }
    ...
    @Override // com.android.internal.telephony.uicc.IHwAdnRecordLoaderInner

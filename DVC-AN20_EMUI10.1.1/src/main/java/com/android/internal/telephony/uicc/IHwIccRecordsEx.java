...
public interface IHwIccRecordsEx {
    ...
    default ArrayList<OperatorInfo> getEonsForAvailableNetworks(ArrayList<OperatorInfo> arrayList) {
        return null;
    }
    ...
    default boolean checkFileInServiceTable(int efid, UsimServiceTable usimServiceTable, byte[] data) {
        return false;
    }

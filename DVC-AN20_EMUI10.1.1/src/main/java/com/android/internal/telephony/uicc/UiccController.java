...
public class UiccController extends Handler implements IUiccControllerInner {
    ...
    public void onRefresh(int slotId, int[] fileList) {
        ...
        if (fileChanged && isValidPhoneIndex(slotId) && getUiccCardForPhone(slotId) != null && getUiccCardForPhone(slotId).getApplicationIndex(slotId) != null && (iccRecords = getUiccCardForPhone(slotId).getApplicationIndex(slotId).getIccRecords()) != null) {

...
public class VoicemailNotificationSettingsUtil {
    ...
    public static void setRingtoneUri(Context context, Uri ringtoneUri) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        String ringtoneUriStr = ringtoneUri != null ? ringtoneUri.toString() : PhoneConfigurationManager.SSSS;
    ...
    public static Uri getRingTonePreference(Context context) {
        ...
        String uriString = prefs.getString(getVoicemailRingtoneSharedPrefsKey(), Settings.System.DEFAULT_NOTIFICATION_URI.toString());

...
public class HwVSimSlotSwitchController extends StateMachineEx {
    ...
    private static final boolean IS_HISI_CDMA_SUPPORTED = SystemPropertiesEx.getBoolean(PROPERTY_HISI_CDMA_SUPPORTED, false);
    ...
    public enum CommrilMode {
        ...
        public static boolean isCLGMode(CommrilMode mode, int[] cardType, int mainSlot) {
            ...
            if (!HwVSimSlotSwitchController.IS_HISI_CDMA_SUPPORTED) {
                ...
                return cardType[mainSlot] == 2 || cardType[mainSlot] == 3;
            }
        }
        ...
        public static boolean isULGMode(CommrilMode mode, int[] cardType, int mainSlot) {
            ...
            if (!HwVSimSlotSwitchController.IS_HISI_CDMA_SUPPORTED) {
                ...
                return cardType[mainSlot] == 1 || cardType[mainSlot] == 0;
            } else {
                return false;
            }
        }
        ...
        public static boolean isCGMode(CommrilMode mode, int[] cardType, int mainSlot) {
            if (HwVSimSlotSwitchController.IS_SUPPORT_FULL_NETWORK || HwVSimUtilsInner.isChinaTelecom()) {
                return HwVSimSlotSwitchController.IS_HISI_CDMA_SUPPORTED ? mode == HISI_CG_MODE : mode == CG_MODE;
            }
            return false;
        }
    }
    ...
    private HwVSimSlotSwitchController(Context c, CommandsInterfaceEx vsimCi, CommandsInterfaceEx[] cis) {
        ...
        HwVSimLog.VSimLogI(LOG_TAG, "IS_SUPPORT_FULL_NETWORK: " + IS_SUPPORT_FULL_NETWORK);
        HwVSimLog.VSimLogI(LOG_TAG, "IS_HISI_CDMA_SUPPORTED: " + IS_HISI_CDMA_SUPPORTED);
    ...
    private class InitialState extends StateEx {
        ...
        private void onGetSimStateDone(Message msg) {
            ...
            if (ar == null) {
                ...
                if (HwVSimSlotSwitchController.this.mMainSlot == 0) {
                    slaveSlot = 1;
                } else {
                    slaveSlot = 0;
                }
        ...
        private void onSetSimStateDone(Message msg) {
            ...
            HwVSimSlotSwitchController.this.mCis[balongSlot].setSimState(1, 1, (Message) null);
            checkSimModeDone();
        }
    }
    ...
    public CommrilMode getExpectCommrilMode(int mainSlot, int[] cardType) {
        ...
        int slaveSlot = mainSlot == 0 ? (char) 1 : 0;

...
public interface MessagingMessage extends MessagingLinearLayout.MessagingChild {
    ...
    static default MessagingMessage createMessage(MessagingLayout layout, Notification.MessagingStyle.Message m, ImageResolver resolver) {
    ...
    static default void dropCache() {
        MessagingTextMessage.dropCache();
        MessagingImageMessage.dropCache();
    }

    static default boolean hasImage(Notification.MessagingStyle.Message m) {

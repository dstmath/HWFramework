            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 10:
                        ...
                        return true;
                    case TRANSACTION_setVolume /*{ENCODED_INT: 11}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean volume = setVolume(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(volume ? 1 : 0);
                        return true;
                    case TRANSACTION_startScanDevice /*{ENCODED_INT: 12}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _arg08 = data.readInt();
                        if (data.readInt() != 0) {
                            _arg12 = true;
                        }
                        boolean startScanDevice = startScanDevice(_arg08, _arg12);
                        reply.writeNoException();
                    ...
                    case 13:
                        ...
                        boolean stopScanDevice = stopScanDevice(_arg09, _arg13);
                        reply.writeNoException();
                        reply.writeInt(stopScanDevice ? 1 : 0);
                        return true;
                    case TRANSACTION_connectDevice /*{ENCODED_INT: 14}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_disconnectDevice /*{ENCODED_INT: 15}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_getTargetProjectionDevice /*{ENCODED_INT: 23}*/:
                        ...
                        return true;
                    case TRANSACTION_getHiSightServerPort /*{ENCODED_INT: 24}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result6 = getHiSightServerPort();
                        reply.writeNoException();
                        reply.writeInt(_result6);
                        return true;
                    case TRANSACTION_appendHiSightExInfo /*{ENCODED_INT: 25}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 32:
                        ...
                        return true;
                    case TRANSACTION_castPlay /*{ENCODED_INT: 33}*/:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        return true;
                    case TRANSACTION_registerMediaPlayerListener /*{ENCODED_INT: 34}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_updatePlayInfo /*{ENCODED_INT: 36}*/:
                        ...
                        return true;
                    case TRANSACTION_previous /*{ENCODED_INT: 37}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean previous = previous();
                        reply.writeNoException();
                        reply.writeInt(previous ? 1 : 0);
                        return true;
                    case TRANSACTION_next /*{ENCODED_INT: 38}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean next = next();
                        reply.writeNoException();
                    ...
                    case TRANSACTION_showProjectionActivity /*{ENCODED_INT: 42}*/:
                        ...
                        return true;
                    case TRANSACTION_seekTo /*{ENCODED_INT: 43}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean seekTo = seekTo(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(seekTo ? 1 : 0);
                        return true;
                    case TRANSACTION_setVolumeMute /*{ENCODED_INT: 44}*/:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg07 = true;
                        }

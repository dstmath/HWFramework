...
public class ActionBarEx {
    ...
    private static HwToolbar getToolbar(ActionBar actionBar) {
        Object object;
        if ((actionBar instanceof WindowDecorActionBar) && (object = ReflectUtil.getObject(actionBar, "mActivity", WindowDecorActionBar.class)) != null && (object instanceof Activity)) {
            View toolbar = ((Activity) object).getWindow().getDecorView().findViewById(16908711);
    ...
    private static HwActionBarContextView getHwActionBarContextView(ActionBar actionBar) {
        Object object;
        if ((actionBar instanceof WindowDecorActionBar) && (object = ReflectUtil.getObject(actionBar, "mActivity", WindowDecorActionBar.class)) != null && (object instanceof Activity)) {
            View contextView = ((Activity) object).getWindow().getDecorView().findViewById(16908716);

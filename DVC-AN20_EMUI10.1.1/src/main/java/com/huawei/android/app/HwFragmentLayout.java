...
public class HwFragmentLayout extends RelativeLayout implements View.OnTouchListener, HwFragmentFrameLayout.HwFragmentFrameLayoutCallback {
    ...
    public HwFragmentLayout(Context context) {
        ...
        this.mHandler = new Handler() {
            /* class com.huawei.android.app.HwFragmentLayout.AnonymousClass3 */
    ...
    private void init(Context context, float displayRate, boolean canMove) {
        ...
        if (this.mRightIn == null) {
            ...
            this.mRightIn.setAnimationListener(new Animation.AnimationListener() {
                /* class com.huawei.android.app.HwFragmentLayout.AnonymousClass1 */
        ...
        if (this.mRightOut == null) {
            ...
            this.mRightOut.setAnimationListener(new Animation.AnimationListener() {
                /* class com.huawei.android.app.HwFragmentLayout.AnonymousClass2 */
    ...
    private void setSplitBtnParams(int y) {
        ...
        } else if ((y - iArr[1]) + (i / 2) > getHeight()) {
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() {
            /* class com.huawei.android.app.HwFragmentLayout.SavedState.AnonymousClass1 */
    ...
    public int calculateColumnsNumber(int orientation, int appWidth) {
        ...
        if (i == 2) {
            if (orientation != 2 || appWidth < dip2px(this.mContext, 592.0f)) {
                return 1;
            }
            return 2;
            ...
            } else if (orientation != 2 || appWidth < dip2px(this.mContext, 592.0f)) {
                return 1;
            } else {
                return 2;
            }
    ...
    public void setSelectContainerByTouch(boolean enabled) {
        ...
        if (hwFragmentFrameLayout != null) {
            hwFragmentFrameLayout.setSelectContainerByTouch(enabled);
        }
        HwFragmentFrameLayout hwFragmentFrameLayout2 = this.mRightContent;
        if (hwFragmentFrameLayout2 != null) {
            hwFragmentFrameLayout2.setSelectContainerByTouch(enabled);
        }
    }

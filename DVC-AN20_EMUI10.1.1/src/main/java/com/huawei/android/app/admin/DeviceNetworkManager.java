...
public class DeviceNetworkManager {
    ...
    public boolean addNetworkList(ComponentName admin, boolean isWhiteList, boolean isDomainList, ArrayList<String> addrList) {
        Bundle bundle = new Bundle();
        String listType = getNetworkAccessListType(isWhiteList, isDomainList);
        bundle.putStringArrayList("value", addrList);
        return this.mDpm.setPolicy(admin, listType, bundle);
    }

    public List<String> getNetworkList(ComponentName admin, boolean isWhiteList, boolean isDomainList) {
        Bundle bundle = this.mDpm.getPolicy(admin, getNetworkAccessListType(isWhiteList, isDomainList));
        ArrayList<String> lists = new ArrayList<>();
        if (bundle != null) {
            return bundle.getStringArrayList("value");
        }
    ...
    public boolean removeNetworkList(ComponentName admin, boolean isWhiteList, boolean isDomainList, ArrayList<String> addrList) {
        Bundle bundle = new Bundle();
        String listType = getNetworkAccessListType(isWhiteList, isDomainList);
        bundle.putStringArrayList("value", addrList);
    ...
    public List<String> queryBrowsingHistory(ComponentName admin) {
        Bundle bundle = this.mDpm.getCustomPolicy(admin, "queryBrowsingHistory", (Bundle) null);
        ArrayList<String> lists = new ArrayList<>();
        if (bundle != null) {
            return bundle.getStringArrayList("value");
        }

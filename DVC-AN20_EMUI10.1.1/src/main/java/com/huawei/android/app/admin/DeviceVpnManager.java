...
public class DeviceVpnManager {
    ...
    public boolean isVpnDisabled(ComponentName admin) {
        ...
        if (bundle != null) {
            ...
            Log.d(TAG, "isVpnDisabled: " + allow2);
    ...
    public boolean setShowVpnPasswordDisabled(ComponentName admin, boolean disabled) {
        Bundle bundle = new Bundle();
    ...
    public List<String> getVpnList(ComponentName admin) {
        ...
        Bundle vpnListBundle = this.mDpm.getCustomPolicy(admin, CONFIG_VPN, (Bundle) null);
    ...
    public boolean isInsecureVpnDisabled(ComponentName admin) {
        ...
        if (bundle != null) {
            Boolean disabled2 = Boolean.valueOf(bundle.getBoolean("value"));
            Log.d(TAG, "isInsecureVpnDisabled: " + disabled2);
            return disabled2.booleanValue();
        }

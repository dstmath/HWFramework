...
public class HwDialogStubImpl implements HwWidgetFactory.HwDialogStub {
    ...
    private ViewTreeObserver.OnGlobalLayoutListener mOnGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
        ...
        private int getScreenHeight() {
            ...
            this.screenHeight = res.getDisplayMetrics().heightPixels - res.getDimensionPixelSize(17105443);
    ...
    private void setState(View view, int direction) {
        ...
        if (context != null) {
            ...
            int offset = (((res.getDisplayMetrics().heightPixels - res.getDimensionPixelSize(17105443)) - (view != null ? view.getHeight() : 0)) / 2) - ((int) ((res.getDisplayMetrics().density * 36.0f) + 0.5f));

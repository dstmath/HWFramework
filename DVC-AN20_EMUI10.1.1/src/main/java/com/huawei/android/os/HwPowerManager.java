...
public class HwPowerManager {
    ...
    public static void setMirrorLinkPowerStatus(boolean status) {
        try {
            getService().setMirrorLinkPowerStatus(status);
        } catch (RemoteException e) {
    ...
    public static void stopWakeUpReady(Context context, long eventTime, boolean enableBright) {
        try {
            getService().stopWakeUpReady(eventTime, enableBright, context.getOpPackageName());
        } catch (RemoteException e) {
    ...
    public static void setBiometricDetectState(int state) {
        try {
            ...
            Log.e(TAG, "setBiometricDetectState RemoteException!");
        }
    }

    public static int setAodBrightness(int brightness) {
        try {
            return getService().setAodBrightness(brightness);
        } catch (RemoteException e) {
            Log.e(TAG, "setAodBrightness RemoteException!");
            return -1;
        }
    }
}

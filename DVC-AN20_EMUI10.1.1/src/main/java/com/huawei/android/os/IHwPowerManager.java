            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 4:
                        ...
                        setMirrorLinkPowerStatus(_arg02);
                        reply.writeNoException();
                        return true;
                    case 5:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 6:
                        ...
                        stopWakeUpReady(_arg03, _arg12, data.readString());
                        reply.writeNoException();
                        return true;
                    case 7:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 17:
                        ...
                        int _result6 = setHwBrightnessData(_arg04, _arg1);
                        reply.writeNoException();
                    ...
                    case 18:
                        ...
                        int _result7 = getHwBrightnessData(_arg05, _arg13);
                        reply.writeNoException();

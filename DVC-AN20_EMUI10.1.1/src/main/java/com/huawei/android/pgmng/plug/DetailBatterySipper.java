...
public class DetailBatterySipper implements Comparable<DetailBatterySipper>, Parcelable {
    ...
    private void appendDetailInfo(StringBuilder sb) {
        ...
        if ((this.mBgCpuTime + this.mFgCpuTime) / 1000 > 0) {
            sb.append("    |---Cpu:");
            sb.append(String.format("\tpower: (total %.1f", Float.valueOf(this.mBgCpuPower + this.mFgCpuPower)));
            sb.append(String.format(", bg %.1f", Float.valueOf(this.mBgCpuPower)));
            sb.append(String.format(", fg %.1f)", Float.valueOf(this.mFgCpuPower)));
        ...
        if (this.mFgScreenPower > 0.0f) {
            sb.append("    |---Screen:");
            sb.append(String.format("\t%.1f\t", Float.valueOf(this.mFgScreenPower)));
            str = ", fg %.1f)";
        ...
        if (this.mBgGpsPower + this.mFgGpsPower > 0.0f) {
            sb.append("    |---Gps:");
            sb.append(String.format("\tpower: (total %.2f", Float.valueOf(this.mBgGpsPower + this.mFgGpsPower)));
            sb.append(String.format(", bg %.2f", Float.valueOf(this.mBgGpsPower)));
            sb.append(String.format(", fg %.2f)", Float.valueOf(this.mFgGpsPower)));
            sb.append("\ttime: (total ");
        ...
        if (this.mBgSensorPower + this.mFgSensorPower > 0.0f) {
            sb.append("    |---Sensor:");
            sb.append(String.format("\tpower: (total %.3f", Float.valueOf(this.mBgSensorPower + this.mFgSensorPower)));
            sb.append(String.format(", bg %.3f", Float.valueOf(this.mBgSensorPower)));
            sb.append(String.format(", fg %.3f)", Float.valueOf(this.mFgSensorPower)));
            sb.append("\ttime: (total ");
        ...
        if (this.mBgWlTime / 1000 > 0) {
            sb.append("    |---WakeLock:");
            sb.append(String.format("\t%.1f", Float.valueOf(this.mBgWlPower)));
            sb.append('\t');
            str2 = ", bg %.1f";
        ...
        if (this.mFgGpuTime / 1000 > 0) {
            sb.append("    |---Gpu:");
            sb.append(String.format("\t%.1f", Float.valueOf(this.mFgGpuPower)));
            sb.append('\t');
        ...
        if (mobileTime / 1000 > 0) {
            sb.append("    |---Mobile:");
            sb.append(String.format("\tpower: (total %.1f", Float.valueOf(this.mBgMobileTxPower + this.mBgMobileRxPower + this.mFgMobileTxPower + this.mFgMobileRxPower)));
            sb.append(String.format(", bgTx %.1f", Float.valueOf(this.mBgMobileTxPower)));
            sb.append(String.format(", bgRx %.1f", Float.valueOf(this.mBgMobileRxPower)));
            sb.append(String.format(", fgTx %.1f", Float.valueOf(this.mFgMobileTxPower)));
            sb.append(String.format(", fgRx %.1f)", Float.valueOf(this.mFgMobileRxPower)));
            sb.append("\ttime: (total ");
        ...
        if (wifiPower > 0.0f) {
            sb.append("    |---Wifi:");
            sb.append(String.format("\tactivePower: (total %.1f", Float.valueOf(wifiPower)));
            sb.append(String.format(", bgTx %.1f", Float.valueOf(this.mBgWifiTxPower)));
            sb.append(String.format(", bgRx %.1f", Float.valueOf(this.mBgWifiRxPower)));
            sb.append(String.format(", fgTx %.1f", Float.valueOf(this.mFgWifiTxPower)));
            sb.append(String.format(", fgRx %.1f)", Float.valueOf(this.mFgWifiRxPower)));
            sb.append("\twifi bg: (");
            sb.append(this.mWifiEntry[0]);
            sb.append("\twifi fg: ");
            sb.append(this.mWifiEntry[1]);
            sb.append(String.format(")\tScanPower: (total %.1f", Float.valueOf(this.mBgWifiScanPower + this.mFgWifiScanPower)));
            sb.append(String.format(str2, Float.valueOf(this.mBgWifiScanPower)));
            sb.append(String.format(str, Float.valueOf(this.mFgWifiScanPower)));
    ...
    public String toString() {
        ...
        sb.append('\t');
        sb.append(this.mUid);
        sb.append(String.format("\ttotal: %.1f", Float.valueOf(allPower)));
        sb.append(String.format("\tbg: %.1f", Float.valueOf(this.mBgTotalPower)));
        sb.append(String.format("\tfg: %.1f", Float.valueOf(this.mFgTotalPower)));
        sb.append(String.format("\tdis: %.1f\n", Float.valueOf(this.mDistributedPower)));
        appendDetailInfo(sb);
        return sb.toString();
    }
    ...
    public String toString(float totalPower, boolean verbose) {
        ...
        sb.append(String.format("\tbg: %.1f", Float.valueOf(this.mBgTotalPower)));
        sb.append(String.format("\tfg: %.1f", Float.valueOf(this.mFgTotalPower)));
        sb.append(String.format("\tdis: %.1f", Float.valueOf(this.mDistributedPower)));
        Object[] objArr = new Object[1];
        if (totalPower > 0.0f) {
            f = (allPower / totalPower) * 100.0f;
        }
        objArr[0] = Float.valueOf(f);
        sb.append(String.format("\tratio: %.1f%%\n", objArr));
        if (!verbose) {
            return sb.toString();
        }
        appendDetailInfo(sb);
    ...
    public static class NetEntry {
        ...
        public NetEntry minus(NetEntry other) {
            ...
            for (int i = 0; i < 4; i++) {
                long[] jArr = entry.mItem;
                jArr[i] = this.mItem[i] - other.mItem[i];
                if (jArr[i] < 0) {
        ...
        private void processBytesUnit(StringBuilder sb, long bytes) {
            if (bytes > 1048576) {
                sb.append(String.format("%.2fMB", Double.valueOf(((((double) bytes) * 1.0d) / 1024.0d) / 1024.0d)));
            } else if (bytes > TraceEx.TRACE_TAG_CAMERA) {
                sb.append(String.format("%.2fKB", Double.valueOf((((double) bytes) * 1.0d) / 1024.0d)));
            } else {
                sb.append(bytes);
                sb.append("B");
            }

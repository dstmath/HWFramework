...
public class HwExtDisplaySizeUtil implements IHwExtDisplaySizeUtil {
    ...
    private static int[] SIDE_PARAMS;
    private static String TAG = "HwExtDisplaySizeUtil";
    private static HwExtDisplaySizeUtil mInstance;
    private static final String mNotchProp = SystemProperties.get("ro.config.hw_notch_size", BuildConfig.FLAVOR);
    private static final String mSideProp = SystemProperties.get("ro.config.hw_curved_side_disp", BuildConfig.FLAVOR);

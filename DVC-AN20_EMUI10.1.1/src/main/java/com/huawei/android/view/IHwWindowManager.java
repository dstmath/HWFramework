...
public interface IHwWindowManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHwWindowManager {
        ...
        static final int TRANSACTION_dragStartForMultiDisplay = 39;
        static final int TRANSACTION_dropStartForMultiDisplay = 42;
        ...
        static final int TRANSACTION_getDragSrcPkgName = 51;
        ...
        static final int TRANSACTION_getTopActivityAdaptNotchState = 57;
        ...
        static final int TRANSACTION_isAppNeedExpand = 50;
        static final int TRANSACTION_isFullScreenDevice = 1;
        static final int TRANSACTION_isNavigationBarVisible = 25;
        static final int TRANSACTION_isNeedExceptDisplaySide = 49;
        static final int TRANSACTION_isSwitched = 52;
        ...
        static final int TRANSACTION_registerDropListenerForMultiDisplay = 40;
        static final int TRANSACTION_registerHwMultiDisplayDragStateListener = 46;
        static final int TRANSACTION_registerIsDroppableForMultiDisplay = 43;
        static final int TRANSACTION_registerPhoneOperateListenerForHwMultiDisplay = 55;
        ...
        static final int TRANSACTION_restoreShadow = 53;
        static final int TRANSACTION_setAboveAppWindowsContainersVisible = 58;
        ...
        static final int TRANSACTION_setDroppableForMultiDisplay = 44;
        static final int TRANSACTION_setForcedDisplayDensityAndSize = 28;
        static final int TRANSACTION_setGestureNavMode = 27;
        static final int TRANSACTION_setOriginalDropPoint = 45;
        ...
        static final int TRANSACTION_unregisterDropListenerForMultiDisplay = 41;
        static final int TRANSACTION_unregisterHwMultiDisplayDragStateListener = 47;
        static final int TRANSACTION_unregisterPhoneOperateListenerForHwMultiDisplay = 56;
        static final int TRANSACTION_unregisterRotateObserver = 5;
        static final int TRANSACTION_updateAppView = 6;
        static final int TRANSACTION_updateDragState = 48;
        static final int TRANSACTION_updateFocusWindowFreezed = 54;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 16:
                        ...
                        getCurrFocusedWinInExtDisplay(_arg010);
                        reply.writeNoException();
                        reply.writeInt(1);
                    ...
                    case 33:
                        ...
                        boolean notifyDragAndDropForMultiDisplay = notifyDragAndDropForMultiDisplay(_arg011, _arg12, _arg22, _arg3);
                        reply.writeNoException();
                    ...
                    case 39:
                        ...
                        boolean dragStartForMultiDisplay = dragStartForMultiDisplay(_arg04);
                        reply.writeNoException();
                    ...
                    case 42:
                        ...
                        boolean dropStartForMultiDisplay = dropStartForMultiDisplay(_arg05);
                        reply.writeNoException();
                    ...
                    case 44:
                        ...
                        setDroppableForMultiDisplay(_arg012, _arg13, _arg2);
                        reply.writeNoException();
                        return true;
                    case 45:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 49:
                        data.enforceInterface(DESCRIPTOR);
                        Rect _arg013 = new Rect();
                        boolean isNeedExceptDisplaySide = isNeedExceptDisplaySide(_arg013);
                        reply.writeNoException();
                    ...
                    case 54:
                        ...
                        updateFocusWindowFreezed(_arg08);
                        reply.writeNoException();
                        return true;
                    case 55:
                        data.enforceInterface(DESCRIPTOR);

...
public final class DisplayEngineDataCleanerXMLLoader {
    ...
    public static class Data implements Cloneable {
        ...
        public void loadDefaultConfig() {
            ...
            this.ambientLightLUT = new ArrayList<>(Arrays.asList(0, 2, 5, 10, 15, 20, 30, 50, 70, 100, Integer.valueOf((int) TpCommandConstant.VOLUME_FLICK_THRESHOLD_MAX), Integer.valueOf((int) HwNetworkPolicyManager.TRANSCODE_SET_HWUIDPOLICY), 250, Integer.valueOf((int) AppTypeInfo.PG_TYPE_BASE), 350, 400, 500, 600, 700, 800, 900, 1000, 1200, 1400, 1800, 2400, 3000, 4000, 5000, 6000, 8000, 10000, 15000, 20000, 30000));

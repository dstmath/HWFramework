...
public class VirtualModemDevice {
    ...
    public static void eventHandle(ILocalVirtualDeviceObserver stateChangeCallback, DMSDPDeviceService service, int event) {
        ...
        switch (event) {
            case DMSDPConfig.EVENT_DEVICE_SERVICE_INVALID /*{ENCODED_INT: 220}*/:
                ...
                return;
            case DMSDPConfig.EVENT_DEVICE_SERVICE_READY /*{ENCODED_INT: 221}*/:
                ...
                return;
            case DMSDPConfig.EVENT_DEVICE_SERVICE_RUNNING /*{ENCODED_INT: 222}*/:
                ...
                return;
            case DMSDPConfig.EVENT_DEVICE_SERVICE_BUSY /*{ENCODED_INT: 223}*/:

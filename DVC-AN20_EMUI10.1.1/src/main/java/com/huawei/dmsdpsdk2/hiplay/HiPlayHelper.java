...
public class HiPlayHelper {
    ...
    private static final int OPERATE_TIMEOUT = 5000;
    ...
    public void reportDisableOptFailed() {
        ...
        Iterator it = deviceOperationParams.getCapability().iterator();
        while (it.hasNext()) {
            this.mHiPlayListener.onVirtualDeviceFailed(this.mActiveOptParams.getDevice(), (Capability) it.next(), 206);
        }
    ...
    public static class DeviceOperationParams {
        ...
        public void init(HiPlayDevice device2) {
            ...
            this.discoverProc = 96;
            if (OptMode.ENABLE.equals(this.mode)) {
                try {
                    String disMode = new JSONObject(this.jsonString).getString(HiPlayHelper.DISCOVER_MODE);
    ...
    public static class DevSvrId {
        ...
        public int hashCode() {
            return (((((HiPlayHelper.HASHCODE_17 * HiPlayHelper.HASHCODE_31) + getDeviceId().hashCode()) * HiPlayHelper.HASHCODE_31) + getServiceId().hashCode()) * HiPlayHelper.HASHCODE_31) + getServiceType();
        }
    }
    ...
    public class HiPlayTask implements Runnable {
        ...
        public void run() {
            if (OptMode.ENABLE.equals(getMode())) {
                ...
                HiPlayHelper.this.mDeviceOptHandler.postDelayed(HiPlayHelper.this.mEnableTimeout, 5000);
            }

...
import vendor.huawei.hardware.biometrics.hwfacerecognize.V1_0.IBiometricsFaceRecognize;
...
import vendor.huawei.hardware.biometrics.hwfacerecognize.V1_3.IBiometricsFaceRecognizeDataCallback;
...
public class FaceHidlAdapter {
    ...
    private void getFaceDaemonByMode() {
        try {
            if (FaceRecognizeConstant.SUPPORT_FACE_MODE != 0) {
                this.mFaceIdDaemon = vendor.huawei.hardware.biometrics.hwfacerecognize.V1_3.IBiometricsFaceRecognize.getService(false);
            } else {
    ...
    public int setDataCallback(FaceRecognizeDataCallbackWarpper faceRecognizeDataCallback) {
        ...
        IBiometricsFaceRecognize daemon = getFaceRecognizeDaemon();
        if (daemon == null || !(daemon instanceof vendor.huawei.hardware.biometrics.hwfacerecognize.V1_3.IBiometricsFaceRecognize)) {
        ...
        try {
            return ((vendor.huawei.hardware.biometrics.hwfacerecognize.V1_3.IBiometricsFaceRecognize) daemon).setDataCallback(this.mFaceIdHidlDataCallback);
        } catch (RemoteException e) {
    ...
    public int sendBigData(int dataType, int dataSize, FileDescriptor fileDescriptor, ArrayList<Byte> extra) {
        ...
        IBiometricsFaceRecognize daemon = getFaceRecognizeDaemon();
        if (daemon == null || !(daemon instanceof vendor.huawei.hardware.biometrics.hwfacerecognize.V1_3.IBiometricsFaceRecognize)) {
            Slog.w(TAG, "sendBigData: no face recognize HAL!");
            return 6;
        }
        ...
        try {
            int sendBigData = ((vendor.huawei.hardware.biometrics.hwfacerecognize.V1_3.IBiometricsFaceRecognize) daemon).sendBigData(dataType, dataSize, memHdl, extra);
            try {
                memHdl.close();
    ...
    public int sendData(int dataType, ArrayList<Byte> data, ArrayList<Byte> extra) {
        IBiometricsFaceRecognize daemon = getFaceRecognizeDaemon();
        if (daemon == null || !(daemon instanceof vendor.huawei.hardware.biometrics.hwfacerecognize.V1_3.IBiometricsFaceRecognize)) {
            Slog.w(TAG, "sendData: no face recognize HAL!");
            return 6;
        }
        try {
            return ((vendor.huawei.hardware.biometrics.hwfacerecognize.V1_3.IBiometricsFaceRecognize) daemon).sendData(dataType, data, extra);
        } catch (RemoteException e) {
    ...
    public int setSecureFaceMode(int mode) {
        ...
        if (daemon == null) {
            ...
            return 6;
        } else if (!(daemon instanceof vendor.huawei.hardware.biometrics.hwfacerecognize.V1_2.IBiometricsFaceRecognize)) {
            Slog.e(TAG, "can't currently call interface hidl : setSecureFaceMode");
            return 6;
        } else {
            try {
                int val = ((vendor.huawei.hardware.biometrics.hwfacerecognize.V1_2.IBiometricsFaceRecognize) daemon).setSecureFaceMode(mode);
    ...
    public int getAngleDim() {
        ...
        if (daemon == null) {
            ...
            Slog.e(TAG, "can't currently call interface hidl : getAngleDim");
            return 6;
        } else {
            try {
                return ((vendor.huawei.hardware.biometrics.hwfacerecognize.V1_2.IBiometricsFaceRecognize) daemon).getAngleDim();
            } catch (RemoteException e) {
    ...
    public int setFlag(int flag) {
        ...
        if (daemon == null) {
            ...
            Slog.e(TAG, "can't currently call interface hidl : setFlag");
            return 6;
        } else {
            try {
                return ((vendor.huawei.hardware.biometrics.hwfacerecognize.V1_2.IBiometricsFaceRecognize) daemon).setFlag(flag);
            } catch (RemoteException e) {
    ...
    public int prepare(ArrayList<Byte> aaidList, ArrayList<Byte> nonceList, ArrayList<Byte> extralist) {
        ...
        if (daemon == null) {
            ...
            Slog.e(TAG, "can't currently call interface hidl : prepare");
            return 6;
        } else {
            try {
                return ((vendor.huawei.hardware.biometrics.hwfacerecognize.V1_2.IBiometricsFaceRecognize) daemon).prepare(aaidList, nonceList, extralist);
            } catch (RemoteException e) {
    ...
    public void getUvt(AuthPayResultCallbackWrapper authPayResultWrapper) {
        ...
        if (daemon == null) {
            ...
            Slog.e(TAG, "can't currently call interface hidl : getUvt");
        } else {
            try {
                AuthPayResultCallback authPayResult = new AuthPayResultCallback();
                ((vendor.huawei.hardware.biometrics.hwfacerecognize.V1_2.IBiometricsFaceRecognize) daemon).getUvt(authPayResult);
    ...
    public int sendCommand(int cmd, ArrayList<Byte> parm) {
        ...
        if (daemon == null) {
            ...
            Slog.e(TAG, "can't currently call interface hidl : sendCommand");
            return -1;
        } else {
            try {
                return ((vendor.huawei.hardware.biometrics.hwfacerecognize.V1_2.IBiometricsFaceRecognize) daemon).sendCommand(cmd, parm);
            } catch (RemoteException e) {
    ...
    public void getStatus(int statusId, GetStatusResultCallbackWrapper getStatusResultWrapper) {
        ...
        if (daemon == null) {
            ...
            Slog.e(TAG, "can't currently call interface hidl : getStatus");
        } else {
            try {
                GetStatusResultCallback getStatusResult = new GetStatusResultCallback();
                ((vendor.huawei.hardware.biometrics.hwfacerecognize.V1_2.IBiometricsFaceRecognize) daemon).getStatus(statusId, getStatusResult);

...
public class LocaleParamGet_fi {
    public HashMap<String, String> date = new HashMap<String, String>() {
        /* class com.huawei.g11n.tmr.datetime.data.LocaleParamGet_fi.AnonymousClass1 */

        {
            ...
            put("param_EEEE", "sunnuntai(na)?|maanantai(na)?|tiistai(na)?|keskiviikko(na)?|torstai(na)?|perjantai(na)?|lauantai(na)?");

...
public class Rules {
    private HashMap<Integer, String> filterRegex = new HashMap<Integer, String>() {
        /* class com.huawei.g11n.tmr.datetime.detect.Rules.AnonymousClass3 */
    ...
    private HashMap<Integer, String> pastRegex = new HashMap<Integer, String>() {
        /* class com.huawei.g11n.tmr.datetime.detect.Rules.AnonymousClass4 */

        {
            put(100, "[param_pastForward]");
            put(Integer.valueOf((int) BastetParameters.HONGBAO_SPEEDUP_STOP), "(?<![0-9])1[0-9]{3}\\s*[./-]");
        }
    };
    private HashMap<Integer, String> rules = new HashMap<Integer, String>() {
        /* class com.huawei.g11n.tmr.datetime.detect.Rules.AnonymousClass2 */
    ...
    private HashMap<String, String> subRules = new HashMap<String, String>() {
        /* class com.huawei.g11n.tmr.datetime.detect.Rules.AnonymousClass1 */

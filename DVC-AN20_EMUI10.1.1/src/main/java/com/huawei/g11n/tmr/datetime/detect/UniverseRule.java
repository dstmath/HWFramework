...
public class UniverseRule {
    private HashMap<Integer, String> rules = new HashMap<Integer, String>() {
        /* class com.huawei.g11n.tmr.datetime.detect.UniverseRule.AnonymousClass2 */
    ...
    private HashMap<Integer, HashMap<Integer, String>> subRulesMaps = new HashMap<Integer, HashMap<Integer, String>>() {
        /* class com.huawei.g11n.tmr.datetime.detect.UniverseRule.AnonymousClass1 */

        {
            put(20002, new HashMap<Integer, String>() {
                /* class com.huawei.g11n.tmr.datetime.detect.UniverseRule.AnonymousClass1.AnonymousClass1 */
            ...
            put(20003, new HashMap<Integer, String>() {
                /* class com.huawei.g11n.tmr.datetime.detect.UniverseRule.AnonymousClass1.AnonymousClass2 */
            ...
            put(20004, new HashMap<Integer, String>() {
                /* class com.huawei.g11n.tmr.datetime.detect.UniverseRule.AnonymousClass1.AnonymousClass3 */

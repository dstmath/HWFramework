...
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_ug;
...
public class LocaleParam {
    ...
    private static List<String> support = Arrays.asList("en", "de", "fr", "it", "pt", "es", "es_MX", "ca", "ru", "uk", "pl", "cs", "el", "hu", "hr", "ro", "da", "fi", "nl", "nb", "sv", "sk", "tr", "ar", "he", "th", "ja", "zh_hans", "ko", "ms", "hi", "id", "vi", "az", "et", "eu", "bg", "bs", "fa", "km", "ka", "gl", "lv", "lt", "mk", "sr", "sl", "ur", "uz", "bo", "si", "my", "be", "kk", "bn", "lo", "fil", "ne", "jv", "am", "as", "or", "gu", "kn", "mr", "ml", "mai", "mi", "mn", "pa", "sw", "te", "ta", "ug");
    private HashMap<String, String> defaultParam = new HashMap<String, String>() {
        /* class com.huawei.g11n.tmr.datetime.utils.LocaleParam.AnonymousClass2 */
    ...
    private HashMap<String, String> param_b = new HashMap<String, String>() {
        /* class com.huawei.g11n.tmr.datetime.utils.LocaleParam.AnonymousClass1 */

        {
            put("en", "\\b");
            put("zh_hans", BuildConfig.FLAVOR);
            put("ko", BuildConfig.FLAVOR);
            put("ja", BuildConfig.FLAVOR);
            put("hi", BuildConfig.FLAVOR);
            put("he", BuildConfig.FLAVOR);
            put("km", BuildConfig.FLAVOR);
            put("bo", BuildConfig.FLAVOR);
            put("si", BuildConfig.FLAVOR);
            put("my", BuildConfig.FLAVOR);
            put("ne", BuildConfig.FLAVOR);
            put("bn", BuildConfig.FLAVOR);
            put("be", BuildConfig.FLAVOR);
            put("lo", BuildConfig.FLAVOR);
            put("kk", BuildConfig.FLAVOR);
            put("th", BuildConfig.FLAVOR);
            put("as", BuildConfig.FLAVOR);
            put("gu", BuildConfig.FLAVOR);
            put("kn", BuildConfig.FLAVOR);
            put("mr", BuildConfig.FLAVOR);
            put("ml", BuildConfig.FLAVOR);
            put("mai", BuildConfig.FLAVOR);
            put("mi", BuildConfig.FLAVOR);
            put("te", BuildConfig.FLAVOR);
            put("ta", BuildConfig.FLAVOR);
            put("ug", BuildConfig.FLAVOR);
        }
    };
    ...
    public LocaleParam(String locale2) {
        if (isSupport(locale2)) {
            ...
            } else if (this.locale.equals("ug")) {
                this.param = new LocaleParamGet_ug().date;
            }
        }
        if (this.param == null) {
            this.param = new LocaleParamGet_en().date;
    ...
    public static boolean isSupport(String locale2) {
        return support.contains(locale2);
    }
    ...
    public String get(String pName) {
        ...
        if (hashMap.get(pName) != null) {
            result = this.param.get(pName);
        } else {
            result = BuildConfig.FLAVOR;
        }
        if (result.trim().isEmpty() && this.defaultParam.containsKey(pName)) {
            result = this.defaultParam.get(pName);
        }
    ...
    public String getWithoutB(String pName) {
        ...
        String result = hashMap.get(pName) != null ? this.param.get(pName) : BuildConfig.FLAVOR;
    ...
    public static boolean isRelDates(String s, String locale2) {
        if (s.trim().isEmpty()) {
            return true;
        }
        if (s.trim().equals(",")) {
            if (locale2.equalsIgnoreCase("zh_hans") || locale2.equalsIgnoreCase("ja") || locale2.equalsIgnoreCase("ko")) {
                return false;
            }
            return true;
            ...
            if (locale2.equalsIgnoreCase("ur") || locale2.equalsIgnoreCase("ug")) {
                return true;
            }
            return false;
        }

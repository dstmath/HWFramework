...
public class PhoneNumberRule_FR_FR extends PhoneNumberRule {
    ...
    public void init() {
        ...
        this.codesRules.add(new PhoneNumberRule.RegexRule(this, BuildConfig.FLAVOR) {
            /* class com.huawei.g11n.tmr.phonenumber.data.PhoneNumberRule_FR_FR.AnonymousClass1 */
            ...
            public PhoneNumberMatch isValid(PhoneNumberMatch possibleNumber, String msg) {
                ...
                if (p.trim().startsWith("+") || p.trim().startsWith("0") || p.trim().startsWith("(+") || p.trim().startsWith("(0")) {
        ...
        this.codesRules.add(new PhoneNumberRule.RegexRule(this, BuildConfig.FLAVOR) {
            /* class com.huawei.g11n.tmr.phonenumber.data.PhoneNumberRule_FR_FR.AnonymousClass2 */

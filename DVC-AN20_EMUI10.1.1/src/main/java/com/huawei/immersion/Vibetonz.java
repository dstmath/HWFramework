...
public class Vibetonz {
    ...
    private static boolean mIsVibrateImplemented = SystemPropertiesEx.getBoolean("ro.config.touch_vibrate", false);
    ...
    public static boolean isVibrateOn(Context mContext) {
        if (mContext != null && mIsVibrateImplemented && 1 == Settings.System.getInt(mContext.getContentResolver(), "touch_vibrate_mode", 1)) {
            return true;
        }
        return false;
    }

...
public class IccCardEx {
    ...
    public enum State {
        ...
        public static boolean isPukLocked(IccCardConstants.State obj) {
    ...
    public static State getIccCardExState(IccCardConstants.State state) {
        ...
        if ("UNKNOWN".equals(state.toString())) {
        ...
        if (IccCardConstantsEx.INTENT_VALUE_ICC_NOT_READY.equals(state.toString())) {

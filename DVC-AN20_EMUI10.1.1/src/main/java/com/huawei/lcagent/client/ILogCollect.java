            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 11:
                        ...
                        int _result9 = allowUploadAlways(_arg02);
                        reply.writeNoException();
                    ...
                    case 33:
                        ...
                        return true;
                    case TRANSACTION_doEncrypt /*{ENCODED_INT: 34}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String _result31 = doEncrypt(data.readString());
                        reply.writeNoException();
                        reply.writeString(_result31);
                        return true;
                    case TRANSACTION_postRemoteDebugCmd /*{ENCODED_INT: 35}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 36:
                        ...
                        return true;
                    case TRANSACTION_captureRemoteDebugLogWithRemark /*{ENCODED_INT: 37}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_captureRemoteDebugLog /*{ENCODED_INT: 38}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result35 = captureRemoteDebugLog(ICaptureLogCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        reply.writeInt(_result35);
                        return true;
                    case TRANSACTION_getMaxSizeOfLogFile /*{ENCODED_INT: 39}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 43:
                        ...
                        return true;
                    case TRANSACTION_testPreset /*{ENCODED_INT: 44}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String _result41 = testPreset(data.readInt(), data.readString());
                        reply.writeNoException();
                        reply.writeString(_result41);
                        return true;
                    case TRANSACTION_testTrigger /*{ENCODED_INT: 45}*/:
                        data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements ILogCollect {
            ...
            public String doEncrypt(String src) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(Stub.TRANSACTION_doEncrypt, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public int postRemoteDebugCmd(String msg) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(Stub.TRANSACTION_postRemoteDebugCmd, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public int captureRemoteDebugLogWithRemark(ICaptureLogCallback callback, String remarkPath, String patchFilespath) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(Stub.TRANSACTION_captureRemoteDebugLogWithRemark, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public int captureRemoteDebugLog(ICaptureLogCallback callback) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeStrongBinder(callback != null ? callback.asBinder() : null);
                    if (!this.mRemote.transact(Stub.TRANSACTION_captureRemoteDebugLog, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public int getMaxSizeOfLogFile() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getMaxSizeOfLogFile, _data, _reply, 0) && Stub.getDefaultImpl() != null) {

...
public final class MotionTypeApps {
    ...
    private static String getPocketKey(int motionApps) {
        switch (motionApps) {
            case 800:
                return KEY_POCKET;
            case TYPE_POCKET_CALL_RAISE /*{ENCODED_INT: 801}*/:
                return KEY_POCKET_CALL_RAISE;
            case TYPE_POCKET_AOD /*{ENCODED_INT: 802}*/:
    ...
    private static String getShakeKey(int motionApps) {
        switch (motionApps) {
            case 400:
                return KEY_SHAKE;
            case TYPE_SHAKE_REFRESH /*{ENCODED_INT: 401}*/:
                return KEY_SHAKE_REFRESH;
            case TYPE_SHAKE_CHANGE_WALLPAPER /*{ENCODED_INT: 402}*/:
                return KEY_SHAKE_CHANGE_WALLPAPER;
            case TYPE_SHAKE_REARRAGE_WIDGETS /*{ENCODED_INT: 403}*/:
                return KEY_SHAKE_REARRAGE_WIDGETS;
            case TYPE_SHAKE_START_PRIVACY /*{ENCODED_INT: 404}*/:
    ...
    private static String getProxiKey(int motionApps) {
        switch (motionApps) {
            case 300:
                return KEY_PROXI;
            case TYPE_PROXIMITY_ANSWER /*{ENCODED_INT: 301}*/:
                return KEY_PROXI_ANSWER;
            case TYPE_PROXIMITY_DIAL /*{ENCODED_INT: 302}*/:
                return KEY_PROXI_DIAL;
            case TYPE_PROXIMITY_SCREEN_OFF /*{ENCODED_INT: 303}*/:
                return KEY_PROXI_SCREEN_OFF;
            case TYPE_PROXIMITY_SPEAKER /*{ENCODED_INT: 304}*/:
                return KEY_PROXI_SPEAKER;
            case TYPE_PROXIMITY_BLUETOOTHSET /*{ENCODED_INT: 305}*/:
    ...
    private static String getFlipKey(int motionApps) {
        switch (motionApps) {
            case 200:
                return KEY_FLIP;
            case TYPE_FLIP_MUTE_CALL /*{ENCODED_INT: 201}*/:
                return KEY_FLIP_MUTE_CALL;
            case 202:
                return KEY_FLIP_MUTE_CLOCK;
            case TYPE_FLIP_MUTE_AOD /*{ENCODED_INT: 203}*/:

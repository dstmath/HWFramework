...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        /* class com.huawei.okhttp3.internal.cache.DiskLruCache.AnonymousClass1 */
    ...
    private BufferedSink newJournalWriter() throws FileNotFoundException {
        return Okio.buffer(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile)) {
            /* class com.huawei.okhttp3.internal.cache.DiskLruCache.AnonymousClass2 */
            static final /* synthetic */ boolean $assertionsDisabled = false;

            /* access modifiers changed from: protected */
            @Override // com.huawei.okhttp3.internal.cache.FaultHidingSink
    ...
    public synchronized Iterator<Snapshot> snapshots() throws IOException {
        ...
        return new Iterator<Snapshot>() {
            /* class com.huawei.okhttp3.internal.cache.DiskLruCache.AnonymousClass3 */
                ...
                if (this.done) {
                    ...
                    try {
                        return new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[index])) {
                            /* class com.huawei.okhttp3.internal.cache.DiskLruCache.Editor.AnonymousClass1 */

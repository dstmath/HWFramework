...
public final class RouteSelector {
    ...
    public static final class Selection {
        ...
        public boolean hasNext() {
            return this.concurrentConnectEnabled ? this.routes.size() > 0 : this.nextRouteIndex < this.routes.size();
        }
        ...
        public void connectFailed() {
            ...
            if (this.concurrentConnectEnabled && (inetSocketAddress = this.connectedTcpAddress) != null) {

...
public interface IHoldNotifier extends IInterface {
    ...
    public static class Default implements IHoldNotifier {
        @Override // com.huawei.permission.IHoldNotifier
    ...
    public static abstract class Stub extends Binder implements IHoldNotifier {
        ...
        public static class Proxy implements IHoldNotifier {
            public static IHoldNotifier sDefaultImpl;
            ...
            public int notifyResult(String owner, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(1, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().notifyResult(owner, bundle);
                    }
        ...
        public static boolean setDefaultImpl(IHoldNotifier impl) {
        ...
        public static IHoldNotifier getDefaultImpl() {

            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 2:
                        ...
                        boolean checkSystemAppInternal = checkSystemAppInternal(_arg0, _arg13);
                        reply.writeNoException();
                    ...
                    case 4:
                        ...
                        addRecord(_arg03, _arg14, _arg22, _arg3);
                        reply.writeNoException();
                        return true;
                    case 5:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 10:
                        ...
                        boolean checkPreBlock = checkPreBlock(_arg05, _arg15, _arg2);
                        reply.writeNoException();

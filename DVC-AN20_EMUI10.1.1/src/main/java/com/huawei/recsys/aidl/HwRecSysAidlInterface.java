            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case TRANSACTION_doNotificationCollect /*{ENCODED_INT: 10}*/:
                        ...
                        return true;
                    case TRANSACTION_clsRuleManger /*{ENCODED_INT: 11}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_getRequestNeed /*{ENCODED_INT: 12}*/:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg02 = TRANSACTION_getRecommendation;
                        }
                        String _result5 = getRequestNeed(_arg02);
                        reply.writeNoException();
                        reply.writeString(_result5);
                        return true;
                    case TRANSACTION_updateCandidateSet /*{ENCODED_INT: 13}*/:
                        data.enforceInterface(DESCRIPTOR);
                        updateCandidateSet(data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_updateCloudRules /*{ENCODED_INT: 14}*/:
                        data.enforceInterface(DESCRIPTOR);
                        updateCloudRules(data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setCandidateCount /*{ENCODED_INT: 15}*/:
                        data.enforceInterface(DESCRIPTOR);
                        setCandidateCount(data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getCandisetId /*{ENCODED_INT: 16}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_doNotificationCollectTest /*{ENCODED_INT: 17}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String _arg03 = data.readString();
                        if (data.readInt() != 0) {
                            _arg12 = TRANSACTION_getRecommendation;
                        }
                        String _result7 = doNotificationCollectTest(_arg03, _arg12);
                        reply.writeNoException();
                        reply.writeString(_result7);
                        return true;
                    case TRANSACTION_isAllowABTest /*{ENCODED_INT: 18}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isAllowABTest = isAllowABTest(data.readString());
                        reply.writeNoException();
                        reply.writeInt(isAllowABTest ? 1 : 0);
                        return true;
                    case TRANSACTION_getOutputNum /*{ENCODED_INT: 19}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result8 = getOutputNum(data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result8);
                        return true;
                    case TRANSACTION_isInitConfigFile /*{ENCODED_INT: 20}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isInitConfigFile = isInitConfigFile(data.readString());
                        reply.writeNoException();
                        reply.writeInt(isInitConfigFile ? 1 : 0);
                        return true;
                    case TRANSACTION_handleEvent /*{ENCODED_INT: 21}*/:
                        data.enforceInterface(DESCRIPTOR);

            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 2:
                        ...
                        int _result2 = generateKey(_arg03, _arg1, _arg24, _arg32, _arg42, _arg5);
                        reply.writeNoException();
                    ...
                    case 3:
                        ...
                        int _result3 = getKeyCharacteristics(_arg04, _arg12, _arg2, _arg33, _arg43);
                        reply.writeNoException();
                    ...
                    case 4:
                        ...
                        HwExportResult _result4 = exportKey(_arg05, _arg17, _arg22, _arg3, data.readInt());
                        reply.writeNoException();
                        if (_result4 != null) {
                            reply.writeInt(1);
                    ...
                    case 5:
                        ...
                        HwOperationResult _result5 = begin(_arg06, _arg18, _arg25, _arg34, _arg4, data.createByteArray(), data.readInt());
                        reply.writeNoException();
                        if (_result5 != null) {
                            reply.writeInt(1);
                    ...
                    case 6:
                        ...
                        HwOperationResult _result6 = update(_arg07, _arg13, data.createByteArray());
                        reply.writeNoException();
                        if (_result6 != null) {
                            reply.writeInt(1);
                    ...
                    case 7:
                        ...
                        HwOperationResult _result7 = finish(_arg08, _arg14, data.createByteArray(), data.createByteArray());
                        reply.writeNoException();
                        if (_result7 != null) {
                            reply.writeInt(1);
                    ...
                    case 9:
                        ...
                        int _result9 = attestKey(_arg09, _arg19, _arg23, _arg35);
                        reply.writeNoException();
                    ...
                    case 11:
                        ...
                        int _result11 = set(_arg010, _arg15, data.readInt());
                        reply.writeNoException();
                    ...
                    case 13:
                        ...
                        HwKeymasterCertificateChain _arg110 = new HwKeymasterCertificateChain();
                        int _result13 = attestDeviceIds(_arg0, _arg110);
                        reply.writeNoException();
                    ...
                    case 14:
                        ...
                        int _result14 = assetHandleReq(_arg02, _arg111);
                        reply.writeNoException();
                    ...
                    case 15:
                        data.enforceInterface(DESCRIPTOR);
                        HwKeymasterCertificateChain _arg011 = new HwKeymasterCertificateChain();
                        int _result15 = exportTrustCert(_arg011);
                        reply.writeNoException();
                    ...
                    case 16:
                        ...
                        int _result16 = setKeyProtection(_arg012, _arg16);
                        reply.writeNoException();

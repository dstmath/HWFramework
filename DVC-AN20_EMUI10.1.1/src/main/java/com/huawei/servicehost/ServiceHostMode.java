...
public class ServiceHostMode {
    public static final int BACKGROUND_PHOTO_MODE = 2048;
    public static final int BACKGROUND_VIDEO_MODE = 4096;
    ...
    public static final int CAPTURE_SMART_NORMAL_MODE = 256;
    public static final int COSPLAY_PHOTO_MODE = 512;
    public static final int COSPLAY_VIDEO_MODE = 1024;
    public static final int VIDEO_BEAUTY_MODE = 131072;
    public static final int VIDEO_NORMAL_MODE = 65536;

    private ServiceHostMode() {
    }
}

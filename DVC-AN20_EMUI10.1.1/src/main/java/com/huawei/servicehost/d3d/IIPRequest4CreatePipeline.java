...
public interface IIPRequest4CreatePipeline extends IInterface {
    ...
    public static class Default implements IIPRequest4CreatePipeline {
        @Override // com.huawei.servicehost.d3d.IIPRequest4CreatePipeline
            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 8:
                        ...
                        return true;
                    case TRANSACTION_uselessFunction /*{ENCODED_INT: 9}*/:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
        ...
        public static class Proxy implements IIPRequest4CreatePipeline {
            ...
            public void uselessFunction(ImageDescriptor val) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_uselessFunction, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;

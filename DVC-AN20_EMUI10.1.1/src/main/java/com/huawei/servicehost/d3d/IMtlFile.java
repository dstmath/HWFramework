...
public interface IMtlFile extends IInterface {
    ...
    public static class Default implements IMtlFile {
        @Override // com.huawei.servicehost.d3d.IMtlFile
    ...
    public static abstract class Stub extends Binder implements IMtlFile {
        ...
        public static class Proxy implements IMtlFile {
            public static IMtlFile sDefaultImpl;
        ...
        public static boolean setDefaultImpl(IMtlFile impl) {
        ...
        public static IMtlFile getDefaultImpl() {

...
public interface IIPRequest4Algo extends IInterface {
    ...
    public static class Default implements IIPRequest4Algo {
        @Override // com.huawei.servicehost.test.IIPRequest4Algo
    ...
    public static abstract class Stub extends Binder implements IIPRequest4Algo {
            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 8:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getSurface /*{ENCODED_INT: 9}*/:
                        data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements IIPRequest4Algo {
            public static IIPRequest4Algo sDefaultImpl;
        ...
        public static boolean setDefaultImpl(IIPRequest4Algo impl) {
        ...
        public static IIPRequest4Algo getDefaultImpl() {

...
public class IDeviceDesc implements Parcelable {
    public static final Parcelable.Creator<IDeviceDesc> CREATOR = new Parcelable.Creator<IDeviceDesc>() {
        /* class com.huawei.softnet.connect.IDeviceDesc.AnonymousClass1 */

        @Override // android.os.Parcelable.Creator
        public IDeviceDesc createFromParcel(Parcel in) {
            return new IDeviceDesc(in);
        }

        @Override // android.os.Parcelable.Creator
        public IDeviceDesc[] newArray(int size) {
            return new IDeviceDesc[size];
        }
    };
    ...
    protected IDeviceDesc(Parcel in) {
    ...
    public static class Builder {
        private IDeviceDesc info = new IDeviceDesc();

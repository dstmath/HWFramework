...
public class SmartSlideOverScroller {
    ...
    private void initOverScrollerConfig(Context context) {
        ...
        if (context != null) {
            ...
            float f15 = this.mMultipleVelocity;
            if (f15 < DEFAULT_MULTIPLE_VELOCITY) {
                f15 = 1.5f;
            }
            this.mMultipleVelocity = f15;

            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 5:
                        ...
                        return true;
                    case TRANSACTION_notifyCheckCertResult /*{ENCODED_INT: 6}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_deliverSeIntent /*{ENCODED_INT: 7}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_selectUicc /*{ENCODED_INT: 8}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result5 = selectUicc(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result5);
                        return true;
                    case TRANSACTION_getSelectedUicc /*{ENCODED_INT: 9}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result6 = getSelectedUicc();
                        reply.writeNoException();
                        reply.writeInt(_result6);
                        return true;
                    case TRANSACTION_openuicc /*{ENCODED_INT: 10}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_closeuicc /*{ENCODED_INT: 11}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_transceiveuicc /*{ENCODED_INT: 12}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_eSEChipReset /*{ENCODED_INT: 13}*/:
                        data.enforceInterface(DESCRIPTOR);

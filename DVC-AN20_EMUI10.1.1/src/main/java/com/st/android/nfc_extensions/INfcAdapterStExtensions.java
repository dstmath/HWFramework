            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 5:
                        ...
                        return true;
                    case TRANSACTION_getHceCapability /*{ENCODED_INT: 6}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean hceCapability = getHceCapability();
                        reply.writeNoException();
                        reply.writeInt(hceCapability ? 1 : 0);
                        return true;
                    case TRANSACTION_setRfConfiguration /*{ENCODED_INT: 7}*/:
                        data.enforceInterface(DESCRIPTOR);
                        setRfConfiguration(data.readInt(), data.createByteArray());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getRfConfiguration /*{ENCODED_INT: 8}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_setRfBitmap /*{ENCODED_INT: 9}*/:
                        data.enforceInterface(DESCRIPTOR);
                        setRfBitmap(data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getHalTraceLevel /*{ENCODED_INT: 10}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String _result6 = getHalTraceLevel();
                        reply.writeNoException();
                        reply.writeString(_result6);
                        return true;
                    case TRANSACTION_getCoreStackTraceLevel /*{ENCODED_INT: 11}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String _result7 = getCoreStackTraceLevel();
                        reply.writeNoException();
                        reply.writeString(_result7);
                        return true;
                    case TRANSACTION_getCeScreenOffMode /*{ENCODED_INT: 12}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String _result8 = getCeScreenOffMode();
                        reply.writeNoException();
                        reply.writeString(_result8);
                        return true;
                    case TRANSACTION_getCeSwitchOffMode /*{ENCODED_INT: 13}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String _result9 = getCeSwitchOffMode();
                        reply.writeNoException();
                        reply.writeString(_result9);
                        return true;
                    case TRANSACTION_getProprietaryConfigSettings /*{ENCODED_INT: 14}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_setProprietaryConfigSettings /*{ENCODED_INT: 15}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 16:
                        ...
                        return true;
                    case TRANSACTION_getPipeInfo /*{ENCODED_INT: 17}*/:
                        data.enforceInterface(DESCRIPTOR);

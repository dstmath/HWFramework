                ...
                public void handleMessage(Message msg) {
                    ...
                    if (!HwWidgetUtils.isHwTheme(HwProgressDialog.this.getContext())) {
                        if (HwProgressDialog.this.mProgressNumberFormat != null) {
                            ...
                            HwProgressDialog.this.mProgressNumber.setText(String.format(format, Integer.valueOf(progress), Integer.valueOf(max)));
                        } else {
                            HwProgressDialog.this.mProgressNumber.setText(BuildConfig.FLAVOR);
                        }
                    }
                    ...
                    HwProgressDialog.this.mProgressPercent.setText(BuildConfig.FLAVOR);
                }
            };

...
public class SectionLocaleUtils {
    ...
    public String getLabel(String displayName) {
        ...
        if (!TextUtils.isEmpty(displayName)) {
            ...
            } else if (this.mLocale.getLanguage().equals("ar") && (ch = getSortKey(displayName).charAt(0)) < 1574 && ch > 1569) {
                return "آ";
            }
        }
    ...
    public static String getLocaleScript(Locale locale) {
        ...
        return subtags.length > 1 ? subtags[1] : BuildConfig.FLAVOR;
    }

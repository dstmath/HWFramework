...
public class MpLinkCommonUtils {
    private static final int[] CERTIFIED_APPS = {IndexObserverHandler.MSG_BOUND, IndexObserverHandler.MSG_UNBOUND, HwLockPatternUtils.transaction_setActiveVisitorPasswordState, ConstantValue.transaction_setWifiDisabled, ConstantValue.transaction_isWifiDisabled, ConstantValue.transaction_setWifiApDisabled, ConstantValue.transaction_isWifiApDisabled};
    ...
    public static String getProductLocale() {
        return SystemProperties.get("ro.product.locale.region", BuildConfig.FLAVOR);
    }

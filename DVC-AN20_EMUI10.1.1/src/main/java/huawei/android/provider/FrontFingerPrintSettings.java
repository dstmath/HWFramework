...
public class FrontFingerPrintSettings {
    ...
    public static final int SINGLE_VIRTUAL_AI_MODE = SystemProperties.getInt("ro.config.show_navbar_slide", SystemProperties.get("ro.config.hw_optb", "0").equals("156") ? 1 : 0);

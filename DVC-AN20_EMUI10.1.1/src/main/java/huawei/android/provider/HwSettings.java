...
public final class HwSettings {
    ...
    public static class NameValueCache {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:23:?, code lost:
            r3 = r2.call(r13.getPackageName(), r12.mCallCommand, r14, (android.os.Bundle) null);
         */
        ...
        public String getString(ContentResolver cr, String name) {
            ...
            if (cp != null) {
                try {
                    c = cp.query(cr.getPackageName(), this.mUri, SELECT_VALUE, ContentResolver.createSqlQueryBundle(NAME_EQ_PLACEHOLDER, new String[]{name}, null), (ICancellationSignal) null);
    ...
    public static final class Systemex extends Settings.NameValueTable {
        ...
        public static float getFloat(ContentResolver cr, String name) throws Settings.SettingNotFoundException {
            String v = getString(cr, name);
            if (v == null) {
                return Float.parseFloat(BuildConfig.FLAVOR);
            }
            try {
                return Float.parseFloat(v);
            } catch (NumberFormatException e) {

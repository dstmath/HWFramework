        ...
        if (type == 1) {
            ...
            switch (type) {
                ...
                case 1001:
                    paramSeq = 6;
                    break;
                case Modules.DEFAULT_OTHER:
                    paramSeq = 7;
                    break;
                case 1003:
                    paramSeq = 8;
                    break;
                case TYPE_APPLICATION_MEDIA_OVERLAY /*{ENCODED_INT: 1004}*/:
                    paramSeq = 9;
                    break;
                case TYPE_APPLICATION_ABOVE_SUB_PANEL /*{ENCODED_INT: 1005}*/:
                    paramSeq = 10;
                    break;
                default:
                    switch (type) {
                        case FaceRecognizeManager.AcquireInfo.FACEID_ENROLL_INFO_BEGIN:
                            paramSeq = 11;
                            break;
                        case 2001:
                            paramSeq = 12;
                        ...
                        case 2003:
                            paramSeq = 14;
                            break;
                        case TYPE_KEYGUARD /*{ENCODED_INT: 2004}*/:
                            paramSeq = 15;
                            break;
                        case 2005:
                            paramSeq = 16;

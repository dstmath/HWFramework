...
public interface IHwCCModePlugin extends IInterface {
    ...
    public static class Default implements IHwCCModePlugin {
    ...
    public static abstract class Stub extends Binder implements IHwCCModePlugin {
        ...
        public static class Proxy implements IHwCCModePlugin {
            public static IHwCCModePlugin sDefaultImpl;
            ...
            public int openCCMode() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(1, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().openCCMode();
                    }
            ...
            public int closeCCMode() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(2, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().closeCCMode();
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
        ...
        public static boolean setDefaultImpl(IHwCCModePlugin impl) {
        ...
        public static IHwCCModePlugin getDefaultImpl() {

        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 17:
                        data.enforceInterface(DESCRIPTOR);
                        int _result9 = setSecureFaceMode(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result9);
                        return true;
                    case 18:
                        data.enforceInterface(DESCRIPTOR);
                        int _result10 = getAngleDim();
                        reply.writeNoException();
                    ...
                    case 19:
                        ...
                        int _result11 = preparePayInfo(_arg07, _arg17, _arg23);
                        reply.writeNoException();
                    ...
                    case 20:
                        ...
                        int _result12 = getPayResult(_arg0, _arg16, _arg22, _arg3);
                        reply.writeNoException();
                    ...
                    case 21:
                        data.enforceInterface(DESCRIPTOR);
                        int _result13 = hasAlternateAppearance(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result13);
                        return true;
                    case 22:
                        data.enforceInterface(DESCRIPTOR);
                        long _result14 = getAuthenticatorId();
                        reply.writeNoException();
                        reply.writeLong(_result14);
                        return true;
                    case 23:
                        data.enforceInterface(DESCRIPTOR);
                        int _result15 = setEnrollInfo(data.createIntArray());
                        reply.writeNoException();
                        reply.writeInt(_result15);
                        return true;
                    case 24:
                        data.enforceInterface(DESCRIPTOR);
                        int _result16 = registerSecureRegCallBack(SecureRegCallBack.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
            ...
            public int setSecureFaceMode(int mode) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(17, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setSecureFaceMode(mode);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();

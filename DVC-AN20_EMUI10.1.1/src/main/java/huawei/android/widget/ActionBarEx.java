...
public class ActionBarEx {
    ...
    public static void setStartIcon(ActionBar actionBar, HwToolbar toolbar, boolean isIcon1Visible, Drawable icon1, View.OnClickListener listener1) {
        toolbar.setStartIcon(isIcon1Visible, icon1, listener1);
        setIconLayout(actionBar, toolbar);
    }

    public static void setEndIcon(ActionBar actionBar, HwToolbar toolbar, boolean isIcon2Visible, Drawable icon2, View.OnClickListener listener2) {
        toolbar.setEndIcon(isIcon2Visible, icon2, listener2);
        setIconLayout(actionBar, toolbar);
    }

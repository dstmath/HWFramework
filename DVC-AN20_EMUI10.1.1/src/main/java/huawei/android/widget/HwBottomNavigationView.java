...
public class HwBottomNavigationView extends LinearLayout {
    ...
    public HwBottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = theme.obtainStyledAttributes(attrs, resLoader.getIdentifierArray(context, ResLoaderUtil.STAYLEABLE, "BottomNavigation"), defStyleAttr, defStyleRes);
        int menuResId = a.getResourceId(resLoader.getIdentifier(context, ResLoaderUtil.STAYLEABLE, "BottomNavigation_bottomNavMenu"), 0);
        int defatultColor = a.getResourceId(resLoader.getIdentifier(context, ResLoaderUtil.STAYLEABLE, "BottomNavigation_bottomNavItemDefaultColor"), resLoader.getIdentifier(getContext(), ResLoaderUtil.COLOR, "emui_color_gray_7"));
        int activeColor = a.getResourceId(resLoader.getIdentifier(context, ResLoaderUtil.STAYLEABLE, "BottomNavigation_bottomNavItemActiveColor"), resLoader.getIdentifier(getContext(), ResLoaderUtil.COLOR, "emui_accent"));
        int messageColor = a.getResourceId(resLoader.getIdentifier(context, ResLoaderUtil.STAYLEABLE, "BottomNavigation_bottomMessageBgColor"), resLoader.getIdentifier(getContext(), ResLoaderUtil.COLOR, "bottom_nav_message_bg"));
        int bottomDividerId = a.getResourceId(resLoader.getIdentifier(context, ResLoaderUtil.STAYLEABLE, "BottomNavigation_bottomNavDivider"), -1);
        HwBlurEngine.BlurType blurType = HwBlurEngine.BlurType.fromTypeValue(a.getInteger(resLoader.getIdentifier(context, ResLoaderUtil.STAYLEABLE, "BottomNavigation_bottomNavBlurType"), DEFAULT_BLUR_TYPE));
        if (blurType != null) {
            this.mBlurType = blurType;
        }
        this.mBlurOverlayColor = a.getColor(resLoader.getIdentifier(context, ResLoaderUtil.STAYLEABLE, "BottomNavigation_bottomNavBlurOverlayColor"), INVALID_BLUR_OVERLAY_COLOR);
        this.mIsColumnEnabled = a.getBoolean(resLoader.getIdentifier(context, ResLoaderUtil.STAYLEABLE, "BottomNavigation_hwColumnEnabled"), false);
        a.recycle();
    ...
    private void parseTextAndIconColor(Resources.Theme theme) {
        TypedArray a = theme.obtainStyledAttributes(new int[]{33620147, 34668564});
        this.mTextColor = a.getColorStateList(0);
        this.mIconColor = a.getColorStateList(1);
        a.recycle();

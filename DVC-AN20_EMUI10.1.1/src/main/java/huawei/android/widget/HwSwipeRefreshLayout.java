...
public class HwSwipeRefreshLayout extends FrameLayout {
    ...
    private void setRefreshingBarAnimLoadingLine(float offsetY) {
        ...
        float progressBarScaleRatio = (0.1f * ((offsetY - f) / (this.mOffsetMaxPullDistance - f))) + 1.0f;
    ...
    private void setRefreshingBarAppearLine(float offsetY) {
        float f = this.mOffsetProgressBarAppearDistance;
        float distanceRatio = (offsetY - f) / (this.mOffsetLoadingStartDistance - f);

...
public class HwToolbar extends Toolbar {
    ...
    public void setStartIcon(boolean isIcon1Visible, Drawable icon1, View.OnClickListener listener1) {
    ...
    public void setEndIcon(boolean isIcon2Visible, Drawable icon2, View.OnClickListener listener2) {
        if (this.mIconLayout == null) {
            initIconLayout();
        }
    ...
    /* JADX INFO: Multiple debug info for r1v10 huawei.android.widget.HwTextView: [D('titleViewVp' android.view.ViewParent), D('subTitleView' android.view.View)] */
    ...
    public void onLayout(boolean isChanged, int left, int top, int right, int bottom) {
        ...
        if (shouldLayout(this.mParentClassTitleTextView)) {
            ...
            if (realTop > titleTextViewTop) {
                int i = realTop - titleTextViewTop;
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        initTitleTextSize(this.mResLoader, this.mContext.getResources());
        HwTextView hwTextView = this.mSubTitleView;
        if (hwTextView != null) {
    ...
    public void setMenu(MenuBuilder menu, ActionMenuPresenter outerPresenter) {
        ...
        this.mActionMenuPresenter.setId(16908719);
    ...
    private void init(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        initTitleTextSize(this.mResLoader, res);
        ...
        if (attrs != null) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (attrResId == 0) {
                    ...
                    this.mIsColumnEnabled = array.getBoolean(i, false);
                }
            }
            array.recycle();
        }
    ...
    private void initTitleTextSize(ResLoader resLoader, Resources res) {
    ...
    private void setMenuPresenterStatus(boolean isSplitActionBar) {
        ...
        if (hwActionMenuPresenter != null) {
            if (!isSplitActionBar) {
                hwActionMenuPresenter.setExpandedActionViewsExclusive(getResources().getBoolean(17891335));
                return;
            }
    ...
    private void updateViews() {
        ...
        if (navView != null && (navView.getLayoutParams() instanceof Toolbar.LayoutParams)) {
            Toolbar.LayoutParams params = (Toolbar.LayoutParams) navView.getLayoutParams();
            int currentMarginStart = params.getMarginStart();
            int marginStart = res.getDimensionPixelSize(this.mResLoader.getIdentifier(this.mContext, "dimen", "emui_dimens_default_start"));
            if (currentMarginStart != marginStart) {
                params.setMarginStart(marginStart);
                int iconSize = res.getDimensionPixelSize(this.mResLoader.getIdentifier(this.mContext, "dimen", "hwtoolbar_icon_size"));
    ...
    private void ensureSplitView() {
        if (this.mSplitView == null) {
            ...
            if (activity != null) {
                ...
                View splitView = decor.findViewById(16909427);
                ...
                this.mSplitView.setId(16909427);
    ...
    private boolean hasViewsStart() {
        ...
        ImageView imageView = this.mLogoView;
        return isHaveNavView || (imageView != null && imageView.getVisibility() == 0 && this.mLogoView.getParent() == this);
    }
    ...
    public void initIconLayout() {
        ...
        this.mTitleView = (HwTextView) this.mIconLayout.findViewById(16908715);
        this.mSubTitleView = (HwTextView) this.mIconLayout.findViewById(16908714);
        this.mTitleView.setAutoTextInfo(this.mTitleMinSize, this.mTitleSizeStep, 1);
    ...
    private void initStartAndEndIconLayout() {
        ...
        if (this.mIconLayout != null && (resLoader = this.mResLoader) != null) {
            ...
            setViewClickEffectBackground(this.mIcon1View);
            ...
            setViewClickEffectBackground(this.mIcon2View);
    ...
    private void setViewClickEffectBackground(View view) {
        ClickEffectEntry clickEffectEntry;
        if (view != null && (clickEffectEntry = this.mClickEffectEntry) != null) {
            HwAnimatedGradientDrawable iconBgDrawable = HwWidgetUtils.getHwAnimatedGradientDrawable(this.mContext, clickEffectEntry);
            iconBgDrawable.setCornerRadius((float) this.mBgCornerDimen);
    ...
    private boolean hasViewsEnd() {
        ...
        return (shouldLayout(this.mMenuView) && isChildVisible) || !(!shouldLayout(this.mIconLayout) || (imageView = this.mIcon2View) == null || imageView.getVisibility() == 8);
    }
    ...
    private void setNavButtonColor() {
        ...
        if (navView instanceof ImageButton) {
            ...
            if (colorStateList != null) {
                ...
                setViewClickEffectBackground(navButton);
            }
        }
    }
    ...
    public boolean getSplitStatus() {
        ...
        boolean isSplitActionBar = false;
        if (activity == null) {
    ...
    public class MenuBuilderCallback implements MenuBuilder.Callback {
        ...
        public boolean onMenuItemSelected(MenuBuilder menu, MenuItem item) {
            return HwToolbar.this.mMenuViewItemClickListener != null && HwToolbar.this.mMenuViewItemClickListener.onMenuItemClick(item);
        }

...
public class PinTextField extends EditText {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mDivideWidth = res.getDimensionPixelSize(34472780);
        setBackground(null);
        setRawInputType(128);
        setPadding(0, 0, 0, 0);
        setCursorVisible(false);
        this.mLeftBg = res.getDrawable(33752127);
        this.mMiddleBg = res.getDrawable(33752128);
        this.mRightBg = res.getDrawable(33752129);
        this.mPinSize = res.getDimensionPixelSize(34472781);

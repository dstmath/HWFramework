...
public class ProgressButton extends View {
    ...
    private synchronized void initProgressButton(Context context) {
        ...
        this.mMaxWidth = res.getDimensionPixelSize(34472703);
        this.mMinWidth = res.getDimensionPixelSize(34472705);
        this.mMaxHeight = res.getDimensionPixelSize(34472702);
        this.mMinHeight = res.getDimensionPixelSize(34472704);
        this.mTextSize = res.getDimensionPixelSize(34472709);
        this.mTextPaddingLeft = res.getDimensionPixelSize(34472707);
        this.mTextPaddingRight = res.getDimensionPixelSize(34472708);
        this.mProgressDrawable = res.getDrawable(33752039);
        this.mTextColor = res.getColor(33882934);
    }

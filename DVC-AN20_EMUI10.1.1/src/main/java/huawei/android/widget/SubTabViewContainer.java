...
public class SubTabViewContainer extends HorizontalScrollView {
    ...
    public static class SlidingTabStrip extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            if (i2 != -1) {
                marginBottom = ((TextView) getChildAt(i2)).getTotalPaddingBottom() - this.mSelectedIndicatorMargin;
            }
            int i3 = this.mIndicatorLeft;
            if (i3 >= 0 && (i = this.mIndicatorRight) > i3) {
                this.mUnderlineDrawable.setBounds(0, 0, i - i3, this.mSelectedIndicatorHeight);
                canvas.save();

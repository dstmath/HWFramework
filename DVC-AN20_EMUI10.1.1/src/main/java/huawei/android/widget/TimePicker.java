...
public class TimePicker extends android.widget.TimePicker {
    ...
    public TimePicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (obj != null && (minuteSpinner = (NumberPicker) ReflectUtil.getObject(obj, "mMinuteSpinner", this.mTimePickerSpinnerClass)) != null) {
    ...
    private void updateAmPmStart() {
        ...
        Object obj = ReflectUtil.getObject(this, "mDelegate", this.mGoogleTimePickerClass);
        if (obj != null && ((Boolean) ReflectUtil.callMethod(obj, "isAmPmAtStart", null, null, this.mTimePickerSpinnerClass)).booleanValue() && (timeDividerMinuteAndAmPm = (amPmParent = (ViewGroup) findViewById(16909499)).findViewById(34603117)) != null) {

...
public class HwExpandedAppbarController {
    ...
    private void initViews(int flag) {
        if (this.mRootView != null) {
            if (flag != 0) {
                ...
                this.mContentContainer = (ViewGroup) this.mRootView.findViewById(34603049);
                this.mHwToolbar = (HwToolbar) this.mRootView.findViewById(34603512);
            }
            this.mHwCollapsingToolbarLayout = (HwCollapsingToolbarLayout) this.mRootView.findViewById(34603045);
            this.mContentContainer = (ViewGroup) this.mRootView.findViewById(34603049);
            this.mHwToolbar = (HwToolbar) this.mRootView.findViewById(34603512);
            ...
            if (flag != 0) {
                ...
                this.mContentContainer = (ViewGroup) this.mActivity.findViewById(34603049);
                this.mHwToolbar = (HwToolbar) this.mActivity.findViewById(34603512);
            }
            this.mHwCollapsingToolbarLayout = (HwCollapsingToolbarLayout) this.mActivity.findViewById(34603045);
            this.mContentContainer = (ViewGroup) this.mActivity.findViewById(34603049);
            this.mHwToolbar = (HwToolbar) this.mActivity.findViewById(34603512);
        }
    }
    ...
    public void setSubTitle(CharSequence subTitle) {
        HwCollapsingToolbarLayout hwCollapsingToolbarLayout = this.mHwCollapsingToolbarLayout;
        if (hwCollapsingToolbarLayout != null) {
            hwCollapsingToolbarLayout.setSubTitle(subTitle);
        }
    }

...
public class HwContentDialog extends LinearLayout {
    ...
    private void initView() {
        ((LayoutInflater) getContext().getSystemService("layout_inflater")).inflate(ResLoaderUtil.getLayoutId(getContext(), "hwpattern_image_dialog_layout"), (ViewGroup) this, true);

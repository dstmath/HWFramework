...
public class HwShareBottomSheet extends RelativeLayout {
    ...
    public void runExitAnim(AnimatorListenerAdapter animatorListenerAdapter) {
        if (!this.mIsHideMask) {
            ...
            ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(this.mRecyclerView, "TranslationY", 0.0f, (float) recyclerviewHeight);
    ...
    public void onLayout(boolean isChanged, int l, int t, int r, int b) {
        ...
        if (this.mIsHasInitData && !this.mIsHasStartAnim && !this.mIsHideMask) {
            ...
            int recyclerviewHeight = this.mRecyclerView.getMeasuredHeight();
            ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(this.mRecyclerView, "TranslationY", (float) recyclerviewHeight, 0.0f);
            objectAnimator.setDuration((long) this.mDuration);
            objectAnimator.start();
        }
    }
                        ...
                        if (HwShareBottomSheet.this.mItemClickListener != null) {
                            if (position != ShareAdapter.this.mList.size() - 1) {
                                ...
                                if (HwShareBottomSheet.this.mShareIntent != null) {
                                    HwShareBottomSheet.this.mContext.startActivity(Intent.createChooser(HwShareBottomSheet.this.mShareIntent, BuildConfig.FLAVOR));
                                }
                            }
                        }
    ...
    public static class ShareBean implements Serializable {
        ...
        private Object mParam = BuildConfig.FLAVOR;

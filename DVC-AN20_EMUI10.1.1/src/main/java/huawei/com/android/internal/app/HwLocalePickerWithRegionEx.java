...
public final class HwLocalePickerWithRegionEx implements IHwLocalePickerWithRegionEx, SearchView.OnQueryTextListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(34013414, container, false);
    }

    public void onViewCreated(final Context context, View view, Bundle savedInstanceState) {
        final LinearLayout searchViewContainer = (LinearLayout) view.findViewById(34603450);
        searchViewContainer.setVisibility(0);
        FrameLayout listViewContainer = (FrameLayout) view.findViewById(34603381);
        LinearLayout emptyRoot = (LinearLayout) view.findViewById(34603067);
    ...
    private void setQuery(View view) {
        ...
        if (this.mInner.getParentLocaleEx() != null) {
            searchView.setQueryHint(this.mInner.getTextEx(33686184));
        } else {
            searchView.setQueryHint(this.mInner.getTextEx(33685748));
        }

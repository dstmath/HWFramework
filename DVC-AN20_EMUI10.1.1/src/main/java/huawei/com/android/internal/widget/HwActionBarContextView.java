...
public class HwActionBarContextView extends ActionBarContextView implements View.OnClickListener, ActionModeView {
    ...
    public HwActionBarContextView(Context context, AttributeSet attrs) {
        ...
        this.mOkMenuItem = new ActionMenuItem(context, 0, 16909219, 0, 0, context.getString(17039370));
        this.mCancelMenuItem = new ActionMenuItem(context, 0, 16908819, 0, 0, context.getString(17039360));
    ...
    private LinearLayout initTitleLayout() {
        ...
        this.mOk = (ImageView) titleLayout.findViewById(16909219);
        this.mCancel = (ImageView) titleLayout.findViewById(16908819);
    ...
    public void initTitle() {
        ...
        if (titleLayout == null && (titleLayout = initTitleLayout()) != null) {
            titleView = (TextView) titleLayout.findViewById(16908715);
            subTitleView = (TextView) titleLayout.findViewById(16908714);
            if (titleView != null) {
    ...
    public int measureChildView(View child, int availableWidth, int childSpecHeight, int spacing) {
        ...
        child.measure(View.MeasureSpec.makeMeasureSpec(availableWidth, 1073741824), childSpecHeight);
    ...
    public void setImageResource(int resIdOk, int resIdCancel) {
        ...
        if (i2 != 0) {
            this.mCancel.setImageResource(i2);
        }
    }
    ...
    public void onClick(View view) {
        ...
        if (menuCallback != null && mode != null) {
            if (view.getId() == 16909219) {
                if ((mode.getMenu() instanceof MenuBuilder) && !menuCallback.onMenuItemSelected(mode.getMenu(), this.mOkMenuItem)) {
                    mode.finish();
                }
            } else if (view.getId() == 16908819 && (mode.getMenu() instanceof MenuBuilder) && !menuCallback.onMenuItemSelected(mode.getMenu(), this.mCancelMenuItem)) {
                mode.finish();
            }
        }
    }
    ...
    public void onLayout(boolean isChanged, int left, int top, int right, int bottom) {
        ...
        if (isChanged && getParent() != null && (getParent() instanceof ViewGroup) && (viewGroup = (ViewGroup) getParent()) != null && viewGroup.getId() != 16909427 && viewGroup.getId() != 16908712) {

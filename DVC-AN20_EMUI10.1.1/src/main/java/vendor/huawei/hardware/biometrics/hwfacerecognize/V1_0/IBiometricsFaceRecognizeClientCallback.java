...
public interface IBiometricsFaceRecognizeClientCallback extends IBase {
    public static final String kInterfaceName = "vendor.huawei.hardware.biometrics.hwfacerecognize@1.0::IBiometricsFaceRecognizeClientCallback";
    ...
    public static final class Proxy implements IBiometricsFaceRecognizeClientCallback {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.biometrics.hwfacerecognize@1.0::IBiometricsFaceRecognizeClientCallback]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IBiometricsFaceRecognizeClientCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{76, 78, -35, 67, 54, -32, -36, 65, -88, 18, 98, -48, 6, -40, -113, 116, 87, -82, -126, -103, -85, 72, 99, 44, 27, -84, 79, 56, -104, 117, -97, 51}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }

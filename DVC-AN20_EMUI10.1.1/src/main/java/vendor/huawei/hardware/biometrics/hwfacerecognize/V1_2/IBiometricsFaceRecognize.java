package vendor.huawei.hardware.biometrics.hwfacerecognize.V1_2;
...
public interface IBiometricsFaceRecognize extends vendor.huawei.hardware.biometrics.hwfacerecognize.V1_1.IBiometricsFaceRecognize {
    public static final String kInterfaceName = "vendor.huawei.hardware.biometrics.hwfacerecognize@1.2::IBiometricsFaceRecognize";
    ...
    public static final class Proxy implements IBiometricsFaceRecognize {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.biometrics.hwfacerecognize@1.2::IBiometricsFaceRecognize]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IBiometricsFaceRecognize {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IBiometricsFaceRecognize.kInterfaceName, vendor.huawei.hardware.biometrics.hwfacerecognize.V1_1.IBiometricsFaceRecognize.kInterfaceName, vendor.huawei.hardware.biometrics.hwfacerecognize.V1_0.IBiometricsFaceRecognize.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{41, 104, 34, 58, -74, 4, -16, 34, -99, -121, 17, -65, -68, -34, 84, -61, 101, 57, -12, -115, -85, 70, 92, 74, -16, 11, -85, -29, 7, -93, 36, 90}, new byte[]{9, -38, -59, -59, 57, -22, -67, 36, -112, 115, -98, 85, -88, 33, -36, 59, 102, 112, -61, 50, -14, 85, -8, -59, -57, -99, 115, -62, 110, -22, -63, 1}, new byte[]{-110, 116, -69, 10, -65, 40, 124, -41, -69, -96, 88, -10, -77, -18, -63, 6, -116, -8, -41, 36, 118, 13, -14, 12, -6, -62, -43, 29, -118, -115, 97, 41}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
            ...
            switch (_hidl_code) {
                ...
                case 20:
                    ...
                    getUvt(new IBiometricsFaceRecognize.getUvtCallback() {
                        /* class vendor.huawei.hardware.biometrics.hwfacerecognize.V1_2.IBiometricsFaceRecognize.Stub.AnonymousClass1 */
                ...
                case 22:
                    ...
                    getStatus(_hidl_request.readInt32(), new getStatusCallback() {
                        /* class vendor.huawei.hardware.biometrics.hwfacerecognize.V1_2.IBiometricsFaceRecognize.Stub.AnonymousClass2 */

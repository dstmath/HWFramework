...
public interface IBiometricsFaceRecognizeClientCallback extends vendor.huawei.hardware.biometrics.hwfacerecognize.V1_1.IBiometricsFaceRecognizeClientCallback {
    public static final String kInterfaceName = "vendor.huawei.hardware.biometrics.hwfacerecognize@1.2::IBiometricsFaceRecognizeClientCallback";
    ...
    public static final class Proxy implements IBiometricsFaceRecognizeClientCallback {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.biometrics.hwfacerecognize@1.2::IBiometricsFaceRecognizeClientCallback]@Proxy";
            }
        }

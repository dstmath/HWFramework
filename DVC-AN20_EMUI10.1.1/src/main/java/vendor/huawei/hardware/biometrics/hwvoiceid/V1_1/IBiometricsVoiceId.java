...
public interface IBiometricsVoiceId extends vendor.huawei.hardware.biometrics.hwvoiceid.V1_0.IBiometricsVoiceId {
    public static final String kInterfaceName = "vendor.huawei.hardware.biometrics.hwvoiceid@1.1::IBiometricsVoiceId";
    ...
    byte[] getAbility(byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) throws RemoteException;
    ...
    byte[] getUserStatus() throws RemoteException;
    ...
    int notifyLostState() throws RemoteException;
    ...
    byte setPubKey(byte[] bArr, byte[] bArr2, byte[] bArr3) throws RemoteException;
    ...
    public static final class Proxy implements IBiometricsVoiceId {
        ...
        @Override // vendor.huawei.hardware.biometrics.hwvoiceid.V1_1.IBiometricsVoiceId, vendor.huawei.hardware.biometrics.hwvoiceid.V1_0.IBiometricsVoiceId, android.hidl.base.V1_0.IBase
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.biometrics.hwvoiceid@1.1::IBiometricsVoiceId]@Proxy";
            }
        }
        ...
        public long setNotify(IBiometricsVoiceIdClientCallback clientCallback) throws RemoteException {
            ...
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.biometrics.hwvoiceid.V1_0.IBiometricsVoiceId.kInterfaceName);
        ...
        @Override // vendor.huawei.hardware.biometrics.hwvoiceid.V1_1.IBiometricsVoiceId
    ...
    public static abstract class Stub extends HwBinder implements IBiometricsVoiceId {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IBiometricsVoiceId.kInterfaceName, vendor.huawei.hardware.biometrics.hwvoiceid.V1_0.IBiometricsVoiceId.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-41, -62, 80, 79, 68, -24, 60, -62, -76, 102, 34, 87, -110, -71, -120, 26, -62, 10, 29, -124, -40, -125, 91, 120, 86, -94, -109, 25, -79, 94, 62, 98}, new byte[]{88, -52, -99, 55, 6, -72, -116, -30, -15, 64, 14, -3, 98, 11, -63, 11, 12, 50, -110, -33, 123, -28, 51, -106, -11, -106, 0, 70, -46, 77, 100, 49}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        /* JADX INFO: Multiple debug info for r3v14 byte[]: [D('_hidl_blob' android.os.HwBlob), D('headsetSn' byte[])] */
        /* JADX INFO: Multiple debug info for r4v12 byte[]: [D('_hidl_blob' android.os.HwBlob), D('headsetAbility' byte[])] */
        /* JADX INFO: Multiple debug info for r5v5 byte[]: [D('_hidl_blob' android.os.HwBlob), D('headsetWordList' byte[])] */
        /* JADX INFO: Multiple debug info for r0v60 byte[]: [D('pubKey' byte[]), D('_hidl_blob' android.os.HwBlob)] */
        /* JADX INFO: Multiple debug info for r1v42 byte[]: [D('_hidl_blob' android.os.HwBlob), D('signature' byte[])] */
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    _hidl_request.enforceInterface(vendor.huawei.hardware.biometrics.hwvoiceid.V1_0.IBiometricsVoiceId.kInterfaceName);

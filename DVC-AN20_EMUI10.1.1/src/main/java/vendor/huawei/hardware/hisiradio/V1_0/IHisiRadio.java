...
public interface IHisiRadio extends IBase {
    ...
    public static final class Proxy implements IHisiRadio {
        ...
        @Override // android.os.IHwInterface, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadio, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IHisiRadio {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{38, -77, -84, -126, -5, MidiConstants.STATUS_PITCH_BEND, 72, MidiConstants.STATUS_CHANNEL_PRESSURE, -104, 95, -21, 81, -122, -104, -77, 43, -19, -124, -92, -83, -82, 44, -4, -18, 83, -54, 26, MidiConstants.STATUS_SONG_POSITION, GsmAlphabet.GSM_EXTENDED_ESCAPE, GsmAlphabet.GSM_EXTENDED_ESCAPE, 103, -25}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        @Override // android.os.IHwBinder, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadio, android.internal.hidl.base.V1_0.IBase

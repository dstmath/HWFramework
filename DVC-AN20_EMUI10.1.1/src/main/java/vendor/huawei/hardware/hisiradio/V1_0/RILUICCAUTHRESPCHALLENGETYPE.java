...
public final class RILUICCAUTHRESPCHALLENGETYPE {
    public RILUICCAUTHCKTYPE ckData = new RILUICCAUTHCKTYPE();
    public RILUICCAUTHIKTYPE ikData = new RILUICCAUTHIKTYPE();
    public RILUICCAUTHRESTYPE resData = new RILUICCAUTHRESTYPE();

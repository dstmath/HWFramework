...
public interface IHisiRadioIndication extends vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioIndication {
    ...
    @Override // vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioIndication, android.os.IHwInterface, android.internal.hidl.base.V1_0.IBase
    IHwBinder asBinder();

    void currentHwSignalStrength_1_1(int i, HwSignalStrength_1_1 hwSignalStrength_1_1) throws RemoteException;

    @Override // vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioIndication, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IHisiRadioIndication {
        ...
        @Override // vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioIndication, android.os.IHwBinder, vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioIndication, android.internal.hidl.base.V1_0.IBase

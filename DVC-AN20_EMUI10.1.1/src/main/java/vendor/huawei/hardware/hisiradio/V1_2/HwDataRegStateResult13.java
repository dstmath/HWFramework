...
public final class HwDataRegStateResult13 {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != HwDataRegStateResult13.class) {
            return false;
        }
        HwDataRegStateResult13 other = (HwDataRegStateResult13) otherObject;
    ...
    public static final ArrayList<HwDataRegStateResult13> readVectorFromParcel(HwParcel parcel) {
        ArrayList<HwDataRegStateResult13> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 208), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            HwDataRegStateResult13 _hidl_vec_element = new HwDataRegStateResult13();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<HwDataRegStateResult13> _hidl_vec) {

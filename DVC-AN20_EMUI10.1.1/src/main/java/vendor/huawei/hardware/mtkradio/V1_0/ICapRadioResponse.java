...
public interface ICapRadioResponse extends IBase {
    public static final String kInterfaceName = "vendor.huawei.hardware.mtkradio@1.0::ICapRadioResponse";
    ...
    public static final class Proxy implements ICapRadioResponse {
        ...
        @Override // vendor.huawei.hardware.mtkradio.V1_0.ICapRadioResponse, android.os.IHwInterface, android.internal.hidl.base.V1_0.IBase
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.mtkradio@1.0::ICapRadioResponse]@Proxy";
            }
        }
        ...
        @Override // vendor.huawei.hardware.mtkradio.V1_0.ICapRadioResponse
        ...
        @Override // vendor.huawei.hardware.mtkradio.V1_0.ICapRadioResponse, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements ICapRadioResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ICapRadioResponse.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-47, BluetoothHidDevice.SUBCLASS1_KEYBOARD, -86, 77, -76, -102, 78, 29, 108, -22, -121, 26, 103, -65, 17, 92, 47, MidiConstants.STATUS_SONG_POSITION, 9, -75, -17, 24, -23, 50, 113, 65, -89, 126, 26, 57, 49, -111}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        @Override // vendor.huawei.hardware.mtkradio.V1_0.ICapRadioResponse, android.os.IHwBinder, android.internal.hidl.base.V1_0.IBase

...
public interface IRadioIndication extends android.hardware.radio.V1_0.IRadioIndication {
    ...
    public static final class Proxy implements IRadioIndication {
        ...
        @Override // vendor.huawei.hardware.radio.V1_0.IRadioIndication, android.os.IHwInterface, android.hardware.radio.V1_0.IRadioIndication, android.internal.hidl.base.V1_0.IBase
        ...
        @Override // vendor.huawei.hardware.radio.V1_0.IRadioIndication
        ...
        @Override // vendor.huawei.hardware.radio.V1_0.IRadioIndication, android.hardware.radio.V1_0.IRadioIndication, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IRadioIndication {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{10, 2, MidiConstants.STATUS_MIDI_TIME_CODE, -115, -127, 52, 97, 101, -2, -10, -77, 75, 91, -18, -121, -38, -2, -12, -100, -89, 45, -70, -61, -65, -50, -102, 39, -46, -45, 9, 29, MidiConstants.STATUS_MIDI_TIME_CODE}, new byte[]{92, -114, -5, -71, -60, 81, -91, -105, 55, -19, 44, 108, 32, 35, 10, -82, 71, 69, -125, -100, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 29, Byte.MIN_VALUE, -120, -42, -36, -55, 2, BluetoothHidDevice.ERROR_RSP_UNKNOWN, 82, -46, -59}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        @Override // vendor.huawei.hardware.radio.V1_0.IRadioIndication, android.os.IHwBinder, android.hardware.radio.V1_0.IRadioIndication, android.internal.hidl.base.V1_0.IBase
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 47:
                    ...
                    apDsFlowInfoReport(type13, apDsFlowInfo);
                    return;
                case 48:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    dsFlowInfoReport(type14, apDsFlowInfo2);
                    return;
                case 49:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    vsimOtaSmsReport(type15, vsimOtaSms);
                    return;
                case 50:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    imsHandoverInd(type16, imsHandover);
                    return;
                case 51:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    imsSrvStatusInd(type17, imsHandover2);
                    return;
                case 52:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    imsSuppSrvInd(type18, imsSuppSvcNofitication);
                    return;
                case 53:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    imsCallModifyInd(type19, imsCallModify);
                    return;
                case 54:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    imsCallModifyEndCauseInd(type20, imsModifyEndCause);
                    return;
                case 55:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    imsCallMtStatusInd(type21, imsCallMtStatus);
                    return;
                case 56:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                ...
                case 57:
                    ...
                    vtFlowInfoReport(type22, vtFlowInfo);
                    return;
                default:
                    switch (_hidl_code) {
                        case 256067662:

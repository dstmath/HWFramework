...
public interface IRadioResponse extends vendor.huawei.hardware.radio.V1_0.IRadioResponse {
    ...
    @Override // android.hardware.radio.V1_0.IRadioResponse, android.os.IHwInterface, vendor.huawei.hardware.radio.V1_0.IRadioResponse, android.internal.hidl.base.V1_0.IBase
    IHwBinder asBinder();

    @Override // android.hardware.radio.V1_0.IRadioResponse, vendor.huawei.hardware.radio.V1_0.IRadioResponse, android.internal.hidl.base.V1_0.IBase
    ...
    public static final class Proxy implements IRadioResponse {
        ...
        @Override // android.hardware.radio.V1_0.IRadioResponse, android.os.IHwInterface, vendor.huawei.hardware.radio.V1_1.IRadioResponse, vendor.huawei.hardware.radio.V1_0.IRadioResponse, android.internal.hidl.base.V1_0.IBase
        ...
        @Override // vendor.huawei.hardware.radio.V1_0.IRadioResponse
        ...
        @Override // vendor.huawei.hardware.radio.V1_1.IRadioResponse
        ...
        @Override // android.hardware.radio.V1_0.IRadioResponse, vendor.huawei.hardware.radio.V1_1.IRadioResponse, vendor.huawei.hardware.radio.V1_0.IRadioResponse, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IRadioResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IRadioResponse.kInterfaceName, vendor.huawei.hardware.radio.V1_0.IRadioResponse.kInterfaceName, android.hardware.radio.V1_0.IRadioResponse.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{107, -60, -47, 77, 38, 95, 25, -63, 48, 49, 60, -106, -71, -86, -34, 21, BluetoothHidDevice.ERROR_RSP_UNKNOWN, 94, 120, -102, -18, -58, -68, -95, -62, 111, 42, -1, -120, -90, -31, 37}, new byte[]{-52, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 0, -43, -38, -10, -77, -22, 5, 122, -89, 47, 26, 39, 9, 126, 31, 121, 21, 98, 29, 21, MidiConstants.STATUS_SONG_POSITION, -36, 18, 19, 126, 21, -33, 62, -49, -104}, new byte[]{29, 74, 87, 118, 97, 76, 8, -75, -41, -108, -91, -20, 90, MidiConstants.STATUS_CONTROL_CHANGE, 70, -105, 38, 12, -67, 75, 52, 65, -43, -109, 92, -43, 62, -25, 29, 25, -38, 2}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        @Override // android.hardware.radio.V1_0.IRadioResponse, android.os.IHwBinder, vendor.huawei.hardware.radio.V1_1.IRadioResponse, vendor.huawei.hardware.radio.V1_0.IRadioResponse, android.internal.hidl.base.V1_0.IBase
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 131:
                    ...
                    getDeviceVersionResponse(info130, deviceVersion);
                    return;
                case 132:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    getDsFlowInfoResponse(info131, dsFlowInfo);
                    return;
                case 133:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    getPolListResponse(info132, preferredplmnselector);
                    return;
                case 134:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    getSystemInfoExResponse(info133, sysInfo);
                    return;
                case 135:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    getCurrentImsCallsResponse(info134, RILImsCall.readVectorFromParcel(_hidl_request));
                    return;
                case 136:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    uiccAuthResponse(info135, uiccAuthRst);
                    return;
                case 137:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    getAvailableCsgIdsResponse(info136, CsgNetworkInfo.readVectorFromParcel(_hidl_request));
                    return;
                case 138:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    manualSelectionCsgIdResponse(info137);
                    return;
                case 139:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    setupDataCallEmergencyResponse(info138, dcResponse2);
                    return;
                case 140:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    deactivateDataCallEmergencyResponse(info139);
                    return;
                case 141:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    getCellInfoListOtdoaResponse(info140, CellInfo.readVectorFromParcel(_hidl_request));
                    return;
                case 142:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    getCurrentImsCallsWithImsDomainResponse(info141, RILImsCallEx.readVectorFromParcel(_hidl_request));
                    return;
                default:
                    switch (_hidl_code) {
                        case 256067662:

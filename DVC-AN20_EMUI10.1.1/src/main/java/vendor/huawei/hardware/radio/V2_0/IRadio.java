...
public interface IRadio extends IBase {
    ...
    public static final class Proxy implements IRadio {
        ...
        @Override // android.os.IHwInterface, vendor.huawei.hardware.radio.V2_0.IRadio, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IRadio {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-94, -127, 4, 66, -53, -87, -7, -46, -101, 52, Byte.MAX_VALUE, 9, -7, -114, -24, 57, -125, 36, -120, -119, -70, 82, 44, 121, -74, MidiConstants.STATUS_PITCH_BEND, 44, -93, -68, -79, -113, 112}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        @Override // android.os.IHwBinder, vendor.huawei.hardware.radio.V2_0.IRadio, android.internal.hidl.base.V1_0.IBase

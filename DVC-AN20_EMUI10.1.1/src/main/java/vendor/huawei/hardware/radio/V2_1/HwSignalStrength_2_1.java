...
public final class HwSignalStrength_2_1 {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != HwSignalStrength_2_1.class) {
            return false;
        }
        HwSignalStrength_2_1 other = (HwSignalStrength_2_1) otherObject;
    ...
    public static final ArrayList<HwSignalStrength_2_1> readVectorFromParcel(HwParcel parcel) {
        ArrayList<HwSignalStrength_2_1> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 96), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            HwSignalStrength_2_1 _hidl_vec_element = new HwSignalStrength_2_1();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<HwSignalStrength_2_1> _hidl_vec) {

...
public interface IRadioResponse extends vendor.huawei.hardware.radio.V2_0.IRadioResponse {
    public static final String kInterfaceName = "vendor.huawei.hardware.radio@2.1::IRadioResponse";
    ...
    void getHwDataRegistrationStateResponse_2_1(RadioResponseInfo radioResponseInfo, HwDataRegStateResult_2_1 hwDataRegStateResult_2_1) throws RemoteException;
    ...
    void getHwSignalStrengthResponse_2_1(RadioResponseInfo radioResponseInfo, HwSignalStrength_2_1 hwSignalStrength_2_1) throws RemoteException;
    ...
    public static final class Proxy implements IRadioResponse {
        ...
        @Override // vendor.huawei.hardware.radio.V2_1.IRadioResponse, android.os.IHwInterface, vendor.huawei.hardware.radio.V2_0.IRadioResponse, android.internal.hidl.base.V1_0.IBase
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.radio@2.1::IRadioResponse]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IRadioResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IRadioResponse.kInterfaceName, vendor.huawei.hardware.radio.V2_0.IRadioResponse.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        @Override // vendor.huawei.hardware.radio.V2_1.IRadioResponse, android.os.IHwBinder, vendor.huawei.hardware.radio.V2_0.IRadioResponse, android.internal.hidl.base.V1_0.IBase

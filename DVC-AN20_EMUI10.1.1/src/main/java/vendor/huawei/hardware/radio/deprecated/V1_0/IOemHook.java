...
public interface IOemHook extends IBase {
    ...
    static default IOemHook asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static default IOemHook castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static default IOemHook getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static default IOemHook getService(boolean retry) throws RemoteException {
        return getService(PhoneConstants.APN_TYPE_DEFAULT, retry);
    }

    static default IOemHook getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static default IOemHook getService() throws RemoteException {
    ...
    public static final class Proxy implements IOemHook {
        ...
        @Override // android.os.IHwInterface, vendor.huawei.hardware.radio.deprecated.V1_0.IOemHook, android.internal.hidl.base.V1_0.IBase
        ...
        @Override // vendor.huawei.hardware.radio.deprecated.V1_0.IOemHook, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IOemHook {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{22, -93, 1, 30, -37, 113, 41, 53, -73, -100, -66, 113, -45, -101, 59, -30, 48, -6, 75, 87, 119, -41, -125, MidiConstants.STATUS_CONTROL_CHANGE, 0, 7, 82, -127, -71, -72, -21, -89}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        @Override // android.os.IHwBinder, vendor.huawei.hardware.radio.deprecated.V1_0.IOemHook, android.internal.hidl.base.V1_0.IBase

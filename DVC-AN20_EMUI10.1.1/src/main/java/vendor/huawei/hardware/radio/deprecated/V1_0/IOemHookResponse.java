...
public interface IOemHookResponse extends IBase {
    ...
    static default IOemHookResponse asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static default IOemHookResponse castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static default IOemHookResponse getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static default IOemHookResponse getService(boolean retry) throws RemoteException {
        return getService(PhoneConstants.APN_TYPE_DEFAULT, retry);
    }

    static default IOemHookResponse getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static default IOemHookResponse getService() throws RemoteException {
    ...
    public static final class Proxy implements IOemHookResponse {
        ...
        @Override // android.os.IHwInterface, vendor.huawei.hardware.radio.deprecated.V1_0.IOemHookResponse, android.internal.hidl.base.V1_0.IBase
        ...
        @Override // vendor.huawei.hardware.radio.deprecated.V1_0.IOemHookResponse, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IOemHookResponse {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-63, 59, 85, 47, -50, 95, 98, -87, -70, -20, -5, 80, 72, 50, 57, 124, -73, Byte.MAX_VALUE, 115, 113, 59, 9, -103, 43, 40, -114, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 17, -6, -103, BluetoothHidDevice.ERROR_RSP_UNKNOWN, 95}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        @Override // android.os.IHwBinder, vendor.huawei.hardware.radio.deprecated.V1_0.IOemHookResponse, android.internal.hidl.base.V1_0.IBase

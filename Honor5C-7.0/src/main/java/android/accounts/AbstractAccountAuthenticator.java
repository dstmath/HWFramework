...
public abstract class AbstractAccountAuthenticator {
    ...
    class AnonymousClass1 implements Runnable {
        ...
        AnonymousClass1(AccountAuthenticatorResponse val$response) {
    ...
    class AnonymousClass2 implements Runnable {
        ...
        AnonymousClass2(AccountAuthenticatorResponse val$response) {
            this.val$response = val$response;
        }
    ...
    class AnonymousClass3 implements Runnable {
        ...
        AnonymousClass3(String val$authTokenType, String[] val$requiredFeatures, Bundle val$options, AccountAuthenticatorResponse val$response) {
        ...
        public void run() {
            ...
            sessionBundle.putString(AbstractAccountAuthenticator.KEY_AUTH_TOKEN_TYPE, this.val$authTokenType);
            sessionBundle.putStringArray(AbstractAccountAuthenticator.KEY_REQUIRED_FEATURES, this.val$requiredFeatures);
            sessionBundle.putBundle(AbstractAccountAuthenticator.KEY_OPTIONS, this.val$options);
            Bundle result = new Bundle();
    ...
    class AnonymousClass4 implements Runnable {
        ...
        AnonymousClass4(String val$authTokenType, Account val$account, Bundle val$options, AccountAuthenticatorResponse val$response) {
            this.val$authTokenType = val$authTokenType;
        ...
        public void run() {
            Bundle sessionBundle = new Bundle();
            sessionBundle.putString(AbstractAccountAuthenticator.KEY_AUTH_TOKEN_TYPE, this.val$authTokenType);
            sessionBundle.putParcelable(AbstractAccountAuthenticator.KEY_ACCOUNT, this.val$account);
            sessionBundle.putBundle(AbstractAccountAuthenticator.KEY_OPTIONS, this.val$options);
            Bundle result = new Bundle();
            result.putBundle(AccountManager.KEY_ACCOUNT_SESSION_BUNDLE, sessionBundle);
            this.val$response.onResult(result);
    ...
    public Bundle startAddAccountSession(AccountAuthenticatorResponse response, String accountType, String authTokenType, String[] requiredFeatures, Bundle options) throws NetworkErrorException {
        new Thread(new AnonymousClass3(authTokenType, requiredFeatures, options, response)).start();
        return null;
    }
    ...
    public Bundle startUpdateCredentialsSession(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws NetworkErrorException {
        new Thread(new AnonymousClass4(authTokenType, account, options, response)).start();
        return null;
    }

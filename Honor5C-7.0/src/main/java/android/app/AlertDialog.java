...
public class AlertDialog extends Dialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        public AlertDialog create() {
            AlertDialog dialog = new AlertDialog(this.P.mContext, (int) AlertDialog.LAYOUT_HINT_NONE, false);
    ...
    AlertDialog(Context context, int themeResId, boolean createContextThemeWrapper) {
        super(context, createContextThemeWrapper ? resolveDialogTheme(context, themeResId) : LAYOUT_HINT_NONE, createContextThemeWrapper);
    ...
    static int resolveDialogTheme(Context context, int themeResId) {
        ...
        if (themeResId == THEME_HOLO_DARK) {
            return 16974981;
        }
        if (themeResId == THEME_HOLO_LIGHT) {
            return 16974982;
        }
        if (themeResId == THEME_DEVICE_DEFAULT_DARK) {
            return R.style.Theme_DeviceDefault_Dialog_Alert;
        }
        if (themeResId == THEME_DEVICE_DEFAULT_LIGHT) {
            return R.style.Theme_DeviceDefault_Light_Dialog_Alert;
        }
        if (themeResId >= StrictMode.PENALTY_DEATH_ON_NETWORK) {
            return themeResId;
        }

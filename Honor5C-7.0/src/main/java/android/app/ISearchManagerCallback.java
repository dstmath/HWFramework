        ...
        private static class Proxy implements ISearchManagerCallback {
            ...
            public void onDismiss() throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onDismiss, _data, null, Stub.TRANSACTION_onDismiss);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onCancel() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_onCancel, _data, null, Stub.TRANSACTION_onDismiss);
                } finally {
                    _data.recycle();
                }
            }

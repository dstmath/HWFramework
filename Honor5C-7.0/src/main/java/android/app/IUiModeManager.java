        ...
        private static class Proxy implements IUiModeManager {
            ...
            public void enableCarMode(int flags) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_enableCarMode, _data, _reply, 0);
            ...
            public void disableCarMode(int flags) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(flags);
                    this.mRemote.transact(Stub.TRANSACTION_disableCarMode, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public int getCurrentModeType() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getCurrentModeType, _data, _reply, 0);
                    _reply.readException();
            ...
            public void setNightMode(int mode) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(mode);
                    this.mRemote.transact(Stub.TRANSACTION_setNightMode, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public int getNightMode() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getNightMode, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public boolean isUiModeLocked() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_isUiModeLocked, _data, _reply, 0);
                    _reply.readException();
            ...
            public boolean isNightModeLocked() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_isNightModeLocked, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_getNightMode /*5*/:
                    ...
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_isUiModeLocked /*6*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = isUiModeLocked();
                    reply.writeNoException();
                    if (_result2) {
                        i = TRANSACTION_enableCarMode;
                    }
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_isNightModeLocked /*7*/:
                    data.enforceInterface(DESCRIPTOR);

...
public interface IWallpaperManagerCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWallpaperManagerCallback {
        ...
        static final int TRANSACTION_onBlurWallpaperChanged = 2;
        ...
        private static class Proxy implements IWallpaperManagerCallback {
            ...
            public void onBlurWallpaperChanged() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_onBlurWallpaperChanged, _data, null, Stub.TRANSACTION_onWallpaperChanged);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_onWallpaperChanged /*1*/:
                    ...
                    onWallpaperChanged();
                    return true;
                case TRANSACTION_onBlurWallpaperChanged /*2*/:
                    data.enforceInterface(DESCRIPTOR);

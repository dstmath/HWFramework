...
public class NativeActivity extends Activity implements Callback2, Callback, OnGlobalLayoutListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ActivityInfo ai = getPackageManager().getActivityInfo(getIntent().getComponent(), KeymasterDefs.KM_ALGORITHM_HMAC);
            if (ai.metaData != null) {
            ...
            LogPower.push(BluetoothAssignedNumbers.STARKEY_LABORATORIES, getPackageName());
    ...
    protected void onDestroy() {
        ...
        super.onDestroy();
        LogPower.push(BluetoothAssignedNumbers.S_POWER_ELECTRONICS, getPackageName());
    }

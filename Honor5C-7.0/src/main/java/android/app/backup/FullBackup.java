...
public class FullBackup {
    ...
    public static class BackupScheme {
        ...
        String tokenToDirectoryPath(String domainToken) {
            try {
                ...
                if (!domainToken.equals(FullBackup.MANAGED_EXTERNAL_TREE_TOKEN)) {
                    ...
                    return null;
                } else if (this.EXTERNAL_DIR != null) {
        ...
        private String getTokenForXmlDomain(String xmlDomain) {
            ...
            if (WifiManager.EXTRA_PASSPOINT_ICON_FILE.equals(xmlDomain)) {
        ...
        private File getDirectoryForCriteriaDomain(String domain) {
            ...
            if (WifiManager.EXTRA_PASSPOINT_ICON_FILE.equals(domain)) {
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.app.backup.FullBackup.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.app.backup.FullBackup.<clinit>():void

        ...
        private static class Proxy implements IMultiTaskProcessObserver {
            ...
            public void onForegroundActivitiesChanged(int pid, int uid, boolean foregroundActivities) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_onForegroundActivitiesChanged, _data, _reply, 0);
            ...
            public void onProcessStateChanged(int pid, int uid, int procState) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onProcessStateChanged, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void onProcessDied(int pid, int uid) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(pid);
                    _data.writeInt(uid);
                    this.mRemote.transact(Stub.TRANSACTION_onProcessDied, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();

...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.bluetooth.BluetoothAvrcpPlayerSettings.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.bluetooth.BluetoothAvrcpPlayerSettings.<clinit>():void
...
*/
    ...
    private BluetoothAvrcpPlayerSettings(Parcel in) {
        ...
        for (int i = STATE_OFF; i < numSettings; i += STATE_ON) {

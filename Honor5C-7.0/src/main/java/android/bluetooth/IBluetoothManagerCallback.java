    ...
    public static abstract class Stub extends Binder implements IBluetoothManagerCallback {
        ...
        private static class Proxy implements IBluetoothManagerCallback {
            ...
            public void onBluetoothServiceUp(IBluetooth bluetoothService) throws RemoteException {
                ...
                try {
                    ...
                    if (bluetoothService != null) {
                        iBinder = bluetoothService.asBinder();
                    }
                    _data.writeStrongBinder(iBinder);
                    this.mRemote.transact(Stub.TRANSACTION_onBluetoothServiceUp, _data, null, Stub.TRANSACTION_onBluetoothServiceUp);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onBluetoothServiceDown() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_onBluetoothServiceDown, _data, null, Stub.TRANSACTION_onBluetoothServiceUp);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onBrEdrDown() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_onBrEdrDown, _data, null, Stub.TRANSACTION_onBluetoothServiceUp);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case TRANSACTION_onBluetoothServiceDown /*2*/:
                    ...
                    return true;
                case TRANSACTION_onBrEdrDown /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    onBrEdrDown();
                    return true;

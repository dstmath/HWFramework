...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.content.RestrictionEntry.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.content.RestrictionEntry.<clinit>():void
...
*/
    ...
    public RestrictionEntry(Parcel in) {
        ...
        if (parcelables != null) {
            ...
            for (int i = TYPE_NULL; i < parcelables.length; i += TYPE_BOOLEAN) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelableArray(this.mRestrictions, TYPE_NULL);
    }

...
public abstract class PackageManager {
    ...
    public static final int MATCH_EUID = 4194304;
    ...
    public PackageInfo getPackageArchiveInfo(String archiveFilePath, int flags) {
        ...
        try {
            Package pkg = parser.parseMonolithicPackage(apkFile, SIGNATURE_MATCH);
            if ((flags & INSTALL_ALL_USERS) != 0) {
                PackageParser.collectCertificates(pkg, SIGNATURE_MATCH);
            }
    ...
    public static boolean isMoveStatusFinished(int status) {
        return (status < 0 || status > 100) ? APPLY_DEFAULT_TO_DEVICE_PROTECTED_STORAGE : false;
    }
    ...
    public static String installStatusToString(int status) {
        switch (status) {
            ...
            case MOVE_FAILED_DEVICE_ADMIN /*-8*/:
    ...
    public static int installStatusToPublicStatus(int status) {
        switch (status) {
            case INSTALL_FAILED_ABORTED /*-115*/:
                return NOTIFY_PACKAGE_USE_BROADCAST_RECEIVER;
            case INSTALL_FAILED_NO_MATCHING_ABIS /*-113*/:
                return NOTIFY_PACKAGE_USE_INSTRUMENTATION;
            case INSTALL_FAILED_DUPLICATE_PERMISSION /*-112*/:
                return NOTIFY_PACKAGE_USE_BACKUP;
            case INSTALL_FAILED_USER_RESTRICTED /*-111*/:
                return NOTIFY_PACKAGE_USE_INSTRUMENTATION;
            case INSTALL_FAILED_INTERNAL_ERROR /*-110*/:
                return VERIFICATION_ALLOW;
            case INSTALL_PARSE_FAILED_MANIFEST_EMPTY /*-109*/:
                return ONLY_IF_NO_MATCH_FOUND;
            case INSTALL_PARSE_FAILED_MANIFEST_MALFORMED /*-108*/:
                return ONLY_IF_NO_MATCH_FOUND;
            case INSTALL_PARSE_FAILED_BAD_SHARED_USER_ID /*-107*/:
                return ONLY_IF_NO_MATCH_FOUND;
            ...
            case INSTALL_FAILED_VERIFICATION_TIMEOUT /*-21*/:
                return NOTIFY_PACKAGE_USE_BROADCAST_RECEIVER;
            case INSTALL_FAILED_MEDIA_UNAVAILABLE /*-20*/:
                return NOTIFY_PACKAGE_USE_CROSS_PACKAGE;
            case INSTALL_FAILED_INVALID_INSTALL_LOCATION /*-19*/:
                return NOTIFY_PACKAGE_USE_CROSS_PACKAGE;
            case INSTALL_FAILED_CONTAINER_ERROR /*-18*/:
                return NOTIFY_PACKAGE_USE_CROSS_PACKAGE;
    ...
    public static String permissionFlagToString(int flag) {
        switch (flag) {
            case VERIFICATION_ALLOW /*1*/:
                return "USER_SET";
            case VERIFICATION_ALLOW_WITHOUT_SUFFICIENT /*2*/:
                return "USER_FIXED";
            case ONLY_IF_NO_MATCH_FOUND /*4*/:
                return "POLICY_FIXED";
            case NOTIFY_PACKAGE_USE_REASONS_COUNT /*8*/:
                return "REVOKE_ON_UPGRADE";
            case INSTALL_INTERNAL /*16*/:
                return "SYSTEM_FIXED";
            case INSTALL_FROM_ADB /*32*/:
                return "GRANTED_BY_DEFAULT";
            case INSTALL_ALL_USERS /*64*/:

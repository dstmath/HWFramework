...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.content.pm.Signature.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.content.pm.Signature.<clinit>():void
...
*/
    ...
    private static final int parseHexDigit(int nibble) {
        ...
        if (97 <= nibble && nibble <= Ndef.TYPE_ICODE_SLI) {
            return (nibble - 97) + 10;
        }

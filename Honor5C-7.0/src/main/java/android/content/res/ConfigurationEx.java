...
public final class ConfigurationEx implements Comparable<Object>, IHwConfiguration {
    ...
    public void setDensityDPI(int dpi) {
        int oldDisplayDpi = SystemProperties.getInt("persist.sys.dpi", SystemProperties.getInt("ro.sf.lcd_density", 0));
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder(PduHeaders.VALUE_YES);
        if (this.hwtheme != 0) {
            sb.append(" hwt:");

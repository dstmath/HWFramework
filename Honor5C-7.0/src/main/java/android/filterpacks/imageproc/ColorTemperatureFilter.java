...
public class ColorTemperatureFilter extends Filter {
    ...
    public ColorTemperatureFilter(String name) {
        super(name);
        this.mScale = NetworkHistoryUtils.RECOVERY_PERCENTAGE;
        this.mTileSize = 640;
        this.mTarget = 0;
    ...
    private void updateParameters() {
        this.mProgram.setHostValue(BatteryManager.EXTRA_SCALE, Float.valueOf((this.mScale * 2.0f) - Engine.DEFAULT_VOLUME));
    }

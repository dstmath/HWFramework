...
public class SaturateFilter extends Filter {
    ...
    private void updateParameters() {
        if (this.mScale > 0.0f) {
            this.mHerfProgram.setHostValue("exponents", new float[]{(this.mScale * 0.9f) + Engine.DEFAULT_VOLUME, (this.mScale * 2.1f) + Engine.DEFAULT_VOLUME, (this.mScale * 2.7f) + Engine.DEFAULT_VOLUME});
            return;
        }
        this.mBenProgram.setHostValue(BatteryManager.EXTRA_SCALE, Float.valueOf(this.mScale + Engine.DEFAULT_VOLUME));
    }
}

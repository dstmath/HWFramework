...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.graphics.Rect.UnflattenHelper.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.graphics.Rect.UnflattenHelper.<clinit>():void
...
*/
    ...
    static {
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.graphics.Rect.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	at jadx.core.ProcessClass.processDependencies(ProcessClass.java:59)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.graphics.Rect.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 7 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 0073
...
*/
    ...
    public final float exactCenterX() {
        return ((float) (this.left + this.right)) * NetworkHistoryUtils.RECOVERY_PERCENTAGE;
    }

    public final float exactCenterY() {
        return ((float) (this.top + this.bottom)) * NetworkHistoryUtils.RECOVERY_PERCENTAGE;
    }
    ...
    public void scale(float scale) {
        if (scale != Engine.DEFAULT_VOLUME) {
            this.left = (int) ((((float) this.left) * scale) + NetworkHistoryUtils.RECOVERY_PERCENTAGE);
            this.top = (int) ((((float) this.top) * scale) + NetworkHistoryUtils.RECOVERY_PERCENTAGE);
            this.right = (int) ((((float) this.right) * scale) + NetworkHistoryUtils.RECOVERY_PERCENTAGE);
            this.bottom = (int) ((((float) this.bottom) * scale) + NetworkHistoryUtils.RECOVERY_PERCENTAGE);
        }
    }
}

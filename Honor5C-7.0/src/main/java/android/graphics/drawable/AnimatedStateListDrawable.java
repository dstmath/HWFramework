...
public class AnimatedStateListDrawable extends StateListDrawable {
    ...
    private static class FrameInterpolator implements TimeInterpolator {
        ...
        public float getInterpolation(float input) {
            float frameElapsed;
            int elapsed = (int) ((((float) this.mTotalDuration) * input) + NetworkHistoryUtils.RECOVERY_PERCENTAGE);
            int N = this.mFrames;
            int[] frameTimes = this.mFrameTimes;
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.graphics.drawable.AnimatedStateListDrawable.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.graphics.drawable.AnimatedStateListDrawable.<clinit>():void

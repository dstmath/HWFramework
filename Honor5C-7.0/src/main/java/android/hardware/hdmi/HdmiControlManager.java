...
public final class HdmiControlManager {
    ...
    class AnonymousClass1 extends Stub {
        ...
        AnonymousClass1(HotplugEventListener val$listener) {
    ...
    private static boolean hasDeviceType(int[] types, int type) {
        ...
        for (int i = TIMER_STATUS_MEDIA_INFO_PRESENT_NOT_PROTECTED; i < length; i += TIMER_STATUS_NOT_PROGRAMMED_NO_FREE_TIME) {
            if (types[i] == type) {
                return true;
            }
        }

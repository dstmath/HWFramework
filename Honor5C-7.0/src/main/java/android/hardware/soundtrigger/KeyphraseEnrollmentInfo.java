...
public class KeyphraseEnrollmentInfo {
    ...
    public KeyphraseEnrollmentInfo(PackageManager pm) {
        List<ResolveInfo> ris = pm.queryIntentActivities(new Intent(ACTION_MANAGE_VOICE_KEYPHRASES), Root.FLAG_EMPTY);
        ...
        for (ResolveInfo ri : ris) {
            try {
                ApplicationInfo ai = pm.getApplicationInfo(ri.activityInfo.packageName, KeymasterDefs.KM_ALGORITHM_HMAC);

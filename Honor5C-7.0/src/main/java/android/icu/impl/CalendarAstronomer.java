...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.icu.impl.CalendarAstronomer.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.icu.impl.CalendarAstronomer.<clinit>():void
...
*/
    ...
    private long lstToUT(double lst) {
        return ((long) (3600000.0d * normalize((lst - getSiderealOffset()) * 0.9972695663d, 24.0d))) + ((((this.time + this.fGmtOffset) / DAY_MS) * DAY_MS) - this.fGmtOffset);
    }
    ...
    public long getSunTime(double desired, boolean next) {
        ...
        }, desired, TROPICAL_YEAR, RelativeDateTimeFormatter.MINUTE_IN_MILLIS, next);
    }
    ...
    public long getSunRiseSet(boolean rise) {
        long t0 = this.time;
        setTime(((rise ? -6 : 6) * RelativeDateTimeFormatter.HOUR_IN_MILLIS) + (((((this.time + this.fGmtOffset) / DAY_MS) * DAY_MS) - this.fGmtOffset) + 43200000));
    ...
    public Equatorial getMoonPosition() {
        if (this.moonPosition == null) {
            ...
            double variation = 0.011489502465878671d * Math.sin((this.moonLongitude - sunLong) * 2.0d);
            ...
            this.moonEclipLong = Math.atan2(Math.cos(moonI) * y, x) + nodeLongitude;
    ...
    public long getMoonTime(double desired, boolean next) {
        ...
        }, desired, SYNODIC_MONTH, RelativeDateTimeFormatter.MINUTE_IN_MILLIS, next);
    }

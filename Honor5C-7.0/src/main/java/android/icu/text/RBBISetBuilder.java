...
class RBBISetBuilder {
        ...
        public int getFoldedValue(int start, int offset) {
            ...
            while (start < limit) {
                ...
                if (inBlockZero[0]) {
                    ...
                    return DateUtilsBridge.FORMAT_ABBREV_WEEKDAY | offset;
                } else {
                    start++;
                }
            }
    ...
    static class RangeDescriptor {
        ...
        void setDictionaryFlag() {
            for (int i = 0; i < this.fIncludesSets.size(); i++) {
                ...
                String setName = XmlPullParser.NO_NAMESPACE;
                ...
                if (setName.equals("dictionary")) {
                    this.fNum |= DateUtilsBridge.FORMAT_ABBREV_TIME;
                    return;
                }
            }
        }
    ...
    void build() {
        ...
        this.fRangeList.fEndChar = UnicodeSet.MAX_VALUE;
    ...
    void printRangeGroups() {
        ...
        for (RangeDescriptor rlRange = this.fRangeList; rlRange != null; rlRange = rlRange.fNext) {
            ...
            if (groupNum > lastPrintedGroupNum) {
                ...
                if ((rlRange.fNum & DateUtilsBridge.FORMAT_ABBREV_TIME) != 0) {

...
class UnicodeNameTransliterator extends Transliterator {
    ...
    public void addSourceTargetSet(UnicodeSet inputFilter, UnicodeSet sourceSet, UnicodeSet targetSet) {
        ...
        if (myFilter.size() > 0) {
            ...
            targetSet.addAll(48, 57).addAll(65, 90).add(45).add(32).addAll(OPEN_DELIM).add((int) Opcodes.OP_NEG_LONG).addAll(97, UScript.INSCRIPTIONAL_PAHLAVI).add(60).add(62).add(40).add(41);
        }
    }
}

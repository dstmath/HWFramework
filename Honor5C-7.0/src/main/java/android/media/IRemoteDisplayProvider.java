        ...
        private static class Proxy implements IRemoteDisplayProvider {
            ...
            public void setDiscoveryMode(int mode) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(mode);
                    this.mRemote.transact(Stub.TRANSACTION_setDiscoveryMode, _data, null, Stub.TRANSACTION_setCallback);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void connect(String id) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_connect, _data, null, Stub.TRANSACTION_setCallback);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void disconnect(String id) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(id);
                    this.mRemote.transact(Stub.TRANSACTION_disconnect, _data, null, Stub.TRANSACTION_setCallback);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void setVolume(String id, int volume) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setVolume, _data, null, Stub.TRANSACTION_setCallback);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void adjustVolume(String id, int delta) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_adjustVolume, _data, null, Stub.TRANSACTION_setCallback);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_setCallback /*1*/:
                    ...
                    return true;
                case TRANSACTION_setDiscoveryMode /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_setVolume /*5*/:
                    ...
                    return true;
                case TRANSACTION_adjustVolume /*6*/:
                    data.enforceInterface(DESCRIPTOR);

...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.net.SSLCertificateSocketFactory.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.net.SSLCertificateSocketFactory.<clinit>():void
...
*/
    ...
    static byte[] toLengthPrefixedList(byte[]... items) {
        ...
        int totalLength = 0;
        for (byte[] s : items) {
            if (s.length == 0 || s.length > Process.PROC_TERM_MASK) {

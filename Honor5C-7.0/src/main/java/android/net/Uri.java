...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.net.Uri.Part.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.net.Uri.Part.<clinit>():void
...
*/
    ...
    static class PathPart extends AbstractPart {
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.net.Uri.PathPart.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.net.Uri.PathPart.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 0073
...
*/
    ...
    static class PathSegments extends AbstractList<String> implements RandomAccess {
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.net.Uri.PathSegments.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.net.Uri.PathSegments.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 0073
...
*/
    ...
    private static class StringUri extends AbstractHierarchicalUri {
        ...
        private String parseSsp() {
            ...
            if (fsi == Uri.NOT_FOUND) {
                return this.uriString.substring(ssi + TYPE_ID);
            }
            return this.uriString.substring(ssi + TYPE_ID, fsi);
        }
    ...
    static {
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.net.Uri.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	at jadx.core.ProcessClass.processDependencies(ProcessClass.java:59)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.net.Uri.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 7 more
...
*/
    ...
    public String toSafeString() {
        ...
        if (scheme != null) {
            if (scheme.equalsIgnoreCase("tel") || scheme.equalsIgnoreCase(PhoneLookup.QUERY_PARAMETER_SIP_ADDRESS) || scheme.equalsIgnoreCase("sms") || scheme.equalsIgnoreCase("smsto") || scheme.equalsIgnoreCase("mailto") || scheme.equalsIgnoreCase(System.RADIO_NFC)) {
                ...
                ssp = "//" + (getHost() != null ? getHost() : ProxyInfo.LOCAL_EXCL_LIST) + (getPort() != NOT_FOUND ? ":" + getPort() : ProxyInfo.LOCAL_EXCL_LIST) + "/...";
            }
        }
        builder = new StringBuilder(64);
        if (scheme != null) {
    ...
    public static Uri fromFile(File file) {
        if (file == null) {
            throw new NullPointerException(WifiManager.EXTRA_PASSPOINT_ICON_FILE);
        }
    ...
    public Set<String> getQueryParameterNames() {
        ...
        do {
            ...
            int end = next == NOT_FOUND ? query.length() : next;
    ...
    public String getQueryParameter(String key) {
        if (isOpaque()) {
            ...
            while (true) {
                int nextAmpersand = query.indexOf(38, start);
                end = nextAmpersand != NOT_FOUND ? nextAmpersand : length;
            ...
            if (nextToEncode != oldLength) {
                ...
                try {
                    ...
                    for (int i = 0; i < bytesLength; i++) {
                        encoded.append('%');
                        encoded.append(HEX_DIGITS[(bytes[i] & NetworkPolicyManager.MASK_ALL_NETWORKS) >> 4]);
    ...
    private static boolean isAllowed(char c, String allow) {
        ...
        if ((c >= '0' && c <= '9') || "_-!.~'()*".indexOf(c) != NOT_FOUND) {
            return true;
        }
        if (allow == null || allow.indexOf(c) == NOT_FOUND) {
            return false;
        }
        return true;
    }
    ...
    public Uri getCanonicalUri() {
        if (!WifiManager.EXTRA_PASSPOINT_ICON_FILE.equals(getScheme())) {
            return this;
        }
        try {
    ...
    public void checkFileUriExposed(String location) {
        if (WifiManager.EXTRA_PASSPOINT_ICON_FILE.equals(getScheme()) && !getPath().startsWith("/system/")) {

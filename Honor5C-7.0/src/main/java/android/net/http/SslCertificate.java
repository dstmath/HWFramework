...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.net.http.SslCertificate.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.net.http.SslCertificate.<clinit>():void
...
*/
    ...
    public View inflateCertificateView(Context context) {
        View certificateView = LayoutInflater.from(context).inflate(17367272, null);
        DName issuedTo = getIssuedTo();
        if (issuedTo != null) {
            ((TextView) certificateView.findViewById(16909320)).setText(issuedTo.getCName());
            ((TextView) certificateView.findViewById(16909322)).setText(issuedTo.getOName());
            ((TextView) certificateView.findViewById(16909324)).setText(issuedTo.getUName());
        }
        ((TextView) certificateView.findViewById(16909326)).setText(getSerialNumber(this.mX509Certificate));
        DName issuedBy = getIssuedBy();
        if (issuedBy != null) {
            ((TextView) certificateView.findViewById(16909328)).setText(issuedBy.getCName());
            ((TextView) certificateView.findViewById(16909330)).setText(issuedBy.getOName());
            ((TextView) certificateView.findViewById(16909332)).setText(issuedBy.getUName());
        }
        ((TextView) certificateView.findViewById(16909335)).setText(formatCertificateDate(context, getValidNotBeforeDate()));
        ((TextView) certificateView.findViewById(16909337)).setText(formatCertificateDate(context, getValidNotAfterDate()));
        ((TextView) certificateView.findViewById(16909340)).setText(getDigest(this.mX509Certificate, "SHA256"));
        ((TextView) certificateView.findViewById(16909342)).setText(getDigest(this.mX509Certificate, "SHA1"));

...
public class WifiDetectConfInfo implements Parcelable {
    public static final Creator<WifiDetectConfInfo> CREATOR = null;
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.net.wifi.WifiDetectConfInfo.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.net.wifi.WifiDetectConfInfo.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.net.wifi.WifiDetectConfInfo.<clinit>():void");
    }

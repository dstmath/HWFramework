...
public class HealthKeys {
    ...
    public static class Constants {
        ...
        public Constants(Class clazz) {
            int i;
            this.mKeys = new int[HealthKeys.TYPE_COUNT][];
            ...
            for (i = HealthKeys.TYPE_TIMER; i < keys.length; i += HealthKeys.TYPE_MEASUREMENT) {
                keys[i] = new SortedIntArray(N);
            }
            for (i = HealthKeys.TYPE_TIMER; i < N; i += HealthKeys.TYPE_MEASUREMENT) {
    ...
    private static class SortedIntArray {
        ...
        void addValue(int value) {
            ...
            int i = this.mCount;
            this.mCount = i + HealthKeys.TYPE_MEASUREMENT;
            iArr[i] = value;
        }
        ...
        int[] getArray() {
            ...
            System.arraycopy(this.mArray, HealthKeys.TYPE_TIMER, result, HealthKeys.TYPE_TIMER, this.mCount);
            Arrays.sort(result);
            return result;
        }
    }

...
public class TextArrowPreference extends Preference {
    ...
    protected void onBindView(View view) {
        ...
        View imageFrame = view.findViewById(34603122);
        if (imageFrame != null) {
            if (getIcon() != null) {
                i = 0;
            } else {
        ...
        TextView netherSummaryView = (TextView) view.findViewById(34603164);
        ...
        View title_frame = view.findViewById(34603163);
        if (title_frame != null) {
        ...
        TextView detailView = (TextView) view.findViewById(34603165);
        if (detailView != null) {
        ...
        View arrowWidgetView = view.findViewById(34603162);
    ...
    public void setNetherSummary(CharSequence netherSummary) {
        if (netherSummary != null || this.mNetherSummary == null) {
            if (netherSummary == null) {
                return;
            }
            if (netherSummary.equals(this.mNetherSummary)) {
                return;
            }
        }
    ...
    private void adjustLayoutPadding(View view) {
        ...
        int padding_tb_threelines = dp2pixel(PADDING_TOP_BOTTOM_THREELINES);

        ...
        private static class Proxy implements ILayoutResultCallback {
            ...
            public void onLayoutStarted(ICancellationSignal cancellation, int sequence) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onLayoutStarted, _data, null, Stub.TRANSACTION_onLayoutStarted);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onLayoutFinished(PrintDocumentInfo info, boolean changed, int sequence) throws RemoteException {
                int i = Stub.TRANSACTION_onLayoutStarted;
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (info != null) {
                        _data.writeInt(Stub.TRANSACTION_onLayoutStarted);
                    ...
                    _data.writeInt(i);
                    _data.writeInt(sequence);
                    this.mRemote.transact(Stub.TRANSACTION_onLayoutFinished, _data, null, Stub.TRANSACTION_onLayoutStarted);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onLayoutFailed(CharSequence error, int sequence) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(sequence);
                    this.mRemote.transact(Stub.TRANSACTION_onLayoutFailed, _data, null, Stub.TRANSACTION_onLayoutStarted);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onLayoutCanceled(int sequence) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(sequence);
                    this.mRemote.transact(Stub.TRANSACTION_onLayoutCanceled, _data, null, Stub.TRANSACTION_onLayoutStarted);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case TRANSACTION_onLayoutFinished /*2*/:
                    ...
                    return true;
                case TRANSACTION_onLayoutFailed /*3*/:
                    ...
                    return true;
                case TRANSACTION_onLayoutCanceled /*4*/:
                    data.enforceInterface(DESCRIPTOR);

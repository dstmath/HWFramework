...
public abstract class SearchIndexablesProvider extends ContentProvider {
    ...
    public void attachInfo(Context context, ProviderInfo info) {
        ...
        this.mMatcher.addURI(this.mAuthority, SearchIndexablesContract.INDEXABLES_XML_RES_PATH, MATCH_RES_CODE);
        this.mMatcher.addURI(this.mAuthority, SearchIndexablesContract.INDEXABLES_RAW_PATH, MATCH_RAW_CODE);
        this.mMatcher.addURI(this.mAuthority, SearchIndexablesContract.NON_INDEXABLES_KEYS_PATH, MATCH_NON_INDEXABLE_KEYS_CODE);
        if (!info.exported) {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        switch (this.mMatcher.match(uri)) {
            case MATCH_RES_CODE /*1*/:
                return queryXmlResources(null);
            case MATCH_RAW_CODE /*2*/:
                return queryRawData(null);
            case MATCH_NON_INDEXABLE_KEYS_CODE /*3*/:

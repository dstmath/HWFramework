...
public final class ScriptIntrinsicBLAS extends ScriptIntrinsic {
    ...
    static void validateGEMV(Element e, int TransA, Allocation A, Allocation X, int incX, Allocation Y, int incY) {
        ...
        if (!A.getType().getElement().isCompatible(e) || !X.getType().getElement().isCompatible(e) || !Y.getType().getElement().isCompatible(e)) {
        ...
        } else if (X.getType().getY() > RsBlas_sdsdot || Y.getType().getY() > RsBlas_sdsdot) {
            ...
            int expectedXDim;
            int expectedYDim;
            if (TransA == RsBlas_zher2) {
                expectedXDim = ((N - 1) * incX) + RsBlas_sdsdot;
                expectedYDim = ((M - 1) * incY) + RsBlas_sdsdot;
            } else {
                expectedXDim = ((M - 1) * incX) + RsBlas_sdsdot;
                expectedYDim = ((N - 1) * incY) + RsBlas_sdsdot;
            }
    ...
    public void SGEMV(int TransA, float alpha, Allocation A, Allocation X, int incX, float beta, Allocation Y, int incY) {
        ...
        float f = alpha;
        float f2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_sgemv, i, 0, 0, 0, 0, M, N, 0, f, A.getID(this.mRS), X.getID(this.mRS), f2, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void DGEMV(int TransA, double alpha, Allocation A, Allocation X, int incX, double beta, Allocation Y, int incY) {
        ...
        double d = alpha;
        double d2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dgemv, i, 0, 0, 0, 0, M, N, 0, d, A.getID(this.mRS), X.getID(this.mRS), d2, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void CGEMV(int TransA, Float2 alpha, Allocation A, Allocation X, int incX, Float2 beta, Allocation Y, int incY) {
        ...
        int N = A.getType().getX();
        int i = TransA;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_cgemv, i, 0, 0, 0, 0, M, N, 0, alpha.x, alpha.y, A.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZGEMV(int TransA, Double2 alpha, Allocation A, Allocation X, int incX, Double2 beta, Allocation Y, int incY) {
        ...
        int N = A.getType().getX();
        int i = TransA;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zgemv, i, 0, 0, 0, 0, M, N, 0, alpha.x, alpha.y, A.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void SGBMV(int TransA, int KL, int KU, float alpha, Allocation A, Allocation X, int incX, float beta, Allocation Y, int incY) {
        ...
        float f = alpha;
        float f2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_sgbmv, i, 0, 0, 0, 0, M, N, 0, f, A.getID(this.mRS), X.getID(this.mRS), f2, Y.getID(this.mRS), incX, incY, KL, KU);
    }
    ...
    public void DGBMV(int TransA, int KL, int KU, double alpha, Allocation A, Allocation X, int incX, double beta, Allocation Y, int incY) {
        ...
        double d = alpha;
        double d2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dgbmv, i, 0, 0, 0, 0, M, N, 0, d, A.getID(this.mRS), X.getID(this.mRS), d2, Y.getID(this.mRS), incX, incY, KL, KU);
    }
    ...
    public void CGBMV(int TransA, int KL, int KU, Float2 alpha, Allocation A, Allocation X, int incX, Float2 beta, Allocation Y, int incY) {
        ...
        int N = A.getType().getX();
        int i = TransA;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_cgbmv, i, 0, 0, 0, 0, M, N, 0, alpha.x, alpha.y, A.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, KL, KU);
    }
    ...
    public void ZGBMV(int TransA, int KL, int KU, Double2 alpha, Allocation A, Allocation X, int incX, Double2 beta, Allocation Y, int incY) {
        ...
        int N = A.getType().getX();
        int i = TransA;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zgbmv, i, 0, 0, 0, 0, M, N, 0, alpha.x, alpha.y, A.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, KL, KU);
    }
    ...
    static void validateTRMV(Element e, int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        ...
        if (A.getType().getX() != N) {
            ...
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        } else if (X.getType().getY() > RsBlas_sdsdot) {
            throw new RSRuntimeException("BLAS vectors must have Y dimension of 0 or 1");
        } else if (incX <= 0) {
            throw new RSRuntimeException("Vector increments must be greater than 0");
        } else {
            if (X.getType().getX() != ((N - 1) * incX) + RsBlas_sdsdot) {
    ...
    public void STRMV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_strmv, i, 0, 0, i2, i3, 0, N, 0, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0, incX, 0, 0, 0);
    }
    ...
    public void DTRMV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dtrmv, i, 0, 0, i2, i3, 0, N, 0, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void CTRMV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_ctrmv, i, 0, 0, i2, i3, 0, N, 0, 0.0f, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0.0f, 0, incX, 0, 0, 0);
    }
    ...
    public void ZTRMV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_ztrmv, i, 0, 0, i2, i3, 0, N, 0, 0.0d, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void STBMV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        int i3 = Diag;
        int i4 = K;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_stbmv, i, 0, 0, i2, i3, 0, N, i4, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0, incX, 0, 0, 0);
    }
    ...
    public void DTBMV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        int i3 = Diag;
        int i4 = K;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dtbmv, i, 0, 0, i2, i3, 0, N, i4, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void CTBMV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        int i3 = Diag;
        int i4 = K;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_ctbmv, i, 0, 0, i2, i3, 0, N, i4, 0.0f, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0.0f, 0, incX, 0, 0, 0);
    }
    ...
    public void ZTBMV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        int i3 = Diag;
        int i4 = K;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_ztbmv, i, 0, 0, i2, i3, 0, N, i4, 0.0d, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void STPMV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_stpmv, i, 0, 0, i2, i3, 0, N, 0, 0.0f, Ap.getID(this.mRS), X.getID(this.mRS), 0.0f, 0, incX, 0, 0, 0);
    }
    ...
    public void DTPMV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dtpmv, i, 0, 0, i2, i3, 0, N, 0, 0.0d, Ap.getID(this.mRS), X.getID(this.mRS), 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void CTPMV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_ctpmv, i, 0, 0, i2, i3, 0, N, 0, 0.0f, 0.0f, Ap.getID(this.mRS), X.getID(this.mRS), 0.0f, 0.0f, 0, incX, 0, 0, 0);
    }
    ...
    public void ZTPMV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_ztpmv, i, 0, 0, i2, i3, 0, N, 0, 0.0d, 0.0d, Ap.getID(this.mRS), X.getID(this.mRS), 0.0d, 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void STRSV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_strsv, i, 0, 0, i2, i3, 0, N, 0, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0, incX, 0, 0, 0);
    }
    ...
    public void DTRSV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dtrsv, i, 0, 0, i2, i3, 0, N, 0, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void CTRSV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_ctrsv, i, 0, 0, i2, i3, 0, N, 0, 0.0f, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0.0f, 0, incX, 0, 0, 0);
    }
    ...
    public void ZTRSV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_ztrsv, i, 0, 0, i2, i3, 0, N, 0, 0.0d, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void STBSV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        int i3 = Diag;
        int i4 = K;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_stbsv, i, 0, 0, i2, i3, 0, N, i4, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0, incX, 0, 0, 0);
    }
    ...
    public void DTBSV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        int i3 = Diag;
        int i4 = K;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dtbsv, i, 0, 0, i2, i3, 0, N, i4, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void CTBSV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        int i3 = Diag;
        int i4 = K;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_ctbsv, i, 0, 0, i2, i3, 0, N, i4, 0.0f, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0.0f, 0, incX, 0, 0, 0);
    }
    ...
    public void ZTBSV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        int i3 = Diag;
        int i4 = K;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_ztbsv, i, 0, 0, i2, i3, 0, N, i4, 0.0d, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void STPSV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_stpsv, i, 0, 0, i2, i3, 0, N, 0, 0.0f, Ap.getID(this.mRS), X.getID(this.mRS), 0.0f, 0, incX, 0, 0, 0);
    }
    ...
    public void DTPSV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dtpsv, i, 0, 0, i2, i3, 0, N, 0, 0.0d, Ap.getID(this.mRS), X.getID(this.mRS), 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void CTPSV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_ctpsv, i, 0, 0, i2, i3, 0, N, 0, 0.0f, 0.0f, Ap.getID(this.mRS), X.getID(this.mRS), 0.0f, 0.0f, 0, incX, 0, 0, 0);
    }
    ...
    public void ZTPSV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        ...
        int i2 = Uplo;
        int i3 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_ztpsv, i, 0, 0, i2, i3, 0, N, 0, 0.0d, 0.0d, Ap.getID(this.mRS), X.getID(this.mRS), 0.0d, 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    static int validateSYMV(Element e, int Uplo, Allocation A, Allocation X, Allocation Y, int incX, int incY) {
        ...
        if (A.getType().getX() != N) {
            ...
            if (Y.getType().getX() == ((N - 1) * incY) + RsBlas_sdsdot) {
                return N;
            }
            throw new RSRuntimeException("Incorrect vector dimensions for SYMV");
        }
    ...
    static void validateGER(Element e, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        if (!A.getType().getElement().isCompatible(e) || !X.getType().getElement().isCompatible(e) || !Y.getType().getElement().isCompatible(e)) {
            ...
            int M = A.getType().getY();
            int N = A.getType().getX();
            if (N < RsBlas_sdsdot || M < RsBlas_sdsdot) {
                throw new RSRuntimeException("M and N must be 1 or greater for GER");
            } else if (incX <= 0 || incY <= 0) {
                throw new RSRuntimeException("Vector increments must be greater than 0");
            } else {
                if (X.getType().getX() != ((M - 1) * incX) + RsBlas_sdsdot) {
    ...
    static int validateSYR(Element e, int Uplo, Allocation X, int incX, Allocation A) {
        ...
        if (A.getType().getElement().isCompatible(e) && X.getType().getElement().isCompatible(e)) {
            int N = A.getType().getX();
            if (X.getType().getY() > RsBlas_sdsdot) {
                throw new RSRuntimeException("BLAS vectors must have Y dimension of 0 or 1");
    ...
    static int validateSYR2(Element e, int Uplo, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        if (!A.getType().getElement().isCompatible(e) || !X.getType().getElement().isCompatible(e) || !Y.getType().getElement().isCompatible(e)) {
            ...
            if (N != A.getType().getY()) {
                ...
                int expectedYDim = ((N - 1) * incY) + RsBlas_sdsdot;
                if (X.getType().getX() == ((N - 1) * incX) + RsBlas_sdsdot && Y.getType().getX() == expectedYDim) {
                    return N;
                }
                throw new RSRuntimeException("Incorrect vector dimensions for SYR");
            }
    ...
    public void SSYMV(int Uplo, float alpha, Allocation A, Allocation X, int incX, float beta, Allocation Y, int incY) {
        ...
        float f = alpha;
        float f2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_ssymv, 0, 0, 0, i, 0, 0, N, 0, f, A.getID(this.mRS), X.getID(this.mRS), f2, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void SSBMV(int Uplo, int K, float alpha, Allocation A, Allocation X, int incX, float beta, Allocation Y, int incY) {
        ...
        float f = alpha;
        float f2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_ssbmv, 0, 0, 0, i, 0, 0, N, i2, f, A.getID(this.mRS), X.getID(this.mRS), f2, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void SSPMV(int Uplo, float alpha, Allocation Ap, Allocation X, int incX, float beta, Allocation Y, int incY) {
        ...
        float f = alpha;
        float f2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_sspmv, 0, 0, 0, i, 0, 0, N, 0, f, Ap.getID(this.mRS), X.getID(this.mRS), f2, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void SGER(float alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        float f = alpha;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_sger, 0, 0, 0, 0, 0, M, N, 0, f, X.getID(this.mRS), Y.getID(this.mRS), 0.0f, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void SSYR(int Uplo, float alpha, Allocation X, int incX, Allocation A) {
        ...
        int i = Uplo;
        float f = alpha;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_ssyr, 0, 0, 0, i, 0, 0, N, 0, f, X.getID(this.mRS), A.getID(this.mRS), 0.0f, 0, incX, 0, 0, 0);
    }
    ...
    public void SSPR(int Uplo, float alpha, Allocation X, int incX, Allocation Ap) {
        ...
        int i = Uplo;
        float f = alpha;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_sspr, 0, 0, 0, i, 0, 0, N, 0, f, X.getID(this.mRS), Ap.getID(this.mRS), 0.0f, 0, incX, 0, 0, 0);
    }
    ...
    public void SSYR2(int Uplo, float alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        int i = Uplo;
        float f = alpha;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_ssyr2, 0, 0, 0, i, 0, 0, N, 0, f, X.getID(this.mRS), Y.getID(this.mRS), 0.0f, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void SSPR2(int Uplo, float alpha, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
        ...
        int i = Uplo;
        float f = alpha;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_sspr2, 0, 0, 0, i, 0, 0, N, 0, f, X.getID(this.mRS), Y.getID(this.mRS), 0.0f, Ap.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void DSYMV(int Uplo, double alpha, Allocation A, Allocation X, int incX, double beta, Allocation Y, int incY) {
        ...
        double d = alpha;
        double d2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dsymv, 0, 0, 0, i, 0, 0, N, 0, d, A.getID(this.mRS), X.getID(this.mRS), d2, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void DSBMV(int Uplo, int K, double alpha, Allocation A, Allocation X, int incX, double beta, Allocation Y, int incY) {
        ...
        double d = alpha;
        double d2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dsbmv, 0, 0, 0, i, 0, 0, N, i2, d, A.getID(this.mRS), X.getID(this.mRS), d2, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void DSPMV(int Uplo, double alpha, Allocation Ap, Allocation X, int incX, double beta, Allocation Y, int incY) {
        ...
        double d = alpha;
        double d2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dspmv, 0, 0, 0, i, 0, 0, N, 0, d, Ap.getID(this.mRS), X.getID(this.mRS), d2, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void DGER(double alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        double d = alpha;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dger, 0, 0, 0, 0, 0, M, N, 0, d, X.getID(this.mRS), Y.getID(this.mRS), 0.0d, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void DSYR(int Uplo, double alpha, Allocation X, int incX, Allocation A) {
        ...
        int i = Uplo;
        double d = alpha;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dsyr, 0, 0, 0, i, 0, 0, N, 0, d, X.getID(this.mRS), A.getID(this.mRS), 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void DSPR(int Uplo, double alpha, Allocation X, int incX, Allocation Ap) {
        ...
        int i = Uplo;
        double d = alpha;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dspr, 0, 0, 0, i, 0, 0, N, 0, d, X.getID(this.mRS), Ap.getID(this.mRS), 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void DSYR2(int Uplo, double alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        int i = Uplo;
        double d = alpha;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dsyr2, 0, 0, 0, i, 0, 0, N, 0, d, X.getID(this.mRS), Y.getID(this.mRS), 0.0d, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void DSPR2(int Uplo, double alpha, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
        ...
        int i = Uplo;
        double d = alpha;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dspr2, 0, 0, 0, i, 0, 0, N, 0, d, X.getID(this.mRS), Y.getID(this.mRS), 0.0d, Ap.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void CHEMV(int Uplo, Float2 alpha, Allocation A, Allocation X, int incX, Float2 beta, Allocation Y, int incY) {
        ...
        int i = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_chemv, 0, 0, 0, i, 0, 0, N, 0, alpha.x, alpha.y, A.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void CHBMV(int Uplo, int K, Float2 alpha, Allocation A, Allocation X, int incX, Float2 beta, Allocation Y, int incY) {
        ...
        int i = Uplo;
        int i2 = K;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_chbmv, 0, 0, 0, i, 0, 0, N, i2, alpha.x, alpha.y, A.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void CHPMV(int Uplo, Float2 alpha, Allocation Ap, Allocation X, int incX, Float2 beta, Allocation Y, int incY) {
        ...
        int i = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_chpmv, 0, 0, 0, i, 0, 0, N, 0, alpha.x, alpha.y, Ap.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void CGERU(Float2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        int M = A.getType().getY();
        int N = A.getType().getX();
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_cgeru, 0, 0, 0, 0, 0, M, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), 0.0f, 0.0f, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void CGERC(Float2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        int M = A.getType().getY();
        int N = A.getType().getX();
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_cgerc, 0, 0, 0, 0, 0, M, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), 0.0f, 0.0f, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void CHER(int Uplo, float alpha, Allocation X, int incX, Allocation A) {
        ...
        int i = Uplo;
        float f = alpha;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_cher, 0, 0, 0, i, 0, 0, N, 0, f, 0.0f, X.getID(this.mRS), 0, 0.0f, 0.0f, A.getID(this.mRS), incX, 0, 0, 0);
    }
    ...
    public void CHPR(int Uplo, float alpha, Allocation X, int incX, Allocation Ap) {
        ...
        int i = Uplo;
        float f = alpha;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_chpr, 0, 0, 0, i, 0, 0, N, 0, f, 0.0f, X.getID(this.mRS), 0, 0.0f, 0.0f, Ap.getID(this.mRS), incX, 0, 0, 0);
    }

    public void CHER2(int Uplo, Float2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        int N = validateSYR2(Element.F32_2(this.mRS), Uplo, X, incX, Y, incY, A);
        int i = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_cher2, 0, 0, 0, i, 0, 0, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), 0.0f, 0.0f, A.getID(this.mRS), incX, incY, 0, 0);
    }

    public void CHPR2(int Uplo, Float2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
        int N = validateSPR2(Element.F32_2(this.mRS), Uplo, X, incX, Y, incY, Ap);
        int i = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_chpr2, 0, 0, 0, i, 0, 0, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), 0.0f, 0.0f, Ap.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZHEMV(int Uplo, Double2 alpha, Allocation A, Allocation X, int incX, Double2 beta, Allocation Y, int incY) {
        ...
        int i = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zhemv, 0, 0, 0, i, 0, 0, N, 0, alpha.x, alpha.y, A.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZHBMV(int Uplo, int K, Double2 alpha, Allocation A, Allocation X, int incX, Double2 beta, Allocation Y, int incY) {
        ...
        int i = Uplo;
        int i2 = K;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zhbmv, 0, 0, 0, i, 0, 0, N, i2, alpha.x, alpha.y, A.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZHPMV(int Uplo, Double2 alpha, Allocation Ap, Allocation X, int incX, Double2 beta, Allocation Y, int incY) {
        ...
        int i = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zhpmv, 0, 0, 0, i, 0, 0, N, 0, alpha.x, alpha.y, Ap.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZGERU(Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        int M = A.getType().getY();
        int N = A.getType().getX();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zgeru, 0, 0, 0, 0, 0, M, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), 0.0d, 0.0d, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZGERC(Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        int M = A.getType().getY();
        int N = A.getType().getX();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zgerc, 0, 0, 0, 0, 0, M, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), 0.0d, 0.0d, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZHER(int Uplo, double alpha, Allocation X, int incX, Allocation A) {
        ...
        int i = Uplo;
        double d = alpha;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zher, 0, 0, 0, i, 0, 0, N, 0, d, 0.0d, X.getID(this.mRS), 0, 0.0d, 0.0d, A.getID(this.mRS), incX, 0, 0, 0);
    }
    ...
    public void ZHPR(int Uplo, double alpha, Allocation X, int incX, Allocation Ap) {
        ...
        int i = Uplo;
        double d = alpha;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zhpr, 0, 0, 0, i, 0, 0, N, 0, d, 0.0d, X.getID(this.mRS), 0, 0.0d, 0.0d, Ap.getID(this.mRS), incX, 0, 0, 0);
    }

    public void ZHER2(int Uplo, Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        int N = validateSYR2(Element.F64_2(this.mRS), Uplo, X, incX, Y, incY, A);
        int i = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zher2, 0, 0, 0, i, 0, 0, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), 0.0d, 0.0d, A.getID(this.mRS), incX, incY, 0, 0);
    }

    public void ZHPR2(int Uplo, Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
        int N = validateSPR2(Element.F64_2(this.mRS), Uplo, X, incX, Y, incY, Ap);
        int i = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), TRANSPOSE, 0, 0, 0, i, 0, 0, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), 0.0d, 0.0d, Ap.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    static void validateL3(Element e, int TransA, int TransB, int Side, Allocation A, Allocation B, Allocation C) {
        ...
        if ((A != null && !A.getType().getElement().isCompatible(e)) || ((B != null && !B.getType().getElement().isCompatible(e)) || (C != null && !C.getType().getElement().isCompatible(e)))) {
            ...
            if (Side != RsBlas_zher2k) {
                if (A != null) {
                    if (TransA == TRANSPOSE || TransA == RsBlas_sgemm) {
                        aN = A.getType().getY();
                        aM = A.getType().getX();
                    } else {
                        aM = A.getType().getY();
                ...
                if (B != null) {
                    if (TransB == TRANSPOSE || TransB == RsBlas_sgemm) {
                        bN = B.getType().getY();
                        bM = B.getType().getX();
                    } else {
                        bM = B.getType().getY();
    ...
    public void SGEMM(int TransA, int TransB, float alpha, Allocation A, Allocation B, float beta, Allocation C) {
        ...
        float f = alpha;
        float f2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_sgemm, i, i2, 0, 0, 0, M, N, K, f, A.getID(this.mRS), B.getID(this.mRS), f2, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void DGEMM(int TransA, int TransB, double alpha, Allocation A, Allocation B, double beta, Allocation C) {
        ...
        double d = alpha;
        double d2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dgemm, i, i2, 0, 0, 0, M, N, K, d, A.getID(this.mRS), B.getID(this.mRS), d2, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CGEMM(int TransA, int TransB, Float2 alpha, Allocation A, Allocation B, Float2 beta, Allocation C) {
        ...
        int i = TransA;
        int i2 = TransB;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_cgemm, i, i2, 0, 0, 0, M, N, K, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZGEMM(int TransA, int TransB, Double2 alpha, Allocation A, Allocation B, Double2 beta, Allocation C) {
        ...
        int i = TransA;
        int i2 = TransB;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zgemm, i, i2, 0, 0, 0, M, N, K, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void SSYMM(int Side, int Uplo, float alpha, Allocation A, Allocation B, float beta, Allocation C) {
        ...
        float f = alpha;
        float f2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_ssymm, 0, 0, i, i2, 0, C.getType().getY(), C.getType().getX(), 0, f, A.getID(this.mRS), B.getID(this.mRS), f2, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void DSYMM(int Side, int Uplo, double alpha, Allocation A, Allocation B, double beta, Allocation C) {
        ...
        double d = alpha;
        double d2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dsymm, 0, 0, i, i2, 0, C.getType().getY(), C.getType().getX(), 0, d, A.getID(this.mRS), B.getID(this.mRS), d2, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CSYMM(int Side, int Uplo, Float2 alpha, Allocation A, Allocation B, Float2 beta, Allocation C) {
        ...
        int i = Side;
        int i2 = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_csymm, 0, 0, i, i2, 0, C.getType().getY(), C.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZSYMM(int Side, int Uplo, Double2 alpha, Allocation A, Allocation B, Double2 beta, Allocation C) {
        ...
        int i = Side;
        int i2 = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), UNIT, 0, 0, i, i2, 0, C.getType().getY(), C.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void SSYRK(int Uplo, int Trans, float alpha, Allocation A, float beta, Allocation C) {
        ...
        float f = alpha;
        float f2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_ssyrk, i, 0, 0, i2, 0, 0, C.getType().getX(), K, f, A.getID(this.mRS), 0, f2, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void DSYRK(int Uplo, int Trans, double alpha, Allocation A, double beta, Allocation C) {
        ...
        double d = alpha;
        double d2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), UPPER, i, 0, 0, i2, 0, 0, C.getType().getX(), K, d, A.getID(this.mRS), 0, d2, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CSYRK(int Uplo, int Trans, Float2 alpha, Allocation A, Float2 beta, Allocation C) {
        ...
        int i = Trans;
        int i2 = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_csyrk, i, 0, 0, i2, 0, 0, C.getType().getX(), K, alpha.x, alpha.y, A.getID(this.mRS), 0, beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZSYRK(int Uplo, int Trans, Double2 alpha, Allocation A, Double2 beta, Allocation C) {
        ...
        int i = Trans;
        int i2 = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zsyrk, i, 0, 0, i2, 0, 0, C.getType().getX(), K, alpha.x, alpha.y, A.getID(this.mRS), 0, beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void SSYR2K(int Uplo, int Trans, float alpha, Allocation A, Allocation B, float beta, Allocation C) {
        ...
        float f = alpha;
        float f2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_ssyr2k, i, 0, 0, i2, 0, 0, C.getType().getX(), K, f, A.getID(this.mRS), B.getID(this.mRS), f2, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void DSYR2K(int Uplo, int Trans, double alpha, Allocation A, Allocation B, double beta, Allocation C) {
        ...
        double d = alpha;
        double d2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dsyr2k, i, 0, 0, i2, 0, 0, C.getType().getX(), K, d, A.getID(this.mRS), B.getID(this.mRS), d2, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CSYR2K(int Uplo, int Trans, Float2 alpha, Allocation A, Allocation B, Float2 beta, Allocation C) {
        ...
        int i = Trans;
        int i2 = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_csyr2k, i, 0, 0, i2, 0, 0, C.getType().getX(), K, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZSYR2K(int Uplo, int Trans, Double2 alpha, Allocation A, Allocation B, Double2 beta, Allocation C) {
        ...
        int i = Trans;
        int i2 = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zsyr2k, i, 0, 0, i2, 0, 0, C.getType().getX(), K, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void STRMM(int Side, int Uplo, int TransA, int Diag, float alpha, Allocation A, Allocation B) {
        ...
        int i4 = Diag;
        float f = alpha;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_strmm, i, 0, i2, i3, i4, B.getType().getY(), B.getType().getX(), 0, f, A.getID(this.mRS), B.getID(this.mRS), 0.0f, 0, 0, 0, 0, 0);
    }
    ...
    public void DTRMM(int Side, int Uplo, int TransA, int Diag, double alpha, Allocation A, Allocation B) {
        ...
        int i4 = Diag;
        double d = alpha;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dtrmm, i, 0, i2, i3, i4, B.getType().getY(), B.getType().getX(), 0, d, A.getID(this.mRS), B.getID(this.mRS), 0.0d, 0, 0, 0, 0, 0);
    }
    ...
    public void CTRMM(int Side, int Uplo, int TransA, int Diag, Float2 alpha, Allocation A, Allocation B) {
        ...
        int i3 = Uplo;
        int i4 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_ctrmm, i, 0, i2, i3, i4, B.getType().getY(), B.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), 0.0f, 0.0f, 0, 0, 0, 0, 0);
    }
    ...
    public void ZTRMM(int Side, int Uplo, int TransA, int Diag, Double2 alpha, Allocation A, Allocation B) {
        ...
        int i3 = Uplo;
        int i4 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_ztrmm, i, 0, i2, i3, i4, B.getType().getY(), B.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), 0.0d, 0.0d, 0, 0, 0, 0, 0);
    }
    ...
    public void STRSM(int Side, int Uplo, int TransA, int Diag, float alpha, Allocation A, Allocation B) {
        ...
        int i4 = Diag;
        float f = alpha;
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), RsBlas_strsm, i, 0, i2, i3, i4, B.getType().getY(), B.getType().getX(), 0, f, A.getID(this.mRS), B.getID(this.mRS), 0.0f, 0, 0, 0, 0, 0);
    }
    ...
    public void DTRSM(int Side, int Uplo, int TransA, int Diag, double alpha, Allocation A, Allocation B) {
        ...
        int i4 = Diag;
        double d = alpha;
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), RsBlas_dtrsm, i, 0, i2, i3, i4, B.getType().getY(), B.getType().getX(), 0, d, A.getID(this.mRS), B.getID(this.mRS), 0.0d, 0, 0, 0, 0, 0);
    }
    ...
    public void CTRSM(int Side, int Uplo, int TransA, int Diag, Float2 alpha, Allocation A, Allocation B) {
        ...
        int i3 = Uplo;
        int i4 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_ctrsm, i, 0, i2, i3, i4, B.getType().getY(), B.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), 0.0f, 0.0f, 0, 0, 0, 0, 0);
    }
    ...
    public void ZTRSM(int Side, int Uplo, int TransA, int Diag, Double2 alpha, Allocation A, Allocation B) {
        ...
        int i3 = Uplo;
        int i4 = Diag;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_ztrsm, i, 0, i2, i3, i4, B.getType().getY(), B.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), 0.0d, 0.0d, 0, 0, 0, 0, 0);
    }
    ...
    static void validateHEMM(Element e, int Side, Allocation A, Allocation B, Allocation C) {
        ...
        if (A.getType().getElement().isCompatible(e) && B.getType().getElement().isCompatible(e) && C.getType().getElement().isCompatible(e)) {
            ...
            } else if ((Side == RsBlas_zherk && adim != B.getType().getY()) || (Side == RsBlas_zher2k && adim != B.getType().getX())) {
    ...
    public void CHEMM(int Side, int Uplo, Float2 alpha, Allocation A, Allocation B, Float2 beta, Allocation C) {
        ...
        int i = Side;
        int i2 = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_chemm, 0, 0, i, i2, 0, C.getType().getY(), C.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZHEMM(int Side, int Uplo, Double2 alpha, Allocation A, Allocation B, Double2 beta, Allocation C) {
        ...
        int i = Side;
        int i2 = Uplo;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zhemm, 0, 0, i, i2, 0, C.getType().getY(), C.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CHERK(int Uplo, int Trans, float alpha, Allocation A, float beta, Allocation C) {
        ...
        float f = alpha;
        float f2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_cherk, i, 0, 0, i2, 0, 0, C.getType().getX(), k, f, 0.0f, A.getID(this.mRS), 0, f2, 0.0f, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZHERK(int Uplo, int Trans, double alpha, Allocation A, double beta, Allocation C) {
        ...
        double d = alpha;
        double d2 = beta;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zherk, i, 0, 0, i2, 0, 0, C.getType().getX(), k, d, 0.0d, A.getID(this.mRS), 0, d2, 0.0d, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CHER2K(int Uplo, int Trans, Float2 alpha, Allocation A, Allocation B, float beta, Allocation C) {
        ...
        int i2 = Uplo;
        float f = beta;
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), RsBlas_cher2k, i, 0, 0, i2, 0, 0, C.getType().getX(), k, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), f, 0.0f, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZHER2K(int Uplo, int Trans, Double2 alpha, Allocation A, Allocation B, double beta, Allocation C) {
        ...
        int i2 = Uplo;
        double d = beta;
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), RsBlas_zher2k, i, 0, 0, i2, 0, 0, C.getType().getX(), k, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), d, 0.0d, C.getID(this.mRS), 0, 0, 0, 0);
    }

    public void BNNM(Allocation A, int a_offset, Allocation B, int b_offset, Allocation C, int c_offset, int c_mult) {
        validateL3(Element.U8(this.mRS), RsBlas_zher2, TRANSPOSE, 0, A, B, C);

...
public final class DataContract {
    ...
    public static class BaseBuilder {
        protected final DataNormalizer mCollectEvent;
        protected final DataNormalizer mCollects;

        public BaseBuilder() {
            this.mCollectEvent = new DataNormalizer();
            this.mCollects = new DataNormalizer();
        }

        public BaseBuilder addEvent(int event) {
            DataNormalizer normalizer = new DataNormalizer();
            normalizer.appendCondition(ZenModeConfig.EVENT_PATH, String.valueOf(event));
            this.mCollectEvent.appendCollect(ZenModeConfig.EVENT_PATH, normalizer.toString());
            return this;
        }
    ...
    public static class Apps implements BaseAttr, AppAttr, BaseProperty, AppProperty {
        ...
        public static final class Builder extends BaseBuilder {
            ...
            public Builder addCallerApp(String packageName, String processName, int pid, int uid) {
                ...
                normalizer.appendCondition(BaseProperty.PROCESS_ID, String.valueOf(pid));
            ...
            public Builder addCalledApp(String packageName, String processName, int pid, int uid) {
                DataNormalizer normalizer = new DataNormalizer();
                normalizer.appendCondition(BaseProperty.PACKAGE_NAME, packageName);
                normalizer.appendCondition(BaseProperty.PROCESS_NAME, processName);
                normalizer.appendCondition(BaseProperty.PROCESS_ID, String.valueOf(pid));
    ...
    public static class DevStatus implements BaseAttr, DevStatusAttr, BaseProperty, DevStatusProperty {
        ...
        public static final class Builder extends BaseBuilder {
            ...
            public Builder addUid(int uid) {
                DataNormalizer normalizer = new DataNormalizer();
                normalizer.appendCondition(BaseProperty.UID, String.valueOf(uid));
                this.mCollects.appendCollect(BaseAttr.INFO, normalizer.toString());
                return this;
            }

            public Builder addNetworkType(int networkType, String state) {
                DataNormalizer normalizer = new DataNormalizer();
                normalizer.appendCondition(DevStatusProperty.NETWORK_TYPE, String.valueOf(networkType));
            ...
            public Builder addBatterystate(int plugType, boolean isBatteryPlugged, boolean isBatterCharging) {
                ...
                normalizer.appendCondition(DevStatusProperty.BATTERY_STATE_PLUGGED, isBatteryPlugged ? WifiEnterpriseConfig.ENGINE_ENABLE : WifiEnterpriseConfig.ENGINE_DISABLE);
                normalizer.appendCondition(DevStatusProperty.BATTERY_STATE_CHARGING, isBatterCharging ? WifiEnterpriseConfig.ENGINE_ENABLE : WifiEnterpriseConfig.ENGINE_DISABLE);
                this.mCollects.appendCollect(BaseAttr.INFO, normalizer.toString());
                return this;
            }
            ...
            public Builder addVibrator(int uid, long durationMillis) {
                DataNormalizer normalizer = new DataNormalizer();
                normalizer.appendCondition(BaseProperty.UID, String.valueOf(uid));
                normalizer.appendCondition(DevStatusProperty.VIBRATOR_DURATION, String.valueOf(durationMillis));
                this.mCollects.appendCollect(BaseAttr.INFO, normalizer.toString());
                return this;
            }

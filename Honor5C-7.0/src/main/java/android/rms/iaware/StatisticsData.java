...
public class StatisticsData implements Parcelable {
    public static final Creator<StatisticsData> CREATOR = null;
    private int mEffect;
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.rms.iaware.StatisticsData.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.rms.iaware.StatisticsData.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.rms.iaware.StatisticsData.<clinit>():void");
    }

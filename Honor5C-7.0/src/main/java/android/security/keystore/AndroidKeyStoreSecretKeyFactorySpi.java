        ...
        try {
            ...
            if (keySizeUnsigned == -1) {
                ...
                if (keymasterSwEnforcedUserAuthenticators == 2 || keymasterHwEnforcedUserAuthenticators == 2) {
                    if (keymasterSecureUserIds == null || keymasterSecureUserIds.isEmpty()) {
                        invalidatedByBiometricEnrollment = false;
                    } else {
                        invalidatedByBiometricEnrollment = !keymasterSecureUserIds.contains(getGateKeeperSecureUserId());
                    }
                }

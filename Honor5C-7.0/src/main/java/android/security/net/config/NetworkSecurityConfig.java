...
public final class NetworkSecurityConfig {
    ...
    public static final class Builder {
        ...
        public Builder() {
            this.mCleartextTrafficPermitted = NetworkSecurityConfig.DEFAULT_CLEARTEXT_TRAFFIC_PERMITTED;
        ...
        public Builder setCleartextTrafficPermitted(boolean cleartextTrafficPermitted) {
            ...
            this.mCleartextTrafficPermittedSet = NetworkSecurityConfig.DEFAULT_CLEARTEXT_TRAFFIC_PERMITTED;
            return this;
        }
        ...
        private boolean getEffectiveCleartextTrafficPermitted() {
            ...
            return NetworkSecurityConfig.DEFAULT_CLEARTEXT_TRAFFIC_PERMITTED;
        }

        public Builder setHstsEnforced(boolean hstsEnforced) {
            this.mHstsEnforced = hstsEnforced;
            this.mHstsEnforcedSet = NetworkSecurityConfig.DEFAULT_CLEARTEXT_TRAFFIC_PERMITTED;
            return this;
        }
        ...
        public boolean hasCertificatesEntryRefs() {
            return this.mCertificatesEntryRefs != null ? NetworkSecurityConfig.DEFAULT_CLEARTEXT_TRAFFIC_PERMITTED : false;
        }
        ...
        public NetworkSecurityConfig build() {
            return new NetworkSecurityConfig(getEffectiveHstsEnforced(), getEffectivePinSet(), getEffectiveCertificatesEntryRefs(), null);
        }
    }
    ...
    public static final Builder getDefaultBuilder(int targetSdkVersion) {
        Builder builder = new Builder().setCleartextTrafficPermitted(DEFAULT_CLEARTEXT_TRAFFIC_PERMITTED).setHstsEnforced(false).addCertificatesEntryRef(new CertificatesEntryRef(SystemCertificateSource.getInstance(), false));

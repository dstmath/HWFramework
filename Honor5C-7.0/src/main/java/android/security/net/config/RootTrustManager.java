...
public class RootTrustManager extends X509ExtendedTrustManager {
    ...
    public void checkClientTrusted(X509Certificate[] chain, String authType) throws CertificateException {
        this.mConfig.getConfigForHostname(ProxyInfo.LOCAL_EXCL_LIST).getTrustManager().checkClientTrusted(chain, authType);
    }

    public void checkClientTrusted(X509Certificate[] certs, String authType, Socket socket) throws CertificateException {
        this.mConfig.getConfigForHostname(ProxyInfo.LOCAL_EXCL_LIST).getTrustManager().checkClientTrusted(certs, authType, socket);
    }

    public void checkClientTrusted(X509Certificate[] certs, String authType, SSLEngine engine) throws CertificateException {
        this.mConfig.getConfigForHostname(ProxyInfo.LOCAL_EXCL_LIST).getTrustManager().checkClientTrusted(certs, authType, engine);
    }
    ...
    public void checkServerTrusted(X509Certificate[] certs, String authType) throws CertificateException {
        ...
        this.mConfig.getConfigForHostname(ProxyInfo.LOCAL_EXCL_LIST).getTrustManager().checkServerTrusted(certs, authType);
    }
    ...
    public X509Certificate[] getAcceptedIssuers() {
        return this.mConfig.getConfigForHostname(ProxyInfo.LOCAL_EXCL_LIST).getTrustManager().getAcceptedIssuers();
    }

...
public abstract class RecognitionService extends Service {
    ...
    class AnonymousClass2 implements DeathRecipient {
        ...
        AnonymousClass2(IRecognitionListener val$listener) {
    ...
    private static final class RecognitionServiceBinder extends Stub {
        ...
        public void startListening(Intent recognizerIntent, IRecognitionListener listener) {
            ...
            if (service != null && service.checkPermissions(listener)) {
                ...
                service.getClass();
                -get0.sendMessage(Message.obtain(-get02, RecognitionService.MSG_START_LISTENING, new StartListeningArgs(recognizerIntent, listener, Binder.getCallingUid())));
            }
        }
    ...
    private void dispatchStartListening(Intent intent, IRecognitionListener listener, int callingUid) {
        if (this.mCurrentCallback == null) {
            try {
                listener.asBinder().linkToDeath(new AnonymousClass2(listener), 0);
                this.mCurrentCallback = new Callback(listener, callingUid, null);

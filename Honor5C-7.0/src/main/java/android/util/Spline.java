...
public abstract class Spline {
    ...
    public static class MonotoneCubicSpline extends Spline {
        ...
        public float interpolate(float x) {
            ...
            return ((((this.mY[i] * ((2.0f * t) + LayoutParams.BRIGHTNESS_OVERRIDE_FULL)) + ((this.mM[i] * h) * t)) * (LayoutParams.BRIGHTNESS_OVERRIDE_FULL - t)) * (LayoutParams.BRIGHTNESS_OVERRIDE_FULL - t)) + ((((this.mY[i + 1] * (3.0f - (2.0f * t))) + ((this.mM[i + 1] * h) * (t - LayoutParams.BRIGHTNESS_OVERRIDE_FULL))) * t) * t);
        }

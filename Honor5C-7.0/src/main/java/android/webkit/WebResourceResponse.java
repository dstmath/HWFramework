...
public class WebResourceResponse {
    ...
    public void setStatusCodeAndReasonPhrase(int statusCode, String reasonPhrase) {
        ...
        if (statusCode < 100) {
        ...
        } else if (statusCode > MetricsEvent.ACTION_BUGREPORT_NOTIFICATION_ACTION_SHARE && statusCode < StatisticalConstant.TYPE_WIFI_HiLink_CONNECT_ACTION) {
            ...
            for (int i = 0; i < reasonPhrase.length(); i++) {
                if (reasonPhrase.charAt(i) > LogPower.MIME_TYPE) {

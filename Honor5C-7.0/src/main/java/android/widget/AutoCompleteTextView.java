...
public class AutoCompleteTextView extends EditText implements FilterListener {
    ...
    class AnonymousClass1 implements android.widget.PopupWindow.OnDismissListener {
        ...
        AnonymousClass1(OnDismissListener val$dismissListener) {
            this.val$dismissListener = val$dismissListener;
        }
    ...
    public AutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes, Theme popupTheme) {
        ...
        Drawable popupListSelector = pa.getDrawable(EXPAND_MAX);
        ...
        if ((inputType & 15) == 1) {
            setRawInputType(inputType | Protocol.BASE_SYSTEM_RESERVED);
        }
        setFocusable(true);
    ...
    public void setOnDismissListener(OnDismissListener dismissListener) {
        ...
        if (dismissListener != null) {
            onDismissListener = new AnonymousClass1(dismissListener);
        }

...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.widget.HorizontalScrollView.SavedState.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.widget.HorizontalScrollView.SavedState.<clinit>():void
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mFillViewport && MeasureSpec.getMode(widthMeasureSpec) != 0 && getChildCount() > 0) {
            ...
            if (child.getMeasuredWidth() < desiredWidth) {
                child.measure(MeasureSpec.makeMeasureSpec(desiredWidth, EditorInfo.IME_FLAG_NO_ENTER_ACTION), ViewGroup.getChildMeasureSpec(heightMeasureSpec, heightPadding, lp.height));
            }
        }
    }

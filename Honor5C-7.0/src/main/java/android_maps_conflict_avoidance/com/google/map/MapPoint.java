...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android_maps_conflict_avoidance.com.google.map.MapPoint.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android_maps_conflict_avoidance.com.google.map.MapPoint.<clinit>():void
...
*/
    ...
    public static int getYPixelFromLat(int latitude, Zoom zoom) {
        ...
        j = (long) latDiff;
        j = (long) latDiff;
        int mercatorY = (int) (((((((((((long) (((((values[indexFloor - 1] * -1) + (values[indexFloor] * 3)) - (values[indexFloor + 1] * 3)) + values[indexFloor + 2]) / 6)) * ((long) latDiff)) * ((long) latDiff)) / 1000000) * ((long) latDiff)) / 1000000) / 1000000) + ((((((long) ((((values[indexFloor - 1] * 3) - (values[indexFloor] * 6)) + (values[indexFloor + 1] * 3)) / 6)) * r0) * r0) / 1000000) / 1000000)) + ((((long) (((((values[indexFloor - 1] * -2) - (values[indexFloor] * 3)) + (values[indexFloor + 1] * 6)) - values[indexFloor + 2]) / 6)) * r0) / 1000000)) + ((long) values[indexFloor]));
        if (latitude < 0) {
            mercatorY = -mercatorY;
        }
    ...
    private static int getLatitudeFromY(int y, Zoom zoom) {
        ...
        if (indexFloor < data.length - 2) {
            ...
            long j = (long) yDiff;
            int latitude = (int) (((((((((((long) (((((data[indexFloor - 1] * -1) + (data[indexFloor] * 3)) - (data[indexFloor + 1] * 3)) + data[indexFloor + 2]) / 6)) * ((long) yDiff)) * ((long) yDiff)) / 5000000) * ((long) yDiff)) / 5000000) / 5000000) + ((((((long) ((((data[indexFloor - 1] * 3) - (data[indexFloor] * 6)) + (data[indexFloor + 1] * 3)) / 6)) * ((long) yDiff)) * r0) / 5000000) / 5000000)) + ((((long) (((((data[indexFloor - 1] * -2) - (data[indexFloor] * 3)) + (data[indexFloor + 1] * 6)) - data[indexFloor + 2]) / 6)) * ((long) yDiff)) / 5000000)) + ((long) data[indexFloor]));
            if (latitude > 80000000) {
                latitude = 80000000;
            }
            if (mercator < 0) {

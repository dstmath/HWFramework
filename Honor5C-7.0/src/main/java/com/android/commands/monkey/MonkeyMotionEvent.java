        ...
        if ((verbose > 0 && !this.mIntermediateNote) || verbose > 1) {
            ...
            switch (me.getActionMasked()) {
                ...
                case MonkeySourceRandom.FACTOR_MOTION /*1*/:
                    ...
                    break;
                case MonkeySourceRandom.FACTOR_PINCHZOOM /*2*/:
                    msg.append("ACTION_MOVE");
                    break;
                case MonkeySourceRandom.FACTOR_TRACKBALL /*3*/:
                    msg.append("ACTION_CANCEL");
                    break;
                case MonkeySourceRandom.FACTOR_PERMISSION /*5*/:
                    msg.append("ACTION_POINTER_DOWN ").append(me.getPointerId(me.getActionIndex()));
                    break;
                case MonkeySourceRandom.FACTOR_NAV /*6*/:

        ...
        private static class Proxy implements ImsConfigListener {
            ...
            public void onGetFeatureResponse(int feature, int network, int value, int status) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onGetFeatureResponse, _data, null, Stub.TRANSACTION_onGetFeatureResponse);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onSetFeatureResponse(int feature, int network, int value, int status) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(value);
                    _data.writeInt(status);
                    this.mRemote.transact(Stub.TRANSACTION_onSetFeatureResponse, _data, null, Stub.TRANSACTION_onGetFeatureResponse);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onGetVideoQuality(int status, int quality) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onGetVideoQuality, _data, null, Stub.TRANSACTION_onGetFeatureResponse);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onSetVideoQuality(int status) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(status);
                    this.mRemote.transact(Stub.TRANSACTION_onSetVideoQuality, _data, null, Stub.TRANSACTION_onGetFeatureResponse);
                } finally {
                    _data.recycle();
                }
            }

...
public interface IImsEcbmListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IImsEcbmListener {
        ...
        private static class Proxy implements IImsEcbmListener {
            ...
            public void enteredECBM() throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_enteredECBM, _data, _reply, 0);
            ...
            public void exitedECBM() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_exitedECBM, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_enteredECBM /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    enteredECBM();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_exitedECBM /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    exitedECBM();
                    reply.writeNoException();
                    return true;

...
public interface IVoiceInteractionSessionShowCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IVoiceInteractionSessionShowCallback {
        ...
        private static class Proxy implements IVoiceInteractionSessionShowCallback {
            ...
            public void onFailed() throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onFailed, _data, null, Stub.TRANSACTION_onFailed);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onShown() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_onShown, _data, null, Stub.TRANSACTION_onFailed);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_onFailed /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    onFailed();
                    return true;
                case TRANSACTION_onShown /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    onShown();
                    return true;
                case 1598968902:

...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.internal.os.BatterySipper.DrainType.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.internal.os.BatterySipper.DrainType.<clinit>():void
...
*/
    ...
    public double sumPower() {
        double d = ((((((((this.usagePowerMah + this.wifiPowerMah) + this.gpsPowerMah) + this.cpuPowerMah) + this.sensorPowerMah) + this.mobileRadioPowerMah) + this.wakeLockPowerMah) + this.cameraPowerMah) + this.flashlightPowerMah) + this.bluetoothPowerMah;

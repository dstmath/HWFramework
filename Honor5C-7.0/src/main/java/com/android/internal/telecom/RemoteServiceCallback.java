        ...
        private static class Proxy implements RemoteServiceCallback {
            ...
            public void onError() throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onError, _data, null, Stub.TRANSACTION_onError);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onResult(List<ComponentName> components, List<IBinder> callServices) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onResult, _data, null, Stub.TRANSACTION_onError);
                } finally {
                    _data.recycle();
                }
            }

...
public abstract class AbstractGsmCdmaCallTracker extends CallTracker {
    CdmaCallTrackerReference mCdmaReference;
    GsmCallTrackerReference mGsmReference;
    ...
    protected AbstractGsmCdmaCallTracker(GsmCdmaPhone phone) {
        this.mGsmReference = HwTelephonyFactory.getHwPhoneManager().createHwGsmCallTrackerReference(this);
        this.mCdmaReference = HwTelephonyFactory.getHwPhoneManager().createHwCdmaCallTrackerReference(this);
        this.mPhone = phone;
    }

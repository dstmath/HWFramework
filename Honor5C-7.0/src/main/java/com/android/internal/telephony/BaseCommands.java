...
public abstract class BaseCommands extends AbstractBaseCommands implements CommandsInterface {
    ...
    protected RegistrantList mModemCapRegistrants;
    ...
    protected RegistrantList mRSrvccStateRegistrants;
    ...
    public BaseCommands(Context context) {
        ...
        this.mModemCapRegistrants = new RegistrantList();
        this.mRSrvccStateRegistrants = new RegistrantList();
        this.mRilVersion = -1;

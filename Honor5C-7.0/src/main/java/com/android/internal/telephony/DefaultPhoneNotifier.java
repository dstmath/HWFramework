...
public class DefaultPhoneNotifier implements PhoneNotifier {
    ...
    private static final boolean isVSimSupport = false;
    private ArrayList<HashMap<String, DataState>> mApnTypeAndDataState;
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.internal.telephony.DefaultPhoneNotifier.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.internal.telephony.DefaultPhoneNotifier.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.DefaultPhoneNotifier.<clinit>():void");
    }

    public DefaultPhoneNotifier() {
        this.mApnTypeAndDataState = null;
    ...
    private boolean validatePhoneId(int phoneId) {
        return (phoneId < 0 || phoneId >= this.mNumPhones) ? DBG : true;
    }

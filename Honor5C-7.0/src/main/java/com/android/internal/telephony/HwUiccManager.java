...
public interface HwUiccManager {
    ...
    int simContactsDeleteMSim(Context context, Uri uri, String str, String[] strArr);

    String simContactsGetType(Context context, Uri uri);

    String simContactsGetTypeMsim(Context context, Uri uri);

    Uri simContactsInsert(Context context, Uri uri, ContentValues contentValues);

    Uri simContactsInsertMSim(Context context, Uri uri, ContentValues contentValues);

    Cursor simContactsQuery(Context context, Uri uri, String[] strArr, String str, String[] strArr2, String str2);

    Cursor simContactsQueryMSim(Context context, Uri uri, String[] strArr, String str, String[] strArr2, String str2);

    int simContactsUpdate(Context context, Uri uri, ContentValues contentValues, String str, String[] strArr);

    int simContactsUpdateMSim(Context context, Uri uri, ContentValues contentValues, String str, String[] strArr);

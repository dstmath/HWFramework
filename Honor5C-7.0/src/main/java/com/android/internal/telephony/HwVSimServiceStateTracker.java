...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.internal.telephony.HwVSimServiceStateTracker.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.internal.telephony.HwVSimServiceStateTracker.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.HwVSimServiceStateTracker.<clinit>():void");
    }

    public HwVSimServiceStateTracker(GsmCdmaPhone phone, CommandsInterface ci) {
        super(phone, ci);
        this.LOG_TAG = "VSimSST";
        this.LOG_TAG += "[VSIM]";
    ...
    protected Intent createSpnIntent() {
        return new Intent("android.provider.Telephony.SPN_STRINGS_UPDATED_VSIM");
    }

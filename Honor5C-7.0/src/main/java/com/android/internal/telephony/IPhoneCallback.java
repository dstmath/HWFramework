...
public interface IPhoneCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPhoneCallback {
        ...
        private static class Proxy implements IPhoneCallback {
            ...
            public void onCallback1(int parm) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(parm);
                    this.mRemote.transact(Stub.TRANSACTION_onCallback1, _data, _reply, 0);
            ...
            public void onCallback2(int parm1, int param2) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onCallback2, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void onCallback3(int parm1, int param2, Bundle param3) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(param2);
                    if (param3 != null) {
                        _data.writeInt(Stub.TRANSACTION_onCallback1);
                        param3.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
                    this.mRemote.transact(Stub.TRANSACTION_onCallback3, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_onCallback1 /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    onCallback1(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_onCallback2 /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    onCallback2(data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_onCallback3 /*3*/:
                    Bundle bundle;
                    data.enforceInterface(DESCRIPTOR);

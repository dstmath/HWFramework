        ...
        private static class Proxy implements IPhoneSubInfo {
            ...
            public String getNaiForSubscriber(int subId, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getNaiForSubscriber, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getPesn() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getPesn, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getDeviceIdForPhone(int phoneId, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getDeviceIdForPhone, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getImeiForSubscriber(int subId, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(subId);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getImeiForSubscriber, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getDeviceSvn(String callingPackage) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getDeviceSvn, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getDeviceSvnUsingSubId(int subId, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(subId);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getDeviceSvnUsingSubId, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getSubscriberId(String callingPackage) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getSubscriberId, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getSubscriberIdForSubscriber(int subId, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(subId);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getSubscriberIdForSubscriber, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getGroupIdLevel1(String callingPackage) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getGroupIdLevel1, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getGroupIdLevel1ForSubscriber(int subId, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(subId);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getGroupIdLevel1ForSubscriber, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getIccSerialNumber(String callingPackage) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getIccSerialNumber, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getIccSerialNumberForSubscriber(int subId, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(subId);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getIccSerialNumberForSubscriber, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getLine1NumberForSubscriber(int subId, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(subId);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getLine1NumberForSubscriber, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getLine1AlphaTag(String callingPackage) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getLine1AlphaTag, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getLine1AlphaTagForSubscriber(int subId, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(subId);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getLine1AlphaTagForSubscriber, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getMsisdn(String callingPackage) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getMsisdn, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getMsisdnForSubscriber(int subId, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(subId);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getMsisdnForSubscriber, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getVoiceMailNumberForSubscriber(int subId, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(subId);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getVoiceMailNumberForSubscriber, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getCompleteVoiceMailNumber() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getCompleteVoiceMailNumber, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getCompleteVoiceMailNumberForSubscriber(int subId) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(subId);
                    this.mRemote.transact(Stub.TRANSACTION_getCompleteVoiceMailNumberForSubscriber, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getVoiceMailAlphaTag(String callingPackage) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getVoiceMailAlphaTag, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getVoiceMailAlphaTagForSubscriber(int subId, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(subId);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_getVoiceMailAlphaTagForSubscriber, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getIsimImpi() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getIsimImpi, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getIsimDomain() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getIsimDomain, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String[] getIsimImpu() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getIsimImpu, _data, _reply, 0);
                    _reply.readException();
            ...
            public String getIsimIst() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getIsimIst, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String[] getIsimPcscf() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getIsimPcscf, _data, _reply, 0);
                    _reply.readException();
                    String[] _result = _reply.createStringArray();
                    return _result;
                } finally {
            ...
            public String getIsimChallengeResponse(String nonce) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getIsimChallengeResponse, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public String getIccSimChallengeResponse(int subId, int appType, int authType, String data) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getIccSimChallengeResponse, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.internal.telephony.IPhoneSubInfo.Stub.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.internal.telephony.IPhoneSubInfo.Stub.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean
...
*/
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.IPhoneSubInfo.Stub.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }

...
public abstract class AbstractDcTrackerBase extends Handler {
    protected boolean INTELLIGENT_DATA_SWITCH_CONFIG;
    protected boolean mIntelligentDataSwitchIsOn;
    DcTrackerBaseReference mReference;
    ...
    public interface DcTrackerBaseReference {
        ...
        void addIntentFilter(IntentFilter intentFilter);
        ...
        void disposeAddedIntent(String str);
        ...
        void onActionDataSwitch(int i, int i2);
    ...
    public AbstractDcTrackerBase() {
        this.mReference = HwTelephonyFactory.getHwDataConnectionManager().createHwDcTrackerBaseReference(this);
        this.mIntelligentDataSwitchIsOn = false;
    }
    ...
    public void onActionDataSwitch(int currRecoveryAction, int nextAction) {
        this.mReference.onActionDataSwitch(currRecoveryAction, nextAction);
    }

    public void addIntentFilter(IntentFilter filter) {
        this.mReference.addIntentFilter(filter);
    }

    public void disposeAddedIntent(String action) {
        this.mReference.disposeAddedIntent(action);
    }

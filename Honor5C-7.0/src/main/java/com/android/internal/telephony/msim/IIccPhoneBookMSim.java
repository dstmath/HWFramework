...
public interface IIccPhoneBookMSim extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IIccPhoneBookMSim {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            boolean _result;
            switch (code) {
                case TRANSACTION_updateAdnRecordsInEfBySearch /*2*/:
                    ...
                    reply.writeInt(_result ? TRANSACTION_getAdnRecordsInEf : 0);
                    return true;
                case TRANSACTION_updateAdnRecordsInEfByIndex /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(_result ? TRANSACTION_getAdnRecordsInEf : 0);
                    return true;
                case TRANSACTION_getAdnRecordsSize /*4*/:
                    data.enforceInterface(DESCRIPTOR);

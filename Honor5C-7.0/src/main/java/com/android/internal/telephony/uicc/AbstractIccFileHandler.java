...
public class AbstractIccFileHandler extends Handler {
    protected IccFileHandlerReference mReference;
    ...
    public AbstractIccFileHandler() {
        this.mReference = HwTelephonyFactory.getHwUiccManager().createHwIccFileHandlerReference(this);
    }

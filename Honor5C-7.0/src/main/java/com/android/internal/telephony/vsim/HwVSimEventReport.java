...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.internal.telephony.vsim.HwVSimEventReport.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.internal.telephony.vsim.HwVSimEventReport.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.vsim.HwVSimEventReport.<clinit>():void");
    }
    ...
    private void reportChr(VSimEventInfo eventInfo) {
        if (this.mContext == null) {
            ...
            intent.putExtra(CHR_MODULE_ID, HwChrVSimConstants.CHR_VSIM_CAUSE_TYPE_UNKNOWN);
    ...
    private static boolean isChrScenarioValid(int resultType, int processType) {
        ...
        switch (processType) {
            case VSIM_RESULT_TYPE_SUCCESS /*1*/:
            case VSIM_RESULT_TYPE_FAIL /*2*/:
            case VSIM_PROCESS_TYPE_ED /*4*/:
                break;
            case VSIM_PROCESS_TYPE_DA /*11*/:
            case VSIM_PROCESS_TYPE_DB /*12*/:
            case VSIM_PROCESS_TYPE_DC /*13*/:
                if (resultType == VSIM_RESULT_TYPE_SUCCESS) {
    ...
    private static int toChrResultType(int resultType) {
        switch (resultType) {
            case VSIM_RESULT_TYPE_SUCCESS /*1*/:
                return VSIM_RESULT_TYPE_SUCCESS;
            case VSIM_RESULT_TYPE_FAIL /*2*/:
                return 0;
            default:
                return 0;
    ...
    private static int toChrProcessType(int processType) {
        switch (processType) {
            ...
            case VSIM_RESULT_TYPE_FAIL /*2*/:
                return VSIM_RESULT_TYPE_SUCCESS;
            case VSIM_PROCESS_TYPE_ED /*4*/:
                return VSIM_RESULT_TYPE_FAIL;
            case VSIM_PROCESS_TYPE_DA /*11*/:
                return VSIM_CAUSE_TYPE_GET_SIM_STATE;
            case VSIM_PROCESS_TYPE_DB /*12*/:
                return VSIM_PROCESS_TYPE_ED;
            case VSIM_PROCESS_TYPE_DC /*13*/:
                return VSIM_CAUSE_TYPE_SWITCH_SLOT;
            default:
                return 0;
        }
    }

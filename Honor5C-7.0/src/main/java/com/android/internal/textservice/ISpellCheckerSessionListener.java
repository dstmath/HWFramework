        ...
        private static class Proxy implements ISpellCheckerSessionListener {
            ...
            public void onGetSuggestions(SuggestionsInfo[] results) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onGetSuggestions, _data, null, Stub.TRANSACTION_onGetSuggestions);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onGetSentenceSuggestions(SentenceSuggestionsInfo[] result) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onGetSentenceSuggestions, _data, null, Stub.TRANSACTION_onGetSuggestions);
                } finally {
                    _data.recycle();
                }
            }

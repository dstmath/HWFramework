...
public class EpicenterTranslateClipReveal extends Visibility {
    ...
    static class AnonymousClass1 extends AnimatorListenerAdapter {
        ...
        AnonymousClass1(View val$view, Rect val$terminalClip) {
            this.val$view = val$view;
            this.val$terminalClip = val$terminalClip;
        }

        public void onAnimationEnd(Animator animation) {
            this.val$view.setClipBounds(this.val$terminalClip);
        }
    }
    ...
    private static class StateProperty extends Property<View, State> {
        ...
        public State get(View object) {
            ...
            if (this.mTargetDimension == LogPower.FULL_SCREEN) {
    ...
    private static Animator createRectAnimator(View view, State startX, State startY, float startZ, State endX, State endY, float endZ, TransitionValues endValues, TimeInterpolator interpolatorX, TimeInterpolator interpolatorY, TimeInterpolator interpolatorZ) {
        ...
        ObjectAnimator animY = ObjectAnimator.ofObject(view, new StateProperty(StateProperty.TARGET_Y), evaluator, new State[]{startY, endY});
        if (interpolatorY != null) {
            animY.setInterpolator(interpolatorY);
        }
        AnimatorListenerAdapter animatorListener = new AnonymousClass1(view, (Rect) endValues.values.get(PROPNAME_CLIP));

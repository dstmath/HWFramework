...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (this.mActionBarView == null && MeasureSpec.getMode(heightMeasureSpec) == RtlSpacingHelper.UNDEFINED && this.mHeight >= 0) {
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(Math.min(this.mHeight, MeasureSpec.getSize(heightMeasureSpec)), RtlSpacingHelper.UNDEFINED);
        }
        ...
        if (!(this.mActionBarView == null || this.mTabContainer == null || this.mTabContainer.getVisibility() == 8)) {
            ...
            setMeasuredDimension(getMeasuredWidth(), Math.min(getMeasuredHeightWithMargins(this.mTabContainer) + nonTabMaxHeight, MeasureSpec.getMode(heightMeasureSpec) == RtlSpacingHelper.UNDEFINED ? MeasureSpec.getSize(heightMeasureSpec) : HwBootFail.STAGE_BOOT_SUCCESS));
        }
    }

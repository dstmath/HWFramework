...
public class BaseBlockCipher extends BaseWrapCipher implements PBE {
    ...
    class AnonymousClass1 extends InvalidKeyException {
        ...
        AnonymousClass1(String $anonymous0, Exception val$e) {
            this.val$e = val$e;
            super($anonymous0);
        }
...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.org.bouncycastle.jcajce.provider.symmetric.util.BaseBlockCipher.AEADGenericBlockCipher.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.org.bouncycastle.jcajce.provider.symmetric.util.BaseBlockCipher.AEADGenericBlockCipher.<clinit>():void
...
*/
    ...
    static {
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.org.bouncycastle.jcajce.provider.symmetric.util.BaseBlockCipher.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	at jadx.api.JadxDecompiler.processClass(JadxDecompiler.java:281)
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.org.bouncycastle.jcajce.provider.symmetric.util.BaseBlockCipher.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 5 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 0073
        ...
        if (!(key instanceof SecretKey)) {
            ...
            if ((this.scheme == 2 || (key instanceof PKCS12Key)) && !isBCPBEKeyWithoutIV(key)) {
                try {
                    ...
                    if ((k instanceof PBEKey) && this.pbeSpec == null) {
                        if (((PBEKey) k).getSalt() == null) {
                            throw new InvalidAlgorithmParameterException("Parameters for the algorithm are null and the PBEKey has null salt");
                        }
                    ...
                    if (this.pbeSpec != null || (k instanceof PBEKey)) {
                        ...
                        } else if (((BCPBEKey) key).getParam() == null || !(((BCPBEKey) key).getParam() instanceof ParametersWithIV)) {
                ...
                if (k2.getParam() != null) {
                    ...
                    this.pbeSpec = (PBEParameterSpec) params;
                    param = Util.makePBEParameters(k2, params, this.cipher.getUnderlyingCipher().getAlgorithmName());
                } else {
                ...
                param = Util.makePBEParameters(k3.getEncoded(), this.scheme, this.digest, this.keySizeInBits, this.ivLength * 8, this.pbeSpec, this.cipher.getAlgorithmName());
                if (param instanceof ParametersWithIV) {
                    this.ivParam = (ParametersWithIV) param;
                }
            ...
            if (params instanceof IvParameterSpec) {
                ...
                if (isAEADModeName(this.modeName) || (this.cipher instanceof AEADGenericBlockCipher)) {
                    try {
                        ...
                        KeyParameter keyParameter2 = keyParam;
                        keyParameter = new AEADParameters(keyParameter2, ((Integer) tLen.invoke(params, new Object[0])).intValue(), (byte[]) iv.invoke(params, new Object[0]));
            ...
            if (this.ivLength == 0 || (param instanceof ParametersWithIV) || (param instanceof AEADParameters)) {
                ...
                if (opmode == 1 || opmode == 3) {
                    ...
                    param2 = param;
                } else if (isBCPBEKeyWithoutIV(key)) {
            ...
            switch (opmode) {
                ...
                default:
                    try {
                        ...
                        throw new AnonymousClass1(e3.getMessage(), e3);
                    }
            }
            throw new AnonymousClass1(e3.getMessage(), e3);
        }

...
public class CountryDetectorService extends Stub implements Runnable {
    ...
    class AnonymousClass2 implements Runnable {
        ...
        AnonymousClass2(CountryListener val$listener) {
    ...
    private void initialize() {
        ...
        this.mLocationBasedDetectorListener = new CountryListener() {
            ...
            public void onCountryDetected(Country country) {
                CountryDetectorService.this.mHandler.post(new AnonymousClass1(country));
            }
        };
    }
    ...
    protected void setCountryListener(CountryListener listener) {
        this.mHandler.post(new AnonymousClass2(listener));
    }

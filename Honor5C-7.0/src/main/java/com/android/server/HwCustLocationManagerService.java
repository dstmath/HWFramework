...
public class HwCustLocationManagerService {
    public static String DEL_PKG = null;
    public static final int EVENT_REMOVE_PACKAGE_LOCATION = 3001;

    static {
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.HwCustLocationManagerService.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.HwCustLocationManagerService.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.HwCustLocationManagerService.<clinit>():void");
    }

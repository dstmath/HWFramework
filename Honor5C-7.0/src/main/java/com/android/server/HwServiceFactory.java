...
public class HwServiceFactory {
    ...
    public interface Factory {
        ...
        ActivityStack createActivityStack(ActivityContainer activityContainer, RecentTasks recentTasks);

        DisplayContent createDisplayContent(Display display, WindowManagerService windowManagerService);
        ...
        HwUsbHDBManager getHwUsbHDBManager(Context context);
        ...
        IJankShieldServiceFactory getJankShieldService();
    ...
    public interface ICoverManagerService {
        ...
        void startCoverManagerService(Context context, WindowManagerService windowManagerService, Handler handler);
    }
    ...
    public interface IHiACELightController {
        public static final int BRIGHTNESS_UPDATE_END = 1;
        public static final int BRIGHTNESS_UPDATE_START = 0;

        boolean checkIfUsingBLC();

        boolean checkIfUsingSRE();

        void initialize();

        boolean startHiACELightController(Context context, SensorManager sensorManager);
    ...
    public interface IHwActivityStackSupervisor {
        ActivityStackSupervisor getInstance(ActivityManagerService activityManagerService);
    }
    ...
    public interface IHwAutomaticBrightnessController {
        AutomaticBrightnessController getInstance(Callbacks callbacks, Looper looper, SensorManager sensorManager, Spline spline, int i, int i2, int i3, float f, int i4, long j, long j2, boolean z, int i5, float f2, Context context);
    ...
    public interface IHwMountService {
        MountService getInstance(Context context);
    }
    ...
    public interface IHwUserManagerService {
        UserManagerService getInstance(Context context, PackageManagerService packageManagerService, Object obj);
    }
    ...
    public interface IHwWindowManagerService {
        WindowManagerService getInstance(Context context, InputManagerService inputManagerService, boolean z, boolean z2, boolean z3);
    }
    ...
    public interface IJankShieldServiceFactory {
        IBinder getInstance(Context context);
    }
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.HwServiceFactory.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.HwServiceFactory.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.HwServiceFactory.<clinit>():void");
    }
    ...
    public static IJankShieldServiceFactory getJankShieldService() {
        Factory obj = getImplObject();
        if (obj != null) {
            return obj.getJankShieldService();
        }
        return null;
    }
    ...
    public static HwUsbHDBManager getHwUsbHDBManager(Context context) {
        Factory obj = getImplObject();
        if (obj != null) {
            return obj.getHwUsbHDBManager(context);
        }
        return null;
    }
    ...
    public static IHiACELightController getHiACELightController() {
        Factory obj = getImplObject();
        if (obj != null) {
            return obj.getHiACELightController();
        }
        return null;
    }
    ...
    public static ICoverManagerService getCoverManagerService() {
        Factory obj = getImplObject();
        if (obj != null) {
            return obj.getCoverManagerService();
        }
        return null;
    }
    ...
    public static ActivityStack createActivityStack(ActivityContainer activityContainer, RecentTasks recentTasks) {
        Factory obj = getImplObject();
        if (obj != null) {
            return obj.createActivityStack(activityContainer, recentTasks);
        }
        return new ActivityStack(activityContainer, recentTasks);
    }

    public static ActivityRecord createActivityRecord(ActivityManagerService _service, ProcessRecord _caller, int _launchedFromUid, String _launchedFromPackage, Intent _intent, String _resolvedType, ActivityInfo aInfo, Configuration _configuration, ActivityRecord _resultTo, String _resultWho, int _reqCode, boolean _componentSpecified, boolean _rootVoiceInteraction, ActivityStackSupervisor supervisor, ActivityContainer container, ActivityOptions options, ActivityRecord sourceRecord) {
        Factory obj = getImplObject();
        if (obj != null) {
            return obj.createActivityRecord(_service, _caller, _launchedFromUid, _launchedFromPackage, _intent, _resolvedType, aInfo, _configuration, _resultTo, _resultWho, _reqCode, _componentSpecified, _rootVoiceInteraction, supervisor, container, options, sourceRecord);
        }
        return new ActivityRecord(_service, _caller, _launchedFromUid, _launchedFromPackage, _intent, _resolvedType, aInfo, _configuration, _resultTo, _resultWho, _reqCode, _componentSpecified, _rootVoiceInteraction, supervisor, container, options, sourceRecord);
    }
    ...
    public static DisplayContent createDisplayContent(Display display, WindowManagerService service) {
        Factory obj = getImplObject();
        if (obj != null) {
            return obj.createDisplayContent(display, service);
        }
        return new DisplayContent(display, service);
    }

    public static TaskRecord createTaskRecord(ActivityManagerService service, int _taskId, ActivityInfo info, Intent _intent, IVoiceInteractionSession _voiceSession, IVoiceInteractor _voiceInteractor) {
        Factory obj = getImplObject();
        if (obj != null) {
            return obj.createTaskRecord(service, _taskId, info, _intent, _voiceSession, _voiceInteractor);
        }
        return new TaskRecord(service, _taskId, info, _intent, _voiceSession, _voiceInteractor);
    }

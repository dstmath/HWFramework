...
final class NativeCrashListener extends Thread {
    ...
    static int unpackInt(byte[] buf, int offset) {
        return ((((buf[offset] & RampAnimator.DEFAULT_MAX_BRIGHTNESS) << 24) | ((buf[offset + 1] & RampAnimator.DEFAULT_MAX_BRIGHTNESS) << 16)) | ((buf[offset + 2] & RampAnimator.DEFAULT_MAX_BRIGHTNESS) << 8)) | (buf[offset + 3] & RampAnimator.DEFAULT_MAX_BRIGHTNESS);
    }
    ...
    void consumeNativeCrashData(FileDescriptor fd) {
        byte[] buf = new byte[DumpState.DUMP_PREFERRED];
        ByteArrayOutputStream os = new ByteArrayOutputStream(DumpState.DUMP_PREFERRED);
        try {

...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.content.SyncOperation.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.content.SyncOperation.<clinit>():void
...
*/
    ...
    private SyncOperation(EndPoint info, int owningUid, String owningPackage, int reason, int source, Bundle extras, boolean allowParallelSyncs) {
        this(info, owningUid, owningPackage, reason, source, extras, allowParallelSyncs, false, REASON_BACKGROUND_DATA_SETTINGS_CHANGED, 0, 0);
    }
    ...
    public SyncOperation(EndPoint info, int owningUid, String owningPackage, int reason, int source, Bundle extras, boolean allowParallelSyncs, boolean isPeriodic, int sourcePeriodicId, long periodMillis, long flexMillis) {
        ...
        this.jobId = REASON_BACKGROUND_DATA_SETTINGS_CHANGED;
        this.key = toKey();
    }
    ...
    static SyncOperation maybeCreateFromJobExtras(PersistableBundle jobExtras) {
        ...
        int initiatedBy = jobExtras.getInt("sourcePeriodicId", REASON_BACKGROUND_DATA_SETTINGS_CHANGED);
    ...
    boolean isReasonPeriodic() {
        return this.reason == REASON_PERIODIC;
    }
    ...
    boolean isDerivedFromFailedPeriodicSync() {
        return this.sourcePeriodicId != REASON_BACKGROUND_DATA_SETTINGS_CHANGED;
    }

...
public class CSegCOMHEAD extends ChrLogBaseModel {
    ...
    public LogString strHardwareVersion;
    ...
    public CSegCOMHEAD() {
        ...
        this.strHardwareVersion = new LogString(50);
        ...
        this.lengthMap.put("strHardwareVersion", Integer.valueOf(50));
        this.fieldMap.put("strHardwareVersion", this.strHardwareVersion);
    }
}

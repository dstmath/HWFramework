...
import com.android.server.mtm.condition.CombinedConditionMatchor;
import com.android.server.rms.iaware.hiber.constant.AppHibernateCst;
import com.android.server.rms.shrinker.ProcessStopShrinker;
import java.io.PrintWriter;

public final class TestvCombinedConditions {
    static CombinedConditionMatchor testmatchor;

    static {
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.mtm.test.TestvCombinedConditions.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.mtm.test.TestvCombinedConditions.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.mtm.test.TestvCombinedConditions.<clinit>():void");
    }
    ...
    public static final void test(PrintWriter pw, String[] args) {
        if (args[1] != null && pw != null) {
            ...
            if ("enable_log".equals(cmd)) {
                combinedConditionMatchor = testmatchor;
                CombinedConditionMatchor.enableDebug();
            } else if ("disable_log".equals(cmd)) {
                combinedConditionMatchor = testmatchor;
                CombinedConditionMatchor.disableDebug();
    ...
    private static void runConditionMatch(PrintWriter pw, String[] args) {
        ...
        if (args.length <= 6) {
            ...
            bundles.putString("combinedcondition", args[6]);
        }

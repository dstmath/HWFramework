...
public class HWExtMotionRotationProcessor {
    ...
    private HWExtDeviceEventListener mHWEDListener;
    private HWExtDeviceManager mHWEDManager;
    private HWExtMotion mHWExtMotion;
    private int mProposedRotation;
    private WindowOrientationListenerProxy mWOLPxy;
    ...
    public HWExtMotionRotationProcessor(WindowOrientationListenerProxy wolPxy) {
        ...
        this.mWOLPxy = null;
        this.mProposedRotation = SystemProperties.getInt("ro.panel.hw_orientation", 0) / 90;
        this.mHWEDListener = new HWExtDeviceEventListener() {
            public void onDeviceDataChanged(HWExtDeviceEvent hwextDeviceEvent) {
                ...
                } else if (deviceValues.length >= HWExtMotionRotationProcessor.MOTION_VALUES_LEN) {

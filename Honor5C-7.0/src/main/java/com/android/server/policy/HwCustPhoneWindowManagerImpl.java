...
public class HwCustPhoneWindowManagerImpl extends HwCustPhoneWindowManager {
    ...
    private static final boolean isQuickRecordSupported;
    public static final String mCustSimOperator;
    private static final boolean mDisableHomeKey;
    private static final boolean sEmergencyEnabled;
    private Context mContext;
    private long mLastPowerKeyPressedTime;
    private long mLastVolumeUpKeyDownTime;
    private int mPowerKeyPressedCount;
    private WakeLock mVolumeUpWakeLock;
    private long sLastPressOfPowerKey;
    private long sLastPressOfVolumeDownKey;
    private long sLastPressOfVolumeUpKey;

    static {
        sEmergencyEnabled = SystemProperties.getBoolean("ro.config.enable_sos", false);
        isQuickRecordSupported = SystemProperties.getBoolean("ro.config.hw_quickrecord", false);
        mDisableHomeKey = SystemProperties.getBoolean("ro.config.disableHomeKey", false);
        mCustSimOperator = SystemProperties.get("ro.config.hw_cbs_mcc");
    }

    public HwCustPhoneWindowManagerImpl() {
        this.sLastPressOfPowerKey = 0;
        this.sLastPressOfVolumeUpKey = 0;
        this.sLastPressOfVolumeDownKey = 0;

...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.policy.PolicyControl.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.policy.PolicyControl.<clinit>():void
...
*/
    ...
    public static int getWindowFlags(WindowState win, LayoutParams attrs) {
        ...
        if (sImmersiveStatusFilter != null && sImmersiveStatusFilter.matches(attrs)) {
            flags = (flags | DumpState.DUMP_PROVIDERS) & -67110913;
        }
        if (sImmersiveNavigationFilter == null || !sImmersiveNavigationFilter.matches(attrs)) {
            return flags;
        }

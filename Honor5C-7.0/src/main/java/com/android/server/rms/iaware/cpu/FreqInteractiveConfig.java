...
class FreqInteractiveConfig extends CPUCustBaseConfig {
    ...
    private Map<String, CPUPropInfoItem> mFreqInterInfo;
    private Map<String, String> mFreqInterItem2PropMap;
    private Map<String, CPUPropInfoItem> mNoSaveInfoMap;
    private Map<String, String> mNoSaveItem2PropMap;
    private Map<String, CPUPropInfoItem> mSaveInfoMap;
    private Map<String, String> mSaveItem2PropMap;
    private Map<String, CPUPropInfoItem> mSuperSaveInfoMap;
    private Map<String, String> mSuperSaveItem2PropMap;

    public FreqInteractiveConfig() {
        this.mSaveItem2PropMap = new HashMap();
        this.mSuperSaveItem2PropMap = new HashMap();
        this.mNoSaveItem2PropMap = new HashMap();
        this.mFreqInterItem2PropMap = new HashMap();
        this.mSaveInfoMap = new HashMap();
        this.mNoSaveInfoMap = new HashMap();
        this.mSuperSaveInfoMap = new HashMap();
        this.mFreqInterInfo = new HashMap();
        init();
    }
    ...
    public void setConfig(CPUFeature feature) {
        ...
        sendFreqInteractiveConfig(this.mFreqInterInfo, mInteractiveItemIndex, HwSecDiagnoseConstant.BIT_VERIFYBOOT);
        sendFreqInteractiveConfig(this.mSaveInfoMap, mInteractiveItemIndex, CPUFeature.MSG_SET_INTERACTIVE_SAVE);
        sendFreqInteractiveConfig(this.mNoSaveInfoMap, mInteractiveItemIndex, CPUFeature.MSG_SET_INTERACTIVE_NOSAVE);
    ...
    private void sendFreqInteractiveConfig(Map<String, CPUPropInfoItem> infoMap, String[] itemIndex, int msg) {
        if (infoMap.isEmpty()) {
            AwareLog.d(TAG, "you don't set xml, msg:" + msg);
            return;
        }

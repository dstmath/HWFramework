...
public class IOStatsHistory implements Cloneable {
    public static final int ENTRY_BYTE_SIZE = 28;
    private static final String FORMAT_UTF = "UTF-8";
    private static final String TAG = "IO.IOStatsHistory";
    ...
    public long getTotalBytesNum() {
        ...
        return (long) ((this.mIOStatsList.size() * ENTRY_BYTE_SIZE) + pkgByteSize);
    }
    ...
    public void writeToStream(DataOutputStream out) throws IOException {
        ...
        for (Entry entry : this.mIOStatsList) {
            if (entry.mNumberOfWrite != 0 || entry.mNumberOfRead != 0) {
                ...
                out.writeUTF(this.mPkgName != null ? this.mPkgName : AppHibernateCst.INVALID_PKG);
    ...
    public IOStatsHistory clone() {
        try {
            ...
            return new IOStatsHistory(0, AppHibernateCst.INVALID_PKG);
        }
    }

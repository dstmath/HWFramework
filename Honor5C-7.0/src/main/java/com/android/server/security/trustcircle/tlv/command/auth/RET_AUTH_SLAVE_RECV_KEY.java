...
public class RET_AUTH_SLAVE_RECV_KEY extends TLVRootTree {
    public static int ID = 0;
    public static final short TAG_AUTH_ID = (short) 4352;
    public static final short TAG_MAC = (short) 4353;
    public static final short TAG_RET_AUTH_SLAVE_RECV_KEY = (short) 17;
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.security.trustcircle.tlv.command.auth.RET_AUTH_SLAVE_RECV_KEY.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.security.trustcircle.tlv.command.auth.RET_AUTH_SLAVE_RECV_KEY.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.security.trustcircle.tlv.command.auth.RET_AUTH_SLAVE_RECV_KEY.<clinit>():void");
    }
    ...
    public short getTreeTag() {
        return TAG_RET_AUTH_SLAVE_RECV_KEY;
    }
}

    ...
    private final class Connection implements DeathRecipient {
        ...
        public boolean register() {
            ...
            try {
                ...
                binderDied();
                return TvRemoteProviderProxy.DEBUG_KEY;
            }
        }
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.tv.TvRemoteProviderProxy.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.tv.TvRemoteProviderProxy.<clinit>():void
    ...
    private void disconnect() {
        synchronized (this.mLock) {
            if (this.mActiveConnection != null) {
                this.mConnectionReady = DEBUG_KEY;

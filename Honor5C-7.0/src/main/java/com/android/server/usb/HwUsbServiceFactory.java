...
public class HwUsbServiceFactory {
    ...
    public interface IHwUsbDeviceManager {
        UsbDeviceManager getInstance(Context context, UsbAlsaManager usbAlsaManager);
    }

    static {
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.usb.HwUsbServiceFactory.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.usb.HwUsbServiceFactory.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.usb.HwUsbServiceFactory.<clinit>():void");
    }

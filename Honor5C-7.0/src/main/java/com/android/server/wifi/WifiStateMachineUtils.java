...
public class WifiStateMachineUtils extends EasyInvokeUtils {
    ...
    FieldObject<WifiQualifiedNetworkSelector> mWifiQualifiedNetworkSelector;
    ...
    public void replyToMessage(WifiStateMachine wifiStateMachine, Message msg, int what, int arg1) {
        MethodObject methodObject = this.replyToMessage;
        Object[] objArr = new Object[POOR_LINK_DETECTED];
        objArr[0] = msg;
        objArr[1] = Integer.valueOf(what);
        objArr[2] = Integer.valueOf(arg1);
        invokeMethod(methodObject, wifiStateMachine, objArr);
    }
    ...
    @GetField(fieldObject = "mWifiQualifiedNetworkSelector")
    public WifiQualifiedNetworkSelector getWifiQualifiedNetworkSelector(WifiStateMachine wifiStateMachine) {
        return (WifiQualifiedNetworkSelector) getField(this.mWifiQualifiedNetworkSelector, wifiStateMachine);
    }

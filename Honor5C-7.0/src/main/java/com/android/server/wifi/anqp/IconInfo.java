...
public class IconInfo {
    ...
    public IconInfo(ByteBuffer payload) throws ProtocolException {
        ...
        this.mIconType = Constants.getPrefixedString(payload, 1, StandardCharsets.US_ASCII);
        this.mFileName = Constants.getPrefixedString(payload, 1, StandardCharsets.UTF_8);
    }

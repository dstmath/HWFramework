...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.wifi.hotspot2.Utils.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.wifi.hotspot2.Utils.<clinit>():void
...
*/
    ...
    public static String macToString(long mac) {
        int len = (-281474976710656L & mac) != 0 ? EUI64Length : EUI48Length;
        StringBuilder sb = new StringBuilder();
        boolean first = true;
        for (int n = (len - 1) * EUI64Length; n >= 0; n -= 8) {
            if (first) {
                first = false;
            } else {
                sb.append(':');
    ...
    public static String toUTCString(long ms) {
        ...
        Object[] objArr = new Object[EUI48Length];

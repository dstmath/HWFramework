...
public class HwRouterModelRecognition {
    private static final String ACTION_ROUTER_MODEL_RECOGNITION_RESULT = "com.huawei.wifiprobqeservice.ROUTER_MODEL_RECOGNITION_RESULT";
    ...
    private static HwRouterModelRecognition routerModelInstance;
    private Context mContext;
    private String mGateway;
    private String mGatewayLast;
    private NetworkInfo mNetworkInfo;
    private final BroadcastReceiver mReceiver;
    RouterHandler mRouterHandler;
    private String mSSID;
    private String mSSIDLast;
    private Intent mServiceIntent;
    private WifiManager mWM;
    private HwWifiCHRStateManager mWcsm;
    private HwWifiCHRStateManagerImpl mWcsmImpl;
    ...
    protected class RouterHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case HwRouterModelRecognition.MSG_START_RMC_SERVICE /*1000*/:
                    ...
                    sendEmptyMessageDelayed(HwRouterModelRecognition.MSG_STOP_RMC_SERVICE, 60000);
                case HwRouterModelRecognition.MSG_STOP_RMC_SERVICE /*1001*/:
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.wifi.routermodelrecognition.HwRouterModelRecognition.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.wifi.routermodelrecognition.HwRouterModelRecognition.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.wifi.routermodelrecognition.HwRouterModelRecognition.<clinit>():void");
    }

    public HwRouterModelRecognition() {
        this.mSSID = "";
        this.mGateway = "";
        this.mSSIDLast = "";
        this.mGatewayLast = "";
                ...
                if (intent != null) {
                    ...
                    if (action != null) {
                        if (action.equals("android.net.wifi.STATE_CHANGE")) {
                                ...
                                switch (AnonymousClass1.-getandroid-net-NetworkInfo$DetailedStateSwitchesValues()[HwRouterModelRecognition.this.mNetworkInfo.getDetailedState().ordinal()]) {
                                    case WifiScanGenieController.MSG_CONFIGURED_CHANGED /*1*/:
                                        if (!HwRouterModelRecognition.mIsWifiConnected) {
                                            ...
                                            if (!(HwRouterModelRecognition.this.mSSID == null || HwRouterModelRecognition.this.mSSID.isEmpty() || HwRouterModelRecognition.this.mGateway == null || HwRouterModelRecognition.this.mGateway.isEmpty() || (HwRouterModelRecognition.this.mSSID.equals(HwRouterModelRecognition.this.mSSIDLast) && HwRouterModelRecognition.this.mGateway.equals(HwRouterModelRecognition.this.mGatewayLast)))) {
                                                HwRouterModelRecognition.this.mRouterHandler.sendEmptyMessageDelayed(HwRouterModelRecognition.MSG_START_RMC_SERVICE, 300000);
                                                if (HwRouterModelRecognition.HWFLOW) {
                                    ...
                                    case WifiScanGenieDataBaseImpl.DATABASE_VERSION /*2*/:
                                        HwRouterModelRecognition.mIsWifiConnected = HwRouterModelRecognition.HWFLOW;
                                        HwRouterModelRecognition.this.mRouterHandler.removeMessages(HwRouterModelRecognition.MSG_START_RMC_SERVICE);
                                        break;
                                }
                            }
                            ...
                            HwRouterModelRecognition.this.mWcsmImpl.updateRouterModelInfo(routerName, routerBrand);
                            HwRouterModelRecognition.this.mRouterHandler.removeMessages(HwRouterModelRecognition.MSG_STOP_RMC_SERVICE);
                            HwRouterModelRecognition.this.mRouterHandler.sendEmptyMessage(HwRouterModelRecognition.MSG_STOP_RMC_SERVICE);
                        }
                    }
                }
            }
    ...
    private boolean init(Context context) {
        ...
        if (this.mContext == null || this.mWcsm == null || !(this.mWcsm instanceof HwWifiCHRStateManagerImpl)) {

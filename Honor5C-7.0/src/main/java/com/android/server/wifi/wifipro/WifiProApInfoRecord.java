...
public class WifiProApInfoRecord {
    ...
    public long lastRecordRealTime;
    ...
    public void resetAllParameters() {
        ...
        this.apSecurityType = WIFI_SECURITY_TYPE_UNKNOWN;
        this.lanDataSize = 0;
        this.highSpdFreq = 0;

...
class InputConsumerImpl {
    ...
    private int getLayerLw(int windowType) {
        return (this.mService.mPolicy.windowTypeToLayerLw(windowType) * AbsPowerManagerService.MIN_COVER_SCREEN_OFF_TIMEOUT) + ProcessList.PSS_SAFE_TIME_FROM_STATE_CHANGE;
    }

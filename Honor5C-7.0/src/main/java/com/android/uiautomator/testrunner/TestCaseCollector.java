...
public class TestCaseCollector {
    ...
    /* renamed from: com.android.uiautomator.testrunner.TestCaseCollector.1 */
    class AnonymousClass1 extends UiAutomatorTestCase {
        final /* synthetic */ String val$message;

        AnonymousClass1(String val$message) {
            this.val$message = val$message;
        }

        protected void runTest() {
            AnonymousClass1.fail(this.val$message);
        }
    }
    ...
    private UiAutomatorTestCase error(Class<?> clazz, String message) {
        UiAutomatorTestCase warning = new AnonymousClass1(message);

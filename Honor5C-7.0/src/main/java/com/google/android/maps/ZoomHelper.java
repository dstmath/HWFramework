...
class ZoomHelper {
    private final AnimationSet mAnimations;
    private final Paint mBitmapPaint;
    private long mCommitTime;
    private final MapController mController;
    private boolean mFading;
    private final Transformation mLastDrawnScale;
    ...
    ZoomHelper(MapView mapView, MapController controller) {
        this.mLastDrawnScale = new Transformation();
        this.mAnimations = new AnimationSet(false);

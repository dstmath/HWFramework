...
public class BastetEmail extends BastetManager {
    ...
    protected BastetEmail(EmailLoginInfo login, EmailSyncConfig config, int protocol, Handler handler) {
        ...
        try {
            this.mProxyId = mIBastetManager.initEmailProxy(this.mProtocol, this.mLoginInfo.getHost(), this.mLoginInfo.getPort(), this.mLoginInfo.getSecurity(), this.mLoginInfo.getInterval(), this.mLoginInfo.getAccount(), this.mLoginInfo.getPassword(), this.mIBastetListener);
    ...
    public void startProxy() throws Exception {
        ...
        mIBastetManager.updateEmailBoxInfo(this.mProxyId, this.mSyncConfig.getFolderName(), this.mSyncConfig.getLatestUid());
        mIBastetManager.startBastetProxy(this.mProxyId);
    }
    ...
    public void stopProxy() throws Exception {
        ...
        mIBastetManager.stopBastetProxy(this.mProxyId);
    }
    ...
    public void clearProxy() throws Exception {
        ...
        mIBastetManager.clearProxyById(this.mProxyId);
    }
}

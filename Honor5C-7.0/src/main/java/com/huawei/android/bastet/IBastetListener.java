...
public interface IBastetListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBastetListener {
        ...
        private static class Proxy implements IBastetListener {
            ...
            public void onProxyIndicateMessage(int proxyId, int err, int ext) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(err);
                    _data.writeInt(ext);
                    this.mRemote.transact(Stub.TRANSACTION_onProxyIndicateMessage, _data, null, Stub.TRANSACTION_onProxyIndicateMessage);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_onProxyIndicateMessage /*1*/:

...
public class FmRxRdsData {
    ...
    public int rdsOn(boolean on) {
        ...
        if (on) {
            return FmReceiverWrapper.setControlNative(this.mFd, V4L2_CID_PRIVATE_TAVARUA_RDSON, RDS_GROUP_RT);
        }
    ...
    public int rdsOptions(int rdsMask) {
        ...
        return FmReceiverWrapper.setControlNative(this.mFd, V4L2_CID_PRIVATE_TAVARUA_PSALL, psAllVal >> RDS_GROUP_AF);
    }

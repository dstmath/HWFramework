...
public class FmTransmitter extends FmTransceiver {
    ...
    public static class FmPSFeatures {
        ...
        public FmPSFeatures() {
            this.mMaxPSCharacters = FmTransmitter.RDS_GRPS_TX_PAUSE;
            this.mMaxPSStringRepeatCount = FmTransmitter.RDS_GRPS_TX_PAUSE;
        }
    ...
    public boolean enable(FmConfig configSettings) {
        super.enable(configSettings, RDS_GRPS_TX_STOP);
        return true;
    }

        ...
        private static class Proxy implements IHwAttestationService {
            ...
            public byte[] getAttestationSignature(int keyIndex, int deviceIdType, String signatureType, byte[] challenge) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getAttestationSignature, _data, _reply, 0);
            ...
            public int getPublickKey(int keyIndex, byte[] keyBuf) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getPublickKey, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
            ...
            public int getDeviceCertType(int keyIndex) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(keyIndex);
                    this.mRemote.transact(Stub.TRANSACTION_getDeviceCertType, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getDeviceCert(int keyIndex, int certType, byte[] certBuf) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getDeviceCert, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_getDeviceID /*3*/:
                    ...
                    reply.writeByteArray(_result);
                    return true;
                case TRANSACTION_getPublickKey /*4*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt();
                    ...
                    return true;
                case TRANSACTION_getDeviceCertType /*5*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getDeviceCertType(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_getDeviceCert /*6*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt();

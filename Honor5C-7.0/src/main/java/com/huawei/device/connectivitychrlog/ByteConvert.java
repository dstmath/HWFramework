...
public class ByteConvert {
    ...
    public static byte[] intToBytes(int n) {
        return new byte[]{(byte) (n & PduHeaders.STORE_STATUS_ERROR_END), (byte) ((n >> 8) & PduHeaders.STORE_STATUS_ERROR_END), (byte) ((n >> 16) & PduHeaders.STORE_STATUS_ERROR_END), (byte) ((n >> 24) & PduHeaders.STORE_STATUS_ERROR_END)};
    }

    public static int bytesToInt(byte[] b) {
        return (((b[3] & PduHeaders.STORE_STATUS_ERROR_END) | ((b[2] & PduHeaders.STORE_STATUS_ERROR_END) << 8)) | ((b[1] & PduHeaders.STORE_STATUS_ERROR_END) << 16)) | ((b[0] & PduHeaders.STORE_STATUS_ERROR_END) << 24);
    }

    public static int littleEndianBytesToInt(byte[] b) {
        return (((b[0] & PduHeaders.STORE_STATUS_ERROR_END) | ((b[1] & PduHeaders.STORE_STATUS_ERROR_END) << 8)) | ((b[2] & PduHeaders.STORE_STATUS_ERROR_END) << 16)) | ((b[3] & PduHeaders.STORE_STATUS_ERROR_END) << 24);
    }

    public static byte[] shortToBytes(short n) {
        return new byte[]{(byte) (n & PduHeaders.STORE_STATUS_ERROR_END), (byte) ((n >> 8) & PduHeaders.STORE_STATUS_ERROR_END)};
    }

    public static short bytesToShort(byte[] b) {
        return (short) ((b[1] & PduHeaders.STORE_STATUS_ERROR_END) | ((b[0] & PduHeaders.STORE_STATUS_ERROR_END) << 8));
    }

    public static short littleEndianBytesToShort(byte[] b) {
        return (short) ((b[0] & PduHeaders.STORE_STATUS_ERROR_END) | ((b[1] & PduHeaders.STORE_STATUS_ERROR_END) << 8));
    }

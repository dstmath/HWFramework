...
public class CSegEVENT_WIFI_OPEN_FAILED_EX extends ChrLogBaseEventModel {
    ...
    public CSegEVENT_WIFI_OPEN_FAILED_EX() {
        ...
        this.enEventId.setValue("WIFI_OPEN_FAILED_EX");

...
public class CameraPermission {
    ...
    public void remind() {
        if (StubController.checkPrecondition(this.mUid)) {
            if ((this.mContext == null || StubController.isGlobalSwitchOn(this.mContext, ConstantValue.transaction_setBluetoothDisabled)) && 2 == StubController.holdForGetPermissionSelection(ConstantValue.transaction_setBluetoothDisabled, this.mUid, this.mPid, null)) {

...
public class IndexSearchInfo {
    ...
    public static final class IntentBuilder {
        ...
        private LinkedHashMap<String, String> intentExtraMatch;
        private int mode;
        private HashMap<String, String> queryMatch;
        private Uri uri;

        public IntentBuilder(Uri mUri, HashMap<String, String> queryMatch) {
            this.queryMatch = new HashMap();
            this.intentExtraMatch = new LinkedHashMap();
            this.uri = mUri;

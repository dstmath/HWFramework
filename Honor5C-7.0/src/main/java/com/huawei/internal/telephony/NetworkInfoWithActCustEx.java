...
public class NetworkInfoWithActCustEx {
    ...
    public NetworkInfoWithActCustEx() {
        this.operatorNumeric = WifiManagerCustEx.SUPPLICANT_WAPI_EVENT;
        this.nAct = 0;
        this.nPriority = 0;
    }
    ...
    public static String actToStr(int act) {
        String result = WifiManagerCustEx.SUPPLICANT_WAPI_EVENT;
        switch (act) {
            case ACT_GSM /*1*/:
                return "GSM";
            case ACT_GSM_COMPACT /*2*/:
                return "GSM_COMPACT";
            case ACT_UTRAN /*4*/:
                return "UMTS";
            ...
            case ACT_LTE /*8*/:
                return "LTE";
            default:
                return WifiManagerCustEx.SUPPLICANT_WAPI_EVENT + act;
        }
    }

...
public final class MotionTypeApps {
    ...
    private static String getTiltLrKey(int motionApps) {
        ...
        switch (motionApps) {
            case TYPE_TILT_LR /*600*/:
                return KEY_TILT_LR;
            case TYPE_TILT_LR_MOVE_WIDGETS /*601*/:
                return KEY_TILT_LR_MOVE_WIDGETS;
            case TYPE_TILT_LR_SINGLE_HAND /*602*/:
    ...
    private static String getPickupKey(int motionApps) {
        ...
        switch (motionApps) {
            case TYPE_PICKUP /*100*/:
                return KEY_PICKUP;
            case TYPE_PICKUP_REDUCE_CALL /*101*/:
                return KEY_PICKUP_REDUCE_CALL;
            case TYPE_PICKUP_REDUCE_CLOCK /*102*/:
                return KEY_PICKUP_REDUCE_CLOCK;
            case TYPE_PICKUP_END_HINTS /*103*/:

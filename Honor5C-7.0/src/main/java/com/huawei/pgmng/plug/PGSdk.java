...
public class PGSdk implements DeathRecipient {
    ...
    private static PGSdk sInstance;
    private final ArrayList<Integer> mEnabledStates;
    private final Object mLock;
    private final HashSet<Sink> mSinkSet;
    private final HashMap<Sink, ArrayList<Integer>> mSinkSetStates;
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.huawei.pgmng.plug.PGSdk.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.huawei.pgmng.plug.PGSdk.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.pgmng.plug.PGSdk.<clinit>():void");
    }
    ...
    private boolean registerSink(Sink sink) {
        ...
        if (!this.mSinkSet.contains(sink)) {
            ...
            if (this.mSinkSet.size() == TYPE_LAUNCHER) {
    ...
    public void binderDied() {
        ...
        synchronized (this.mLock) {
            ...
            if (mService != null) {
                this.mSinkTransport.onStateChanged(TYPE_EBOOK, 0, 0, "", 0);
                startStateRecognitionProvider();

    ...
    public RGBLuminanceSource(int width, int height, int[] pixels) {
        ...
        for (int y = 0; y < height; y++) {
            ...
            for (int x = 0; x < width; x++) {
                ...
                int r = (pixel >> 16) & IccConstantsEx.RUIM_SMS_BEARER_DATA_LEN;
                int g = (pixel >> 8) & IccConstantsEx.RUIM_SMS_BEARER_DATA_LEN;
                int b = pixel & IccConstantsEx.RUIM_SMS_BEARER_DATA_LEN;
                if (r == g && g == b) {

...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.huawei.zxing.qrcode.decoder.Version.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.huawei.zxing.qrcode.decoder.Version.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.zxing.qrcode.decoder.Version.<clinit>():void");
    }
    ...
    private static Version[] buildVersions() {
        ...
        iArr = new int[]{6, 30, 54, 78, MotionTypeApps.TYPE_PICKUP_REDUCE_CLOCK};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 32, 58, 84, MetricConstant.SDCARD_METRIC_ID_EX};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 30, 54, 78, MotionTypeApps.TYPE_PICKUP_REDUCE_CLOCK, 126};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 26, 52, 78, MetricConstant.CAMERA_METRIC_ID_EX, 130};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 30, 56, 82, MetricConstant.GPS_METRIC_ID_EX, 134};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 30, 54, 78, MotionTypeApps.TYPE_PICKUP_REDUCE_CLOCK, 126, 150};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 24, 50, 76, MotionTypeApps.TYPE_PICKUP_REDUCE_CLOCK, AppOpsManagerEx.TYPE_MICROPHONE, 154};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 28, 54, 80, MetricConstant.WIFI_METRIC_ID_EX, 132, 158};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 32, 58, 84, MetricConstant.SDCARD_METRIC_ID_EX, 136, 162};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 26, 54, 82, MetricConstant.SDCARD_METRIC_ID_EX, 138, 166};
        eCBlocksArr = new ECBlocks[4];

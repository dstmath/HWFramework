...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.huawei.zxing.qrcode.encoder.Encoder.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.huawei.zxing.qrcode.encoder.Encoder.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.zxing.qrcode.encoder.Encoder.<clinit>():void");
    }
    ...
    private static boolean isOnlyDoubleByteKanji(String content) {
        try {
            ...
            for (int i = 0; i < length; i += 2) {
                int byte1 = bytes[i] & IccConstantsEx.RUIM_SMS_BEARER_DATA_LEN;
    ...
    static byte[] generateECBytes(byte[] dataBytes, int numEcBytesInBlock) {
        ...
        for (i = 0; i < numDataBytes; i++) {
            toEncode[i] = dataBytes[i] & IccConstantsEx.RUIM_SMS_BEARER_DATA_LEN;
        }
    ...
    static void appendKanjiBytes(String content, BitArray bits) throws WriterException {
        try {
            ...
            int length = bytes.length;
            for (int i = 0; i < length; i += 2) {
                int byte2 = bytes[i + 1] & IccConstantsEx.RUIM_SMS_BEARER_DATA_LEN;
                int code = ((bytes[i] & IccConstantsEx.RUIM_SMS_BEARER_DATA_LEN) << 8) | byte2;
                int subtracted = -1;
                ...
                bits.appendBits(((subtracted >> 8) * HwCarrierConfigManager.HD_ICON_MASK_DIALER) + (subtracted & IccConstantsEx.RUIM_SMS_BEARER_DATA_LEN), 13);
            }
        } catch (Throwable uee) {
            throw new WriterException(uee);
        }

...
*/
    ...
    protected void sprint(String a) {
        ...
        this.stringRepresentation += RETURN;
        if (a.compareTo("{") == 0 || a.compareTo("[") == 0) {
            this.indentation++;
        }
    }
                        ...
                        try {
                            if (fieldType.isPrimitive()) {
                                ...
                                if ((hisObj != null || myObj == null) && !(hisObj == null && myObj == null)) {
                                    ...
                                    if (isMySubclass(myObj.getClass())) {
                            ...
                            if (fieldType.isPrimitive()) {
                                ...
                                if (!GenericObject.class.isAssignableFrom(fieldType)) {
                                    if (!GenericObjectList.class.isAssignableFrom(fieldType)) {
                                        if (f.get(this) != null) {
                                            sprint(f.get(this).getClass().getName() + COLON);
                                        } else {
                                            sprint(fieldType.getName() + COLON);
                                        }
                                        sprint("{");
                                        if (f.get(this) != null) {

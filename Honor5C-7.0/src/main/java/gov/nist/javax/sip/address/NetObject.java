                            ...
                            try {
                                if (fieldType.isPrimitive()) {
                                                ...
                                                if (fname.compareTo("long") != 0) {
                                                    if (fname.compareTo("boolean") == 0) {
                                                        ...
                                                        if (fname.compareTo("double") != 0) {
                                                            if (fname.compareTo("float") == 0 && f.getFloat(this) != g.getFloat(that)) {
                                                                return false;
                                                            }
                                                        } else if (f.getDouble(this) != g.getDouble(that)) {
                                                            return false;
                                                        }
                                                    }
                                                } else if (f.getLong(this) != g.getLong(that)) {
                                                    return false;
                                                }
                                            }
                                        }
                                    ...
                                    if ((hisObj != null || myObj == null) && !(hisObj == null && myObj == null)) {
                                        ...
                                        if (GenericObject.isMySubclass(myObj.getClass()) && GenericObject.isMySubclass(hisObj.getClass()) && myObj.getClass().equals(hisObj.getClass())) {
                                            if (((GenericObject) hisObj).getMatcher() != null) {
                                                String myObjEncoded = ((GenericObject) myObj).encode();
                                                if (!((GenericObject) hisObj).getMatcher().match(myObjEncoded)) {
                                                    return false;
                                                }
                                            }
                                        }
                                        if (GenericObject.isMySubclass(myObj.getClass())) {
                                            if (!((GenericObject) myObj).match(hisObj)) {
                                                return false;
                                            }
                                        }

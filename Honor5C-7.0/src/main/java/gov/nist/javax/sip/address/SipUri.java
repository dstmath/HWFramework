...
public class SipUri extends GenericURI implements SipURI, SipURIExt {
    ...
    public void setScheme(String scheme) {
        if (scheme.compareToIgnoreCase(TokenNames.SIP) == 0 || scheme.compareToIgnoreCase(TokenNames.SIPS) == 0) {
    ...
    public void removeTTL() {
        if (this.uriParms != null) {
            this.uriParms.delete(Via.TTL);
        }
    }

    public void removeMAddr() {
        if (this.uriParms != null) {
            this.uriParms.delete(Via.MADDR);
        }
    }
    ...
    public void setMAddr(String mAddr) {
        NameValue nameValue = this.uriParms.getNameValue(Via.MADDR);
        Host host = new Host();
        ...
        this.uriParms.set(new NameValue(Via.MADDR, host));
    }
    ...
    public String getMAddrParam() {
        NameValue maddr = this.uriParms.getNameValue(Via.MADDR);
        if (maddr == null) {
            return null;
        }
    ...
    public int getTTLParam() {
        Integer ttl = (Integer) this.uriParms.getValue(Via.TTL);
        if (ttl != null) {
            return ttl.intValue();
        }
        return -1;
    ...
    public boolean isSecure() {
        return getScheme().equalsIgnoreCase(TokenNames.SIPS);
    }
    ...
    public void setParameter(String name, String value) throws ParseException {
        if (name.equalsIgnoreCase(Via.TTL)) {
            try {
    ...
    public void setTTLParam(int ttl) {
        if (ttl <= 0) {
            ...
            this.uriParms.set(new NameValue(Via.TTL, Integer.valueOf(ttl)));
        }
    }

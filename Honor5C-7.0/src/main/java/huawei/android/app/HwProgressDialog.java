                ...
                public void handleMessage(Message msg) {
                    ...
                    if (!HwWidgetFactory.isHwTheme(HwProgressDialog.this.getContext())) {
                        if (HwProgressDialog.this.mProgressNumberFormat != null) {
                            ...
                            HwProgressDialog.this.mProgressNumber.setText(MSimTelephonyConstants.MY_RADIO_PLATFORM);
                        }
                    }
                    if (HwProgressDialog.this.mProgressPercentFormat != null) {
                        ...
                        tmp.setSpan(new StyleSpan(HwProgressDialog.STYLE_HORIZONTAL), 0, tmp.length(), 33);
                        HwProgressDialog.this.mProgressPercent.setText(tmp);
                        return;
                    }
                    HwProgressDialog.this.mProgressPercent.setText(MSimTelephonyConstants.MY_RADIO_PLATFORM);
                }
            };
            if (HwWidgetFactory.isHwTheme(getContext())) {
                view = inflater.inflate(34013221, null);
                this.mMessageView = (TextView) view.findViewById(34603117);
                this.mProgress = (ProgressBar) view.findViewById(34603119);
                this.mProgressPercent = (TextView) view.findViewById(34603118);
                this.mCancel = view.findViewById(34603120);
                this.mSpace = view.findViewById(34603121);
                view.setTag(this);
            } else {
                view = inflater.inflate(a.getResourceId(17, 17367085), null);
                this.mProgress = (ProgressBar) view.findViewById(16908301);
                this.mProgressNumber = (TextView) view.findViewById(16909097);
                this.mProgressPercent = (TextView) view.findViewById(16909096);
            }
            setView(view);
        } else {
            view = inflater.inflate(a.getResourceId(16, 17367231), null);
            this.mProgress = (ProgressBar) view.findViewById(16908301);

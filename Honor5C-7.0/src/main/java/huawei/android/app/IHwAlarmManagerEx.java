    ...
    public static abstract class Stub extends Binder implements IHwAlarmManagerEx {
        ...
        private static class Proxy implements IHwAlarmManagerEx {
            ...
            public void setAlarmsPending(List<String> pkgList, List<String> actionList, boolean pending, int allAlarms) throws RemoteException {
                int i = Stub.TRANSACTION_setAlarmsPending;
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setAlarmsPending, _data, _reply, 0);
            ...
            public void removeAllPendingAlarms() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_removeAllPendingAlarms, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setAlarmsAdjust(List<String> pkgList, List<String> actionList, boolean adjust, int type, long interval, int mode) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStringList(actionList);
                    if (adjust) {
                        i = Stub.TRANSACTION_setAlarmsPending;
                    }
                    _data.writeInt(i);
                    _data.writeInt(type);
                    _data.writeLong(interval);
                    _data.writeInt(mode);
                    this.mRemote.transact(Stub.TRANSACTION_setAlarmsAdjust, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void removeAllAdjustAlarms() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_removeAllAdjustAlarms, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case TRANSACTION_setAlarmsAdjust /*3*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_removeAllAdjustAlarms /*4*/:
                    data.enforceInterface(DESCRIPTOR);

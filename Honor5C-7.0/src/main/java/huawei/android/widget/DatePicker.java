...
public class DatePicker extends android.widget.DatePicker {
    ...
    protected boolean hwValueChange(NumberPicker picker, int oldVal, int newVal) {
        ...
        if (picker == getDaySpinner()) {
            ...
            dateTemp.add(DEFAULT_DATE_ORDER_SECOND, newVal - oldVal);
        } else if (picker == getYearSpinner()) {
            dateTemp.add(DEFAULT_DATE_ORDER_FIRST, newVal - oldVal);
        } else {
    ...
    private void setDivider() {
        this.mDatedivider1 = findViewById(34603095);
        this.mDatedivider2 = findViewById(34603096);
        ...
        if (childCount > DEFAULT_DATE_ORDER_SECOND && this.mDatedivider2 != null) {
            spinnerGroup.addView(this.mDatedivider2, DEFAULT_DATE_ORDER_SECOND);
        }
        if (childCount > DEFAULT_DATE_ORDER_FIRST && this.mDatedivider1 != null) {
            spinnerGroup.addView(this.mDatedivider1, DEFAULT_DATE_ORDER_FIRST);
        }
    }

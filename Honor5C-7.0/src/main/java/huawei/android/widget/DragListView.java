...
public class DragListView extends ListView {
    ...
    public DragListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mRightTouchTolerance = Float.valueOf(getResources().getDimension(34472093)).intValue();
        this.mLeftTouchTolerance = Float.valueOf(getResources().getDimension(34472094)).intValue();
        this.mItemHeightNormal = Float.valueOf(getResources().getDimension(34472092)).intValue();
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if (this.mDropListener != null && ev.getAction() == 0) {
            ...
            View dragger = item.findViewById(34603105);
            ...
            if (isDragHandle) {
                ...
                this.mLowerBound = Math.max(this.mTouchSlop + y, (this.mHeight * 2) / 3);
                return false;
            }
        }
        return super.onInterceptTouchEvent(ev);
            ...
            case ViewDragHelper.STATE_SETTLING /*2*/:
                ...
                if (!(itemnum == -1 || this.mDragListViewAdapter.getFlagCanNotDrag(itemnum) || itemnum < 0)) {
                    ...
                    if (y > this.mLowerBound) {
                        speed = getLastVisiblePosition() < getCount() + -1 ? y > (this.mHeight + this.mLowerBound) / 2 ? 16 : 4 : SLIDE;

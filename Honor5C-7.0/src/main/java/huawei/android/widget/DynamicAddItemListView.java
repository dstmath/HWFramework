...
public class DynamicAddItemListView extends ListView {
    ...
    public DynamicAddItemListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mTextView = (TextView) this.mDynamicAddItemLayout.findViewById(34603107);
        this.mEditText = (EditText) this.mDynamicAddItemLayout.findViewById(34603110);
        this.mEditText.setBackground(null);
        this.mCancelButton = (Button) this.mDynamicAddItemLayout.findViewById(34603108);
        this.mConfirmButton = (Button) this.mDynamicAddItemLayout.findViewById(34603112);
        this.mCustomPanel = (ViewGroup) this.mDynamicAddItemLayout.findViewById(34603111);
        this.mErrorTipTextLayout = (ErrorTipTextLayout) this.mDynamicAddItemLayout.findViewById(34603109);
        this.mOriPaddingStart = this.mEditText.getPaddingStart();
        this.mOriPaddingEnd = this.mEditText.getPaddingEnd();
        this.mPaddingHorizontal = context.getResources().getDimensionPixelOffset(34472152);
        this.mPaddingVertical = context.getResources().getDimensionPixelOffset(34472153);
        this.mTipPadding = context.getResources().getDimensionPixelOffset(34472154);
        ...
        this.mConfirmButton.setOnClickListener(new OnClickListener() {
            public void onClick(View arg0) {
                String s_null = MSimTelephonyConstants.MY_RADIO_PLATFORM;
                String s_user_input = DynamicAddItemListView.this.mEditText.getText().toString();
                if (!(s_null.equals(s_user_input) || DynamicAddItemListView.this.mOnAddItemListener == null)) {
    ...
    private void exitEditMode() {
        this.mEditText.setText(MSimTelephonyConstants.MY_RADIO_PLATFORM);

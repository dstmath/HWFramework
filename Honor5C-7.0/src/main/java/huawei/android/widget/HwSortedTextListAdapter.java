...
public class HwSortedTextListAdapter extends BaseAdapter {
    ...
    /* renamed from: huawei.android.widget.HwSortedTextListAdapter.1 */
    class AnonymousClass1 implements Comparator<Map<String, ?>> {
        final /* synthetic */ Comparator val$comparator;

        AnonymousClass1(Comparator val$comparator) {
        ...
        public int compare(Map<String, ?> map1, Map<String, ?> map2) {
            ...
            if (HwSortedTextListAdapter.EMPTY_SECTION.equals(section1) && HwSortedTextListAdapter.EMPTY_SECTION.equals(section2)) {
                return this.val$comparator.compare(sortKey1, sortKey2);
            }
            if (HwSortedTextListAdapter.EMPTY_SECTION.equals(section1) && !HwSortedTextListAdapter.EMPTY_SECTION.equals(section2)) {
                return 1;
            }
            ...
            int labelResult = this.val$comparator.compare(section1, section2);
            if (labelResult == 0) {
                labelResult = this.val$comparator.compare(sortKey1, sortKey2);
            }
            return labelResult;
        }
    }

    /* renamed from: huawei.android.widget.HwSortedTextListAdapter.2 */
    class AnonymousClass2 implements Comparator<String> {
        final /* synthetic */ Collator val$comparator;

        AnonymousClass2(Collator val$comparator) {
            this.val$comparator = val$comparator;
        }
        ...
        public int compare(String str1, String str2) {
            ...
            return this.val$comparator.compare(str1, str2);
        }
    }
    ...
    public void sort(Comparator<Object> comparator) {
        synchronized (this.mLock) {
            Collections.sort(this.mData, new AnonymousClass1(comparator));
        }
    ...
    private void buildSectionIndexer() {
        ...
        Arrays.sort(sections, new AnonymousClass2(comparator));

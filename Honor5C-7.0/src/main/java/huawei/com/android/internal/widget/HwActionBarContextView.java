...
public class HwActionBarContextView extends ActionBarContextView implements OnClickListener, ActionModeView {
    ...
    public HwActionBarContextView(Context context, AttributeSet attrs) {
        ...
        this.mOKMenuItem = new ActionMenuItem(context, 0, 16909180, 0, 0, context.getString(17039370));
        this.mCancelMenuItem = new ActionMenuItem(context, 0, 16909122, 0, 0, context.getString(17039360));
    }
    ...
    protected void initTitle() {
        ...
        if (titleLayout == null) {
            ...
            if (titleLayout != null) {
                this.mOK = (ImageView) titleLayout.findViewById(16909180);
                this.mCancel = (ImageView) titleLayout.findViewById(16909122);
                ...
                titleView = (TextView) titleLayout.findViewById(16909073);
                subTitleView = (TextView) titleLayout.findViewById(16909074);
                if (this.mOK != null) {
        ...
        if (subTitleView != null) {
            subTitleView.setVisibility(!TextUtils.isEmpty(getSubtitle()) ? 0 : 8);
    ...
    public void onClick(View view) {
        ...
        if (callback != null && actionMode != null) {
            if (view.getId() == 16909180) {
                if (!callback.onMenuItemSelected((MenuBuilder) actionMode.getMenu(), this.mOKMenuItem)) {
                    actionMode.finish();
                }
            } else if (view.getId() == 16909122 && !callback.onMenuItemSelected((MenuBuilder) actionMode.getMenu(), this.mCancelMenuItem)) {
                actionMode.finish();
            }
        }
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed && getParent() != null) {
            ...
            if (vp != null && vp.getId() != 16909293 && vp.getId() != 16909290) {

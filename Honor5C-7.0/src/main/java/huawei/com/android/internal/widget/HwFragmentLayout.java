...
public class HwFragmentLayout extends RelativeLayout implements OnTouchListener, HwFragmentFrameLayoutCallback {
    ...
    private class FadeAnimationListener implements AnimationListener {
        ...
        public void onAnimationStart(Animation animation) {
            HwFragmentLayout.this.getLeftBlurLayer().setLayerType(HwFragmentLayout.WIDTH_SPLIT_LINE_DEFAULT, null);
            HwFragmentLayout.this.getLeftBlurLayer().setVisibility(0);
            HwFragmentLayout.this.getLeftBlurLayer().setTranslationZ(HwFragmentMenuItemView.ALPHA_NORMAL);
        }
...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: huawei.com.android.internal.widget.HwFragmentLayout.SavedState.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: huawei.com.android.internal.widget.HwFragmentLayout.SavedState.<clinit>():void
...
*/
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: huawei.com.android.internal.widget.HwFragmentLayout.SavedState.<clinit>():void");
        }
    ...
    static {
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: huawei.com.android.internal.widget.HwFragmentLayout.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	at jadx.core.ProcessClass.processDependencies(ProcessClass.java:59)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: huawei.com.android.internal.widget.HwFragmentLayout.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 7 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 0073
...
*/
        ...
        // Can't load method instructions.
        */
        throw new UnsupportedOperationException("Method not decompiled: huawei.com.android.internal.widget.HwFragmentLayout.<clinit>():void");
    }
    ...
    public HwFragmentLayout(Context context) {
        ...
        this.mLocation = new int[WIDTH_SPLIT_LINE_DEFAULT];
        this.mDisplayAnimation = DEBUG;
        this.mHandler = new Handler() {
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case HwFragmentLayout.MSG_SET_TOUCH_DELEGATE /*10*/:
                        HwFragmentLayout.this.setSplitLineTouchDelegate();
                    case HwFragmentLayout.MSG_REFRESH_FRAMENT_LAYOUT /*11*/:
                        HwFragmentLayout.this.refreshFragmentLayout();
                    default:
                }
            }
        };
        init(context, DISPLAY_RATE_FORTY_PERCENT, DEBUG);
    }
    ...
    public HwFragmentLayout(Context context, float displayRate) {
        this(context, displayRate, (boolean) DEBUG);
    }
    ...
    private void init(Context context, float displayRate, boolean canMove) {
        ...
        if (this.mRightIn == null) {
            this.mRightIn = AnimationUtils.loadAnimation(context, 34078744);
        ...
        if (this.mLeftOut == null) {
            this.mLeftOut = AnimationUtils.loadAnimation(context, 34078743);
            this.mLeftOut.setDuration(250);
        }
        if (this.mLeftIn == null) {
            this.mLeftIn = AnimationUtils.loadAnimation(context, 34078741);
        }
        if (this.mRightOut == null) {
            this.mRightOut = AnimationUtils.loadAnimation(context, 34078742);
        ...
        if (this.mFadeInAnimation == null) {
            this.mFadeInAnimation = new AlphaAnimation(DISPLAY_RATE_FORTY_PERCENT, 0.0f);
        ...
        if (this.mFadeOutAnimation == null) {
            this.mFadeOutAnimation = new AlphaAnimation(0.0f, DISPLAY_RATE_FORTY_PERCENT);
    ...
    private void init(Context context) {
        ...
        this.mSplitLineParams = new RelativeLayout.LayoutParams(WIDTH_SPLIT_LINE_DEFAULT, -1);
        ...
        this.mSplitBtn.setImageResource(33751248);
        ...
        Bitmap splitBtnBitmap = getBitmapFor(33751248);
    ...
    protected void setDisplayRate(float displayRate) {
        ...
        if (this.mLeftParams.width != leftWidth) {
            ...
            this.mRightParams.addRule(17, LEFT_CONTENT_ID);
            this.mRightParams.setMarginStart(WIDTH_SPLIT_LINE_DEFAULT);
            ...
            this.mSplitLineParams.width = WIDTH_SPLIT_LINE_DEFAULT;
            this.mSplitLineParams.addRule(17, LEFT_CONTENT_ID);
            this.mSplitLine.setLayoutParams(this.mSplitLineParams);
            if (this.mCanMove) {
                this.mHandler.removeMessages(MSG_SET_TOUCH_DELEGATE);
                this.mHandler.sendEmptyMessageDelayed(MSG_SET_TOUCH_DELEGATE, 300);
            }
        }
    }
    ...
    protected void setSplitLineTouchDelegate() {
        if (getSplitLine().getVisibility() != 8) {
            ...
            bounds.left -= 25;
            bounds.right += TOUCH_DELEGATE_VALUE;
    ...
    protected void refreshFragmentLayout() {
        ...
        } else if (columnNumber == WIDTH_SPLIT_LINE_DEFAULT) {
            getLeftLayout().setVisibility(0);
            getLeftLayout().setAlpha(HwFragmentMenuItemView.ALPHA_NORMAL);
            getRightLayout().setVisibility(0);
            getRightLayout().setAlpha(HwFragmentMenuItemView.ALPHA_NORMAL);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction() & PduHeaders.STORE_STATUS_ERROR_END) {
            case HwFragmentContainer.SPLITE_MODE_DEFAULT_SEPARATE /*0*/:
                ...
                this.mSplitLineParams.setMarginStart((-(this.mSplitLineParams.width - 2)) / WIDTH_SPLIT_LINE_DEFAULT);
                this.mSplitLine.setLayoutParams(this.mSplitLineParams);
                ...
                this.mClicked = true;
                break;
            case WIDTH_SPLIT_LINE_DEFAULT /*2*/:
                if (this.mClicked) {
                    int x = (int) event.getRawX();
                    int y = (int) event.getRawY();
                    boolean exceededYSlop = Math.abs(y - this.mStartY) > MIN_DISTANCE_MOVED ? true : DEBUG;
                    ...
                    boolean exceededXSlop = Math.abs(x - this.mStartX) > MIN_DISTANCE_MOVED ? true : DEBUG;
    ...
    private void setSplitBtnParams(int y) {
        ...
        this.mSplitBtnParams.setMarginStart((-(this.mSplitBtnWidth - 2)) / WIDTH_SPLIT_LINE_DEFAULT);
        if ((y - this.mLocation[1]) - (this.mSplitBtnHeight / WIDTH_SPLIT_LINE_DEFAULT) < 0) {
            this.mSplitBtnParams.topMargin = 0;
        } else if ((y - this.mLocation[1]) + (this.mSplitBtnHeight / WIDTH_SPLIT_LINE_DEFAULT) > getHeight()) {
            this.mSplitBtnParams.topMargin = getHeight() - this.mSplitBtnHeight;
        } else {
            this.mSplitBtnParams.topMargin = (y - this.mLocation[1]) - (this.mSplitBtnHeight / WIDTH_SPLIT_LINE_DEFAULT);
        }
        this.mSplitBtn.setLayoutParams(this.mSplitBtnParams);
    }
    ...
    private void setLeftLayoutParams(int x) {
        ...
        if (((float) x) < ((float) this.mAppWidth) * DISPLAY_RATE_FORTY_PERCENT) {
            this.mLeftParams.width = (int) (((float) this.mAppWidth) * DISPLAY_RATE_FORTY_PERCENT);
            this.mDisplayRate = DISPLAY_RATE_FORTY_PERCENT;
        } else if (((float) x) > ((float) this.mAppWidth) * DISPLAY_RATE_SIXTY_PERCENT) {
            this.mLeftParams.width = (int) (((float) this.mAppWidth) * DISPLAY_RATE_SIXTY_PERCENT);
            this.mDisplayRate = DISPLAY_RATE_SIXTY_PERCENT;
        } else {
            this.mLeftParams.width = x;
            this.mDisplayRate = new BigDecimal((double) (((float) x) / ((float) this.mAppWidth))).setScale(WIDTH_SPLIT_LINE_DEFAULT, 4).floatValue();
        }
        this.mLeftContent.setLayoutParams(this.mLeftParams);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (w != oldw) {
            this.mAppWidth = w;
            this.mHandler.removeMessages(MSG_REFRESH_FRAMENT_LAYOUT);
            this.mHandler.sendEmptyMessage(MSG_REFRESH_FRAMENT_LAYOUT);
        }
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        switch (event.getAction() & PduHeaders.STORE_STATUS_ERROR_END) {
            ...
            case WIDTH_SPLIT_LINE_CLICKED /*3*/:
                if (this.mSplitLine.isPressed()) {
                    this.mClicked = DEBUG;
                    this.mSplitLine.setPressed(DEBUG);
                    this.mSplitLine.setBackgroundColor(COLOR_SPLIT_LINE_DEFAULT);
    ...
    protected int calculateColumnsNumber(int orientation, int appWidth) {
        ...
        if (this.mSplitMode == WIDTH_SPLIT_LINE_CLICKED) {
            return WIDTH_SPLIT_LINE_DEFAULT;
        }
        if (this.mSplitMode == WIDTH_SPLIT_LINE_DEFAULT) {
            if (orientation != WIDTH_SPLIT_LINE_DEFAULT) {
                return 1;
            }
            ...
            } else if (orientation != WIDTH_SPLIT_LINE_DEFAULT) {
                return 1;
            } else {
                if (appWidth >= dip2px(this.mContext, 592.0f)) {
                    return WIDTH_SPLIT_LINE_DEFAULT;
    ...
    private double calculateDeviceSize() {
        ...
        if (iwm != null) {
            ...
            try {
                ...
                mDeviceSize = new BigDecimal(Math.sqrt(Math.pow((double) (((float) point.x) / dm.xdpi), 2.0d) + Math.pow((double) (((float) point.y) / dm.ydpi), 2.0d))).setScale(WIDTH_SPLIT_LINE_DEFAULT, 4).doubleValue();
                return mDeviceSize;
        ...
        mDeviceSize = new BigDecimal(Math.sqrt(Math.pow((double) (((float) dm.widthPixels) / dm.xdpi), 2.0d) + Math.pow((double) (((float) dm.heightPixels) / dm.ydpi), 2.0d))).setScale(WIDTH_SPLIT_LINE_DEFAULT, 4).doubleValue();
        return mDeviceSize;
    }
    ...
    private static int dip2px(Context context, float dpValue) {
        return (int) ((dpValue * context.getResources().getDisplayMetrics().density) + DISPLAY_RATE_FIFTY_PERCENT);
    }

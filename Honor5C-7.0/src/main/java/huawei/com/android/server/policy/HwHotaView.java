...
public class HwHotaView extends RelativeLayout {
    ...
    public void init() {
        this.root = findViewById(34603130);
        this.mRoundProgressBar = (RoundProgressBar) this.root.findViewById(34603176);
        this.mTextView = (TextView) this.root.findViewById(34603177);

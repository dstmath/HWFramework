    ...
    private static class BlockDataOutputStream extends OutputStream implements DataOutput {
        ...
        private void writeBlockHeader(int len) throws IOException {
            if (len <= 255) {
                ...
                this.out.write(this.hbuf, 0, MAX_HEADER_SIZE);
            }
            warnIfClosed();
        }
        ...
        public void writeBytes(String s) throws IOException {
            ...
            while (off < endoff) {
                if (cpos >= csize) {
                    cpos = 0;
                    csize = Math.min(endoff - off, (int) CHAR_BUF_SIZE);
        ...
        public void writeChars(String s) throws IOException {
            ...
            int off = 0;
            while (off < endoff) {
                int csize = Math.min(endoff - off, (int) CHAR_BUF_SIZE);
                s.getChars(off, off + csize, this.cbuf, 0);
        ...
        long getUTFLength(String s) {
            ...
            int off = 0;
            while (off < len) {
                int csize = Math.min(len - off, (int) CHAR_BUF_SIZE);
                s.getChars(off, off + csize, this.cbuf, 0);
                ...
                for (int cpos = 0; cpos < csize; cpos++) {
                    ...
                    if (this.pos <= 1021) {
                        if (c <= '\u007f' && c != '\u0000') {
                            ...
                            this.buf[this.pos + 2] = (byte) (((c >> 0) & 63) | Pattern.CANON_EQ);
                            this.buf[this.pos + 1] = (byte) (((c >> 6) & 63) | Pattern.CANON_EQ);
                            this.buf[this.pos + 0] = (byte) (((c >> 12) & 15) | 224);
                            this.pos += 3;
                        } else {
                            this.buf[this.pos + 1] = (byte) (((c >> 0) & 63) | Pattern.CANON_EQ);
                        ...
                        write(((c >> 12) & 15) | 224);
                        write(((c >> 6) & 63) | Pattern.CANON_EQ);
                        write(((c >> 0) & 63) | Pattern.CANON_EQ);
                    } else {
                        write(((c >> 6) & 31) | 192);
                        write(((c >> 0) & 63) | Pattern.CANON_EQ);
                    }
...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.io.ObjectOutputStream.Caches.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.io.ObjectOutputStream.Caches.<clinit>():void
...
*/
    ...
    private static class HandleTable {
        ...
        private int hash(Object obj) {
            return System.identityHashCode(obj) & PlatformLogger.OFF;
        }
    }
    ...
    private class PutFieldImpl extends PutField {
        ...
        PutFieldImpl(ObjectOutputStream this$0, ObjectStreamClass desc) {
            this.this$0 = this$0;
            this.desc = desc;
        ...
        void writeFields() throws IOException {
            ...
            int numPrimFields = fields.length - this.objVals.length;
            for (int i = 0; i < this.objVals.length; i++) {
                this.this$0.writeObject0(this.objVals[i], fields[numPrimFields + i].isUnshared());
            }
        }

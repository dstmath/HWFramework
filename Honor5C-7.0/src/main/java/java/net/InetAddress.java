...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.net.InetAddress.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.net.InetAddress.<clinit>():void
...
*/
    ...
    public boolean isReachable(int timeout) throws IOException {
        return isReachable(null, NETID_UNSET, timeout);
    }
    ...
    private static InetAddress getByAddress(String host, byte[] addr, int scopeId) throws UnknownHostException {
        if (host != null && host.length() > 0 && host.charAt(NETID_UNSET) == '[' && host.charAt(host.length() - 1) == ']') {
    ...
    public static InetAddress getByName(String host) throws UnknownHostException {
        return impl.lookupAllHostAddr(host, NETID_UNSET)[NETID_UNSET];
    }

    public static InetAddress[] getAllByName(String host) throws UnknownHostException {
        return (InetAddress[]) impl.lookupAllHostAddr(host, NETID_UNSET).clone();
    }

    public static InetAddress getLoopbackAddress() {
        return impl.loopbackAddresses()[NETID_UNSET];
    }
    ...
    public static InetAddress getLocalHost() throws UnknownHostException {
        return impl.lookupAllHostAddr(Libcore.os.uname().nodename, NETID_UNSET)[NETID_UNSET];
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.holder = new InetAddressHolder((String) gf.get("hostName", null), gf.get("address", (int) NETID_UNSET), gf.get("family", (int) NETID_UNSET));
    }
    ...
    public static InetAddress getByNameOnNet(String host, int netId) throws UnknownHostException {
        return impl.lookupAllHostAddr(host, netId)[NETID_UNSET];
    }

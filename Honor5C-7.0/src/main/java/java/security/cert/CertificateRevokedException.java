...
public class CertificateRevokedException extends CertificateException {
    ...
    public CertificateRevokedException(Date revocationDate, CRLReason reason, X500Principal authority, Map<String, Extension> extensions) {
        ...
        this.extensions = new HashMap((Map) extensions);
    }
    ...
    public Date getInvalidityDate() {
        ...
        try {
            return new Date(((Date) InvalidityDateExtension.toImpl(ext).get("DATE")).getTime());
        } catch (IOException e) {
            return null;
        }
    }
    ...
    public String getMessage() {
        return "Certificate has been revoked, reason: " + this.reason + ", revocation date: " + this.revocationDate + ", authority: " + this.authority + ", extensions: " + this.extensions;
    }

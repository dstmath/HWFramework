...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.security.cert.X509CRLSelector.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.security.cert.X509CRLSelector.<clinit>():void
...
*/
    ...
    public boolean match(CRL crl) {
        ...
        if (!(this.minCRL == null && this.maxCRL == null)) {
            ...
            try {
                byte[] encoded = new DerInputStream(crlNumExtVal).getOctetString();
                Boolean bool = Boolean.FALSE;
                BigInteger crlNum = (BigInteger) new CRLNumberExtension(r16, encoded).get(CertificateX509Key.KEY);
                if (this.minCRL != null) {
                    if (crlNum.compareTo(this.minCRL) < 0) {
                        if (debug != null) {
                ...
                if (this.maxCRL != null) {
                    if (crlNum.compareTo(this.maxCRL) > 0) {
                        if (debug != null) {
        ...
        if (this.dateAndTime != null) {
            ...
            if (this.skew > 0) {
                ...
                nowPlusSkew = new Date(r0.getTime() + this.skew);
                date = this.dateAndTime;
                nowMinusSkew = new Date(r0.getTime() - this.skew);
            }

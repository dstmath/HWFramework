...
public class ArrayList<E> extends AbstractList<E> implements List<E>, RandomAccess, Cloneable, Serializable {
    ...
    private class SubList extends AbstractList<E> implements RandomAccess {
        ...
        /* renamed from: java.util.ArrayList.SubList.1 */
        class AnonymousClass1 implements ListIterator<E> {
            ...
            AnonymousClass1(int val$index, int val$offset) {
            ...
            public E next() {
                ...
                Object[] elementData = ArrayList.this.elementData;
                if (this.val$offset + i >= elementData.length) {
                    throw new ConcurrentModificationException();
                }
                this.cursor = i + 1;
                ...
                if (i < size) {
                    ...
                    while (true) {
                        ...
                        if (i2 == size || SubList.this.modCount != this.expectedModCount) {
                            ...
                            i = i2 + 1;
                            consumer.accept(elementData[this.val$offset + i2]);
                        }
                    }
                    this.cursor = i2;
                    this.lastRet = i2;
        ...
        public ListIterator<E> listIterator(int index) {
            if (ArrayList.this.modCount != this.modCount) {
                ...
                return new AnonymousClass1(index, this.offset);
            } else {
                throw new IndexOutOfBoundsException(outOfBoundsMsg(index));
            }
        }
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.ArrayList.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.ArrayList.<clinit>():void
...
*/
    ...
    private void ensureCapacityInternal(int minCapacity) {
        if (this.elementData == EMPTY_ELEMENTDATA) {
            minCapacity = Math.max((int) DEFAULT_CAPACITY, minCapacity);
        }
        ensureExplicitCapacity(minCapacity);
    }

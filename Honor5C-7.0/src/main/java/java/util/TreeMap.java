...
public class TreeMap<K, V> extends AbstractMap<K, V> implements NavigableMap<K, V>, Cloneable, Serializable {
    ...
    static final class DescendingKeySpliterator<K, V> extends TreeMapSpliterator<K, V> implements Spliterator<K> {
        ...
        public DescendingKeySpliterator<K, V> trySplit() {
            ...
            TreeMapEntry<K, V> s = (e == null || e == f) ? null : d == 0 ? this.tree.root : d < 0 ? e.left : (d <= 0 || f == null) ? null : f.right;
    ...
    static final class EntrySpliterator<K, V> extends TreeMapSpliterator<K, V> implements Spliterator<Entry<K, V>> {
        ...
        public EntrySpliterator<K, V> trySplit() {
            ...
            TreeMapEntry<K, V> e = this.current;
            TreeMapEntry<K, V> f = this.fence;
            TreeMapEntry<K, V> s = (e == null || e == f) ? null : d == 0 ? this.tree.root : d > 0 ? e.right : (d >= 0 || f == null) ? null : f.left;
            if (s == null || s == e || s == f || this.tree.compare(e.key, s.key) >= 0) {
                return null;
            }
            this.side = 1;
    ...
    private class SubMap extends AbstractMap<K, V> implements SortedMap<K, V>, Serializable {
        ...
        private SubMap() {
            this.fromStart = TreeMap.RED;
            this.toEnd = TreeMap.RED;
        }
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.TreeMap.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.TreeMap.<clinit>():void

...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
    ...
    static abstract class BulkTask<K, V, R> extends CountedCompleter<R> {
        ...
        BulkTask(BulkTask<K, V, ?> par, int b, int i, int f, Node<K, V>[] t) {
            ...
            this.tab = t;
            if (t == null) {
                this.baseLimit = ConcurrentHashMap.NCPU;
                this.baseSize = ConcurrentHashMap.NCPU;
            } else if (par == null) {
                int length = t.length;
    ...
    static final class EntrySetView<K, V> extends CollectionView<K, V, Entry<K, V>> implements Set<Entry<K, V>>, Serializable {
        ...
        public Spliterator<Entry<K, V>> spliterator() {
            long j = ConcurrentHashMap.TRANSFERINDEX;
            ConcurrentHashMap<K, V> m = this.map;
            long n = m.sumCount();
            Node<K, V>[] t = m.table;
            int f = t == null ? ConcurrentHashMap.NCPU : t.length;
            if (n >= ConcurrentHashMap.TRANSFERINDEX) {
                j = n;
            }
            return new EntrySpliterator(t, f, ConcurrentHashMap.NCPU, f, j, m);
        }
    ...
    static final class ForwardingNode<K, V> extends Node<K, V> {
        ...
        Node<K, V> find(int h, Object k) {
            ...
            while (k != null && tab != null) {
                ...
                Node<K, V> e = ConcurrentHashMap.tabAt(tab, (n + ConcurrentHashMap.MOVED) & h);
                if (e == null) {
                    break;
                }
                while (true) {
    ...
    public static class KeySetView<K, V> extends CollectionView<K, V, K> implements Set<K>, Serializable {
        ...
        public Spliterator<K> spliterator() {
            ...
            return new KeySpliterator(t, f, ConcurrentHashMap.NCPU, f, j);
        }
...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.concurrent.ConcurrentHashMap.TreeBin.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.concurrent.ConcurrentHashMap.TreeBin.<clinit>():void
...
*/
        ...
        static int tieBreakOrder(Object a, Object b) {
            ...
            return System.identityHashCode(a) <= System.identityHashCode(b) ? ConcurrentHashMap.MOVED : WRITER;
        }

        /* JADX WARNING: inconsistent code. */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        TreeBin(TreeNode<K, V> b) {
            super(ConcurrentHashMap.TREEBIN, null, null, null);
            this.first = b;
            TreeNode<K, V> r = null;
            TreeNode<K, V> x = b;
            while (x != null) {
        ...
        private final void lockRoot() {
            if (!U.compareAndSwapInt(this, LOCKSTATE, ConcurrentHashMap.NCPU, WRITER)) {
                contendedLock();
            }
        }
                ...
                while (e != null) {
                    ...
                    if ((s & 3) != 0) {
                        ...
                        try {
                            ...
                            if (U.getAndAddInt(this, LOCKSTATE, -4) == ConcurrentHashMap.UNTREEIFY_THRESHOLD) {
                                w = this.waiter;
                                if (w != null) {
    ...
    static final class ValueSpliterator<K, V> extends Traverser<K, V> implements Spliterator<V> {
        ...
        public ValueSpliterator<K, V> m11trySplit() {
            int i = this.baseIndex;
            int f = this.baseLimit;
            int h = (i + f) >>> 1;
            if (h <= i) {
    ...
    static final class ValuesView<K, V> extends CollectionView<K, V, V> implements Collection<V>, Serializable {
        ...
        public Spliterator<V> spliterator() {
            ...
            return new ValueSpliterator(t, f, ConcurrentHashMap.NCPU, f, j);
        }
...
*/
    ...
    static final int spread(int h) {
        return ((h >>> RESIZE_STAMP_SHIFT) ^ h) & HASH_BITS;
    }
    ...
    public ConcurrentHashMap(Map<? extends K, ? extends V> m) {
        this.sizeCtl = RESIZE_STAMP_SHIFT;
        putAll(m);
    }
    ...
    public V get(Object key) {
        ...
        if (tab != null) {
            int n = tab.length;
            if (n > 0) {
                Node<K, V> e = tabAt(tab, (n + MOVED) & h);
                if (e != null) {
                    K ek;
                    int eh = e.hash;
                    if (eh == h) {
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        int sshift = NCPU;
        int ssize = 1;
        while (ssize < RESIZE_STAMP_SHIFT) {
            sshift++;
            ssize <<= 1;
        }
        int segmentShift = 32 - sshift;
        int segmentMask = ssize + MOVED;
        Segment<K, V>[] segments = new Segment[RESIZE_STAMP_SHIFT];
    ...
    static final int resizeStamp(int n) {
        return Integer.numberOfLeadingZeros(n) | DateUtilsBridge.FORMAT_ABBREV_WEEKDAY;
    }
    ...
    private final Node<K, V>[] initTable() {
        ...
        while (true) {
            ...
            if (sc < 0) {
                Thread.yield();
            } else if (U.compareAndSwapInt(this, SIZECTL, sc, MOVED)) {
                try {
                    break;
                } catch (Throwable th) {
                    this.sizeCtl = sc;
        ...
        tab = this.table;
        if (tab == null || tab.length == 0) {
            int n = sc > 0 ? sc : RESIZE_STAMP_SHIFT;
                        ...
                        if (check > 1) {
                            ...
                            if (check >= 0) {
                                while (true) {
                                    ...
                                    if (sc < 0) {
                                        if (!((sc >>> RESIZE_STAMP_SHIFT) != rs || sc == rs + 1 || sc == MAX_RESIZERS + rs)) {
    ...
    private final void tryPresize(int size) {
        ...
        while (true) {
            ...
            if (sc >= 0) {
                ...
                if (tab != null) {
                    ...
                    if (n != 0) {
                        if (c > sc && n < MAXIMUM_CAPACITY) {
                            if (tab == this.table) {
                                if (U.compareAndSwapInt(this, SIZECTL, sc, (resizeStamp(n) << RESIZE_STAMP_SHIFT) + 2)) {
                                    transfer(tab, null);
                                }
                            }
                        } else {
                ...
                n = sc > c ? sc : c;
                if (U.compareAndSwapInt(this, SIZECTL, sc, MOVED)) {
                    try {
                        if (this.table == tab) {
    ...
    private final void transfer(Node<K, V>[] tab, Node<K, V>[] nextTab) {
        ...
        if (stride < RESIZE_STAMP_SHIFT) {
            stride = RESIZE_STAMP_SHIFT;
        }
        if (nextTab == null) {
            try {
            ...
            if (advance) {
                ...
                if (i >= bound || finishing) {
                    ...
                    if (nextIndex <= 0) {
                        ...
                        int nextBound = nextIndex > stride ? nextIndex - stride : NCPU;
                ...
                long j2 = SIZECTL;
                int sc = this.sizeCtl;
                if (!unsafe2.compareAndSwapInt(this, j2, sc, sc + MOVED)) {
                    continue;
                } else if (sc + TREEBIN == (resizeStamp(n) << RESIZE_STAMP_SHIFT)) {
                    advance = true;
                    finishing = true;
                    i = n;
                } else {
    ...
    public void forEach(long parallelismThreshold, BiConsumer<? super K, ? super V> action) {
        ...
        new ForEachMappingTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, action).invoke();
    }
    ...
    public <U> void forEach(long parallelismThreshold, BiFunction<? super K, ? super V, ? extends U> transformer, Consumer<? super U> action) {
        ...
        new ForEachTransformedMappingTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, transformer, action).invoke();
    }
    ...
    public <U> U search(long parallelismThreshold, BiFunction<? super K, ? super V, ? extends U> searchFunction) {
        ...
        return new SearchMappingsTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, searchFunction, new AtomicReference()).invoke();
    }
    ...
    public <U> U reduce(long parallelismThreshold, BiFunction<? super K, ? super V, ? extends U> transformer, BiFunction<? super U, ? super U, ? extends U> reducer) {
        ...
        return new MapReduceMappingsTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, reducer).invoke();
    }
    ...
    public double reduceToDouble(long parallelismThreshold, ToDoubleBiFunction<? super K, ? super V> transformer, double basis, DoubleBinaryOperator reducer) {
        if (transformer != null && reducer != null) {
            return ((Double) new MapReduceMappingsToDoubleTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, basis, reducer).invoke()).doubleValue();
        }
        throw new NullPointerException();
    }
    ...
    public long reduceToLong(long parallelismThreshold, ToLongBiFunction<? super K, ? super V> transformer, long basis, LongBinaryOperator reducer) {
        if (transformer != null && reducer != null) {
            return ((Long) new MapReduceMappingsToLongTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, basis, reducer).invoke()).longValue();
        }
        throw new NullPointerException();
    }
    ...
    public int reduceToInt(long parallelismThreshold, ToIntBiFunction<? super K, ? super V> transformer, int basis, IntBinaryOperator reducer) {
        ...
        return ((Integer) new MapReduceMappingsToIntTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, basis, reducer).invoke()).intValue();
    }
    ...
    public void forEachKey(long parallelismThreshold, Consumer<? super K> action) {
        ...
        new ForEachKeyTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, action).invoke();
    }
    ...
    public <U> void forEachKey(long parallelismThreshold, Function<? super K, ? extends U> transformer, Consumer<? super U> action) {
        ...
        new ForEachTransformedKeyTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, transformer, action).invoke();
    }
    ...
    public <U> U searchKeys(long parallelismThreshold, Function<? super K, ? extends U> searchFunction) {
        ...
        return new SearchKeysTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, searchFunction, new AtomicReference()).invoke();
    }
    ...
    public K reduceKeys(long parallelismThreshold, BiFunction<? super K, ? super K, ? extends K> reducer) {
        ...
        return new ReduceKeysTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, reducer).invoke();
    }
    ...
    public <U> U reduceKeys(long parallelismThreshold, Function<? super K, ? extends U> transformer, BiFunction<? super U, ? super U, ? extends U> reducer) {
        ...
        return new MapReduceKeysTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, reducer).invoke();
    }
    ...
    public double reduceKeysToDouble(long parallelismThreshold, ToDoubleFunction<? super K> transformer, double basis, DoubleBinaryOperator reducer) {
        if (transformer != null && reducer != null) {
            return ((Double) new MapReduceKeysToDoubleTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, basis, reducer).invoke()).doubleValue();
        }
        throw new NullPointerException();
    }
    ...
    public long reduceKeysToLong(long parallelismThreshold, ToLongFunction<? super K> transformer, long basis, LongBinaryOperator reducer) {
        if (transformer != null && reducer != null) {
            return ((Long) new MapReduceKeysToLongTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, basis, reducer).invoke()).longValue();
        }
        throw new NullPointerException();
    }
    ...
    public int reduceKeysToInt(long parallelismThreshold, ToIntFunction<? super K> transformer, int basis, IntBinaryOperator reducer) {
        ...
        return ((Integer) new MapReduceKeysToIntTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, basis, reducer).invoke()).intValue();
    }
    ...
    public void forEachValue(long parallelismThreshold, Consumer<? super V> action) {
        ...
        new ForEachValueTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, action).invoke();
    }
    ...
    public <U> void forEachValue(long parallelismThreshold, Function<? super V, ? extends U> transformer, Consumer<? super U> action) {
        ...
        new ForEachTransformedValueTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, transformer, action).invoke();
    }
    ...
    public <U> U searchValues(long parallelismThreshold, Function<? super V, ? extends U> searchFunction) {
        ...
        return new SearchValuesTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, searchFunction, new AtomicReference()).invoke();
    }
    ...
    public V reduceValues(long parallelismThreshold, BiFunction<? super V, ? super V, ? extends V> reducer) {
        ...
        return new ReduceValuesTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, reducer).invoke();
    }
    ...
    public <U> U reduceValues(long parallelismThreshold, Function<? super V, ? extends U> transformer, BiFunction<? super U, ? super U, ? extends U> reducer) {
        ...
        return new MapReduceValuesTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, reducer).invoke();
    }
    ...
    public double reduceValuesToDouble(long parallelismThreshold, ToDoubleFunction<? super V> transformer, double basis, DoubleBinaryOperator reducer) {
        if (transformer != null && reducer != null) {
            return ((Double) new MapReduceValuesToDoubleTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, basis, reducer).invoke()).doubleValue();
        }
        throw new NullPointerException();
    }
    ...
    public long reduceValuesToLong(long parallelismThreshold, ToLongFunction<? super V> transformer, long basis, LongBinaryOperator reducer) {
        if (transformer != null && reducer != null) {
            return ((Long) new MapReduceValuesToLongTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, basis, reducer).invoke()).longValue();
        }
        throw new NullPointerException();
    }
    ...
    public int reduceValuesToInt(long parallelismThreshold, ToIntFunction<? super V> transformer, int basis, IntBinaryOperator reducer) {
        ...
        return ((Integer) new MapReduceValuesToIntTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, basis, reducer).invoke()).intValue();
    }
    ...
    public void forEachEntry(long parallelismThreshold, Consumer<? super Entry<K, V>> action) {
        ...
        new ForEachEntryTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, action).invoke();
    }
    ...
    public <U> void forEachEntry(long parallelismThreshold, Function<Entry<K, V>, ? extends U> transformer, Consumer<? super U> action) {
        ...
        new ForEachTransformedEntryTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, transformer, action).invoke();
    }
    ...
    public <U> U searchEntries(long parallelismThreshold, Function<Entry<K, V>, ? extends U> searchFunction) {
        ...
        return new SearchEntriesTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, searchFunction, new AtomicReference()).invoke();
    }
    ...
    public Entry<K, V> reduceEntries(long parallelismThreshold, BiFunction<Entry<K, V>, Entry<K, V>, ? extends Entry<K, V>> reducer) {
        ...
        return (Entry) new ReduceEntriesTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, reducer).invoke();
    }
    ...
    public <U> U reduceEntries(long parallelismThreshold, Function<Entry<K, V>, ? extends U> transformer, BiFunction<? super U, ? super U, ? extends U> reducer) {
        ...
        return new MapReduceEntriesTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, reducer).invoke();
    }
    ...
    public double reduceEntriesToDouble(long parallelismThreshold, ToDoubleFunction<Entry<K, V>> transformer, double basis, DoubleBinaryOperator reducer) {
        if (transformer != null && reducer != null) {
            return ((Double) new MapReduceEntriesToDoubleTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, basis, reducer).invoke()).doubleValue();
        }
        throw new NullPointerException();
    }
    ...
    public long reduceEntriesToLong(long parallelismThreshold, ToLongFunction<Entry<K, V>> transformer, long basis, LongBinaryOperator reducer) {
        if (transformer != null && reducer != null) {
            return ((Long) new MapReduceEntriesToLongTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, basis, reducer).invoke()).longValue();
        }
        throw new NullPointerException();
    }
    ...
    public int reduceEntriesToInt(long parallelismThreshold, ToIntFunction<Entry<K, V>> transformer, int basis, IntBinaryOperator reducer) {
        ...
        return ((Integer) new MapReduceEntriesToIntTask(null, batchFor(parallelismThreshold), NCPU, NCPU, this.table, null, transformer, basis, reducer).invoke()).intValue();
    }
}

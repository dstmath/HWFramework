...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.concurrent.ThreadPoolExecutor.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.concurrent.ThreadPoolExecutor.<clinit>():void
...
*/
    ...
    private List<Runnable> drainQueue() {
        ...
        q.drainTo(taskList);
        if (!q.isEmpty()) {
            Runnable[] runnableArr = (Runnable[]) q.toArray(new Runnable[SHUTDOWN]);
    ...
    public boolean isShutdown() {
        return isRunning(this.ctl.get()) ? false : ONLY_ONE;
    }
    ...
    public void purge() {
        ...
        try {
            ...
            Object[] toArray = q.toArray();
            int length = toArray.length;
            for (int i = SHUTDOWN; i < length; i++) {
                Object r2 = toArray[i];

...
abstract class AbstractShortCircuitTask<P_IN, P_OUT, R, K extends AbstractShortCircuitTask<P_IN, P_OUT, R, K>> extends AbstractTask<P_IN, P_OUT, R, K> {
    ...
    protected boolean taskCanceled() {
        ...
        if (!cancel) {
            ...
            while (!cancel && parent != null) {
                ...
                AbstractShortCircuitTask parent2 = (AbstractShortCircuitTask) parent.getParent();
            }
        }
        return cancel;
    }
    ...
    protected void cancelLaterNodes() {
        K node = this;
        for (K parent = (AbstractShortCircuitTask) getParent(); parent != null; AbstractShortCircuitTask parent2 = (AbstractShortCircuitTask) parent.getParent()) {

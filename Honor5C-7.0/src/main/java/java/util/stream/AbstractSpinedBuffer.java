...
abstract class AbstractSpinedBuffer {
    ...
    protected AbstractSpinedBuffer(int initialCapacity) {
        ...
        this.initialChunkPower = Math.max((int) MIN_CHUNK_POWER, 32 - Integer.numberOfLeadingZeros(initialCapacity - 1));
    }
    ...
    protected int chunkSize(int n) {
        ...
        if (n == 0 || n == 1) {
            ...
            power = Math.min((this.initialChunkPower + n) - 1, (int) MAX_CHUNK_POWER);
        }
        return 1 << power;
    }
}

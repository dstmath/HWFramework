...
public interface LongStream extends BaseStream<Long, LongStream> {
    ...
    static class AnonymousClass1 implements OfLong {
        ...
        AnonymousClass1(long val$seed, LongUnaryOperator val$f) {
    ...
    static LongStream iterate(long seed, LongUnaryOperator f) {
        ...
        return StreamSupport.longStream(Spliterators.spliteratorUnknownSize(new AnonymousClass1(seed, f), 1296), false);
    }

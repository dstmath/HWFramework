    ...
    private static class CollectorTask<P_IN, P_OUT, T_NODE extends Node<P_OUT>, T_BUILDER extends Builder<P_OUT>> extends AbstractTask<P_IN, P_OUT, T_NODE, CollectorTask<P_IN, P_OUT, T_NODE, T_BUILDER>> {
        ...
        private static final class OfDouble<P_IN> extends CollectorTask<P_IN, Double, java.util.stream.Node.OfDouble, java.util.stream.Node.Builder.OfDouble> {
            ...
            OfDouble(PipelineHelper<Double> helper, Spliterator<P_IN> spliterator) {
                super(helper, spliterator, new -void__init__java_util_stream_PipelineHelper_helper_java_util_Spliterator_spliterator_LambdaImpl0(), new -void__init__java_util_stream_PipelineHelper_helper_java_util_Spliterator_spliterator_LambdaImpl1());
            }
        }
        ...
        private static final class OfRef<P_IN, P_OUT> extends CollectorTask<P_IN, P_OUT, Node<P_OUT>, Builder<P_OUT>> {
            ...
            final /* synthetic */ class -void__init__java_util_stream_PipelineHelper_helper_java_util_function_IntFunction_generator_java_util_Spliterator_spliterator_LambdaImpl0 implements LongFunction {
                ...
                public /* synthetic */ -void__init__java_util_stream_PipelineHelper_helper_java_util_function_IntFunction_generator_java_util_Spliterator_spliterator_LambdaImpl0(IntFunction intFunction) {
                    this.val$generator = intFunction;
                }

                public Object apply(long arg0) {
                    return Nodes.builder(arg0, this.val$generator);
                }
            }
            ...
            OfRef(PipelineHelper<P_OUT> helper, IntFunction<P_OUT[]> generator, Spliterator<P_IN> spliterator) {
                super(helper, spliterator, new -void__init__java_util_stream_PipelineHelper_helper_java_util_function_IntFunction_generator_java_util_Spliterator_spliterator_LambdaImpl0(generator), new -void__init__java_util_stream_PipelineHelper_helper_java_util_function_IntFunction_generator_java_util_Spliterator_spliterator_LambdaImpl1());
            }
        }
...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.stream.Nodes.DoubleFixedNodeBuilder.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.stream.Nodes.DoubleFixedNodeBuilder.<clinit>():void
...
*/
        ...
        DoubleFixedNodeBuilder(long size) {
            ...
            if (!-assertionsDisabled) {
                if ((size < Nodes.MAX_ARRAY_SIZE ? 1 : null) == null) {
    ...
    private static final class DoubleSpinedNodeBuilder extends SpinedBuffer.OfDouble implements OfDouble, Builder.OfDouble {
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.stream.Nodes.DoubleSpinedNodeBuilder.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.stream.Nodes.DoubleSpinedNodeBuilder.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e9
...
*/
        ...
        public /* bridge */ /* synthetic */ void copyInto(Object[] boxed, int offset) {
            copyInto((Double[]) boxed, offset);
        }
        ...
        public /* bridge */ /* synthetic */ Node m26truncate(long from, long to, IntFunction generator) {
            return truncate(from, to, generator);
        }
        ...
        public /* bridge */ /* synthetic */ Spliterator.OfPrimitive m24spliterator() {
            return spliterator();
        }

        public /* bridge */ /* synthetic */ Spliterator m25spliterator() {
            return spliterator();
        }

        public Spliterator.OfDouble spliterator() {
            if (!-assertionsDisabled) {
                if ((this.building ? null : 1) == null) {
        ...
        public /* bridge */ /* synthetic */ void forEach(Object consumer) {
        ...
        public /* bridge */ /* synthetic */ void copyInto(Object array, int offset) {
            copyInto((double[]) array, offset);
        }
        ...
        public double[] m22asPrimitiveArray() {
            if (!-assertionsDisabled) {
                if ((this.building ? null : 1) == null) {
                    throw new AssertionError((Object) "during building");
                }
        ...
        public /* bridge */ /* synthetic */ Node m23build() {
            return build();
        }
    ...
    private static abstract class EmptyNode<T, T_ARR, T_CONS> implements Node<T> {
        ...
        private static final class OfDouble extends EmptyNode<Double, double[], DoubleConsumer> implements java.util.stream.Node.OfDouble {
            ...
            public /* bridge */ /* synthetic */ Spliterator.OfPrimitive m28spliterator() {
                return spliterator();
            }

            public /* bridge */ /* synthetic */ Spliterator m29spliterator() {
                return spliterator();
            }
            ...
            public double[] m27asPrimitiveArray() {
        ...
        private static final class OfInt extends EmptyNode<Integer, int[], IntConsumer> implements java.util.stream.Node.OfInt {
            ...
            public /* bridge */ /* synthetic */ Spliterator.OfPrimitive m31spliterator() {
                return spliterator();
            }

            public /* bridge */ /* synthetic */ Spliterator m32spliterator() {
                return spliterator();
            }
            ...
            public int[] m30asPrimitiveArray() {
        ...
        private static final class OfLong extends EmptyNode<Long, long[], LongConsumer> implements java.util.stream.Node.OfLong {
            ...
            public /* bridge */ /* synthetic */ Spliterator.OfPrimitive m34spliterator() {
                return spliterator();
            }

            public /* bridge */ /* synthetic */ Spliterator m35spliterator() {
                return spliterator();
            }
    ...
    private static final class FixedNodeBuilder<T> extends ArrayNode<T> implements Builder<T> {
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.stream.Nodes.FixedNodeBuilder.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.stream.Nodes.FixedNodeBuilder.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e9
...
*/
    ...
    private static class IntArrayNode implements OfInt {
        ...
        public /* bridge */ /* synthetic */ Node m39truncate(long from, long to, IntFunction generator) {
            return truncate(from, to, generator);
        }
        ...
        public /* bridge */ /* synthetic */ Spliterator.OfPrimitive m37spliterator() {
            return spliterator();
        }

        public /* bridge */ /* synthetic */ Spliterator m38spliterator() {
            return spliterator();
        }
        ...
        public int[] m36asPrimitiveArray() {
            if (this.array.length == this.curSize) {
                return this.array;
            }
            return Arrays.copyOf(this.array, this.curSize);
        ...
        public /* bridge */ /* synthetic */ void copyInto(Object dest, int destOffset) {
            copyInto((int[]) dest, destOffset);
        }
    ...
    private static final class IntFixedNodeBuilder extends IntArrayNode implements Builder.OfInt {
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.stream.Nodes.IntFixedNodeBuilder.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.stream.Nodes.IntFixedNodeBuilder.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e9
...
*/
        ...
        public /* bridge */ /* synthetic */ Node m40build() {
            return build();
        }
    ...
    private static final class IntSpinedNodeBuilder extends SpinedBuffer.OfInt implements OfInt, Builder.OfInt {
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.stream.Nodes.IntSpinedNodeBuilder.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.stream.Nodes.IntSpinedNodeBuilder.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e9
...
*/
        ...
        public /* bridge */ /* synthetic */ Node m45truncate(long from, long to, IntFunction generator) {
            return truncate(from, to, generator);
        }
        ...
        public /* bridge */ /* synthetic */ Spliterator.OfPrimitive m43spliterator() {
            return spliterator();
        }

        public /* bridge */ /* synthetic */ Spliterator m44spliterator() {
            return spliterator();
        }
        ...
        public int[] m41asPrimitiveArray() {
            if (!-assertionsDisabled) {
                if ((this.building ? null : 1) == null) {
                    throw new AssertionError((Object) "during building");
                }
        ...
        public /* bridge */ /* synthetic */ Node m42build() {
            return build();
        }
    ...
    private static class LongArrayNode implements OfLong {
        ...
        public /* bridge */ /* synthetic */ Node m49truncate(long from, long to, IntFunction generator) {
            return truncate(from, to, generator);
        }
        ...
        public /* bridge */ /* synthetic */ Spliterator.OfPrimitive m47spliterator() {
            return spliterator();
        }

        public /* bridge */ /* synthetic */ Spliterator m48spliterator() {
            return spliterator();
        }
        ...
        public long[] m46asPrimitiveArray() {
            if (this.array.length == this.curSize) {
                return this.array;
            }
            return Arrays.copyOf(this.array, this.curSize);
    ...
    private static final class LongFixedNodeBuilder extends LongArrayNode implements Builder.OfLong {
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.stream.Nodes.LongFixedNodeBuilder.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.stream.Nodes.LongFixedNodeBuilder.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e9
...
*/
        ...
        public /* bridge */ /* synthetic */ Node m50build() {
            return build();
        }
    ...
    private static final class LongSpinedNodeBuilder extends SpinedBuffer.OfLong implements OfLong, Builder.OfLong {
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.stream.Nodes.LongSpinedNodeBuilder.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.stream.Nodes.LongSpinedNodeBuilder.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e9
...
*/
        ...
        public /* bridge */ /* synthetic */ Node m55truncate(long from, long to, IntFunction generator) {
            return truncate(from, to, generator);
        }
        ...
        public /* bridge */ /* synthetic */ Spliterator.OfPrimitive m53spliterator() {
            return spliterator();
        }

        public /* bridge */ /* synthetic */ Spliterator m54spliterator() {
            return spliterator();
        }
        ...
        public long[] m51asPrimitiveArray() {
            if (!-assertionsDisabled) {
                if ((this.building ? null : 1) == null) {
                    throw new AssertionError((Object) "during building");
                }
        ...
        public /* bridge */ /* synthetic */ Node m52build() {
            return build();
        }
    ...
    private static abstract class SizedCollectorTask<P_IN, P_OUT, T_SINK extends Sink<P_OUT>, K extends SizedCollectorTask<P_IN, P_OUT, T_SINK, K>> extends CountedCompleter<Void> implements Sink<P_OUT> {
        ...
        static final class OfDouble<P_IN> extends SizedCollectorTask<P_IN, Double, java.util.stream.Sink.OfDouble, OfDouble<P_IN>> implements java.util.stream.Sink.OfDouble {
            ...
            /* bridge */ /* synthetic */ SizedCollectorTask m56makeChild(Spliterator spliterator, long offset, long size) {
                return makeChild(spliterator, offset, size);
            }
        ...
        static final class OfInt<P_IN> extends SizedCollectorTask<P_IN, Integer, java.util.stream.Sink.OfInt, OfInt<P_IN>> implements java.util.stream.Sink.OfInt {
            ...
            /* bridge */ /* synthetic */ SizedCollectorTask m57makeChild(Spliterator spliterator, long offset, long size) {
                return makeChild(spliterator, offset, size);
            }
        ...
        static final class OfLong<P_IN> extends SizedCollectorTask<P_IN, Long, java.util.stream.Sink.OfLong, OfLong<P_IN>> implements java.util.stream.Sink.OfLong {
            ...
            /* bridge */ /* synthetic */ SizedCollectorTask m58makeChild(Spliterator spliterator, long offset, long size) {
                return makeChild(spliterator, offset, size);
            }
        ...
        static final class OfRef<P_IN, P_OUT> extends SizedCollectorTask<P_IN, P_OUT, Sink<P_OUT>, OfRef<P_IN, P_OUT>> implements Sink<P_OUT> {
            ...
            /* bridge */ /* synthetic */ SizedCollectorTask m59makeChild(Spliterator spliterator, long offset, long size) {
                return makeChild(spliterator, offset, size);
            }
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.stream.Nodes.SizedCollectorTask.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.stream.Nodes.SizedCollectorTask.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e9
...
*/
        ...
        SizedCollectorTask(Spliterator<P_IN> spliterator, PipelineHelper<P_OUT> helper, int arrayLength) {
            if (-assertionsDisabled || spliterator.hasCharacteristics(Record.maxDataSize)) {
        ...
        public void compute() {
            ...
            if (!-assertionsDisabled) {
                if ((task.offset + task.length < Nodes.MAX_ARRAY_SIZE ? 1 : 0) == 0) {
                    throw new AssertionError();
                }
            }
    ...
    private static final class SpinedNodeBuilder<T> extends SpinedBuffer<T> implements Node<T>, Builder<T> {
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.stream.Nodes.SpinedNodeBuilder.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.stream.Nodes.SpinedNodeBuilder.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e9
...
*/
    ...
    private static abstract class ToArrayTask<T, T_NODE extends Node<T>, K extends ToArrayTask<T, T_NODE, K>> extends CountedCompleter<Void> {
        ...
        private static class OfPrimitive<T, T_CONS, T_ARR, T_SPLITR extends java.util.Spliterator.OfPrimitive<T, T_CONS, T_SPLITR>, T_NODE extends java.util.stream.Node.OfPrimitive<T, T_CONS, T_ARR, T_SPLITR, T_NODE>> extends ToArrayTask<T, T_NODE, OfPrimitive<T, T_CONS, T_ARR, T_SPLITR, T_NODE>> {
            ...
            /* bridge */ /* synthetic */ ToArrayTask m60makeChild(int childIndex, int offset) {
                return makeChild(childIndex, offset);
            }
        ...
        private static final class OfDouble extends OfPrimitive<Double, DoubleConsumer, double[], java.util.Spliterator.OfDouble, java.util.stream.Node.OfDouble> {
            /* synthetic */ OfDouble(java.util.stream.Node.OfDouble node, double[] array, int offset, OfDouble ofDouble) {
                this(node, array, offset);
            }
        ...
        private static final class OfInt extends OfPrimitive<Integer, IntConsumer, int[], java.util.Spliterator.OfInt, java.util.stream.Node.OfInt> {
            /* synthetic */ OfInt(java.util.stream.Node.OfInt node, int[] array, int offset, OfInt ofInt) {
                this(node, array, offset);
            }
        ...
        private static final class OfLong extends OfPrimitive<Long, LongConsumer, long[], java.util.Spliterator.OfLong, java.util.stream.Node.OfLong> {
            /* synthetic */ OfLong(java.util.stream.Node.OfLong node, long[] array, int offset, OfLong ofLong) {
                this(node, array, offset);
            }
        ...
        private static final class OfRef<T> extends ToArrayTask<T, Node<T>, OfRef<T>> {
            ...
            /* bridge */ /* synthetic */ ToArrayTask m61makeChild(int childIndex, int offset) {
                return makeChild(childIndex, offset);
            }
    ...
    static {
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.stream.Nodes.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	at jadx.core.ProcessClass.processDependencies(ProcessClass.java:59)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.stream.Nodes.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 7 more

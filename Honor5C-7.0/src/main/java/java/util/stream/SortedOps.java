...
final class SortedOps {
    ...
    private static final class RefSortingSink<T> extends AbstractRefSortingSink<T> {
        ...
        final /* synthetic */ class -void_end__LambdaImpl0 implements Consumer {
            ...
            public /* synthetic */ -void_end__LambdaImpl0(Sink sink) {
        ...
        public void end() {
            ...
            if (this.cancellationWasRequested) {
                ...
                sink.getClass();
                arrayList.forEach(new -void_end__LambdaImpl0(sink));
            }
            this.downstream.end();
            this.list = null;
        }
    ...
    private static final class SizedDoubleSortingSink extends AbstractDoubleSortingSink {
        ...
        public void end() {
            ...
            int i;
            if (this.cancellationWasRequested) {
                for (i = 0; i < this.offset && !this.downstream.cancellationRequested(); i++) {

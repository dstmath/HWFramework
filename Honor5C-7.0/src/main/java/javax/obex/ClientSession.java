...
public final class ClientSession extends ObexSession {
    ...
    public ClientSession(ObexTransport trans) throws IOException {
        ...
        this.mMaxTxPacketSize = ObexHelper.OBEX_OPCODE_ABORT;
    ...
    public HeaderSet connect(HeaderSet header) throws IOException {
        ...
        requestPacket[3] = (byte) (maxRxPacketSize & ObexHelper.OBEX_OPCODE_ABORT);
        if (bArr != null) {
        ...
        sendRequest(ObexHelper.OBEX_OPCODE_FINAL_BIT_MASK, requestPacket, returnHeaderSet, null, false);

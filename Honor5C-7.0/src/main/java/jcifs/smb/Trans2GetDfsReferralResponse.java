        ...
        int readWireFormat(byte[] buffer, int bufferIndex, int len) {
            ...
            if (this.version == 3 || this.version == 1) {
                ...
                if (this.version == 3) {
                    ...
                    bufferIndex += 2;
                    this.path = Trans2GetDfsReferralResponse.this.readString(buffer, start + this.pathOffset, len, (Trans2GetDfsReferralResponse.this.flags2 & SmbConstants.FLAGS2_UNICODE) != 0);
                    if (this.nodeOffset > 0) {
                        trans2GetDfsReferralResponse = Trans2GetDfsReferralResponse.this;
                        int i = this.nodeOffset + start;
                        if ((Trans2GetDfsReferralResponse.this.flags2 & SmbConstants.FLAGS2_UNICODE) == 0) {
                            z = false;
                        }

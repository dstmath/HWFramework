...
public abstract class AbstractHttpClient implements HttpClient {
    ...
    private BasicHttpResponse getFakeResponse() {
        return new BasicHttpResponse(new ProtocolVersion(FAKE_PROTOCOL_NAME, FAKE_PROTOCOL_MAJOR_VERSION, FAKE_PROTOCOL_MINOR_VERSION), (int) FAKE_HTTP_RESPONSE_CODE, FAKE_HTTP_RESPONSE_REASON);
    }
}

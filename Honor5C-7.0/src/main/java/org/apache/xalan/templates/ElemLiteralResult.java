...
public class ElemLiteralResult extends ElemUse {
    ...
    public class Attribute implements Attr {
        ...
        public String getNodeName() {
            ...
            return uri.equals(ElemLiteralResult.EMPTYSTRING) ? localName : uri + ":" + localName;
        }
    ...
    public AVT getLiteralResultAttribute(String name) {
        if (this.m_avts != null) {
            for (int i = this.m_avts.size() - 1; i >= 0; i--) {
                ...
                if ((namespace == null || namespace.equals(EMPTYSTRING)) && avt.getRawName().equals(name)) {
                    return avt;
                }
            }
        }
    ...
    public boolean containsExcludeResultPrefix(String prefix, String uri) {
        ...
        if (prefix.length() == 0) {
            prefix = Constants.DEFAULT_DECIMAL_FORMAT;
        }

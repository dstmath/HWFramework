...
public class DTMNodeProxy implements Node, Document, Text, Element, Attr, ProcessingInstruction, Comment, DocumentFragment {
    ...
    static final DOMImplementation implementation = null;
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: org.apache.xml.dtm.ref.DTMNodeProxy.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: org.apache.xml.dtm.ref.DTMNodeProxy.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.xml.dtm.ref.DTMNodeProxy.<clinit>():void");
    }
    ...
    public final NodeList getElementsByTagName(String tagname) {
        ...
        if (retNode != null) {
            boolean isTagNameWildCard = PsuedoNames.PSEUDONAME_OTHER.equals(tagname);
    ...
    public final NodeList getElementsByTagNameNS(String namespaceURI, String localName) {
        ...
        Node retNode = this.dtm.getNode(this.node);
        if (retNode != null) {
            boolean isNamespaceURIWildCard = PsuedoNames.PSEUDONAME_OTHER.equals(namespaceURI);
            boolean isLocalNameWildCard = PsuedoNames.PSEUDONAME_OTHER.equals(localName);
            if ((short) 1 == retNode.getNodeType()) {
                NodeList nodeList = retNode.getChildNodes();
                for (i = 0; i < nodeList.getLength(); i++) {
    ...
    public final String getAttribute(String name) {
        ...
        return node == null ? EMPTYSTRING : node.getNodeValue();
    }
    ...
    public final String getAttributeNS(String namespaceURI, String localName) {
        ...
        return retNode == null ? EMPTYSTRING : retNode.getNodeValue();
    }

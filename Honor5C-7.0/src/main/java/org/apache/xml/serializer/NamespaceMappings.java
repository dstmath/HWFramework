...
public class NamespaceMappings {
    ...
    class MappingRecord {
        ...
        MappingRecord(String prefix, String uri, int depth) {
            ...
            if (uri == null) {
                uri = NamespaceMappings.EMPTYSTRING;
            }
            this.m_uri = uri;
    ...
    private void initNamespaces() {
        createPrefixStack(EMPTYSTRING).push(new MappingRecord(EMPTYSTRING, EMPTYSTRING, -1));
        createPrefixStack(XML_PREFIX).push(new MappingRecord(XML_PREFIX, JAXPPrefixResolver.S_XMLNAMESPACEURI, -1));
    }

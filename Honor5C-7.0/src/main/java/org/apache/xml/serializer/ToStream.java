...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: org.apache.xml.serializer.ToStream.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: org.apache.xml.serializer.ToStream.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.xml.serializer.ToStream.<clinit>():void");
    }
        ...
        if (val != null) {
            switch (SerializerBase.getFirstCharLocName(name)) {
                ...
                case 'e':
                    ...
                    if (DOMConstants.S_XSL_OUTPUT_ENCODING.equals(name)) {
                        ...
                        String oldExplicitEncoding = getOutputPropertyNonDefault(DOMConstants.S_XSL_OUTPUT_ENCODING);
                        String oldDefaultEncoding = getOutputPropertyDefault(DOMConstants.S_XSL_OUTPUT_ENCODING);
                        if ((defaultVal && (oldDefaultEncoding == null || !oldDefaultEncoding.equalsIgnoreCase(val))) || (!defaultVal && (oldExplicitEncoding == null || !oldExplicitEncoding.equalsIgnoreCase(val)))) {
                            ...
                            if (val != null && encodingInfo.name == null) {
                                String msg = Utils.messages.createMessage(MsgKey.ER_ENCODING_NOT_SUPPORTED, new Object[]{val});
                            ...
                            if (!defaultVal || oldExplicitEncoding == null) {
                                ...
                                if (os != null) {
                                    Writer w = getWriter();
                                    String oldEncoding = getOutputProperty(DOMConstants.S_XSL_OUTPUT_ENCODING);
                ...
                case 'i':
                    if (!OutputPropertiesFactory.S_KEY_INDENT_AMOUNT.equals(name)) {
                        if (DOMConstants.S_XSL_OUTPUT_INDENT.equals(name)) {
                ...
                case 'm':
                    ...
                    break;
                case 'o':
                    if (DOMConstants.S_XSL_OUTPUT_OMIT_XML_DECL.equals(name)) {
                ...
                case 's':
                    ...
                    break;
                case 'v':
                    if (Constants.ATTRNAME_VERSION.equals(name)) {
                        this.m_version = val;
                        break;
                    }
                    break;
    ...
    private void setOutputStreamInternal(OutputStream output, boolean setByUser) {
        ...
        String encoding = getOutputProperty(DOMConstants.S_XSL_OUTPUT_ENCODING);
    ...
    protected int writeUTF16Surrogate(char c, char[] ch, int i, int end) throws IOException {
        if (i + 1 >= end) {
            throw new IOException(Utils.messages.createMessage(XPATHErrorResources.ER_INVALID_UTF16_SURROGATE, new Object[]{Integer.toHexString(c)}));
        }
        char high = c;
        char low = ch[i + 1];
        ...
        throw new IOException(Utils.messages.createMessage(XPATHErrorResources.ER_INVALID_UTF16_SURROGATE, new Object[]{Integer.toHexString(c) + " " + Integer.toHexString(low)}));
    }
    ...
    protected void cdata(char[] ch, int start, int length) throws SAXException {
        ...
        try {
            ...
            if (length >= 1) {
                writeCDataBrackets = escapingNotNeeded(ch[start]);
            }
                ...
                if (!this.m_charInfo.shouldMapTextChar(ch1)) {
                    switch (ch1) {
                        ...
                        case OpCodes.OP_DIV /*13*/:
                            ...
                            i++;
                            break;
                        case FunctionTable.FUNC_LANG /*32*/:
                            i++;
                            break;
                        default:
    ...
    private int accumDefaultEscape(Writer writer, char ch, int i, char[] chars, int len, boolean fromTextNode, boolean escLF) throws IOException {
        ...
        if (!Encodings.isHighUTF16Surrogate(ch)) {
            ...
            throw new IOException(Utils.messages.createMessage(XPATHErrorResources.ER_INVALID_UTF16_SURROGATE, new Object[]{Integer.toHexString(ch)}));
        } else {
            char next = chars[i + 1];
            ...
            throw new IOException(Utils.messages.createMessage(XPATHErrorResources.ER_INVALID_UTF16_SURROGATE, new Object[]{Integer.toHexString(ch) + " " + Integer.toHexString(next)}));
        }
    }
    ...
    public boolean startPrefixMapping(String prefix, String uri, boolean shouldFlush) throws SAXException {
        ...
        if (pushed) {
            ...
            if (SerializerConstants.EMPTYSTRING.equals(prefix)) {
                name = SerializerConstants.XMLNS_PREFIX;
                ...
                String str = Constants.ATTRNAME_XMLNS + prefix;
    ...
    protected String ensureAttributesNamespaceIsDeclared(String ns, String localName, String rawName) throws SAXException {
        ...
        if (index < 0) {
            prefixFromRawName = SerializerConstants.EMPTYSTRING;
        } else {
    ...
    void ensurePrefixIsDeclared(String ns, String rawName) throws SAXException {
        if (ns != null && ns.length() > 0) {
            ...
            String prefix = no_prefix ? SerializerConstants.EMPTYSTRING : rawName.substring(0, index);
            if (prefix != null) {
                ...
                if (foundURI == null || !foundURI.equals(ns)) {
                    ...
                    if (no_prefix) {
                        str = SerializerConstants.XMLNS_PREFIX;
                    } else {
                        str = prefix;
                    }
                    addAttributeAlways(str2, str, no_prefix ? SerializerConstants.XMLNS_PREFIX : Constants.ATTRNAME_XMLNS + prefix, "CDATA", ns, false);
                }
            }
        }
    }
    ...
    public void setEncoding(String encoding) {
        setOutputProperty(DOMConstants.S_XSL_OUTPUT_ENCODING, encoding);
    }

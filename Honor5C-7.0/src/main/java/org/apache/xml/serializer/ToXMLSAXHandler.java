...
public final class ToXMLSAXHandler extends ToSAXHandler {
    ...
    public boolean setEscaping(boolean escape) throws SAXException {
        ...
        if (escape) {
            processingInstruction("javax.xml.transform.enable-output-escaping", SerializerConstants.EMPTYSTRING);
        } else {
            processingInstruction("javax.xml.transform.disable-output-escaping", SerializerConstants.EMPTYSTRING);
        }

...
public class ToXMLStream extends ToStream {
    ...
    public ToXMLStream() {
        this.m_xmlcharInfo = CharInfo.getCharInfo(CharInfo.XML_ENTITIES_RESOURCE, SerializerConstants.XML_PREFIX);
            ...
            if (!this.m_inEntityRef) {
                ...
                if (!getOmitXMLDeclaration()) {
                    ...
                    if (this.m_standaloneWasSpecified) {
                        ...
                        standalone = SerializerConstants.EMPTYSTRING;
                    }
                    try {
    ...
    public void addAttribute(String uri, String localName, String rawName, String type, String value, boolean xslAttribute) throws SAXException {
        if (this.m_elemContext.m_startTagOpen) {
            if (!(!addAttributeAlways(uri, localName, rawName, type, value, xslAttribute) || xslAttribute || rawName.startsWith(SerializerConstants.XMLNS_PREFIX))) {

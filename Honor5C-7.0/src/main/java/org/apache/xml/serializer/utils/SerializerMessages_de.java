...
public class SerializerMessages_de extends ListResourceBundle {
    public Object[][] getContents() {
        ...
        contents[3] = new Object[]{MsgKey.ER_RESOURCE_COULD_NOT_FIND, "Die Ressource [ {0} ] konnte nicht gefunden werden.\n {1}"};
        contents[4] = new Object[]{MsgKey.ER_RESOURCE_COULD_NOT_LOAD, "Die Ressource [ {0} ] konnte nicht geladen werden: {1} \n {2} \t {3}"};
        contents[5] = new Object[]{MsgKey.ER_BUFFER_SIZE_LESSTHAN_ZERO, "Puffergr\u00f6\u00dfe <=0"};
        contents[6] = new Object[]{XPATHErrorResources.ER_INVALID_UTF16_SURROGATE, "Ung\u00fcltige UTF-16-Ersetzung festgestellt: {0} ?"};
        contents[7] = new Object[]{XPATHErrorResources.ER_OIERROR, "E/A-Fehler"};
        ...
        contents[12] = new Object[]{MsgKey.ER_COULD_NOT_LOAD_RESOURCE, "''{0}'' konnte nicht geladen werden (CLASSPATH pr\u00fcfen). Es werden die Standardwerte verwendet."};
        ...
        contents[15] = new Object[]{MsgKey.ER_INVALID_PORT, "Ung\u00fcltige Portnummer"};
        contents[16] = new Object[]{MsgKey.ER_PORT_WHEN_HOST_NULL, "Der Port kann nicht festgelegt werden, wenn der Host gleich Null ist."};
        contents[17] = new Object[]{MsgKey.ER_HOST_ADDRESS_NOT_WELLFORMED, "Der Host ist keine syntaktisch korrekte Adresse."};
        contents[18] = new Object[]{MsgKey.ER_SCHEME_NOT_CONFORMANT, "Das Schema ist nicht angepasst."};
        contents[19] = new Object[]{MsgKey.ER_SCHEME_FROM_NULL_STRING, "Schema kann nicht von Nullzeichenfolge festgelegt werden."};
        contents[20] = new Object[]{MsgKey.ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE, "Der Pfad enth\u00e4lt eine ung\u00fcltige Escapezeichenfolge."};
        contents[21] = new Object[]{MsgKey.ER_PATH_INVALID_CHAR, "Pfad enth\u00e4lt ung\u00fcltiges Zeichen: {0}."};
        contents[22] = new Object[]{MsgKey.ER_FRAG_INVALID_CHAR, "Fragment enth\u00e4lt ein ung\u00fcltiges Zeichen."};
        contents[23] = new Object[]{MsgKey.ER_FRAG_WHEN_PATH_NULL, "Fragment kann nicht festgelegt werden, wenn der Pfad gleich Null ist."};
        contents[24] = new Object[]{MsgKey.ER_FRAG_FOR_GENERIC_URI, "Fragment kann nur f\u00fcr eine generische URI (Uniform Resource Identifier) festgelegt werden."};
        contents[25] = new Object[]{MsgKey.ER_NO_SCHEME_IN_URI, "Kein Schema gefunden in URI"};
        contents[26] = new Object[]{MsgKey.ER_CANNOT_INIT_URI_EMPTY_PARMS, "URI (Uniform Resource Identifier) kann nicht mit leeren Parametern initialisiert werden."};
        contents[27] = new Object[]{MsgKey.ER_NO_FRAGMENT_STRING_IN_PATH, "Fragment kann nicht im Pfad und im Fragment angegeben werden."};
        contents[28] = new Object[]{MsgKey.ER_NO_QUERY_STRING_IN_PATH, "Abfragezeichenfolge kann nicht im Pfad und in der Abfragezeichenfolge angegeben werden."};
        contents[29] = new Object[]{MsgKey.ER_NO_PORT_IF_NO_HOST, "Der Port kann nicht angegeben werden, wenn der Host nicht angegeben wurde."};
        contents[30] = new Object[]{MsgKey.ER_NO_USERINFO_IF_NO_HOST, "Benutzerinformationen k\u00f6nnen nicht angegeben werden, wenn der Host nicht angegeben wurde."};
        ...
        contents[32] = new Object[]{MsgKey.ER_SCHEME_REQUIRED, "Schema ist erforderlich!"};
        ...
        contents[34] = new Object[]{MsgKey.ER_ENCODING_NOT_SUPPORTED, "Warnung:  Die Codierung ''{0}'' wird von Java Runtime nicht unterst\u00fctzt."};
        contents[35] = new Object[]{MsgKey.ER_FEATURE_NOT_FOUND, "Der Parameter ''{0}'' wird nicht erkannt."};
        contents[36] = new Object[]{MsgKey.ER_FEATURE_NOT_SUPPORTED, "Der Parameter ''{0}'' wird erkannt, der angeforderte Wert kann jedoch nicht festgelegt werden."};
        ...
        contents[57] = new Object[]{MsgKey.ER_ELEM_UNBOUND_PREFIX_IN_ENTREF, "Der Ersatztext des Entit\u00e4tenknotens \"{0}\" enth\u00e4lt einen Elementknoten \"{1}\" mit einem nicht gebundenen Pr\u00e4fix \"{2}\"."};
        contents[58] = new Object[]{MsgKey.ER_ELEM_UNBOUND_PREFIX_IN_ENTREF, "Der Ersatztext des Entit\u00e4tenknotens \"{0}\" enth\u00e4lt einen Attributknoten \"{1}\" mit einem nicht gebundenen Pr\u00e4fix \"{2}\"."};
        return contents;
    }
}

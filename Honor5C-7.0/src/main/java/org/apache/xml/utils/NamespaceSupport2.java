...
public class NamespaceSupport2 extends NamespaceSupport {
    ...
    public void reset() {
        ...
        this.currentContext.declarePrefix(SerializerConstants.XML_PREFIX, XMLNS);
    }
    ...
    public boolean declarePrefix(String prefix, String uri) {
        if (prefix.equals(SerializerConstants.XML_PREFIX) || prefix.equals(SerializerConstants.XMLNS_PREFIX)) {
            return false;
        }

...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: org.apache.xml.utils.URI.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: org.apache.xml.utils.URI.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.xml.utils.URI.<clinit>():void");
    }
    ...
    public URI(String p_scheme, String p_userinfo, String p_host, int p_port, String p_path, String p_queryString, String p_fragment) throws MalformedURIException {
        ...
        this.m_fragment = null;
        if (p_scheme == null || p_scheme.trim().length() == 0) {
            throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_SCHEME_REQUIRED, null));
        }
        if (p_host == null) {
            if (p_userinfo != null) {
                throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_NO_USERINFO_IF_NO_HOST, null));
            } else if (p_port != -1) {
                throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_NO_PORT_IF_NO_HOST, null));
            }
        }
        if (p_path != null) {
            if (p_path.indexOf(63) != -1 && p_queryString != null) {
                throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_NO_QUERY_STRING_IN_PATH, null));
            } else if (!(p_path.indexOf(35) == -1 || p_fragment == null)) {
                throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_NO_FRAGMENT_STRING_IN_PATH, null));
            }
        }
        setScheme(p_scheme);
        setHost(p_host);
    ...
    private void initialize(URI p_base, String p_uriSpec) throws MalformedURIException {
        if (p_base == null && (p_uriSpec == null || p_uriSpec.trim().length() == 0)) {
            throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_CANNOT_INIT_URI_EMPTY_PARMS, null));
            ...
            if (colonIndex >= 0) {
                ...
                throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_NO_SCHEME_IN_URI, new Object[]{uriSpec}));
            }
            if (uriSpec.startsWith("//")) {
                ...
                if (index > startPos) {
                    ...
                    this.m_host = SerializerConstants.EMPTYSTRING;
                }
            }
    ...
    private void initializeScheme(String p_uriSpec) throws MalformedURIException {
        ...
        if (scheme.length() == 0) {
            throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_NO_SCHEME_INURI, null));
        }
        setScheme(scheme);
    }
            ...
            if (!(c == '?' || c == '#')) {
                if (c == '%') {
                    if (index + 2 >= end || !isHex(p_uriSpec.charAt(index + 1)) || !isHex(p_uriSpec.charAt(index + 2))) {
                        throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE, null));
                    }
                } else if (!(isReservedCharacter(c) || isUnreservedCharacter(c) || '\\' == c)) {
                    throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_PATH_INVALID_CHAR, new Object[]{String.valueOf(c)}));
                }
                index++;
            }
        }
    ...
    public void setScheme(String p_scheme) throws MalformedURIException {
        if (p_scheme == null) {
            throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_SCHEME_FROM_NULL_STRING, null));
        } else if (isConformantSchemeName(p_scheme)) {
            this.m_scheme = p_scheme.toLowerCase();
        } else {
            throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_SCHEME_NOT_CONFORMANT, null));
        }
    }
    ...
    public void setHost(String p_host) throws MalformedURIException {
        if (p_host == null || p_host.trim().length() == 0) {
            ...
            throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_HOST_ADDRESS_NOT_WELLFORMED, null));
        }
        this.m_host = p_host;
    }
    ...
    public void setPort(int p_port) throws MalformedURIException {
        if (p_port < 0 || p_port > DTMManager.IDENT_NODE_DEFAULT) {
            if (p_port != -1) {
                throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_INVALID_PORT, null));
            }
        } else if (this.m_host == null) {
            throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_PORT_WHEN_HOST_NULL, null));
        }
        this.m_port = p_port;
    }
    ...
    public void appendPath(String p_addToPath) throws MalformedURIException {
        if (p_addToPath != null && p_addToPath.trim().length() != 0) {
            ...
            throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_PATH_INVALID_CHAR, new Object[]{p_addToPath}));
        }
    }
    ...
    public void setFragment(String p_fragment) throws MalformedURIException {
        if (p_fragment == null) {
            ...
            throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_FRAG_FOR_GENERIC_URI, null));
        } else if (getPath() == null) {
            throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_FRAG_WHEN_PATH_NULL, null));
        } else if (isURIString(p_fragment)) {
            this.m_fragment = p_fragment;
        } else {
            throw new MalformedURIException(XMLMessages.createXMLMessage(MsgKey.ER_FRAG_INVALID_CHAR, null));
        }
    }

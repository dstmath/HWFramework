...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: org.apache.xpath.patterns.NodeTest.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: org.apache.xpath.patterns.NodeTest.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.xpath.patterns.NodeTest.<clinit>():void");
    }
    ...
    public String getLocalName() {
        return this.m_name == null ? SerializerConstants.EMPTYSTRING : this.m_name;
    }
    ...
    protected void calcScore() {
        ...
        } else if ((this.m_namespace == WILD || this.m_namespace == null) && this.m_name == WILD) {
            this.m_score = SCORE_NODETEST;
        } else if (this.m_namespace == WILD || this.m_name != WILD) {
            this.m_score = SCORE_QNAME;
        } else {
            this.m_score = SCORE_NSWILD;
        }
        if (this.m_namespace == null && this.m_name == WILD) {
            z = true;
        }
    ...
    public XObject execute(XPathContext xctxt, int context) throws TransformerException {
        ...
        switch (this.m_whatToShow & (1 << (nodeType - 1))) {
            ...
            case VariableStack.CLEARLIMITATION /*1024*/:
                return SCORE_OTHER;
            case WalkerFactory.BIT_PREDICATE /*4096*/:

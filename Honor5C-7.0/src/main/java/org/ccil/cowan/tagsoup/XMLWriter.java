...
public class XMLWriter extends XMLFilterImpl implements LexicalHandler {
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        boolean z;
        if (!this.htmlMode || (!uri.equals("http://www.w3.org/1999/xhtml") && !uri.equals(""))) {
            z = false;
        } else if (qName.equals("area") || qName.equals("base") || qName.equals("basefont") || qName.equals("br") || qName.equals("col") || qName.equals("frame") || qName.equals("hr") || qName.equals("img") || qName.equals("input") || qName.equals("isindex") || qName.equals("link") || qName.equals("meta")) {
            z = true;
        } else {
            z = qName.equals("param");
        }
        if (!z) {
            write("</");
            writeName(uri, localName, qName, true);

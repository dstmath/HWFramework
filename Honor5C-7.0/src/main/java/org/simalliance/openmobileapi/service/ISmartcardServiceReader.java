    ...
    public static abstract class Stub extends Binder implements ISmartcardServiceReader {
        ...
        private static class Proxy implements ISmartcardServiceReader {
            ...
            public boolean isSecureElementPresent(SmartcardError error) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_isSecureElementPresent, _data, _reply, 0);
                    _reply.readException();
            ...
            public void closeSessions(SmartcardError error) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_closeSessions, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        error.readFromParcel(_reply);
                    }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case TRANSACTION_getName /*1*/:
                    ...
                    if (_arg0 != null) {
                        reply.writeInt(TRANSACTION_getName);
                        _arg0.writeToParcel(reply, TRANSACTION_getName);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case TRANSACTION_isSecureElementPresent /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = new SmartcardError();
                    boolean _result2 = isSecureElementPresent(_arg0);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? TRANSACTION_getName : 0);
                    if (_arg0 != null) {
                        reply.writeInt(TRANSACTION_getName);
                        _arg0.writeToParcel(reply, TRANSACTION_getName);
                    } else {
                    ...
                    return true;
                case TRANSACTION_openSession /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = new SmartcardError();
                    ...
                    return true;
                case TRANSACTION_closeSessions /*4*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = new SmartcardError();
                    closeSessions(_arg0);
                    reply.writeNoException();

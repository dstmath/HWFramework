...
public class ParserAdapter implements XMLReader, DocumentHandler {
    ...
    public void startElement(String qName, AttributeList qAtts) throws SAXException {
            ...
            for (i = 0; i < length; i++) {
                ...
                if (attQName.startsWith(XMLConstants.XMLNS_ATTRIBUTE)) {
                    ...
                    if (prefix != null) {
                        if (this.prefixes) {
                            if (this.uris) {
                                this.atts.addAttribute(NamespaceSupport.XMLNS, prefix, attQName.intern(), type, value);
                            } else {
                                this.atts.addAttribute(XmlPullParser.NO_NAMESPACE, XmlPullParser.NO_NAMESPACE, attQName.intern(), type, value);
                            }
                        }
                    }
                }
                try {
                    ...
                    this.atts.addAttribute(XmlPullParser.NO_NAMESPACE, attQName, attQName, type, value);
                }
            }
        ...
        if (this.contentHandler != null) {
            ...
            this.contentHandler.startElement(XmlPullParser.NO_NAMESPACE, XmlPullParser.NO_NAMESPACE, qName.intern(), this.attAdapter);
        }
    }
    ...
    public void endElement(String qName) throws SAXException {
        ...
        if (this.contentHandler != null) {
            this.contentHandler.endElement(XmlPullParser.NO_NAMESPACE, XmlPullParser.NO_NAMESPACE, qName.intern());
        }
    }

...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: sun.misc.Version.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: sun.misc.Version.<clinit>():void
...
*/
    ...
    public static void print(PrintStream ps) {
        ...
        if (headless != null && headless.equalsIgnoreCase(Unpacker.TRUE)) {
            isHeadless = true;
        }

...
public class PKCS7 {
    ...
    private void parseSignedData(DerValue val) throws ParsingException, IOException {
        ...
        byte peekByte = (byte) dis.peekByte();
        if (r0 == -96) {
    ...
    public void encodeSignedData(DerOutputStream out) throws IOException {
        ...
        signedData.putOrderedSetOf(DerValue.tag_SetOf, this.digestAlgorithmIds);
        ...
        signedData.putOrderedSetOf(DerValue.tag_SetOf, this.signerInfos);
        new ContentInfo(ContentInfo.SIGNED_DATA_OID, new DerValue((byte) DerValue.tag_SequenceOf, signedData.toByteArray())).encode(out);
    }

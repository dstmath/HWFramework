...
public class Extension implements java.security.cert.Extension {
    ...
    public void encode(OutputStream out) throws IOException {
        ...
        dos2.write((byte) DerValue.tag_SequenceOf, dos1);
    ...
    public void encode(DerOutputStream out) throws IOException {
        if (this.extensionId == null) {
            ...
            out.write((byte) DerValue.tag_SequenceOf, dos);
        }
    }
    ...
    public int hashCode() {
        ...
        return (((h * hashMagic) + this.extensionId.hashCode()) * hashMagic) + (this.critical ? 1231 : 1237);
    }

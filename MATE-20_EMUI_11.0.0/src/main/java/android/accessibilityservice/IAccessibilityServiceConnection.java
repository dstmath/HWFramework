            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 7:
                        ...
                        boolean performAccessibilityAction = performAccessibilityAction(_arg04, _arg13, _arg22, _arg3, data.readInt(), IAccessibilityInteractionConnectionCallback.Stub.asInterface(data.readStrongBinder()), data.readLong());
                        reply.writeNoException();
                    ...
                    case 18:
                        ...
                        boolean resetMagnification = resetMagnification(_arg05, _arg02);
                        reply.writeNoException();
                    ...
                    case 20:
                        ...
                        setMagnificationCallbackEnabled(_arg06, _arg02);
                        reply.writeNoException();
                        return true;
                    case 21:
                        data.enforceInterface(DESCRIPTOR);

            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 13:
                        ...
                        removeAccountAsUser(_arg024, _arg13, _arg26, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 14:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 22:
                        ...
                        updateAppPermission(_arg010, _arg113, _arg27, _arg26);
                        reply.writeNoException();
                        return true;
                    case 23:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        getAuthToken(_arg026, _arg15, _arg28, _arg32, _arg43, _arg5);
                        reply.writeNoException();
                        return true;
                    case 24:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        addAccount(_arg027, _arg114, _arg29, _arg33, _arg44, _arg52);
                        reply.writeNoException();
                        return true;
                    case 25:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        addAccountAsUser(_arg028, _arg115, _arg210, _arg34, _arg45, _arg53, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 26:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        updateCredentials(_arg029, _arg16, _arg211, _arg35, _arg4);
                        reply.writeNoException();
                        return true;
                    case 27:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        editProperties(_arg030, _arg116, _arg26);
                        reply.writeNoException();
                        return true;
                    case 28:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 37:
                        ...
                        startAddAccountSession(_arg033, _arg117, _arg212, _arg36, _arg46, _arg54);
                        reply.writeNoException();
                        return true;
                    case 38:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        startUpdateCredentialsSession(_arg034, _arg19, _arg213, _arg37, _arg42);
                        reply.writeNoException();
                        return true;
                    case 39:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        finishSessionAsUser(_arg035, _arg110, _arg214, _arg3, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 40:
                        data.enforceInterface(DESCRIPTOR);

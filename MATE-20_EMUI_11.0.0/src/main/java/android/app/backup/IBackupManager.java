            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 12:
                        ...
                        setBackupEnabledForUser(_arg0, _arg15);
                        reply.writeNoException();
                        return true;
                    case 13:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 14:
                        ...
                        setAutoRestoreForUser(_arg02, _arg15);
                        reply.writeNoException();
                        return true;
                    case 15:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 22:
                        ...
                        adbBackup(_arg03, _arg1, _arg2, _arg32, _arg4, _arg52, _arg62, _arg7, _arg8, _arg15, data.createStringArray());
                        reply.writeNoException();
                        return true;
                    case 23:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 27:
                        ...
                        updateTransportAttributesForUser(_arg05, _arg13, _arg22, _arg3, _arg42, _arg5, _arg6);
                        reply.writeNoException();
                        return true;
                    case 28:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 37:
                        ...
                        selectBackupTransportAsyncForUser(_arg06, _arg14, ISelectBackupTransportCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 38:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 48:
                        ...
                        setBackupServiceActive(_arg07, _arg15);
                        reply.writeNoException();
                        return true;
                    case 49:
                        data.enforceInterface(DESCRIPTOR);

...
public interface IMultiTaskManagerService extends IInterface {
    RPolicyData acquirePolicyData(int i, SceneData sceneData) throws RemoteException;
    ...
    boolean reportScene(int i, SceneData sceneData) throws RemoteException;
    ...
    public static class Default implements IMultiTaskManagerService {
        ...
        @Override // android.app.mtm.IMultiTaskManagerService
        public boolean reportScene(int featureId, SceneData scene) throws RemoteException {
            return false;
        }

        @Override // android.app.mtm.IMultiTaskManagerService
        public RPolicyData acquirePolicyData(int featureId, SceneData scene) throws RemoteException {
            return null;
        }
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 3:
                        ...
                        notifyResourceStatusOverload(_arg02, _arg15, _arg2, _arg3);
                        reply.writeNoException();
                        return true;
                    case 4:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 9:
                        ...
                        if (data.readInt() != 0) {
                            _arg1 = SceneData.CREATOR.createFromParcel(data);
                        } else {
                            _arg1 = null;
                        }
                    ...
                    case 10:
                        ...
                        if (data.readInt() != 0) {
                            _arg12 = SceneData.CREATOR.createFromParcel(data);
                        } else {
                            _arg12 = null;
                        }
                    ...
                    case 13:
                        ...
                        boolean updateAppStartupSettings = updateAppStartupSettings(_arg07, _arg14);
                        reply.writeNoException();

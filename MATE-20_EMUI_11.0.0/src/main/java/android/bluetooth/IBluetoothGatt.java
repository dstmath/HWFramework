...
public interface IBluetoothGatt extends IInterface {
    ...
    void updateScanParams(int i, boolean z, int i2) throws RemoteException;
    ...
    public static class Default implements IBluetoothGatt {
        ...
        @Override // android.bluetooth.IBluetoothGatt
        public void updateScanParams(int appIf, boolean isServer, int scanMode) throws RemoteException {
        }
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 12:
                        ...
                        enableAdvertisingSet(_arg010, _arg07, data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 13:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 18:
                        ...
                        setPeriodicAdvertisingEnable(_arg016, _arg07);
                        reply.writeNoException();
                        return true;
                    case 19:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 29:
                        ...
                        discoverServiceByUuid(_arg017, _arg112, _arg22);
                        reply.writeNoException();
                        return true;
                    case 30:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 31:
                        ...
                        readUsingCharacteristicUuid(_arg018, _arg113, _arg23, data.readInt(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 32:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 35:
                        ...
                        registerForNotification(_arg019, _arg114, _arg24, _arg07);
                        reply.writeNoException();
                        return true;
                    case 36:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 37:
                        ...
                        endReliableWrite(_arg020, _arg115, _arg07);
                        reply.writeNoException();
                        return true;
                    case 38:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 44:
                        ...
                        serverConnect(_arg021, _arg116, _arg07, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 45:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 58:
                        ...
                        updateScanParams(_arg023, _arg07, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 59:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        fastClientConnect(_arg024, _arg117, _arg07, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 60:
                        data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements IBluetoothGatt {
            ...
            public void updateScanParams(int appIf, boolean isServer, int scanMode) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().updateScanParams(appIf, isServer, scanMode);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }

...
public final class ScanResult implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.mAddressTypeEx);
    }
    ...
    private void readFromParcel(Parcel in) {
        ...
        this.mAddressTypeEx = in.readInt();
    }
    ...
    public int getAddressTypeEx() {
        return this.mAddressTypeEx;
    }

    public void setAddressTypeEx(int addressTypeEx) {
        this.mAddressTypeEx = addressTypeEx;
    }

...
public interface HwFrameworkMonitor {
    ...
    public static final String KEY_USAGE_COUNT = "COUNT";
    public static final String KEY_USAGE_TYPE = "TYPE";
    ...
    public static final int SCENE_PMS_PARALLEL_DEX_OPT_FAILED = 907400032;
    ...
    public static final int USAGE_STATS_EVENT_ID = 907400284;

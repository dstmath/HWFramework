...
public interface IPackageManagerNative extends IInterface {
    ...
    boolean[] hasAllowAudioPlaybackCaptureConfig(String[] strArr) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IPackageManagerNative {
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 8:
                    return "hasAllowAudioPlaybackCaptureConfig";
                case 9:
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 8:
                        data.enforceInterface(DESCRIPTOR);
                        boolean[] _result8 = hasAllowAudioPlaybackCaptureConfig(data.createStringArray());
                        reply.writeNoException();
                        reply.writeBooleanArray(_result8);
                        return true;
                    case 9:
                        data.enforceInterface(DESCRIPTOR);
                        String[] _result9 = getPackagesForUid(data.readInt());
                        reply.writeNoException();
            ...
            public boolean[] hasAllowAudioPlaybackCaptureConfig(String[] packageNames) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(8, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().hasAllowAudioPlaybackCaptureConfig(packageNames);
                    }
                    _reply.readException();
                    boolean[] _result = _reply.createBooleanArray();
                    _reply.recycle();

...
public final class Configuration implements Parcelable, Comparable<Configuration> {
    ...
    public Rect getWindowConfigurationBounds() {
        return this.windowConfiguration.getBounds();
    }
                                        ...
                                        try {
                                            ...
                                            if (fieldNumber == 1) {
                                                ...
                                                try {
                                                    ...
                                                    try {
                                                        throw wtme;
                                                    } catch (Throwable wtme2) {
                                                        wireTypeMismatchException = wtme2;
                                                    }
                                                } catch (Throwable th2) {
    ...
    public void setMultiWindowConfigTo(Configuration other) {
        ...
        this.compatScreenWidthDp = other.compatScreenWidthDp;
        this.compatScreenHeightDp = other.compatScreenHeightDp;
        this.compatSmallestScreenWidthDp = other.compatSmallestScreenWidthDp;
        this.windowConfiguration.setTo(other.windowConfiguration);
    }
}

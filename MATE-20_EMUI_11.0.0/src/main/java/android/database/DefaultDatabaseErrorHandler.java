...
public final class DefaultDatabaseErrorHandler implements DatabaseErrorHandler {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x004e, code lost:
        r3 = r2.next();
        deleteDatabaseFile(r3.second);
        reportCorruption(r3.second);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0064, code lost:
        deleteDatabaseFile(r6.getPath());
        reportCorruption(r6.getPath());
     */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:8:0x0038 A[ExcHandler: all (r1v9 'th' java.lang.Throwable A[CUSTOM_DECLARE]), PHI: r0 
    ...
    public void onCorruption(SQLiteDatabase dbObj) {
        ...
        if (attachedDbs != null) {
            for (Pair<String, String> p : attachedDbs) {
                ...
                reportCorruption(p.second);
            }
            return;
        }
        deleteDatabaseFile(dbObj.getPath());
        reportCorruption(dbObj.getPath());
    }
    ...
    private void reportCorruption(String fileName) {
        IHwDatabaseErrorReporter hwDatabaseErrorReporter = HwFrameworkFactory.getHwDatabaseErrorReporter();
        if (hwDatabaseErrorReporter != null) {
            hwDatabaseErrorReporter.report(1, fileName);
        }
    }

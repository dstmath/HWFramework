...
public class EmailInfo extends SmartcareInfos.SmartcareBaseInfo implements Parcelable {
    ...
    public EmailInfo(Parcel pa) {
        ...
        this.type = (byte) (pa.readInt() & ConstantValues.MAX_CHANNEL_VALUE);
        this.latency = pa.readInt();
        this.successFlag = (byte) (pa.readInt() & ConstantValues.MAX_CHANNEL_VALUE);
        this.abnormalDroppingFlag = (byte) (pa.readInt() & ConstantValues.MAX_CHANNEL_VALUE);
        this.hostName = pa.readString();
        this.emailStartDate = pa.readInt();
        this.emailStartTime = pa.readInt();
        this.emailEndTime = pa.readInt();
        this.protocolType = (byte) (pa.readInt() & ConstantValues.MAX_CHANNEL_VALUE);

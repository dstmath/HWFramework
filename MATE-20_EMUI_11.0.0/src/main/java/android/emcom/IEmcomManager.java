        ...
        public static class Proxy implements IEmcomManager {
            ...
            public int startHandoffService(String packageName, String para) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(packageName);
                    _data.writeString(para);
                    if (!this.mRemote.transact(Stub.TRANSACTION_startHandoffService, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public int stopHandoffService(String packageName, String para) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(packageName);
                    _data.writeString(para);
                    if (!this.mRemote.transact(Stub.TRANSACTION_stopHandoffService, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public int syncHandoffData(String packageName, String para) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(packageName);
                    _data.writeString(para);
                    if (!this.mRemote.transact(Stub.TRANSACTION_syncHandoffData, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean isEnableHandoff() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_isEnableHandoff, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean isHandoffServiceSupported(String packageName, int serviceType) throws RemoteException {
                ...
                try {
                    ...
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_isHandoffServiceSupported, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public Map getHandoffBindRelationMap(String packageName, int serviceType) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(packageName);
                    _data.writeInt(serviceType);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getHandoffBindRelationMap, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public int unbindHandoffRelation(String packageName, int serviceType, String nfcSn) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(Stub.TRANSACTION_unbindHandoffRelation, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public int onehopAuthReq(String packageName, IOneHopAuthReqCallback callback) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(packageName);
                    _data.writeStrongBinder(callback != null ? callback.asBinder() : null);
                    if (!this.mRemote.transact(Stub.TRANSACTION_onehopAuthReq, _data, _reply, 0) && Stub.getDefaultImpl() != null) {

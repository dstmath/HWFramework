...
public class HEX {
    ...
    /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x0043: APUT  
      (r1v1 'l_btTmp' byte[] A[D('l_btTmp' byte[]), IMMUTABLE_TYPE])
      (0 ??[int, short, byte, char])
      (wrap: byte : 0x0041: CAST (r9v3 byte A[IMMUTABLE_TYPE]) = (byte) (wrap: int : 0x003d: INVOKE  (r9v2 'jj' int) = (r2v1 'l_stData' java.lang.String A[D('l_stData' java.lang.String)]), (r9v1 'jj' int A[D('jj' int)]) type: VIRTUAL call: java.lang.String.charAt(int):char))
     */

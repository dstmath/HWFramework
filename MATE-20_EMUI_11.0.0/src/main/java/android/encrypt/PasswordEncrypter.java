...
public class PasswordEncrypter {
    ...
    public static String decrypter(String password) {
        try {
            ...
            Log.e("PasswordEncrypter", "decrypter InvalidKeyException error");
            return password;
        } catch (BadPaddingException e2) {
            Log.e("PasswordEncrypter", "decrypter BadPaddingException error");
            return password;
        } catch (IllegalBlockSizeException e3) {
            Log.e("PasswordEncrypter", "decrypter IllegalBlockSizeException error");
            return password;
        } catch (NoSuchAlgorithmException e4) {
            Log.e("PasswordEncrypter", "decrypter NoSuchAlgorithmException error");
            return password;
        } catch (NoSuchPaddingException e5) {
            Log.e("PasswordEncrypter", "decrypter NoSuchPaddingException error");
            return password;
        } catch (Exception e6) {
            Log.e("PasswordEncrypter", "decrypter Exception error");
            return password;
        }
    }
}

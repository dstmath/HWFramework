...
public abstract class ColorSpace {
    ...
    public static final float[] ILLUMINANT_D65 = {0.3127f, 0.329f};
    ...
    public static class Renderer {
        ...
        /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x002e: APUT  
          (r0v4 'v' float[] A[D('v' float[])])
          (0 ??[int, short, byte, char])
          (wrap: float : 0x002c: AGET  (r6v1 float) = 
          (wrap: float[] : 0x0029: IGET  (r6v0 float[]) = (r5v2 'point' android.graphics.ColorSpace$Renderer$Point A[D('point' android.graphics.ColorSpace$Renderer$Point)]) android.graphics.ColorSpace.Renderer.Point.mRgb float[])
          (0 ??[int, short, byte, char])
        )
         */
        /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x0052: APUT  
          (r3v0 'xy' float[] A[D('xy' float[])])
          (0 ??[int, short, byte, char])
          (wrap: float : 0x0051: ARITH  (r9v3 float) = (wrap: float : 0x004f: AGET  (r9v2 float) = (r0v4 'v' float[] A[D('v' float[])]), (0 ??[int, short, byte, char])) / (r6v10 'sum' float A[D('sum' float)]))
         */

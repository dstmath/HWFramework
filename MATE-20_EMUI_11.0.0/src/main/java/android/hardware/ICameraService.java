...
public interface ICameraService extends IInterface {
    ...
    int getRequestQueueSize() throws RemoteException;
    ...
    public static class Default implements ICameraService {
        ...
        @Override // android.hardware.ICameraService
        public int getRequestQueueSize() throws RemoteException {
            return 0;
        }
    ...
    public static abstract class Stub extends Binder implements ICameraService {
        ...
        static final int TRANSACTION_getRequestQueueSize = 19;
        static final int TRANSACTION_isHiddenPhysicalCamera = 13;
        static final int TRANSACTION_isLightStrapCaseOn = 20;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 19:
                        data.enforceInterface(DESCRIPTOR);
                        int _result11 = getRequestQueueSize();
                        reply.writeNoException();
            ...
            public int getRequestQueueSize() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(19, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getRequestQueueSize();
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();

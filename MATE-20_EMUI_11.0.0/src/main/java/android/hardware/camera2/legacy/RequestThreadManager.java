            ...
            if (i == 1) {
                ...
                if (nextBurst == null) {
                    try {
                        ...
                        Log.e(RequestThreadManager.this.TAG, "Interrupted while waiting for requests to complete: ", e6);
                        RequestThreadManager.this.mDeviceState.setError(1);
                        return true;
                    }
                }
                    ...
                    if (RequestThreadManager.this.mLastRequest == null || RequestThreadManager.this.mLastRequest.captureRequest != request) {
                        ...
                        if (!RequestThreadManager.this.mParams.same(legacyRequest.parameters)) {
                            try {
                                ...
                                startTime = startTime2;
                                Log.e(RequestThreadManager.this.TAG, "Exception while setting camera parameters: ", e7);
                                holder.failRequest();
                                ...
                                try {
                                    ...
                                    if (paramsChanged) {
                                        try {
                                            ...
                                            Log.e(RequestThreadManager.this.TAG, "Received device exception: ", e14);
                                            RequestThreadManager.this.mDeviceState.setError(1);
                                        }
                                    }
                ...
                try {
                    ...
                    Log.e(RequestThreadManager.this.TAG, "Interrupted while waiting for requests to complete: ", e26);
                    RequestThreadManager.this.mDeviceState.setError(1);
                }

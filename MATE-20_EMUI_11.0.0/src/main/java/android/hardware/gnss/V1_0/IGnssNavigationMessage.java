...
public interface IGnssNavigationMessage extends IBase {
    ...
    public static final class Proxy implements IGnssNavigationMessage {
        ...
        @Override // android.hardware.gnss.V1_0.IGnssNavigationMessage, android.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IGnssNavigationMessage {
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                int _hidl_out_initRet = setCallback(IGnssNavigationMessageCallback.asInterface(_hidl_request.readStrongBinder()));

...
public class AudioTrack extends PlayerBase implements AudioRouting, VolumeAutomation {
    ...
    public class StreamEventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            LinkedList<StreamEventCbInfo> cbInfoList;
            ...
            try {
                ...
                while (it.hasNext()) {
                    StreamEventCbInfo cbi = it.next();
                    int i = msg.what;
                    if (i == 6) {
                        cbi.mStreamEventExec.execute(new Runnable(cbi) {
                            /* class android.media.$$Lambda$AudioTrack$StreamEventHandler$uWnWUbk1g3MhAY3NoSFc6o37wsk */
                            ...
                            public final void run() {
                                AudioTrack.StreamEventHandler.this.lambda$handleMessage$1$AudioTrack$StreamEventHandler(this.f$1);
                            }
                        });
                    } else if (i == 7) {
                        cbi.mStreamEventExec.execute(new Runnable(cbi) {
                            /* class android.media.$$Lambda$AudioTrack$StreamEventHandler$3NLz6Sbq0z_YUytzGW6tVjPCao */
                            private final /* synthetic */ AudioTrack.StreamEventCbInfo f$1;
                            ...
                            @Override // java.lang.Runnable
                            public final void run() {
                                AudioTrack.StreamEventHandler.this.lambda$handleMessage$2$AudioTrack$StreamEventHandler(this.f$1);
                            }
                        });
                    } else if (i == 9) {
                        cbi.mStreamEventExec.execute(new Runnable(cbi, msg) {
                            /* class android.media.$$Lambda$AudioTrack$StreamEventHandler$IUDediua4qA5AgKwU3zNCXA7jQo */
                            private final /* synthetic */ AudioTrack.StreamEventCbInfo f$1;
                            ...
                            @Override // java.lang.Runnable
                            public final void run() {
                                AudioTrack.StreamEventHandler.this.lambda$handleMessage$0$AudioTrack$StreamEventHandler(this.f$1, this.f$2);
                            }
                        });
                    }
                }

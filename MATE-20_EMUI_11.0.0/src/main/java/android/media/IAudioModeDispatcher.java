...
public interface IAudioModeDispatcher extends IInterface {
    void dispatchAudioModeChange(int i) throws RemoteException;

    public static class Default implements IAudioModeDispatcher {
        @Override // android.media.IAudioModeDispatcher
        public void dispatchAudioModeChange(int audioMode) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IAudioModeDispatcher {
        private static final String DESCRIPTOR = "android.media.IAudioModeDispatcher";
        static final int TRANSACTION_dispatchAudioModeChange = 1;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            ...
            return "dispatchAudioModeChange";
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code == 1) {
                ...
                dispatchAudioModeChange(data.readInt());
                return true;
            ...
            public void dispatchAudioModeChange(int audioMode) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(1, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        ...
                        Stub.getDefaultImpl().dispatchAudioModeChange(audioMode);
                    }
                } finally {
                    _data.recycle();
                }

...
public class Equalizer extends AudioEffect {
    ...
    /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x0041: APUT  (r3v1 'param' int[] A[D('param' int[])]), (1 ??[boolean, int, float, short, byte, char]), (r4v2 'i' int A[D('i' int)]) */

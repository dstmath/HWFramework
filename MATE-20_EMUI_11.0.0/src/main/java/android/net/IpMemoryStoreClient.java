...
public abstract class IpMemoryStoreClient {
    ...
    static /* synthetic */ void lambda$storeNetworkAttributes$0(IIpMemoryStore service, String l2Key, NetworkAttributes attributes, OnStatusListener listener) throws RemoteException {
        service.storeNetworkAttributes(l2Key, attributes.toParcelable(), OnStatusListener.toAIDL(listener));
    }

    static /* synthetic */ void lambda$storeNetworkAttributes$2(OnStatusListener listener) throws RemoteException {
    ...
    static /* synthetic */ void lambda$storeBlob$3(IIpMemoryStore service, String l2Key, String clientId, String name, Blob data, OnStatusListener listener) throws RemoteException {
    ...
    static /* synthetic */ void lambda$isSameNetwork$9(IIpMemoryStore service, String l2Key1, String l2Key2, OnSameL3NetworkResponseListener listener) throws RemoteException {

...
public final class MacAddress implements Parcelable {
    ...
    private static final long LOCALLY_ELI_ASSIGNED_MASK = fromString("4:0:0:0:0:0").mAddr;
    private static final long LOCALLY_SAI_ASSIGNED_MASK = fromString("8:0:0:0:0:0").mAddr;
    ...
    public static MacAddress createRandomUnicastAddress() {
        return new MacAddress(((new SecureRandom().nextLong() & VALID_LONG_MASK & (~LOCALLY_SAI_ASSIGNED_MASK) & (~LOCALLY_ELI_ASSIGNED_MASK)) | LOCALLY_ASSIGNED_MASK) & (~MULTICAST_MASK));
    }

    public static MacAddress createRandomUnicastAddress(MacAddress base, Random r) {
        return new MacAddress(((((base.mAddr & OUI_MASK) | (NIC_MASK & r.nextLong())) & (~LOCALLY_SAI_ASSIGNED_MASK) & (~LOCALLY_ELI_ASSIGNED_MASK)) | LOCALLY_ASSIGNED_MASK) & (~MULTICAST_MASK));
    }

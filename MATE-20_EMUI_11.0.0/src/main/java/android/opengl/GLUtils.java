...
public final class GLUtils {
    ...
    private static native int native_texImage2D(int i, int i2, int i3, long j, int i4, int i5);
    ...
    public static void texImage2D(int target, int level, int internalformat, Bitmap bitmap, int border) {
        if (bitmap == null) {
            ...
            throw new IllegalArgumentException("bitmap is recycled");
        } else if (native_texImage2D(target, level, internalformat, bitmap.getNativeInstance(), -1, border) != 0) {
    ...
    public static void texImage2D(int target, int level, int internalformat, Bitmap bitmap, int type, int border) {
        if (bitmap == null) {
            ...
            throw new IllegalArgumentException("bitmap is recycled");
        } else if (native_texImage2D(target, level, internalformat, bitmap.getNativeInstance(), type, border) != 0) {
            throw new IllegalArgumentException("invalid Bitmap format");
        }
    }
    ...
    public static void texImage2D(int target, int level, Bitmap bitmap, int border) {
        if (bitmap == null) {
            ...
            throw new IllegalArgumentException("bitmap is recycled");
        } else if (native_texImage2D(target, level, -1, bitmap.getNativeInstance(), -1, border) != 0) {
            throw new IllegalArgumentException("invalid Bitmap format");
        }
    }
    ...
    public static void texSubImage2D(int target, int level, int xoffset, int yoffset, Bitmap bitmap, int format, int type) {
        if (bitmap == null) {
            ...
            throw new IllegalArgumentException("bitmap is recycled");
        } else if (native_texSubImage2D(target, level, xoffset, yoffset, bitmap.getNativeInstance(), format, type) != 0) {
            throw new IllegalArgumentException("invalid Bitmap format");
        }
    }

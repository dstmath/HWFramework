...
public abstract class VibrationEffect implements Parcelable {
    ...
    public void setType(String type) {
        this.mVibrateType = type;
    }

    public static VibrationEffect createWaveformType(long[] timings, String type) {
        VibrationEffect effect = createWaveform(timings, -1);
        effect.mVibrateType = type;
        return effect;
    }

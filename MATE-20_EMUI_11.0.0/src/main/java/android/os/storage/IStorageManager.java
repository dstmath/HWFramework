            ...
            if (code == 1) {
                ...
                switch (code) {
                    ...
                    case 601:
                        ...
                        createUserKeyISec(_arg02, _arg13, _arg1);
                        reply.writeNoException();
                        return true;
                    case 602:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    default:
                        switch (code) {
                            case 22:
                                ...
                                mountObb(_arg03, _arg14, _arg2, _arg3, _arg4, _arg5);
                                reply.writeNoException();
                                return true;
                            case 23:
                                data.enforceInterface(DESCRIPTOR);
                                ...
                                unmountObb(_arg04, _arg1, IObbActionListener.Stub.asInterface(data.readStrongBinder()), data.readInt());
                                reply.writeNoException();
                                return true;
                            case 24:
                                data.enforceInterface(DESCRIPTOR);

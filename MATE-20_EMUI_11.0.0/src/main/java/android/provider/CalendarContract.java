...
public final class CalendarContract {
    ...
    public static final class CalendarAlerts implements BaseColumns, CalendarAlertsColumns, EventsColumns, CalendarColumns {
        ...
        public static final void rescheduleMissedAlarms(ContentResolver cr, Context context, AlarmManager manager) {
            ...
            Cursor cursor = cr.query(CONTENT_URI, new String[]{CalendarAlertsColumns.ALARM_TIME}, WHERE_RESCHEDULE_MISSED_ALARMS, new String[]{Long.toString(now), Long.toString(now - 86400000), Long.toString(now)}, SORT_ORDER_ALARMTIME_ASC);
            if (cursor != null) {
                long alarmTime = -1;

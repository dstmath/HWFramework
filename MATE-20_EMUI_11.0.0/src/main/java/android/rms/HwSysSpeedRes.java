        ...
        if (this.mResourceFlowControl.checkSpeedOverload(id, threshold, loopInterval)) {
            ...
            if (this.mOverloadPeriod >= maxPeriod) {
                ...
                if (this.mResourceFlowControl.isReportTime(id, loopInterval, this.mPreReportTime, totalTimeInterval) || this.mResourceType == 18) {
                    ...
                    mapParam.put("uid", Integer.valueOf(callingUid));
                    mapParam.put("pkg", pkg);
                    mapParam.put("resourceType", Integer.valueOf(this.mResourceType));
                    mapParam.put("overloadNum", Integer.valueOf(this.mOverloadNumber));
                    mapParam.put("speedOverLoadPeriod", Integer.valueOf(this.mOverloadPeriod));
                    mapParam.put("totalNum", Integer.valueOf(countInPeriod));

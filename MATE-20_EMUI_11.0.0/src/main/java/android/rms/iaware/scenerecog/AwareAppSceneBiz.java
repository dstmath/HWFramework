...
public class AwareAppSceneBiz implements AwareAppDataBiz.IAwareAppSceneBiz {
    private static final boolean SCENE_RECOG_SWITCH = SystemPropertiesEx.getBoolean("persist.sys.iaware.appscenerecog.switch", false);
    ...
    public void initAppSceneBiz(Context context) {
        ...
        disable();
        if (UserHandleEx.getAppId(Process.myUid()) < 10000 || !SCENE_RECOG_SWITCH) {
            return;
        }

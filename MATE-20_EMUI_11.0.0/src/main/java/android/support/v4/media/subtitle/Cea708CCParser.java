        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    case 159:
                        int pos14 = pos + 6;
                        emitCaptionEvent(new CaptionEvent(16, new CaptionWindow(this.mCommand - 152, (data[pos] & 32) != 0, (data[pos] & 16) != 0, (data[pos] & 8) != 0, data[pos] & 7, (data[pos + 1] & 128) != 0, data[pos + 1] & Byte.MAX_VALUE, data[pos + 2] & 255, (data[pos + 3] & 240) >> 4, 15 & data[pos + 3], data[pos + 4] & 63, 7 & data[pos + 5], (data[pos + 5] & 56) >> 3)));
                        return pos14;
                }
        }
        return pos;

            ...
            if (isBlockingFetch) {
                ...
                synchronized (sLock) {
                    ...
                    sBackgroundThread.postAndReply(r2, new SelfDestructiveThread.ReplyCallback<TypefaceResult>() {
                        ...
                        public void onReply(TypefaceResult typeface) {
                            ArrayList<SelfDestructiveThread.ReplyCallback<TypefaceResult>> replies;
                            synchronized (FontsContractCompat.sLock) {
                                replies = FontsContractCompat.sPendingReplies.get(id);
                                if (replies != null) {
        ...
        try {
            ...
            if (cursor2 != null && cursor2.getCount() > 0) {
                ...
                while (cursor2.moveToNext()) {
                    ...
                    result.add(new FontInfo(fileUri, ttcIndex, weightColumnIndex != -1 ? cursor2.getInt(weightColumnIndex) : Version.DTCP_VER_400, italicColumnIndex != -1 && cursor2.getInt(italicColumnIndex) == 1, resultCode));
                    i = 0;
                }
            }

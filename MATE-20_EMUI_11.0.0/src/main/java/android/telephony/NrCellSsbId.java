...
public class NrCellSsbId implements Parcelable {
    ...
    public String toString() {
        String str;
        synchronized (this) {
            str = "[arfcn: **, cid: **, pci: **, rsrp: " + this.mRsrp + ", sinr: " + this.mSinr + ", timeAdvance: **, ssbCellSsbList: " + this.mSsbCellSsbList + ", nbCellCount: " + this.mNbCellCount + ", nbCellSsbList: " + this.mNbCellSsbList + "]";
        }
        return str;
    }

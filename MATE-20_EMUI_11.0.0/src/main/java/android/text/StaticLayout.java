...
public class StaticLayout extends Layout {
    ...
    /* JADX INFO: Multiple debug info for r12v6 android.graphics.text.LineBreaker: [D('lineBreaker' android.graphics.text.LineBreaker), D('firstWidthLineCount' int)] */
    /* JADX INFO: Multiple debug info for r2v10 'fm'  android.graphics.Paint$FontMetricsInt: [D('spanStart' int), D('fm' android.graphics.Paint$FontMetricsInt)] */
    /* JADX INFO: Multiple debug info for r1v9 'bufEnd'  int: [D('bufEnd' int), D('paraStart' int)] */
    ...
    /* JADX INFO: Multiple debug info for r22v5 int: [D('fmDescent' int), D('fmBottom' int)] */
    ...
    /* JADX INFO: Multiple debug info for r3v25 float[]: [D('ascents' float[]), D('descents' float[])] */
    /* JADX INFO: Multiple debug info for r3v26 boolean[]: [D('hasTabs' boolean[]), D('descents' float[])] */
    /* access modifiers changed from: package-private */
    ...
    public void generate(Builder b, boolean includepad, boolean trackpad) {
        ...
        if (source4 instanceof PrecomputedText) {
            ...
            int checkResult = precomputed.checkResultUsable(bufStart3, bufEnd, textDir3, paint3, b.mBreakStrategy, b.mHyphenationFrequency);
            if (checkResult != 0) {
                if (checkResult == 1) {
        ...
        if (paragraphInfo3 == null) {
            paragraphInfo = PrecomputedText.createMeasuredParagraphs(source4, new PrecomputedText.Params(paint3, textDir3, b.mBreakStrategy, b.mHyphenationFrequency), bufStart3, bufEnd, false);
        } else {
        ...
        while (true) {
            ...
            int paraStart2 = paraIndex == 0 ? bufStart3 : paragraphInfo[paraIndex - 1].paragraphEnd;
            ...
            if (spanned5 != null) {
                LeadingMarginSpan[] sp = (LeadingMarginSpan[]) getParagraphSpans(spanned5, paraStart2, paraEnd, LeadingMarginSpan.class);
                textDir2 = textDir3;
                ...
                bufStart2 = bufStart3;
                source3 = source4;
                LineHeightSpan[] chooseHt2 = (LineHeightSpan[]) getParagraphSpans(spanned5, paraStart2, paraEnd, LineHeightSpan.class);
            ...
            if (spanned5 != null) {
                TabStopSpan[] spans = (TabStopSpan[]) getParagraphSpans(spanned5, paraStart2, paraEnd, TabStopSpan.class);
                if (spans.length > 0) {
                    ...
                    while (spanStart < paraEnd) {
                        ...
                        while (true) {
                            ...
                            fmTop = fmTop2;
                            if (paraStart2 + breaks[breakIndex] >= spanStart) {
                                break;
                            }
                            breakIndex++;
                            fmTop2 = fmTop;
                        ...
                        int fmBottom4 = fmBottom2;
                        int here = breakIndex2;
                        int v3 = v2;
                        int fmTop3 = fmTop;
                        int fmDescent2 = fmDescent;
                        while (fmAscent4 < breakCount2 && breaks[fmAscent4] + paraStart2 <= spanEnd) {
                            int endPos = paraStart2 + breaks[fmAscent4];
                            boolean moreChars = endPos < bufEnd ? z : fmBottom3;
                            ...
                            if (fallbackLineSpacing) {
                                fmAscent = spanEnd2;
                                fmAscent2 = Math.max(fmDescent2, Math.round(descents[fmAscent4]));
                            } else {
                                fmAscent = spanEnd2;
                                fmAscent2 = fmDescent2;
                            }
                            v3 = out(source3, here, endPos, ascent, fmAscent2, fmTop3, fmBottom4, v3, spacingmult, spacingadd, chooseHt, chooseHtv2, fm5, hasTabs[fmAscent4], hyphenEdits[fmAscent4], needMultiply, measuredPara, bufEnd, includepad, trackpad, addLastLineSpacing, chs, paraStart2, ellipsize2, ellipsizedWidth3, lineWidths[fmAscent4], paint2, moreChars);
                            if (endPos < spanEnd) {
                                fm3 = fm5;
                                fmTop3 = fm3.top;
                                fmBottom4 = fm3.bottom;
                                fmBottom = fm3.ascent;
                                fmDescent2 = fm3.descent;
                            } else {
                                fm3 = fm5;
                                fmBottom = fmBottom3;
                                fmDescent2 = fmBottom3;
                                fmBottom4 = fmBottom3;
                                fmTop3 = fmBottom3;
                            }
                            here = endPos;
        ...
        if (paraStart != bufStart) {
            source2 = source;
            if (source2.charAt(paraStart - 1) != '\n') {
                return;
            }
        } else {
            source2 = source;
        ...
        if (staticLayout.mLineCount < staticLayout.mMaximumVisibleLineCount) {
            MeasuredParagraph measuredPara3 = MeasuredParagraph.buildForBidi(source2, paraStart, paraStart, textDir, null);
            paint.getFontMetricsInt(fm2);
            out(source2, paraStart, paraStart, fm2.ascent, fm2.descent, fm2.top, fm2.bottom, v, spacingmult, spacingadd, null, null, fm2, false, 0, needMultiply, measuredPara3, paraStart, includepad, trackpad, addLastLineSpacing, null, bufStart, ellipsize, ellipsizedWidth, 0.0f, paint, false);
        }
    }

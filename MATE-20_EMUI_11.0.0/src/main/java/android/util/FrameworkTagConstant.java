...
public class FrameworkTagConstant {
    ...
    public static final String getModuleTagStr(int moduleTag) {
        int subModuleIndex = moduleTag % 100;
        switch (FWK_MODULE.values()[moduleTag / 100]) {
            case FWK:
                return FWK_TAG;
            case AM:
                String[] strArr = AM_MODULE_TAG;
                if (subModuleIndex < strArr.length) {
                    return strArr[subModuleIndex];
                }
                return null;
            case PM:
                String[] strArr2 = PM_MODULE_TAG;
                if (subModuleIndex < strArr2.length) {
                    return strArr2[subModuleIndex];
                }
                return null;
            case WM:
                String[] strArr3 = WM_MODULE_TAG;
                if (subModuleIndex < strArr3.length) {
                    return strArr3[subModuleIndex];
                }
                return null;
            case NM:
                String[] strArr4 = NM_MODULE_TAG;
                if (subModuleIndex < strArr4.length) {
                    return strArr4[subModuleIndex];
                }
                return null;
            case ALARM:
                String[] strArr5 = ALARM_MODULE_TAG;
                if (subModuleIndex < strArr5.length) {
                    return strArr5[subModuleIndex];
                }
                return null;
            case POWER:
                String[] strArr6 = POWER_MODULE_TAG;
                if (subModuleIndex < strArr6.length) {
                    return strArr6[subModuleIndex];
                }
                return null;
            case DEAMON:
                String[] strArr7 = DEAMON_MODULE_TAG;
                if (subModuleIndex < strArr7.length) {
                    return strArr7[subModuleIndex];
                }
                return null;
            case SERVICES:
                String[] strArr8 = SERVICES_MODULE_TAG;
                if (subModuleIndex < strArr8.length) {
                    return strArr8[subModuleIndex];
                }
                return null;
            case USERS:
                String[] strArr9 = USERS_MODULE_TAG;
                if (subModuleIndex < strArr9.length) {
                    return strArr9[subModuleIndex];
                }
                return null;
            case STORAGE:
                String[] strArr10 = STORAGE_MODULE_TAG;
                if (subModuleIndex < strArr10.length) {
                    return strArr10[subModuleIndex];
                }
                return null;
            case SENSOR:
                String[] strArr11 = SENSOR_MODULE_TAG;
                if (subModuleIndex < strArr11.length) {
                    return strArr11[subModuleIndex];
                }
                return null;
            case VIEW:
                String[] strArr12 = VIEW_MODULE_TAG;
                if (subModuleIndex < strArr12.length) {
                    return strArr12[subModuleIndex];
                }
                return null;
            case SECURITY:
                String[] strArr13 = SECURITY_MODULE_TAG;
                if (subModuleIndex < strArr13.length) {
                    return strArr13[subModuleIndex];
                }
                return null;
            case ANIMATION:
                String[] strArr14 = ANIMATION_MODULE_TAG;
                if (subModuleIndex < strArr14.length) {
                    return strArr14[subModuleIndex];
                }
                return null;
            case INPUT:
                String[] strArr15 = INPUT_MODULE_TAG;
                if (subModuleIndex < strArr15.length) {
                    return strArr15[subModuleIndex];
                }
                return null;
            case POWERONOFF:
                String[] strArr16 = POWERONOFF_MODULE_TAG;
                if (subModuleIndex < strArr16.length) {
                    return strArr16[subModuleIndex];
                }
                return null;
            case USM:
                String[] strArr17 = USM_MODULE_TAG;
                if (subModuleIndex < strArr17.length) {
                    return strArr17[subModuleIndex];
                }
                return null;
            default:
                return null;

...
public class GestureDetector {
    ...
    private float mCurrentDownRawX;
    private float mCurrentDownRawY;
    private long mCurrentDownTime;
    private MotionEvent mCurrentMotionEvent;
    private float mCurrentMotionRawX;
    private float mCurrentMotionRawY;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        this.mCurrentMotionRawX = ev.getRawX();
        this.mCurrentMotionRawY = ev.getRawY();
        ...
        if (i2 == 0) {
            ...
            this.mCurrentDownRawX = ev.getRawX();
            this.mCurrentDownRawY = ev.getRawY();
            this.mCurrentDownTime = ev.getDownTime();
    ...
    private void recordGestureClassification(int classification) {
        if (!this.mHasRecordedClassification && classification != 0) {
            ...
            StatsLog.write(177, getClass().getName(), classification, (int) (SystemClock.uptimeMillis() - this.mCurrentDownTime), (float) Math.hypot((double) (this.mCurrentMotionRawX - this.mCurrentDownRawX), (double) (this.mCurrentMotionRawY - this.mCurrentDownRawY)));
            this.mHasRecordedClassification = true;
        }
    }
}

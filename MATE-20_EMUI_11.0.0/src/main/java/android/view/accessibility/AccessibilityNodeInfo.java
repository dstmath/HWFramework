...
public class AccessibilityNodeInfo implements Parcelable {
    ...
    /* JADX INFO: Multiple debug info for r6v12 int: [D('nonStandardActionCount' int), D('fieldIndex' int)] */
    ...
    private void initFromParcel(Parcel parcel) {
        ...
        int fieldIndex31 = fieldIndex30 + 1;
        this.mExtraDataKeys = BitUtils.isBitSet(nonDefaultFields, fieldIndex30) ? parcel.createStringArrayList() : null;
        int fieldIndex32 = fieldIndex31 + 1;
        this.mExtras = BitUtils.isBitSet(nonDefaultFields, fieldIndex31) ? parcel.readBundle() : null;
        RangeInfo rangeInfo = this.mRangeInfo;
        if (rangeInfo != null) {
            rangeInfo.recycle();
        }
        int fieldIndex33 = fieldIndex32 + 1;
        this.mRangeInfo = BitUtils.isBitSet(nonDefaultFields, fieldIndex32) ? RangeInfo.obtain(parcel.readInt(), parcel.readFloat(), parcel.readFloat(), parcel.readFloat()) : null;

...
public final class GenerateLinksLogger {
    ...
    private static void debugLog(LogMaker log) {
        if (Log.ENABLE_FULL_LOGGING) {
            Log.v(LOG_TAG, String.format(Locale.US, "%s:%s %d links (%d/%d chars) %dms %s", Objects.toString(log.getTaggedData(1319), ""), Objects.toString(log.getTaggedData(1318), "ANY_ENTITY"), Integer.valueOf(Integer.parseInt(Objects.toString(log.getTaggedData(1316), "0"))), Integer.valueOf(Integer.parseInt(Objects.toString(log.getTaggedData(1317), "0"))), Integer.valueOf(Integer.parseInt(Objects.toString(log.getTaggedData(1315), "0"))), Integer.valueOf(Integer.parseInt(Objects.toString(log.getTaggedData(1314), "0"))), log.getPackageName()));
        }
    }

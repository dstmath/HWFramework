...
public final class SelectionActionModeHelper {
    ...
    public static final class SelectionMetricsLogger {
        ...
        private static TextClassifierEvent generateTranslateEvent(int eventType, TextClassification classification, TextClassificationContext classificationContext, String actionLabel) {
            ...
            return ((TextClassifierEvent.LanguageDetectionEvent.Builder) ((TextClassifierEvent.LanguageDetectionEvent.Builder) ((TextClassifierEvent.LanguageDetectionEvent.Builder) ((TextClassifierEvent.LanguageDetectionEvent.Builder) ((TextClassifierEvent.LanguageDetectionEvent.Builder) ((TextClassifierEvent.LanguageDetectionEvent.Builder) new TextClassifierEvent.LanguageDetectionEvent.Builder(eventType).setEventContext(classificationContext)).setResultId(classification.getId())).setEntityTypes(strArr)).setScores(ExtrasUtils.getScore(foreignLanguageExtra))).setActionIndices(classification.getActions().indexOf(translateAction))).setModelName(ExtrasUtils.getModelName(foreignLanguageExtra))).build();
        }
    }

...
public class DecorView extends FrameLayout implements RootViewSurfaceTaker, WindowCallbacks {
    ...
    public void onScaleFreeFrom(int state) {
        ...
        if (oriActivity != null) {
            ...
            if (!isFullScreen && !oriActivity.isTaskRoot()) {
    ...
    private DecorCaptionView createDecorCaptionView(LayoutInflater inflater) {
        ...
        boolean isCaptionNeeded = !this.mWindow.isFloating() && isApplication && ((winConfig.hasWindowDecorCaption() || (i2 = this.mWindowMode) == 5 || WindowConfiguration.isHwMultiStackWindowingMode(i2)) && (i = this.mWindowMode) != 1 && i != 103);
    ...
    private void updateElevation() {
        ...
        if ((windowingMode == 5 || this.mWindowMode == 5) && !isResizing()) {
            ...
            elevation = dipToPx(5.0f);
            this.mElevationAdjustedForStack = true;
        } else if (!WindowConfiguration.isHwFreeFormWindowingMode(this.mWindowMode) || WindowConfiguration.isHwPCFreeFormWindowingMode(this.mWindowMode) || this.isSlashScreen) {
            this.mElevationAdjustedForStack = false;
        } else {
        ...
        } else if (!this.mWindow.windowIsTranslucent()) {

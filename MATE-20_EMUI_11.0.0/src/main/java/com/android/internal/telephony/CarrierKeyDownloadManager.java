...
public class CarrierKeyDownloadManager extends Handler {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null && intent.getAction() != null) {
                ...
                if (action.equals(CarrierKeyDownloadManager.INTENT_KEY_RENEWAL_ALARM_PREFIX + slotId)) {
                    ...
                    try {
                        CarrierKeyDownloadManager.this.sendMessage(CarrierKeyDownloadManager.this.obtainMessage(1, Long.valueOf(intent.getLongExtra("extra_download_id", 0))));
                    } catch (BadParcelableException e) {
                        Log.e(CarrierKeyDownloadManager.LOG_TAG, "get data error.");
                    } catch (Exception e2) {
                        Log.e(CarrierKeyDownloadManager.LOG_TAG, "may get other Exception.");
                    }
                }
            }
        }
                ...
                if (8 == cursor.getInt(cursor.getColumnIndex("status"))) {
                    try {
                        ...
                        try {
                            ...
                            Log.e(LOG_TAG, "IOException in download.");
                        }
                    } catch (Exception e2) {
    ...
    private static String convertToString(InputStream is) {
        try {
            ...
            Log.d(LOG_TAG, "convertToString catch ioException.");
            return null;
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:52:0x0150 A[SYNTHETIC, Splitter:B:52:0x0150] */

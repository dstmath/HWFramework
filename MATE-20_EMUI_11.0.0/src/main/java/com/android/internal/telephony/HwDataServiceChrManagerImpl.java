...
public class HwDataServiceChrManagerImpl implements HwDataServiceChrManager {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 1) {
                ...
                onApnChanged();
            } else if (i == HwDataServiceChrManagerImpl.EVENT_APN_CONNECTION_INFO_INTENT) {
    ...
    private boolean isCardReady(Phone phone) {
        ...
        if (subscriptionControllerEx == null) {
            ...
            return false;
        } else if (getSimCardState(phone.getSubId()) == EVENT_APN_CONNECTION_INFO_INTENT) {
            return true;
        } else {
            return false;
        }
    ...
    private void sendBroadcastDelayed(Intent intent, long delayedTimer) {
        ...
        handler.sendMessageDelayed(handler.obtainMessage(EVENT_APN_CONNECTION_INFO_INTENT, intent), delayedTimer);
    }

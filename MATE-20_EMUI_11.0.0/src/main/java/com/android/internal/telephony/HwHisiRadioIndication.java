...
public class HwHisiRadioIndication extends IHisiRadioIndication.Stub {
    ...
    public static SignalStrength convertHwHalSignalStrength(int[] payload, int phoneId) {
        ...
        SignalStrength signalStrength = new SignalStrength(new CellSignalStrengthCdma(payload[4], payload[SIGNAL_STRENGTH_EXCELLENT], payload[6], payload[AS_DS_FLOW_INFO_REPORT_ARRAY_LENGTH], payload[8]), new CellSignalStrengthGsm(payload[0], payload[1], Integer.MAX_VALUE), new CellSignalStrengthWcdma(Integer.MAX_VALUE, Integer.MAX_VALUE, payload[2], Integer.MAX_VALUE, payload[3]), new CellSignalStrengthTdscdma(Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE), new CellSignalStrengthLte(payload[9], payload[10], payload[11], payload[12], payload[13], Integer.MAX_VALUE), new CellSignalStrengthNr());
    ...
    public void hwXpassReselectInfo(RILUnsolMsgPayload payload) {
        int[] resultTemp = processInts(payload);
        Rlog.d(LOG_TAG, "resultTemp[0]=" + resultTemp[0] + "   ,resultTemp[1]=" + resultTemp[1]);
    ...
    private ArrayList<OperatorInfo> convertHwHalOperators(String[] response) {
        ...
        while (index < response.length) {
            try {
                ...
                Rlog.d(LOG_TAG, "convertHwHalOperators is Exception ");
            }
        }
        return operators;
    }

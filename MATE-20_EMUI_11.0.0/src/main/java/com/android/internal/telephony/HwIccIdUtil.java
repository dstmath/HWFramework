...
public class HwIccIdUtil {
    ...
    private static final List<String> MTN_ICCID_ARRAY = new ArrayList(10);
    private static final List<String> MTN_MCCMNC_ARRAY = new ArrayList(10);
    ...
    private static final String PREFIX_MTN_MCC = "655";
    private static final String PREFIX_SMART_MCC = "515";
    private static final List<String> SMART_ICCID_ARRAY = new ArrayList(10);
    private static final List<String> SMART_MCCMNC_ARRAY = new ArrayList(10);
    ...
    private static final String TABLE_OPERATOR_NAME_MTN = "mtn";
    private static final String TABLE_OPERATOR_NAME_SMART = "smart";
    ...
    private static void clearImsiIccidList() {
        ...
        SMART_ICCID_ARRAY.clear();
        MTN_ICCID_ARRAY.clear();
        CU_MCCMNC_ARRAY.clear();
        AIS_MCCMNC_ARRAY.clear();
        SMART_MCCMNC_ARRAY.clear();
        MTN_MCCMNC_ARRAY.clear();
    ...
    private static void loadImsiIccidLocal() {
        ...
        SMART_ICCID_ARRAY.clear();
        SMART_ICCID_ARRAY.add("896303");
        SMART_ICCID_ARRAY.add("896305");
        MTN_ICCID_ARRAY.clear();
        MTN_ICCID_ARRAY.add("892700");
        CT_ICCID_ARRAY.clear();
        ...
        SMART_MCCMNC_ARRAY.clear();
        SMART_MCCMNC_ARRAY.add("51503");
        SMART_MCCMNC_ARRAY.add("51505");
        MTN_MCCMNC_ARRAY.clear();
        MTN_MCCMNC_ARRAY.add("65510");
    }
            ...
            while (true) {
                ...
                if (TABLE_IMSI_ICCID_ENTRY.equalsIgnoreCase(parser.getName())) {
                    ...
                    if (!TextUtils.isEmpty(operator)) {
                        ...
                        } else if (operator.equalsIgnoreCase(TABLE_OPERATOR_NAME_SMART)) {
                            parseImsiIccidElement(imsiArray, iccidArray, SMART_MCCMNC_ARRAY, SMART_ICCID_ARRAY);
                        } else if (operator.equalsIgnoreCase(TABLE_OPERATOR_NAME_MTN)) {
                            parseImsiIccidElement(imsiArray, iccidArray, MTN_MCCMNC_ARRAY, MTN_ICCID_ARRAY);
                        }
                    }
                } else {
                    try {
    ...
    public static boolean isSmart(String inn) {
        String tmpInn = inn;
        if (tmpInn != null && tmpInn.length() >= 7) {
            tmpInn = tmpInn.substring(0, 6);
        }
        return SMART_ICCID_ARRAY.contains(tmpInn);
    }

    public static boolean isCustomByIccid(String inn, String custom) {
        String tmpInn = inn;
        if (tmpInn != null && tmpInn.length() >= 7) {
            tmpInn = tmpInn.substring(0, 6);
        }
        if (TABLE_OPERATOR_NAME_AIS.equalsIgnoreCase(custom)) {
            return AIS_ICCID_ARRAY.contains(tmpInn);
        }
        if (TABLE_OPERATOR_NAME_SMART.equalsIgnoreCase(custom)) {
            return SMART_ICCID_ARRAY.contains(tmpInn);
        }
        if (TABLE_OPERATOR_NAME_MTN.equalsIgnoreCase(custom)) {
            return MTN_ICCID_ARRAY.contains(tmpInn);
        }
        return false;
    }
    ...
    public static boolean isSmartByMccMnc(String mccMnc) {
        String tmpMccMnc = mccMnc;
        if (tmpMccMnc != null && tmpMccMnc.length() > 5) {
            tmpMccMnc = tmpMccMnc.substring(0, 5);
        }
        return SMART_MCCMNC_ARRAY.contains(tmpMccMnc);
    }

    public static boolean isCustomByMccMnc(String mccMnc, String custom) {
        String tmpMccMnc = mccMnc;
        if (tmpMccMnc != null && tmpMccMnc.length() > 5) {
            tmpMccMnc = tmpMccMnc.substring(0, 5);
        }
        ...
        if (TABLE_OPERATOR_NAME_MTN.equalsIgnoreCase(custom)) {
            return MTN_MCCMNC_ARRAY.contains(tmpMccMnc);
        }
        return false;
    }

...
public final class HwVSimServiceStateTracker extends ServiceStateTrackerEx {
    ...
    HwVSimServiceStateTracker(PhoneExt phone, CommandsInterfaceEx ci) {
        ...
        this.mCi.setOnVsimRDH(this.mHandler, (int) EVENT_VSIM_RDH_NEEDED, (Object) null);
        this.mCi.setOnVsimRegPLMNSelInfo(this.mHandler, (int) EVENT_VSIM_PLMN_SELINFO, (Object) null);
        this.mCi.setOnVsimApDsFlowInfo(this.mHandler, (int) EVENT_VSIM_AP_TRAFFIC, (Object) null);
        ...
        this.mHandler.sendMessage(this.mHandler.obtainMessage(EVENT_RPLMNS_STATE_CHANGED));
    ...
    public class HwVsimServiceStateTrackerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case HwVSimServiceStateTracker.EVENT_VSIM_RDH_NEEDED /* 101 */:
                    HwVSimServiceStateTracker.this.log("EVENT_VSIM_RDH_NEEDED");
                    HwVSimServiceStateTracker.this.sendBroadcastRDHNeeded();
                    return;
                case HwVSimServiceStateTracker.EVENT_VSIM_PLMN_SELINFO /* 102 */:
                    handleVsimPlmnSelinfo(msg);
                    return;
                case HwVSimServiceStateTracker.EVENT_VSIM_AP_TRAFFIC /* 103 */:

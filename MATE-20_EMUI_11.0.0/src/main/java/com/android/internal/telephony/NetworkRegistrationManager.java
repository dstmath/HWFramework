...
import com.huawei.internal.telephony.CellularNetworkServiceEx;
...
public class NetworkRegistrationManager extends Handler {
    ...
    public boolean isServiceConnected() {
        if (this.mTransportType != 2) {
            return this.mCellularNetworkService != null;
        }
        ...
        if (onCompleteMessage != null) {
            ...
            try {
                ...
                if (this.mTransportType == 2) {
                    ...
                    CellularNetworkServiceEx.requestNetworkRegistrationInfo(this.mCellularNetworkService, this.mPhone.getPhoneId(), domain, callback);
                }
    ...
    public class NetworkRegStateCallback extends INetworkServiceCallback.Stub {
        ...
        public void onRequestNetworkRegistrationInfoComplete(int result, NetworkRegistrationInfo info) {
            ...
            if (onCompleteMessage == null || onCompleteMessage.getTarget() == null) {
            ...
            onCompleteMessage.getTarget().sendMessageAtFrontOfQueue(onCompleteMessage);
        }
    ...
    private void bindService() {
        ...
        if (TextUtils.isEmpty(packageName)) {
            ...
            try {
                ...
                if (this.mTransportType != 2) {
                    bindCellularService();
                } else if (!this.mPhone.getContext().bindService(intent, this.mServiceConnection, 1)) {
    ...
    private void logd(String msg) {
        ...
        Rlog.i(str, "[" + this.mPhone.getPhoneId() + "] " + msg);
    }
    ...
    private void bindCellularService() {
        this.mCellularNetworkService = new CellularNetworkService();
        CellularNetworkServiceEx.createNetworkServiceProvider(this.mCellularNetworkService, this.mPhone.getPhoneId());
        logd("service CellularNetworkService for transport " + AccessNetworkConstants.transportTypeToString(this.mTransportType) + " is now connected.");
        CellularNetworkServiceEx.registerForNetworkRegistrationInfoChanged(this.mCellularNetworkService, this.mPhone.getPhoneId(), new NetworkRegStateCallback());
        this.mRegStateChangeRegistrants.notifyRegistrants();
    }
}

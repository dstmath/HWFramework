...
public class OperatorInfo implements Parcelable {
    ...
    public OperatorInfo(String operatorAlphaLong, String operatorAlphaShort, String operatorNumeric, State state, int level) {
    ...
    public String toString() {
        return "OperatorInfo " + this.mOperatorAlphaLong + "/" + this.mOperatorAlphaShort + "/" + this.mOperatorNumeric + "/" + this.mRadioTech + "/" + this.mState + "/" + this.mLevel;
    }

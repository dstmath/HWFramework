...
public class RadioConfig extends Handler {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:3:0x0016, code lost:
        r0 = move-exception;
     */
    /* JADX WARNING: Removed duplicated region for block: B:3:0x0016 A[ExcHandler: RemoteException | RuntimeException (r0v11 'e' java.lang.Exception A[CUSTOM_DECLARE]), Splitter:B:5:0x0019] */
    private void updateRadioConfigProxy() {
        try {
            this.mRadioConfigProxy = android.hardware.radio.config.V1_1.IRadioConfig.getService(CommandsInterfaceEx.isNeedRetryGetRadioProxy(PhoneFactory.getDefaultPhone().mContext));
        ...
        try {
            if (this.mRadioConfigProxy == null) {
                try {
                    this.mRadioConfigProxy = IRadioConfig.getService(CommandsInterfaceEx.isNeedRetryGetRadioProxy(PhoneFactory.getDefaultPhone().mContext));
    ...
    public boolean isSetPreferredDataCommandSupported() {
        if (HuaweiTelephonyConfigs.isHisiPlatform() || HwModemCapability.isCapabilitySupport(32) || getRadioConfigProxy(null) == null || !this.mRadioConfigVersion.greaterOrEqual(RADIO_CONFIG_HAL_VERSION_1_1)) {
            return false;
        }
        return true;
    }

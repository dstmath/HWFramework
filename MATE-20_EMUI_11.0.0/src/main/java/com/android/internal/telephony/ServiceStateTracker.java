...
public class ServiceStateTracker extends Handler implements IServiceStateTrackerInner {
        ...
        if (this.mPhone.isPhoneTypeGsm()) {
            ...
            if (combinedRegState == 1 || combinedRegState == 2) {
                ...
                if (!this.mEmergencyOnly || forceDisplayNoService) {
                    plmn4 = Resources.getSystem().getText(17040419).toString();
                    noService2 = true;
                } else {
                    plmn4 = Resources.getSystem().getText(17040030).toString();
                ...
                showPlmn2 = true;
                plmn2 = Resources.getSystem().getText(17040419).toString();
            ...
            if (combinedRegState == 1) {
                plmn = Resources.getSystem().getText(17040419).toString();
    ...
    /* JADX INFO: Multiple debug info for r4v23 int: [D('transport' int), D('hasRegistered' boolean)] */
    /* JADX INFO: Multiple debug info for r7v8 int: [D('hasCssIndicatorChanged' boolean), D('transport' int)] */
    /* JADX WARNING: Code restructure failed: missing block: B:195:0x03a8, code lost:
        if (r43.mNewSS.getRilDataRadioTechnology() == 13) goto L_0x03ad;
     */
    private void pollStateDone() {
        ...
        boolean hasOperatorNumericChanged3;
        boolean hasDeregistered;
        boolean z;
        int[] iArr;
        DcTracker dcTracker;
        int i;
        boolean hasLostMultiApnSupport2;
        ...
        boolean hasLocationChanged2 = !Objects.equals(this.mNewCellIdentity, this.mCellIdentity);
        HwCustGsmServiceStateTracker hwCustGsmServiceStateTracker = this.mHwCustGsmServiceStateTracker;
        if (hwCustGsmServiceStateTracker != null) {
        ...
        if (!(this.mNewSS.getDataRegState() == 0) || !updateCaByCell || isCtVolte) {
            ...
            anyDataRegChanged = anyDataRegChanged2;
            this.mRatRatcheter.ratchet(this.mSS, this.mNewSS, hasLocationChanged2);
        }
        ...
        if (this.mPhone.isPhoneTypeCdmaLte()) {
            ...
            if (!ServiceState.isLte(this.mSS.getRilDataRadioTechnology()) && this.mSS.getRilDataRadioTechnology() != 13) {
                ...
                has4gHandoff = hasNrStateChanged2;
                hasNrStateChanged = this.mNewSS.getRilDataRadioTechnology() < 4 && this.mNewSS.getRilDataRadioTechnology() <= 8;
                hasLostMultiApnSupport = hasAirplaneModeOnChanged2;
                hasAirplaneModeOnChanged = hasMultiApnSupport;
            }
            ...
            hasLostMultiApnSupport = hasAirplaneModeOnChanged2;
            hasAirplaneModeOnChanged = false;
        }
        ...
        while (i3 < length2) {
            ...
            if (hwCustGsmServiceStateTracker3 != null) {
                hasLostMultiApnSupport2 = hasNrStateChanged;
            ...
            hasNrStateChanged = hasLostMultiApnSupport2;
        }
        StringBuilder sb = new StringBuilder();
        ...
        sb.append(hasOperatorNumericChanged2);
        log(sb.toString());
        ...
        while (i4 < length3) {
            ...
            hasCssIndicatorChanged2 = hasCssIndicatorChanged2;
        }
        ...
        if (hasRegistered || hasOperatorNumericChanged2) {
            ...
            if (CLEAR_NITZ_WHEN_REG) {
                hasOperatorNumericChanged3 = hasOperatorNumericChanged2;
    ...
    private String getOperatorNameFromEri() {
        ...
        if (this.mPhone.isPhoneTypeCdma()) {
            ...
            return this.mPhone.getContext().getText(17041158).toString();
            ...
            if (!((this.mUiccController.getUiccCard(getPhoneId()) == null || this.mUiccController.getUiccCard(getPhoneId()).getOperatorBrandOverride() == null) ? false : true) && this.mCi.getRadioState() == 1 && this.mEriManager.isEriFileLoaded() && ((!ServiceState.isLte(this.mSS.getRilVoiceRadioTechnology()) || this.mPhone.getContext().getResources().getBoolean(17891336)) && !this.mIsSubscriptionFromRuim)) {
                ...
                if (this.mSS.getVoiceRegState() == 0) {
                    ...
                    eriText = this.mPhone.getContext().getText(17041158).toString();
                }
            }
            UiccCardApplication uiccCardApplication = this.mUiccApplcation;

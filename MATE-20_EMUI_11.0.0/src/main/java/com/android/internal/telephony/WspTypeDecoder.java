...
public class WspTypeDecoder implements IWspTypeDecoderInner {
    ...
    int mDataLength;
    private IHwWspTypeDecoderEx mHwWspTypeDecoder = HwPartTelephonyFactory.loadFactory(HwPartTelephonyFactory.TELEPHONY_FACTORY_IMPL_NAME).createHwWspTypeDecoderEx(this);
    String mStringValue;
    long mUnsigned32bit;
    @UnsupportedAppUsage
    byte[] mWspData;
    ...
    @Override // com.android.internal.telephony.IWspTypeDecoderInner
    @UnsupportedAppUsage
    ...
    public boolean decodeContentType(int startIndex) {
        ...
        try {
            ...
            if (this.mHwWspTypeDecoder.decodeForConnectwb(startIndex, mediaPrefixLength)) {
                return true;
            }
    ...
    @Override // com.android.internal.telephony.IWspTypeDecoderInner
    public byte[] getWspData() {
        return this.mWspData;
    }

    @Override // com.android.internal.telephony.IWspTypeDecoderInner
    public void setDecodedDataLength(int dataLength) {
    ...
    public byte[] getMacByte() {
        IHwWspTypeDecoderEx iHwWspTypeDecoderEx = this.mHwWspTypeDecoder;
        if (iHwWspTypeDecoderEx != null) {
            return iHwWspTypeDecoderEx.getMacByte();
        }
        return null;
    }
    ...
    public int getSec() {
        IHwWspTypeDecoderEx iHwWspTypeDecoderEx = this.mHwWspTypeDecoder;
        if (iHwWspTypeDecoderEx != null) {
            return iHwWspTypeDecoderEx.getSec();
        }
        return -1;
    }
}

...
public class AccessNetworksManager extends Handler {
    ...
    private static final int[] SUPPORTED_APN_TYPES = {17, 2, 32, 64, 128, 4, ApnSettingHelper.TYPE_EMERGENCY};
    ...
    private String getQualifiedNetworksServicePackageName() {
        String packageName = this.mPhone.getContext().getResources().getString(17039886);

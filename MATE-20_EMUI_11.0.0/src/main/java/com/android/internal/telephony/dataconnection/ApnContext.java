...
public class ApnContext {
    ...
    public boolean isProvisioningApn() {
        ...
        String provisioningApn = this.mPhone.getContext().getResources().getString(17040621);
    ...
    public static int getApnTypeFromNetworkType(int networkType) {
        ...
        if (networkType == 14) {
            return ApnSettingHelper.TYPE_IA;
        }
        if (networkType == 15) {
            return ApnSettingHelper.TYPE_EMERGENCY;
        }
        switch (networkType) {
            case 10:
                return 32;
            ...
            default:
                switch (networkType) {
                    ...
                    case 39:
                        return 65536;
                    case 40:
                        return ApnSettingHelper.TYPE_BIP2;
                    case 41:
                        return 262144;
                    case 42:
                        return 524288;
                    case 43:
                        return ApnSettingHelper.TYPE_BIP5;
                    case 44:
                        return ApnSettingHelper.TYPE_BIP6;
                    case 45:
                        return ApnSettingHelper.TYPE_XCAP;
                    default:
                        switch (networkType) {
                            case 48:
                                return ApnSettingHelper.TYPE_INTERNALDEFAULT;
                            case 49:
                            case 50:
                            case 51:
                            case 52:
                            case 53:
                            case 54:
                                return ApnSettingHelper.TYPE_SNSSAI;
                            default:
                                return 0;
                        }
                }
    ...
    static int getApnTypeFromNetworkRequest(NetworkRequest nr) {
        ...
        if (nc.hasCapability(7)) {
            ...
            apnType = ApnSettingHelper.TYPE_IA;
        }
        ...
        if (nc.hasCapability(9)) {
            ...
            apnType = ApnSettingHelper.TYPE_XCAP;
        }
        if (nc.hasCapability(10)) {
            if (apnType != 0) {
                error = true;
            }
            apnType = ApnSettingHelper.TYPE_EMERGENCY;
        }
        if (nc.hasCapability(23)) {
            if (apnType != 0) {
                error = true;
            }
            apnType = ApnSettingHelper.TYPE_MCX;
        }
        ...
        if (nc.hasCapability(27)) {
            ...
            apnType = ApnSettingHelper.TYPE_BIP2;
        }
        ...
        if (nc.hasCapability(30)) {
            ...
            apnType = ApnSettingHelper.TYPE_BIP5;
        }
        if (nc.hasCapability(31)) {
            if (apnType != 0) {
                error = true;
            }
            apnType = ApnSettingHelper.TYPE_BIP6;
        }
        if (nc.hasCapability(32)) {
            if (apnType != 0) {
                error = true;
            }
            apnType = ApnSettingHelper.TYPE_INTERNALDEFAULT;
        }
        if (IS_NR_SLICES_SUPPORTED && NetworkCapabilities.hasSNSSAICapability(nc)) {
            if (apnType != 0) {
                error = true;
            }
            apnType = ApnSettingHelper.TYPE_SNSSAI;
        }
        if (error) {

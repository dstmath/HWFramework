...
public class DcTracker extends Handler {
    ...
    public class ProvisionNotificationBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            DcTracker.this.mProvisioningSpinner.setMessage(context.getText(17040487));
    ...
    private void onDataSetupComplete(ApnContext apnContext, boolean success, int cause, int requestType) {
        ...
        if (apnContext != null) {
            boolean isDefault2 = TransportManager.IWLAN_OPERATION_MODE_DEFAULT.equals(apnContext.getApnType());
            this.preSetupBasedRadioTech = this.mPhone.getServiceState().getRilDataRadioTechnology();
            ...
            if (success) {
                ...
                if (hwCustDcTracker4 != null && hwCustDcTracker4.isClearCodeEnabled() && isDefault2) {
                ...
                if (this.mHwDcTrackerEx.needSetCTProxy(apn)) {
                    ...
                    try {
                        ...
                        String str2 = this.mProvisionActionName;
                        int i = isDefault ? 1 : 0;
                        int i2 = isDefault ? 1 : 0;
                        int i3 = isDefault ? 1 : 0;
                        cm.setProvisioningNotificationVisible(isDefault, i, str2);
                ...
                String str22 = this.mProvisionActionName;
                int i4 = isDefault ? 1 : 0;
                int i22 = isDefault ? 1 : 0;
                int i32 = isDefault ? 1 : 0;
                cm2.setProvisioningNotificationVisible(isDefault, i4, str22);
                completeConnection(apnContext, requestType);
                log("onDataSetupComplete: SETUP complete type=" + apnContext.getApnType());
                if (Build.IS_DEBUGGABLE) {
                }
    ...
    private void sendErrorEvent(IccRecords r, String operator, boolean hasDefaultApn) {
        if (this.mAllApnSettings.isEmpty()) {
            if (!VSimUtilsInner.isVSimSub(this.mPhone.getPhoneId()) && this.mHwDcTrackerEx.getPrimarySlot() == this.mPhone.getPhoneId() && r != null && r.getRecordsLoaded() && operator.length() != 0) {

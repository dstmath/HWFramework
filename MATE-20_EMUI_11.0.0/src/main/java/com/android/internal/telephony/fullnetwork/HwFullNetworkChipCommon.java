...
public class HwFullNetworkChipCommon {
    ...
    public boolean isCmccHybirdAndNoRoaming() {
        boolean isCmccHybird = HwFullNetworkConfigInner.isCMCCDsdxDisable() && isCmccHybirdBySubCarrierType();
        boolean isRoaming = TelephonyManagerEx.isNetworkRoaming(SubscriptionManagerEx.getSubIdUsingSlotId(getCMCCCardSlotId()));
    ...
    public boolean isAnySimContactLoaded() {
        for (int i = 0; i < HwFullNetworkConstantsInner.SIM_NUM; i++) {

...
public class HwFullNetworkConfig {
    ...
    public static final boolean IS_CT_4GSWITCH_DISABLE = HwTelephonyManagerInner.TAG_MDM_CARRIER_CT.equalsIgnoreCase(SystemPropertiesEx.get("ro.hwpp.dualsim_swap_solution", BuildConfig.FLAVOR));

...
public class HwFullNetworkConfigInner {
    ...
    static {
        boolean z = true;
        if (!HuaweiTelephonyConfigs.isMTKPlatform() || !"normal".equals(SystemPropertiesEx.get("ro.runmode", "normal")) || !SystemPropertiesEx.getBoolean("ro.config.use_user_preference_default_slot", true)) {
            z = false;
        }

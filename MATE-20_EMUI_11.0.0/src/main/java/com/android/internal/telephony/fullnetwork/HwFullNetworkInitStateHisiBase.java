...
public abstract class HwFullNetworkInitStateHisiBase extends HwFullNetworkInitStateBase {
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            case HwFullNetworkConstantsInner.EVENT_ICC_STATUS_CHANGED /* 1001 */:
                logd("Received EVENT_ICC_STATUS_CHANGED on index " + index);
                onIccStatusChanged(index);
                return;
            case HwFullNetworkConstantsInner.EVENT_QUERY_CARD_TYPE_DONE /* 1005 */:
                ...
                return;
            case HwFullNetworkConstantsInner.EVENT_GET_BALONG_SIM_DONE /* 1006 */:
                logd("Received EVENT_GET_BALONG_SIM_DONE on index " + index);
                onGetBalongSimDone(ar, index);
                return;
            case HwFullNetworkConstantsInner.EVENT_SIM_HOTPLUG /* 1008 */:
                logd("Received EVENT_SIM_HOTPLUG on index " + index);
                onSimHotPlug(ar, index);
                return;
            case HwFullNetworkConstantsInner.EVENT_GET_ICCID_DONE /* 1009 */:
                logd("Received EVENT_GET_ICCID_DONE on index " + index);
                onGetIccidDone(ar, index);
                return;
            case HwFullNetworkConstantsInner.EVENT_GET_ICC_STATUS_DONE /* 1012 */:
    ...
    /* JADX WARNING: Removed duplicated region for block: B:24:0x007e A[Catch:{ all -> 0x0071 }] */
    /* JADX WARNING: Removed duplicated region for block: B:30:0x0090 A[Catch:{ all -> 0x0071 }] */

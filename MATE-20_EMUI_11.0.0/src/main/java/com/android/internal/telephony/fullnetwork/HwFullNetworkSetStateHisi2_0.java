...
public class HwFullNetworkSetStateHisi2_0 extends HwFullNetworkSetStateBase {
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case 402:
                ...
                return;
            case HwFullNetworkConstantsInner.EVENT_GET_CDMA_MODE_SIDE_DONE /* 1007 */:
                ...
                return;
            case HwFullNetworkConstantsInner.EVENT_CMCC_SET_NETWOR_DONE /* 1011 */:
                logd("EVENT_CMCC_SET_NETWOR_DONE reveived for slot: " + msg.arg1);
                this.mChipHisi.handleSetCmccPrefNetwork(msg);
                return;
            case HwFullNetworkConstantsInner.EVENT_RESTART_RILD_FOR_NV /* 1013 */:
                logd("Received EVENT_RESTART_RILD_FOR_NV on index " + index);
                restartRildForNvcfg();
                return;
            case HwFullNetworkConstantsInner.EVENT_SWITCH_SLOT_TYPE_DONE /* 2205 */:
                logd("EVENT_SWITCH_SLOT_TYPE_DONE");
                return;
            case HwFullNetworkConstantsInner.EVENT_UNSOL_RESTART_RILD_STATUS /* 2206 */:
    ...
    private void fastSwitchDualCardsSlot(int expectedMainSlotId) {
        ...
        if (this.mChipCommon.isAnySimContactLoaded()) {
            switchSlotType = 2;
        } else {

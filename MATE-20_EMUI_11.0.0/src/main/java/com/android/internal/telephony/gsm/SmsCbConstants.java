...
public class SmsCbConstants {
    ...
    public static final int MESSAGE_ID_CMAS_ALERT_PUBLIC_SAFETY = 4396;
    public static final int MESSAGE_ID_CMAS_ALERT_PUBLIC_SAFETY_LANGUAGE = 4397;
    ...
    public static final int MESSAGE_ID_CMAS_ALERT_STATE_LOCAL_TEST = 4398;
    public static final int MESSAGE_ID_CMAS_ALERT_STATE_LOCAL_TEST_LANGUAGE = 4399;

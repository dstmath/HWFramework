...
public interface IIccRecordsInner {
    ...
    AdnRecordCacheEx getAdnCacheHw();
    ...
    ArrayList<OperatorInfoEx> getEonsForAvailableNetworks(ArrayList<OperatorInfoEx> arrayList);
    ...
    default IVoiceMailConstantsInner getVmConfig() {
        return null;
    }

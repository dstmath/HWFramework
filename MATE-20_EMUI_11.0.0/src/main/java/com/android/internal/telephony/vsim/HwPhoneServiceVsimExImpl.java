...
public class HwPhoneServiceVsimExImpl extends DefaultHwPhoneServiceVsimEx {
    ...
    private void initGetModemSupportVsimVersion() {
        this.mMainHandler.sendMessage(this.mMainHandler.obtainMessage(3, getRadioOnSlotId(), 0));
    }
    ...
    public int getPlatformSupportVsimVer(int what) {
        ...
        switch (what) {
            case 0:
                ...
                break;
            case 1:
                result = FRAMEWORK_SUPPORT_VERSION;
                break;
        }
    ...
    private int getModemSupportVsimVersionInner() {
        ...
        this.mMainHandler.sendMessage(this.mMainHandler.obtainMessage(1, slotId, 0, new MainThreadRequest<>(null, latchForGetVersion, resultForGetVersion)));
    ...
    public String getRegPlmn(int slotId) {
        ...
        if (slotId == 0 || slotId == 1 || slotId == 2) {
            ...
            this.mMainHandler.sendMessage(this.mMainHandler.obtainMessage(5, slotId, 0, new MainThreadRequest<>(null, latchForGetPlmn, resultForGetPlmn)));
    ...
    public void blockingGetVsimService(IGetVsimServiceCallback callback) {
        ...
        log(sb.toString());
        this.mMainHandler.sendMessage(this.mMainHandler.obtainMessage(7, callback));
    }

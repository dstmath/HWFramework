...
public class BluetoothManagerService extends IBluetoothManager.Stub implements IHwBluetoothManagerInner {
    ...
    BluetoothManagerService(Context context) {
        ...
        if (packageManagerService != null) {
            this.isFirstBoot = packageManagerService.isFirstBoot();
        }
        this.mIsHearingAidProfileSupported = context.getResources().getBoolean(17891467);
    ...
    private boolean isBluetoothPersistedStateOn() {
        ...
        if (TV_CHARACTERISTICS_PROP_TV_VALUE.equals(SystemProperties.get(CHARACTERISTICS_PROP, "default")) || (this.isWatch && this.isFirstBoot)) {
            return true;
        }
    ...
    public boolean enable(String packageName) throws RemoteException {
        ...
        int callingUid;
        if (!TV_CHARACTERISTICS_PROP_TV_VALUE.equals(SystemProperties.get(CHARACTERISTICS_PROP, "default")) || getState() == 10 || !packageName.equals(HIRMSERVICE_NAME)) {
    ...
    private void sendBleServiceReadyBroadcast() {
        if (TV_CHARACTERISTICS_PROP_TV_VALUE.equals(SystemProperties.get(CHARACTERISTICS_PROP, "default"))) {

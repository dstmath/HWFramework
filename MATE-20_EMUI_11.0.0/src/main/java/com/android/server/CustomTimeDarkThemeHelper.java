...
public class CustomTimeDarkThemeHelper {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (c == 0) {
                ...
                if (CustomTimeDarkThemeHelper.this.mCustomTimeDarkThemeActivated != activated) {
                    ...
                    Slog.d(CustomTimeDarkThemeHelper.TAG, "CustomTimeDarkThemeObserver#onChange: set dark_theme_last_activated_time to null");
                }
                ...
                if (CustomTimeDarkThemeHelper.this.mCurrentDarkThemeMode != mode) {
                    ...
                    Slog.d(CustomTimeDarkThemeHelper.TAG, "CustomTimeDarkThemeObserver#onChange: set dark_theme_last_activated_time to " + now);
    ...
    public void onStarted(Context context, int userHandle) {
        Slog.d(TAG, "onStarted: userHandle=" + userHandle);
    ...
    public void onUserSwitched(Context context, int userHandle) {
        Slog.d(TAG, "onUserSwitched: userHandle=" + userHandle);
        this.mContext = context;
        this.mUserHandle = userHandle;
    ...
    public final class CustomTimeDarkTheme implements AlarmManager.OnAlarmListener {
        ...
        CustomTimeDarkTheme() {
            ...
            this.mTimeChangedReceiver = new BroadcastReceiver(CustomTimeDarkThemeHelper.this) {
                ...
                public void onReceive(Context context, Intent intent) {
                    Slog.d(CustomTimeDarkThemeHelper.TAG, "Time changed: " + intent.getAction());
            ...
            this.mScreenStateChangedReceiver = new BroadcastReceiver(CustomTimeDarkThemeHelper.this) {
                ...
                public void onReceive(Context context, Intent intent) {
                    if (CustomTimeDarkTheme.this.mShouldDelaySwitch) {
                        Slog.d(CustomTimeDarkThemeHelper.TAG, "screen state changed: " + intent.getAction());
        ...
        private void updateActivated() {
            ...
            Slog.d(CustomTimeDarkThemeHelper.TAG, "updateActivated: now=" + now + ", start=" + start + ", end=" + end + ", activated=" + activated + ", mLastActivatedTime=" + this.mLastActivatedTime + ", userHandle=" + CustomTimeDarkThemeHelper.this.mUserHandle + ", mShouldDelaySwitchMode=" + this.mShouldDelaySwitch + ", mNextNightMode=" + this.mNextNightMode);
            if (!this.mShouldDelaySwitch) {
        ...
        private void updateNextAlarm(boolean activated, LocalDateTime now) {
            ...
            Slog.d(CustomTimeDarkThemeHelper.TAG, "updateNextAlarm: activated=" + activated + ", next=" + next);
        }
        ...
        public void onAlarm() {
            Slog.d(CustomTimeDarkThemeHelper.TAG, "onAlarm");
            this.mLastActivatedTime = CustomTimeDarkThemeHelper.this.getDarkThemeLastActivatedTimeSetting();
    ...
    private void onCustomTimeDarkThemeChanged(boolean activited) {
        Slog.d(TAG, "onCustomTimeDarkThemeChanged: activited=" + activited);
    ...
    private void onDarkThemeCustomStartTimeChanged(LocalTime startTime) {
        Slog.d(TAG, "onDarkThemeCustomStartTimeChanged: startTime=" + startTime);
        CustomTimeDarkTheme customTimeDarkTheme = this.mCustomTimeDarkTheme;
        if (customTimeDarkTheme != null) {
    ...
    private void onDarkThemeCustomEndTimeChanged(LocalTime endTime) {
        Slog.d(TAG, "onDarkThemeCustomEndTimeChanged: endTime=" + endTime);
        CustomTimeDarkTheme customTimeDarkTheme = this.mCustomTimeDarkTheme;
        if (customTimeDarkTheme != null) {

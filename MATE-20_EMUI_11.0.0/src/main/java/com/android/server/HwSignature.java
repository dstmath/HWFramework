...
public class HwSignature {
    ...
    private native int sign_check_key();
    ...
    private native int sign_hwmember(int i, byte[] bArr, int i2, byte[] bArr2, int i3, byte[] bArr3, int i4, byte[] bArr4, int i5, byte[] bArr5);

...
public class LocationManagerService extends AbsLocationManagerService {
    ...
    public void lambda$initializeLocked$2$LocationManagerService() {
        ...
        LocationProviderProxy networkProvider = HwServiceFactory.locationProviderProxyCreateAndBind(locationManagerService.mContext, networkProviderManager, NETWORK_LOCATION_SERVICE_ACTION, 17891445, 17039879, 17236033);
        ...
        LocationProviderProxy fusedProvider = LocationProviderProxy.createAndBind(locationManagerService.mContext, fusedProviderManager, FUSED_LOCATION_SERVICE_ACTION, 17891437, 17039852, 17236033);
        ...
        locationManagerService.mGeocodeProvider = HwServiceFactory.geocoderProxyCreateAndBind(locationManagerService.mContext, 17891438, 17039853, 17236033);
        if (locationManagerService.mGeocodeProvider == null) {
            Slog.e(TAG, "no geocoder provider found");
        }
        if (GeofenceProxy.createAndBind(locationManagerService.mContext, 17891439, 17039854, 17236033, locationManagerService.mGpsGeofenceProxy, null) == null) {
        ...
        if (ActivityRecognitionProxy.createAndBind(locationManagerService.mContext, activityRecognitionHardwareIsSupported, activityRecognitionHardware, 17891431, 17039789, 17236033) == null) {

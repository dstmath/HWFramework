...
public class UsbP2pStateMachine extends StateMachine {
    ...
    private class IdleState extends State {
        ...
        public void enter() {
            UsbP2pStateMachine.this.log("Idle state enter.");
            UsbP2pStateMachine.this.updateState(0);
        }

        public boolean processMessage(Message msg) {
            UsbP2pStateMachine usbP2pStateMachine = UsbP2pStateMachine.this;
            usbP2pStateMachine.log("IdleState handle message " + UsbP2pStateMachine.this.cmdToString(msg.what));
            int i = msg.what;
    ...
    private class StartingState extends State {
        ...
        public void enter() {
            UsbP2pStateMachine.this.log("StartingState enter.");
            ...
            if (UsbP2pStateMachine.this.configIface(true)) {
                UsbP2pStateMachine usbP2pStateMachine = UsbP2pStateMachine.this;
                usbP2pStateMachine.transitionTo(usbP2pStateMachine.mP2pState);
            }
        }

        public boolean processMessage(Message msg) {
            UsbP2pStateMachine usbP2pStateMachine = UsbP2pStateMachine.this;
            usbP2pStateMachine.log("StartingState handle message " + UsbP2pStateMachine.this.cmdToString(msg.what));
            switch (msg.what) {
                ...
                case UsbP2pStateMachine.CMD_USB_CONNECTED /* 594026 */:
                    ...
                    usbP2pStateMachine4.transitionTo(usbP2pStateMachine4.mP2pState);
                    return true;
            }
        }
    ...
    private class P2pState extends State {
        ...
        public void enter() {
            UsbP2pStateMachine.this.log("P2pState enter.");
            UsbP2pStateMachine.this.updateState(1);
        }

        public boolean processMessage(Message msg) {
            UsbP2pStateMachine usbP2pStateMachine = UsbP2pStateMachine.this;
            usbP2pStateMachine.log("P2pState handle message " + UsbP2pStateMachine.this.cmdToString(msg.what));
            switch (msg.what) {
                case UsbP2pStateMachine.CMD_P2P_START /* 594021 */:
                    return true;
                case UsbP2pStateMachine.CMD_P2P_STOP /* 594022 */:
    ...
    private class StoppingState extends State {
        ...
        public void enter() {
            UsbP2pStateMachine.this.log("StoppingState enter.");
            UsbP2pStateMachine.this.configIface(false);
            if (UsbP2pStateMachine.this.mCommands.isUsbRndisEnabled()) {
            ...
            UsbP2pStateMachine usbP2pStateMachine = UsbP2pStateMachine.this;
            usbP2pStateMachine.transitionTo(usbP2pStateMachine.mIdleState);
        }
    ...
    private class JointState extends State {
        ...
        public void enter() {
            UsbP2pStateMachine.this.log("JointState enter.");
            UsbP2pStateMachine.this.updateState(2);
        }

        public boolean processMessage(Message msg) {
            UsbP2pStateMachine usbP2pStateMachine = UsbP2pStateMachine.this;
            usbP2pStateMachine.log("JointState handle message " + UsbP2pStateMachine.this.cmdToString(msg.what));
            int i = msg.what;
    ...
    private class TetherState extends State {
        ...
        public void enter() {
            UsbP2pStateMachine.this.log("TetherState enter.");
            UsbP2pStateMachine.this.updateState(2);
        }

        public boolean processMessage(Message msg) {
            UsbP2pStateMachine usbP2pStateMachine = UsbP2pStateMachine.this;
            usbP2pStateMachine.log("TetherState handle message " + UsbP2pStateMachine.this.cmdToString(msg.what));
            int i = msg.what;
            if (i == UsbP2pStateMachine.CMD_P2P_START) {
                UsbP2pStateMachine usbP2pStateMachine2 = UsbP2pStateMachine.this;
    ...
    private boolean configIface(boolean isToUp) {
        String iface = this.mManager.getIfaceName();
        ...
        log("configIface: iface = " + iface + " to " + isToUp + " result = [" + isIpAddressCongiured + "," + isTetherConfigured + "]");

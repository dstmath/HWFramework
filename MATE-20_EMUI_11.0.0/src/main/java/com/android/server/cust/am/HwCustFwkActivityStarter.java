...
public class HwCustFwkActivityStarter {
    ...
    private static final List<String> TASK_LOCK_PKG_WHITE_LIST = Arrays.asList("com.huawei.android.launcher", "com.huawei.systemmanager", HwCustPkgNameConstant.HW_PERMISSION_CONTROLLER_PACKAGE, "com.android.systemui", HwCustPkgNameConstant.HW_HWOUC_PACKAGE, HwCustPkgNameConstant.HW_STARTUP_GUIDE, HwCustPkgNameConstant.HW_UPGRADE_GUIDE, HwCustPkgNameConstant.PACKAGE_INSTALLER);

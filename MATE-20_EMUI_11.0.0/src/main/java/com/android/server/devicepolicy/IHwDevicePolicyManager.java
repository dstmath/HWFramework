...
interface IHwDevicePolicyManager {
    ...
    Bundle getDeviceAdminDeactiveTime(ComponentName componentName, int i);
    ...
    Bundle getEthernetConfiguration(ComponentName componentName, Bundle bundle, int i);
    ...
    Bundle isForcedActiveDeviceAdmin(ComponentName componentName, int i);
    ...
    int removeActiveDeviceAdmin(ComponentName componentName, int i);
    ...
    int setDelayDeactiveDeviceAdmin(ComponentName componentName, Bundle bundle, int i);

    void setDeviceOwnerApp(ComponentName componentName, String str, int i);

    int setEthernetConfiguration(ComponentName componentName, Bundle bundle, int i);

    void setExternalStorageDisabled(ComponentName componentName, boolean z, int i);

    int setForcedActiveDeviceAdmin(ComponentName componentName, int i);

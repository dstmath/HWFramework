...
public class DeviceBluetoothPlugin extends DevicePolicyPlugin {
    ...
    public PolicyStruct getPolicyStruct() {
        ...
        struct.addStruct(BLUETOOTH_BLACK_LIST_ITEM, PolicyStruct.PolicyType.LIST, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct(BLUETOOTH_WHITE_LIST, PolicyStruct.PolicyType.LIST, new String[0]);
        struct.addStruct(BLUETOOTH_WHITE_LIST_ITEM, PolicyStruct.PolicyType.LIST, new String[]{SettingsMDMPlugin.STATE_VALUE});
    ...
    public boolean onSetPolicy(ComponentName who, String policyName, Bundle policyData, boolean isChanged) {
        ...
        switch (c) {
            ...
            case 1:
                if (policyData != null) {
                    notifyBluetoohListPolicyChange(0, policyData.getStringArrayList(SettingsMDMPlugin.STATE_VALUE), policyName);
                    break;
                }
                break;
            case 2:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0077, code lost:
        if (r6.equals(com.android.server.devicepolicy.plugins.DeviceBluetoothPlugin.BLUETOOTH_BLACK_LIST) != false) goto L_0x007b;
     */
    public boolean onRemovePolicy(ComponentName who, String policyName, Bundle policyData, boolean isChanged) {
        ...
        switch (c) {
            ...
            case 1:
                if (policyData != null) {
                    notifyBluetoohListPolicyChange(1, policyData.getStringArrayList(SettingsMDMPlugin.STATE_VALUE), policyName);
                    break;
                }
                break;
            case 2:
            ...
            for (int j = 0; j < k; j++) {
                ...
                if (policyName.equals(BLUETOOTH_BLACK_LIST) || policyName.equals(BLUETOOTH_WHITE_LIST)) {
                    ...
                    for (int i = 0; i < n; i++) {
                        ...
                        notifyBluetoohListPolicyChange(1, oldAttr.getStringArrayList(SettingsMDMPlugin.STATE_VALUE), policyName);
                    }
                    continue;

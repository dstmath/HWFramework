...
public class FrameworkTestPlugin extends DevicePolicyPlugin {
    ...
    public PolicyStruct getPolicyStruct() {
        ...
        struct.addStruct(TEST_CONFIGURATION_LIST, PolicyStruct.PolicyType.CONFIGLIST, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct(TEST_MULTIUSERS, PolicyStruct.PolicyType.STATE, true, new String[]{SettingsMDMPlugin.STATE_VALUE});
        return struct;
    }

...
public class HwEmailMDMPlugin extends DevicePolicyPlugin {
    ...
    public PolicyStruct getPolicyStruct() {
        ...
        struct.addStruct(RESTRICT_DISABLE_DELETE_ACCOUNT, PolicyStruct.PolicyType.STATE, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct(RESTRICT_DISABLE_ADD_ACCOUNT, PolicyStruct.PolicyType.STATE, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct(RESTRICT_DISABLE_IMAP_POP3, PolicyStruct.PolicyType.STATE, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct(RESTRICT_DISABLE_CLEAR_DATA, PolicyStruct.PolicyType.STATE, new String[]{SettingsMDMPlugin.STATE_VALUE});
        ...
        struct.addStruct(DISABLING_ADDITION_WHITE_LIST_ITEM, PolicyStruct.PolicyType.LIST, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct(ALLOWING_ADDITION_BLACK_LIST_ITEM, PolicyStruct.PolicyType.LIST, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct(DISABLING_DELETION_WHITE_LIST_ITEM, PolicyStruct.PolicyType.LIST, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct(ALLOWING_DELETION_BLACK_LIST_ITEM, PolicyStruct.PolicyType.LIST, new String[]{SettingsMDMPlugin.STATE_VALUE});

...
public class PhoneManagerPlugin extends DevicePolicyPlugin {
    ...
    public PolicyStruct getPolicyStruct() {
        ...
        struct.addStruct("disallow-data-roaming", stateType, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct("disallow-access-point-name", stateType, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct("disallow-phone-number-showing", stateType, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct("phone-number-incoming-is-black-list-mode", stateType, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct("phone-number-outgoing-is-black-list-mode", stateType, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct("apply-to-all-incoming-calls", stateType, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct("apply-to-all-outgoing-calls", stateType, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct("disallow-non-emergency-call", stateType, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct("disallow-roaming-call", stateType, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct("disallow-multi-calling", stateType, new String[]{SettingsMDMPlugin.STATE_VALUE});
        ...
        struct.addStruct(PHONE_NUMBER_INCOMING_LIST_ITEM, listType, new String[]{SettingsMDMPlugin.STATE_VALUE});
        struct.addStruct(PHONE_NUMBER_OUTGOING_LIST_ITEM, listType, new String[]{SettingsMDMPlugin.STATE_VALUE});
        ...
        struct.addStruct("call-status-notification-app", configType, new String[]{SettingsMDMPlugin.STATE_VALUE});
        return struct;
    }
    ...
    private void onSetDataRoamingPolicy(Bundle policyData) {
        ...
        boolean isRestrictDataRoaming = policyData.getBoolean(SettingsMDMPlugin.STATE_VALUE, false);
        long callingId = Binder.clearCallingIdentity();

...
public class HwBrightnessBatteryDetection extends BroadcastReceiver {
    ...
    private static final int POWER_SAVE_MODE_BRIGHTNESS_RATIO = SystemProperties.getInt("ro.powersavemode.backlight_ratio", (int) POWER_SAVE_MODE_DEFAULT_BRIGHTNESS_RATIO);

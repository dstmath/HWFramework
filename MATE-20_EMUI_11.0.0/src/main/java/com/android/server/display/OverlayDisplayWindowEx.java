...
public class OverlayDisplayWindowEx {
    ...
    public static class ListenerEx {
        OverlayDisplayWindow.Listener mListener = new OverlayDisplayWindow.Listener() {
            ...
            public void onWindowCreated(SurfaceTexture surfaceTexture, float refreshRate, long presentationDeadlineNanos, int i) {
                ListenerEx.this.onWindowCreated(surfaceTexture, refreshRate, presentationDeadlineNanos, i);
            }

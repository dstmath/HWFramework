...
public class GestureNavView extends SurfaceView {
    ...
    public void lambda$scheduleUpdateExcludeRegion$0$GestureNavView() {
        if (!isAttachedToWindow() || getWindow() == null) {
    ...
    private void updateTapExcludeRegion() {
        ...
        try {
            WindowManagerGlobal.getWindowSession().updateTapExcludeRegion(getWindow(), this.mRegionId, this.mLocalTapExcludeRegion);
    ...
    private void clearTapExcludeRegion() {
        if (!this.mLocalTapExcludeRegion.isEmpty()) {
            ...
            try {
                WindowManagerGlobal.getWindowSession().updateTapExcludeRegion(getWindow(), this.mRegionId, (Region) null);

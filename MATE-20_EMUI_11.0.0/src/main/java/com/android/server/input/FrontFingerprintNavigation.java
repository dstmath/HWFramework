...
public class FrontFingerprintNavigation {
    ...
    private int mVibratorModeLongPressForFrontFp = 16;
    private int mVibratorModeLongPressForHomeFrontFp = 16;
    ...
    private void initDefaultVibrateValue() {
        ...
        this.mVibratorModeLongPressForFrontFp = SystemPropertiesEx.getInt("ro.config.trikey_vibrate_press", 16);
    ...
    private boolean isPad() {
        if (GestureNavConst.DEVICE_TYPE_TABLET.equals(SystemPropertiesEx.get("ro.build.characteristics", ""))) {

...
public class HwInputManagerService extends InputManagerServiceEx {
    ...
    public boolean filterInputEvent(InputEvent event, int policyFlags) {
        ...
        if (stylusGestureListener == null || stylusGestureListener.filterInputEvent(event)) {
    ...
    public final class HwInputManagerLocalService extends InputManagerServiceEx.DefaultHwInputManagerLocalService {
        ...
        public void setStylusGestureListener(StylusGestureListener stylusGestureListener) {
            HwInputManagerService.this.mStylusGestureListener = stylusGestureListener;
            HwInputManagerService.this.setInputFilterEnabled();
        }
    ...
    private boolean checkIsSystemApp() {
        ...
        try {
            ...
            String str5 = TAG;
            SlogEx.e(str5, "isSystemApp not found appexception");
            return false;
        }
    }
    ...
    private void setInputFilterEnabled() {
        synchronized (getInputFilterLock()) {
            if (!this.mIsEnableFingerSnapshot && !this.mIsStartInputEventControl && getInputFilter() == null && this.mTripleFingersFreeForm == null) {

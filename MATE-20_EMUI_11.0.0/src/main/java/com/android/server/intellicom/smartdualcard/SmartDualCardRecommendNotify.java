...
public class SmartDualCardRecommendNotify extends Handler {
    ...
    private String getSmartCardSwitchFirstPromtString(int uid, int lengthOfNoTrafficAppList) {
        ...
        if (lengthOfNoTrafficAppList == 1) {
            return String.format(Locale.ROOT, sContext.getResources().getString(33686231), appName, Integer.valueOf(slaveSlotId), Integer.valueOf(slaveSlotId));
        }
    ...
    private void showAlertDialog(final int uid, int appListSize) {
        ...
        View view = LayoutInflater.from(builder.getContext()).inflate(34013435, (ViewGroup) null);
        final CheckBox checkBox = (CheckBox) view.findViewById(34603059);
        ((TextView) view.findViewById(34603493)).setText(toastString);
        ...
        builder.setNegativeButton(33686230, new DialogInterface.OnClickListener() {

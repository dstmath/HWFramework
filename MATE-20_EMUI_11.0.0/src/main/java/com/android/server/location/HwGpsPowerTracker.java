...
public class HwGpsPowerTracker {
    ...
    public final class GpsAppTracker {
        ...
        private boolean noPidRunning() {
            ...
            if (HwGpsPowerTracker.PACKAGE_NAME_FUSED.equals(this.mPkgName) || HwGpsPowerTracker.PACKAGE_NAME_HWID.equals(this.mPkgName) || HwGpsPowerTracker.PACKAGE_NAME_ANDROID.equals(this.mPkgName) || HwGpsPowerTracker.PACKAGE_NAME_HMS.equals(this.mPkgName) || (packageNameHms != null && !"".equals(packageNameHms) && packageNameHms.equals(this.mPkgName))) {

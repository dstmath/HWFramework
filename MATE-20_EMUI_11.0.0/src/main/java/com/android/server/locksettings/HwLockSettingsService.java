...
public class HwLockSettingsService extends LockSettingsService {
    ...
    public void showEncryptionNotificationForUser(UserHandle user) {
        ...
        showEncryptionNotification(user, r.getText(33685896), r.getText(33685897), r.getText(17041441), PendingIntent.getBroadcast(this.mContext, 0, ACTION_NULL, 134217728));
    }

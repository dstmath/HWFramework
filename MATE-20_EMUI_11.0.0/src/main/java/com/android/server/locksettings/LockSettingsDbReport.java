...
public class LockSettingsDbReport {
     ...
     */
    /* JADX WARNING: Removed duplicated region for block: B:20:0x0082 A[ExcHandler: SQLiteException | OperationCanceledException | SecurityException (r0v1 'ex' java.lang.RuntimeException A[CUSTOM_DECLARE]), Splitter:B:15:0x0044] */
            ...
            try {
                ...
                if (cursor != null) {
                    ...
                    while (cursor.moveToNext()) {
                        edit.putString(getUserKey(Integer.parseInt(getString(cursor, COLUMN_USERID, "1")), getString(cursor, COLUMN_KEY, "")), getString(cursor, "value", ""));
                    }
                    edit.commit();
                }
                if (cursor == null) {

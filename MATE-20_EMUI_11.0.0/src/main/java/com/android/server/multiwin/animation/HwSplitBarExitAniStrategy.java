...
public abstract class HwSplitBarExitAniStrategy {
    ...
    public void split2FullAnimation() {
        ...
        ValueAnimator scaleUpAni = ValueAnimator.ofInt(getScaleUpStartLen(), getScaleUpEndLen()).setDuration(DEFAULT_ANIMATION_TIME);
        ...
        animatorSets.setDuration(DEFAULT_ANIMATION_TIME);

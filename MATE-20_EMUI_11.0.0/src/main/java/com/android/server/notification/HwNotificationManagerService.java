...
public class HwNotificationManagerService extends NotificationManagerService {
    ...
    private static final String[] NOTIFICATION_WHITE_LIST = {"com.huawei.message", MMS_PKGNAME, "com.huawei.contacts", "com.android.contacts", PHONE_PKGNAME, "com.android.deskclock", "com.android.calendar", "com.huawei.calendar", "com.android.systemui", "android", "com.android.incallui", "com.android.phone.recorder", "com.android.cellbroadcastreceiver", TELECOM_PKGNAME, "com.huawei.harmonyos.call", "com.huawei.meetime", "com.huawei.deskclock"};
    ...
    private static final String RIDEMODE_NOTIFICATION_WHITE_LIST = "com.huawei.ridemode,com.huawei.sos,com.android.phone,com.android.server.telecom,com.android.incallui,com.android.deskclock,com.android.cellbroadcastreceiver,com.huawei.harmonyos.call,com.huawei.meetime,com.huawei.deskclock";
    ...
    private static final boolean VIBRATE_RESERVE = SystemProperties.getBoolean("hw_sc.vibrate.reserve", false);
    ...
    static {
        ...
        EXPANDEDNTF_PKGS.add("com.huawei.harmonyos.call");
    ...
    public HwNotificationManagerService(Context context, StatusBarManagerService statusBar, LightsService lights) {
        ...
        this.mVibratorTypeObserver = new ContentObserver(new Handler()) {
            ...
            public void onChange(boolean selfChange) {
                ...
                if (HwNotificationManagerService.VIBRATE_RESERVE || !HwVibrator.isSupportHwVibrator("haptic.audio_vibrate.sync")) {
            ...
            public void onChange(boolean selfChange) {
                ...
                if (HwNotificationManagerService.this.mRecHandler != null) {
                    HwNotificationManagerService.this.mRecHandler.postAtFrontOfQueue(new Runnable() {
                        /* class com.android.server.notification.HwNotificationManagerService.AnonymousClass8.AnonymousClass1 */

                        @Override // java.lang.Runnable
                        public void run() {
                            int userId = ActivityManager.getCurrentUser();
                            boolean enable = false;
                            if (Settings.System.getIntForUser(HwNotificationManagerService.this.mContext.getContentResolver(), HwNotificationManagerService.KEY_SMART_NOTIFICATION_SWITCH, HwNotificationManagerService.IS_CHINA_REGION ? 1 : 0, userId) == 1) {
                                enable = true;
                            }
    ...
    public boolean isHwSoundAllow(String pkg, String channelId, int userId) {
        ...
        Slog.v(TAG, "isHwSoundAllow pkg=" + pkg + ", channelId=" + channelId + ", userId=" + userId + ", soundVibrate=" + soundVibrate);
    ...
    public boolean isHwVibrateAllow(String pkg, String channelId, int userId) {
        ...
        if ((!(this.mAudioManager.getRingerModeInternal() == 0) && ((this.mAudioManager.getRingerModeInternal() == 1) || this.mVibrateWhenRinging)) && (soundVibrate == null || (soundVibrate.intValue() & 2) != 0)) {
            vibrateEnable = true;
        }
        Slog.v(TAG, "isHwVibrateAllow pkg=" + pkg + ", channelId=" + channelId + ", userId=" + userId + ", vibrateEnable=" + vibrateEnable);
    ...
    public boolean doForUpdateNotification(String key, Handler handler) {
        if (!HwPartIawareUtil.isNotificatinSwitchEnable() || handler == null || key == null || !isUpdateNotificationNeedToMng(key)) {
            return false;
        }
        long interval = HwPartIawareUtil.getNotificationInterval();
    ...
    private boolean isWechatHongbao(NotificationRecord record) {
        ...
        if (topImCN == null || !topImCN.equals(statusBarNotification.getPackageName()) || (notification = statusBarNotification.getNotification()) == null || (extras = notification.extras) == null || (charSequence = extras.getCharSequence("android.text")) == null || !charSequence.toString().contains(WECHAT_HONGBAO)) {
            return false;
        }
        return true;
    }
    ...
    public boolean isAllowToShow(String pkg, ActivityInfo topActivity) {
        ...
        try {
            boolean hsmCheck = HwServiceSecurityPartsFactoryEx.getInstance().getHwAddViewHelper(getContext()).addViewPermissionCheck(pkg, 2, uid);
    ...
    public void setNotificationWhiteList() {
        ...
        for (String s : PLUS_NOTIFICATION_WHITE_LIST) {
            this.power_save_whiteSet.add(s);
        }
        for (String s2 : NOTIFICATION_WHITE_LIST) {
            this.power_save_whiteSet.add(s2);
        }
        if (!TextUtils.isEmpty(apps_plus)) {
            for (String s3 : apps_plus.split(AwarenessInnerConstants.SEMI_COLON_KEY)) {

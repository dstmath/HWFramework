...
public class HwZenModeFiltering {
    ...
    private void buildAndSendZenmodeNotification() {
        ...
        builder.setContentTitle(this.mContext.getString(33686307)).setSmallIcon(33752177).setContentIntent(createToSettingsIntent()).setShowWhen(false).setAppName(this.mContext.getString(33686308)).setActions(createClosedAction());
    ...
    private Notification.Action createClosedAction() {
        ...
        return new Notification.Action.Builder((Icon) null, this.mContext.getString(33686306), PendingIntent.getBroadcast(this.mContext, 0, intent, 268435456)).build();
    }

...
public final class DexoptOptions {
    ...
    private boolean mIsOnlyPerformBaseDexopt;
    ...
    public DexoptOptions(String packageName, int compilationReason, String compilerFilter, String splitName, int flags) {
        if (((~1663) & flags) == 0) {
            ...
            this.mIsOnlyPerformBaseDexopt = false;
            return;
        }
    ...
    public void setOnlyPerformBaseDexopt() {
        this.mIsOnlyPerformBaseDexopt = true;
    }

    public boolean isOnlyPerformBaseDexopt() {
        return this.mIsOnlyPerformBaseDexopt;
    }
}

...
public class LegacyGlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener {
    ...
    private ActionsDialog createDialog() {
        ...
        this.mAirplaneModeOn = new ToggleAction(17302459, 17302461, 17040219, 17040218, 17040217) {
    ...
    private Action getSettingsAction() {
        return new SinglePressAction(17302807, 17040211) {
    ...
    private Action getEmergencyAction() {
        return new SinglePressAction(17302203, 17040204) {
    ...
    private Action getAssistAction() {
        return new SinglePressAction(17302284, 17040202) {
    ...
    private Action getVoiceAssistAction() {
        return new SinglePressAction(17302847, 17040215) {
    ...
    private Action getLockdownAction() {
        return new SinglePressAction(17301551, 17040206) {
    ...
    public class SilentModeToggleAction extends ToggleAction {
        public SilentModeToggleAction() {
            super(17302311, 17302309, 17040214, 17040213, 17040212);
        }

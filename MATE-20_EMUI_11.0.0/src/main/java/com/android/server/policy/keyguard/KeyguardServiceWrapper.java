...
public class KeyguardServiceWrapper implements IKeyguardService {
    ...
    public KeyguardServiceWrapper(Context context, IKeyguardService service, KeyguardStateMonitor.StateCallback callback) {
        ...
        this.mKeyguardStateMonitor = HwPolicyFactory.getHwKeyguardStateMonitor(context, service, callback);
    ...
    public boolean isPendingLock() {
        return this.mKeyguardStateMonitor.isPendingLock();
    }
    ...
    public void setHwPCKeyguardShowingCallback(KeyguardStateMonitor.HwPCKeyguardShowingCallback callback) {
        ...
        if (keyguardStateMonitor != null) {
            keyguardStateMonitor.setHwPCKeyguardShowingCallback(callback);
        }
    }
}

...
public class NetManager {
    ...
    private void start(int enable, int mode, List<ActivityManager.RunningAppProcessInfo> appProcesses) {
        ...
        sendLimitMode(mode, MSG_SET_LIMIT_MODE);
    ...
    private void stop() {
        ...
        resetUids.add(-1);
        sendLimitMode(0, MSG_SET_LIMIT_MODE);
    ...
    /* access modifiers changed from: private */
    public class AwareVisibleCallback implements AwareAppAssociate.IAwareVisibleCallback {
        ...
        public void onVisibleWindowsChanged(int type, int pid, int mode) {
            if (NetManager.this.mEnable) {
                ...
                data.putInt(NetManager.TYPE_STR, type);
                data.putInt("pid", pid);
    ...
    /* access modifiers changed from: private */
    public class AwareToastCallback implements AwareIntelligentRecg.IAwareToastCallback {
    ...
    private boolean isAppUid(int userUid) {
        if (UserHandleEx.getAppId(userUid) >= 10000) {
            return true;
        }
        return false;
    }
    ...
    public class NetManagerHandler extends Handler {
        ...
        /* JADX INFO: Multiple debug info for r0v2 int: [D('diedPid' int), D('bgPid' int)] */
        /* JADX INFO: Multiple debug info for r0v3 int: [D('diedPid' int), D('dlUid' int)] */
        /* JADX INFO: Multiple debug info for r0v4 int: [D('audioUid' int), D('dlUid' int)] */
        /* JADX INFO: Multiple debug info for r0v5 int: [D('audioUid' int), D('visData' android.os.Bundle)] */
        /* JADX INFO: Multiple debug info for r0v7 int: [D('toastMsg' int), D('enable' int)] */
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 0) {
                ...
                NetManager.this.appendVisiblePid(visData.getInt(NetManager.TYPE_STR), visData.getInt("pid"), visData.getInt(NetManager.MODE_STR), 1);
            } else if (i == 11) {

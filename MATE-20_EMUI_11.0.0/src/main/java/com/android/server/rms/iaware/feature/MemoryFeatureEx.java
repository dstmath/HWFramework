...
public class MemoryFeatureEx extends RFeature {
    ...
    private boolean setMemConfigValueInternel4(String itemName, String itemValue, StringBuffer logBuf) {
        ...
        try {
            ...
            if (hashCode != -1395754022) {
                if (hashCode != -891694571) {
                    if (hashCode == 1985079069 && itemName.equals(MemoryConstant.MEM_ENHANCED_RCC_SIZE)) {
                        c = 2;
                        if (c != 0) {
                ...
                } else if (itemName.equals(MemoryConstant.MEM_ENHANCED_KILL_SIZE)) {
                    c = 1;
                    if (c != 0) {
                    }
                }
            } else if (itemName.equals(MemoryConstant.MEM_SWAPPINESS_RANGE)) {
                c = 0;
                if (c != 0) {
                }
            }

...
public class HwABSStateMachine extends StateMachine {
    ...
    private int RESTART_ABS_TIME = HwMSSUtils.HISI_M2S_RSP_TIMEOUT;
    ...
    class DefaultState extends State {
        ...
        public boolean processMessage(Message message) {
            ...
            if (i == 1) {
                ...
                hwABSStateMachine5.mIsSupportVoWIFI = ImsManager.isWfcEnabledByPlatform(hwABSStateMachine5.mContext);

...
public class ClientModeImpl extends AbsWifiStateMachine implements IHwWifiStateMachineInner {
    ...
    public ClientModeImpl(Context context, FrameworkFacade facade, Looper looper, UserManager userManager, WifiInjector wifiInjector, BackupManagerProxy backupManagerProxy, WifiCountryCode countryCode, WifiNative wifiNative, WrongPasswordNotifier wrongPasswordNotifier, SarManager sarManager, WifiTrafficPoller wifiTrafficPoller, LinkProbeManager linkProbeManager) {
        ...
        this.mPrimaryDeviceType = this.mContext.getResources().getString(17039897);
    ...
    public boolean setRandomMacOui() {
        String oui = this.mContext.getResources().getString(17039898);
    ...
    class ConnectModeState extends State {
         ...
         */
        /* JADX WARNING: Code restructure failed: missing block: B:351:0x0c85, code lost:
            if (com.android.server.wifi.ClientModeImpl.FACTORY_MODE.equals(android.os.SystemProperties.get(com.android.server.wifi.ClientModeImpl.RO_RUN_MODE, com.android.server.wifi.ClientModeImpl.NORMAL_MODE)) != false) goto L_0x0cb4;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:358:0x0cb0, code lost:
            if (com.android.server.wifi.ClientModeImpl.FACTORY_MODE.equals(android.os.SystemProperties.get(com.android.server.wifi.ClientModeImpl.RO_RUN_MODE, com.android.server.wifi.ClientModeImpl.NORMAL_MODE)) != false) goto L_0x0cb4;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:415:0x0f78, code lost:
            if (r4.isProviderOwnedNetwork(r4.mLastNetworkId, r3) != false) goto L_0x0f7a;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:426:0x0fe8, code lost:
            if (r6.isProviderOwnedNetwork(r6.mLastNetworkId, r5) != false) goto L_0x0fea;
         */
        public boolean processMessage(Message message) {
            boolean ok;

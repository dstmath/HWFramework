...
public class HwWiFiCCode {
    ...
    public String getActiveCountryCode() {
        ...
        if (countryCode3 == null || countryCode3.isEmpty()) {
            String countryCode4 = this.mHwWiFiNoMobileCountryCode.getCountryCodeInNoMobileScene();
            if (!TextUtils.isEmpty(countryCode4)) {
                HwHiLog.d(TAG, false, "countryCode got in no mobile scene == %{private}s", new Object[]{countryCode4});
                return countryCode4.toUpperCase(Locale.ENGLISH);
            }
        ...
        String countryCode9 = countryCode3.toUpperCase(Locale.ENGLISH);

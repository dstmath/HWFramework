        ...
        synchronized (this.mLock) {
            ...
            if (!(this.mIfaceMgr == null || wifiInjector == null)) {
                if (wifiInjector.getWifiSettingsStore() != null) {
                    Log.i(TAG, "wifiEnabled:" + wifiInjector.getWifiSettingsStore().isWifiToggleEnabled() + " scanEnabled:" + wifiInjector.getWifiSettingsStore().isScanAlwaysAvailable() + " ifaceMgr.isNotEmpty:" + this.mIfaceMgr.hasAnyIface());

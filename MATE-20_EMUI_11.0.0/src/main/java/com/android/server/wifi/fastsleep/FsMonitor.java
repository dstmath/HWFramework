...
public class FsMonitor {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean isInBlackListScene(HwAPPQoEResourceManger qoeResourceManager, String appName) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean isInWhiteListScene(HwAPPQoEResourceManger qoeResourceManager, String appName) {

...
public class HwWifiP2pManagerEx {
    ...
    public void sharelinkReuse(Context context, WifiP2pManager.Channel c, WifiP2pManager.ActionListener listener) {
        ...
        sendMessageToChanel(c, SHARELINK_APPLY_P2P_REUSE, 0, wifiP2pManagerUtils.putListener(c, listener), bundle);
    }

    public void sharelinkRemoveGroup(WifiP2pManager.Channel c, String groupInfo, WifiP2pManager.ActionListener listener) {
        HwHiLogEx.d(TAG, false, "enter sharelinkRemoveGroup", new Object[0]);
        checkChannel(c);
        Bundle bundle = new Bundle();
        bundle.putString("info", groupInfo);
        sendMessageToChanel(c, SHARELINK_REMOVE_GROUP, 0, wifiP2pManagerUtils.putListener(c, listener), bundle);
    }

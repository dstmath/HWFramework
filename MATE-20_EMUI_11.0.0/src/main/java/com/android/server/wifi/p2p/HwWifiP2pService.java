...
public class HwWifiP2pService extends WifiP2pServiceImpl {
    ...
    private boolean isHuaweiShareOnGoing() {
        boolean isHuaweiShareOnGoing = SystemPropertiesEx.getBoolean("instantshare.sending", false);
        HwHiSLog.i(TAG, false, "isHuaweiShareOnGoing = %{public}s", new Object[]{String.valueOf(isHuaweiShareOnGoing)});
        return isHuaweiShareOnGoing;
    }
    ...
    public class HwP2pStateMachine extends WifiP2pServiceImpl.P2pStateMachine {
        ...
        private void applyP2pReuseMsgProc(Message message) {
            ...
            String packageName = ((Bundle) message.obj).getString("pkg");

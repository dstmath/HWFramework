...
public class HwWifiP2pServiceTvEx implements IHwWifiP2pServiceTvEx {
    ...
    public void notifyP2pInvitationReceived(int groupCreatingTimeoutIndex, final WifiP2pConfig savedPeerConfig, String deviceName) {
        ...
        View view = LayoutInflater.from(this.mContext).inflate(34013462, (ViewGroup) null, false);
        final AlertDialog dialog = new AlertDialog.Builder(this.mContext).setView(view).create();
        ((Button) view.findViewById(34603478)).setOnClickListener(new View.OnClickListener() {
        ...
        ((Button) view.findViewById(34603479)).setOnClickListener(new View.OnClickListener() {
        ...
        ((TextView) view.findViewById(34603480)).setText(String.format(Locale.ROOT, Resources.getSystem().getString(33686289), deviceName));
    ...
    private void pauseUntrustRequest() {
        ...
        View view = LayoutInflater.from(this.mContext).inflate(34013463, (ViewGroup) null, false);
        final AlertDialog dialog = new AlertDialog.Builder(this.mContext).setView(view).create();
        ((Button) view.findViewById(34603485)).setOnClickListener(new View.OnClickListener() {
        ...
        ((Button) view.findViewById(34603483)).setOnClickListener(new View.OnClickListener() {
        ...
        ((TextView) view.findViewById(34603482)).setText(String.format(Locale.ROOT, Resources.getSystem().getString(33686291), 10));
        setDialogSkipUpDownKeyEvent(dialog);
        setDialogWindowStyle(dialog);
        dialog.show();

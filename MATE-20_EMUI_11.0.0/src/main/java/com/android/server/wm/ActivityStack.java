...
public class ActivityStack extends AbsActivityStack {
    ...
    private static final String INCALL_ACTIVITY_NAME_Z = "com.huawei.harmonyos.call.InCallAbilityShellActivity";
    static final int LAUNCH_TICK = 500;
    static final int LAUNCH_TICK_MSG = 103;
    private static final int MAX_STOPPING_TO_FORCE = 3;
    private static final String MEETIME_INCALLUI_ACTIVITY = "com.huawei.hicallmanager.InCallActivity";
    ...
    boolean mIsStartOneStepWin = false;
    ...
    private void switchFocusedStackIfNeed(ActivityRecord current, ActivityRecord topResumed) {
        if (!(current == null || topResumed == null || current.getDisplay() != topResumed.getDisplay() || current.inMultiWindowMode())) {
            ...
            if (current.appInfo == null || !current.appInfo.isSystemApp()) {
        ...
        while (taskNdx >= 0) {
            ...
            if (task.voiceSession != null) {
                ...
                if (r == null || r.finishing) {
                    ...
                    userId = userId2;
                    z = z2;
                } else if ((r.mUserId != userId2 && (!activityStack.mStackSupervisor.isCurrentProfileLocked(r.mUserId) || !activityStack.mStackSupervisor.isCurrentProfileLocked(userId2))) || r.launchMode == 3) {
                    info = info2;
                    userId = userId2;
                    z = true;
    ...
    public void minimalResumeActivityLocked(ActivityRecord r) {
        ...
        if (INCALL_ACTIVITY_NAME_A.equals(r.info.name) || INCALL_ACTIVITY_NAME_Z.equals(r.info.name) || MEETIME_INCALLUI_ACTIVITY.equals(r.info.name)) {
    ...
    /* access modifiers changed from: package-private */
    /* JADX WARNING: Code restructure failed: missing block: B:178:0x02b1, code lost:
        r12 = r21;
     */
    /* JADX WARNING: Removed duplicated region for block: B:216:0x01fd A[SYNTHETIC] */
    @StackVisibility
    public int getVisibility(ActivityRecord starting) {
        ...
        int i4 = display.getChildCount() - 1;
        while (true) {
            if (i4 < 0) {
            ...
            ActivityStack other = display.getChildAt(i4);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:341:0x07d1  */
    /* JADX WARNING: Removed duplicated region for block: B:342:0x07ee  */
    /* JADX WARNING: Removed duplicated region for block: B:345:0x07f7  */
    /* JADX WARNING: Removed duplicated region for block: B:348:0x0814  */
    /* JADX WARNING: Removed duplicated region for block: B:349:0x0819  */
    /* JADX WARNING: Removed duplicated region for block: B:357:0x0831  */
    @GuardedBy({"mService"})
                    ...
                    if (next.attachedToProcess()) {
                        ...
                        if (notUpdated) {
                            ...
                            if (!next.visible || next.stopped) {
                                next.setVisibility(true);
                                if (INCALL_ACTIVITY_NAME_A.equals(next.info.name) || INCALL_ACTIVITY_NAME_Z.equals(next.info.name) || MEETIME_INCALLUI_ACTIVITY.equals(next.info.name)) {
    ...
    /* JADX INFO: Multiple debug info for r0v23 boolean: [D('e' java.lang.Exception), D('wasNowVisible' boolean)] */
    /* access modifiers changed from: package-private */
    ...
    public void moveTaskToFrontLocked(TaskRecord tr, boolean noAnimation, ActivityOptions options, AppTimeTracker timeTracker, String reason) {
        ...
        boolean noAnimation2 = (tr == null || tr.getStack() == null || !tr.inHwFreeFormWindowingMode() || !tr.getStack().isAlwaysOnTop()) ? noAnimation : true;

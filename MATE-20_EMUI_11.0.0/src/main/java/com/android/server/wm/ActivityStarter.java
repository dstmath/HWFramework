...
public class ActivityStarter extends AbsActivityStarter {
    ...
    /* JADX INFO: Multiple debug info for r9v11 'userId'  int: [D('checkedOptions' android.app.ActivityOptions), D('userId' int)] */
    /* JADX WARNING: Removed duplicated region for block: B:284:0x07b1 A[RETURN] */
    /* JADX WARNING: Removed duplicated region for block: B:285:0x07b3  */
    private int startActivity(IApplicationThread caller, Intent intent, Intent ephemeralIntent, String resolvedType, ActivityInfo aInfo, ResolveInfo rInfo, IVoiceInteractionSession voiceSession, IVoiceInteractor voiceInteractor, IBinder resultTo, String resultWho, int requestCode, int callingPid, int callingUid, String callingPackage, int realCallingPid, int realCallingUid, int startFlags, SafeActivityOptions options, boolean ignoreTargetSecurity, boolean componentSpecified, ActivityRecord[] outActivity, TaskRecord inTask, boolean allowPendingRemoteAnimationRegistryLookup, PendingIntentRecord originatingPendingIntent, boolean allowBackgroundActivityStart) {
        ...
        if (caller != null) {
            ...
            if (callerApp5 != null) {
                int callingPid5 = callerApp5.getPid();
        ...
        if (err2 == 0) {
            ...
            if (ACTION_HWCHOOSER.equals(intent.getAction()) && intent.getBooleanExtra(EXTRA_ALWAYS_USE_OPTION, false) && !HWPCEXPLORER_PACKAGE_NAME.equals(callingPackage4)) {
        ...
        if (restrictedBgActivity) {
            i2 = realCallingUid;
            if (this.mService.mHwATMSEx.shouldAbortSelfLaunchWhenReturnHome(activityInfo.applicationInfo.packageName, callingUid2, i2)) {
        ...
        if (!abort2) {
            ...
            if (this.mService.mHwATMSEx.shouldPreventStartActivity(aInfo, callingUid2, callingPid2, callingPackage2, userId2, intent, callerApp3, checkedOptions5)) {
                abort2 = true;
            }
        } else {
            i3 = i2;
        ...
        if (this.mService.mController != null) {
            try {
                abort2 |= !this.mService.mController.activityStarting(intent.cloneFilter(), activityInfo.applicationInfo.packageName);
        ...
        if (aInfo2 != null) {
            ...
            if (this.mService.getPackageManagerInternalLocked().isPermissionsReviewRequired(aInfo2.packageName, userId)) {
                ...
                ResolveInfo rInfo8 = this.mSupervisor.resolveIntent(newIntent, null, userId, 0, computeResolveFilterUid(callingUid3, i3, this.mRequest.filterCallingUid));
                i4 = startFlags;
                ActivityInfo aInfo8 = this.mSupervisor.resolveActivity(newIntent, rInfo8, i4, null);
                ...
                if (rInfo3 != null || rInfo3.auxiliaryInfo == null) {
                    ...
                    resolvedType4 = null;
                    intent4 = intent6;
                    aInfo4 = activityStarter.mSupervisor.resolveActivity(intent6, rInfo3, i4, null);
    ...
    /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x053f: APUT  (r3v19 java.lang.Object[]), (0 ??[int, short, byte, char]), (r4v17 android.view.IApplicationToken$Stub) */
    /* JADX WARNING: Removed duplicated region for block: B:172:0x0314  */
    /* JADX WARNING: Removed duplicated region for block: B:180:0x034b  */
            ...
            if (ret.getBoolean("skipReuse", false)) {
                ...
                if (r.isActivityTypeHome() || this.mRootActivityContainer.canStartHomeOnDisplay(r.info, this.mPreferredDisplayId, true)) {
                    ...
                    if (reusedActivity != null || reusedActivity.getTaskRecord() == null) {
                        ...
                        if (startStack != null && (startStack.mTaskStack == null || !startStack.mTaskStack.isVisible())) {
                        ...
                        if (!(startStack == null || resultRect.isEmpty() || (activityRecord3 = this.mSourceRecord) == null || activityRecord3.getActivityStack() == null || startStack.getWindowingMode() != 102)) {
                        ...
                        if (!(activityRecord7 == null || activityRecord7.getActivityStack() == null)) {
                            ActivityRecord activityRecord8 = this.mStartActivity;
                            handleStackFromOneStep(activityRecord8, activityRecord8.getActivityStack());
                            ...
                            iHwActivityTaskManagerServiceEx.oneStepHwMultiWindowBdReport(activityRecord9, activityRecord9.getActivityStack().getWindowingMode(), this.mOptions);
                        }
                    ...
                    ActivityStack.logStartActivity(30005, activityRecord10, activityRecord10.getTaskRecord());
                    ...
                    if (HwMwUtils.ENABLED && topFocused != null) {
                        ...
                        ActivityRecord activityRecord11 = this.mSourceRecord;
                        objArr[0] = activityRecord11 != null ? activityRecord11.appToken : topFocused.appToken;
    ...
    private void handleStackFromOneStep(ActivityRecord activity, ActivityStack stack) {
        if (stack.inHwFreeFormWindowingMode() && this.mStartActivity.intent != null && (this.mStartActivity.intent.getHwFlags() & 1048576) != 0) {
            stack.mIsStartOneStepWin = true;
        }
    }
    ...
    private int setTaskFromReuseOrCreateNewTask(TaskRecord taskToAffiliate) {
        ...
        if (this.mTargetStack != null) {
            ...
            handleStackFromOneStep(this.mStartActivity, this.mTargetStack);
        ...
        if (taskRecord2 == null) {
            ...
            if (this.mTargetStack.getWindowingMode() == 102 && this.mLaunchParams.mBounds.isEmpty()) {
                ...
                if (reuseScale > 0.0f) {
                    this.mOptions.setStackScale(reuseScale);
                    isBoundsReused = true;
                }
            }
            if (((this.mTargetStack.inHwMultiStackWindowingMode() && !this.mTargetStack.inHwSplitScreenWindowingMode()) || this.mTargetStack.inCoordinationSecondaryWindowingMode()) && !this.mLaunchParams.mBounds.isEmpty()) {
                if (this.mOptions.getStackScale() > 0.0f && this.mTargetStack.getTaskStack() != null) {
                ...
                if (activityOptions2 != null) {
                    this.mTargetStack.setPendingShow(activityOptions2.isPendingShow());
                }
            }

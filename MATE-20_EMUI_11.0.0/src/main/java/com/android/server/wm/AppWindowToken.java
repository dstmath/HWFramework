...
public class AppWindowToken extends WindowToken implements WindowManagerService.AppFreezeListener, ConfigurationContainerListener {
    ...
    private boolean shouldStartChangeTransition(int prevWinMode, int newWinMode) {
        ...
        this.mIsNeedChangeAnimationCorner = WindowConfiguration.isHwFreeFormWindowingMode(prevWinMode) && !WindowConfiguration.isHwMultiStackWindowingMode(newWinMode);
        if (this.mIsNeedChangeAnimationCorner) {
            return true;
        }
        if ((prevWinMode == 5) != (newWinMode == 5) || ((WindowConfiguration.isHwMultiStackWindowingMode(prevWinMode) && !WindowConfiguration.isHwMultiStackWindowingMode(newWinMode)) || (getStack() != null && this.mWmService.mAtmService.mHwATMSEx.isPadCastStack(getStack().mActivityStack) && !WindowConfiguration.isHwMultiStackWindowingMode(prevWinMode) && WindowConfiguration.isHwMultiStackWindowingMode(newWinMode)))) {
            return true;
        }
        return false;
    }
    ...
    public void layoutLetterbox(WindowState winHint) {
        ...
        if (winHint == null || w == winHint) {
            ...
            if (this.mBackgroundSurface == null) {
                ...
                this.mBackgroundSurface.drawBackgroundBitmapLocked(this.mWmService.mAtmService.mHwATMSEx.getPadCastWallpaperBitmap());
            }
    ...
    private boolean isFreeformExit(int transit, WindowState windowState) {
        ...
        if ((transit == 9 || (transit == 7 && isAllActivityExit(windowState))) && this.mWmService.mHwWMSEx.isLastOneApp(getDisplayContent())) {
            return true;
        }
        return false;
    }
                ...
                if (okToAnimate()) {
                    ...
                    if (adapter != null) {
                        ...
                        if (isCrossAppTransit(transit) && adapter.getShowWallpaper()) {
                            startWallpaperAnimaiton(lp, 34209853);
                        }
    ...
    private Animation loadAnimation(WindowManager.LayoutParams lp, int transit, boolean enter, boolean isVoiceInteraction) {
        ...
        if (enter || !inSecondaryCoordination) {
            ...
            if (HwPCUtils.isPcCastModeInServer() && HwPCUtils.isValidExtDisplayId(displayContent.mDisplayId)) {
                ...
                a = getDisplayContent().mAppTransition.loadAnimationRes(lp, 34209870);
            } else if (inHwFreeFormWindowingMode() && transit == 10 && enter2) {
                a = getDisplayContent().mAppTransition.loadAnimationRes(lp, 34209874);
            }
            int height3 = height;
            Animation a2 = this.mWmService.mHwWMSEx.createCardClipRevealAnimation(this.mWmService.mHwWMSEx.loadHwFreeWindowFloatOpenSceneAnimation(this.mWmService.mHwWMSEx.loadHwFreeWindowFloatDrawBackAnimation(this.mWmService.mHwWMSEx.loadHwAssociateFullScreenBackgroundAnimation(this.mWmService.mHwWMSEx.reloadHwSplitScreenOpeningAnimation(this.mWmService.mHwWMSEx.loadAppWindowExitToLauncherAnimation(this.mWmService.mHwWMSEx.getMagicWindowAnimation(a, enter2, transit, this, frame), transit, frame, this), this, this.mDisplayContent != null ? this.mDisplayContent.mOpeningApps : null, enter2), transit, this), transit, this), transit, this), enter2, transit, this, frame);
            if (a2 != null) {
    ...
    public void onAnimationLeashCreated(SurfaceControl.Transaction t, SurfaceControl leash) {
        ...
        if (leash != surfaceControl) {
            ...
            if (this.mNeedsAnimationBoundsLayer) {
                ...
                int lazyMode = this.mWmService.getLazyMode();
                WindowState window = findMainWindow();
                boolean isHwFreeWindowFLoatToWindowScene = this.mWmService.mHwWMSEx.isHwFreeWindowFloatDrawBackScene(this, this.mTransit, getDisplayContent()) || this.mWmService.mHwWMSEx.isHwFreeWindowFloatOpenScene(this, this.mTransit, getDisplayContent());
            ...
            } else if (this.mIsNeedChangeAnimationCorner) {
    ...
    public void onAnimationFinished() {
        ...
        this.mIsNeedChangeAnimationCorner = false;
        IHwAppWindowTokenEx iHwAppWindowTokenEx = this.mHwAppWinTokenEx;
        if (iHwAppWindowTokenEx != null) {
            iHwAppWindowTokenEx.cancelInputMethodRetractAnimation(this.mWmService.mRoot.getCurrentInputMethodWindow());
        }

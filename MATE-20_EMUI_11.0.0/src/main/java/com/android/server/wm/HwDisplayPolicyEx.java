...
public class HwDisplayPolicyEx implements IHwDisplayPolicyEx {
    ...
    private StylusGestureListener mStylusGestureListenerForPcMode = null;
    ...
    public void unRegisterExternalPointerEventListener() {
        ...
        if (HwPCUtils.enabledInPad() && HwStylusUtils.hasStylusFeature(this.mContext) && HwPCUtils.isPcCastModeInServer() && (stylusGestureListener = this.mStylusGestureListenerForPcMode) != null) {
            this.mService.unregisterPointerEventListener(stylusGestureListener, HwPCUtils.getPCDisplayID());
            this.mStylusGestureListenerForPcMode = null;
        }
    }
    ...
    public boolean isNaviBarMini() {
        NavigationBarPolicy navigationBarPolicy = this.mNavigationBarPolicy;
        return navigationBarPolicy != null && navigationBarPolicy.getMinNavigationBar();
    }
    ...
    public void updateNavigationBar(boolean isMinNaviBar) {
        if (isMinNaviBar) {
            ...
            setNavigationBarValueForRotation(1, getRotationValueByType(2), res.getDimensionPixelSize(17105307));
            setNavigationBarValueForRotation(1, getRotationValueByType(3), res.getDimensionPixelSize(17105307));
            setNavigationBarValueForRotation(1, getRotationValueByType(0), res.getDimensionPixelSize(17105309));
            setNavigationBarValueForRotation(1, getRotationValueByType(1), res.getDimensionPixelSize(17105309));
            setNavigationBarValueForRotation(2, getRotationValueByType(2), res.getDimensionPixelSize(17105312));
            setNavigationBarValueForRotation(2, getRotationValueByType(3), res.getDimensionPixelSize(17105312));
            setNavigationBarValueForRotation(2, getRotationValueByType(0), res.getDimensionPixelSize(17105312));
            setNavigationBarValueForRotation(2, getRotationValueByType(1), res.getDimensionPixelSize(17105312));
        ...
        this.mNavigationBarPolicy.updateNavigationBar(isMinNaviBar);
    }
    ...
    public void initialNavigationSize(Display display, int width, int height, int density) {
        if (density == 0) {
            ...
            int navBarHeight = res.getDimensionPixelSize(17105307);
            ...
            int navBarHeightLand = res.getDimensionPixelSize(17105309);
            ...
            int navBarWidth = res.getDimensionPixelSize(17105312);
    ...
    private void showGameAssist() {
        ...
        if (hwGameDockGesture != null) {
            hwGameDockGesture.notifyFingerServiceFromTop();
        }
    }

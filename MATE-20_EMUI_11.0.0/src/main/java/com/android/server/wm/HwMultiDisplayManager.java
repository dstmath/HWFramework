...
public class HwMultiDisplayManager {
    ...
    private static int mMultiCastWindowNumConfig = 0;
            ...
            this.mDisplayManager.registerDisplayListener(new DisplayManager.DisplayListener() {
                ...
                public void onDisplayAdded(int displayId) {
                    ...
                    if (display != null && HwActivityTaskManager.isCastDisplay(display.getUniqueId(), "padCast")) {
                        ...
                        HwMultiDisplayManager.this.showSecureViewIfNeed();
    ...
    public boolean computeBounds(ActivityRecord activity, Rect outBounds) {
        int width;
        if (!isVirtualDisplayId(activity.getDisplayId(), "padCast") || CAMERA_PACKAGE_NAME.equals(activity.packageName) || activity.inHwMagicWindowingMode() || HwPartMagicWindowServiceFactory.getInstance().getHwPartMagicWindowServiceFactoryImpl().getHwMagicWinManager().getHwMagicWinEnabled(1, activity.packageName) || activity.mAppWindowToken == null || !activity.mAppWindowToken.isForcedPortraitOrientation() || activity.getDisplay() == null || activity.getDisplay().mDisplayContent == null) {
            return false;
        }
        DisplayInfo displayInfo = activity.getDisplay().mDisplayContent.getDisplayInfo();
        Rect bounds = activity.mAtmService.mHwATMSEx.getHwMagicWinMiddleBounds(1);
    ...
    public void calcHwMultiWindowStackBoundsForConfigChange(ActivityStack stack, Rect outBounds, Rect oldStackBounds, int oldDisplayWidth, int oldDisplayHeight, int newDisplayWidth, int newDisplayHeight, boolean isModeChanged) {
        if (stack != null) {
            ...
            if (!outBounds.equals(oldStackBounds) || (oldDisplayWidth == newDisplayWidth && oldDisplayHeight == newDisplayHeight)) {
                ...
                if (outBounds.left == 0 && taskSize <= mMultiCastWindowNumConfig) {
    ...
    private boolean fixMultiCastWindowAfterTaskRemoved() {
        if (!checkMultiCastDisplayAbility(mMultiCastWindowNumConfig)) {
            return true;
        }
        for (Map.Entry<Integer, ArrayList<Bundle>> entry : getMultiCastWindowTask().entrySet()) {
            ...
            while (true) {
                if (index < array.size()) {
                    ...
                    if (rect != null && rect.left >= mMultiCastWindowNumConfig * edgeLen) {
                        return false;
                    }
                    if (rect != null && this.mIsOverGPUSize && mMultiCastWindowNumConfig > 1 && rect.left >= ((mMultiCastWindowNumConfig - 1) * this.mOverGPUHeight) + edgeLen) {
                        return false;
                    }
                    index++;
                }
                ...
                for (int i = array.size() - 1; i >= 0; i--) {
                    ...
                    if (taskBundle.getBoolean(KEY_PC_VISIBLE)) {
                        ...
                        if (taskId != curTaskId) {
                            ...
                            hwTogglePhoneFullScreenWindow(taskId);
                            return;
                        }
                        return;
                    }
        ...
        if (isCallerHasPermission("android.permission.MANAGE_ACTIVITY_STACKS", Binder.getCallingPid(), Binder.getCallingUid(), "moveTaskToFrontForMultiDisplay")) {
            ...
            synchronized (this.mService.getGlobalLock()) {
                ...
                Optional<Bundle> optional = taskBundles.stream().filter(new Predicate(taskId) {
                    /* class com.android.server.wm.$$Lambda$HwMultiDisplayManager$1kEtSrue2InK7AcXrOBr_sy0A */
                    ...
                    public final boolean test(Object obj) {
                        return HwMultiDisplayManager.lambda$moveTaskToFrontForMultiDisplay$3(this.f$0, (Bundle) obj);
                    }
                }).findFirst();
    ...
    static /* synthetic */ boolean lambda$moveTaskToFrontForMultiDisplay$3(int taskId, Bundle task) {
    ...
    public void moveTaskBackwardsForMultiDisplay(int taskId) {
        ...
        if (isCallerHasPermission("android.permission.MANAGE_ACTIVITY_STACKS", Binder.getCallingPid(), Binder.getCallingUid(), "moveTaskBackwardsForMultiDisplay")) {
            ...
            synchronized (this.mService.getGlobalLock()) {
                ...
                Rect currentRect = new Rect();
                Optional<Bundle> optional = taskBundles.stream().filter(new Predicate(taskId) {
                    /* class com.android.server.wm.$$Lambda$HwMultiDisplayManager$7IyM6KrQGbesjRYYfwmyx0MuKgk */
                    private final /* synthetic */ int f$0;
                    ...
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                        return HwMultiDisplayManager.lambda$moveTaskBackwardsForMultiDisplay$4(this.f$0, (Bundle) obj);
                    }
                }).findFirst();
                if (optional.isPresent()) {
                    currentRect = (Rect) optional.get().getParcelable(KEY_PC_RECT);
    ...
    static /* synthetic */ boolean lambda$moveTaskBackwardsForMultiDisplay$4(int taskId, Bundle task) {
        return task.getInt(KEY_PC_TASKID) == taskId;
    }
                        ...
                        while (true) {
                            ...
                            if (recentTaskId != 0 && recentTaskId == validTaskId && !taskBundle.getBoolean(KEY_PC_FLOATING)) {
                                if (isSupportPCMultiCastInConfig(getPkNameByTaskId(taskBundle.getInt(KEY_PC_TASKID)))) {
                                    ...
                                    count++;
                                    if (count >= mMultiCastWindowNumConfig) {
                                        break;
                                    }
                                }
                            }
        ...
        if (isCallerHasPermission("android.permission.MANAGE_ACTIVITY_STACKS", Binder.getCallingPid(), Binder.getCallingUid(), "hwTogglePhoneFullScreen")) {
            synchronized (this.mService.getGlobalLock()) {
                ...
                if (taskId > 0) {
                    ...
                    new Rect();
                    Optional<Bundle> optional = taskBundles.stream().filter(new Predicate(taskId) {
                        /* class com.android.server.wm.$$Lambda$HwMultiDisplayManager$_k6DhpWWT5qRgFzxKhabsu7t4A */
                        private final /* synthetic */ int f$0;
                        ...
                        @Override // java.util.function.Predicate
                        public final boolean test(Object obj) {
                            return HwMultiDisplayManager.lambda$hwTogglePhoneFullScreen$5(this.f$0, (Bundle) obj);
                        }
                    }).findFirst();
                    if (optional.isPresent()) {
                        currentRect = (Rect) optional.get().getParcelable(KEY_PC_RECT);
                    ...
                    for (int index = 0; index <= taskBundles.size() - 1; index++) {
                        ...
                        Rect rect = (Rect) bundle.getParcelable(KEY_PC_RECT);
                        if (bundle.getBoolean(KEY_PC_FLOATING) && rect != null && rect.left == currentRect.left) {
                            hwTogglePhoneFullScreenWindow(bundle.getInt(KEY_PC_TASKID));
                        }
                    }
                    return;
                }
                ...
                for (int index2 = taskBundles.size() - 1; index2 >= 0; index2--) {
                    ...
                    if (bundle2.getBoolean(KEY_PC_FLOATING)) {
                        ...
                        hwTogglePhoneFullScreenWindow(bundle2.getInt(KEY_PC_TASKID));
    ...
    static /* synthetic */ boolean lambda$hwTogglePhoneFullScreen$5(int taskId, Bundle task) {
        return task.getInt(KEY_PC_TASKID) == taskId;
    }
        ...
        try {
            ...
            if (tr != null) {
                ...
                ((ActivityTaskManagerService) this.mService).mH.postDelayed(new Runnable() {
                    /* class com.android.server.wm.$$Lambda$HwMultiDisplayManager$vxk9mfgLRvY0mNVwGB8lLT05EI */

                    @Override // java.lang.Runnable
                    public final void run() {
                        HwMultiDisplayManager.this.lambda$hwRestoreTaskForMultiDisplay$6$HwMultiDisplayManager();
                    }
                }, 200);
                Binder.restoreCallingIdentity(origId);
            }
    ...
    public /* synthetic */ void lambda$hwRestoreTaskForMultiDisplay$6$HwMultiDisplayManager() {
        this.mService.mWindowManager.stopFreezingScreen();
    }

    private void hwTogglePhoneFullScreenWindow(int taskId) {
        long ident = Binder.clearCallingIdentity();
        try {
            synchronized (this.mService.getGlobalLock()) {
                TaskRecord task = this.mService.mRootActivityContainer.anyTaskForId(taskId);
                ...
                if (stack.inHwPCMultiStackWindowingMode()) {
                    ...
                    this.mService.mH.postDelayed(new Runnable() {
                        /* class com.android.server.wm.$$Lambda$HwMultiDisplayManager$_lSdjlexv3cUyI1fkoJSDhHsc5E */

                        @Override // java.lang.Runnable
                        public final void run() {
                            HwMultiDisplayManager.this.lambda$hwTogglePhoneFullScreenWindow$7$HwMultiDisplayManager();
                        }
                    }, 200);
                }
                Binder.restoreCallingIdentity(ident);
    ...
    public /* synthetic */ void lambda$hwTogglePhoneFullScreenWindow$7$HwMultiDisplayManager() {
        this.mService.mWindowManager.stopFreezingScreen();
    }
    ...
    public void hwTogglePhoneFullScreenFromLauncherOrRecent(int taskId) {
        for (Map.Entry<Integer, ArrayList<Bundle>> entry : getMultiCastWindowTask().entrySet()) {
            ...
            if (array.stream().filter(new Predicate(taskId) {
                /* class com.android.server.wm.$$Lambda$HwMultiDisplayManager$5l_cQNJArkRHnYGQyYdxZGbuL1Y */
                private final /* synthetic */ int f$0;
                ...
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    return HwMultiDisplayManager.lambda$hwTogglePhoneFullScreenFromLauncherOrRecent$8(this.f$0, (Bundle) obj);
                }
            }).findFirst().isPresent()) {
                int listSize = array.size();
    ...
    static /* synthetic */ boolean lambda$hwTogglePhoneFullScreenFromLauncherOrRecent$8(int taskId, Bundle task) {
        return task.getInt(KEY_PC_TASKID) == taskId;
    }
    ...
    public void notifyHoldScreenStateChange(String tag, int lockHash, int ownerUid, int ownerPid, String state) {
        this.mService.mH.post(new Runnable(state, tag, ownerUid, ownerPid, lockHash) {
            /* class com.android.server.wm.$$Lambda$HwMultiDisplayManager$3F9nAaVMAKnwuGpsQB0j1FyhGYA */
            ...
            @Override // java.lang.Runnable
            public final void run() {
                HwMultiDisplayManager.this.lambda$notifyHoldScreenStateChange$9$HwMultiDisplayManager(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5);
            }
        });
    }

    public /* synthetic */ void lambda$notifyHoldScreenStateChange$9$HwMultiDisplayManager(String state, String tag, int ownerUid, int ownerPid, int lockHash) {
        synchronized (this.mService.getGlobalLock()) {
    ...
    public void moveStackToFrontEx(ActivityOptions options, ActivityStack stack) {
        if (stack != null && stack.mDisplayId != -1 && !stack.isActivityTypeHome() && this.mPadCastVirtualDisplayId != -1) {
            if ((options == null || options.getLaunchDisplayId() != this.mPadCastVirtualDisplayId) && stack.mDisplayId == this.mPadCastVirtualDisplayId) {
                ...
                notifyHoldScreenStateChangeInner();
                this.mService.mH.postDelayed(new Runnable() {
                    /* class com.android.server.wm.$$Lambda$HwMultiDisplayManager$7hY7cn0J79WYtagkHuCH_ZTwKZk */

                    @Override // java.lang.Runnable
                    public final void run() {
                        HwMultiDisplayManager.this.lambda$moveStackToFrontEx$10$HwMultiDisplayManager();
                    }
                }, 200);
    ...
    public /* synthetic */ void lambda$moveStackToFrontEx$10$HwMultiDisplayManager() {
        this.mService.mWindowManager.stopFreezingScreen();
    }
    ...
    public void updateTaskByRequestedOrientationForPCCast(int taskId, int requestedOrientation) {
        ...
        Optional<Bundle> optional = list.stream().filter(new Predicate(taskId) {
            /* class com.android.server.wm.$$Lambda$HwMultiDisplayManager$3CCTBZklUGPzuTsscAkbAHKQhUw */
            private final /* synthetic */ int f$0;
            ...
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return HwMultiDisplayManager.lambda$updateTaskByRequestedOrientationForPCCast$12(this.f$0, (Bundle) obj);
            }
        }).findFirst();
        ...
        if (isSupportTaskResizeByPCSizeInConfig(pkName) && isSupportDirectlyPCFullScreenInConfig(pkName)) {
            ...
            if (!isBoundsMatchOrientation(requestedOrientation, bounds) && task.getBoolean(KEY_PC_FLOATING)) {
                ...
                sendCaptureScreenToPc(taskId, getTaskSnapshotBitmap(taskId, false));
                hwResizeTaskForMultiDisplay(taskId, newBounds);
    ...
    static /* synthetic */ boolean lambda$updateTaskByRequestedOrientationForPCCast$12(int taskId, Bundle task) {
        return task.getInt(KEY_PC_TASKID) == taskId;
    }
    ...
    public void onTaskStackChangedForMultiDisplay() {
        if (!this.mConfigSupportPCMultiCastList.isEmpty()) {
            ...
            if (!taskList.isEmpty() && mMultiCastWindowNumConfig > 0) {
                String pkgName = "";
                Bundle msgData = new Bundle();
                ...
                if (!pkgName.equals(this.mTopFullScreenPackageName)) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void showSecureViewIfNeed() {
        WindowState secureWindow;
        synchronized (this.mService.getGlobalLock()) {
            ActivityRecord top = this.mService.mRootActivityContainer.getTopResumedActivity();
            if (!(top == null || top.mAppWindowToken == null || (secureWindow = top.mAppWindowToken.findSecureWindow()) == null || top.task == null)) {
                Bundle msgData = new Bundle();
                msgData.putBoolean(KEY_PC_FLOATING, false);
                setScreenPower(true);
                sendToMessengers(10, top.task.taskId, 1, msgData);
                Slog.i(TAG, "showSecureViewIfNeed msg: 10 , taskid= " + top.task.taskId + " , state 1 mainWindow " + secureWindow);
            }
        }
    }
    ...
    public Bitmap getPadCastWallpaperBitmap() {
        ...
        if (this.mPadCastWallpaperBitmap == null && (wallpaperManager = WallpaperManager.getInstance(this.mService.mContext)) != null) {
            ...
            synchronized (this.mService.getGlobalLock()) {
                ...
                ActivityDisplay padcastDisplay = ((ActivityTaskManagerService) this.mService).mRootActivityContainer.getActivityDisplay(this.mPadCastVirtualDisplayId);
                if (padcastDisplay != null) {
    ...
    private void handleSetMinConfigNum(Bundle bundle) {
        if (bundle == null) {
            ...
            mMultiCastWindowNumConfig = bundle.getInt(KEY_PC_CONFIG_NUM);
        }
    }
    ...
    private void handleStartFloatWin(Bundle bundle) {
        ...
        if (!(bundle == null || (intent = (Intent) bundle.getParcelable("intent")) == null)) {
            ...
            for (Bundle task : getTaskList()) {
                String pkg = task.getString(KEY_PC_PKGNAME);
                int windowingMode = task.getInt(KEY_PC_MULTI_WINDOW_MODE);
                Slog.i(TAG, "handleStartFloatWin pkg " + pkg + " windowingMode " + windowingMode);
                if (packageName.equals(pkg) && WindowConfiguration.isHwMultiStackWindowingMode(windowingMode)) {
                    if (windowingMode == 105) {
                        int taskId = task.getInt(KEY_PC_TASKID);
                        if (task.getBoolean(KEY_PC_VISIBLE)) {

...
public class HwMultiWindowSwitchManager implements DragAnimationListener, BlurListener, HwMultiWinHotAreaConfigListener {
    ...
    private WindowManager.LayoutParams initHotArea() {
        ...
        this.mRootView = (RelativeLayout) LayoutInflater.from(this.mUiContext).inflate(34013351, (ViewGroup) null);
        ...
        this.mDropView = (LinearLayout) this.mRootView.findViewById(34603281);
        ...
        this.mHotArea = (ViewGroup) this.mDropView.findViewById(34603282);
        ...
        LinearLayout splitLayout = (LinearLayout) this.mHotArea.findViewById(34603306);
        if (splitLayout == null) {
        ...
        if (this.mWindowingMode == 102) {
            HwMultiWinHotAreaView freeformScreenRegion = (HwMultiWinHotAreaView) this.mHotArea.findViewById(34603276);
    ...
    public boolean isSupportedSplit(IBinder token) {
        ...
        if (!isSupportedSplit) {
            showNotSupportToast(this.mUiContext, activityName);
        }
        ...
        synchronized (this.mAtms.getGlobalLock()) {
            ...
            if (ar != null) {
                if (ar.task != null) {
                    ...
                    if (isCheckAppLock && ActivityStartInterceptorBridge.isAppLockActivity(ar.shortComponentName)) {
    ...
    static /* synthetic */ void lambda$showNotSupportToast$0(Context context, String activityName) {
        Toast toast = Toast.makeText(new ContextThemeWrapper(context, 33947656), context.getString(33685798, activityName), 0);
    ...
    private boolean startDragAndDrop(View dragView, Bundle info) {
        ...
        if (info == null) {
            ...
            Drawable background = new ColorDrawable(this.mUiContext.getResources().getColor(33882976));
    ...
    private void configBaseRegions(List<Bitmap> screenShots) {
        this.mLeftSplitScreenRegion = (HwMultiWinHotAreaView) this.mHotArea.findViewById(34603280);
        if (this.mIsLeftRightSplit) {
        ...
        this.mRightSplitScreenRegion = (HwMultiWinHotAreaView) this.mHotArea.findViewById(34603298);
        if (this.mIsLeftRightSplit) {
    ...
    private void setMarginForSplitBar(HwMultiWinHotAreaView leftSplitScreenRegion, HwMultiWinHotAreaView rightSplitScreenRegion) {
        ...
        if (isLandScape()) {
            leftLp.rightMargin = this.mUiContext.getResources().getDimensionPixelSize(34472588);
            rightLp.leftMargin = this.mUiContext.getResources().getDimensionPixelSize(34472588);
            return;
        }
        leftLp.bottomMargin = this.mUiContext.getResources().getDimensionPixelSize(34472588);
        rightLp.topMargin = this.mUiContext.getResources().getDimensionPixelSize(34472588);
    }
    ...
    private void addSplitBar() {
        ...
        int splitBarContainerWidth = this.mUiContext.getResources().getDimensionPixelSize(34472582);
        ...
        splitBar.setImageDrawable(this.mUiContext.getDrawable(33751916));
        int splitBarWidth = this.mUiContext.getResources().getDimensionPixelSize(34472588);
        int splitBarLength = this.mUiContext.getResources().getDimensionPixelSize(34472587);
        ...
        ((LinearLayout) this.mHotArea.findViewById(34603306)).bringToFront();
        ((HwMultiWinHotAreaView) this.mHotArea.findViewById(34603276)).bringToFront();
    }
    ...
    public void onDrop(View v, DragEvent event, int splitMode, Rect dropBounds, int dragSurfaceAnimType) {
        ...
        Bundle info = new Bundle();
        info.putInt(HwMultiWinConstants.ANIM_TYPE_KEY_STR, dragSurfaceAnimType);
        if (v.getId() == 34603280 || v.getId() == 34603298) {
            Slog.d(TAG, "onDrop: view is left or right screen");
        } else if (v.getId() == 34603276) {
    ...
    private Drawable getTaskIcon(TaskRecord taskRecord) {
        ...
        if (topActivityRecord != null && "com.huawei.hwdockbar".equals(topActivityRecord.packageName)) {

        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case TaskChangeNotificationController.NOTIFY_SIZE_COMPAT_MODE_ACTIVITY_CHANGED_MSG /* 20 */:
                    ...
                    return;
                case TaskChangeNotificationController.NOTIFY_BACK_PRESSED_ON_TASK_ROOT /* 21 */:
        ...
        synchronized (this.mServiceLock) {
            for (int i = this.mRemoteTaskStackListeners.beginBroadcast() - 1; i >= 0; i--) {
                try {
                    ...
                    Slog.i(TAG, "forAllRemoteListeners: This GraphicBuffer has been destroyed.");
                }
            }
        ...
        synchronized (this.mServiceLock) {
            for (int i = this.mLocalTaskStackListeners.size() - 1; i >= 0; i--) {
                try {
                    ...
                    Slog.i(TAG, "forAllLocalListeners: This GraphicBuffer has been destroyed.");
                }
            }
        }
    }

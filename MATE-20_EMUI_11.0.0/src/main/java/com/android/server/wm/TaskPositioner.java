...
public class TaskPositioner implements IBinder.DeathRecipient {
                    ...
                    if ((event.getSource() & 2) != 0) {
                        ...
                        if (action != 0) {
                            if (action == 1) {
                                ...
                                if (TaskPositioner.this.mTask == null || !TaskPositioner.this.mTask.inHwFreeFormWindowingMode() || (TaskPositioner.this.mCurScale * TaskPositioner.this.mInitialScale <= TaskPositioner.this.maxScale && TaskPositioner.this.mCurScale * TaskPositioner.this.mInitialScale >= TaskPositioner.this.minScale)) {
    ...
    public void unregister() {
        ...
        if (task != null && task.inHwFreeFormWindowingMode()) {
            ...
            if (f * f2 > this.maxScale || f * f2 < this.minScale) {
                ...
                if (!this.mTask.getAnimRunningFlag()) {
                    this.mTask.startReboundScaleAnimation(this.mStartAnimationBounds, this.mStopAnimationBounds, this.mCtrlType, this.mCurScale, this.mInitialScale);
                } else {
                    this.mTask.destroyHwFreeFormScaleLeash(this.mCurScale * this.mInitialScale);
        ...
        if (!HwPCUtils.enabledInPad() || !HwPCUtils.isPcCastModeInServer() || !HwPCUtils.isValidExtDisplayId(this.mDisplayContent.getDisplayId())) {
            this.mService.mAnimationHandler.post(new Runnable() {
                /* class com.android.server.wm.$$Lambda$TaskPositioner$fusmvfrZLcqrcO6mL6fXRHOW4o */

                @Override // java.lang.Runnable
                public final void run() {
                    TaskPositioner.this.lambda$unregister$1$TaskPositioner();
                }
            });
        } else {
                ...
                try {
                    ...
                    if (this.mTask.inHwFreeFormWindowingMode()) {
                        ...
                        if (this.mTask.inHwFreeFormWindowingMode()) {
                            ...
                            this.mWindowDragBounds.set(tmpRect);
                            relocateOffScreenHwFreeformWindow();
                        } else {
                            this.mActivityManager.resizeTask(this.mTask.mTaskId, tmpRect, 3);
                        }
                    }
                } finally {
                    WindowManagerService.resetPriorityAfterLockedSection();
    ...
    public /* synthetic */ void lambda$unregister$1$TaskPositioner() {
    ...
    public void startDrag(boolean resize, boolean preserveOrientation, float startX, float startY, Rect startBounds) {
        ...
        if (this.mResizing) {
            ...
            this.mService.mH.post(new Runnable(startBounds) {
                /* class com.android.server.wm.$$Lambda$TaskPositioner$iJQccr4DkDrWn5czHsUEQGL2MSs */
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    TaskPositioner.this.lambda$startDrag$2$TaskPositioner(this.f$1);
                }
            });
        }
    ...
    public /* synthetic */ void lambda$startDrag$2$TaskPositioner(Rect startBounds) {
        try {
            if (this.mTask.inHwFreeFormWindowingMode()) {
    ...
    /* JADX INFO: Multiple debug info for r0v8 int: [D('nX' int), D('stableBounds' android.graphics.Rect)] */
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    ...
    private void relocateOffScreenHwFreeformWindow() {
        Rect originalWindowBounds;
        Rect tmpRect;
        String str;
        RemoteException e;
        if (this.mTask.inHwFreeFormWindowingMode() && this.mTask.mStack != null) {
            Rect originalWindowBounds2 = new Rect();
            if (!isImeVisible() || this.mService.mAtmService.mHwATMSEx.isPhoneLandscape(this.mDisplayContent)) {
                Rect originalWindowBounds3 = new Rect(this.mWindowDragBounds);
                this.mTmpRect = new Rect(originalWindowBounds3);
                tmpRect = this.mTmpRect;
                originalWindowBounds = originalWindowBounds3;
            } else {
                this.mTask.getBounds(originalWindowBounds2);
                tmpRect = new Rect(originalWindowBounds2);
                originalWindowBounds = originalWindowBounds2;
            }
            ...
            if (stack != null) {
                ...
                if (!validHwFreeformWindowBounds.equals(originalWindowBounds)) {
                    ...
                    try {
                        ...
                        IActivityTaskManager iActivityTaskManager = this.mActivityManager;
                        int stackId = this.mTask.mTaskRecord.getStack().getStackId();
                        str = TAG;
                        try {
                            iActivityTaskManager.resizeStack(stackId, validHwFreeformWindowBounds, false, false, false, -1);
                        } catch (RemoteException e2) {
                            e = e2;
                        }
                        ...
                        e = e3;
                        str = TAG;
                        Slog.e(str, "Exception caught by relocateOffScreenHwFreeformWindow", e);

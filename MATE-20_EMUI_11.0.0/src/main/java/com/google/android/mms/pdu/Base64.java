...
public class Base64 {
    ...
    static {
        ...
        for (int i3 = TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_AUTH_FAILURE_ON_EMERGENCY_CALL; i3 >= 97; i3--) {
        ...
        bArr[43] = 62;
        bArr[47] = AnswerToReset.INVERSE_CONVENTION;
    }
    ...
    /* JADX INFO: Multiple debug info for r2v2 byte[]: [D('packedData' byte[]), D('i' int)] */

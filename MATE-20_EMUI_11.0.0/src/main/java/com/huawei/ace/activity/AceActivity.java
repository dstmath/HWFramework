...
public class AceActivity extends Activity {
    ...
    private void createContainer() {
        ...
        this.container = AceEnv.createContainer(r0, this.pluginJni, this.activityId);
        ...
        if (aceContainer != null) {
            ...
            boolean z = true;
            if (this.container.getDeviceType() != 1) {
                z = false;
            }

            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 2:
                        ...
                        setCpusetSwitch(_arg12, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 3:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 12:
                        ...
                        boolean killProcessRecordFromIAwareNative = killProcessRecordFromIAwareNative(_arg02, _arg13, _arg12, data.readString());
                        reply.writeNoException();
                    ...
                    case 24:
                        ...
                        registerServiceHooker(_arg05, _arg1);
                        reply.writeNoException();
                        return true;
                    case 25:
                        data.enforceInterface(DESCRIPTOR);

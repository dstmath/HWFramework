...
public interface IHwAtmDAMonitorCallback extends IInterface {
    ...
    void noteActivityStart(String[] strArr, int i, int i2, boolean z) throws RemoteException;
    ...
    public static class Default implements IHwAtmDAMonitorCallback {
        ...
        public void noteActivityStart(String[] procInfos, int pid, int uid, boolean started) throws RemoteException {
        }
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        noteActivityStart(_arg0, _arg1, _arg22, _arg3);
                    ...
                    case 4:
                        ...
                        reportData(_arg02, _arg12, _arg2);
                        reply.writeNoException();
                        return true;
                    case 5:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 7:
                        ...
                        noteActivityDisplayed(_arg03, _arg13, _arg23, _arg3);
                        reply.writeNoException();
                        return true;
                    default:
        ...
        public static class Proxy implements IHwAtmDAMonitorCallback {
            ...
            public void noteActivityStart(String[] procInfos, int pid, int uid, boolean started) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().noteActivityStart(procInfos, pid, uid, started);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }

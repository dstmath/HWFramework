...
public class DeviceNetworkManager {
    ...
    public boolean setEthernetConfiguration(ComponentName admin, DeviceEthernetProfile deviceEthernetProfile) {
        ...
        bundle.putString(ETH_PROXY_PORT, deviceEthernetProfile.getProxyPort() + DeviceSettingsManager.EMPTY_STRING);
    ...
    public DeviceEthernetProfile getEthernetConfiguration(ComponentName admin, String interfaceName) {
        ...
        if (bundle != null) {
            String type = bundle.getString(ETH_STATIC_OR_DHCP, DeviceSettingsManager.EMPTY_STRING);
            if (DHCP.equals(type)) {
            ...
            result.setIpAddress(bundle.getString(ETH_IPADDRESS, DeviceSettingsManager.EMPTY_STRING));
            result.setSubnetMask(bundle.getString(ETH_SUBNET_MASK, DeviceSettingsManager.EMPTY_STRING));
            result.setGateway(bundle.getString(ETH_GATEWAY, DeviceSettingsManager.EMPTY_STRING));
            result.setProxyHost(bundle.getString(ETH_PROXY_HOST, DeviceSettingsManager.EMPTY_STRING));
            try {

...
public class DevicePhoneManager {
    ...
    public boolean addMdmNumberList(ComponentName admin, ArrayList<String> numbers, int blockMode, boolean isOutgoing, boolean isBlockList) {
        ...
        if (!setListTypePolicy(admin, isBlockList, isOutgoing)) {
    ...
    private boolean phoneNumberMatchedInList(ArrayList<String> list, String number) {
        ...
        while (it.hasNext()) {
            ...
            if (numRecord.endsWith("*")) {
                ...
                if (!DeviceSettingsManager.EMPTY_STRING.equals(standardNumRecord) && standardNumber.startsWith(standardNumRecord)) {
                    return true;
                }
    ...
    private String getCountryIso(Context context) {
        ...
        if (!(this.sCountryDetector != null || context == null || (detector = (CountryDetector) context.getSystemService("country_detector")) == null)) {
    ...
    public String getCallStatusNotificationApp() {
        ...
        if (bundle == null) {
            return DeviceSettingsManager.EMPTY_STRING;
        }
        return bundle.getString("value", DeviceSettingsManager.EMPTY_STRING);
    }

    public boolean setMultiCallingDisabled(ComponentName admin, boolean disabled) {
        Bundle bundle = new Bundle();

...
public class DeviceRestrictionManager {
    ...
    public boolean setSettingsApplicationDisabled(ComponentName admin, boolean disable) {
        ...
        packageNames.add(IS_TV ? TV_SETTINGS_PACKAGE_NAME : "com.android.settings");
    ...
    public boolean isSettingsApplicationDisabled(ComponentName admin) {
        return isApplicationDisabled(admin, IS_TV ? TV_SETTINGS_PACKAGE_NAME : "com.android.settings");
    }
    ...
    public boolean setVoiceAssistantButtonDisabled(ComponentName admin, boolean disable) {
        Bundle bundle = new Bundle();
        bundle.putBoolean("value", disable);

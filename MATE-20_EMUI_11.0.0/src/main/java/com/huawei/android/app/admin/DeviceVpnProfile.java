...
public final class DeviceVpnProfile {
    ...
    public String ipsecCaCert = DeviceSettingsManager.EMPTY_STRING;
    public String ipsecIdentifier = DeviceSettingsManager.EMPTY_STRING;
    public String ipsecSecret = DeviceSettingsManager.EMPTY_STRING;
    public String ipsecServerCert = DeviceSettingsManager.EMPTY_STRING;
    public String ipsecUserCert = DeviceSettingsManager.EMPTY_STRING;
    public final String key;
    public String l2tpSecret = DeviceSettingsManager.EMPTY_STRING;
    public boolean mppe = true;
    public String name = DeviceSettingsManager.EMPTY_STRING;
    public String password = DeviceSettingsManager.EMPTY_STRING;
    public String server = DeviceSettingsManager.EMPTY_STRING;
    public int type = 0;
    public String username = DeviceSettingsManager.EMPTY_STRING;

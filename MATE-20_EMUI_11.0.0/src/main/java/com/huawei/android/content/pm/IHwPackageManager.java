...
public interface IHwPackageManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHwPackageManager {
        ...
        static final int TRANSACTION_getDisplayChangeAppRestartConfig = 48;
        ...
        static final int TRANSACTION_getHwSystemAvailableFeatures = 49;
        ...
        static final int TRANSACTION_getOpenFileResult = 47;
        ...
        static final int TRANSACTION_getVersionMatchFlag = 45;
        static final int TRANSACTION_hasHwSystemFeature = 50;
        ...
        static final int TRANSACTION_setOpenFileResult = 46;
        static final int TRANSACTION_setVersionMatchFlag = 44;
        static final int TRANSACTION_shouldSkipTriggerFreeform = 24;
        static final int TRANSACTION_startBackupSession = 10;
        static final int TRANSACTION_uninstallHep = 43;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 49:
                        data.enforceInterface(DESCRIPTOR);
                        FeatureInfo[] _result25 = getHwSystemAvailableFeatures();
                        reply.writeNoException();

...
public class FmRxRdsData {
    ...
    public int rdsOptions(int rdsMask) {
        ...
        FmReceiverWrapper.setControlNative(this.mFd, V4L2_CID_PRIVATE_TAVARUA_RDSGROUP_PROC, (byte) (((rdsMask & 7) << 3) | ((byte) (((byte) FmReceiverWrapper.getControlNative(this.mFd, V4L2_CID_PRIVATE_TAVARUA_RDSGROUP_PROC)) & 199))));

...
public interface IHwNetworkStats extends IInterface {
    ...
    boolean setMpTrafficEnabled(boolean z) throws RemoteException;
    ...
    public static class Default implements IHwNetworkStats {
        ...
        @Override // com.huawei.android.net.IHwNetworkStats
        public boolean setMpTrafficEnabled(boolean enable) throws RemoteException {
            return false;
        }
    ...
    public static abstract class Stub extends Binder implements IHwNetworkStats {
        ...
        static final int TRANSACTION_setMpTrafficEnabled = 3;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code == 1) {
                ...
                data.enforceInterface(DESCRIPTOR);
                boolean mpTrafficEnabled = setMpTrafficEnabled(data.readInt() != 0);
                reply.writeNoException();
                reply.writeInt(mpTrafficEnabled ? 1 : 0);
                return true;
            ...
            public boolean setMpTrafficEnabled(boolean enable) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(3, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setMpTrafficEnabled(enable);
                    }
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;

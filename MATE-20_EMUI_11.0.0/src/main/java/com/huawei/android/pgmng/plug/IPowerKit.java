...
public interface IPowerKit extends IInterface {
    ...
    public static class Default implements IPowerKit {
        ...
        @Override // com.huawei.android.pgmng.plug.IPowerKit
        public boolean applyForAlarmAdjustInterval(String callingPkg, List<String> list, boolean apply, long interval) throws RemoteException {
            return false;
        }

        @Override // com.huawei.android.pgmng.plug.IPowerKit
        public boolean applyForAlarmExemption(String callingPkg, List<String> list, boolean apply) throws RemoteException {
            return false;
        }
    ...
    public static abstract class Stub extends Binder implements IPowerKit {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 21:
                        ...
                        boolean applyForAlarmExemption = applyForAlarmExemption(_arg0, _arg1, _arg2);
                        reply.writeNoException();
        ...
        public static class Proxy implements IPowerKit {
            ...
            @Override // com.huawei.android.pgmng.plug.IPowerKit
            public boolean applyForAlarmAdjustInterval(String callingPkg, List<String> actions, boolean apply, long interval) throws RemoteException {
                Throwable th;
                boolean _result;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            boolean applyForAlarmAdjustInterval = Stub.getDefaultImpl().applyForAlarmAdjustInterval(callingPkg, actions, apply, interval);
                            _reply.recycle();
                            _data.recycle();
            ...
            @Override // com.huawei.android.pgmng.plug.IPowerKit
            public boolean applyForAlarmExemption(String callingPkg, List<String> actions, boolean apply) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    if (!this.mRemote.transact(21, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().applyForAlarmExemption(callingPkg, actions, apply);
                    }
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;

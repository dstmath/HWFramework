...
public final class ContactsContractEx {
    ...
    @HwSystemApi
    public static final class CommonDataKindsEx {

        public static final class PhoneEx {
            public static final CharSequence getDisplayLabel(Context context, int type, CharSequence label) {
                return ContactsContract.CommonDataKinds.Phone.getDisplayLabel(context, type, label);
            }
        }
    }
}

...
public class AppGalleryAssistantService {
    ...
    public static final String TAG = "AssistantService-1060301";
    ...
    private String hmsPackageName = PACKAGE_NAME_HMS;
    ...
    private void initHmsPackageName(Context context) {
        try {
            List<ResolveInfo> resolveInfoList = context.getPackageManager().queryIntentServices(new Intent("com.huawei.hms.core.aidlservice"), 128);
            if (resolveInfoList != null && resolveInfoList.size() != 0) {
                this.hmsPackageName = resolveInfoList.get(0).serviceInfo.applicationInfo.packageName;
                Log.i(TAG, "initHmsPackageName:" + this.hmsPackageName);
            }
        } catch (Throwable e) {

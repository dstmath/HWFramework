...
public interface OnResultListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements OnResultListener {
        ...
        public static OnResultListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof OnResultListener)) {
                return new Proxy(obj);
            }
            return (OnResultListener) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            AwarenessResult _arg0;
            if (code == 1) {
                data.enforceInterface(DESCRIPTOR);
                if (data.readInt() != 0) {
                    _arg0 = AwarenessResult.CREATOR.createFromParcel(data);
                } else {
                    _arg0 = null;
                }
                onResult(_arg0);
        ...
        private static class Proxy implements OnResultListener {
            ...
            public void onResult(AwarenessResult awarenessResult) throws RemoteException {
                ...
                try {
                    ...
                    if (awarenessResult != null) {
                        _data.writeInt(1);
                        awarenessResult.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }

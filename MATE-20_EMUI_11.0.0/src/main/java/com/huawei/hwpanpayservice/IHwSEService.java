            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 23:
                        ...
                        return true;
                    case TRANSACTION_isSwitchFeatureOn /* 24 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result23 = isSwitchFeatureOn();
                        reply.writeNoException();
                        reply.writeInt(_result23);
                        return true;
                    case TRANSACTION_setUKeySwitchDisabled /* 25 */:
                        data.enforceInterface(DESCRIPTOR);
                        String _arg02 = data.readString();
                        if (data.readInt() != 0) {
                            _arg1 = true;
                        }
                        int _result24 = setUKeySwitchDisabled(_arg02, _arg1);
                        reply.writeNoException();
                        reply.writeInt(_result24);
                        return true;
                    case TRANSACTION_isUKeySwitchDisabled /* 26 */:
                        data.enforceInterface(DESCRIPTOR);

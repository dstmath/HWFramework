...
public final class SQLiteDatabase extends SQLiteClosable {
    ...
    private final ThreadLocal<SQLiteSession> mThreadSession = new ThreadLocal<SQLiteSession>() {
        /* class com.huawei.hwsqlite.SQLiteDatabase.AnonymousClass1 */
    ...
    private class EncryptKeyLoader implements SQLiteEncryptKeyLoader {
        ...
        @Override // com.huawei.hwsqlite.SQLiteEncryptKeyLoader
    ...
    /* access modifiers changed from: protected */
    @Override // com.huawei.hwsqlite.SQLiteClosable
        ...
        if (file != null) {
            ...
            if (dir != null) {
                ...
                File[] files = dir.listFiles(new FileFilter() {
                    /* class com.huawei.hwsqlite.SQLiteDatabase.AnonymousClass2 */
    ...
    public String[] getSQLTables(String sql, int rwFlags, CancellationSignal cancellationSignal) {
        if (sql == null || sql.isEmpty()) {
            throw new IllegalArgumentException("sql must not be null/empty");
        }
        acquireReference();
        try {
            return getThreadSession().getSQLTables(sql, getThreadDefaultConnectionFlags(true), rwFlags, cancellationSignal);
        } finally {
            releaseReference();
        }
    }
    ...
    public void addAttachAlias(String alias, String path, byte[] key) throws SQLException {
        ...
        String newPath = path;
        if (path == null) {
            newPath = SQLiteDatabaseConfiguration.MEMORY_DB_PATH;
        }
        synchronized (this.mLock) {
            throwIfNotOpenLocked();
            byte[] keyCopy = null;
            ...
            SQLiteAttached attached = new SQLiteAttached(newPath, alias, keyCopy);

...
public class WifiHandover {
    ...
    private boolean isScanResultSkip(ScanResult nextResult, String currentSsid, String currentBssid, String currentEncrypt, int currentLevel) {
        ...
        if (switchConfigKeySame && (isCurrentWifiOpenOrEapType() || (i = this.mWifiSwitchReason) == 1 || i == 3 || ((i == 4 || i == 5) && signalLevel - currentLevel < 2))) {
            ...
            return true;
        } else if (!this.mNetworkBlackListManager.isInAbnormalWifiBlacklist(nextResult.BSSID)) {
            return false;
        } else {

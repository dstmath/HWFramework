...
public class WifiProStateMachine extends StateMachine implements INetworkQosCallBack, INetworksHandoverCallBack, IWifiProUICallBack, IDualBandManagerCallback {
    ...
    private static final int EVENT_QOE_GAIN_STATISTICS = 136375;
    ...
    private static final int EVENT_REPORT_WIFIPRO_CHR = 136376;
    ...
    private static final long MP_WIFIPRO_TOAST_INTERVAL = 120000;
    ...
    private volatile boolean isQoeFirstGood = false;
    ...
    private IHwCommBoosterCallback mHwCommBoosterCallback = new IHwCommBoosterCallback.Stub() {
        /* class com.huawei.hwwifiproservice.WifiProStateMachine.AnonymousClass15 */
    ...
    private ContentObserver mMapNavigatingStateChangeObserver = new ContentObserver(null) {
        /* class com.huawei.hwwifiproservice.WifiProStateMachine.AnonymousClass14 */
    ...
    private long mMpToastTimestamps = 0;
    ...
    private AppQoeInfo mTempAppQoeInfoForChr;
    ...
    private long mWlanproToastTimestamps = 0;
    ...
    static /* synthetic */ String access$13284(WifiProStateMachine x0, Object x1) {
        String str = x0.respCodeChrInfo + x1;
        x0.respCodeChrInfo = str;
        return str;
    }

    static /* synthetic */ int access$17908(WifiProStateMachine x0) {
        int i = x0.mCellToWiFiCnt;
        x0.mCellToWiFiCnt = i + 1;
        return i;
    }

    static /* synthetic */ int access$19808(WifiProStateMachine x0) {
        int i = x0.mCurrentVerfyCounter;
        x0.mCurrentVerfyCounter = i + 1;
        return i;
    }

    static /* synthetic */ int access$35408(WifiProStateMachine x0) {
    ...
    public class AppQoeInfo {
        ...
        static /* synthetic */ int access$22608(AppQoeInfo x0) {
            int i = x0.mNetworkSlowChannelBadCnt;
            x0.mNetworkSlowChannelBadCnt = i + 1;
            return i;
        }

        static /* synthetic */ int access$22808(AppQoeInfo x0) {
        ...
        private void parseQoeInfo(Bundle data) {
            ...
            try {
                ...
                WifiProStateMachine.this.logE("parseQoeInfo parseInt err");
            }
        }
    ...
    private WifiProStateMachine(Context context, Messenger dstMessenger, Looper looper) {
        ...
        this.mTempAppQoeInfoForChr = new AppQoeInfo();
    }
    ...
    private void init(Context context) {
        ...
        registerForMpToastChanges();
        registerForWlanproToastChanges();
    ...
    private void registerForMpToastChanges() {
        this.mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(LAST_TOAST_TIMESTAMPS), false, new ContentObserver(getHandler()) {
            /* class com.huawei.hwwifiproservice.WifiProStateMachine.AnonymousClass5 */

            @Override // android.database.ContentObserver
            public void onChange(boolean selfChange) {
                WifiProStateMachine wifiProStateMachine = WifiProStateMachine.this;
                wifiProStateMachine.mMpToastTimestamps = Settings.System.getLong(wifiProStateMachine.mContext.getContentResolver(), WifiProStateMachine.LAST_TOAST_TIMESTAMPS, 0);
                WifiProStateMachine wifiProStateMachine2 = WifiProStateMachine.this;
                wifiProStateMachine2.logI("onChange ,mMpToastTimestamps = " + WifiProStateMachine.this.mMpToastTimestamps);
            }
        });
    }

    private void registerForWlanproToastChanges() {
        this.mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor("last_wifipro_toast_timestamps"), false, new ContentObserver(getHandler()) {
            /* class com.huawei.hwwifiproservice.WifiProStateMachine.AnonymousClass6 */

            @Override // android.database.ContentObserver
            public void onChange(boolean selfChange) {
                WifiProStateMachine wifiProStateMachine = WifiProStateMachine.this;
                wifiProStateMachine.mWlanproToastTimestamps = Settings.System.getLong(wifiProStateMachine.mContext.getContentResolver(), "last_wifipro_toast_timestamps", 0);
                WifiProStateMachine wifiProStateMachine2 = WifiProStateMachine.this;
                wifiProStateMachine2.logI("onChange ,mWlanproToastTimestamps = " + WifiProStateMachine.this.mWlanproToastTimestamps);
            }
        });
    }
    ...
    private boolean isKeepCurrWiFiConnected() {
        ...
        logW("mIsVpnWorking = " + this.mIsVpnWorking + ", mIsUserHandoverWiFi = " + this.mIsUserHandoverWiFi + ", mIsWiFiNoInternet = " + this.mIsWiFiNoInternet + ", mHiLinkUnconfig = " + this.mHiLinkUnconfig + ", isAppinWhitelists = " + isAppinWhitelists() + ", isWifiRepeaterOn = " + isWifiRepeaterOn());
        if (this.mIsVpnWorking || ((this.mIsUserHandoverWiFi && !this.mIsWiFiNoInternet) || this.mHiLinkUnconfig || isAppinWhitelists() || isWifiRepeaterOn())) {
            return DBG;
        }
        return false;
    }
    ...
    private boolean isAllowWifi2Mobile() {
        if (!this.mIsWiFiProEnabled || !this.mIsPrimaryUser || !isMobileDataConnected() || !this.mPowerManager.isScreenOn() || !HwWifiProFeatureControl.sWifiProToCellularCtrl || this.mEmuiPdpSwichValue == 2) {
            return false;
        }
        return DBG;
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void handleWifiProFaultChrReport(int reason) {
        if (reason == 10) {
            reportWifiProFaultEvent(TYPE_CHANNEL_QOE_BAD, TRIGGER_REASON_CHANNEL_QOE_BAD_3);
        } else if (reason == 11) {
            reportWifiProFaultEvent(TYPE_APP_QOE_BAD, TRIGGER_REASON_APP_QOE_BAD_3);
        } else if (reason == 107) {
            reportWifiProFaultEvent(TYPE_WIFI_SIGNAL_BAD, TRIGGER_REASON_WIFI_SIGNAL_BAD_4);
        }
    }

    private void reportWifiProFaultEvent(String type, String reason) {
        if (this.mAppQoeInfo == null) {
            Log.e(TAG, "handleWifiProFaultChrReport: appQoeInfo is null");
            return;
        }
        WifiManager wifiManager = this.mWifiManager;
        if (wifiManager == null) {
            Log.e(TAG, "handleWifiProFaultChrReport: mWifiManager is null");
            return;
        }
        WifiInfo wifiInfo = wifiManager.getConnectionInfo();
        if (wifiInfo == null) {
            Log.e(TAG, "handleWifiProFaultChrReport: wifiInfo is null");
            return;
        }
        ...
        WifiProChr.getInstance().reportWifi2CellParam(wifi2CellParam);
    }

    private String getReasonType(int reason) {
        if (reason == 10) {
            return TYPE_CHANNEL_QOE_BAD;
        }
        if (reason == 11) {
            return TYPE_APP_QOE_BAD;
        }
        if (reason != 107) {
            return "";
        }
        return TYPE_WIFI_SIGNAL_BAD;
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateAppQoeForWifiProChr(Message msg) {
        if (SystemClock.elapsedRealtime() - this.mHandoverCellSuccessTime >= 30000) {
            Log.d(TAG, "updateAppQoeForChr: statistics qoe only 30s");
            return;
        }
        Bundle data = null;
        ...
        if (data == null) {
            Log.e(TAG, "updateAppQoeForChr: qoe data is null");
        } else {
            this.mTempAppQoeInfoForChr.parseQoeInfo(data);
        }
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateQoeGainStatistics(int handoverReason) {
        if (this.mTempAppQoeInfoForChr == null) {
            Log.e(TAG, "updateQoeGainStatistics: mTempAppQoeInfoForChr is null");
            return;
        }
        long currentTime = SystemClock.elapsedRealtime();
        if (currentTime - this.mHandoverCellSuccessTime >= 30000) {
            Log.d(TAG, "updateQoeGainStatistics: count qoe only 30s");
            if (!this.isQoeFirstGood) {
                this.mQoeFirstGoodTime = 30000;
            }
            if (this.mQoeBadCount >= 6) {
                WifiProChr.getInstance().updateWifi2CellQoe(getReasonType(handoverReason), 0, (int) this.mQoeFirstGoodTime, 1);
            } else {
                WifiProChr.getInstance().updateWifi2CellQoe(getReasonType(handoverReason), 1, (int) this.mQoeFirstGoodTime, 1);
            }
            sendMessage(EVENT_REPORT_WIFIPRO_CHR);
            this.isQoeFirstGood = false;
            this.mQoeBadCount = 0;
            this.mQoeFirstGoodTime = 0;
            this.mHandoverCellSuccessTime = 0;
            return;
        }
        if (!this.isQoeFirstGood && (this.mTempAppQoeInfoForChr.mNetworkQoeLevel == 4 || this.mTempAppQoeInfoForChr.mNetworkQoeLevel == 0)) {
            this.mQoeFirstGoodTime = currentTime - this.mHandoverCellStartTime;
            this.isQoeFirstGood = DBG;
        }
        if (this.mTempAppQoeInfoForChr.mNetworkQoeLevel == 5) {
            this.mQoeBadCount++;
        } else {
            this.mQoeBadCount = 0;
        }
        sendMessageDelayed(EVENT_QOE_GAIN_STATISTICS, handoverReason, 1000);
    }
    ...
    public class DefaultState extends State {
        ...
        public boolean processMessage(Message msg) {
            int i = msg.what;
            if (i != WifiProStateMachine.EVENT_WIFIPRO_WORKING_STATE_CHANGE) {
                if (i == WifiProStateMachine.EVENT_REGISTER_APP_QOE) {
                    int result = HwDataServiceQoeEx.registerNetworkQoe("com.huawei.hwwifiproservice", "all", WifiProStateMachine.this.getHandler());
                    WifiProStateMachine wifiProStateMachine = WifiProStateMachine.this;
                    wifiProStateMachine.logI("registerNetworkQoe result = " + result);
                    return WifiProStateMachine.DBG;
                } else if (i != WifiProStateMachine.EVENT_UNREGISTER_CELL_CARD) {
                    return false;
                } else {
                    int subId = msg.arg1;
            ...
            } else if (!WifiProStateMachine.this.mIsWiFiProEnabled || !WifiProStateMachine.this.mIsPrimaryUser) {
    ...
    public class WiFiLinkMonitorState extends State {
        ...
        public void enter() {
            ...
            if (WifiProStateMachine.this.mCellToWiFiCnt >= 1) {
                ...
                WifiProStateMachine.this.sendMessageDelayed(WifiProStateMachine.EVENT_WAIT_CELL_QOE_BETTER, 120000);
            }
            NetworkInfo wifiInfo = WifiProStateMachine.this.mConnectivityManager.getNetworkInfo(1);
            if (wifiInfo != null && wifiInfo.getDetailedState() == NetworkInfo.DetailedState.VERIFYING_POOR_LINK) {
                WifiProStateMachine.this.logI(" POOR_LINK_DETECTED sendMessageDelayed");
        ...
        private void handleAppQoeInfo() {
            if (WifiProStateMachine.this.mAppQoeInfo.mNetworkQoeLevel == 5 && WifiProStateMachine.this.mAppQoeInfo.mMaxPktRatioChannelId == 2) {
                ...
                if ((WifiProStateMachine.this.mAppQoeInfo.mNetworkSlowReason & 1) == 1 || (WifiProStateMachine.this.mAppQoeInfo.mNetworkSlowReason & 2) == 2) {
                    AppQoeInfo.access$22608(WifiProStateMachine.this.mAppQoeInfo);
                } else {
            ...
            if (WifiProStateMachine.this.mAppQoeInfo.mMasterWifiChannelQoeLevel == 5 && ((WifiProStateMachine.this.mAppQoeInfo.mMasterWifiChannelQoeSlowReason & 1) == 1 || (WifiProStateMachine.this.mAppQoeInfo.mMasterWifiChannelQoeSlowReason & 2) == 2)) {
                AppQoeInfo.access$22808(WifiProStateMachine.this.mAppQoeInfo);
            } else {
            ...
            WifiProStateMachine wifiProStateMachine = WifiProStateMachine.this;
            wifiProStateMachine.logI(wifiProStateMachine.mStringBuffer.toString());
            if ((WifiProStateMachine.this.mAppQoeInfo.mChannelQoeBadCnt >= 1 && isWifiSignalBad(WifiProStateMachine.this.mAppQoeInfo.mMasterWifiRssi)) || WifiProStateMachine.this.mAppQoeInfo.mChannelQoeBadCnt >= 3) {
                WifiProStateMachine.this.logI("channel qoe is bad, notify link poor");
                WifiProStateMachine.this.handleWifiProFaultChrReport(10);
                WifiProStateMachine.this.notifyWifiLinkPoor(WifiProStateMachine.DBG, 10);
                this.mIsNeedIgnoreQoeUpdate = WifiProStateMachine.DBG;
            } else if ((WifiProStateMachine.this.mAppQoeInfo.mAppQoeBadCnt >= 1 && WifiProStateMachine.this.mAppQoeInfo.mNetworkSlowChannelBadCnt >= 1 && isWifiSignalBad(WifiProStateMachine.this.mAppQoeInfo.mMasterWifiRssi)) || (WifiProStateMachine.this.mAppQoeInfo.mAppQoeBadCnt >= 3 && WifiProStateMachine.this.mAppQoeInfo.mNetworkSlowChannelBadCnt >= 3)) {
                WifiProStateMachine.this.logI("app and channel qoe all bad, notify link poor");
                WifiProStateMachine.this.handleWifiProFaultChrReport(11);
                WifiProStateMachine.this.notifyWifiLinkPoor(WifiProStateMachine.DBG, 10);
                this.mIsNeedIgnoreQoeUpdate = WifiProStateMachine.DBG;
            } else if (WifiProStateMachine.this.mAppQoeInfo.mAppQoeBadCnt >= 9 && WifiProStateMachine.this.mCurrentWifiConfig != null && WifiProStateMachine.this.mCurrentWifiConfig.isEnterprise()) {
        ...
        private boolean isWifiSignalBad(int rssi) {
            ...
            if (WifiProStateMachine.this.mWifiManager == null) {
                WifiProStateMachine.this.loge("mWifiManager is null");
                return false;
            }
        ...
        private boolean isAppInBlacklist(String packageName) {
            ...
            if (this.mApkConfigList == null) {
                ...
                HwAPPQoEResourceManger hwAPPQoEResourceManger = this.mHwAppQoeResourceManager;
                if (hwAPPQoEResourceManger == null) {
                    return false;
                }
                this.mApkConfigList = hwAPPQoEResourceManger.getAPKConfigList();
                if (this.mApkConfigList == null) {
                    return false;
                }
            }
        ...
        private long getWifiProToastInterval() {
            return SystemClock.elapsedRealtime() - WifiProStateMachine.this.mWlanproToastTimestamps;
        }

        private long getToastInterval() {
            return SystemClock.elapsedRealtime() - WifiProStateMachine.this.mMpToastTimestamps;
        }

        private void showWifiToMobileToast(boolean isMplinkStarted) {
            if (!WifiProStateMachine.this.mIsWiFiProEnabled || ((isMplinkStarted && getToastInterval() < 120000 && getToastInterval() > 0) || (getWifiProToastInterval() < 120000 && getWifiProToastInterval() > 0))) {
                WifiProStateMachine.this.logI("wifi pro is shut down or interval < 2 minutes  don't show toast.");
            } else {
        ...
        private void handleWifiNetworkStateChange(Message msg) {
            if (msg.obj instanceof Intent) {
                ...
                if (networkInfo != null && NetworkInfo.DetailedState.VERIFYING_POOR_LINK == networkInfo.getDetailedState()) {
                    ...
                    WifiProStateMachine.this.isQoeFirstGood = false;
                    WifiProStateMachine.this.mQoeBadCount = 0;
                    WifiProStateMachine.this.mQoeFirstGoodTime = 0;
                    if (WifiProStateMachine.this.mNotifyWifiLinkPoorReason == 10 || WifiProStateMachine.this.mNotifyWifiLinkPoorReason == 11 || WifiProStateMachine.this.mNotifyWifiLinkPoorReason == 107) {
                        WifiProStateMachine wifiProStateMachine = WifiProStateMachine.this;
                        wifiProStateMachine.updateSwitchTimeStatistics(wifiProStateMachine.mNotifyWifiLinkPoorReason);
                        WifiProStateMachine wifiProStateMachine2 = WifiProStateMachine.this;
                        wifiProStateMachine2.deferMessage(wifiProStateMachine2.obtainMessage(WifiProStateMachine.EVENT_QOE_GAIN_STATISTICS, wifiProStateMachine2.mNotifyWifiLinkPoorReason));
                    }
                    ...
                    showWifiToMobileToast(WifiProStateMachine.this.isMpLinkStarted());
                    WifiProStateMachine wifiProStateMachine3 = WifiProStateMachine.this;
                    wifiProStateMachine3.transitionTo(wifiProStateMachine3.mWiFiProVerfyingLinkState);
                } else if (networkInfo != null && NetworkInfo.State.DISCONNECTED == networkInfo.getState()) {
                    WifiProStateMachine wifiProStateMachine4 = WifiProStateMachine.this;
                    wifiProStateMachine4.logI("wifi has disconnected,isWifi2WifiProcess = " + this.isWifi2WifiProcess);
                    ...
                    if (!this.isWifi2WifiProcess || !WifiProStateMachine.this.mWifiManager.isWifiEnabled()) {
                        WifiProStateMachine wifiProStateMachine5 = WifiProStateMachine.this;
                        wifiProStateMachine5.transitionTo(wifiProStateMachine5.mWifiDisConnectedState);
                    }
                }
            } else {
            ...
            if (msg.obj instanceof Intent) {
                ...
                if (networkType == 0 && mobileInfo != null && mobileInfo.getDetailedState() == NetworkInfo.DetailedState.CONNECTED && !WifiProStateMachine.this.isWifiNetworkCapabilityValidated() && !this.isWifi2WifiProcess) {
                    if (WifiProStateMachine.this.mIsWiFiNoInternet && !this.isWifiHandoverMobileToastShowed) {
                        showWifiToMobileToast(WifiProStateMachine.this.mIsMplinkStarted);
                        WifiProStateMachine wifiProStateMachine2 = WifiProStateMachine.this;
        ...
        private void handlePortalAuthCheckResultInLinkMonitorState(Message msg) {
            ...
            if (6 == msg.arg1) {
                ...
                if (WifiProStateMachine.this.respCodeChrInfo.length() != 0) {
                    WifiProStateMachine.access$13284(WifiProStateMachine.this, "/");
                }
                WifiProStateMachine.access$13284(WifiProStateMachine.this, WifiProStateMachine.RESP_CODE_PORTAL);
                if (this.detectCounter >= 2) {
                    ...
                    this.detectCounter = 0;
                    WifiProStateMachine.this.sendMessageDelayed(WifiProStateMachine.EVENT_CHR_ALARM_EXPIRED, 120000);
                    WifiProStateMachine wifiProStateMachine = WifiProStateMachine.this;
                ...
                if (wifiInternetLevel < 1 || wifiInternetLevel > 5) {
                    WifiProStateMachine.access$13284(WifiProStateMachine.this, "/");
                    WifiProStateMachine.access$13284(WifiProStateMachine.this, WifiProStateMachine.RESP_CODE_INTERNET_UNREACHABLE);
                } else {
                    WifiProStateMachine.access$13284(WifiProStateMachine.this, "/");
                    WifiProStateMachine.access$13284(WifiProStateMachine.this, WifiProStateMachine.RESP_CODE_INTERNET_AVAILABLE);
                }
        ...
        private void handleDualbandApAvailable() {
            ...
            if (!WifiProStateMachine.this.isFullscreen() && !WifiProCommonUtils.isCalling(WifiProStateMachine.this.mContext)) {
                HwWifiProFeatureControl.getInstance();
                if (!HwWifiProFeatureControl.isSelfCureOngoing()) {
                    if (WifiproUtils.isCastOptWorking()) {
    ...
    public class WiFiProVerfyingLinkState extends State {
        ...
        public void enter() {
            ...
            WifiProStateMachine.access$19808(WifiProStateMachine.this);
            ...
            if (WifiProStateMachine.this.mNotifyWifiLinkPoorReason == 10) {
                ...
                WifiProStateMachine.this.sendMessageDelayed(WifiProStateMachine.EVENT_CHECK_WIFI_NETWORK_BACKGROUND, 120000);
            } else if (WifiProStateMachine.this.mNotifyWifiLinkPoorReason == 12) {
                if (isElevatorAndOnlineScene()) {
        ...
        private boolean isElevatorAndOnlineScene() {
            if (WifiProStateMachine.this.mWifiManager == null) {
        ...
        public boolean processMessage(Message msg) {
            switch (msg.what) {
                ...
                case WifiProStateMachine.EVENT_DISPATCH_INTERNET_RESULT /* 136224 */:
                    ...
                    WifiProStateMachine.this.handleInternetResultForDisplay(level, msg.arg2);
                    break;
                case WifiProStateMachine.EVENT_QOE_GAIN_STATISTICS /* 136375 */:
                    WifiProStateMachine.this.updateQoeGainStatistics(msg.arg1);
                    break;
                case WifiProStateMachine.EVENT_REPORT_WIFIPRO_CHR /* 136376 */:
                    WifiProStateMachine.this.handleWifiProStaticsChrReport();
                    break;
                default:
                    return false;
            }
        ...
        private void handleUpdateWifiQoeMsg(Message msg) {
            WifiProStateMachine.this.updateAppQoeForWifiProChr(msg);
        ...
        private void handleMobileQosChange(int level) {
            if (WifiProStateMachine.this.mIsWiFiNoInternet) {
                ...
                this.mIsChrUserHandoverBack = false;
                restoreWifiConnect();
                WifiProStateMachine.access$17908(WifiProStateMachine.this);
    ...
    private void handleInternetResultForDisplay(int level, int delayShow) {
        ...
        if (level == -1 && delayShow != 1 && !hasMessages(EVENT_DISPATCH_INTERNET_RESULT)) {
            ...
            sendMessageDelayed(EVENT_DISPATCH_INTERNET_RESULT, level, 1, 120000);
    ...
    public class WifiSemiAutoScoreState extends State {
        ...
        private int handleWifiCheckResult(int result) {
            if (5 == result) {
                ...
                WifiProStateMachine.access$35408(WifiProStateMachine.this);
    ...
    public void notifyWifiLinkPoor(boolean poorLink, int reason) {
        ...
        if (poorLink) {
            if (reason != 107 || (!this.mIsWiFiNoInternet && getCurrentState() != this.mWiFiProVerfyingLinkState)) {
                ...
                if (reason == 107) {
                    handleWifiProFaultChrReport(reason);
                }
                WifiManager wifiManager = this.mWifiManager;

...
public class TabooReader {
    ...
    public enum ParamType {
        ...
        BLACK_LANG("black_lang", StorageManagerExt.INVALID_KEY_DESC),
        TABOO_BLACK_LANG("taboo_black_lang", StorageManagerExt.INVALID_KEY_DESC),
        CITY_NAME("city", "citys"),
        BLACK_CITY("black_city", StorageManagerExt.INVALID_KEY_DESC);
    ...
    private static Taboo getCurrentTaboo() {
        ...
        HashMap<Long, Taboo> tabooMap = new HashMap<>(10);

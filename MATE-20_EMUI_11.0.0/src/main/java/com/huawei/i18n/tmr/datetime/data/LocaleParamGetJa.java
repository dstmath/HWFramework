...
public class LocaleParamGetJa {
    public HashMap<String, String> date = new HashMap<String, String>() {
        /* class com.huawei.i18n.tmr.datetime.data.LocaleParamGetJa.AnonymousClass1 */

        {
            ...
            put("param_pastForward", "1[0-9]{3}年|一[一二三四五六七八九零]{3}年|[五六七八九][一二三四五六七八九零]年");

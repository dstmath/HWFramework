...
public class CommandExceptionEx extends Exception {
    ...
    @HwSystemApi
    public CommandExceptionEx(Error e) {
        super(e.toString());
        this.mError = e;
    }
    ...
    public static Throwable fromRilErrno(int ril_errno) {
        return CommandException.fromRilErrno(ril_errno);
    }

    @HwSystemApi
    public static boolean isSpecificError(Throwable throwable, Error specificError) {
        if (!(throwable instanceof CommandException) || getCommandError((CommandException) throwable) != specificError) {
            return false;
        }
        return true;
    }
    ...
    @HwSystemApi
    public static CommandExceptionEx getCommandException(Throwable throwable) {
        if (throwable instanceof CommandException) {
            return new CommandExceptionEx(getCommandError((CommandException) throwable));
        }
        return new CommandExceptionEx();
    }
    ...
    @HwSystemApi
    public static boolean isNotProvisionedError(Throwable throwable) {
        if (!(throwable instanceof CommandException) || ((CommandException) throwable).getCommandError() != CommandException.Error.NOT_PROVISIONED) {
            return false;
        }
        return true;
    }

...
public class AdnRecordExt {
    ...
    public static Object convertToAdnRecords(ArrayList<AdnRecordExt> adnRecordExts) {
        ...
        while (it.hasNext()) {
            adnRecords.add((AdnRecord) it.next().getAdnRecord());
        }
        return adnRecords;
    }
    ...
    public boolean isSameAdnRecord(AdnRecordExt adnRecordExt) {
        if (this.mAdnRecord == null || adnRecordExt == null || !(adnRecordExt.getAdnRecord() instanceof AdnRecord)) {
            return false;
        }
        return this.mAdnRecord.isEqual((AdnRecord) adnRecordExt.getAdnRecord());
    }

    public void updateAnrEmailArray(AdnRecordExt adnRecordExt, int emailFileNum, int anrFileNum) {
        if (adnRecordExt != null && (adnRecordExt.getAdnRecord() instanceof AdnRecord)) {
            this.mAdnRecord.updateAnrEmailArray((AdnRecord) adnRecordExt.getAdnRecord(), emailFileNum, anrFileNum);
        }
    }

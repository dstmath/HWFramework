...
public class HwDragBarPopupWindow extends PopupWindow {
    ...
    private void init() {
        ...
        setWidth(-1);
        setHeight(-2);
        this.mContentView = LayoutInflater.from(this.mCaptionView.mContext).inflate(34013350, (ViewGroup) null);
    ...
    private void getImageViews() {
        ...
        if (view != null) {
            this.mPopMaximize = view.findViewById(34603293);
            this.mPopMinimize = this.mContentView.findViewById(34603294);
            this.mPopClose = this.mContentView.findViewById(34603292);
    ...
    private void checkAppLockAction() {
        Intent intent;
        HwFreeFormCaptionView hwFreeFormCaptionView = this.mCaptionView;
        if (hwFreeFormCaptionView != null && hwFreeFormCaptionView.mOwner != null && (this.mCaptionView.mOwner.getContext() instanceof Activity) && this.mPopMaximize != null && this.mPopMinimize != null && this.mPopClose != null && (intent = ((Activity) this.mCaptionView.mOwner.getContext()).getIntent()) != null && isAppLockAction(intent.getAction())) {
            HwDragBarPopupBubbleLayout hwDragBarPopupBubbleLayout = this.mHwBubbleLayout;

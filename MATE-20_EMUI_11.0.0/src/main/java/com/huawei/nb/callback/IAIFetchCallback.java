...
public interface IAIFetchCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAIFetchCallback {
        ...
        public static IAIFetchCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface == null || !(queryLocalInterface instanceof IAIFetchCallback)) {
                return new Proxy(iBinder);
            }
            return (IAIFetchCallback) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onResult(parcel.readInt(), parcel.readInt() != 0 ? ObjectContainer.CREATOR.createFromParcel(parcel) : null);

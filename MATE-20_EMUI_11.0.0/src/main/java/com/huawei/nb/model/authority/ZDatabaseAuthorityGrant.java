...
public class ZDatabaseAuthorityGrant extends AManagedObject {
    public static final Parcelable.Creator<ZDatabaseAuthorityGrant> CREATOR = new Parcelable.Creator<ZDatabaseAuthorityGrant>() {
        ...
        public ZDatabaseAuthorityGrant createFromParcel(Parcel parcel) {
            return new ZDatabaseAuthorityGrant(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public ZDatabaseAuthorityGrant[] newArray(int i) {
            return new ZDatabaseAuthorityGrant[i];
        }
    };
    ...
    public ZDatabaseAuthorityGrant(Parcel parcel) {
        super(parcel);
        Boolean bool;
        boolean z = true;
        String str = null;
    ...
    private ZDatabaseAuthorityGrant(Long l, Long l2, String str, Long l3, String str2, Integer num, Boolean bool, String str3) {
        this.id = l;
        this.dbId = l2;
        this.dbName = str;
        this.packageUid = l3;
    ...
    public String toString() {
        return "ZDatabaseAuthorityGrant { id: " + this.id + ", dbId: " + this.dbId + ", dbName: " + this.dbName + ", packageUid: " + this.packageUid + ", packageName: " + this.packageName + ", authority: " + this.authority + ", supportGroupAuthority: " + this.supportGroupAuthority + ", reserved: " + this.reserved + " }";
    }

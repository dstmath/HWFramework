...
public class ZTableAuthority extends AManagedObject {
    public static final Parcelable.Creator<ZTableAuthority> CREATOR = new Parcelable.Creator<ZTableAuthority>() {
        ...
        public ZTableAuthority createFromParcel(Parcel parcel) {
            return new ZTableAuthority(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public ZTableAuthority[] newArray(int i) {
            return new ZTableAuthority[i];
        }
    };
    ...
    public ZTableAuthority(Parcel parcel) {
        super(parcel);
        Boolean bool;
        boolean z = true;
        String str = null;
    ...
    private ZTableAuthority(Long l, Long l2, String str, Long l3, String str2, Integer num, Boolean bool, String str3) {
        this.id = l;
        this.tableId = l2;
        this.tableName = str;
        this.packageUid = l3;
    ...
    public String toString() {
        return "ZTableAuthority { id: " + this.id + ", tableId: " + this.tableId + ", tableName: " + this.tableName + ", packageUid: " + this.packageUid + ", packageName: " + this.packageName + ", authority: " + this.authority + ", supportGroupAuthority: " + this.supportGroupAuthority + ", reserved: " + this.reserved + " }";
    }

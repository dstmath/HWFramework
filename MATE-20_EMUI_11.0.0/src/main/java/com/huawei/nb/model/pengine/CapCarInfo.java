...
public class CapCarInfo extends AManagedObject {
    public static final Parcelable.Creator<CapCarInfo> CREATOR = new Parcelable.Creator<CapCarInfo>() {
        ...
        public CapCarInfo createFromParcel(Parcel parcel) {
            return new CapCarInfo(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public CapCarInfo[] newArray(int i) {
            return new CapCarInfo[i];
        }
    };
    ...
    public CapCarInfo(Parcel parcel) {
        super(parcel);
        String str = null;
    ...
    private CapCarInfo(Integer num, Integer num2, Long l, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, String str19, String str20) {
        this.id = num;
        this.dataType = num2;
        this.timestamp = l;
        this.column0 = str;

...
public class CapMediaApp extends AManagedObject {
    public static final Parcelable.Creator<CapMediaApp> CREATOR = new Parcelable.Creator<CapMediaApp>() {
        ...
        public CapMediaApp createFromParcel(Parcel parcel) {
            return new CapMediaApp(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public CapMediaApp[] newArray(int i) {
            return new CapMediaApp[i];
        }
    };
    ...
    public CapMediaApp(Parcel parcel) {
        super(parcel);
        String str = null;
    ...
    private CapMediaApp(Integer num, Integer num2, Long l, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, String str19, String str20) {
        this.id = num;
        this.dataType = num2;
        this.timestamp = l;
        this.column0 = str;

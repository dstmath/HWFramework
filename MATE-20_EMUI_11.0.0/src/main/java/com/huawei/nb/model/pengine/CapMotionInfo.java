...
public class CapMotionInfo extends AManagedObject {
    public static final Parcelable.Creator<CapMotionInfo> CREATOR = new Parcelable.Creator<CapMotionInfo>() {
        ...
        public CapMotionInfo createFromParcel(Parcel parcel) {
            return new CapMotionInfo(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public CapMotionInfo[] newArray(int i) {
            return new CapMotionInfo[i];
        }
    };
    ...
    public CapMotionInfo(Parcel parcel) {
        super(parcel);
        String str = null;

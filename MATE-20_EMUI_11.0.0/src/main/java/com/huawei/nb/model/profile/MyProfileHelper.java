...
public class MyProfileHelper extends AEntityHelper<MyProfile> {
    ...
    public Object getRelationshipObject(String str, MyProfile myProfile) {
        return null;
    }
    ...
    public void bindValue(Statement statement, MyProfile myProfile) {
        ...
        Float buziTripPreferConfidence = myProfile.getBuziTripPreferConfidence();
        ...
        Float photoPreferConfidence = myProfile.getPhotoPreferConfidence();
        ...
        Float photoPreferTurismConfidence = myProfile.getPhotoPreferTurismConfidence();
        ...
        Float leaveHomeTimeWorkdayConfidence = myProfile.getLeaveHomeTimeWorkdayConfidence();
        ...
        Float arriveWorkplaceTimeWorkdayConfidence = myProfile.getArriveWorkplaceTimeWorkdayConfidence();
        ...
        Float leaveWorkplaceTimeWorkdayConfidence = myProfile.getLeaveWorkplaceTimeWorkdayConfidence();
        ...
        Float arriveHomeTimeWorkdayConfidence = myProfile.getArriveHomeTimeWorkdayConfidence();
        ...
        Float offTimeWorkdayConfidence = myProfile.getOffTimeWorkdayConfidence();
        ...
        Float onTimeWeekendConfidence = myProfile.getOnTimeWeekendConfidence();
        ...
        Float leaveHomeTimeWeekendConfidence = myProfile.getLeaveHomeTimeWeekendConfidence();
        ...
        Float arriveHomeTimeWeekendConfidence = myProfile.getArriveHomeTimeWeekendConfidence();
        ...
        Float offTimeWeekendConfidence = myProfile.getOffTimeWeekendConfidence();
    ...
    @Override // com.huawei.odmf.model.AEntityHelper
    public MyProfile readObject(Cursor cursor, int i) {
        return new MyProfile(cursor);
    }

    public void setPrimaryKeyValue(MyProfile myProfile, long j) {
        myProfile.setId(Integer.valueOf((int) j));
    }
}

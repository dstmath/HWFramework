                ...
                try {
                    if (SharedMemoryHelper.writeIndexDataList(list, create) > 153600) {
                        ...
                        try {
                            ...
                            DSLog.dt(TAG, "large insert " + list.size() + " index cost " + (System.currentTimeMillis() - currentTimeMillis), new Object[0]);
                        ...
                        DSLog.dt(TAG, "insert " + list.size() + " index cost " + (System.currentTimeMillis() - currentTimeMillis), new Object[0]);
                    }
                    SharedMemoryHelper.releaseMemory(sharedMemory);
                    SharedMemoryHelper.releaseMemory(sharedMemory5);
                    return insert;
                ...
                try {
                    if (SharedMemoryHelper.writeIndexDataList(list, create) > 153600) {
                        ...
                        try {
                            ...
                            DSLog.dt(TAG, "large update " + list.size() + " index cost " + (System.currentTimeMillis() - currentTimeMillis), new Object[0]);
                        } catch (ErrnoException e4) {
                            e = e4;
                            sharedMemory3 = sharedMemory5;
                            sharedMemory5 = sharedMemory;
                        ...
                        DSLog.dt(TAG, "update " + list.size() + " index cost " + (System.currentTimeMillis() - currentTimeMillis), new Object[0]);
                    }
                    SharedMemoryHelper.releaseMemory(sharedMemory);
                    SharedMemoryHelper.releaseMemory(sharedMemory5);
                    return update;
                ...
                try {
                    if (SharedMemoryHelper.writeIndexDataList(list, create) > 153600) {
                        ...
                        try {
                            ...
                            DSLog.dt(TAG, "large delete " + list.size() + " index cost " + (System.currentTimeMillis() - currentTimeMillis), new Object[0]);
                        } catch (ErrnoException e4) {
                            e = e4;
                            sharedMemory3 = sharedMemory5;
                            sharedMemory5 = sharedMemory;
                        ...
                        DSLog.dt(TAG, "delete " + list.size() + " index cost " + (System.currentTimeMillis() - currentTimeMillis), new Object[0]);
                    }
                    SharedMemoryHelper.releaseMemory(sharedMemory);
                    SharedMemoryHelper.releaseMemory(sharedMemory5);
                    return delete;

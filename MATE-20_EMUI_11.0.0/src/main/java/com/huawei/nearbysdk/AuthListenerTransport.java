...
public class AuthListenerTransport extends IAuthListener.Stub {
    ...
    private void _handleMessage(Message msg) {
        ...
        try {
            ...
            try {
                sessionKeyIV = msg.getData().getByteArray(BUNDLE_SESSION_KEY_IV);
            } catch (ArrayIndexOutOfBoundsException e2) {
                e = e2;
                HwLog.e(TAG, "_handleMessage: " + e.getMessage());
            }
            try {
                byte[] rsaBytes = msg.getData().getByteArray(BUNDLE_RSA_BYTES);
                ...
                if (this.mNearbyAdapter != null) {
                    ...
                    this.mNearbyAdapter.setSessionKey(authId, sessionKey, sessionKeyIV, rsaBytes, device);

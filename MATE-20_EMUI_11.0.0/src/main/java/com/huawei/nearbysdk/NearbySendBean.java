...
public class NearbySendBean implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.mSelectedFileUri == null ? "" : this.mSelectedFileUri);
        dest.writeString(this.mSelectedFileId == null ? "" : this.mSelectedFileId);
        dest.writeString(this.mAlbumCountUri == null ? "" : this.mAlbumCountUri);
        dest.writeString(this.mAlbumItemsUri == null ? "" : this.mAlbumItemsUri);
    }

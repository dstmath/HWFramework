...
public class AbilityUtils {
    ...
    public static int connectAbility(Context context, Intent intent, ServiceConnection serviceConnection) {
        return AbilityUtilsProxy.getInstance().connectAbility(context, intent, serviceConnection);
    }

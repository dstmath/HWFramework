...
public class SurfaceControlEx {
    ...
    @HwSystemApi
    public static void setWindowCrop(SurfaceControl targetSurfaceControl, Rect crop) {
        if (targetSurfaceControl != null) {
            targetSurfaceControl.setWindowCrop(crop);
        }
    }

    @HwSystemApi
    public static void setCornerRadius(SurfaceControl targetSurfaceControl, float cornerRadius) {
        if (targetSurfaceControl != null) {
            targetSurfaceControl.setCornerRadius(cornerRadius);
        }
    }

    @HwSystemApi
    public static IBinder getPhysicalDisplayToken(int displayId) {
        return SurfaceControl.getPhysicalDisplayToken((long) displayId);
    }
}

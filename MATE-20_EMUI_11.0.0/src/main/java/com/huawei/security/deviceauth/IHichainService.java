...
public interface IHichainService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHichainService {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        if (data.readInt() != 0) {
                            _arg1 = UserInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg1 = null;
                        }
                    ...
                    case 2:
                        ...
                        if (data.readInt() != 0) {
                            _arg12 = UserInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg12 = null;
                        }
                    ...
                    case 3:
                        ...
                        if (data.readInt() != 0) {
                            _arg13 = UserInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg13 = null;
                        }
                    ...
                    case 5:
                        ...
                        if (data.readInt() != 0) {
                            _arg14 = UserInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg14 = null;
                        }
                    ...
                    case 6:
                        ...
                        if (data.readInt() != 0) {
                            _arg15 = UserInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg15 = null;
                        }
                    ...
                    case 7:
                        ...
                        if (data.readInt() != 0) {
                            _arg16 = UserInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg16 = null;
                        }
                        if (data.readInt() != 0) {
                    ...
                    case 8:
                        ...
                        if (data.readInt() != 0) {
                            _arg2 = UserInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg2 = null;
                        }
                        if (data.readInt() != 0) {
                    ...
                    case 10:
                        ...
                        if (data.readInt() != 0) {
                            _arg22 = UserInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg22 = null;
                        }
                        if (data.readInt() != 0) {
                    ...
                    case 12:
                        ...
                        if (data.readInt() != 0) {
                            _arg17 = UserInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg17 = null;
                        }
                    ...
                    case 13:
                        ...
                        if (data.readInt() != 0) {
                            _arg18 = SessionInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg18 = null;
                        }
                    ...
                    case 14:
                        ...
                        if (data.readInt() != 0) {
                            _arg19 = SessionInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg19 = null;
                        }
                    ...
                    case 15:
                        ...
                        if (data.readInt() != 0) {
                            _arg110 = SessionInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg110 = null;
                        }
                    ...
                    case 16:
                        ...
                        if (data.readInt() != 0) {
                            _arg23 = SessionInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg23 = null;
                        }
                    ...
                    case 17:
                        ...
                        if (data.readInt() != 0) {
                            _arg111 = SessionInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg111 = null;
                        }
                        ...
                        if (data.readInt() != 0) {
                            _arg4 = UserInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg4 = null;
                        }
                    ...
                    case 18:
                        ...
                        if (data.readInt() != 0) {
                            _arg112 = SessionInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg112 = null;
                        }
                        ...
                        if (data.readInt() != 0) {
                            _arg42 = UserInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg42 = null;
                        }
                    ...
                    case 19:
                        ...
                        if (data.readInt() != 0) {
                            _arg113 = SessionInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg113 = null;
                        }
                    ...
                    case 20:
                        ...
                        if (data.readInt() != 0) {
                            _arg114 = SessionInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg114 = null;
                        }
                    ...
                    case 21:
                        ...
                        if (data.readInt() != 0) {
                            _arg115 = SessionInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg115 = null;
                        }
                    ...
                    case 22:
                        ...
                        if (data.readInt() != 0) {
                            _arg116 = UserInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg116 = null;
                        }
                    ...
                    case 23:
                        ...
                        if (data.readInt() != 0) {
                            _arg117 = UserInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg117 = null;
                        }
                        ...
                        return true;
                    case TRANSACTION_importHomeId /* 24 */:
                        data.enforceInterface(DESCRIPTOR);
        ...
        private static class Proxy implements IHichainService {
            ...
            public int importHomeId(String callerPackageName, String serviceType, int importType, String encryptKeyBase, byte[] homeIdBlob) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_importHomeId, _data, _reply, 0);
                    _reply.readException();
                    return _reply.readInt();
                } finally {
                    _reply.recycle();

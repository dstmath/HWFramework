...
public abstract class HwKeyProperties {
    ...
    public static final String KEY_ALGORITHM_HMAC_SM3 = "HmacSM3";
    public static final String KEY_ALGORITHM_RSA = "RSA";
    public static final String KEY_ALGORITHM_SM2 = "SM2";
    public static final String KEY_ALGORITHM_SM4 = "SM4";
    ...
    public static final String SIGNATURE_PADDING_EC_NONE = "NOPADDING";
        ...
        public static String fromKeymasterSecretKeyAlgorithm(int keymasterAlgorithm, int keymasterDigest) {
            ...
            if (keymasterAlgorithm == 128) {
                switch (keymasterDigest) {
                    ...
                    case 7:
                        return HwKeyProperties.KEY_ALGORITHM_HMAC_SM3;
                    default:
        ...
        public static int toKeymasterDigest(@NonNull String algorithm) {
            ...
            switch (digestUpper.hashCode()) {
                ...
                case -1850265334:
                    ...
                    break;
                case 82201:
                    if (digestUpper.equals(HwKeyProperties.DIGEST_SM3)) {
                        c = 5;
                        break;
                    }
                    break;
    ...
    public static abstract class EncryptionPadding {
        ...
        public static int toKeymasterEC(@NonNull String padding) {
            if (HwKeyProperties.ENCRYPTION_PADDING_NONE.equalsIgnoreCase(padding)) {
                return 1;
            }
            throw new IllegalArgumentException("Unsupported encryption padding scheme: " + padding + " for EC");
        }
        ...
        @NonNull
        public static int[] allToKeymasterEC(@Nullable String[] paddings) {
            if (paddings == null || paddings.length == 0) {
                return ArrayUtils.EmptyArray.INT;
            }
            int[] result = new int[paddings.length];
            for (int i = 0; i < paddings.length; i++) {
                result[i] = toKeymasterEC(paddings[i]);
            }
            return result;
        }
    }
    ...
    public static abstract class SignaturePadding {
        ...
        static int toKeymasterEC(@NonNull String padding) {
            char c;
            String upperCase = padding.toUpperCase(Locale.ROOT);
            int hashCode = upperCase.hashCode();
            if (hashCode != 79536) {
                if (hashCode != 76183014) {
                    if (hashCode == 907178768 && upperCase.equals(HwKeyProperties.SIGNATURE_PADDING_EC_NONE)) {
                        c = 0;
                        if (c != 0) {
                            return 1;
                        }
                        ...
                        throw new IllegalArgumentException("Unsupported signature padding scheme: " + padding + " for EC");
                    }
                } else if (upperCase.equals(HwKeyProperties.SIGNATURE_PADDING_RSA_PKCS1)) {
                    c = 1;
                    if (c != 0) {
                    }
                }
    ...
    public static abstract class Digest {
        ...
        public static int toKeymaster(@NonNull String digest) {
            ...
            switch (upperCase.hashCode()) {
                ...
                case -1523886674:
                    ...
                    break;
                case -1523884971:
                    if (upperCase.equals(HwKeyProperties.DIGEST_SHA512)) {
                        c = 2;
                        break;
                    }
                    c = 65535;
                    break;
                case 82201:
                    if (upperCase.equals(HwKeyProperties.DIGEST_SM3)) {
                        c = 3;
                        break;
                    }
                    c = 65535;
        ...
        public static String fromKeymaster(int digest) {
            ...
            if (digest == 7) {
                return HwKeyProperties.DIGEST_SM3;
            }
            throw new IllegalArgumentException("Unsupported digest algorithm: " + digest);
        }

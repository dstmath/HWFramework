...
public class HwPartIawareUtil {
    ...
    public static DefaultAdvancedKiller getAdvancedKiller(Context context) {
        return HwPartIawareServiceFactoryEx.loadFactory("com.huawei.server.HwPartIawareServiceFactoryExImpl").getAdvancedKiller(context);
    }

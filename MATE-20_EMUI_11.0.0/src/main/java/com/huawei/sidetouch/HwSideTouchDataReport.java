...
public class HwSideTouchDataReport {
    ...
    public void reportSideTouchConfigChanged(boolean isEnabled) {
        HiView.report(new HiEvent(CONFIG_EVEVT_ID).putInt("config", isEnabled ? 1 : 0));
    }

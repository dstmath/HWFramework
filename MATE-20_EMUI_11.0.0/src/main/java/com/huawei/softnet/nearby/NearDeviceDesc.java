...
public class NearDeviceDesc implements Parcelable {
    public static final Parcelable.Creator<NearDeviceDesc> CREATOR = new Parcelable.Creator<NearDeviceDesc>() {
        /* class com.huawei.softnet.nearby.NearDeviceDesc.AnonymousClass1 */

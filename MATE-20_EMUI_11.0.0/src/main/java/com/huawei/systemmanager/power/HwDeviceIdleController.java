...
public class HwDeviceIdleController {
    ...
    public static void addPowerSaveWhitelistApp(String var1) throws RemoteException {
        IDeviceIdleController.Stub.asInterface(ServiceManagerEx.getService("deviceidle")).addPowerSaveWhitelistApp(var1);
    }

    public static void removePowerSaveWhitelistApp(String var1) throws RemoteException {
        IDeviceIdleController.Stub.asInterface(ServiceManagerEx.getService("deviceidle")).removePowerSaveWhitelistApp(var1);
    }
}

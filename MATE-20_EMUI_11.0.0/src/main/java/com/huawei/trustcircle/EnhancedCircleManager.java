...
public final class EnhancedCircleManager {
    ...
    private static final int ERROR_CODE_START_RANDOM_ACTIVITY = 10002;
    ...
    private static final String KEY_IS_ACTIVITY_CONTEXT = "is_activity_context";
    ...
    private static final String NORMAL_PERMISSION_RANDOM_ACTIVITY_CLASS_NAME = "com.huawei.trustcircle.enhanced.ui.activities.ControlRandomActivity";
    ...
    private static final String SYSTEM_PERMISSION_RANDOM_ACTIVITY_CLASS_NAME = "com.huawei.trustcircle.enhanced.ui.activities.EnhanceCircleRandomActivity";
    ...
    public static class EnhancedCircleClient {
        ...
        public void createOrJoinCircle(Bundle reqParams, final IResultListener resultListener) {
            ...
            if (resultListener != null) {
                ...
                IEnhancedCircleListener callback = new IEnhancedCircleListener.Stub() {
                    ...
                    public void onResult(Bundle result) {
                        EnhancedCircleClient.this.handleResult(resultListener, result);
                    }
        ...
        private void startLockAndPwdVerifyActivity() {
            Intent intent = new Intent();
            if (this.mIsNormalPermission) {
                Log.d(EnhancedCircleManager.TAG, "startLockAndPwdVerifyActivity normal permission");
                ...
                Log.d(EnhancedCircleManager.TAG, "startLockAndPwdVerifyActivity system or signature permission");
                intent.setClassName(EnhancedCircleManager.SERVICE_PACKAGE, EnhancedCircleManager.SYSTEM_PERMISSION_ACTIVITY_CLASS_NAME);
            }
            startTcActivity(intent);
        }

        private void startRandomActivity(Bundle bundle) {
            if (bundle == null) {
                Log.e(EnhancedCircleManager.TAG, "startRandomActivity bundle is null");
                return;
            }
            Intent intent = new Intent();
            if (this.mIsNormalPermission) {
                Log.d(EnhancedCircleManager.TAG, "startRandomActivity: normal permission");
                intent.setClassName(EnhancedCircleManager.SERVICE_PACKAGE, EnhancedCircleManager.NORMAL_PERMISSION_RANDOM_ACTIVITY_CLASS_NAME);
                bundle.putString(EnhancedCircleManager.KEY_CALLING_PACKAGE_NAME, this.mContext.getPackageName());
            } else {
                Log.d(EnhancedCircleManager.TAG, "startRandomActivity: system or signature");
                intent.setClassName(EnhancedCircleManager.SERVICE_PACKAGE, EnhancedCircleManager.SYSTEM_PERMISSION_RANDOM_ACTIVITY_CLASS_NAME);
            }
            intent.putExtras(bundle);
            startTcActivity(intent);
        }

        private void startTcActivity(Intent intent) {
            if (EnhancedCircleManager.sInstance.mActivity == null || intent == null) {
                Log.e(EnhancedCircleManager.TAG, "startTcActivity: failed activity or intent null");
                return;
            }
            try {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private void handleResult(IResultListener resultListener, Bundle result) {
            if (resultListener == null) {
                Log.e(EnhancedCircleManager.TAG, "resultListener is null");
            } else if (result == null) {
                Log.e(EnhancedCircleManager.TAG, "handleResult result is null");
                resultListener.onResult(new Bundle());
            } else {
                int value = result.getInt(EnhancedCircleManager.KEY_ERROR_CODE);
                if (value == EnhancedCircleManager.ERROR_CODE_FOR_START_ACTIVITY) {
                    Log.i(EnhancedCircleManager.TAG, "start lock and password activity for third party");
                    startLockAndPwdVerifyActivity();
                } else if (value != EnhancedCircleManager.ERROR_CODE_START_RANDOM_ACTIVITY) {
                    resultListener.onResult(result);
                } else {
                    Log.i(EnhancedCircleManager.TAG, "start random activity for third party");
                    startRandomActivity(result);
                }
            }
        }
    }

...
public final class Decoder {
    ...
    private static final String[] PUNCT_TABLE = {"", "\r", "\r\n", ". ", ", ", ": ", "!", "\"", "#", "$", "%", ContainerUtils.FIELD_DELIMITER, "'", "(", ")", PhoneConstantsEx.APN_TYPE_ALL, "+", SmartTrimProcessEvent.ST_EVENT_STRING_TOKEN, "-", ".", "/", ":", SmartTrimProcessEvent.ST_EVENT_INTER_STRING_TOKEN, "<", ContainerUtils.KEY_VALUE_DELIMITER, Route.ROUTE_TYPE_SPLIT, "?", "[", "]", "{", "}", "CTRL_UL"};

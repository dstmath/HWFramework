...
public interface INxpNfcAdapter extends IInterface {
    ...
    byte[] getCPLCFromVn() throws RemoteException;
    ...
    String getNfcChip() throws RemoteException;
    ...
    void notifyActiveResult(String str, int i, String str2) throws RemoteException;
    ...
    void notifyCardUid(String str, String str2) throws RemoteException;

    void notifySwipeCardStatus(String str, int i) throws RemoteException;

    void notifyTrafficCardSwipeStatus(String str, int i) throws RemoteException;

    void nxpOsuUpdate() throws RemoteException;
    ...
    public static class Default implements INxpNfcAdapter {
        ...
        @Override // com.nxp.nfc.INxpNfcAdapter
        public int configureSecureReader(boolean on, String readerType) throws RemoteException {
            return 0;
        }

        @Override // com.nxp.nfc.INxpNfcAdapter
        public void notifyTrafficCardSwipeStatus(String aid, int status) throws RemoteException {
        }
        ...
        @Override // com.nxp.nfc.INxpNfcAdapter
        public String getNfcChip() throws RemoteException {
            return null;
        }

        @Override // com.nxp.nfc.INxpNfcAdapter
        public void notifyActiveResult(String aid, int type, String result) throws RemoteException {
        }
        ...
        @Override // com.nxp.nfc.INxpNfcAdapter
        public void nxpOsuUpdate() throws RemoteException {
        }

        @Override // com.nxp.nfc.INxpNfcAdapter
        public byte[] getCPLCFromVn() throws RemoteException {
            return null;
        }

        @Override // com.nxp.nfc.INxpNfcAdapter
        public void notifyCardUid(String aid, String uid) throws RemoteException {
        }

        @Override // com.nxp.nfc.INxpNfcAdapter
        public void notifySwipeCardStatus(String aid, int status) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements INxpNfcAdapter {
        ...
        static final int TRANSACTION_getNfcChip = 58;
        ...
        static final int TRANSACTION_mPOSGetReaderMode = 61;
        static final int TRANSACTION_mPOSSetReaderMode = 60;
        static final int TRANSACTION_manageAutoSwitch = 23;
        static final int TRANSACTION_notifyActiveResult = 59;
        static final int TRANSACTION_notifyCardMatchInfos = 25;
        static final int TRANSACTION_notifyCardRemoved = 17;
        static final int TRANSACTION_notifyCardUid = 64;
        static final int TRANSACTION_notifySwipeCardStatus = 65;
        static final int TRANSACTION_notifyTrafficCardSwipeStatus = 55;
        static final int TRANSACTION_nxpOsuUpdate = 62;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case TRANSACTION_setEmvCoPollProfile /* 10 */:
                        ...
                        int _result9 = setEmvCoPollProfile(_arg1, data.readInt());
                        reply.writeNoException();
                    ...
                    case TRANSACTION_MifareDesfireRouteSet /* 11 */:
                        ...
                        MifareDesfireRouteSet(_arg0, _arg12, _arg2, _arg1);
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_DefaultRouteSet /* 12 */:
                        ...
                        DefaultRouteSet(_arg02, _arg13, _arg22, _arg1);
                        reply.writeNoException();
                        return true;
                    ...
                    case TRANSACTION_updateCurrentDefaultAid /* 20 */:
                        ...
                        updateCurrentDefaultAid(_arg04, _arg15, _arg1);
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_updateDefaultAid /* 21 */:
                        data.enforceInterface(DESCRIPTOR);
                        updateDefaultAid(data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setAutoSwitchSysCfg /* 22 */:
                        data.enforceInterface(DESCRIPTOR);
                        setAutoSwitchSysCfg(data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_manageAutoSwitch /* 23 */:
                        data.enforceInterface(DESCRIPTOR);
                        manageAutoSwitch(data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_syncNfcServiceTa /* 24 */:
                        data.enforceInterface(DESCRIPTOR);
                        boolean syncNfcServiceTa = syncNfcServiceTa(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(syncNfcServiceTa ? 1 : 0);
                        return true;
                    case TRANSACTION_notifyCardMatchInfos /* 25 */:
                        data.enforceInterface(DESCRIPTOR);
                        notifyCardMatchInfos(data.readString(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_updateAutoActivedAidsList /* 26 */:
                        data.enforceInterface(DESCRIPTOR);
                        updateAutoActivedAidsList(data.readArrayList(getClass().getClassLoader()));
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_syncDeactiveCard /* 27 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result13 = syncDeactiveCard(data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result13);
                        return true;
                    case TRANSACTION_syncActiveCard /* 28 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result14 = syncActiveCard(data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result14);
                        return true;
                    case TRANSACTION_getFWVersion /* 29 */:
                        data.enforceInterface(DESCRIPTOR);
                        byte[] _result15 = getFWVersion();
                        reply.writeNoException();
                        reply.writeByteArray(_result15);
                        return true;
                    case TRANSACTION_getServicesAidCacheSize /* 30 */:
                        data.enforceInterface(DESCRIPTOR);
                        Map _result16 = getServicesAidCacheSize(data.readInt(), data.readString());
                        reply.writeNoException();
                        reply.writeMap(_result16);
                        return true;
                    case TRANSACTION_getMaxAidRoutingTableSize /* 31 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result17 = getMaxAidRoutingTableSize();
                        reply.writeNoException();
                        reply.writeInt(_result17);
                        return true;
                    case TRANSACTION_getCommittedAidRoutingTableSize /* 32 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result18 = getCommittedAidRoutingTableSize();
                        reply.writeNoException();
                        reply.writeInt(_result18);
                        return true;
                    case TRANSACTION_getActiveSecureElementList /* 33 */:
                        data.enforceInterface(DESCRIPTOR);
                        int[] _result19 = getActiveSecureElementList(data.readString());
                        reply.writeNoException();
                        reply.writeIntArray(_result19);
                        return true;
                    case TRANSACTION_updateServiceState /* 34 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result20 = updateServiceState(data.readInt(), data.readHashMap(getClass().getClassLoader()));
                        reply.writeNoException();
                        reply.writeInt(_result20);
                        return true;
                    case TRANSACTION_setConfig /* 35 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result21 = setConfig(data.readString(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result21);
                        return true;
                    case TRANSACTION_getNfcInfo /* 36 */:
                        data.enforceInterface(DESCRIPTOR);
                        String _result22 = getNfcInfo(data.readString());
                        reply.writeNoException();
                        reply.writeString(_result22);
                        return true;
                    case TRANSACTION_setNfcPolling /* 37 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result23 = setNfcPolling(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result23);
                        return true;
                    case TRANSACTION_isListenTechMaskEnable /* 38 */:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isListenTechMaskEnable = isListenTechMaskEnable();
                        reply.writeNoException();
                        reply.writeInt(isListenTechMaskEnable ? 1 : 0);
                        return true;
                    case TRANSACTION_setNfcEventCallback /* 39 */:
                        data.enforceInterface(DESCRIPTOR);
                        setNfcEventCallback(INfcEventCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_enablePolling /* 40 */:
                        data.enforceInterface(DESCRIPTOR);
                        enablePolling();
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_disablePolling /* 41 */:
                        data.enforceInterface(DESCRIPTOR);
                        disablePolling();
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getPollingState /* 42 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result24 = getPollingState();
                        reply.writeNoException();
                        reply.writeInt(_result24);
                        return true;
                    case TRANSACTION_getSelectedCardEmulation /* 43 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result25 = getSelectedCardEmulation();
                        reply.writeNoException();
                        reply.writeInt(_result25);
                        return true;
                    case TRANSACTION_selectCardEmulation /* 44 */:
                        data.enforceInterface(DESCRIPTOR);
                        selectCardEmulation(data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getSupportCardEmulation /* 45 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result26 = getSupportCardEmulation();
                        reply.writeNoException();
                        reply.writeInt(_result26);
                        return true;
                    case TRANSACTION_getFirmwareVersion /* 46 */:
                        data.enforceInterface(DESCRIPTOR);
                        String _result27 = getFirmwareVersion();
                        reply.writeNoException();
                        reply.writeString(_result27);
                        return true;
                    case TRANSACTION_is2ndLevelMenuOn /* 47 */:
                        data.enforceInterface(DESCRIPTOR);
                        boolean is2ndLevelMenuOn = is2ndLevelMenuOn();
                        reply.writeNoException();
                        reply.writeInt(is2ndLevelMenuOn ? 1 : 0);
                        return true;
                    case TRANSACTION_set2ndLevelMenu /* 48 */:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg1 = true;
                        }
                        set2ndLevelMenu(_arg1);
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getDumpInfoForChr /* 49 */:
                        data.enforceInterface(DESCRIPTOR);
                        String _result28 = getDumpInfoForChr();
                        reply.writeNoException();
                        reply.writeString(_result28);
                        return true;
                    case TRANSACTION_bindSeService /* 50 */:
                        data.enforceInterface(DESCRIPTOR);
                        bindSeService(ISecureElementCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getInfoFromConfigFile /* 51 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result29 = getInfoFromConfigFile(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result29);
                        return true;
                    case TRANSACTION_setFelicaRouteToEse /* 52 */:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg1 = true;
                        }
                        setFelicaRouteToEse(_arg1);
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_isFelicaRouteToEse /* 53 */:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isFelicaRouteToEse = isFelicaRouteToEse();
                        reply.writeNoException();
                        reply.writeInt(isFelicaRouteToEse ? 1 : 0);
                        return true;
                    case TRANSACTION_configureSecureReader /* 54 */:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg1 = true;
                        }
                        int _result30 = configureSecureReader(_arg1, data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result30);
                        return true;
                    case TRANSACTION_notifyTrafficCardSwipeStatus /* 55 */:
                        data.enforceInterface(DESCRIPTOR);
                        notifyTrafficCardSwipeStatus(data.readString(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_doWriteT4tData /* 56 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result31 = doWriteT4tData(data.createByteArray(), data.createByteArray(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result31);
                        return true;
                    case TRANSACTION_doReadT4tData /* 57 */:
                        data.enforceInterface(DESCRIPTOR);
                        byte[] _result32 = doReadT4tData(data.createByteArray());
                        reply.writeNoException();
                        reply.writeByteArray(_result32);
                        return true;
                    case TRANSACTION_getNfcChip /* 58 */:
                        data.enforceInterface(DESCRIPTOR);
                        String _result33 = getNfcChip();
                        reply.writeNoException();
                        reply.writeString(_result33);
                        return true;
                    case TRANSACTION_notifyActiveResult /* 59 */:
                        data.enforceInterface(DESCRIPTOR);
                        notifyActiveResult(data.readString(), data.readInt(), data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_mPOSSetReaderMode /* 60 */:
                        data.enforceInterface(DESCRIPTOR);
                        String _arg05 = data.readString();
                        if (data.readInt() != 0) {
                            _arg1 = true;
                        }
                        int _result34 = mPOSSetReaderMode(_arg05, _arg1);
                        reply.writeNoException();
                        reply.writeInt(_result34);
                        return true;
                    case TRANSACTION_mPOSGetReaderMode /* 61 */:
                        data.enforceInterface(DESCRIPTOR);
                        boolean mPOSGetReaderMode = mPOSGetReaderMode(data.readString());
                        reply.writeNoException();
                        reply.writeInt(mPOSGetReaderMode ? 1 : 0);
                        return true;
                    case TRANSACTION_nxpOsuUpdate /* 62 */:
                        data.enforceInterface(DESCRIPTOR);
                        nxpOsuUpdate();
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getCPLCFromVn /* 63 */:
                        data.enforceInterface(DESCRIPTOR);
                        byte[] _result35 = getCPLCFromVn();
                        reply.writeNoException();
                        reply.writeByteArray(_result35);
                        return true;
                    case TRANSACTION_notifyCardUid /* 64 */:
                        data.enforceInterface(DESCRIPTOR);
                        notifyCardUid(data.readString(), data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_notifySwipeCardStatus /* 65 */:
                        data.enforceInterface(DESCRIPTOR);
                        notifySwipeCardStatus(data.readString(), data.readInt());
                        reply.writeNoException();
                        return true;
                    default:
        ...
        public static class Proxy implements INxpNfcAdapter {
            ...
            public int configureSecureReader(boolean on, String readerType) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(readerType);
                    if (!this.mRemote.transact(Stub.TRANSACTION_configureSecureReader, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().configureSecureReader(on, readerType);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
            ...
            public void notifyTrafficCardSwipeStatus(String aid, int status) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_notifyTrafficCardSwipeStatus, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
                    }
                    Stub.getDefaultImpl().notifyTrafficCardSwipeStatus(aid, status);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public String getNfcChip() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getNfcChip, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getNfcChip();
                    }
                    _reply.readException();
                    String _result = _reply.readString();
                    _reply.recycle();
            ...
            public void notifyActiveResult(String aid, int type, String result) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_notifyActiveResult, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
                    }
                    Stub.getDefaultImpl().notifyActiveResult(aid, type, result);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void nxpOsuUpdate() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (this.mRemote.transact(Stub.TRANSACTION_nxpOsuUpdate, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
                    }
                    Stub.getDefaultImpl().nxpOsuUpdate();
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public byte[] getCPLCFromVn() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getCPLCFromVn, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getCPLCFromVn();
                    }
                    _reply.readException();
                    byte[] _result = _reply.createByteArray();
                    _reply.recycle();
            ...
            public void notifyCardUid(String aid, String uid) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_notifyCardUid, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
                    }
                    Stub.getDefaultImpl().notifyCardUid(aid, uid);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void notifySwipeCardStatus(String aid, int status) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(aid);
                    _data.writeInt(status);
                    if (this.mRemote.transact(Stub.TRANSACTION_notifySwipeCardStatus, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
                    }
                    Stub.getDefaultImpl().notifySwipeCardStatus(aid, status);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }

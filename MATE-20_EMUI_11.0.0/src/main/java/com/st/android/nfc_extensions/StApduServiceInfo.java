...
public final class StApduServiceInfo implements Parcelable {
    ...
    public StApduServiceInfo(PackageManager pm, ResolveInfo info, boolean onHost) throws XmlPullParserException, IOException {
        ...
        XmlResourceParser extParser4 = null;
        String seName2 = null;
        if (onHost) {
            try {
            ...
            try {
                ...
                extParser4 = si.loadXmlMetaData(pm, ST_NFC_EXT_META_DATA);
                if (extParser4 == null) {
                    Log.d(TAG, "No com.gsma.services.nfc.extensions meta-data");
                }
                if (parser == null && extParser4 == null) {
        ...
        try {
            ...
            if (onHost && !"host-apdu-service".equals(tagName)) {
                ...
                String str9 = "SIM1";
                String str10 = SECURE_ELEMENT_UICC;
                String str11 = SECURE_ELEMENT_ESE;
                String str12 = "eSE";
                if (onHost) {
                    try {
                        attrs = attrs2;
                    ...
                    try {
                        ...
                        if (seName != null) {
                            try {
                                if (seName.equals(str12)) {
                                    seName = str11;
                                } else if (seName.equals(str10)) {
                                    seName = str9;
                                }
                                    ...
                                    if (eventType4 == 2 && "se-id".equals(tagName4)) {
                                        ...
                                        try {
                                            ...
                                            if (!seName.equalsIgnoreCase(str)) {
                                                str8 = str2;
                                                if (!seName.equalsIgnoreCase(str8)) {
                                                    str6 = str3;
                                                    if (seName.equalsIgnoreCase(str6)) {
                                                        depth = depth3;
                                                        str7 = str4;
                                                    } else if (!seName.equalsIgnoreCase("SIM2")) {
                                                        str7 = str4;
                                                        if (!seName.equalsIgnoreCase(str7)) {
                                                            depth = depth3;

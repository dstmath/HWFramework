                        ...
                        if (maxConnections != null) {
                            try {
                                ...
                                if (isLoggingEnabled()) {
                                    ...
                                    stackLogger2.logError("max connections - bad value " + ex3.getMessage());
                                }
                            }
                        }
                        ...
                        if (threadPoolSize != null) {
                            try {
                                ...
                                if (isLoggingEnabled()) {
                                    ...
                                    stackLogger3.logError("thread pool size - bad value " + ex4.getMessage());
                                }
                            }
                        }
                        ...
                        if (serverTransactionTableSize != null) {
                            try {
                                ...
                                if (isLoggingEnabled()) {
                                    ...
                                    stackLogger4.logError("transaction table size - bad value " + ex5.getMessage());
                                }
                            }
                        } else {
                        ...
                        if (clientTransactionTableSize != null) {
                            try {
                                ...
                                if (isLoggingEnabled()) {
                                    ...
                                    stackLogger5.logError("transaction table size - bad value " + ex6.getMessage());
                                }
                            }
                            z = true;
                        } else {
                        ...
                        if (maxMsgSize == null) {
                            try {
                                ...
                                if (!isLoggingEnabled()) {
                                    ...
                                    stackLogger7.logError("maxMessageSize - bad value " + ex2.getMessage());
                                }

...
public class HwDeviceAdminInfo implements IHwDeviceAdminInfo {
    ...
    public static final int USES_POLICY_SET_MDM_DEVICE_OWNER = 30;
    ...
    public static final int USES_POLICY_SET_MDM_VOICEASSISTANT = 31;
    ...
    static {
        ...
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(14, "com.huawei.permission.sec.MDM_PHONE_MANAGER", 33686176, 33686160));
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(15, "com.huawei.permission.sec.SDK_LAUNCHER", 33686175, 33686158));
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(16, "com.huawei.permission.sec.MDM_CAPTURE_SCREEN", 33686169, 33686151));
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(17, "com.huawei.permission.sec.MDM_VPN", 33686181, 33686165));
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(18, "com.huawei.permission.sec.MDM_FIREWALL", 33686172, 33686154));
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(19, "com.huawei.permission.sec.MDM_UPDATESTATE_MANAGER", 33686179, 33686163));
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(20, "com.huawei.permission.sec.MDM_CLIPBOARD", 33686170, 33686152));
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(21, "com.huawei.permission.sec.MDM_GOOGLE_ACCOUNT", 33686173, 33686155));
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(22, "com.huawei.permission.sec.MDM_SETTINGS_RESTRICTION", 33686177, 33686161));
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(23, "com.huawei.permission.sec.MDM_TELEPHONY", 33686178, 33686162));
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(24, "com.huawei.permission.sec.MDM_KEYGUARD", 33686174, 33686157));
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(25, "com.huawei.permission.sec.MDM_INFRARED", 33686166, 33686149));
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(26, "com.huawei.permission.sec.MDM_CAMERA", 33686168, 33686150));
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(27, "com.huawei.systemmanager.permission.ACCESS_INTERFACE", 33686167, 33686156));
        ...
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(30, "com.huawei.permission.sec.MDM_DEVICE_OWNER", 33686171, 33686153));
        sPoliciesDisplayOrder.add(new IHwDeviceAdminInfo.PolicyInfo(31, "com.huawei.permission.sec.MDM_VOICEASSISTANT", 33686180, 33686164));

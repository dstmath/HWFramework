...
public class HwDevicePolicyManagerEx {
    ...
    public void setBluetoothDisabled(ComponentName who, boolean disabled) {
        this.mSponsor.transactTo_setFunctionDisabled(ConstantValue.transaction_setBluetoothDisabled, "setBluetoothDisabled", who, disabled, UserHandle.myUserId());
    }
    ...
    public void installPackage(ComponentName admin, String packagePath) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_installPackage, "installPackage", admin, packagePath, UserHandle.myUserId());
    }
    ...
    public void clearPackageData(ComponentName admin, String packageName) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_clearPackageData, "clearPackageData", admin, packageName, UserHandle.myUserId());
    }
    ...
    public void disableInstallSource(ComponentName admin, List<String> whitelist) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_disableInstallSource, "disableInstallPackage", admin, whitelist, UserHandle.myUserId());
    }
    ...
    public void addPersistentApp(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_addPersistentApp, "addPersistentApp", admin, packageNames, UserHandle.myUserId());
    }

    public void removePersistentApp(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_removePersistentApp, "removePersistentApp", admin, packageNames, UserHandle.myUserId());
    }
    ...
    public void addDisallowedRunningApp(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_addDisallowedRunningApp, "addDisallowedRunningApp", admin, packageNames, UserHandle.myUserId());
    }

    public void removeDisallowedRunningApp(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_removeDisallowedRunningApp, "removeDisallowedRunningApp", admin, packageNames, UserHandle.myUserId());
    }
    ...
    public void addInstallPackageWhiteList(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_addInstallPackageWhiteList, "add_install_packages", admin, packageNames, UserHandle.myUserId());
    }

    public void addInstallPackageTrustList(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand(ConstantValue.TRANSACTION_ADD_INSTALL_PACKAGE_TRUST_LIST, "add_install_packages", admin, packageNames, UserHandle.myUserId());
    }

    public void removeInstallPackageWhiteList(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_removeInstallPackageWhiteList, "remove_install_packages", admin, packageNames, UserHandle.myUserId());
    }

    public void removeInstallPackageTrustList(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand(ConstantValue.TRANSACTION_REMOVE_INSTALL_PACKAGE_TRUST_LIST, "remove_install_packages", admin, packageNames, UserHandle.myUserId());
    }
    ...
    public void addDisallowedUninstallPackages(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_addDisallowedUninstallPackages, "add_notuninstall_packages", admin, packageNames, UserHandle.myUserId());
    }

    public void removeDisallowedUninstallPackages(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_removeDisallowedUninstallPackages, "remove_notuninstall_packages", admin, packageNames, UserHandle.myUserId());
    }
    ...
    public void addDisabledDeactivateMdmPackages(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_addDisabledDeactivateMdmPackages, "add_disabled_deactive_Mdm_packages", admin, packageNames, UserHandle.myUserId());
    }

    public void removeDisabledDeactivateMdmPackages(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_removeDisabledDeactivateMdmPackages, "remove_disabled_deactive_Mdm_packages", admin, packageNames, UserHandle.myUserId());
    }
    ...
    public void killApplicationProcess(ComponentName admin, String packageName) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_killApplicationProcess, "killApplicationProcess", admin, packageName, UserHandle.myUserId());
    }
    ...
    public void setSysTime(ComponentName admin, long millis) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_setSysTime, "setSysTime", admin, String.valueOf(millis), UserHandle.myUserId());
    }
    ...
    public void setCustomSettingsMenu(ComponentName admin, List<String> menusToDelete) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_setCustomSettingsMenu, "setCustomSettingsMenu", admin, menusToDelete, UserHandle.myUserId());
    }

    public void addApn(ComponentName admin, Map<String, String> apninfo) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_addApn, "addApn", admin, apninfo, 0);
    }

    public void deleteApn(ComponentName admin, String id) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_deleteApn, "deleteApn", admin, id, 0);
    }
    ...
    public void setPreferApn(ComponentName admin, String id) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_setPreferApn, "setPreferApn", admin, id, 0);
    }

    public void addNetworkAccessWhitelist(ComponentName admin, List<String> addrList) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_addNetworkAccessWhitelist, "addNetworkAccessWhitelist", admin, addrList, 0);
    }

    public void removeNetworkAccessWhitelist(ComponentName admin, List<String> addrList) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_removeNetworkAccessWhitelist, "removeNetworkAccessWhitelist", admin, addrList, 0);
    }
    ...
    public Bundle getPolicy(ComponentName who, String policyName, int userId) {
        return this.mSponsor.transactTo_getPolicy(ConstantValue.transaction_getPolicy, policyName, null, "getPolicy", who, userId, 0);
    }
    ...
    public void setDeviceOwnerApp(ComponentName admin, String ownerName) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_setDeviceOwnerApp, "setDeviceOwnerApp", admin, ownerName, UserHandle.myUserId());
    }
    ...
    public void resetNetworkSetting(ComponentName who) {
        this.mSponsor.transactTo_execCommand(ConstantValue.transaction_resetNetworkSetting, "resetNetworkSetting", who, UserHandle.myUserId());
    }

    public boolean setDefaultDataCard(ComponentName who, int slotId, Message response) {
        return this.mSponsor.transactToSetDefaultDataCard(ConstantValue.TRANSACTION_SET_DEFAULT_DATA_CARD, "setDefaultDataCard", who, slotId, response, UserHandle.myUserId());
    }
}

...
public class MpLinkCommonDefs {
    public static final int AP_TYPE_DJI_DRONE = 1;
    public static final int AP_TYPE_NORMAL = 0;
    public static final String BASE_TAG = "HiData_";
    public static final String INTENT_MPLINK_CHECK_REQUEST_SUCCESS = "mplink_intent_check_request_success";
    public static final String INTENT_MPLINK_KEY_REQUEST_CHECK = "mplink_intent_key_check_request";

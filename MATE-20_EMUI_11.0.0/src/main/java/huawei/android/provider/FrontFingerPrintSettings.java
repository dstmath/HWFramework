...
public class FrontFingerPrintSettings {
    ...
    public static final int SINGLE_VIRTUAL_AI_MODE = SystemProperties.getInt("ro.config.show_navbar_slide", CN_OPTB.equals(SystemProperties.get("ro.config.hw_optb", "0")) ? 1 : 0);
    ...
    public static boolean isChinaArea() {
        return CN_OPTB.equals(SystemProperties.get("ro.config.hw_optb", "0"));
    }

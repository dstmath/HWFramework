...
public class HwSettingsManagerImpl implements HwSettingsManager {
    ...
    private static HwSettingsManager sHwSettingsManager = null;

    private HwSettingsManagerImpl() {
    }

    public static synchronized HwSettingsManager getDefault() {
        HwSettingsManager hwSettingsManager;
        synchronized (HwSettingsManagerImpl.class) {
            if (sHwSettingsManager == null) {
                sHwSettingsManager = new HwSettingsManagerImpl();
            }
            hwSettingsManager = sHwSettingsManager;
        }
        return hwSettingsManager;
    }

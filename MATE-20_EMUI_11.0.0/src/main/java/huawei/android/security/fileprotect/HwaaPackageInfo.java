    ...
    public static class Builder {
        ...
        private String generatePolicys(List<HwaaPolicy> policys) {
            ...
            try {
                ...
                Log.w(HwaaPackageInfo.TAG, "Json constuct falied!");
            }
        ...
        private String getSHA256String(String input) {
            ...
            try {
                ...
                Log.e(HwaaPackageInfo.TAG, "NoSuchAlgorithm for getSHA");
                return null;
            } catch (UnsupportedEncodingException e2) {
                Log.e(HwaaPackageInfo.TAG, "encoding not supported for utf-8");
                return null;
            }
        }

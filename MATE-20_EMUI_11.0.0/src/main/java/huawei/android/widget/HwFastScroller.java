...
public class HwFastScroller extends FastScrollerEx {
    ...
    public void measureViewToSide(View view, View adjacent, Rect margins, Rect out) {
        ...
        view.measure(View.MeasureSpec.makeMeasureSpec((getMaxWidth(adjacent, containerWidth) - marginLeft) - marginRight, FloatConsts.SIGN_BIT_MASK), View.MeasureSpec.makeMeasureSpec(0, 0));

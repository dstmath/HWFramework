...
public class HwToolbar extends Toolbar {
    ...
    public void setMenu(MenuBuilder menu, ActionMenuPresenter outerPresenter) {
        if (outerPresenter != null) {
            ...
            this.mActionMenuPresenter.setId(16908726);
    ...
    private void ensureSplitView() {
        if (this.mSplitView == null) {
            ...
            if (activity != null) {
                ...
                View splitView = decor.findViewById(16909433);
                ...
                this.mSplitView.setId(16909433);
    ...
    public void initIconLayout() {
        ...
        this.mTitleView = (HwTextView) this.mIconLayout.findViewById(16908722);
        this.mSubTitleView = (HwTextView) this.mIconLayout.findViewById(16908721);
        this.mTitleView.setAutoTextInfo(this.mTitleMinSize, this.mTitleSizeStep, 1);
    ...
    private void initStartAndEndIconLayout() {
        ...
        if (this.mIconLayout != null && (resLoader = this.mResLoader) != null) {
            ...
            setViewClickEffectBackground(this.mIcon2View, IS_DEBUG);
    ...
    private void setViewClickEffectBackground(View view, boolean isNeedInset) {
        ...
        if (view != null && (clickEffectEntry = this.mClickEffectEntry) != null) {
            ...
            if (isNeedInset) {
                ...
                view.setBackground(new InsetDrawable((Drawable) iconBgDrawable, 0, i, 0, i));
                return;
            }

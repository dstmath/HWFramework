...
public class NumberPicker extends android.widget.NumberPicker {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mVelocityStage1 = ((float) i) * 0.1f;
        ...
        this.mEdgeOffsetTop = res.getDimensionPixelSize(34472742);
        this.mInternalOffsetAbove = res.getDimensionPixelSize(34472744);
        this.mInternalOffsetBelow = res.getDimensionPixelSize(34472745);
    ...
    private void initialNumberPicker(Context context, AttributeSet attrs) {
        ...
        this.mGradientHeight = res.getDimensionPixelSize(34472743);

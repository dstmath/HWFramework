...
public class PinTextField extends EditText {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mDivideWidth = res.getDimensionPixelSize(34472834);
        setBackground(null);
        setRawInputType(128);
        setPadding(0, 0, 0, 0);
        setCursorVisible(false);
        this.mLeftBg = res.getDrawable(33752150);
        this.mMiddleBg = res.getDrawable(33752151);
        this.mRightBg = res.getDrawable(33752152);
        this.mPinSize = res.getDimensionPixelSize(34472835);

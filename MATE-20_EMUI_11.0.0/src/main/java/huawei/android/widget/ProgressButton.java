...
public class ProgressButton extends View {
    ...
    private synchronized void initProgressButton(Context context) {
        ...
        this.mMaxWidth = res.getDimensionPixelSize(34472756);
        this.mMinWidth = res.getDimensionPixelSize(34472758);
        this.mMaxHeight = res.getDimensionPixelSize(34472755);
        this.mMinHeight = res.getDimensionPixelSize(34472757);
        this.mTextSize = res.getDimensionPixelSize(34472762);
        this.mTextPaddingLeft = res.getDimensionPixelSize(34472760);
        this.mTextPaddingRight = res.getDimensionPixelSize(34472761);
        this.mProgressDrawable = res.getDrawable(33752061);
        this.mTextColor = res.getColor(33883046);
    }
    ...
    private synchronized void initAttrs(Context context, AttributeSet attrs, int defStyle, int styleRes) {
        if (attrs != null) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ProgressButton, defStyle, styleRes);
            if (a != null) {

...
public class PullUpListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private static final int PADDING_FACTOR = -1;
    ...
    private void initInternal(Context context) {
        ...
        View view = ResLoaderUtil.getLayout(this.mContext, "pullup_listview_foot", null, false);
        if (view instanceof RelativeLayout) {
            this.mFooterView = (RelativeLayout) view;
            ...
            this.mRefreshingAnimation = new RotateAnimation(0.0f, REFRESHING_ANIMATION_TO_DEGREES, 1, 0.5f, 1, 0.5f);
        ...
        if (action == 0) {
            ...
            if (this.mIsBottomDownRecorded) {
                if (this.mIsRefreshing && this.mFooterView.getPaddingBottom() >= 0) {
                    ...
                    if (i == 1) {
                        pullToRefresh();
                    } else if (i == 3 && ((float) tempY) - this.mStartY > 0.0f) {
                        this.mState = 1;

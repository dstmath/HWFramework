...
public class TimePicker extends android.widget.TimePicker {
    ...
    private void updateAmPmStart() {
        ...
        if (obj != null) {
            ...
            if ((objBool instanceof Boolean) && ((Boolean) objBool).booleanValue() && (timeDividerMinuteAndAmPm = (amPmParent = (ViewGroup) findViewById(16909505)).findViewById(34603117)) != null) {

...
public class HwCollapsingToolbarLayout extends FrameLayout {
    ...
    public HwCollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (theme != null) {
            TypedArray a = theme.obtainStyledAttributes(attrs, R.styleable.HwCollapsingToolbarLayout, 34668596, 33947772);
    ...
    private void updateDummyView() {
        ...
        if (this.mCollapsingTitleEnabled && this.mToolbar != null) {
            ...
            if (this.mDummyView != null) {
                ...
                this.mTitleView = (TextView) this.mDummyView.findViewById(16908722);
                ...
                this.mSubTitleView = (TextView) this.mDummyView.findViewById(16908721);
                setSubTitleVisible();
            }
        }
    }

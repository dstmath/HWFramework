...
public class HwColumnSystem {
    ...
    private static final int[][] MAX_COLUMN_DEFINE = {new int[]{4, 6, 8}, new int[]{4, 6, 8}, new int[]{4, 6, 8}, new int[]{4, 6, 8}, new int[]{4, 6, 6}, new int[]{4, 6, 6}, new int[]{4, 6, 6}, new int[]{-2, 8, 8}, new int[]{4, 6, 10}, new int[]{-2, 8, 12}, new int[]{4, 6, 8}, new int[]{4, 6, 8}, new int[]{4, 4, 5}, new int[]{3, 4, 4}, new int[]{4, 5, 5}};
    public static final int MENU_TYPE = 10;
    private static final int[][] MIN_COLUMN_DEFINE = {new int[]{4, 6, 8}, new int[]{2, 3, 4}, new int[]{4, 6, 8}, new int[]{4, 6, 8}, new int[]{4, 6, 6}, new int[]{2, 2, 2}, new int[]{4, 6, 6}, new int[]{-2, 8, 8}, new int[]{4, 6, 10}, new int[]{-2, 8, 12}, new int[]{2, 2, 2}, new int[]{4, 6, 8}, new int[]{4, 4, 5}, new int[]{3, 4, 4}, new int[]{4, 5, 5}};
    ...
    private void initContentType() {
        ...
        this.mColumnCount = this.mContext.getResources().getInteger(34275357);
        this.mMaxColumnCount = this.mContext.getResources().getInteger(34275358);
    }
    ...
    private void initSingleButtonType() {
        ...
        this.mColumnCount = this.mContext.getResources().getInteger(34275353);
        this.mMaxColumnCount = this.mContext.getResources().getInteger(34275354);
    }

    private void initDoubleButtonType() {
        this.mMargin = this.mContext.getResources().getDimensionPixelOffset(34472374);
        this.mGutter = this.mContext.getResources().getDimensionPixelOffset(34472373);
        this.mColumnCount = this.mContext.getResources().getInteger(34275359);
        this.mMaxColumnCount = this.mContext.getResources().getInteger(34275360);
    }
    ...
    private void initToastType() {
        ...
        this.mColumnCount = this.mContext.getResources().getInteger(34275375);
        this.mMaxColumnCount = this.mContext.getResources().getInteger(34275376);
    }

    private void initMenuType() {
        this.mMargin = this.mContext.getResources().getDimensionPixelOffset(34472382);
        this.mGutter = this.mContext.getResources().getDimensionPixelOffset(34472381);
        this.mColumnCount = this.mContext.getResources().getInteger(34275367);
        this.mMaxColumnCount = this.mContext.getResources().getInteger(34275368);
    }
    ...
    private void initSmallToolbarType() {
        ...
        this.mColumnCount = this.mContext.getResources().getInteger(34275373);
        this.mMaxColumnCount = this.mContext.getResources().getInteger(34275374);
    }

    private void initLargeToolbarType() {
        this.mMargin = this.mContext.getResources().getDimensionPixelOffset(34472380);
        this.mGutter = this.mContext.getResources().getDimensionPixelOffset(34472379);
    ...
    private void initSmallBottomTabType() {
        this.mMargin = this.mContext.getResources().getDimensionPixelOffset(34472384);
        this.mGutter = this.mContext.getResources().getDimensionPixelOffset(34472383);
        this.mColumnCount = this.mContext.getResources().getInteger(34275369);
        this.mMaxColumnCount = this.mContext.getResources().getInteger(34275370);
    }

    private void initLargeBottomTabType() {
        this.mMargin = this.mContext.getResources().getDimensionPixelOffset(34472376);
        this.mGutter = this.mContext.getResources().getDimensionPixelOffset(34472375);
        this.mColumnCount = this.mContext.getResources().getInteger(34275361);
        this.mMaxColumnCount = this.mContext.getResources().getInteger(34275362);
    }
    ...
    private void initCardType() {
        ...
        this.mColumnCount = this.mContext.getResources().getInteger(34275355);
        this.mMaxColumnCount = this.mContext.getResources().getInteger(34275356);
    }
    ...
    private void initBubbleType() {
        ...
        this.mColumnCount = this.mContext.getResources().getInteger(34275351);
        this.mMaxColumnCount = this.mContext.getResources().getInteger(34275352);
    }

    private void initSmallDialogType() {
        this.mMargin = this.mContext.getResources().getDimensionPixelOffset(34472386);
        this.mGutter = this.mContext.getResources().getDimensionPixelOffset(34472385);
        this.mColumnCount = this.mContext.getResources().getInteger(34275371);
        this.mMaxColumnCount = this.mContext.getResources().getInteger(34275372);
    }

    private void initLargeDialogType() {
        this.mMargin = this.mContext.getResources().getDimensionPixelOffset(34472378);
        this.mGutter = this.mContext.getResources().getDimensionPixelOffset(34472377);
        this.mColumnCount = this.mContext.getResources().getInteger(34275363);
        this.mMaxColumnCount = this.mContext.getResources().getInteger(34275364);
    }
    ...
    private void initResource() {
        ...
        if (context != null) {
            this.mTotalColumn = context.getResources().getInteger(34275377);
            int i = this.mColumnType;
            if (i == 12 || i == 13 || i == 14) {
                switchDialogType();
            }

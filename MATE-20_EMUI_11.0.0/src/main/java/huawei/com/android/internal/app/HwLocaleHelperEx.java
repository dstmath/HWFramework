...
public class HwLocaleHelperEx implements IHwLocaleHelperEx {
    private static final boolean IS_DT = "150".equals(SystemProperties.get("ro.config.hw_opta", "0"));
    private static final boolean IS_HIDE_COUNTRY_NAME = SystemProperties.getBoolean("ro.config.hw_hide_country_name", false);
    private static final boolean IS_MKD = "807".equals(SystemProperties.get("ro.config.hw_optb", "0"));

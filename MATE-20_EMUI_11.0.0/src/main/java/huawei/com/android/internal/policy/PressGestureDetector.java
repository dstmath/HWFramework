...
public class PressGestureDetector implements IPressGestureDetector {
    ...
    private void updateDisplayParameters() {
        ...
        if (!SystemProperties.get("ro.config.hw_notch_size", StorageManagerExt.INVALID_KEY_DESC).trim().isEmpty()) {
            int notchHeight = this.mContextActivity.getResources().getDimensionPixelSize(17105445);

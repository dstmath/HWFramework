...
public class HwActionBarContextView extends ActionBarContextView implements View.OnClickListener, ActionModeView {
    ...
    public HwActionBarContextView(Context context, AttributeSet attrs) {
        ...
        this.mOkMenuItem = new ActionMenuItem(context, 0, 16909225, 0, 0, context.getString(17039370));
        this.mCancelMenuItem = new ActionMenuItem(context, 0, 16908825, 0, 0, context.getString(17039360));
    ...
    private LinearLayout initTitleLayout() {
        ...
        this.mOk = (ImageView) titleLayout.findViewById(16909225);
        this.mCancel = (ImageView) titleLayout.findViewById(16908825);
    ...
    public void initTitle() {
        ...
        if (titleLayout == null && (titleLayout = initTitleLayout()) != null) {
            titleView = (TextView) titleLayout.findViewById(16908722);
            subTitleView = (TextView) titleLayout.findViewById(16908721);
            if (titleView != null) {
    ...
    public void onLayout(boolean isChanged, int left, int top, int right, int bottom) {
        ...
        if (isChanged && getParent() != null && (getParent() instanceof ViewGroup) && (viewGroup = (ViewGroup) getParent()) != null && viewGroup.getId() != 16909433 && viewGroup.getId() != 16908719) {

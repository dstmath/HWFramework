...
public class BreathImageDrawable extends BitmapDrawable {
    ...
    private void initBreathTouchAnim() {
        this.mBreathTouchAnim = ObjectAnimator.ofFloat(this, "BreathCircleScale", 1.0f, 1.3f);
    ...
    public void startTouchUpBreathAnim() {
        ...
        this.mBreathTouchAnim.setFloatValues(1.3f, 1.0f);
        this.mBreathTouchAnim.start();
    }
    ...
    public static class FastOutSlowInInterpolator implements Interpolator {
        ...
        public float getInterpolation(float input) {
            ...
            if (((int) (((float) (fArr.length - 1)) * input)) < fArr.length - 2) {
                position = (int) (((float) (fArr.length - 1)) * input);
            } else {
                position = fArr.length - 2;
            }

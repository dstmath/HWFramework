...
public class HwFalseTouchMonitor extends DefaultHwFalseTouchMonitor {
    ...
    public class TrembleChecker extends FalseTouchChecker {
        ...
        public boolean reportData() {
            ...
            eventStream.setParam(eventStream, (short) HwFalseTouchMonitor.FT_OLD_WIN, HwFalseTouchMonitor.this.mLastUpPoint.getX() + "," + HwFalseTouchMonitor.this.mLastUpPoint.getY());
    ...
    public class NoEffectClickChecker extends FalseTouchChecker {
        ...
        public boolean reportData() {
            ...
            eventStream.setParam(eventStream, (short) HwFalseTouchMonitor.FT_OLD_WIN, this.mNearbyEdgePoint.getX() + "," + this.mNearbyEdgePoint.getY());
            eventStream.setParam(eventStream, (short) HwFalseTouchMonitor.FT_NEW_WIN, this.mCentralClickPoint.getX() + "," + this.mCentralClickPoint.getY());
            IMonitorExt.sendEvent(eventStream);
            IMonitorExt.closeEventStream(eventStream);

...
public class HwScreenOnProximityLock extends DefaultHwScreenOnProximityLock {
    ...
    private static final String HW_CURVED_SIDE = SystemPropertiesEx.get("ro.config.hw_curved_side_disp", "");
    private static final String HW_NOTCH_SIZE = SystemPropertiesEx.get("ro.config.hw_notch_size", "");
    ...
    private void initProximityView(boolean isFoldFullScreen) {
        ...
        if (!isLandScape() || isFoldFullScreen) {
            if (this.mIsHasSensorDevice) {
                ...
                view = View.inflate(this.mContext, 34013450, null);
            }

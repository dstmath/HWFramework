...
public class HwCarrierConfigPolicy implements IHwCarrierConfigPolicy {
    ...
    private static final boolean IS_MULTI_SIM_ENABLED = TelephonyManager.getDefault().isMultiSimEnabled();
    ...
    public String getOpKey(int slotId) {
        ...
        if (opKey == null || StorageManagerExt.INVALID_KEY_DESC.equals(opKey.trim())) {
            return null;
        }
        return opKey;
    }
    ...
    public <T> T getValue(String key, int slotId, Class<T> clazz) {
        ...
        try {
            ...
            if (data == null || (value = data.get(key)) == null) {
                return null;
            }
            ...
            loge("Error getValue for slotId " + slotId);
            return null;
        }
    }
    ...
    public SimMatchRule querySimMatchRule(String mccmnc, String iccid, String imsi, int slotId) {
        ...
        try {
            ...
            loge("Error querySimRule for slotId " + slotId);
            return null;
        }
    }
    ...
    public void updateSimFileInfo(SimFileInfo simFileInfo, int slotId) {
        ...
        try {
            ...
            loge("Error updateSimFileInfo for slotId " + slotId);
        }
    }
    ...
    private int getDefaultSlotId() {
        String opKey;
        String opKey2;
        if (!IS_MULTI_SIM_ENABLED || (((opKey = getOpKey(0)) != null && !StorageManagerExt.INVALID_KEY_DESC.equals(opKey.trim())) || (opKey2 = getOpKey(1)) == null || StorageManagerExt.INVALID_KEY_DESC.equals(opKey2.trim()))) {
            return 0;
        }
        return 1;
    }

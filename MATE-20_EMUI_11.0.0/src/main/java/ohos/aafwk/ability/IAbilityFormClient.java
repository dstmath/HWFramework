                ...
                if (componentProvider.setApplyType(2)) {
                    try {
                        ...
                        if (!componentProvider.setApplyType(applyType)) {
                            HiLog.error(LABEL, "set apply type error. after marshalling actions in remote views.", new Object[0]);
                    ...
                    HiLog.error(LABEL, "set apply type error. before marshalling actions in remote views.", new Object[0]);
                    throw new RemoteException();
                }
            }

...
public class Intent implements Sequenceable {
    ...
    public static final int FLAG_ABILITY_CLEAR_TASK = 32768;
    public static final int FLAG_ABILITY_CONTINUATION = 8;
    public static final int FLAG_ABILITY_CONTINUATION_REVERSIBLE = 96;
    public static final int FLAG_ABILITY_FORM_ENABLED = 32;
    public static final int FLAG_ABILITY_FORWARD_RESULT = 4;
    public static final int FLAG_ABILITY_NEW_TASK = 268435456;
    ...
    private void convertImplicitToExplicit(ElementName elementName) {
        if (elementName != null) {
            Operation build = new OperationBuilder().withFlags(this.operation.getFlags()).withAbilityName(elementName.getAbilityName()).withBundleName(elementName.getBundleName()).withDeviceId(elementName.getDeviceId()).withAction(this.operation.getAction()).withEntities(this.operation.getEntities()).withUri(this.operation.getUri()).build();
    ...
    public boolean marshalling(Parcel parcel) {
        ...
        if (parcel.writeInt(this.operation.getFlags()) && marshallingSequenceable(parcel, this.element) && marshallingSequenceable(parcel, this.parameters) && parcel.writeString(this.operation.getBundleName()) && marshallingSequenceable(parcel, this.picker)) {
            return true;
        }
        return false;
    }
    ...
    public boolean unmarshalling(Parcel parcel) {
        ...
        this.operation.setBundleName(parcel.readString());
        this.picker = null;
        if (parcel.readInt() == 1) {
    ...
    private static boolean parseArrayParam(String str, String str2, String str3, Intent intent) {
        if (str3.startsWith("[") && str3.endsWith("]")) {
            ...
            try {
                ...
                } else if (str2.equals("CharSequenceArray")) {
    ...
    private static boolean parseUriInternal(String str, Intent intent) {
        ...
        if (!substring.isEmpty()) {
            ...
            } else if (trim.equals(Constants.ELEMNAME_URL_STRING)) {
                intent.setUri(Uri.parse(decode(substring)));
            } else if (trim.equals("entity")) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.operation.getAction(), intent.getAction()) || !Objects.equals(this.operation.getUri(), intent.getUri()) || !Objects.equals(this.operation.getBundleName(), intent.getBundle()) || !Objects.equals(this.element, intent.getElement()) || !Objects.equals(this.operation.getEntities(), intent.getEntities())) {
            return false;
        }
        return true;
    }

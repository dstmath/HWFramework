...
public class IntentFilter implements Sequenceable {
    public static final Sequenceable.Producer<IntentFilter> PRODUCER = $$Lambda$IntentFilter$AOfaCfB_Wd49tve8QMlDOeoO5s.INSTANCE;
    ...
    public IntentFilter(IntentFilter intentFilter) {
        if (intentFilter != null) {
            List<String> list = intentFilter.entities;
            if (list != null) {
            ...
            List<String> list3 = intentFilter.schemes;
            if (list3 != null) {
                this.schemes = new ArrayList(list3);
            }
            List<String> list4 = intentFilter.schemeSpecificParts;
            if (list4 != null) {
                this.schemeSpecificParts = new ArrayList(list4);
            }
            List<String> list5 = intentFilter.authorities;
            if (list5 != null) {
                this.authorities = new ArrayList(list5);
            }
            List<PatternsMatcher> list6 = intentFilter.pathsMatcher;
            if (list6 != null) {
                this.pathsMatcher = new ArrayList(list6);
            }
            List<PatternsMatcher> list7 = intentFilter.typesMatcher;
            if (list7 != null) {
                this.typesMatcher = new ArrayList(list7);
            }
            if (intentFilter.getIntentParams() != null) {
                setIntentParams(intentFilter.getIntentParams());
            }
        }
    }

    static /* synthetic */ IntentFilter lambda$static$0(Parcel parcel) {
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.unmarshalling(parcel);
        return intentFilter;
    }

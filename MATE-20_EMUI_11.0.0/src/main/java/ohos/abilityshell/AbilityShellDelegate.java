...
public class AbilityShellDelegate {
    ...
    public final void checkHapHasLoaded(AbilityInfo abilityInfo2) {
        if (abilityInfo2 == null || abilityInfo2.getModuleName() == null || abilityInfo2.getModuleName().isEmpty()) {
            AppLog.w(SHELL_LABEL, "abilityInfo or muduleInfo is null", new Object[0]);
            ...
            AppLog.w(SHELL_LABEL, "this module %{public}s, has already been load", abilityInfo2.getModuleName());
        } else {
    ...
    public void updateConfiguration(Configuration configuration) {
        ...
        this.ability.onConfigurationChanged(convert);
    }
}

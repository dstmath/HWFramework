...
import ohos.ace.featureabilityplugin.requestprocess.QueryAbilityProcess;
...
public class FeatureAbilityPlugin implements ModuleGroup.ModuleGroupHandler, EventGroup.EventGroupHandler {
    ...
    public void onFunctionCall(Function function, Result result) {
        ...
        if (c == 0) {
            ...
            QueryAbilityProcess.getInstance().queryAbility(this.abilityContext, function.arguments, result);
        } else if (c == 2) {

...
public abstract class Animator {
    ...
    private native void nativeBindAnimator(long j);
    ...
    /* access modifiers changed from: protected */
    @Deprecated
    public void setRepeatCountInternal(int i) {
        if (i >= 0 || i == -1) {
            nativeSetRepeatCount(this.mNativeAnimatorPtr, i);
        }
    }
    ...
    /* access modifiers changed from: protected */
    @Deprecated
    public void setInterpolatorTypeInternal(int i) {
        if (CurveType.checkTypeValue(i)) {
            nativeSetCurveType(this.mNativeAnimatorPtr, i);
        }
    }
    ...
    /* access modifiers changed from: protected */
    @Deprecated
    public void setRepeatListenerInternal(LoopedListener loopedListener) {
        this.mLoopedListener = loopedListener;
        nativeSetRepeatListener(this.mNativeAnimatorPtr, this.mLoopedListener);
    }

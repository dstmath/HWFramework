...
public class AnimatorGroup extends Animator {
    ...
    protected ArrayList<AnimatorParallel> mAnimatorParallelList = new ArrayList<>();
    ...
    @Deprecated
    public void setStartListener(Animator.StateChangedListener stateChangedListener) {
        setStartListenerInternal(stateChangedListener);
    }

    @Deprecated
    public void setPauseListener(Animator.StateChangedListener stateChangedListener) {
        setPauseListenerInternal(stateChangedListener);
    }

    @Deprecated
    public void setRepeatListener(Animator.LoopedListener loopedListener) {
        setLoopedListenerInternal(loopedListener);
    }

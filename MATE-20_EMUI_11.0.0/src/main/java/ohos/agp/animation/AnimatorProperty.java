...
public class AnimatorProperty extends Animator implements Component.AvailabilityObserver {
    ...
    private native void nativeRotationX(long j, float f);

    private native void nativeRotationXBy(long j, float f);

    private native void nativeRotationY(long j, float f);

    private native void nativeRotationYBy(long j, float f);
        ...
        try {
            if (this.intSet.contains(str)) {
                ...
                if (c == 0) {
                    ...
                    setRepeatCount(typedAttribute.getIntegerValue());
                } else {
    ...
    public AnimatorProperty setRepeatCount(int i) {
    ...
    public AnimatorProperty rotation(float f) {
    ...
    public AnimatorProperty rotationX(float f) {
        nativeRotationX(this.mNativeAnimatorPtr, f);
        return this;
    }

    public AnimatorProperty rotationXBy(float f) {
        nativeRotationXBy(this.mNativeAnimatorPtr, f);
        return this;
    }

    public AnimatorProperty rotationY(float f) {
        nativeRotationY(this.mNativeAnimatorPtr, f);
        return this;
    }

    public AnimatorProperty rotationYBy(float f) {
        nativeRotationYBy(this.mNativeAnimatorPtr, f);
        return this;
    }
}

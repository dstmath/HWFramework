...
public class ComponentProvider implements Sequenceable {
    ...
    private LinkedHashMap<String, Action> mActionsMap = new LinkedHashMap<>();
    ...
    public ComponentProvider(int i, Context context) {
        ...
        if (i != 0) {
            this.mLayoutXMLId = i;
            this.mPackageName = context.getBundleName();
    ...
    public boolean isValidComponentId(int i) {
        HiLog.debug(LABEL, "enter isValidViewId, viewId:%{public}d", new Object[]{Integer.valueOf(i)});
        ...
        if (allComponents == null) {
            ...
            HiLog.error(LABEL, "invalid view id:%{public}d ", new Object[]{Integer.valueOf(i)});
            return false;
        }
    }
    ...
    public boolean marshalling(Parcel parcel) {
        ...
        if (parcel.getCapacity() - parcel.getSize() > length) {
            if (!parcel.writeInt(0) || !parcel.writeBytes(bytes)) {
    ...
    private boolean marshallingAppInfo(Parcel parcel) {
        if (!parcel.writeInt(this.mLayoutXMLId)) {
            ...
            return false;
        } else if (parcel.writeString(this.mPackageName)) {
            return true;
        } else {
            HiLog.error(LABEL, "marshalling application info failed: package name", new Object[0]);
            return false;
        }
    }
    ...
    public void inflateLayout(Context context) {
        ...
        if (this.mApplicationInfo == null) {
            ...
            Context createBundleContext = context.createBundleContext(this.mPackageName, 3);
            ...
            Component parse = LayoutScatter.getInstance(context).clone(context, resourceManager).parse(this.mLayoutXMLId, null, false);
    ...
    public Action setTextSize(int i, int i2) {
        ...
        return setInt(i, "setTextSize", i2);
    }
    ...
    public final class SetBackgroundPixelMapAction extends Action {
        PixelMap value;
    ...
    /* access modifiers changed from: private */
    public final class SetTextColorAction extends Action {
        int color;
    ...
    /* access modifiers changed from: private */
    public final class ComponentContainerLayoutAction extends Action {
        int bottomMargin;
        int layoutHeight;
        int layoutWidth;
        int leftMargin;
        ...
        public ComponentContainerLayoutAction(int i, ComponentContainer.LayoutConfig layoutConfig) {
            super();
            this.viewId = i;
        ...
        public ComponentContainerLayoutAction(Parcel parcel) {
            super();
            unmarshalling(parcel);
        }
    ...
    /* access modifiers changed from: private */
    public final class SetProgressBarAction extends Action {
        ...
        public SetProgressBarAction(int i, int i2, int i3, boolean z) {
            super();
            this.viewId = i;
            this.max = i2;
            this.progress = i3;
        ...
        public SetProgressBarAction(Parcel parcel) {
            super();
            unmarshalling(parcel);
        }
    ...
    /* access modifiers changed from: private */
    public final class SetPaddingAction extends Action {
        int bottom;
        int left;
        int right;
        int top;
        ...
        public SetPaddingAction(int i, int i2, int i3, int i4, int i5) {
            super();
            this.viewId = i;
            this.top = i2;
            this.bottom = i3;
        ...
        public SetPaddingAction(Parcel parcel) {
            super();
            unmarshalling(parcel);
        }
        ...
        public boolean unmarshalling(Parcel parcel) {
            ...
            switch (this.type) {
                ...
                case 4:
                    ...
                    if (createFromParcel instanceof PixelMap) {
                        this.value = (PixelMap) createFromParcel;
                        break;
                    } else {
                        return false;
                    }
        ...
        public void apply(ComponentContainer componentContainer) {
            ...
            if (findComponentById == null) {
                ...
                findComponentById.setClickedListener(new Component.ClickedListener() {
                    /* class ohos.agp.components.ComponentProvider.OnClickAction.AnonymousClass1 */
                    ...
                    public void onClick(Component component) {
                        ...
                        if (ComponentProvider.this.mContext != null) {
                            IntentAgentHelper.triggerIntentAgent(ComponentProvider.this.mContext, OnClickAction.this.intent, null, null, null);
                        } else {
                            HiLog.error(ComponentProvider.LABEL, "OnClickAction apply mContext is null", new Object[0]);
                        }
                    }
                });
            }
    ...
    public abstract class Action implements Sequenceable {

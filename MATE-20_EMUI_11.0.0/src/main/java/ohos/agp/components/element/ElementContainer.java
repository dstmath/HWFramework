...
public class ElementContainer extends Element {
    ...
    public ElementState mElementState = new ElementState(this);
    ...
    public ElementContainer() {
        setConstantState(this.mElementState);
    }
    ...
    public void setConstantState(ElementState elementState) {

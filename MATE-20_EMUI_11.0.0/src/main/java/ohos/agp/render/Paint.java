...
public class Paint {
    static final StrokeCap[] STROKECAP_ARRAY = {StrokeCap.BUTT, StrokeCap.ROUND, StrokeCap.SQUARE};
    static final Style[] STYLE_ARRAY = {Style.FILL, Style.STROKE, Style.FILL_AND_STROKE};
    ...
    public float getLineSpacingMultiplier() {
        return nativeGetLineSpacingMultiplier(this.mNativePaintHandle);
    }

    public float getLineSpacingExtra() {
        return nativeGetLineSpacingExtra(this.mNativePaintHandle);
    }
    ...
    private Join getStrokeJoinValue(int i) {
        Join[] joinArr = {Join.MITER, Join.ROUND, Join.BEVEL};

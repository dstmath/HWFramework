...
public class RenderLoop {
            ...
            this.mFrameCallback = new VsyncScheduler.FrameCallback() {
                ...
                public void doFrame(long j) {
                    ...
                    if (!RenderLoop.this.mIsFinished && !RenderLoop.this.mIsPaused) {
                        VsyncScheduler.getInstance().requestVsync(this);
                    }
                }
            };
            VsyncScheduler.getInstance().requestVsync(this.mFrameCallback);
        }
    }
    ...
    private float getDisplayRefreshRate() {
        float f = this.mDisplayFps;
        return f <= 0.0f ? DEFAULT_DISPLAY_REFRESH_RATE : f;
    }

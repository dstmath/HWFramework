...
public class TransitionScheduler {
    ...
    protected long mNativeTransitionSchedulerPtr;
    ...
    public TransitionScheduler() {
        this.mNativeTransitionSchedulerPtr = 0;
        this.mNativeTransitionSchedulerPtr = nativeGetTransitionSchedulerHandle();
    ...
    public void setTransition(Transition transition) {
        nativeSetTransition(this.mNativeTransitionSchedulerPtr, transition.getNativeTransitionPtr());
    }

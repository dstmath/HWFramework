...
public class Window {
    ...
    public void setLayoutGravity(int i) {
        getLayoutConfig().ifPresent(new Consumer(i) {
            /* class ohos.agp.window.service.$$Lambda$Window$JVgtPjHs8mf3M_kD6i4ETD93VlA */
            ...
            public final void accept(Object obj) {
                Window.this.lambda$setLayoutGravity$0$Window(this.f$1, (WindowManager.LayoutConfig) obj);
            }
        });
    }

    public /* synthetic */ void lambda$setLayoutGravity$0$Window(int i, WindowManager.LayoutConfig layoutConfig) {
        layoutConfig.gravity = i;
    ...
    public void setBackground(String str) {
        if (new File(str).exists()) {
            if (str.isEmpty()) {
                HiLog.error(LABEL, "Window can not set background to an empty drawable.", new Object[0]);
                return;
            }
            checkWindow();

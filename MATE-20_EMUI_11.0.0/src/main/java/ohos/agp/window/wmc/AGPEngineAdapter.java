...
public class AGPEngineAdapter implements IAGPEngineAdapter {
    ...
    public void processSurfaceChanged(Surface surface, int i, int i2, int i3) {
        ...
        if (this.mSurfaceState != 0) {
            ...
            nativeLoad(this.mNativeWindowPtr, surface, i2, i3);
    ...
    public void processSurfaceDestroy(Surface surface) {
        ...
        if (this.mSurfaceState != 0 && this.mNativeWindowPtr != 0) {
    ...
    public boolean processKeyEvent(KeyEvent keyEvent) {
        ...
        return nativeDispatchKeyboardEvent(this.mNativeWindowPtr, keyEvent);
    }
    ...
    public boolean processRotationEvent(RotationEvent rotationEvent) {
        ...
        return nativeDispatchRotationEvent(this.mNativeWindowPtr, rotationEvent);
    }
    ...
    public void processConfigurationChanged(android.content.res.Configuration configuration) {
        ...
        this.mRootView.dispatchConfigurationChanged(this.mConfiguration);
    }
    ...
    public void setPreContentLayout(ComponentContainer componentContainer, int i, int i2) {
        ...
        nativePreSetContentLayout(this.mNativeWindowPtr, componentContainer, i, i2);
    }

    public void setBackgroundColor(int i, int i2, int i3) {
        nativeSetBackgroundColor(this.mNativeWindowPtr, i, i2, i3);
    }
    ...
    public void setWindowOffset(int i, int i2) {
        ...
        nativeSetWindowOffset(this.mNativeWindowPtr, i, i2);
    }

    public void setTransparent(boolean z) {
        if (z) {
            nativeSetTransparent(this.mNativeWindowPtr, 1);
        } else {
            nativeSetTransparent(this.mNativeWindowPtr, 0);
        }
    }

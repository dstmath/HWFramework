...
public class ModelCoreManager {
    ...
    public boolean insertResourceInformation(String str) {
        ...
        try {
            boolean insertResourceInformation = orElse.insertResourceInformation(str);
            String str3 = TAG;
            HiAILog.info(str3, "isInserted " + insertResourceInformation);
    ...
    public long getResourceVersionCode(String str) {
        ...
        try {
            long resourceVersionCode = orElse.getResourceVersionCode(str);
            String str3 = TAG;
            HiAILog.info(str3, "versionCode " + resourceVersionCode);
    ...
    public Optional<String> requestModelPath(long j) {
        ...
        try {
            String requestModelPath = orElse.requestModelPath(j);
            String str2 = TAG;
            HiAILog.info(str2, "modelPath " + requestModelPath);
            return Optional.of(requestModelPath);
        } catch (RemoteException unused) {
    ...
    public Optional<ByteBuffer> requestModelBuffer(long j) {
        ...
        if (requestModelBytes != null) {
            return Optional.of(ByteBuffer.wrap(requestModelBytes));
        }
    ...
    public List<AiModelBean> requestModelsByBusiDomain(String str) {
        ...
        try {
            List<AiModelBean> requestModelsByBusiDomain = orElse.requestModelsByBusiDomain(str);
            if (requestModelsByBusiDomain != null) {
                String str3 = TAG;
                HiAILog.info(str3, "models " + requestModelsByBusiDomain.toString());
            }
    ...
    public boolean syncModel(String str, long j) {
        ...
        try {
            boolean syncModel = orElse.syncModel(str, j);
            String str3 = TAG;
            HiAILog.info(str3, "isSync " + syncModel);
            return syncModel;
        } catch (RemoteException unused) {

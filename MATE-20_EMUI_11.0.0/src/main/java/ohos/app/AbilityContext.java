...
public abstract class AbilityContext implements Context, IAbilityLoader {
    ...
    public void onLoadAbility() {
        if (this.context instanceof IAbilityLoader) {
            AppLog.d("AbilityContext::init context is ContextDeal type", new Object[0]);
            ((IAbilityLoader) this.context).onLoadAbility();
            return;
        }
    ...
    public boolean isCredentialProtectedStorage() {
        Context context2 = this.context;
        if (context2 != null) {
            return context2.isCredentialProtectedStorage();
        }
        AppLog.e("AbilityContext::isCredentialProtectedStorage context is null", new Object[0]);
        return false;
    }
    ...
    public void startAbility(Intent intent, int i) {
        if (this.context == null) {
            ...
            this.context.startAbility(intent, i);
        }
    }
    ...
    public boolean moveTaskToEnd(boolean z) {
        Context context2 = this.context;
        if (context2 != null) {
            return context2.moveTaskToEnd(z);
        }
        AppLog.e("AbilityContext::moveTaskToBack context is null", new Object[0]);
        throw new IllegalArgumentException("Ability is not initialized.");
    }
    ...
    public boolean isFirstInTask() {
        Context context2 = this.context;
        if (context2 != null) {
            return context2.isFirstInTask();
        }
        AppLog.e("AbilityContext::isTaskRoot context is null", new Object[0]);
        throw new IllegalArgumentException("Ability is not initialized.");
    }
    ...
    public int getTaskId() {
        Context context2 = this.context;
        if (context2 != null) {
            return context2.getTaskId();
        }
        AppLog.e("AbilityContext::getTaskId context is null", new Object[0]);
        throw new IllegalArgumentException("Ability is not initialized.");
    }
    ...
    public boolean setTaskInformation(TaskInformation taskInformation) {
        Context context2 = this.context;
        if (context2 != null) {
            return context2.setTaskInformation(taskInformation);
        }
        AppLog.e("AbilityContext::setTaskDescription context is null", new Object[0]);
        throw new IllegalArgumentException("Ability is not initialized.");
    }
    ...
    public void terminateAndRemoveTask() {
        this.context.terminateAndRemoveTask();
    }

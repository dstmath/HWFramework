...
public class BatteryInfo {
    ...
    public static final String HARMONY_BATTERY_CAPACITY = "batteryCapacity";
    public static final String HARMONY_BATTERY_LOW = "batteryLow";
    public static final String HARMONY_BATTERY_PRESENT = "batteryPresent";
    public static final String HARMONY_BATTERY_TECHNOLOGY = "batteryTechnology";
    public static final String HARMONY_BATTERY_TEMPERATURE = "batteryTemperature";
    public static final String HARMONY_BATTERY_VOLTAGE = "batteryVoltage";
    public static final String HARMONY_CHARGE_COUNTER = "chargeCounter";
    public static final String HARMONY_CHARGE_STATE = "chargeState";
    public static final String HARMONY_CHARGE_TYPE = "chargeType";
    public static final String HARMONY_CHARGING_CURRENT_MAX = "maxCurrent";
    public static final String HARMONY_CHARGING_VOLTAGE_MAX = "maxVoltage";
    public static final String HARMONY_TEMPERATURE_STATE = "temperatureState";

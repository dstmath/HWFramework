...
public class BiometricEnroll {
    ...
    private BiometricEnroll(Ability ability) {
    ...
    public static BiometricEnroll getInstance(Ability ability) throws IllegalAccessException {
        ...
        } else if (ability.verifySelfPermission(ENROLL_PERMISSION) == 0) {
            if (sInstance == null) {
                synchronized (BiometricEnroll.class) {
                    if (sInstance == null) {
                        sInstance = new BiometricEnroll(ability);
    ...
    public synchronized EnrollInitResult initEnroll(BiometricType biometricType) {
        ...
        if (this.mAbility.verifySelfPermission(ACCESS_PERMISSION) == 0) {
            if (this.mAbility.verifySelfPermission(ENROLL_PERMISSION) == 0) {
                ...
                if (this.mBiometricType == BiometricType.BIOMETRICTYPE_NONE || this.mBiometricType == biometricType) {
                    if (AnonymousClass1.$SwitchMap$ohos$biometrics$enrollment$BiometricEnroll$BiometricType[biometricType.ordinal()] != 1) {
                        ...
                        enrollInitResult = FaceEnroll.getInstance(this.mAbility).initEnroll();
                    }
        ...
        if (this.mAbility.verifySelfPermission(ACCESS_PERMISSION) == 0) {
            if (this.mAbility.verifySelfPermission(ENROLL_PERMISSION) == 0) {
                ...
                if (AnonymousClass1.$SwitchMap$ohos$biometrics$enrollment$BiometricEnroll$BiometricType[biometricType.ordinal()] != 1) {
                    ...
                    i2 = FaceEnroll.getInstance(this.mAbility).execEnroll(bArr, j, i, surface);
                }
                return i2;
            }
        }
        ...
        if (this.mAbility.verifySelfPermission(ACCESS_PERMISSION) == 0) {
            if (this.mAbility.verifySelfPermission(ENROLL_PERMISSION) == 0) {
                ...
                if (i2 == 1) {
                    ...
                    i = FaceEnroll.getInstance(this.mAbility).finishEnroll();
                } else if (i2 != 2) {
    ...
    public int cancelEnroll() {
        if (this.mAbility.verifySelfPermission(ACCESS_PERMISSION) == 0 && this.mAbility.verifySelfPermission(ENROLL_PERMISSION) == 0) {
            BiometricType biometricType = this.mBiometricType;
            if (AnonymousClass1.$SwitchMap$ohos$biometrics$enrollment$BiometricEnroll$BiometricType[biometricType.ordinal()] == 1) {
                return FaceEnroll.getInstance(this.mAbility).cancelEnroll();
            }
        ...
        if (this.mAbility.verifySelfPermission(ACCESS_PERMISSION) == 0) {
            if (this.mAbility.verifySelfPermission(ENROLL_PERMISSION) == 0) {
                ...
                if (AnonymousClass1.$SwitchMap$ohos$biometrics$enrollment$BiometricEnroll$BiometricType[biometricType.ordinal()] != 1) {
                    ...
                    i2 = FaceEnroll.getInstance(this.mAbility).removeEnrolledInfo(i);
                }
                return i2;
            }
        }
        ...
        if (this.mAbility.verifySelfPermission(ACCESS_PERMISSION) == 0) {
            if (this.mAbility.verifySelfPermission(ENROLL_PERMISSION) == 0) {
                ...
                if (AnonymousClass1.$SwitchMap$ohos$biometrics$enrollment$BiometricEnroll$BiometricType[biometricType.ordinal()] != 1) {
                    ...
                    arrayList = FaceEnroll.getInstance(this.mAbility).getEnrolledInfo();
                }
                return arrayList;
            }
        }
        ...
        if (this.mAbility.verifySelfPermission(ACCESS_PERMISSION) == 0) {
            if (this.mAbility.verifySelfPermission(ENROLL_PERMISSION) == 0) {
                if (AnonymousClass1.$SwitchMap$ohos$biometrics$enrollment$BiometricEnroll$BiometricType[biometricType.ordinal()] != 1) {
                    ...
                    i2 = FaceEnroll.getInstance(this.mAbility).renameEnrolledInfo(i, str);
                }
                return i2;
            }
        }
    ...
    public EnrolledTips getEnrolledTips() {
        if (this.mAbility.verifySelfPermission(ACCESS_PERMISSION) == 0 && this.mAbility.verifySelfPermission(ENROLL_PERMISSION) == 0) {
            ...
            BiometricType biometricType = this.mBiometricType;
            if (AnonymousClass1.$SwitchMap$ohos$biometrics$enrollment$BiometricEnroll$BiometricType[biometricType.ordinal()] == 1) {
                return FaceEnroll.getInstance(this.mAbility).getEnrolledTips();
            }
            HiLog.error(LABEL, "BiometricType status error! please check initEnroll: BiometricType = %{public}d", new Object[]{biometricType});
            return enrolledTips;
        }
    ...
    public int getEnrolledBiometricId() {
        if (this.mAbility.verifySelfPermission(ACCESS_PERMISSION) == 0 && this.mAbility.verifySelfPermission(ENROLL_PERMISSION) == 0) {
            BiometricType biometricType = this.mBiometricType;
            if (AnonymousClass1.$SwitchMap$ohos$biometrics$enrollment$BiometricEnroll$BiometricType[biometricType.ordinal()] == 1) {
                return FaceEnroll.getInstance(this.mAbility).getEnrolledFaceId();
            }
            HiLog.error(LABEL, "BiometricType status error, please initEnroll first! BiometricType = %{public}d", new Object[]{biometricType});
            return -1;
        }

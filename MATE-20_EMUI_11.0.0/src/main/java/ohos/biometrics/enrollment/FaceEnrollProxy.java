...
public class FaceEnrollProxy implements IFaceEnroll {
    ...
    FaceEnrollProxy(Ability ability) {
        AnonymousClass1 r0 = new DefaultFaceRecognizeManagerImpl.FaceRecognizeCallback() {
        ...
        if (ability == null || ability.getContext() == null) {
            this.mFaceManagerImpl = null;
            HiLog.error(LABEL, "FaceEnrollProxy structure failed! ability error", new Object[0]);
            return;
        }
        ...
        this.mFaceManagerImpl = FaceRecognizeManagerFactory.getInstance().getFaceRecognizeManagerImpl((Context) hostContext, r0);
    }

...
public abstract class BlePeripheralCallbackSkeleton extends RemoteObject implements IBlePeripheralCallback {
    ...
    private static final HiLogLabel TAG = new HiLogLabel(3, (int) LogHelper.BT_DOMAIN_ID, "BluetoothGatt");
            ...
            case 5:
                ...
                for (int i2 = 0; i2 < readInt; i2++) {
                    ...
                    if (messageParcel.readInt() == 0) {
                        HiLog.info(TAG, "parcel frome remote is null with Key: %d", new Object[]{Integer.valueOf(readInt2)});
                    } else {

        ...
        synchronized (this.mLock) {
            ...
            try {
                ...
                if (!sendRequest || readInt != 0) {
                    HiLog.error(TAG, "addService : call fail %{public}d, %{public}d", new Object[]{Boolean.valueOf(sendRequest), Integer.valueOf(readInt)});
                }
    ...
    public void disconnectServer(int i, String str) {
        synchronized (this.mLock) {
            ...
            try {
                ...
                int readInt = obtain2.readInt();
                if (!sendRequest || readInt != 0) {
                    HiLog.error(TAG, "disconnectServer : call fail %{public}d, %{public}d", new Object[]{Boolean.valueOf(sendRequest), Integer.valueOf(readInt)});
                    obtain.reclaim();
                    obtain2.reclaim();
                }
            } catch (RemoteException unused) {
    ...
    public void unregisterServer(int i) {
        synchronized (this.mLock) {
            ...
            try {
                ...
                int readInt = obtain2.readInt();
                if (!sendRequest || readInt != 0) {
                    HiLog.error(TAG, "unregisterServer : call fail %{public}d, %{public}d", new Object[]{Boolean.valueOf(sendRequest), Integer.valueOf(readInt)});
                    obtain.reclaim();
                    obtain2.reclaim();
                }
            } catch (RemoteException unused) {
    ...
    public void sendNotification(int i, String str, int i2, boolean z, byte[] bArr) {
        synchronized (this.mLock) {
            ...
            try {
                ...
                int readInt = obtain2.readInt();
                if (!sendRequest || readInt != 0) {
                    HiLog.error(TAG, "sendNotification : call fail %{public}d, %{public}d", new Object[]{Boolean.valueOf(sendRequest), Integer.valueOf(readInt)});
                    obtain.reclaim();
                    obtain2.reclaim();
                }
            } catch (RemoteException unused) {
    ...
    public void removeService(int i, int i2) {
        synchronized (this.mLock) {
            ...
            try {
                ...
                int readInt = obtain2.readInt();
                if (!sendRequest || readInt != 0) {
                    HiLog.error(TAG, "removeService : call fail %{public}d, %{public}d", new Object[]{Boolean.valueOf(sendRequest), Integer.valueOf(readInt)});
                    obtain.reclaim();
                    obtain2.reclaim();
                }
            } catch (RemoteException unused) {
    ...
    public void sendResponse(int i, String str, int i2, int i3, int i4, byte[] bArr) {
        synchronized (this.mLock) {
            ...
            try {
                ...
                int readInt = obtain2.readInt();
                if (!sendRequest || readInt != 0) {
                    HiLog.error(TAG, "sendResponse : call fail %{public}d, %{public}d", new Object[]{Boolean.valueOf(sendRequest), Integer.valueOf(readInt)});
                    obtain.reclaim();
                    obtain2.reclaim();
                }
            } catch (RemoteException unused) {

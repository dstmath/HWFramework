...
public interface IBundleManager extends IRemoteBroker {
    ...
    boolean addHomeShortcut(ShortcutInfo shortcutInfo) throws IllegalArgumentException;
    ...
    void disableHomeShortcuts(List<String> list);
    ...
    void enableHomeShortcuts(List<String> list);

...
public abstract class NodeCounter {
    ...
    private static final String[] Hundreds = {"", "c", "cc", "ccc", "cd", DateFormat.DAY, "dc", "dcc", "dccc", "cm"};
    private static final String[] Ones = {"", "i", "ii", "iii", "iv", DateFormat.ABBR_GENERIC_TZ, "vi", "vii", "viii", "ix"};
    private static final String[] Tens = {"", LanguageTag.PRIVATEUSE, "xx", "xxx", "xl", "l", "lx", "lxx", "lxxx", "xc"};
    private static final String[] Thousands = {"", DateFormat.MINUTE, "mm", "mmm"};

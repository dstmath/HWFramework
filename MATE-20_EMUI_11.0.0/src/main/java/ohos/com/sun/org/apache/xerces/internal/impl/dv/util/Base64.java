...
public final class Base64 {
    ...
    public static String encode(byte[] bArr) {
        ...
        while (i3 < i2) {
            ...
            byte b4 = (byte) (b2 & 15);
            byte b5 = (byte) (b & 3);
            int i9 = b & Bidi.LEVEL_OVERRIDE;
            int i10 = b >> 2;
            if (i9 != 0) {
                i10 ^= 192;
            }
            byte b6 = (byte) i10;
            int i11 = b2 & Bidi.LEVEL_OVERRIDE;
            int i12 = b2 >> 4;
            if (i11 != 0) {
                i12 ^= 240;
            }
            byte b7 = (byte) i12;
            int i13 = (b3 & Bidi.LEVEL_OVERRIDE) == 0 ? b3 >> 6 : (b3 >> 6) ^ 252;
            int i14 = i5 + 1;
        ...
        if (i == 8) {
            byte b8 = bArr[i4];
            byte b9 = (byte) (b8 & 3);
            int i17 = b8 & Bidi.LEVEL_OVERRIDE;
            int i18 = b8 >> 2;
            if (i17 != 0) {
                i18 ^= 192;
            }
            ...
            byte b13 = (byte) (b10 & 3);
            int i21 = b10 & Bidi.LEVEL_OVERRIDE;
            int i22 = b10 >> 2;
            if (i21 != 0) {
                i22 ^= 192;
            }
            byte b14 = (byte) i22;
            int i23 = b11 & Bidi.LEVEL_OVERRIDE;
            int i24 = b11 >> 4;
            if (i23 != 0) {
                i24 ^= 240;
            }

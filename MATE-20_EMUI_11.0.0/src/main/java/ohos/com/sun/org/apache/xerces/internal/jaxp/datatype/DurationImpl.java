...
public class DurationImpl extends Duration implements Serializable {
    ...
    public String toString() {
        ...
        if (this.months != null) {
            stringBuffer.append(this.months + DateFormat.NUM_MONTH);
        }
        if (this.days != null) {
        ...
        if (!(this.hours == null && this.minutes == null && this.seconds == null)) {
            ...
            if (this.hours != null) {
                stringBuffer.append(this.hours + DateFormat.HOUR24);
            }
            if (this.minutes != null) {
                stringBuffer.append(this.minutes + DateFormat.NUM_MONTH);
            }

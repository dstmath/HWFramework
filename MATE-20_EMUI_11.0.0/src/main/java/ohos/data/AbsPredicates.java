...
public abstract class AbsPredicates {
    ...
    public AbsPredicates limit(int i) {
        if (this.limit != null) {
            ...
            throw new IllegalPredicateException("AbsPredicates limit(): limit cannot be less than zero.");
        }
    }
    ...
    public AbsPredicates offset(int i) {
        if (this.offset != null) {
            ...
            throw new IllegalPredicateException("AbsPredicates offset(): the value of offset can't be less than zero.");
        }
    }

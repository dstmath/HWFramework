...
public class RdbUtils {
    ...
    public static void verifyPredicates(RdbStore rdbStore, OperationType operationType, RdbPredicates rdbPredicates) {
        ...
        if (rdbStoreImpl != null) {
            rdbStoreImpl.verifyPredicates(operationType, rdbPredicates);
            return;
        }

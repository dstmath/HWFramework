...
public class CallStateObserver {
    public static final int OBSERVE_CALL_FORWARDING_UNCONDITIONAL_INDICATOR = 2;
    public static final int OBSERVE_CALL_STATE = 4;
    public static final int OBSERVE_VOICE_MAIL_MESSAGE_INDICATOR = 1;

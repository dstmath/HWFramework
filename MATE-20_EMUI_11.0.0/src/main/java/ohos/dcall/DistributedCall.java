...
public final class DistributedCall {
    ...
    public static final Sequenceable.Producer<DistributedCall> CREATOR = new Sequenceable.Producer<DistributedCall>() {
        ...
        public DistributedCall createFromParcel(Parcel parcel) {
            ...
            try {
                pacMap.putAll(DistributedCall.convertToSpecificMap(parcel.readMap()));
            } catch (ParcelException unused) {
                HiLog.error(DistributedCall.LABEL, "createFromParcel: got ParcelException when read originalExtraInfo.", new Object[0]);
            }
            PacMap pacMap2 = new PacMap();
            try {
                pacMap2.putAll(DistributedCall.convertToSpecificMap(parcel.readMap()));
            } catch (ParcelException unused2) {
                HiLog.error(DistributedCall.LABEL, "createFromParcel: got ParcelException when read extraInfo.", new Object[0]);
            }
            pacMap2.putAll(pacMap);
            return new DistributedCall(readInt, readInt2, readInt3, disconnectInfo, readLong, build, readInt4, readString, readInt5, pacMap2, parcel.readLong(), parcel.readInt());
        }
    };
    ...
    public static class Info {
        ...
        public int hashCode() {
            return Objects.hash(this.mHandle, Integer.valueOf(this.mHandlePresentation), this.mPeerDisplayName, this.mCallHandler, Integer.valueOf(this.mCallAttributes), this.mDisconnectInfo, Long.valueOf(this.mConnectTimeMillis), this.mExtraInfo, Long.valueOf(this.mCreationTimeMillis), Integer.valueOf(this.mCallDirection));
        }
        ...
        public String toString() {
            return "[id: " + this.mCallId + this.mCallHandler + ", hdlPres: " + this.mHandlePresentation + ", attributes: " + attributesToString(this.mCallAttributes) + "]";
        }
    }

    /* access modifiers changed from: private */
    public static Map<String, Object> convertToSpecificMap(Map<?, ?> map) {
        HashMap hashMap = new HashMap();
        if (map == null) {
            HiLog.error(LABEL, "convertToSpecificMap: sourceMap is null.", new Object[0]);
            return hashMap;
        }
    ...
    public int accept(int i) {
        HiLog.info(LABEL, "accept: telecomCallId: %{public}s", new Object[]{Integer.valueOf(this.mCallId)});
        return DistributedCallProxy.getInstance().answerCall(this.mCallId, 0);
    }

    public int reject(boolean z, String str) {
        HiLog.info(LABEL, "reject: telecomCallId: %{public}s", new Object[]{Integer.valueOf(this.mCallId)});
        return DistributedCallProxy.getInstance().reject(this.mCallId, z, str);
    }

    public int hangup() {
        HiLog.info(LABEL, "hangup", new Object[0]);
    ...
    DistributedCall(int i, int i2, int i3, DisconnectInfo disconnectInfo, long j, Uri uri, int i4, String str, int i5, PacMap pacMap, long j2, int i6) {
        this.mCallId = i;
        this.mStatus = i2;
        this.mInfo = new Info(i, uri, i4, str, i5, null, i3, disconnectInfo, j, 0, pacMap, j2, i6);
    }

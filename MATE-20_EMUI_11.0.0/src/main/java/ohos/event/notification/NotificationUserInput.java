...
public class NotificationUserInput implements Sequenceable {
    ...
    private NotificationUserInput(String str, String str2, List<String> list, boolean z, Set<String> set, PacMap pacMap2) {
        this.inputKey = str;
        this.tag = str2;
        this.options = list;
    ...
    public static final class Builder {
        ...
        public NotificationUserInput build() {
            return new NotificationUserInput(this.inputKey, this.tag, this.options, this.permitFreeFormInput, this.permitDataTypes, this.pacMaps);
        }
    }

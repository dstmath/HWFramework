                ...
                if (i14 >= length || charSequence.charAt(i13) - '0' < 0 || i4 > 9 || charSequence.charAt(i14) != '}') {
                    ...
                    if (i13 < length) {
                        ...
                        if ('1' > charAt2 || charAt2 > '9') {
                            ...
                            charAt2 = charAt;
                            if (i5 >= 0 || charAt2 != '}') {
                                throw new IllegalArgumentException("Argument syntax error in pattern \"" + ((Object) charSequence) + "\" at index " + i15 + PluralRules.KEYWORD_RULE_SEPARATOR + ((Object) charSequence.subSequence(i15, i13)));
                            }
                            i4 = i5;
                        }
                    }

...
public class LocaleValidityChecker {
    ...
    static final Set<String> REORDERING_INCLUDE = new HashSet(Arrays.asList("space", "punct", "symbol", "currency", Constants.ATTRNAME_DIGIT, "others", DateFormat.SPECIFIC_TZ));
            ...
            if (str3.length() == 2 && (sb4 == null || str3.charAt(1) <= '9')) {
                ...
                if (i4 == 1) {
                    ...
                    if (i4 == 3) {
                        ...
                        } else if (str3.length() < 6 || !str3.endsWith(DateFormat.SPECIFIC_TZ)) {
                            return where.set(datatype, str3);
                        } else {

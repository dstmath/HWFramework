...
public class Bidi {
    ...
    private static final short[][] impTabProps = {new short[]{1, 2, 4, 5, 7, 15, 17, 7, 9, 7, 0, 7, 3, 18, 21, 4}, new short[]{1, 34, 36, 37, 39, 47, 49, 39, 41, 39, 1, 1, 35, 50, 53, 0}, new short[]{33, 2, 36, 37, 39, 47, 49, 39, 41, 39, 2, 2, 35, 50, 53, 1}, new short[]{33, 34, 38, 38, 40, 48, 49, 40, 40, 40, 3, 3, 3, 50, 53, 1}, new short[]{33, 34, 4, 37, 39, 47, 49, 74, 11, 74, 4, 4, 35, 18, 21, 2}, new short[]{33, 34, 36, 5, 39, 47, 49, 39, 41, 76, 5, 5, 35, 50, 53, 3}, new short[]{33, 34, 6, 6, 40, 48, 49, 40, 40, 77, 6, 6, 35, 18, 21, 3}, new short[]{33, 34, 36, 37, 7, 47, 49, 7, 78, 7, 7, 7, 35, 50, 53, 4}, new short[]{33, 34, 38, 38, 8, 48, 49, 8, 8, 8, 8, 8, 35, 50, 53, 4}, new short[]{33, 34, 4, 37, 7, 47, 49, 7, 9, 7, 9, 9, 35, 18, 21, 4}, new short[]{97, 98, 4, 101, Constants.I2D, Constants.DDIV, Constants.LREM, Constants.I2D, Constants.D2I, Constants.I2D, 10, Constants.I2D, 99, 18, 21, 2}, new short[]{33, 34, 4, 37, 39, 47, 49, 39, 11, 39, 11, 11, 35, 18, 21, 2}, new short[]{97, 98, 100, 5, Constants.I2D, Constants.DDIV, Constants.LREM, Constants.I2D, Constants.D2I, Constants.I2D, 12, Constants.I2D, 99, Constants.FREM, Constants.LNEG, 3}, new short[]{97, 98, 6, 6, Constants.L2I, Constants.IREM, Constants.LREM, Constants.L2I, Constants.L2I, Constants.L2I, 13, Constants.L2I, 99, 18, 21, 3}, new short[]{33, 34, Constants.IINC, 37, 7, 47, 49, 7, 14, 7, 14, 14, 35, 146, Constants.FCMPL, 4}, new short[]{33, 34, 36, 37, 39, 15, 49, 39, 41, 39, 15, 39, 35, 50, 53, 5}, new short[]{33, 34, 38, 38, 40, 16, 49, 40, 40, 40, 16, 40, 35, 50, 53, 5}, new short[]{33, 34, 36, 37, 39, 47, 17, 39, 41, 39, 17, 39, 35, 50, 53, 6}, new short[]{33, 34, 18, 37, 39, 47, 49, 83, 20, 83, 18, 18, 35, 18, 21, 0}, new short[]{97, 98, 18, 101, Constants.I2D, Constants.DDIV, Constants.LREM, Constants.I2D, Constants.D2I, Constants.I2D, 19, Constants.I2D, 99, 18, 21, 0}, new short[]{33, 34, 18, 37, 39, 47, 49, 39, 20, 39, 20, 20, 35, 18, 21, 0}, new short[]{33, 34, 21, 37, 39, 47, 49, 86, 23, 86, 21, 21, 35, 18, 21, 3}, new short[]{97, 98, 21, 101, Constants.I2D, Constants.DDIV, Constants.LREM, Constants.I2D, Constants.D2I, Constants.I2D, 22, Constants.I2D, 99, 18, 21, 3}, new short[]{33, 34, 21, 37, 39, 47, 49, 39, 23, 39, 23, 23, 35, 18, 21, 3}};
        ...
        while (i14 < this.length) {
            ...
            switch (b8) {
                ...
                case 15:
                    this.flags |= DirPropFlag((byte) 18);
                    this.levels[i14] = b7;
                    byte NoOverride = (byte) ((b8 == 11 || b8 == 12) ? (b6 + 2) & 126 : (NoOverride(b6) + 1) | 1);

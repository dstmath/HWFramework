...
public abstract class Collator implements Comparator<Object>, Freezable<Collator>, Cloneable {
    ...
    private static final boolean getYesOrNo(String str, String str2) {
        ...
        if (ASCII.equalIgnoreCase(str2, IndexType.NO)) {
            return false;
        }
    ...
    private static final int getReorderCode(String str, String str2) {
        return getIntValue(str, str2, "space", "punct", "symbol", "currency", Constants.ATTRNAME_DIGIT) + 4096;
    }
    ...
    private static void setAttributesFromKeywords(ULocale uLocale, Collator collator, RuleBasedCollator ruleBasedCollator) {
        ...
        if (uLocale.getKeywordValue("colHiraganaQuaternary") != null) {
            ...
            if (keywordValue4 != null) {
                if (ruleBasedCollator != null) {
                    int intValue2 = getIntValue("colCaseFirst", keywordValue4, IndexType.NO, SearchParameter.LOWER, SearchParameter.UPPER);
                    if (intValue2 == 0) {
            ...
            if (keywordValue8 != null) {
                ...
                while (i2 != iArr.length) {
                    ...
                    if (substring.length() == 4) {
                        i = UCharacter.getPropertyValueEnum(UProperty.SCRIPT, substring);
                    } else {
    ...
    public static final String[] getKeywordValues(String str) {
        if (str.equals(KEYWORDS[0])) {
            return ICUResourceBundle.getKeywordValues("ohos/global/icu/impl/data/icudt66b/coll", RESOURCE);
        }
    ...
    public static final String[] getKeywordValuesForLocale(String str, ULocale uLocale, boolean z) {
        ...
        UResourceBundle.getBundleInstance("ohos/global/icu/impl/data/icudt66b/coll", uLocale).getAllItemsWithFallback(RESOURCE, keywordsSink);
    ...
    public static final ULocale getFunctionalEquivalent(String str, ULocale uLocale, boolean[] zArr) {
        return ICUResourceBundle.getFunctionalEquivalent("ohos/global/icu/impl/data/icudt66b/coll", ICUResourceBundle.ICU_DATA_CLASS_LOADER, RESOURCE, str, uLocale, zArr, true);
    }

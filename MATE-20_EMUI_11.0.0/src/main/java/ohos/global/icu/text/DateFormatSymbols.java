...
public class DateFormatSymbols implements Serializable, Cloneable {
            ...
            for (int i = 0; table.getKeyAndValue(i, key, value); i++) {
                if (!key.endsWith("%variant")) {
                    ...
                    if (value.getType() == 0) {
                        ...
                        String str2 = str + PsuedoNames.PSEUDONAME_ROOT + key2;
    ...
    /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x02d0: APUT  (r3v6 boolean[] A[IMMUTABLE_TYPE]), (0 ??[int, short, byte, char]), (r4v18 boolean A[IMMUTABLE_TYPE]) */
    /* access modifiers changed from: protected */
    @Deprecated

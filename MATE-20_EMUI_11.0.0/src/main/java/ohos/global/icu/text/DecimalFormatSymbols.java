...
public class DecimalFormatSymbols implements Cloneable, Serializable {
    ...
    private static final String[] SYMBOL_DEFAULTS = {String.valueOf((char) DEF_DECIMAL_SEPARATOR), String.valueOf((char) DEF_GROUPING_SEPARATOR), String.valueOf((char) DEF_PERCENT), String.valueOf('-'), String.valueOf((char) DEF_PLUS_SIGN), DateFormat.ABBR_WEEKDAY, String.valueOf((char) DEF_PERMILL), "∞", "NaN", null, null, "×"};
    private static final String[] SYMBOL_KEYS = {SchemaSymbols.ATTVAL_DECIMAL, "group", "percentSign", "minusSign", "plusSign", "exponential", "perMille", Constants.ATTRNAME_INFINITY, "nan", "currencyDecimal", "currencyGroup", "superscriptingExponent"};
    ...
    private void initialize(ULocale uLocale, NumberingSystem numberingSystem) {
        ...
        CacheData instance = cachedLocaleData.getInstance(uLocale2, null);
    ...
    public static CacheData loadData(ULocale uLocale) {
        ...
        try {
            bundleInstance.getAllItemsWithFallback("NumberElements/" + str + PsuedoNames.PSEUDONAME_ROOT + SYMBOLS, decFmtDataSink);

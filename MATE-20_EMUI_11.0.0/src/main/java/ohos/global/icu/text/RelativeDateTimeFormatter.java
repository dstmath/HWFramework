...
public final class RelativeDateTimeFormatter {
    ...
    private CharSequence formatRelativeImpl(double d, RelativeDateTimeUnit relativeDateTimeUnit) {
        ...
        if (d > -2.1d && d < 2.1d) {
            double d2 = 100.0d * d;
            int i = (int) (d2 < XPath.MATCH_SCORE_QNAME ? d2 - 0.5d : d2 + 0.5d);
            if (i == -200) {
    ...
    public static class Loader {
        ...
        public RelativeDateTimeFormatterData load() {
            ...
            ICUResourceBundle bundleInstance = UResourceBundle.getBundleInstance(ICUData.ICU_BASE_NAME, this.ulocale);
            bundleInstance.getAllItemsWithFallback("fields", relDateTimeDataSink);
            ...
            return new RelativeDateTimeFormatterData(relDateTimeDataSink.qualitativeUnitMap, relDateTimeDataSink.styleRelUnitPatterns, getDateTimePattern(bundleInstance));
        }
    }
}

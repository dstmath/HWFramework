...
public class TimeUnitFormat extends MeasureFormat {
    ...
    private void setup(String str, Map<TimeUnit, Map<String, Object[]>> map, int i, Set<String> set) {
        try {
            try {
                UResourceBundle.getBundleInstance(ICUData.ICU_UNIT_BASE_NAME, this.locale).getAllItemsWithFallback(str, new TimeUnitFormatSetupSink(map, i, set, this.locale));
    ...
    private void searchInTree(String str, int i, TimeUnit timeUnit, String str2, String str3, Map<String, Object[]> map) {
        ...
        while (uLocale != null) {
            try {
                MessageFormat messageFormat = new MessageFormat(UResourceBundle.getBundleInstance(ICUData.ICU_UNIT_BASE_NAME, uLocale).getWithFallback(str).getWithFallback(timeUnit2).getStringWithFallback(str3), this.locale);

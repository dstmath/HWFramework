...
public class ByteArrayWrapper implements Comparable<ByteArrayWrapper> {
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.size; i++) {
            ...
            sb.append(Utility.hex((long) (this.bytes[i] & Metadata.BeautySkinToneType.BEAUTY_COLORS_NONE), 2));
        }
        return sb.toString();
    }
    ...
    public int compareTo(ByteArrayWrapper byteArrayWrapper) {
        ...
        while (true) {
            ...
            if (b != bArr2[i3]) {
                i = bArr[i3] & Metadata.BeautySkinToneType.BEAUTY_COLORS_NONE;
                i2 = bArr2[i3] & Metadata.BeautySkinToneType.BEAUTY_COLORS_NONE;
                break;
            }
            i3++;
        }

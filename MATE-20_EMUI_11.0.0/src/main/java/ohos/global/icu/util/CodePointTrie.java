...
public abstract class CodePointTrie extends CodePointMap {
    ...
    public final boolean getRange(int i, CodePointMap.ValueFilter valueFilter, CodePointMap.Range range) {
        ...
        if (i >= this.highStart) {
            ...
            range.set(i, MAX_UNICODE, fromIndex2);
            return true;
        }
        ...
        while (true) {
                ...
                if (c2 == c5 && i6 - i >= 512) {
                    ...
                    while (true) {
                        if ((c2 & 32768) != 0) {
                            ...
                            c4 = ((cArr2[i15] << ((i16 * 2) + 2)) & 196608) | cArr2[i15 + 1 + i16];
                        }
                        if (c4 == i8 || i6 - i < i2) {
                            int i17 = i2 - 1;
            ...
            if (i6 >= this.highStart) {
                range.set(i, maybeFilterValue(this.data.getFromIndex(this.dataLength + -2), this.nullValue, i5, valueFilter) != i7 ? i6 - 1 : MAX_UNICODE, i7);
                return true;
            }
            z3 = true;
        }
    ...
    private static final class Data8 extends Data {
        ...
        @Override // ohos.global.icu.util.CodePointTrie.Data
        public int getFromIndex(int i) {
            return this.array[i] & Metadata.BeautySkinToneType.BEAUTY_COLORS_NONE;
        }
    ...
    public static abstract class Fast extends CodePointTrie {
        ...
        public final int cpIndex(int i) {
            if (i >= 0) {
                ...
                if (i <= CodePointTrie.MAX_UNICODE) {
    ...
    public static final class Fast8 extends Fast {
        ...
        @Override // ohos.global.icu.util.CodePointTrie, ohos.global.icu.util.CodePointMap
        public final int get(int i) {
            return this.dataArray[cpIndex(i)] & Metadata.BeautySkinToneType.BEAUTY_COLORS_NONE;
        }

        @Override // ohos.global.icu.util.CodePointTrie.Fast
        public final int bmpGet(int i) {
            return this.dataArray[fastIndex(i)] & Metadata.BeautySkinToneType.BEAUTY_COLORS_NONE;
        }

        @Override // ohos.global.icu.util.CodePointTrie.Fast
        public final int suppGet(int i) {
            return this.dataArray[smallIndex(Type.FAST, i)] & Metadata.BeautySkinToneType.BEAUTY_COLORS_NONE;
        }
    }

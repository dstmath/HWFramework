    ...
    private String _getDisplayName(int i, boolean z, ULocale uLocale) {
        ...
        if (uLocale != null) {
            ...
            if (i == 7 || i == 3 || i == 2) {
                ...
                if (i == 2) {
                    nameType = instance.format(TimeZoneFormat.Style.GENERIC_SHORT, this, currentTimeMillis, output);
                } else if (i == 3) {
                    nameType = instance.format(TimeZoneFormat.Style.GENERIC_LONG, this, currentTimeMillis, output);
                } else if (i == 7) {
                    nameType = instance.format(TimeZoneFormat.Style.GENERIC_LOCATION, this, currentTimeMillis, output);
                }
                ...
                if (i == 4) {
                    nameType = instance2.formatOffsetISO8601Basic(rawOffset2, false, false, false);
                } else if (i == 5) {
                    nameType = instance2.formatOffsetLocalizedGMT(rawOffset2);
                }
                return nameType;
            } else {

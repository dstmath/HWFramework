...
public class TextUtility {
    ...
    public Bundle textToBundle(Text text) {
        ...
        bundle.putFloat("probability", ConstantValue.MIN_ZOOM_VALUE);
    ...
    private static TextLine textLineFromBundle(Bundle bundle) {
        ...
        if (bundle != null) {
            textLine.setLineRect(bundle.getParcelable("rect"));
    ...
    private static TextElement textElementFromBundle(Bundle bundle) {
        ...
        if (bundle != null) {
            textElement.setElementRect(bundle.getParcelable("rect"));

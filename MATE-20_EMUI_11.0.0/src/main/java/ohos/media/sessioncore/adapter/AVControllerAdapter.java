...
public class AVControllerAdapter {
    ...
    static {
        ...
        HOST_KEY_CODE_MAPPING.put(KeyEvent.KEY_MEDIA_PLAY, 126);
        HOST_KEY_CODE_MAPPING.put(KeyEvent.KEY_MEDIA_PAUSE, 127);
    ...
    public boolean setAVControllerCallback(final AVControllerCallback aVControllerCallback) {
        AnonymousClass1 r0 = new MediaController.Callback() {
            ...
            public void onAudioInfoChanged(MediaController.PlaybackInfo playbackInfo) {
                aVControllerCallback.onAVPlaybackInfoChanged(AVPlaybackInfoAdapter.getAVPlaybackInfo(playbackInfo).get());
            }
        };

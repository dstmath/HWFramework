...
public class TranslateUtils {
    ...
    public static PendingIntent getPendingIntent(Context context, Intent intent, int i) {
        ...
        if (androidContext instanceof android.content.Context) {
            context2 = (android.content.Context) androidContext;
        } else {
            context2 = null;
        }
        ...
        if (i == 1) {
            return PendingIntent.getActivity(context2, 0, intent2, WifiUtils.WIFI_FEATURE_WPA3_SAE);
        }
        if (i == 2) {
            return PendingIntent.getBroadcast(context2, 0, intent2, WifiUtils.WIFI_FEATURE_WPA3_SAE);
        }
        if (i != 3) {
            return null;
        }
        return PendingIntent.getService(context2, 0, intent2, WifiUtils.WIFI_FEATURE_WPA3_SAE);
    }

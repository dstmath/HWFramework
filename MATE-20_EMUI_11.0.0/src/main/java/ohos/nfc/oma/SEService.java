...
public final class SEService {
    ...
    private SecureElementCallbackProxy mCallbackProxy;
    ...
    public SEService(Context context, OnCallback onCallback) {
        this.mContext = null;
        this.mCallback = null;

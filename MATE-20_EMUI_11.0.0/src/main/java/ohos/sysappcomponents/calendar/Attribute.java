...
public class Attribute {
    public static final Uri ATTENDEES_URI = UriConverter.convertToZidaneUri(CalendarContract.Attendees.CONTENT_URI);
    public static final Uri CALENDARS_URI = UriConverter.convertToZidaneUri(CalendarContract.Calendars.CONTENT_URI);
    public static final Uri EVENTS_URI = UriConverter.convertToZidaneUri(CalendarContract.Events.CONTENT_URI);
    public static final Uri INSTANCES_URI = UriConverter.convertToZidaneUri(CalendarContract.Instances.CONTENT_URI);
    public static final Uri REMINDERS_URI = UriConverter.convertToZidaneUri(CalendarContract.Reminders.CONTENT_URI);

...
public class SystemRestoreZipFilePropBean {
    ...
    private void setCommentSize(byte[] bArr) {
        this.commentLength = ((bArr[5] & Metadata.BeautySkinToneType.BEAUTY_COLORS_NONE) << 8) | (bArr[4] & Metadata.BeautySkinToneType.BEAUTY_COLORS_NONE);
    }
    ...
    private void setSignatureStart(byte[] bArr) {
        this.signatureStart = ((bArr[1] & Metadata.BeautySkinToneType.BEAUTY_COLORS_NONE) << 8) | (bArr[0] & Metadata.BeautySkinToneType.BEAUTY_COLORS_NONE);
    }

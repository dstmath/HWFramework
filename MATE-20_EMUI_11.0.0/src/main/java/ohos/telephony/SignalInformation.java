...
public abstract class SignalInformation implements Sequenceable {
    ...
    protected SignalInformation(int i) {
        this.signalNetworkType = i;
    }

    public int getSignalNetworkType() {
        return this.signalNetworkType;
    }

    public int hashCode() {
        return Objects.hash(Integer.valueOf(this.signalNetworkType));
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.signalNetworkType == ((SignalInformation) obj).signalNetworkType;
    }
    ...
    public boolean marshalling(Parcel parcel) {
        ...
        parcel.writeInt(this.signalNetworkType);
        return true;
    }
    ...
    public boolean unmarshalling(Parcel parcel) {
        ...
        this.signalNetworkType = parcel.readInt();
        return true;
    }

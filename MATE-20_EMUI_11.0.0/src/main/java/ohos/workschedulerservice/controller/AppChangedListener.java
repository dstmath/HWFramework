...
public final class AppChangedListener extends StateListener {
    ...
    private CommonEventSubscribeInfo getInfo() {
        ...
        intentFilter.addAction("usual.event.PACKAGE_ADDED");
        intentFilter.addAction("usual.event.PACKAGE_REMOVED");
        intentFilter.addAction("usual.event.PACKAGE_REPLACED");
        intentFilter.addAction("usual.event.PACKAGE_RESTARTED");
        IntentParams intentParams = new IntentParams();
        intentParams.setParam("scheme", new String[]{"package"});
        intentFilter.setIntentParams(intentParams);

...
public final class BatteryStateListener extends StateListener {
    ...
    private boolean enableBatteryListener() {
        ...
        intentFilter.addAction("usual.event.BATTERY_CHANGED");
        intentFilter.addAction("usual.event.BATTERY_LOW");
        intentFilter.addAction("usual.event.BATTERY_OKAY");
        intentFilter.addAction("usual.event.POWER_CONNECTED");
        intentFilter.addAction("usual.event.POWER_DISCONNECTED");
        intentFilter.addAction("usual.event.DISCHARGING");
        intentFilter.addAction("usual.event.CHARGING");
        this.batteryEventSubscriber = new BatteryStateEventSubscriber(new CommonEventSubscribeInfo(intentFilter));
        try {

...
public final class DeviceIdleListener extends StateListener {
    ...
    private CommonEventSubscribeInfo getInfo() {
        ...
        intentFilter.addAction("usual.event.SCREEN_ON");
        intentFilter.addAction("usual.event.SCREEN_OFF");
        intentFilter.addAction(START_DREAM);
        intentFilter.addAction(STOP_DREAM);

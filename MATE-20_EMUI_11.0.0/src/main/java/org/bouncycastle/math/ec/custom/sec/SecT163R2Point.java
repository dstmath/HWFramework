...
public class SecT163R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            eCFieldElement5 = divide.multiply(xCoord.add(addOne)).add(addOne).add(yCoord).divide(addOne).add(addOne);
            eCFieldElement4 = curve.fromBigInteger(ECConstants.ONE);
            eCFieldElement6 = addOne;
        } else {
            ...
            if (eCFieldElement6.isZero()) {
                return new SecT163R2Point(curve, eCFieldElement6, curve.getB().sqrt());
            }
        ...
        return new SecT163R2Point(curve, eCFieldElement6, eCFieldElement5, new ECFieldElement[]{eCFieldElement4});
    }

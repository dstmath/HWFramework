    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement6.isZero()) {
                return new SecT283R1Point(curve, eCFieldElement6, curve.getB().sqrt());
            }
        ...
        return new SecT283R1Point(curve, eCFieldElement6, eCFieldElement5, new ECFieldElement[]{eCFieldElement4});
    }

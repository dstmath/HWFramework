...
public abstract class Nat160 {
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 5; i < i2; i2 = 5) {
            ...
            iArr3[i3] = (int) j13;
            int i4 = i + 1;
            long j14 = (j13 >>> 32) + (j12 * j2) + (((long) iArr3[i4]) & 4294967295L);
            iArr3[i4] = (int) j14;
            int i5 = i + 2;
            long j15 = (j14 >>> 32) + (j12 * j3) + (((long) iArr3[i5]) & 4294967295L);
            iArr3[i5] = (int) j15;
            int i6 = i + 3;
            long j16 = (j15 >>> 32) + (j12 * j4) + (((long) iArr3[i6]) & 4294967295L);
            iArr3[i6] = (int) j16;
            int i7 = i + 4;
            long j17 = (j16 >>> 32) + (j12 * j5) + (((long) iArr3[i7]) & 4294967295L);
            iArr3[i7] = (int) j17;
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i4 < 5) {
            ...
            iArr3[i10] = (int) j13;
            int i11 = i5 + 5;
            long j14 = (j13 >>> 32) + (((long) iArr3[i11]) & 4294967295L) + j7;
            iArr3[i11] = (int) j14;
            j7 = j14 >>> 32;
            i4++;
            i5 = i7;
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i < 5) {
            ...
            iArr3[i6] = (int) j13;
            int i7 = i + 5;
            long j14 = (j13 >>> 32) + (((long) iArr3[i7]) & 4294967295L) + j7;
            iArr3[i7] = (int) j14;
            j7 = j14 >>> 32;
            i = i3;
            j = 4294967295L;
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                long j27 = (((long) iArr2[i20]) & 4294967295L) + (j22 >>> 32) + (j26 >>> 32);
                int i22 = (int) j24;
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                long j25 = (((long) iArr2[8]) & 4294967295L) + (j20 >>> 32) + (j24 >>> 32);
                int i11 = (int) j22;

...
public interface IBiometricsFaceRecognizeClientCallback extends IBase {
    public static final String kInterfaceName = "vendor.huawei.hardware.biometrics.hwfacerecognize@2.0::IBiometricsFaceRecognizeClientCallback";
    ...
    void onInitResult(int i) throws RemoteException;

    void onReleaseResult(int i) throws RemoteException;
    ...
    static IBiometricsFaceRecognizeClientCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static IBiometricsFaceRecognizeClientCallback castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static IBiometricsFaceRecognizeClientCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IBiometricsFaceRecognizeClientCallback getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static IBiometricsFaceRecognizeClientCallback getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static IBiometricsFaceRecognizeClientCallback getService() throws RemoteException {
    ...
    public static final class Proxy implements IBiometricsFaceRecognizeClientCallback {
        ...
        @Override // vendor.huawei.hardware.biometrics.hwfacerecognize.V2_0.IBiometricsFaceRecognizeClientCallback, android.hidl.base.V1_0.IBase
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.biometrics.hwfacerecognize@2.0::IBiometricsFaceRecognizeClientCallback]@Proxy";
            }
        }
        ...
        public void onEnrollResult(int faceId, int userId, int errorCode) throws RemoteException {
            ...
            _hidl_request.writeInterfaceToken(IBiometricsFaceRecognizeClientCallback.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements IBiometricsFaceRecognizeClientCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IBiometricsFaceRecognizeClientCallback.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{90, -126, -86, 114, 116, -18, 56, -70, -69, 66, -105, Byte.MAX_VALUE, -40, -98, 79, -37, -35, 94, 87, 117, 42, -42, 68, -124, -21, -9, 45, -53, 17, -79, 58, -13}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    _hidl_request.enforceInterface(IBiometricsFaceRecognizeClientCallback.kInterfaceName);

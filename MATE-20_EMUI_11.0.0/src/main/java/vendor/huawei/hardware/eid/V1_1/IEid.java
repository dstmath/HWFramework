...
public interface IEid extends vendor.huawei.hardware.eid.V1_0.IEid {
    ...
    public static final class Proxy implements IEid {
        ...
        @Override // vendor.huawei.hardware.eid.V1_0.IEid
        public void HWEidGetImage(ENCRYPTION_FACTOR_S factor, IEid.HWEidGetImageCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.eid.V1_0.IEid.kInterfaceName);
        ...
        @Override // vendor.huawei.hardware.eid.V1_0.IEid
        public void HWEidGetUnsecImage(IMAGE_CONTAINER_S container, ENCRYPTION_FACTOR_S factor, IEid.HWEidGetUnsecImageCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.eid.V1_0.IEid.kInterfaceName);
        ...
        @Override // vendor.huawei.hardware.eid.V1_0.IEid
        public void HWEidGetCertificateRequestMessage(CERTIFICATE_REQUEST_MESSAGE_INPUT_INFO_S input, IEid.HWEidGetCertificateRequestMessageCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.eid.V1_0.IEid.kInterfaceName);
        ...
        @Override // vendor.huawei.hardware.eid.V1_0.IEid
        public void HWEidGetInfoSign(INFO_SIGN_INPUT_INFO_S input, IEid.HWEidGetInfoSignCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.eid.V1_0.IEid.kInterfaceName);
            input.writeToParcel(_hidl_request);
            HwParcel _hidl_reply = new HwParcel();
        ...
        @Override // vendor.huawei.hardware.eid.V1_0.IEid
        public void HWEidGetIdentityInformation(IDENTITY_INFORMATION_INPUT_INFO_S input, IEid.HWEidGetIdentityInformationCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.eid.V1_0.IEid.kInterfaceName);
            input.writeToParcel(_hidl_request);
            HwParcel _hidl_reply = new HwParcel();
        ...
        @Override // vendor.huawei.hardware.eid.V1_0.IEid
        public void HWEidGetFaceIsChanged(FACE_CHANGE_INPUT_INFO_S input, IEid.HWEidGetFaceIsChangedCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.eid.V1_0.IEid.kInterfaceName);
            input.writeToParcel(_hidl_request);
            HwParcel _hidl_reply = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IEid {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-88, -30, -29, 32, 17, 102, 27, -35, 88, -120, -94, 80, -61, 119, 108, 6, -79, -18, 29, 19, -87, 20, 59, -20, 31, -79, 70, -102, 22, -29, -5, -66}, new byte[]{61, -19, 84, 41, -25, 29, -106, 79, 96, 47, 120, 123, -46, 1, -54, 102, 115, 88, 123, -105, 95, 101, -79, 101, 119, 77, -46, -9, 54, 45, 117, 84}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 3:
                    ...
                    HWEidGetImage(factor, new IEid.HWEidGetImageCallback() {
                ...
                case 4:
                    ...
                    HWEidGetUnsecImage(container, factor2, new IEid.HWEidGetUnsecImageCallback() {
                ...
                case 5:
                    ...
                    HWEidGetCertificateRequestMessage(input, new IEid.HWEidGetCertificateRequestMessageCallback() {
                ...
                case 6:
                    ...
                    HWEidGetInfoSign(input2, new IEid.HWEidGetInfoSignCallback() {
                ...
                case 7:
                    ...
                    HWEidGetIdentityInformation(input3, new IEid.HWEidGetIdentityInformationCallback() {
                ...
                case 8:
                    ...
                    HWEidGetFaceIsChanged(input4, new IEid.HWEidGetFaceIsChangedCallback() {

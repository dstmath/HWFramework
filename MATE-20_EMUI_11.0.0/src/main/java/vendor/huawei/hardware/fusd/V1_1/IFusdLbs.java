...
public interface IFusdLbs extends vendor.huawei.hardware.fusd.V1_0.IFusdLbs {
    public static final String kInterfaceName = "vendor.huawei.hardware.fusd@1.1::IFusdLbs";

    @Override // vendor.huawei.hardware.fusd.V1_0.IFusdLbs, android.hidl.base.V1_0.IBase
    IHwBinder asBinder();

    void cleanUpHifence(int i) throws RemoteException;

    @Override // vendor.huawei.hardware.fusd.V1_0.IFusdLbs, android.hidl.base.V1_0.IBase
    void debug(NativeHandle nativeHandle, ArrayList<String> arrayList) throws RemoteException;

    ICellFenceInterface getCellFenceInterface() throws RemoteException;

    @Override // vendor.huawei.hardware.fusd.V1_0.IFusdLbs, android.hidl.base.V1_0.IBase
    DebugInfo getDebugInfo() throws RemoteException;

    IGeofenceInterface getGeofenceInterface() throws RemoteException;

    IGnssBatchingInterface getGnssBatchingInterface() throws RemoteException;
    ...
    void registerLbsServiceCallbackV1_1(IFusdLbsCallback iFusdLbsCallback) throws RemoteException;

    void sendHwNLPLocation(ArrayList<GnssLocation> arrayList) throws RemoteException;

    void sendHwNLPStatus(ArrayList<Integer> arrayList) throws RemoteException;
    ...
    public static final class Proxy implements IFusdLbs {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.fusd@1.1::IFusdLbs]@Proxy";
            }
        }
        ...
        public void registerLbsServiceCallbackV1_1(IFusdLbsCallback callback) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IFusdLbs {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IFusdLbs.kInterfaceName, vendor.huawei.hardware.fusd.V1_0.IFusdLbs.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 11:
                    ...
                    registerLbsServiceCallbackV1_1(IFusdLbsCallback.asInterface(_hidl_request.readStrongBinder()));
                    return;
                case 12:
                    if ((_hidl_flags & 1) == 0) {
                        _hidl_is_oneway2 = false;

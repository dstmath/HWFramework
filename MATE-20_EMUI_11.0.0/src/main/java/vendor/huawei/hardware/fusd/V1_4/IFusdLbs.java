...
public interface IFusdLbs extends vendor.huawei.hardware.fusd.V1_3.IFusdLbs {
    public static final String kInterfaceName = "vendor.huawei.hardware.fusd@1.4::IFusdLbs";

    @Override // vendor.huawei.hardware.fusd.V1_3.IFusdLbs, vendor.huawei.hardware.fusd.V1_2.IFusdLbs, vendor.huawei.hardware.fusd.V1_1.IFusdLbs, vendor.huawei.hardware.fusd.V1_0.IFusdLbs, android.hidl.base.V1_0.IBase
    IHwBinder asBinder();
    ...
    IGnssEEData getExtensionEEData() throws RemoteException;

    IFlpLocationBatchingInterface getFlpLocationBatchingInterface() throws RemoteException;

    @Override // vendor.huawei.hardware.fusd.V1_3.IFusdLbs, vendor.huawei.hardware.fusd.V1_2.IFusdLbs, vendor.huawei.hardware.fusd.V1_1.IFusdLbs, vendor.huawei.hardware.fusd.V1_0.IFusdLbs, android.hidl.base.V1_0.IBase
    ArrayList<byte[]> getHashChain() throws RemoteException;

    IInterferenceWeakInterface getInterferenceWeakInterface() throws RemoteException;

    IMMInterface getMMInterfaceV1_4() throws RemoteException;

    IPDRInterface getPDRInterface() throws RemoteException;

    IRemoteVehicleInterface getRemoteVehicleInterface() throws RemoteException;

    ISDMInterface getSDMInterface() throws RemoteException;
    ...
    public static final class Proxy implements IFusdLbs {
        ...
        @Override // vendor.huawei.hardware.fusd.V1_4.IFusdLbs, vendor.huawei.hardware.fusd.V1_3.IFusdLbs, vendor.huawei.hardware.fusd.V1_2.IFusdLbs, vendor.huawei.hardware.fusd.V1_1.IFusdLbs, vendor.huawei.hardware.fusd.V1_0.IFusdLbs, android.hidl.base.V1_0.IBase
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.fusd@1.4::IFusdLbs]@Proxy";
            }
        }
        ...
        @Override // vendor.huawei.hardware.fusd.V1_4.IFusdLbs
        public IMMInterface getMMInterfaceV1_4() throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IFusdLbs.kInterfaceName);
            HwParcel _hidl_reply = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements IFusdLbs {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IFusdLbs.kInterfaceName, vendor.huawei.hardware.fusd.V1_3.IFusdLbs.kInterfaceName, vendor.huawei.hardware.fusd.V1_2.IFusdLbs.kInterfaceName, vendor.huawei.hardware.fusd.V1_1.IFusdLbs.kInterfaceName, vendor.huawei.hardware.fusd.V1_0.IFusdLbs.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 29:
                    ...
                    _hidl_request.enforceInterface(IFusdLbs.kInterfaceName);
                    IMMInterface _hidl_out_cbIface3 = getMMInterfaceV1_4();
                    _hidl_reply.writeStatus(0);

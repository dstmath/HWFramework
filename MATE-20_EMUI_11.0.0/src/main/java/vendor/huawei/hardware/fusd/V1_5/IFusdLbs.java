package vendor.huawei.hardware.fusd.V1_5;
...
public interface IFusdLbs extends vendor.huawei.hardware.fusd.V1_4.IFusdLbs {
    public static final String kInterfaceName = "vendor.huawei.hardware.fusd@1.5::IFusdLbs";
    ...
    void sendCityCode(int i) throws RemoteException;

    void sendHDGnssMode(int i) throws RemoteException;

    void sendHigeoExtraInfo(int i, ArrayList<Integer> arrayList) throws RemoteException;

    void sendMccCode(int i) throws RemoteException;
    ...
    public static final class Proxy implements IFusdLbs {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.fusd@1.5::IFusdLbs]@Proxy";
            }
        }

...
public final class RILUICCAUTHRESPONSE {
    public RILUICCAUTHRESPCHALLENGETYPE authChallenge = new RILUICCAUTHRESPCHALLENGETYPE();
    public int authStatus;
    public RILUICCAUTHRESPSYNCFAILTYPE authSyncfail = new RILUICCAUTHRESPSYNCFAILTYPE();

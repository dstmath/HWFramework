...
public final class HwCellIdentity_1_1 {
    ...
    public ArrayList<HwCellIdentityNr> cellIdentityNr = new ArrayList<>();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob6 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size6 * 48), _hidl_blob.handle(), _hidl_offset + 88 + 0, true);
        ...
        for (int _hidl_index_06 = 0; _hidl_index_06 < _hidl_vec_size6; _hidl_index_06++) {
            ...
            _hidl_vec_element6.readEmbeddedFromParcel(parcel, childBlob6, (long) (_hidl_index_06 * 48));
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_06 = 0; _hidl_index_06 < _hidl_vec_size6; _hidl_index_06++) {
            this.cellIdentityNr.get(_hidl_index_06).writeEmbeddedToBlob(childBlob6, (long) (_hidl_index_06 * 48));
        }

...
public final class HwDataRegStateResult_1_2 {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != HwDataRegStateResult_1_2.class) {
            return false;
        }
        HwDataRegStateResult_1_2 other = (HwDataRegStateResult_1_2) otherObject;
    ...
    public static final ArrayList<HwDataRegStateResult_1_2> readVectorFromParcel(HwParcel parcel) {
        ArrayList<HwDataRegStateResult_1_2> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 128), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            HwDataRegStateResult_1_2 _hidl_vec_element = new HwDataRegStateResult_1_2();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<HwDataRegStateResult_1_2> _hidl_vec) {

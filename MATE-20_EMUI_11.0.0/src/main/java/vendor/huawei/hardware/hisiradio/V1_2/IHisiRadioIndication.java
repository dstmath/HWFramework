...
public interface IHisiRadioIndication extends vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioIndication {
    public static final String kInterfaceName = "vendor.huawei.hardware.hisiradio@1.2::IHisiRadioIndication";

    @Override // vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioIndication, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioIndication, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
    IHwBinder asBinder();

    @Override // vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioIndication, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioIndication, android.internal.hidl.base.V1_0.IBase
    ...
    void reportDl256QamState(int i, int i2) throws RemoteException;
    ...
    public static final class Proxy implements IHisiRadioIndication {
        ...
        @Override // vendor.huawei.hardware.hisiradio.V1_2.IHisiRadioIndication, vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioIndication, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioIndication, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.hisiradio@1.2::IHisiRadioIndication]@Proxy";
            }
        }
        ...
        @Override // vendor.huawei.hardware.hisiradio.V1_2.IHisiRadioIndication, vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioIndication, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioIndication, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IHisiRadioIndication {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IHisiRadioIndication.kInterfaceName, vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioIndication.kInterfaceName, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioIndication.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-108, 50, -91, 74, 80, -51, -93, -58, -75, -30, 26, 19, 56, -106, -7, -81, 34, 74, 92, -41, 34, -19, -29, 80, 119, -42, 30, BluetoothHidDevice.SUBCLASS1_KEYBOARD, 115, -12, -47, 68}, new byte[]{98, -58, -111, 89, -53, -93, -123, BluetoothHidDevice.SUBCLASS1_KEYBOARD, 84, 110, -34, 72, 36, 28, 115, -24, 52, 1, 91, 54, 121, -59, 90, -24, 39, -91, 19, -121, 3, 49, 58, -66}, new byte[]{-104, WifiScanner.PnoSettings.PnoNetwork.FLAG_SAME_NETWORK, MidiConstants.STATUS_PITCH_BEND, -88, 19, 68, 21, MidiConstants.STATUS_CHANNEL_PRESSURE, -110, 43, -63, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 52, 31, -93, -98, -43, -51, -117, -105, -42, -10, -115, -90, -29, 126, 117, 78, 99, -120, 8, -28}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }

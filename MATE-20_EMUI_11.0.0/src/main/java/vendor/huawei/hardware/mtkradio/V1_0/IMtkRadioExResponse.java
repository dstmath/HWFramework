...
public interface IMtkRadioExResponse extends IBase {
    public static final String kInterfaceName = "vendor.huawei.hardware.mtkradio@1.0::IMtkRadioExResponse";
    ...
    void getCsconEnabledResponse(RadioResponseInfo radioResponseInfo, int i) throws RemoteException;
    ...
    void setCsconEnabledResponse(RadioResponseInfo radioResponseInfo) throws RemoteException;
    ...
    public static final class Proxy implements IMtkRadioExResponse {
        ...
        @Override // vendor.huawei.hardware.mtkradio.V1_0.IMtkRadioExResponse, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.mtkradio@1.0::IMtkRadioExResponse]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IMtkRadioExResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IMtkRadioExResponse.kInterfaceName, IBase.kInterfaceName));
        }

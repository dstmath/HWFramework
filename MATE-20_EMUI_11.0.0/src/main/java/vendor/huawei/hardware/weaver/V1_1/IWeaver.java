package vendor.huawei.hardware.weaver.V1_1;
...
public interface IWeaver extends vendor.huawei.hardware.weaver.V1_0.IWeaver {
    public static final String kInterfaceName = "vendor.huawei.hardware.weaver@1.1::IWeaver";
    ...
    int prepareWeaver(int i) throws RemoteException;
    ...
    public static final class Proxy implements IWeaver {
        ...
        @Override // vendor.huawei.hardware.weaver.V1_1.IWeaver, vendor.huawei.hardware.weaver.V1_0.IWeaver
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.weaver@1.1::IWeaver]@Proxy";
            }
        }
        ...
        @Override // vendor.huawei.hardware.weaver.V1_0.IWeaver
        public void getStatus(int slotId, IWeaver.getStatusCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.weaver.V1_0.IWeaver.kInterfaceName);
            _hidl_request.writeInt32(slotId);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        @Override // vendor.huawei.hardware.weaver.V1_1.IWeaver
        public int prepareWeaver(int slotId) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IWeaver {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IWeaver.kInterfaceName, vendor.huawei.hardware.weaver.V1_0.IWeaver.kInterfaceName, "android.hardware.weaver@1.0::IWeaver", "android.hidl.base@1.0::IBase"));
        }
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    getConfig(new IWeaver.getConfigCallback() {
                        /* class vendor.huawei.hardware.weaver.V1_1.IWeaver.Stub.AnonymousClass1 */
                ...
                case 3:
                    ...
                    read(_hidl_request.readInt32(), _hidl_request.readInt8Vector(), new IWeaver.readCallback() {
                        /* class vendor.huawei.hardware.weaver.V1_1.IWeaver.Stub.AnonymousClass2 */
                ...
                case 4:
                    ...
                    _hidl_request.enforceInterface(vendor.huawei.hardware.weaver.V1_0.IWeaver.kInterfaceName);
                    getStatus(_hidl_request.readInt32(), new IWeaver.getStatusCallback() {
                        /* class vendor.huawei.hardware.weaver.V1_1.IWeaver.Stub.AnonymousClass3 */
                ...
                case 6:
                    ...
                    int _hidl_out_status3 = prepareWeaver(_hidl_request.readInt32());
                    _hidl_reply.writeStatus(0);

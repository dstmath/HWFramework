...
public interface ISupplicantStaNetwork extends android.hardware.wifi.supplicant.V1_2.ISupplicantStaNetwork {
    ...
    public static final class Proxy implements ISupplicantStaNetwork {
        ...
        @Override // vendor.huawei.hardware.wifi.supplicant.V3_0.ISupplicantStaNetwork, android.hardware.wifi.supplicant.V1_2.ISupplicantStaNetwork, android.hardware.wifi.supplicant.V1_1.ISupplicantStaNetwork, android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork, android.hardware.wifi.supplicant.V1_0.ISupplicantNetwork, android.hidl.base.V1_0.IBase

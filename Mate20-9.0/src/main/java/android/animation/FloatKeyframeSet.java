    ...
    public float getFloatValue(float fraction) {
        ...
        if (fraction <= 0.0f) {
            ...
            if (this.mEvaluator == null) {
                f3 = ((nextValue - prevValue) * intervalFraction) + prevValue;
            } else {
                f3 = ((Number) this.mEvaluator.evaluate(intervalFraction, Float.valueOf(prevValue), Float.valueOf(nextValue))).floatValue();
            }
            return f3;
            ...
            if (this.mEvaluator == null) {
                f2 = ((nextValue2 - prevValue2) * intervalFraction2) + prevValue2;
            } else {
                f2 = ((Number) this.mEvaluator.evaluate(intervalFraction2, Float.valueOf(prevValue2), Float.valueOf(nextValue2))).floatValue();
            }
            return f2;
        } else {
            ...
            for (int i = 1; i < this.mNumKeyframes; i++) {
                ...
                if (fraction < nextKeyframe3.getFraction()) {
                    ...
                    if (this.mEvaluator == null) {
                        f = ((nextValue3 - prevValue3) * intervalFraction3) + prevValue3;
                    } else {
                        f = ((Number) this.mEvaluator.evaluate(intervalFraction3, Float.valueOf(prevValue3), Float.valueOf(nextValue3))).floatValue();
                    }
                    return f;
                }

...
class ActivityTransitionState {
    ...
    public void enterReady(Activity activity) {
        if (this.mEnterActivityOptions != null && !this.mIsEnterTriggered) {
            ...
            EnterTransitionCoordinator enterTransitionCoordinator = new EnterTransitionCoordinator(activity, resultReceiver, sharedElementNames, this.mEnterActivityOptions.isReturning(), this.mEnterActivityOptions.isCrossTask());
            this.mEnterTransitionCoordinator = enterTransitionCoordinator;
    ...
    public boolean startExitBackTransition(Activity activity) {
        ...
        if (!this.mHasExited) {
            ...
            ExitTransitionCoordinator exitTransitionCoordinator = new ExitTransitionCoordinator(activity, activity.getWindow(), activity.mEnterTransitionListener, this.mEnteringNames, null, null, true);

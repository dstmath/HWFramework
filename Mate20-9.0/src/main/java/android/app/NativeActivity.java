    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (path == null) {
                ...
                if (libraryPath != null) {
                    ...
                    while (true) {
                        ...
                        File libraryFile = new File(paths[i], libName);
            ...
            if (path2 != null) {
                ...
                this.mNativeHandle = loadNativeCode(path2, funcname2, Looper.myQueue(), getAbsolutePath(getFilesDir()), getAbsolutePath(getObbDir()), getAbsolutePath(getExternalFilesDir(null)), Build.VERSION.SDK_INT, getAssets(), bundle != null ? bundle.getByteArray(KEY_NATIVE_SAVED_STATE) : null, classLoader, classLoader.getLdLibraryPath());

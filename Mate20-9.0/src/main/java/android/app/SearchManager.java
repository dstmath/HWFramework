...
public class SearchManager implements DialogInterface.OnDismissListener, DialogInterface.OnCancelListener {
    ...
    SearchManager(Context context, Handler handler) throws ServiceManager.ServiceNotFoundException {
        ...
        this.mService = ISearchManager.Stub.asInterface(ServiceManager.getServiceOrThrow(Context.SEARCH_SERVICE));
    }
    ...
    public Cursor getSuggestions(SearchableInfo searchable, String query, int limit) {
        ...
        if (Settings.Secure.getInt(this.mContext.getContentResolver(), "app_lock_func_status", 0) == 1) {
            if ((Settings.Secure.getString(this.mContext.getContentResolver(), "app_lock_list") + ";").contains(pkgName + ";")) {
                return this.cursor;
            }
        }

...
public final class Slice implements Parcelable {
    ...
    public static class Builder {
        ...
        public Builder addAction(PendingIntent action, Slice s, String subType) {
            ...
            SliceItem sliceItem = new SliceItem(action, s, "action", subType, (String[]) hints.toArray(new String[hints.size()]));
            arrayList.add(sliceItem);
            return this;
        }

        public Builder addText(CharSequence text, String subType, List<String> hints) {
            this.mItems.add(new SliceItem((Object) text, SliceItem.FORMAT_TEXT, subType, hints));
            return this;
        }

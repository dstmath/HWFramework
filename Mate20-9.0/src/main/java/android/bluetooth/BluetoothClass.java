...
public final class BluetoothClass implements Parcelable {
    ...
    public int getMajorDeviceClass() {
        return this.mClass & Device.Major.UNCATEGORIZED;
    }
    ...
    public boolean doesClassMatch(int profile) {
        ...
        if (profile == 1) {
            ...
            return deviceClass == 1044 || deviceClass == 1048 || deviceClass == 1056 || deviceClass == 1064;
        } else if (profile == 6) {
            if (hasService(524288)) {
                return true;
            }
            int deviceClass2 = getDeviceClass();
            return deviceClass2 == 1060 || deviceClass2 == 1064 || deviceClass2 == 1068;
        } else if (profile == 0) {
            if (hasService(262144)) {
                return true;
            }
            int deviceClass3 = getDeviceClass();
            return deviceClass3 == 1028 || deviceClass3 == 1032 || deviceClass3 == 1056;
        } else if (profile == 2) {

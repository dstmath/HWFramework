...
public final class BluetoothDevice implements Parcelable {
    ...
    public BluetoothSocket createRfcommSocket(int channel) throws IOException {
        if (isBluetoothEnabled()) {
            BluetoothSocket bluetoothSocket = new BluetoothSocket(1, -1, true, true, this, channel, null);
    ...
    public BluetoothSocket createL2capSocket(int channel) throws IOException {
        BluetoothSocket bluetoothSocket = new BluetoothSocket(3, -1, true, true, this, channel, null);
        return bluetoothSocket;
    }

    public BluetoothSocket createInsecureL2capSocket(int channel) throws IOException {
        BluetoothSocket bluetoothSocket = new BluetoothSocket(3, -1, false, false, this, channel, null);
        return bluetoothSocket;
    }

    public BluetoothSocket createRfcommSocketToServiceRecord(UUID uuid) throws IOException {
        if (isBluetoothEnabled()) {
            BluetoothSocket bluetoothSocket = new BluetoothSocket(1, -1, true, true, this, -1, new ParcelUuid(uuid));
            return bluetoothSocket;
        }
        Log.e(TAG, "Bluetooth is not enabled");
        throw new IOException();
    ...
    public BluetoothSocket createInsecureRfcommSocketToServiceRecord(UUID uuid) throws IOException {
        if (isBluetoothEnabled()) {
            BluetoothSocket bluetoothSocket = new BluetoothSocket(1, -1, false, false, this, -1, new ParcelUuid(uuid));
            return bluetoothSocket;
        }
        Log.e(TAG, "Bluetooth is not enabled");
        throw new IOException();
    ...
    public BluetoothSocket createInsecureRfcommSocket(int port) throws IOException {
        if (isBluetoothEnabled()) {
            BluetoothSocket bluetoothSocket = new BluetoothSocket(1, -1, false, false, this, port, null);
            return bluetoothSocket;
        }
        Log.e(TAG, "Bluetooth is not enabled");
        throw new IOException();
    ...
    public BluetoothSocket createScoSocket() throws IOException {
        if (isBluetoothEnabled()) {
            BluetoothSocket bluetoothSocket = new BluetoothSocket(2, -1, true, true, this, -1, null);
            return bluetoothSocket;
        }
        Log.e(TAG, "Bluetooth is not enabled");
        throw new IOException();
    ...
    public BluetoothGatt connectGatt(Context context, boolean autoConnect, BluetoothGattCallback callback, int transport, boolean opportunistic, int phy, Handler handler) {
        ...
        if (bluetoothGattCallback != null) {
            try {
                ...
                BluetoothGatt bluetoothGatt = new BluetoothGatt(iGatt, this, transport, opportunistic, phy);
    ...
    public BluetoothSocket createL2capCocSocket(int transport, int psm) throws IOException {
        if (!isBluetoothEnabled()) {
            ...
            BluetoothSocket bluetoothSocket = new BluetoothSocket(4, -1, true, true, this, psm, null);
            return bluetoothSocket;
        } else {
    ...
    public BluetoothSocket createInsecureL2capCocSocket(int transport, int psm) throws IOException {
        if (!isBluetoothEnabled()) {
            ...
            BluetoothSocket bluetoothSocket = new BluetoothSocket(4, -1, false, false, this, psm, null);
            return bluetoothSocket;
        } else {
            throw new IllegalArgumentException("Unsupported transport: " + transport);
        }

...
public final class BluetoothHealth implements BluetoothProfile {
        ...
        public void onBluetoothStateChange(boolean up) {
            ...
            if (!up) {
                synchronized (BluetoothHealth.this.mConnection) {
                    try {
                        IBluetoothHealth unused = BluetoothHealth.this.mService = null;
    ...
    public final ServiceConnection mConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            IBluetoothHealth unused = BluetoothHealth.this.mService = IBluetoothHealth.Stub.asInterface(Binder.allowBlocking(service));
    ...
    /* access modifiers changed from: private */
    public volatile IBluetoothHealth mService;
    /* access modifiers changed from: private */

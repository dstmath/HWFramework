...
public final class AdvertisingSetParameters implements Parcelable {
    ...
    public static final class Builder {
        ...
        public AdvertisingSetParameters build() {
            ...
            AdvertisingSetParameters advertisingSetParameters = new AdvertisingSetParameters(this.mConnectable, this.mScannable, this.mIsLegacy, this.mIsAnonymous, this.mIncludeTxPower, this.mPrimaryPhy, this.mSecondaryPhy, this.mInterval, this.mTxPowerLevel);
    ...
    private AdvertisingSetParameters(Parcel in) {
        ...
        this.mIncludeTxPower = in.readInt() != 0 ? true : z;

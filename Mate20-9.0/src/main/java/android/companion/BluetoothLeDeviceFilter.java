...
public final class BluetoothLeDeviceFilter implements DeviceFilter<ScanResult> {
    ...
    public static final class Builder extends OneTimeUseBuilder<BluetoothLeDeviceFilter> {
        ...
        public BluetoothLeDeviceFilter build() {
            markUsed();
            BluetoothLeDeviceFilter bluetoothLeDeviceFilter = new BluetoothLeDeviceFilter(this.mNamePattern, this.mScanFilter, this.mRawDataFilter, this.mRawDataFilterMask, this.mRenamePrefix, this.mRenameSuffix, this.mRenameBytesFrom, this.mRenameBytesLength, this.mRenameNameFrom, this.mRenameNameLength, this.mRenameBytesReverseOrder);

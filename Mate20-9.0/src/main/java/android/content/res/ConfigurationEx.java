...
public final class ConfigurationEx implements Comparable<Object>, IHwConfiguration {
    ...
    public int compareTo(Object that) {
        if (that instanceof ConfigurationEx) {
            return compareTo((IHwConfiguration) (ConfigurationEx) that);
        }
    ...
    /* JADX WARNING: type inference failed for: r5v0, types: [android.content.res.IHwConfiguration] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public boolean equals(IHwConfiguration r5) {
        ConfigurationEx that = r5;
        boolean z = false;
        if (that == null) {
            return false;
        }
    ...
    public boolean equals(Object that) {
        if (that instanceof ConfigurationEx) {
            return equals((IHwConfiguration) (ConfigurationEx) that);
        }
        return false;
    }

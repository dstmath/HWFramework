...
public class RotateFilter extends Filter {
    ...
    private void updateParameters() {
        ...
        if (this.mAngle % 90 == 0) {
            ...
            ((ShaderProgram) this.mProgram).setTargetRegion(new Quad(new Point(((-sinTheta) + cosTheta + 1.0f) * 0.5f, (((-cosTheta) - sinTheta) + 1.0f) * 0.5f), new Point((sinTheta + cosTheta + 1.0f) * 0.5f, ((cosTheta - sinTheta) + 1.0f) * 0.5f), new Point((((-sinTheta) - cosTheta) + 1.0f) * 0.5f, ((-cosTheta) + sinTheta + 1.0f) * 0.5f), new Point(((sinTheta - cosTheta) + 1.0f) * 0.5f, 0.5f * (cosTheta + sinTheta + 1.0f))));
            return;
        }

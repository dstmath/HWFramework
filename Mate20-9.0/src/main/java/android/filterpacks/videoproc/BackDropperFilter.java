...
public class BackDropperFilter extends Filter {
    ...
    private static final String[] mInputNames = {MediaCodec.MetricsConstants.MODE_VIDEO, "background"};
    ...
    private static final String[] mOutputNames = {MediaCodec.MetricsConstants.MODE_VIDEO};
    ...
    public void setupPorts() {
        ...
        for (String outputName : mOutputNames) {
            addOutputBasedOnInput(outputName, MediaCodec.MetricsConstants.MODE_VIDEO);
        }
        if (this.mProvideDebugOutputs) {
            for (String outputName2 : mDebugOutputNames) {
                addOutputBasedOnInput(outputName2, MediaCodec.MetricsConstants.MODE_VIDEO);
            }
        }
    }
    ...
    public void process(FilterContext context) {
        int i;
        boolean z;
        Frame video = pullInput(MediaCodec.MetricsConstants.MODE_VIDEO);
        ...
        if (this.mFrameCount <= this.mLearningDuration) {
            pushOutput(MediaCodec.MetricsConstants.MODE_VIDEO, video);

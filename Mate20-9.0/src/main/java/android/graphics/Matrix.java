...
public class Matrix {
    ...
    private static class NoImagePreloadHolder {
        ...
        static {
            NativeAllocationRegistry nativeAllocationRegistry = new NativeAllocationRegistry(Matrix.class.getClassLoader(), Matrix.nGetNativeFinalizer(), Matrix.NATIVE_ALLOCATION_SIZE);

...
public final class Sensor {
    ...
    public static final String SENSOR_STRING_TYPE_CMC = "com.qti.sensor.cmc";
    public static final String SENSOR_STRING_TYPE_TILT_DETECTOR = "android.sensor.tilt_detector";
    public static final int SENSOR_TYPE_CMC = 33171012;
    ...
    private boolean setType(int value) {
        ...
        if (i == 27) {
            ...
            this.mStringType = SENSOR_STRING_TYPE_CMC;
            return true;
        }
    }

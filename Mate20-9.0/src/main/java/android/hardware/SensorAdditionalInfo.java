...
public class SensorAdditionalInfo {
    ...
    public static SensorAdditionalInfo createLocalGeomagneticField(float strength, float declination, float inclination) {
        ...
        SensorAdditionalInfo sensorAdditionalInfo = new SensorAdditionalInfo(null, 196608, 0, null, new float[]{strength, declination, inclination});
    ...
    public static SensorAdditionalInfo createCustomInfo(Sensor aSensor, int type2, float[] data) {
        ...
        SensorAdditionalInfo sensorAdditionalInfo = new SensorAdditionalInfo(aSensor, type2, 0, null, data);
        return sensorAdditionalInfo;
    }
}

...
public abstract class CameraMetadata<TKey> {
    ...
    public <TKey> ArrayList<TKey> getKeys(Class<?> type, Class<TKey> keyClass, CameraMetadata<TKey> instance, int[] filterTags) {
        long vendorId;
        String keyName;
        ...
        ArrayList<K> allVendorKeys = this.mNativeInstance.getAllVendorKeys(keyClass);

...
public class CameraDeviceUserShim implements ICameraDeviceUser {
    ...
    public static CameraDeviceUserShim connectBinderShim(ICameraDeviceCallbacks callbacks, int cameraId) {
        ...
        try {
            ...
            CameraDeviceUserShim cameraDeviceUserShim = new CameraDeviceUserShim(cameraId, new LegacyCameraDevice(cameraId, legacyCamera, characteristics, threadCallbacks), characteristics, init, threadCallbacks);
            return cameraDeviceUserShim;
        } catch (RuntimeException e) {

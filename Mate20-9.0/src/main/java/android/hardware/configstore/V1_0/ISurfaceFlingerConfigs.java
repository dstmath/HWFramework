...
public interface ISurfaceFlingerConfigs extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements ISurfaceFlingerConfigs {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{Byte.MAX_VALUE, 95, -24, -12, -8, -94, 64, 55, 21, 60, 80, 77, -117, 77, 51, 19, -62, -50, 51, -40, 28, -116, 105, -2, 81, -108, -35, -46, -44, 8, 14, 114}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, UsbASFormat.EXT_FORMAT_TYPE_II, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, UsbDescriptor.DESCRIPTORTYPE_BOS, -39}}));
        }

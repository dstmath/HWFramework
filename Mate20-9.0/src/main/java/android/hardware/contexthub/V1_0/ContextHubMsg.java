...
public final class ContextHubMsg {
    ...
    public final String toString() {
        return "{" + ".appName = " + this.appName + ", .hostEndPoint = " + this.hostEndPoint + ", .msgType = " + this.msgType + ", .msg = " + this.msg + "}";
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                childBlob.putInt8((long) (_hidl_index_02 * 1), this.msg.get(_hidl_index_02).byteValue());

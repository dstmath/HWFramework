...
public interface IContexthub extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IContexthub {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-91, -82, UsbDescriptor.DESCRIPTORTYPE_BOS, -24, 102, Byte.MAX_VALUE, 11, 26, -16, -101, 19, -25, 45, UsbDescriptor.DESCRIPTORTYPE_HUB, 96, UsbDescriptor.DESCRIPTORTYPE_BOS, 78, -77, -123, 59, UsbDescriptor.DESCRIPTORTYPE_AUDIO_ENDPOINT, 112, 121, -60, 90, -103, -74, -12, -93, 54, 6, 73}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, UsbASFormat.EXT_FORMAT_TYPE_II, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, UsbDescriptor.DESCRIPTORTYPE_BOS, -39}}));
        }

...
public final class NanoAppBinary {
    ...
    public final String toString() {
        return "{" + ".appId = " + this.appId + ", .appVersion = " + this.appVersion + ", .flags = " + NanoAppFlags.dumpBitfield(this.flags) + ", .targetChreApiMajorVersion = " + this.targetChreApiMajorVersion + ", .targetChreApiMinorVersion = " + this.targetChreApiMinorVersion + ", .customBinary = " + this.customBinary + "}";
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                childBlob.putInt8((long) (_hidl_index_02 * 1), this.customBinary.get(_hidl_index_02).byteValue());

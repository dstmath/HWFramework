...
public class RadioManager {
    ...
    public static class AmBandConfig extends BandConfig {
        ...
        public static class Builder {
            ...
            public Builder(AmBandDescriptor descriptor) {
                BandDescriptor bandDescriptor = new BandDescriptor(descriptor.getRegion(), descriptor.getType(), descriptor.getLowerLimit(), descriptor.getUpperLimit(), descriptor.getSpacing());
                this.mDescriptor = bandDescriptor;
                this.mStereo = descriptor.isStereoSupported();
            }

            public Builder(AmBandConfig config) {
                BandDescriptor bandDescriptor = new BandDescriptor(config.getRegion(), config.getType(), config.getLowerLimit(), config.getUpperLimit(), config.getSpacing());
                this.mDescriptor = bandDescriptor;
    ...
    public static class BandConfig implements Parcelable {
        ...
        BandConfig(int region, int type, int lowerLimit, int upperLimit, int spacing) {
            BandDescriptor bandDescriptor = new BandDescriptor(region, type, lowerLimit, upperLimit, spacing);
            this.mDescriptor = bandDescriptor;
        }
    ...
    public static class FmBandConfig extends BandConfig {
        ...
        public int hashCode() {
            return (31 * ((31 * ((31 * ((31 * ((31 * super.hashCode()) + (this.mStereo ? 1 : 0))) + (this.mRds ? 1 : 0))) + (this.mTa ? 1 : 0))) + (this.mAf ? 1 : 0))) + (this.mEa ? 1 : 0);
        }

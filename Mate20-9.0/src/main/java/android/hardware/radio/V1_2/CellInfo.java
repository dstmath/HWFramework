...
public final class CellInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size * 96), _hidl_blob.handle(), _hidl_offset + 24 + 0, true);
        this.gsm.clear();
        int _hidl_index_0 = 0;
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size2; _hidl_index_02++) {
            CellInfoGsm _hidl_vec_element = new CellInfoGsm();
            _hidl_vec_element.readEmbeddedFromParcel(hwParcel, childBlob, (long) (_hidl_index_02 * 96));
            this.gsm.add(_hidl_vec_element);
        }
        int _hidl_vec_size3 = hwBlob.getInt32(_hidl_offset + 40 + 8);
        HwBlob childBlob2 = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size3 * 80), _hidl_blob.handle(), _hidl_offset + 40 + 0, true);
        this.cdma.clear();
        ...
        HwBlob childBlob3 = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size4 * 112), _hidl_blob.handle(), _hidl_offset + 56 + 0, true);
        this.lte.clear();
        for (int _hidl_index_04 = 0; _hidl_index_04 < _hidl_vec_size4; _hidl_index_04++) {
            CellInfoLte _hidl_vec_element3 = new CellInfoLte();
            _hidl_vec_element3.readEmbeddedFromParcel(hwParcel, childBlob3, (long) (_hidl_index_04 * 112));
            this.lte.add(_hidl_vec_element3);
        }
        int _hidl_vec_size5 = hwBlob.getInt32(_hidl_offset + 72 + 8);
        HwBlob childBlob4 = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size5 * 96), _hidl_blob.handle(), _hidl_offset + 72 + 0, true);
        this.wcdma.clear();
        for (int _hidl_index_05 = 0; _hidl_index_05 < _hidl_vec_size5; _hidl_index_05++) {
            CellInfoWcdma _hidl_vec_element4 = new CellInfoWcdma();
            _hidl_vec_element4.readEmbeddedFromParcel(hwParcel, childBlob4, (long) (_hidl_index_05 * 96));
            this.wcdma.add(_hidl_vec_element4);
        }
        int _hidl_vec_size6 = hwBlob.getInt32(_hidl_offset + 88 + 8);
        HwBlob childBlob5 = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size6 * AbstractPhoneBase.EVENT_ECC_NUM), _hidl_blob.handle(), 0 + _hidl_offset + 88, true);
        this.tdscdma.clear();
        while (true) {
            int _hidl_index_06 = _hidl_index_0;
            if (_hidl_index_06 < _hidl_vec_size6) {
                CellInfoTdscdma _hidl_vec_element5 = new CellInfoTdscdma();
                _hidl_vec_element5.readEmbeddedFromParcel(hwParcel, childBlob5, (long) (_hidl_index_06 * AbstractPhoneBase.EVENT_ECC_NUM));
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob5 = new HwBlob(_hidl_vec_size5 * AbstractPhoneBase.EVENT_ECC_NUM);
        while (true) {
            int _hidl_index_06 = _hidl_index_05;
            if (_hidl_index_06 < _hidl_vec_size5) {
                this.tdscdma.get(_hidl_index_06).writeEmbeddedToBlob(childBlob5, (long) (_hidl_index_06 * AbstractPhoneBase.EVENT_ECC_NUM));

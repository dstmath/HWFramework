...
public final class NetworkScanRequest {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
            this.specifiers.get(_hidl_index_02).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_02 * 72));
        }
        ...
        while (true) {
            ...
            if (_hidl_index_03 < _hidl_vec_size2) {
                childBlob2.putString((long) (_hidl_index_03 * 16), this.mccMncs.get(_hidl_index_03));

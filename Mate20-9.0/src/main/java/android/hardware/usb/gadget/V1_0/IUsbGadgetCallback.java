...
public interface IUsbGadgetCallback extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IUsbGadgetCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-83, 10, 98, 12, -38, 8, -16, 27, 21, 28, UsbDescriptor.DESCRIPTORTYPE_ENDPOINT_COMPANION, -53, 122, -6, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -80, 99, 124, -56, 67, 64, -49, -115, -20, 0, -84, -114, 50, -49, 84, -88, -37}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, UsbASFormat.EXT_FORMAT_TYPE_II, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, UsbDescriptor.DESCRIPTORTYPE_BOS, -39}}));
        }

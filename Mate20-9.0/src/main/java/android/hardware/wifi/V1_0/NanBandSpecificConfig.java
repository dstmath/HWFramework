...
public final class NanBandSpecificConfig {
    ...
    public final String toString() {
        return "{" + ".rssiClose = " + this.rssiClose + ", .rssiMiddle = " + this.rssiMiddle + ", .rssiCloseProximity = " + this.rssiCloseProximity + ", .dwellTimeMs = " + this.dwellTimeMs + ", .scanPeriodSec = " + this.scanPeriodSec + ", .validDiscoveryWindowIntervalVal = " + this.validDiscoveryWindowIntervalVal + ", .discoveryWindowIntervalVal = " + this.discoveryWindowIntervalVal + "}";
    }

...
public final class NanConfigRequest {
    ...
    public final String toString() {
        return "{" + ".masterPref = " + this.masterPref + ", .disableDiscoveryAddressChangeIndication = " + this.disableDiscoveryAddressChangeIndication + ", .disableStartedClusterIndication = " + this.disableStartedClusterIndication + ", .disableJoinedClusterIndication = " + this.disableJoinedClusterIndication + ", .includePublishServiceIdsInBeacon = " + this.includePublishServiceIdsInBeacon + ", .numberOfPublishServiceIdsInBeacon = " + this.numberOfPublishServiceIdsInBeacon + ", .includeSubscribeServiceIdsInBeacon = " + this.includeSubscribeServiceIdsInBeacon + ", .numberOfSubscribeServiceIdsInBeacon = " + this.numberOfSubscribeServiceIdsInBeacon + ", .rssiWindowSize = " + this.rssiWindowSize + ", .macAddressRandomizationIntervalSec = " + this.macAddressRandomizationIntervalSec + ", .bandSpecificConfig = " + Arrays.toString(this.bandSpecificConfig) + "}";
    }

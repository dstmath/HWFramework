...
public final class NanDataPathRequestInd {
    ...
    public final String toString() {
        return "{" + ".discoverySessionId = " + this.discoverySessionId + ", .peerDiscMacAddr = " + Arrays.toString(this.peerDiscMacAddr) + ", .ndpInstanceId = " + this.ndpInstanceId + ", .securityRequired = " + this.securityRequired + ", .appInfo = " + this.appInfo + "}";
    }

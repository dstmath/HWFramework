...
public final class NanDebugConfig {
    ...
    public final String toString() {
        return "{" + ".validClusterIdVals = " + this.validClusterIdVals + ", .clusterIdBottomRangeVal = " + this.clusterIdBottomRangeVal + ", .clusterIdTopRangeVal = " + this.clusterIdTopRangeVal + ", .validIntfAddrVal = " + this.validIntfAddrVal + ", .intfAddrVal = " + Arrays.toString(this.intfAddrVal) + ", .validOuiVal = " + this.validOuiVal + ", .ouiVal = " + this.ouiVal + ", .validRandomFactorForceVal = " + this.validRandomFactorForceVal + ", .randomFactorForceVal = " + this.randomFactorForceVal + ", .validHopCountForceVal = " + this.validHopCountForceVal + ", .hopCountForceVal = " + this.hopCountForceVal + ", .validDiscoveryChannelVal = " + this.validDiscoveryChannelVal + ", .discoveryChannelMhzVal = " + Arrays.toString(this.discoveryChannelMhzVal) + ", .validUseBeaconsInBandVal = " + this.validUseBeaconsInBandVal + ", .useBeaconsInBandVal = " + Arrays.toString(this.useBeaconsInBandVal) + ", .validUseSdfInBandVal = " + this.validUseSdfInBandVal + ", .useSdfInBandVal = " + Arrays.toString(this.useSdfInBandVal) + "}";
    }

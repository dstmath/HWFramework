...
public final class RttCapabilities {
    ...
    public final String toString() {
        return "{" + ".rttOneSidedSupported = " + this.rttOneSidedSupported + ", .rttFtmSupported = " + this.rttFtmSupported + ", .lciSupported = " + this.lciSupported + ", .lcrSupported = " + this.lcrSupported + ", .responderSupported = " + this.responderSupported + ", .preambleSupport = " + RttPreamble.dumpBitfield(this.preambleSupport) + ", .bwSupport = " + RttBw.dumpBitfield(this.bwSupport) + ", .mcVersion = " + this.mcVersion + "}";
    }

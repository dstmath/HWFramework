...
public final class RttLciInformation {
    ...
    public final String toString() {
        return "{" + ".latitude = " + this.latitude + ", .longitude = " + this.longitude + ", .altitude = " + this.altitude + ", .latitudeUnc = " + this.latitudeUnc + ", .longitudeUnc = " + this.longitudeUnc + ", .altitudeUnc = " + this.altitudeUnc + ", .motionPattern = " + RttMotionPattern.toString(this.motionPattern) + ", .floor = " + this.floor + ", .heightAboveFloor = " + this.heightAboveFloor + ", .heightUnc = " + this.heightUnc + "}";
    }

...
public final class WifiRateInfo {
    ...
    public final String toString() {
        return "{" + ".preamble = " + WifiRatePreamble.toString(this.preamble) + ", .nss = " + WifiRateNss.toString(this.nss) + ", .bw = " + WifiChannelWidthInMhz.toString(this.bw) + ", .rateMcsIdx = " + this.rateMcsIdx + ", .bitRateInKbps = " + this.bitRateInKbps + "}";
    }

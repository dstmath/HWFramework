...
public interface ISupplicantStaIfaceCallback extends IBase {
    ...
    public static final class AnqpData {
        ...
        public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
            ...
            for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
                this.venueName.add(Byte.valueOf(childBlob.getInt8((long) (_hidl_index_02 * 1))));
            }
            ...
            for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size2; _hidl_index_03++) {
                this.roamingConsortium.add(Byte.valueOf(childBlob2.getInt8((long) (_hidl_index_03 * 1))));
            }
            ...
            for (int _hidl_index_04 = 0; _hidl_index_04 < _hidl_vec_size3; _hidl_index_04++) {
                this.ipAddrTypeAvailability.add(Byte.valueOf(childBlob3.getInt8((long) (_hidl_index_04 * 1))));
            }
            ...
            for (int _hidl_index_05 = 0; _hidl_index_05 < _hidl_vec_size4; _hidl_index_05++) {
                this.naiRealm.add(Byte.valueOf(childBlob4.getInt8((long) (_hidl_index_05 * 1))));
            }
            ...
            for (int _hidl_index_06 = 0; _hidl_index_06 < _hidl_vec_size5; _hidl_index_06++) {
                this.anqp3gppCellularNetwork.add(Byte.valueOf(childBlob5.getInt8((long) (_hidl_index_06 * 1))));
            }
            ...
            while (true) {
                ...
                if (_hidl_index_07 < _hidl_vec_size6) {
                    this.domainName.add(Byte.valueOf(childBlob6.getInt8((long) (_hidl_index_07 * 1))));
        ...
        public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
            ...
            int _hidl_index_06 = 0;
            hwBlob.putBool(_hidl_offset + 80 + 12, false);
            HwBlob childBlob6 = new HwBlob(_hidl_vec_size6 * 1);
            while (true) {
                int _hidl_index_07 = _hidl_index_06;
                if (_hidl_index_07 < _hidl_vec_size6) {
                    childBlob6.putInt8((long) (_hidl_index_07 * 1), this.domainName.get(_hidl_index_07).byteValue());
                    _hidl_index_06 = _hidl_index_07 + 1;
                } else {
    ...
    public static final class Hs20AnqpData {
        ...
        public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
            ...
            int _hidl_index_0 = 0;
            for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
                this.operatorFriendlyName.add(Byte.valueOf(childBlob.getInt8((long) (_hidl_index_02 * 1))));
            }
            int _hidl_vec_size2 = hwBlob.getInt32(_hidl_offset + 16 + 8);
            HwBlob childBlob2 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 1), _hidl_blob.handle(), _hidl_offset + 16 + 0, true);
            this.wanMetrics.clear();
            for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size2; _hidl_index_03++) {
                this.wanMetrics.add(Byte.valueOf(childBlob2.getInt8((long) (_hidl_index_03 * 1))));
            }
            int _hidl_vec_size3 = hwBlob.getInt32(_hidl_offset + 32 + 8);
            HwBlob childBlob3 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size3 * 1), _hidl_blob.handle(), _hidl_offset + 32 + 0, true);
            this.connectionCapability.clear();
            for (int _hidl_index_04 = 0; _hidl_index_04 < _hidl_vec_size3; _hidl_index_04++) {
                this.connectionCapability.add(Byte.valueOf(childBlob3.getInt8((long) (_hidl_index_04 * 1))));
            }
            int _hidl_vec_size4 = hwBlob.getInt32(_hidl_offset + 48 + 8);
            HwBlob childBlob4 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size4 * 1), _hidl_blob.handle(), _hidl_offset + 48 + 0, true);
            ...
            while (true) {
                ...
                if (_hidl_index_05 < _hidl_vec_size4) {
                    this.osuProvidersList.add(Byte.valueOf(childBlob4.getInt8((long) (_hidl_index_05 * 1))));
        ...
        public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
            ...
            while (true) {
                ...
                if (_hidl_index_05 < _hidl_vec_size4) {
                    childBlob4.putInt8((long) (_hidl_index_05 * 1), this.osuProvidersList.get(_hidl_index_05).byteValue());
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantStaIfaceCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-41, -127, -56, -41, -25, -77, -2, 92, -54, -116, -10, -31, -40, Byte.MIN_VALUE, 110, 119, 9, -126, -82, 83, 88, -57, -127, 110, -43, 27, 15, 14, -62, 114, -25, 13}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}}));
        }

    ...
    private static synchronized IHwClipboardReadDelayRegister getImplObject() {
        synchronized (HwClipboardReadDelayRegister.class) {
            if (serviceRegistInstance != null) {
                IHwClipboardReadDelayRegister iHwClipboardReadDelayRegister = serviceRegistInstance;
                return iHwClipboardReadDelayRegister;
            }
            ...
            IHwClipboardReadDelayRegister iHwClipboardReadDelayRegister2 = serviceRegistInstance;
            return iHwClipboardReadDelayRegister2;
        }
    }

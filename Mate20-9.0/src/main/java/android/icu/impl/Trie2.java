...
public abstract class Trie2 implements Iterable<Range> {
    ...
    public final boolean equals(Object other) {
        ...
        while (it.hasNext()) {
            Range rangeFromThis = it.next();
            if (!otherIter.hasNext()) {
                return false;
            }
            if (!rangeFromThis.equals(otherIter.next())) {
                return false;
            }
        }

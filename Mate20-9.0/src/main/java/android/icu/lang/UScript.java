...
public final class UScript {
    ...
    public static final boolean hasScript(int c, int sc) {
        ...
        while (sc > scriptExtensions[scx2]) {
            scx2++;
        }
        if (sc == (32767 & scriptExtensions[scx2])) {
            z = true;
        }
        return z;
    }
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=char, code=int, for r3v5, types: [char] */

    ...
    public String nextToken() {
        ...
        if (this.m_tokenOffset_ < 0) {
            if (this.m_nextOffset_ < 0) {
                ...
                if (tokenlimit < 0) {
                    result3 = this.m_source_.substring(this.m_nextOffset_);
                } else {
                    result3 = this.m_source_.substring(this.m_nextOffset_, tokenlimit);
                }
                this.m_nextOffset_ = tokenlimit;
                return result3;
            } else {
                int tokenlimit2 = getNextDelimiter(this.m_nextOffset_);
                if (tokenlimit2 < 0) {
                    result2 = this.m_source_.substring(this.m_nextOffset_);
                    this.m_nextOffset_ = tokenlimit2;
                } else {
                    result2 = this.m_source_.substring(this.m_nextOffset_, tokenlimit2);
            ...
            do {
                ...
                if (this.m_returnDelimiters_) {
                    ...
                    if (this.delims == null) {
                        ...
                        contains = c < this.delims.length && this.delims[c];
                    }
                    if (!contains) {

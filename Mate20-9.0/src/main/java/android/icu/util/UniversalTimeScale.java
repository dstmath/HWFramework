...
public final class UniversalTimeScale {
    ...
    static {
        TimeScaleData timeScaleData = new TimeScaleData(milliseconds, 621355968000000000L, -9223372036854774999L, 9223372036854774999L, -984472800485477L, 860201606885477L);
        TimeScaleData timeScaleData2 = new TimeScaleData(seconds, 621355968000000000L, Long.MIN_VALUE, Long.MAX_VALUE, -984472800485L, 860201606885L);
        TimeScaleData timeScaleData3 = new TimeScaleData(milliseconds, 621355968000000000L, -9223372036854774999L, 9223372036854774999L, -984472800485477L, 860201606885477L);
        TimeScaleData timeScaleData4 = new TimeScaleData(ticks, 504911232000000000L, -8718460804854775808L, Long.MAX_VALUE, Long.MIN_VALUE, 8718460804854775807L);
        TimeScaleData timeScaleData5 = new TimeScaleData(ticks, 0, Long.MIN_VALUE, Long.MAX_VALUE, Long.MIN_VALUE, Long.MAX_VALUE);
        TimeScaleData timeScaleData6 = new TimeScaleData(seconds, 600527520000000000L, Long.MIN_VALUE, Long.MAX_VALUE, -982389955685L, 862284451685L);
        TimeScaleData timeScaleData7 = new TimeScaleData(seconds, 631139040000000000L, Long.MIN_VALUE, Long.MAX_VALUE, -985451107685L, 859223299685L);
        TimeScaleData timeScaleData8 = new TimeScaleData(days, 599265216000000000L, Long.MIN_VALUE, Long.MAX_VALUE, -11368793, 9981605);
        TimeScaleData timeScaleData9 = new TimeScaleData(days, 599265216000000000L, Long.MIN_VALUE, Long.MAX_VALUE, -11368793, 9981605);
        TimeScaleData timeScaleData10 = new TimeScaleData(microseconds, 621355968000000000L, -9223372036854775804L, 9223372036854775804L, -984472800485477580L, 860201606885477580L);
        timeScaleTable = new TimeScaleData[]{timeScaleData, timeScaleData2, timeScaleData3, timeScaleData4, timeScaleData5, timeScaleData6, timeScaleData7, timeScaleData8, timeScaleData9, timeScaleData10};
    }

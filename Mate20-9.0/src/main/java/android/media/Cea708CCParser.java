...
class Cea708CCParser {
    ...
    private int parseC1(byte[] data, int pos) {
        ...
        switch (i) {
            ...
            case 144:
                int pos8 = pos + 2;
                CaptionPenAttr captionPenAttr = new CaptionPenAttr(data[pos] & 3, (data[pos] & 12) >> 2, (data[pos] & 240) >> 4, 7 & data[pos + 1], (data[pos + 1] & 56) >> 3, (data[pos + 1] & BluetoothHidDevice.SUBCLASS1_KEYBOARD) != 0, (data[pos + 1] & BluetoothHidDevice.SUBCLASS1_MOUSE) != 0);
            ...
            case 145:
                ...
                int pos10 = pos9 + 1;
                int pos11 = pos10 + 1;
                emitCaptionEvent(new CaptionEvent(13, new CaptionPenColor(new CaptionColor((data[pos] & BluetoothHidDevice.SUBCLASS1_COMBO) >> 6, (data[pos] & 48) >> 4, (data[pos] & 12) >> 2, data[pos] & 3), new CaptionColor((data[pos9] & BluetoothHidDevice.SUBCLASS1_COMBO) >> 6, (data[pos9] & 48) >> 4, (data[pos9] & 12) >> 2, data[pos9] & 3), new CaptionColor(0, (data[pos10] & 48) >> 4, (12 & data[pos10]) >> 2, data[pos10] & 3))));
                return pos11;
            case 146:
                int pos12 = pos + 2;
            ...
            default:
                switch (i) {
                    case 151:
                        int pos13 = pos + 4;
                        CaptionWindowAttr captionWindowAttr = new CaptionWindowAttr(new CaptionColor((data[pos] & BluetoothHidDevice.SUBCLASS1_COMBO) >> 6, (data[pos] & 48) >> 4, (data[pos] & 12) >> 2, data[pos] & 3), new CaptionColor(0, (data[pos + 1] & 48) >> 4, (data[pos + 1] & 12) >> 2, data[pos + 1] & 3), ((data[pos + 2] & BluetoothHidDevice.SUBCLASS1_MOUSE) >> 5) | ((data[pos + 1] & BluetoothHidDevice.SUBCLASS1_COMBO) >> 6), (data[pos + 2] & BluetoothHidDevice.SUBCLASS1_KEYBOARD) != 0, (data[pos + 2] & 48) >> 4, (data[pos + 2] & 12) >> 2, data[pos + 2] & 3, (12 & data[pos + 3]) >> 2, (data[pos + 3] & 240) >> 4, 3 & data[pos + 3]);
                        CaptionEvent captionEvent = new CaptionEvent(15, captionWindowAttr);
                        emitCaptionEvent(captionEvent);
                        return pos13;
                    case 152:
                    case 153:
                    case 154:
                    ...
                    case 159:
                        ...
                        CaptionWindow captionWindow2 = new CaptionWindow(this.mCommand - 152, (data[pos] & 32) != 0, (data[pos] & 16) != 0, (data[pos] & 8) != 0, data[pos] & 7, (data[pos + 1] & BluetoothHidDevice.SUBCLASS1_MOUSE) != 0, data[pos + 1] & 127, data[pos + 2] & 255, (data[pos + 3] & 240) >> 4, 15 & data[pos + 3], data[pos + 4] & 63, 7 & data[pos + 5], (data[pos + 5] & 56) >> 3);

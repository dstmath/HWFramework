            ...
            if (code != 1598968902) {
                switch (code) {
                    case 1:
                        ...
                        remoteVolumeChanged(ISessionController.Stub.asInterface(data.readStrongBinder()), data.readInt());
                        return true;
                    case 2:
                        data.enforceInterface(DESCRIPTOR);
                        updateRemoteController(ISessionController.Stub.asInterface(data.readStrongBinder()));
                        return true;
                    default:

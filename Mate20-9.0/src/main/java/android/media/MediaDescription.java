...
public class MediaDescription implements Parcelable {
    ...
    public static class Builder {
        ...
        public MediaDescription build() {
            MediaDescription mediaDescription = new MediaDescription(this.mMediaId, this.mTitle, this.mSubtitle, this.mDescription, this.mIcon, this.mIconUri, this.mExtras, this.mMediaUri);

            ...
            try {
                ...
                if (route != btRoute) {
                    ...
                    for (int i = 3; i < callStack.length; i++) {
                        ...
                        sb.append(caller.getClassName() + "." + caller.getMethodName() + ":" + caller.getLineNumber());
                        sb.append("  ");
                    }
        ...
        for (WifiDisplay d : displays) {
            if (shouldShowWifiDisplay(d, activeDisplay)) {
                ...
                if (route == null) {
                    ...
                    updateWifiDisplayRoute(route, d, status, !address.equals(activeDisplayAddress) && address.equals(sStatic.mPreviousActiveWifiDisplayAddress));
                }

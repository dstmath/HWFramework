...
class WebVttRenderingWidget extends ViewGroup implements SubtitleTrack.RenderingWidget {
    ...
    private static class CueLayout extends LinearLayout {
        ...
        /* JADX WARNING: type inference failed for: r7v0, types: [android.media.WebVttRenderingWidget$SpanLayout, android.view.View] */
        public void update() {
            ...
            for (TextTrackCueSpan[] spanLayout : this.mCue.mLines) {
                ? spanLayout2 = new SpanLayout(getContext(), spanLayout);
                spanLayout2.setAlignment(alignment);
                spanLayout2.setCaptionStyle(captionStyle, fontSize);
                addView(spanLayout2, -2, -2);
            }
        }

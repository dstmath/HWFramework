...
public class TunerBperInfo implements Parcelable {
    public static final byte BBER_CIRCUIT_BPER1 = 0;
    public static final byte BBER_CIRCUIT_BPER2 = 1;
    public static final byte BPERTYPE_BERD = 2;
    public static final byte BPERTYPE_BERV = 0;
    public static final byte BPERTYPE_PER = 1;
    public static final Parcelable.Creator<TunerBperInfo> CREATOR = new Parcelable.Creator<TunerBperInfo>() {
    ...
    public static final byte MONITOR_MODE_NO_WAIT = 1;
    public static final byte MONITOR_MODE_WAIT_UPDATE = 0;

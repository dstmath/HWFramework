...
public class TunerBperPara implements Parcelable {
    public static final byte BPERMODE_BIT_NUM = 2;
    public static final byte BPERMODE_PACKET_NUM = 0;
    public static final byte BPERMODE_TIME_LENGTH = 1;
    public static final Parcelable.Creator<TunerBperPara> CREATOR = new Parcelable.Creator<TunerBperPara>() {

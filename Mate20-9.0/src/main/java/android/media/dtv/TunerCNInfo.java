...
public class TunerCNInfo implements Parcelable {
    public static final Parcelable.Creator<TunerCNInfo> CREATOR = new Parcelable.Creator<TunerCNInfo>() {
    ...
    public static final byte VALUE_MONITOR_MODE_NO_WAIT = 1;
    public static final byte VALUE_MONITOR_MODE_WAIT_UPDATE = 0;
    private int mCn;
    private int mCnrd;

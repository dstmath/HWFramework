...
public final class PlaybackState implements Parcelable {
    ...
    public static final class Builder {
        ...
        public PlaybackState build() {
            PlaybackState playbackState = new PlaybackState(this.mState, this.mPosition, this.mUpdateTime, this.mSpeed, this.mBufferedPosition, this.mActions, this.mCustomActions, this.mActiveItemId, this.mErrorMessage, this.mExtras);

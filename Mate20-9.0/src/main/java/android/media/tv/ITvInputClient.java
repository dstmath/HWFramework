            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case 3:
                        ...
                        onSessionEvent(_arg02, _arg2, data.readInt());
                        return true;
                    case 4:
                        parcel.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        onChannelRetuned(_arg2, data.readInt());
                        return true;
                    case 5:
                        parcel.enforceInterface(DESCRIPTOR);
                    ...
                    case 16:
                        ...
                        onRecordingStopped(_arg2, data.readInt());
                        return true;
                    case 17:
                        parcel.enforceInterface(DESCRIPTOR);

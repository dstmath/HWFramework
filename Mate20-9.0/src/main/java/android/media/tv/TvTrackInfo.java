...
public final class TvTrackInfo implements Parcelable {
    ...
    public static final class Builder {
        ...
        public TvTrackInfo build() {
            TvTrackInfo tvTrackInfo = new TvTrackInfo(this.mType, this.mId, this.mLanguage, this.mDescription, this.mAudioChannelCount, this.mAudioSampleRate, this.mVideoWidth, this.mVideoHeight, this.mVideoFrameRate, this.mVideoPixelAspectRatio, this.mVideoActiveFormatDescription, this.mExtra);
            return tvTrackInfo;
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!TextUtils.equals(this.mId, obj.mId) || this.mType != obj.mType || !TextUtils.equals(this.mLanguage, obj.mLanguage) || !TextUtils.equals(this.mDescription, obj.mDescription) || !Objects.equals(this.mExtra, obj.mExtra) || (this.mType != 0 ? !(this.mType != 1 || (this.mVideoWidth == obj.mVideoWidth && this.mVideoHeight == obj.mVideoHeight && this.mVideoFrameRate == obj.mVideoFrameRate && this.mVideoPixelAspectRatio == obj.mVideoPixelAspectRatio)) : !(this.mAudioChannelCount == obj.mAudioChannelCount && this.mAudioSampleRate == obj.mAudioSampleRate))) {
            z = false;
        }
        return z;
    }

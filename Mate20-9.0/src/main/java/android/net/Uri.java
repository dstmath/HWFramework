...
public abstract class Uri implements Parcelable, Comparable<Uri> {
    ...
    public static final class Builder {
        ...
        public Uri build() {
            if (this.opaquePart == null) {
                ...
                HierarchicalUri hierarchicalUri = new HierarchicalUri(this.scheme, this.authority, path2, this.query, this.fragment);
    ...
    private static class HierarchicalUri extends AbstractHierarchicalUri {
        ...
        static Uri readFrom(Parcel parcel) {
            HierarchicalUri hierarchicalUri = new HierarchicalUri(parcel.readString(), Part.readFrom(parcel), PathPart.readFrom(parcel), Part.readFrom(parcel), Part.readFrom(parcel));
            return hierarchicalUri;
        }
    ...
    static {
        HierarchicalUri hierarchicalUri = new HierarchicalUri(null, Part.NULL, PathPart.EMPTY, Part.NULL, Part.NULL);
        EMPTY = hierarchicalUri;
    }
    ...
    public static Uri fromFile(File file) {
        if (file != null) {
            HierarchicalUri hierarchicalUri = new HierarchicalUri(ContentResolver.SCHEME_FILE, Part.EMPTY, PathPart.fromDecoded(file.getAbsolutePath()), Part.NULL, Part.NULL);
            return hierarchicalUri;
        }
    ...
    public static String encode(String s, String allow) {
        ...
        while (current < oldLength) {
            ...
            if (nextToEncode != oldLength) {
                ...
                try {
                    byte[] bytes = s.substring(current2, nextAllowed).getBytes(DEFAULT_ENCODING);

...
public class HwDhcpClient extends DhcpClient {
    ...
    public DhcpResultsInfoRecord getDhcpResultsInfoRecord() {
        ...
        synchronized (mLock) {
            ...
            DhcpResultsInfoRecord dhcpResultsInfoRecord = mDhcpResultsInfoCache.get(pendingSSID);
    ...
    private String dhcpResults2String(DhcpResults dhcpResults) {
        ...
        lastDhcpResults.append(String.valueOf(-1) + "|");
        StringBuilder sb = new StringBuilder();
        sb.append(dhcpResults.domains == null ? BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS : dhcpResults.domains);
        sb.append("|");
        ...
        sb2.append(dhcpResults.gateway != null ? dhcpResults.gateway.getHostAddress() : BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS);
        sb2.append("|");

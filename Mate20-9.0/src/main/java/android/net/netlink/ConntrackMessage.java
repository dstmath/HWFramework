...
public class ConntrackMessage extends NetlinkMessage {
    ...
    public static byte[] newIPv4TimeoutUpdateRequest(int proto, Inet4Address src, int sport, Inet4Address dst, int dport, int timeoutSec) {
        StructNlAttr ctaTupleOrig = new StructNlAttr(1, new StructNlAttr(1, new StructNlAttr(1, (InetAddress) src), new StructNlAttr(2, (InetAddress) dst)), new StructNlAttr(2, new StructNlAttr(1, (byte) proto), new StructNlAttr(2, (short) sport, ByteOrder.BIG_ENDIAN), new StructNlAttr(3, (short) dport, ByteOrder.BIG_ENDIAN)));
        StructNlAttr ctaTimeout = new StructNlAttr(7, timeoutSec, ByteOrder.BIG_ENDIAN);

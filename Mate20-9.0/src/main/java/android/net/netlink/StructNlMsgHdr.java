...
public class StructNlMsgHdr {
    ...
    public String toString() {
        String typeStr = BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS + this.nlmsg_type + "(" + NetlinkConstants.stringForNlMsgType(this.nlmsg_type) + ")";
        String flagsStr = BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS + this.nlmsg_flags + "(" + stringForNlMsgFlags(this.nlmsg_flags) + ")";

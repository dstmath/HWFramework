...
public class PerformanceCollector {
    ...
    private void endPerformanceSnapshot() {
        ...
        this.mPerfSnapshot.putLong(METRIC_KEY_JAVA_ALLOCATED, dalvikAllocated2);
        long j = nativeMax;
        long nativeMax2 = dalvikFree2;
        this.mPerfSnapshot.putLong(METRIC_KEY_JAVA_FREE, nativeMax2);
        long j2 = nativeMax2;
        this.mPerfSnapshot.putLong(METRIC_KEY_JAVA_PSS, (long) memInfo.dalvikPss);
        Bundle bundle = allocCounts;

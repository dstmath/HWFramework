...
public class Process {
    ...
    public static final String MAPLE_SECONDARY_ZYGOTE_SOCKET = "mygote_secondary";
    public static final String MAPLE_ZYGOTE_SOCKET = "mygote";
    ...
    public static final ZygoteProcess mygoteProcess = new ZygoteProcess(MAPLE_ZYGOTE_SOCKET, MAPLE_SECONDARY_ZYGOTE_SOCKET);
    ...
    public static final native void setThreadVip(int i, int i2, boolean z) throws IllegalArgumentException, SecurityException;
    ...
    public static final ProcessStartResult startMapledApp(String processClass, String niceName, int uid, int gid, int[] gids, int runtimeFlags, int mountExternal, int targetSdkVersion, String seInfo, String abi, String instructionSet, String appDataDir, String invokeWith, String[] zygoteArgs) {
        return mygoteProcess.start(processClass, niceName, uid, gid, gids, runtimeFlags, mountExternal, targetSdkVersion, seInfo, abi, instructionSet, appDataDir, invokeWith, zygoteArgs);
    }

    public static final void establishMygoteConnectionForAbi(String abi) {
        try {
            mygoteProcess.establishZygoteConnectionForAbi(abi);
        } catch (RuntimeException e) {
            Slog.e(LOG_TAG, "establish mygote connection failed: " + abi);
        }
    }

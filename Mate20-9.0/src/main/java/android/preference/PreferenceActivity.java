...
public abstract class PreferenceActivity extends ListActivity implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceFragment.OnPreferenceStartFragmentCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mListFooter = (FrameLayout) findViewById(16909052);
        this.mPrefsContainer = (ViewGroup) findViewById(16909219);
        this.mHeadersContainer = (ViewGroup) findViewById(16908962);
        ...
        if (this.mHeaders.size() == 0 && initialFragment == null) {
            ...
            this.mListFooter = (FrameLayout) findViewById(16909052);
            this.mPrefsContainer = (ViewGroup) findViewById(16909217);
            ...
            ((ViewGroup) findViewById(16909218)).setLayoutTransition(new LayoutTransition());
        ...
        if (intent.getBooleanExtra(EXTRA_PREFS_SHOW_BUTTON_BAR, false)) {
            ...
            Button backButton = (Button) findViewById(16908762);
            ...
            Button skipButton = (Button) findViewById(16909340);
            ...
            this.mNextButton = (Button) findViewById(16909122);
    ...
    public void loadHeadersFromResource(int resid, List<Header> target) {
        ...
        try {
            try {
                ...
                if ("preference-headers".equals(parser.getName())) {
                    ...
                    while (true) {
                                ...
                                if (Downloads.Impl.RequestHeaders.COLUMN_HEADER.equals(parser.getName())) {
                                    ...
                                    try {
                                        ...
                                        while (true) {
                                            ...
                                            int type3 = next3;
                                            if (next3 != i2 && (type3 != i3 || parser.getDepth() > innerDepth)) {
                                                if (type3 != i3) {
                                                    if (type3 != 4) {
                                        ...
                                        e = e;
                                        List<Header> list = target;
                                        throw new RuntimeException("Error parsing headers", e);
                                    } catch (IOException e2) {
                                        e = e2;
                                        List<Header> list2 = target;
                                        throw new RuntimeException("Error parsing headers", e);
                                    } catch (Throwable th) {
                                        e = th;
                                        List<Header> list3 = target;
                                        if (parser != null) {
                                        }
                                        throw e;
                                    }
                        ...
                        List<Header> list5 = target;
                        i = 2;
                        i2 = 1;
                    }
                    List<Header> list6 = target;
                    if (parser != null) {
                        parser.close();
                        return;
                    }
                ...
                e = e5;
                List<Header> list8 = target;
                throw new RuntimeException("Error parsing headers", e);
            } catch (IOException e6) {
                e = e6;
                List<Header> list22 = target;
                throw new RuntimeException("Error parsing headers", e);
            } catch (Throwable th2) {
                e = th2;
                List<Header> list32 = target;
                if (parser != null) {
                }
                throw e;
            }
            ...
            e = e7;
            int i4 = resid;
            List<Header> list82 = target;
            throw new RuntimeException("Error parsing headers", e);
        } catch (IOException e8) {
            e = e8;
            int i5 = resid;
            List<Header> list222 = target;
            throw new RuntimeException("Error parsing headers", e);
        } catch (Throwable th3) {
            e = th3;
            if (parser != null) {
        ...
        if (this.mFragmentBreadCrumbs == null) {
            try {
                ...
                if (this.mSinglePane) {
                    ...
                    View bcSection = findViewById(16908777);
                    if (bcSection != null) {
    ...
    private void switchToHeaderInner(String fragmentName, Bundle args) {
        ...
        if (isValidFragment(fragmentName)) {
            ...
            transaction.replace(16909217, f);
    ...
    public void startPreferenceFragment(Fragment fragment, boolean push) {
        FragmentTransaction transaction = getFragmentManager().beginTransaction();
        transaction.replace(16909217, fragment);
        if (push) {

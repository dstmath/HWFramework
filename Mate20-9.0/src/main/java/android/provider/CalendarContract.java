...
public final class CalendarContract {
    ...
    public static final class CalendarAlerts implements BaseColumns, CalendarAlertsColumns, EventsColumns, CalendarColumns {
        ...
        public static final Uri insert(ContentResolver cr, long eventId, long begin, long end, long alarmTime, int minutes) {
            ...
            values.put(CalendarAlertsColumns.RECEIVED_TIME, 0);
            values.put(CalendarAlertsColumns.NOTIFY_TIME, 0);
            values.put("state", 0);
        ...
        public static void scheduleAlarm(Context context, AlarmManager manager, long alarmTime) {
            if (manager == null) {
                manager = context.getSystemService(ZenModeConfig.IS_ALARM_PATH);
            }
        ...
        public static final boolean alarmExists(ContentResolver cr, long eventId, long begin, long alarmTime) {
            Cursor cursor = cr.query(CONTENT_URI, new String[]{CalendarAlertsColumns.ALARM_TIME}, WHERE_ALARM_EXISTS, new String[]{Long.toString(eventId), Long.toString(begin), Long.toString(alarmTime)}, null);
            boolean found = false;
            if (cursor != null) {
                try {
    ...
    public static final class CalendarEntity implements BaseColumns, SyncColumns, CalendarColumns {
        ...
        /* JADX WARNING: type inference failed for: r0v0, types: [android.provider.CalendarContract$CalendarEntity$EntityIteratorImpl, android.content.EntityIterator] */
    ...
    public static final class EventsEntity implements BaseColumns, SyncColumns, EventsColumns {
        ...
        private static class EntityIteratorImpl extends CursorEntityIterator {
            ...
            public Entity getEntityAndIncrementCursor(Cursor cursor) throws RemoteException {
                ...
                subCursor2.close();
                if (this.mResolver != null) {
                    subCursor3 = this.mResolver.query(Attendees.CONTENT_URI, ATTENDEES_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(eventId)}, null);
                } else {
                    subCursor3 = this.mProvider.query(Attendees.CONTENT_URI, ATTENDEES_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(eventId)}, null);
                }
                Cursor subCursor5 = subCursor3;
                while (subCursor5.moveToNext()) {
                    try {
                        ContentValues attendeeValues = new ContentValues();
                        attendeeValues.put(AttendeesColumns.ATTENDEE_NAME, subCursor5.getString(0));
                        attendeeValues.put(AttendeesColumns.ATTENDEE_EMAIL, subCursor5.getString(1));
                        attendeeValues.put(AttendeesColumns.ATTENDEE_RELATIONSHIP, Integer.valueOf(subCursor5.getInt(2)));
                        attendeeValues.put(AttendeesColumns.ATTENDEE_TYPE, Integer.valueOf(subCursor5.getInt(3)));
                        attendeeValues.put(AttendeesColumns.ATTENDEE_STATUS, Integer.valueOf(subCursor5.getInt(4)));
                        attendeeValues.put(AttendeesColumns.ATTENDEE_IDENTITY, subCursor5.getString(5));
                        attendeeValues.put(AttendeesColumns.ATTENDEE_ID_NAMESPACE, subCursor5.getString(6));
                ...
                subCursor5.close();
                if (this.mResolver != null) {
                    subCursor4 = this.mResolver.query(ExtendedProperties.CONTENT_URI, EXTENDED_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(eventId)}, null);
                } else {
                    subCursor4 = this.mProvider.query(ExtendedProperties.CONTENT_URI, EXTENDED_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(eventId)}, null);
                }
                Cursor subCursor6 = subCursor4;
                while (subCursor6.moveToNext()) {
                    try {
                        ContentValues extendedValues = new ContentValues();
                        extendedValues.put("_id", subCursor6.getString(0));
                        extendedValues.put("name", subCursor6.getString(1));
                        extendedValues.put("value", subCursor6.getString(2));
        ...
        /* JADX WARNING: type inference failed for: r0v0, types: [android.content.EntityIterator, android.provider.CalendarContract$EventsEntity$EntityIteratorImpl] */

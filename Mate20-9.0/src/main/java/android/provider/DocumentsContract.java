    ...
    public static Bitmap getDocumentThumbnail(ContentProviderClient client, Uri documentUri, Point size, CancellationSignal signal) throws RemoteException, IOException {
        ...
        try {
            ...
            if (orientation != 0) {
                ...
                Matrix m = new Matrix();
                Bundle bundle3 = openOpts;
                int i = orientation;
                try {
                    int i2 = heightSample;
                    m.setRotate((float) orientation, (float) (width / 2), (float) (height / 2));
                    bitmap2 = Bitmap.createBitmap(bitmap2, 0, 0, width, height, m, false);
                } catch (Throwable th2) {
                    th = th2;
                    IoUtils.closeQuietly(afd);
                    throw th;
    ...
    public static AssetFileDescriptor openImageThumbnail(File file) throws FileNotFoundException {
        ...
        try {
            ...
            try {
                ...
                if (thumb != null) {
                    AssetFileDescriptor assetFileDescriptor = new AssetFileDescriptor(pfd, thumb[0], thumb[1], extras);
                    return assetFileDescriptor;
                }
            } catch (IOException e) {
                extras2 = extras;
                extras = extras2;
                AssetFileDescriptor assetFileDescriptor2 = new AssetFileDescriptor(pfd, 0, -1, extras);
                return assetFileDescriptor2;
            }
        } catch (IOException e2) {
            extras = extras2;
            AssetFileDescriptor assetFileDescriptor22 = new AssetFileDescriptor(pfd, 0, -1, extras);
            return assetFileDescriptor22;
        }
        AssetFileDescriptor assetFileDescriptor222 = new AssetFileDescriptor(pfd, 0, -1, extras);
        return assetFileDescriptor222;
    }

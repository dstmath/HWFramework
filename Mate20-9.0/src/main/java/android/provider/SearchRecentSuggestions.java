...
public class SearchRecentSuggestions {
    ...
    public static final String[] QUERIES_PROJECTION_1LINE = {"_id", "date", SuggestionColumns.QUERY, SuggestionColumns.DISPLAY1};
    public static final String[] QUERIES_PROJECTION_2LINE = {"_id", "date", SuggestionColumns.QUERY, SuggestionColumns.DISPLAY1, SuggestionColumns.DISPLAY2};

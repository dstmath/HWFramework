...
public final class Settings {
    ...
    public static final Object mLocationSettingsLock = new Object();
    ...
    private static class NameValueCache {
        ...
        public boolean putStringForUser(ContentResolver cr, String name, String value, String tag, boolean makeDefault, int userHandle) {
            ...
            if (contentResolver == null) {
                ...
                String mode = getStringForUser(contentResolver, System.SCREEN_BRIGHTNESS_MODE, i);
                if (System.SCREEN_BRIGHTNESS_MODE.equals(str)) {
                    String packageName = cr.getPackageName();
                    if (allowBrightnessAdjust(packageName)) {
                        Log.i(Settings.TAG, "nosystemapp to change adjust brightness mode,packageName:" + packageName + " , mode:" + mode + ",value=" + str2);
                        if (mode != null && !mode.equals(str2)) {
                ...
                if (System.SCREEN_BRIGHTNESS.equals(str) && allowBrightnessAdjust(cr.getPackageName()) && mode != null && mode.equals(WifiEnterpriseConfig.ENGINE_DISABLE)) {
                    putStringForUser(contentResolver, System.HW_SCREEN_TEMP_BRIGHTNESS, str2, null, false, i);
                }
                Bundle arg = new Bundle();
                arg.putString("value", str2);
                arg.putInt(Settings.CALL_METHOD_USER_KEY, i);
                if (str3 != null) {
                    arg.putString(Settings.CALL_METHOD_TAG_KEY, str3);
                }
                if (makeDefault) {
                    arg.putBoolean(Settings.CALL_METHOD_MAKE_DEFAULT_KEY, true);
                }
                this.mProviderHolder.getProvider(contentResolver).call(cr.getPackageName(), this.mCallSetCommand, str, arg);
                if (System.SCREEN_BRIGHTNESS_MODE.equals(str)) {
                    Log.i(Settings.TAG, "package: " + cr.getPackageName() + " modify " + System.SCREEN_BRIGHTNESS_MODE + " to " + str2);
                }
                if (System.SCREEN_OFF_TIMEOUT.equals(str) || "location_providers_allowed".equals(str) || System.NOTIFICATION_SOUND.equals(str) || System.RINGTONE.equals(str) || Global.WIFI_SCAN_ALWAYS_AVAILABLE.equals(str) || Global.BLE_SCAN_ALWAYS_AVAILABLE.equals(str) || "airplane_mode_on".equals(str)) {
                    Log.i(Settings.TAG, "package: " + cr.getPackageName() + " modify " + str + " to " + str2);
                }
                return true;
            }
        }
        ...
        /* JADX WARNING: Removed duplicated region for block: B:143:0x01da A[SYNTHETIC, Splitter:B:143:0x01da] */
        /* JADX WARNING: Removed duplicated region for block: B:158:0x01ff  */
        /* JADX WARNING: Removed duplicated region for block: B:182:0x024c  */
        /* JADX WARNING: Removed duplicated region for block: B:186:0x0253  */
        public String getStringForUser(ContentResolver cr, String name, int userHandle) {
                ...
                synchronized (this) {
                    if (this.mGenerationTracker != null) {
                        if (this.mGenerationTracker.isGenerationChanged()) {
                            this.mValues.clear();
                        } else if (this.mValues.containsKey(str2)) {
                            String str3 = this.mValues.get(str2);
                            return str3;
                        }
                        if (this.mGenerationTracker != null) {
            ...
            if (this.mCallGetCommand != null) {
                ...
                synchronized (this) {
                    ...
                    if (!Settings.isInSystemServer() || Binder.getCallingUid() == Process.myUid()) {
                        b = cp.call(cr.getPackageName(), this.mCallGetCommand, str2, args2);
                    } else {
                            ...
                            synchronized (this) {
                                if (needsGenerationTracker) {
                                    ...
                                    if (array != null && index >= 0) {
                                        ...
                                        this.mGenerationTracker = new GenerationTracker(array, index, generation, new Runnable() {
                                ...
                                if (!needsGenerationTracker) {
                                    if (this.mGenerationTracker == null || currentGeneration != this.mGenerationTracker.getCurrentGeneration()) {
                                        Log.w(Settings.TAG, "mValues not put! needsGenerationTracker: " + needsGenerationTracker + " currentGeneration: " + currentGeneration + " name: " + str2 + " value: " + value);
                                    }
                                }
                                this.mValues.put(str2, value);
                            }
                        }
                        return value;
                    }
            ...
            try {
                Bundle queryArgs = ContentResolver.createSqlQueryBundle(NAME_EQ_PLACEHOLDER, new String[]{str2}, null);
                if (Settings.isInSystemServer()) {
                    try {
                        if (Binder.getCallingUid() != Process.myUid()) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        e = e2;
                                        IContentProvider iContentProvider = cp;
                                        c = c2;
                                        try {
                                            Log.w(Settings.TAG, "Can't get key " + str2 + " from " + this.mUri, e);
                                            if (c != null) {
                                            }
                                            return str;
                                        } catch (Throwable th3) {
                                        ...
                                        e = th4;
                                        IContentProvider iContentProvider2 = cp;
                                        c = c2;
                                        if (c != null) {
                                        }
                                        throw e;
                            ...
                            try {
                                Binder.restoreCallingIdentity(token);
                                IContentProvider iContentProvider3 = cp;
                                if (c != null) {
                                    if (c != null) {
                                        c.close();
                                    }
                                ...
                                e = e4;
                                IContentProvider iContentProvider4 = cp;
                                Log.w(Settings.TAG, "Can't get key " + str2 + " from " + this.mUri, e);
                                if (c != null) {
                                }
                                return str;
                                ...
                                e = th6;
                                IContentProvider iContentProvider5 = cp;
                                if (c != null) {
                                }
                                throw e;
                            }
                        ...
                        e = e5;
                        str = null;
                        IContentProvider iContentProvider6 = cp;
                        c = null;
                        Log.w(Settings.TAG, "Can't get key " + str2 + " from " + this.mUri, e);
                        if (c != null) {
                            c.close();
                        ...
                        e = th7;
                        IContentProvider iContentProvider7 = cp;
                        c = null;
                        if (c != null) {
                            c.close();
                        }
                ...
                c2 = null;
                try {
                    IContentProvider iContentProvider8 = cp;
                    try {
                        c = cp.query(cr.getPackageName(), this.mUri, SELECT_VALUE_PROJECTION, queryArgs, null);
                        if (c != null) {
                        }
                    ...
                    e = e7;
                    IContentProvider iContentProvider9 = cp;
                    c = null;
                    Log.w(Settings.TAG, "Can't get key " + str2 + " from " + this.mUri, e);
                    if (c != null) {
                    }
                    ...
                    e = th9;
                    IContentProvider iContentProvider10 = cp;
                    c = null;
                    if (c != null) {
                    }
                    throw e;
                ...
                e = e8;
                str = null;
                IContentProvider iContentProvider11 = cp;
                c = null;
                Log.w(Settings.TAG, "Can't get key " + str2 + " from " + this.mUri, e);
                if (c != null) {
                }
                ...
                e = th10;
                IContentProvider iContentProvider12 = cp;
                c = null;
                if (c != null) {
                }
                throw e;
    ...
    public static final class Secure extends NameValueTable {
        ...
        private static final SettingsValidators.Validator ACCESSIBILITY_SPEAK_PASSWORD_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        public static final String ADB_ENABLED = "adb_enabled";
        ...
        private static final SettingsValidators.Validator ASSIST_GESTURE_SENSITIVITY_VALIDATOR = new SettingsValidators.InclusiveFloatRangeValidator(0.0f, 1.0f);
        public static final String ASSIST_GESTURE_SETUP_COMPLETE = "assist_gesture_setup_complete";
        private static final SettingsValidators.Validator ASSIST_GESTURE_SETUP_COMPLETE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final SettingsValidators.Validator DOZE_PULSE_ON_DOUBLE_TAP_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final SettingsValidators.Validator DOZE_PULSE_ON_PICK_UP_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final SettingsValidators.Validator SCREENSAVER_COMPONENTS_VALIDATOR = new SettingsValidators.ComponentNameListValidator(",");
        ...
        private static final SettingsValidators.Validator SELECTED_SPELL_CHECKER_SUBTYPE_VALIDATOR = SettingsValidators.COMPONENT_NAME_VALIDATOR;
        private static final SettingsValidators.Validator SELECTED_SPELL_CHECKER_VALIDATOR = SettingsValidators.COMPONENT_NAME_VALIDATOR;
        ...
        private static final SettingsValidators.Validator SLEEP_TIMEOUT_VALIDATOR = new SettingsValidators.InclusiveIntegerRangeValidator(-1, Integer.MAX_VALUE);
        public static final String SMS_DEFAULT_APPLICATION = "sms_default_application";
        public static final String SPELL_CHECKER_ENABLED = "spell_checker_enabled";
        private static final SettingsValidators.Validator SPELL_CHECKER_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final SettingsValidators.Validator SWIPE_UP_TO_SWITCH_APPS_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        public static boolean putStringForUser(ContentResolver resolver, String name, String value, String tag, boolean makeDefault, int userHandle) {
            ...
            String value2 = fixedValue;
            if (LOCATION_MODE.equals(name)) {
                return setLocationModeForUser(resolver, Integer.parseInt(value2), userHandle);
            }
            if (!MOVED_TO_GLOBAL.contains(name)) {
                return sNameValueCache.putStringForUser(resolver, name, value2, tag, makeDefault, userHandle);
            }
            Log.w(Settings.TAG, "Setting " + name + " has moved from android.provider.Settings.Secure to android.provider.Settings.Global");
            return Global.putStringForUser(resolver, name, value2, tag, makeDefault, userHandle);
        }
    ...
    public static final class System extends NameValueTable {
        ...
        private static final SettingsValidators.Validator DISPLAY_COLOR_MODE_VALIDATOR = new SettingsValidators.InclusiveIntegerRangeValidator(0, 3);
        @Deprecated
        public static final String DOCK_SOUNDS_ENABLED = "dock_sounds_enabled";
        private static final SettingsValidators.Validator DOCK_SOUNDS_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;

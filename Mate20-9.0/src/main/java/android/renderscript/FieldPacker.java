...
public class FieldPacker {
    ...
    public short subI16() {
        ...
        int i = this.mPos - 1;
        this.mPos = i;
        short v = (short) ((bArr[i] & BatteryStats.HistoryItem.CMD_NULL) << 8);
        byte[] bArr2 = this.mData;
        int i2 = this.mPos - 1;
        this.mPos = i2;
        return (short) (((short) (bArr2[i2] & BatteryStats.HistoryItem.CMD_NULL)) | v);
    }
    ...
    public int subI32() {
        ...
        int i = this.mPos - 1;
        this.mPos = i;
        int v = (bArr[i] & BatteryStats.HistoryItem.CMD_NULL) << 24;
        byte[] bArr2 = this.mData;
        int i2 = this.mPos - 1;
        this.mPos = i2;
        int v2 = v | ((bArr2[i2] & BatteryStats.HistoryItem.CMD_NULL) << WifiScanner.PnoSettings.PnoNetwork.FLAG_SAME_NETWORK);
        byte[] bArr3 = this.mData;
        int i3 = this.mPos - 1;
        this.mPos = i3;
        int v3 = v2 | ((bArr3[i3] & BatteryStats.HistoryItem.CMD_NULL) << 8);
        byte[] bArr4 = this.mData;
        int i4 = this.mPos - 1;
        this.mPos = i4;
    ...
    public long subI64() {
        ...
        int i2 = this.mPos - 1;
        this.mPos = i2;
        long v2 = v | ((((long) bArr2[i2]) & 255) << 48);
        byte[] bArr3 = this.mData;
        int i3 = this.mPos - 1;
        this.mPos = i3;
        long v3 = v2 | ((((long) bArr3[i3]) & 255) << 40);
        byte[] bArr4 = this.mData;
        int i4 = this.mPos - 1;
        this.mPos = i4;
        long v4 = v3 | ((((long) bArr4[i4]) & 255) << 32);
        byte[] bArr5 = this.mData;
        int i5 = this.mPos - 1;
        this.mPos = i5;
        long v5 = v4 | ((((long) bArr5[i5]) & 255) << 24);
        byte[] bArr6 = this.mData;
        int i6 = this.mPos - 1;
        this.mPos = i6;
        long v6 = v5 | ((((long) bArr6[i6]) & 255) << 16);
        byte[] bArr7 = this.mData;
        int i7 = this.mPos - 1;
        this.mPos = i7;
        long v7 = v6 | ((((long) bArr7[i7]) & 255) << 8);
        byte[] bArr8 = this.mData;
        int i8 = this.mPos - 1;
        this.mPos = i8;
        return v7 | (((long) bArr8[i8]) & 255);
    }

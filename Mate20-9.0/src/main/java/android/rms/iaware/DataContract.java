...
public final class DataContract {
    ...
    public static class DevStatus implements BaseAttr, DevStatusAttr, BaseProperty, DevStatusProperty {
        ...
        public static final class Builder extends BaseBuilder {
            public CollectData build() {
                return super.build(AwareConstant.ResourceType.getReousrceId(AwareConstant.ResourceType.RES_DEV_STATUS));
            }
            ...
            public Builder addBatterystate(int plugType, boolean isBatteryPlugged, boolean isBatterCharging) {
                ...
                normalizer.appendCondition(DevStatusProperty.BATTERY_STATE_PLUGGED, isBatteryPlugged ? "1" : HwSettings.System.FINGERSENSE_KNUCKLE_GESTURE_OFF);
                normalizer.appendCondition(DevStatusProperty.BATTERY_STATE_CHARGING, isBatterCharging ? "1" : HwSettings.System.FINGERSENSE_KNUCKLE_GESTURE_OFF);
                this.mCollects.appendCollect(BaseAttr.INFO, normalizer.toString());
                return this;
            }

...
public final class KeyPairGeneratorSpec implements AlgorithmParameterSpec {
    ...
    public static final class Builder {
        ...
        public KeyPairGeneratorSpec build() {
            KeyPairGeneratorSpec keyPairGeneratorSpec = new KeyPairGeneratorSpec(this.mContext, this.mKeystoreAlias, this.mKeyType, this.mKeySize, this.mSpec, this.mSubjectDN, this.mSerialNumber, this.mStartDate, this.mEndDate, this.mFlags);

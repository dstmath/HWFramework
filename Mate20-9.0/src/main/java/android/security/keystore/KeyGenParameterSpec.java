...
public final class KeyGenParameterSpec implements AlgorithmParameterSpec, UserAuthArgs {
    ...
    public static final class Builder {
        ...
        public KeyGenParameterSpec build() {
            ...
            KeyGenParameterSpec keyGenParameterSpec = new KeyGenParameterSpec(str, i, i2, algorithmParameterSpec, x500Principal, bigInteger, date, date2, date3, date4, date5, i3, strArr, strArr3, this.mSignaturePaddings, this.mBlockModes, this.mRandomizedEncryptionRequired, this.mUserAuthenticationRequired, this.mUserAuthenticationValidityDurationSeconds, this.mUserPresenceRequired, this.mAttestationChallenge, this.mUniqueIdIncluded, this.mUserAuthenticationValidWhileOnBody, this.mInvalidatedByBiometricEnrollment, this.mIsStrongBoxBacked, this.mUserConfirmationRequired, this.mUnlockedDeviceRequired);

...
public final class NetworkSecurityConfig {
    ...
    public static final class Builder {
        ...
        public NetworkSecurityConfig build() {
            NetworkSecurityConfig networkSecurityConfig = new NetworkSecurityConfig(getEffectiveCleartextTrafficPermitted(), getEffectiveHstsEnforced(), getEffectivePinSet(), getEffectiveCertificatesEntryRefs());
    ...
    public static Builder getDefaultBuilder(ApplicationInfo info) {
        ...
        builder.setCleartextTrafficPermitted(info.targetSdkVersion < 28 && info.targetSandboxVersion < 2);

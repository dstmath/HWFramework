    ...
    public static final class Builder {
        ...
        public Builder addSanitizer(Sanitizer sanitizer, AutofillId... ids) {
            ...
            for (AutofillId id : ids) {
                Preconditions.checkArgument(!this.mSanitizerIds.contains(id), "already added %s", new Object[]{id});
        ...
        public SaveInfo build() {
            throwIfDestroyed();
            Preconditions.checkState(!ArrayUtils.isEmpty(this.mRequiredIds) || !ArrayUtils.isEmpty(this.mOptionalIds), "must have at least one required or optional id");

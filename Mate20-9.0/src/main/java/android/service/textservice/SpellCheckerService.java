...
public abstract class SpellCheckerService extends Service {
    ...
    public static final String TAG = SpellCheckerService.class.getSimpleName();
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [android.service.textservice.SpellCheckerService$SpellCheckerServiceBinder, android.os.IBinder] */

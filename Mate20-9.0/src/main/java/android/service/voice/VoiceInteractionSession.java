...
public class VoiceInteractionSession implements KeyEvent.Callback, ComponentCallbacks2 {
    ...
    public VoiceInteractionSession(Context context, Handler handler) {
        ...
        this.mSession = new IVoiceInteractionSession.Stub() {
            ...
            public void handleAssist(Bundle data, AssistStructure structure, AssistContent content, int index, int count) {
                ...
                final int i = index;
                final int i2 = count;
                AnonymousClass1 r0 = new Thread("AssistStructure retriever") {
                    public void run() {
    ...
    public void ensureWindowCreated() {
        if (!this.mInitialized) {
            if (this.mUiEnabled) {
                ...
                this.mRootView = this.mInflater.inflate(17367328, (ViewGroup) null);
    ...
    /* access modifiers changed from: package-private */
    public void doOnHandleAssist(Bundle data, AssistStructure structure, Throwable failure, AssistContent content) {
        if (failure != null) {
    ...
    /* access modifiers changed from: package-private */
    public void doOnHandleAssistSecondary(Bundle data, AssistStructure structure, Throwable failure, AssistContent content, int index, int count) {
        if (failure != null) {
            onAssistStructureFailure(failure);
        }

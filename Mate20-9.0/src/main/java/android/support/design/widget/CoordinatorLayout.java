...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (true) {
            int i = childState4;
            if (i < childCount2) {
                View child3 = this.mDependencySortedChildren.get(i);
                int i2 = i;
                if (child3.getVisibility() == 8) {
                    ...
                    View child5 = child2;
                    int widthUsed5 = Math.max(widthUsed2, widthPadding + child5.getMeasuredWidth() + lp.leftMargin + lp.rightMargin);
                ...
                int i3 = heightMode2;
                int i4 = childState3;
                int childState5 = heightUsed3;
                int widthUsed6 = widthUsed4;
                int childState6 = i4;
                setMeasuredDimension(View.resolveSizeAndState(widthUsed6, widthMeasureSpec, -16777216 & childState6), View.resolveSizeAndState(childState5, heightMeasureSpec, childState6 << 16));
                return;
            }
        }
    }

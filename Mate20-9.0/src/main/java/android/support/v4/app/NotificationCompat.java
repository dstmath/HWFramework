...
public class NotificationCompat {
        ...
        public static final class Builder {
            ...
            public Action build() {
                ...
                if (!textInputs.isEmpty()) {
                    textInputsArr = textInputs.toArray(new RemoteInput[textInputs.size()]);
                }
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(@Nullable Bundle b) {
            ...
            UnreadConversation unreadConversation = new UnreadConversation(messages, remoteInputCompat, onReply, onRead, participants, bundle.getLong(KEY_TIMESTAMP));
            return unreadConversation;
        }
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        Action action2 = new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputs, null, allowGeneratedReplies, semanticAction, showsUserInterface);
        return action2;
    }

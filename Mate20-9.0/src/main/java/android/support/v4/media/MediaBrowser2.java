...
public class MediaBrowser2 extends MediaController2 {
    ...
    public SupportLibraryImpl createImpl(@NonNull Context context, @NonNull SessionToken2 token, @NonNull Executor executor, @NonNull MediaController2.ControllerCallback callback) {
        if (token.isLegacySession()) {
            MediaBrowser2ImplLegacy mediaBrowser2ImplLegacy = new MediaBrowser2ImplLegacy(context, this, token, executor, (BrowserCallback) callback);
            return mediaBrowser2ImplLegacy;
        }
        MediaBrowser2ImplBase mediaBrowser2ImplBase = new MediaBrowser2ImplBase(context, this, token, executor, (BrowserCallback) callback);

...
public class MediaController2 implements AutoCloseable {
    ...
    public SupportLibraryImpl createImpl(@NonNull Context context, @NonNull SessionToken2 token, @NonNull Executor executor, @NonNull ControllerCallback callback) {
        if (token.isLegacySession()) {
            MediaController2ImplLegacy mediaController2ImplLegacy = new MediaController2ImplLegacy(context, this, token, executor, callback);
            return mediaController2ImplLegacy;
        }
        MediaController2ImplBase mediaController2ImplBase = new MediaController2ImplBase(context, this, token, executor, callback);

            ...
            if (code == TRANSACTION_rateWithExtras) {
                ...
                switch (code) {
                    case 1:
                        ...
                        if (data.readInt() != 0) {
                            _arg12 = MediaSessionCompat.ResultReceiverWrapper.CREATOR.createFromParcel(data);
                        }
                        sendCommand(_arg05, _arg1, _arg12);
                        reply.writeNoException();
                        return true;
                    case 2:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg12 = (KeyEvent) KeyEvent.CREATOR.createFromParcel(data);
                        }
                        boolean _result = sendMediaButton(_arg12);
                        reply.writeNoException();
                    ...
                    case 25:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg12 = RatingCompat.CREATOR.createFromParcel(data);
                        }
                        rate(_arg12);
                        reply.writeNoException();
                        return true;
                    case 26:
                        ...
                        sendCustomAction(_arg08, _arg12);
                        reply.writeNoException();
                        return true;
                    case 27:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 34:
                        ...
                        prepareFromMediaId(_arg09, _arg12);
                        reply.writeNoException();
                        return true;
                    case 35:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 42:
                        ...
                        addQueueItemAt(_arg12, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 43:
                        data.enforceInterface(DESCRIPTOR);

    ...
    private int parseC1(byte[] data, int pos) {
        ...
        switch (i) {
            ...
            case Const.CODE_C1_SPA /*144*/:
                int pos8 = pos + 2;
                CaptionPenAttr captionPenAttr = new CaptionPenAttr(data[pos] & 3, (data[pos] & 12) >> 2, (data[pos] & 240) >> 4, 7 & data[pos + 1], (data[pos + 1] & 56) >> 3, (data[pos + 1] & 64) != 0, (data[pos + 1] & 128) != 0);
            ...
            default:
                switch (i) {
                    case Const.CODE_C1_SWA /*151*/:
                        int pos13 = pos + 4;
                        CaptionWindowAttr captionWindowAttr = new CaptionWindowAttr(new CaptionColor((data[pos] & 192) >> 6, (data[pos] & 48) >> 4, (data[pos] & 12) >> 2, data[pos] & 3), new CaptionColor(0, (data[pos + 1] & 48) >> 4, (data[pos + 1] & 12) >> 2, data[pos + 1] & 3), ((data[pos + 2] & 128) >> 5) | ((data[pos + 1] & 192) >> 6), (data[pos + 2] & 64) != 0, (data[pos + 2] & 48) >> 4, (data[pos + 2] & 12) >> 2, data[pos + 2] & 3, (12 & data[pos + 3]) >> 2, (data[pos + 3] & 240) >> 4, 3 & data[pos + 3]);

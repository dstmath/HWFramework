    ...
    class Cea708CCWidget extends ClosedCaptionWidget implements Cea708CCParser.DisplayListener {
        ...
        private class CCWindowLayout extends RelativeLayout implements View.OnLayoutChangeListener {
            ...
            public void initWindow(CCLayout ccLayout, Cea708CCParser.CaptionWindow captionWindow) {
                ...
                float f = (float) captionWindow2.anchorVertical;
                ...
                float f2 = (float) captionWindow2.anchorHorizontal;
                ...
                cCLayout4.getClass();
                ScaledLayout.ScaledLayoutParams scaledLayoutParams = new ScaledLayout.ScaledLayoutParams(scaleStartRow, scaleEndRow, scaleStartCol, scaleEndCol);
                cCLayout3.addOrUpdateViewToSafeTitleArea(this, scaledLayoutParams);

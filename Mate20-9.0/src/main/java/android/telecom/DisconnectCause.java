...
public final class DisconnectCause implements Parcelable {
    ...
    public static final Parcelable.Creator<DisconnectCause> CREATOR = new Parcelable.Creator<DisconnectCause>() {
        public DisconnectCause createFromParcel(Parcel source) {
            DisconnectCause disconnectCause = new DisconnectCause(source.readInt(), TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(source), TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(source), source.readString(), source.readInt());

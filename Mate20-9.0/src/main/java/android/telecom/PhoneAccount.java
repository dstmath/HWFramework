...
public final class PhoneAccount implements Parcelable {
    ...
    public static class Builder {
        ...
        public PhoneAccount build() {
            ...
            PhoneAccount phoneAccount = new PhoneAccount(this.mAccountHandle, this.mAddress, this.mSubscriptionAddress, this.mCapabilities, this.mIcon, this.mHighlightColor, this.mLabel, this.mShortDescription, this.mSupportedUriSchemes, this.mExtras, this.mSupportedAudioRoutes, this.mIsEnabled, this.mGroupId);
            return phoneAccount;
        }
    }

...
public final class RemoteConnection {
    ...
    public void setAddress(Uri address, int presentation) {
        ...
        for (CallbackRecord record : this.mCallbackRecords) {
            ...
            AnonymousClass13 r2 = new Runnable() {
                public void run() {
                    callback2.onAddressChanged(this, uri, i);
                }
            };
            handler.post(r2);
        }
    ...
    public void setCallerDisplayName(String callerDisplayName, int presentation) {
        ...
        for (CallbackRecord record : this.mCallbackRecords) {
            ...
            AnonymousClass14 r2 = new Runnable() {
                public void run() {
                    callback2.onCallerDisplayNameChanged(this, str, i);
                }
            };
            handler.post(r2);
        }
    ...
    public void onConnectionEvent(String event, Bundle extras) {
        for (CallbackRecord record : this.mCallbackRecords) {
            ...
            AnonymousClass18 r2 = new Runnable() {
                public void run() {
                    callback2.onConnectionEvent(this, str, bundle);
                }
            };
            handler.post(r2);
        }

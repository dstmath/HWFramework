...
public class Voicemail implements Parcelable {
    ...
    public static class Builder {
        ...
        public Voicemail build() {
            ...
            Voicemail voicemail = new Voicemail(this.mBuilderTimestamp, this.mBuilderNumber, this.mBuilderPhoneAccount, this.mBuilderId, this.mBuilderDuration, this.mBuilderSourcePackage, this.mBuilderSourceData, this.mBuilderUri, this.mBuilderIsRead, Boolean.valueOf(this.mBuilderHasContent), this.mBuilderTranscription);
            return voicemail;
        }
    }

...
public class HwCustTelephonyManagerImpl extends HwCustTelephonyManager {
    ...
    public void setDataEnabledVZW(Context context, final int subId, final boolean enable) {
        ...
        builder.setTitle(33686064);
        builder.setMessage(33686062);
        if (HwCustUtil.isVoLteOn && !HwCustUtil.isVoWiFi) {
            builder.setMessage(33686063);
        }
        builder.setPositiveButton(17039370, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                teleManager.setDataEnabled(subId, enable);
                dialog.dismiss();
                AlertDialog unused = HwCustTelephonyManagerImpl.this.mConfirmDialog = null;
                boolean unused2 = HwCustTelephonyManagerImpl.this.mIsOkClicked = true;
        ...
        builder.setNegativeButton(17039360, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                boolean unused = HwCustTelephonyManagerImpl.this.mIsOkClicked = false;
    ...
    public void onDialogDismiss() {
        Settings.Global.putInt(this.mContext.getContentResolver(), "mobile_data", this.mIsOkClicked ^ true ? 1 : 0);

...
public class HwTelephonyManager {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$android$telephony$TelephonyManager$MultiSimVariants[TelephonyManager.MultiSimVariants.UNKNOWN.ordinal()] = 4;
    ...
    public void setServiceAbility(int subId, int type, int ability) {
        HwTelephonyManagerInner.getDefault().setServiceAbility(subId, type, ability);
    }

    public int getServiceAbility(int subId, int type) {
        return HwTelephonyManagerInner.getDefault().getServiceAbility(subId, type);
    }
    ...
    public int getDataRegisteredState(int subId) {
        return HwTelephonyManagerInner.getDefault().getDataRegisteredState(subId);
    }

    public int getVoiceRegisteredState(int subId) {
        return HwTelephonyManagerInner.getDefault().getVoiceRegisteredState(subId);
    }

...
public final class DownloadableSubscription implements Parcelable {
    ...
    public static final class Builder {
        ...
        public DownloadableSubscription build() {
            DownloadableSubscription downloadableSubscription = new DownloadableSubscription(this.encodedActivationCode, this.confirmationCode, this.carrierName, this.accessRules);
            return downloadableSubscription;
        }

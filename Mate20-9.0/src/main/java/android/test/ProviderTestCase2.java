...
public abstract class ProviderTestCase2<T extends ContentProvider> extends AndroidTestCase {
    ...
    private class MockContext2 extends MockContext {
        ...
        /* JADX WARNING: type inference failed for: r0v0, types: [android.content.Context, android.test.ProviderTestCase2$MockContext2] */
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, android.test.ProviderTestCase2$MockContext2] */
    ...
    static <T extends ContentProvider> T createProviderForTest(Context context, Class<T> providerClass, String authority) throws IllegalAccessException, InstantiationException {
        T instance = (ContentProvider) providerClass.newInstance();

...
public class CharacterPickerDialog extends Dialog implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    private class OptionsAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            Button b = (Button) CharacterPickerDialog.this.mInflater.inflate(17367110, (ViewGroup) null);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        GridView grid = (GridView) findViewById(16908807);
        grid.setAdapter((ListAdapter) new OptionsAdapter(getContext()));
        grid.setOnItemClickListener(this);
        this.mCancelButton = (Button) findViewById(16908798);

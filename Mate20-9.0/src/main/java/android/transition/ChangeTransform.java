...
public class ChangeTransform extends Transition {
    ...
    private static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            this.mView.setTagInternal(16909465, null);
            this.mView.setTagInternal(16909184, null);
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (view.getVisibility() != 8) {
            ...
            if (this.mReparent) {
                ...
                transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(16909465));
                transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(16909184));
            }
        }
    }
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues startValues, TransitionValues endValues, boolean handleParentChange) {
        ...
        ObjectAnimator animator = ObjectAnimator.ofPropertyValuesHolder(pathAnimatorMatrix, new PropertyValuesHolder[]{valuesProperty, PropertyValuesHolder.ofObject(TRANSLATIONS_PROPERTY, null, path)});
        ...
        AnonymousClass3 r4 = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (!this.mIsCanceled) {
                    if (!z || !ChangeTransform.this.mUseOverlay) {
                        view2.setTagInternal(16909465, null);
                        view2.setTagInternal(16909184, null);
                    } else {
            ...
            private void setCurrentMatrix(Matrix currentMatrix) {
                ...
                view2.setTagInternal(16909465, this.mTempMatrix);
                transforms.restore(view2);
            }
        };
        animator.addListener(r4);
        animator.addPauseListener(r4);
        return animator;
    }
    ...
    private void setMatricesForParent(TransitionValues startValues, TransitionValues endValues) {
        ...
        endValues.view.setTagInternal(16909184, endParentMatrix);

...
public class TransitionSet extends Transition {
    ...
    public void runAnimators() {
        ...
        if (this.mPlayTogether) {
            ...
            for (int i3 = 1; i3 < numTransitions; i3++) {
                final Transition nextTransition = this.mTransitions.get(i3);
                this.mTransitions.get(i3 - 1).addListener(new TransitionListenerAdapter() {
                    public void onTransitionEnd(Transition transition) {

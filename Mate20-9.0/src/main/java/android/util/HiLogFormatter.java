...
public final class HiLogFormatter implements Closeable, Flushable {
    ...
    private class FormatSpecifier implements FormatString {
        ...
        static {
            Class<HiLogFormatter> cls = HiLogFormatter.class;
        }
        ...
        public void print(Object arg, Locale l, boolean showPrivacy) throws IOException {
            if (showPrivacy || !this.privacy) {
                ...
                printString(HiLogString.privateString, l);
            }
        }
        ...
        private void print(StringBuilder sb, double value, Locale l, Flags f2, char c2, int precision2, boolean neg) throws IOException {
            ...
            if (c3 == 'e') {
                ...
                System.arraycopy(exp4, 1, tmp, 0, exp4.length - 1);
                char[] cArr2 = tmp;
                char c4 = sign;
                LocaleData localeData2 = localeData;
                Locale locale = separatorLocale;
                sb2.append(localizedMagnitude((StringBuilder) null, tmp, flags2, -1, l));
            } else if (c3 == 'f') {
                if (i != -1) {
                    i2 = i;
                }
                ...
                if (exp6 != null) {
                    ...
                    System.arraycopy(exp6, 1, tmp2, 0, exp6.length - 1);
                    char[] cArr3 = tmp2;
                    char c5 = sign2;
                    sb2.append(localizedMagnitude((StringBuilder) null, tmp2, flags3, -1, l));
                }
            } else if (c3 == 'a') {
                int prec6 = i;
                if (i == -1) {
        ...
        private Appendable print(StringBuilder sb, Calendar t, char c2, Locale l) throws IOException {
            ...
            switch (c3) {
                ...
                case 'y':
                    ...
                    sb2.append(localizedMagnitude((StringBuilder) null, (long) i4, Flags.ZERO_PAD, size, locale2));
                    break;
                case HwLogExceptionInner.LEVEL_D:
                ...
                case 'l':
                    ...
                    sb2.append(localizedMagnitude((StringBuilder) null, (long) i6, flags, 2, locale2));
                    break;
                case 'L':
                    sb2.append(localizedMagnitude((StringBuilder) null, (long) calendar.get(14), Flags.ZERO_PAD, 3, locale2));
                    break;
                case 'M':
                    sb2.append(localizedMagnitude((StringBuilder) null, (long) calendar.get(12), Flags.ZERO_PAD, 2, locale2));
                    break;
                case 'N':
                    sb2.append(localizedMagnitude((StringBuilder) null, (long) (calendar.get(14) * 1000000), Flags.ZERO_PAD, 9, locale2));
                    break;
                case 'Q':
                    sb2.append(localizedMagnitude((StringBuilder) null, t.getTimeInMillis(), Flags.NONE, this.width, locale2));
                    break;
                case 'R':
                case 'T':
                    ...
                    break;
                case 'S':
                    sb2.append(localizedMagnitude((StringBuilder) null, (long) calendar.get(13), Flags.ZERO_PAD, 2, locale2));
                    break;
                case 'Z':
                ...
                case BastetParameters.HONGBAO_SPEEDUP_STOP /*101*/:
                    ...
                    sb2.append(localizedMagnitude((StringBuilder) null, (long) i7, flags2, 2, locale2));
                    break;
                case CharacterSets.DEFAULT_CHARSET /*106*/:
                    sb2.append(localizedMagnitude((StringBuilder) null, (long) calendar.get(6), Flags.ZERO_PAD, 3, locale2));
                    break;
                case 'm':
                    sb2.append(localizedMagnitude((StringBuilder) null, (long) (calendar.get(2) + 1), Flags.ZERO_PAD, 2, locale2));
                    break;
                case 'p':
                    String[] ampm = {"AM", "PM"};
                ...
                case 'r':
                    ...
                    break;
                case 's':
                    sb2.append(localizedMagnitude((StringBuilder) null, t.getTimeInMillis() / 1000, Flags.NONE, this.width, locale2));
                    break;
                case 'z':
                    ...
                    int min = i8 / HwSecureWaterMark.MAX_NUMER;
                    sb2.append(localizedMagnitude((StringBuilder) null, (long) (((min / 60) * 100) + (min % 60)), Flags.ZERO_PAD, 4, locale2));
                    break;
            }
            return sb2;
        }
        ...
        private Appendable print(StringBuilder sb, TemporalAccessor t, char c2, Locale l) throws IOException {
            ...
            switch (c2) {
                ...
                case 'y':
                    ...
                    sb.append(localizedMagnitude((StringBuilder) null, (long) i3, Flags.ZERO_PAD, size, l));
                    break;
                case HwLogExceptionInner.LEVEL_D:
                ...
                case 'F':
                    ...
                    break;
                case 'H':
                    sb.append(localizedMagnitude((StringBuilder) null, (long) t.get(ChronoField.HOUR_OF_DAY), Flags.ZERO_PAD, 2, l));
                    break;
                case 'I':
                    sb.append(localizedMagnitude((StringBuilder) null, (long) t.get(ChronoField.CLOCK_HOUR_OF_AMPM), Flags.ZERO_PAD, 2, l));
                    break;
                case 'L':
                    sb.append(localizedMagnitude((StringBuilder) null, (long) t.get(ChronoField.MILLI_OF_SECOND), Flags.ZERO_PAD, 3, l));
                    break;
                case 'M':
                    sb.append(localizedMagnitude((StringBuilder) null, (long) t.get(ChronoField.MINUTE_OF_HOUR), Flags.ZERO_PAD, 2, l));
                    break;
                case 'N':
                    sb.append(localizedMagnitude((StringBuilder) null, (long) (t.get(ChronoField.MILLI_OF_SECOND) * 1000000), Flags.ZERO_PAD, 9, l));
                    break;
                case 'Q':
                    sb.append(localizedMagnitude((StringBuilder) null, (t.getLong(ChronoField.INSTANT_SECONDS) * 1000) + t.getLong(ChronoField.MILLI_OF_SECOND), Flags.NONE, this.width, l));
                    break;
                case 'R':
                case 'T':
                    ...
                    break;
                case 'S':
                    sb.append(localizedMagnitude((StringBuilder) null, (long) t.get(ChronoField.SECOND_OF_MINUTE), Flags.ZERO_PAD, 2, l));
                    break;
                case 'Z':
                ...
                case BastetParameters.HONGBAO_SPEEDUP_STOP /*101*/:
                    ...
                    sb.append(localizedMagnitude((StringBuilder) null, (long) i4, flags, 2, l));
                    break;
                case CharacterSets.DEFAULT_CHARSET /*106*/:
                    sb.append(localizedMagnitude((StringBuilder) null, (long) t.get(ChronoField.DAY_OF_YEAR), Flags.ZERO_PAD, 3, l));
                    break;
                case 'k':
                    sb.append(localizedMagnitude((StringBuilder) null, (long) t.get(ChronoField.HOUR_OF_DAY), Flags.NONE, 2, l));
                    break;
                case 'l':
                    sb.append(localizedMagnitude((StringBuilder) null, (long) t.get(ChronoField.CLOCK_HOUR_OF_AMPM), Flags.NONE, 2, l));
                    break;
                case 'm':
                    sb.append(localizedMagnitude((StringBuilder) null, (long) t.get(ChronoField.MONTH_OF_YEAR), Flags.ZERO_PAD, 2, l));
                    break;
                case 'p':
                    String[] ampm = {"AM", "PM"};
                ...
                case 'r':
                    ...
                    break;
                case 's':
                    sb.append(localizedMagnitude((StringBuilder) null, t.getLong(ChronoField.INSTANT_SECONDS), Flags.NONE, this.width, l));
                    break;
                case 'z':
                    try {
                        ...
                        int min = i5 / 60;
                        sb.append(localizedMagnitude((StringBuilder) null, (long) (((min / 60) * 100) + (min % 60)), Flags.ZERO_PAD, 4, l));
                        break;
    ...
    private class FormatSpecifierParser {
        ...
        public FormatSpecifierParser(String format2, int startIdx) {
            ...
            if (format2.charAt(this.cursor) == '{') {
                int flagEndIndex = format2.indexOf(125, this.cursor);
                if (-1 != flagEndIndex) {
            ...
            FormatSpecifier formatSpecifier = new FormatSpecifier(this.index, this.flags, this.width, this.precision, this.tT, this.conv, privacyStr);
    ...
    private HiLogFormatter(Charset charset, Locale l2, File file) throws FileNotFoundException {
        this(l2, (Appendable) new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file), charset)));
    }

...
public class RenderNode {
    ...
    private static class NoImagePreloadHolder {
        ...
        static {
            NativeAllocationRegistry nativeAllocationRegistry = new NativeAllocationRegistry(RenderNode.class.getClassLoader(), RenderNode.nGetNativeFinalizer(), Trace.TRACE_TAG_CAMERA);

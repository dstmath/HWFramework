...
public class StylusTouchListener implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    private static final int LONGPRESS_TIMEOUT = SystemProperties.getInt("ro.config.stylus_longpress_timeout", 1500);
    ...
    public StylusTouchListener(Context context) {
        ...
        this.mGestureDetector.setCustomLongpressTimeout(LONGPRESS_TIMEOUT);
    }
    ...
    private void startHitouchSensor(MotionEvent e) {
        ...
        try {
            ...
            Log.d(TAG, "startHitouchSensor error:" + ex);
        }
    }

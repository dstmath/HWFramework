...
public class VRManagerService extends IVRManagerService.Stub {
    ...
    public boolean startFrontBufferDisplay() {
        ...
        synchronized (this.mLock) {
            ...
            IHivrarService hivrarService2 = getHivrarService();
            if (hivrarService2 == null) {
                Slog.e(TAG, "hivrarService service is unavailable");
                return false;
            }
            int r2 = -1;
            try {
                r2 = hivrarService2.vrAutoRefresh(1);

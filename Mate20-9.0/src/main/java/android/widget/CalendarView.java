...
public class CalendarView extends FrameLayout {
    ...
    public CalendarView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        switch (mode) {
            case 0:
                CalendarViewLegacyDelegate calendarViewLegacyDelegate = new CalendarViewLegacyDelegate(this, context, attrs, defStyleAttr, defStyleRes);
                this.mDelegate = calendarViewLegacyDelegate;
                return;
            case 1:
                CalendarViewMaterialDelegate calendarViewMaterialDelegate = new CalendarViewMaterialDelegate(this, context, attrs, defStyleAttr, defStyleRes);
                this.mDelegate = calendarViewMaterialDelegate;
                return;
            default:

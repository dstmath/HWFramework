...
public class NumberPicker extends LinearLayout {
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
        ...
        private String getVirtualDecrementButtonText() {
            ...
            if (NumberPicker.this.mDisplayedValues == null) {
                str = NumberPicker.this.formatNumber(value);
            } else {
                str = NumberPicker.this.mDisplayedValues[value - NumberPicker.this.mMinValue];
            }
            return str;
        }
    ...
    class InputTextFilter extends NumberKeyListener {
        ...
        public CharSequence filter(CharSequence source, int start, int end, Spanned dest, int dstart, int dend) {
            ...
            if (TextUtils.isEmpty(String.valueOf(source.subSequence(start, end)))) {
                return "";
            }
            String result2 = String.valueOf(dest.subSequence(0, dstart)) + filtered + dest.subSequence(dend, dest.length());
        ...
        if (this.mMinHeight == -1 || this.mMaxHeight == -1 || this.mMinHeight <= this.mMaxHeight) {
            ...
            if (this.mMinWidth == -1 || this.mMaxWidth == -1 || this.mMinWidth <= this.mMaxWidth) {
                ...
                if (!this.mHasSelectorWheel) {
                    this.mIncrementButton = (ImageButton) findViewById(16908995);
                ...
                if (!this.mHasSelectorWheel) {
                    this.mDecrementButton = (ImageButton) findViewById(16908855);
                ...
                this.mInputText = (EditText) findViewById(16909153);
                ...
                int i = color;
                Paint paint2 = paint;
                ColorStateList colorStateList = colors;
    ...
    public void scrollBy(int x, int y) {
        ...
        if (!this.mWrapSelectorWheel && y > 0 && selectorIndices[this.SELECTOR_MIDDLE_ITEM_INDEX] <= this.mMinValue) {
            ...
            int maxScrollY = this.mSelectorElementHeight * (this.mDisplayedValues != null ? this.mDisplayedValues.length + 1 : (this.mMaxValue - this.mMinValue) + 2);
    ...
    public void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            String scrollSelectorValue = this.mSelectorIndexToStringCache.get(selectorIndices[i2]);
            if ((!showSelectorWheel || i2 == this.SELECTOR_MIDDLE_ITEM_INDEX) && (i2 != this.SELECTOR_MIDDLE_ITEM_INDEX || this.mInputText.getVisibility() == 0)) {
                ...
                canvas2.drawText(scrollSelectorValue, x, adjustYCoordinate(i2, y2), this.mSelectorWheelPaint);
            }

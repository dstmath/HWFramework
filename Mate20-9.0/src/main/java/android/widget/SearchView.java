...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if (!SearchView.this.mSearchSrcTextView.isEmpty() && event.hasNoModifiers()) {
                    if (event.getAction() == 1 && keyCode == 66) {
                        ...
                        SearchableInfo.ActionKeyInfo actionKey = SearchView.this.mSearchable.findActionKey(keyCode);
        ...
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(16909293);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(16909289);
        this.mSearchPlate = findViewById(16909292);
        this.mSubmitArea = findViewById(16909386);
        this.mSearchButton = (ImageView) findViewById(16909287);
        this.mGoButton = (ImageView) findViewById(16909290);
        this.mCloseButton = (ImageView) findViewById(16909288);
        this.mVoiceButton = (ImageView) findViewById(16909295);
        this.mCollapsedIcon = (ImageView) findViewById(16909291);
    ...
    private Intent createIntent(String action, Uri data, String extraData, String query, int actionKey, String actionMsg) {
        ...
        if (query != null) {
            intent.putExtra(SearchRecentSuggestions.SuggestionColumns.QUERY, query);
        }
        if (extraData != null) {

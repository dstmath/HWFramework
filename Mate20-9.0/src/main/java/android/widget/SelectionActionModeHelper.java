...
public final class SelectionActionModeHelper {
    ...
    SelectionActionModeHelper(Editor editor) {
        ...
        TextClassificationHelper textClassificationHelper = new TextClassificationHelper(context, new Supplier() {
            public final Object get() {
                return TextView.this.getTextClassifier();
            }
        }, getText(this.mTextView), 0, 1, this.mTextView.getTextLocales());
        this.mTextClassificationHelper = textClassificationHelper;
    ...
    public void startSelectionActionModeAsync(boolean adjustSelection) {
        ...
        TextClassificationAsyncTask textClassificationAsyncTask = new TextClassificationAsyncTask(textView, timeoutDuration, supplier, consumer, new Supplier() {
            public final Object get() {
                return SelectionActionModeHelper.TextClassificationHelper.this.getOriginalSelection();
            }
        });
        this.mTextClassificationAsyncTask = textClassificationAsyncTask.execute((Params[]) new Void[0]);
    }
    ...
    public void startLinkActionModeAsync(int start, int end) {
        ...
        TextClassificationHelper textClassificationHelper2 = this.mTextClassificationHelper;
        Objects.requireNonNull(textClassificationHelper2);
        TextClassificationAsyncTask textClassificationAsyncTask = new TextClassificationAsyncTask(textView, timeoutDuration, r4, r5, new Supplier() {
            public final Object get() {
                return SelectionActionModeHelper.TextClassificationHelper.this.getOriginalSelection();
            }
        });

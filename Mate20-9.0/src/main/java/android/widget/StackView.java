...
public class StackView extends AdapterViewAnimator {
    ...
    public void transformViewForTransition(int fromIndex, int toIndex, final View view, boolean animate) {
        ...
        if (fromIndex == -1 && toIndex == getNumActiveViews() - 1) {
            ...
            if (animate) {
                ObjectAnimator slideIn = ObjectAnimator.ofPropertyValuesHolder(animationSlider, new PropertyValuesHolder[]{PropertyValuesHolder.ofFloat("XProgress", new float[]{0.0f}), PropertyValuesHolder.ofFloat("YProgress", new float[]{0.0f})});
            ...
            if (animate) {
                ObjectAnimator slideOut = ObjectAnimator.ofPropertyValuesHolder(animationSlider2, new PropertyValuesHolder[]{PropertyValuesHolder.ofFloat("XProgress", new float[]{0.0f}), PropertyValuesHolder.ofFloat("YProgress", new float[]{1.0f})});
    ...
    private void transformViewAtIndex(int index, View view, boolean animate) {
        ...
        if (animate) {
            ...
            ObjectAnimator oa = ObjectAnimator.ofPropertyValuesHolder(view2, new PropertyValuesHolder[]{PropertyValuesHolder.ofFloat("scaleX", new float[]{scale}), PropertyValuesHolder.ofFloat("scaleY", new float[]{scale}), translationY, translationX});
    ...
    public void showOnly(int childIndex, boolean animate) {
        ...
        for (int i = this.mCurrentWindowEnd; i >= this.mCurrentWindowStart; i--) {
            ...
            if (((AdapterViewAnimator.ViewAndMetaData) this.mViewsMap.get(Integer.valueOf(index))) != null) {
                View v = ((AdapterViewAnimator.ViewAndMetaData) this.mViewsMap.get(Integer.valueOf(index))).view;
                if (v != null) {
                    v.bringToFront();
                }
            }
    ...
    private void handlePointerUp(MotionEvent ev) {
        ...
        if (deltaY > this.mSwipeThreshold && this.mSwipeGestureType == 2 && this.mStackSlider.mMode == 0) {
            ...
            if (this.mSwipeGestureType == 1) {
                ...
                ObjectAnimator pa = ObjectAnimator.ofPropertyValuesHolder(new StackSlider(this.mStackSlider), new PropertyValuesHolder[]{PropertyValuesHolder.ofFloat("XProgress", new float[]{0.0f}), PropertyValuesHolder.ofFloat("YProgress", new float[]{finalYProgress})});
                ...
                ObjectAnimator pa2 = ObjectAnimator.ofPropertyValuesHolder(new StackSlider(this.mStackSlider), new PropertyValuesHolder[]{PropertyValuesHolder.ofFloat("XProgress", new float[]{0.0f}), PropertyValuesHolder.ofFloat("YProgress", new float[]{finalYProgress2})});
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (heightSpecMode == 0) {
            if (haveChildRefSize) {
                i = Math.round(((float) this.mReferenceChildHeight) * (1.0f + 1.1111112f)) + this.mPaddingTop + this.mPaddingBottom;
            } else {
                i = 0;
            }
            heightSpecSize = i;

...
public class HwSuperResolution {
    ...
    public static native Bitmap nativeSRCreate(int[] iArr, int i, int i2, int i3, int i4, int i5, boolean z, float[] fArr, ColorSpace.Rgb.TransferParameters transferParameters);
    ...
    public int cancel(Bitmap bitmap) {
        ...
        int ret = nativeCancel(this.mSupResPar, this.mBitmapFd.get(bitmap).intValue());
        if (ret == 0) {

...
public class Content {
    ...
    private static class DeleteCommand extends Command {
        ...
        public void onExecute(IContentProvider provider) throws Exception {
            provider.delete(resolveCallingPackage(), this.mUri, this.mWhere, null);
        }
    }
        ...
        public CallCommand parseCallCommand() {
            ...
            while (true) {
                ...
                if (access$000 != null) {
                    ...
                    CallCommand callCommand = new CallCommand(uri, userId, method, arg, values);
                    return callCommand;
                } else {
        ...
        public QueryCommand parseQueryCommand() {
            ...
            while (true) {
                ...
                if (access$000 != null) {
                    ...
                    QueryCommand queryCommand = new QueryCommand(uri, userId, projection, where, sort);
                    return queryCommand;
                } else {
                    throw new IllegalArgumentException("Content provider URI not specified. Did you specify --uri argument?");
                }
    ...
    private static class QueryCommand extends DeleteCommand {
        ...
        public void onExecute(IContentProvider provider) throws Exception {
            Cursor cursor = provider.query(resolveCallingPackage(), this.mUri, this.mProjection, ContentResolver.createSqlQueryBundle(this.mWhere, null, this.mSortOrder), null);
            if (cursor == null) {
    ...
    private static class UpdateCommand extends InsertCommand {
        ...
        public void onExecute(IContentProvider provider) throws Exception {
            provider.update(resolveCallingPackage(), this.mUri, this.mContentValues, this.mWhere, null);
        }
    }

    ...
    private int run(String[] args) {
        ...
        if (this.mScriptFileNames != null && this.mScriptFileNames.size() == 1) {
            ...
            if (this.mSetupFileName != null) {
                MonkeySourceRandomScript monkeySourceRandomScript = new MonkeySourceRandomScript(this.mSetupFileName, this.mScriptFileNames, this.mThrottle, this.mRandomizeThrottle, this.mRandom, this.mProfileWaitTime, this.mDeviceSleepTime, this.mRandomizeScript);
                this.mEventSource = monkeySourceRandomScript;
                this.mCount++;
            } else {
                MonkeySourceRandomScript monkeySourceRandomScript2 = new MonkeySourceRandomScript(this.mScriptFileNames, this.mThrottle, this.mRandomizeThrottle, this.mRandom, this.mProfileWaitTime, this.mDeviceSleepTime, this.mRandomizeScript);
                this.mEventSource = monkeySourceRandomScript2;
            }
            this.mEventSource.setVerbose(this.mVerbose);
            this.mCountEvents = false;
                    ...
                    if (!this.mSendNoEvents) {
                        ...
                        if (ev == null) {
                            ...
                            if (injectCode == 0) {
                                ...
                                systemCrashed = true ^ this.mIgnoreSecurityExceptions;
                                if (systemCrashed) {

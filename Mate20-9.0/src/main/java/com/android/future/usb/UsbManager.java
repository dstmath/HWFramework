...
public class UsbManager {
    ...
    public ParcelFileDescriptor openAccessory(UsbAccessory accessory) {
        try {
            ...
            UsbAccessory usbAccessory = new UsbAccessory(accessory.getManufacturer(), accessory.getModel(), accessory.getDescription(), accessory.getVersion(), accessory.getUri(), accessory.getSerial());
            return iUsbManager.openAccessory(usbAccessory);
        } catch (RemoteException e) {
    ...
    public void requestPermission(UsbAccessory accessory, PendingIntent pi) {
        try {
            IUsbManager iUsbManager = this.mService;
            UsbAccessory usbAccessory = new UsbAccessory(accessory.getManufacturer(), accessory.getModel(), accessory.getDescription(), accessory.getVersion(), accessory.getUri(), accessory.getSerial());
            iUsbManager.requestAccessoryPermission(usbAccessory, this.mContext.getPackageName(), pi);
        } catch (RemoteException e) {

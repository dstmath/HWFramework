...
public class HwImsUtManager {
    private static final Singleton<IHwImsUtManager> IImsUtManagerSingleton = new Singleton<IHwImsUtManager>() {
        /* access modifiers changed from: protected */
        public IHwImsUtManager create() {
            try {
                if (HwImsUtManager.getImsUt() != null) {
                    return IHwImsUtManager.Stub.asInterface(HwImsUtManager.getImsUt().getHwInnerService());
                }
    ...
    private static IHwImsUtManager getService() {
        return (IHwImsUtManager) IImsUtManagerSingleton.get();
    }

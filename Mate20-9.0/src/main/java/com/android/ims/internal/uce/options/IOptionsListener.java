            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 2:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg12 = StatusCode.CREATOR.createFromParcel(data);
                        }
                        serviceAvailable(_arg12);
                        reply.writeNoException();
                        return true;
                    case 3:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 4:
                        ...
                        sipResponseReceived(_arg0, _arg1, _arg12);
                        reply.writeNoException();
                        return true;
                    case 5:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg12 = OptionsCmdStatus.CREATOR.createFromParcel(data);
                        }
                        cmdStatus(_arg12);
                        reply.writeNoException();
                        return true;

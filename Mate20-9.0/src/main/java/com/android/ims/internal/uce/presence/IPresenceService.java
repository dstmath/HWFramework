            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 2:
                        ...
                        StatusCode _result2 = addListener(_arg0, _arg1, _arg2);
                        reply.writeNoException();
                        if (_result2 != null) {
                            reply.writeInt(1);
                    ...
                    case 3:
                        ...
                        StatusCode _result3 = removeListener(_arg02, _arg2);
                        reply.writeNoException();
                        if (_result3 != null) {
                            reply.writeInt(1);
                    ...
                    case 5:
                        ...
                        if (data.readInt() != 0) {
                            _arg2 = PresCapInfo.CREATOR.createFromParcel(data);
                        }
                        StatusCode _result5 = publishMyCap(_arg03, _arg2, data.readInt());
                        reply.writeNoException();
                        if (_result5 != null) {
                            reply.writeInt(1);
                    ...
                    case 8:
                        ...
                        if (data.readInt() != 0) {
                            _arg2 = PresServiceInfo.CREATOR.createFromParcel(data);
                        }
                        StatusCode _result8 = setNewFeatureTag(_arg04, _arg12, _arg2, data.readInt());
                        reply.writeNoException();
                        if (_result8 != null) {
                            reply.writeInt(1);

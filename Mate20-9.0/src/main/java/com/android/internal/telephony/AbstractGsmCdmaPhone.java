...
public abstract class AbstractGsmCdmaPhone extends Phone {
    public static final String CDMA_PHONE = "CDMA";
    public static final String GSM_PHONE = "GSM";
    ...
    public interface CDMAPhoneReference {
        ...
        String getCdmaMlplVersion(String str);

        String getCdmaMsplVersion(String str);
        ...
        void logForImei(String str, String str2);

        void logForTest(String str, String str2);
    ...
    public boolean isPhoneTypeGsm() {
        return GSM_PHONE.equalsIgnoreCase(this.mName);
    }
    ...
    public void logForTest(String operationName, String content) {
        if (isPhoneTypeGsm()) {
            this.mGsmReference.logForTest(operationName, content);
        } else {
            this.mCdmaReference.logForTest(operationName, content);
        }
    }

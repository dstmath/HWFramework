...
public class HwDsdsController extends Handler {
                ...
                if (index.intValue() < this.mCis.length) {
                    ...
                    switch (msg.what) {
                        ...
                        case 201:
                            ...
                            break;
                        case 202:
                            if (!this.mAutoSetPowerupModemDone && this.mCis[index.intValue()].getRadioState() != CommandsInterface.RadioState.RADIO_UNAVAILABLE) {
                        ...
                        case 204:
                            ...
                            sb.append("Received ");
                            sb.append(msg.what == 203 ? "EVENT_HWDSDS_SET_ACTIVEMODE_DONE" : "EVENT_HWDSDS_SET_ACTIVEMODE_TIMEOUT");
                            sb.append(" on index ");
                            sb.append(index);
                            logd(sb.toString());
                        ...
                        case 301:
                            ...
                            this.mNumOfCloseModemSuccess = this.mNumOfCloseModemSuccess + 1;
    ...
    private void handleActiveModeDoneOrTimeout(Message msg) {
        AsyncResult ar_setmode = (AsyncResult) msg.obj;
    ...
    private void setRadioPowerForHotPlug() {
        ...
        if (this.mUiccCards[0] != null) {
            isCard1Present = this.mUiccCards[0].getCardState() == IccCardStatus.CardState.CARDSTATE_PRESENT;
        ...
        if (this.mUiccCards[1] != null) {
            isCard2Present = this.mUiccCards[1].getCardState() == IccCardStatus.CardState.CARDSTATE_PRESENT;
    ...
    private void uiccHwdsdsStartTimeOut() {
        uiccHwdsdscancelTimeOut();
        sendMessageDelayed(obtainMessage(204), HwVSimConstants.WAIT_FOR_SIM_STATUS_CHANGED_UNSOL_TIMEOUT);

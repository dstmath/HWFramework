...
public interface HwNetworkManager {
    ...
    boolean checkForRoamingForIndianOperators(ServiceStateTracker serviceStateTracker, Phone phone, ServiceState serviceState);
    ...
    int getNrConfigTechnology(ServiceStateTracker serviceStateTracker, GsmCdmaPhone gsmCdmaPhone, int i, int i2);

    void handle4GSwitcherForNoMdn(Phone phone, int i);

    boolean isAllowLocationUpdate(ServiceStateTracker serviceStateTracker, Phone phone, int i);
    ...
    boolean recoverAutoSelectMode(ServiceStateTracker serviceStateTracker, GsmCdmaPhone gsmCdmaPhone, boolean z);
    ...
    void sendTimeZoneSelectionNotification(ServiceStateTracker serviceStateTracker, GsmCdmaPhone gsmCdmaPhone);
    ...
    boolean signalStrengthResultHW(ServiceStateTracker serviceStateTracker, GsmCdmaPhone gsmCdmaPhone, AsyncResult asyncResult, SignalStrength signalStrength, boolean z);

...
public interface HwPhoneManager {
    ...
    boolean checkApnShouldNotify(int i, String str, PhoneConstants.DataState dataState);

    void checkMMICode(String str, int i);

    String convertUssdMessage(String str);

    AbstractGsmCdmaPhone.CDMAPhoneReference createHwCDMAPhoneReference(AbstractGsmCdmaPhone abstractGsmCdmaPhone);

    AbstractCallManager.CallManagerReference createHwCallManagerReference(AbstractCallManager abstractCallManager);

    AbstractGsmCdmaCallTracker.CdmaCallTrackerReference createHwCdmaCallTrackerReference(AbstractGsmCdmaCallTracker abstractGsmCdmaCallTracker);

    AbstractGsmCdmaConnection.HwCdmaConnectionReference createHwCdmaConnectionReference(AbstractGsmCdmaConnection abstractGsmCdmaConnection);

    AbstractGsmCdmaPhone.GSMPhoneReference createHwGSMPhoneReference(AbstractGsmCdmaPhone abstractGsmCdmaPhone);

    AbstractGsmCdmaCallTracker.GsmCallTrackerReference createHwGsmCallTrackerReference(AbstractGsmCdmaCallTracker abstractGsmCdmaCallTracker);

    IHwGsmCdmaPhoneEx createHwGsmCdmaPhoneEx(IHwGsmCdmaPhoneInner iHwGsmCdmaPhoneInner);

    AbstractImsPhoneCallTracker.ImsPhoneCallTrackerReference createHwImsPhoneCallTrackerReference(AbstractImsPhoneCallTracker abstractImsPhoneCallTracker);

    IHwImsPhoneEx createHwImsPhoneEx(ImsPhoneCallTracker imsPhoneCallTracker);

    AbstractPhoneBase.HwPhoneBaseReference createHwPhoneBaseReference(AbstractPhoneBase abstractPhoneBase);
    ...
    boolean isShortCodeHw(String str, GsmCdmaPhone gsmCdmaPhone);
    ...
    int removeUssdCust(GsmCdmaPhone gsmCdmaPhone);

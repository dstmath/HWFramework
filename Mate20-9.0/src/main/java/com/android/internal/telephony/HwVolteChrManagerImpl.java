...
public class HwVolteChrManagerImpl implements HwVolteChrManager {
    ...
    private CallEndReason getCallEndReason(int causeCode, int remoteCauseCode) {
        int SIP_CODE_MIN = HwFullNetworkConstants.EVENT_CHECK_STATE_BASE + HwImsCallFailCause.IMS_ERROR_BASE;
        int SIP_CODE_MAX = 606 + HwImsCallFailCause.IMS_ERROR_BASE;

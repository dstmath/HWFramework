        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 13:
                        data.enforceInterface(DESCRIPTOR);
                        int _result12 = setIconTint(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result12);
                        return true;
                    case 14:
                        data.enforceInterface(DESCRIPTOR);
                        int _result13 = setDisplayName(data.readString(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result13);
                        return true;
                    case 15:
                        data.enforceInterface(DESCRIPTOR);
                        int _result14 = setDisplayNameUsingSrc(data.readString(), data.readInt(), data.readLong());
                        reply.writeNoException();
                        reply.writeInt(_result14);
                        return true;
                    case 16:
                        data.enforceInterface(DESCRIPTOR);
                        int _result15 = setDisplayNumber(data.readString(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result15);
                        return true;
                    case 17:
                        data.enforceInterface(DESCRIPTOR);
                        int _result16 = setDataRoaming(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result16);
                        return true;
                    case 18:
                        data.enforceInterface(DESCRIPTOR);
                        int _result17 = getSlotIndex(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result17);
                        return true;
                    case 19:
                        data.enforceInterface(DESCRIPTOR);
                        int[] _result18 = getSubId(data.readInt());
                        reply.writeNoException();
                    ...
                    case 22:
                        data.enforceInterface(DESCRIPTOR);
                        int _result21 = getPhoneId(data.readInt());
                        reply.writeNoException();
                    ...
                    case 32:
                        data.enforceInterface(DESCRIPTOR);
                        String _result26 = getSubscriptionProperty(data.readInt(), data.readString(), data.readString());
                        reply.writeNoException();
                        reply.writeString(_result26);
                        return true;
                    case 33:
                        data.enforceInterface(DESCRIPTOR);
                        int _result27 = getSimStateForSlotIndex(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result27);
                        return true;
                    case 34:
                        data.enforceInterface(DESCRIPTOR);
                        boolean _result28 = isActiveSubId(data.readInt());
                        reply.writeNoException();

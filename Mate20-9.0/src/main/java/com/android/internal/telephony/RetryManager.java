...
public class RetryManager {
    ...
    private String getGsmDefaultDataRetryConfig() {
        ...
        log("getGsmDefaultDataRetryConfig, subId:" + subId + ", card:" + valueFromCard + ", prop:" + valueFromProp);
    ...
    private String getGsm2ndDataRetryConfig() {
        ...
        log("getGsm2ndDataRetryConfig, subId:" + subId + ", card:" + valueFromCard + ", prop:" + valueFromProp);
        return valueFromCard != null ? valueFromCard : valueFromProp;
    }
}

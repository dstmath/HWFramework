            ...
            public void onReceive(Context context, Intent intent) {
                ...
                synchronized (SubscriptionMonitor.this.mLock) {
                    if (SubscriptionMonitor.this.mDefaultDataSubId != newDefaultDataSubId) {
                        ...
                        int access$500 = SubscriptionMonitor.this.mDefaultDataSubId;
                        int oldDefaultDataPhoneId = SubscriptionMonitor.this.mDefaultDataPhoneId;
                        int unused = SubscriptionMonitor.this.mDefaultDataSubId = newDefaultDataSubId;
                        ...
                        if (newDefaultDataPhoneId != oldDefaultDataPhoneId) {
                            ...
                            sb.append(", ");
                            sb.append(SubscriptionMonitor.this.invalidPhoneId(oldDefaultDataPhoneId) ? 0 : SubscriptionMonitor.this.mDefaultDataSubChangedRegistrants[oldDefaultDataPhoneId].size());
                            sb.append(",");
                            ...
                            int unused2 = SubscriptionMonitor.this.mDefaultDataPhoneId = newDefaultDataPhoneId;

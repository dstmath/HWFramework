...
public interface AppInterface {
    ...
    public static final String CAT_EF_LOCK_UPDATED_INTERNAL_ACTION = "com.huawei.android.intent.action.EF_LOCK_UPDATED_INTERNAL";
    ...
    public static final String UIM_LOCK_PACKAGE_NAME = "jp.co.fsi.felicalock";
    public static final String UIM_LOCK_SERVICE_NAME = "jp.co.fsi.felicalock.FelicaLockReceiver";

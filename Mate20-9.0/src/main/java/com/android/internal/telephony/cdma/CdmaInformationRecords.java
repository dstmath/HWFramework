...
public final class CdmaInformationRecords {
    ...
    public static class CdmaRedirectingNumberInfoRec {
        ...
        public CdmaRedirectingNumberInfoRec(String number, int numberType, int numberPlan, int pi, int si, int reason) {
            CdmaNumberInfoRec cdmaNumberInfoRec = new CdmaNumberInfoRec(5, number, numberType, numberPlan, pi, si);
            this.numberInfoRec = cdmaNumberInfoRec;
    ...
    public CdmaInformationRecords(Parcel p) {
        ...
        switch (id) {
            ...
            case 2:
            case 3:
                CdmaNumberInfoRec cdmaNumberInfoRec = new CdmaNumberInfoRec(id, p.readString(), p.readInt(), p.readInt(), p.readInt(), p.readInt());
            ...
            case 4:
                ...
                return;
            case 5:
                CdmaRedirectingNumberInfoRec cdmaRedirectingNumberInfoRec = new CdmaRedirectingNumberInfoRec(p.readString(), p.readInt(), p.readInt(), p.readInt(), p.readInt(), p.readInt());

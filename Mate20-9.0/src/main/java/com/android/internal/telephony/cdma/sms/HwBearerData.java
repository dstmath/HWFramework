...
public class HwBearerData {
    ...
    public static void encodeMsgCenterTimeStampCheck(BearerData bData, BitwiseOutputStream outStream) throws BitwiseOutputStream.AccessException {
    ...
    private static void encodeMsgCenterTimeStamp(BearerData bData, BitwiseOutputStream outStream) throws BitwiseOutputStream.AccessException {
        ...
        outStream.write(4, (byte) (bData.msgCenterTimeStamp.year % 10));
        bData.msgCenterTimeStamp.month++;
    ...
    public static GsmAlphabet.TextEncodingDetails calcTextEncodingDetailsEx(CharSequence msg, boolean force7BitEncoding) {

...
public class HwCustApnReminderImpl extends HwCustApnReminder {
    ...
    public static boolean mAllowApnMention = HWDBG;
    /* access modifiers changed from: private */
    public Context mContext = null;
    /* access modifiers changed from: private */
    public ApnRemindHandler mHandler = null;
    /* access modifiers changed from: private */
    ...
    private class ApnRemindHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                ...
                HandlerThread unused2 = HwCustApnReminderImpl.this.mHandlerThread = null;
                ApnRemindHandler unused3 = HwCustApnReminderImpl.this.mHandler = null;
            }
        }
    }

    private class goSetApnListener implements DialogInterface.OnClickListener {
    ...
    /* access modifiers changed from: private */
    public ApnRemindHandler getHandler() {
    ...
    /* access modifiers changed from: private */
    public HandlerThread getMyHandlerThread() {
    ...
    public void deletePreferApn(Context context, String imsi, int slotId) {
        ...
        try {
            ...
            log("Exception: read delete_preferapn_switch error " + e.toString());
        }
    }
}

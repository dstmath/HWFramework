...
public abstract class HwFullNetworkDefaultStateHisiBase extends HwFullNetworkDefaultStateBase {
    ...
    public void onRadioAvailable(Integer index) {
        ...
        if (HwFullNetworkConfig.IS_HISI_DSDX && !HwVSimUtils.isVSimEnabled() && !HwVSimUtils.isVSimCauseCardReload() && !HwVSimUtils.isSubActivationUpdate()) {
            ...
            if (dataSub != curr4GSlot && this.mChipCommon.mSet4GSlotCompleteMsg == null) {
        ...
        if (!HwFullNetworkConfig.IS_FAST_SWITCH_SIMSLOT && this.mChipCommon.mSet4GSlotCompleteMsg != null) {
            AsyncResult.forMessage(this.mChipCommon.mSet4GSlotCompleteMsg, true, null);
        ...
        if (this.mChipHisi.mSetSdcsCompleteMsg != null) {
            AsyncResult.forMessage(this.mChipHisi.mSetSdcsCompleteMsg, true, null);
    ...
    public void processPreBootCompleted() {
        ...
        this.mStateHandler.sendMessage(this.mStateHandler.obtainMessage(HwFullNetworkConstants.EVENT_CHECK_MAIN_SLOT, 0));
    }

...
public class UsimPhoneBookManagerUtils extends EasyInvokeUtils {
    ...
    FieldObject<ArrayList<UsimPhoneBookManager.PbrRecord>> mPbrRecords;
    FieldObject<ArrayList<AdnRecord>> mPhoneBookRecords;
    MethodObject<Void> readPbrFileAndWait;

    @GetField(fieldObject = "mPbrRecords")
    public ArrayList<UsimPhoneBookManager.PbrRecord> getPbrRecords(UsimPhoneBookManager usimPhoneBookManager) {
    ...
    public void setPbrRecords(UsimPhoneBookManager usimPhoneBookManager, ArrayList<UsimPhoneBookManager.PbrRecord> value) {

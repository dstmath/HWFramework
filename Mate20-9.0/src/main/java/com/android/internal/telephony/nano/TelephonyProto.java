        ...
        public static final class Event extends ExtendableMessageNano<Event> {
            ...
            public void writeTo(CodedOutputByteBufferNano output) throws IOException {
                ...
                if (this.calls != null && this.calls.length > 0) {
                    while (true) {
                        int i2 = i;
                        if (i2 >= this.calls.length) {
                            break;
                        }
                        RilCall element2 = this.calls[i2];
                        if (element2 != null) {
                ...
                while (true) {
                    ...
                    switch (tag) {
                        ...
                        case 98:
                            ...
                            int i2 = this.calls == null ? 0 : this.calls.length;
    ...
    public static final class TelephonyHistogram extends ExtendableMessageNano<TelephonyHistogram> {
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (this.bucketCounters != null && this.bucketCounters.length > 0) {
                while (true) {
                    int i2 = i;
                    if (i2 >= this.bucketCounters.length) {
                        break;
                    }
                    output.writeInt32(9, this.bucketCounters[i2]);
                    i = i2 + 1;
                }
            }
            super.writeTo(output);
        ...
        public int computeSerializedSize() {
            ...
            return size + dataSize2 + (1 * this.bucketCounters.length);
        }
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 72:
                        ...
                        int i3 = this.bucketCounters == null ? 0 : this.bucketCounters.length;
                    ...
                    case 74:
                        ...
                        int i4 = this.bucketCounters == null ? 0 : this.bucketCounters.length;
    ...
    public static final class TelephonyLog extends ExtendableMessageNano<TelephonyLog> {
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (this.histograms != null && this.histograms.length > 0) {
                while (true) {
                    ...
                    TelephonyHistogram element4 = this.histograms[i2];
                    if (element4 != null) {
        ...
        public int computeSerializedSize() {
            ...
            if (this.histograms != null && this.histograms.length > 0) {
                while (true) {
                    int i3 = i2;
                    if (i3 >= this.histograms.length) {
                        break;
                    }
                    TelephonyHistogram element4 = this.histograms[i3];
                    if (element4 != null) {
                        i += CodedOutputByteBufferNano.computeMessageSize(4, element4);
                    }
                    i2 = i3 + 1;
                }
            }
            if (this.eventsDropped) {
                i += CodedOutputByteBufferNano.computeBoolSize(5, this.eventsDropped);
            }
            if (this.startTime != null) {
                i += CodedOutputByteBufferNano.computeMessageSize(6, this.startTime);
            }
            if (this.endTime != null) {
                i += CodedOutputByteBufferNano.computeMessageSize(7, this.endTime);
            }
            if (this.modemPowerStats != null) {
                return i + CodedOutputByteBufferNano.computeMessageSize(8, this.modemPowerStats);
            }
            return i;
        }
        ...
        public TelephonyLog mergeFrom(CodedInputByteBufferNano input) throws IOException {
            while (true) {
                ...
                if (tag == 10) {
                    ...
                    int i2 = this.callSessions == null ? 0 : this.callSessions.length;
                    ...
                    int i3 = this.smsSessions == null ? 0 : this.smsSessions.length;
                    ...
                    int i4 = this.histograms == null ? 0 : this.histograms.length;

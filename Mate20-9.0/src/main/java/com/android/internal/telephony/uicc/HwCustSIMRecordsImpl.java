...
public class HwCustSIMRecordsImpl extends HwCustSIMRecords {
    ...
    public static final String CUST_ROAMING_VOICEMAIL = SystemProperties.get("ro.config.cust_roamingvoicemail", "");
                ...
                if (tm != null) {
                    ...
                    if (TextUtils.isEmpty(rplmn)) {
                        ...
                        if (items.length != HwCustSIMRecordsImpl.VOICEMAIL_CUST_LENGTH || !rplmn.startsWith(items[0])) {
                            String unused = HwCustSIMRecordsImpl.this.voiceMailNumforSBM = items[2];
                        } else {
                            String unused2 = HwCustSIMRecordsImpl.this.voiceMailNumforSBM = items[1];
                        }
    ...
    /* access modifiers changed from: private */
    public String voiceMailNumforSBM;

...
public class NotificationChannelController {
    ...
    public static void createAll(Context context) {
        ...
        NotificationChannel mobileDataStatusChannel = new NotificationChannel(CHANNEL_ID_MOBILE_DATA_STATUS, context.getText(17040582), 2);
        mobileDataStatusChannel.setBlockableSystem(true);
        NotificationChannel simChannel = new NotificationChannel(CHANNEL_ID_SIM, context.getText(17040590), 2);

...
public class EpicenterTranslateClipReveal extends Visibility {
    ...
    public Animator onAppear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        float f6 = startY;
        return createRectAnimator(view2, startStateX, startStateY, f3, endStateX, endStateY, endZ, transitionValues, timeInterpolator4, timeInterpolator2, this.mInterpolatorZ);
    }

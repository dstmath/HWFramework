...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public Animator setupAnimatorToVisibility(int visibility, long duration) {
        if (visibility == 8) {
            ObjectAnimator anim = ObjectAnimator.ofFloat(this.mToolbar, View.ALPHA, new float[]{1.0f, 0.0f});
            ...
            ObjectAnimator anim2 = ObjectAnimator.ofFloat(this.mToolbar, View.ALPHA, new float[]{0.0f, 1.0f});

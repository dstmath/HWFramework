...
public abstract class LocationProviderBase {
    ...
    public final ProviderProperties mProperties;
    ...
    /* JADX WARNING: type inference failed for: r1v2, types: [com.android.location.provider.LocationProviderBase$Service, android.os.IBinder] */

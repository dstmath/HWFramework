            ...
            if (this.set.size() > 1) {
                ...
                while (true) {
                    ...
                    if (swapped) {
                        ...
                        swapped = false;
                        for (int index2 = 0; index2 != lastSwap; index2++) {
                            byte[] b = getDEREncoded((ASN1Encodable) this.set.elementAt(index2 + 1));
                            if (lessThanOrEqual(a, b)) {
                                a = b;
                            } else {
                                Object o = this.set.elementAt(index2);
                                this.set.setElementAt(this.set.elementAt(index2 + 1), index2);
                                this.set.setElementAt(o, index2 + 1);
                                swapped = true;
                                swapIndex = index2;
                            }
                        }

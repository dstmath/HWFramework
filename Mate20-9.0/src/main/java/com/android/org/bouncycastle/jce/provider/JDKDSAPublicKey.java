...
public class JDKDSAPublicKey implements DSAPublicKey {
    ...
    public byte[] getEncoded() {
        try {
            ...
            return new SubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa, new DSAParameter(this.dsaSpec.getP(), this.dsaSpec.getQ(), this.dsaSpec.getG())), (ASN1Encodable) new ASN1Integer(this.y)).getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            return null;
        }
    }

...
public class ECNamedCurveSpec extends ECParameterSpec {
    ...
    public ECNamedCurveSpec(String name2, ECCurve curve, com.android.org.bouncycastle.math.ec.ECPoint g, BigInteger n) {
    ...
    public ECNamedCurveSpec(String name2, ECCurve curve, com.android.org.bouncycastle.math.ec.ECPoint g, BigInteger n, BigInteger h) {
    ...
    public ECNamedCurveSpec(String name2, ECCurve curve, com.android.org.bouncycastle.math.ec.ECPoint g, BigInteger n, BigInteger h, byte[] seed) {

...
public class SecP192K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint b) {
        ...
        SecP192K1Field.subtract(U12, U22, S13);
        int[] R = t2;
        SecP192K1Field.subtract(S12, S2, R);
        if (!Nat192.isZero(S13)) {
            SecP192K1FieldElement secP192K1FieldElement = X1;
            int[] HSquared = t3;
            SecP192K1Field.square(S13, HSquared);
            SecP192K1FieldElement secP192K1FieldElement2 = Y1;
            int[] G = Nat192.create();
            SecP192K1Field.multiply(HSquared, S13, G);
            SecP192K1FieldElement secP192K1FieldElement3 = X2;
            int[] V = t3;
            SecP192K1Field.multiply(HSquared, U12, V);
            ...
            SecP192K1FieldElement Z3 = new SecP192K1FieldElement(S13);
            if (!Z1IsOne) {
                int[] iArr2 = R;
                Y3 = Y32;
            ...
            int[] iArr3 = S13;
            int[] iArr4 = S14;
            SecP192K1FieldElement X33 = X32;
            SecP192K1FieldElement secP192K1FieldElement4 = Z3;
            int[] iArr5 = U13;
            int[] iArr6 = S22;
            SecP192K1FieldElement Y33 = Y3;
            SecP192K1FieldElement secP192K1FieldElement5 = X33;
            int[] iArr7 = U22;
            SecP192K1FieldElement secP192K1FieldElement6 = Y33;
            int[] iArr8 = t4;
            SecP192K1Point secP192K1Point = new SecP192K1Point(curve, secP192K1FieldElement5, secP192K1FieldElement6, zs, this.withCompression);
    ...
    public ECPoint twice() {
        ...
        SecP192K1Field.subtract(X3.x, S, X3.x);
        SecP192K1FieldElement Y32 = new SecP192K1FieldElement(S);
        ...
        SecP192K1FieldElement secP192K1FieldElement2 = X3;
        ECFieldElement[] eCFieldElementArr = {Z3};
        int i = c;
        SecP192K1Point secP192K1Point = new SecP192K1Point(curve, X3, Y3, eCFieldElementArr, this.withCompression);
        return secP192K1Point;
    }

...
public final class OpenSSLProvider extends Provider {
    ...
    private void putMacImplClass(String algorithm, String className) {
        String str = "Mac." + algorithm;
        putImplClassWithKeyConstraints(str, PREFIX + className, PREFIX + "OpenSSLKeyHolder", "RAW");
    }
    ...
    private void putRSACipherImplClass(String transformation, String className) {
        String str = "Cipher." + transformation;
        putImplClassWithKeyConstraints(str, PREFIX + className, PREFIX + "OpenSSLRSAPrivateKey|" + STANDARD_RSA_PRIVATE_KEY_INTERFACE_CLASS_NAME + "|" + PREFIX + "OpenSSLRSAPublicKey|" + STANDARD_RSA_PUBLIC_KEY_INTERFACE_CLASS_NAME, null);
    }

    private void putSignatureImplClass(String algorithm, String className) {
        String str = "Signature." + algorithm;
        putImplClassWithKeyConstraints(str, PREFIX + className, PREFIX + "OpenSSLKeyHolder|" + STANDARD_RSA_PRIVATE_KEY_INTERFACE_CLASS_NAME + "|" + STANDARD_EC_PRIVATE_KEY_INTERFACE_CLASS_NAME + "|" + STANDARD_RSA_PUBLIC_KEY_INTERFACE_CLASS_NAME, "PKCS#8|X.509");
    }

...
public class TrustedCertificateStore {
    ...
    private static class PreloadHolder {
        ...
        public static File defaultCaCertsAddedDir;
        /* access modifiers changed from: private */
        public static File defaultCaCertsDeletedDir;
        /* access modifiers changed from: private */
        public static File defaultCaCertsSystemDir;
    ...
    public static void setDefaultUserDirectory(File root) {
        File unused = PreloadHolder.defaultCaCertsAddedDir = new File(root, "cacerts-added");
        File unused2 = PreloadHolder.defaultCaCertsDeletedDir = new File(root, "cacerts-removed");
    }
    ...
    public TrustedCertificateStore(File systemDir2, File addedDir2, File deletedDir2) {
        this.systemDir = systemDir2;
        this.addedDir = addedDir2;
        this.deletedDir = deletedDir2;
    }

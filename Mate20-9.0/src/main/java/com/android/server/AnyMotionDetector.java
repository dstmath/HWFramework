...
public class AnyMotionDetector {
    ...
    private static class RunningSignalStats {
        ...
        public void reset() {
            ...
            Vector3 vector3 = new Vector3(0, 0.0f, 0.0f, 0.0f);
            this.runningSum = vector3;
            this.energy = 0.0f;
            this.sampleCount = 0;
        }
        ...
        public String toString() {
            ...
            String msg2 = msg + ", currentVector = " + currentVectorString;
            String msg3 = msg2 + ", sampleCount = " + this.sampleCount;
            return msg3 + ", energy = " + this.energy;
        }
    }
    ...
    public static final class Vector3 {
        ...
        public Vector3 normalized() {
            float mag = norm();
            Vector3 vector3 = new Vector3(this.timeMillisSinceBoot, this.x / mag, this.y / mag, this.z / mag);
            return vector3;
        }
        ...
        public Vector3 cross(Vector3 v) {
            Vector3 vector3 = new Vector3(v.timeMillisSinceBoot, (this.y * v.z) - (this.z * v.y), (this.z * v.x) - (this.x * v.z), (this.x * v.y) - (this.y * v.x));
            return vector3;
        }
        ...
        public String toString() {
            ...
            String msg2 = msg + " | x=" + this.x;
            String msg3 = msg2 + ", y=" + this.y;
            return msg3 + ", z=" + this.z;
        }
        ...
        public Vector3 times(float val) {
            Vector3 vector3 = new Vector3(this.timeMillisSinceBoot, this.x * val, this.y * val, this.z * val);
            return vector3;
        }

        public Vector3 plus(Vector3 v) {
            Vector3 vector3 = new Vector3(v.timeMillisSinceBoot, v.x + this.x, v.y + this.y, v.z + this.z);
            return vector3;
        }

        public Vector3 minus(Vector3 v) {
            Vector3 vector3 = new Vector3(v.timeMillisSinceBoot, this.x - v.x, this.y - v.y, this.z - v.z);
            return vector3;
        }
    }

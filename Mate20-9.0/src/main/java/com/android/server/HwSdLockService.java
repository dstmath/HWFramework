...
public final class HwSdLockService {
            ...
            this.mHandler.post(new Runnable() {
                public void run() {
                    if (HwSdLockService.this.mProgressDialog == null) {
                        ...
                        HwSdLockService.this.mProgressDialog.setMessage(HwSdLockService.this.mContext.getText(17040959));
                    }
    ...
    public String getSDCardId() {
        ...
        if (this.mErasingSDLock) {
            ...
            String cid = null;
            try {
                String cid2 = this.mVold.sdlockGetCid();
                if (cid2 == null) {
    ...
    public void deleteKeyValue(String key) {
        ...
        Cursor query = db.query(TABLE, COLUMNS_FOR_QUERY_VALUE, "cid=?", new String[]{key}, null, null, null);
        Cursor cursor = query;
        if (query != null) {
            try {
                db.delete(TABLE, "cid=?", new String[]{key});
    ...
    public static String bcd2Str(byte[] bytes) {
        ...
        for (int i = 0; i < bytes.length; i++) {
            ...
            temp[(i * 2) + 1] = (char) (val2 > 9 ? (val2 + 'A') - 10 : val2 + '0');
        }

...
public class NetworkScoreService extends INetworkScoreService.Stub {
    ...
    static class FilteringCacheUpdatingConsumer implements BiConsumer<INetworkScoreCache, Object> {
        ...
        static FilteringCacheUpdatingConsumer create(Context context, List<ScoredNetwork> scoredNetworkList, int networkType) {
            FilteringCacheUpdatingConsumer filteringCacheUpdatingConsumer = new FilteringCacheUpdatingConsumer(context, scoredNetworkList, networkType, null, null);
            return filteringCacheUpdatingConsumer;
        }
    ...
    public static final class Lifecycle extends SystemService {
        ...
        /* JADX WARNING: type inference failed for: r1v1, types: [com.android.server.NetworkScoreService, android.os.IBinder] */
        public void onStart() {
    ...
    public void dump(final FileDescriptor fd, final PrintWriter writer, final String[] args) {
        if (DumpUtils.checkDumpPermission(this.mContext, TAG, writer)) {
            ...
            try {
                ...
                writer.flush();
                Binder.restoreCallingIdentity(token);
            } catch (Throwable currentScorer2) {
                Binder.restoreCallingIdentity(token);
                throw currentScorer2;
            }
        }
    }

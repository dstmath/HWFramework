...
final class UriPermission {
    ...
    UriPermission(String sourcePkg2, String targetPkg2, int targetUid2, ActivityManagerService.GrantUri uri2) {
    ...
    public boolean takePersistableModes(int modeFlags2) {
        ...
        this.persistedModeFlags |= this.persistableModeFlags & modeFlags3;

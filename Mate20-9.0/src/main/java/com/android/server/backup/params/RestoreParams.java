...
public class RestoreParams {
    ...
    public static RestoreParams createForSinglePackage(TransportClient transportClient2, IRestoreObserver observer2, IBackupManagerMonitor monitor2, long token2, PackageInfo packageInfo2, OnTaskFinishedListener listener2) {
        RestoreParams restoreParams = new RestoreParams(transportClient2, observer2, monitor2, token2, packageInfo2, 0, false, null, listener2);
    ...
    public static RestoreParams createForRestoreAtInstall(TransportClient transportClient2, IRestoreObserver observer2, IBackupManagerMonitor monitor2, long token2, String packageName, int pmToken2, OnTaskFinishedListener listener2) {
        RestoreParams restoreParams = new RestoreParams(transportClient2, observer2, monitor2, token2, null, pmToken2, false, new String[]{packageName}, listener2);
        return restoreParams;
    }
    ...
    public static RestoreParams createForRestoreAll(TransportClient transportClient2, IRestoreObserver observer2, IBackupManagerMonitor monitor2, long token2, OnTaskFinishedListener listener2) {
        RestoreParams restoreParams = new RestoreParams(transportClient2, observer2, monitor2, token2, null, 0, true, null, listener2);
        return restoreParams;
    }

    public static RestoreParams createForRestoreSome(TransportClient transportClient2, IRestoreObserver observer2, IBackupManagerMonitor monitor2, long token2, String[] filterSet2, boolean isSystemRestore2, OnTaskFinishedListener listener2) {
        RestoreParams restoreParams = new RestoreParams(transportClient2, observer2, monitor2, token2, null, 0, isSystemRestore2, filterSet2, listener2);
        return restoreParams;
    }

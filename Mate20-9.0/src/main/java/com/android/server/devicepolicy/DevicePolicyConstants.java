...
public class DevicePolicyConstants {
    ...
    private DevicePolicyConstants(String settings) {
        ...
        long dasDiedServiceReconnectBackoffSec2 = Math.max(5, dasDiedServiceReconnectBackoffSec);
        double dasDiedServiceReconnectBackoffIncrease = Math.max(1.0d, (double) parser.getFloat(DAS_DIED_SERVICE_RECONNECT_BACKOFF_INCREASE_KEY, 2.0f));

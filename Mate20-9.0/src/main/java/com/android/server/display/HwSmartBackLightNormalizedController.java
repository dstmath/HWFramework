...
public class HwSmartBackLightNormalizedController implements HwLightSensorController.LightSensorCallbacks {
    ...
    public boolean mAppSBLScene;
    private int mCurrentLux;
    /* access modifiers changed from: private */
    public final HwSmartBackLightXmlLoader.Data mData;
    ...
    /* access modifiers changed from: private */
    public boolean mLightSensorEnable;
    ...
    /* access modifiers changed from: private */
    public final ProcessTriggerHandler mProcessTriggerHandler;
    ...
    /* access modifiers changed from: private */
    public boolean mVideoSceneEntered = false;
    ...
    private final class SceneRecognition implements IPGPlugCallbacks {
        ...
        public boolean onEvent(int actionID, String value) {
            ...
            boolean unused = HwSmartBackLightNormalizedController.this.mAppSBLScene = isInAppScene();
            HwSmartBackLightNormalizedController hwSmartBackLightNormalizedController = HwSmartBackLightNormalizedController.this;
            if (HwSmartBackLightNormalizedController.this.mData.sceneVideoEnable && this.mInVideoScene) {
                z = true;
            }
            boolean unused2 = hwSmartBackLightNormalizedController.mVideoSceneEntered = z;

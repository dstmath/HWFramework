...
public class HwForceRotationManagerService extends IHwForceRotationManager.Stub {
    ...
    public boolean isForceRotationSwitchOpen() {
        if (this.mContext != null && this.mContext.getContentResolver() != null && Settings.System.getInt(this.mContext.getContentResolver(), "force_rotation_mode", 0) == 1 && (!HwPCUtils.enabledInPad() || !HwPCUtils.isPcCastModeInServer())) {
            return true;
        }
        return false;
    }

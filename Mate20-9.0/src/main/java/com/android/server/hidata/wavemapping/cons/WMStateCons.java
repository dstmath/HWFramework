...
public class WMStateCons {
    ...
    public static final int MSG_AR_STATION = 111;
    ...
    public static final int MSG_HIGH_TEMPERATRUE = 220;
    ...
    public static final int MSG_POWER_CONNECTED = 112;
    public static final int MSG_POWER_DISCONNECTED = 113;

...
public class HwCmccGpsFeature implements IHwCmccGpsFeature {
    ...
    private void setAgpsServer() {
        ...
        int iSuplServerPort = SettingsEx.Systemex.getInt(this.mContext.getContentResolver(), KEY_AGPS_SERVICE_PORT, AGPS_SERVICE_PORT_DEFAULT);
    ...
    private int setPostionMode() {
        ...
        if (1 != SettingsEx.Systemex.getInt(this.mContext.getContentResolver(), KEY_AGPS_ROAMING_ENABLED, 0) && this.mIsRoaming) {
            positionMode = 0;
        }

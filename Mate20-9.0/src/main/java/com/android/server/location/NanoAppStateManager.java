        ...
        synchronized (this) {
            ...
            while (true) {
                if (i2 > Integer.MAX_VALUE) {
                    break;
                } else if (!this.mNanoAppHash.containsKey(Integer.valueOf(nanoAppHandle))) {
                    HashMap<Integer, NanoAppInstanceInfo> hashMap = this.mNanoAppHash;
                    Integer valueOf = Integer.valueOf(nanoAppHandle);
                    NanoAppInstanceInfo nanoAppInstanceInfo = new NanoAppInstanceInfo(nanoAppHandle, nanoAppId, nanoAppVersion, contextHubId);
                    hashMap.put(valueOf, nanoAppInstanceInfo);

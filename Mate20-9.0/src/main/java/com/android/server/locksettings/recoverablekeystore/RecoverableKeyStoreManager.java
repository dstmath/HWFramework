        ...
        if (this.mTestCertHelper.isValidRootCertificateAlias(rootCertificateAlias2)) {
            ...
            if (this.mDatabase.setActiveRootOfTrust(userId, uid, rootCertificateAlias2) >= 0) {
                try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (updatedCertPathRows > 0) {
                                    CertXml certXml2 = certXml;
                                    String str = rootCertificateAlias2;
                                    CertPath certPath2 = certPath;
                                    String str2 = rootCertificateAlias2;
                                    i = 25;
                                    try {
                                        if (this.mDatabase.setRecoveryServiceCertSerial(userId, uid, str, newSerial) >= 0) {
                                        ...
                                        throw new ServiceSpecificException(i, e.getMessage());
                                    }
                                } else {
                                    CertXml certXml3 = certXml;
                                    CertPath certPath3 = certPath;
                                    String str3 = rootCertificateAlias2;
                                    if (updatedCertPathRows < 0) {
                                ...
                                e = e2;
                                long j = newSerial;
                                CertXml certXml4 = certXml;
                                CertPath certPath4 = certPath;
                                String str4 = rootCertificateAlias2;
                                i = 25;
                                Log.e(TAG, "Failed to encode CertPath", e);
                                throw new ServiceSpecificException(i, e.getMessage());
                            }
                            ...
                            long j2 = newSerial;
                            CertXml certXml5 = certXml;
                            String str5 = rootCertificateAlias2;
                    ...
                    String str6 = rootCertificateAlias2;
                    CertParsingException certParsingException = e4;

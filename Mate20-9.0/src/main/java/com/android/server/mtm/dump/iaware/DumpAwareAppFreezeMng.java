...
public final class DumpAwareAppFreezeMng {
    ...
    public static final void dumpFreezeApp(Context context, PrintWriter pw, String[] args) {
    ...
    public static final void dumpCheckBadApp(Context context, PrintWriter pw, String[] args) {
        if (args != null && args.length >= 3) {
            try {

...
public final class AwareJobSchedulerConstants {
    ...
    static {
        CACHE_CONDITION_MAP.put(NETWORKSTATUS_ACTION_FILTER_NAME, true);
        CACHE_CONDITION_MAP.put("WifiStatus", true);
        CACHE_CONDITION_MAP.put(SERVICESSTATUS_ACTION_FILTER_NAME, true);
    }

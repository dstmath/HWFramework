    ...
    public void dump(PrintWriter pw, String[] args) {
        if (pw != null && args != null) {
            if (args.length < 3 || args[2] == null) {
                dumpAllJobs(pw);
            } else if (XmlConst.PreciseIgnore.RECEIVER_ACTION_ELEMENT_KEY.equals(args[2])) {
            ...
            } else if (XmlConst.PreciseIgnore.RECEIVER_ACTION_RECEIVER_ELEMENT_KEY.equals(args[2])) {
                if (args.length < 4 || TextUtils.isEmpty(args[3])) {

...
class PrivacyUtils {
    ...
    private static LongitudinalReportingConfig createLongitudinalReportingConfig(String appDigest) {
        LongitudinalReportingConfig longitudinalReportingConfig = new LongitudinalReportingConfig(ENCODER_ID_PREFIX + appDigest, PROB_F, PROB_P, PROB_Q);
        return longitudinalReportingConfig;
    }

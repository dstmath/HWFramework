        ...
        try {
            ...
            if (this.mDropBoxManager == null || !this.mDropBoxManager.isTagEnabled(DROPBOX_TAG)) {
                ...
                if (aggregatedResult == null) {
                    ...
                    String str2 = TAG;
                    Slog.i(str2, "Milliseconds spent on tryAggregateRecords(): " + (endTime - startTime));
                    return;
                }
            ...
            String str3 = TAG;
            Slog.i(str3, "Milliseconds spent on tryAggregateRecords(): " + (endTime2 - startTime));
        } finally {
            long endTime3 = System.currentTimeMillis();
            String str4 = TAG;
            StringBuilder sb = new StringBuilder();
            str = "Milliseconds spent on tryAggregateRecords(): ";
            sb.append(str);
            sb.append(endTime3 - startTime);
    ...
    private byte[] getDigestFromUid(int uid) {
        return this.mCachedUidDigestMap.computeIfAbsent(Integer.valueOf(uid), new Function(uid) {
            ...
            public final Object apply(Object obj) {
                return WatchlistLoggingHandler.lambda$getDigestFromUid$0(WatchlistLoggingHandler.this, this.f$1, (Integer) obj);
            }
        });
    }

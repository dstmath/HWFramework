...
public class SnoozeHelper {
    ...
    public boolean isSnoozed(int userId, String pkg, String key) {
        return this.mSnoozedNotifications.containsKey(Integer.valueOf(userId)) && this.mSnoozedNotifications.get(Integer.valueOf(userId)).containsKey(pkg) && ((ArrayMap) this.mSnoozedNotifications.get(Integer.valueOf(userId)).get(pkg)).containsKey(key);
    }
    ...
    public Collection<NotificationRecord> getSnoozed(int userId, String pkg) {
        ...
        return ((ArrayMap) this.mSnoozedNotifications.get(Integer.valueOf(userId)).get(pkg)).values();
    }
    ...
    public List<NotificationRecord> getSnoozed() {
        ...
        if (userIds != null) {
            for (int valueOf : userIds) {
                ArrayMap<String, ArrayMap<String, NotificationRecord>> snoozedPkgs = this.mSnoozedNotifications.get(Integer.valueOf(valueOf));
                if (snoozedPkgs != null) {
    ...
    public boolean cancel(int userId, String pkg, String tag, int id) {
        if (this.mSnoozedNotifications.containsKey(Integer.valueOf(userId))) {
            ArrayMap<String, NotificationRecord> recordsForPkg = (ArrayMap) this.mSnoozedNotifications.get(Integer.valueOf(userId)).get(pkg);
    ...
    public boolean cancel(int userId, String pkg) {
        ...
        ArrayMap<String, NotificationRecord> records = (ArrayMap) this.mSnoozedNotifications.get(Integer.valueOf(userId)).get(pkg);
        int N = records.size();
        for (int i = 0; i < N; i++) {
    ...
    public void repostGroupSummary(String pkg, int userId, String groupKey) {
        if (this.mSnoozedNotifications.containsKey(Integer.valueOf(userId))) {
            ArrayMap<String, ArrayMap<String, NotificationRecord>> keysByPackage = this.mSnoozedNotifications.get(Integer.valueOf(userId));

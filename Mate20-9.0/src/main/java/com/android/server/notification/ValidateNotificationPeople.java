...
public class ValidateNotificationPeople implements NotificationSignalExtractor {
        ...
        if (this.mEnabled) {
            ...
            this.mObserver = new ContentObserver(this.mHandler) {
                public void onChange(boolean selfChange, Uri uri, int userId) {
                    ...
                    int unused = ValidateNotificationPeople.this.mEvictionCount = ValidateNotificationPeople.this.mEvictionCount + 1;
                }
            };
    ...
    private PeopleRankingReconsideration validatePeople(Context context, String key, Bundle extras, List<String> peopleOverride, float[] affinityOut) {
        ...
        PeopleRankingReconsideration peopleRankingReconsideration = new PeopleRankingReconsideration(context, str, pendingLookups);
        return peopleRankingReconsideration;
    }
    ...
    private static String[] getExtraPeopleForKey(Bundle extras, String key) {
        ...
        if (people instanceof ArrayList) {
            ...
            if (arrayList.get(0) instanceof String) {
                ...
                while (i < N2) {
                    array2[i] = ((Person) list.get(i)).resolveToLegacyUri();
                    i++;
                }
                return array2;
            }

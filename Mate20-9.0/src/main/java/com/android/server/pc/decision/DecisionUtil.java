...
public final class DecisionUtil {
    ...
    public static String ENTER_PROJECTION_EVENT = "com.huawei.desktop.intent.action.PcScreen";
    /* access modifiers changed from: private */
    public static String ENTER_PROJECTION_TYPE = "ENTER_PROJECTION_TYPE";
    private static final String ID_KEY = "id";
    private static final int OPER_SUCCESS = 0;
    /* access modifiers changed from: private */
    public static String OP_TYPE_CANCEL = "cancel";
    /* access modifiers changed from: private */
    public static String OP_TYPE_GOTO = "goto";
    ...
    /* access modifiers changed from: private */
    public static String REPORT_EVENT = "com.huawei.tips.intent.action.UE_DATA_USER_OPERATION";
    /* access modifiers changed from: private */
    ...
    private static ServiceConnection mDecisionConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            if (DecisionUtil.REPORT_TYPE.equals(DecisionUtil.mType)) {
                ...
                DecisionUtil.executeEvent(DecisionUtil.REPORT_EVENT, (Map<String, Object>) extras);
    ...
    public static void showPCRecommendDialog(Context context) {
        ...
        View contentView = LayoutInflater.from(context).inflate(34013359, null);
        mRecommendDialog = builder.setPositiveButton(33686172, new DialogInterface.OnClickListener() {
        ...
        }).setNegativeButton(33686170, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                DecisionUtil.executeReportEvent(DecisionUtil.mContext, DecisionUtil.OP_TYPE_CANCEL);
            }
        }).setView(contentView).create();
        ((ImageView) contentView.findViewById(34603355)).getDrawable().setAutoMirrored(true);
        String linkStr = context.getResources().getString(33686171);
        String tmpInfo = context.getResources().getString(33686169);
        int start = tmpInfo.length();
        StringBuilder agreeInfo = new StringBuilder(tmpInfo);
        agreeInfo.append(" ");
        agreeInfo.append(linkStr);
        setClickableSpanForTextView((TextView) contentView.findViewById(34603354), new NoUnderLineClickSpan(), agreeInfo.toString(), start, agreeInfo.length());

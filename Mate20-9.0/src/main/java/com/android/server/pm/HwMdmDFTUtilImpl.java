...
public class HwMdmDFTUtilImpl {
        ...
        if (hwMdmDFT != null) {
            switch (type) {
                case HwMdmDFTConst.EID_MDM_DFT_CERT_PARSE_SUCCESS:
                    IMonitor.EventStream eventCertParseSuccess = IMonitor.openEventStream(HwMdmDFTConst.EID_MDM_DFT_CERT_PARSE_SUCCESS);
                ...
                case HwMdmDFTConst.EID_MDM_DFT_SET_DEVICEOWNER_SUCCESS:
                    IMonitor.EventStream eventDoSuccess = IMonitor.openEventStream(HwMdmDFTConst.EID_MDM_DFT_SET_DEVICEOWNER_SUCCESS);
                ...
                case HwMdmDFTConst.EID_MDM_DFT_SET_WORKPROFILE_SUCCESS:
                    IMonitor.EventStream eventWpSuccess = IMonitor.openEventStream(HwMdmDFTConst.EID_MDM_DFT_SET_WORKPROFILE_SUCCESS);
    ...
    public static void getMdmInstallInfoDft(Context mContext, PackageParser.Package pkg) {
        if (pkg != null && mContext != null) {
            ...
            if (!(mContext.getPackageManager() == null || pkg.mSigningDetails == null)) {
                Signature[] signatures = pkg.mSigningDetails.signatures;
                if (signatures != null) {
                    String sign = getSha256FingerData(signatures[0].toByteArray());
                    if (sign != null) {

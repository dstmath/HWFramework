...
class ShortcutUser {
    ...
    public void mergeRestoredFile(ShortcutUser restored) {
        ...
        restored.forAllLaunchers(new Consumer(s, restoredLaunchers) {
            ...
            public final void accept(Object obj) {
                ShortcutUser.lambda$mergeRestoredFile$3(ShortcutUser.this, this.f$1, this.f$2, (ShortcutLauncher) obj);
            }
        });
        restored.forAllPackages(new Consumer(s, restoredPackages, restoredShortcuts) {
            ...
            public final void accept(Object obj) {
                ShortcutUser.lambda$mergeRestoredFile$4(ShortcutUser.this, this.f$1, this.f$2, this.f$3, (ShortcutPackage) obj);
            }
        });

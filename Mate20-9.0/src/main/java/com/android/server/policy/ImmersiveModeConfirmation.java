...
public class ImmersiveModeConfirmation {
    ...
    private final Runnable mConfirm = new Runnable() {
        public void run() {
            if (!ImmersiveModeConfirmation.this.mConfirmed) {
                boolean unused = ImmersiveModeConfirmation.this.mConfirmed = true;
    ...
    private class ClingWindowView extends FrameLayout {
        ...
        public void onAttachedToWindow() {
            ...
            ((Button) this.mClingLayout.findViewById(16909156)).setOnClickListener(new View.OnClickListener() {
            ...
            if (ActivityManager.isHighEndGfx()) {
                ...
                postOnAnimation(new Runnable() {
                    public void run() {
                        ...
                        ValueAnimator unused = ClingWindowView.this.mColorAnim = ValueAnimator.ofObject(new ArgbEvaluator(), new Object[]{0, Integer.MIN_VALUE});

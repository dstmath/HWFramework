...
public abstract class WindowOrientationListener {
    ...
    final class AccelSensorJudge extends OrientationJudge {
        ...
        public void onSensorChanged(SensorEvent event) {
                ...
                if (now >= then && now <= 1000000000 + then) {
                    if (x != 0.0f || y != 0.0f || z2 != 0.0f) {
                        ...
                        if (WindowOrientationListener.LOG) {
                            StringBuilder sb2 = new StringBuilder();
                            float f4 = x;
                            sb2.append("Result: currentRotation=");
                            sb2.append(WindowOrientationListener.this.mCurrentRotation);
                            sb2.append(", proposedRotation=");
                            sb2.append(proposedRotation);
                            sb2.append(", predictedRotation=");
                            sb2.append(this.mPredictedRotation);
                            sb2.append(", timeDeltaMS=");
                            sb2.append(timeDeltaMS);
                            sb2.append(", isAccelerating=");
                            sb2.append(isAccelerating);
                            sb2.append(", isFlat=");
                            sb2.append(isFlat2);
                            sb2.append(", isSwinging=");
                            sb2.append(isSwinging2);
                            sb2.append(", isOverhead=");
                            sb2.append(this.mOverhead);
                            sb2.append(", isTouched=");
                            sb2.append(this.mTouched);
                            sb2.append(", timeUntilSettledMS=");
                            boolean z4 = skipSample;
                            float f5 = y;
                            sb2.append(remainingMS(now, this.mPredictedRotationTimestampNanos + PROPOSAL_SETTLE_TIME_NANOS));
                            sb2.append(", timeUntilAccelerationDelayExpiredMS=");
                            sb2.append(remainingMS(now, this.mAccelerationTimestampNanos + 500000000));
                            sb2.append(", timeUntilFlatDelayExpiredMS=");
                            sb2.append(remainingMS(now, this.mFlatTimestampNanos + 500000000));
                            sb2.append(", timeUntilSwingDelayExpiredMS=");
                            sb2.append(remainingMS(now, this.mSwingTimestampNanos + 300000000));
                            sb2.append(", timeUntilTouchDelayExpiredMS=");
                            sb2.append(remainingMS(now, this.mTouchEndedTimestampNanos + 500000000));
                            Slog.v(WindowOrientationListener.TAG, sb2.toString());
                        }
                    }
                }
                if (WindowOrientationListener.LOG) {
            ...
            if (proposedRotation2 != oldProposedRotation2 && proposedRotation2 >= 0) {
                if (WindowOrientationListener.LOG) {
                    Slog.v(WindowOrientationListener.TAG, "Proposed rotation changed!  proposedRotation=" + proposedRotation2 + ", oldProposedRotation=" + oldProposedRotation2);
                }
    ...
    public int getProposedRotation() {
        synchronized (this.mLock) {
            ...
            if (McuSwitch) {
                int proposedRotation = this.mHWEMRProcessor.getProposedRotation();

...
public final class AwareSceneRecognize {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v2, resolved type: android.rms.iaware.AwareConfig$Item} */
    ...
    public void hanldeCameraOperation(Message msg) {
        ...
        if (bundle != null) {
            int uid = bundle.getInt("uid", -1) % LaserTSMService.EXCUTE_OTA_RESULT_SUCCESS;

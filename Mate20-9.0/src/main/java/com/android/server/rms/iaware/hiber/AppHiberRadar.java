...
class AppHiberRadar {
    private static int APPHIBER_FEATURE_ID = AwareConstant.FeatureType.getFeatureId(AwareConstant.FeatureType.FEATURE_APPHIBER);
    ...
    AppHiberRadar() {
        StatisticsData statisticsData = new StatisticsData(APPHIBER_FEATURE_ID, STATISTIC_TYPE_EXEC, STATISTIC_SUBTYPE, 0, 0, 0, 0, 0);
    ...
    public ArrayList<StatisticsData> getStatisticsData() {
        ...
        synchronized (this.mStatisticsData) {
            StatisticsData statisticsData = new StatisticsData(this.mStatisticsData.getFeatureId(), this.mStatisticsData.getType(), this.mStatisticsData.getSubType(), this.mStatisticsData.getOccurCount(), this.mStatisticsData.getTotalTime(), this.mStatisticsData.getEffect(), this.mStatisticsData.getStartTime(), this.mStatisticsData.getEndTime());
            retList.add(statisticsData);

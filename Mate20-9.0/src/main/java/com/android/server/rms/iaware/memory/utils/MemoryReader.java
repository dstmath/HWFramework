...
public class MemoryReader {
    ...
    private static String parseMemData(long[] data) {
        ...
        return "[" + "{\"pgAlloc\":\"" + data[1] + "\",\"slowpath0\":\"" + data[2] + "\",\"slowpath1\":\"" + data[3] + "\",\"slowpath2\":\"" + data[4] + "\",\"slowpath3\":\"" + data[5] + "\",\"slowpath4\":\"" + data[6] + "\",\"compactStall\":\"" + data[7] + "\",\"compactSuc\":\"" + data[8] + "\",\"warnAllocFailed\":\"" + data[9] + "\",\"fcache\":\"" + data[11] + "\",\"fcacheMiss\":\"" + data[13] + "\"}" + "]";
    }
}

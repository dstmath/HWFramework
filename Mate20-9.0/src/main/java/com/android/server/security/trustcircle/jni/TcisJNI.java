    ...
    public static final byte[] processCmd(Context context, byte[] param) {
        ...
        synchronized (TcisJNI.class) {
            try {
                ...
                String str = TAG;
                LogHelper.e(str, "error, processCmd failed, " + e.getMessage());
                response = new byte[0];
            }
        }
        return response;
    ...
    public static final int start() {
        ...
        synchronized (TcisJNI.class) {
            ...
            try {
                ...
                String str = TAG;
                LogHelper.e(str, "error, nativeStart failed, " + e.getMessage());
            }
        }
        return result;
    }
    ...
    public static final void stop() {
        synchronized (TcisJNI.class) {
            try {
                ...
                String str = TAG;
                LogHelper.e(str, "error, nativeStop failed, " + e.getMessage());
            }
        }
    }
}

...
public class TSMAgentService extends ITSMAgent.Stub implements IHwSecurityPlugin {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [com.android.server.security.tsmagent.service.TSMAgentService, android.os.IBinder] */

...
class TvInputHardwareManager implements TvInputHal.Callback {
                    ...
                    switch (status) {
                        case 1:
                            if (findHdmiDeviceInfo(deviceInfo.getId()) == null) {
                                ...
                                Slog.w(access$900, "The list already contains " + deviceInfo + "; ignoring.");
                                return;
                            }
                        case 2:
                        ...
                        case 3:
                            if (TvInputHardwareManager.this.mHdmiDeviceList.remove(findHdmiDeviceInfo(deviceInfo.getId()))) {
                                ...
                                Slog.w(access$9003, "The list doesn't contain " + deviceInfo + "; ignoring.");
                                return;
                            }
                    }
    ...
    public void addHardwareInput(int deviceId, TvInputInfo info) {
        synchronized (this.mLock) {
            if (this.mHardwareInputIdMap.get(deviceId) != null) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:27:0x0069 A[LOOP:0: B:27:0x0069->B:34:0x0083, LOOP_START, PHI: r3 
      PHI: (r3v1 'i' int) = (r3v0 'i' int), (r3v8 'i' int) binds: [B:26:0x0067, B:34:0x0083] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        if (DumpUtils.checkDumpPermission(this.mContext, TAG, pw)) {
            synchronized (this.mLock) {
                ...
                for (int i = 0; i < this.mConnections.size(); i++) {
                    ...
                    pw.println(deviceId + ": " + this.mConnections.valueAt(i));
                }
                pw.decreaseIndent();
                ...
                for (int i2 = 0; i2 < this.mHardwareInputIdMap.size(); i2++) {
                    ...
                    pw.println(deviceId2 + ": " + this.mHardwareInputIdMap.valueAt(i2));
                }
                pw.decreaseIndent();
                ...
                for (int i3 = 0; i3 < this.mHdmiInputIdMap.size(); i3++) {
                    ...
                    pw.println(id + ": " + this.mHdmiInputIdMap.valueAt(i3));
                }
                pw.decreaseIndent();

...
public final class UsbDeviceDescriptor extends UsbDescriptor {
    ...
    public String getDeviceReleaseString() {
        return String.format("%d.%d%d", new Object[]{Integer.valueOf((((this.mDeviceRelease & 61440) >> 12) * 10) + ((this.mDeviceRelease & 3840) >> 8)), Integer.valueOf((this.mDeviceRelease & 240) >> 4), Integer.valueOf(this.mDeviceRelease & 15)});
    }

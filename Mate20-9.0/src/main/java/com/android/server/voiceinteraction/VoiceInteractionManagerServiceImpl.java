...
class VoiceInteractionManagerServiceImpl implements VoiceInteractionSessionConnection.Callback {
    ...
    public boolean showSessionLocked(Bundle args, int flags, IVoiceInteractionSessionShowCallback showCallback, IBinder activityToken) {
        ...
        if (this.mActiveSession == null) {
            VoiceInteractionSessionConnection voiceInteractionSessionConnection = new VoiceInteractionSessionConnection(this.mServiceStub, this.mSessionComponentName, this.mUser, this.mContext, this, this.mInfo.getServiceInfo().applicationInfo.uid, this.mHandler);
            this.mActiveSession = voiceInteractionSessionConnection;
        }
                    ...
                    if (!this.mActiveSession.mShown) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                return this.mAm.startVoiceActivity(this.mComponent.getPackageName(), callingPid, callingUid, intent4, resolvedType, this.mActiveSession.mSession, this.mActiveSession.mInteractor, 0, null, null, this.mUser);

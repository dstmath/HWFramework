...
public class HwQoENetWorkMonitor {
                ...
                if (i != 105) {
                    switch (i) {
                        case 151573:
                            ...
                            boolean unused = HwQoENetWorkMonitor.this.isOTADataUpdate = true;
                    ...
                    boolean unused2 = HwQoENetWorkMonitor.this.isTCPDataUpdate = true;
                    HwQoENetWorkMonitor.this.reportNetworkInfo();
                }
    ...
    /* access modifiers changed from: private */
    public void initOTAData(RssiPacketCountInfo info) {
    ...
    /* access modifiers changed from: private */
    public void updateOTAData(RssiPacketCountInfo info) {
    ...
    /* access modifiers changed from: private */
    public void initTcpQualityDate(HwQoENetWorkInfo result) {
    ...
    /* access modifiers changed from: private */
    public void updateTcpQualityDate(HwQoENetWorkInfo result) {

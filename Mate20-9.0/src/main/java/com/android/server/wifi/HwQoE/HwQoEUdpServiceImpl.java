            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case 101:
                        ...
                        int unused = HwQoEUdpServiceImpl.this.mAddScore = HwQoEUdpServiceImpl.this.calculateNewUdpAccessScore(HwQoEUdpServiceImpl.this.mCurrUdpInfoForMonitor, HwQoEUdpServiceImpl.this.mLastUdpInfoForMonitor);
                        int unused2 = HwQoEUdpServiceImpl.this.mUdpNoAccessScore = HwQoEUdpServiceImpl.this.mUdpNoAccessScore + HwQoEUdpServiceImpl.this.mAddScore;
                        int unused3 = HwQoEUdpServiceImpl.this.mUdpNoAccessScore = Math.max(0, HwQoEUdpServiceImpl.this.mUdpNoAccessScore);
                        ...
                        if (HwQoEUdpServiceImpl.this.mIsUDPAccessMonitorEnabled) {
                            ...
                            } else if (HwQoEUdpServiceImpl.this.mUdpNoAccessScore == 0 && HwQoEUdpServiceImpl.this.mHwQoEMonitorCallback != null) {
                                HwQoEUdpServiceImpl.this.mHwQoEMonitorCallback.onUDPInternetAccessStatusChange(false);
                            }

...
public class HwWiTasUtils {
    ...
    protected static final int WITAS_DEFAULT_ANTENNA_INDEX = 0;
    ...
    protected static final int WITAS_TAS_ANTENNA_INDEX = 1;
    public static final boolean isWiTasEnable = SystemProperties.getBoolean("ro.config.hw_witas_enable", false);

    public static boolean getWiTasEnable() {
        return isWiTasEnable;
    }
}

        ...
        this.mBroadcastReceiver = new BroadcastReceiver() {
            public void onReceive(Context context, Intent intent) {
                ...
                if ("android.intent.action.BOOT_COMPLETED".equals(action)) {
                    ...
                    LaaPhoneStateListener unused2 = HwLaaCellStatusObserver.this.mLaaPhoneStateListener = new LaaPhoneStateListener();
    ...
    private void registerForMobileDataChanges() {
        this.mContext.getContentResolver().registerContentObserver(Settings.Global.getUriFor("mobile_data"), false, new ContentObserver(null) {
            public void onChange(boolean selfChange) {
                boolean unused = HwLaaCellStatusObserver.this.mIsMobileDataEnabled = HwLaaUtils.getSettingsGlobalBoolean(HwLaaCellStatusObserver.this.mContentResolver, "mobile_data", false);

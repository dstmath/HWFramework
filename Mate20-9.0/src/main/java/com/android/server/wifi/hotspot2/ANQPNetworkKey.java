...
public class ANQPNetworkKey {
    ...
    public static ANQPNetworkKey buildKey(String ssid, long bssid, long hessid, int anqpDomainId) {
        if (anqpDomainId == 0) {
            ANQPNetworkKey aNQPNetworkKey = new ANQPNetworkKey(ssid, bssid, 0, 0);
            return aNQPNetworkKey;
        } else if (hessid != 0) {
            ANQPNetworkKey aNQPNetworkKey2 = new ANQPNetworkKey(null, 0, hessid, anqpDomainId);
            return aNQPNetworkKey2;
        } else {
            ANQPNetworkKey aNQPNetworkKey3 = new ANQPNetworkKey(ssid, 0, 0, anqpDomainId);
            return aNQPNetworkKey3;
        }
    }

...
public class WifiproBqeUtils {
            ...
            if (WifiproBqeUtils.BQE_REQUEST_FINISHED.equals(action)) {
                ...
                if (bqeResult != 1) {
                    ...
                    if (WifiproBqeUtils.this.mBestSpeed == 0) {
                        ...
                        long speed2 = speed;
                        if (speed2 > WifiproBqeUtils.this.mBestSpeed) {
                            long unused = WifiproBqeUtils.this.mBestSpeed = speed2;
                        }
                    }
    ...
    private void computeQos(int tcp_rtt, int tcp_rtt_pkts, int tcp_rtt_when) {
        ...
        } else if (tcp_rtt <= 1200 || this.mBestSpeed > 358400) {
            bqeLevel = 3;
            this.mWifiProStatisticsManager.updateBqeSvcChrStatistic(1);
        } else if (tcp_rtt <= 4800 || this.mBestSpeed > 20480) {
            bqeLevel = 2;
    ...
    /* access modifiers changed from: private */
    public void notifyBQEResult(int bqeLevel, int tcp_rtt, int tcp_rtt_pkts, long bestSpeed) {
        synchronized (this.mLock) {

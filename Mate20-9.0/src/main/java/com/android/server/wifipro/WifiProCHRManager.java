...
public class WifiProCHRManager {
    ...
    public void increasePortalUnauthCount() {
        ...
        if (wifiproStatisticObj != null) {
            try {
                Method method = wifiproStatisticObj.getClass().getMethod("increasePortalUnauthCount", new Class[0]);
                method.setAccessible(true);
                method.invoke(wifiproStatisticObj, new Object[]{null});
            } catch (Exception e) {
    ...
    public void increasePortalNoAutoConnCnt() {
        ...
        if (wifiproStatisticObj != null) {
            try {
                Method method = wifiproStatisticObj.getClass().getMethod("increasePortalNoAutoConnCnt", new Class[0]);
                method.setAccessible(true);
                method.invoke(wifiproStatisticObj, new Object[]{null});
            } catch (Exception e) {

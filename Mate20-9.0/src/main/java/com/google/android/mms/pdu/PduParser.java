    ...
    public PduHeaders parseHeaders(ByteArrayInputStream pduDataStream) {
        ...
        while (keepParsing && pduDataStream.available() > 0) {
            ...
            if (headerField < 32 || headerField > 127) {
                ...
                pduDataStream.reset();
                byte[] parseWapString = parseWapString(pduDataStream, 0);
            }
        }
        return headers;
    }
    ...
    public PduBody parseParts(ByteArrayInputStream pduDataStream) {
        ...
        while (i < count2) {
            ...
            if (contentType != null) {
                ...
                part.setContentType(PduContentTypes.contentTypes[c2].getBytes());
            }
            ...
            if (partHeaderLen > 0) {
                if (!pduParser.parsePartHeaders(byteArrayInputStream, part, partHeaderLen)) {
                    return pduBody2;
                }

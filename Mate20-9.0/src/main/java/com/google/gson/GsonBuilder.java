...
public final class GsonBuilder {
    ...
    private void addTypeAdaptersForDate(String datePattern2, int dateStyle2, int timeStyle2, List<TypeAdapterFactory> factories2) {
        ...
        if (datePattern2 != null && !"".equals(datePattern2.trim())) {
            ...
            dateTypeAdapter = new DefaultDateTypeAdapter((Class<? extends java.util.Date>) java.util.Date.class, dateStyle2, timeStyle2);
            timestampTypeAdapter = new DefaultDateTypeAdapter((Class<? extends java.util.Date>) Timestamp.class, dateStyle2, timeStyle2);
            javaSqlDateTypeAdapter = new DefaultDateTypeAdapter((Class<? extends java.util.Date>) Date.class, dateStyle2, timeStyle2);
        } else {
            return;
        }

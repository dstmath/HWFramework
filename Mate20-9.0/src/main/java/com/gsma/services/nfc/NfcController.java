...
public class NfcController {
    ...
    private String getRandomString() {
        return new String("service" + Integer.toString(10000 + new SecureRandom().nextInt(10000)));
    }
        ...
        if (this.mIsHceCapable) {
            ...
            if (description == null) {
                ...
                if (sSEName.equals("SIM")) {
                    sSEName = sSEName + Integer.toString(1);
                }
                String sSEName2 = sSEName;
                new ArrayList(3);
                List<String> secureElementList = this.mNxpHandset.getAvailableSecureElements(146);
                if (secureElementList.size() > 0) {
                    int i = 0;
                    while (i < secureElementList.size() && !secureElementList.get(i).equals(sSEName2)) {
                        i++;
                    }

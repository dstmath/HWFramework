...
public class HwFragmentContainer {
    ...
    public HwFragmentLayout mFragmentLayout;
    private FragmentManager mFragmentManager;
    private boolean mNoFragmentAnim;
    private int mPopCount;
    private boolean mPopMultiple;

    private static class TranslateAnimatorListener implements Animator.AnimatorListener {
    ...
    private void openRightClearStack(Fragment fragment, boolean isInitial) {
        if (fragment != null) {
            setSelectedAndAnimation(isInitial ^ true ? 1 : 0);
            popPrepare();
    ...
    private AnimatorSet createAnimator(View view, int type) {
        if (type == 0) {
            ...
            ObjectAnimator translateAnimator = ObjectAnimator.ofFloat(view, "translationX", new float[]{(float) this.mAnimatorWidth, 0.0f});
            ...
            view.setTranslationZ(-1.0f);
            ObjectAnimator translateAnimator2 = ObjectAnimator.ofFloat(view, "translationX", new float[]{0.0f, ((float) (-this.mAnimatorWidth)) / 2.0f});
            ...
            animatorSet2.playTogether(new Animator[]{translateAnimator2, this.mBlurLayerAnimator});
            return animatorSet2;
        } else if (type == 2) {
            view.setTranslationZ(-1.0f);
            ObjectAnimator translateAnimator3 = ObjectAnimator.ofFloat(view, "translationX", new float[]{((float) (-this.mAnimatorWidth)) / 2.0f, 0.0f});
            translateAnimator3.setInterpolator(INTERPOLATOR_20_90);
            translateAnimator3.setDuration(300);
            createBlurLayerAnimator(view, 0.4f, BLUR_LAYER_TRANSPARENT);
            AnimatorSet animatorSet3 = new AnimatorSet();
            animatorSet3.playTogether(new Animator[]{translateAnimator3, this.mBlurLayerAnimator});
            return animatorSet3;
        } else if (type != 3) {
            return null;
        } else {
            view.setTranslationZ(1.0f);
            ObjectAnimator translateAnimator4 = ObjectAnimator.ofFloat(view, "translationX", new float[]{0.0f, (float) this.mAnimatorWidth});
            translateAnimator4.setInterpolator(INTERPOLATOR_20_90);
            translateAnimator4.setDuration(300);

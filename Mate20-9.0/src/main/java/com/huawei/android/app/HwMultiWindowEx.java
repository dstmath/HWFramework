...
public class HwMultiWindowEx {
    ...
    public static List<StateChangeListener> sStateChangeListeners;
    ...
    private static void initDeclaredMethods() {
        ...
        Class[] clsArr2 = {IMWThirdpartyCallback.class};
        try {
            ...
            sMultiWinService = asInterface.invoke(null, new Object[]{sGetServiceMethod.invoke(sServiceManagerClazz, new Object[]{"multiwin"})});
            if (sMultiWinService != null) {
                ...
                sGetMultiWinFrameMethod = clazz.getDeclaredMethod("getMultiWinFrameByTaskID", clsArr);
                sRegisterThirdPartyCallBackMethod = clazz.getDeclaredMethod("registerThirdPartyCallBack", clsArr2);
                sUnregisterThirdPartyCallBackMethod = clazz.getDeclaredMethod("unregisterThirdPartyCallBack", clsArr2);
            }
            ...
            String str6 = TAG;
            Log.e(str6, "initDeclaredMethods failed:" + e6.toString());
        }
    }
    ...
    private static boolean isInMultiWindowMode_N() {
        return HwActivityManager.isInMultiWindowMode();
    }

...
public class DeviceSettingsManager {
    ...
    static {
        ...
        WIFI_STANDBY_MODE_MAP.put(-1, WIFI_STANDBY_MODE_NORMAL);
        FONT_SIZE_TYPES.put(1, Float.valueOf(FONT_SIZE_SMALL_VALUE));
        FONT_SIZE_TYPES.put(2, Float.valueOf(FONT_SIZE_NORMAL_VALUE));
        FONT_SIZE_TYPES.put(3, Float.valueOf(FONT_SIZE_LARGE_VALUE));
        FONT_SIZE_TYPES.put(4, Float.valueOf(FONT_SIZE_HUGE_VALUE));
        FONT_SIZE_TYPES.put(5, Float.valueOf(FONT_SIZE_EXTRA_HUGE_VALUE));
    }
    ...
    private boolean getStateTypeDataFromBundle(Bundle policyValue, boolean defaultValue) {
        ...
        String str = TAG;
        Log.w(str, "getStateTypeDataFromBundle() get null data. will return default value: " + defaultValue);
        return defaultValue;
    }
    ...
    public boolean setPhoneFindDisabled(ComponentName admin, boolean disabled) {
        Bundle bundle = new Bundle();
        bundle.putBoolean("value", disabled);
    ...
    public boolean setParentControlDisabled(ComponentName admin, boolean disabled) {
        Bundle bundle = new Bundle();
        bundle.putBoolean("value", disabled);
    ...
    public boolean setApplicationLockDisabled(ComponentName admin, boolean disabled) {
        Bundle bundle = new Bundle();
        bundle.putBoolean("value", disabled);
    ...
    public boolean setForceEncryptSdcardEnabled(ComponentName admin, boolean enabled) {
        return setStateTypePolicy(admin, POLICY_FORCE_ENCRYPT_SDCARD, enabled);
    }

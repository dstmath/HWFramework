...
public abstract class InstallManager {
    ...
    protected RemoteRequestStrategy mRemoteRequestStrategy;
    ...
    public abstract void registerListener(InstallStateUpdatedListener installStateUpdatedListener);

    public abstract Task<Integer> startInstallModules(InstallRequest installRequest);

    public abstract void unregisterListener(InstallStateUpdatedListener installStateUpdatedListener);
}

...
public class NonIsolatedDynamicModule extends DynamicModuleInternal {
    ...
    public static Object getField(Class cls, Object obj, String str) {
        ...
        RelectUtils.setFieldAccess(declaredField);
    ...
    public int install() {
        ...
        Log.d(TAG, "extractNatvieLibrary end. errcode:" + extractNatvieLibrary);
        if (extractNatvieLibrary != 0) {
        ...
        try {
            ...
            try {
                ...
                try {
                    invoke(cls, assets, "addAssetPath", this.mModuleInfo.mApkPath);

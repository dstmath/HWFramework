    ...
    public static abstract class Stub extends Binder implements IActivityRecognitionHardwareService {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result2 = registerSink(IActivityRecognitionHardwareSink.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    if (_result2) {
                        i = 1;
                    }
                ...
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result3 = unregisterSink(IActivityRecognitionHardwareSink.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    if (_result3) {
                        i = 1;
                    }
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result8 = providerLoadOk();
                    reply.writeNoException();
                    if (_result8) {
                        i = 1;
                    }

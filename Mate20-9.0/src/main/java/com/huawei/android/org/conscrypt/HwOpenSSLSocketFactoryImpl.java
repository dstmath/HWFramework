...
public class HwOpenSSLSocketFactoryImpl {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [com.huawei.android.org.conscrypt.HwOpenSSLSocketFactoryImpl$OpenSSLSocketFactoryImplInner, javax.net.ssl.SSLSocketFactory] */

...
public interface HwTransCodeEx {
    ...
    public static final int ADD_GAMESPACE_PACKAGE_LIST_TRANSACTION = 3301;
    ...
    public static final int DEL_GAMESPACE_PACKAGE_LIST_TRANSACTION = 3302;
    public static final int GET_GAMESPACE_LIST_TRANSACTION = 3304;
    ...
    public static final int IS_GAME_DND_ON_TRANSACTION = 3307;
    public static final int IS_GAME_GESTURE_DISABLED_TRANSACTION = 3309;
    public static final int IS_GAME_KEYCONTROL_ON_TRANSACTION = 3308;
    public static final int IS_IN_GAMESPACE_TRANSACTION = 3303;
    ...
    public static final int REGISTER_GAME_OBSERVER_TRANSACTION = 3305;
    ...
    public static final int UNREGISTER_GAME_OBSERVER_TRANSACTION = 3306;

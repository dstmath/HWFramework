...
public class NetworkManagerEx {
    ...
    public static void setAdFilterRules(HashMap<String, List<String>> adStrategy, boolean needReset) {
        ...
        IBinder b = ServiceManager.getService(ContextEx.NETWORKMANAGEMENT_SERVICE);
    ...
    public static void registerObserver(BaseNetworkObserverEx obs) throws RemoteException {
        INetworkManagementService networkManagement = INetworkManagementService.Stub.asInterface(ServiceManager.getService(ContextEx.NETWORKMANAGEMENT_SERVICE));
    ...
    public static void unregisterObserver(BaseNetworkObserverEx obs) throws RemoteException {
        INetworkManagementService.Stub.asInterface(ServiceManager.getService(ContextEx.NETWORKMANAGEMENT_SERVICE)).unregisterObserver(obs.getInnerBaseNetworkObserver());
    }

    public static String[] listTetheredInterfaces() throws RemoteException {
        return INetworkManagementService.Stub.asInterface(ServiceManager.getService(ContextEx.NETWORKMANAGEMENT_SERVICE)).listTetheredInterfaces();
    }

    public static void tetherInterface(String iface) throws RemoteException {
        INetworkManagementService.Stub.asInterface(ServiceManager.getService(ContextEx.NETWORKMANAGEMENT_SERVICE)).tetherInterface(iface);
    }

    public static void untetherInterface(String iface) throws RemoteException {
        INetworkManagementService.Stub.asInterface(ServiceManager.getService(ContextEx.NETWORKMANAGEMENT_SERVICE)).untetherInterface(iface);
    }

    public static boolean isTetheringStarted() throws RemoteException {
        return INetworkManagementService.Stub.asInterface(ServiceManager.getService(ContextEx.NETWORKMANAGEMENT_SERVICE)).isTetheringStarted();
    }

    public static void startTethering(String[] addressRange) throws RemoteException {
        INetworkManagementService.Stub.asInterface(ServiceManager.getService(ContextEx.NETWORKMANAGEMENT_SERVICE)).startTethering(addressRange);
    }

    public static void stopTethering() throws RemoteException {
        INetworkManagementService.Stub.asInterface(ServiceManager.getService(ContextEx.NETWORKMANAGEMENT_SERVICE)).stopTethering();
    }

    public static InterfaceConfigurationEx getInterfaceConfig(String iface) throws RemoteException {
        return new InterfaceConfigurationEx(INetworkManagementService.Stub.asInterface(ServiceManager.getService(ContextEx.NETWORKMANAGEMENT_SERVICE)).getInterfaceConfig(iface));
    }

    public static void setInterfaceConfig(String iface, InterfaceConfigurationEx config) throws RemoteException {
        INetworkManagementService.Stub.asInterface(ServiceManager.getService(ContextEx.NETWORKMANAGEMENT_SERVICE)).setInterfaceConfig(iface, config.getInterfaceConfiguration());
    }
    ...
    public static void ipTableConfig(boolean enable, String iface, int uid, IBinder binder) {
        ...
        if (b != null) {
            try {
                ...
                b.transact(CODE_IP_TABLE_CONFIG, data, reply, 0);
                reply.readException();
            } catch (RemoteException e) {

...
public class VibratorEx {
    ...
    public static final String HW_VIBRATOR_TYPE_VIRTUAL_BUTTON_PRESS = "haptic.virtual_button.press";
    public static final String HW_VIBRATOR_TYPE_VIRTUAL_BUTTON_PRESS_DOWN = "haptic.virtual_button.press_down";

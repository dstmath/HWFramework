...
public class PhoneNumberRule_EN_GB extends PhoneNumberRule {
    ...
    public void init() {
        ...
        cRules.add(new PhoneNumberRule.RegexRule(this, "") {
            public PhoneNumberMatch isValid(PhoneNumberMatch possibleNumber, String msg) {
                ...
                if (!number.startsWith(HwSettings.System.FINGERSENSE_KNUCKLE_GESTURE_OFF) && PhoneNumberRule_EN_GB.countDigits(number) == 8) {
                    isvalid = false;
                }
    ...
    public List<MatchedNumberInfo> handlePossibleNumberWithPattern(Pattern p, PhoneNumberMatch possibleNumber, String msg, boolean startsWith) {
        boolean ok;

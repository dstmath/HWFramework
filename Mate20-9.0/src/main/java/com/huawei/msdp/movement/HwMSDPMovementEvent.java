...
public class HwMSDPMovementEvent implements Parcelable {
    ...
    public String toString() {
        if (this.mOtherParams != null) {
            return String.format("Movement='%s', EventType=%s, TimestampNs=%s, Param1=%s, Param2=%s, Param3=%s, Param4=%s, Param5=%s, Confidence=%s", new Object[]{this.mMovement, Integer.valueOf(this.mEventType), Long.valueOf(this.mTimestampNs), Double.valueOf(this.mOtherParams.getmParam1()), Double.valueOf(this.mOtherParams.getmParam2()), Double.valueOf(this.mOtherParams.getmParam3()), Double.valueOf(this.mOtherParams.getmParam4()), this.mOtherParams.getmParam5(), Integer.valueOf(this.mConfidence)});
        }
        return String.format("Activity='%s', EventType=%s, TimestampNs=%s, Confidence=%s", new Object[]{this.mMovement, Integer.valueOf(this.mEventType), Long.valueOf(this.mTimestampNs), Integer.valueOf(this.mConfidence)});
    }
}

...
public class HwMSDPOtherParameters implements Parcelable {
    ...
    public String toString() {
        return String.format("Param1=%f, Param2=%f, Param3=%f, Param4=%f, Param5=%s", new Object[]{Double.valueOf(this.mParam1), Double.valueOf(this.mParam2), Double.valueOf(this.mParam3), Double.valueOf(this.mParam4), this.mParam5});
    }
}

    ...
    class CreateP2PClientRunable implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                hasException = true;
                HwLog.e(CreateSocketListenerTransport.TAG, "createP2PNearbySocketClient : IOException" + e);
            } catch (RemoteException e2) {
                hasException = true;
                HwLog.e(CreateSocketListenerTransport.TAG, "createP2PNearbySocketClient : RemoteException" + e2);
            }
            try {
                socket.setKeepAlive(true);
            } catch (SocketException e3) {
                hasException = true;
                HwLog.e(CreateSocketListenerTransport.TAG, "createP2PNearbySocketClient : SocketException" + e3);
            }
            if (hasException) {
                try {
                    this.innerSocket.close();
                } catch (RemoteException e4) {
                    HwLog.e(CreateSocketListenerTransport.TAG, "createP2PNearbySocketClient : RemoteException" + e4);
                }
                msg.what = 2;

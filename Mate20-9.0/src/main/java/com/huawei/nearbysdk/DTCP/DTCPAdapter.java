    ...
    public static synchronized boolean createInstance(Context context, AdapterCreateCallback cb) {
        synchronized (DTCPAdapter.class) {
            ...
            if (msInstance == null) {
                ...
                try {
                    isBindServiceAsUser = ((Boolean) Context.class.getDeclaredMethod("bindServiceAsUser", new Class[]{Intent.class, ServiceConnection.class, Integer.TYPE, UserHandle.class}).invoke(context, new Object[]{intent, new DTCPServiceConnection(context, cb), 1, (UserHandle) UserHandle.class.getField("CURRENT").get(UserHandle.class)})).booleanValue();
                } catch (Throwable e) {

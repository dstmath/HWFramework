...
public final class CacheControl {
    ...
    public static CacheControl parse(Headers headers) {
                    ...
                    if (!(value.charAt(pos4) == ',' || value.charAt(pos4) == ';')) {
                        ...
                        if (!"no-cache".equalsIgnoreCase(directive)) {
                            ...
                            if ("max-age".equalsIgnoreCase(directive)) {
                                maxAgeSeconds3 = HttpHeaders.parseSeconds(parameter2, -1);
                                noCache3 = noCache2;
                                noStore2 = noStore3;
                                pos3 = pos2;
                            } else {
                                if ("s-maxage".equalsIgnoreCase(directive)) {
                                    sMaxAgeSeconds2 = HttpHeaders.parseSeconds(parameter2, -1);
                                    ...
                                    maxStaleSeconds2 = HttpHeaders.parseSeconds(parameter2, Integer.MAX_VALUE);
                                } else if ("min-fresh".equalsIgnoreCase(directive)) {
                                    minFreshSeconds2 = HttpHeaders.parseSeconds(parameter2, -1);
        ...
        CacheControl cacheControl = new CacheControl(noCache3, noStore2, maxAgeSeconds3, sMaxAgeSeconds2, isPrivate2, isPublic2, mustRevalidate2, maxStaleSeconds2, minFreshSeconds2, onlyIfCached2, noTransform4, immutable2, headerValue2);
        return cacheControl;
    }

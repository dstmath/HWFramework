...
final class Hpack {
    ...
    static final class Reader {
        ...
        public void readHeaders() throws IOException {
            while (!this.source.exhausted()) {
                ...
                } else if ((b & AppOpsManagerEx.TYPE_MICROPHONE) == 128) {
        ...
        public ByteString readByteString() throws IOException {
            ...
            boolean huffmanDecode = (firstByte & AppOpsManagerEx.TYPE_MICROPHONE) == 128;
    ...
    static final class Writer {
        ...
        public void writeInt(int value, int prefixMask, int bits) {
            ...
            while (value2 >= 128) {
                this.out.writeByte((value2 & 127) | AppOpsManagerEx.TYPE_MICROPHONE);
                value2 >>>= 7;
            }

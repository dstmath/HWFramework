...
public class DetailBatterySipper implements Comparable<DetailBatterySipper>, Parcelable {
    ...
    public float mBgCpuPower = 0.0f;
    public long mBgCpuTime = 0;
    public float mBgGpsPower = 0.0f;
    public long mBgGpsTime = 0;
    public float mBgMobileRxPower = 0.0f;
    public long mBgMobileRxTime = 0;
    public float mBgMobileTxPower = 0.0f;
    public long mBgMobileTxTime = 0;
    public float mBgSensorPower = 0.0f;
    public long mBgSensorsTime = 0;
    public float mBgTotalPower = 0.0f;
    public float mBgWifiRxPower = 0.0f;
    public float mBgWifiScanPower = 0.0f;
    public long mBgWifiScanTime = 0;
    public float mBgWifiTxPower = 0.0f;
    public float mBgWlPower = 0.0f;
    public long mBgWlTime = 0;
    public float mDistributedPower = 0.0f;
    public float mFgCpuPower = 0.0f;
    public long mFgCpuTime = 0;
    public float mFgGpsPower = 0.0f;
    public long mFgGpsTime = 0;
    public float mFgGpuPower = 0.0f;
    public long mFgGpuTime = 0;
    public float mFgMobileRxPower = 0.0f;
    public long mFgMobileRxTime = 0;
    public float mFgMobileTxPower = 0.0f;
    public long mFgMobileTxTime = 0;
    public float mFgScreenPower = 0.0f;
    public long mFgScreenTime = 0;
    public float mFgSensorPower = 0.0f;
    public long mFgSensorsTime = 0;
    public float mFgTotalPower = 0.0f;
    public float mFgWifiRxPower = 0.0f;
    public float mFgWifiScanPower = 0.0f;
    public long mFgWifiScanTime = 0;
    public float mFgWifiTxPower = 0.0f;
    public boolean mIsPkg = false;
    public NetEntry[] mMobileEntry = new NetEntry[2];
    public String mName;
    public int mUid;
    public NetEntry[] mWifiEntry = new NetEntry[2];

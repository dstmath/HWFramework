        ...
        if (errorCode == 1) {
            ...
            if (exportResult.resultCode == 1) {
                ...
                if (keymasterAlgorithm != null) {
                    try {
                        return getAndroidKeyStorePublicKey(privateKeyAlias, uid, HwKeyProperties.KeyAlgorithm.fromKeymasterAsymmetricKeyAlgorithm(keymasterAlgorithm.intValue()), x509EncodedPublicKey);

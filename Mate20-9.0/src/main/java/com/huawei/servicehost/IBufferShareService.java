        ...
        private static class Proxy implements IBufferShareService {
            ...
            public IImageConsumer createImageConsumer(int type) throws RemoteException {
                ...
                try {
                    ...
                    return IImageConsumer.Stub.asInterface(_reply.readStrongBinder());
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public IImageProducer createImageProducer(Surface val) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    return IImageProducer.Stub.asInterface(_reply.readStrongBinder());
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public IImageAllocator getImageAllocator() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    return IImageAllocator.Stub.asInterface(_reply.readStrongBinder());
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }

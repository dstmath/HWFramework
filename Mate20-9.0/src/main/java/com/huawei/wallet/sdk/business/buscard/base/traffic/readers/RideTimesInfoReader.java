...
public class RideTimesInfoReader extends InfoReader<String[]> {
    private static final String TAG = "RideTimesInfoReader";

    public RideTimesInfoReader(IAPDUService omaService) {
        super(omaService);
    }

...
public final class CtidCardServerAccessService {
    private static final byte[] SYNC_LOCK = new byte[0];
    private static final String TAG = "IDCard:ServerAccessService";
    private static volatile CtidCardServerAccessService instance = null;
    private String apduError = "";
    private CtidCardServer cardServer = null;
    ...
    private CtidCardServerAccessService(Context context) {
        this.mContext = context.getApplicationContext();
        this.cardServer = new CtidCardServer(this.mContext);
        this.mMediaType = getMediaType();
    }

    public static CtidCardServerAccessService getInstance(Context context) {
        if (instance == null) {
            synchronized (SYNC_LOCK) {
                if (instance == null && context != null) {
                    instance = new CtidCardServerAccessService(context);
                }
            }
        }
        return instance;

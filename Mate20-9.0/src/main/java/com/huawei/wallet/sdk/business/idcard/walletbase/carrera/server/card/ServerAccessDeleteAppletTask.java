...
public class ServerAccessDeleteAppletTask extends HttpConnTask<ServerAccessDeleteAppletResponse, ServerAccessDeleteAppletRequest> {
    ...
    public String prepareRequestStr(ServerAccessDeleteAppletRequest request) {
        ...
        if (!isDebugBuild()) {
            LogX.i("ServerAccessDeleteAppletTask prepareRequestStr, commander= delete.app reportRequestMessageJson= " + reportRequestMessageJson);
        }
    ...
    public ServerAccessDeleteAppletResponse readErrorResponse(int errorCode, String errorMessage) {
        ...
        if (!isDebugBuild()) {
            LogX.i("ServerAccessDeleteAppletTask readErrorResponse, commander= delete.app errorCode= " + errorCode + " errorMessage= " + errorMessage);
        }
        return response;
    }
    ...
    public ServerAccessDeleteAppletResponse readSuccessResponse(int returnCode, String returnDesc, JSONObject dataObject) {
        ...
        if (!isDebugBuild()) {
            LogX.i("ServerAccessDeleteAppletTask readSuccessResponse, commander= delete.app returnCode= " + returnCode + " returnDesc= " + returnDesc + " dataObject: " + this.builder.toString());
        }
        return response;
    }

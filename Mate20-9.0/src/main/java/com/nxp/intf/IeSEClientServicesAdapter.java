        ...
        private static class Proxy implements IeSEClientServicesAdapter {
            ...
            public INxpExtrasService getNxpExtrasService() throws RemoteException {
                ...
                try {
                    ...
                    return INxpExtrasService.Stub.asInterface(_reply.readStrongBinder());
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public ILoaderService getLoaderService() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    return ILoaderService.Stub.asInterface(_reply.readStrongBinder());
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public IJcopService getJcopService() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    return IJcopService.Stub.asInterface(_reply.readStrongBinder());
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }

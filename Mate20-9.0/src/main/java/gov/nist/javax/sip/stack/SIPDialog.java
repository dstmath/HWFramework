...
public class SIPDialog implements Dialog, DialogExt {
    ...
    /*  JADX ERROR: StackOverflow in pass: MarkFinallyVisitor
        ...
        */
    private void addRoute(gov.nist.javax.sip.header.RecordRouteList r7) {
        /*
            r6 = this;
            boolean r0 = r6.isClientDialog()     // Catch:{ all -> 0x00ea }
            r1 = 1
            if (r0 == 0) goto L_0x004d
            gov.nist.javax.sip.header.RouteList r0 = new gov.nist.javax.sip.header.RouteList     // Catch:{ all -> 0x00ea }
            r0.<init>()     // Catch:{ all -> 0x00ea }
            r6.routeList = r0     // Catch:{ all -> 0x00ea }
            int r0 = r7.size()     // Catch:{ all -> 0x00ea }
            java.util.ListIterator r0 = r7.listIterator(r0)     // Catch:{ all -> 0x00ea }
        L_0x0017:
            boolean r2 = r0.hasPrevious()     // Catch:{ all -> 0x00ea }
            if (r2 == 0) goto L_0x004c
            java.lang.Object r2 = r0.previous()     // Catch:{ all -> 0x00ea }
            gov.nist.javax.sip.header.RecordRoute r2 = (gov.nist.javax.sip.header.RecordRoute) r2     // Catch:{ all -> 0x00ea }
            if (r1 == 0) goto L_0x004b
            gov.nist.javax.sip.header.Route r3 = new gov.nist.javax.sip.header.Route     // Catch:{ all -> 0x00ea }
            r3.<init>()     // Catch:{ all -> 0x00ea }
            javax.sip.address.Address r4 = r2.getAddress()     // Catch:{ all -> 0x00ea }
            gov.nist.javax.sip.address.AddressImpl r4 = (gov.nist.javax.sip.address.AddressImpl) r4     // Catch:{ all -> 0x00ea }
            java.lang.Object r4 = r4.clone()     // Catch:{ all -> 0x00ea }
            gov.nist.javax.sip.address.AddressImpl r4 = (gov.nist.javax.sip.address.AddressImpl) r4     // Catch:{ all -> 0x00ea }
            r3.setAddress(r4)     // Catch:{ all -> 0x00ea }
            gov.nist.core.NameValueList r5 = r2.getParameters()     // Catch:{ all -> 0x00ea }
            java.lang.Object r5 = r5.clone()     // Catch:{ all -> 0x00ea }
            gov.nist.core.NameValueList r5 = (gov.nist.core.NameValueList) r5     // Catch:{ all -> 0x00ea }
            r3.setParameters(r5)     // Catch:{ all -> 0x00ea }
            gov.nist.javax.sip.header.RouteList r5 = r6.routeList     // Catch:{ all -> 0x00ea }
            r5.add(r3)     // Catch:{ all -> 0x00ea }
        L_0x004b:
            goto L_0x0017
        L_0x004c:
            goto L_0x008e
        L_0x004d:
            ...
            r0.<init>()     // Catch:{ all -> 0x00ea }
            r6.routeList = r0     // Catch:{ all -> 0x00ea }
            java.util.ListIterator r0 = r7.listIterator()     // Catch:{ all -> 0x00ea }
        L_0x0059:
            boolean r2 = r0.hasNext()     // Catch:{ all -> 0x00ea }
            if (r2 == 0) goto L_0x008e
            java.lang.Object r2 = r0.next()     // Catch:{ all -> 0x00ea }
            gov.nist.javax.sip.header.RecordRoute r2 = (gov.nist.javax.sip.header.RecordRoute) r2     // Catch:{ all -> 0x00ea }
        ...
        L_0x008d:
            goto L_0x0059
        L_0x008e:
            gov.nist.javax.sip.stack.SIPTransactionStack r0 = r6.sipStack
            gov.nist.core.StackLogger r0 = r0.getStackLogger()
            boolean r0 = r0.isLoggingEnabled()
            if (r0 == 0) goto L_0x00e9
            gov.nist.javax.sip.header.RouteList r0 = r6.routeList
            java.util.Iterator r0 = r0.iterator()
        L_0x00a0:
            boolean r1 = r0.hasNext()
            if (r1 == 0) goto L_0x00e8
            java.lang.Object r1 = r0.next()
            gov.nist.javax.sip.header.Route r1 = (gov.nist.javax.sip.header.Route) r1
            javax.sip.address.Address r1 = r1.getAddress()
            javax.sip.address.URI r1 = r1.getURI()
            javax.sip.address.SipURI r1 = (javax.sip.address.SipURI) r1
            boolean r2 = r1.hasLrParam()
            if (r2 != 0) goto L_0x00e7
            gov.nist.javax.sip.stack.SIPTransactionStack r2 = r6.sipStack
            ...
            r3.<init>()
            java.lang.String r4 = "NON LR route in Route set detected for dialog : "
            r3.append(r4)
            r3.append(r6)
        ...
        L_0x00ea:
            r0 = move-exception
            gov.nist.javax.sip.stack.SIPTransactionStack r1 = r6.sipStack
            gov.nist.core.StackLogger r1 = r1.getStackLogger()
            boolean r1 = r1.isLoggingEnabled()
            if (r1 == 0) goto L_0x0145
            gov.nist.javax.sip.header.RouteList r1 = r6.routeList
        ...
        L_0x00fd:
            ...
            gov.nist.javax.sip.stack.SIPTransactionStack r3 = r6.sipStack
            ...
            r4.<init>()
            java.lang.String r5 = "NON LR route in Route set detected for dialog : "
            r4.append(r5)
            r4.append(r6)
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:60:0x00ef, code lost:
        return;
     */
    /* JADX WARNING: Unknown top exception splitter block from list: {B:35:0x0094=Splitter:B:35:0x0094, B:55:0x00dd=Splitter:B:55:0x00dd} */
    ...
    private synchronized RouteList getRouteList() {
        ...
        if (this.routeList != null) {
            ...
            while (li.hasNext()) {
                retval.add((Route) ((Route) li.next()).clone());
            }
        }
        if (this.sipStack.isLoggingEnabled()) {
    ...
    private void setRemoteTag(String hisTag2) {
        ...
        if (this.hisTag == null || hisTag2 == null || hisTag2.equals(this.hisTag)) {
            if (hisTag2 != null) {
                this.hisTag = hisTag2;
    ...
    public Request createRequest(String method2) throws SipException {
        if (method2.equals("ACK") || method2.equals(Request.PRACK)) {
            ...
            return createRequest(method2, this.lastResponse);
        } else {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v11, resolved type: gov.nist.javax.sip.address.SipUri} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v27, resolved type: java.lang.Object} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v13, resolved type: gov.nist.javax.sip.address.SipUri} */
    ...
    private Request createRequest(String method2, SIPResponse sipResponse) throws SipException {
        ...
        if (method2 == null || sipResponse == null) {
            ...
            if (getRemoteTarget() != null) {
                sipUri = getRemoteTarget().getURI().clone();
            } else {
                sipUri = getRemoteParty().getURI().clone();
            ...
            if (SIPRequest.isTargetRefresh(method2)) {
                ...
                sipRequest.setHeader((Header) contactHeader2);
            }
            try {
            ...
            if (method2.equals("SUBSCRIBE") && this.eventHeader != null) {
        ...
        if (!this.firstTransactionIsServerTransaction) {
            ...
            if (request.getMethod().equals("INVITE")) {
                ...
                if (list == null || !optionPresent(list, "100rel")) {
                    ListIterator<SIPHeader> list2 = request.getHeaders("Require");
                    if (list2 == null || !optionPresent(list2, "100rel")) {

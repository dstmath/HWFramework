    ...
    public void processMessage(SIPMessage sipMessage) throws Exception {
        ...
        if (sipMessage instanceof SIPRequest) {
            ...
            try {
                ...
                InternalErrorHandler.handleException((Exception) ex, this.sipStack.getStackLogger());
            }
            if (!this.isCached) {
        ...
        if (sipMessage instanceof SIPRequest) {
            ...
            if (this.sipStack.getStackLogger().isLoggingEnabled(16)) {
                ...
                serverLogger.logMessage(sipMessage, hostPort, getMessageProcessor().getIpAddress().getHostAddress() + Separators.COLON + getMessageProcessor().getPort(), false, receptionTime);
            }

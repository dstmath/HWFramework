...
public class HwCustEmergDataManagerImpl extends HwCustEmergDataManager {
    ...
    private static class FileBackup {
        ...
        static {
            ...
            boolean z2 = HWLOGW_E;
            HWFLOW = z || (Log.HWModuleLog && Log.isLoggable(TAG, ONEINTLENGTH));
    ...
    public void backupEmergencyDataFile() {
        ...
        if (mFileBackup.init()) {
            ...
            boolean unused = mFileBackup.copy(CONTACTS_PROVIDER_PATH_BK, CONTACTS_PROVIDER_PATH);
            boolean unused2 = mFileBackup.copy(TELEPHONY_PROVIDER_PATH_BK, TELEPHONY_PROVIDER_PATH);
            boolean unused3 = mFileBackup.copy(PKGXML_PATH_BK, PKGXML_PATH);

...
public class HwDevicePolicyManagerEx {
    ...
    public void disableInstallSource(ComponentName admin, List<String> whitelist) {
        this.mSponsor.transactTo_execCommand((int) ConstantValue.transaction_disableInstallSource, "disableInstallPackage", admin, whitelist, UserHandle.myUserId());
    }
    ...
    public void addPersistentApp(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand((int) ConstantValue.transaction_addPersistentApp, "addPersistentApp", admin, packageNames, UserHandle.myUserId());
    }

    public void removePersistentApp(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand((int) ConstantValue.transaction_removePersistentApp, "removePersistentApp", admin, packageNames, UserHandle.myUserId());
    }

    public List<String> getPersistentApp(ComponentName admin) {
        return this.mSponsor.transactTo_getListFunction(ConstantValue.transaction_getPersistentApp, "getPersistentApp", admin, UserHandle.myUserId());
    }

    public void addDisallowedRunningApp(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand((int) ConstantValue.transaction_addDisallowedRunningApp, "addDisallowedRunningApp", admin, packageNames, UserHandle.myUserId());
    }

    public void removeDisallowedRunningApp(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand((int) ConstantValue.transaction_removeDisallowedRunningApp, "removeDisallowedRunningApp", admin, packageNames, UserHandle.myUserId());
    }
    ...
    public void addInstallPackageWhiteList(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand((int) ConstantValue.transaction_addInstallPackageWhiteList, "add_install_packages", admin, packageNames, UserHandle.myUserId());
    }

    public void removeInstallPackageWhiteList(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand((int) ConstantValue.transaction_removeInstallPackageWhiteList, "remove_install_packages", admin, packageNames, UserHandle.myUserId());
    }
    ...
    public void addDisallowedUninstallPackages(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand((int) ConstantValue.transaction_addDisallowedUninstallPackages, "add_notuninstall_packages", admin, packageNames, UserHandle.myUserId());
    }

    public void removeDisallowedUninstallPackages(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand((int) ConstantValue.transaction_removeDisallowedUninstallPackages, "remove_notuninstall_packages", admin, packageNames, UserHandle.myUserId());
    }
    ...
    public void addDisabledDeactivateMdmPackages(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand((int) ConstantValue.transaction_addDisabledDeactivateMdmPackages, "add_disabled_deactive_Mdm_packages", admin, packageNames, UserHandle.myUserId());
    }

    public void removeDisabledDeactivateMdmPackages(ComponentName admin, List<String> packageNames) {
        this.mSponsor.transactTo_execCommand((int) ConstantValue.transaction_removeDisabledDeactivateMdmPackages, "remove_disabled_deactive_Mdm_packages", admin, packageNames, UserHandle.myUserId());
    }
    ...
    public void setCustomSettingsMenu(ComponentName admin, List<String> menusToDelete) {
        this.mSponsor.transactTo_execCommand((int) ConstantValue.transaction_setCustomSettingsMenu, "setCustomSettingsMenu", admin, menusToDelete, UserHandle.myUserId());
    }
    ...
    public void addNetworkAccessWhitelist(ComponentName admin, List<String> addrList) {
        this.mSponsor.transactTo_execCommand((int) ConstantValue.transaction_addNetworkAccessWhitelist, "addNetworkAccessWhitelist", admin, addrList, 0);
    }

    public void removeNetworkAccessWhitelist(ComponentName admin, List<String> addrList) {
        this.mSponsor.transactTo_execCommand((int) ConstantValue.transaction_removeNetworkAccessWhitelist, "removeNetworkAccessWhitelist", admin, addrList, 0);
    }

        ...
        try {
            ...
            if (binder != null) {
                ...
                try {
                    ...
                    int i2 = flag;
                    boolean z = requestAccess;
                    int i3 = userId;
                    try {
                        Log.e(TAG, "transactTo " + str + " failed: " + localRemoteException.getMessage());
                        _reply.recycle();
                        _data.recycle();
                        return bDisabled;
                    } catch (Throwable th) {
                ...
                try {
                    ...
                    th = th4;
                    int i10 = code;
                    String str52 = password;
                    int i522 = flag;
                    boolean z222 = requestAccess;
                    int i622 = userId;
                    _reply.recycle();
                    _data.recycle();
                    throw th;
            ...
            int i23 = type;
            String str22 = name;
            String str322 = password;
            int i2222 = flag;
            boolean z3222 = requestAccess;
            int i322222 = userId;
            Log.e(TAG, "transactTo " + str + " failed: " + localRemoteException.getMessage());
            _reply.recycle();
            _data.recycle();
            ...
            int i25 = type;
            String str42 = name;
            String str522 = password;
            int i5222 = flag;
            boolean z22222 = requestAccess;
            int i622222 = userId;
            _reply.recycle();
            _data.recycle();
            throw th;

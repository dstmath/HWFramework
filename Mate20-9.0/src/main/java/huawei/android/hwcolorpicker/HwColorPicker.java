...
public class HwColorPicker {
    ...
    public static final PickedColor DEFAULT_COLOR = new PickedColor();
    ...
    public static class PickedColor {
        ...
        public int get(ResultType resultType) {
            ...
            int index = resultType.index & HwColorPicker.MASK_RESULT_INDEX;
    ...
    public enum ResultType {
        ...
        private ResultType(ClientType clientType2, int index2) {
            ...
            this.index = index2 & HwColorPicker.MASK_RESULT_INDEX;
            this.flag = (65535 & index2) | ((clientType2.index << 24) & -16777216);
        }

...
public class SectionLocaleUtils {
    ...
    private static class SectionLocaleUtilsBase {
        ...
        public SectionLocaleUtilsBase(Locale locale) {
            ...
            this.mAlphabeticIndex = new AlphabeticIndex(locale).setMaxLabelCount(AppTypeInfo.PG_TYPE_BASE).addLabels(new Locale[]{Locale.ENGLISH}).addLabels(new Locale[]{Locale.JAPANESE}).addLabels(new Locale[]{Locale.KOREAN}).addLabels(new Locale[]{SectionLocaleUtils.LOCALE_THAI}).addLabels(new Locale[]{"fa".equals(locale.getLanguage()) ? SectionLocaleUtils.LOCALE_FARSI : SectionLocaleUtils.LOCALE_ARABIC}).addLabels(new Locale[]{SectionLocaleUtils.LOCALE_HEBREW}).addLabels(new Locale[]{SectionLocaleUtils.LOCALE_GREEK}).addLabels(new Locale[]{SectionLocaleUtils.LOCALE_UKRAINIAN}).addLabels(new Locale[]{SectionLocaleUtils.LOCALE_HINDI}).buildImmutableIndex();

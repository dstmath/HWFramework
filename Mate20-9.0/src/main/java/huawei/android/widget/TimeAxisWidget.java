...
public class TimeAxisWidget extends LinearLayout {
    ...
    public static class Builder {
        ...
        public TimeAxisWidget build() {
            ...
            int unused = taw.mode = this.mMode;
            int unused2 = taw.axisStyle = this.mAxisStyle;
            Calendar unused3 = taw.cal = this.mCal;
            taw.updateStyle();
    ...
    private String getDigitMonthDay(Locale locale, String value) {
        ...
        if (value != null) {
            ...
            if (month >= 0 && day >= 0) {
                ...
                if (month < day) {
                    value2 = String.format(template, new Object[]{"MM", "dd"});
                } else {
                    value2 = String.format(template, new Object[]{"dd", "MM"});
                }
                return value2;
            }
        }

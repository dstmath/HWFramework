...
public class HwHalfScreenImageText extends LinearLayout {
    ...
    public void setData(ArrayList<HwImageTextBean> beanList) {
        if (beanList != null && beanList.size() != 0 && this.mViewPager != null && this.mIndicator != null) {
            ...
            this.mViewPager.setAdapter(new HwImageTextAdapter(this.mContext, list, ImageView.ScaleType.FIT_CENTER));
            ...
            this.mIndicator.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
                ...
                public void onPageSelected(int position) {
                    HwHalfScreenImageText.this.handlePageSelected(position, list);
                }

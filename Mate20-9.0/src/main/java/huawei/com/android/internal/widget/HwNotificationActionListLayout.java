...
public class HwNotificationActionListLayout extends NotificationActionListLayout {
    ...
    private boolean isMultipleLines(TextView textView) {
        ...
        float firstWordWidth = Layout.getDesiredWidth(firstWord.toUpperCase(), 0, firstWord.length(), textView.getPaint());
        float mutipleLineTextSize = (float) textView.getContext().getResources().getDimensionPixelSize(34472476);

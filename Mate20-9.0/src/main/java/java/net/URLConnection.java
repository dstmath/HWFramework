...
public abstract class URLConnection {
    ...
    public synchronized ContentHandler getContentHandler() throws IOException {
        ...
        try {
            handler2 = handlers.get(contentType);
            if (handler2 != null) {
                return handler2;
            }
        } catch (Exception e) {
        ...
        if (factory != null) {
            handler2 = factory.createContentHandler(contentType);
        }
        if (handler == null) {
            try {
    ...
    private static boolean checkfpx(InputStream is) throws IOException {
        ...
        if (skipForward(inputStream, toSkip2) < toSkip2) {
            ...
            is.reset();
            return false;
        } else if (byteOrder2 == 254 && c[0] == 0 && c[2] == 97 && c[3] == 86 && c[4] == 84 && c[5] == 193 && c[6] == 206 && c[7] == 17 && c[8] == 133 && c[9] == 83 && c[10] == 0 && c[11] == 170 && c[12] == 0 && c[13] == 161 && c[14] == 249 && c[15] == 91) {
            is.reset();
            return true;

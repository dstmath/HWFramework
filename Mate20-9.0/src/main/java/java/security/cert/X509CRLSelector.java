...
public class X509CRLSelector implements CRLSelector {
    ...
    public void setIssuers(Collection<X500Principal> issuers) {
        ...
        this.issuerX500Principals = new HashSet<>((Collection<? extends X500Principal>) issuers);
    ...
    public Object clone() {
        try {
            ...
            if (this.issuerNames != null) {
                copy.issuerNames = new HashSet<>((Collection<? extends Object>) this.issuerNames);
                copy.issuerX500Principals = new HashSet<>((Collection<? extends X500Principal>) this.issuerX500Principals);
            }
            return copy;

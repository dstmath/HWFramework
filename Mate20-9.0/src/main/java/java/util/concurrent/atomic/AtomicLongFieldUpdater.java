...
public abstract class AtomicLongFieldUpdater<T> {
    ...
    private static final class CASUpdater<T> extends AtomicLongFieldUpdater<T> {
        ...
        private final void throwAccessCheckException(T obj) {
            ...
            throw new RuntimeException((Throwable) new IllegalAccessException("Class " + this.cclass.getName() + " can not access a protected member of class " + this.tclass.getName() + " using an instance of " + obj.getClass().getName()));
        }
    ...
    private static final class LockedUpdater<T> extends AtomicLongFieldUpdater<T> {
        ...
        private final RuntimeException accessCheckException(T obj) {
            ...
            return new RuntimeException((Throwable) new IllegalAccessException("Class " + this.cclass.getName() + " can not access a protected member of class " + this.tclass.getName() + " using an instance of " + obj.getClass().getName()));
        }

...
public final class Matcher implements MatchResult {
    ...
    static {
        NativeAllocationRegistry nativeAllocationRegistry = new NativeAllocationRegistry(Matcher.class.getClassLoader(), getNativeFinalizer(), (long) nativeSize());

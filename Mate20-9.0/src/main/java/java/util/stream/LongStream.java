...
public interface LongStream extends BaseStream<Long, LongStream> {
    ...
    static LongStream range(long startInclusive, long endExclusive) {
        ...
        Streams.RangeLongSpliterator rangeLongSpliterator = new Streams.RangeLongSpliterator(startInclusive, endExclusive, false);
    ...
    static LongStream rangeClosed(long startInclusive, long endInclusive) {
        ...
        Streams.RangeLongSpliterator rangeLongSpliterator = new Streams.RangeLongSpliterator(startInclusive, endInclusive, true);
        return StreamSupport.longStream(rangeLongSpliterator, false);
    }

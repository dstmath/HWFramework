...
abstract class NameServicePacket {
    ...
    public int writeWireFormat(byte[] dst, int dstIndex) {
        ...
        return (dstIndex2 + writeBodyWireFormat(dst, dstIndex2)) - start;
    }
    ...
    public int readWireFormat(byte[] src, int srcIndex) {
        ...
        return (srcIndex2 + readBodyWireFormat(src, srcIndex2)) - start;
    }
    ...
    public int writeResourceRecordWireFormat(byte[] dst, int dstIndex) {
        ...
        return (dstIndex6 + (this.rDataLength + 2)) - start;
    }

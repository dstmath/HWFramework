...
public class StylesheetHandler extends DefaultHandler implements TemplatesHandler, PrefixResolver, NodeConsumer {
    ...
    public void init(TransformerFactoryImpl processor) {
    ...
    /* access modifiers changed from: package-private */
    public XPath createMatchPatternXPath(String str, ElemTemplateElement owningTemplate) throws TransformerException {
    ...
    /* access modifiers changed from: package-private */
    public XSLTElementProcessor getProcessorFor(String uri, String localName, String rawName) throws SAXException {
    ...
    /* access modifiers changed from: protected */
    public void error(String msg, Object[] args, Exception e) throws SAXException {
    ...
    /* access modifiers changed from: package-private */
    public void setStylesheetType(int type) {
    ...
    /* access modifiers changed from: package-private */
    public Stylesheet getLastPoppedStylesheet() {
    ...
    /* access modifiers changed from: package-private */
    public void pushProcessor(XSLTElementProcessor processor) {
    ...
    /* access modifiers changed from: package-private */
    public void pushImportSource(Source sourceFromURIResolver) {
    ...
    /* access modifiers changed from: package-private */
    public void pushSpaceHandling(boolean b) throws SAXParseException {
        this.m_spacePreserveStack.push(b);
    }

    /* access modifiers changed from: package-private */
    public void pushSpaceHandling(Attributes attrs) throws SAXParseException {

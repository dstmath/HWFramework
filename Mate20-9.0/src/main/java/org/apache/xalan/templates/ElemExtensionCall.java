            ...
            try {
                ...
                if (nsh == null) {
                    if (hasFallbackChildren()) {
                        ...
                        Object[] objArr = {getNodeName()};
                        transformer.getErrorListener().fatalError(new TransformerException(XSLMessages.createMessage(XSLTErrorResources.ER_CALL_TO_EXT_FAILED, objArr)));
                    }
                    return;
                }
                try {

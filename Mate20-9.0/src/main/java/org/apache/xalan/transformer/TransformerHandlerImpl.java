...
public class TransformerHandlerImpl implements EntityResolver, DTDHandler, ContentHandler, ErrorHandler, LexicalHandler, TransformerHandler, DeclHandler {
    ...
    /* access modifiers changed from: protected */
    public void clearCoRoutine(SAXException ex) {
        if (ex != null) {
    ...
    public void setDocumentLocator(Locator locator) {
        if (DEBUG) {
            ...
            printStream.println("TransformerHandlerImpl#setDocumentLocator: " + locator.getSystemId());
        }
    ...
    public void startPrefixMapping(String prefix, String uri) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#startPrefixMapping: " + prefix + ", " + uri);
        }
        if (this.m_contentHandler != null) {
    ...
    public void endPrefixMapping(String prefix) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#endPrefixMapping: " + prefix);
        }
        if (this.m_contentHandler != null) {
    ...
    public void startElement(String uri, String localName, String qName, Attributes atts) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#startElement: " + qName);
        }
        if (this.m_contentHandler != null) {
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#endElement: " + qName);
        }
        if (this.m_contentHandler != null) {
    ...
    public void characters(char[] ch, int start, int length) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#characters: " + start + ", " + length);
        }
        if (this.m_contentHandler != null) {
    ...
    public void ignorableWhitespace(char[] ch, int start, int length) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#ignorableWhitespace: " + start + ", " + length);
        }
        if (this.m_contentHandler != null) {
    ...
    public void processingInstruction(String target, String data) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#processingInstruction: " + target + ", " + data);
        }
        if (this.m_contentHandler != null) {
    ...
    public void skippedEntity(String name) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#skippedEntity: " + name);
        }
        if (this.m_contentHandler != null) {
    ...
    public void startDTD(String name, String publicId, String systemId) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#startDTD: " + name + ", " + publicId + ", " + systemId);
        }
    ...
    public void startEntity(String name) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#startEntity: " + name);
        }
        if (this.m_lexicalHandler != null) {
    ...
    public void endEntity(String name) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#endEntity: " + name);
        }
        if (this.m_lexicalHandler != null) {
    ...
    public void comment(char[] ch, int start, int length) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#comment: " + start + ", " + length);
        }
        if (this.m_lexicalHandler != null) {
    ...
    public void elementDecl(String name, String model) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#elementDecl: " + name + ", " + model);
        }
    ...
    public void attributeDecl(String eName, String aName, String type, String valueDefault, String value) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#attributeDecl: " + eName + ", " + aName + ", etc...");
        }
        if (this.m_declHandler != null) {
    ...
    public void internalEntityDecl(String name, String value) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#internalEntityDecl: " + name + ", " + value);
        }
        if (this.m_declHandler != null) {
    ...
    public void externalEntityDecl(String name, String publicId, String systemId) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            printStream.println("TransformerHandlerImpl#externalEntityDecl: " + name + ", " + publicId + ", " + systemId);
        }
        if (this.m_declHandler != null) {

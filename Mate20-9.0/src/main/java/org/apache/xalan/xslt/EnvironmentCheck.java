...
public class EnvironmentCheck {
            ...
            if ("-out".equalsIgnoreCase(args[i])) {
                ...
                if (i < args.length) {
                    try {
                        ...
                        printStream.println("# WARNING: -out " + args[i] + " threw " + e.toString());
                    }
                } else {
    ...
    public boolean writeEnvironmentReport(Hashtable h) {
        if (h == null) {
    ...
    /* access modifiers changed from: protected */
    public boolean logFoundJars(Vector v, String desc) {
        if (v == null || v.size() < 1) {
            return false;
        }
        boolean errors = false;
    ...
    public void appendEnvironmentReport(Node container, Document factory, Hashtable h) {
        if (container != null && factory != null) {
            try {
                ...
                PrintStream printStream = System.err;
                printStream.println("appendEnvironmentReport threw: " + e2.toString());
                e2.printStackTrace();
            }
        }
    }
    ...
    /* access modifiers changed from: protected */
    public boolean appendFoundJars(Node container, Document factory, Vector v, String desc) {
        if (v == null || v.size() < 1) {
            return false;
        }
        boolean errors = false;
    ...
    /* access modifiers changed from: protected */
    public void checkSystemProperties(Hashtable h) {
        if (h == null) {
            h = new Hashtable();
        }
        try {
    ...
    /* access modifiers changed from: protected */
    public Vector checkPathForJars(String cp, String[] jars) {
            ...
            for (int i = 0; i < jars.length; i++) {
                if (filename.indexOf(jars[i]) > -1) {
                    ...
                    if (f.exists()) {
                        ...
                        h2.put(sb.toString(), CLASS_NOTPRESENT);
                        v.addElement(h2);
                    }
                }
            }
    ...
    /* access modifiers changed from: protected */
    public String getApparentVersion(String jarName, long jarSize) {
    ...
    /* access modifiers changed from: protected */
    public void checkJAXPVersion(Hashtable h) {
        if (h == null) {
            h = new Hashtable();
        }
    ...
    /* access modifiers changed from: protected */
    public void checkProcessorVersion(Hashtable h) {
        if (h == null) {
            h = new Hashtable();
        }
        try {
        ...
        try {
            ...
            buf2.append(clazz2.getField("S_VERSION").get(null));
    ...
    /* access modifiers changed from: protected */
    public void checkParserVersion(Hashtable h) {
        if (h == null) {
            h = new Hashtable();
        }
        try {
    ...
    /* access modifiers changed from: protected */
    public void checkAntVersion(Hashtable h) {
        if (h == null) {
            h = new Hashtable();
        }
        try {
    ...
    /* access modifiers changed from: protected */
    public void checkDOMVersion(Hashtable h) {
        if (h == null) {
            h = new Hashtable();
        }
        ...
        try {
            ...
            try {
                Method method2 = ObjectFactory.findProviderClass("org.w3c.dom.Node", ObjectFactory.findClassLoader(), true).getMethod("supported", twoStringArgs);
                h.put("ERROR.version.DOM.draftlevel", "2.0wd");
                h.put(ERROR, ERROR_FOUND);
            } catch (Exception e) {
                try {
                    Method method3 = ObjectFactory.findProviderClass("org.w3c.dom.Node", ObjectFactory.findClassLoader(), true).getMethod("isSupported", twoStringArgs);
    ...
    /* access modifiers changed from: protected */
    public void checkSAXVersion(Hashtable h) {
        if (h == null) {
            h = new Hashtable();
        }
        ...
        try {
            ...
            h.put(ERROR, ERROR_FOUND);
            try {
                Method method2 = ObjectFactory.findProviderClass("org.xml.sax.XMLReader", ObjectFactory.findClassLoader(), true).getMethod("parse", oneStringArg);
                h.put("version.SAX-backlevel", "2.0beta2-or-earlier");
            } catch (Exception e2) {
                h.put("ERROR.version.SAX", "ERROR attempting to load SAX version 2 class: " + e.toString());
                h.put(ERROR, ERROR_FOUND);
                try {
                    Method method3 = ObjectFactory.findProviderClass("org.xml.sax.Parser", ObjectFactory.findClassLoader(), true).getMethod("parse", oneStringArg);

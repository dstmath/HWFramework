...
public class NamespaceMappings {
    ...
    public MappingRecord getMappingFromPrefix(String prefix) {
    ...
    /* access modifiers changed from: package-private */
    public MappingRecord getMappingFromURI(String uri) {
        Enumeration prefixes = this.m_namespaces.keys();
        while (prefixes.hasMoreElements()) {
    ...
    public boolean pushNamespace(String prefix, String uri, int elemDepth) {
        ...
        if (!stack2.empty()) {
            MappingRecord mr = (MappingRecord) stack2.peek();

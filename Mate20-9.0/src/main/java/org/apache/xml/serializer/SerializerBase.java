...
public abstract class SerializerBase implements SerializationHandler, SerializerConstants {
    ...
    public void fireEndElem(String name) throws SAXException {
    ...
    /* access modifiers changed from: protected */
    public void fireCharEvent(char[] chars, int start, int length) throws SAXException {
        if (this.m_tracer != null) {
            flushMyWriter();
    ...
    /* access modifiers changed from: protected */
    public String patchName(String qname) {
    ...
    /* access modifiers changed from: protected */
    public void setStandaloneInternal(String standalone) {
    ...
    public void setIndentAmount(int m_indentAmount2) {
        this.m_indentAmount = m_indentAmount2;
    }
    ...
    /* access modifiers changed from: protected */
    public void fireStartEntity(String name) throws SAXException {
        if (this.m_tracer != null) {
            flushMyWriter();
    ...
    /* access modifiers changed from: protected */
    public void fireCDATAEvent(char[] chars, int start, int length) throws SAXException {
        if (this.m_tracer != null) {
            flushMyWriter();
    ...
    /* access modifiers changed from: protected */
    public void fireCommentEvent(char[] chars, int start, int length) throws SAXException {
        if (this.m_tracer != null) {
            flushMyWriter();
    ...
    /* access modifiers changed from: protected */
    public void fireStartElem(String elemName) throws SAXException {
        if (this.m_tracer != null) {
            flushMyWriter();
    ...
    /* access modifiers changed from: protected */
    public void fireEscapingEvent(String name, String data) throws SAXException {
        if (this.m_tracer != null) {
            flushMyWriter();
    ...
    /* access modifiers changed from: protected */
    public void fireEntityReference(String name) throws SAXException {
        if (this.m_tracer != null) {
            flushMyWriter();
    ...
    /* access modifiers changed from: package-private */
    public void initCdataElems(String s) {
        if (s != null) {
            int max = s.length();
    ...
    /* access modifiers changed from: package-private */
    public Set getOutputPropDefaultKeys() {
        return this.m_OutputPropsDefault.keySet();
    }

    /* access modifiers changed from: package-private */
    public Set getOutputPropKeys() {
    ...
    public void setProp(String name, String val, boolean defaultVal) {
        ...
        if (defaultVal) {
            ...
            initCdataElems(val);
            if (((String) this.m_OutputProps.get(name)) == null) {
                newVal = oldVal + ' ' + val;
            } else {
                newVal = val;
            }

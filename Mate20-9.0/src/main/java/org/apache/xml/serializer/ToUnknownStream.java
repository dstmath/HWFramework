...
public final class ToUnknownStream extends SerializerBase {
    ...
    public void namespaceAfterStartElement(String prefix, String uri) throws SAXException {
        if (this.m_firstTagNotEmitted && this.m_firstElementURI == null && this.m_firstElementName != null && getPrefixPart(this.m_firstElementName) == null && "".equals(prefix)) {
    ...
    public void firePseudoElement(String elementName) {
        if (this.m_tracer != null) {

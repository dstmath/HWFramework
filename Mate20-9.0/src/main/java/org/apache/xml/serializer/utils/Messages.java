...
public final class Messages {
    ...
    private final String createMsg(ListResourceBundle fResourceBundle, String msgKey, Object[] args) {
        ...
        if (msg == null) {
            throwex = true;
            try {
                String msg2 = MessageFormat.format(MsgKey.BAD_MSGKEY, new Object[]{msgKey, this.m_resourceBundleName});
            } catch (Exception e) {
                String msg3 = "The message key '" + msgKey + "' is not in the message class '" + this.m_resourceBundleName + "'";
            }
        } else if (args != null) {
            try {
                int n = args.length;
                ...
                throwex = true;
                try {
                    String fmsg2 = MessageFormat.format(MsgKey.BAD_MSGFORMAT, new Object[]{msgKey, this.m_resourceBundleName});
                    fmsg = fmsg2 + " " + msg;
                } catch (Exception e3) {
    ...
    /* JADX WARNING: type inference failed for: r1v4, types: [java.util.ResourceBundle] */
    /* JADX WARNING: Multi-variable type inference failed */
    private ListResourceBundle loadResourceBundle(String resourceBundle) throws MissingResourceException {
        ListResourceBundle lrb;
        this.m_resourceBundleName = resourceBundle;
        try {
            lrb = ResourceBundle.getBundle(this.m_resourceBundleName, getLocale());

...
public class DOMBuilder implements ContentHandler, LexicalHandler {
    ...
    public void append(Node newNode) throws SAXException {
    ...
    public void startElement(String ns, String localName, String name, Attributes atts) throws SAXException {
        ...
        try {
            ...
            for (int i2 = 0; i2 < nDecls; i2 += 2) {
                ...
                if (prefix != null) {
                    elem.setAttributeNS(SerializerConstants.XMLNS_URI, prefix, (String) this.m_prefixMappings.elementAt(i2 + 1));
                }
            }
    ...
    public void startPrefixMapping(String prefix, String uri) throws SAXException {
        ...
        if (prefix == null || prefix.equals("")) {
            ...
            prefix2 = Constants.ATTRNAME_XMLNS + prefix;
        }

...
public class DefaultErrorHandler implements ErrorHandler, ErrorListener {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v0, resolved type: org.apache.xml.utils.SAXSourceLocator} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v1, resolved type: org.apache.xml.utils.SAXSourceLocator} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v2, resolved type: org.apache.xml.utils.SAXSourceLocator} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v4, resolved type: org.apache.xml.utils.SAXSourceLocator} */
    ...
    public static void printLocation(PrintWriter pw, Throwable exception) {
        ...
        if (locator != null) {
            if (locator.getPublicId() != null) {
                ...
                id = locator.getSystemId() != null ? locator.getSystemId() : XMLMessages.createXMLMessage(XMLErrorResources.ER_SYSTEMID_UNKNOWN, null);
            }

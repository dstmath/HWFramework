...
public class XPathContext extends DTMManager {
    ...
    public VariableStack m_variableStacks;
    ...
    public DTM getRTFDTM() {
        if (this.m_rtfdtm_stack == null) {
            ...
            SAX2RTFDTM rtfdtm = (SAX2RTFDTM) this.m_dtmManager.getDTM(null, true, null, false, false);
            ...
            SAX2RTFDTM rtfdtm2 = (SAX2RTFDTM) this.m_rtfdtm_stack.elementAt(this.m_which_rtfdtm);
            if (!rtfdtm2.isTreeIncomplete()) {
                return rtfdtm2;
            }
            ...
            SAX2RTFDTM rtfdtm3 = (SAX2RTFDTM) this.m_dtmManager.getDTM(null, true, null, false, false);
            this.m_rtfdtm_stack.addElement(rtfdtm3);
            return rtfdtm3;
        }
    }
        ...
        if (this.m_rtfdtm_stack != null) {
            if (this.m_which_rtfdtm != previous) {
                while (this.m_which_rtfdtm != previous) {
                    boolean popRewindMark = ((SAX2RTFDTM) this.m_rtfdtm_stack.elementAt(this.m_which_rtfdtm)).popRewindMark();
                    this.m_which_rtfdtm--;
                }
            } else if (previous >= 0) {

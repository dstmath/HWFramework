...
public abstract class PredicatedNodeTest extends NodeTest implements SubContextList {
    ...
    public void initPredicateInfo(Compiler compiler, int opPos) throws TransformerException {
    ...
    public boolean executePredicates(int context, XPathContext xctxt) throws TransformerException {
        int nPredicates = getPredicateCount();
        if (nPredicates == 0) {
            return true;
        }
    ...
    /* access modifiers changed from: protected */
    public String nodeToString(int n) {
        if (-1 == n) {
            return "null";
        }

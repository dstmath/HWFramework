...
public class FunctionTable {
    ...
    /* access modifiers changed from: package-private */
    public Function getFunction(int which) throws TransformerException {
        if (which >= 37) {
    ...
    /* access modifiers changed from: package-private */
    public Object getFunctionID(String key) {
    ...
    public int installFunction(String name, Class func) {
        ...
        int funcIndex2 = this.m_funcNextFreeIndex;
        this.m_funcNextFreeIndex = funcIndex2 + 1;
        this.m_functions_customer[funcIndex2 - 37] = func;
        this.m_functionID_customer.put(name, new Integer(funcIndex2));
        return funcIndex2;
    }

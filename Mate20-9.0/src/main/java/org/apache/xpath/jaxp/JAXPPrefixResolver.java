...
public class JAXPPrefixResolver implements PrefixResolver {
    ...
    public String getNamespaceForPrefix(String prefix, Node namespaceContext2) {
        String namespace = null;
        if (prefix.equals("xml")) {
            return "http://www.w3.org/XML/1998/namespace";
        }
        for (Node parent = namespaceContext2; parent != null && namespace == null; parent = parent.getParentNode()) {

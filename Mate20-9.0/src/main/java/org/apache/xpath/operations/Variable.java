...
public class Variable extends Expression implements PathComponent {
    ...
    public XObject execute(XPathContext xctxt, boolean destructiveOK) throws TransformerException {
        XObject result;
        PrefixResolver namespaceContext = xctxt.getNamespaceContext();
    ...
    public ElemVariable getElemVariable() {
        ...
        if (owner != null && (owner instanceof ElemTemplateElement)) {
            ElemTemplateElement savedprev = (ElemTemplateElement) owner;
            if (!(savedprev instanceof Stylesheet)) {
                while (savedprev != null && !(savedprev.getParentNode() instanceof Stylesheet)) {
                    ...
                    while (true) {
                        ...
                        if (previousSiblingElem == null) {
                            ...
                            ElemVariable vvar3 = (ElemVariable) prev;
                            if (vvar3.getName().equals(this.m_qname)) {
                                return vvar3;
                            }
                            vvar2 = null;
                        }
            ...
            if (savedprev != null) {
                vvar = savedprev.getStylesheetRoot().getVariableOrParamComposed(this.m_qname);
            }
        }
        return vvar;
    }

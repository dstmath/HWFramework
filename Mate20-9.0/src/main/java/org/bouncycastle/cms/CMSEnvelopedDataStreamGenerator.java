...
public class CMSEnvelopedDataStreamGenerator extends CMSEnvelopedGenerator {
    ...
    public OutputStream open(OutputStream outputStream, ASN1EncodableVector aSN1EncodableVector, OutputEncryptor outputEncryptor) throws CMSException {
        try {
            ...
            CmsEnvelopedDataOutputStream cmsEnvelopedDataOutputStream = new CmsEnvelopedDataOutputStream(outputEncryptor.getOutputStream(CMSUtils.createBEROctetOutputStream(bERSequenceGenerator3.getRawOutputStream(), 0, false, this._bufferSize)), bERSequenceGenerator, bERSequenceGenerator2, bERSequenceGenerator3);
            return cmsEnvelopedDataOutputStream;
        } catch (IOException e) {

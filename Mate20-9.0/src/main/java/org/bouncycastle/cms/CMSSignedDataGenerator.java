...
public class CMSSignedDataGenerator extends CMSSignedGenerator {
    ...
    public CMSSignedData generate(CMSTypedData cMSTypedData, boolean z) throws CMSException {
        ...
        if (this.signerInfs.isEmpty()) {
            ...
            if (cMSTypedData.getContent() != null) {
                ...
                try {
                    ...
                    if (z) {
                        ...
                        SignedData signedData = new SignedData(new DERSet(aSN1EncodableVector), new ContentInfo(contentType, bEROctetString), createBerSetFromList, aSN1Set, new DERSet(aSN1EncodableVector2));
                        return new CMSSignedData((CMSProcessable) cMSTypedData, new ContentInfo(CMSObjectIdentifiers.signedData, signedData));
                    }
                } catch (IOException e) {
            ...
            SignedData signedData2 = new SignedData(new DERSet(aSN1EncodableVector), new ContentInfo(contentType, bEROctetString), createBerSetFromList, aSN1Set, new DERSet(aSN1EncodableVector2));
            return new CMSSignedData((CMSProcessable) cMSTypedData, new ContentInfo(CMSObjectIdentifiers.signedData, signedData2));
        }

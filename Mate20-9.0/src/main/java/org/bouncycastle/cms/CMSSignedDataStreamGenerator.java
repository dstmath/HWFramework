...
public class CMSSignedDataStreamGenerator extends CMSSignedGenerator {
    ...
    private ASN1Integer calculateVersion(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        return z4 ? new ASN1Integer(5) : z2 ? new ASN1Integer(4) : z ? new ASN1Integer(3) : checkForVersion3(this._signers, this.signerGens) ? new ASN1Integer(3) : !CMSObjectIdentifiers.data.equals(aSN1ObjectIdentifier) ? new ASN1Integer(3) : new ASN1Integer(1);
    }

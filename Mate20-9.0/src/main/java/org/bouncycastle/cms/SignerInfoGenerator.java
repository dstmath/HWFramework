...
public class SignerInfoGenerator {
    ...
    public SignerInfo generate(ASN1ObjectIdentifier aSN1ObjectIdentifier) throws CMSException {
        ...
        try {
            ...
            SignerInfo signerInfo = new SignerInfo(this.signerIdentifier, algorithmIdentifier, aSN1Set, findEncryptionAlgorithm, (ASN1OctetString) new DEROctetString(signature), aSN1Set2);
            return signerInfo;
        } catch (IOException e) {

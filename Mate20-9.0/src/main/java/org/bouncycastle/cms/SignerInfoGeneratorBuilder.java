...
public class SignerInfoGeneratorBuilder {
    ...
    private SignerInfoGenerator createGenerator(ContentSigner contentSigner, SignerIdentifier signerIdentifier) throws OperatorCreationException {
        if (this.directSignature) {
            SignerInfoGenerator signerInfoGenerator = new SignerInfoGenerator(signerIdentifier, contentSigner, this.digestProvider, this.sigEncAlgFinder, true);
            ...
            SignerInfoGenerator signerInfoGenerator2 = new SignerInfoGenerator(signerIdentifier, contentSigner, this.digestProvider, this.sigEncAlgFinder, this.signedGen, this.unsignedGen);
            return signerInfoGenerator2;
        }
    }

...
public class SignerInformation {
    ...
    public static SignerInformation replaceUnsignedAttributes(SignerInformation signerInformation, AttributeTable attributeTable) {
        SignerInfo signerInfo = signerInformation.info;
        SignerInfo signerInfo2 = new SignerInfo(signerInfo.getSID(), signerInfo.getDigestAlgorithm(), signerInfo.getAuthenticatedAttributes(), signerInfo.getDigestEncryptionAlgorithm(), signerInfo.getEncryptedDigest(), (ASN1Set) attributeTable != null ? new DERSet(attributeTable.toASN1EncodableVector()) : null);
        return new SignerInformation(signerInfo2, signerInformation.contentType, signerInformation.content, null);
    }

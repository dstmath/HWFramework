...
public class CamelliaEngine implements BlockCipher {
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i) {
        ...
        int i4 = iArr[1] ^ iArr2[1 + i];
        int i5 = (SBOX2_0222[(i4 >>> 24) & 255] ^ ((SBOX1_1110[i4 & 255] ^ SBOX4_4404[(i4 >>> 8) & 255]) ^ SBOX3_3033[(i4 >>> 16) & 255])) ^ i3;
        iArr[2] = iArr[2] ^ i5;
        iArr[3] = (rightRotate(i3, 8) ^ i5) ^ iArr[3];
        int i6 = iArr[2] ^ iArr2[2 + i];
        int i7 = SBOX1_1110[(i6 >>> 24) & 255] ^ ((SBOX4_4404[i6 & 255] ^ SBOX3_3033[(i6 >>> 8) & 255]) ^ SBOX2_0222[(i6 >>> 16) & 255]);
        int i8 = iArr2[3 + i] ^ iArr[3];
        int i9 = (SBOX2_0222[(i8 >>> 24) & 255] ^ ((SBOX1_1110[i8 & 255] ^ SBOX4_4404[(i8 >>> 8) & 255]) ^ SBOX3_3033[(i8 >>> 16) & 255])) ^ i7;
        iArr[0] = iArr[0] ^ i9;
        iArr[1] = (i9 ^ rightRotate(i7, 8)) ^ iArr[1];
    }
    ...
    private static void decroldqo32(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        int i11 = 0 + i3;
        int i12 = 0 + i2;
        iArr2[i11] = (iArr[i12] >>> i8) | (iArr[i10] << i6);
        int i13 = 1 + i3;

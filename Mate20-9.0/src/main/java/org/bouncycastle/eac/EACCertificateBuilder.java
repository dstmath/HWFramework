...
public class EACCertificateBuilder {
    ...
    private CertificateBody buildBody() {
        CertificateBody certificateBody = new CertificateBody(new DERApplicationSpecific(41, ZeroArray), this.certificationAuthorityReference, this.publicKey, this.certificateHolderReference, this.certificateHolderAuthorization, this.certificateEffectiveDate, this.certificateExpirationDate);

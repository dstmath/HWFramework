...
public class JsseESTServiceBuilder extends ESTServiceBuilder {
    ...
    public ESTService build() {
        ...
        if (this.clientProvider == null) {
            DefaultESTHttpClientProvider defaultESTHttpClientProvider = new DefaultESTHttpClientProvider(this.hostNameAuthorizer, this.socketFactoryCreator, this.timeoutMillis, this.bindingProvider, this.supportedSuites, this.absoluteLimit, this.filterCipherSuites);
            this.clientProvider = defaultESTHttpClientProvider;
        }
        return super.build();
    }

        ...
        if (!(aSN1Primitive instanceof ASN1Sequence) || !(ASN1Sequence.getInstance(aSN1Primitive).size() == 2 || ASN1Sequence.getInstance(aSN1Primitive).size() == 3)) {
            ...
            if (instance.isNamedCurve()) {
                ...
                if (namedCurveByOid == null) {
                    ...
                    ECNamedCurveSpec eCNamedCurveSpec2 = new ECNamedCurveSpec(ECGOST3410NamedCurves.getName(instance2), EC5Util.convertCurve(byOID.getCurve(), byOID.getSeed()), EC5Util.convertPoint(byOID.getG()), byOID.getN(), byOID.getH());
                    eCNamedCurveSpec = eCNamedCurveSpec2;
                } else {
                    ECNamedCurveSpec eCNamedCurveSpec3 = new ECNamedCurveSpec(ECUtil.getCurveName(instance2), EC5Util.convertCurve(namedCurveByOid.getCurve(), namedCurveByOid.getSeed()), EC5Util.convertPoint(namedCurveByOid.getG()), namedCurveByOid.getN(), namedCurveByOid.getH());
                ...
                eCNamedCurveSpec = new ECParameterSpec(EC5Util.convertCurve(instance4.getCurve(), instance4.getSeed()), EC5Util.convertPoint(instance4.getG()), instance4.getN(), instance4.getH().intValue());
            }
            ...
            ECNamedCurveSpec eCNamedCurveSpec4 = new ECNamedCurveSpec(ECGOST3410NamedCurves.getName(this.gostParams.getPublicKeyParamSet()), EC5Util.convertCurve(parameterSpec.getCurve(), parameterSpec.getSeed()), EC5Util.convertPoint(parameterSpec.getG()), parameterSpec.getN(), parameterSpec.getH());
            this.ecSpec = eCNamedCurveSpec4;
    ...
    public byte[] getEncoded() {
        ...
        if (this.gostParams != null) {
            ...
            if (this.ecSpec instanceof ECNamedCurveSpec) {
                ...
                return new PrivateKeyInfo(new AlgorithmIdentifier(aSN1ObjectIdentifier, x962Parameters.toASN1Primitive()), (this.publicKey == null ? new org.bouncycastle.asn1.sec.ECPrivateKey(i, getS(), this.publicKey, x962Parameters) : new org.bouncycastle.asn1.sec.ECPrivateKey(i, getS(), (ASN1Encodable) x962Parameters)).toASN1Primitive()).getEncoded(ASN1Encoding.DER);
            } else {

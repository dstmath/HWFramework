        ...
        if (upperCase.equals("ECB")) {
            ...
            if (upperCase.startsWith("OFB")) {
                ...
                if (upperCase.length() != 3) {
                    ...
                    paddedBufferedBlockCipher = new PaddedBufferedBlockCipher(new OFBBlockCipher(this.cipher.getUnderlyingCipher(), 8 * this.cipher.getBlockSize()));
                }
                ...
                if (upperCase.length() != 3) {
                    ...
                    paddedBufferedBlockCipher = new PaddedBufferedBlockCipher(new CFBBlockCipher(this.cipher.getUnderlyingCipher(), 8 * this.cipher.getBlockSize()));
                }
            } else {

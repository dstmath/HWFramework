...
public class PKIXNameConstraintValidator {
    ...
    private String stringifyIPCollection(Set set) {
        ...
        while (set.iterator().hasNext()) {
            str = str + stringifyIP((byte[]) r4.next()) + ",";
        }
        if (str.length() > 1) {
    ...
    public String toString() {
        ...
        String str7 = str + "excluded:\n";
        if (!this.excludedSubtreesDN.isEmpty()) {
            String str8 = str7 + "DN:\n";
            str7 = str8 + this.excludedSubtreesDN.toString() + "\n";
        }
        if (!this.excludedSubtreesDNS.isEmpty()) {
            String str9 = str7 + "DNS:\n";
            str7 = str9 + this.excludedSubtreesDNS.toString() + "\n";
        }
        if (!this.excludedSubtreesEmail.isEmpty()) {
            String str10 = str7 + "Email:\n";
            str7 = str10 + this.excludedSubtreesEmail.toString() + "\n";
        }
        if (!this.excludedSubtreesURI.isEmpty()) {
            String str11 = str7 + "URI:\n";
            str7 = str11 + this.excludedSubtreesURI.toString() + "\n";
        }
        if (this.excludedSubtreesIP.isEmpty()) {
            return str7;
        }
        String str12 = str7 + "IP:\n";
        return str12 + stringifyIPCollection(this.excludedSubtreesIP) + "\n";
    }

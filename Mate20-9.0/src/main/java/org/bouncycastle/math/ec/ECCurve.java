...
public abstract class ECCurve {
    ...
    public static class F2m extends AbstractF2m {
                ...
                public ECPoint lookup(int i) {
                    ...
                    for (int i3 = 0; i3 < i7; i3++) {
                        ...
                        for (int i4 = 0; i4 < i3; i4++) {
                            ...
                            create642[i4] = create642[i4] ^ (jArr[(i3 + i2) + i4] & j);
                        }
                        i2 += i3 * 2;
                    }
                    return F2m.this.createRawPoint(new ECFieldElement.F2m(F2m.this.m, iArr, new LongArray(create64)), new ECFieldElement.F2m(F2m.this.m, iArr, new LongArray(create642)), false);
                }
            };
            return r1;
        }
        ...
        public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z) {
            ECPoint.F2m f2m = new ECPoint.F2m(this, eCFieldElement, eCFieldElement2, eCFieldElementArr, z);
            return f2m;
        }

        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            ECFieldElement.F2m f2m = new ECFieldElement.F2m(this.m, this.k1, this.k2, this.k3, bigInteger);
            return f2m;
        }
    ...
    public static class Fp extends AbstractFp {
        ...
        /* access modifiers changed from: protected */
        public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z) {
            ECPoint.Fp fp = new ECPoint.Fp(this, eCFieldElement, eCFieldElement2, eCFieldElementArr, z);
            return fp;
        }
        ...
        public ECPoint importPoint(ECPoint eCPoint) {
            if (this != eCPoint.getCurve() && getCoordinateSystem() == 2 && !eCPoint.isInfinity()) {
                switch (eCPoint.getCurve().getCoordinateSystem()) {
                    ...
                    case 3:
                    case 4:
                        ECPoint.Fp fp = new ECPoint.Fp(this, fromBigInteger(eCPoint.x.toBigInteger()), fromBigInteger(eCPoint.y.toBigInteger()), new ECFieldElement[]{fromBigInteger(eCPoint.zs[0].toBigInteger())}, eCPoint.withCompression);
                        return fp;
                }
            }
            ...
            public ECPoint lookup(int i) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    ...
                    for (int i5 = 0; i5 < fieldSize; i5++) {
                        bArr[i5] = (byte) (bArr[i5] ^ (bArr[i2 + i5] & i4));
                        bArr2[i5] = (byte) (bArr2[i5] ^ (bArr[(fieldSize + i2) + i5] & i4));
                    }
                    i2 += fieldSize * 2;
                }
        ...
        switch (b2) {
            ...
            case 4:
                if (bArr.length == (2 * fieldSize) + 1) {
                    eCPoint = validatePoint(BigIntegers.fromUnsignedByteArray(bArr, 1, fieldSize), BigIntegers.fromUnsignedByteArray(bArr, 1 + fieldSize, fieldSize));
                    break;
                } else {

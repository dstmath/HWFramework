...
public class SM2P256V1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SM2P256V1Point sM2P256V1Point = new SM2P256V1Point(curve, sM2P256V1FieldElement7, sM2P256V1FieldElement8, new ECFieldElement[]{sM2P256V1FieldElement9}, this.withCompression);
    ...
    public ECPoint negate() {
        ...
        SM2P256V1Point sM2P256V1Point = new SM2P256V1Point(this.curve, this.x, this.y.negate(), this.zs, this.withCompression);
        return sM2P256V1Point;
    }
    ...
    public ECPoint twice() {
        ...
        SM2P256V1FieldElement sM2P256V1FieldElement7 = sM2P256V1FieldElement4;
        SM2P256V1FieldElement sM2P256V1FieldElement8 = sM2P256V1FieldElement5;
        SM2P256V1Point sM2P256V1Point = new SM2P256V1Point(curve, sM2P256V1FieldElement7, sM2P256V1FieldElement8, new ECFieldElement[]{sM2P256V1FieldElement6}, this.withCompression);
        return sM2P256V1Point;
    }

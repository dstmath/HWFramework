...
public class SecP128R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP128R1Point secP128R1Point = new SecP128R1Point(curve, secP128R1FieldElement7, secP128R1FieldElement8, new ECFieldElement[]{secP128R1FieldElement9}, this.withCompression);
    ...
    public ECPoint negate() {
        ...
        SecP128R1Point secP128R1Point = new SecP128R1Point(this.curve, this.x, this.y.negate(), this.zs, this.withCompression);
        return secP128R1Point;
    }
    ...
    public ECPoint twice() {
        ...
        SecP128R1FieldElement secP128R1FieldElement7 = secP128R1FieldElement4;
        SecP128R1FieldElement secP128R1FieldElement8 = secP128R1FieldElement5;
        SecP128R1Point secP128R1Point = new SecP128R1Point(curve, secP128R1FieldElement7, secP128R1FieldElement8, new ECFieldElement[]{secP128R1FieldElement6}, this.withCompression);
        return secP128R1Point;
    }

...
public class SecP160K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP160K1Point secP160K1Point = new SecP160K1Point(curve, secP160R2FieldElement7, secP160R2FieldElement8, new ECFieldElement[]{secP160R2FieldElement9}, this.withCompression);
        return secP160K1Point;
    }
    ...
    public ECPoint negate() {
        ...
        SecP160K1Point secP160K1Point = new SecP160K1Point(this.curve, this.x, this.y.negate(), this.zs, this.withCompression);
        return secP160K1Point;
    }
    ...
    public ECPoint twice() {
        ...
        SecP160K1Point secP160K1Point = new SecP160K1Point(curve, secP160R2FieldElement4, secP160R2FieldElement5, new ECFieldElement[]{secP160R2FieldElement6}, this.withCompression);
        return secP160K1Point;
    }

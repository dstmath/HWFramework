...
public class SecP160R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP160R1Point secP160R1Point = new SecP160R1Point(curve, secP160R1FieldElement7, secP160R1FieldElement8, new ECFieldElement[]{secP160R1FieldElement9}, this.withCompression);
    ...
    public ECPoint negate() {
        ...
        SecP160R1Point secP160R1Point = new SecP160R1Point(this.curve, this.x, this.y.negate(), this.zs, this.withCompression);
        return secP160R1Point;
    }
    ...
    public ECPoint twice() {
        ...
        SecP160R1FieldElement secP160R1FieldElement7 = secP160R1FieldElement4;
        SecP160R1FieldElement secP160R1FieldElement8 = secP160R1FieldElement5;
        SecP160R1Point secP160R1Point = new SecP160R1Point(curve, secP160R1FieldElement7, secP160R1FieldElement8, new ECFieldElement[]{secP160R1FieldElement6}, this.withCompression);
        return secP160R1Point;
    }

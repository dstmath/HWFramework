...
public class SecP521R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint r18) {
        ...
        int[] iArr3;
        int[] iArr4;
        SecP521R1Point secP521R1Point = r18;
        if (isInfinity()) {
        ...
        SecP521R1FieldElement secP521R1FieldElement3 = (SecP521R1FieldElement) r18.getXCoord();
        SecP521R1FieldElement secP521R1FieldElement4 = (SecP521R1FieldElement) r18.getYCoord();
        SecP521R1FieldElement secP521R1FieldElement5 = (SecP521R1FieldElement) this.zs[0];
        SecP521R1FieldElement secP521R1FieldElement6 = (SecP521R1FieldElement) secP521R1Point.getZCoord(0);
        ...
        SecP521R1Point secP521R1Point2 = new SecP521R1Point(curve, secP521R1FieldElement7, secP521R1FieldElement8, new ECFieldElement[]{secP521R1FieldElement9}, this.withCompression);
        return secP521R1Point2;
    }

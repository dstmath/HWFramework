...
public class SecT113R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecT113R2Point secT113R2Point = new SecT113R2Point(curve, eCFieldElement6, eCFieldElement5, new ECFieldElement[]{eCFieldElement4}, this.withCompression);
    ...
    public ECPoint negate() {
        ...
        SecT113R2Point secT113R2Point = new SecT113R2Point(eCCurve2, eCFieldElement, add, new ECFieldElement[]{eCFieldElement3}, this.withCompression);
        return secT113R2Point;
    }
    ...
    public ECPoint twice() {
        ...
        SecT113R2Point secT113R2Point = new SecT113R2Point(curve, square2, eCFieldElement.squarePlusProduct(add, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2}, this.withCompression);
        return secT113R2Point;
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        SecT113R2Point secT113R2Point = new SecT113R2Point(curve, multiply2, multiplyPlusProduct.add(square4).square().multiplyPlusProduct(add, addOne, multiply3), new ECFieldElement[]{multiply3}, this.withCompression);
        return secT113R2Point;
    }
}

...
public class SecT163K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecT163K1Point secT163K1Point = new SecT163K1Point(curve, eCFieldElement6, eCFieldElement5, new ECFieldElement[]{eCFieldElement4}, this.withCompression);
    ...
    public ECPoint negate() {
        ...
        SecT163K1Point secT163K1Point = new SecT163K1Point(eCCurve2, eCFieldElement, add, new ECFieldElement[]{eCFieldElement3}, this.withCompression);
        return secT163K1Point;
    }
    ...
    public ECPoint twice() {
        ...
        SecT163K1Point secT163K1Point = new SecT163K1Point(curve, square, square2.add(add).add(eCFieldElement3).multiply(square2).add(square), new ECFieldElement[]{multiply2}, this.withCompression);
        return secT163K1Point;
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        SecT163K1Point secT163K1Point = new SecT163K1Point(curve, multiply2, multiplyPlusProduct.add(square4).square().multiplyPlusProduct(add, rawYCoord.addOne(), multiply3), new ECFieldElement[]{multiply3}, this.withCompression);
        return secT163K1Point;
    }
}

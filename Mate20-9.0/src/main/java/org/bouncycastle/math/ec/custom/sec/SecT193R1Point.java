...
public class SecT193R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecT193R1Point secT193R1Point = new SecT193R1Point(curve, eCFieldElement6, eCFieldElement5, new ECFieldElement[]{eCFieldElement4}, this.withCompression);
    ...
    public ECPoint negate() {
        ...
        SecT193R1Point secT193R1Point = new SecT193R1Point(eCCurve2, eCFieldElement, add, new ECFieldElement[]{eCFieldElement3}, this.withCompression);
        return secT193R1Point;
    }
    ...
    public ECPoint twice() {
        ...
        SecT193R1Point secT193R1Point = new SecT193R1Point(curve, square2, eCFieldElement.squarePlusProduct(add, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2}, this.withCompression);
        return secT193R1Point;
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        SecT193R1Point secT193R1Point = new SecT193R1Point(curve, multiply2, multiplyPlusProduct.add(square4).square().multiplyPlusProduct(add, addOne, multiply3), new ECFieldElement[]{multiply3}, this.withCompression);
        return secT193R1Point;
    }
}

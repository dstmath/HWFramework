...
public class SecT233Field {
    ...
    protected static void implMulwAcc(long j, long j2, long[] jArr, int i) {
        ...
        while (true) {
            int i5 = (int) (j3 >>> i4);
            long j6 = jArr2[i5 & 7] ^ (jArr2[(i5 >>> 3) & i2] << 3);
            j4 ^= j6 << i4;
            j5 ^= j6 >>> (-i4);
            i4 -= 6;
            if (i4 <= 0) {
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        while (i < iArr.length) {
            int i2 = iArr[i] >>> 6;
            int i3 = iArr[i] & 63;
            createExt64[i2] = createExt64[i2] ^ (j8 << i3);
            int i4 = i2 + 1;
            int[] iArr2 = iArr;
            int i5 = -i3;
            createExt64[i4] = createExt64[i4] ^ ((j7 << i3) | (j8 >>> i5));
            int i6 = i2 + 2;
            createExt64[i6] = createExt64[i6] ^ ((j6 << i3) | (j7 >>> i5));
            int i7 = i2 + 3;
            createExt64[i7] = createExt64[i7] ^ (j6 >>> i5);
            i++;
            iArr = iArr2;
        }
        reduce(createExt64, jArr3);

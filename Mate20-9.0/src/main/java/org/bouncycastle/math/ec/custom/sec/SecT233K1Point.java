...
public class SecT233K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecT233K1Point secT233K1Point = new SecT233K1Point(curve, eCFieldElement6, eCFieldElement5, new ECFieldElement[]{eCFieldElement4}, this.withCompression);
    ...
    public ECPoint negate() {
        ...
        SecT233K1Point secT233K1Point = new SecT233K1Point(eCCurve2, eCFieldElement, add, new ECFieldElement[]{eCFieldElement3}, this.withCompression);
        return secT233K1Point;
    }
    ...
    public ECPoint twice() {
        ...
        SecT233K1Point secT233K1Point = new SecT233K1Point(curve, square2, square3.add(add).add(square).multiply(square3).add(eCFieldElement3).add(square2).add(multiply), new ECFieldElement[]{multiply}, this.withCompression);
        return secT233K1Point;
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        SecT233K1Point secT233K1Point = new SecT233K1Point(curve, multiply2, multiplyPlusProduct.add(square4).square().multiplyPlusProduct(add, addOne, multiply3), new ECFieldElement[]{multiply3}, this.withCompression);
        return secT233K1Point;
    }
}

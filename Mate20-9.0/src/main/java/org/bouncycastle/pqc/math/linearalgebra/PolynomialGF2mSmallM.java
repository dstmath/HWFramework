...
public class PolynomialGF2mSmallM {
    ...
    public PolynomialGF2mSmallM[] modPolynomialToFracton(PolynomialGF2mSmallM polynomialGF2mSmallM) {
        ...
        int[] iArr4 = mod;
        while (computeDegree(iArr4) > i) {
            int[][] div = div(iArr3, iArr4);
            int[] iArr5 = div[1];
        ...
        return new PolynomialGF2mSmallM[]{new PolynomialGF2mSmallM(this.field, iArr4), new PolynomialGF2mSmallM(this.field, iArr2)};
    }

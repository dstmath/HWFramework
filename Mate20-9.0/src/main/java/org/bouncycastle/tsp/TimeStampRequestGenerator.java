...
public class TimeStampRequestGenerator {
    ...
    public TimeStampRequest generate(String str, byte[] bArr, BigInteger bigInteger) {
        if (str != null) {
            ...
            if (bigInteger != null) {
                TimeStampReq timeStampReq = new TimeStampReq(messageImprint, this.reqPolicy, new ASN1Integer(bigInteger), this.certReq, extensions2);
                return new TimeStampRequest(timeStampReq);
            }
            TimeStampReq timeStampReq2 = new TimeStampReq(messageImprint, this.reqPolicy, null, this.certReq, extensions2);
            return new TimeStampRequest(timeStampReq2);
        }

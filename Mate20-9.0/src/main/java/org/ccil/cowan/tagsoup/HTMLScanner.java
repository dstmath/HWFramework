    ...
    static {
        ...
        for (int theState2 = 0; theState2 <= maxState; theState2++) {
            for (int ch = -2; ch <= maxChar; ch++) {
                ...
                int i2 = 0;
                while (true) {
                    if (i2 >= statetable.length) {
                        break;
                    }
                    if (theState2 != statetable[i2]) {
                        if (action != 0) {
                            break;
                        }
    ...
    public void scan(Reader r0, ScanHandler h) throws IOException, SAXException {
        ...
        while (this.theState != 21) {
            ...
            if (ch >= 32 || ch == 10 || ch == 9 || ch == -1) {
                short statetableRow = statetableIndex[this.theState][((ch < -1 || ch >= statetableIndexMaxChar) ? -2 : ch) + 2];
                int action = 0;
                if (statetableRow != -1) {
                                ...
                                if (ent >= 32) {
                                    if (ent < 55296 || ent > 57343) {
                                        if (ent <= 65535) {
                                            ...
                                            save((ent2 >> 10) + 55296, scanHandler);
                                            save((ent2 & 1023) + 56320, scanHandler);
                                        }
                                    }
                                }
                                if (ch != 59) {

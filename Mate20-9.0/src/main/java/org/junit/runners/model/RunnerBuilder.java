...
public abstract class RunnerBuilder {
    ...
    public Class<?> addParent(Class<?> parent) throws InitializationError {
    ...
    /* access modifiers changed from: package-private */
    public void removeParent(Class<?> klass) {
    ...
    public List<Runner> runners(Class<?> parent, List<Class<?>> children) throws InitializationError {
        return runners(parent, (Class<?>[]) (Class[]) children.toArray(new Class[0]));
    }

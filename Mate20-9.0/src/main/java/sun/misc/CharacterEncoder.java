...
public abstract class CharacterEncoder {
    ...
    public void encode(byte[] aBuffer, OutputStream aStream) throws IOException {
        encode((InputStream) new ByteArrayInputStream(aBuffer), aStream);
    }

    public String encode(byte[] aBuffer) {
        ByteArrayOutputStream outStream = new ByteArrayOutputStream();
        try {
            encode((InputStream) new ByteArrayInputStream(aBuffer), (OutputStream) outStream);
    ...
    public void encodeBuffer(byte[] aBuffer, OutputStream aStream) throws IOException {
        encodeBuffer((InputStream) new ByteArrayInputStream(aBuffer), aStream);
    }

    public String encodeBuffer(byte[] aBuffer) {
        ByteArrayOutputStream outStream = new ByteArrayOutputStream();
        try {
            encodeBuffer((InputStream) new ByteArrayInputStream(aBuffer), (OutputStream) outStream);

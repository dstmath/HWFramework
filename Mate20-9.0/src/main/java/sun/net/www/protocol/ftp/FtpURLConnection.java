...
public class FtpURLConnection extends URLConnection {
    ...
    public synchronized void connect() throws IOException {
        if (!this.connected) {
            ...
            try {
                ...
                throw new IOException((Throwable) fe);
    ...
    public InputStream getInputStream() throws IOException {
        ...
        if (this.os != null) {
            ...
            try {
                ...
                if (this.filename != null) {
                    if (this.type != 3) {
                        ...
                        if (0 == 0) {
                            ...
                            String ftype = guessContentTypeFromName(this.fullpath);
                            if (ftype == null && this.is.markSupported()) {
                                ftype = guessContentTypeFromStream(this.is);
                            }
                            if (ftype != null) {
                ...
                throw new IOException((Throwable) ftpe);
            }
            setProperties(msgh);
            return this.is;
        }
    ...
    public String getRequestProperty(String key) {
        ...
        return this.type == 1 ? "a" : this.type == 3 ? "d" : "i";
    }

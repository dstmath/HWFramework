...
public final class RILCallDetails {
    ...
    public final String toString() {
        return "{" + ".callType = " + RILCallType.toString(this.callType) + ", .callDomain = " + RILCallDomain.toString(this.callDomain) + ", .extrasLength = " + this.extrasLength + ", .extras = " + this.extras + "}";
    }

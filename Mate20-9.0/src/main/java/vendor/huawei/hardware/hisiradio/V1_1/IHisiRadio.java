...
public interface IHisiRadio extends vendor.huawei.hardware.hisiradio.V1_0.IHisiRadio {
    ...
    public static abstract class Stub extends HwBinder implements IHisiRadio {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IHisiRadio.kInterfaceName, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadio.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    hwParcel.enforceInterface(vendor.huawei.hardware.hisiradio.V1_0.IHisiRadio.kInterfaceName);

...
public interface ISupplicant extends vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicant {
    public static final String kInterfaceName = "vendor.huawei.hardware.wifi.supplicant@2.1::ISupplicant";
    ...
    public static final class Proxy implements ISupplicant {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.wifi.supplicant@2.1::ISupplicant]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ISupplicant {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{ISupplicant.kInterfaceName, vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicant.kInterfaceName, android.hardware.wifi.supplicant.V1_1.ISupplicant.kInterfaceName, android.hardware.wifi.supplicant.V1_0.ISupplicant.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-73, 92, 126, 44, 123, -109, 56, -14, 8, -55, -62, 117, 51, -29, 39, -23, 54, 94, 31, -23, -110, 108, 44, 120, -102, -78, -52, 111, 15, -37, -4, -115}, new byte[]{-48, -60, -22, -10, 6, 98, WifiLoggerHal.WIFI_ALERT_REASON_MAX, -13, 119, -7, 7, -34, -63, -121, -74, -102, -93, -89, 95, 21, -91, -16, 11, 111, 69, -37, 15, -25, -91, -121, 116, -97}, new byte[]{-29, 98, 32, 59, -108, 31, 24, -67, 76, -70, 41, -90, 42, -33, -96, 36, 83, -19, 0, -42, -66, 91, 114, -51, -74, -60, -41, -32, -65, 57, 74, WifiLoggerHal.WIFI_ALERT_REASON_MAX}, new byte[]{-9, -27, 92, 8, 24, 125, -116, -123, 80, 104, -95, -18, 61, 12, -115, -82, -18, 117, 112, 41, 45, -106, 80, -100, 33, -88, 117, 109, 79, 92, -5, -101}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}}));
        }

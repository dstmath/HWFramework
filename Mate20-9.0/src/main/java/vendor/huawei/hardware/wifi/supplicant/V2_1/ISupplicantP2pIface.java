...
public interface ISupplicantP2pIface extends vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantP2pIface {
    public static final String kInterfaceName = "vendor.huawei.hardware.wifi.supplicant@2.1::ISupplicantP2pIface";
    ...
    public static final class Proxy implements ISupplicantP2pIface {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.wifi.supplicant@2.1::ISupplicantP2pIface]@Proxy";
            }
        }
        ...
        public SupplicantStatus hwP2pRegisterCallback(vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantP2pIfaceCallback callback) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantP2pIface.kInterfaceName);
            _hidl_request.writeStrongBinder(callback == null ? null : callback.asBinder());
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public void getP2pLinkspeed(String ifaceName, ISupplicantP2pIface.getP2pLinkspeedCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantP2pIface.kInterfaceName);
        ...
        public SupplicantStatus hwP2pRegisterCallback_2_1(ISupplicantP2pIfaceCallback callback) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantP2pIface {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{ISupplicantP2pIface.kInterfaceName, vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantP2pIface.kInterfaceName, android.hardware.wifi.supplicant.V1_0.ISupplicantP2pIface.kInterfaceName, ISupplicantIface.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{91, 67, -16, -65, 21, -123, WifiLoggerHal.WIFI_ALERT_REASON_MAX, -59, 111, 37, 96, -19, -122, 9, 7, 5, 81, -91, 11, -40, 87, 77, 38, 32, 119, -54, -116, 100, 107, -56, 27, 112}, new byte[]{71, 24, 106, -85, -19, 1, 120, -43, 76, -21, -87, 73, -76, -29, 71, -68, 121, -91, -99, 116, -46, -118, 13, 60, 53, 0, -71, -116, 80, 83, 69, -25}, new byte[]{73, 7, 65, 3, 56, -59, -24, -37, -18, -60, -75, -19, -62, 96, -114, -93, 35, -11, 86, 25, 69, -8, -127, 10, -8, 24, 16, -60, 123, 1, -111, -124}, new byte[]{53, -70, 123, -51, -15, -113, 36, -88, 102, -89, -27, 66, -107, 72, -16, 103, 104, -69, 32, -94, 87, -9, 91, 16, -93, -105, -60, -40, 37, -17, -124, 56}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 54:
                    ...
                    hwParcel.enforceInterface(vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantP2pIface.kInterfaceName);
                    SupplicantStatus _hidl_out_status41 = hwP2pRegisterCallback(vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantP2pIfaceCallback.asInterface(_hidl_request.readStrongBinder()));
                    hwParcel2.writeStatus(0);
                ...
                case 56:
                    ...
                    hwParcel2.writeStatus(0);
                    _hidl_out_status43.writeToParcel(hwParcel2);
                    _hidl_reply.send();
                    return;
                case 57:
                    if (_hidl_flags == false || !true) {
                    ...
                    hwParcel2.writeStatus(0);
                    _hidl_out_status44.writeToParcel(hwParcel2);
                    _hidl_reply.send();
                    return;
                case 58:
                    if (_hidl_flags != false && true) {
                    ...
                    hwParcel.enforceInterface(vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantP2pIface.kInterfaceName);
                    getP2pLinkspeed(_hidl_request.readString(), new ISupplicantP2pIface.getP2pLinkspeedCallback() {
                ...
                case 59:
                    ...
                    SupplicantStatus _hidl_out_status45 = hwP2pRegisterCallback_2_1(ISupplicantP2pIfaceCallback.asInterface(_hidl_request.readStrongBinder()));
                    hwParcel2.writeStatus(0);
                    _hidl_out_status45.writeToParcel(hwParcel2);
                    _hidl_reply.send();
                    return;
                default:
                    switch (_hidl_code) {
    ...
    SupplicantStatus hwP2pRegisterCallback_2_1(ISupplicantP2pIfaceCallback iSupplicantP2pIfaceCallback) throws RemoteException;

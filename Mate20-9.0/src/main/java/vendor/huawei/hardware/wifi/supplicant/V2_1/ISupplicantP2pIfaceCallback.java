...
public interface ISupplicantP2pIfaceCallback extends vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantP2pIfaceCallback {
    public static final String kInterfaceName = "vendor.huawei.hardware.wifi.supplicant@2.1::ISupplicantP2pIfaceCallback";
    ...
    public static final class Proxy implements ISupplicantP2pIfaceCallback {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.wifi.supplicant@2.1::ISupplicantP2pIfaceCallback]@Proxy";
            }
        }
        ...
        public void onP2pInterfaceCreated(String stringData) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantP2pIfaceCallback.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantP2pIfaceCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{ISupplicantP2pIfaceCallback.kInterfaceName, vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantP2pIfaceCallback.kInterfaceName, android.hardware.wifi.supplicant.V1_0.ISupplicantP2pIfaceCallback.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 18:
                    ...
                    hwParcel.enforceInterface(vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantP2pIfaceCallback.kInterfaceName);
                ...
                case 19:
                    ...
                    hwParcel.readBuffer(6).copyToInt8Array(0, srcAddress7, 6);
                    byte[] p2pDeviceAddress6 = new byte[6];
                    hwParcel.readBuffer(6).copyToInt8Array(0, p2pDeviceAddress6, 6);
                    byte[] primaryDeviceType2 = new byte[8];
                    hwParcel.readBuffer(8).copyToInt8Array(0, primaryDeviceType2, 8);
                    ...
                    hwParcel.readBuffer(128).copyToInt8Array(0, wfdDeviceInfo2, 128);
                    byte[] bArr5 = primaryDeviceType2;
                    byte[] bArr6 = p2pDeviceAddress6;

...
public interface ISupplicantStaIfaceCallback extends vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantStaIfaceCallback {
    public static final String kInterfaceName = "vendor.huawei.hardware.wifi.supplicant@2.1::ISupplicantStaIfaceCallback";
    ...
    public static final class Proxy implements ISupplicantStaIfaceCallback {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.wifi.supplicant@2.1::ISupplicantStaIfaceCallback]@Proxy";
            }
        }
        ...
        public void onHilinkStartWps(String arg) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantStaIfaceCallback.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantStaIfaceCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{ISupplicantStaIfaceCallback.kInterfaceName, vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantStaIfaceCallback.kInterfaceName, android.hardware.wifi.supplicant.V1_1.ISupplicantStaIfaceCallback.kInterfaceName, android.hardware.wifi.supplicant.V1_0.ISupplicantStaIfaceCallback.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 19:
                    ...
                    _hidl_request.enforceInterface(vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantStaIfaceCallback.kInterfaceName);

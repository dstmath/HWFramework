...
public interface ISupplicantStaNetworkCallback extends vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantStaNetworkCallback {
    public static final String kInterfaceName = "vendor.huawei.hardware.wifi.supplicant@2.1::ISupplicantStaNetworkCallback";
    ...
    public static final class Proxy implements ISupplicantStaNetworkCallback {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.wifi.supplicant@2.1::ISupplicantStaNetworkCallback]@Proxy";
            }
        }
        ...
        public void onNetworkEapNotificationErrorCode(int errorCode) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantStaNetworkCallback.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantStaNetworkCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{ISupplicantStaNetworkCallback.kInterfaceName, vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantStaNetworkCallback.kInterfaceName, android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetworkCallback.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{119, 107, -48, 74, Byte.MAX_VALUE, 42, -68, -113, 25, -65, -113, 53, 28, 108, -109, 14, 106, -39, -55, 17, 113, 0, 119, 57, -65, 4, -3, -117, -59, 77, 6, 20}, new byte[]{58, -113, WifiLoggerHal.WIFI_ALERT_REASON_MAX, -126, -22, 43, 113, -123, 117, 2, -125, -38, -15, 107, 88, -17, Byte.MIN_VALUE, 16, 44, -73, 91, -3, 12, -10, -46, -56, 56, -14, -82, 63, -38, -117}, new byte[]{-40, -16, -121, 122, -31, -45, 33, -63, -40, -124, -57, 99, 29, -2, 54, -54, -80, -20, -118, 75, 40, 99, -44, -74, -121, -8, 93, 53, 73, -90, 59, -52}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 4:
                    ...
                    _hidl_request.enforceInterface(vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantStaNetworkCallback.kInterfaceName);

...
public interface IApplicationThread extends IInterface {
    ...
    void scheduleFreeFormOutLineChangedForFloating(IBinder iBinder, int i) throws RemoteException;

    void scheduleGetFreeFormInfo(IBinder iBinder, int i) throws RemoteException;
    ...
    public static class Default implements IApplicationThread {
        ...
        @Override // android.app.IApplicationThread
        public void scheduleGetFreeFormInfo(IBinder token, int direction) throws RemoteException {
        }

        @Override // android.app.IApplicationThread
        public void scheduleFreeFormOutLineChangedForFloating(IBinder token, int touchingState) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IApplicationThread {
        ...
        static final int TRANSACTION_notifyAppToTop = 63;
        static final int TRANSACTION_notifyCleartextNetwork = 44;
        static final int TRANSACTION_notifyHwMultiWindowCaption = 64;
        static final int TRANSACTION_performDirectAction = 62;
        static final int TRANSACTION_preLoadClass = 65;
        ...
        static final int TRANSACTION_requestDirectActions = 61;
        ...
        static final int TRANSACTION_scheduleFreeFormOutLineChangedForFloating = 59;
        static final int TRANSACTION_scheduleGetFreeFormInfo = 58;
        ...
        static final int TRANSACTION_scheduleRestoreFreeFormConfig = 60;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 58:
                    return "scheduleGetFreeFormInfo";
                case 59:
                    return "scheduleFreeFormOutLineChangedForFloating";
                case 60:
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 58:
                        data.enforceInterface(DESCRIPTOR);
                        scheduleGetFreeFormInfo(data.readStrongBinder(), data.readInt());
                        return true;
                    case 59:
                        data.enforceInterface(DESCRIPTOR);
                        scheduleFreeFormOutLineChangedForFloating(data.readStrongBinder(), data.readInt());
                        return true;
                    case 60:
                        data.enforceInterface(DESCRIPTOR);
            ...
            public void scheduleGetFreeFormInfo(IBinder token, int direction) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(58, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        ...
                        Stub.getDefaultImpl().scheduleGetFreeFormInfo(token, direction);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void scheduleFreeFormOutLineChangedForFloating(IBinder token, int touchingState) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(59, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        ...
                        Stub.getDefaultImpl().scheduleFreeFormOutLineChangedForFloating(token, touchingState);
                    }
                } finally {
                    _data.recycle();
                }

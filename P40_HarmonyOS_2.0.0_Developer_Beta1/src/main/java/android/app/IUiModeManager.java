...
public interface IUiModeManager extends IInterface {
    ...
    void setNightModeForUser(int i, int i2) throws RemoteException;

    void setUserIdAndNightMode(int i, int i2) throws RemoteException;
    ...
    public static class Default implements IUiModeManager {
        ...
        @Override // android.app.IUiModeManager
        public void setNightModeForUser(int mode, int userHandle) throws RemoteException {
        }

        @Override // android.app.IUiModeManager
        public void setUserIdAndNightMode(int userId, int mode) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IUiModeManager {
        ...
        static final int TRANSACTION_setNightModeForUser = 5;
        static final int TRANSACTION_setUserIdAndNightMode = 6;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 4:
                    return "setNightMode";
                case 5:
                    return "setNightModeForUser";
                case 6:
                    return "setUserIdAndNightMode";
                case 7:
                    return "getNightMode";
                case 8:
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 5:
                        data.enforceInterface(DESCRIPTOR);
                        setNightModeForUser(data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 6:
                        data.enforceInterface(DESCRIPTOR);
                        setUserIdAndNightMode(data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 7:
                        data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements IUiModeManager {
            ...
            public void setNightModeForUser(int mode, int userHandle) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().setNightModeForUser(mode, userHandle);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void setUserIdAndNightMode(int userId, int mode) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().setUserIdAndNightMode(userId, mode);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }

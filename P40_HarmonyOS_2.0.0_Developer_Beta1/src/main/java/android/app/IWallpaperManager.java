...
public interface IWallpaperManager extends IInterface {
    ...
    ParcelFileDescriptor screenshotLiveWallpaper(float f, int i) throws RemoteException;
    ...
    public static class Default implements IWallpaperManager {
        ...
        @Override // android.app.IWallpaperManager
        public ParcelFileDescriptor screenshotLiveWallpaper(float scale, int config) throws RemoteException {
            return null;
        }
    ...
    public static abstract class Stub extends Binder implements IWallpaperManager {
        ...
        static final int TRANSACTION_screenshotLiveWallpaper = 29;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 29:
                    return "screenshotLiveWallpaper";
                default:
                    return null;
            }
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 29:
                        data.enforceInterface(DESCRIPTOR);
                        ParcelFileDescriptor _result13 = screenshotLiveWallpaper(data.readFloat(), data.readInt());
                        reply.writeNoException();
                        if (_result13 != null) {
                            reply.writeInt(1);
            ...
            public ParcelFileDescriptor screenshotLiveWallpaper(float scale, int config) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(29, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().screenshotLiveWallpaper(scale, config);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = ParcelFileDescriptor.CREATOR.createFromParcel(_reply);

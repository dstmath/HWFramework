...
public class Notification implements Parcelable {
    ...
    public static class Builder {
        ...
        private HwCustNotification mHwCustNotification;
        ...
        public Builder(Context context, Notification toAdopt) {
            this.mHwCustNotification = (HwCustNotification) HwCustUtils.createObj(HwCustNotification.class, new Object[0]);
        ...
        private RemoteViews applyStandardTemplateWithActions(int layoutId, StandardTemplateParams p, TemplateBindResult result) {
            ...
            HwCustNotification hwCustNotification = this.mHwCustNotification;
            if (hwCustNotification != null) {
                emphazisedMode = hwCustNotification.calculateEmphazisedMode(this.mN.fullScreenIntent != null);
            }
            ...
            if (N > 0) {
                ...
                for (int i2 = 0; i2 < N; i2++) {
                    ...
                    if (action != null) {
                        ...
                        big.addView(R.id.actions, generateActionButton(action, emphazisedMode, p));
                    }
                }
            } else {
        ...
        public RemoteViews createLineView(String nType) {
            int layoutId;
            if ("single_notification_drag_type".equals(nType)) {
                layoutId = R.layout.notification_single_drop;
            } else {
                layoutId = R.layout.notification_template_header;
            }
            ...
            RemoteViews header = new BuilderRemoteViews(this.mContext.getApplicationInfo(), layoutId);

...
public class SearchManager implements DialogInterface.OnDismissListener, DialogInterface.OnCancelListener {
    ...
    private IIndexSearchManager mIndexSearchManager = null;
    @UnsupportedAppUsage
    ...
    public IIndexSearchManager getHwIndexSearchManager() {
        return this.mIndexSearchManager;
    }

    public void setHwIndexSearchManager(IIndexSearchManager indexSearchManager) {
        this.mIndexSearchManager = indexSearchManager;
    }
}

...
public class TaskInfo {
    ...
    @UnsupportedAppUsage
    public boolean isSupportsHwFreeForm;
    @UnsupportedAppUsage
    ...
    public void readFromParcel(Parcel source) {
        ...
        this.bounds = rect;
        this.stackScale = source.readFloat();
        this.isSupportsHwFreeForm = source.readBoolean();
    }

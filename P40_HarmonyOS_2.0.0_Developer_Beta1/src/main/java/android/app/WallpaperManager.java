...
public class WallpaperManager {
    ...
    public static class Globals extends IWallpaperManagerCallback.Stub {
        ...
        public Bitmap peekWallpaperBitmap(Context context, boolean returnDefault, int which, int userId, boolean hardware) {
            ...
            Bitmap defaultWallpaper2 = getDefaultWallpaper(context, userId);
            if (defaultWallpaper2 != null) {
                this.wallpaperWidth = defaultWallpaper2.getWidth();
                this.wallpaperHeight = defaultWallpaper2.getHeight();
            } else {
                this.wallpaperWidth = 0;
                this.wallpaperHeight = 0;
            }
                ...
                if (fd != null) {
                    ...
                    try {
                        ...
                        if (HwFoldScreenManager.isFoldable()) {
                            ...
                            sb.append("getCurrentWallpaperLocked width = ");
    ...
    public void setWallpaperOffsets(IBinder windowToken, float xOffset, float yOffset) {
        try {
            String str = TAG;
            Log.i(str, "setWallpaperOffsets wallpaper = [" + xOffset + SmsManager.REGEX_PREFIX_DELIMITER + yOffset + SmsManager.REGEX_PREFIX_DELIMITER + this.mWallpaperXStep + SmsManager.REGEX_PREFIX_DELIMITER + this.mWallpaperYStep + "]");
    ...
    public void setWallpaperOffsetSteps(float xStep, float yStep) {
        String str = TAG;
        Log.i(str, "setWallpaperOffsetSteps xStep = " + xStep + ", yStep = " + yStep);

...
public class WindowConfiguration implements Parcelable, Comparable<WindowConfiguration> {
    ...
    public void setActivityType(@ActivityType int activityType) {
        ...
        if (this.mActivityType != activityType) {
            if (!ActivityThread.isSystem() || (i = this.mActivityType) == 0 || activityType == 0) {
                this.mActivityType = activityType;
            } else if (i == 2) {
                Slog.i("WindowConfiguration", "activityType = " + activityType + " ,callers = " + Debug.getCallers(15));
            } else {
    ...
    public static boolean isFloating(int windowingMode) {
        return windowingMode == 5 || windowingMode == 2 || windowingMode == 10 || windowingMode == 103 || isHwFreeFormWindowingMode(windowingMode);
    }
    ...
    public boolean isAlwaysOnTop() {
        int i = this.mWindowingMode;
        if (i != 2) {
            return this.mAlwaysOnTop == 1 && (i == 5 || i == 102 || i == 105 || i == 108);
        }
        return true;
    }
    ...
    public static String windowingModeToString(@WindowingMode int windowingMode) {
        ...
        if (windowingMode == 105) {
            return "hwPCMultiwindow-freeform";
        }
    ...
    public static boolean isHwFreeFormWindowingMode(int windowingMode) {
        return windowingMode == 102 || windowingMode == 105 || (windowingMode >= 106 && windowingMode <= 108);
    }

    public boolean inHwTvFreeFormWindowingMode() {
        return isHwTvFreeFormWindowingMode(this.mWindowingMode);
    }

    public static boolean isHwTvFreeFormWindowingMode(int windowingMode) {
        return windowingMode == 108;
    }

    public boolean inHwTvSplitPrimaryWindowingMode() {
        return isHwTvSplitPrimaryWindowingMode(this.mWindowingMode);
    }

    public static boolean isHwTvSplitPrimaryWindowingMode(int windowingMode) {
        return windowingMode == 106;
    }

    public boolean inHwTvSplitSecondaryWindowingMode() {
        return isHwTvSplitSecondaryWindowingMode(this.mWindowingMode);
    }

    public static boolean isHwTvSplitSecondaryWindowingMode(int windowingMode) {
        return windowingMode == 107;
    }

    public boolean inHwTvSplitWindowingMode() {
        return isHwTvSplitWindowingMode(this.mWindowingMode);
    }

    public static boolean isHwTvSplitWindowingMode(int windowingMode) {
        return windowingMode == 106 || windowingMode == 107;
    }

    public boolean inHwTvMultiWindowingMode() {
        return isHwTvMultiWindowingMode(this.mWindowingMode);
    }

    public static boolean isHwTvMultiWindowingMode(int windowingMode) {
        return isHwTvSplitWindowingMode(windowingMode) || isHwTvFreeFormWindowingMode(windowingMode);
    }
    ...
    public static boolean isHwPCFreeFormWindowingMode(int windowingMode) {
        return windowingMode == 105;
    }

    public boolean inHwPCFreeFormWindowingMode() {
        return isHwPCFreeFormWindowingMode(this.mWindowingMode);
    }
    ...
    public static boolean isHwMultiStackWindowingMode(int windowingMode) {
        return windowingMode == 100 || windowingMode == 101 || isHwFreeFormWindowingMode(windowingMode);
    }
    ...
    public static boolean isIncompatibleWindowingMode(int windowMode, int otherWindowMode) {
        if (windowMode == otherWindowMode) {
            return false;
        }
        if (isHwMultiStackWindowingMode(windowMode) || isHwMultiStackWindowingMode(otherWindowMode) || windowMode == 10 || otherWindowMode == 10) {
            return true;
        }
        return false;
    }

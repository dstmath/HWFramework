...
public final class MultiTaskUtils {
    ...
    public static int getAppType(int pid, int uid, String pkgName) {
        ...
        if (info == null) {
            ...
            if ((info.flags & 1) != 0 && ((new ApplicationInfoEx(info).getHwFlags() & AppTypeInfo.APP_ATTRIBUTE_FORCE_ROTATE_WINDOW) != 0 || (info.flags & AppTypeInfo.APP_ATTRIBUTE_FORCE_ROTATE_WINDOW) != 0)) {
                return 3;
            }
            if ((info.flags & 1) != 0) {
                return 2;

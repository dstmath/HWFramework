...
public class AppWidgetManager {
    ...
    private HwCustAppWidgetManager mAppWidgetManager = ((HwCustAppWidgetManager) HwCustUtils.createObj(HwCustAppWidgetManager.class, this));
    ...
    public static AppWidgetManager getInstance(Context context) {
        if (context != null) {
            sPkgName = context.getOpPackageName();
        }
    ...
    public List<AppWidgetProviderInfo> getInstalledProvidersForProfile(int categoryFilter, UserHandle profile, String packageName) {
        ...
        try {
            ...
            if (this.mAppWidgetManager != null) {
                this.mAppWidgetManager.hideTotemweatherWidgets(sPkgName, providers);
            }

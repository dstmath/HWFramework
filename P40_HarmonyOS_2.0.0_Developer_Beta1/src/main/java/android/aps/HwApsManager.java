...
public class HwApsManager implements IApsManager {
    ...
    private boolean checkApsInfo(ApsAppInfo info) {
        ...
        if (resolutionRatio <= 0.25f && (fps < 15 || fps > 120)) {
    ...
    public int setLowResolutionMode(int lowResolutionMode) {
        ...
        try {
            ...
            Slog.w(TAG, "setLowResolutionMode,ex:" + ex.getMessage());
            return -1;
        }
    }
    ...
    public int setResolution(String pkgName, float ratio, boolean isSwitchable) {
        ...
        try {
            return this.mApsService.setResolution(pkgName, ratio, isSwitchable);
        } catch (RemoteException ex) {
            Slog.w(TAG, "setResolution,ex:" + ex.getMessage());
            return -1;
        }
    }
    ...
    public int setFps(String pkgName, int fps) {
        ...
        try {
            ...
            Slog.w(TAG, "setFps,ex:" + ex.getMessage());
            return -1;
        }
    }
    ...
    public int setMaxFps(String pkgName, int fps) {
        ...
        try {
            ...
            Slog.w(TAG, "setMaxFps,ex:" + ex.getMessage());
            return -1;
        }
    }
    ...
    public int setBrightness(String pkgName, int ratioPercent) {
        ...
        try {
            ...
            Slog.w(TAG, "setBrightness,ex:" + ex.getMessage());
            return -1;
        }
    }
    ...
    public int setTexture(String pkgName, int ratioPercent) {
        ...
        try {
            ...
            Slog.w(TAG, "setTexture,ex:" + ex.getMessage());
            return -1;
        }
    }
    ...
    public int setPackageApsInfo(String pkgName, ApsAppInfo info) {
        ...
        try {
            ...
            Slog.w(TAG, "setPackageApsInfo,ex:" + ex.getMessage());
            return -1;
        }
    }
    ...
    public ApsAppInfo getPackageApsInfo(String pkgName) {
        ...
        try {
            ...
            Slog.w(TAG, "getPackageApsInfo,ex:" + ex.getMessage());
            return null;
        }
    }
    ...
    public float getResolution(String pkgName) {
        ...
        try {
            ...
            Slog.w(TAG, "getResolution,ex:" + ex.getMessage());
            return -1.0f;
        }
    }
    ...
    public int getFps(String pkgName) {
        ...
        try {
            ...
            Slog.w(TAG, "getFps,ex:" + ex.getMessage());
            return -1;
        }
    }
    ...
    public int getMaxFps(String pkgName) {
        ...
        try {
            ...
            Slog.w(TAG, "getMaxFps,ex:" + ex.getMessage());
            return -1;
        }
    }
    ...
    public int getBrightness(String pkgName) {
        ...
        try {
            ...
            Slog.w(TAG, "brightness,ex:" + ex.getMessage());
            return -1;
        }
    }
    ...
    public int getTexture(String pkgName) {
        ...
        try {
            ...
            Slog.w(TAG, "getTexture,ex:" + ex.getMessage());
            return -1;
        }
    }
    ...
    public boolean deletePackageApsInfo(String pkgName) {
        ...
        try {
            ...
            Slog.w(TAG, "deletePackageApsInfo,ex:" + ex.getMessage());
            return false;
        }
    }
    ...
    public int isFeaturesEnabled(int bitmask) {
        ...
        try {
            ...
            Slog.w(TAG, "isFeaturesEnabled,ex:" + ex.getMessage());
            return -1;
        }
    }
    ...
    public boolean disableFeatures(int bitmask) {
        ...
        try {
            ...
            Slog.w(TAG, "disableFeatures,ex:" + ex.getMessage());
            return false;
        }
    }
    ...
    public boolean enableFeatures(int bitmask) {
        ...
        try {
            ...
            Slog.w(TAG, "enableFeatures,ex:" + ex.getMessage());
            return false;
        }
    }
    ...
    public List<ApsAppInfo> getAllPackagesApsInfo() {
        ...
        try {
            ...
            Slog.w(TAG, "getAllPackagesApsInfo,ex:" + ex.getMessage());
            return new ArrayList();
        }
    }
    ...
    public List<String> getAllApsPackages() {
        ...
        try {
            ...
            Slog.w(TAG, "getAllApsPackages,ex:" + ex.getMessage());
            return new ArrayList();
        }
    }
    ...
    public boolean updateApsInfo(List<ApsAppInfo> infos) {
        ...
        try {
            ...
            Slog.w(TAG, "updateApsInfo,ex:" + ex.getMessage());
            return false;
        }
    }
    ...
    public boolean registerCallback(String pkgName, IApsManagerServiceCallback callback) {
        ...
        try {
            ...
            Slog.w(TAG, "registerCallback,ex:" + ex.getMessage());
            return false;
        }
    }
    ...
    public float getSeviceVersion() {
        ...
        try {
            ...
            Slog.w(TAG, "getSeviceVersion,ex:" + ex.getMessage());
            return 0.0f;
        }
    }
    ...
    public boolean stopPackages(List<String> pkgs) {
        ...
        try {
            ...
            Slog.w(TAG, "stopPackages,ex:" + ex.getMessage());
            return false;
        }
    }
    ...
    public int setDynamicResolutionRatio(String pkgName, float ratio) {
        ...
        try {
            ...
            Slog.w(TAG, "setDynamicResolutionRatio,ex:" + ex.getMessage());
            return -1;
        }
    }
    ...
    public int setDynamicFps(String pkgName, int fps) {
        ...
        if (fps == -1 || (fps >= 15 && fps <= 120)) {
            try {
                return this.mApsService.setDynamicFps(pkgName, fps);
            } catch (RemoteException ex) {
                Slog.w(TAG, "setDynamicFps,ex:" + ex.getMessage());
                return -1;
            }
        } else {

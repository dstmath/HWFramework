...
public abstract class AbstractThreadedSyncAdapter {
    ...
    public class ISyncAdapterImpl extends ISyncAdapter.Stub {
        ...
        static /* synthetic */ void lambda$onUnsyncableAccount$0(Object rec$, ISyncAdapterUnsyncableAccountCallback x$0) {
            ((AbstractThreadedSyncAdapter) rec$).handleOnUnsyncableAccount(x$0);
        }

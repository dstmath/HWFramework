...
public class PackageParser {
    ...
    private static final String METADATA_PERMZA = "permZA";
    private static final int MIN_ZIP_FILE_SIZE = 22;
    ...
    public static final class CallbackImpl implements Callback {
        ...
        public boolean hasFeature(String feature) {
            if (this.mPm.hasSystemFeature(feature) || HwPackageManager.hasHwSystemFeature(feature, 0)) {
                return true;
            }
            return false;
        }
    ...
    public static final boolean isApkFileJudgeByName(File file) {
        if (file == null) {
            return false;
        }
    ...
    public static final boolean isApkFile(File file) {
        return isApkPath(file.getName()) && file.length() > 22;
    }
    ...
    public static PackageInfo generatePackageInfo(Package p, int[] gids, int flags, long firstInstallTime, long lastUpdateTime, Set<String> grantedPermissions, PackageUserState state, int userId) {
        ...
        Log.i(TAG, "generatePackageInfo error, " + p.packageName + " is been hidden or uninstalld");
        return null;
    }
    ...
    static PackageLite parseClusterPackageLite(File packageDir, int flags) throws PackageParserException {
        ...
        if (!ArrayUtils.isEmpty(files)) {
            ...
            if (versionCode == 0 || pluginVersionCode == 0 || IHwPluginManager.compareAPIMajorVersion(versionCode, pluginVersionCode) == 0) {
                ...
                throw new PackageParserException(-101, "Missing base APK in " + packageDir, true);
            }
    ...
    public Package parsePackage(File packageFile, int flags, boolean useCaches, int hwFlags) throws PackageParserException {
        Package parsed;
        if (HwFoldScreenState.isInwardFoldDevice() && packageFile != null && packageFile.getName() != null && packageFile.getName().contains("SystemUIResOverlay")) {
            Slog.w(TAG, "contains:" + packageFile.getName().contains("SystemUIResOverlay"));
            useCaches = false;
        }
    ...
    private Package parseClusterPackage(File packageDir, int flags, int hwFlags) throws PackageParserException {
        ...
        if (!this.mOnlyCoreApps || lite.coreApp) {
            ...
            try {
                ...
                throw new PackageParserException((int) PackageManager.INSTALL_PARSE_FAILED_UNEXPECTED_EXCEPTION, "Failed to get path: " + lite.baseCodePath, e2);
            } catch (Throwable th) {
                IoUtils.closeQuietly(assetLoader);
                throw th;
            }
    ...
    public Package parseMonolithicPackage(File apkFile, int flags, int hwFlags) throws PackageParserException {
        ...
        try {
            ...
            throw new PackageParserException((int) PackageManager.INSTALL_PARSE_FAILED_UNEXPECTED_EXCEPTION, "Failed to get path: " + apkFile, e);
        } catch (Throwable th) {
            IoUtils.closeQuietly(assetLoader);
            throw th;
        }
    ...
    private Package parseBaseApk(File apkFile, AssetManager assets, int flags, int hwFlags) throws PackageParserException {
        ...
        try {
            ...
            if (cookie != 0) {
                ...
                if (pkg != null) {
                    if (pkg.mAppMetaData != null && pkg.mAppMetaData.getBoolean(METADATA_PERMZA, false)) {
                        Slog.i(TAG, "packageName: " + pkg.packageName + ", meta-data has permZA.");
                        pkg.hasPermZA = true;
                    }
            ...
            e2 = e4;
            throw new PackageParserException((int) PackageManager.INSTALL_PARSE_FAILED_UNEXPECTED_EXCEPTION, "Failed to read manifest from " + apkPath, e2);
    ...
    private Package parseSplitApk(Package pkg, Resources res, XmlResourceParser parser, int flags, int splitIndex, String[] outError) throws XmlPullParserException, IOException, PackageParserException {
        ...
        boolean hasPermZA = pkg.hasPermZA;
        int i = 1;
        pkg.isSplit = true;
                ...
                if (type != 3) {
                    if (type != 4) {
                        ...
                        if (tagName.equals(TAG_APPLICATION)) {
                            ...
                            } else if (!parseSplitApplication(pkg, res, parser, flags, splitIndex, outError)) {
                                return null;
                            } else {
                                foundApp = true;
                            }
                            ...
                            XmlUtils.skipCurrentTag(parser);
                        } else if (hasPermZA && !parseUsesPermission(pkg, res, parser)) {
                            return null;
                        }
                        i = 1;
                    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x00a1, code lost:
        throw new android.content.pm.PackageParser.PackageParserException((int) android.content.pm.PackageManager.INSTALL_PARSE_FAILED_UNEXPECTED_EXCEPTION, "Failed to parse " + r0, r4);
     */
    ...
    /* JADX INFO: Multiple debug info for r23v13 'supportsXLargeScreens'  int: [D('supportsXLargeScreens' int), D('resizeable' int)] */
    /* JADX WARNING: Code restructure failed: missing block: B:72:0x02f7, code lost:
    ...
    private boolean parseUsesPermission(Package pkg, Resources res, XmlResourceParser parser) throws XmlPullParserException, IOException {
        ...
        if (pkg.isSplit) {
            int baseIndex = pkg.requestedPermissions.indexOf(name);
            int splitIndex = pkg.splitRequestedPermissions.indexOf(name);
            if (baseIndex == -1 && splitIndex == -1) {
                pkg.splitRequestedPermissions.add(name.intern());
            }
        } else if (pkg.requestedPermissions.indexOf(name) == -1) {
    ...
    private boolean parsePermissionGroup(Package owner, int flags, Resources res, XmlResourceParser parser, String[] outError) throws XmlPullParserException, IOException {
        ...
        if (!parseAllMetaData(res, parser, "<permission-group>", perm, outError)) {
            this.mParseError = PackageManager.INSTALL_PARSE_FAILED_MANIFEST_MALFORMED;
            return false;
        } else if (owner.isSplit) {
            owner.splitPermissionGroups.add(perm);
            return true;
        } else {
        ...
        if (sa.hasValue(10)) {
            if ("android".equals(owner.packageName)) {
                ...
                if (perm.info.getProtectionFlags() != 0 && (perm.info.protectionLevel & 4096) == 0 && (perm.info.protectionLevel & 8192) == 0 && (perm.info.protectionLevel & 15) != 2) {
                    ...
                    owner.splitPermissions.add(perm);
                    return true;
                } else {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:320:0x081d, code lost:
        if (android.text.TextUtils.isEmpty(r14.staticSharedLibName) == false) goto L_0x082d;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:321:0x081f, code lost:
        r14.activities.add(r0.generateAppDetailsHiddenActivity(r14, r41, r9, r14.baseHardwareAccelerated));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:323:0x082f, code lost:
        if (r26 == 0) goto L_0x0838;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:324:0x0831, code lost:
        java.util.Collections.sort(r14.activities, android.content.pm.$$Lambda$PackageParser$0aobsT7Zf7WVZCqMZ5z2clAuQf4.INSTANCE);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:325:0x0838, code lost:
        if (r27 == false) goto L_0x0841;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:326:0x083a, code lost:
        java.util.Collections.sort(r14.receivers, android.content.pm.$$Lambda$PackageParser$0DZRgzfgaIMpCOhJqjw6PUiU5vw.INSTANCE);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:327:0x0841, code lost:
        if (r28 == false) goto L_0x084a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:328:0x0843, code lost:
        java.util.Collections.sort(r14.services, android.content.pm.$$Lambda$PackageParser$M9fHqS_eEp1oYkuKJhRHOGUxf8.INSTANCE);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:329:0x084a, code lost:
        setMaxAspectRatio(r38);
        setMinAspectRatio(r38);
        r2 = false;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:330:0x0855, code lost:
        if (r14.mAppMetaData == null) goto L_0x0865;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:332:0x085d, code lost:
        if (r14.mAppMetaData.containsKey(android.content.pm.PackageParser.METADATA_NOTCH_SUPPORT) == false) goto L_0x0865;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:333:0x085f, code lost:
        r2 = r14.mAppMetaData.getBoolean(android.content.pm.PackageParser.METADATA_NOTCH_SUPPORT, r1);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:334:0x0865, code lost:
        r4 = 0;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:335:0x086a, code lost:
        if (r14.mAppMetaData == null) goto L_0x087a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:337:0x0872, code lost:
        if (r14.mAppMetaData.containsKey(android.content.pm.PackageParser.METADATA_GESTURE_NAV_OPTIONS) == false) goto L_0x087a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:338:0x0874, code lost:
        r12 = r14.mAppMetaData;
        r1 = r1 ? 1 : 0;
        r1 = r1 ? 1 : 0;
        r1 = r1 ? 1 : 0;
        r4 = r12.getInt(android.content.pm.PackageParser.METADATA_GESTURE_NAV_OPTIONS, r1);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:339:0x087a, code lost:
        r12 = 0;
        r15 = r14.activities.size();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:340:0x0881, code lost:
        if (r12 >= r15) goto L_0x08ce;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:341:0x0883, code lost:
        r1 = r14.activities.get(r12);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:342:0x088b, code lost:
        if (r2 != false) goto L_0x08a1;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:344:0x088f, code lost:
        if (r1.metaData == null) goto L_0x089d;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:345:0x0891, code lost:
        r23 = r2;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:346:0x089a, code lost:
        if (r1.metaData.getBoolean(android.content.pm.PackageParser.METADATA_NOTCH_SUPPORT, false) == false) goto L_0x08a9;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:347:0x089d, code lost:
        r23 = r2;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:348:0x08a1, code lost:
        r23 = r2;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:349:0x08a4, code lost:
        r1.info.hwNotchSupport = true;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:351:0x08ab, code lost:
        if (r1.metaData == null) goto L_0x08c0;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:353:0x08b3, code lost:
        if (r1.metaData.containsKey(android.content.pm.PackageParser.METADATA_GESTURE_NAV_OPTIONS) == false) goto L_0x08c0;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:354:0x08b5, code lost:
        r1.info.hwGestureNavOptions = r1.metaData.getInt(android.content.pm.PackageParser.METADATA_GESTURE_NAV_OPTIONS, r4);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:355:0x08c0, code lost:
        if (r4 == 0) goto L_0x08c6;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:356:0x08c2, code lost:
        r1.info.hwGestureNavOptions = r4;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:357:0x08c6, code lost:
        r12 = r12 + 1;
        r2 = r23;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:359:0x08d4, code lost:
        if (hasDomainURLs(r38) == false) goto L_0x08df;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:360:0x08d6, code lost:
        r14.applicationInfo.privateFlags |= 16;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:361:0x08df, code lost:
    ...
    private boolean parseBaseApplication(Package owner, Resources res, XmlResourceParser parser, int flags, String[] outError) throws XmlPullParserException, IOException {
        ...
        String pkgName4 = sa.getString(28);
        if (pkgName4 != null && pkgName4.length() > 0) {
            r14.mRestrictedAccountType = pkgName4;
        }
        ...
        while (true) {
            ...
            if (type != i) {
                ...
                if (type == 3) {
                    innerDepth = innerDepth2;
                    ai = ai3;
                    restrictedAccountType = pkgName4;
                    strArr2 = strArr3;
                    ...
                    if (tagName.equals(Context.ACTIVITY_SERVICE)) {
                        ...
                        if (tagName.equals("receiver")) {
                            ...
                            if (tagName.equals("service")) {
                                ...
                                ai.isSupportMultiInstance = r14.mAppMetaData.getBoolean("com.huawei.android.multiwindow.multiinstance.enable", false);
                                restrictedAccountType2 = pkgName2;
                            } else {
                                xmlResourceParser = parser;
                                strArr2 = outError;
                    ...
                    pkgName4 = restrictedAccountType;
                    innerDepth2 = innerDepth;
                    i = 1;
                    ai3 = ai;
                }
    ...
    private Activity parseActivity(Package owner, Resources res, XmlResourceParser parser, int flags, String[] outError, CachedComponentArgs cachedArgs, boolean receiver, boolean hardwareAccelerated) throws XmlPullParserException, IOException {
        ...
        if (!receiver) {
            ...
            int i6 = z ? 1 : 0;
            int i7 = z ? 1 : 0;
            activityInfo.lockTaskLaunchMode = sa.getInt(38, i4);
            ActivityInfo activityInfo2 = a.info;
            ActivityInfo activityInfo3 = a.info;
            boolean z2 = sa.getBoolean(42, z);
            activityInfo3.directBootAware = z2;
            activityInfo2.encryptionAware = z2;
            ...
            ActivityInfo activityInfo5 = a.info;
            boolean z3 = sa.getBoolean(42, false);
            activityInfo5.directBootAware = z3;
            activityInfo4.encryptionAware = z3;
        }
    ...
    private void setMinAspectRatio(Package owner) {
        ...
        if (HwFoldScreenState.isFoldScreenDevice()) {
            ...
            } else if (owner.mAppMetaData != null && owner.mAppMetaData.containsKey(METADATA_MIN_ASPECT_RATIO)) {
    ...
    public static final class Package implements Parcelable {
        ...
        public String[] hapPaths;
        @UnsupportedAppUsage
        public boolean hasPermZA;
        ...
        @UnsupportedAppUsage
        public final ArrayList<PermissionGroup> splitPermissionGroups;
        @UnsupportedAppUsage
        public final ArrayList<Permission> splitPermissions;
        public int[] splitPrivateFlags;
        @UnsupportedAppUsage
        public final ArrayList<String> splitRequestedPermissions;
        ...
        public Package(String packageName2) {
            ...
            this.hasPermZA = false;
            this.isSplit = false;
            this.splitPermissions = new ArrayList<>(0);
            this.splitPermissionGroups = new ArrayList<>(0);
            this.splitRequestedPermissions = new ArrayList<>();
            this.packageName = packageName2;
        ...
        public boolean isHarmonyApk() {
            return (this.applicationInfo.hwFlags & 1048576) == 1048576;
        }

        public List<String> getAllHarmonyCodePaths() {
            ArrayList<String> paths = new ArrayList<>();
            paths.add(this.baseCodePath);
            String baseAppPath = new File(this.baseCodePath).getParent();
            this.hapPaths = new File(baseAppPath).list($$Lambda$PackageParser$Package$TGC0xVRQRdRvkydDfNrbgPqu1yY.INSTANCE);
            String[] strArr = this.hapPaths;
            if (!(strArr == null || strArr.length == 0)) {
                for (String hapPath : strArr) {
                    paths.add(baseAppPath + '/' + hapPath);
                }
            }
            return paths;
        }
        ...
        public Package(Parcel dest) {
            ...
            dest.readParcelableList(this.splitPermissions, boot);
            fixupOwner(this.splitPermissions);
            dest.readParcelableList(this.splitPermissionGroups, boot);
            fixupOwner(this.splitPermissionGroups);
            dest.readStringList(this.splitRequestedPermissions);
            internStringArrayList(this.splitRequestedPermissions);
            this.hasPermZA = dest.readBoolean();
        }
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeParcelableList(this.splitPermissions, flags);
            dest.writeParcelableList(this.splitPermissionGroups, flags);
            dest.writeStringList(this.splitRequestedPermissions);
            dest.writeBoolean(this.hasPermZA);
        }
    ...
    public static class PackageParserException extends Exception {
        ...
        public boolean isMissBase = false;
        ...
        public PackageParserException(int error2, String detailMessage, boolean isMissBase2) {
            super(detailMessage);
            this.error = error2;
            this.isMissBase = isMissBase2;
        }
    }

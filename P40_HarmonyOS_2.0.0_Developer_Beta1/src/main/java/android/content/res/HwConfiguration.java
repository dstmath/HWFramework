...
public class HwConfiguration extends HwConfigurationDummy {
    ...
    public void setDensityDPI(int dpi) {
        ...
        SystemPropertiesEx.set("persist.sys.realdpi", ((int) ((((float) dpi) * Float.parseFloat(SystemPropertiesEx.get("persist.sys.rog.currentratio", BuildConfig.VERSION_NAME))) + 0.5f)) + BuildConfig.FLAVOR);
    }

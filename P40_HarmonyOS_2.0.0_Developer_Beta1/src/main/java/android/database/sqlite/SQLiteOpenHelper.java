...
public abstract class SQLiteOpenHelper implements AutoCloseable {
    ...
    private boolean misEnableExclusiveConnection;
            ...
            try {
                ...
                if (db != null) {
                    ...
                    try {
                        ...
                        db.enableExclusiveConnection(this.misEnableExclusiveConnection, this.mConnectionExclusiveHandler);
    ...
    public void setExclusiveConnectionEnabled(boolean isEnabled, SQLiteDatabaseEx.DatabaseConnectionExclusiveHandler connectionExclusiveHandler) {
        synchronized (this) {
            this.misEnableExclusiveConnection = isEnabled;

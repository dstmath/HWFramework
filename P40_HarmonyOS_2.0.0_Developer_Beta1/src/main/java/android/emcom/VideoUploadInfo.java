...
public class VideoUploadInfo extends SmartcareInfos.SmartcareBaseInfo {
    ...
    private static final int LINK_MODE_DEFAULT = -1;
    private static final int POLICY_TYPE_DEFAULT = -1;
    private static final int PRB_DEFAULT = -1;
    private static final int RADIO_SNR_DEFAULT = -1;
    private static final byte RADIO_SQ_DEFAULT = -1;
    private static final byte RADIO_SS_DEFAULT = -1;
    ...
    private static final byte WLAN_SS_DEFAULT = -1;

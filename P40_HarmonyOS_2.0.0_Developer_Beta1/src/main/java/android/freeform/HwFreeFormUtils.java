...
public final class HwFreeFormUtils {
    ...
    public static final int DIM_EXPAND = -1;
    public static final int DIM_FADED = -2;
    ...
    static final float MAX_DRAG_PERCENT_LANDSCAPE_PHONE = 1.0f;
    static final float MAX_DRAG_PERCENT_PHONE = 0.99f;
    ...
    private static Point mOldMaxVisibleSize = new Point();
    ...
    private static int sLandscapeMaxLength = 0;
    ...
    static {
        ...
        sExitFreeformActivity.add("com.tencent.mm/.plugin.recordvideo.activity.MMRecordUI");
        sExitFreeformActivity.add("com.tencent.mobileqq/com.tencent.av.ui.VideoInviteActivity");
    }
    ...
    public static void computeFreeFormSize(Point MaxVisibleSize) {
        if (isFreeFormEnable() && !mOldMaxVisibleSize.equals(MaxVisibleSize)) {
            mOldMaxVisibleSize.set(MaxVisibleSize.x, MaxVisibleSize.y);
            int minLength = 0;
            ...
            if (isTablet()) {
                ...
                sLandscapeMaxLength = (int) (((float) minLength) * 1.0f);
            }
    ...
    public static int getLandscapeFreeformMaxLength() {
        return sLandscapeMaxLength;
    }

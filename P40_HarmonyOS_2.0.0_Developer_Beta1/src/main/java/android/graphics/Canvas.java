...
public class Canvas extends BaseCanvas {
    ...
    private static native void nUpdateForceColorPolicy(long j, int[] iArr);
    ...
    public void updateCanvasForceColorPolicy(int[] params) {
        boolean z = true;
        if (params[1] == 0) {
            z = false;
        }
        this.mLastHwForceDark = z;
        nUpdateForceColorPolicy(this.mNativeCanvasWrapper, params);
    }

    public static void updateGlobalForceColorPolicy(int[] params) {
        nUpdateForceColorPolicy(0, params);
    }

...
public class Camera {
    ...
    private final native void startPreviewInner();
    ...
    private int cameraInitVersion(int cameraId, int halVersion) {
        ...
        getCameraInfo(this.mCameraId, new CameraInfo());
    ...
    public void setParameters(Parameters params) {
        ...
        if (HwFrameworkFactory.getHwActivityThread() != null && HwFrameworkFactory.getHwActivityThread().getScanOpt()) {
            params.setScanOptEnable(true);
        }
    ...
    public class Parameters {
        ...
        private static final String KEY_ENABLE_SCANOPT = "hw-enable-scan-opt";
        ...
        public void setScanOptEnable(boolean enable) {
            set(KEY_ENABLE_SCANOPT, enable ? TRUE : FALSE);
        }

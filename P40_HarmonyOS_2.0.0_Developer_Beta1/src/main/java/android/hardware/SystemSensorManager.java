...
public class SystemSensorManager extends SensorManager {
    ...
    private static native int nativeSetPackageWhiteList(long j, String[] strArr);
    ...
    public boolean registerListenerImpl(SensorEventListener listener, Sensor sensor, int delayUs, Handler handler, int maxBatchReportLatencyUs, int reservedFlags) {
        ...
        if (listener == null || sensor == null) {
            ...
            if (21 == sensorType && !HwSystemManager.allowOp(134217728)) {
    ...
    public static final class SensorEventQueue extends BaseEventQueue {
        ...
        public void dispatchSensorEvent(int handle, float[] values, int inAccuracy, long timestamp) {
            ...
            Sensor sensor = (Sensor) this.mManager.mHandleToSensor.get(Integer.valueOf(handle));
            if (sensor == null) {
                Log.e("SensorManager", "Error: Sensor is null");
                return;
            }
            synchronized (this.mSensorsEvents) {
            ...
            if (t == null) {
            ...
            } else if (!HwActivityTaskManager.isPCMultiCastMode() || this.mManager.mContext == null || this.mManager.mContext.getResources() == null || !this.mManager.mContext.getResources().getConfiguration().windowConfiguration.inHwPCFreeFormWindowingMode() || ((sensor.getType() & 1) == 0 && (sensor.getType() & 3) == 0)) {
                ...
                Log.e("SensorManager", "In pc cast mode, skipping the sensor.");
            }
        }
    ...
    public int hwSetPackageWhiteListImpl(List<String> config) {
        return nativeSetPackageWhiteList(this.mNativeInstance, (String[]) config.toArray(new String[config.size()]));
    }
}

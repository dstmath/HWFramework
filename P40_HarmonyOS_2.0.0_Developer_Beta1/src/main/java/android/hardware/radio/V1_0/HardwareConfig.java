...
public final class HardwareConfig {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        parcel.readEmbeddedBuffer((long) (this.uuid.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 8 + 0, false);
        this.state = _hidl_blob.getInt32(_hidl_offset + 24);
        int _hidl_vec_size = _hidl_blob.getInt32(_hidl_offset + 32 + 8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 20), _hidl_blob.handle(), _hidl_offset + 32 + 0, true);
        this.modem.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
        ...
        HwBlob childBlob2 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 16), _hidl_blob.handle(), _hidl_offset + 48 + 0, true);
        this.sim.clear();

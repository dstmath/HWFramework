...
public interface IRadioConfigResponse extends android.hardware.radio.config.V1_1.IRadioConfigResponse {
    ...
    @Override // android.hardware.radio.config.V1_1.IRadioConfigResponse, android.hardware.radio.config.V1_0.IRadioConfigResponse
    IHwBinder asBinder();
    ...
    public static final class Proxy implements IRadioConfigResponse {
        ...
        @Override // android.hardware.radio.config.V1_2.IRadioConfigResponse, android.hardware.radio.config.V1_1.IRadioConfigResponse, android.hardware.radio.config.V1_0.IRadioConfigResponse

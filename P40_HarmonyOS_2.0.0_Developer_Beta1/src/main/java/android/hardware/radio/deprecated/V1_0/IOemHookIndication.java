...
public interface IOemHookIndication extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IOemHookIndication {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IOemHookIndication.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{6, -125, 123, 109, 126, -124, 60, -6, -100, -46, 15, -19, 64, 112, -2, -54, 122, -101, 92, -127, -87, -19, 100, AnswerToReset.DIRECT_CONVENTION, -9, -48, 104, 3, 69, 90, -104, 22}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, AnswerToReset.DIRECT_CONVENTION, 24, -54, 76}));
        }

...
public class HwThemeManager {
    ...
    public static final String HWT_MODE_ALL_0771 = "0771";
    public static final String HWT_MODE_ALL_0775 = "0775";
    ...
    public static int getShadowcolor(TypedArray typedArray, int attr) {
        return getImplObject().getShadowcolor(typedArray, attr);
    }

...
public interface IHwMagicWindow extends IInterface {
    ...
    float getRatio(String str) throws RemoteException;
    ...
    boolean isScaled(String str) throws RemoteException;
    ...
    public static class Default implements IHwMagicWindow {
        ...
        @Override // android.magicwin.IHwMagicWindow
        public boolean isScaled(String pkgName) throws RemoteException {
            return false;
        }

        @Override // android.magicwin.IHwMagicWindow
        public float getRatio(String pkgName) throws RemoteException {
            return 0.0f;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 10:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isScaled = isScaled(data.readString());
                        reply.writeNoException();
                        reply.writeInt(isScaled ? 1 : 0);
                        return true;
                    case 11:
                        data.enforceInterface(DESCRIPTOR);
                        float _result4 = getRatio(data.readString());
                        reply.writeNoException();
            ...
            public boolean isScaled(String pkgName) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(10, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().isScaled(pkgName);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public float getRatio(String pkgName) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(11, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getRatio(pkgName);
                    }
                    _reply.readException();

                        ...
                        if (msg.what != 1) {
                            ...
                            synchronized (AudioRecordingMonitorImpl.this.mRecordCallbackLock) {
                                if (AudioRecordingMonitorImpl.this.mRecordCallbackList.size() != 0) {
                                    cbInfoList = new LinkedList<>(AudioRecordingMonitorImpl.this.mRecordCallbackList);
                                } else {
                                    return;
                                }
                            }
                            ...
                            try {
                                ...
                                while (it.hasNext()) {
                                    AudioRecordingCallbackInfo cbi = it.next();
                                    cbi.mExecutor.execute(new Runnable(configs) {
                                        /* class android.media.$$Lambda$AudioRecordingMonitorImpl$2$cn04v8rie0OYr_fiLO_SMYka7I */
                                        ...
                                        public final void run() {
                                            AudioRecordingMonitorImpl.AudioRecordingCallbackInfo.this.mCb.onRecordingConfigChanged(this.f$1);
                                        }
                                    });
                                }
                            } finally {

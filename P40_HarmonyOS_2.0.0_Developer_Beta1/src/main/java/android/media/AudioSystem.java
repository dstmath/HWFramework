...
public class AudioSystem {
    ...
    public static final int STREAM_ALL = -100;
    ...
    private static MultiAudioRecordCallback mMultiAudioRecordCallback;
    ...
    public interface MultiAudioRecordCallback {
        void onMultiAudioRecord(int i, int i2);
    }
    ...
    public static native boolean isVoiceRecordingEnable();
    ...
    private static native void native_registerMultiAudioRecordCallback();
    ...
    public static native int registerPolicyMixes(ArrayList<AudioMix> arrayList, boolean z, boolean z2, int i);
    ...
    public static native void setGameForeground(int i);
    ...
    public static native void setMultiAudioRecordEnable(boolean z);
    ...
    public static native void setVoiceRecordingEnable(boolean z, int i);
    ...
    private static void postMultiAudioRecordFromNative(int arg1, int arg2) {
        MultiAudioRecordCallback multiAudioRecordCallback = mMultiAudioRecordCallback;
        if (multiAudioRecordCallback != null) {
            multiAudioRecordCallback.onMultiAudioRecord(arg1, arg2);
        }
    }

    public static void setMultiAudioRecordCallback(MultiAudioRecordCallback cb) {
        synchronized (AudioSystem.class) {
            Log.e(TAG, "reportMultiAudioRecord setMultiAudioRecordCallback");
            mMultiAudioRecordCallback = cb;
            native_registerMultiAudioRecordCallback();
        }
    }
}

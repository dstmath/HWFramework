...
public class HwAudioRecordImpl extends DefaultHwAudioRecord {
    private static final int DISABLE_MICROPHONE_TOAST = 1004;
    private static final int STATE_CHAGED_VALUE = 1002;
    ...
    public boolean isAudioRecordAllowed() {
        ...
        if (ActivityThreadEx.currentApplication() != null) {
            context = ActivityThreadEx.currentApplication().getApplicationContext();
        }

...
public class Ringtone {
    ...
    @UnsupportedAppUsage
    private Uri mUri;
    private String mVibratePackage;
    ...
    public Ringtone(Context context, boolean allowRemote) {
        Binder binder = null;
        this.mVibrateType = null;
        this.mVibratePackage = null;
        this.mUid = -1;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0041, code lost:
        ...
        r3.mPrepareStat = true;
        destroyLocalPlayer();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0050, code lost:
        if (r3.mAllowRemote == false) goto L_0x0052;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0052, code lost:
        android.util.Log.w(android.media.Ringtone.TAG, "Remote playback not allowed: " + r0);
     */
    /* JADX WARNING: Removed duplicated region for block: B:15:0x0040 A[ExcHandler: IOException | IllegalArgumentException | IllegalStateException | SecurityException (r0v9 'e' java.lang.Exception A[CUSTOM_DECLARE]), Splitter:B:7:0x0028] */
    private void tryCreateLocalPlayer() {
        destroyLocalPlayer();
    ...
    public void playWithVibrate(String effectType) {
        Log.w(TAG, "playWithVibrate : " + effectType);
        this.mVibrateType = effectType;
        play();
    }

    public void playWithVibrate(String effectType, String packageName, int uid) {
        Log.w(TAG, "start playWithVibrate : " + effectType);
        this.mVibrateType = effectType;
        this.mVibratePackage = packageName;
        this.mUid = uid;
        play();
    }
    ...
    private void startLocalPlayer() {
        if (this.mLocalPlayer != null) {
            ...
            if (str == null) {
                ...
                String str2 = this.mVibratePackage;
                if (str2 == null) {
                    this.mLocalPlayer.startWithVibrate(str);
                } else {
                    this.mLocalPlayer.startWithVibrate(str, str2, this.mUid);
                }
            }
    ...
    public class MyOnCompletionListener implements MediaPlayer.OnCompletionListener {
        ...
        public void onCompletion(MediaPlayer mp) {
            Ringtone.this.mVibrateType = null;
            Ringtone.this.mVibratePackage = null;
            Ringtone.this.mUid = -1;

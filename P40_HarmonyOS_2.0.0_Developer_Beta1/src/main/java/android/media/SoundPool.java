...
public class SoundPool extends PlayerBase {
    ...
    public final void setVolume(int streamID, float leftVolume, float rightVolume) {
        ...
        HwMediaMonitorManager.readyForWriteBigData(HwMediaMonitorUtils.BD_AUDIO_SOUNDPOOL_VOLUME, HwMediaMonitorUtils.TYPE_VOLUME_SET_VOLUME, "1: " + String.valueOf(streamID) + ", " + String.valueOf(leftVolume) + ", " + String.valueOf(rightVolume));
    }
    ...
    public void playerSetVolume(boolean muting, float leftVolume, float rightVolume) {
        _mute(muting);
        HwMediaMonitorManager.readyForWriteBigData(HwMediaMonitorUtils.BD_AUDIO_SOUNDPOOL_VOLUME, HwMediaMonitorUtils.TYPE_VOLUME_PLAYER_SET_VOLUME, "2: " + String.valueOf(muting) + ", " + String.valueOf(leftVolume) + ", " + String.valueOf(rightVolume));
    }

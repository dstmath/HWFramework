...
public class NetworkStatsHistory implements Parcelable {
    ...
    /* JADX INFO: Multiple debug info for r6v1 long: [D('rxBytes' long), D('rxBytes_mp' long)] */
    ...
    /* JADX INFO: Multiple debug info for r6v4 long: [D('txPackets_mp' long), D('txBytes_mp' long)] */
    /* JADX INFO: Multiple debug info for r13v2 long: [D('txPackets' long), D('curStart' long)] */
    /* JADX INFO: Multiple debug info for r5v4 long: [D('fracRxPackets' long), D('curEnd' long)] */
    /* JADX INFO: Multiple debug info for r13v5 long: [D('fracTxBytes' long), D('curStart' long)] */
    /* JADX INFO: Multiple debug info for r11v3 long: [D('fracTxPackets' long), D('txBytes' long)] */
    /* JADX INFO: Multiple debug info for r11v4 long: [D('fracTxPackets' long), D('fracOperations' long)] */
    /* JADX INFO: Multiple debug info for r11v5 long: [D('fracOperations' long), D('fracRxBytes_mp' long)] */
    /* JADX INFO: Multiple debug info for r11v6 long: [D('fracRxBytes_mp' long), D('fracRxPackets_mp' long)] */
    /* JADX INFO: Multiple debug info for r11v7 long: [D('fracRxPackets_mp' long), D('fracTxBytes_mp' long)] */
    /* JADX INFO: Multiple debug info for r11v8 long: [D('fracTxBytes_mp' long), D('fracTxPackets_mp' long)] */
    /* JADX INFO: Multiple debug info for r7v6 'i'  int: [D('duration' long), D('i' int)] */
    public void recordData(long start, long end, NetworkStats.Entry entry) {
        ...
        long rxBytes_mp2 = entry.rxBytes_mp;
        long rxBytes_mp3 = entry.rxPackets_mp;
        long txBytes_mp2 = entry.txBytes_mp;
        long txBytes_mp3 = entry.txPackets_mp;
        if (entry.isNegative()) {
            Log.d("NetworkStatsHistory", "tried recording negative data.");
        } else if (!entry.isEmpty()) {
            ensureBuckets(start, end);
            int i2 = getIndexAfter(j2);
            long txPackets_mp2 = txBytes_mp3;
            long txBytes_mp4 = txBytes_mp2;
            long rxPackets_mp2 = rxBytes_mp3;
            long rxBytes_mp4 = rxBytes_mp2;
            ...
            while (true) {
                ...
                if (curStart <= j2) {
                    ...
                    if (overlap > 0) {
                        ...
                        long curEnd2 = (rxPackets3 * overlap) / duration2;
                        long curStart2 = (fracTxPackets_mp * overlap) / duration2;
                        long txBytes3 = (fracTxBytes * overlap) / duration2;
                        long fracOperations = (operations3 * overlap) / duration2;
                        long fracRxBytes_mp = (rxBytes_mp4 * overlap) / duration2;
                        long fracRxPackets_mp = (rxPackets_mp2 * overlap) / duration2;
                        long fracTxBytes_mp = (txBytes_mp4 * overlap) / duration2;
                        long fracTxPackets_mp2 = (txPackets_mp2 * overlap) / duration2;
                        i = i2;
                        ...
                        long txBytes4 = fracTxPackets_mp - curStart2;
                        addLong(this.txPackets, i, txBytes3);
                        addLong(this.operations, i, fracOperations);
                        operations3 -= fracOperations;
                        addLong(this.rxBytes_mp, i, fracRxBytes_mp);
                        rxBytes_mp4 -= fracRxBytes_mp;
                        addLong(this.rxPackets_mp, i, fracRxPackets_mp);
                        rxPackets_mp2 -= fracRxPackets_mp;
                        addLong(this.txBytes_mp, i, fracTxBytes_mp);
                        txBytes_mp4 -= fracTxBytes_mp;
                        addLong(this.txPackets_mp, i, fracTxPackets_mp2);
                        txPackets_mp2 -= fracTxPackets_mp2;
                        duration = duration2 - overlap;
                        fracTxBytes -= txBytes3;
                        fracTxPackets_mp = txBytes4;
                        i2 = i - 1;
                        j = start;
                        j2 = end;
                        duration2 = duration;

...
public interface HwInnerWifiManager {
    ...
    String queryArp(String str, List<String> list);

    int queryCsi(String str, boolean z, List<MacAddress> list, int i, IWifiActionListener iWifiActionListener);

    int querySniffer(String str, int i, MacAddress macAddress, String str2, IWifiActionListener iWifiActionListener);
    ...
    int setWifiLowLatencyMode(String str, boolean z);

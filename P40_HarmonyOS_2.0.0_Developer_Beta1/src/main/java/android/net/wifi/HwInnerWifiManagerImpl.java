...
public class HwInnerWifiManagerImpl implements HwInnerWifiManager {
    ...
    private static final int CODE_CTRL_HW_WIFI_CONFIG = 4207;
    ...
    private static final int WHITE_UID_HW_WIFI_CONFIG = 5513;
    ...
    public Bundle ctrlHwWifiConfig(String pkgName, int cmdId, Bundle inputData) {
        Bundle result = new Bundle();
        if (Binder.getCallingUid() != WHITE_UID_HW_WIFI_CONFIG) {
            Log.e(TAG, "ctrlHwWifiConfig calling uid does not matches: 5513");
            return result;
        }
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        IBinder binder = HwWifiAdapterEx.getWifiserviceBinder("wifi");
        Log.d(TAG, "ctrlHwWifiConfig");
        if (binder != null) {
            try {
                data.writeInterfaceToken(DESCRIPTOR);
                data.writeString(pkgName);
                data.writeInt(cmdId);
                data.writeBundle(inputData);
                binder.transact(CODE_CTRL_HW_WIFI_CONFIG, data, reply, 0);
                reply.readException();
                result = reply.readBundle();
            } catch (RemoteException e) {
                HwHiLogEx.d(TAG, false, "ctrlHwWifiConfig, localRemoteException e", new Object[0]);
                reply.recycle();
                data.recycle();
            } catch (Throwable th) {
                reply.recycle();
    ...
    public boolean requestWifiAware(Context ctx, int requestId) {
        ...
        try {
            ...
            binder.transact(CODE_REQUEST_WIFI_AWARE, data, reply, 0);
            reply.readException();
            result = reply.readInt();
        } catch (RemoteException e) {
            Log.d(TAG, "requestWifiAware, localRemoteException");
        } finally {
            reply.recycle();
            data.recycle();
        }
    ...
    public boolean setWifiAwareInfo(Context ctx, int queryId, byte[] content) {
        ...
        try {
            ...
            binder.transact(CODE_SET_WIFI_AWARE, data, reply, 0);
            reply.readException();
            result = reply.readInt();
        } catch (RemoteException e) {
            Log.d(TAG, "requestWifiAware, localRemoteException");
    ...
    public byte[] getWifiAwareInfo(Context ctx, int queryId, byte[] filter) {
        ...
        try {
            data.writeInterfaceToken(DESCRIPTOR);
            data.writeInt(queryId);
            data.writeByteArray(filter);
            binder.transact(CODE_GET_WIFI_AWARE, data, reply, 0);
            reply.readException();
    ...
    public boolean isSupportDualWifi() {
        ...
        if (binder != null) {
            try {
                data.writeInterfaceToken(DESCRIPTOR);
                binder.transact(CODE_IS_SUPPORT_DUAL_WIFI, data, reply, 0);
                reply.readException();
                boolean[] resultArray = new boolean[1];
                reply.readBooleanArray(resultArray);
                isSupport = resultArray[0];
            } catch (RemoteException e) {
                HwHiLogEx.e(TAG, false, "IsSupportDualWifi, localRemoteException", new Object[0]);
                reply.recycle();
                data.recycle();
            } catch (Throwable th) {
                reply.recycle();
    ...
    public void setSlaveWifiNetworkSelectionPara(int signalLevel, int callerUid, int needInternet) {
        ...
        if (binder != null) {
            try {
                data.writeInterfaceToken(DESCRIPTOR);
                data.writeInt(signalLevel);
                data.writeInt(callerUid);
                data.writeInt(needInternet);
                binder.transact(CODE_CONFIG_NSP_SLAVE_WIFI, data, reply, 0);
                reply.readException();
            } catch (RemoteException e) {
                HwHiLogEx.e(TAG, false, "startSlaveWifi, localRemoteException", new Object[0]);
                reply.recycle();
                data.recycle();
                return;
            } catch (Throwable th) {
    ...
    public WifiInfo getSlaveWifiConnectionInfo() {
        ...
        if (binder != null) {
            try {
                data.writeInterfaceToken(DESCRIPTOR);
                binder.transact(CODE_GET_SLAVE_WIFI_INFO, data, reply, 0);
                reply.readException();
                Parcelable parcelableObj = reply.readParcelable(null);
                if (parcelableObj instanceof WifiInfo) {
                    info = (WifiInfo) parcelableObj;
                }
            } catch (RemoteException e) {
                HwHiLogEx.e(TAG, false, "getSlaveWifiConnectionInfo, localRemoteException", new Object[0]);
                reply.recycle();
                data.recycle();
                return null;
            } catch (BadParcelableException e2) {
                HwHiLogEx.e(TAG, false, "getSlaveWifiConnectionInfo, parcelException", new Object[0]);
                reply.recycle();
                data.recycle();
                return null;
            } catch (Throwable th) {
    ...
    public LinkProperties getLinkPropertiesForSlaveWifi() {
        ...
        if (binder != null) {
            try {
                data.writeInterfaceToken(DESCRIPTOR);
                binder.transact(CODE_GET_SLAVE_WIFI_LINKPROPERTY, data, reply, 0);
                reply.readException();
                Parcelable parcelableObj = reply.readParcelable(null);
                if (parcelableObj instanceof LinkProperties) {
                    lp = (LinkProperties) parcelableObj;
                }
            } catch (RemoteException e) {
                HwHiLogEx.e(TAG, false, "getLinkPropertiesForSlaveWifi, localRemoteException", new Object[0]);
                reply.recycle();
                data.recycle();
                return null;
            } catch (BadParcelableException e2) {
                HwHiLogEx.e(TAG, false, "getLinkPropertiesForSlaveWifi, parcelException", new Object[0]);
                reply.recycle();
                data.recycle();
                return null;
            } catch (Throwable th) {
    ...
    public NetworkInfo getNetworkInfoForSlaveWifi() {
        ...
        if (binder != null) {
            try {
                data.writeInterfaceToken(DESCRIPTOR);
                binder.transact(CODE_GET_SLAVE_WIFI_NETWORK_IFNO, data, reply, 0);
                reply.readException();
                Parcelable parcelableObj = reply.readParcelable(null);
                if (parcelableObj instanceof NetworkInfo) {
                    ni = (NetworkInfo) parcelableObj;
                }
            } catch (RemoteException e) {
                HwHiLogEx.e(TAG, false, "getNetworkInfoForSlaveWifi, localRemoteException", new Object[0]);
                reply.recycle();
                data.recycle();
                return null;
            } catch (BadParcelableException e2) {
                HwHiLogEx.e(TAG, false, "getNetworkInfoForSlaveWifi, parcelException", new Object[0]);
                reply.recycle();
                data.recycle();
                return null;
            } catch (Throwable th) {
    ...
    public void setWifiSlicing(int uid, int protocolType, int mode) {
        ...
        if (binder != null) {
            try {
                HwHiLogEx.i(TAG, false, "setWifiSlicing uid = %{public}d, protocolType = %{public}d", new Object[]{Integer.valueOf(uid), Integer.valueOf(protocolType)});
                data.writeInterfaceToken(DESCRIPTOR);
                data.writeInt(uid);
                data.writeInt(protocolType);
                data.writeInt(mode);
                binder.transact(CODE_SET_HIGH_PRIORITY_TRANSMIT, data, reply, 0);
                reply.readException();
            } catch (RemoteException e) {
                HwHiLogEx.e(TAG, false, "Exception happened in setWifiSlicing", new Object[0]);
                data.recycle();
                reply.recycle();
                return;
            } catch (Throwable th) {
    ...
    public int handleInterferenceParams(int type, int value) {
        ...
        if (binder != null) {
            try {
                HwHiLogEx.i(TAG, false, "hid2d type = %{public}d, value = %{public}d", new Object[]{Integer.valueOf(type), Integer.valueOf(value)});
                data.writeInterfaceToken(DESCRIPTOR);
                data.writeInt(type);
                data.writeInt(value);
                binder.transact(CODE_HANDLE_HID2D_PARAMS, data, reply, 0);
                reply.readException();
                result = reply.readInt();
            } catch (RemoteException e) {
                HwHiLogEx.e(TAG, false, "Exception happened in handleInterferenceParams", new Object[0]);
                data.recycle();
                reply.recycle();
            } catch (Throwable th) {
                data.recycle();
    ...
    public byte[] getSelfWifiCfgInfo(String packageName, int cfgType) {
        ...
        if (binder != null) {
            try {
                data.writeInterfaceToken(DESCRIPTOR);
                data.writeString(packageName);
                data.writeInt(cfgType);
                binder.transact(CODE_DBAC_GET_SELF_WIFI_INFO, data, reply, 0);
                reply.readException();
                result = reply.createByteArray();
            } catch (RemoteException e) {
                HwHiLogEx.e(TAG, false, "getSelfWifiCfgInfo, localRemoteException", new Object[0]);
                reply.recycle();
                data.recycle();
                return null;
            } catch (Throwable th) {
    ...
    public int setPeerWifiCfgInfo(String packageName, int cfgType, byte[] cfgData) {
        ...
        if (binder != null) {
            try {
                ...
                data.writeString(packageName);
                data.writeInt(cfgType);
                data.writeByteArray(cfgData);
                binder.transact(CODE_DBAC_SET_PEER_WIFI_INFO, data, reply, 0);
                reply.readException();
                result = reply.readInt();
            } catch (RemoteException e) {
                HwHiLogEx.e(TAG, false, "setPeerWifiCfgInfo, localRemoteException", new Object[0]);
                reply.recycle();
                data.recycle();
                return 0;
            } catch (Throwable th) {
    ...
    public int registerWifiCfgCallback(String packageName, IWifiCfgCallback callback) {
        ...
        IBinder binder = HwWifiAdapterEx.getWifiserviceBinder("wifi");
        if (binder == null) {
            HwHiLogEx.e(TAG, false, "getWifiserviceBinder is null", new Object[0]);
            return -1;
        }
        try {
            data.writeInterfaceToken(DESCRIPTOR);
            ...
            binder.transact(CODE_DBAC_REGISTER_CALLBACK, data, reply, 1);
            reply.readException();
            result = reply.readInt();
        } catch (RemoteException e) {
            HwHiLogEx.e(TAG, false, "registerWifiCfgCallback, localRemoteException", new Object[0]);
        } finally {
            reply.recycle();
            data.recycle();
        }
    ...
    public int unregisterWifiCfgCallback(String packageName) {
        ...
        if (binder != null) {
            try {
                data.writeInterfaceToken(DESCRIPTOR);
                data.writeString(packageName);
                binder.transact(CODE_DBAC_UNREGISTER_CALLBACK, data, reply, 0);
                reply.readException();
                result = reply.readInt();
            } catch (RemoteException e) {
                HwHiLogEx.e(TAG, false, "unregisterWifiCfgCallback, localRemoteException", new Object[0]);
                reply.recycle();
                data.recycle();
                return 0;
            } catch (Throwable th) {
        ...
        if (!TextUtils.isEmpty(packageName)) {
            ...
            if (binder != null) {
                try {
                    data.writeInterfaceToken(DESCRIPTOR);
                    data.writeString(packageName);
                    binder.transact(CODE_DBAC_GET_RECOMMEND_CHANNEL, data, reply, 0);
                    reply.readException();
                    result = reply.readInt();
                } catch (RemoteException e) {
                    HwHiLogEx.e(TAG, false, "getP2pRecommendChannel, localRemoteException", new Object[0]);
                    reply.recycle();
                    data.recycle();
                } catch (Throwable th) {
                    reply.recycle();
    ...
    public int setWifiLowLatencyMode(String packageName, boolean enabled) {
        ...
        IBinder binder = HwWifiAdapterEx.getWifiserviceBinder("wifi");
        if (binder == null) {
            HwHiLogEx.e(TAG, false, "setWifiLowLatencyMode: getWifiserviceBinder is null", new Object[0]);
            return -1;
        }
        try {
            data.writeInterfaceToken(DESCRIPTOR);
            ...
            data.writeInt(i);
            binder.transact(CODE_SET_WIFI_LOW_LATENCY_MODE, data, reply, 0);
            reply.readException();
            result = reply.readInt();
        } catch (RemoteException e) {
            HwHiLogEx.e(TAG, false, "setWifiLowLatencyMode: localRemoteException", new Object[0]);
        } finally {
            reply.recycle();
            data.recycle();
        }
    ...
    public int queryCsi(String packageName, boolean enable, List<MacAddress> taList, int mask, IWifiActionListener listener) {
        int i = 0;
        if (TextUtils.isEmpty(packageName) || taList == null || taList.isEmpty() || listener == null) {
            return -1;
        }
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        ...
        if (binder != null) {
            try {
                ...
                data.writeInt(i);
                data.writeTypedList(taList);
                data.writeInt(mask);
                data.writeStrongBinder(listener.asBinder());
                binder.transact(CODE_QUERY_CSI, data, reply, 0);
                reply.readException();
                result = reply.readInt();
            } catch (RemoteException e) {
                HwHiLogEx.e(TAG, false, "queryCsi, localRemoteException", new Object[0]);
                reply.recycle();
                data.recycle();
                return -1;
            } catch (Throwable th) {
    ...
    public int querySniffer(String packageName, int id, MacAddress filterMac, String channel, IWifiActionListener listener) {
        int result = -1;
        if (!TextUtils.isEmpty(packageName) && filterMac != null && !TextUtils.isEmpty(channel) && listener != null) {
            Parcel data = Parcel.obtain();
            Parcel reply = Parcel.obtain();
            IBinder binder = HwWifiAdapterEx.getWifiserviceBinder("wifi");
            result = -1;
            if (binder != null) {
                try {
                    ...
                    data.writeString(packageName);
                    data.writeInt(id);
                    data.writeTypedObject(filterMac, 0);
                    data.writeString(channel);
                    data.writeStrongBinder(listener.asBinder());
                    binder.transact(CODE_QUERY_SNIFFER, data, reply, 0);
                    reply.readException();
                    result = reply.readInt();
                } catch (RemoteException e) {
                    HwHiLogEx.e(TAG, false, "querySniffer, localRemoteException", new Object[0]);
                    reply.recycle();
                    data.recycle();
                } catch (Throwable th) {
                    reply.recycle();
    ...
    public String queryArp(String packageName, List<String> filterIp) {
        if (TextUtils.isEmpty(packageName) || filterIp == null) {
            return "";
        }
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        ...
        if (binder != null) {
            try {
                data.writeInterfaceToken(DESCRIPTOR);
                data.writeString(packageName);
                data.writeStringList(filterIp);
                binder.transact(CODE_QUERY_ARP, data, reply, 0);
                reply.readException();
                result = reply.readString();
            } catch (RemoteException e) {
                HwHiLogEx.e(TAG, false, "queryArp, localRemoteException", new Object[0]);
                reply.recycle();
                data.recycle();
                return result;
            } catch (Throwable th) {

...
public final class NxpApduServiceInfo extends ApduServiceInfo implements Parcelable {
    ...
    private static final List<String> ESE_APP_PACKAGE_LIST = Arrays.asList("de.bmw.connected.cn", "de.bmw.connected.cn.dev", "de.bmw.connected.cn.int", "de.bmw.connected.cn.stg", "de.myaudi.mobile.assistant.dev", "de.myaudi.mobile.assistant.r", "de.myaudi.mobile.assistant.p", "de.myaudi.mobile.assistant", "com.huawei.wallet", "com.huawei.wearwallet");
    ...
    public NxpApduServiceInfo(ResolveInfo info, boolean onHost, String description, ArrayList<NxpAidGroup> staticNxpAidGroups, ArrayList<NxpAidGroup> dynamicNxpAidGroups, boolean requiresUnlock, int bannerResource, int uid, String settingsActivityName, ESeInfo seExtension, ArrayList<Nfcid2Group> nfcid2Groups, byte[] banner, boolean modifiable) {
        super(info, description, nxpAidGroups2AidGroups(staticNxpAidGroups), nxpAidGroups2AidGroups(dynamicNxpAidGroups), requiresUnlock, bannerResource, uid, settingsActivityName, onHost ? null : seExtension.getSEName(), seExtension.getSEName());
    ...
    public NxpApduServiceInfo(PackageManager pm, ResolveInfo info, boolean onHost) throws XmlPullParserException, IOException {
        ...
        if (onHost && !"host-apdu-service".equals(tagName)) {
            ...
            while (true) {
                ...
                if (eventType4 == 3 && parser.getDepth() <= depth3) {
                    break;
                }
                if (eventType4 == 1) {
                    break;
                ...
                if (!onHost) {
                    depth2 = depth3;
                    if (eventType4 == 2 && "apdu-pattern-group".equals(tagName3) && currApduPatternGroup2 == null) {
                ...
                if (!onHost && eventType4 == 3 && "apdu-pattern-group".equals(tagName3) && currApduPatternGroup2 != null) {
                ...
                } else if (!onHost && eventType4 == 2 && "apdu-pattern-filter".equals(tagName3) && currApduPatternGroup2 != null) {
                    currApduPatternGroup = currApduPatternGroup2;
                } else if (eventType4 == 2 && "nfcid2-group".equals(tagName3) && currentNfcid2Group == null) {
                    ...
                    currApduPatternGroup = currApduPatternGroup2;
                    if (eventType4 == 3 && "nfcid2-group".equals(tagName3) && currentNfcid2Group != null) {
                    ...
                    } else if (eventType4 == 2 && "nfcid2-filter".equals(tagName3) && currentNfcid2Group != null) {
            ...
            if (extParser != null) {
                ...
                if (str2.equals(tagName2)) {
                    ...
                    while (true) {
                        ...
                        if (eventType2 == 2 && "se-id".equals(tagName4)) {
                            ...
                            str2 = str;
                        } else if (eventType2 == 2 && "se-power-state".equals(tagName4)) {
                        ...
                        } else if (eventType2 != 2 || !"felica-id".equals(tagName4)) {
                            depth = depth;
                            nfcSeExtParser4 = nfcSeExtParser4;
                            si3 = si3;
                            eventType = eventType2;
            ...
            if (nfcSeExtParser != null) {
                try {
                    int eventType5 = nfcSeExtParser.getEventType();
                    int depth4 = nfcSeExtParser.getDepth();
                    int i = 1;
                    this.mAidSupport = true;
                    while (eventType5 != 2 && eventType5 != i) {
                        try {
                            eventType5 = nfcSeExtParser.next();
                            i = 1;
                    ...
                    if (str.equals(tagName5)) {
                        while (true) {
                            int eventType6 = nfcSeExtParser.next();
                            if (eventType6 == 3 && nfcSeExtParser.getDepth() <= depth4) {
                            ...
                            if (eventType6 != 2 || !"se-id".equals(tagName6)) {
                                nfcSeExtParser2 = nfcSeExtParser;
                            } else {
                                nfcSeExtParser2 = nfcSeExtParser;
                                try {
                            ...
                            if (eventType6 == 2 && "AID-based".equals(tagName6)) {
    ...
    public ApduServiceInfo createApduServiceInfo() {
        ...
        if (IS_ST) {
            ...
            apduServiceInfo = new ApduServiceInfo(resolveInfo, description, nxpAidGroups2AidGroups, nxpAidGroups2AidGroups2, requiresUnlock, bannerId, uid, settingsActivityName, str, this.mSeExtension.getSEName());
        } else {
            ...
            if (!isOnHost()) {
                str = this.mSeExtension.getSEName();
            }
    ...
    public String getOtherAidGroupDescription() {
        ...
        if (this.mStaticNxpAidGroups.containsKey("other")) {
            otherAidGroupDescription = this.mStaticNxpAidGroups.get("other").description;
        } else if (this.mDynamicNxpAidGroups.containsKey("other")) {
            otherAidGroupDescription = this.mDynamicNxpAidGroups.get("other").description;
        } else {
            Log.e(TAG, "getOtherAidGroupDescription: Aid Group with OTHER category not available");
        }
        Log.i(TAG, "getOtherAidGroupDescription: " + otherAidGroupDescription);

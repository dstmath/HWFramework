...
public class Binder implements IBinder {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x005b, code lost:
        r5.callEnded(r0, r7.dataSize(), r8.dataSize(), android.os.Binder.sWorkSourceProvider.resolveWorkSourceUid(r7.readCallingWorkSourceUid()));
     */
    ...
    private boolean execTransactInternal(int code, long dataObj, long replyObj, int flags, int callingUid) {
        ...
        if (tracingEnabled) {
            try {
                ...
                if ((e instanceof SecurityException) && message != null && message.contains("incorrect interface")) {
                    Log.e(TAG, "server side security exception: " + this + ", interface: " + this.mDescriptor);
                }

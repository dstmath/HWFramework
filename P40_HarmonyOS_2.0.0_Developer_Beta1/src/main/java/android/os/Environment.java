...
public class Environment {
    ...
    public static final String DIR_ANDROID = (IS_TV_RPODUCT ? "Harmony" : "Android");
    ...
    private static final boolean IS_TV_RPODUCT = ("tv".equals(SystemProperties.get("ro.build.characteristics", PhoneConstants.APN_TYPE_DEFAULT)) || "mobiletv".equals(SystemProperties.get("ro.build.characteristics", PhoneConstants.APN_TYPE_DEFAULT)));
    ...
    public static class UserEnvironment {
        ...
        public File[] buildExternalStorageAndroidDataDirs() {
            return Environment.buildPaths(getExternalDirs(), Environment.DIR_ANDROID, "data");
        }

        public File[] buildExternalStorageAndroidObbDirs() {
            return Environment.buildPaths(getExternalDirs(), Environment.DIR_ANDROID, "obb");
        }

        public File[] buildExternalStorageAppDataDirs(String packageName) {
            return Environment.buildPaths(getExternalDirs(), Environment.DIR_ANDROID, "data", packageName);
        }

        public File[] buildExternalStorageAppMediaDirs(String packageName) {
            return Environment.buildPaths(getExternalDirs(), Environment.DIR_ANDROID, "media", packageName);
        }

        public File[] buildExternalStorageAppObbDirs(String packageName) {
            return Environment.buildPaths(getExternalDirs(), Environment.DIR_ANDROID, "obb", packageName);
        }

        public File[] buildExternalStorageAppFilesDirs(String packageName) {
            return Environment.buildPaths(getExternalDirs(), Environment.DIR_ANDROID, "data", packageName, "files");
        }

        public File[] buildExternalStorageAppCacheDirs(String packageName) {
            return Environment.buildPaths(getExternalDirs(), Environment.DIR_ANDROID, "data", packageName, Environment.DIR_CACHE);
        }
    }
    ...
    public static File getLegacyExternalStorageObbDirectory() {
        return buildPath(getLegacyExternalStorageDirectory(), DIR_ANDROID, "obb");
    }

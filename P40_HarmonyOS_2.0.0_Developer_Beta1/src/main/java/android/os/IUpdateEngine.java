...
public interface IUpdateEngine extends IInterface {
    ...
    int checkPkgValidAndUncompress(String str, String str2) throws RemoteException;
    ...
    boolean setCurrentSlot() throws RemoteException;

    boolean setSlot() throws RemoteException;

    void startRemovePara(String str, String str2) throws RemoteException;
    ...
    public static class Default implements IUpdateEngine {
        ...
        @Override // android.os.IUpdateEngine
        public int checkPkgValidAndUncompress(String source_path, String dest_path) throws RemoteException {
            return 0;
        }

        @Override // android.os.IUpdateEngine
        public int deleteDir(String dir_path) throws RemoteException {
            return 0;
        }

        @Override // android.os.IUpdateEngine
        public void startRemovePara(String domain, String cfgDir) throws RemoteException {
        }

        @Override // android.os.IUpdateEngine
        public boolean setCurrentSlot() throws RemoteException {
            return false;
        }
    ...
    public static abstract class Stub extends Binder implements IUpdateEngine {
        ...
        static final int TRANSACTION_checkPkgValidAndUncompress = 16;
        static final int TRANSACTION_deleteDir = 17;
        ...
        static final int TRANSACTION_setCurrentSlot = 19;
        static final int TRANSACTION_setSlot = 12;
        static final int TRANSACTION_startRemovePara = 18;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 16:
                    return "checkPkgValidAndUncompress";
                case 17:
                    return "deleteDir";
                case 18:
                    return "startRemovePara";
                case 19:
                    return "setCurrentSlot";
                default:
                    return null;
            }
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 16:
                        data.enforceInterface(DESCRIPTOR);
                        int _result3 = checkPkgValidAndUncompress(data.readString(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 17:
                        data.enforceInterface(DESCRIPTOR);
                        int _result4 = deleteDir(data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result4);
                        return true;
                    case 18:
                        data.enforceInterface(DESCRIPTOR);
                        startRemovePara(data.readString(), data.readString());
                        reply.writeNoException();
                        return true;
                    case 19:
                        data.enforceInterface(DESCRIPTOR);
                        boolean currentSlot = setCurrentSlot();
                        reply.writeNoException();
                        reply.writeInt(currentSlot ? 1 : 0);
                        return true;
                    default:
        ...
        public static class Proxy implements IUpdateEngine {
            ...
            public int checkPkgValidAndUncompress(String source_path, String dest_path) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(source_path);
                    _data.writeString(dest_path);
                    if (!this.mRemote.transact(16, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().checkPkgValidAndUncompress(source_path, dest_path);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
            ...
            public int deleteDir(String dir_path) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(dir_path);
                    if (!this.mRemote.transact(17, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().deleteDir(dir_path);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
            ...
            public void startRemovePara(String domain, String cfgDir) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().startRemovePara(domain, cfgDir);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public boolean setCurrentSlot() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(19, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setCurrentSlot();
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;

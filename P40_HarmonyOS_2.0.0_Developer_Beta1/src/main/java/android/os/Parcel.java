...
public final class Parcel {
    ...
    public final void writeException(Exception e) {
        ...
        if (code != 0) {
            ...
            writeString(message);
            boolean isStackTraceNeeded = sParcelExceptionStackTrace || (message != null && message.contains("incorrect interface"));
            long timeNow = isStackTraceNeeded ? SystemClock.elapsedRealtime() : 0;
            if (!isStackTraceNeeded || timeNow - sLastWriteExceptionStackTrace <= 1000) {
                writeInt(0);
            } else {

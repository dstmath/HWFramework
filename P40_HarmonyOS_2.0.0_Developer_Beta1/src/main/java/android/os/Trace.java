...
public final class Trace {
    ...
    static {
        SystemProperties.addChangeCallback($$Lambda$Trace$2zLZLc2kAXsVjw_nLYeNhqmGq0.INSTANCE);
    }
    ...
    public static void traceCounter(long traceTag, String counterName, int counterValue) {
        if (isTagEnabled(traceTag)) {
            nativeTraceCounter(traceTag, counterName, (long) counterValue);
        }
    }
    ...
    public static void beginAsyncSection(String methodName, int cookie) {
        asyncTraceBegin(4096, methodName, cookie);
    }

    public static void endAsyncSection(String methodName, int cookie) {
        asyncTraceEnd(4096, methodName, cookie);
    }

    public static void setCounter(String counterName, long counterValue) {
        if (isTagEnabled(4096)) {
            nativeTraceCounter(4096, counterName, counterValue);
        }
    }
}

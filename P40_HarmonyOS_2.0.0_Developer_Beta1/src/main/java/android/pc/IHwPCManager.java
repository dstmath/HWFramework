...
public interface IHwPCManager extends IInterface {
    ...
    boolean isScreenOnAccurately() throws RemoteException;
    ...
    void setDockBarInfo(int i, Bundle bundle) throws RemoteException;
    ...
    public static class Default implements IHwPCManager {
        ...
        @Override // android.pc.IHwPCManager
        public boolean isScreenOnAccurately() throws RemoteException {
            return false;
        }
        ...
        @Override // android.pc.IHwPCManager
        public void setDockBarInfo(int mode, Bundle info) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IHwPCManager {
        ...
        static final int TRANSACTION_checkPermissionForHwMultiDisplay = 44;
        static final int TRANSACTION_closeTopWindow = 17;
        static final int TRANSACTION_disableRio = 72;
        static final int TRANSACTION_dispatchKeyEventForExclusiveKeyboard = 33;
        static final int TRANSACTION_enableRio = 71;
        static final int TRANSACTION_enterFullScreen = 68;
        static final int TRANSACTION_execVoiceCmd = 40;
        static final int TRANSACTION_exitFullScreen = 69;
        static final int TRANSACTION_forceDisplayMode = 24;
        static final int TRANSACTION_getAllSupportPcAppList = 3;
        static final int TRANSACTION_getCarAppList = 75;
        static final int TRANSACTION_getCastMode = 1;
        static final int TRANSACTION_getDisplayBitmap = 12;
        static final int TRANSACTION_getFocusedDisplayId = 59;
        static final int TRANSACTION_getHwRecentTaskInfo = 11;
        static final int TRANSACTION_getHwRioRule = 70;
        static final int TRANSACTION_getPCDisplayId = 39;
        ...
        static final int TRANSACTION_hideImeStatusIcon = 35;
        ...
        static final int TRANSACTION_isAvoidShowDefaultKeyguard = 60;
        static final int TRANSACTION_isConnectExtDisplayFromPkg = 43;
        static final int TRANSACTION_isDisallowLockScreenForHwMultiDisplay = 49;
        static final int TRANSACTION_isFocusedOnWindowsCastDisplay = 61;
        static final int TRANSACTION_isHiCarCastModeForClient = 45;
        static final int TRANSACTION_isInBasicMode = 66;
        static final int TRANSACTION_isInSinkWindowsCastMode = 54;
        static final int TRANSACTION_isInWindowsCastMode = 53;
        static final int TRANSACTION_isModeSupportDrag = 67;
        static final int TRANSACTION_isPackageRunningOnPCMode = 29;
        static final int TRANSACTION_isPadAssistantMode = 64;
        static final int TRANSACTION_isRioEnable = 73;
        static final int TRANSACTION_isScreenOnAccurately = 30;
        static final int TRANSACTION_isScreenPowerOn = 31;
        static final int TRANSACTION_isShopDemo = 50;
        static final int TRANSACTION_isSinkHasKeyboard = 56;
        static final int TRANSACTION_lockScreen = 28;
        static final int TRANSACTION_notifyDpState = 38;
        static final int TRANSACTION_onTaskMovedToBack = 46;
        static final int TRANSACTION_onTaskMovedToFront = 47;
        static final int TRANSACTION_registHwSystemUIController = 13;
        static final int TRANSACTION_relaunchIMEIfNecessary = 7;
        static final int TRANSACTION_removeCarApp = 76;
        static final int TRANSACTION_saveAppIntent = 25;
        static final int TRANSACTION_saveNeedRestartAppIntent = 48;
        ...
        static final int TRANSACTION_screenshotPc = 16;
        static final int TRANSACTION_sendLockScreenShowViewMsg = 52;
        static final int TRANSACTION_setCarApp = 74;
        static final int TRANSACTION_setCustomPointerIcon = 36;
        static final int TRANSACTION_setDockBarInfo = 77;
        static final int TRANSACTION_setIsInBasicMode = 65;
        static final int TRANSACTION_setIsInSinkWindowsCastMode = 55;
        static final int TRANSACTION_setIsSinkHasKeyboard = 57;
        static final int TRANSACTION_setNetworkReconnectionState = 51;
        static final int TRANSACTION_setPadAssistant = 63;
        static final int TRANSACTION_setPointerIconType = 37;
        static final int TRANSACTION_setScreenPower = 32;
        static final int TRANSACTION_shouldInterceptInputEvent = 41;
        static final int TRANSACTION_showDialogForSwitchDisplay = 58;
        static final int TRANSACTION_showImeStatusIcon = 34;
        static final int TRANSACTION_showStartMenu = 15;
        static final int TRANSACTION_showTopBar = 14;
        static final int TRANSACTION_toggleHome = 21;
        static final int TRANSACTION_triggerRecentTaskSplitView = 18;
        static final int TRANSACTION_triggerSplitWindowPreviewLayer = 19;
        static final int TRANSACTION_triggerSwitchTaskView = 20;
        static final int TRANSACTION_updateFocusDisplayToWindowsCast = 62;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 30:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isScreenOnAccurately = isScreenOnAccurately();
                        reply.writeNoException();
                        reply.writeInt(isScreenOnAccurately ? 1 : 0);
                        return true;
                    case 31:
                        data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements IHwPCManager {
            ...
            public boolean isScreenOnAccurately() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(30, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().isScreenOnAccurately();
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public void setDockBarInfo(int mode, Bundle info) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().setDockBarInfo(mode, info);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }

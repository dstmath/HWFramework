            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 3:
                        ...
                        IPrintDocumentAdapter _arg12 = IPrintDocumentAdapter.Stub.asInterface(data.readStrongBinder());
                        if (data.readInt() != 0) {
                            _arg2 = PrintAttributes.CREATOR.createFromParcel(data);
                        } else {
                            _arg2 = null;
                        }
                        Bundle _result3 = print(_arg08, _arg12, _arg2, data.readString(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        if (_result3 != null) {
                            reply.writeInt(1);
                    ...
                    case 24:
                        ...
                        setBindInstantServiceAllowed(_arg09, _arg1);
                        reply.writeNoException();
                        return true;
                    default:

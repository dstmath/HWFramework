...
public class SearchIndexablesContract {
    ...
    public static final String[] INDEXABLES_XML_RES_COLUMNS = {BaseColumns.COLUMN_RANK, XmlResource.COLUMN_XML_RESID, BaseColumns.COLUMN_CLASS_NAME, BaseColumns.COLUMN_ICON_RESID, BaseColumns.COLUMN_INTENT_ACTION, BaseColumns.COLUMN_INTENT_TARGET_PACKAGE, BaseColumns.COLUMN_INTENT_TARGET_CLASS};

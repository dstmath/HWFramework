...
public interface IHwSysResManager extends IInterface {
    ...
    List<String> getCtsPkgs() throws RemoteException;
    ...
    void reportTopActData(Bundle bundle) throws RemoteException;
    ...
    public static class Default implements IHwSysResManager {
        ...
        @Override // android.rms.IHwSysResManager
        public String fetchBigDataByVersion(int awareVersion, int featureId, boolean beta, boolean clear) throws RemoteException {
            return null;
        }
        ...
        @Override // android.rms.IHwSysResManager
        public void reportTopActData(Bundle bdl) throws RemoteException {
        }
        ...
        @Override // android.rms.IHwSysResManager
        public List<String> getCtsPkgs() throws RemoteException {
            return null;
        }
    ...
    public static abstract class Stub extends Binder implements IHwSysResManager {
        ...
        static final int TRANSACTION_getCtsPkgs = 54;
        ...
        static final int TRANSACTION_reportTopActData = 49;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 2:
                        ...
                        recordResourceOverloadStatus(_arg010, _arg13, _arg24, _arg33, _arg4, _arg5, _arg6);
                        reply.writeNoException();
                        return true;
                    case 3:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 5:
                        ...
                        notifyResourceStatus(_arg012, _arg14, _arg26, _arg32);
                        reply.writeNoException();
                        return true;
                    case 6:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 17:
                        ...
                        String _result5 = saveBigData(_arg015, _arg23);
                        reply.writeNoException();
                    ...
                    case 18:
                        ...
                        String _result6 = fetchBigDataByVersion(_arg016, _arg15, _arg27, _arg23);
                        reply.writeNoException();
                    ...
                    case 35:
                        ...
                        reportAppType(_arg017, _arg16, _arg23, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 36:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 47:
                        ...
                        registerDevModeMethod(_arg018, _arg17, _arg2);
                        reply.writeNoException();
                        return true;
                    case 48:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        unregisterDevModeMethod(_arg019, _arg18, _arg22);
                        reply.writeNoException();
                        return true;
                    case 49:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 54:
                        data.enforceInterface(DESCRIPTOR);
                        List<String> _result19 = getCtsPkgs();
                        reply.writeNoException();
        ...
        public static class Proxy implements IHwSysResManager {
            ...
            public String fetchBigDataByVersion(int awareVersion, int featureId, boolean beta, boolean clear) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(18, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().fetchBigDataByVersion(awareVersion, featureId, beta, clear);
                    }
                    _reply.readException();
                    String _result = _reply.readString();
                    _reply.recycle();
            ...
            public void reportTopActData(Bundle bdl) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().reportTopActData(bdl);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public List<String> getCtsPkgs() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(54, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getCtsPkgs();
                    }
                    _reply.readException();
                    List<String> _result = _reply.createStringArrayList();
                    _reply.recycle();

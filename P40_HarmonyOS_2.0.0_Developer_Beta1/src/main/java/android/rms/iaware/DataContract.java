...
public final class DataContract {
    ...
    public static class Apps implements BaseAttr, AppAttr, BaseProperty, AppProperty {
        ...
        public static final class Builder extends BaseBuilder {
            ...
            public Builder addLaunchCalledApp(String packageName, String processName, String launchMode, String launchReason, int[] procIds) {
                DataNormalizer normalizer = new DataNormalizer();
                normalizer.appendCondition(BaseProperty.PACKAGE_NAME, packageName);
                normalizer.appendCondition(BaseProperty.PROCESS_NAME, processName);
                ...
                if (procIds == null || procIds.length != 2) {
                    normalizer.appendCondition(BaseProperty.PROCESS_ID, String.valueOf(-1));
                    normalizer.appendCondition(BaseProperty.UID, String.valueOf(-1));
                } else {
                    normalizer.appendCondition(BaseProperty.PROCESS_ID, String.valueOf(procIds[0]));
                    normalizer.appendCondition(BaseProperty.UID, String.valueOf(procIds[1]));
                }
                this.mCollects.appendCollect(AppAttr.CALLED_APP, normalizer.toString());
                return this;
            }

...
public class DataNormalizer {
    ...
    public static String[] parseCollect(String collect) {
        ...
        return (end < 1 || end > collect.length() - 1) ? new String[0] : new String[]{collect.substring(0, end), collect.substring(end + 1)};
    }
    ...
    public static String[] parseCondition(String condition) {
        ...
        return (end < 1 || end > condition.length() - 1) ? new String[0] : new String[]{condition.substring(0, end), condition.substring(end + 1)};
    }
}

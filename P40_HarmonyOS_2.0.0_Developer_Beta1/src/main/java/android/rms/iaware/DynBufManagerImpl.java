        ...
        if (context != null) {
            ...
            if (this.mPkgName != null) {
                if (context.toString().contains("Activity")) {
                    this.mActivityName = context.toString();
                } else {
                ...
                if (this.mRefreshRateIndex != -1 && (dynBufSdkCallback = this.mDynBufSdkCallback) == null) {
                    ...
                    IAwareSdk.asyncReportDataWithCallback(3042, this.mPkgName, this.mDynBufSdkCallback, System.currentTimeMillis());
                }
            }
        }
    }
        ...
        if (this.mJankCount != null) {
            ...
            if (jankCount > 1) {
                ...
                if (this.mActivityName == null) {
                    ...
                    str = "/" + this.mActivityName;
                }
                sb.append(str);
                Jlog.d(475, "#ARG1:<" + sb.toString() + ">#ARG2:<" + jankCount + ">#RR:<" + this.mFrameIntervalMs + ">#ST:<" + SystemClock.uptimeMillis() + ">");
            }
        }
    }

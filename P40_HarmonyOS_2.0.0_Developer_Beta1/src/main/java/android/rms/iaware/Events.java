...
public final class Events {
    ...
    public static final int EVENT_BASE_APP_TYPE = 30000;
    public static final int EVENT_BASE_DEV_STATUS = 10000;
    public static final int EVENT_BASE_HOSP = 40000;
    ...
    public interface AppTypeEvents {
        public static final int EVENT_GET_APP_DEVICE_ID_ACCESS = 40001;
        public static final int EVENT_GET_APP_SCROLL_TOP_ENABLE = 40002;
    }

    public interface DevStatusEvents {
        public static final int EVENT_LOW_MEMORY = 20029;
        public static final int EVENT_MEDIA_BUTTON_CLICK = 20017;
        public static final int EVENT_MID_NIGHT = 20027;
        ...
        public static final int EVENT_SCHED_THREAD_RTG = 20032;
        ...
        public static final int EVENT_SYSTEM_MANAGER_CLEAN = 20031;
        public static final int EVENT_USER_PRESENT = 20022;
        public static final int EVENT_WAKEUP_PRELAUNCH_CAMERA = 20025;
    }

    public interface HospEvents {
        public static final int EVENT_MIDDLEWARE_TRANSACT = 50001;
    }

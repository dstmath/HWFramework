...
public class KeyStore {
    ...
    private static final int FUTURE_WAIT_TIME_MAX = 10;
    ...
    public byte[] get(String key, int uid, boolean suppressKeyNotFoundWarning) {
        try {
            if (this.mBinder == null) {
                Log.w(TAG, "mBinder is null on get");
                return null;
            }
    ...
    public int delete2(String key, int uid) {
        try {
            ...
            Log.w(TAG, "mBinder is null on delete2");
            return 4;
        } catch (RemoteException e) {
            Log.w(TAG, "Cannot connect to keystore", e);
            return 4;
    ...
    public String[] list(String prefix, int uid) {
        try {
            ...
            Log.w(TAG, "mBinder is null on list");
            return null;
        } catch (RemoteException e) {
            Log.w(TAG, "Cannot connect to keystore", e);
            return null;
    ...
    public boolean lock(int userId) {
        try {
            if (this.mBinder == null) {
                Log.w(TAG, "mBinder is null on lock");
                return false;
            } else if (this.mBinder.lock(userId) == 1) {
                return true;
            } else {
                return false;
            }
    ...
    public boolean unlock(int userId, String password) {
        try {
            if (this.mBinder == null) {
                Log.w(TAG, "mBinder is null on unlock");
                return false;
            }
    ...
    public boolean isEmpty(int userId) {
        try {
            if (this.mBinder == null) {
                Log.w(TAG, "mBinder is null on isEmpty");
                return false;
            } else if (this.mBinder.isEmpty(userId) != 0) {
                return true;
            } else {
                return false;
            }
    ...
    public String grant(String key, int uid) {
        try {
            if (this.mBinder == null) {
                Log.w(TAG, "mBinder is null on grant");
                return null;
            }
    ...
    public boolean ungrant(String key, int uid) {
        try {
            if (this.mBinder == null) {
                Log.w(TAG, "mBinder is null on ungrant");
                return false;
            } else if (this.mBinder.ungrant(key, uid) == 1) {
                return true;
            } else {
                return false;
            }
    ...
    public boolean isHardwareBacked(String keyType) {
        try {
            if (this.mBinder == null) {
                Log.w(TAG, "mBinder is null on isHardwareBacked");
                return false;
            } else if (this.mBinder.is_hardware_backed(keyType.toUpperCase(Locale.US)) == 1) {
                return true;
            } else {
                return false;
            }
    ...
    public boolean clearUid(int uid) {
        try {
            if (this.mBinder == null) {
                Log.w(TAG, "mBinder is null on clearUid");
                return false;
            } else if (this.mBinder.clear_uid((long) uid) == 1) {
                return true;
            } else {
                return false;
            }
    ...
    public boolean addRngEntropy(byte[] data, int flags) {
        ...
        try {
            ...
            if (this.mBinder.addRngEntropy(promise, data, flags) == 1) {
                if (promise.getFuture().get(10, TimeUnit.SECONDS).getErrorCode() != 1) {
                    z = false;
                }
                return z;
            }
    ...
    private int generateKeyInternal(String alias, KeymasterArguments args, byte[] entropy, int uid, int flags, KeyCharacteristics outCharacteristics) throws RemoteException, ExecutionException, InterruptedException {
        ...
        try {
            ...
            KeyCharacteristicsCallbackResult result = promise.getFuture().get(10, TimeUnit.SECONDS);
            this.mBinder.asBinder().unlinkToDeath(promise, 0);
            ...
            Log.e(TAG, "generateKeyInternal completed with exception", e2);
            this.mBinder.asBinder().unlinkToDeath(promise, 0);
            return 4;
        } catch (Throwable th) {
            e = th;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:32:0x0085, code lost:
        r12 = e;
     */
    /* JADX WARNING: Removed duplicated region for block: B:32:0x0085 A[ExcHandler: InterruptedException | ExecutionException | TimeoutException (e java.lang.Throwable), Splitter:B:18:0x0041] */
    ...
    private int importKeyInternal(String alias, KeymasterArguments args, int format, byte[] keyData, int uid, int flags, KeyCharacteristics outCharacteristics) throws RemoteException, ExecutionException, InterruptedException {
        ...
        try {
            ...
            try {
                ...
                e2 = e3;
                try {
                    Log.e(TAG, "importKeyInternal completed with exception", e2);
                    this.mBinder.asBinder().unlinkToDeath(promise, 0);
                    return 4;
                } catch (Throwable th) {
                    e = th;
    ...
    private int importWrappedKeyInternal(String wrappedKeyAlias, byte[] wrappedKey, String wrappingKeyAlias, byte[] maskingKey, KeymasterArguments args, long rootSid, long fingerprintSid, KeyCharacteristics outCharacteristics) throws RemoteException, ExecutionException, InterruptedException {
        ...
        try {
            ...
            try {
                ...
                e2 = e3;
                try {
                    Log.e(TAG, "importWrappedKeyInternal completed with exception", e2);
                    this.mBinder.asBinder().unlinkToDeath(promise, 0);
                    return 4;
                } catch (Throwable th) {
                    e = th;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x0063, code lost:
        r0 = e;
     */
    /* JADX WARNING: Removed duplicated region for block: B:22:0x0063 A[ExcHandler: InterruptedException | ExecutionException | TimeoutException (e java.lang.Throwable), Splitter:B:18:0x0054] */
    public ExportResult exportKey(String alias, int format, KeymasterBlob clientId, KeymasterBlob appId, int uid) {
        ...
        try {
            ...
            try {
                ...
                if (error == 1) {
                    ExportResult exportResult = promise.getFuture().get(10, TimeUnit.SECONDS);
                    this.mBinder.asBinder().unlinkToDeath(promise, 0);
                    return exportResult;
                }
                try {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x0064, code lost:
        r0 = e;
     */
    /* JADX WARNING: Removed duplicated region for block: B:22:0x0064 A[ExcHandler: InterruptedException | ExecutionException | TimeoutException (e java.lang.Throwable), Splitter:B:18:0x0055] */
    public OperationResult begin(String alias, int purpose, boolean pruneable, KeymasterArguments args, byte[] entropy, int uid) {
        ...
        try {
            ...
            try {
                ...
                if (errorCode == 1) {
                    OperationResult operationResult = promise.getFuture().get(10, TimeUnit.SECONDS);
                    this.mBinder.asBinder().unlinkToDeath(promise, 0);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:23:?, code lost:
        android.util.Log.e(android.security.KeyStore.TAG, "Update completed with exception", r4);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x005b, code lost:
        r9.mBinder.asBinder().unlinkToDeath(r1, 0);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0065, code lost:
        return null;
     */
    /* JADX WARNING: Removed duplicated region for block: B:20:0x0055 A[ExcHandler: InterruptedException | ExecutionException | TimeoutException (r4v7 'e' java.lang.Exception A[CUSTOM_DECLARE]), Splitter:B:15:0x0044] */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x0060, code lost:
        r12 = e;
     */
    /* JADX WARNING: Removed duplicated region for block: B:29:0x0060 A[ExcHandler: InterruptedException | ExecutionException | TimeoutException (e java.lang.Throwable), Splitter:B:23:0x004d] */
    ...
    public int abort(IBinder token) {
        ...
        try {
            ...
            if (errorCode == 1) {
                return promise.getFuture().get(10, TimeUnit.SECONDS).getErrorCode();
            }
            this.mBinder.asBinder().unlinkToDeath(promise, 0);
            return errorCode;
        } catch (RemoteException e) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:?, code lost:
        android.util.Log.e(android.security.KeyStore.TAG, "AttestKey completed with exception", r4);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0069, code lost:
        r10.mBinder.asBinder().unlinkToDeath(r1, 0);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x0073, code lost:
        return 4;
     */
    /* JADX WARNING: Removed duplicated region for block: B:19:0x0063 A[ExcHandler: InterruptedException | ExecutionException | TimeoutException (r4v5 'e' java.lang.Exception A[CUSTOM_DECLARE]), Splitter:B:12:0x0036] */
    public int attestKey(String alias, KeymasterArguments params, KeymasterCertificateChain outChain) {
        ...
        try {
            ...
            try {
                KeyAttestationCallbackResult result = promise.getFuture().get(10, TimeUnit.SECONDS);
                int error2 = result.getKeystoreResponse().getErrorCode();
                if (error2 == 1) {
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:22:?, code lost:
        android.util.Log.e(android.security.KeyStore.TAG, "AttestDevicdeIds completed with exception", r4);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0069, code lost:
        r10.mBinder.asBinder().unlinkToDeath(r1, 0);
     */
    ...
    public void onDeviceOffBody() {
        try {
            if (this.mBinder == null) {
                Log.w(TAG, "mBinder is null on device off body");
            } else {
    ...
    public int presentConfirmationPrompt(IBinder listener, String promptText, byte[] extraData, String locale, int uiOptionsAsFlags) {
        try {
            ...
            Log.w(TAG, "mBinder is null on present confirmation");
            return 5;
        } catch (RemoteException e) {
            Log.w(TAG, "Cannot connect to keystore", e);
            return 5;
    ...
    public int cancelConfirmationPrompt(IBinder listener) {
        try {
            ...
            Log.w(TAG, "mBinder is null on cancel confirmation");
            return 5;
        } catch (RemoteException e) {
            Log.w(TAG, "Cannot connect to keystore", e);
            return 5;
    ...
    public boolean isConfirmationPromptSupported() {
        try {
            ...
            Log.w(TAG, "mBinder is null on confirmation");
            return false;
        } catch (RemoteException e) {
            Log.w(TAG, "Cannot connect to keystore", e);
            return false;
    ...
    public InvalidKeyException getInvalidKeyException(String keystoreKeyAlias, int uid, KeyStoreException e) {
        ...
        if (errorCode != 15) {
            switch (errorCode) {
                ...
                default:
                    Log.w(TAG, "keystore operation failed error code " + e.getErrorCode());

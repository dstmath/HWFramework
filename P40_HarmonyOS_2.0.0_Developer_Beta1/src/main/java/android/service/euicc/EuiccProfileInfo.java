...
public final class EuiccProfileInfo implements Parcelable {
    ...
    public EuiccProfileInfo(String iccid, UiccAccessRule[] accessRules, String nickname) {
        if (TextUtils.isDigitsOnly(iccid) || validIccid(iccid)) {
            this.mIccid = iccid;
    ...
    public static final class Builder {
        ...
        public Builder(String value) {
            if (TextUtils.isDigitsOnly(value) || EuiccProfileInfo.validIccid(value)) {
                this.mIccid = value;
                return;
            }
    ...
    public static boolean validIccid(String iccid) {
        if (TextUtils.isEmpty(iccid)) {
            return false;
        }
        return iccid.matches("^[0-9a-fA-F]+$");
    }

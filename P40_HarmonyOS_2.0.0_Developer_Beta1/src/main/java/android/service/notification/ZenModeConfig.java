...
public class ZenModeConfig implements Parcelable {
    ...
    public static Condition toNextAlarmCondition(Context context, long alarm, int userHandle) {
        return new Condition(toCountdownConditionId(alarm, true), "", context.getResources().getString(R.string.zen_mode_until, getFormattedTime(context, alarm, isToday(alarm), userHandle)), "", 0, 1, 1);
    }

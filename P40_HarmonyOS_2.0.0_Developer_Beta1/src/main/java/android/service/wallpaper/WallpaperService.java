...
public abstract class WallpaperService extends Service {
    ...
    public class Engine {
        ...
        public Engine(Supplier<Long> clockFunction, Handler handler) {
            ...
            this.mSurfaceHolder = new BaseSurfaceHolder() {
                ...
                public Canvas lockHardwareCanvas() {
                    Canvas canvas;
                    prepareToDraw();
                    if (Engine.this.mDisplay == null || !Engine.this.mDisplay.isWideColorGamut() || (canvas = super.lockHardwareWideColorGamutCanvas()) == null) {
                        return super.lockHardwareCanvas();
                    }
                    Log.d(WallpaperService.TAG, "lock hardware wide color gamut canvas");
                    return canvas;
                }
            };
        ...
        /* access modifiers changed from: package-private */
        /* JADX WARNING: Removed duplicated region for block: B:220:0x05e8 A[Catch:{ RemoteException -> 0x05f5 }] */

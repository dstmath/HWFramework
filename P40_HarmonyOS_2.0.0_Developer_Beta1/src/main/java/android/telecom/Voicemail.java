...
public class Voicemail implements Parcelable {
    public static final Parcelable.Creator<Voicemail> CREATOR = new Parcelable.Creator<Voicemail>() {
        /* class android.telecom.Voicemail.AnonymousClass1 */
    ...
    public static class Builder {
        ...
        public Voicemail build() {
            ...
            this.mBuilderId = Long.valueOf(l == null ? -1 : l.longValue());
            Long l2 = this.mBuilderTimestamp;
            long j = 0;
            this.mBuilderTimestamp = Long.valueOf(l2 == null ? 0 : l2.longValue());

...
public class HwTelephonyManager {
    ...
    public static final int MODEM_ID_MAIN_MODEM = 0;
    public static final int MODEM_ID_SECONDARY_MODEM = 1;
    public static final int NETWORK_CLASS_2_G = 1;
    public static final int NETWORK_MODE_NSA = 1;
    public static final int NETWORK_MODE_SA = 2;
    ...
    public int getPlatformSupportVSimVer(int key) {
        return HwTelephonyManagerInner.getDefault().getPlatformSupportVsimVer(key);
    }
    ...
    public boolean setNrOptionModeForSlotId(int slotId, int mode, Message msg) {
        return HwTelephonyManagerInner.getDefault().setNrOptionModeForSlotId(slotId, mode, msg);
    }
    ...
    public int getNrOptionModeForSlotId(int slotId) {
        return HwTelephonyManagerInner.getDefault().getNrOptionModeForSlotId(slotId);
    }
    ...
    public void setSimPowerStateForSlot(int slotIndex, int state, Message msg) {
        HwTelephonyManagerInner.getDefault().setSimPowerStateForSlot(slotIndex, state, msg);
    }

    public int getOtaStatus(EuiccManager euiccManager) {
        return HwEuiccManager.getOtaStatus(euiccManager);
    }

    public void startOtaUpdating(int cardId, int otaReason) {
        HwEuiccManager.startOtaUpdating(cardId, otaReason);
    }

    public int[] getSimFactoryCapability() {
        return HwTelephonyManagerInner.getDefault().getSimFactoryCapability();
    }

    public int getModemMaxCapability(int modemId) {
        return HwTelephonyManagerInner.getDefault().getModemMaxCapability(modemId);
    }

    public int getNetworkMode(int phoneId) {
        return HwTelephonyManagerInner.getDefault().getNetworkMode(phoneId);
    }

    public void setSwitchState(int type, int ability) {
        HwTelephonyManagerInner.getDefault().setSwitchState(type, ability);
    }

    public boolean getSwitchState(int type) {
        return HwTelephonyManagerInner.getDefault().getSwitchState(type);
    }

...
public abstract class RcsMessage {
    ...
    public /* synthetic */ Integer lambda$getSubscriptionId$0$RcsMessage(IRcs iRcs, String callingPackage) {
    ...
    public /* synthetic */ void lambda$setSubscriptionId$1$RcsMessage(int subId, IRcs iRcs, String callingPackage) {
        iRcs.setMessageSubId(this.mId, isIncoming(), subId, callingPackage);
    }

    public void setStatus(int rcsMessageStatus) {
    ...
    public /* synthetic */ void lambda$setStatus$2$RcsMessage(int rcsMessageStatus, IRcs iRcs, String callingPackage) {
    ...
    public /* synthetic */ Integer lambda$getStatus$3$RcsMessage(IRcs iRcs, String callingPackage) {
    ...
    public /* synthetic */ void lambda$setOriginationTimestamp$4$RcsMessage(long timestamp, IRcs iRcs, String callingPackage) {
    ...
    public /* synthetic */ Long lambda$getOriginationTimestamp$5$RcsMessage(IRcs iRcs, String callingPackage) {
    ...
    public /* synthetic */ void lambda$setRcsMessageId$6$RcsMessage(String rcsMessageGlobalId, IRcs iRcs, String callingPackage) {
    ...
    public /* synthetic */ String lambda$getRcsMessageId$7$RcsMessage(IRcs iRcs, String callingPackage) {
    ...
    public /* synthetic */ String lambda$getText$8$RcsMessage(IRcs iRcs, String callingPackage) {
    ...
    public /* synthetic */ void lambda$setText$9$RcsMessage(String text, IRcs iRcs, String callingPackage) {
    ...
    public /* synthetic */ Double lambda$getLatitude$10$RcsMessage(IRcs iRcs, String callingPackage) {
    ...
    public /* synthetic */ void lambda$setLatitude$11$RcsMessage(double latitude, IRcs iRcs, String callingPackage) {
    ...
    public /* synthetic */ Double lambda$getLongitude$12$RcsMessage(IRcs iRcs, String callingPackage) {
    ...
    public /* synthetic */ void lambda$setLongitude$13$RcsMessage(double longitude, IRcs iRcs, String callingPackage) {
        iRcs.setLongitudeForMessage(this.mId, isIncoming(), longitude, callingPackage);
    }

    public RcsFileTransferPart insertFileTransfer(RcsFileTransferCreationParams fileTransferCreationParameters) {
    ...
    public /* synthetic */ Integer lambda$insertFileTransfer$14$RcsMessage(RcsFileTransferCreationParams fileTransferCreationParameters, IRcs iRcs, String callingPackage) {
    ...
    public /* synthetic */ int[] lambda$getFileTransferParts$15$RcsMessage(IRcs iRcs, String callingPackage) {

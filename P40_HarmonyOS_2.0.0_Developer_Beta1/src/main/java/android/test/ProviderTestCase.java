...
public abstract class ProviderTestCase<T extends ContentProvider> extends InstrumentationTestCase {
    ...
    public void setUp() throws Exception {
        ...
        this.mProvider = (T) ProviderTestCase2.createProviderForTest(this.mProviderContext, this.mProviderClass, this.mProviderAuthority);
    ...
    public void tearDown() throws Exception {
        ...
        ProviderTestCase.super.tearDown();
    }

...
public final class HwPCUtils {
    ...
    public static final String CAR_DOCK = "CarNavigationBar_port";
    public static final String CAR_DOCK_PORTRAIT = "CarNavigationBar_horizontal";
    public static final String CAR_LAUNCHER = "CarLauncher";
    public static final String CAST_PLUS_VIRTUALDISPLAY_NAME = "CastPlusDisplay";
    ...
    public static final String MSDP_PACKAGE_NAME = "com.huawei.dmsdp";
    public static final int MULTI_DISPLAY_MODE_HICAR = 1;
    public static final int MULTI_DISPLAY_MODE_NONE = 0;
    ...
    public static boolean enabledInPad() {
    ...
    public static boolean isPcCastModeInServerEarly() {
        return enabled() && PC_MODE_EARLY;
    }

    public static void setPcCastModeInServerEarly(ProjectionMode mode) {
    ...
    public static boolean isValidExtDisplayId(int displayId) {
    ...
    public static boolean isPcCastMode() {
        ...
        try {
            ...
            Log.e(TAG, "call isPcCastMode error");
        }
        return false;
    }
    ...
    public static boolean isHiCarCastModeForClient() {
        try {
            ...
            Log.e(TAG, "call isHiCarCastModeForClient error");
            return false;
        }
    }
    ...
    public static boolean isInWindowsCastMode() {
        ...
        try {
            ...
            Log.e(TAG, "call isInWindowsCastMode error");
            return false;
        }
    }
    ...
    public static boolean isInSinkWindowsCastMode() {
        ...
        try {
            ...
            Log.e(TAG, "call isInSinkWindowsCastMode error");
            return false;
        }
    }
    ...
    public static void setIsInSinkWindowsCastMode(boolean isInCastMode) {
        ...
        if (SINK_WINDOWS_CAST_ENABLED && (mService = getHwPCManager()) != null) {
            try {
                ...
                Log.e(TAG, "call setIsInSinkWindowsCastMode error");
            }
        }
    }
    ...
    public static boolean isSinkHasKeyboard() {
        ...
        try {
            ...
            Log.e(TAG, "call isSinkHasKeyboard error");
            return false;
        }
    }
    ...
    public static IHwPCManager getHwPCManager() {
        try {
            ...
            Log.e(TAG, "getHwPCManager error");
            return null;
        }
    }
    ...
    public static Bundle hookStartActivityOptions(Context context, Bundle options) {
        ...
        if (!enabledInPad() || !PKG_DESKTOP_EXPLORER.equals(context.getPackageName()) || isPcCastMode()) {
            ...
            if (activityOptions.getLaunchDisplayId() == -1) {
                if (isDisconnectDisplayId(validDiplayid)) {
    ...
    private static boolean isDisconnectDisplayId(int displayId) {
        if (!isValidExtDisplayId(displayId) || isPcCastMode()) {
            return false;
        }
        return true;
    }
    ...
    public static void showImeStatusIcon(int iconResId, String pkgName) {
        try {
            Log.i(TAG, "PCU showImeStatusIcon start");
            IHwPCManager pcManager = getHwPCManager();
            if (pcManager != null) {
                pcManager.showImeStatusIcon(iconResId, pkgName);
            }
            Log.i(TAG, "PCU showImeStatusIcon end");
        } catch (RemoteException e) {
            Log.e(TAG, "call showImeStatusIcon error");
        }
    }

    public static void hideImeStatusIcon(String pkgName) {
        try {
            Log.i(TAG, "PCU hideImeStatusIcon start");
            IHwPCManager pcManager = getHwPCManager();
            if (pcManager != null) {
                pcManager.hideImeStatusIcon(pkgName);
            }
            Log.i(TAG, "PCU hideImeStatusIcon end");
        } catch (RemoteException e) {
            Log.e(TAG, "call hideImeStatusIcon error");
        }
    }
    ...
    public static boolean isDisallowLockScreenForHwMultiDisplay() {
        try {
            ...
            Log.e(TAG, "call isDisallowLockScreenForHwMultiDisplay error");
            return false;
        }
    }
    ...
    public static boolean isShopDemo() {
        try {
            IHwPCManager pcManager = getHwPCManager();
            if (pcManager != null) {
                return pcManager.isShopDemo();
            }
            return false;
        } catch (RemoteException e) {
            Log.e(TAG, "call isShopDemo error");
            return false;
        }
    }
    ...
    public static boolean isInBasicMode() {
        ...
        try {
            if (mService.isInBasicMode()) {
                return true;
            }
            return false;
        } catch (RemoteException e) {
            Log.e(TAG, "call isInBasicMode error");
            return false;
        }
    }
    ...
    public static boolean isScreenOnAccurately() {
        ...
        try {
            return pcManager.isScreenOnAccurately();
        } catch (RemoteException e) {
            Log.e(TAG, "call isScreenOnAccurately error");
            return true;
        }
    }
    ...
    public static void setDockBarInfo(int mode, Bundle info) {
        ...
        if (pcManager != null) {
            try {
                pcManager.setDockBarInfo(mode, info);
            } catch (RemoteException e) {
                Log.e(TAG, "call setDockInfo error");
            }
        }
    }
}

...
public class ZRHungInner extends ZRHung {
    ...
    public static final short APPEYE_EXIT_CATCH = 293;
    ...
    public static final short APPEYE_RESUME = 289;
    ...
    public static final short APPEYE_TEMP1 = 290;
    public static final short APPEYE_TEMP2 = 291;
    public static final short APPEYE_TEMP3 = 292;
    ...
    public static final short EVENT_TYPE_MASK_LENGTH = 8;
    public static final int NOT_READY = 1;
    public static final int NOT_SUPPORT = -1;
    public static final int NO_CONFIG = -2;
    public static final String TAG = "ZRHungInner";
    ...
    public static String getVersionName(String pkgName) {
        ...
        try {
            if (ActivityThreadEx.currentApplication() == null || (packageInfo = ActivityThreadEx.currentApplication().getApplicationContext().getPackageManager().getPackageInfo(pkgName, 0)) == null) {
                return BuildConfig.FLAVOR;
            }
            return packageInfo.versionName;
        } catch (PackageManager.NameNotFoundException e) {
            Log.e(TAG, "name not found exception in AppEyeUiProbe");
            return BuildConfig.FLAVOR;
        }
    }
}

...
public class DefaultHwViewRootImpl implements IHwViewRootImpl {
    ...
    @Override // android.view.IHwViewRootImpl
    public void processJank(boolean isScroll, long[] jankdrawdata, String windowtitle, int windowtype) {
    }
    ...
    @Override // android.view.IHwViewRootImpl
    public void updateDoframeStatus(boolean isIndoframe) {
    }
    ...
    @Override // android.view.IHwViewRootImpl
    public void updateLastTraversal(boolean isTraversed) {
    }

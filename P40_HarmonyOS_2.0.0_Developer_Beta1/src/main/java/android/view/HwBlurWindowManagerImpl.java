...
public class HwBlurWindowManagerImpl implements IHwBlurWindowManager {
    ...
    public boolean isBlurWindow(ViewRootImpl viewRoot) {
        return AbsLayoutParams.BLUR_FEATURE_ENABLED && !((viewRoot.mWindowAttributes.hwFlags & 33554432) == 0 && (viewRoot.mWindowAttributes.hwFlags & PackageManagerExt.MATCH_STATIC_SHARED_LIBRARIES) == 0);
    }

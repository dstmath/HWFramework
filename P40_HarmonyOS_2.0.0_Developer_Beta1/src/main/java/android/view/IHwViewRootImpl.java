...
public interface IHwViewRootImpl {
    ...
    boolean isAnimInAdvance();

    boolean isInputInAdvance();

    boolean isTouchDownEvent();
    ...
    void reportDrawRequestResult();

    void savePkgName(String str);
    ...
    void updateInputState(MotionEvent motionEvent);

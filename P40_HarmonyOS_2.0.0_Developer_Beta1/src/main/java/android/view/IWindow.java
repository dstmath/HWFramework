...
public interface IWindow extends IInterface {
    ...
    void notifyDragEnterExitState(boolean z, int i, int i2) throws RemoteException;
    ...
    public static class Default implements IWindow {
        ...
        @Override // android.view.IWindow
        public void notifyDragEnterExitState(boolean status, int mimeTypeSupportState, int supportItemCnt) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IWindow {
        ...
        static final int TRANSACTION_notifyDragEnterExitState = 21;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 21:
                    return "notifyDragEnterExitState";
                default:
                    return null;
            }
        }
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 21:
                        ...
                        notifyDragEnterExitState(_arg05, data.readInt(), data.readInt());
                        return true;
                    default:
        ...
        public static class Proxy implements IWindow {
            ...
            public void notifyDragEnterExitState(boolean status, int mimeTypeSupportState, int supportItemCnt) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(supportItemCnt);
                    if (this.mRemote.transact(21, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        _data.recycle();
                    } else {
                        Stub.getDefaultImpl().notifyDragEnterExitState(status, mimeTypeSupportState, supportItemCnt);
                    }
                } finally {
                    _data.recycle();
                }

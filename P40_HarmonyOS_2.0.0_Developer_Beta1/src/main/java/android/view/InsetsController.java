    ...
    private void applyAnimation(final int types, final boolean show, boolean fromIme) {
        if (types != 0) {
            controlAnimationUnchecked(types, new WindowInsetsAnimationControlListener() {
                ...
                /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x002b: APUT  (r2v1 android.graphics.Insets[]), (0 ??[int, short, byte, char]), (r4v1 android.graphics.Insets) */

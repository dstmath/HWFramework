...
public class Surface implements Parcelable {
    ...
    private static native void nativeSyncDynBufSize(long j, int i, boolean z);
    ...
    @UnsupportedAppUsage
    public void syncDynamicBufSize(int size, boolean isDynBuffer) {
        nativeSyncDynBufSize(this.mNativeObject, size, isDynBuffer);
    }
}

...
public final class SurfaceControl implements Parcelable {
    public static final int CORNER_CURVE_POSITION_ALL = 3;
    public static final int CORNER_CURVE_POSITION_BOTTOM = 2;
    public static final int CORNER_CURVE_POSITION_TOP = 1;
    public static final int CORNER_CURVE_PRECISION_HIGH = 2;
    public static final int CORNER_CURVE_PRECISION_LOW = 1;
    public static final int CORNER_CURVE_TYPE_G2 = 2;
    public static final int CORNER_CURVE_TYPE_ROUND = 1;
    ...
    public static final int PRIVATE_SURFACE = 134217728;
    ...
    public static final int SURFACE_BLUR_BEHIND = 1048576;
    public static final int SURFACE_BLUR_SELF = 2097152;
    ...
    private static native int nativeGetConnectedDisplay(IBinder iBinder);
    ...
    /* access modifiers changed from: private */
    public static native void nativeSetBehindLayerBlurStyle(long j, long j2, int i);

    /* access modifiers changed from: private */
    public static native void nativeSetBlurCacheEnabled(long j, long j2, boolean z);

    /* access modifiers changed from: private */
    public static native void nativeSetBlurEnabled(long j, long j2, boolean z);

    /* access modifiers changed from: private */
    public static native void nativeSetBlurMode(long j, long j2, int i);

    /* access modifiers changed from: private */
    public static native void nativeSetBlurProgress(long j, long j2, float f);
    ...
    private static native int nativeSetColorMgrInfo(int i, int i2, int[] iArr);
    ...
    /* access modifiers changed from: private */
    public static native void nativeSetCornerCurveParams(long j, long j2, int i, int i2, int i3, float f, float f2);
    ...
    /* access modifiers changed from: private */
    public static native void nativeSetFrontLayerBlurStyle(long j, long j2, int i);
    ...
    /* access modifiers changed from: private */
    public static native void nativeSetWindowIconInfo(long j, long j2, int i, int i2, int i3, byte[] bArr, int i4, int i5, int i6, int i7);
    ...
    public static class CornerCurveParams {
        private int mCornerCurvePosition;
        private int mCornerCurvePrecision;
        private int mCornerCurveType;
        private float mCornerG2ParamA;
        private float mCornerG2ParamB;

        public CornerCurveParams() {
            this.mCornerCurveType = 0;
            this.mCornerCurvePrecision = 0;
            this.mCornerCurvePosition = 0;
            this.mCornerG2ParamA = 0.0f;
            this.mCornerG2ParamB = 0.0f;
        }

        public CornerCurveParams(int curveType, int curvePrecision, int curvePosition, float g2ParamA, float g2ParamB) {
            this.mCornerCurveType = curveType;
            this.mCornerCurvePrecision = curvePrecision;
            this.mCornerCurvePosition = curvePosition;
            this.mCornerG2ParamA = g2ParamA;
            this.mCornerG2ParamB = g2ParamB;
        }
    }
    ...
    public static class Builder {
        ...
        public Builder setPrivate(boolean isPrivate) {
            if (isPrivate) {
                this.mFlags |= 134217728;
            } else {
                this.mFlags &= -134217729;
            }
            return this;
        }
    ...
    public void setBlurMode(int mode) {
        checkNotReleased();
        synchronized (SurfaceControl.class) {
            sGlobalTransaction.setBlurMode(this, mode);
        }
    }
    ...
    public void setBlurEnabled(boolean enabled) {
        checkNotReleased();
        synchronized (SurfaceControl.class) {
            sGlobalTransaction.setBlurEnabled(this, enabled);
        }
    }

    @UnsupportedAppUsage
    public void setBehindLayerBlurStyle(int style) {
        checkNotReleased();
        synchronized (SurfaceControl.class) {
            sGlobalTransaction.setBehindLayerBlurStyle(this, style);
        }
    }

    @UnsupportedAppUsage
    public void setFrontLayerBlurStyle(int style) {
        checkNotReleased();
        synchronized (SurfaceControl.class) {
            sGlobalTransaction.setFrontLayerBlurStyle(this, style);
        }
    }
    ...
    public void setBlurProgress(float progress) {
        checkNotReleased();
        synchronized (SurfaceControl.class) {
            sGlobalTransaction.setBlurProgress(this, progress);
        }
    }
    ...
    public void setBlurCacheEnabled(boolean enabled) {
        checkNotReleased();
        synchronized (SurfaceControl.class) {
            sGlobalTransaction.setBlurCacheEnabled(this, enabled);
        }
    }
    ...
    public void setCornerCurveParams(CornerCurveParams cornerCurveParams) {
        checkNotReleased();
        synchronized (SurfaceControl.class) {
            sGlobalTransaction.setCornerCurveParams(this, cornerCurveParams);
        }
    }
    ...
    public void setWindowIconInfo(int iconType, int iconViewWidth, int iconViewHeight, byte[] iconPixels, int byteCount, int width, int height, int colorSpaceId) {
        synchronized (SurfaceControl.class) {
            sGlobalTransaction.setWindowIconInfo(this, iconType, iconViewWidth, iconViewHeight, iconPixels, byteCount, width, height, colorSpaceId);
        }
    }
    ...
    public static Bitmap screenshot(Rect sourceCrop, int width, int height, boolean useIdentityTransform, int rotation) {
        ...
        int i = 3;
        if (IS_SIDE_PROP && !finalSourceCrop.isEmpty()) {
            Rect exceptDisplayRect = new Rect();
            boolean isNeedExceptDisplaySide = HwWindowManager.isNeedExceptDisplaySide(exceptDisplayRect);
            boolean isRectLandScape = false;
            boolean isLandScape = rotation2 == 1 || rotation2 == 3;
            if (exceptDisplayRect.width() > exceptDisplayRect.height()) {
                isRectLandScape = true;
            }
            if (isLandScape == isRectLandScape && isNeedExceptDisplaySide) {
                if (finalSourceCrop.intersect(exceptDisplayRect)) {
                    if (sourceCrop.width() == width) {
                        finalWidth = finalSourceCrop.width();
                    }
                    if (sourceCrop.height() == height) {
                        finalHeight = finalSourceCrop.height();
                    }
                    if (exceptDisplayRect.bottom == exceptDisplayRect.top * 4) {
                        finalSourceCrop = exceptDisplayRect;
                    }
                }
            }
        }
    ...
    public static ScreenshotGraphicBuffer screenshotToBuffer(IBinder display, Rect sourceCrop, int width, int height, boolean useIdentityTransform, int rotation) {
        ...
        if (display != null) {
            return nativeScreenshot(display, HwActivityTaskManager.adjustScreenShotRectForPCCast(sourceCrop), width, height, useIdentityTransform, rotation, true);
        }
        throw new IllegalArgumentException("displayToken must not be null");
    }
    ...
    public static int getConnectedDisplay(IBinder displayToken) {
        if (displayToken != null) {
            int connectedDisplay = nativeGetConnectedDisplay(displayToken);
            Log.i(TAG, "get connected display: " + connectedDisplay);
    ...
    public static int setColorMgrInfo(int feature, int mode, int[] params) {
        return nativeSetColorMgrInfo(feature, mode, params);
    }
    ...
    public static class Transaction implements Closeable {
        ...
        public Transaction setMatrix(SurfaceControl sc, float dsdx, float dtdx, float dtdy, float dsdy) {
            ...
            if (HwFoldScreenState.isInwardFoldDevice() && "ColorFade".equals(sc.mName)) {
                Log.i(SurfaceControl.DEBUG_TAG, "setMatrix ColorFade sc " + sc + " native " + sc.mNativeObject + " caller " + Debug.getCallers(6));
            }
        ...
        @UnsupportedAppUsage
        public Transaction setBlurMode(SurfaceControl sc, int mode) {
            sc.checkNotReleased();
            SurfaceControl.nativeSetBlurMode(this.mNativeObject, sc.mNativeObject, mode);
            return this;
        }

        @UnsupportedAppUsage
        public Transaction setBlurEnabled(SurfaceControl sc, boolean enabled) {
            sc.checkNotReleased();
            SurfaceControl.nativeSetBlurEnabled(this.mNativeObject, sc.mNativeObject, enabled);
            return this;
        }

        @UnsupportedAppUsage
        public Transaction setBehindLayerBlurStyle(SurfaceControl sc, int style) {
            sc.checkNotReleased();
            SurfaceControl.nativeSetBehindLayerBlurStyle(this.mNativeObject, sc.mNativeObject, style);
            return this;
        }

        @UnsupportedAppUsage
        public Transaction setFrontLayerBlurStyle(SurfaceControl sc, int style) {
            sc.checkNotReleased();
            SurfaceControl.nativeSetFrontLayerBlurStyle(this.mNativeObject, sc.mNativeObject, style);
            return this;
        }

        @UnsupportedAppUsage
        public Transaction setBlurProgress(SurfaceControl sc, float progress) {
            sc.checkNotReleased();
            SurfaceControl.nativeSetBlurProgress(this.mNativeObject, sc.mNativeObject, progress);
            return this;
        }

        @UnsupportedAppUsage
        public Transaction setBlurCacheEnabled(SurfaceControl sc, boolean enabled) {
            sc.checkNotReleased();
            SurfaceControl.nativeSetBlurCacheEnabled(this.mNativeObject, sc.mNativeObject, enabled);
            return this;
        }
        ...
        @UnsupportedAppUsage
        public Transaction setCornerCurveParams(SurfaceControl sc, CornerCurveParams params) {
            sc.checkNotReleased();
            SurfaceControl.nativeSetCornerCurveParams(this.mNativeObject, sc.mNativeObject, params.mCornerCurveType, params.mCornerCurvePrecision, params.mCornerCurvePosition, params.mCornerG2ParamA, params.mCornerG2ParamB);
            return this;
        }
        ...
        public Transaction setWindowIconInfo(SurfaceControl sc, int iconType, int iconViewWidth, int iconViewHeight, byte[] iconPixels, int byteCount, int width, int height, int colorSpaceId) {
            sc.checkNotReleased();
            SurfaceControl.nativeSetWindowIconInfo(this.mNativeObject, sc.mNativeObject, iconType, iconViewWidth, iconViewHeight, iconPixels, byteCount, width, height, colorSpaceId);
            return this;
        }
    }

    private void addValidSurfaceLog(String function, boolean needCaller) {
        if (!DEBUG_SURFACE && (!HwFoldScreenState.isInwardFoldDevice() || !"ColorFade".equals(this.mName))) {
            return;
        }
        if (needCaller) {
            Log.i(DEBUG_TAG, toString() + ", " + function + " native " + this.mNativeObject + " called by " + Debug.getCallers(8));
            return;
        }
        Log.i(DEBUG_TAG, toString() + ", " + function + " native " + this.mNativeObject);
    }

...
public interface WindowManager extends ViewManager {
    ...
    public static final int HW_TRANSIT_TV_SPLIT_CAST_ENTER = 52;
    public static final int HW_TRANSIT_TV_SPLIT_ENTER = 50;
    public static final int HW_TRANSIT_TV_SPLIT_EXIT = 51;

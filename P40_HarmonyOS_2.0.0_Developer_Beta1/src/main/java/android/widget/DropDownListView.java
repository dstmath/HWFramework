...
public class DropDownListView extends ListView {
    ...
    private void drawSelectorDrwable(Canvas canvas) {
        ...
        if (selectedPosition == -1 && this.mCachePos == -1) {
            adjustSelector(0, new Rect());
        } else if (this.mCachePos != -1 || selectedPosition == -1) {
            adjustSelector(this.mCachePos, new Rect());
        } else {
            adjustSelector(selectedPosition, new Rect());
        }

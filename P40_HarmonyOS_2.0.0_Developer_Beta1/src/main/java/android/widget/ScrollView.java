...
public class ScrollView extends FrameLayout {
    ...
    public ScrollView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mOnGenericMotionScrollListener = new HwOnScrollListener() {
            ...
            public boolean onScrollBy(float deltaX, float deltaY, MotionEvent event) {
                if (!(Float.compare(deltaY, 0.0f) != 0)) {
                    return false;
                }
                return ScrollView.this.scrollInDetector(deltaY);
            }
        };
        initScrollView();
    ...
    private boolean handleScrollToTop() {
        ...
        post(new Runnable() {
            /* class android.widget.ScrollView.AnonymousClass2 */
    ...
    private boolean scrollInDetector(float deltaY) {
        scrollTo(getScrollX(), ((int) deltaY) + getScrollY());
        return true;
    }

...
public class StackView extends AdapterViewAnimator {
    ...
    private void transformViewAtIndex(int index, View view, boolean animate) {
        ...
        if (animate) {
            ObjectAnimator oa = ObjectAnimator.ofPropertyValuesHolder(view, PropertyValuesHolder.ofFloat("scaleX", scale), PropertyValuesHolder.ofFloat("scaleY", scale), PropertyValuesHolder.ofFloat("translationY", transY), PropertyValuesHolder.ofFloat("translationX", transX));

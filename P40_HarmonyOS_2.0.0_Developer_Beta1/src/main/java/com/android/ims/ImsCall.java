        ...
        public void callSessionProgressing(ImsCallSession session, ImsStreamMediaProfile profile) {
            ...
            synchronized (ImsCall.this) {
                ...
                if (ImsCall.this.mCallProfile != null) {
                    ImsStreamMediaProfile mediaProfile = ImsCall.this.mCallProfile.mMediaProfile;
                    if (mediaProfile != null) {
                        mediaProfile.copyFrom(profile);
                    } else {
                        ImsCall.this.logi("callSessionProgressing :: mediaProfile = null");
                    }
                } else {
                    ImsCall.this.logi("callSessionProgressing :: mCallProfile = null");
                }
            }
            if (listener != null) {
                try {

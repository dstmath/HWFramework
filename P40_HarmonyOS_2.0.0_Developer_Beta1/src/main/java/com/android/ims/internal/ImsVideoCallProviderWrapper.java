...
public class ImsVideoCallProviderWrapper extends Connection.VideoProvider {
    ...
    public void onSendSessionModifyRequest(VideoProfile fromProfile, VideoProfile toProfile) {
        ...
        try {
            if (HuaweiTelephonyConfigs.isMTKPlatform() || !isResumeRequest(fromProfile.getVideoState(), toProfile.getVideoState()) || VideoProfile.isPaused(this.mCurrentVideoState)) {

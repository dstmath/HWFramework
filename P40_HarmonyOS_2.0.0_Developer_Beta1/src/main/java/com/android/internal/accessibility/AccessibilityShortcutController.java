    ...
    private boolean performTtsPrompt(AlertDialog alertDialog) {
        ...
        alertDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
            ...
            public final void onDismiss(DialogInterface dialogInterface) {
                AccessibilityShortcutController.lambda$performTtsPrompt$2(AccessibilityShortcutController.TtsPrompt.this, dialogInterface);
            }
        });
        return true;
    }

    static /* synthetic */ void lambda$performTtsPrompt$2(TtsPrompt tts, DialogInterface dialog) {
        tts.dismiss();
    }

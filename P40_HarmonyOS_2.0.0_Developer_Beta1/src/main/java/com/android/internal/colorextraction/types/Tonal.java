...
public class Tonal implements ExtractionType {
    ...
    public static class ColorRange {
        ...
        public boolean containsColor(float h, float s, float l) {
            if (this.mHue.contains((Range<Float>) Float.valueOf(h)) && this.mSaturation.contains((Range<Float>) Float.valueOf(s)) && this.mLightness.contains((Range<Float>) Float.valueOf(l))) {
                return true;
            }
            return false;
        }

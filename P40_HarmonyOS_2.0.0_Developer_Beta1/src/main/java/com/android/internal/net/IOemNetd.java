...
public interface IOemNetd extends IInterface {
    ...
    void HwNetFilterAddUidRules(String[] strArr, int i) throws RemoteException;

    void HwNetFilterClearIpRules(int i) throws RemoteException;

    void HwNetFilterClearUidRules(int i) throws RemoteException;

    void HwNetFilterRemoveUidRules(String[] strArr, int i) throws RemoteException;
    ...
    void SetIpForwardingInterface(boolean z, String str, String str2) throws RemoteException;
    ...
    public static class Default implements IOemNetd {
        ...
        @Override // com.android.internal.net.IOemNetd
        public void HwNetFilterSetIpRules(String addr, int trustOrBlock) throws RemoteException {
        }

        @Override // com.android.internal.net.IOemNetd
        public void HwNetFilterAddIpRules(String[] addr, int trustOrBlock) throws RemoteException {
        }

        @Override // com.android.internal.net.IOemNetd
        public void HwNetFilterClearIpRules(int trustOrBlock) throws RemoteException {
        }

        @Override // com.android.internal.net.IOemNetd
        public void HwNetFilterAddUidRules(String[] uid, int trustOrBlock) throws RemoteException {
        }

        @Override // com.android.internal.net.IOemNetd
        public void HwNetFilterClearUidRules(int trustOrBlock) throws RemoteException {
        }

        @Override // com.android.internal.net.IOemNetd
        public void HwNetFilterRemoveUidRules(String[] uid, int trustOrBlock) throws RemoteException {
        }
        ...
        @Override // com.android.internal.net.IOemNetd
        public void SetIpForwardingInterface(boolean enabled, String srcAddress, String ifaceName) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IOemNetd {
        ...
        static final int TRANSACTION_HwNetFilterAddUidRules = 23;
        static final int TRANSACTION_HwNetFilterClearIpRules = 22;
        static final int TRANSACTION_HwNetFilterClearUidRules = 24;
        static final int TRANSACTION_HwNetFilterRemoveUidRules = 25;
        static final int TRANSACTION_HwNetFilterSetIpRules = 20;
        static final int TRANSACTION_HwSetArpIgnore = 32;
        static final int TRANSACTION_SetDnsForwarding = 31;
        static final int TRANSACTION_SetInterfaceProxyArp = 30;
        static final int TRANSACTION_SetIpForwardingInterface = 33;
        static final int TRANSACTION_SetMpDnsApp = 29;
        ...
        static final int TRANSACTION_hwFilterCommand = 26;
        static final int TRANSACTION_ipTableConfig = 27;
        ...
        static final int TRANSACTION_trafficSwapActiveProcessStatsMap = 28;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 23:
                        data.enforceInterface(DESCRIPTOR);
                        HwNetFilterAddUidRules(data.createStringArray(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 24:
                        data.enforceInterface(DESCRIPTOR);
                        HwNetFilterClearUidRules(data.readInt());
                        reply.writeNoException();
                        return true;
                    case 25:
                        data.enforceInterface(DESCRIPTOR);
                        HwNetFilterRemoveUidRules(data.createStringArray(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 26:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 33:
                        ...
                        SetIpForwardingInterface(_arg0, data.readString(), data.readString());
                        reply.writeNoException();
                        return true;
                    default:
        ...
        public static class Proxy implements IOemNetd {
            ...
            public void HwNetFilterSetIpRules(String addr, int trustOrBlock) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().HwNetFilterSetIpRules(addr, trustOrBlock);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void HwNetFilterAddIpRules(String[] addr, int trustOrBlock) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().HwNetFilterAddIpRules(addr, trustOrBlock);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void HwNetFilterClearIpRules(int trustOrBlock) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().HwNetFilterClearIpRules(trustOrBlock);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void HwNetFilterAddUidRules(String[] uid, int trustOrBlock) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().HwNetFilterAddUidRules(uid, trustOrBlock);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void HwNetFilterClearUidRules(int trustOrBlock) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().HwNetFilterClearUidRules(trustOrBlock);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void HwNetFilterRemoveUidRules(String[] uid, int trustOrBlock) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().HwNetFilterRemoveUidRules(uid, trustOrBlock);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void SetIpForwardingInterface(boolean enabled, String srcAddress, String ifaceName) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().SetIpForwardingInterface(enabled, srcAddress, ifaceName);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }

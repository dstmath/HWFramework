...
public class HighlightViewMgr {
    ...
    private static final int DRAG_BAR_VIEW_ID_FREEFORM = 34603298;
    private static final int DRAG_BAR_VIEW_ID_SPLIT = 34603303;
    private static final int DRAG_BAR_VIEW_SRC_ID_FREEFORM = 33752031;
    private static final int DRAG_BAR_VIEW_SRC_ID_SPLIT = 33752030;
    private static final int DRAG_BAR_VIEW_SRC_STYLE_FOCUSED = 33947792;
    private static final int DRAG_BAR_VIEW_SRC_STYLE_FOCUSED_HONOR = 33947793;
    private static final int DRAG_BAR_VIEW_SRC_STYLE_NORMAL = 33947794;
    ...
    private static final int RECT_FRAME_BORDER_COLOR_ID = 33883094;
    private static final int RECT_FRAME_BORDER_WIDTH_DEFAULT = 2;
    private static final int RECT_FRAME_BORDER_WIDTH_ID = 34472616;
    private static final int RECT_FRAME_LAYOUT_NAME = 34013362;
    private static final float RECT_FRAME_RADIUS_DEFAULT = 16.0f;
    private static final float RECT_FRAME_RADIUS_FOR_SCALE = 14.0f;
    private static final int RECT_FRAME_RADIUS_ID_FREEFORM = 34472614;
    private static final int RECT_FRAME_RADIUS_ID_SPLIT = 34472617;
    private static final int RECT_FRAME_VIEW_ID = 34603300;
    ...
    private View getRectFrameView() {
        ...
        if (rectFrameView == null) {
            ...
            rectFrameView = rectFrameLayout.findViewById(34603300);
            if (rectFrameView == null) {
    ...
    private View findRectFrameView() {
        return this.mDecorView.findViewById(34603300);
    }

    private View findDragBarView() {
        if (WindowConfiguration.isHwSplitScreenWindowingMode(this.mDecorView.mWindowMode)) {
            return this.mDecorView.findViewById(34603303);
        }
        if (WindowConfiguration.isHwFreeFormWindowingMode(this.mDecorView.mWindowMode)) {
            return this.mDecorView.findViewById(34603298);
        }
        return null;
    }

    private View addRectFrameLayout() {
        View rectFrameLayout = LayoutInflater.from(this.mDecorView.getContext()).inflate(34013362, (ViewGroup) null);
        if (rectFrameLayout == null) {
        ...
        this.mHighLightLayout = rectFrameLayout;
        return rectFrameLayout;
    }
    ...
    private void updateDragBarView(boolean isHasFocus) {
        ...
        if (dragBarImgView instanceof ImageView) {
            ...
            if (isHasFocus) {
                i = HwThemeManager.isHonorBrand() ? 33947793 : 33947792;
            } else {
                i = 33947794;
            }
    ...
    public abstract class ViewUpdator {
        ...
        public int getRectFrameBorderColor() {
            ...
            return HighlightViewMgr.this.isNightMode() ? HighlightViewMgr.RECT_FRAME_BORDER_COLOR_DARK : HighlightViewMgr.this.mDecorView.getContext().getColor(33883094);
        }
    ...
    public class FreeFormUpdator extends ViewUpdator {
        ...
        @Override // com.android.internal.policy.HighlightViewMgr.ViewUpdator
        public float getRectFrameRadius() {
            return HighlightViewMgr.this.mDecorView.getResources().getDimension(34472614) - ((float) HighlightViewMgr.this.dip2px(1.0f));
        }
    ...
    public class SplitScreenUpdator extends ViewUpdator {
        ...
        @Override // com.android.internal.policy.HighlightViewMgr.ViewUpdator
        public int getRectFrameBorderWidth() {
            return HighlightViewMgr.this.mDecorView.getResources().getDimensionPixelSize(34472616);
        }
        ...
        public float getRectFrameRadius() {
            ...
            return HighlightViewMgr.this.mDecorView.getResources().getDimension(34472617) - ((float) HighlightViewMgr.this.dip2px(1.0f));
        }
    ...
    public void onConfigurationChanged() {
        ...
        if (!WindowConfiguration.isHwMultiStackWindowingMode(this.mDecorView.mWindowMode) && (view = this.mHighLightLayout) != null) {
    ...
    private void obtainFreeFromOutlineDuringScale() {
        ...
        if (WindowConfiguration.isHwFreeFormWindowingMode(this.mDecorView.mWindowMode) && (rectFrameView = getRectFrameView()) != null) {
            ...
            if (HwThemeManager.isHonorBrand()) {
                ...
                i = isNightMode() ? RECT_FRAME_BORDER_COLOR_DARK : this.mDecorView.getContext().getColor(33883094);
            }

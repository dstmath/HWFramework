...
public interface AbstractCommandsInterface {
    ...
    void registerForModemDataRetry(Handler handler, int i, Object obj);
    ...
    void registerForVsimIndication(Handler handler, int i, Object obj);
    ...
    void sendVsimNotification(int i, int i2, int i3, String str, Message message);

    void sendVsimNotificationEx(int i, int i2, int i3, String str, Message message);

    void sendVsimOperation(int i, int i2, int i3, int i4, byte[] bArr, Message message);
    ...
    void unregisterForModemDataRetry(Handler handler);
    ...
    void unregisterForVsimIndication(Handler handler);

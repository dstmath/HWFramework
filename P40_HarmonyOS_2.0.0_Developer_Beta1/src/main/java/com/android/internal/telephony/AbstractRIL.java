...
public abstract class AbstractRIL extends BaseCommands {
    ...
    public interface HwRILReference {
        ...
        void getUEOperationMode(Message message);
        ...
        void notifyCellularCloudParaReady(int i, int i2, Message message);
        ...
        void sendVsimNotificationEx(int i, int i2, int i3, String str, Message message);
    ...
    public void queryCardType(Message result) {
        HwRILReference hwRILReference = this.mReference;
        if (hwRILReference != null) {
            hwRILReference.queryCardType(result);
        }
    }
    ...
    public void getRegPlmn(Message result) {
        HwRILReference hwRILReference = this.mReference;
        if (hwRILReference != null) {
            hwRILReference.getRegPlmn(result);
        }
    }
    ...
    public void setUEOperationMode(int mode, Message result) {
        HwRILReference hwRILReference = this.mReference;
        if (hwRILReference != null) {
            hwRILReference.setUEOperationMode(mode, result);
        }
    }
    ...
    public void getUEOperationMode(Message result) {
        HwRILReference hwRILReference = this.mReference;
        if (hwRILReference != null) {
            hwRILReference.getUEOperationMode(result);
        }
    }

    @Override // com.android.internal.telephony.AbstractBaseCommands, com.android.internal.telephony.AbstractCommandsInterface
    public void notifyCellularCloudParaReady(int paratype, int pathtype, Message result) {
        HwRILReference hwRILReference = this.mReference;
        if (hwRILReference != null) {
            hwRILReference.notifyCellularCloudParaReady(paratype, pathtype, result);
        }
    }
    ...
    public void getAttachedApnSettings(Message response) {
        HwRILReference hwRILReference = this.mReference;
        if (hwRILReference != null) {
            hwRILReference.getAttachedApnSettings(response);
        }
    }
    ...
    public void setApDsFlowCfg(Message result) {
        HwRILReference hwRILReference = this.mReference;
        if (hwRILReference != null) {
            hwRILReference.setApDsFlowCfg(result);
        }
    }
    ...
    public void setApDsFlowCfg(int config, int threshold, int totalThreshold, int oper, Message response) {
        HwRILReference hwRILReference = this.mReference;
        if (hwRILReference != null) {
            hwRILReference.setApDsFlowCfg(config, threshold, totalThreshold, oper, response);
        }
    }
    ...
    public void getTrafficData(Message result) {
        HwRILReference hwRILReference = this.mReference;
        if (hwRILReference != null) {
            hwRILReference.getTrafficData(result);
        }
    }
    ...
    public void clearTrafficData(Message result) {
        HwRILReference hwRILReference = this.mReference;
        if (hwRILReference != null) {
            hwRILReference.clearTrafficData(result);
        }
    }
    ...
    public void sendVsimNotificationEx(int transactionId, int eventId, int simType, String challenge, Message message) {
        HwRILReference hwRILReference = this.mReference;
        if (hwRILReference != null) {
            hwRILReference.sendVsimNotificationEx(transactionId, eventId, simType, challenge, message);
        }
    }
}

...
public class CallerInfo {
    ...
    public static CallerInfo getCallerInfo(Context context, String number, int subId) {
        ...
        CallerInfo info = getCallerInfo(context, Uri.withAppendedPath(ContactsContract.PhoneLookup.ENTERPRISE_CONTENT_FILTER_URI, Uri.encode(number)));
        if (info != null) {
            info = doSecondaryLookupIfNecessary(context, number, info);
        }
        if (info != null && TextUtils.isEmpty(info.phoneNumber)) {

...
public abstract class HwBaseSignalStrengthManager extends Handler {
    ...
    protected boolean mIsSimStateChange = false;
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null) {
                ...
                if ("com.huawei.action.CARRIER_CONFIG_CHANGED".equals(action)) {
                    ...
                    if ("READY".equals(stateExtra) || "ABSENT".equals(stateExtra)) {
                        HwBaseSignalStrengthManager.this.mIsSimStateChange = true;
                    }
                } else {
    ...
    protected HwBaseSignalStrengthManager(IServiceStateTrackerInner serviceStateTracker, PhoneExt phoneExt, HwServiceStateTrackerEx hwServiceStateTrackerEx) {
        ...
        if (HwTelephonyManager.getDefault().isNrSupported() && this.mPhoneId != 2) {
            registerSetPreferDb();
        }
    }
    ...
    private synchronized void registerSetPreferDb() {
        ...
        if (this.mPreferNetworkDb == null && cr != null) {
            ...
            cr.registerContentObserver(Settings.Global.getUriFor("preferred_network_mode" + this.mPhoneId), true, this.mPreferNetworkDb);
        }
    }
    ...
    public class PreferNetworkDb extends ContentObserver {
        ...
        public void onChange(boolean isSelfChange) {
            ...
            if (!HwBaseSignalStrengthManager.this.mHwServiceStateTrackerEx.isNrSwitchOn(HwBaseSignalStrengthManager.this.mPhoneId)) {

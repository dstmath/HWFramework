...
public class HwCustGsmCdmaCallTrackerImpl extends HwCustGsmCdmaCallTracker {
    ...
    private static final boolean IS_REJECT_HW_CALL = SystemProperties.getBoolean("ro.config.isRejectHwCall", (boolean) IS_REJECT_HW_CALL);
    public static final String LOG_TAG = "HwCustGsmCdmaCallTrackerImpl";
    protected static final boolean REJCALL_RINGING_REJECT = SystemProperties.getBoolean("ro.config.ringing_reject", (boolean) IS_REJECT_HW_CALL);
    ...
    public boolean canDial() {
        ...
        boolean ret = (1 == 0 || hasRingCallOnIms) ? IS_REJECT_HW_CALL : true;
    ...
    private boolean hasRingCallOnIms() {
        ...
        if (this.mGsmPhone == null || (imsPhone = this.mGsmPhone.getImsPhone()) == null) {
            return IS_REJECT_HW_CALL;
        }
        Call imsRingingCall = imsPhone.getRingingCall();
        return imsRingingCall != null ? imsRingingCall.isRinging() : IS_REJECT_HW_CALL;
    }
    ...
    private boolean blockCsCallWhenHasImsEmCall() {
        if (this.mGsmPhone != null) {
            return getBooleanCarrierConfig(this.mGsmPhone.getContext(), BLOCK_CS_WHEN_HAS_IMS_EM_CALL_BOOL, this.mGsmPhone.getSubId(), IS_REJECT_HW_CALL);
        }
        return IS_REJECT_HW_CALL;
    }

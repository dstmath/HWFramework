...
public class HwGsmAlphabet {
    ...
    public static String gsm8BitUnpackedToString(byte[] data, int offset, int length) {
        return gsm8BitUnpackedToString(data, offset, length, BuildConfig.FLAVOR);
    }
    ...
    public static String gsm8BitUnpackedToString(byte[] data, int offset, int length, boolean needConvertCharacter) {
        return gsm8BitUnpackedToString(data, offset, length, BuildConfig.FLAVOR, needConvertCharacter);
    }
    ...
    public static int countGsmSeptetsUsingTables(CharSequence sequence, boolean use7bitOnly, int languageTable, int languageShiftTable) {
        ...
        if (languageTable < sparseIntArrayArr.length) {
            SparseIntArray[] sparseIntArrayArr2 = sCharsToShiftTables;
            if (languageShiftTable < sparseIntArrayArr2.length) {
                SparseIntArray charToLanguageTable = sparseIntArrayArr[languageTable];
                SparseIntArray charToShiftTable = sparseIntArrayArr2[languageShiftTable];
                for (int i = 0; i < sz; i++) {
    ...
    public static int findGsmSeptetLimitIndex(String s, int start, int limit, int langTable, int langShiftTable) {
        ...
        SparseIntArray[] sparseIntArrayArr = sCharsToGsmTables;
        if (langTable < sparseIntArrayArr.length) {
            SparseIntArray[] sparseIntArrayArr2 = sCharsToShiftTables;
            if (langShiftTable < sparseIntArrayArr2.length) {
                SparseIntArray charToLangTable = sparseIntArrayArr[langTable];
                SparseIntArray charToLangShiftTable = sparseIntArrayArr2[langShiftTable];
    ...
    public static char ussd_7bit_ucs2_to_gsm_char_default(char c) {
        switch (c) {
            ...
            default:
                return c;
            case HwDctConstants.CMD_RESET_DEFAULT_APN /* 200 */:
            case 201:
            case 202:
            case 203:
                return 'E';

...
public class HwHisiCsgSearch extends CsgSearch {
    ...
    @Override // com.android.internal.telephony.CsgSearch, android.os.Handler
    ...
    public void handleCsgNetworkQueryResult(AsyncResult ar) {
        ...
        if (ar == null || ar.userObj == null) {
            ...
            AsyncResult.forMessage((Message) ar.userObj, (ArrayList) ar.result, (Throwable) null);
            ((Message) ar.userObj).sendToTarget();
        } else {
            AsyncResult.forMessage((Message) ar.userObj, new CSGNetworkList((ArrayList) ar.result), (Throwable) null);
            ((Message) ar.userObj).sendToTarget();
        }
    }
    ...
    public class CSGNetworkList {
        ...
        public HwHisiCsgNetworkInfo getToBeRegsiteredCSGNetwork() {
            ...
            ArrayList<HwHisiCsgNetworkInfo> arrayList = this.mCSGNetworks;
            if (arrayList == null) {

...
import com.huawei.internal.telephony.vsim.ExternalSimConstants;
...
public class HwRILReferenceImpl extends Handler implements AbstractRIL.HwRILReference {
    ...
    private int mApDsFlowConfig = 0;
    private int mApDsFlowOper = 0;
    private int mApDsFlowThreshold = 0;
    private int mApDsFlowTotalThreshold = 0;
    ...
    public void requestSetEmergencyNumbers(final String ecclist_withcard, final String ecclist_nocard) {
        ...
        invokeIRadio(ExternalSimConstants.MSG_ID_UICC_AUTHENTICATION_REQUEST_IND, null, new RILCommand() {
    ...
    public void custSetModemProperties() {
        Context context = this.mContext;
        if (context == null) {
            riljLog("custSetModemProperties, mContext is null.nothing to do");
            return;
        }
        int isSlotsSwitched = Settings.System.getInt(context.getContentResolver(), "switch_dual_card_slots", 0);
    ...
    public void queryCardType(Message result) {
        riljLog("getCardType in");
        if (!isSupportIRadio22()) {
            sendFailMessage(result, 528);
        } else {
            invokeIRadio(528, result, new RILCommand() {
                /* class com.android.internal.telephony.HwRILReferenceImpl.AnonymousClass34 */

                @Override // com.android.internal.telephony.HwRILReferenceImpl.RILCommand
                public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                    vendor.huawei.hardware.radio.V2_2.IRadio radioProxy22 = vendor.huawei.hardware.radio.V2_2.IRadio.castFrom(radio);
                    if (radioProxy22 != null) {
                        radioProxy22.getCardType(serial);
                    }
                }
            });
        }
    ...
    public void getRegPlmn(Message result) {
        riljLog("getPlmnInfo in");
        if (!isSupportIRadio22()) {
            sendFailMessage(result, 2042);
        } else {
            invokeIRadio(2042, result, new RILCommand() {
                /* class com.android.internal.telephony.HwRILReferenceImpl.AnonymousClass35 */

                @Override // com.android.internal.telephony.HwRILReferenceImpl.RILCommand
                public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                    vendor.huawei.hardware.radio.V2_2.IRadio radioProxy22 = vendor.huawei.hardware.radio.V2_2.IRadio.castFrom(radio);
                    if (radioProxy22 != null) {
                        radioProxy22.getPlmnInfo(serial);
                    }
                }
            });
        }
    ...
    public void setUEOperationMode(final int mode, Message result) {
        riljLog("setUeOperationMode in");
        if (!isSupportIRadio22()) {
            sendFailMessage(result, 2119);
        } else {
            invokeIRadio(2119, result, new RILCommand() {
                /* class com.android.internal.telephony.HwRILReferenceImpl.AnonymousClass36 */

                @Override // com.android.internal.telephony.HwRILReferenceImpl.RILCommand
                public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                    vendor.huawei.hardware.radio.V2_2.IRadio radioProxy22 = vendor.huawei.hardware.radio.V2_2.IRadio.castFrom(radio);
                    if (radioProxy22 != null) {
                        radioProxy22.setUeOperationMode(serial, mode);
                    }
                }
            });
        }
    ...
    public void getUEOperationMode(Message result) {
        if (!isSupportIRadio22()) {
            sendFailMessage(result, 2209);
        } else {
            invokeIRadio(2209, result, new RILCommand() {
                /* class com.android.internal.telephony.HwRILReferenceImpl.AnonymousClass37 */

                @Override // com.android.internal.telephony.HwRILReferenceImpl.RILCommand
                public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                    vendor.huawei.hardware.radio.V2_2.IRadio radioProxy22 = vendor.huawei.hardware.radio.V2_2.IRadio.castFrom(radio);
                    if (radioProxy22 != null) {
                        radioProxy22.getUeOperationMode(serial);
                    }
                }
            });
        }
    ...
    public void notifyCellularCloudParaReady(final int paratype, final int pathtype, Message result) {
        riljLog("notifyCellularCloudParaReady in");
        if (!isSupportIRadio22()) {
            sendFailMessage(result, 2133);
        } else {
            invokeIRadio(2133, result, new RILCommand() {
                /* class com.android.internal.telephony.HwRILReferenceImpl.AnonymousClass38 */

                @Override // com.android.internal.telephony.HwRILReferenceImpl.RILCommand
                public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                    vendor.huawei.hardware.radio.V2_2.IRadio radioProxy22 = vendor.huawei.hardware.radio.V2_2.IRadio.castFrom(radio);
                    if (radioProxy22 != null) {
                        radioProxy22.notifyCellularCloudParaReady(serial, paratype, pathtype);
                    }
                }
            });
        }
    ...
    public void getAttachedApnSettings(Message result) {
        riljLog("getAttachedApnSettings in");
        if (!isSupportIRadio22()) {
            sendFailMessage(result, 2185);
        } else {
            invokeIRadio(2185, result, new RILCommand() {
                /* class com.android.internal.telephony.HwRILReferenceImpl.AnonymousClass39 */

                @Override // com.android.internal.telephony.HwRILReferenceImpl.RILCommand
                public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                    vendor.huawei.hardware.radio.V2_2.IRadio radioProxy22 = vendor.huawei.hardware.radio.V2_2.IRadio.castFrom(radio);
                    if (radioProxy22 != null) {
                        radioProxy22.getAttachedApnSettings(serial);
                    }
                }
            });
        }
    ...
    public void clearTrafficData(Message result) {
        if (!isSupportIRadio22()) {
            sendFailMessage(result, 2090);
        } else {
            invokeIRadio(2090, result, new RILCommand() {
                /* class com.android.internal.telephony.HwRILReferenceImpl.AnonymousClass40 */

                @Override // com.android.internal.telephony.HwRILReferenceImpl.RILCommand
                public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                    vendor.huawei.hardware.radio.V2_2.IRadio.castFrom(radio).clearDsFlowInfo(serial);
                }
            });
        }
    }
    ...
    public void getTrafficData(Message result) {
        if (!isSupportIRadio22()) {
            sendFailMessage(result, 2089);
        } else {
            invokeIRadio(2089, result, new RILCommand() {
                /* class com.android.internal.telephony.HwRILReferenceImpl.AnonymousClass41 */

                @Override // com.android.internal.telephony.HwRILReferenceImpl.RILCommand
                public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                    vendor.huawei.hardware.radio.V2_2.IRadio.castFrom(radio).getDsFlowInfo(serial);
                }
            });
        }
    }
    ...
    public void setApDsFlowCfg(final int config, final int threshold, final int totalThreshold, final int oper, Message result) {
        ...
        invokeIRadio(2110, result, new RILCommand() {
            /* class com.android.internal.telephony.HwRILReferenceImpl.AnonymousClass42 */

            @Override // com.android.internal.telephony.HwRILReferenceImpl.RILCommand
            public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                vendor.huawei.hardware.radio.V2_2.IRadio.castFrom(radio).setApDsFlowReportConfig(serial, config, threshold, totalThreshold, oper);
            }
        });
    }

    public void sendVsimNotificationEx(final int transactionId, final int eventId, final int simType, final String challenge, Message message) {
        riljLog("sendVsimNotification with chanllenge");
        if (!isSupportIRadio22()) {
            sendFailMessage(message, 2207);
        } else {
            invokeIRadio(2207, message, new RILCommand() {
                /* class com.android.internal.telephony.HwRILReferenceImpl.AnonymousClass43 */

                @Override // com.android.internal.telephony.HwRILReferenceImpl.RILCommand
                public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                    vendor.huawei.hardware.radio.V2_2.IRadio.castFrom(radio).sendVsimNotificationEx(serial, transactionId, eventId, simType, challenge);
                }
            });
        }
    }
    ...
    private boolean isSupportIRadio22() {
        IRadio radio = getHuaweiCommonRadioProxy(null);
        if (radio == null || vendor.huawei.hardware.radio.V2_2.IRadio.castFrom(radio) == null) {
            return false;
        }
        return true;
    }

...
public class HwResponseInfoToString {
    ...
    private static String processCellIdentityGsmArray(ArrayList<CellIdentityGsm> cellIdentityGsm) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (gsmCellIdentity instanceof CellIdentityGsm) {
    ...
    private static String processCellIdentityWcdmaArray(ArrayList<CellIdentityWcdma> cellIdentityWcdma) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (wcdmaCellIdentity instanceof CellIdentityWcdma) {
    ...
    private static String processCellIdentityCdmaArray(ArrayList<CellIdentityCdma> cellIdentityCdma) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (cdmaCellIdentity instanceof CellIdentityCdma) {
    ...
    private static String processCellIdentityLteArray(ArrayList<CellIdentityLte> cellIdentityLte) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (lteCellIdentity instanceof CellIdentityLte) {
    ...
    private static String processCellIdentityTdscdmaArray(ArrayList<CellIdentityTdscdma> cellIdentityTdscdma) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (tdscdmaCellIdentity instanceof CellIdentityTdscdma) {
    ...
    /* JADX INFO: Multiple debug info for r0v20 java.lang.String: [D('results' java.util.ArrayList<java.lang.Object>), D('str' java.lang.String)] */
    ...
    private String handleDataRegState(Object ret) {
        ...
        if (!(ret instanceof HwDataRegStateResult_2_1)) {
            return "****";
        }
        HwDataRegStateResult_2_1 dataReg = (HwDataRegStateResult_2_1) ret;
        String result = dataRegStateResultToString14(dataReg.base);
        return result + cellIdentityNrToString(dataReg.cellIdentityNr);
    }

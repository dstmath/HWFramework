...
public class HwVSimPhoneSwitcher extends Handler {
    ...
    public HwVSimPhoneSwitcher(int maxActivePhones, int numPhones, Context context, Looper looper, PhoneExt vsimPhone, CommandsInterfaceEx vsimCi, PhoneExt phone1, PhoneExt phone2, CommandsInterfaceEx[] cis) {
        ...
        this.mLocalLog = new LocalLogEx((int) MAX_LOCAL_LOG_LINES);
        ...
        networkFactory.setScoreFilter((int) HwVSimConstants.EVENT_NOTIFY_PLUG_OUT_DONE);
        ...
        networkFactoryForVowifi.setScoreFilter((int) HwVSimConstants.EVENT_NOTIFY_PLUG_OUT_DONE);
    ...
    private static class PhoneSwitcherNetworkRequestListener extends NetworkFactoryEx {
        ...
        public void needNetworkFor(NetworkRequest networkRequest, int score) {
            ...
            Message msg = this.mPhoneSwitcher.obtainMessage(HwVSimConstants.EVENT_NOTIFY_PLUG_OUT_DONE);
        ...
        public void releaseNetworkFor(NetworkRequest networkRequest) {
            ...
            Message msg = this.mPhoneSwitcher.obtainMessage(102);
            msg.obj = networkRequest;
            msg.sendToTarget();
        }

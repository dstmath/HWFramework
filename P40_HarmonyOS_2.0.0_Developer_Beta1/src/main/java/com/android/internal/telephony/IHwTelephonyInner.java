...
public interface IHwTelephonyInner extends IInterface {
    ...
    int getNrOptionModeForSlotId(int i) throws RemoteException;
    ...
    boolean getSwitchState(int i) throws RemoteException;
    ...
    boolean setNrOptionModeForSlotId(int i, int i2, Message message) throws RemoteException;

    void setSimPowerStateForSlot(int i, int i2, Message message) throws RemoteException;

    void setSwitchState(int i, int i2) throws RemoteException;
    ...
    public static class Default implements IHwTelephonyInner {
        ...
        @Override // com.android.internal.telephony.IHwTelephonyInner
        public void setSwitchState(int type, int ability) throws RemoteException {
        }

        @Override // com.android.internal.telephony.IHwTelephonyInner
        public boolean getSwitchState(int type) throws RemoteException {
            return false;
        }

        @Override // com.android.internal.telephony.IHwTelephonyInner
        public boolean setNrOptionModeForSlotId(int slotId, int mode, Message msg) throws RemoteException {
            return false;
        }

        @Override // com.android.internal.telephony.IHwTelephonyInner
        public int getNrOptionModeForSlotId(int slotId) throws RemoteException {
            return 0;
        }
    ...
    public static abstract class Stub extends Binder implements IHwTelephonyInner {
        ...
        static final int TRANSACTION_getNrOptionModeForSlotId = 20;
        ...
        static final int TRANSACTION_getSwitchState = 18;
        ...
        static final int TRANSACTION_setNrOptionModeForSlotId = 19;
        static final int TRANSACTION_setSimPowerStateForSlot = 10;
        static final int TRANSACTION_setSwitchState = 17;
            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 16:
                        ...
                        return true;
                    case TRANSACTION_setSwitchState /* 17 */:
                        data.enforceInterface(DESCRIPTOR);
                        setSwitchState(data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getSwitchState /* 18 */:
                        data.enforceInterface(DESCRIPTOR);
                        boolean switchState = getSwitchState(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(switchState ? 1 : 0);
                        return true;
                    case TRANSACTION_setNrOptionModeForSlotId /* 19 */:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        boolean nrOptionModeForSlotId = setNrOptionModeForSlotId(_arg03, _arg12, _arg22);
                        reply.writeNoException();
                        reply.writeInt(nrOptionModeForSlotId ? 1 : 0);
                        return true;
                    case 20:
                        data.enforceInterface(DESCRIPTOR);
                        int _result7 = getNrOptionModeForSlotId(data.readInt());
                        reply.writeNoException();
        ...
        public static class Proxy implements IHwTelephonyInner {
            ...
            public void setSwitchState(int type, int ability) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_setSwitchState, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
                    }
                    Stub.getDefaultImpl().setSwitchState(type, ability);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public boolean getSwitchState(int type) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(type);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_getSwitchState, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getSwitchState(type);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public boolean setNrOptionModeForSlotId(int slotId, int mode, Message msg) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(Stub.TRANSACTION_setNrOptionModeForSlotId, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setNrOptionModeForSlotId(slotId, mode, msg);
                    }
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
            ...
            public int getNrOptionModeForSlotId(int slotId) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(20, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getNrOptionModeForSlotId(slotId);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();

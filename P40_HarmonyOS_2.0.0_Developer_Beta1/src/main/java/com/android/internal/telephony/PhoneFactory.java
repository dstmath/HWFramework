...
public class PhoneFactory {
                ...
                while (true) {
                    ...
                    if (!hasException) {
                        ...
                        for (int i2 = 0; i2 < numPhones; i2++) {
                            ...
                            try {
                                sCommandsInterfaces[i2] = (CommandsInterface) HwTelephonyFactory.getHwTelephonyBaseManager().createHwRil(context, networkModes[i2], cdmaSubscription, Integer.valueOf(i2));
                            } catch (Exception e2) {
                        ...
                        HwTelephonyFactory.getHwUiccManager().initHwSubscriptionManager(context, CommandsInterfaceEx.getCommandsInterfaceExs(sCommandsInterfaces));
                        ...
                        if (context.getPackageManager().hasSystemFeature("android.hardware.telephony.ims")) {
                            ...
                            String defaultImsPackage = sContext.getResources().getString(17039851);
                        ...
                        IHwGsmCdmaPhoneEx hwGsmCdmaPhoneEx = ((GsmCdmaPhone) getDefaultPhone()).getHwGsmCdmaPhoneEx();
                        if (hwGsmCdmaPhoneEx != null) {
                            hwGsmCdmaPhoneEx.initHwTimeZoneUpdater(sContext);
                        }
    ...
    public static Phone getPhone(int phoneId) {
        ...
        synchronized (sLockProxyPhones) {
            if (!sMadeDefaults) {
                throw new IllegalStateException("Default phones haven't been made yet!");
            } else if (VSimUtilsInner.isHisiVSimSlot(phoneId)) {
    ...
    public static void dump(FileDescriptor fd, PrintWriter printwriter, String[] args) {
        ...
        for (int i = 0; i < phones.length; i++) {
            ...
            try {
                ...
                pw.println("Telephony DebugService: Could not get Phone[" + i + "]");
            }
        }
        ...
        try {
            ...
            pw.println("sSubscriptionMonitor Exception");
        }
        pw.decreaseIndent();
        pw.println("++++++++++++++++++++++++++++++++");
        ...
        try {
            ...
            pw.println("sUiccController Exception");
        }
        pw.flush();
        pw.decreaseIndent();
        pw.println("++++++++++++++++++++++++++++++++");
        if (sEuiccController != null) {
            ...
            try {
                ...
                pw.println("sEuiccController Exception");
            }
            pw.flush();
            pw.decreaseIndent();
            pw.println("++++++++++++++++++++++++++++++++");
        ...
        try {
            ...
            pw.println("SubscriptionController Exception");
        }
        pw.flush();
        pw.decreaseIndent();
        pw.println("++++++++++++++++++++++++++++++++");
        ...
        try {
            ...
            pw.println("sSubInfoRecordUpdater Exception");
        }
        pw.flush();
        pw.decreaseIndent();
        ...
        if (Log.HWINFO) {
            ...
            try {
                ...
                pw.println("SharedPreferences Exception");
            }
            pw.decreaseIndent();
            pw.println("++++++++++++++++++++++++++++++++");
            ...
            try {
                ...
                pw.println("AnomalyReporter Exception");
            }
            pw.flush();
            pw.decreaseIndent();
        }

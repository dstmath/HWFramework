...
public abstract class SMSDispatcher extends Handler implements ISMSDispatcherInner {
    ...
    public void handleMessage(Message msg) {
        ...
        if (i == 2) {
            ...
            if (i == 17) {
                ...
                this.mToast = Toast.makeText(this.mContext, 33686283, 1);
                this.mToast.show();
            } else if (i != 1000) {
                switch (i) {
                    case 7:
    ...
    public void handleConfirmShortCode(boolean isPremium, SmsTracker tracker) {
        ...
        if (!denyIfQueueLimitReached(tracker)) {
            ...
            ConfirmDialogListener listener = new ConfirmDialogListener(tracker, (TextView) layout.findViewById(16909424), 0);
            ((TextView) layout.findViewById(16909419)).setText(messageText);
            ((TextView) ((ViewGroup) layout.findViewById(16909420)).findViewById(16909421)).setText(detailsId);
            ((CheckBox) layout.findViewById(16909422)).setOnCheckedChangeListener(listener);

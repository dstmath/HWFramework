...
public class EriManager {
    ...
    private EriDisplayInformation getEriDisplayInformation(int roamInd, int defRoamInd) {
        ...
        switch (roamInd) {
            case 0:
                return new EriDisplayInformation(0, 0, this.mContext.getText(17041146).toString());
            case 1:
                return new EriDisplayInformation(1, 0, this.mContext.getText(17041147).toString());
            case 2:
                return new EriDisplayInformation(2, 1, this.mContext.getText(17041151).toString());
            case 3:
            ...
            case 9:
                return new EriDisplayInformation(roamInd, 0, this.mContext.getText(17041158).toString());
            case 10:

...
public class HwCustApnReminderImpl extends HwCustApnReminder {
    ...
    private static final boolean IS_DELETE_PREFERAPN = SystemProperties.getBoolean("ro.config.delete.preferapn", (boolean) IS_DELETE_PREFERAPN);
    private static boolean IS_DISABLE_AP = IS_DELETE_PREFERAPN;
    ...
    private void mentionApnFailed() {
        mAllowApnMention = IS_DELETE_PREFERAPN;
    ...
    public void deletePreferApn(Context context, String imsi, int slotId) {
        int subId;
        boolean deletePreferApnState = IS_DELETE_PREFERAPN;
        boolean hasHwCfgConfig = IS_DELETE_PREFERAPN;
        try {

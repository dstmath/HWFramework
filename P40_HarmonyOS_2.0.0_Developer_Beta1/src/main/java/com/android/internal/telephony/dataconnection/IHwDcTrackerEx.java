...
public interface IHwDcTrackerEx {
    ...
    static DataProfileEx createDataProfile(ApnSetting apn, int profileId, boolean isPreferred, Bundle extraData) {
    ...
    default void actionProcess(int inputAction) {
    }
    ...
    default void updateLastDoRecoveryTimestamp(int action) {
    }

    default boolean isDorecoveryTrigger() {
        return false;
    }

    default void setIsDorecoveryTrigger(boolean isDorecoveryTrigger) {
    }
    ...
    default UiccCardApplicationEx getUiccCardApplication(int phoneId, int appFamily) {
        ...
        if (VSimUtilsInner.isHisiVSimSlot(phoneId)) {
    ...
    default void checkDataSelfCureAfterDisconnect(int failReason) {
    }
    ...
    default String[] addSliceNetworkConfigStrings(String[] networkConfigStrings) {
        return networkConfigStrings;
    }

    default boolean isHwRadioDataStallEnable() {
        return false;
    }

    default boolean isPdnRejCureEnable() {
        return false;
    }

    default boolean isEnableEsmFlagCure() {
        return false;
    }

...
public class TelephonyNetworkFactory extends NetworkFactory {
    ...
    private class InternalHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (!HuaweiTelephonyConfigs.isHisiPlatform() || !VSimUtilsInner.isVSimOn() || msg.what == 3 || msg.what == 4) {
                switch (msg.what) {
                    case 1:
                ...
                TelephonyNetworkFactory telephonyNetworkFactory = TelephonyNetworkFactory.this;
                telephonyNetworkFactory.log("not handle message due to vsim is on for " + msg.what);
            }
        }
    }

...
public interface IHwEuiccManager extends IInterface {
    ...
    void startOtaUpdating(int i, int i2) throws RemoteException;
    ...
    public static class Default implements IHwEuiccManager {
        ...
        @Override // com.android.internal.telephony.euicc.IHwEuiccManager
        public void startOtaUpdating(int cardId, int otaReason) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IHwEuiccManager {
        ...
        static final int TRANSACTION_startOtaUpdating = 5;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code == 1) {
                ...
                data.enforceInterface(DESCRIPTOR);
                startOtaUpdating(data.readInt(), data.readInt());
                reply.writeNoException();
                return true;
        ...
        public static class Proxy implements IHwEuiccManager {
            ...
            public void startOtaUpdating(int cardId, int otaReason) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().startOtaUpdating(cardId, otaReason);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }

...
public class HwFullNetworkManager {
    ...
    private HwFullNetworkManager() {
        Log.d(TAG, "add " + this.mHwFullNetworkManager.getClass().getCanonicalName() + " to memory");
    }
    ...
    public void setServiceAbilityForQCOM(int slotId, int type, int ability, int serviceOnMappingMode) {
        this.mHwFullNetworkManager.setServiceAbilityForQCOM(slotId, type, ability, serviceOnMappingMode);
    }
    ...
    public void setSimContactLoaded(int slotId, boolean loaded) {
        this.mHwFullNetworkManager.setSimContactLoaded(slotId, loaded);
    }
}

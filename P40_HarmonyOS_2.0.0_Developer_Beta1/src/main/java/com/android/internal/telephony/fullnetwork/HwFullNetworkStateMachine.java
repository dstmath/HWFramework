        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case HwFullNetworkConstantsInner.EVENT_FORCE_CHECK_MAIN_SLOT_FOR_CMCC /* 207 */:
                    ...
                    if (!hwFullNetworkStateMachine2.isInSpecificState(hwFullNetworkStateMachine2.mMainSlotSetState)) {
                        HwFullNetworkStateMachine hwFullNetworkStateMachine3 = HwFullNetworkStateMachine.this;
                        hwFullNetworkStateMachine3.transitionTo(hwFullNetworkStateMachine3.mMainSlotCheckState);
                        ...
                        hwFullNetworkStateMachine4.logd("DefaultState deferred Msg " + msg.what);
                        HwFullNetworkStateMachine.this.deferMessage(msg);
                    }
                    return true;
                case 202:
                    HwFullNetworkStateMachine.this.logd("DefaultState Received EVENT_SET_MAIN_SLOT.");
                    HwFullNetworkStateMachine hwFullNetworkStateMachine5 = HwFullNetworkStateMachine.this;
                    hwFullNetworkStateMachine5.transitionTo(hwFullNetworkStateMachine5.mMainSlotSetState);
                    HwFullNetworkStateMachine.this.deferMessage(msg);
                    return true;
                case HwFullNetworkConstantsInner.EVENT_CHECK_NETWORK_TYPE /* 205 */:
                    ...
                    HwFullNetworkStateMachine hwFullNetworkStateMachine6 = HwFullNetworkStateMachine.this;
                    if (!hwFullNetworkStateMachine6.isInSpecificState(hwFullNetworkStateMachine6.mMainSlotSetState)) {
                        HwFullNetworkStateMachine hwFullNetworkStateMachine7 = HwFullNetworkStateMachine.this;
                        hwFullNetworkStateMachine7.transitionTo(hwFullNetworkStateMachine7.mMainSlotCheckState);
                        HwFullNetworkStateMachine.this.deferMessage(msg);
                    } else {
                        HwFullNetworkStateMachine hwFullNetworkStateMachine8 = HwFullNetworkStateMachine.this;
                        hwFullNetworkStateMachine8.logd("DefaultState deferred Msg " + msg.what);
                        HwFullNetworkStateMachine.this.deferMessage(msg);
                    }
                    return true;
                case HwFullNetworkConstantsInner.EVENT_SET_NETWORK_TYPE /* 206 */:
                default:
                    HwFullNetworkStateMachine hwFullNetworkStateMachine9 = HwFullNetworkStateMachine.this;
                    hwFullNetworkStateMachine9.logd("DefaultState.processMessage default:" + msg.what);
                    return true;
            }
        }
    }
    ...
    public class MainSlotSetState extends StateEx {
        ...
        public boolean processMessage(Message msg) {
            ...
            if (i == 202) {
                ...
                HwFullNetworkStateMachine hwFullNetworkStateMachine3 = HwFullNetworkStateMachine.this;
                hwFullNetworkStateMachine3.transitionTo(hwFullNetworkStateMachine3.mDefaultState);
                return true;
            }
        }
    }

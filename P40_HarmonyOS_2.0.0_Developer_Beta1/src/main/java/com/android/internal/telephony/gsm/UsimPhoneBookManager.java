...
public class UsimPhoneBookManager extends Handler implements IccConstants, IUsimPhoneBookManagerInner {
    ...
    private IHwUsimPhoneBookManagerEx mHwUsimPhoneBookManagerEx = null;
    ...
    public UsimPhoneBookManager(IccFileHandler fh, AdnRecordCache cache) {
        ...
        this.mHwUsimPhoneBookManagerEx = HwPartTelephonyFactory.loadFactory(HwPartTelephonyFactory.TELEPHONY_FACTORY_IMPL_NAME).createHwUsimPhoneBookManagerEx(this, this.mFh, cache, this.mLock);
    }

    public void reset() {
        if (IccRecords.getEmailAnrSupport()) {
            this.mHwUsimPhoneBookManagerEx.reset();
            return;
        }
    ...
    public ArrayList<AdnRecord> loadEfFilesFromUsim() {
        if (IccRecords.getEmailAnrSupport()) {
            return (ArrayList) AdnRecordExt.convertToAdnRecords(this.mHwUsimPhoneBookManagerEx.loadEfFilesFromUsimHw());
        }
    ...
    public void invalidateCache() {
        if (IccRecords.getEmailAnrSupport()) {
            this.mHwUsimPhoneBookManagerEx.invalidateCache();
        } else {
    ...
    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public void setIccFileHandler(IIccFileHandlerInner iccFileHandler) {
        if (IccRecords.getEmailAnrSupport()) {
            this.mHwUsimPhoneBookManagerEx.setIccFileHandlerHw(iccFileHandler);
        } else if (iccFileHandler instanceof IccFileHandler) {
            this.mFh = (IccFileHandler) iccFileHandler;
        } else {
            log("setIccFileHandler fail.");
        }
    }
    ...
    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public boolean getIsPbrPresent() {
        return this.mIsPbrPresent.booleanValue();
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getPbrRecordsSize() {
    ...
    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getEFidInPBRForEx(int recNum, int tag) {
        SparseArray<File> files;
        int efid = 0;
        ArrayList<PbrRecord> arrayList = this.mPbrRecords;
        if (arrayList == null || arrayList.get(recNum) == null || (files = this.mPbrRecords.get(recNum).mFileIds) == null || files.size() == 0) {
            return 0;
        }
    ...
    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public void readPbrFileAndWaitHw() {
        readPbrFileAndWait();
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getEFidInPBR(int recNum, int tag) {
        return this.mHwUsimPhoneBookManagerEx.getEFidInPBRHw(recNum, tag);
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int[] getAdnRecordsSizeFromEF() {
        return this.mHwUsimPhoneBookManagerEx.getAdnRecordsSizeFromEFHw();
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public void readExt1FileForSim(int efid) {
        this.mHwUsimPhoneBookManagerEx.readExt1FileForSim(efid);
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getPbrFileSize() {
        return this.mHwUsimPhoneBookManagerEx.getPbrFileSizeHw();
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public boolean updateEmailFile(int adnRecNum, String oldEmail, String newEmail, int efidIndex) {
        return this.mHwUsimPhoneBookManagerEx.updateEmailFile(adnRecNum, oldEmail, newEmail, efidIndex);
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public boolean updateAnrFile(int adnRecNum, String oldAnr, String newAnr, int efidIndex) {
        return this.mHwUsimPhoneBookManagerEx.updateAnrFile(adnRecNum, oldAnr, newAnr, efidIndex);
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public boolean updateExt1File(int adnRecNum, AdnRecordExt oldAdnRecord, AdnRecordExt newAdnRecord, int tagOrEfid) {
        return this.mHwUsimPhoneBookManagerEx.updateExt1File(adnRecNum, oldAdnRecord, newAdnRecord, tagOrEfid);
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getAnrCount() {
        return this.mHwUsimPhoneBookManagerEx.getAnrCount();
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getEmailCount() {
        return this.mHwUsimPhoneBookManagerEx.getEmailCount();
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getSpareAnrCount() {
        return this.mHwUsimPhoneBookManagerEx.getSpareAnrCount();
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getSpareEmailCount() {
        return this.mHwUsimPhoneBookManagerEx.getSpareEmailCount();
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getUsimAdnCount() {
        return this.mHwUsimPhoneBookManagerEx.getUsimAdnCount();
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getEmptyEmailNumByPbrindex(int pbrindex) {
        return this.mHwUsimPhoneBookManagerEx.getEmptyEmailNumByPbrindex(pbrindex);
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getEmptyAnrNumByPbrindex(int pbrindex) {
        return this.mHwUsimPhoneBookManagerEx.getEmptyAnrNumByPbrindex(pbrindex);
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getEmailFilesCountEachAdn() {
        return this.mHwUsimPhoneBookManagerEx.getEmailFilesCountEachAdn();
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getAnrFilesCountEachAdn() {
        return this.mHwUsimPhoneBookManagerEx.getAnrFilesCountEachAdn();
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getAdnRecordsFreeSize() {
        return this.mHwUsimPhoneBookManagerEx.getAdnRecordsFreeSize();
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getPbrIndexBy(int adnIndex) {
        return this.mHwUsimPhoneBookManagerEx.getPbrIndexBy(adnIndex);
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getPbrIndexByEfid(int efid) {
        return this.mHwUsimPhoneBookManagerEx.getPbrIndexByEfid(efid);
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getInitIndexByPbr(int pbrIndex) {
        return this.mHwUsimPhoneBookManagerEx.getInitIndexByPbr(pbrIndex);
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getExt1Count() {
        return this.mHwUsimPhoneBookManagerEx.getExt1Count();
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public int getSpareExt1Count() {
        return this.mHwUsimPhoneBookManagerEx.getSpareExt1Count();
    }

    @Override // com.android.internal.telephony.gsm.IUsimPhoneBookManagerInner
    public ArrayList<AdnRecordExt> loadEfFilesFromUsimHw() {
        return this.mHwUsimPhoneBookManagerEx.loadEfFilesFromUsimHw();
    }
}

...
public class SipPhone extends SipPhoneBase {
    ...
    @Override // com.android.internal.telephony.sip.SipPhoneBase, com.android.internal.telephony.PhoneInternalInterface
    ...
    @Override // com.android.internal.telephony.sip.SipPhoneBase, com.android.internal.telephony.AbstractPhoneBase, com.android.internal.telephony.PhoneInternalInterface, com.android.internal.telephony.AbstractPhoneInternalInterface
    ...
    public void handleMessage(Message msg) {
        try {
            ...
            loge("handleMessage, message not handled, event:" + msg.what);
        }
    }
        ...
        public void onError(SipAudioCall call, int errorCode, String errorMessage) {
            ...
            switch (errorCode) {
                ...
                case -10:
                    ...
                    return;
                case -9:
                case TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_PREF_RADIO_TECH_CHANGED /* -4 */:
                default:
                    onError(36);
                    return;
                case -8:
                ...
                case -7:
                    onError(8);
                    return;
                case TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_TETHERED_CALL_ACTIVE /* -6 */:
                    onError(7);
                    return;
                case TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_RADIO_POWER_OFF /* -5 */:
                case TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_SIGNAL_LOST /* -3 */:
                    onError(13);
                    return;
                case -2:
                    onError(12);

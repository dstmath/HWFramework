...
public class HwCustSIMRecordsImpl extends HwCustSIMRecords {
    ...
    private BroadcastReceiver mNetworkInfoReceiver = new BroadcastReceiver() {
        /* class com.android.internal.telephony.uicc.HwCustSIMRecordsImpl.AnonymousClass1 */

        @Override // android.content.BroadcastReceiver
        public void onReceive(Context context, Intent intent) {
            TelephonyManager tm;
            if ("android.intent.action.SERVICE_STATE".equals(intent.getAction()) && (tm = (TelephonyManager) HwCustSIMRecordsImpl.this.mContext.getSystemService("phone")) != null) {

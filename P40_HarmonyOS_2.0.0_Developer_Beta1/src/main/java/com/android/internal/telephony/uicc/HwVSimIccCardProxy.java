...
public class HwVSimIccCardProxy {
    ...
    private void updateExternalState() {
        ...
        UiccCardExt uiccCardExt = this.mUiccCard;
        if (uiccCardExt == null || uiccCardExt.getCardState() == IccCardStatusExt.CardStateEx.CARDSTATE_ABSENT) {
            ...
            int i = AnonymousClass1.$SwitchMap$com$huawei$internal$telephony$uicc$IccCardApplicationStatusEx$AppStateEx[this.mUiccApplication.getState().ordinal()];
            if (i == 1) {
    ...
    private void registerUiccCardEvents() {
        UiccCardApplicationEx uiccCardApplicationEx = this.mUiccApplication;
        if (uiccCardApplicationEx != null) {
            uiccCardApplicationEx.registerForReady(this.mHandler, 5, (Object) null);
        }
    }
    ...
    private void unregisterUiccCardEvents() {
        UiccCardApplicationEx uiccCardApplicationEx = this.mUiccApplication;
        if (uiccCardApplicationEx != null) {
            uiccCardApplicationEx.unregisterForReady(this.mHandler);
        }
    }
    ...
    private String getIccStateReason(IccCardConstantsEx.StateEx state) {
        int i = AnonymousClass1.$SwitchMap$com$huawei$internal$telephony$IccCardConstantsEx$StateEx[state.ordinal()];
        if (i == 2) {
            return "PIN";
        }
        if (i == 3) {

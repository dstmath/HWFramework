...
public class NotificationChannelController {
    ...
    public static void createAll(Context context) {
        NotificationChannel alertChannel = new NotificationChannel(CHANNEL_ID_ALERT, context.getText(17040673), 3);
        ...
        NotificationChannel mobileDataStatusChannel = new NotificationChannel(CHANNEL_ID_MOBILE_DATA_STATUS, context.getText(17040672), 2);
        mobileDataStatusChannel.setBlockableSystem(true);
        NotificationChannel simChannel = new NotificationChannel(CHANNEL_ID_SIM, context.getText(17040680), 2);
        simChannel.setSound(null, null);
        NotificationChannel callforwardChannel = new NotificationChannel(CHANNEL_ID_CALL_FORWARD, context.getText(17040664), 3);
        migrateCallFowardNotificationChannel(context, callforwardChannel);
        ((NotificationManager) context.getSystemService(NotificationManager.class)).createNotificationChannels(Arrays.asList(new NotificationChannel(CHANNEL_ID_SMS, context.getText(17040681), 4), new NotificationChannel(CHANNEL_ID_WFC, context.getText(17040688), 2), alertChannel, mobileDataStatusChannel, simChannel, callforwardChannel));
    ...
    public static void migrateVoicemailNotificationSettings(Context context) {
        NotificationChannel voiceMailChannel = new NotificationChannel(CHANNEL_ID_VOICE_MAIL, context.getText(17040686), 3);

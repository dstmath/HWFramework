...
public final class SMSDispatcherUtil {
    ...
    public static boolean isSupportHandleSmsBybinderService(Context context, String packageName) {
        ...
        try {
            packageInfo = pm.getPackageInfo("com.google.android.gms", 0);
            applicationInfo = pm.getApplicationInfo("com.google.android.gms", 0);
        } catch (PackageManager.NameNotFoundException e) {
            packageInfo = null;
            applicationInfo = null;
        }
        if ((packageInfo == null || applicationInfo == null || !applicationInfo.isPrivilegedApp()) && "com.google.android.ims".equals(packageName)) {
            return false;
        }
        return true;
    }

...
public class HwVSimDisableProcessor extends HwVSimHisiProcessor {
    ...
    public void onEnter() {
        ...
        this.mVSimController.setProcessAction(HwVSimConstants.ProcessAction.PROCESS_ACTION_DISABLE);

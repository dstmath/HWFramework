...
public class HwVSimSwitchModeProcessor extends HwVSimHisiProcessor {
    ...
    public void onEnter() {
        ...
        this.mVSimController.setProcessAction(HwVSimConstants.ProcessAction.PROCESS_ACTION_SWITCHWORKMODE);

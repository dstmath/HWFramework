...
public final class FloatingActionMode extends ActionMode {
    ...
    private boolean isContentRectWithinBounds() {
        ...
        if (config != null && config.windowConfiguration.inHwPCFreeFormWindowingMode() && HwActivityTaskManager.isPCMultiCastMode()) {
            ...
            Rect bounds2 = config.windowConfiguration.getBounds();
            if (bounds2 != null && !bounds2.isEmpty()) {
                this.mScreenRect.set(bounds2);
            }
            this.mScreenRect.offsetTo(this.mViewRectOnScreen.left, this.mViewRectOnScreen.top);
        }
    ...
    public static final class FloatingToolbarVisibilityHelper {
        private static final long MIN_SHOW_DURATION_FOR_MOVE_HIDE = 1200;

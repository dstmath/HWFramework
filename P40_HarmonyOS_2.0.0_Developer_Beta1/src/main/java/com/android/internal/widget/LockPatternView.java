...
public class LockPatternView extends View {
    ...
    public LockPatternView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.LockPatternView, 16844297, R.style.Widget_LockPatternView);
        String aspect = a.getString(3);
        ...
        this.mRegularColor = a.getColor(1, 0);
        this.mErrorColor = a.getColor(0, 0);
        this.mSuccessColor = a.getColor(2, 0);
        this.mPathPaint.setColor(a.getColor(4, this.mRegularColor));

...
public abstract class AbstractConnectivityService extends IConnectivityManager.Stub {
    ...
    public void setUseCtrlSocket(boolean isUseCtrlSocket) {
    }
    ...
    /* access modifiers changed from: protected */
    public boolean needSetUserDataEnabled(boolean isEnabled) {
        return true;
    }
    ...
    /* access modifiers changed from: protected */
    public void setVpnSettingValue(boolean isEnable) {
    }
    ...
    public void setLteMobileDataEnabled(boolean isEnable) {
    }

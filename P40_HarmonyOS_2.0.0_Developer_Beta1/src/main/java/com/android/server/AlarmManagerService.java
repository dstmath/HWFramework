...
public class AlarmManagerService extends AbsAlarmManagerService {
    ...
    public final class Constants extends ContentObserver {
        ...
        public Constants(Handler handler) {
            super(handler);
            AlarmManagerService.this = this$0;
    ...
    public final class Batch {
        ...
        Batch(Alarm seed) {
            ...
            if (seed.listener == this$0.mTimeTickTrigger) {
                this$0.mLastTickAdded = this$0.mInjector.getCurrentTimeMillis();
            }
        }
    ...
    public class ClockReceiver extends BroadcastReceiver {
        public ClockReceiver() {
            ...
            this$0.getContext().registerReceiver(this, filter);
        }
    ...
    class UninstallReceiver extends BroadcastReceiver {
        public UninstallReceiver() {
            ...
            this$0.getContext().registerReceiver(this, sdFilter);
        }

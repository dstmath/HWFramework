...
public class HwBastetService extends SystemService {
    ...
    private boolean checkBastetService() {
        ...
        if (this.mConnectTimes < 5) {
            ...
            timeoutMsg.what = 2;
            this.mHandler.sendMessageDelayed(timeoutMsg, HwSwingMotionGestureConstant.HOVER_SCREEN_OFF_THRESHOLD);
        } else {
            ...
            public void run() {
                for (int i = 0; i < 10; i++) {
                    ...
                    if (HwBastetService.this.mPowerKit == null) {
                        ...
                        SystemClock.sleep(HwSwingMotionGestureConstant.HOVER_SCREEN_OFF_THRESHOLD);
                    } else {
                        try {

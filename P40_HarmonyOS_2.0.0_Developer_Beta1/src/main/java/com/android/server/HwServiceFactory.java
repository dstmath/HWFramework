...
import com.android.server.connectivity.DefaultHwTetheringEx;
...
public class HwServiceFactory {
    ...
    public interface Factory {
        ...
        void addJankShieldService(Context context);
        ...
        FoldPolicy getHwFoldPolicy(Context context);
        ...
        IHwTetheringEx getHwTetheringEx();
    ...
    public static PackageManagerService getHuaweiPackageManagerService(Context context, Installer installer, boolean isFactoryTest, boolean isOnlyCore) {
        Factory obj2 = getImplObject();
        if (obj2 != null) {
            return obj2.getHuaweiPackageManagerService(context, installer, isFactoryTest, isOnlyCore);
        }
        return new PackageManagerService(context, installer, isFactoryTest, isOnlyCore);
    }
    ...
    public static boolean isCustedCouldStopped(String pkg, boolean isBlock, boolean isStopped) {
        Factory obj2 = getImplObject();
        if (obj2 != null) {
            return obj2.isCustedCouldStopped(pkg, isBlock, isStopped);
        }
        return false;
    }
    ...
    public static SyncManager createHwSyncManager(Context context, boolean isFactoryTest) {
        Factory obj2 = getImplObject();
        if (obj2 != null) {
            return obj2.createHwSyncManager(context, isFactoryTest);
        }
        return new SyncManager(context, isFactoryTest);
    }
    ...
    public static boolean removeProtectAppInPrivacyMode(AuthenticatorDescription desc, boolean isRemoved, Context context) {
        Factory obj2 = getImplObject();
        if (obj2 != null) {
            return obj2.removeProtectAppInPrivacyMode(desc, isRemoved, context);
        }
        return false;
    }
    ...
    public static IHwTetheringEx getHwTetheringEx() {
        Factory factory = getImplObject();
        if (factory != null) {
            return factory.getHwTetheringEx();
        }
        return DefaultHwTetheringEx.getDefault();
    }

    public static ActivityStack createActivityStack(ActivityDisplay display, int stackId, ActivityStackSupervisor supervisor, int windowingMode, int activityType, boolean isOnTop) {
        Factory obj2 = getImplObject();
        if (obj2 != null) {
            return obj2.createActivityStack(display, stackId, supervisor, windowingMode, activityType, isOnTop);
        }
        return new ActivityStack(display, stackId, supervisor, windowingMode, activityType, isOnTop);
    }

    public static ActivityRecord createActivityRecord(ActivityTaskManagerService service, WindowProcessController caller, int launchedFromPid, int launchedFromUid, String launchedFromPackage, Intent intent, String resolvedType, ActivityInfo activityInfo, Configuration configuration, ActivityRecord resultTo, String resultWho, int reqCode, boolean isComponentSpecified, boolean isRootVoiceInteraction, ActivityStackSupervisor supervisor, ActivityOptions options, ActivityRecord sourceRecord) {
        Factory obj2 = getImplObject();
        return obj2 != null ? obj2.createActivityRecord(service, caller, launchedFromPid, launchedFromUid, launchedFromPackage, intent, resolvedType, activityInfo, configuration, resultTo, resultWho, reqCode, isComponentSpecified, isRootVoiceInteraction, supervisor, options, sourceRecord) : new ActivityRecord(service, caller, launchedFromPid, launchedFromUid, launchedFromPackage, intent, resolvedType, activityInfo, configuration, resultTo, resultWho, reqCode, isComponentSpecified, isRootVoiceInteraction, supervisor, options, sourceRecord);
    }
    ...
    public static AppTransition createHwAppTransition(Context context, WindowManagerService wms, DisplayContent displayContent) {
        Factory obj2 = getImplObject();
        if (obj2 != null) {
            return obj2.createHwAppTransition(context, wms, displayContent);
        }
        return new AppTransition(context, wms, displayContent);
    }
    ...
    public static TaskRecord createTaskRecord(ActivityTaskManagerService service, int taskId, Intent intent, Intent affinityIntent, String affinity, String rootAffinity, ComponentName realActivity, ComponentName origActivity, boolean isRootWasReset, boolean isAutoRemoveRecents, boolean isAskedCompatMode, int userId, int effectiveUid, String lastDescription, ArrayList<ActivityRecord> activities, long lastTimeMoved, boolean isNeverRelinquishIdentity, ActivityManager.TaskDescription lastTaskDescription, int taskAffiliation, int prevTaskId, int nextTaskId, int taskAffiliationColor, int callingUid, String callingPackage, int resizeMode, boolean isSupportsPictureInPicture, boolean isRealActivitySuspended, boolean isUserSetupComplete, int minWidth, int minHeight) {
        Factory obj2 = getImplObject();
        return obj2 != null ? obj2.createTaskRecord(service, taskId, intent, affinityIntent, affinity, rootAffinity, realActivity, origActivity, isRootWasReset, isAutoRemoveRecents, isAskedCompatMode, userId, effectiveUid, lastDescription, activities, lastTimeMoved, isNeverRelinquishIdentity, lastTaskDescription, taskAffiliation, prevTaskId, nextTaskId, taskAffiliationColor, callingUid, callingPackage, resizeMode, isSupportsPictureInPicture, isRealActivitySuspended, isUserSetupComplete, minWidth, minHeight) : new TaskRecord(service, taskId, intent, affinityIntent, affinity, rootAffinity, realActivity, origActivity, isRootWasReset, isAutoRemoveRecents, isAskedCompatMode, userId, effectiveUid, lastDescription, activities, lastTimeMoved, isNeverRelinquishIdentity, lastTaskDescription, taskAffiliation, prevTaskId, nextTaskId, taskAffiliationColor, callingUid, callingPackage, resizeMode, isSupportsPictureInPicture, isRealActivitySuspended, isUserSetupComplete, minWidth, minHeight);
    }
    ...
    public static void reportProximitySensorEventToIAware(boolean isPositive) {
        Factory obj2 = getImplObject();
        if (obj2 != null) {
            obj2.reportProximitySensorEventToIAware(isPositive);
        }
    }
    ...
    public static FocusRequester getHwFocusRequester(AudioAttributes audioAttributes, int focusRequest, int grantFlags, IAudioFocusDispatcher afl, IBinder source, String id, MediaFocusControl.AudioFocusDeathHandler hdlr, String pn, int uid, MediaFocusControl ctlr, int sdk, boolean isInExternal) {
        Factory obj2 = getImplObject();
        return obj2 != null ? obj2.getHwFocusRequester(audioAttributes, focusRequest, grantFlags, afl, source, id, hdlr, pn, uid, ctlr, sdk, isInExternal) : new FocusRequester(audioAttributes, focusRequest, grantFlags, afl, source, id, hdlr, pn, uid, ctlr, sdk);
    }
    ...
    public static void reportGoogleConn(boolean isConn) {
        Factory obj2 = getImplObject();
        if (obj2 != null) {
            obj2.reportGoogleConn(isConn);
        }
    }
    ...
    public static FoldPolicy getHwFoldPolicy(Context context) {
        Factory obj2 = getImplObject();
        if (obj2 != null) {
            return obj2.getHwFoldPolicy(context);
        }
        return null;
    }
    ...
    public static void addJankShieldService(Context context) {
        Factory obj2 = getImplObject();
        if (obj2 != null) {
            obj2.addJankShieldService(context);
        }
    }
}

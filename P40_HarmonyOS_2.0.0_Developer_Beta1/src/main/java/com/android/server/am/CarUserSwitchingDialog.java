...
public final class CarUserSwitchingDialog extends UserSwitchingDialog {
    ...
    public void inflateContent() {
        ...
        if (bitmap != null) {
            ((ImageView) view.findViewById(16909582)).setImageDrawable(CircleFramedDrawable.getInstance(bitmap, res.getDimension(17104987)));
        }
        ((TextView) view.findViewById(16909581)).setText(res.getString(17039742));
        setView(view);
    }

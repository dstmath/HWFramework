...
public abstract class PreBootBroadcaster extends IIntentReceiver.Stub {
    ...
    private Handler mHandler = new Handler(UiThread.get().getLooper(), null, true) {
        ...
        public void handleMessage(Message msg) {
            ...
            int i = msg.what;
            if (i == 1) {
                CharSequence title = context.getText(17039596);
    ...
    public void sendNext() {
        ...
        if (this.mIndex >= this.mTargets.size()) {
            ...
            if (this.mProgress != null) {
                this.mProgress.setProgress(this.mIndex, this.mTargets.size(), this.mService.mContext.getString(17039591, ri.activityInfo.loadLabel(this.mService.mContext.getPackageManager())));
            }

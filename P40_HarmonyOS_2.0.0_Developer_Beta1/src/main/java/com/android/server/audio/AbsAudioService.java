...
public abstract class AbsAudioService extends IAudioService.Stub {
    ...
    protected static final boolean SPK_RCV_STEREO_SUPPORT = (!"false".equals(AudioSystem.getParameters("audio_capability#spk_rcv_stereo_support")));
    ...
    /* access modifiers changed from: protected */
    public class DeviceVolumeState {

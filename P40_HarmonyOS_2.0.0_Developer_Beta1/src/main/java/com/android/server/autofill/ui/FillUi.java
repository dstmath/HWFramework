...
public final class FillUi {
    ...
    FillUi(Context context, FillResponse response, AutofillId focusedViewId, String filterText, OverlayControl overlayControl, CharSequence serviceLabel, Drawable serviceIcon, boolean nightMode, Callback callback) {
        ...
        TextView titleView = (TextView) decor.findViewById(16908786);
        if (titleView != null) {
            titleView.setText(this.mContext.getString(17039695, serviceLabel));
        }
        ImageView iconView = (ImageView) decor.findViewById(16908783);
        if (iconView != null) {
        ...
        if (response.getAuthentication() != null) {
            ...
            this.mFooter = null;
            this.mAdapter = null;
            ViewGroup container = (ViewGroup) decor.findViewById(16908785);
            try {
            ...
            if (headerPresentation2 != null) {
                ...
                LinearLayout headerContainer = (LinearLayout) decor.findViewById(16908782);
                if (Helper.sVerbose) {
            ...
            if (footerPresentation2 != null) {
                LinearLayout footerContainer2 = (LinearLayout) decor.findViewById(16908781);
            ...
            this.mListView = (ListView) decor.findViewById(16908784);
            ...
            if (iHwAutofillHelper != null && iHwAutofillHelper.isHwAutofillService(this.mContext)) {
                FrameLayout layout = (FrameLayout) decor.findViewById(16908785);
    ...
    public final class AnchoredWindow {
        ...
        public void show(WindowManager.LayoutParams params) {
            ...
            try {
                ...
                if (!this.mShowing) {
                    params.accessibilityTitle = this.mContentView.getContext().getString(17039667);
    ...
    public final class AnnounceFilterResult implements Runnable {
        ...
        public void run() {
            ...
            if (count <= 0) {
                text = FillUi.this.mContext.getString(17039668);
            } else {

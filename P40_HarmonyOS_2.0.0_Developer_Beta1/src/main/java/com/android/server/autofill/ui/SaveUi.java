...
public final class SaveUi {
    ...
    private static final int THEME_ID_DARK = 16974816;
    private static final int THEME_ID_LIGHT = 16974824;
    ...
    SaveUi(Context context, PendingUi pendingUi, CharSequence serviceLabel, Drawable serviceIcon, String servicePackageName, ComponentName componentName, SaveInfo info, ValueFinder valueFinder, OverlayControl overlayControl, OnSaveListener listener, boolean nightMode, boolean isUpdate, boolean compatMode) {
        ...
        TextView titleView = (TextView) view.findViewById(16908791);
        ...
        if ((type & 2) != 0) {
            types.add(context2.getString(17039679));
        }
        if ((type & 4) != 0) {
        ...
        if (applyCustomDescription(context2, view, valueFinder, info)) {
            ...
            if (this.mSubTitle != null) {
                writeLog(1131, type);
                ViewGroup subtitleContainer = (ViewGroup) view.findViewById(16908788);
        ...
        TextView noButton = (TextView) view.findViewById(16908790);
        if (info.getNegativeActionStyle() == 1) {
            noButton.setText(17041167);
        } else {
            noButton.setText(17039674);
        }
        ...
        TextView yesButton = (TextView) view.findViewById(16908792);
        if (isUpdate) {
            yesButton.setText(17039693);
        }
        ...
        params.width = -1;
        params.accessibilityTitle = context2.getString(17039673);
    ...
    private boolean applyCustomDescription(Context context, View saveUiView, ValueFinder valueFinder, SaveInfo info) {
        ...
        if (transformations2 == null || InternalTransformation.batchApply(valueFinder, template, transformations2)) {
            try {
                ...
                try {
                    ViewGroup subtitleContainer = (ViewGroup) saveUiView.findViewById(16908788);
    ...
    private void setServiceIcon(Context context, View view, Drawable serviceIcon) {
        ImageView iconView = (ImageView) view.findViewById(16908789);
        int maxWidth = context.getResources().getDimensionPixelSize(17104950);

...
public class BackupHandler extends Handler {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:150:0x044f  */
        ...
        switch (msg.what) {
            case 1:
                ...
                try {
                    ...
                    Slog.e(BackupManagerService.TAG, "get current transport client failed: " + e4);
                    return;
                } catch (Exception e5) {
                    Slog.e(BackupManagerService.TAG, "get current transport client failed.");
                    return;
                }
            case 2:
            ...
            case 6:
                ...
                try {
                    ...
                    Slog.e(BackupManagerService.TAG, "Error from transport getting set list: " + e8.getMessage());
                    if (params4.observer != null) {
                        try {
                    ...
                    if (params4.observer != null) {
                        try {
                            ...
                            Slog.e(BackupManagerService.TAG, "Restore observer threw: " + e12.getMessage());
                        }
                    }
                    removeMessages(8);

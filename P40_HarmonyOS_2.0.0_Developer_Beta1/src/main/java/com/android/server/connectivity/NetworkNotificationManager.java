...
public class NetworkNotificationManager {
    ...
    public void showNotification(int id, NotificationType notifyType, NetworkAgentInfo nai, NetworkAgentInfo switchToNai, PendingIntent intent, boolean highPriority) {
        ...
        if (notifyType == NotificationType.NO_INTERNET && transportType == 1) {
            ...
            CharSequence title4 = r.getString(17040639, WifiInfo.removeDoubleQuotes(nai.networkCapabilities.getSSID()));
            details = r.getString(17040640);
            title = title4;
            z = false;
            ...
            if (transportType == 0) {
                CharSequence title6 = r.getString(17040635, 0);
                ...
                z = false;
                CharSequence title7 = r.getString(17040635, 0);
                details = r.getString(17040636, name);
                title = title7;
            } else {
                CharSequence title8 = r.getString(17041538, 0);
                details = r.getString(17040636, WifiInfo.removeDoubleQuotes(nai.networkCapabilities.getSSID()));
            ...
            z = false;
            title = r.getString(17040641, toTransport);
            details = r.getString(17040642, toTransport, fromTransport);
    ...
    public void showToast(NetworkAgentInfo fromNai, NetworkAgentInfo toNai) {
        Toast.makeText(this.mContext, this.mContext.getResources().getString(17040643, getTransportName(getFirstTransportType(fromNai)), getTransportName(getFirstTransportType(toNai))), 1).show();
    }

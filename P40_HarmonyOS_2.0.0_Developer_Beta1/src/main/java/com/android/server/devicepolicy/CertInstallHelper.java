...
public class CertInstallHelper {
    ...
    private static boolean installCertToKeyStore(KeyStore.PrivateKeyEntry entry, String alias, int certInstallType) {
        ...
        return CertInstaller.installCert(alias == null ? DeviceSettingsPlugin.EMPTY_STRING : alias, userKey, userCert, caCerts, certInstallType);
    }
    ...
    public static boolean installX509Cert(byte[] bytes, String alias, int certInstallType) {
        ...
        try {
            ...
            return CertInstaller.installCert(alias == null ? DeviceSettingsPlugin.EMPTY_STRING : alias, null, userCert, caCerts, certInstallType);

...
public class EthernetUtils {
    ...
    public static boolean setEthernetConfiguration(Context context, Bundle policyData) {
        ...
        String ethStaticOrdhcp = policyData.getString(ETH_STATIC_OR_DHCP, DeviceSettingsPlugin.EMPTY_STRING);
        if (DHCP.equals(ethStaticOrdhcp)) {
            ipConfiguration = new IpConfiguration(IpConfiguration.IpAssignment.DHCP, IpConfiguration.ProxySettings.NONE, (StaticIpConfiguration) null, ProxyInfo.buildDirectProxy(DeviceSettingsPlugin.EMPTY_STRING, 0));
    ...
    private static IpConfiguration convertParamsToIpConfiguration(Bundle policyData) {
        ...
        String ipAddressStr = policyData.getString(ETH_IPADDRESS, DeviceSettingsPlugin.EMPTY_STRING);
        ...
        LinkAddress ipAddress = getIpLinkAddress(policyData.getString(ETH_STATIC_OR_DHCP, DeviceSettingsPlugin.EMPTY_STRING), getNetPrefixLength(policyData.getString(ETH_SUBNET_MASK, DeviceSettingsPlugin.EMPTY_STRING)), ipAddressStr);
        InetAddress gateway = NetworkUtils.numericToInetAddress(policyData.getString(ETH_GATEWAY, DeviceSettingsPlugin.EMPTY_STRING));
        ...
        try {
            String proxyHost = policyData.getString(ETH_PROXY_HOST, DeviceSettingsPlugin.EMPTY_STRING);
            if (!TextUtils.isEmpty(proxyHost)) {
                ...
                ipConfiguration2 = new IpConfiguration(IpConfiguration.IpAssignment.STATIC, IpConfiguration.ProxySettings.NONE, staticIpConfiguration, ProxyInfo.buildDirectProxy(DeviceSettingsPlugin.EMPTY_STRING, 0));
            }
        ...
        if (!(keyWords == null || context == null || (ipConfiguration = getIpConfiguration(context, keyWords.getString(ETH_KEY_WORDS))) == null)) {
            ...
            if (staticIpConfiguration != null) {
                ...
                if (linkAddress != null) {
                    ...
                    result.putString(ETH_SUBNET_MASK, linkAddress.getPrefixLength() + DeviceSettingsPlugin.EMPTY_STRING);
                }
            ...
            if (proxyInfo != null) {
                ...
                result.putString(ETH_PROXY_PORT, proxyInfo.getPort() + DeviceSettingsPlugin.EMPTY_STRING);
            }
        }
        return result;
    }

                ...
                if ("wifi_p2p_item_policy_name".equals(policyName)) {
                    ...
                    if (code == -1) {
                        ...
                        if (code2 == -1) {
                            ...
                            syncHwAdminCache(code2, bundle.getStringArrayList(DeviceSettingsPlugin.STATE_VALUE));
                        }
                    } else {
                        syncHwAdminCache(code, bundle.getBoolean(DeviceSettingsPlugin.STATE_VALUE, false));
                    }
                }
            }
        }

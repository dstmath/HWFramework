...
public class DeviceEmailPlugin extends DevicePolicyPlugin {
    ...
    private static final String DEVICE_POLICY_ACTION_POLICY_CHANGED = "com.huawei.devicepolicy.action.POLICY_CHANGED";
    ...
    private static final String TAG = "DeviceEmailPlugin";

    public DeviceEmailPlugin(Context context) {
        super(context);
    }
    ...
    private boolean isStatePolicy(String policyName) {
        return RESTRICT_DISABLE_DELETE_ACCOUNT.equals(policyName) || RESTRICT_DISABLE_ADD_ACCOUNT.equals(policyName) || RESTRICT_DISABLE_IMAP_POP3.equals(policyName);
    }

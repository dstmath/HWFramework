...
public class DeviceStorageManagerPlugin extends DevicePolicyPlugin {
    ...
    private static final String TAG = "DeviceStorageManagerPlugin";
    ...
    public PolicyStruct getPolicyStruct() {
        ...
        struct.addStruct(DISABLE_SDWRITING, PolicyStruct.PolicyType.STATE, new String[]{DeviceSettingsPlugin.STATE_VALUE});
        return struct;
    }
    ...
    private boolean doExecutePolicy(String policyName, Bundle policyData, boolean isChanged) {
        if (policyData == null) {
            ...
            if (c == 0) {
                ...
                new Thread(new Runnable(policyData.getBoolean(DeviceSettingsPlugin.STATE_VALUE)) {

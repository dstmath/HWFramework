...
public final class DisplayPowerController implements AutomaticBrightnessController.Callbacks, ManualBrightnessController.ManualBrightnessCallbacks, DisplayWhiteBalanceController.Callbacks, IHwDisplayPowerControllerEx.Callbacks {
    ...
    private static final boolean mSupportAod;
    ...
    public DisplayPowerController(Context context, DisplayManagerInternal.DisplayPowerCallbacks callbacks, Handler handler, SensorManager sensorManager, DisplayBlanker blanker) {
        ...
        this.mUseSoftwareAutoBrightnessConfig = resources2.getBoolean(17891368);
        this.mAllowAutoBrightnessWhileDozingConfig = resources2.getBoolean(17891343);
        ...
        if (this.mUseSoftwareAutoBrightnessConfig) {
            ...
            boolean autoBrightnessResetAmbientLuxAfterWarmUp = resources2.getBoolean(17891363);
            ...
            Sensor lightSensor = findDisplayLightSensor(resources2.getString(17039831));
        ...
        displayPowerController.mColorFadeFadesConfig = resources.getBoolean(17891360);
        displayPowerController.mDisplayBlanksAfterDozeConfig = resources.getBoolean(17891411);
        displayPowerController.mBrightnessBucketsInDozeConfig = resources.getBoolean(17891412);
    ...
    private void updatePowerState() {
        ...
        if (automaticBrightnessController2 != null) {
            automaticBrightnessController2.updatePowerStateAndPolicy(state2, this.mPowerRequest.policy);
    ...
    private boolean setScreenState(int state, boolean reportOnly) {
        ...
        if (this.mPowerState.getScreenState() != state) {
            ...
            if (!reportOnly) {
                ...
                HwLog.dubaie("DUBAI_TAG_SCREEN_STATE", "state=" + state);

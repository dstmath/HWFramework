...
public class HwBrightnessSceneController {
    ...
    public void initBrightnessParaForSpline() {
        ...
        if (this.mData.darkModeEnable && this.mData.isDarkModeCurveEnable) {
            initDarkModeBrightnessPara(this.mData.isDarkModeCurveEnable, this.mData.isDarkModeDefaultCurveEnable, this.mData.brightnessLineForDarkMode, this.mData.brightnessLineDefaultForDarkMode);
        }
    }
    ...
    private void initDarkModeBrightnessPara(boolean isDarkModeCurveEnable, boolean isDarkModeDefaultCurveEnable, List<PointF> darkModeBrightnessLinePoints, List<PointF> darkModeBrightnessDefaultLinePoints) {
        HwNormalizedSpline hwNormalizedSpline = this.mHwNormalizedSpline;
        if (hwNormalizedSpline == null) {
            Slog.w(TAG, "initDarkModeBrightnessPara fail, mHwNormalizedSpline=null");
        } else {
            hwNormalizedSpline.initDarkModeBrightnessPara(isDarkModeCurveEnable, isDarkModeDefaultCurveEnable, darkModeBrightnessLinePoints, darkModeBrightnessDefaultLinePoints);
        }
    }
    ...
    public void updateDarkMode() {
        ...
        if ((currentDarkMode == 32 && this.mCurrentDarkMode != 32) || (this.mCurrentDarkMode == 32 && currentDarkMode != 32)) {
            if (currentDarkMode == 32) {
                updateDarkModeBrightness(true, this.mData.darkModeOffsetMinBrightness, this.mData.darkModeOffsetSavedMinBrightness);
            } else {
                updateDarkModeBrightness(false, 4, 4);
            }
    ...
    private void updateDarkModeBrightness(boolean isDarkModeEnable, int minOffsetBrightness, int minOffsetSavedBrightness) {
        if (HWFLOW) {
            Slog.i(TAG, "DarkBrightMode, isDarkModeEnable=" + isDarkModeEnable + ",minOffsetBrightness=" + minOffsetBrightness + ",minOffsetSavedBrightness=" + minOffsetSavedBrightness);
        }
        HwAmbientLuxFilterAlgo hwAmbientLuxFilterAlgo = this.mHwAmbientLuxFilterAlgo;
        if (hwAmbientLuxFilterAlgo != null) {
        ...
        HwNormalizedSpline hwNormalizedSpline = this.mHwNormalizedSpline;
        if (hwNormalizedSpline != null) {
            hwNormalizedSpline.updateDarkModeBrightness(isDarkModeEnable, minOffsetBrightness, minOffsetSavedBrightness);
        }
    }

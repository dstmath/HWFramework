...
public class HwDualSensorData implements XmlData {
    ...
    static final int FUSED_COLOR_MSG_TIMER = 4;
    ...
    static final int VERSION_CCT_TYPE = 14;
    ...
    private void setDefaultControlParams() {
        ...
        this.backLuxDeviationThresh = 10000;
    ...
    private void printControlParam() {
        Slog.i(TAG, "frontRateMillis=" + this.frontRateMillis + " backRateMillis=" + this.backRateMillis + " fusedRateMillis=" + this.fusedRateMillis + " fusedColorRateMillis=" + this.fusedColorRateMillis);
        StringBuilder sb = new StringBuilder();
        sb.append("frontSensorStabilityThreshold:");
        sb.append(Arrays.toString(this.frontSensorStabilityThreshold));
        Slog.i(TAG, sb.toString());
        StringBuilder sb2 = new StringBuilder();
        sb2.append("backSensorStabilityThreshold:");
        sb2.append(Arrays.toString(this.backSensorStabilityThreshold));
        Slog.i(TAG, sb2.toString());
        ...
        sb3.append("flashlightDetectionMode=");
        sb3.append(this.flashlightDetectionMode);
        sb3.append(" flashlightOffTimeThMs=");
        sb3.append(this.flashlightOffTimeThMs);
        ...
        sb4.append("isFilterOn=");
        sb4.append(this.isFilterOn);

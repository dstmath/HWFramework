...
public class HwDualSensorEventListenerImpl {
    public static final int CCT_SENSOR_DUAL = 3;
    ...
    private static final int DEFAULT_SENSOR_VALUE = 0;
    ...
    private final SensorEventListener mBackSensorEventListener = new SensorEventListener() {
            ...
            if (event != null) {
                ...
                if (length >= 15) {
                    ...
                    if (i2 == 14) {
                            ...
                            if (i4 == 2) {
                                ...
                                if (i5 == 3) {
                                    ...
                                    if (i6 == 4) {
                                        ...
                                        int i7 = HwDualSensorEventListenerImpl.this.mData.sensorVersion;
                                        ...
                                        if (i7 == 12) {
                                            ...
                                            int i8 = HwDualSensorEventListenerImpl.this.mData.sensorVersion;
                        ...
                        int lux = arr[0];
                        int cct = arr[1];
                        i = HwDualSensorEventListenerImpl.this.mBackWarmUpFlg;
                        ...
                        if (i < 2) {
                            ...
                            if (HwDualSensorEventListenerImpl.this.mHandler != null) {
                                ...
                                HwDualSensorData unused14 = HwDualSensorEventListenerImpl.this.mData;
                    ...
                    int cct2 = arr[1];
                    i = HwDualSensorEventListenerImpl.this.mBackWarmUpFlg;
                    HwDualSensorData unused122 = HwDualSensorEventListenerImpl.this.mData;
                    if (i < 2) {
                    }
        ...
        private void printLuxAndCct(int lux, int cct, long sensorClockTimeStamp, long systemClockTimeStamp, SensorEvent event) {
            ...
            HwDualSensorData unused = HwDualSensorEventListenerImpl.this.mData;
            if (i == 14) {
                Slog.d(HwDualSensorEventListenerImpl.TAG, "SensorEventListener.onSensorChanged(): warmUp=" + HwDualSensorEventListenerImpl.this.mBackWarmUpFlg + " lux not provided set to 0 cct=" + cct + " sensorTime=" + sensorClockTimeStamp + " systemTime=" + systemClockTimeStamp + " cRaw=" + event.values[0] + " rRaw=" + event.values[1] + " gRaw=" + event.values[2] + " bRaw=" + event.values[3] + " wRaw=" + event.values[4]);
                return;
            }
            int i2 = HwDualSensorEventListenerImpl.this.mData.sensorVersion;
            HwDualSensorData unused2 = HwDualSensorEventListenerImpl.this.mData;
    ...
    private long mFusedColorEnableTime = 0;
    private SensorDataSender mFusedColorSender;
    private FusedColorSensorData mFusedColorSensorData;
    private final Object mFusedColorSensorLock = new Object();
    private int mFusedColorTimer = -1;
    private int mFusedColorWarmUpFlg = 0;
    ...
    private boolean mIsFusedColorEnable = false;
    ...
    private interface FusedColorSensorDataRefresher {
    ...
    static /* synthetic */ int access$2808(HwDualSensorEventListenerImpl x0) {
        int i = x0.mFusedWarmUpFlg;
        x0.mFusedWarmUpFlg = i + 1;
        return i;
    }

    static /* synthetic */ int access$3308(HwDualSensorEventListenerImpl x0) {
        int i = x0.mFusedColorWarmUpFlg;
        x0.mFusedColorWarmUpFlg = i + 1;
        return i;
    }
    ...
    private HwDualSensorEventListenerImpl(Context context, SensorManager sensorManager) {
        ...
        this.mFusedColorSensorData = new FusedColorSensorData();
        ...
        this.mFusedColorSender = new FusedColorSensorDataSender();
    ...
    private class FusedColorSensorDataSender implements SensorDataSender {
        private FusedColorSensorDataSender() {
        }

        @Override // com.android.server.display.HwDualSensorEventListenerImpl.SensorDataSender
        public int getRate() {
            return HwDualSensorEventListenerImpl.this.mData.fusedColorRateMillis;
        }

        @Override // com.android.server.display.HwDualSensorEventListenerImpl.SensorDataSender
        public int getTimer() {
            return HwDualSensorEventListenerImpl.this.mFusedColorTimer;
        }

        @Override // com.android.server.display.HwDualSensorEventListenerImpl.SensorDataSender
        public void setTimer(int timer) {
            HwDualSensorEventListenerImpl.this.mFusedColorTimer = timer;
        }

        @Override // com.android.server.display.HwDualSensorEventListenerImpl.SensorDataSender
        public void sendData() {
            synchronized (HwDualSensorEventListenerImpl.this.mFusedColorSensorLock) {
                HwDualSensorEventListenerImpl.this.mFusedColorSensorData.sendFusedColorData();
            }
        }

        @Override // com.android.server.display.HwDualSensorEventListenerImpl.SensorDataSender
        public boolean needQueue() {
            if (HwDualSensorEventListenerImpl.this.mIsFusedColorEnable) {
                int i = HwDualSensorEventListenerImpl.this.mFusedColorWarmUpFlg;
                HwDualSensorData unused = HwDualSensorEventListenerImpl.this.mData;
                if (i >= 2) {
                    return true;
                }
    ...
    public void attachFusedColorSensorData(Observer observer) {
        if (observer == null) {
            Slog.e(TAG, "observer is null!");
            return;
        }
        synchronized (this.mFusedColorSensorLock) {
            attachFrontSensorData(this.mFusedColorSensorData.frontSensorDataObserver);
            attachBackSensorData(this.mFusedColorSensorData.frontColorSensorDataObserver);
            enableFusedColorSensor();
            this.mFusedColorSensorData.addObserver(observer);
        }
    }
    ...
    public void detachFusedColorSensorData(Observer observer) {
        if (observer == null) {
            Slog.e(TAG, "observer is null!");
            return;
        }
        synchronized (this.mFusedColorSensorLock) {
            this.mFusedColorSensorData.deleteObserver(observer);
            if (this.mFusedColorSensorData.countObservers() == 0) {
                disableFusedColorSensor();
                detachFrontSensorData(this.mFusedColorSensorData.frontSensorDataObserver);
                detachBackSensorData(this.mFusedColorSensorData.frontColorSensorDataObserver);
            }
        }
    }
    ...
    private void enableFusedColorSensor() {
        if (!this.mIsFusedColorEnable) {
            Slog.i(TAG, "enable Fused Color Sensor...");
            this.mIsFusedColorEnable = true;
            this.mFusedColorWarmUpFlg = 0;
            this.mFusedColorEnableTime = SystemClock.elapsedRealtimeNanos();
            Handler handler = this.mHandler;
            if (handler != null) {
                HwDualSensorData hwDualSensorData = this.mData;
            ...
            if (DEBUG) {
                Slog.d(TAG, "Fused color sensor enabled.");
            }
            if (this.mData.backSensorBypassCount > 0) {
                this.mData.backSensorBypassCount--;
                Slog.i(TAG, "mData.frontColorSensorBypassCount-- :" + this.mData.backSensorBypassCount);
            }
        }
    }
    ...
    private void disableFusedColorSensor() {
        if (this.mIsFusedColorEnable) {
            this.mIsFusedColorEnable = false;
            Handler handler = this.mHandler;
            if (handler != null) {
                HwDualSensorData hwDualSensorData = this.mData;
                handler.removeMessages(4);
            }
            this.mFusedColorSensorData.clearSensorData();
            if (DEBUG) {
                Slog.d(TAG, "Fused color sensor disabled.");
            }
        }
    }
    ...
    public class FusedSensorData extends Observable {
                ...
                if (this.mRefresher == null) {
                    ...
                    if (i < 2) {
                        if (FusedSensorData.this.mIsFrontUpdated && FusedSensorData.this.mIsBackUpdated) {
                            HwDualSensorEventListenerImpl.access$2808(HwDualSensorEventListenerImpl.this);
                        }
                        if (HwDualSensorEventListenerImpl.this.mHandler != null) {
                            Handler handler = HwDualSensorEventListenerImpl.this.mHandler;
                            HwDualSensorData unused3 = HwDualSensorEventListenerImpl.this.mData;
        ...
        private void handleStability() {
            ...
            if (f == 20.0f) {
                ...
                this.mModifyFactor = HwDualSensorEventListenerImpl.MODIFY_FACTOR_OTHER;
            }
    ...
    /* access modifiers changed from: private */
    public class FusedColorSensorData extends Observable {
        SensorDataObserver frontColorSensorDataObserver;
        SensorDataObserver frontSensorDataObserver;
        private int mCurFrontColorCct;
        private int mCurFrontLux;
        private long mDebugPrintTime;
        private long mFrontColorLastValueSystemTime;
        private long mFrontLastValueSystemTime;
        private int mFusedColorCct;
        private int mFusedColorLux;
        private boolean mIsFrontColorUpdated = false;
        private boolean mIsFrontUpdated = false;
        private long mLastValueFrontColorSensorTime;
        private long mLastValueFrontSensorTime;

        FusedColorSensorData() {
            clearSensorData();
            this.frontSensorDataObserver = new SensorDataObserver(new FusedColorSensorDataRefresher(HwDualSensorEventListenerImpl.this) {
                /* class com.android.server.display.HwDualSensorEventListenerImpl.FusedColorSensorData.AnonymousClass1 */

                @Override // com.android.server.display.HwDualSensorEventListenerImpl.FusedColorSensorDataRefresher
                public void updateData(int lux, int cct, long systemTimeStamp, long sensorTimeStamp) {
                    FusedColorSensorData.this.setFrontData(lux, systemTimeStamp, sensorTimeStamp);
                }
            }, "FrontSensor");
            this.frontColorSensorDataObserver = new SensorDataObserver(new FusedColorSensorDataRefresher(HwDualSensorEventListenerImpl.this) {
                /* class com.android.server.display.HwDualSensorEventListenerImpl.FusedColorSensorData.AnonymousClass2 */

                @Override // com.android.server.display.HwDualSensorEventListenerImpl.FusedColorSensorDataRefresher
                public void updateData(int lux, int cct, long systemTimeStamp, long sensorTimeStamp) {
                    FusedColorSensorData.this.setFrontColorData(cct, systemTimeStamp, sensorTimeStamp);
                }
            }, "FrontColorSensor");
        }
        ...
        public class SensorDataObserver implements Observer {
            private final String mName;
            private final FusedColorSensorDataRefresher mRefresher;

            SensorDataObserver(FusedColorSensorDataRefresher refresher, String name) {
                this.mRefresher = refresher;
                this.mName = name;
            }
            ...
            public void update(Observable observable, Object arg) {
                if (this.mRefresher == null) {
                    ...
                    long systemTimeStamp = data[2];
                    long sensorTimeStamp = data[3];
                    FusedColorSensorData.this.mDebugPrintTime = SystemClock.elapsedRealtimeNanos();
                    if (HwDualSensorEventListenerImpl.DEBUG && FusedColorSensorData.this.mDebugPrintTime - HwDualSensorEventListenerImpl.this.mFusedColorEnableTime < 1000000000) {
                        Slog.d(HwDualSensorEventListenerImpl.TAG, "FusedColorSensorData.update(): " + this.mName + " warmUp=" + HwDualSensorEventListenerImpl.this.mFusedWarmUpFlg + " lux=" + lux + " cct=" + cct + " systemTime=" + systemTimeStamp + " sensorTime=" + sensorTimeStamp);
                    }
                    this.mRefresher.updateData(lux, cct, systemTimeStamp, sensorTimeStamp);
                    int i = HwDualSensorEventListenerImpl.this.mFusedColorWarmUpFlg;
                    HwDualSensorData unused2 = HwDualSensorEventListenerImpl.this.mData;
                    if (i < 2) {
                        if (FusedColorSensorData.this.mIsFrontUpdated && FusedColorSensorData.this.mIsFrontColorUpdated) {
                            HwDualSensorEventListenerImpl.access$3308(HwDualSensorEventListenerImpl.this);
                        }
                        if (HwDualSensorEventListenerImpl.this.mHandler != null) {
                            Handler handler = HwDualSensorEventListenerImpl.this.mHandler;
                            HwDualSensorData unused3 = HwDualSensorEventListenerImpl.this.mData;
        ...
        /* access modifiers changed from: package-private */
        public void setFrontData(int lux, long systemTimeStamp, long sensorTimeStamp) {
            this.mCurFrontLux = lux;
            this.mFrontLastValueSystemTime = systemTimeStamp;
            this.mLastValueFrontSensorTime = sensorTimeStamp;
            this.mIsFrontUpdated = true;
            if (HwDualSensorEventListenerImpl.DEBUG && this.mDebugPrintTime - HwDualSensorEventListenerImpl.this.mFusedEnableTime < 1000000000) {
                Slog.d(HwDualSensorEventListenerImpl.TAG, "FusedSensorData.setFrontData(): lux=" + lux + " systemTime=" + this.mFrontLastValueSystemTime + " sensorTime=" + this.mLastValueFrontSensorTime);
            }
        }

        /* access modifiers changed from: package-private */
        public void setFrontColorData(int cct, long systemTimeStamp, long sensorTimeStamp) {
            this.mCurFrontColorCct = cct;
            this.mFrontColorLastValueSystemTime = systemTimeStamp;
            this.mLastValueFrontColorSensorTime = sensorTimeStamp;
            this.mIsFrontColorUpdated = true;
            if (HwDualSensorEventListenerImpl.DEBUG && this.mDebugPrintTime - HwDualSensorEventListenerImpl.this.mFusedColorEnableTime < 1000000000) {
                Slog.d(HwDualSensorEventListenerImpl.TAG, "FusedColorSensorData.setFrontColorData(): cct=" + cct + " systemTime=" + this.mFrontColorLastValueSystemTime + " sensorTime=" + this.mLastValueFrontColorSensorTime);
            }
        }

        private void updateFusedColorData() {
            this.mFusedColorLux = this.mCurFrontLux;
            this.mFusedColorCct = this.mCurFrontColorCct;
            if (HwDualSensorEventListenerImpl.DEBUG && this.mDebugPrintTime - HwDualSensorEventListenerImpl.this.mFusedEnableTime < 1000000000) {
                Slog.d(HwDualSensorEventListenerImpl.TAG, "FusedSensorData.updateFusedData(): mFusedColorLux=" + this.mFusedColorLux + " mCurFrontLux=" + this.mCurFrontLux + " mFusedColorCct=" + this.mFusedColorCct + " mCurFrontColorCct=" + this.mCurFrontColorCct);
            }
        }

        /* access modifiers changed from: package-private */
        public void sendFusedColorData() {
            if (this.mIsFrontUpdated) {
                if (HwDualSensorEventListenerImpl.this.mData.backSensorBypassCount <= 0 && !this.mIsFrontColorUpdated) {
                    HwDualSensorEventListenerImpl.this.mData.backTimeOutCount++;
                    if (HwDualSensorEventListenerImpl.this.mData.backTimeOutCount >= HwDualSensorEventListenerImpl.this.mData.backSensorTimeOutTh) {
                        HwDualSensorEventListenerImpl.this.mData.backSensorBypassCount = HwDualSensorEventListenerImpl.this.mData.backSensorBypassCountMax;
                        Slog.i(HwDualSensorEventListenerImpl.TAG, "mData.frontColorTimeOutCount start: " + HwDualSensorEventListenerImpl.this.mData.backTimeOutCount);
                    } else if (HwDualSensorEventListenerImpl.DEBUG && this.mDebugPrintTime - HwDualSensorEventListenerImpl.this.mFusedColorEnableTime < 1000000000) {
                        Slog.d(HwDualSensorEventListenerImpl.TAG, "Skip this sendFusedColorData! mIsFrontUpdated=" + this.mIsFrontUpdated + " mIsFrontColorUpdated=" + this.mIsFrontColorUpdated);
                        return;
                    } else {
                        return;
                    }
                ...
                HwDualSensorEventListenerImpl.this.mData.backTimeOutCount = 0;
                updateFusedColorData();
                long lastValueSensorTime = this.mLastValueFrontSensorTime;
                long j = this.mLastValueFrontColorSensorTime;
                if (lastValueSensorTime <= j) {
                    lastValueSensorTime = j;
                }
                if (this.mFusedColorLux < 0 || this.mFusedColorCct < 0) {
                    Slog.i(HwDualSensorEventListenerImpl.TAG, "FusedColorSensorData.sendFusedColorData(): skip. mFusedColorLux=" + this.mFusedColorLux + " mFusedColorCct=" + this.mFusedColorCct);
                    return;
                }
                if (HwDualSensorEventListenerImpl.DEBUG && this.mDebugPrintTime - HwDualSensorEventListenerImpl.this.mFusedColorEnableTime < 1000000000) {
                    Slog.d(HwDualSensorEventListenerImpl.TAG, "FusedColorSensorData.sendFusedColorData(): lux=" + this.mFusedColorLux + " cct=" + this.mFusedColorCct + " sensorTime=" + lastValueSensorTime + " FrontSensorTime=" + this.mLastValueFrontSensorTime + " FrontColorSensorTime=" + this.mLastValueFrontColorSensorTime);
                }
                long lastValueSystemTime = this.mFrontLastValueSystemTime;
                long j2 = this.mFrontColorLastValueSystemTime;
                if (lastValueSystemTime <= j2) {
                    lastValueSystemTime = j2;
                }
                setChanged();
                notifyObservers(new long[]{(long) this.mFusedColorLux, (long) this.mFusedColorCct, lastValueSystemTime, lastValueSensorTime, 0, 0});
            } else if (HwDualSensorEventListenerImpl.DEBUG) {
                Slog.d(HwDualSensorEventListenerImpl.TAG, "Skip this sendFusedColorData! mIsFrontUpdated=" + this.mIsFrontUpdated + " mIsFrontColorUpdated=" + this.mIsFrontColorUpdated);
            }
        }
        ...
        public final void clearSensorData() {
            this.mCurFrontLux = -1;
            this.mCurFrontColorCct = -1;
            this.mFusedColorLux = -1;
            this.mFusedColorCct = -1;
            this.mLastValueFrontSensorTime = -1;
            this.mLastValueFrontColorSensorTime = -1;
            this.mFrontLastValueSystemTime = -1;
            this.mFrontColorLastValueSystemTime = -1;
            this.mDebugPrintTime = -1;
            this.mIsFrontUpdated = false;
            this.mIsFrontColorUpdated = false;
        }
    }
    ...
    private final class DualSensorHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 0) {
                ...
                processTimer(HwDualSensorEventListenerImpl.this.mFusedColorSender);
                ...
                updateTimer(HwDualSensorEventListenerImpl.this.mFusedColorTimer);
                if (HwDualSensorEventListenerImpl.this.mTimer != -1) {
                    queueMessage();
                }
            } else if (i == 1) {
                ...
                processTimerAsTrigger(HwDualSensorEventListenerImpl.this.mFusedColorSender);
            }
        }
    }

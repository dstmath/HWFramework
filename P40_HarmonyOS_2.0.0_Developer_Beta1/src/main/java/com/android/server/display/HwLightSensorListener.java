    ...
    public void enableSensor() {
        if (!this.mIsEnable) {
            ...
            if (i == -1) {
                ...
                this.mHwDualSensorEventListenerImpl.attachFusedColorSensorData(this.mSensorObserver);
            } else if (HWFLOW) {
    ...
    public void disableSensor() {
        if (this.mIsEnable) {
            ...
            if (i == -1) {
                ...
                this.mHwDualSensorEventListenerImpl.detachFusedColorSensorData(this.mSensorObserver);
            } else if (HWFLOW) {

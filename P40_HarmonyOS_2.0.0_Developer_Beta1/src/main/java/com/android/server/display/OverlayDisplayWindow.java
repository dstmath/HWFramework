...
public final class OverlayDisplayWindow implements DumpUtils.Dump {
    ...
    private void resize(int width, int height, int densityDpi, boolean doLayout) {
        ...
        this.mTitle = this.mContext.getResources().getString(17039987, this.mName, Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight), Integer.valueOf(this.mDensityDpi));
        if (this.mSecure) {
            this.mTitle += this.mContext.getResources().getString(17039986);
        }
        if (doLayout) {
            relayout();
        }
    ...
    private void updateWindowParams() {
        ...
        if (Float.isNaN(scale)) {
            Slog.e(TAG, "mWindowScale=" + this.mWindowScale + ", mLiveScale=" + this.mLiveScale + ", logicalWidth=" + ((float) this.mDefaultDisplayInfo.logicalWidth) + ", logicalHeight=" + ((float) this.mDefaultDisplayInfo.logicalHeight) + ", mWidth=" + this.mWidth + ", mHeight=" + this.mHeight + ", mName=" + this.mName + ", mTitle=" + this.mTitle);
        }
        try {
            ...
            throw new IllegalArgumentException(e.getMessage() + ", mName = " + this.mName + ", mTitle = " + this.mTitle + ", mWindowScale = " + this.mWindowScale + ", mLiveScale = " + this.mLiveScale, e.getCause());
        }
    }

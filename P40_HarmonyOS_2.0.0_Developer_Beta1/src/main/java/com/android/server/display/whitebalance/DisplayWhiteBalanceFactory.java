...
public class DisplayWhiteBalanceFactory {
    ...
    public static DisplayWhiteBalanceController create(Handler handler, SensorManager sensorManager, Resources resources) {
        ...
        DisplayWhiteBalanceController controller = new DisplayWhiteBalanceController(brightnessSensor, brightnessFilter, colorTemperatureSensor, createColorTemperatureFilter(resources), createThrottler(resources), getFloat(resources, 17105058), getFloat(resources, 17105059), getFloatArray(resources, 17236011), getFloatArray(resources, 17236014));
    ...
    public static AmbientSensor.AmbientColorTemperatureSensor createColorTemperatureSensor(Handler handler, SensorManager sensorManager, Resources resources) {
        return new AmbientSensor.AmbientColorTemperatureSensor(handler, sensorManager, resources.getString(17039832), resources.getInteger(17694794));
    }

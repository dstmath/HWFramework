...
public class SubScreenViewEntry extends BroadcastReceiver {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 3:
                    ...
                    SubScreenViewEntry.this.isEnbaleInputScaleMode(true);
                    return;
                case 2:
                ...
                case 4:
                    ...
                    SubScreenViewEntry.this.isEnbaleInputScaleMode(false);
                    return;
                case 5:
    ...
    private void initSubScreenView(int rotation) {
        ...
        if (this.mIsTelephonyCallFront && (this.mIsCallStateRinging || this.mIsCallStateOffHook)) {
            ...
            this.mRelativeLayout = (RelativeLayout) this.mSubScreenView.findViewById(34603522);
            this.mLinearLayout = (LinearLayout) this.mSubScreenView.findViewById(34603519);
            this.mViewContent = (TextView) this.mSubScreenView.findViewById(34603403);
            this.mImageView = (ImageView) this.mSubScreenView.findViewById(34603518);
            ...
            this.mNavigationLayout = (LinearLayout) this.mSubScreenView.findViewById(34603520);
            this.mBackButtonView = (ImageView) this.mSubScreenView.findViewById(34603515);
            this.mHomeButtonView = (ImageView) this.mSubScreenView.findViewById(34603517);
            this.mRecentButtonView = (ImageView) this.mSubScreenView.findViewById(34603521);
    ...
    private void handleAftPolicyChange(int ownerPid, int mode) {
        boolean isEarpieceOnly = false;
        if ((AudioSystem.getDevicesForStream(0) & 3) == 1 && isInVoipCallMode(mode)) {
            isEarpieceOnly = true;
        }
        Log.i(TAG, "ownerPid: " + ownerPid + " mForegroundPid: " + this.mForegroundPid + " mode: " + mode + " isEarpieceOnly: " + isEarpieceOnly + " mIsEarpieceIncall: " + this.mIsEarpieceIncall + ", mIsVideoCall = " + this.mIsVideoCall);
        if (checkHeadSetIsConnected()) {
            this.mUseEarpiecePid = -1;
            this.mIsEarpieceIncall = isEarpieceOnly;
            return;
        }
        if (isEarpieceOnly) {
        ...
        if (this.mIsEarpieceIncall != isEarpieceOnly && !this.mIsVideoCall && isEarpieceOnly && getAppNameByPid(this.mForegroundPid).equals(getAppNameByPid(this.mUseEarpiecePid))) {
            requestShowFlipTipsAndFlip(1);
        }
        this.mIsEarpieceIncall = isEarpieceOnly;
    }
    ...
    private void initSubScreenViewForFsmIntelTurnOff(int rotation) {
        ...
        this.mRelativeLayout = (RelativeLayout) this.mSubScreenView.findViewById(34603522);
        this.mLinearLayout = (LinearLayout) this.mSubScreenView.findViewById(34603519);
        this.mFlipButtonClockZone = (LinearLayout) this.mSubScreenView.findViewById(34603516);
        ...
        this.mViewContent = (TextView) this.mSubScreenView.findViewById(34603403);
        if (this.mIsTelephonyCallFront && (this.mIsCallStateRinging || this.mIsCallStateOffHook)) {
            this.mViewContent.setText(this.mContext.getString(33685598));
        }
        this.mNavigationLayout = (LinearLayout) this.mSubScreenView.findViewById(34603520);
        this.mBackButtonView = (ImageView) this.mSubScreenView.findViewById(34603515);
        this.mHomeButtonView = (ImageView) this.mSubScreenView.findViewById(34603517);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void isEnbaleInputScaleMode(boolean isEnbale) {
        int side = isEnbale ? getSubDisplayInputScaleSide(this.mCurrentRotation) : 0;

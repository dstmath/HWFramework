...
public class GestureNavConst extends DefaultGestureNavConst {
    ...
    public static final float BOTTOM_WINDOW_SINGLE_HAND_RATIO = (SystemPropertiesEx.getInt("ro.config.curved_screen", 0) == 1 ? 1.8f : 1.4f);
    public static final int CHECK_ABNORMAL_POINTER_COUNT = 2;
    public static final int CHECK_AFT_TIMEOUT = 2500;
    public static final boolean CHINA_REGION = "CN".equalsIgnoreCase(SystemPropertiesEx.get("ro.product.locale.region", BuildConfig.FLAVOR));
    ...
    public static final int DEFAULT_VALUE_GESTURE_NAVIGATION_ASSISTANT = (1 ^ (CHINA_REGION ? 1 : 0));

...
import com.huawei.android.view.ISystemGestureExclusionListenerEx;
...
public class GestureNavManager extends DefaultGestureNavManager implements GestureNavPolicy, GestureNavView.IGestureEventProxy {
    ...
    private static final int NAV_BOTTOM_HEIGHT_CHANGE_DELAY = 1000;
    ...
    private ContentObserver mAccessibilityObserver = new ContentObserver(new Handler()) {
        /* class com.android.server.gesture.GestureNavManager.AnonymousClass2 */

        @Override // android.database.ContentObserver
        public void onChange(boolean isChange) {
            if (GestureNavManager.this.mIsGestureNavEnabled) {
                GestureNavManager.this.mHandler.sendEmptyMessageDelayed(2, 1000);
            }
        }
    };
    ...
    public GestureNavManager(Context context) {
        ...
        ContentResolverExt.registerContentObserver(this.mContext.getContentResolver(), Settings.Secure.getUriFor("enabled_accessibility_services"), true, this.mAccessibilityObserver, -2);
    }
    ...
    private void registerHorizontalSwitchObserver(ContentResolver resolver) {
        ContentResolverExt.registerContentObserver(resolver, Settings.Secure.getUriFor(GestureNavConst.KEY_SECURE_GESTURE_HORIZONTAL_SWITCH), false, new ContentObserver(new Handler()) {
            ...
            public void onChange(boolean isSelfChange) {
                ...
                GestureNavManager.this.mHandler.sendEmptyMessage(GestureNavManager.MSG_UPDATE_NAV_HORIZONTAL_SWITCH_STATE);
            }
        }, -1);
    }
    ...
    public final class NightModeObserver extends ContentObserver {
        ...
        public void onChange(boolean isSelfChange, Uri uri) {
            if (GestureNavManager.this.mIsNavStarted) {
                ...
                GestureNavManager.this.mHandler.sendEmptyMessage(GestureNavManager.MSG_NIGHT_MODE_CHANGED);
            }
        }
    }
    ...
    public final class FoldDisplayListener implements HwFoldScreenManagerEx.FoldDisplayModeListener {
        ...
        public void onScreenDisplayModeChange(int displayMode) {
            if (GestureNavManager.this.mIsNavStarted) {
                ...
                GestureNavManager.this.mHandler.sendMessage(GestureNavManager.this.mHandler.obtainMessage(GestureNavManager.MSG_FOLD_DISPLAY_MODE_CHANGED, displayMode, 0));
            }
        }
    }

    /* access modifiers changed from: private */
    public final class GestureExclusionListener extends ISystemGestureExclusionListenerEx {
        ...
        public void onSystemGestureExclusionChanged(int displayId, Region systemGestureExclusion) {
            if (GestureNavManager.this.mIsNavStarted && displayId == 0) {
                ...
                GestureNavManager.this.mHandler.sendMessage(GestureNavManager.this.mHandler.obtainMessage(GestureNavManager.MSG_GESTURE_EXCLUSION_REGION_CHANGED, new Region(systemGestureExclusion)));
            }
        }
    }
    ...
    private final class GestureHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            int i = msg.what;
            if (i != GestureNavManager.MSG_UPDATE_NAV_HORIZONTAL_SWITCH_STATE) {
                switch (i) {
                    case 1:
    ...
    private void handleOtherMessage(Message msg) {
        switch (msg.what) {
            ...
            case 13:
                ...
                return;
            case MSG_NIGHT_MODE_CHANGED /* 14 */:
                handleNightModeChanged();
                return;
            case 15:
                handleSubScreenCreateNavView();
                return;
            case MSG_SUB_SCREEN_REMOVE_NAV /* 16 */:
                handleSubScreenDestoryNavView();
                return;
            case MSG_SUB_SCREEN_BRING_TOP_NAV /* 17 */:
                handleSubScreenBringTopNavView();
                return;
            case MSG_MULTI_WINDOW_CHANGED /* 18 */:
                handleMultiWindowChanged(msg.arg1);
                return;
            case MSG_FOLD_DISPLAY_MODE_CHANGED /* 19 */:
                handleFoldDisplayModeChanged();
                return;
            case 20:
                handleUserChanged();
                return;
            case MSG_UPDATE_NAV_HORIZONTAL_SWITCH_STATE /* 21 */:
            default:
                return;
            case MSG_UPDATE_NAV_REGION /* 22 */:
                boolean z = true;
                if (msg.arg1 != 1) {
                    z = false;
                }
                ...
                return;
            case MSG_GESTURE_EXCLUSION_REGION_CHANGED /* 23 */:
    ...
    private void registerLocalMonitor() {
        ...
        if (this.mGestureExclusionListener == null) {
            ...
            try {
                WindowManagerGlobalEx.registerSystemGestureExclusionListener(this.mGestureExclusionListener, 0);
    ...
    private void unregisterLocalMonitor() {
        ...
        GestureExclusionListener gestureExclusionListener = this.mGestureExclusionListener;
        if (gestureExclusionListener != null) {
            try {
                WindowManagerGlobalEx.unregisterSystemGestureExclusionListener(gestureExclusionListener, 0);
            } catch (RemoteException e) {
    ...
    public void onMultiWindowChanged(int state) {
        if (this.mIsNavStarted) {
            ...
            this.mHandler.sendMessage(this.mHandler.obtainMessage(MSG_MULTI_WINDOW_CHANGED, state, 0));
        }
    }
    ...
    public void updateGestureNavRegion(boolean shrink, int navId) {
        if (this.mIsNavStarted) {
            this.mHandler.sendMessage(this.mHandler.obtainMessage(MSG_UPDATE_NAV_REGION, shrink ? 1 : 0, navId));
        }
    }
    ...
    private void updateConfigLocked() {
        ...
        if (this.mHasGestureNavReady) {
            ...
            if (GestureNavConst.isInScreenReaderMode(this.mContext, -2)) {
                bottomWindowHeight = GestureNavConst.getBottomWindowHeight(this.mContext);
            } else {
                bottomWindowHeight = GestureNavConst.getBottomQuickOutHeight(this.mContext);
            }
    ...
    /* JADX WARN: Type inference failed for: r1v1, types: [com.android.server.gesture.GestureNavView, android.view.View] */
    /* JADX WARN: Type inference failed for: r1v2, types: [com.android.server.gesture.GestureNavView, android.view.View] */
    /* JADX WARN: Type inference failed for: r1v3, types: [com.android.server.gesture.GestureNavView, android.view.View] */
    ...
    private WindowManager.LayoutParams createLayoutParams(String title, GestureNavView.WindowConfig config) {
        ...
        paramsEx.addHwFlags((int) HwPackageManagerServiceEx.SCAN_AS_SYSTEM);
        paramsEx.addHwFlags(2097152);
        if (!isShowDockEnabled() || !this.mIsKeyNavEnabled) {
            paramsEx.clearHwFlags(262144);
        } else {
            paramsEx.addHwFlags(262144);
        }
        return lp;
    }

    /* JADX DEBUG: Multi-variable search result rejected for r12v0, resolved type: com.android.server.gesture.GestureNavView */
    ...
    public void dump(String dumpPrefix, PrintWriter pw, String[] args) {
        if (GestureNavConst.DEBUG_DUMP && this.mIsGestureNavEnabled) {
            ...
            DumpUtilsEx.dumpAsync(this.mHandler, new DumpUtilsEx.DumpEx() {
                /* class com.android.server.gesture.GestureNavManager.AnonymousClass7 */
    ...
    public void destroySubScreenNavView() {
        ...
        if (this.mIsNavStarted) {
            this.mHandler.sendEmptyMessage(MSG_SUB_SCREEN_REMOVE_NAV);
        }
    }
    ...
    public void bringTopSubScreenNavView() {
        if (this.mIsSubScreenEnableGestureNav && this.mIsNavStarted) {
            this.mHandler.sendEmptyMessage(MSG_SUB_SCREEN_BRING_TOP_NAV);
        }
    }

...
public class GestureNavSubScreenManager implements GestureNavView.IGestureEventProxy {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: com.android.server.gesture.GestureNavView */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: android.view.WindowManager */
    /* JADX DEBUG: Multi-variable search result rejected for r0v5, resolved type: android.view.WindowManager */
    /* JADX DEBUG: Multi-variable search result rejected for r2v2, resolved type: android.view.WindowManager */
    /* JADX DEBUG: Multi-variable search result rejected for r0v7, resolved type: android.view.WindowManager */
    /* JADX DEBUG: Multi-variable search result rejected for r2v4, resolved type: android.view.WindowManager */
    /* JADX DEBUG: Multi-variable search result rejected for r0v9, resolved type: android.view.WindowManager */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v1, types: [com.android.server.gesture.GestureNavView, android.view.View] */
    /* JADX WARN: Type inference failed for: r0v2, types: [com.android.server.gesture.GestureNavView, android.view.View] */
    /* JADX WARN: Type inference failed for: r0v3, types: [com.android.server.gesture.GestureNavView, android.view.View] */
    /* JADX WARN: Type inference failed for: r1v2, types: [com.android.server.gesture.GestureNavView, android.view.View] */
    /* JADX WARN: Type inference failed for: r2v3, types: [com.android.server.gesture.GestureNavView, android.view.View] */
    /* JADX WARN: Type inference failed for: r2v5, types: [com.android.server.gesture.GestureNavView, android.view.View] */
    /* JADX WARNING: Unknown variable types count: 6 */
    public void bringSubScreenNavViewToTop() {
        Log.d(TAG, "bringNavExtViewToTop ");
        ?? r0 = this.mSubScreenGestureNavLeft;
        if (r0 != 0) {
            this.mWindowManager.removeView(r0);
            this.mSubScreenGestureNavLeft.setZOrderOnTop(true);
            WindowManager windowManager = this.mWindowManager;
            ?? r2 = this.mSubScreenGestureNavLeft;
            windowManager.addView(r2, r2.getLayoutParams());
        }
        ?? r02 = this.mSubScreenGestureNavRight;
        if (r02 != 0) {
            this.mWindowManager.removeView(r02);
            this.mSubScreenGestureNavRight.setZOrderOnTop(true);
            WindowManager windowManager2 = this.mWindowManager;
            ?? r22 = this.mSubScreenGestureNavRight;
            windowManager2.addView(r22, r22.getLayoutParams());
        }
        ?? r03 = this.mSubScreenGestureNavBottom;
        if (r03 != 0) {
            this.mWindowManager.removeView(r03);
            this.mSubScreenGestureNavBottom.setZOrderOnTop(true);
            WindowManager windowManager3 = this.mWindowManager;
            ?? r1 = this.mSubScreenGestureNavBottom;
            windowManager3.addView(r1, r1.getLayoutParams());
        }
    }
}

...
public class HwGestureSideLayout extends RelativeLayout {
    ...
    public static final boolean IS_CHINA_REGION = "CN".equalsIgnoreCase(SystemPropertiesEx.get("ro.product.locale.region", BuildConfig.FLAVOR));
    ...
    private void configLeftIconLayoutParams(float density) {
        ...
        leftIconLayoutParams.leftMargin = ((int) density) * ICON_SIDE_MARGIN_DP;
    ...
    private void configRightIconLayoutParams(float density) {
        ...
        rightIconLayoutParams.rightMargin = ((int) density) * ICON_SIDE_MARGIN_DP;
    ...
    private void configInnerMaskLayoutParams(float density) {
        ...
        innerMaskLayoutParams.rightMargin = ((int) density) * ICON_SIDE_MARGIN_DP;
    ...
    private void configLeftInnerMaskLayoutParams(float density) {
        ...
        leftInnerMaskLayoutParams.leftMargin = ((int) density) * ICON_SIDE_MARGIN_DP;

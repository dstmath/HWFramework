...
public class CollectUserFingersHandler {
    ...
    public void updateUserAction(String action, String apkName) {
        try {
            ...
            if (!this.isUserOperated) {
                ...
                this.mMachineHandler.sendEmptyMessage(WMStateCons.MSG_USER_DATA_ACTION);
                    ...
                    try {
                        ...
                        if (spaceIdOfAllAp == 0) {
                            ...
                            if (calResult2 == null) {
                                ...
                                this.mMachineHandler.sendEmptyMessage(WMStateCons.MSG_USER_NEED_FURTHER_SPACE);
                                return output;
                            }
                        }
                        n++;
    ...
    private void checkDefaultConnectivityState() {
        ...
        if (defaultType == 8 || !this.mDestNetworkId.equals("UNKNOWN")) {
            ...
            this.mDestNetworkId = connectivity.getString(KEY_DEFAULT_NETWORK_ID, "UNKNOWN");
            this.mDestNetworkName = connectivity.getString(KEY_DEFAULT_NETWORK_NAME, "UNKNOWN");
            this.mDestNetworkFreq = connectivity.getString(KEY_DEFAULT_NETWORK_FREQUENCY, "UNKNOWN");

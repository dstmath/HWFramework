...
public class InputMethodManagerService extends AbsInputMethodManagerService implements IHwInputMethodManagerInner, ServiceConnection, Handler.Callback {
    ...
    public class HardKeyboardListener implements WindowManagerInternal.OnHardKeyboardStatusChangeListener {
        ...
        public void handleHardKeyboardStatusChange(boolean available) {
            ...
            synchronized (InputMethodManagerService.this.mMethodMap) {
                if (!(InputMethodManagerService.this.mSwitchingDialog == null || InputMethodManagerService.this.mSwitchingDialogTitleView == null || !InputMethodManagerService.this.mSwitchingDialog.isShowing() || (switchSectionView = InputMethodManagerService.this.mSwitchingDialogTitleView.findViewById(16909010)) == null)) {
    ...
    public InputMethodManagerService(Context context) {
        ...
        this.mImeSwitcherNotification = new Notification.Builder(this.mContext, SystemNotificationChannels.VIRTUAL_KEYBOARD).setSmallIcon(17302751).setWhen(0).setOngoing(true).addExtras(extras).setCategory("sys").setColor(this.mContext.getColor(17170460));
    ...
    @GuardedBy({"mMethodMap"})
    private boolean bindCurrentInputMethodServiceLocked(Intent service, ServiceConnection conn, int flags, boolean isTextEditor) {
        if (service == null || conn == null) {
            Slog.e(TAG, "--- bind failed: service = " + service + ", conn = " + conn);
            return false;
        } else if (!this.mHwIMMSEx.isTvMode() || isTextEditor) {
            return this.mContext.bindServiceAsUser(service, conn, flags, new UserHandle(this.mSettings.getCurrentUserId()));
        } else {
            Slog.e(TAG, "Don't do bind input method if not TextEditer on TV.");
            return false;
        }
    }
    ...
    public InputBindResult startInputUncheckedLocked(ClientState cs, IInputContext inputContext, int missingMethods, EditorInfo attribute, int startInputFlags, int startInputReason) {
        ...
        if (!InputMethodUtils.checkIfPackageBelongsToUid(this.mAppOpsManager, cs.uid, attribute.packageName)) {
            ...
            if (info != null) {
                ...
                this.mCurIntent.putExtra("android.intent.extra.client_label", 17040300);
                ...
                if (bindCurrentInputMethodServiceLocked(intent, this, IME_CONNECTION_BIND_FLAGS, z)) {
    ...
    private void updateSystemUiLocked(int vis, int backDisposition) {
        if (this.mCurToken != null) {
            ...
            if (imi != null && needsToShowImeSwitcher) {
                CharSequence title = this.mRes.getText(17041186);
    ...
    public void updateKeyboardFromSettingsLocked() {
        ...
        if (alertDialog != null && this.mSwitchingDialogTitleView != null && alertDialog.isShowing() && (hardKeySwitch = (Switch) this.mSwitchingDialogTitleView.findViewById(16909011)) != null) {
    ...
    public boolean showCurrentInputLocked(int flags, ResultReceiver resultReceiver) {
        ...
        if (this.mWindowManagerInternal.isPcFreeFormWinClient(this.mCurFocusedWindow)) {
            ...
            if (this.mHaveConnection && !this.mVisibleBound) {
                bindCurrentInputMethodServiceLocked(this.mCurIntent, this.mVisibleConnection, IME_VISIBLE_BIND_FLAGS, true);
            ...
            this.mContext.unbindService(this);
            bindCurrentInputMethodServiceLocked(this.mCurIntent, this, IME_CONNECTION_BIND_FLAGS, true);
            return false;
        }
    }
    ...
    public static class ImeSubtypeListAdapter extends ArrayAdapter<InputMethodSubtypeSwitchingController.ImeSubtypeListItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            RadioButton radioButton = (RadioButton) view.findViewById(16909310);
    ...
    public class HwInnerInputMethodManagerService extends IHwInputMethodManager.Stub {
        ...
        public void onReceivedInputContent(String content) {
            if (isCallingFromSystem() || checkCallingPermission(InputMethodManagerService.MULTI_DISPLAY_INPUT_METHOD_PERMISSION, "onReceivedInputContent")) {
                if (InputMethodManagerService.this.mPowerManager != null && HwPCUtils.isShopDemo()) {
                    InputMethodManagerService.this.mPowerManager.userActivity(SystemClock.uptimeMillis(), false);
                }
        ...
        public void raiseIawarePriority() {
            InputMethodManagerService.this.mHwIMMSEx.raiseIawarePriority();
        }

        public void recoveryIawarePriority() {
            InputMethodManagerService.this.mHwIMMSEx.recoveryIawarePriority();
        }

...
public class NetworkSlicesHandler extends Handler {
        ...
        if (i == 1) {
            ...
            switch (i) {
                ...
                case 1002:
                    ...
                    return;
                case ON_NETWORK_UNAVAILABLE /* 1003 */:
    ...
    public void registerForAppStateObserver() {
        ...
        HwAppStateObserver.getInstance().registerForAppRemoved(this, APP_REMOVED, null);
        HwAppStateObserver.getInstance().registerForAppGone(this, APP_GONE, null);
    }

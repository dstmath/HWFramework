...
public class HwGpsLogServices implements IHwGpsLogServices {
    ...
    private static final int SEND_TO_DFT_WITH_BUNDLE = 2;
    private static final int SEND_TO_DFT_WITH_LIST = 1;
    ...
    private int sendToDft(int event, List<String> list) {
        ...
        int ret = 1;
        if (msg == null) {
            LBSLog.w(TAG, false, "msg is null before sendToDft with list", new Object[0]);
            return 1;
        }
        msg.what = 1;
        msg.obj = list;
        msg.arg1 = event;
        if (this.mHwGpsLogHandler.sendMessage(msg)) {
            ret = 0;
        }
        if (ret != 0) {
            LBSLog.w(TAG, false, "sendToDft with list failed", new Object[0]);
        }
        return ret;
    }
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 0) {
                ...
                if (i == 2) {
                    ...
                    if (bundle2 != null) {
                        if (HwGpsLogServices.this.hwNcDftConnManager == null) {
                            LBSLog.w(HwGpsLogServices.TAG, false, "hwNcDfnnManager is null", new Object[0]);
                        } else {
                            HwGpsLogServices.this.hwNcDftConnManager.reportToDft(0, msg.arg1, bundle2);
                        }
                    }
                }
                ...
                if (HwGpsLogServices.this.hwNcDftConnManager == null) {
                    ...
                    HwGpsLogServices.this.hwNcDftConnManager.reportToDft(0, msg.arg1, (List) msg.obj);
                }
            }
        }
    }
    ...
    private int sendToDft(int event, Bundle data) {
        ...
        int ret = 1;
        if (msg == null) {
            LBSLog.w(TAG, false, "msg is null before sendToDft with bundle", new Object[0]);
            return 1;
        }
        msg.what = 2;
        msg.obj = data;

...
public class FingerprintActionsListener extends DefaultFingerprintActionsListener {
    ...
    private static volatile FingerprintActionsListener sListener = null;
    ...
    private FingerprintActionsListener(Context context, PhoneWindowManagerEx policy) {
    ...
    private void initView() {
        ...
        if (searchPanelView != null && searchPanelView.isAttachedToWindow()) {
    ...
    public static synchronized FingerprintActionsListener getInstance(Context context, PhoneWindowManagerEx policy) {
        FingerprintActionsListener fingerprintActionsListener;
        synchronized (FingerprintActionsListener.class) {
            if (sListener == null) {
                sListener = new FingerprintActionsListener(context, policy);
            }
            fingerprintActionsListener = sListener;
        }
        return fingerprintActionsListener;
    }
}

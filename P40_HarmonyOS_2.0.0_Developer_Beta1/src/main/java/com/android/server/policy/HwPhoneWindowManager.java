...
import com.huawei.aod.HwAodManagerService;
...
public class HwPhoneWindowManager extends PhoneWindowManager implements AccessibilityManager.TouchExplorationStateChangeListener {
    ...
    private static final long DISABLE_VOLUME_DOWN_DOUBLE_CLICK_INTERVAl_MAX = 15000;
    private static final long DISABLE_VOLUME_DOWN_DOUBLE_CLICK_INTERVAl_MIN = 1500;
    private static final int DISPATCH_EVER = -1;
    private static final int DISPATCH_IMMEDIATELY = 0;
    ...
    private static final int DOUBLE_CLICK_INTERVAL_TIME = 200;
    ...
    private static final int INVALID_DEVICEID = -1;
    private static final int INVALID_GAME_MODE = -1;
    private static final int INVALID_HARDWARE_TYPE = -1;
    private static final int INVALID_PROCESS_ID = -1;
    private static final int INVALID_REASON = -1;
    private static final int INVALID_RESULT = -1;
    private static final int INVALID_STYLE_VALUE = -1;
    ...
    private static final boolean IS_SIDE_WITHOUT_SOLID = (HwExtDisplaySizeUtil.getInstance().getSideTouchMode() == 1);
    private static final boolean IS_SUPPORT_AOD = ("1".equals(SystemProperties.get("ro.config.support_aod", null)) || "2".equals(SystemProperties.get("ro.config.support_aod", null)));
    ...
    private static final List KEYCODE_NOT_FOR_CLOUD_LIST = Arrays.asList(4, 3, 25, 24, 220, 221);
    ...
    private static final String PACKAGE_NAME_LAUNCHER = "com.huawei.android.launcher";
    ...
    private static final String SYS_SUPER_POWER_SAVE = "sys.super_power_save";
    static final String TAG = "HwPhoneWindowManager";
    private static final String TAG_AOD_HWPWM = "AOD_HwPWM";
    ...
    private static final String WATCH_DESKCLOCK_PACKAGE_NAME = "com.huawei.ohos.deskclock";
    private static final String WATCH_DESKCLOCK_WINDOW_TITLE = "com.huawei.ohos.deskclock.alarmclock.AlarmClockAlertAbilityShellActivity";
    ...
    private static final String WATCH_INCALLUI_PACKAGE_NAME = "com.huawei.ohos.call";
    private static final String WATCH_INCALLUI_WINDOW_TITLE = "com.huawei.ohos.call.base.InCallAbility";
    ...
    private final Runnable mDelayPressMenuActionForTv = new Runnable() {
        /* class com.android.server.policy.$$Lambda$HwPhoneWindowManager$fKZaCgQwCt2SThzYqtotpsPbi6g */

        @Override // java.lang.Runnable
        public final void run() {
            HwPhoneWindowManager.this.lambda$new$1$HwPhoneWindowManager();
        }
    };
    ...
    private int mInterceptBackKeyRepeatTimes = 0;
    ...
    private boolean mIsDoublePressMenuKeyWaiting;
    ...
    private boolean mIsMenuKeyDownTriggeredForTv = false;
    ...
    private boolean mIsRebootResumeTp = false;
    ...
    private boolean mIsScreenshotMenuKeyTriggered;
    ...
    private KeyEvent mKeyEventLastKeyDown = null;
    ...
    private final Runnable mScreenshotTvRunnable = new Runnable() {
        /* class com.android.server.policy.HwPhoneWindowManager.AnonymousClass2 */

        @Override // java.lang.Runnable
        public void run() {
            HwPhoneWindowManager.this.mContext.sendBroadcastAsUser(new Intent("com.huawei.homevision.action.SCREEN_SHOT"), UserHandle.CURRENT, "com.huawei.homevision.permission.SCREEN_SHOT");
        }
    };
    ...
    private final List<String> mSpecialPackages = Arrays.asList(HwCustPkgNameConstant.HW_PERMISSION_CONTROLLER_PACKAGE);
    private final List<Integer> mSpecialWindowTypeList = Arrays.asList(2003, 2038, 2008, 2011);
    ...
    private WindowManagerPolicyConstants.PointerEventListener mStylusActionPointerEventListener = new WindowManagerPolicyConstants.PointerEventListener() {
        /* class com.android.server.policy.HwPhoneWindowManager.AnonymousClass13 */

        public void onPointerEvent(MotionEvent motionEvent) {
            HwPhoneWindowManager.this.mStylusGestureListener.onPointerEvent(motionEvent);
        }
    };
    private DefaultStylusGestureListener mStylusGestureListener = null;
    ...
    private WindowManagerPolicy.WindowState mWinLastIntercepted = null;
    private WindowManagerPolicy.WindowState mWinLastKeyDown = null;
    ...
    static {
        ...
        sSpecialWindowType.add(2038);
        sSpecialWindowType.add(2026);
    }

    public /* synthetic */ void lambda$new$1$HwPhoneWindowManager() {
        this.mIsDoublePressMenuKeyWaiting = false;
        this.mIsMenuKeyDownTriggeredForTv = false;
        sendHwMenuKeyEvent();
    }

    /* JADX WARN: Type inference failed for: r4v20, types: [com.android.server.policy.DefaultEasyWakeUpManager, android.os.IBinder] */
    /* JADX WARN: Type inference failed for: r0v19, types: [com.huawei.aod.HwAodManagerService, android.os.IBinder] */
    ...
    public void systemReady() {
        ...
        if (IS_SUPPORT_AOD) {
            ServiceManager.addService("aod_service", (IBinder) HwAodManagerService.getInstance(this.mContext));
        }
        ...
        DefaultHwSideTouchPolicy defaultHwSideTouchPolicy = this.mSideTouchPolicy;
        if (defaultHwSideTouchPolicy != null) {
            defaultHwSideTouchPolicy.systemReady();
        }
        Handler proximityHandler = CommonThread.getHandler();
        proximityHandler.post(new Runnable(proximityHandler) {
            /* class com.android.server.policy.$$Lambda$HwPhoneWindowManager$ViX85Amuz182808TVAQDPUO4k */
            ...
            @Override // java.lang.Runnable
            public final void run() {
                HwPhoneWindowManager.this.lambda$systemReady$2$HwPhoneWindowManager(this.f$1);
            }
        });
    ...
    public /* synthetic */ void lambda$systemReady$2$HwPhoneWindowManager(Handler proximityHandler) {
        WindowManagerPolicyEx.WindowManagerFuncsEx funcsEx = new WindowManagerPolicyEx.WindowManagerFuncsEx();
        funcsEx.setWindowManagerFuncs(this.mWindowManagerFuncs);
    ...
    private boolean getPowerFpType() {
        String[] fpTypeArrays = SystemProperties.get("ro.config.hw_fp_type").split(",");
        if (fpTypeArrays.length != 4) {
            return false;
        }
        int type = -1;
        try {
            type = Integer.parseInt(fpTypeArrays[0]);
    ...
    private int getDisplayRotation() {
        return getDefaultDisplayPolicy().getDisplayRotation();
    }
    ...
    private void initNoPasswordDetectionScheme() {
        ...
        String lockActivity = "";
        try {
            lockActivity = this.mContext.getResources().getString(17039857);
        ...
        this.mKeyguardDelegate.setHwPCKeyguardShowingCallback(new KeyguardStateMonitor.HwPCKeyguardShowingCallback() {
            ...
            public void onShowingChanged(boolean isShowing) {
                if (HwPCUtils.isPcCastModeInServer() || HwPCUtils.isInWindowsCastMode()) {
                    HwPhoneWindowManager.this.lockScreen(isShowing);
                }
                ...
                if (HwPhoneWindowManager.this.mAccessbilityWaterMark != null) {
                    HwPhoneWindowManager.this.mAccessbilityWaterMark.isKeyGuardShowing(isShowing);
                }
                Slog.i(HwPhoneWindowManager.TAG, "onShowingChangedL: " + isShowing);
                if (HwPhoneWindowManager.this.mSubScreenViewEntry != null) {
                    HwPhoneWindowManager.this.mSubScreenViewEntry.handleLockScreenShowChanged(isShowing);
                }
            }
        });
    ...
    private void updateConfigBehaviors() {
        this.mIsScreenRecorderChordEnabled = this.mContext.getResources().getBoolean(17891449);
    }
    ...
    private void updateNotchSwitchStatus(boolean isForceUpdate) {
        boolean isOpen = this.mIsNotchSwitchOpen;
        boolean z = true;
        ...
        if (this.mIsNotchSwitchOpen != isOpen || isForceUpdate) {
    ...
    public int getWindowLayerFromTypeLw(int type, boolean isCanAddInternalSystemWindow) {
        if (type == 2100) {
            return 33;
        }
        if (type == TOAST_TYPE_COVER_SCREEN) {
        ...
        int ret = HwPhoneWindowManager.super.getWindowLayerFromTypeLw(type, isCanAddInternalSystemWindow);
    ...
    public void startedGoingToSleepSync(int why) {
        if (HwPCUtils.isInWindowsCastMode() && needTurnOff(why)) {
    ...
    private void interceptScreenRecorder() {
        ...
        } else if (this.mIsScreenRecorderChordEnabled && this.mIsScreenRecorderVolumeUpKeyTriggered && this.mIsScreenRecorderPowerKeyTriggered && !this.mIsScreenRecorderVolumeDownKeyTriggered && !SystemProperties.getBoolean(SYS_SUPER_POWER_SAVE, false) && !keyguardIsShowingTq() && checkPackageInstalled(HUAWEI_SCREENRECORDER_PACKAGE)) {
    ...
    private void sendKeyEvent(int keycode, int scanCode) {
        int[] actions;
        for (int i : new int[]{0, 1}) {
            long curTime = SystemClock.uptimeMillis();
            InputManager.getInstance().injectInputEvent(new KeyEvent(curTime, curTime, i, keycode, 0, 0, -1, scanCode, 8, LightsManagerEx.LIGHT_ID_SMARTBACKLIGHT), 0);
        }
    }
    ...
    private boolean isExcluedScene() {
        ...
        boolean isSuperPowerMode = SystemProperties.getBoolean(SYS_SUPER_POWER_SAVE, false);
        if (pkgName == null) {
            return false;
        }
    ...
    private void resetButtonLightStatus() {
        ...
        if (this.mTrikeyNaviMode < 0) {
            ...
            msg.setAsynchronous(true);
            this.mHandlerEx.sendMessageDelayed(msg, HwSwingMotionGestureConstant.HOVER_SCREEN_OFF_THRESHOLD);
        } else {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setButtonLightTimeout(boolean isTimeout) {
        SystemProperties.set("sys.button.light.timeout", String.valueOf(isTimeout));
    }
    ...
    private boolean isIncallui(WindowManagerPolicy.WindowState focusedWindow) {
        ...
        String title = focusedWindow.getAttrs().getTitle().toString();
        if (title.contains(HUAWEI_ANDROID_INCALL_UI) || title.contains(WATCH_INCALLUI_PACKAGE_NAME)) {
            return true;
        }
        return false;
    }
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags) {
        ...
        boolean isDown2 = event.getAction() == 0;
        int keyCode2 = event.getKeyCode();
        int deviceID2 = event.getDeviceId();
        boolean isScreenOn2 = (policyFlags & 536870912) != 0;
        interceptDiagnosisDetector(keyCode2, isDown2);
        if (isTvMode() && isInterceptKeyBeforeQueueingTv(event, isScreenOn2)) {
            return 0;
        }
        int flags = event.getFlags();
        if (IS_TV && ((keyCode2 == 24 || keyCode2 == 25 || keyCode2 == 4 || keyCode2 == 164 || keyCode2 == 26 || keyCode2 == 3 || ((keyCode2 == 82 && (268435456 & flags) == 0) || keyCode2 == 182 || keyCode2 == 737 || keyCode2 == 738)) && isDown2 && (audioManager = this.mAudioManager) != null)) {
        ...
        if (hwCustPhoneWindowManager4 != null) {
            hwCustPhoneWindowManager4.processCustInterceptKey(keyCode2, isDown2, this.mContext);
        }
        Flog.i((int) WifiProCommonUtils.RESP_CODE_INVALID_URL, "HwPhoneWindowManager has intercept Key : " + keyCode2 + ", isdown : " + isDown2 + ", flags : " + flags);
        lockOnPadAssistMode(keyCode2);
        boolean isInitialDown = isDown2 && event.getRepeatCount() == 0;
        if (isInitialDown && (hwTvPowerManagerPolicy = this.mTvPolicy) != null) {
            hwTvPowerManagerPolicy.onKeyOperation();
        }
        reportMonitorData(keyCode2, isDown2);
        ...
        if (isInitialDown) {
            if (((keyCode2 == 82 && (268435456 & flags) == 0) || keyCode2 == 3 || keyCode2 == 4) && AppActConstant.VALUE_TRUE.equals(SystemProperties.get(VIBRATE_ON_TOUCH, AppActConstant.VALUE_FALSE)) && (policyFlags & 2) != 0) {
        ...
        int i = 25;
        if ((keyCode2 == 25 || keyCode2 == 24) && this.mDefaultDisplayPolicy.getFocusedWindow() != null && (this.mDefaultDisplayPolicy.getFocusedWindow().getAttrs().hwFlags & 8) == 8 && AppActConstant.VALUE_TRUE.equals(SystemProperties.get("runtime.mmitest.isrunning", AppActConstant.VALUE_FALSE))) {
            Log.i(TAG, "Prevent hard key volume event to mmi test before queueing.");
            return result & -2;
        } else if (lightScreenOnPcMode(keyCode2)) {
            return 0;
        } else {
            if (!isTvMode()) {
                c = 24;
            } else if (keyCode2 == 82 && interceptMenuKeyForTv(event, isScreenOn2)) {
                return result & -2;
            } else {
                if (keyCode2 != 82) {
                    c = 24;
                    if (keyCode2 != 24 && this.mIsMenuKeyDownTriggeredForTv) {
                        this.mIsMenuKeyDownTriggeredForTv = false;
                        this.mHandler.removeCallbacks(this.mDelayPressMenuActionForTv);
                        this.mIsDoublePressMenuKeyWaiting = false;
                        sendHwMenuKeyEvent();
                    }
                } else {
            ...
            if (keyCode2 == 3 || keyCode2 == 4) {
                ...
                if (keyCode2 != 82) {
                            ...
                            if (keyCode2 == 187) {
                                ...
                                if (keyCode2 != 265) {
                                    if (keyCode2 == 702) {
                                        ...
                                        Log.d(TAG, "Camera keycode: " + keyCode2 + " isDwon:" + isDown2 + " isCamera: " + isCameraOpened);
                                        if (!isInitialDown || isCameraOpened) {
                                            keyEvent = event;
                                        } else {
                                        ...
                                        switch (keyCode2) {
                                            ...
                                            case 26:
                                                if (!HwFrameworkFactory.getVRSystemServiceManager().isVRDeviceConnected()) {
                                                    updatePowerKeyPolicy(isDown2, isScreenOn2, event);
                                            ...
                                            default:
                                                switch (keyCode2) {
                                                    case FingerprintSupportEx.MMI_TYPE_GET_LOCATION_CIRCLE_X_INDICATOR /* 401 */:
                                                    case FingerprintSupportEx.MMI_TYPE_GET_LOCATION_CIRCLE_Y_INDICATOR /* 402 */:
                                                    case FingerprintSupportEx.MMI_TYPE_GET_LOCATION_CIRCLE_RADIUS /* 403 */:
                                                    case FingerprintSupportEx.MMI_TYPE_GET_LOCATION_CIRCLE_COLOR /* 404 */:
                                                    case 405:
                                                        processing_KEYCODE_SOUNDTRIGGER_EVENT(keyCode2, this.mContext, isMusicActive() || isFMActive(), isDown2, keyguardIsShowingTq());
                                                        keyEvent = event;
                                                        break;
                                                    default:
                                                        switch (keyCode2) {
                                        ...
                                        DefaultStylusGestureListener defaultStylusGestureListener = this.mStylusGestureListener;
                                        if (defaultStylusGestureListener != null) {
                                            defaultStylusGestureListener.onKeyEvent(keyCode2, isDown2);
                                        }
                                        policyFlags2 = policyFlags & -2;
                                        keyEvent = event;
                                        return HwPhoneWindowManager.super.interceptKeyBeforeQueueing(keyEvent, policyFlags2);
                                    }
                                } else if (handleStem1Event(isDown2, isScreenOn2, event)) {
                                    return result & -2;
                                } else {
                                    keyEvent = event;
                                }
                                ...
                                keyEvent = event;
                            } else if (isDisabledVoiceAssistButton(isDown2)) {
                                return 0;
                            } else {
                                if (isInitialDown || !isDown2) {
                                    Message message = this.mHandlerEx.obtainMessage(110, Boolean.valueOf(isDown2));
                    ...
                    if (defaultHwSideTouchPolicy != null) {
                        str2 = TAG;
                        i = 25;
                        if (defaultHwSideTouchPolicy.interceptVolumeKey(event, isInjected2, isScreenOn2, keyCode2, isDown2)) {
                            return result & -2;
                        }
                    } else {
                        str2 = TAG;
                    ...
                    if (keyCode2 == i) {
                        ...
                        Log.i(str2, "interceptVolumeDownKey isDown=" + isDown2 + " policyFlags=" + Integer.toHexString(policyFlags));
                        if ((isScreenOn2 && !keyguardIsShowingTq()) || isInjected2) {
                            ...
                            if (this.mIsVoiceRecognitionActive) {
                                ...
                                if (interval > DISABLE_VOLUME_DOWN_DOUBLE_CLICK_INTERVAl_MAX) {
                        ...
                        if (!IS_QUICK_RECORD_SUPPORTED || (hwCustPhoneWindowManager = this.mCust) == null) {
                            ...
                            keyEvent = event;
                            if (hwCustPhoneWindowManager.interceptVolumeUpKey(event, this.mContext, isScreenOn2, keyguardIsShowingTq(), isMusicActive() || isVoiceCall() || isFMActive(), isInjected2, isDown2)) {
                                return result;
                            }
                        }
                    } else {
                    ...
                    keyEvent = event;
                    if (!this.mDefaultDisplayPolicy.hasNavigationBar() && isDown2) {
            ...
            if (deviceID > 0 && isFrontFpNavi && isSupportTrikey && !isMmiTest && keyCode == 4) {
                ...
                if (isDown) {
                    ...
                    boolean isHandled = this.mBackTrikeyHandled;
            ...
            if (!this.mDefaultDisplayPolicy.hasNavigationBar() && keyCode == 4 && isDown) {
                if (isScreenInLockTaskMode()) {
    ...
    private boolean isDisabledVoiceAssistButton(boolean isDown) {
    ...
    private boolean isDoubleClickEnabled() {
        ...
        DefaultHwSideTouchPolicy defaultHwSideTouchPolicy = this.mSideTouchPolicy;
        boolean isSideScreenAndTalkbackEnable = defaultHwSideTouchPolicy != null && defaultHwSideTouchPolicy.isTalkbackEnable();
        Log.i(TAG, "isMusicOrFMOrVoiceCallActive=" + isMusicOrFMOrVoiceCallActive + " mIsVoiceRecognitionActive=" + this.mIsVoiceRecognitionActive + " isSideScreenAndTalkbackEnable=" + isSideScreenAndTalkbackEnable + ",sideWithoutSolid:" + IS_SIDE_WITHOUT_SOLID);
        if (isMusicOrFMOrVoiceCallActive || this.mIsVoiceRecognitionActive || SystemProperties.getBoolean(SYS_SUPER_POWER_SAVE, false)) {
            return false;
        }
        if (!isSideScreenAndTalkbackEnable || !IS_SIDE_WITHOUT_SOLID) {
            return true;
        }
        return false;
    }

    private void reportMonitorData(int keyCode, boolean isDown) {
        TurnOnWakeScreenManager turnOnWakeScreenManager;
        HwPartIawareUtil.getContinuePowerDevMng().keyDownEvent(keyCode, isDown);
        if (!isDown && keyCode == 26 && (turnOnWakeScreenManager = TurnOnWakeScreenManager.getInstance(this.mContext)) != null && turnOnWakeScreenManager.isTurnOnSensorSupport()) {
    ...
    private boolean setGSensorEnabled(int keyCode, boolean isDown, int deviceID) {
        boolean z = false;
    ...
    private int interceptHomeKeyEventForTvKidMode(int keycode) {
        if (keycode != 3 || !IS_TV || !this.mIsKidsMode || !isKidsSpecialPage()) {
            return 0;
        }
    ...
    private boolean interceptKeyInPCMultiCastMode(WindowManagerPolicy.WindowState win, KeyEvent event) {
        ...
        Log.i(TAG, "win:" + win.toString() + " key:" + event + " winRect:" + win.getDisplayFrameLw() + " windowingMode:" + win.getWindowingMode() + " mInterceptBackKeyRepeatTimes:" + this.mInterceptBackKeyRepeatTimes);
        int eventAction = event.getAction();
        if (this.mInterceptBackKeyRepeatTimes >= 20) {
            if (eventAction == 1) {
                this.mInterceptBackKeyRepeatTimes = 0;
            }
            return true;
        } else if (eventAction == 0) {
            this.mWinLastKeyDown = win;
            this.mKeyEventLastKeyDown = event;
            return !isWinMatchKeyInPCMultiCastMode(win, event);
        } else if (eventAction != 1) {
            this.mInterceptBackKeyRepeatTimes = 0;
            return false;
        } else if (isWinMatchKeyInPCMultiCastMode(this.mWinLastKeyDown, this.mKeyEventLastKeyDown)) {
            this.mInterceptBackKeyRepeatTimes = 0;
            return false;
        } else {
            findWinForBackKeyInPCMultiCastMode(event);
            interceptBackKeyRepeatTime(win);
            return true;
        }
    }

    private boolean isWinMatchKeyInPCMultiCastMode(WindowManagerPolicy.WindowState win, KeyEvent event) {
        ...
        if (windowingMode == 105) {
            if (eventPositionX < winRect.left || eventPositionX > winRect.right) {
                return false;
            }
            return true;
        } else if (eventPositionX == 0) {
            return true;
        } else {
            return false;
        }
    ...
    private void findWinForBackKeyInPCMultiCastMode(KeyEvent event) {
        int eventPositionX = event.getScanCode();
        List<Bundle> taskList = HwActivityTaskManager.getTaskList();
        Optional.empty();
        if (eventPositionX == 0) {
            resendBackKeyToWin(taskList.stream().filter($$Lambda$HwPhoneWindowManager$PpFlDD3NQ4G1gCbnvdE8Leemh28.INSTANCE).reduce($$Lambda$HwPhoneWindowManager$5Ezd8vDdFyj3Jj8SChaKzSYU0.INSTANCE), event);
        } else {
            resendBackKeyToWin(taskList.stream().filter(new Predicate(eventPositionX) {
                /* class com.android.server.policy.$$Lambda$HwPhoneWindowManager$9G3F13sbqDEEvNTbwzm2uKQWf6Y */
                ...
                public final boolean test(Object obj) {
                    return HwPhoneWindowManager.lambda$findWinForBackKeyInPCMultiCastMode$5(this.f$0, (Bundle) obj);
                }
            }).reduce($$Lambda$HwPhoneWindowManager$HYaD7zo3w3FA7SbMwAXD4GsBfDY.INSTANCE), event);
        }
    }

    static /* synthetic */ boolean lambda$findWinForBackKeyInPCMultiCastMode$3(Bundle task) {
    ...
    static /* synthetic */ Bundle lambda$findWinForBackKeyInPCMultiCastMode$4(Bundle first, Bundle second) {
        return second;
    }

    static /* synthetic */ boolean lambda$findWinForBackKeyInPCMultiCastMode$5(int eventPositionX, Bundle task) {
        Rect rect = (Rect) task.getParcelable(HwMultiDisplayManager.KEY_PC_RECT);
        return rect != null && eventPositionX >= rect.left && eventPositionX <= rect.right && task.getBoolean(HwMultiDisplayManager.KEY_PC_VISIBLE);
    }

    static /* synthetic */ Bundle lambda$findWinForBackKeyInPCMultiCastMode$6(Bundle first, Bundle second) {
        return second;
    }

    private void interceptBackKeyRepeatTime(WindowManagerPolicy.WindowState win) {
        WindowManagerPolicy.WindowState windowState = this.mWinLastIntercepted;
        if (windowState == null || windowState != win) {
            this.mWinLastIntercepted = win;
            this.mInterceptBackKeyRepeatTimes = 1;
            return;
        }
        this.mInterceptBackKeyRepeatTimes++;
    }

    private void resendBackKeyToWin(Optional<Bundle> optional, KeyEvent event) {
        if (optional.isPresent()) {
            ...
            sendKeyEvent(4, event.getScanCode());
        }
    }
    ...
    public long interceptKeyBeforeDispatching(WindowManagerPolicy.WindowState win, KeyEvent event, int policyFlags) {
        ...
        if (result != -2) {
            if (isActionDown) {
                this.mHandler.post(new Runnable() {
                    ...
                    @Override // java.lang.Runnable
                    public void run() {
                        Toast toast = Toast.makeText(HwPhoneWindowManager.this.mContext, this.hint, 0);
                        toast.getWindowParams().type = 2010;
                        toast.getWindowParams().privateFlags |= 16;
                        toast.show();
                    }
        ...
        int result2 = interceptHomeKeyEventForTvKidMode(keyCode);
        if (result2 < 0) {
            ...
            if (keyCode == 82 && !this.mDefaultDisplayPolicy.hasNavigationBar() && (268435456 & flags) == 0) {
                ...
                if (!isNeedPassEventToCloud(keyCode)) {
                    if (!isNeedPassEventToAssociateAssistant(keyCode)) {
                        ...
                        if (IS_TABLET && handleKeyEvent(event)) {
                            return -1;
                        }
                        ...
                        if (isTvMode() && (flags & 1024) == 0) {
                            if (this.mIsScreenRecorderVolumeUpKeyTriggered && !this.mIsScreenshotMenuKeyTriggered) {
                                long now2 = SystemClock.uptimeMillis();
                                long timeoutTime2 = this.mScreenRecorderVolumeUpKeyTime + 150;
    ...
    private void handleAppSwitchKeyEvent(boolean isActionDown, int repeatCount) {
        if (!isActionDown) {
            boolean isHandled = this.mRecentTrikeyHandled;
    ...
    private void initTpKeepParamters() {
        ...
        try {
            ...
            if (serviceManager != null) {
                isRegister = serviceManager.registerForNotifications(ITouchscreen.kInterfaceName, "", this.mServiceNotification);
            }
            if (!isRegister) {
    ...
    private void triggerSwitchTaskView(boolean isShowing) {
        IHwPCManager pcManager = HwPCUtils.getHwPCManager();
        if (pcManager != null) {
            try {
                pcManager.triggerSwitchTaskView(isShowing);
            } catch (RemoteException e) {
            ...
            this.mWindowManagerFuncs.registerPointerEventListener(new WindowManagerPolicyConstants.PointerEventListener() {
                ...
                public void onPointerEvent(MotionEvent motionEvent) {
                    if (motionEvent.getActionMasked() == 1) {
                        HwPartFingerprintFactory.loadFactory().getFingerViewController(HwPhoneWindowManager.this.mContext).notifyTouchUp(motionEvent.getRawX(), motionEvent.getRawY());
                    } else if (motionEvent.getActionMasked() == 6) {
                        int actionIndex = motionEvent.getActionIndex();
                        HwPartFingerprintFactory.loadFactory().getFingerViewController(HwPhoneWindowManager.this.mContext).notifyTouchUp(motionEvent.getX(actionIndex), motionEvent.getY(actionIndex));
                    }
                }
            }, 0);
        }
    ...
    public void screenTurningOn(WindowManagerPolicy.ScreenOnListener screenOnListener) {
        ...
        if (IS_SUPPORT_AP && !this.mIsRebootResumeTp) {
            HwAodManager.getInstance().configTpInApMode(102);
            this.mIsRebootResumeTp = true;
        }
    ...
    public void screenTurnedOn() {
        ...
        if (this.mSystemReady) {
            ...
            DefaultHwSideTouchPolicy defaultHwSideTouchPolicy = this.mSideTouchPolicy;
            if (defaultHwSideTouchPolicy != null) {
                defaultHwSideTouchPolicy.screenTurnedOn();
            }
    ...
    public void screenTurnedOff() {
        ...
        if (this.mSystemReady) {
            ...
            DefaultHwSideTouchPolicy defaultHwSideTouchPolicy = this.mSideTouchPolicy;
            if (defaultHwSideTouchPolicy != null) {
                defaultHwSideTouchPolicy.screenTurnedOff(false);
            }
            HwFoldScreenManagerInternal hwFoldScreenManagerInternal = this.mFoldScreenManagerService;
            if (hwFoldScreenManagerInternal != null) {
            ...
            DefaultStylusGestureListener defaultStylusGestureListener = this.mStylusGestureListener;
            if (defaultStylusGestureListener != null) {
                defaultStylusGestureListener.onScreenTurnedOff();
            }
            synchronized (this.mScreenTurnedOnLock) {
    ...
    public void setRotationLw(int rotation) {
        ...
        DefaultHwSideTouchPolicy defaultHwSideTouchPolicy = this.mSideTouchPolicy;
        if (defaultHwSideTouchPolicy != null) {
            defaultHwSideTouchPolicy.onRotationChanged(rotation);
        }
    }
    ...
    private void enableStylusAction() {
        if (this.mStylusGestureListener == null) {
            this.mStylusGestureListener = HwBasicPlatformFactory.loadFactory(HwBasicPlatformFactory.STYLUS_GESTURE_PART_FACTORY_IMPL).getStylusGestureListener(this.mContext);
            if (this.mStylusGestureListener != null) {
                this.mWindowManagerFuncs.registerPointerEventListener(this.mStylusActionPointerEventListener, 0);
            }
        }
    }
    ...
    private boolean isNeedPassEventToCloud(int keyCode) {
        return !KEYCODE_NOT_FOR_CLOUD_LIST.contains(Integer.valueOf(keyCode)) && (IS_TABLET || HwPCUtils.isPcCastModeInServer()) && isCloudOnTOP();
    }
    ...
    private void removeHwVAFromPowerSaveWhitelist() {
        this.mHandler.postDelayed(this.mRemovePowerSaveWhitelistRunnable, HWVASSISTANT_STAY_IN_WHITELIST_TIMEOUT);
    }
    ...
    private void notifyScreenPowerChanged(boolean isChanged) {
        Intent intent = new Intent(SCREEN_POWER_CHANGED_ACTION);
        intent.putExtra("flag", isChanged);
    ...
    private void powerOffToast() {
        Toast toast = Toast.makeText(new ContextThemeWrapper(this.mContext, 33947656), this.mContext.getString(33686282, 3), 1);
    ...
    private boolean needDropSmartKey() {
        boolean isNneedDropSmartKey = false;
    ...
    public void onProximityPositive() {
        ...
        DefaultHwSideTouchPolicy defaultHwSideTouchPolicy = this.mSideTouchPolicy;
        if (defaultHwSideTouchPolicy != null) {
            defaultHwSideTouchPolicy.screenTurnedOff(true);
        }
    }
    ...
    public void adjustConfigurationLw(Configuration config, int keyboardPresence, int navigationPresence) {
        ...
        if (tempDpi != this.lastDensityDpi) {
            ...
            DefaultStylusGestureListener defaultStylusGestureListener = this.mStylusGestureListener;
            if (defaultStylusGestureListener != null) {
                defaultStylusGestureListener.updateConfiguration();
            }
    ...
    private void showKeyEnableToast() {
        this.mHandler.post(new Runnable() {
            ...
            @Override // java.lang.Runnable
            public void run() {
                Toast toast = Toast.makeText(HwPhoneWindowManager.this.mContext, 33686281, 0);
                toast.getWindowParams().type = 2010;
                toast.getWindowParams().privateFlags |= 16;
                toast.show();
            }
        ...
        if (activityManager != null) {
            try {
                ...
                if (runningTask != null && runningTask.size() > 0) {
                    ...
                    if ((runningTask.get(0).numActivities <= 1 && (runningTask.size() <= 1 || !packageName.equals(nextAppName))) || HwCustPkgNameConstant.HW_SYSTEMUI_PACKAGE.equals(nextAppName)) {
                        results[1] = true;
                    }
                }
            } catch (RuntimeException e) {
    ...
    private boolean handleKeyEvent(KeyEvent event) {
        HwHandleKeyManager hwHandleKeyManager = HwHandleKeyManager.getInstance(this.mContext);
        if (hwHandleKeyManager != null) {
            return hwHandleKeyManager.handleKeyEvent(event);
        }
        return false;
    }
    ...
    public void notifyRotationChange(int rotation) {
        ...
        if (defaultHwScreenOnProximityLock != null) {
            ...
            if (CoordinationStackDividerManager.getInstance(this.mContext).isVisible() && getDefaultDisplayPolicy() != null) {
                CoordinationStackDividerManager.getInstance(this.mContext).updateDividerView(isLandscape(getDisplayRotation()));
            }
        }
        IHwSwingService hwSwing = HwSwingManager.getService();
        if (hwSwing != null) {
        ...
        DefaultStylusGestureListener defaultStylusGestureListener = this.mStylusGestureListener;
        if (defaultStylusGestureListener != null) {
            defaultStylusGestureListener.onRotationChange(rotation);
        }
    }
    ...
    private boolean shouldSkipSpecialWindow(WindowManagerPolicy.WindowState win) {
        for (String packageName : this.mSpecialPackages) {
            if (packageName.equals(win.getOwningPackage())) {
                return true;
            }
        }
        for (Integer num : this.mSpecialWindowTypeList) {
    ...
    public void notchControlFilletForSideScreen(WindowManagerPolicy.WindowState win, boolean isForced) {
        ...
        if (win != null && win.getDisplayId() <= 0 && !this.mIsNeedHide) {
            if (this.mWindowManagerInternal.isInDisplayFrozen()) {
                Slog.i(TAG, "skip update side and corner when display frozen");
            } else if (this.mIsSkipUpdateSideAndCorner) {
    ...
    private int detectNotchMode(WindowManagerPolicy.WindowState win, int displayRotation, int lazyMode) {
        if (this.mIsNotchSwitchOpen) {
            ...
            return detectNotchMode(win, lazyMode);
        } else if ((displayRotation != 1 && displayRotation != 3) || WindowConfiguration.isHwSplitScreenWindowingMode(win.getWindowingMode())) {
            return 0;
        } else {
    ...
    private int detectNotchMode(WindowManagerPolicy.WindowState win, int lazyMode) {
        if (lazyMode != 0) {
            return 0;
        }
    ...
    private void handleNotchRoundCorner(WindowManagerPolicy.WindowState win) {
        ...
        boolean isSplashScreen = win.toString().contains(SPLASH_SCREEN);
    ...
    private void transferSwitchStatusToSurfaceFlinger(int notchMode) {
        Slog.d(TAG, "Window issued fillet display notchMode = " + notchMode + ", mIsNotchSwitchOpen = " + this.mIsNotchSwitchOpen + ", mDisplayRotation = " + getDisplayRotation());
        Parcel dataIn = Parcel.obtain();
        try {
    ...
    public boolean hideNotchStatusBar(int fl) {
        ...
        if (isPowerOffScreen()) {
            ...
            if (focusedWindow != null && (this.hwNotchScreenWhiteConfig.isNoneNotchAppWithStatusbarInfo(windowStateEx) || (((focusedWindow.getAttrs().hwFlags & 32768) != 0 && ((fl & 1024) != 0 || (lastSystemUiFlags & 4) != 0)) || (getForceNotchStatusBar() && (focusedWindow.toString().contains("SearchPanel") || (!topFullscreenOpaqueWindowState.toString().contains(SPLASH_SCREEN) && !topFullscreenOpaqueWindowState.toString().equals(focusedWindow.toString()))))))) {
                ...
                isHideNotchStatusBar = false;
                this.mBarVisibility = 0;
            } else if ((focusedWindow == null && getForceNotchStatusBar() && (!((fl & 1024) == 0 && (lastSystemUiFlags & 4) == 0) && !topFullscreenOpaqueWindowState.toString().contains(SPLASH_SCREEN))) || !(topFullscreenOpaqueWindowState.getAttrs().type == 3 || (fl & 1024) == 0 || !topFullscreenOpaqueWindowState.toString().contains(SPLASH_SCREEN))) {
                setForceNotchStatusBar(true);
                isHideNotchStatusBar = false;
                this.mBarVisibility = 0;
            }
    ...
    public void setAodState(final int aodState) {
        this.mHandler.post(new Runnable() {
            ...
            @Override // java.lang.Runnable
            public void run() {
                if (!PhoneWindowManager.IS_SUPPORT_AP) {
                    HwPhoneWindowManager.this.startAodService(aodState);
                } else if (aodState == 100) {
                    Slog.i(HwPhoneWindowManager.TAG, "awaken dreams when waking up");
    ...
    private void startAodService(int aodState) {
        Slog.i(TAG_AOD_HWPWM, "startAodService mAodSwitch=" + this.mAodSwitch + " mAODState=" + this.mAODState + " aodState=" + aodState + " mIsFingerprintEnabledBySettings=" + this.mIsFingerprintEnabledBySettings + " mFingerprintType=" + this.mFingerprintType);
        if (!this.mIsActuralShutDown || !(aodState == 101 || aodState == 103)) {
            ...
            if (this.mAodSwitch == 0) {
                ...
                if (isInScreenFingerprint(this.mFingerprintType) && this.mIsFingerprintEnabledBySettings) {
                    Slog.i(TAG_AOD_HWPWM, "startAodService fp enabled");
                    isFpEnable = true;
                }
                boolean isAudioStreamEnable = false;
                if (!TextUtils.isEmpty(RING_VOLUMEBAR_DISP)) {
                    Slog.i(TAG_AOD_HWPWM, "startAodService audio enabled");
            ...
            if (this.mAODState == aodState) {
                Slog.i(TAG_AOD_HWPWM, "handleAodState mAODState equal, state =" + aodState);
                return;
            }
            this.mAODState = aodState;
            handleAodState(aodState);
            Slog.w(TAG_AOD_HWPWM, " startAodService end success.");
        }
    }

    private void handleAodState(int aodState) {
        Intent intent = null;
        Slog.w(TAG_AOD_HWPWM, " handleAodState aodState:" + aodState);
        switch (aodState) {
            case 100:
            case 102:
    ...
    private boolean isSupportAodAnimationPlay() {
        ...
        try {
            ...
            SharedPreferences spf = this.mContext.createPackageContext("com.huawei.aod", 0).getSharedPreferences(AodThemeConst.THEME_PREFERENCE, 4);
            if (spf == null) {
                Slog.w(TAG, "isSupportAnimationPlay return false for sharedPreferences invalid");
                return false;
            }
            isAnimationable = spf.getBoolean(AodThemeConst.IS_ANIMATIONABLE, false);
    ...
    public boolean isSideTouchVolumeKey(KeyEvent event, boolean isInjected) {
        DefaultHwSideTouchPolicy defaultHwSideTouchPolicy = this.mSideTouchPolicy;
        return defaultHwSideTouchPolicy != null && defaultHwSideTouchPolicy.isSideTouchEvent(event, isInjected);
    }

    public void notifyVolumePanelStatus(boolean isVolumePanelVisible) {
        DefaultHwSideTouchPolicy defaultHwSideTouchPolicy = this.mSideTouchPolicy;
        if (defaultHwSideTouchPolicy != null) {
            defaultHwSideTouchPolicy.notifyVolumePanelStatus(isVolumePanelVisible);
        }
    }

    public int checkActionResult(KeyEvent event, boolean isInjected, boolean isScreenOn, boolean isKeyguardActive, int result) {
        DefaultHwSideTouchPolicy defaultHwSideTouchPolicy = this.mSideTouchPolicy;
        if (defaultHwSideTouchPolicy == null || !defaultHwSideTouchPolicy.shouldSendToSystemMediaSession(event, isInjected, isScreenOn, isKeyguardActive)) {
            return result;
        }
        return result & -2;
    }
    ...
    public boolean isMusicOnly(boolean isScreenOn) {
        DefaultHwSideTouchPolicy defaultHwSideTouchPolicy = this.mSideTouchPolicy;
        if (defaultHwSideTouchPolicy != null) {
            return defaultHwSideTouchPolicy.isMusicOnly(isScreenOn);
        }
        return true;
    }
    ...
    private boolean interceptMenuKeyForTv(KeyEvent event, boolean isScreenOn) {
        if ((event.getFlags() & 268435456) != 0) {
            return false;
        }
        if (event.getAction() == 0) {
            this.mIsMenuKeyDownTriggeredForTv = true;
            if (this.mIsDoublePressMenuKeyWaiting) {
                this.mHandler.removeCallbacks(this.mDelayPressMenuActionForTv);
                handleDoublePressOnMenuKeyForTv();
            } else {
            ...
            if (!this.mIsScreenshotMenuKeyTriggered && (event.getFlags() & 1024) == 0) {
                this.mIsScreenshotMenuKeyTriggered = true;
                interceptScreenshotChordTv();
            }
        } else {
            if (!this.mIsLongPressMenuKeyHandled) {
                this.mIsLongPressMenuKeyHandled = true;
                this.mHandler.removeCallbacks(this.mLongPressMenuActionForTv);
                if (!this.mIsDoublePressMenuKeyWaiting && this.mIsMenuKeyDownTriggeredForTv) {
                    this.mIsDoublePressMenuKeyWaiting = true;
                    this.mHandler.postDelayed(this.mDelayPressMenuActionForTv, 200);
                }
            }
            this.mIsScreenshotMenuKeyTriggered = false;
        }
        if (!isScreenOn) {
            this.mHandler.removeCallbacks(this.mDelayPressMenuActionForTv);
            this.mHandler.removeCallbacks(this.mLongPressMenuActionForTv);
    ...
    private void interceptScreenshotChordTv() {
        if (isTvMode() && this.mIsScreenRecorderVolumeUpKeyTriggered && this.mIsScreenshotMenuKeyTriggered && !this.mIsScreenRecorderVolumeDownKeyTriggered && SystemClock.uptimeMillis() <= this.mScreenRecorderVolumeUpKeyTime + 150) {
            this.mIsScreenshotMenuKeyTriggered = false;
            this.mIsMenuKeyDownTriggeredForTv = false;
            this.mIsScreenRecorderVolumeUpKeyConsumed = true;
            this.mIsLongPressMenuKeyHandled = true;
            this.mHandler.removeCallbacks(this.mLongPressMenuActionForTv);
            this.mHandler.post(this.mScreenshotTvRunnable);
        }
    }
    ...
    public void lambda$new$0$HwPhoneWindowManager() {
        ...
        if (attrs != null && ((type = attrs.type) == 2009 || (attrs.privateFlags & 1024) != 0 || type == 2003 || type == 2010)) {
            ...
            this.mContext.sendOrderedBroadcastAsUser(new Intent("com.huawei.homevision.action.LONG_PRESS_MENU"), UserHandle.CURRENT, "com.huawei.homevision.permission.LONG_PRESS_MENU", null, null, -1, null, null);
        }
    }

    private void handleDoublePressOnMenuKeyForTv() {
        this.mIsDoublePressMenuKeyWaiting = false;
        this.mIsMenuKeyDownTriggeredForTv = false;
        if (isUserSetupComplete() && !keyguardOn()) {
            this.mContext.sendBroadcastAsUser(new Intent("com.huawei.homevision.action.DOUBLE_PRESS_MENU"), UserHandle.CURRENT, "com.huawei.homevision.permission.DOUBLE_PRESS_MENU");
        }
    }
    ...
    private void updatePowerKeyPolicy(boolean isDown, boolean isScreenOn, KeyEvent event) {
        if (this.mHasFeatureWatch) {
            ...
            if (isTargetWindowFocused(focusedWindow, WATCH_HEALTHSPORT_PACKAGE_NAME, WATCH_HEALTHSPORT_WINDOW_TITLE)) {
                ...
                Log.i(TAG, "ringer had mute, then send event to target");
                this.mPowerKeyPolicy |= 65537;
            }

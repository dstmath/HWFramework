...
public class SearchPanelCircleView extends FrameLayout {
    ...
    private void updateElevation() {
        ...
        float offsetWeight = (((float) i) - this.mOffset) / ((float) i);
        float offsetWeight2 = 0.0f;
        if (1.0f - offsetWeight > 0.0f) {
            offsetWeight2 = offsetWeight;
        }
        setElevation(((float) this.mMaxElevation) * offsetWeight2);
    }

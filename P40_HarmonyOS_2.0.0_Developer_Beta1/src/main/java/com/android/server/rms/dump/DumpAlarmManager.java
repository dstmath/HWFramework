...
public final class DumpAlarmManager {
    ...
    private static final String TAG = "DumpAlarmManager";
    ...
    public static void setDebugSwitch(Context context, PrintWriter pw, String[] args) {
        if (pw != null) {
            if ("on".equals(args[2])) {
    ...
    /* access modifiers changed from: private */
    public static void dumpDebugLog(Context context, PrintWriter pw, String[] args) {
        if (pw != null) {
    ...
    /* access modifiers changed from: private */
    public static void delay(Context context, PrintWriter pw, String[] args) {
        if (pw != null) {
    ...
    /* access modifiers changed from: private */
    public static void dumpBigData(Context context, PrintWriter pw, String[] args) {
        if (pw != null) {

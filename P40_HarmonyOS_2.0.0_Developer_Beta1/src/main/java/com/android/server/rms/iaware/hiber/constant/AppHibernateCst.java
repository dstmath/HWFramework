...
public class AppHibernateCst {
    public static final int APPHIBER_EVENT_TYPE_BASE = 90000;
    ...
    public static final int MSB_BASE_VALUE_APPHIBER = 380;
    ...
    public static final int SWITCH_ID_ALL = 8;
    public static final int SWITCH_ID_ANON = 4;
    public static final int SWITCH_ID_FILE = 2;

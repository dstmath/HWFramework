...
public class AppStandbyController {
    ...
    private boolean isDeviceProvisioningPackage(String packageName) {
        String deviceProvisioningPackage = this.mContext.getResources().getString(17039828);
    ...
    public static class Injector {
        ...
        public boolean isAppIdleEnabled() {
            return this.mContext.getResources().getBoolean(17891434) && (Settings.Global.getInt(this.mContext.getContentResolver(), "app_standby_enabled", 1) == 1 && Settings.Global.getInt(this.mContext.getContentResolver(), "adaptive_battery_management_enabled", 1) == 1);
        }

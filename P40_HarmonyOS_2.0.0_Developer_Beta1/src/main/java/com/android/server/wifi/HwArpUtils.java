...
public class HwArpUtils {
    ...
    public void doGratuitousArp(int timeout) {
        ...
        try {
            ...
            HwHiLog.e(TAG, false, "Exception happens when doGratuitousArp", new Object[0]);
            if (0 == 0) {
                return;
            }
        } catch (Throwable th) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x0043, code lost:
        r6 = new android.util.Pair<>(java.lang.Boolean.valueOf(r2), r3);
        android.util.wifi.HwHiLog.d(com.android.server.wifi.HwArpUtils.TAG, false, "getGateWayArpResult:%{public}s %{public}d %{public}d", new java.lang.Object[]{r6.toString(), java.lang.Integer.valueOf(r4), java.lang.Integer.valueOf(r11)});
     */
    ...
    public Pair<Boolean, Long> getGateWayArpResult(int times, int timeout) {
        ...
        try {
            ...
            isReachable = true;
            HwHiLog.e(TAG, false, "Exception happens when getGateWayArpResult", new Object[0]);
        } catch (Throwable th) {
            if (0 != 0) {
                peer.close();
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0037, code lost:
        android.util.wifi.HwHiLog.d(com.android.server.wifi.HwArpUtils.TAG, false, "GateWay response num:%{public}d", new java.lang.Object[]{java.lang.Integer.valueOf(r1.getGwNum())});
     */
    ...
    public HwMultiGw getGateWayArpResponses(int times, int timeout) {
        ...
        try {
            ...
            HwHiLog.e(TAG, false, "Exception happens when getGateWayArpResponses", new Object[0]);
        } catch (Throwable th) {
            if (0 != 0) {
                peer.close();
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x002b, code lost:
        android.util.wifi.HwHiLog.d(com.android.server.wifi.HwArpUtils.TAG, false, "GateWay arp rtt:%{public}s", new java.lang.Object[]{java.lang.String.valueOf(r2)});
     */
    ...
    public long getGateWayArpRTT(int timeout) {
        ...
        try {
            ...
            HwHiLog.e(TAG, false, "Exception happens when getGateWayArpRTT", new Object[0]);
        } catch (Throwable th) {
            if (0 != 0) {
                peer.close();
            }

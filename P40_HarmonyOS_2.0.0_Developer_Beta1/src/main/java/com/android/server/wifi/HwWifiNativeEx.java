...
public class HwWifiNativeEx implements IHwWifiNativeEx {
    ...
    private static final String MTK_6635X = "mc3";
    private static final String PLATFORM_MTK = "M";
    ...
    static {
        ...
        if (!(wifiInjector == null || wifiInjector.getWifiSettingsStore() == null || wifiInjector.getWifiSettingsStore().getHwWifiSettingsStoreEx() == null)) {
            if (wifiInjector.getWifiSettingsStore().getHwWifiSettingsStoreEx().getLocationMode() != 0) {
                ...
                isNeedStartWifiHidl = wifiInjector.getWifiSettingsStore().isWifiToggleEnabled();
            }
        }
    ...
    public void setChipsetWifiCategory() {
        if (PLATFORM_MTK.equals(SystemProperties.get("ro.connectivity.chiptype", "unknown"))) {
            String chipName = SystemProperties.get("ro.connectivity.sub_chiptype", "unknown");
            HwHiLog.d(TAG, false, "chipname =  " + chipName, new Object[0]);
            if (MTK_6635X.equals(chipName)) {
                this.chipsetCategory = 2;
            } else {

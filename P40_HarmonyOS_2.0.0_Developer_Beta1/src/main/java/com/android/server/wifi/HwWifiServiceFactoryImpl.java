...
import com.android.server.wifi.p2p.HwWifiP2pServiceEx;
...
public class HwWifiServiceFactoryImpl implements HwWifiServiceFactory.Factory {
    ...
    public IHwWifiP2pServiceEx getHwWifiP2pServiceEx(Context context) {
        return HwWifiP2pServiceEx.createHwWifiP2pServiceEx(context);
    }
}

...
public class WifiConfigStoreUtils {
    ...
    private static final boolean AUTO_CONNECT_PROP_ENABLED;
    ...
    private static boolean isAutoConnect(Context context) {
        if (context == null || !AUTO_CONNECT_PROP_ENABLED || Settings.System.getInt(context.getContentResolver(), "auto_connect_att", 1) == 1) {
            return true;
        }
        return false;
    }

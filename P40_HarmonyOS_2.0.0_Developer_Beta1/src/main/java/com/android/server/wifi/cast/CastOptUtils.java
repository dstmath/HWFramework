...
public class CastOptUtils {
    protected static final int CMD_ID_CTRL_ROAM_CHANNEL = 169;
    protected static final int CMD_ID_MCC_STA_P2P_QUOTA_TIME = 167;
    ...
    protected static final int INVALID_VALUE_OR_TYPE = -1;
    ...
    protected static final String STA_INTERFACE = "wlan0";
    ...
    protected static final int TRIGGER_TYPE_CAST_PLUS = 2;
    protected static final int TRIGGER_TYPE_MIRACAST = 1;
    protected static final int TRIGGER_TYPE_REGISTER_CALLBACK = 3;
    protected static final int WIFI_MODE_CAST_PLUS = 3003;
    protected static final int WIFI_MODE_MIRACAST = 3001;
    ...
    protected static boolean isCastOptSupported() {
        boolean isSupport = IS_CAST_OPT_ENABLE;

...
public class WifiCommonUtils {
    ...
    public static final int WIFI_MODE_BIT_DISCONNECT_WIFI = 1;
    public static final int WIFI_MODE_BIT_ENABLE_WIFI = 8;
    public static final int WIFI_MODE_BIT_FORBID_WIFI_SCAN = 4;
    public static final int WIFI_MODE_BIT_REFUSE_AUTO_CONNECT_WIFI = 2;

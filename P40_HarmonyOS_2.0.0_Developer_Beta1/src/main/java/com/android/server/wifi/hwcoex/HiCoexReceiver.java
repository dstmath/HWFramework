    ...
    public class HwProcessObserver extends IProcessObserver.Stub {
        ...
        public void onForegroundActivitiesChanged(int pid, int uid, boolean foregroundActivities) {
            if (!HiCoexReceiver.this.isConnected()) {
                ...
                HwAppQoeResourceManager qoeResourceManger = HwAppQoeResourceManager.getInstance();
                if (!(qoeResourceManger == null || qoeResourceManger.checkIsMonitorGameScenes(currentAppName) == null)) {

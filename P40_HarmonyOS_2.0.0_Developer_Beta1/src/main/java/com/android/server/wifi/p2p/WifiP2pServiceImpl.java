...
public class WifiP2pServiceImpl extends AbsWifiP2pService implements IHwWifiP2pServiceInner {
    ...
    private IHwWifiP2pServiceEx mHwWifiP2pServiceEx = null;
    ...
    static /* synthetic */ byte access$11204(WifiP2pServiceImpl x0) {
    ...
    public WifiP2pServiceImpl(Context context) {
        ...
        this.mThisDevice.primaryDeviceType = this.mContext.getResources().getString(17039887);
        ...
        this.mHwWifiP2pServiceEx = HwWifiServiceFactory.getHwWifiP2pServiceEx(this.mContext);
    }
    ...
    public class P2pStateMachine extends StateMachine {
        ...
        public class InactiveState extends State {
            ...
            public void enter() {
                ...
                if (WifiP2pServiceImpl.this.mHwWifiP2pServiceEx != null) {
                    WifiP2pServiceImpl.this.mHwWifiP2pServiceEx.updateGroupCreatedPkgList(WifiCommonUtils.WIFI_MODE_BIT_ACTION_FRWK, "", false, false);
                }
            }
                ...
                switch (message.what) {
                        ...
                        if (WifiP2pServiceImpl.this.mWifiPermissionsUtil.checkCanAccessWifiDirect(P2pStateMachine.this.getCallingPkgName(message.sendingUid, message.replyTo), message.sendingUid, false)) {
                            if ((WifiP2pServiceImpl.this.mWifiInjector.getClientModeImpl().getWifiMode() & 16) == 0) {
                                ...
                                if (P2pStateMachine.this.isConfigValidAsGroup(config)) {
                                    ...
                                    WifiP2pServiceImpl.this.updateP2pGoCreateStatus(!isConnectFailed);
                                ...
                                if (!isConnectFailed) {
                                    P2pStateMachine p2pStateMachine7 = P2pStateMachine.this;
                                    p2pStateMachine7.mSavedPeerConfig = config;
                                    p2pStateMachine7.mPeers.updateStatus(P2pStateMachine.this.mSavedPeerConfig.deviceAddress, 1);
                                    P2pStateMachine.this.sendPeersChangedBroadcast();
                                    if (WifiP2pServiceImpl.this.mHwWifiP2pServiceEx != null) {
                                        WifiP2pServiceImpl.this.mHwWifiP2pServiceEx.updateGroupCreatedPkgList(message.sendingUid, P2pStateMachine.this.getCallingPkgName(message.sendingUid, message.replyTo), true, false);
                                    }
                    ...
                    case WifiP2pMonitor.P2P_GO_NEGOTIATION_REQUEST_EVENT /* 147479 */:
                        ...
                        if (!P2pStateMachine.this.isConfigInvalid(config3)) {
                            P2pStateMachine p2pStateMachine16 = P2pStateMachine.this;
                            p2pStateMachine16.mSavedPeerConfig = config3;
                            WifiP2pServiceImpl.this.mAutonomousGroup = false;
                            WifiP2pServiceImpl.this.mJoinExistingGroup = false;
                            WifiP2pServiceImpl.this.mWifiP2pMetrics.startConnectionEvent(0, config3);
                            P2pStateMachine p2pStateMachine17 = P2pStateMachine.this;
                            p2pStateMachine17.transitionTo(p2pStateMachine17.mUserAuthorizingNegotiationRequestState);
                            break;
                        } else {
                            P2pStateMachine p2pStateMachine18 = P2pStateMachine.this;
                            p2pStateMachine18.loge("Dropping GO neg request " + config3);
                            break;
                        }
                    case WifiP2pMonitor.P2P_GROUP_STARTED_EVENT /* 147485 */:
                        if (message.obj != null) {
                            ...
                            if (WifiP2pServiceImpl.this.mVerboseLoggingEnabled) {
                                P2pStateMachine p2pStateMachine19 = P2pStateMachine.this;
                                p2pStateMachine19.logd(getName() + " group started");
                            }
                            ...
                            if (P2pStateMachine.this.mGroup.getNetworkId() != -2) {
                                P2pStateMachine p2pStateMachine20 = P2pStateMachine.this;
                                p2pStateMachine20.loge("Unexpected group creation, remove " + P2pStateMachine.this.mGroup);
                                P2pStateMachine.this.mWifiNative.p2pGroupRemove(P2pStateMachine.this.mGroup.getInterface());
                                break;
                            } else {
                                WifiP2pServiceImpl.this.mAutonomousGroup = false;
                                ...
                                p2pStateMachine21.transitionTo(p2pStateMachine21.mGroupNegotiationState);
                                break;
                            }
                        } else {
                    ...
                    case WifiP2pMonitor.P2P_INVITATION_RECEIVED_EVENT /* 147487 */:
                        if (message.obj != null) {
                            ...
                            if (!P2pStateMachine.this.isConfigInvalid(config4)) {
                                ...
                                p2pStateMachine22.mSavedPeerConfig = config4;
                                if (!(owner2 == null || (owner = p2pStateMachine22.mPeers.get(owner2.deviceAddress)) == null)) {
                                ...
                                p2pStateMachine23.transitionTo(p2pStateMachine23.mUserAuthorizingInviteRequestState);
                                break;
                            } else {
                                P2pStateMachine p2pStateMachine24 = P2pStateMachine.this;
                                p2pStateMachine24.loge("Dropping invitation request " + config4);
                                break;
                            }
                        } else {
                            Log.e(WifiP2pServiceImpl.TAG, "Invalid argument(s)");
                    ...
                    case WifiP2pMonitor.P2P_PROV_DISC_SHOW_PIN_EVENT /* 147492 */:
                        if (message.obj != null) {
                            ...
                            if (device != null) {
                                ...
                                p2pStateMachine25.transitionTo(p2pStateMachine25.mUserAuthorizingNegotiationRequestState);
                                break;
                            } else {
        ...
        public class GroupCreatingState extends State {
            ...
            public void enter() {
                ...
                P2pStateMachine p2pStateMachine = P2pStateMachine.this;
                p2pStateMachine.sendMessageDelayed(p2pStateMachine.obtainMessage(WifiP2pServiceImpl.GROUP_CREATING_TIMED_OUT, WifiP2pServiceImpl.access$8304(), 0), (long) groupCreatingWaitTime);
            }
            ...
            public boolean processMessage(Message message) {
                ...
                switch (message.what) {
                    case 139265:
                        ...
                        return true;
                    case 139274:
                        if (WifiP2pServiceImpl.this.mHwWifiP2pServiceEx == null || WifiP2pServiceImpl.this.mHwWifiP2pServiceEx.isRemoveGroupAllowed(message.sendingUid, P2pStateMachine.this.getCallingPkgName(message.sendingUid, message.replyTo))) {
        ...
        public class FrequencyConflictState extends State {
            ...
            private void notifyFrequencyConflict() {
                ...
                P2pStateMachine p2pStateMachine = P2pStateMachine.this;
                AlertDialog dialog = builder.setMessage(r.getString(17041555, p2pStateMachine.getDeviceName(p2pStateMachine.mSavedPeerConfig.deviceAddress))).setPositiveButton(r.getString(17039991), new DialogInterface.OnClickListener() {
                ...
                }).setNegativeButton(r.getString(17039953), new DialogInterface.OnClickListener() {
        ...
        private void addRowToDialog(ViewGroup group, int stringId, String value) {
            ...
            ((TextView) row.findViewById(16909176)).setText(r.getString(stringId));
            ((TextView) row.findViewById(16909584)).setText(value);
            group.addView(row);
        }
        ...
        public void notifyInvitationSent(String pin, String peerAddress) {
            ...
            ViewGroup group = (ViewGroup) textEntryView.findViewById(16909057);
        ...
        private void notifyInvitationReceived() {
            if (!WifiP2pServiceImpl.this.autoAcceptConnection()) {
                if (!WifiCommonUtils.IS_TV || WifiP2pServiceImpl.this.mHwWifiP2pServiceTvEx == null) {
                    ...
                    ((TextView) row.findViewById(16909176)).setText(String.format(r.getString(33685699), getDeviceName(this.mSavedPeerConfig.deviceAddress)));
                    ...
                    if (isNightMode) {
                        ((TextView) row.findViewById(16909176)).setTextColor(WHITE_COLOR);
                    } else {
                        ((TextView) row.findViewById(16909176)).setTextColor(BLACK_COLOR);
                    }
                    group.addView(row);
                    final EditText pin = (EditText) textEntryView.findViewById(16909606);
                    ...
                    if (i == 1) {
                        ...
                        textEntryView.findViewById(16908931).setVisibility(0);
                    }
        ...
        private boolean addServiceRequest(Messenger m, WifiP2pServiceRequest req) {
            ...
            WifiP2pServiceImpl.access$11204(WifiP2pServiceImpl.this);
        ...
        private void clearClientInfo(Messenger m) {
            ...
            if (clientInfo != null) {
                ...
                if (WifiP2pServiceImpl.this.mHwWifiP2pServiceEx != null) {
                    WifiP2pServiceImpl.this.mHwWifiP2pServiceEx.updateGroupCreatedPkgList(0, clientInfo.mPackageName, false, false);
                }
            }
        }

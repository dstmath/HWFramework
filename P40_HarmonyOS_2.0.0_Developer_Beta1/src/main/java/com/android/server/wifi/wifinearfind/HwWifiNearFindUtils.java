...
public class HwWifiNearFindUtils {
    private static final String BAIDU_INPUT_APK = "com.baidu.input";
    ...
    private static final int DEFAULT_FLOATING_WINDOWS = 1;
    ...
    public static boolean isExistFloatingWindows(HwWindowManagerServiceEx hwWindowManagerServiceEx) {
        ...
        if (result.size() != 1 || !BAIDU_INPUT_APK.equals(result.get(0).getString("window_package", DEFAULT_CHIP_TYPE))) {
            return true;
        }
        return false;
    }

...
public class HwSavedNetworkEvaluator extends SavedNetworkEvaluator {
                ...
                if (wifiConfiguration3 != null) {
                    ...
                    if (wifiConfiguration4 != null) {
                        ...
                        if (wifiConfiguration5 != null) {
                            ...
                            newConfig = handleNoInetNetworkCandidate(newConfig, isfactorymode);
                        } else {
    ...
    private WifiConfiguration handleNoInetNetworkCandidate(WifiConfiguration config, boolean isfactorymode) {
        if (!WifiProCommonUtils.isWifiProSwitchOn(this.mContext) || isfactorymode) {
            ...
            WifiConfiguration newConfig = this.noInetNetworkCandidate;
            ...
            WifiConfiguration newConfig2 = this.noInetNetworkCandidate;
            this.backupTypeSelected = NO_INET_SELECTED;

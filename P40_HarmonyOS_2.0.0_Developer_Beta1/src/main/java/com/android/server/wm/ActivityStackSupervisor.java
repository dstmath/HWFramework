...
public class ActivityStackSupervisor extends AbsActivityStackSupervisor implements RecentTasks.Callbacks {
                ...
                if (HwDeviceManager.disallowOp(3, packageName)) {
                    ...
                    UiThread.getHandler().post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (context != null) {
                                Toast toast = Toast.makeText(context, context.getString(33686042), 0);
    ...
    public final void scheduleRestartTimeout(ActivityRecord r) {
        ...
        activityStackSupervisorHandler.sendMessageDelayed(activityStackSupervisorHandler.obtainMessage(RESTART_ACTIVITY_PROCESS_TIMEOUT_MSG, r), (long) WindowManagerService.WINDOW_FREEZE_TIMEOUT_DURATION);
    }
    ...
    public boolean checkNeedFullScreenDisplay(TaskRecord task) {
        ActivityRecord top;
        if (task == null || !task.inHwMultiStackWindowingMode() || task.getStack() == null || task.getWindowingMode() == 105 || (top = task.getTopActivity()) == null || !"com.huawei.camera".equals(top.appInfo.packageName)) {
            return false;
        }

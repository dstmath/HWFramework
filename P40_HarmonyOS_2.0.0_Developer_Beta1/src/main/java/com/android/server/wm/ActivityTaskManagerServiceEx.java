...
public class ActivityTaskManagerServiceEx {
    ...
    public final boolean postDelayed(Runnable runnable, long time) {
        return this.mATMS.mH.postDelayed(runnable, time);
    }
    ...
    public void call(Bundle extras) {
        ActivityTaskManagerService activityTaskManagerService = this.mATMS;
        if (activityTaskManagerService != null && activityTaskManagerService.mHwATMSEx != null) {
            this.mATMS.mHwATMSEx.call(extras);
        }
    }

    public static boolean exitCoordinationMode(boolean toTop, boolean changeMode) {
        ...
        if (activityTaskManagerInternal != null) {
            return activityTaskManagerInternal.exitCoordinationMode(toTop, changeMode);
        }
        return false;
    }

    public static void setExpandScreenTurningOn(boolean isExpandScreenTurningOn) {
        ActivityTaskManagerInternal activityTaskManagerInternal = (ActivityTaskManagerInternal) LocalServices.getService(ActivityTaskManagerInternal.class);
        if (activityTaskManagerInternal != null) {
            activityTaskManagerInternal.setExpandScreenTurningOn(isExpandScreenTurningOn);
        }
    }

    public void removeSplitScreenDividerBar(int windowMode, boolean isImmediately, int displayId) {
        this.mATMS.mHwATMSEx.removeSplitScreenDividerBar(windowMode, isImmediately, displayId);
    }

    public boolean isInForceRotateList(String packageName) {
        return this.mATMS.mHwATMSEx.isInForceRotateList(packageName);
    }

    public boolean isInForbiddenForceRotateList(String packageName) {
        return this.mATMS.mHwATMSEx.isInNoForceRotateList(packageName);
    }
}

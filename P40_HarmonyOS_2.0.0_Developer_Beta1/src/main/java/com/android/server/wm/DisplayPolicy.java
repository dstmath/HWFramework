...
public class DisplayPolicy implements IHwDisplayPolicyInner {
    ...
    public void selectRotationAnimationLw(int[] anim) {
        boolean forceJumpcut = !this.mScreenOnFully || (!this.mService.mPolicy.okToAnimate() && !this.mService.mPolicy.isSuperWallpaperGoingToSleep());
        if (WindowManagerDebugConfig.DEBUG_ANIM) {
    ...
    private boolean layoutNavigationBar(DisplayFrames displayFrames, int uiMode, boolean navVisible, boolean navTranslucent, boolean navAllowedHidden, boolean isKeyguardOn, boolean statusBarForcesShowingNavigation) {
        ...
        displayFrames.mContent.set(dockFrame);
        sTmpRect.setEmpty();
        if (this.mNavigationBarPosition == 4 && HwDisplaySizeUtil.hasSideInScreen() && this.mNavigationBar.isVisibleLw() && (displayFrames.mRotation == 1 || displayFrames.mRotation == 3)) {
            int width2 = HwDisplaySizeUtil.getInstance(this.mService).getSafeSideWidth();
            navigationFrame.set(navigationFrame.left, navigationFrame.top - width2, navigationFrame.right, navigationFrame.bottom - width2);
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:299:0x0788, code lost:
        if (r13 <= 1999) goto L_0x079a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:303:0x0790, code lost:
        if (r13 == 2009) goto L_0x079a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:495:0x0c36, code lost:
        if (r12.type != 2013) goto L_0x0c3b;
     */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:205:0x053b  */
    /* JADX WARNING: Removed duplicated region for block: B:22:0x009a  */
    /* JADX WARNING: Removed duplicated region for block: B:23:0x00a5  */
    /* JADX WARNING: Removed duplicated region for block: B:326:0x081d  */
    /* JADX WARNING: Removed duplicated region for block: B:370:0x08ca  */
    /* JADX WARNING: Removed duplicated region for block: B:372:0x08e0  */
    /* JADX WARNING: Removed duplicated region for block: B:375:0x08ed  */
    /* JADX WARNING: Removed duplicated region for block: B:376:0x0907  */
    /* JADX WARNING: Removed duplicated region for block: B:48:0x00f9  */
    /* JADX WARNING: Removed duplicated region for block: B:524:0x0d4d  */
    /* JADX WARNING: Removed duplicated region for block: B:525:0x0d53  */
    /* JADX WARNING: Removed duplicated region for block: B:567:0x0e54  */
    /* JADX WARNING: Removed duplicated region for block: B:572:0x0e6d  */
    /* JADX WARNING: Removed duplicated region for block: B:580:0x0e80  */
    /* JADX WARNING: Removed duplicated region for block: B:581:0x0e82  */
    /* JADX WARNING: Removed duplicated region for block: B:590:0x0e9e  */
    /* JADX WARNING: Removed duplicated region for block: B:647:0x0f95  */
    /* JADX WARNING: Removed duplicated region for block: B:668:0x0fe5  */
    /* JADX WARNING: Removed duplicated region for block: B:678:0x1002  */
    /* JADX WARNING: Removed duplicated region for block: B:733:0x10f8  */
    /* JADX WARNING: Removed duplicated region for block: B:734:0x1101  */
    /* JADX WARNING: Removed duplicated region for block: B:740:0x111e  */
    /* JADX WARNING: Removed duplicated region for block: B:743:0x112e  */
    /* JADX WARNING: Removed duplicated region for block: B:75:0x013a  */
    /* JADX WARNING: Removed duplicated region for block: B:76:0x013c  */
    /* JADX WARNING: Removed duplicated region for block: B:774:0x1213  */
    /* JADX WARNING: Removed duplicated region for block: B:79:0x0146  */
    /* JADX WARNING: Removed duplicated region for block: B:802:0x12bb  */
    /* JADX WARNING: Removed duplicated region for block: B:803:0x1374  */
    /* JADX WARNING: Removed duplicated region for block: B:806:0x1380  */
    /* JADX WARNING: Removed duplicated region for block: B:80:0x0148  */
    /* JADX WARNING: Removed duplicated region for block: B:833:0x1420  */
    /* JADX WARNING: Removed duplicated region for block: B:834:0x1428  */
                    ...
                    if ((attrs4.privateFlags & Integer.MIN_VALUE) != 0) {
                        ...
                        if (HwPCUtils.isPcCastModeInServer() || !isPCDisplay) {
                            ...
                            if (type3 != 2011) {
                                ...
                                if (!(displayFrames2.mDock.left == 0 || (windowState6 = this.mAloneTarget) == null || !windowState6.inHwFreeFormWindowingMode())) {
                                    Slog.v(TAG, "layoutWindowLw mDock: " + displayFrames2.mDock);
                                }
                        ...
                        if (!HwDisplaySizeUtil.hasSideInScreen()) {
                            if (win.getAttrs().type != 2011 || displayPolicy.mService.getImeHolder() == null || !isCompressibleInputMethod(win)) {
                                ...
                                if (WindowConfiguration.isFloating(displayPolicy.mService.getImeHolder().getWindowingMode())) {
                                    unfloatingWin = displayPolicy.mDisplayContent.findVisibleUnfloatingModeWindow();
                                } else {
                                    unfloatingWin = displayPolicy.mService.getImeHolder();
                                }
                                if (unfloatingWin == null) {
                                    z = false;
                                } else {
                                    z = displayPolicy.mHwDisplayPolicyEx.isNeedExceptDisplaySide(unfloatingWin.mAttrs, unfloatingWin, displayPolicy.mDisplayRotation);
                                }
                                windowState.mIsNeedExceptDisplaySide = z;
                            }
                            if (windowState.mIsNeedExceptDisplaySide) {
                                ...
                                if (i35 == 1) {
                                    ...
                                    if (!(displayFrames2.mRotation == 1 || displayFrames2.mRotation == 3)) {
    ...
    /* access modifiers changed from: package-private */
    public boolean isCompressibleInputMethod(WindowState win) {
        String packageName = win.getAttrs().packageName;
        return "com.baidu.input_huawei".contains(packageName) || SEC_IME_PACKAGE.contains(packageName);
    }
    ...
    public void onConfigurationChanged() {
        ...
        int dimensionPixelSize3 = res.getDimensionPixelSize(17105309);
        ...
        int dimensionPixelSize4 = res.getDimensionPixelSize(17105311);
        ...
        int dimensionPixelSize5 = res.getDimensionPixelSize(17105306);
        ...
        int dimensionPixelSize6 = res.getDimensionPixelSize(17105307);
        ...
        int dimensionPixelSize7 = res.getDimensionPixelSize(17105314);
        ...
        this.mBottomGestureAdditionalInset = res.getDimensionPixelSize(17105308) - getNavigationBarFrameHeight(portraitRotation, uiMode);
    ...
    public void updateConfigurationAndScreenSizeDependentBehaviors() {
        ...
        this.mAllowSeamlessRotationDespiteNavBarMoving = res.getBoolean(17891347);
    }

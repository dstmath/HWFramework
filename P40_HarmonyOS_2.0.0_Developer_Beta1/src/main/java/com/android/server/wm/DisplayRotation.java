...
public class DisplayRotation {
    ...
    private boolean isNeedQuitSingleHand(int requestedOrientation) {
        if (!(this.mService.mHwWMSEx.getLazyModeEx() != 0)) {
            return true;
        }
        if (requestedOrientation != 0 && requestedOrientation != 6 && requestedOrientation != 8 && requestedOrientation != 11) {
            return true;
        }
        Slog.i(TAG, "isNeedQuitSingleHand");
        this.mService.mHwWMSEx.quickQuitLazyMode();
        return false;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:151:0x022f, code lost:
        if ((r21.mDisableRotationFlag & (1 << r11)) != 0) goto L_0x0231;
     */
    /* JADX WARNING: Removed duplicated region for block: B:135:0x01f7  */
    ...
    public int rotationForOrientation(int orientation, int lastRotation) {
        ...
        if (!isFixedToUserRotation()) {
            ...
            if (desiredRotation < 0 || !isNeedQuitSingleHand(orientation)) {
                OrientationListener orientationListener = this.mOrientationListener;
                if (orientationListener != null) {
                        ...
                        if (!(this.mUserRotationMode == 0 && (orientation == 2 || orientation == -1 || orientation == 11 || orientation == 12 || orientation == 13))) {
                            if (orientation == 4 || orientation == 10 || orientation == 6) {
                                if (this.mAllowAllRotations < 0) {
                                    this.mAllowAllRotations = this.mContext.getResources().getBoolean(17891341) ? 1 : 0;
                                }

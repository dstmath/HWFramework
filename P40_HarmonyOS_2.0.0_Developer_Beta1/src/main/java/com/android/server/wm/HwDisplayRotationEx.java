...
public class HwDisplayRotationEx extends DefaultDisplayRotationExImpl {
    ...
    public HwDisplayRotationEx(WindowManagerServiceEx service, DisplayContentEx displayContent, boolean isDefaultDisplay) {
        ...
        this.mGestureNavPolicy = (DefaultGestureNavManager) LocalServicesEx.getService(DefaultGestureNavManager.class);
        this.mGameDockGesture = (HwGameDockGesture) LocalServicesEx.getService(HwGameDockGesture.class);
    ...
    public void setSwingRotation(int rotation) {
        ...
        if (this.mSwingRotation == -2 && rotation == -1) {
            SlogEx.i(TAG, "old swing rotation is -2 current is -1 ignore it");
            return;
        }
    ...
    public int swingRotationForSensorRotation(int lastRotation, int sensorRotation) {
        ...
        if (i != -2) {
            ...
            SlogEx.i(TAG, "swingRotationForSensor desireRotation " + desireRotation + " swingRotation " + this.mSwingRotation + " sensorRotation " + sensorRotation + " lastRotation " + lastRotation);
    ...
    public void handleReportLog(Message msg) {
        ...
        if (bundle != null) {
            ...
            String packageName = bundle.getString("packageName", BuildConfig.FLAVOR);
    ...
    public int getRotationFromSensorOrFace(int sensor) {
        if (IntelliServiceManager.getInstance(this.mService.getContext()).isKeepPortrait()) {
            SlogEx.d("IntelliServiceManager", "portraitRotaion:0");
            return 0;
            ...
            SlogEx.d("IntelliServiceManager", "faceRotation:" + sensorRotation);
            return sensorRotation;
        } else {
            SlogEx.d("IntelliServiceManager", "sensor:" + sensor);
            return sensor;
        }
    }
}

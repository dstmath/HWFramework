...
public class HwMagicWinAmsPolicy extends HwMagicWinModulePolicy.ModulePolicy {
    ...
    private static final int SCHEDULE_IDLE_DELAY_TIME = 100;
    ...
    public static final HashSet<String> TRANSITION_ACTIVITIES = new HashSet<>();
    ...
    private HwMagicWinModulePolicy.IPolicyOperation getAppInfo = new HwMagicWinModulePolicy.IPolicyOperation() {
    ...
    private HwMagicActivityLifeManager mActivityLifeManager;
    private HwMagicActivityStarter mActivityStarter;
    ...
    private OrientationPolicy mOrientationPolicy;
    ...
    private HwMagicWinModulePolicy.IPolicyOperation overrideArgsForHwMagicWin = new HwMagicWinModulePolicy.IPolicyOperation() {
        /* class com.android.server.wm.$$Lambda$HwMagicWinAmsPolicy$qqgeUT2plaLyhTVhdoG6k4xaRI */
    ...
    private HwMagicWinModulePolicy.IPolicyOperation resizeSpecialVideoInMagicWindowMode = new HwMagicWinModulePolicy.IPolicyOperation() {
        /* class com.android.server.wm.$$Lambda$HwMagicWinAmsPolicy$ZmNoHRDb1AaMbf3a5lLmxJNOlUk */

        @Override // com.android.server.wm.HwMagicWinModulePolicy.IPolicyOperation
        public final void execute(List list, Bundle bundle) {
            HwMagicWinAmsPolicy.this.lambda$new$35$HwMagicWinAmsPolicy(list, bundle);
        }
    };
    private HwMagicWinModulePolicy.IPolicyOperation resizeSplitStackBeforeResume = new HwMagicWinModulePolicy.IPolicyOperation() {
        /* class com.android.server.wm.$$Lambda$HwMagicWinAmsPolicy$P7BCp3cFQt7iWPsyv3nS3bklFkg */
    ...
    private HwMagicWinModulePolicy.IPolicyOperation resizeWhenMovebackIfNeed = new HwMagicWinModulePolicy.IPolicyOperation() {
        /* class com.android.server.wm.$$Lambda$HwMagicWinAmsPolicy$aOKNqDMEdSRuUe7IrEALmxfSMgk */
    ...
    private HwMagicWinModulePolicy.IPolicyOperation updateMagicWindowConfiguration = new HwMagicWinModulePolicy.IPolicyOperation() {
        /* class com.android.server.wm.$$Lambda$HwMagicWinAmsPolicy$U5Tw1hNSls3Ea1jkYXJlM0x_k8 */
    ...
    private HwMagicWinModulePolicy.IPolicyOperation updateRequestedOrientation = new HwMagicWinModulePolicy.IPolicyOperation() {
        /* class com.android.server.wm.$$Lambda$HwMagicWinAmsPolicy$aFVqEU7jmRYmQ7o7fKBp9ZM1XI */

        @Override // com.android.server.wm.HwMagicWinModulePolicy.IPolicyOperation
        public final void execute(List list, Bundle bundle) {
            HwMagicWinAmsPolicy.this.lambda$new$44$HwMagicWinAmsPolicy(list, bundle);
        }
    };
    ...
    private HwMagicWinModulePolicy.IPolicyOperation updateVisibilityForHwMagicWin = new HwMagicWinModulePolicy.IPolicyOperation() {
        /* class com.android.server.wm.$$Lambda$HwMagicWinAmsPolicy$a6govWasbU6buSwMP0teGn4Nbvw */

        @Override // com.android.server.wm.HwMagicWinModulePolicy.IPolicyOperation
        public final void execute(List list, Bundle bundle) {
            HwMagicWinAmsPolicy.this.lambda$new$30$HwMagicWinAmsPolicy(list, bundle);
        }
    };
    ...
    public /* synthetic */ void lambda$new$0$HwMagicWinAmsPolicy(List params, Bundle result) {
        ...
        if (container != null) {
            String packageName = Utils.getRealPkgName(task.getTopActivity());
            if (container.getConfig().isSupportAppTaskSplitScreen(packageName) && !this.mMagicWinSplitMng.isInAppSplite(task.getActivityStack(), false)) {
                DisplayInfoEx displayInfoEx = new DisplayInfoEx();
                displayInfoEx.resetDisplayInfo(params.get(1));
                Rect masterBounds = container.getBounds(1, packageName);
                Rect slaveBounds = container.getBounds(2, packageName);
                Rect bgRect = new Rect();
                Point bgPoint = new Point();
                if (Utils.isLayoutRtl()) {
                    bgRect.set(slaveBounds.right, masterBounds.top, masterBounds.left, displayInfoEx.getAppHeight());
                    bgPoint.set(bgRect.width(), masterBounds.top);
                } else {
                    bgRect.set(masterBounds.right, masterBounds.top, slaveBounds.left, displayInfoEx.getAppHeight());
                    bgPoint.set(-masterBounds.right, masterBounds.top);
                }
                result.putInt("bgColor", container.getConfig().getSplitBarBgColor(packageName));
                result.putParcelable("bgRect", bgRect);
                result.putParcelable("bgPoint", bgPoint);
                result.putParcelable("masterBounds", masterBounds);
                result.putParcelable("slaveBounds", slaveBounds);
            }
        }
    }
    ...
    public /* synthetic */ void lambda$new$8$HwMagicWinAmsPolicy(List params, Bundle result) {
        ...
        synchronized (this.mActivityTaskManager.getGlobalLock()) {
            ...
            touchActivity.setMagicWindowPageType(1);
        }
    }
    ...
    public /* synthetic */ void lambda$new$23$HwMagicWinAmsPolicy(List params, Bundle result) {
        this.mActivityStarter.overrideArgsForHwMagicWin((ApplicationInfo) params.get(0), (String[]) params.get(2));
    }

    public /* synthetic */ void lambda$new$24$HwMagicWinAmsPolicy(List params, Bundle result) {
        this.mActivityLifeManager.resumeActivityForHwMagicWin(ActivityRecordEx.forToken((IBinder) params.get(0)));
    }
    ...
    public HwMagicWinAmsPolicy(SharedParameters parameters) {
        ...
        this.mActivityStarter = new HwMagicActivityStarter(parameters.getAms(), this.mMwManager, this);
        this.mActivityLifeManager = new HwMagicActivityLifeManager(parameters.getAms(), this.mMwManager, this.mMagicWinSplitMng, this);
    ...
    private void initPolicy() {
        ...
        addPolicy(Utils.POLICY_GET_APP_INFO, this.getAppInfo, Object.class, Object.class);
    }
    ...
    public ActivityStackEx getActivityStackEx(int stackId) {
        ...
        ActivityStackEx result2 = (ActivityStackEx) Optional.ofNullable(this.mMwManager.getLocalContainer()).map($$Lambda$HwMagicWinAmsPolicy$TC8t2PTZ2vNehkfmdzY3TBBMxY.INSTANCE).map(new Function(stackId) {
            /* class com.android.server.wm.$$Lambda$HwMagicWinAmsPolicy$0Ptb6NFSE5OC8jLb2JKx8XHWdag */
        ...
        return (ActivityStackEx) Optional.ofNullable(this.mMwManager.getVirtualContainer()).map($$Lambda$HwMagicWinAmsPolicy$TGGz7xVmUP2A8fNg6RI1p8BYVis.INSTANCE).map(new Function(stackId) {
            /* class com.android.server.wm.$$Lambda$HwMagicWinAmsPolicy$er26a1MG7BJ04Ke3dvR2MEAGw */
            private final /* synthetic */ int f$0;
    ...
    public /* synthetic */ void lambda$new$29$HwMagicWinAmsPolicy(List params, Bundle result) {
        ...
        if (container != null && !FINISH_REASON_CRASH.equals(finishReason)) {
            if (finishActivity.inHwMagicWindowingMode()) {
                ...
                if (isMainActivity(container, finishActivity)) {
                    removeRelatedActivity(container, finishActivity.getActivityStackEx(), false);
                }
                boolean isFinishSlave = this.mMwManager.isSlave(finishActivity);
                if (isFinishSlave) {
                ...
                if (this.mMwManager.isMaster(finishActivity.getActivityStackEx().getResumedActivity()) && isFinishSlave) {
                    scheduleIdleLocked();
                }
    ...
    public void scheduleIdleLocked() {
        this.mMwManager.getHandler().removeMessages(24);
        this.mMwManager.getHandler().sendEmptyMessageDelayed(24, 100);
    }
    ...
    public void removeRelatedActivity(HwMagicContainer container, ActivityStackEx stack, boolean isClearBounds) {
    ...
    public /* synthetic */ void lambda$new$30$HwMagicWinAmsPolicy(List params, Bundle result) {
    ...
    public /* synthetic */ void lambda$new$32$HwMagicWinAmsPolicy(List params, Bundle result) {
        ...
        if (paramTwo != null) {
            ...
            if (options != null) {
                focus = (ActivityRecordEx) Optional.ofNullable(this.mActivityTaskManager).map(new Function(options) {
                    /* class com.android.server.wm.$$Lambda$HwMagicWinAmsPolicy$uKE1cNaHqVQzsRBYH17SS_zk36k */
        ...
        this.mActivityStarter.overrideIntentFlagForHwMagicWin(focus, next, options);
    }
    ...
    public /* synthetic */ void lambda$new$33$HwMagicWinAmsPolicy(List params, Bundle result) {
        ...
        IBinder reusedToken = (IBinder) params.get(2);
        boolean isNewTask = ((Boolean) params.get(3)).booleanValue();
        ActivityOptions options = (ActivityOptions) params.get(4);
        this.mActivityStarter.overrideIntentForHwMagicWin((IBinder) params.get(0), next, reusedToken, isNewTask, options);
    }
    ...
    public /* synthetic */ void lambda$new$34$HwMagicWinAmsPolicy(List params, Bundle result) {
        this.mActivityStarter.clearTask((IBinder) params.get(0), ((Integer) params.get(1)).intValue(), (IBinder) params.get(2), result);
    }
    ...
    public /* synthetic */ void lambda$new$35$HwMagicWinAmsPolicy(List params, Bundle result) {
    ...
    private int getDisplayId(int taskId) {
        return ((Integer) Optional.ofNullable(this.mActivityTaskManager).map($$Lambda$HwMagicWinAmsPolicy$tWvAgLOO1BsNQbAloKRutz58.INSTANCE).map(new Function(taskId) {
            /* class com.android.server.wm.$$Lambda$HwMagicWinAmsPolicy$F2VVCuPLJEIe6polXbO7zjbKFI */
            private final /* synthetic */ int f$0;
        ...
        }).map($$Lambda$HwMagicWinAmsPolicy$z93kfG82h378jkq3dBN5ow1OuYA.INSTANCE).map($$Lambda$HwMagicWinAmsPolicy$P2bxW5S48FQR6AcVGu5giccv8eU.INSTANCE).orElse(0)).intValue();
    }
    ...
    public boolean isNeedStartOrMoveRight(ActivityRecordEx resumeActivity, String pkgName) {
        HwMagicContainer container = this.mMwManager.getContainer(resumeActivity);
        if (container == null) {
            return false;
        }
    ...
    public void startRelateActivity(String pkgName, String relateActName, ActivityRecordEx mainAr) {
    ...
    public /* synthetic */ void lambda$new$44$HwMagicWinAmsPolicy(List params, Bundle result) {
        this.mOrientationPolicy.updateRequestedOrientation();
    }
    ...
    public OrientationPolicy getOrientationPolicy() {
        if (this.mOrientationPolicy == null) {
            this.mOrientationPolicy = new OrientationPolicy(this.mAms, this.mMwManager, this);
        }

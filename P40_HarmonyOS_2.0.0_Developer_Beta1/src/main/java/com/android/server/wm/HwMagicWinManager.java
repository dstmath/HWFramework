...
public class HwMagicWinManager extends DefaultHwMagicWinManager {
    ...
    private void notifyPCAssistantStateChanged() {
        Optional<ActivityTaskManagerServiceEx> atmsEx = Optional.ofNullable(this.mSharedParameters).map($$Lambda$HwMagicWinManager$H14HHBeYd8rUwXp6BZZ7i52IwoY.INSTANCE).map($$Lambda$HwMagicWinManager$dtmjVmrQAAUiq5Bz2DnD51N9Q.INSTANCE);
        if (atmsEx.isPresent()) {
            Bundle bundle = new Bundle();
            bundle.putString("android.intent.extra.REASON", "magicAppStateChange");
            bundle.putInt("android.intent.extra.user_handle", atmsEx.get().getCurrentUserId());
            atmsEx.get().call(bundle);
            SlogEx.i(TAG, "Notify PCAssistant state change succeed.");
            return;
        }
    ...
    public boolean isSupportMagicRotatingScreen(String packageName) {
        return ((Boolean) Optional.ofNullable(getLocalContainer()).map($$Lambda$HwMagicWinManager$89MPXjcyDO3AZC4ILGxt4fjOTvs.INSTANCE).map(new Function(packageName) {
            /* class com.android.server.wm.$$Lambda$HwMagicWinManager$bnNCogpkgWyPHBQ9LQk4XggCZc */
            ...
            public final Object apply(Object obj) {
                return Boolean.valueOf(((HwMagicWindowConfig) obj).isSupportMagicRotatingScreen(this.f$0));
            }
    ...
    public void removeUninstallAppConfig(String pkgName, Boolean isReplace) {
        this.mContainers.forEach(new BiConsumer(pkgName, isReplace) {
            /* class com.android.server.wm.$$Lambda$HwMagicWinManager$_me2lIsczay1LDNnEi7EjrWgtx4 */
            private final /* synthetic */ String f$0;
    ...
    public void addInstallAppConfig(String pkgName) {
        this.mContainers.forEach(new BiConsumer(pkgName) {
            /* class com.android.server.wm.$$Lambda$HwMagicWinManager$No7hFNFfPHJfx9Z5KXRSMjZgmY */
            private final /* synthetic */ String f$0;
    ...
    public void dumpAppConfig(PrintWriter pw, String pkgName) {
        this.mContainers.forEach(new BiConsumer(pw, pkgName) {
            /* class com.android.server.wm.$$Lambda$HwMagicWinManager$qxZI9ONFA1ndF1S1Mo5S6dQyNlk */
            ...
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
                HwMagicWinManager.lambda$dumpAppConfig$9(this.f$0, this.f$1, (Integer) obj, (HwMagicContainer) obj2);
            }
        });
    }

    static /* synthetic */ void lambda$dumpAppConfig$9(PrintWriter pw, String pkgName, Integer key, HwMagicContainer container) {

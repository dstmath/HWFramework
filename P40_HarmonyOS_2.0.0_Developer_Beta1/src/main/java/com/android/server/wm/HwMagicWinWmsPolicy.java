...
public class HwMagicWinWmsPolicy extends HwMagicWinModulePolicy.ModulePolicy {
    ...
    private HwMagicWinModulePolicy.IPolicyOperation computePivotForMagic = new HwMagicWinModulePolicy.IPolicyOperation() {
        /* class com.android.server.wm.$$Lambda$HwMagicWinWmsPolicy$H4o5NvoYRtEQRdOGQo6l3i4jId8 */
    ...
    private HwMagicWinModulePolicy.IPolicyOperation getRotationAnima = new HwMagicWinModulePolicy.IPolicyOperation() {
        /* class com.android.server.wm.$$Lambda$HwMagicWinWmsPolicy$aZQoDnIDBQ29yVYWDKrjyrrCwjo */
    ...
    private HwMagicWinModulePolicy.IPolicyOperation updatePageTypeByKeyEvent = $$Lambda$HwMagicWinWmsPolicy$otdGgW1szbzdcbAp2CC9AQuIEI.INSTANCE;
    ...
    private HwMagicWinModulePolicy.IPolicyOperation updateWindowAttrs = new HwMagicWinModulePolicy.IPolicyOperation() {
        /* class com.android.server.wm.$$Lambda$HwMagicWinWmsPolicy$anAIq9SElDeKn2BbeISSLCdxvbQ */
    ...
    private HwMagicWinModulePolicy.IPolicyOperation updateWindowFrame = new HwMagicWinModulePolicy.IPolicyOperation() {
        /* class com.android.server.wm.$$Lambda$HwMagicWinWmsPolicy$GZKlhv5w89g4KW4Fh3oTXJGYLQ */
    ...
    public /* synthetic */ void lambda$new$0$HwMagicWinWmsPolicy(List params, Bundle result) {
        this.mMwManager.getAmsPolicy().getOrientationPolicy().getRotationAnima(params);
    }
    ...
    public /* synthetic */ void lambda$new$5$HwMagicWinWmsPolicy(List params, Bundle result) {
        ...
        if (container != null && !container.getBounds(5, false).equals(windowState.getBounds())) {
            ActivityRecordEx ar = this.mMwManager.getAmsPolicy().getTopActivity(container);
            if (ar == null || !ar.isFullScreenVideoInLandscape()) {
                int movementDistance = ((Integer) params.get(0)).intValue() - ((Integer) params.get(1)).intValue();
                ...
                if (middleLeft - leftLeft == movementDistance || rightLeft - leftLeft == movementDistance) {
                    result.putBoolean("IS_NEED_SYNC", true);
                } else if (windowState.isAppTokenNotEqual(ar)) {
                    if (leftLeft - rightLeft == movementDistance || leftLeft - middleLeft == movementDistance) {
                        result.putBoolean("IS_NEED_SYNC", true);
                    }
                }
            }
    ...
    static /* synthetic */ void lambda$new$10(List params, Bundle result) {
        Object curWindow = params.get(0);
        if (curWindow != null) {
            WindowStateEx curWindowEx = new WindowStateEx();
            curWindowEx.resetWindowState(curWindow);
            ActivityRecordEx activity = (ActivityRecordEx) Optional.ofNullable(curWindowEx).map($$Lambda$HwMagicWinWmsPolicy$lWW4ckzJKmBf4QkxBnZVeaUIWOg.INSTANCE).map($$Lambda$HwMagicWinWmsPolicy$vH0QRDmmRwsWH2Gp_XaU7J6qu8.INSTANCE).orElse(null);
            if (activity != null) {
    ...
    private boolean isClearTransitionAnimation(AppWindowTokenExt appWindowTokenExt, int transit, boolean isEnter) {
        ...
        boolean isClearAnimation2 = !isEnter;
        if (!isEnter || task == null) {
    ...
    private boolean isActivityFullMode(AppWindowTokenExt appWindowTokenExt) {
        TaskRecordEx taskRecordEx = (TaskRecordEx) Optional.ofNullable(appWindowTokenExt.getActivityRecordEx()).map($$Lambda$HwMagicWinWmsPolicy$5pqoRtyzDpucDck9nIxNFAtt4U.INSTANCE).orElse(null);
    ...
    public Animation getMagicAnimation(Animation animation, AppWindowTokenExt appWindowToken, int transit, boolean isEnter, Rect frame, boolean isAppLauncher) {
        ...
        if (isActivityFullMode(appWindowToken)) {
            ...
            if (!appWindowToken.inHwMagicWindowingMode()) {
                if (transit != 12 || isEnter || !isAppLauncher || (focusedTopStack = this.mMwManager.getAmsPolicy().getFocusedTopStack(container)) == null || !focusedTopStack.inHwMagicWindowingMode()) {
                    return animation;
                }
                return container.getAnimation().getMwWallpaperCloseAnimation();
            } else if (isClearTransitionAnimation(appWindowToken, transit, isEnter)) {
                return null;
            } else {
                setWindowFrame(appWindowToken, frame);
                return container.getAnimation().getMagicAppAnimation(animation, isEnter, transit);
            }
        }
    }

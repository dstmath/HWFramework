...
public final class HwWmConstants {
    public static final int DEFAULT_TV_THUMBNAIL_CORNER_RADIUS = 8;
    ...
    public static final PathInterpolator FRICTION_CURVE_INTERPOLATOR = new PathInterpolator(0.2f, 0.0f, 0.2f, 1.0f);
    ...
    public static final boolean IS_TV;
    ...
    public static final long TV_ANIMATION_DURATION = 350;

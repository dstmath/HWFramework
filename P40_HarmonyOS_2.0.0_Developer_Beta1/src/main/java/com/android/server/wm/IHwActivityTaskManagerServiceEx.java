...
public interface IHwActivityTaskManagerServiceEx {
    ...
    void dispatchSystemAlertWindowChange(String str, int i, boolean z);
    ...
    Bitmap getPadCastWallpaperBitmap(int i);
    ...
    boolean isDelayRemoveTask(int i);
    ...
    boolean isInBopdModeAndKoBackUpApp(String str);

    boolean isInDisplaySurfaceScaled();

    boolean isInForceRotateList(String str);

    boolean isInGameSpace(String str);

    boolean isInMultiWindowMode();

    boolean isInNoForceRotateList(String str);
    ...
    boolean isPendingShowStack(IBinder iBinder);
    ...
    boolean isSupportMagicRotatingScreen(String str);
    ...
    void notifyTvSplitWindowStateChange();

    void notifyWindowStateChange(String str, String str2, int i, Rect rect, float f, int i2, String str3, int i3, Rect rect2, float f2, int i4);
    ...
    void removeSplitScreenDividerBar(int i, boolean z, int i2);
    ...
    void resizeCombinedStack(int i, Rect rect, float f, int i2, Rect rect2, float f2);

    boolean resizeStack(IBinder iBinder, int i, Rect rect, float f);
    ...
    void setFocusableStack(int i, boolean z);
    ...
    void setTaskCombinedWindowingMode(int i, int i2, Rect rect, float f, int i3, int i4, Rect rect2, float f2);

    void setTaskStackHide(ActivityStack activityStack, boolean z);

    void setTaskWindowingMode(IBinder iBinder, int i, int i2, Rect rect, float f);
    ...
    boolean shouldPreventStartActivity(ActivityInfo activityInfo, int i, int i2, String str, int i3, Intent intent, WindowProcessController windowProcessController, ActivityOptions activityOptions, ActivityRecord activityRecord);
    ...
    boolean shouldReuseActivity(ActivityRecord activityRecord, ActivityRecord activityRecord2);
    ...
    void startActivityTvSplit(Intent intent, int i, Rect rect, float f, Rect rect2, float f2);
    ...
    void updateMagicInVisiblePkgs(ActivityRecord activityRecord, boolean z);

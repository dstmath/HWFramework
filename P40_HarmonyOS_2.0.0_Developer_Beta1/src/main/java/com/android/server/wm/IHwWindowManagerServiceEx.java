...
public interface IHwWindowManagerServiceEx {
    ...
    Animation createScreenRotationAnimation(int i, int i2, boolean z, Rect rect);
    ...
    LocalAnimationAdapter.AnimationSpec getChangingAnimationSpec(Rect rect, Rect rect2, DisplayInfo displayInfo, float f, boolean z, boolean z2);
    ...
    Animation loadTvMultiWindowAnimation(Animation animation, boolean z, int i, AppWindowToken appWindowToken, Rect rect);
    ...
    void notifyFocusViewLocationChange(List<Rect> list, ComponentName componentName);
    ...
    void registerFocusViewLocationChangeListener(IHwFocusViewLocationChangeListener iHwFocusViewLocationChangeListener);
    ...
    void registerPointerEventListener(IHwPointerEventListener iHwPointerEventListener, int i, int i2);
    ...
    void unregisterFocusViewLocationChangeListener();
    ...
    void unregisterPointerEventListener(int i);

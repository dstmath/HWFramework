...
public class ImmersiveModeConfirmation {
    ...
    private FrameLayout.LayoutParams getBubbleLayoutParams() {
        return new FrameLayout.LayoutParams(this.mContext.getResources().getDimensionPixelSize(17105212), -2, 49);
    }
    ...
    public class ClingWindowView extends FrameLayout {
        ...
        public void onAttachedToWindow() {
            ...
            ((Button) this.mClingLayout.findViewById(16909228)).setOnClickListener(new View.OnClickListener() {

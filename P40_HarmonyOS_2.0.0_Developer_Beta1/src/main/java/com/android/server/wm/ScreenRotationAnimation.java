...
public class ScreenRotationAnimation {
    ...
    private boolean mIsUseNewScreenShotAnim = false;
    ...
    Animation mScreenShotAnimation;
    final Transformation mScreenShotTransformation = new Transformation();
    ...
    private boolean startAnimation(SurfaceControl.Transaction t, long maxAnimationDuration, float animationScale, int finalWidth, int finalHeight, boolean dismissing, int exitAnim, int enterAnim) {
        ...
        if (exitAnim == 0 || enterAnim == 0) {
            ...
            if (context2 == null) {
                ...
                int rotateExitAnimationId = context2.getResources().getIdentifier(SCREEN_ROTATE_STR_CONST + delta + EXIT_STR_CONST, ANIM_STR_CONST, HWEXT_STR_CONST);
                rotateEnterAnimationId = this.mContext.getResources().getIdentifier(SCREEN_ROTATE_STR_CONST + delta + ENTER_STR_CONST, ANIM_STR_CONST, HWEXT_STR_CONST);
                if (!(rotateExitAnimationId == 0 || rotateEnterAnimationId == 0)) {
                    ...
                    this.mIsUseNewScreenShotAnim = (this.mRotateEnterAnimation == null || this.mRotateExitAnimation == null) ? false : true;
                }
                if (HwMwUtils.ENABLED) {
                    HwMwUtils.performPolicy(70, new Object[]{this, Integer.valueOf(delta), Integer.valueOf(finalHeight)});
                    if (this.mIsHwMagicWindow) {
                        this.mIsUseNewScreenShotAnim = false;
                    }
                }
                ...
                if (!this.mIsUseNewScreenShotAnim) {
                    Rect screenRect = new Rect(0, 0, this.mWidth, this.mHeight);
                    this.mRotateEnterAnimation = this.mService.mHwWMSEx.createScreenRotationAnimation(this.mOriginalRotation, this.mCurRotation, true, screenRect);
                    this.mScreenShotAnimation = this.mService.mHwWMSEx.createScreenRotationAnimation(this.mOriginalRotation, this.mCurRotation, false, screenRect);
                    this.mScreenShotAnimation.initialize(finalWidth, finalHeight, this.mOriginalWidth, this.mOriginalHeight);
                    this.mScreenShotAnimation.restrictDuration(maxAnimationDuration);
                    this.mScreenShotAnimation.scaleCurrentDuration(animationScale);
                }
                if (this.mContext != null && (this.mRotateExitAnimation == null || this.mRotateEnterAnimation == null)) {
                    if (delta != 0) {
            ...
            customAnim = true;
            if (context != null) {
                this.mRotateExitAnimation = AnimationUtils.loadAnimation(context, exitAnim);
    ...
    public void kill() {
        ...
        Animation animation4 = this.mFoldProjectionAnimation;
        if (animation4 != null) {
            animation4.cancel();
        ...
        if (this.mIsUseNewScreenShotAnim && (animation = this.mScreenShotAnimation) != null) {
            animation.cancel();
            this.mScreenShotAnimation = null;
        }
    }
    ...
    private boolean stepAnimation(long now) {
        ...
        Animation animation2 = this.mRotateExitAnimation;
        if (animation2 != null) {
            this.mMoreRotateExit = animation2.getTransformation(now, this.mRotateExitTransformation);
            if (this.mUsingFoldAnim) {
                stepAnimationToEnd(this.mRotateExitAnimation, now);
            }
        }
        Animation animation3 = this.mScreenShotAnimation;
        if (animation3 != null) {
            animation3.getTransformation(now, this.mScreenShotTransformation);
        }
        ...
        if (!this.mMoreRotateExit) {
            Animation animation5 = this.mRotateExitAnimation;
            if (animation5 != null) {
                animation5.cancel();
                this.mRotateExitAnimation = null;
                this.mRotateExitTransformation.clear();
            }
            Animation animation6 = this.mScreenShotAnimation;
            if (animation6 != null) {
                animation6.cancel();
                this.mScreenShotAnimation = null;
                this.mScreenShotTransformation.clear();
            }
        }
        ...
        if (!this.mIsUseNewScreenShotAnim || (transformation = this.mScreenShotTransformation) == null) {
            this.mSnapshotFinalMatrix.setConcat(this.mExitTransformation.getMatrix(), this.mSnapshotInitialMatrix);
        } else {
            this.mSnapshotFinalMatrix.setConcat(transformation.getMatrix(), this.mSnapshotInitialMatrix);
        }
        return more;
    }
    ...
    public void updateSurfaces(SurfaceControl.Transaction t) {
        ...
        if (this.mStarted) {
            ...
            if (!this.mIsUseNewScreenShotAnim || (transformation = this.mScreenShotTransformation) == null) {
                ...
                setSnapshotTransform(t, this.mSnapshotFinalMatrix, transformation.getAlpha());
                if (!(this.mSurfaceControl == null || this.mScreenShotTransformation.getClipRect() == null)) {
                    t.setWindowCrop(this.mSurfaceControl, this.mScreenShotTransformation.getClipRect());
                }
            }
            if (HwFoldScreenState.isFoldScreenDevice()) {

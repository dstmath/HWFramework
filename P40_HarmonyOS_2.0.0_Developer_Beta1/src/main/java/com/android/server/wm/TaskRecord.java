...
public class TaskRecord extends AbsTaskRecord {
    ...
    public void addActivityAtIndex(int index, ActivityRecord r) {
        ...
        if (task == null || task == this) {
            ...
            if (!TaskLaunchParamsModifier.isAppLockActivity(r.shortComponentName)) {
                isApplockTarget = false;
            }
            if (isApplockTarget) {
                this.mService.mRootActivityContainer.getHwRootActivityContainerEx().removeStartingAppLockTaskId(getStackId());
            }

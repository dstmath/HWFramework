...
public class Task {
    ...
    public static class TaskKey {
        ...
        @ViewDebug.ExportedProperty(category = "recents")
        public final int id;
        private boolean isSupportsHwFreeForm;
        @ViewDebug.ExportedProperty(category = "recents")
        ...
        public TaskKey(ActivityManager.RecentTaskInfo t) {
            ...
            try {
                this.isSupportsHwFreeForm = t.isSupportsHwFreeForm;
            } catch (NoSuchFieldError e) {
                this.isSupportsHwFreeForm = t.supportsSplitScreenMultiWindow;
                Log.e("TaskKey", "no isSupportsHwFreeForm");
            }
            updateHashCode();
        }
        ...
        public boolean supportHwFreeForm() {
            return this.isSupportsHwFreeForm;
        }

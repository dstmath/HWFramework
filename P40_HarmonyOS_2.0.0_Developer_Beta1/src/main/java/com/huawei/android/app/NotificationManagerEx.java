...
public class NotificationManagerEx {
    public static void enqueueToast(String packageName, TransientNotificationEx transientNotification, int duration) throws RemoteException {
        NotificationManager.getService().enqueueToast(packageName, transientNotification.getStub(), duration, 0);
    }
    ...
    public static Notification.Builder setAppName(Notification.Builder builder, CharSequence appName) {
        builder.setAppName(appName);
        return builder;
    }

    public static Notification.Builder setShowActionIcon(Notification.Builder builder, boolean showActionIcon) {

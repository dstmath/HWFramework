...
import android.view.IRotateCallback;
...
public class WindowManagerEx {
    private static final String CHARACTERISTICS = SystemProperties.get("ro.build.characteristics", PhoneConstantsEx.APN_TYPE_DEFAULT);
    ...
    public static void registerRotateCallback(IRotateCallback callback) {
        if (callback == null) {
            Log.w("WindowManagerEx", "registerRotateCallback can not be null");
        } else {
            HwWindowManager.registerRotateCallback(callback);
        }
    }

    public static void unregisterRotateCallback(IRotateCallback callback) {
        if (callback == null) {
            Log.w("WindowManagerEx", "unregisterRotateCallback can not be null");
        } else {
            HwWindowManager.unregisterRotateCallback(callback);
        }
    }
    ...
    public static void registerFocusViewLocationChangeListener(HwFocusViewLocationChangeListenerEx listener) {
        if (!IS_TV) {
            Log.e("WindowManagerEx", "registerFocusViewLocationChangeListener failed: is not Tv model.");
        } else if (listener == null) {
            Log.e("WindowManagerEx", "registerFocusViewLocationChangeListener listener is null.");
        } else {
            IHwWindowManager wm = HwWindowManager.getService();
            if (wm != null) {
                try {
                    wm.registerFocusViewLocationChangeListener(listener.getInnerListener());
                } catch (RemoteException e) {
                    Log.e("WindowManagerEx", "registerFocusViewLocationChangeListener failed: catch RemoteException!");
                }
            }
        }
    }

    public static void unregisterFocusViewLocationChangeListener() {
        if (!IS_TV) {
            Log.e("WindowManagerEx", "unregisterFocusViewLocationChangeListener failed: is not Tv model.");
            return;
        }
        IHwWindowManager wm = HwWindowManager.getService();
        if (wm != null) {
            try {
                wm.unregisterFocusViewLocationChangeListener();
            } catch (RemoteException e) {
                Log.e("WindowManagerEx", "unregisterFocusViewLocationChangeListener failed: catch RemoteException!");
            }
        }
    }
    ...
    public static void registerHwMultiDisplayBasicModeDragListener(HwMultiDisplayBasicModeDragListenerEx listener) {
        if (listener == null) {
            Log.e("WindowManagerEx", "registerHwMultiDisplayBasicModeDragListener listener is null.");
            return;
        }
        IHwWindowManager wm = HwWindowManager.getService();
        if (wm != null) {
            try {
                wm.registerHwMultiDisplayBasicModeDragListener(listener.getInnerListener());
            } catch (RemoteException e) {
                Log.e("WindowManagerEx", "registerHwMultiDisplayBasicModeDragListener failed: catch RemoteException!");
            }
        }
    }

    public static void unregisterHwMultiDisplayBasicModeDragListener() {
        IHwWindowManager wm = HwWindowManager.getService();
        if (wm != null) {
            try {
                wm.unregisterHwMultiDisplayBasicModeDragListener();
            } catch (RemoteException e) {
                Log.e("WindowManagerEx", "unregisterHwMultiDisplayBasicModeDragListener failed: catch RemoteException!");
            }
        }
    }
    ...
    public static boolean isDragDropActive() {
        ...
        try {
            return wm.isDragDropActive();
        } catch (RemoteException e) {
            Log.e("WindowManagerEx", "isDragDropActive failed: catch RemoteException!");
            return false;
        }
    }

    public static void setDragShadowVisible(boolean visible) {
        IHwWindowManager wm = HwWindowManager.getService();
        if (wm != null) {
            try {
                wm.setDragShadowVisible(visible);
            } catch (RemoteException e) {
                Log.e("WindowManagerEx", "setDragShadowVisible failed: catch RemoteException!");
            }
        }
    }

    public static void registerMouseEventListener(HwMouseEventListenerEx listener, int displayId) {
        if (listener == null) {
            Log.e("WindowManagerEx", "registerMouseEventListener listener is null.");
            return;
        }
        IHwWindowManager wm = HwWindowManager.getService();
        if (wm != null) {
            try {
                wm.registerMouseEventListener(listener.getInnerListener(), displayId);
            } catch (RemoteException e) {
                Log.e("WindowManagerEx", "registerMouseEventListener failed: catch RemoteException!");
            }
        }
    }

    public static void unregisterMouseEventListener(int displayId) {
        IHwWindowManager wm = HwWindowManager.getService();
        if (wm != null) {
            try {
                wm.unregisterMouseEventListener(displayId);
            } catch (RemoteException e) {
                Log.e("WindowManagerEx", "unregisterMouseEventListener failed: catch RemoteException!");
            }
        }
    }
    ...
    public static void cancelDragAndDrop(boolean skipAnimation) {
        IHwWindowManager wm = HwWindowManager.getService();
        if (wm != null) {
            try {
                wm.cancelDragAndDrop(skipAnimation);
            } catch (RemoteException e) {
                Log.e("WindowManagerEx", "cancelCurrentDragAndDrop failed: catch RemoteException!");
            }
        }
    }

    public static void setActivityVisibleInFingerBoost(boolean isVisible) {
        IHwWindowManager wm = HwWindowManager.getService();
        if (wm != null) {
            try {
                wm.setActivityVisibleInFingerBoost(isVisible);
            } catch (RemoteException e) {
                Log.e("WindowManagerEx", "setActivityVisibleInFingerBoost failed: catch RemoteException!");
            }
        } else {
            Log.e("WindowManagerEx", "setActivityVisibleInFingerBoost null HwWindowManager!");
        }
    }

    public static void registerPointerEventListener(final HwPointerEventListenerEx listener, int deviceSource, int displayId) {
        if (listener == null) {
            Log.e("WindowManagerEx", "registerPointerEventListener listener is null.");
            return;
        }
        IHwWindowManager wm = HwWindowManager.getService();
        if (wm != null) {
            try {
                wm.registerPointerEventListener(new IHwPointerEventListener.Stub() {
                    /* class com.huawei.android.app.WindowManagerEx.AnonymousClass2 */

                    public void onPointerEvent(Bundle bundle) {
                        HwPointerEventListenerEx.this.onPointerEvent(bundle);
                    }
                }, deviceSource, displayId);
            } catch (RemoteException e) {
                Log.e("WindowManagerEx", "registerPointerEventListener failed: catch RemoteException!");
            }
        }
    }

    public static void unregisterPointerEventListener(int displayId) {
        IHwWindowManager wm = HwWindowManager.getService();
        if (wm != null) {
            try {
                wm.unregisterPointerEventListener(displayId);
            } catch (RemoteException e) {
                Log.e("WindowManagerEx", "unregisterPointerEventListener failed: catch RemoteException!");
            }
        }
    }
}

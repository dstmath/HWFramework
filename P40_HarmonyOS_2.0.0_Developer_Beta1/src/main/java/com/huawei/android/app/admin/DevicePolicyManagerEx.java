...
public class DevicePolicyManagerEx {
    ...
    private static HwDevicePolicyManagerEx sDpm = new HwDevicePolicyManagerEx();

    private DevicePolicyManagerEx() {
    }

    public static int getSDCardEncryptionStatus() {
        return sDpm.getSdCardEncryptionStatus();
    }

    public static void setSDCardDecryptionDisabled(ComponentName admin, boolean isDisabled) {
        sDpm.setSdCardDecryptionDisabled(admin, isDisabled);
    }

    public static boolean isSDCardDecryptionDisabled(ComponentName admin) {
        return sDpm.isSdCardDecryptionDisabled(admin);
    }

    public static boolean hasHwPolicy() {
        return sDpm.hasHwPolicy();
    }

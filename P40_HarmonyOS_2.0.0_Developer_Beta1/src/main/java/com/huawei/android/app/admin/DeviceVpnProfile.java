...
public final class DeviceVpnProfile {
    ...
    public DeviceVpnProfile(String key2, String name2, int type2, String server2, String username2, String password2, boolean isMppeEnabled, String l2tpSecret2, String ipsecIdentifier2, String ipsecSecret2, String ipsecUserCert2, String ipsecCaCert2, String ipsecServerCert2) {
        this.name = "";
        this.type = 0;
        this.server = "";
        this.username = "";
    ...
    public void setMppe(boolean isMppeEnabled) {
        this.mppe = isMppeEnabled;
    }

...
public class HwPackageManager {
    ...
    public static final int HW_FLAG_INSTALL_SOURCE_FOUNDATION = 16;
    ...
    public static HwPresetPackage getPresetPackage(String packageName) {
        try {
            return getService().getPresetPackage(packageName);
        } catch (RemoteException e) {
            Log.e(TAG, "getPresetPackage RemoteException ");
            return null;
        }
    }

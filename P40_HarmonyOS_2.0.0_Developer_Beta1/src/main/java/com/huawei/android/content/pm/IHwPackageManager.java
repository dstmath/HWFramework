...
public interface IHwPackageManager extends IInterface {
    ...
    FeatureInfo[] getHwSystemAvailableFeatures() throws RemoteException;
    ...
    HwPresetPackage getPresetPackage(String str) throws RemoteException;
    ...
    boolean hasHwSystemFeature(String str, int i) throws RemoteException;
    ...
    boolean setAllAppsUseSideModeAndStopApps(List<String> list, boolean z) throws RemoteException;
    ...
    public static class Default implements IHwPackageManager {
        ...
        @Override // com.huawei.android.content.pm.IHwPackageManager
        public boolean setAllAppsUseSideModeAndStopApps(List<String> list, boolean isUse) throws RemoteException {
            return false;
        }
        ...
        @Override // com.huawei.android.content.pm.IHwPackageManager
        public HwPresetPackage getPresetPackage(String packageName) throws RemoteException {
            return null;
        }
        ...
        @Override // com.huawei.android.content.pm.IHwPackageManager
        public FeatureInfo[] getHwSystemAvailableFeatures() throws RemoteException {
            return null;
        }

        @Override // com.huawei.android.content.pm.IHwPackageManager
        public boolean hasHwSystemFeature(String featureName, int version) throws RemoteException {
            return false;
        }
    ...
    public static abstract class Stub extends Binder implements IHwPackageManager {
        ...
        static final int TRANSACTION_canGrantDPermissions = 39;
        static final int TRANSACTION_clearPreferredActivityAsUser = 32;
        ...
        static final int TRANSACTION_getClusterApplications = 41;
        static final int TRANSACTION_getDisplayChangeAppRestartConfig = 49;
        static final int TRANSACTION_getForceDarkSetting = 38;
        static final int TRANSACTION_getHwPublicityAppList = 8;
        static final int TRANSACTION_getHwPublicityAppParcelFileDescriptor = 9;
        static final int TRANSACTION_getHwRenamedPackages = 40;
        static final int TRANSACTION_getHwSystemAvailableFeatures = 50;
        static final int TRANSACTION_getInstalledHep = 42;
        static final int TRANSACTION_getMapleEnableFlag = 35;
        static final int TRANSACTION_getMspesOEMConfig = 21;
        static final int TRANSACTION_getOpenFileResult = 48;
        static final int TRANSACTION_getPreinstalledApkList = 7;
        static final int TRANSACTION_getPresetPackage = 43;
        ...
        static final int TRANSACTION_getVersionMatchFlag = 46;
        static final int TRANSACTION_hasHwSystemFeature = 51;
        static final int TRANSACTION_isAllAppsUseSideMode = 31;
        ...
        static final int TRANSACTION_registerExtServiceProvider = 33;
        static final int TRANSACTION_restoreAllAppsUseSideMode = 30;
        static final int TRANSACTION_scanInstallApk = 14;
        static final int TRANSACTION_setAllAppsUseSideMode = 28;
        static final int TRANSACTION_setAllAppsUseSideModeAndStopApps = 29;
        ...
        static final int TRANSACTION_setForceDarkSetting = 37;
        static final int TRANSACTION_setHdbKey = 16;
        static final int TRANSACTION_setMapleEnableFlag = 36;
        static final int TRANSACTION_setOpenFileResult = 47;
        static final int TRANSACTION_setVersionMatchFlag = 45;
        static final int TRANSACTION_shouldSkipTriggerFreeform = 24;
        static final int TRANSACTION_startBackupSession = 10;
        static final int TRANSACTION_uninstallHep = 44;
        static final int TRANSACTION_unregisterExtServiceProvider = 34;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 29:
                    return "setAllAppsUseSideModeAndStopApps";
                case 30:
                ...
                case 50:
                    return "getHwSystemAvailableFeatures";
                case 51:
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 4:
                        ...
                        setAppCanUninstall(_arg04, _arg2);
                        reply.writeNoException();
                        return true;
                    case 5:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 17:
                        ...
                        boolean pmInstallHwTheme = pmInstallHwTheme(_arg05, _arg2, data.readInt());
                        reply.writeNoException();
                    ...
                    case 28:
                        ...
                        boolean allAppsUseSideMode = setAllAppsUseSideMode(_arg2);
                        reply.writeNoException();
                    ...
                    case 29:
                        ...
                        boolean allAppsUseSideModeAndStopApps = setAllAppsUseSideModeAndStopApps(_arg06, _arg2);
                        reply.writeNoException();
                        reply.writeInt(allAppsUseSideModeAndStopApps ? 1 : 0);
                        return true;
                    case 30:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 32:
                        ...
                        ComponentName[] _arg22 = (ComponentName[]) data.createTypedArray(ComponentName.CREATOR);
                        if (data.readInt() != 0) {
                            _arg3 = ComponentName.CREATOR.createFromParcel(data);
                        } else {
                            _arg3 = null;
                        }
                        clearPreferredActivityAsUser(_arg0, _arg12, _arg22, _arg3, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 33:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 36:
                        ...
                        setMapleEnableFlag(_arg08, _arg2);
                        reply.writeNoException();
                        return true;
                    case 37:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 41:
                        ...
                        List<ApplicationInfo> _result20 = getClusterApplications(_arg09, _arg13, _arg2);
                        reply.writeNoException();
                    ...
                    case 43:
                        data.enforceInterface(DESCRIPTOR);
                        HwPresetPackage _result22 = getPresetPackage(data.readString());
                        reply.writeNoException();
                        if (_result22 != null) {
                            reply.writeInt(1);
                    ...
                    case 44:
                        data.enforceInterface(DESCRIPTOR);
                        int _result23 = uninstallHep(data.readString(), data.readInt());
                        reply.writeNoException();
                    ...
                    case 45:
                        ...
                        setVersionMatchFlag(_arg010, _arg14, _arg2);
                        reply.writeNoException();
                        return true;
                    case 46:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 48:
                        ...
                        int _result24 = getOpenFileResult(_arg03);
                        reply.writeNoException();
                        reply.writeInt(_result24);
                        return true;
                    case 49:
                        data.enforceInterface(DESCRIPTOR);
                        int _result25 = getDisplayChangeAppRestartConfig(data.readInt(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result25);
                        return true;
                    case 50:
                        data.enforceInterface(DESCRIPTOR);
                        FeatureInfo[] _result26 = getHwSystemAvailableFeatures();
                        reply.writeNoException();
                        reply.writeTypedArray(_result26, 1);
                        return true;
                    case 51:
                        data.enforceInterface(DESCRIPTOR);
                        boolean hasHwSystemFeature = hasHwSystemFeature(data.readString(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(hasHwSystemFeature ? 1 : 0);
                        return true;
                    default:
        ...
        public static class Proxy implements IHwPackageManager {
            ...
            @Override // com.huawei.android.content.pm.IHwPackageManager
            public boolean setAllAppsUseSideModeAndStopApps(List<String> pkgs, boolean isUse) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    if (!this.mRemote.transact(29, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setAllAppsUseSideModeAndStopApps(pkgs, isUse);
                    }
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
            ...
            public HwPresetPackage getPresetPackage(String packageName) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(43, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getPresetPackage(packageName);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = HwPresetPackage.CREATOR.createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    _reply.recycle();
            ...
            public FeatureInfo[] getHwSystemAvailableFeatures() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(50, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getHwSystemAvailableFeatures();
                    }
                    _reply.readException();
            ...
            public boolean hasHwSystemFeature(String featureName, int version) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(51, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().hasHwSystemFeature(featureName, version);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;

...
public interface IHwInputManager extends IInterface {
    ...
    int[] runSideTouchCommandByType(int i, Bundle bundle) throws RemoteException;
    ...
    public static class Default implements IHwInputManager {
        ...
        @Override // com.huawei.android.hardware.input.IHwInputManager
        public int[] runSideTouchCommandByType(int type, Bundle bundle) throws RemoteException {
            return null;
        }
    ...
    public static abstract class Stub extends Binder implements IHwInputManager {
        ...
        static final int TRANSACTION_runSideTouchCommandByType = 6;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 6:
                    return "runSideTouchCommandByType";
                case 7:
            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 6:
                        ...
                        int[] _result3 = runSideTouchCommandByType(_arg02, _arg1);
                        reply.writeNoException();
            ...
            public int[] runSideTouchCommandByType(int type, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(6, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().runSideTouchCommandByType(type, bundle);
                    }
                    _reply.readException();

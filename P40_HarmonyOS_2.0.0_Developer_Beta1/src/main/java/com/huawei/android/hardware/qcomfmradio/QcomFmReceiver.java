...
public class QcomFmReceiver extends FmTransceiver implements BaseFmReceiver {
    ...
    public static boolean isCherokeeChip() {
        if (SystemPropertiesEx.get("vendor.qcom.bluetooth.soc", "cherokee").equals("cherokee")) {
            return true;
        }
        return false;
    }
    ...
    /* JADX INFO: Multiple debug info for r7v3 byte: [D('tag_start_pos' byte), D('j' int)] */
    ...
    public void FMcontrolLowPassFilter(int state, int net_type, int enable) {
        ...
        switch (net_type) {
            ...
            case 9:
                ...
                return;
            case HwMtpConstants.TYPE_UINT128 /* 10 */:

...
import huawei.android.widget.HwCompoundEventDetectorImpl;
import huawei.android.widget.HwFastScroller;
import huawei.android.widget.HwGenericEventDetectorImpl;
import huawei.android.widget.HwImageViewZoomImpl;
import huawei.android.widget.HwKeyEventDetectorImpl;
import huawei.android.widget.HwOverflowMenuButton;
import huawei.android.widget.HwPlumeImpl;
...
public class HwWidgetFactoryImpl implements HwWidgetFactory.Factory {
    ...
    public int getThemeIdImpl(Bundle data, Resources res) {
        ...
        try {
            ...
            Log.e(TAG, "Bad parcel target when calling getThemeIdImpl.");
            return 0;
        }
    }
    ...
    public IHwWechatOptimize getHwWechatOptimizeImpl() {
        return HwPartIawareFactory.loadFactory("android.common.HwPartIawareFactoryImpl").getHwWechatOptimizeImpl();
    }
    ...
    public Drawable getDesireCompoundButtonDrawable(Context context, CompoundButton view, TypedArray typedArray, int defButtonArrayIndex) {
        ...
        if (context == null || view == null) {
            ...
            if (view instanceof RadioButton) {
                ...
                } else if (defButtonDrawableResId == 33751544 || defButtonDrawableResId == 33751538) {
    ...
    public Drawable getDesireCheckMarkDrawable(Context context, TypedArray typedArray, int defCheckMarkTypedArrayIndex) {
        ...
        if (context == null) {
            ...
            } else if (defCheckMarkDrawableResId == 33751544 || defCheckMarkDrawableResId == 33751538) {
    ...
    public DecorCaptionView getHwMultiWindowCaptionView(LayoutInflater inflater, int windowMode) {
        if (WindowConfiguration.isHwFreeFormWindowingMode(windowMode)) {
            View decorCaptionView = inflater.inflate(34013361, (ViewGroup) null);
            ...
            View decorCaptionView2 = inflater.inflate(34013363, (ViewGroup) null);
    ...
    public HwKeyEventDetector getKeyEventDetector(Context context) {
        return new HwKeyEventDetectorImpl(context);
    }

    public HwGenericEventDetector getGenericEventDetector(Context context) {
        return new HwGenericEventDetectorImpl(context);
    }

    public HwCompoundEventDetector getCompoundEventDetector(Context context) {
        return new HwCompoundEventDetectorImpl(context);
    }

    public HwImageViewZoom getImageViewZoom(Context context, ImageView imageView) {
        return new HwImageViewZoomImpl(context, imageView);
    }

    public HwPlume getHwPlume(Context context) {
        return new HwPlumeImpl(context);
    }
}

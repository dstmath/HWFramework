...
public interface IHwInputMethodManager extends IInterface {
    ...
    void raiseIawarePriority() throws RemoteException;

    void recoveryIawarePriority() throws RemoteException;
    ...
    void sendChangeInputMsg(int i) throws RemoteException;

    int sendEventData(int i, String str) throws RemoteException;
    ...
    public static class Default implements IHwInputMethodManager {
        ...
        @Override // com.huawei.android.inputmethod.IHwInputMethodManager
        public int sendEventData(int dataType, String dataStr) throws RemoteException {
            return 0;
        }

        @Override // com.huawei.android.inputmethod.IHwInputMethodManager
        public void raiseIawarePriority() throws RemoteException {
        }

        @Override // com.huawei.android.inputmethod.IHwInputMethodManager
        public void recoveryIawarePriority() throws RemoteException {
        }

        @Override // com.huawei.android.inputmethod.IHwInputMethodManager
        public void sendChangeInputMsg(int changeInputReason) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IHwInputMethodManager {
        ...
        static final int TRANSACTION_raiseIawarePriority = 18;
        static final int TRANSACTION_recoveryIawarePriority = 19;
        ...
        static final int TRANSACTION_sendChangeInputMsg = 20;
        static final int TRANSACTION_sendEventData = 17;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 18:
                    return "raiseIawarePriority";
                case 19:
                    return "recoveryIawarePriority";
                case 20:
                    return "sendChangeInputMsg";
                default:
                    return null;
            }
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 17:
                        data.enforceInterface(DESCRIPTOR);
                        int _result3 = sendEventData(data.readInt(), data.readString());
                        reply.writeNoException();
                    ...
                    case 19:
                        data.enforceInterface(DESCRIPTOR);
                        recoveryIawarePriority();
                        reply.writeNoException();
                        return true;
                    case 20:
                        data.enforceInterface(DESCRIPTOR);
                        sendChangeInputMsg(data.readInt());
                        reply.writeNoException();
                        return true;
                    default:
        ...
        public static class Proxy implements IHwInputMethodManager {
            ...
            public int sendEventData(int dataType, String dataStr) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(dataStr);
                    if (!this.mRemote.transact(17, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().sendEventData(dataType, dataStr);
                    }
                    _reply.readException();
            ...
            public void raiseIawarePriority() throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().raiseIawarePriority();
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void recoveryIawarePriority() throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().recoveryIawarePriority();
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void sendChangeInputMsg(int changeInputReason) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(changeInputReason);
                    ...
                    Stub.getDefaultImpl().sendChangeInputMsg(changeInputReason);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }

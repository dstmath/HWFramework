...
public class PowerManagerEx {
    ...
    @HwSystemApi
    public static final int WAKE_REASON_MAGNETIC = 103;
    @HwSystemApi
    ...
    private static volatile PowerManagerEx sSelf = null;
    ...
    public static PowerManagerEx getDefault() {
        ...
        synchronized (PowerManagerEx.class) {
            if (sSelf == null) {
                sSelf = new PowerManagerEx();
            }
            powerManagerEx = sSelf;
        }
    ...
    public int setAodBrightness(int brightness) {
        return HwPowerManager.setAodBrightness(brightness);
    }
}

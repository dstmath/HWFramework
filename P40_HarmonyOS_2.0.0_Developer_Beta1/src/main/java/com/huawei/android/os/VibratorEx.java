...
public class VibratorEx {
    ...
    public static final String HW_VIBRATOR_TYPE_WATCH_ALARMCLOCK_NOTIFICATION = "watchhaptic.alarmclock.notification";
    public static final String HW_VIBRATOR_TYPE_WATCH_APPLICATION_MESSAGE_NOTIFICATION = "watchhaptic.application.message.notification";
    public static final String HW_VIBRATOR_TYPE_WATCH_BAROMETER_WARNING = "watchhaptic.barometer.warning";
    public static final String HW_VIBRATOR_TYPE_WATCH_BATTERY_CHARGING_SUCCESS = "watchhaptic.battery.charging.success";
    public static final String HW_VIBRATOR_TYPE_WATCH_BLUETOOTHBREAK_WARNING = "watchhaptic.bluetoothbreak.warning";
    public static final String HW_VIBRATOR_TYPE_WATCH_BREATHTAKE_SPEED1 = "watchhaptic.breathtake.speed1";
    public static final String HW_VIBRATOR_TYPE_WATCH_BREATHTAKE_SPEED2 = "watchhaptic.breathtake.speed2";
    public static final String HW_VIBRATOR_TYPE_WATCH_BREATHTAKE_SPEED3 = "watchhaptic.breathtake.speed3";
    public static final String HW_VIBRATOR_TYPE_WATCH_CARDPAY_FAIL = "watchhaptic.cardpay.fail";
    public static final String HW_VIBRATOR_TYPE_WATCH_CARDPAY_SUCCESS = "watchhaptic.cardpay.success";
    public static final String HW_VIBRATOR_TYPE_WATCH_CHANGE_LONGPRESS = "watchhaptic.watchface.change.long_press";
    public static final String HW_VIBRATOR_TYPE_WATCH_CROWN_STRENGTH1 = "watchhaptic.crown.strength1";
    public static final String HW_VIBRATOR_TYPE_WATCH_CROWN_STRENGTH2 = "watchhaptic.crown.strength2";
    public static final String HW_VIBRATOR_TYPE_WATCH_CROWN_STRENGTH3 = "watchhaptic.crown.strength3";
    public static final String HW_VIBRATOR_TYPE_WATCH_EXCERCISE_HEARTBEAT_WARNING = "watchhaptic.excercise.heartbeat.warning";
    public static final String HW_VIBRATOR_TYPE_WATCH_EXCERCISE_NOTIFICATION = "watchhaptic.exercise.notification";
    public static final String HW_VIBRATOR_TYPE_WATCH_EXERCISE_LONGPRESS = "watchhaptic.exercise.long_press";
    public static final String HW_VIBRATOR_TYPE_WATCH_EXERCISE_START_END_PAUSE = "watchhaptic.exercise.start_end_pause";
    public static final String HW_VIBRATOR_TYPE_WATCH_HEARTBEATHIGH_WARNING = "watchhaptic.heartbeathigh.warning";
    public static final String HW_VIBRATOR_TYPE_WATCH_LAUNCHER_LONGPRESS = "watchhaptic.launcher.long_press";
    public static final String HW_VIBRATOR_TYPE_WATCH_LOWBATTERY_WARNING = "watchhaptic.lowbattery.warning";
    public static final String HW_VIBRATOR_TYPE_WATCH_MESSAGE_NOTIFICATION = "watchhaptic.message.notification";
    public static final String HW_VIBRATOR_TYPE_WATCH_PHONEPAIR_REQUIRING = "watchhaptic.phonepair.requiring";
    public static final String HW_VIBRATOR_TYPE_WATCH_PHONEPAIR_SUCCESS = "watchhaptic.phonepair.success";
    public static final String HW_VIBRATOR_TYPE_WATCH_REMOTECAMERA_LONG = "watchhaptic.remotecamera.long";
    public static final String HW_VIBRATOR_TYPE_WATCH_REMOTECAMERA_SHORT = "watchhaptic.remotecamera.short";
    public static final String HW_VIBRATOR_TYPE_WATCH_SITLONGTIME_NOTIFICATION = "watchhaptic.sitlongtime.notification";
    public static final String HW_VIBRATOR_TYPE_WATCH_SPO2MEASURE_FINISH = "watchhaptic.spo2measure.finish";
    public static final String HW_VIBRATOR_TYPE_WATCH_SYSTEMTYPE_STRENGTH1 = "watchhaptic.systemtype.strength1";
    public static final String HW_VIBRATOR_TYPE_WATCH_SYSTEMTYPE_STRENGTH2 = "watchhaptic.systemtype.strength2";
    public static final String HW_VIBRATOR_TYPE_WATCH_SYSTEMTYPE_STRENGTH3 = "watchhaptic.systemtype.strength3";
    public static final String HW_VIBRATOR_TYPE_WATCH_SYSTEMTYPE_STRENGTH4 = "watchhaptic.systemtype.strength4";
    public static final String HW_VIBRATOR_TYPE_WATCH_SYSTEMTYPE_STRENGTH5 = "watchhaptic.systemtype.strength5";
    public static final String HW_VIBRATOR_TYPE_WATCH_SYSTEMTYPE_STRENGTH6 = "watchhaptic.systemtype.strength6";
    public static final String HW_VIBRATOR_TYPE_WATCH_SYSTEMTYPE_STRENGTH7 = "watchhaptic.systemtype.strength7";
    public static final String HW_VIBRATOR_TYPE_WATCH_SYSTEM_EMERGENCY_WARNING = "watchhaptic.system.emergency.warning";
    public static final String HW_VIBRATOR_TYPE_WATCH_TILES_LONGPRESS = "watchhaptic.tiles.long_press";
    public static final String HW_VIBRATOR_TYPE_WATCH_TIMER_NOTIFICATION = "watchhaptic.timer.notification";

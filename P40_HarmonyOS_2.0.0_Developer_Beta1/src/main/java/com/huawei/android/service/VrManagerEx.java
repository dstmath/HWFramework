...
public class VrManagerEx {
    ...
    private static final Singleton<IVrManager> VR_MANAGER_SINGLETON = new Singleton<IVrManager>() {
        /* class com.huawei.android.service.VrManagerEx.AnonymousClass1 */
    ...
    private static IVrManager getDefault() {
        return (IVrManager) VR_MANAGER_SINGLETON.get();
    }

...
public class SignalStrengthEx {
    ...
    @HwSystemApi
    public static int getGsmLevel(SignalStrength signal) {
        if (signal != null) {
            return signal.getGsmLevel();
        }
        return INVALID;
    ...
    @HwSystemApi
    public static int getWcdmaLevel(SignalStrength signal) {
        if (signal != null) {
            return signal.getWcdmaLevel();
        }
        return INVALID;
    ...
    @HwSystemApi
    public static int getLteLevel(SignalStrength signal) {
        if (signal != null) {
            return signal.getLteLevel();
        }
        return INVALID;

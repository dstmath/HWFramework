...
public class TelephonyManagerEx {
    ...
    @HwSystemApi
    public static int getNetworkType(Context context, int subId) {
        return TelephonyManager.from(context).getNetworkType(subId);
    }

    @HwSystemApi
    public static int getSimState(int slotIndex) {
        return TelephonyManager.getDefault().getSimState(slotIndex);
    }
    ...
    public static int getDataState() {
        return TelephonyManager.getDefault().getDataState();
    }

    @HwSystemApi
    public static String getNetworkOperatorForPhone(int phoneId) {
        return TelephonyManager.getDefault().getNetworkOperatorForPhone(phoneId);
    }

    @HwSystemApi
    public static boolean setRadioPower(boolean isTurnOn) {
        return TelephonyManager.getDefault().setRadioPower(isTurnOn);
    }
}

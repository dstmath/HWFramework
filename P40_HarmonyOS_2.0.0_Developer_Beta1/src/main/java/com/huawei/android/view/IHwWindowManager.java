...
public interface IHwWindowManager extends IInterface {
    ...
    void notifyFocusViewLocationChange(List<Rect> list, ComponentName componentName) throws RemoteException;
    ...
    void registerFocusViewLocationChangeListener(IHwFocusViewLocationChangeListener iHwFocusViewLocationChangeListener) throws RemoteException;
    ...
    void registerPointerEventListener(IHwPointerEventListener iHwPointerEventListener, int i, int i2) throws RemoteException;
    ...
    void unregisterFocusViewLocationChangeListener() throws RemoteException;
    ...
    void unregisterPointerEventListener(int i) throws RemoteException;
    ...
    public static class Default implements IHwWindowManager {
        ...
        @Override // com.huawei.android.view.IHwWindowManager
        public void registerPointerEventListener(IHwPointerEventListener listener, int deviceSource, int displayId) throws RemoteException {
        }

        @Override // com.huawei.android.view.IHwWindowManager
        public void unregisterPointerEventListener(int displayId) throws RemoteException {
        }

        @Override // com.huawei.android.view.IHwWindowManager
        public void notifyFocusViewLocationChange(List<Rect> list, ComponentName componentName) throws RemoteException {
        }

        @Override // com.huawei.android.view.IHwWindowManager
        public void registerFocusViewLocationChangeListener(IHwFocusViewLocationChangeListener listener) throws RemoteException {
        }

        @Override // com.huawei.android.view.IHwWindowManager
        public void unregisterFocusViewLocationChangeListener() throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IHwWindowManager {
        ...
        static final int TRANSACTION_cancelDragAndDrop = 65;
        static final int TRANSACTION_dismissKeyguardLw = 25;
        static final int TRANSACTION_dragStartForBasicMode = 40;
        static final int TRANSACTION_dragStartForMultiDisplay = 43;
        static final int TRANSACTION_dropStartForMultiDisplay = 46;
        static final int TRANSACTION_freezeOrThawRotation = 21;
        static final int TRANSACTION_getAppUseNotchMode = 9;
        static final int TRANSACTION_getBounds = 30;
        static final int TRANSACTION_getCurrFocusedWinInExtDisplay = 16;
        static final int TRANSACTION_getDeviceMaxRatio = 2;
        static final int TRANSACTION_getDragSrcPkgName = 55;
        ...
        static final int TRANSACTION_getRestrictedScreenHeight = 22;
        static final int TRANSACTION_getSafeInsets = 29;
        static final int TRANSACTION_getTopActivityAdaptNotchState = 61;
        static final int TRANSACTION_getTopAppDisplayBounds = 3;
        static final int TRANSACTION_getTouchedWinPackageName = 31;
        static final int TRANSACTION_getVisibleWindows = 12;
        static final int TRANSACTION_hasLighterViewInPCCastMode = 17;
        static final int TRANSACTION_isAppControlPolicyExists = 69;
        static final int TRANSACTION_isAppNeedExpand = 54;
        static final int TRANSACTION_isDragDropActive = 41;
        static final int TRANSACTION_isFullScreenDevice = 1;
        static final int TRANSACTION_isNavigationBarVisible = 24;
        static final int TRANSACTION_isNeedExceptDisplaySide = 53;
        static final int TRANSACTION_isNeedForbidDialogAct = 66;
        static final int TRANSACTION_isSwitched = 56;
        static final int TRANSACTION_isTaskPositionDebugOpen = 68;
        static final int TRANSACTION_isWindowSupportKnuckle = 23;
        static final int TRANSACTION_notifyDragAndDropForMultiDisplay = 32;
        static final int TRANSACTION_notifyFocusViewLocationChange = 72;
        static final int TRANSACTION_notifySwingRotation = 28;
        static final int TRANSACTION_registerBitmapDragListenerForMultiDisplay = 35;
        static final int TRANSACTION_registerDragListenerForMultiDisplay = 33;
        static final int TRANSACTION_registerDropListenerForMultiDisplay = 44;
        static final int TRANSACTION_registerFocusViewLocationChangeListener = 73;
        static final int TRANSACTION_registerHwMultiDisplayBasicModeDragListener = 38;
        static final int TRANSACTION_registerHwMultiDisplayDragStateListener = 50;
        static final int TRANSACTION_registerIsDroppableForMultiDisplay = 47;
        static final int TRANSACTION_registerMouseEventListener = 62;
        static final int TRANSACTION_registerPhoneOperateListenerForHwMultiDisplay = 59;
        static final int TRANSACTION_registerPointerEventListener = 70;
        ...
        static final int TRANSACTION_restoreShadow = 57;
        static final int TRANSACTION_setAboveAppWindowsContainersVisible = 64;
        ...
        static final int TRANSACTION_setDragShadowVisible = 42;
        static final int TRANSACTION_setDragStartBitmap = 37;
        static final int TRANSACTION_setDroppableForMultiDisplay = 48;
        static final int TRANSACTION_setForcedDisplayDensityAndSize = 27;
        static final int TRANSACTION_setGestureNavMode = 26;
        static final int TRANSACTION_setOriginalDropPoint = 49;
        ...
        static final int TRANSACTION_unregisterBitmapDragListenerForMultiDisplay = 36;
        static final int TRANSACTION_unregisterDragListenerForMultiDisplay = 34;
        static final int TRANSACTION_unregisterDropListenerForMultiDisplay = 45;
        static final int TRANSACTION_unregisterFocusViewLocationChangeListener = 74;
        static final int TRANSACTION_unregisterHwMultiDisplayBasicModeDragListener = 39;
        static final int TRANSACTION_unregisterHwMultiDisplayDragStateListener = 51;
        static final int TRANSACTION_unregisterMouseEventListener = 63;
        static final int TRANSACTION_unregisterPhoneOperateListenerForHwMultiDisplay = 60;
        static final int TRANSACTION_unregisterPointerEventListener = 71;
        static final int TRANSACTION_unregisterRotateObserver = 5;
        static final int TRANSACTION_updateAppView = 6;
        static final int TRANSACTION_updateDragState = 52;
        static final int TRANSACTION_updateFocusWindowFreezed = 58;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 71:
                    return "unregisterPointerEventListener";
                case 72:
                    return "notifyFocusViewLocationChange";
                case 73:
                    return "registerFocusViewLocationChangeListener";
                case 74:
                    return "unregisterFocusViewLocationChangeListener";
                default:
                    return null;
            }
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 22:
                        data.enforceInterface(DESCRIPTOR);
                        int _result8 = getRestrictedScreenHeight();
                        reply.writeNoException();
                    ...
                    case 29:
                        data.enforceInterface(DESCRIPTOR);
                        Rect _result9 = getSafeInsets(data.readInt());
                        reply.writeNoException();
                        if (_result9 != null) {
                            reply.writeInt(1);
                    ...
                    case 30:
                        data.enforceInterface(DESCRIPTOR);
                        List<Rect> _result10 = getBounds(data.readInt());
                        reply.writeNoException();
                        reply.writeTypedList(_result10);
                        return true;
                    case 31:
                        data.enforceInterface(DESCRIPTOR);
                        String _result11 = getTouchedWinPackageName(data.readFloat(), data.readFloat(), data.readInt());
                        reply.writeNoException();
                    ...
                    case 32:
                        ...
                        boolean notifyDragAndDropForMultiDisplay = notifyDragAndDropForMultiDisplay(_arg09, _arg15, _arg2, _arg3);
                        reply.writeNoException();
                    ...
                    case 48:
                        ...
                        setDroppableForMultiDisplay(_arg010, _arg16, _arg07);
                        reply.writeNoException();
                        return true;
                    case 49:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 55:
                        data.enforceInterface(DESCRIPTOR);
                        String _result12 = getDragSrcPkgName();
                        reply.writeNoException();
                    ...
                    case 61:
                        data.enforceInterface(DESCRIPTOR);
                        int _result13 = getTopActivityAdaptNotchState(data.readString());
                        reply.writeNoException();
                    ...
                    case 70:
                        data.enforceInterface(DESCRIPTOR);
                        registerPointerEventListener(IHwPointerEventListener.Stub.asInterface(data.readStrongBinder()), data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 71:
                        data.enforceInterface(DESCRIPTOR);
                        unregisterPointerEventListener(data.readInt());
                        reply.writeNoException();
                        return true;
                    case 72:
                        data.enforceInterface(DESCRIPTOR);
                        List<Rect> _arg013 = data.createTypedArrayList(Rect.CREATOR);
                        if (data.readInt() != 0) {
                            _arg14 = ComponentName.CREATOR.createFromParcel(data);
                        } else {
                            _arg14 = null;
                        }
                        notifyFocusViewLocationChange(_arg013, _arg14);
                        return true;
                    case 73:
                        data.enforceInterface(DESCRIPTOR);
                        registerFocusViewLocationChangeListener(IHwFocusViewLocationChangeListener.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 74:
                        data.enforceInterface(DESCRIPTOR);
                        unregisterFocusViewLocationChangeListener();
                        reply.writeNoException();
                        return true;
                    default:
        ...
        public static class Proxy implements IHwWindowManager {
            ...
            public void registerPointerEventListener(IHwPointerEventListener listener, int deviceSource, int displayId) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().registerPointerEventListener(listener, deviceSource, displayId);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void unregisterPointerEventListener(int displayId) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().unregisterPointerEventListener(displayId);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            @Override // com.huawei.android.view.IHwWindowManager
            public void notifyFocusViewLocationChange(List<Rect> focusAreas, ComponentName componentName) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    if (this.mRemote.transact(72, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        ...
                        Stub.getDefaultImpl().notifyFocusViewLocationChange(focusAreas, componentName);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void registerFocusViewLocationChangeListener(IHwFocusViewLocationChangeListener listener) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().registerFocusViewLocationChangeListener(listener);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void unregisterFocusViewLocationChangeListener() throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().unregisterFocusViewLocationChangeListener();
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }

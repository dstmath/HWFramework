...
public class InputConsumerEx {
    ...
    private static final Singleton<IWindowManager> WINDOW_MANAGER_SINGLETON = new Singleton<IWindowManager>() {
    ...
    public static void createInputConsumer(IBinder token, String name, int displayId, InputChannelEx inputChannelEx) {
        IWindowManager mWindowManager = (IWindowManager) WINDOW_MANAGER_SINGLETON.get();

...
public class InputMethodManagerEx {
    ...
    public static void onPreWindowFocus(InputMethodManager imm, View rootView, boolean isHasWindowFocus) {
        imm.onPreWindowFocus(rootView, isHasWindowFocus);
    }
    ...
    public static int sendEventData(int dataType, String dataStr) {
        ...
        return HwInputMethodManager.sendEventData(dataType, dataStr);
    }

    public static void sendChangeInputMsg(int changeInputReason) {
        HwInputMethodManager.sendChangeInputMsg(changeInputReason);
    }
}

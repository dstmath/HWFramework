...
public class CoMessengerClient {
    ...
    public void disConnectServer(Context context) {
        CoAuthServiceConnection coAuthServiceConnection;
        if (context == null || (coAuthServiceConnection = this.connection) == null) {
            Log.e(TAG, "CoAuth disConnectServer input invalid");
            return;
        }
        try {
            context.unbindService(coAuthServiceConnection);
            if (this.connection.callback != null) {
                this.connection.callback.onDisconnect();
            }
        } catch (IllegalArgumentException e) {
            Log.e(TAG, "CoAuth disConnectServer error");
        }

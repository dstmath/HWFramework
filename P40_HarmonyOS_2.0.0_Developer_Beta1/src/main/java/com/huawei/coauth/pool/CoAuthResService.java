...
public class CoAuthResService extends Service {
    ...
    private Intent getExplicitIntent(Intent implicitIntent) {
        ...
        ComponentName comp = new ComponentName(serviceInfo.serviceInfo.packageName, serviceInfo.serviceInfo.name);
        Intent explicit = new Intent(implicitIntent);
        explicit.setComponent(comp);
        return explicit;
    }
    ...
    public int registerToHwCoAuth(String gid, String udid, String profileSid, byte[] publicKey, ExecutorCallback callback) {
        throw new NoExtAPIException("Function not supported!");
    }

    public int unRegisterFromHwCoAuth(String gid, String udid, String profileSid) {
        throw new NoExtAPIException("Function not supported!");
    }
}

...
public class DisplayEngineInterface {
    ...
    private static final Map<String, Integer> ID_MAP = new HashMap<String, Integer>(128) {
...

        {
            ...
            put("FEATURE_GAME_ENHANCEMENT", 39);
            ...
            put("ACTION_GAME_PUBG", 55);
            put("ACTION_GAME_MOVIE", 56);

...
public interface IDisplayEngineService extends IInterface {
    ...
    public static final int DE_ACTION_FULLSCREEN_CUVA = 57;
    ...
    public static final int DE_ACTION_GAME_MOVIE = 56;
    public static final int DE_ACTION_GAME_PUBG = 55;
    public static final int DE_ACTION_IMAGE_EXIT = 13;
    public static final int DE_ACTION_LIVE_IMAGE = 11;
    public static final int DE_ACTION_MAX = 58;
    ...
    public static final int DE_ACTION_MOTION_DOWN = 53;
    ...
    public static final int DE_ACTION_MOTION_SWAP = 54;
    ...
    public static final int DE_DATA_MAX = 20;
    ...
    public static final int DE_DATA_TYPE_GAME_MODE = 19;
    ...
    public static final int DE_EVENT_HDR = 2;
    public static final int DE_EVENT_MAX = 3;
    ...
    public static final int DE_FEATURE_MAX = 40;
    ...
    public static final int DE_SCENE_ENHANCEMENT_GAME = 52;
    ...
    public static final int DE_SCENE_LIVE_WALLPAPER = 53;
    public static final int DE_SCENE_MAX = 55;
    ...
    public static final int DE_SCENE_QR_CODE = 54;
    ...
    public static final int FEATURE_GAME_ENHANCEMENT = 39;
    ...
    public static final int MT_CALIB_INFO_FULL_BLUE = 5;
    public static final int MT_CALIB_INFO_FULL_GREEN = 4;
    public static final int MT_CALIB_INFO_FULL_RED = 3;
    public static final int MT_CALIB_INFO_MAIN_BLUE = 2;
    public static final int MT_CALIB_INFO_MAIN_GREEN = 1;
    public static final int MT_CALIB_INFO_MAIN_RED = 0;
    public static final int MT_CALIB_INFO_NUM = 9;
    public static final int MT_CALIB_INFO_SCOPE_BLUE = 8;
    public static final int MT_CALIB_INFO_SCOPE_GREEN = 7;
    public static final int MT_CALIB_INFO_SCOPE_RED = 6;

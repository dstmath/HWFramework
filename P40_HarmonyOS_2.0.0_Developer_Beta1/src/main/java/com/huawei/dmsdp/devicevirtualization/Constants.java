...
public class Constants {
    ...
    public static final String KEEP_CHANNEL_ACTIVE = "keepChannelActive";
    public static final String KEEP_CHANNEL_ACTIVE_ONE_MINUTE = "keepChannelActiveOneMinute";
    ...
    public static final String TRANSPORT_CONFIG = "transport.parameter.config";
}

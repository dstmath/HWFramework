...
public class DMSDPConfig {
    ...
    public static final int CHANNEL_TYPE_WAUDIO = 13;
    ...
    public static final int DATA_TYPE_AIRSHARING_RESIZE_SOURCE_DISPLAY = 27;
    ...
    public static final int DATA_TYPE_HIPLAY_ALLCONNECT_EVENT = 39;
    public static final int DATA_TYPE_HIPLAY_EVENT = 29;
    ...
    public static final int DATA_TYPE_MOUSE_SHARE_STATUS = 28;
    public static final int DATA_TYPE_MSDP_PORT = 6;
    public static final int DATA_TYPE_PARTIAL_REFRESH_BASETIME = 38;
    public static final int DATA_TYPE_PARTIAL_REFRESH_DATA = 37;
    public static final int DATA_TYPE_REMOTE_DEVICE = 26;
    public static final int DATA_TYPE_SCREEN_EVENT = 15;
    public static final int DATA_TYPE_SET_VIRTUAL_MOUSE_POSITION = 23;
    public static final int DATA_TYPE_TV_NETWORK_WEAK = 20;
    public static final int DATA_TYPE_UPGRADE_DATA = 18;
    public static final int DATA_TYPE_VIRTUAL_INPUT_EVENT = 22;
    public static final int DATA_TYPE_VIRTUAL_MOUSE_DOWN = 24;
    public static final int DATA_TYPE_VIRTUAL_MOUSE_UP = 25;
    public static final int DATA_TYPE_VIRTUAl_KEY_EVENT = 10;
    public static final int DATA_TYPE_WAUDIO_EVENT = 19;
    ...
    public static final int DEVICE_EVENT_AUDIO_SYNC = 6;
    ...
    public static final String DEVICE_POLICY_KEY = "dmsdp_dynamic_audio_sync";
    ...
    public static final int DEVICE_SERVICE_TYPE_ALL = 98303;
    ...
    public static final int DEVICE_SERVICE_TYPE_MOUSEKEYBOARD = 16384;
    public static final int DEVICE_SERVICE_TYPE_NOTIFICATION = 8192;
    public static final int DEVICE_SERVICE_TYPE_PARTIALREFRESH = 65536;
    ...
    public static final int DEVICE_TYPE_COMBINATION_VOICEBOX = 10;
    ...
    public static final int ERROR_CODE_MAX_CONCURRENCE_REACHED = -18;
    ...
    public static final int HILINK_KEY_NEG_ERR0R = 1000;
    public static final int HILINK_KEY_NEG_RST_FORMAT_ERROR = 1001;
    public static final int HILINK_PORT_NEG_ERR0R = 1002;
    public static final int HILINK_PORT_NEG_RST_FORMAT_ERROR = 1003;
    public static final int HWTV_POLICY_LATENCY = 100;
    public static final int HWTV_POLICY_LATENCY_ONLY = 300;
    public static final int HWTV_POLICY_TIMESTAMP = 320;
    ...
    public static final int PAD_POLICY_LATENCY = 100;
    public static final int PAD_POLICY_LATENCY_ONLY = 150;
    public static final int PAD_POLICY_TIMESTAMP = 320;
    ...
    public enum FrameProcessStratgy {
        ...
        private FrameProcessStratgy(int key2) {
            this.key = key2;
        }
    ...
    public enum VirCameraType {
        ...
        private VirCameraType(int preEnableType2, String enableType2) {
            this.preEnableType = preEnableType2;

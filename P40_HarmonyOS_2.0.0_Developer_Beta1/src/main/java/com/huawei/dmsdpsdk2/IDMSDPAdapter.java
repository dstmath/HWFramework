...
public interface IDMSDPAdapter extends IInterface {
    ...
    public static class Default implements IDMSDPAdapter {
        ...
        @Override // com.huawei.dmsdpsdk2.IDMSDPAdapter
        public int openVirtualCameraStream(String appId, String deviceId, String serviceId, Map cameraParas, ICameraDataCallback callback) throws RemoteException {
            return 0;
        }
            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 32:
                        ...
                        return true;
                    case TRANSACTION_openVirtualCameraStream /* 33 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result31 = openVirtualCameraStream(data.readString(), data.readString(), data.readString(), data.readHashMap(getClass().getClassLoader()), ICameraDataCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        reply.writeInt(_result31);
                        return true;
                    case TRANSACTION_closeVirtualCameraStream /* 34 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result32 = closeVirtualCameraStream(data.readString(), data.readString(), data.readString());
                        reply.writeNoException();
        ...
        public static class Proxy implements IDMSDPAdapter {
            ...
            public int openVirtualCameraStream(String appId, String deviceId, String serviceId, Map cameraParas, ICameraDataCallback callback) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeMap(cameraParas);
                    _data.writeStrongBinder(callback != null ? callback.asBinder() : null);
                    if (!this.mRemote.transact(Stub.TRANSACTION_openVirtualCameraStream, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().openVirtualCameraStream(appId, deviceId, serviceId, cameraParas, callback);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
            ...
            public int closeVirtualCameraStream(String appId, String deviceId, String serviceId) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(deviceId);
                    _data.writeString(serviceId);
                    if (!this.mRemote.transact(Stub.TRANSACTION_closeVirtualCameraStream, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().closeVirtualCameraStream(appId, deviceId, serviceId);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();

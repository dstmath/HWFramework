...
public class HiPlayHelper {
    ...
    private static final String STEREO_MODE_DOUBLE = "1";
    ...
    private final Runnable mDisableTimeout = new Runnable() {
        ...
        public void run() {
            ...
            hiPlayHelper2.reportAllConnectState(hiPlayHelper2.mActiveOptParams.getDevice(), DeviceState.STOP_CONTINUTING_FAILED, DMSDPConfig.DISADBLE_FAILED);
        }
    };
    ...
    private final Runnable mEnableTimeout = new Runnable() {
        ...
        public void run() {
            if (HiPlayHelper.this.mEnableOptFinish) {
                ...
                HiPlayHelper hiPlayHelper3 = HiPlayHelper.this;
                hiPlayHelper3.reportAllConnectState(hiPlayHelper3.mActiveOptParams.getDevice(), DeviceState.CONTINUTING_FAILED, DMSDPConfig.CONNECT_DEVICE_TIMEOUT);
            }
        }
    };
        ...
        try {
            ...
            if (jsonObject.has(KEY_DEVICE_CONN_STATUS)) {
                if (!BuildConfig.FLAVOR.equals(jsonObject.getString(KEY_DEVICE_CONN_STATUS))) {
                    ...
                    reportAllConnectState(this.mActiveOptParams.getDevice(), DeviceState.CONTINUTING_FAILED, DMSDPConfig.DEVICE_BUSY);
                    return deviceIdList;
                }
            }
    ...
    public void reportEnableOptFailed() {
        ...
        reportAllConnectState(this.mActiveOptParams.getDevice(), DeviceState.CONTINUTING_FAILED, DMSDPConfig.CONNECT_DEVICE_FAILED);
    }
    ...
    public void reportDisableOptFailed() {
        ...
        reportAllConnectState(this.mActiveOptParams.getDevice(), DeviceState.STOP_CONTINUTING_FAILED, DMSDPConfig.DISADBLE_FAILED);
    }
    ...
    public static class DeviceOperationParams {
        ...
        private AccessVersion checkAccessVersion() {
            ...
            if (isStereoMode() && !isRsdbSupported) {
        ...
        private boolean isStereoMode() {
            return this.stereoMode.equals(HiPlayHelper.STEREO_MODE_SINGLE) || this.stereoMode.equals(HiPlayHelper.STEREO_MODE_DOUBLE);
        }
    ...
    public class DeviceServiceHandler extends Handler {
        ...
        private void onServiceEnableSuccess(HiPlayDevice hiPlayDevice, Capability cap) {
            ...
            HiPlayHelper.this.reportAllConnectState(hiPlayDevice, DeviceState.CONTIUITING, 0);
        }
        ...
        private void onServiceDisableSuccess(HiPlayDevice hiPlayDevice, Capability cap) {
            ...
            HiPlayHelper.this.reportAllConnectState(hiPlayDevice, DeviceState.NO_CONTINUTING, 0);
            synchronized (HiPlayHelper.HIPLAY_ADAPTER_LOCK) {
                if (HiPlayHelper.this.mHiPlayAdapter != null) {
        ...
        private void onServiceAbnormal(HiPlayDevice hiPlayDevice, Capability cap) {
            ...
            HiPlayHelper.this.reportAllConnectState(hiPlayDevice, DeviceState.NO_CONTINUTING, DMSDPConfig.CONNECT_DEVICE_FAILED);
        }
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void reportAllConnectState(HiPlayDevice hiPlayDevice, String deviceState, int errorCode) {
        if (hiPlayDevice == null) {
            HwLog.e(TAG, "hiPlayDevice is invalid");
            return;
        }
        try {
            AllConnectReporter.doReport(this.mHiPlayAdapter, new AllConnectReporter.Builder().setHiPlayDeviceState(deviceState).setErrorCode(errorCode).setConnectSource(AllConnectReporter.CONNECT_SOURCE_HIPLAY).setCurrentTime(System.currentTimeMillis()).setHiPlayDevice(hiPlayDevice).build());
        } catch (JSONException e) {

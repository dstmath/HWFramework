...
public interface OnEnvelopeReceiver extends IInterface {
    ...
    public static abstract class Stub extends Binder implements OnEnvelopeReceiver {
        ...
        public static OnEnvelopeReceiver asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof OnEnvelopeReceiver)) {
                return new Proxy(obj);
            }
            return (OnEnvelopeReceiver) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            AwarenessEnvelope _arg0;
            if (code == 1) {
                data.enforceInterface(DESCRIPTOR);
                if (data.readInt() != 0) {
                    _arg0 = AwarenessEnvelope.CREATOR.createFromParcel(data);
                } else {
                    _arg0 = null;
                }
                onReceive(_arg0);
        ...
        private static class Proxy implements OnEnvelopeReceiver {
            ...
            public void onReceive(AwarenessEnvelope envelope) throws RemoteException {
                ...
                try {
                    ...
                    if (envelope != null) {
                        _data.writeInt(1);
                        envelope.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }

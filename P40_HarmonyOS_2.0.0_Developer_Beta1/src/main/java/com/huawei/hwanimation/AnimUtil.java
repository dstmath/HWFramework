...
public class AnimUtil {
    ...
    public void overrideTransition(int transit) {
        if (this.mClientToken != null) {
            Context hwAnimationContext = null;
            try {
                if (this.mClientContext != null) {
                    hwAnimationContext = this.mClientContext.createPackageContext(sHwAnimResPackageName, 0);
                } else {
                    Log.e(TAG, "overrideTransition context is null ");
                }
    ...
    private int getResId(Context context) {
        ...
        if (resId == 0) {
            return context.getResources().getIdentifier(HW_ANIMATION, STYLE, sHwAnimResPackageName);
        }
        return resId;
    }
    ...
    private void initToken() {
        try {
            ...
            Object obj = method.invoke(this.mClientContext, new Object[0]);
            if (obj instanceof IBinder) {
                this.mClientToken = (IBinder) obj;
            }

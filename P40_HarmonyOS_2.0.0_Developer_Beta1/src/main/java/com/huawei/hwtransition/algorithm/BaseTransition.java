...
public abstract class BaseTransition {
    ...
    public int getDrawingOrder(int childCount, int index, int part, float scrollProgress) {
        return index;
    }

    public int getBreakOrder(int index, float scrollProgress) {
        return index;
    }
    ...
    public boolean transform(int index, float scrollProgress, Rect targetRt) {
        return false;
    }
    ...
    public void setCameraDistance(float distanceValue) {
        this.mCameraZ = distanceValue;

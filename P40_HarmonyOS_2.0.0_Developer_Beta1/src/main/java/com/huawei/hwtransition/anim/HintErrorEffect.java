...
public class HintErrorEffect {
    ...
    private void getOutlinePath(Outline outline) {
        if (outline != null) {
            try {
                ...
                if (pathField.get(outline) instanceof Path) {
                    this.mPath = (Path) pathField.get(outline);
                }
                if (rectField.get(outline) instanceof Rect) {
                    this.mRect = (Rect) rectField.get(outline);
                }
                if (radiusField.get(outline) instanceof Float) {
            ...
            if (getPath() != null || getRect() != null) {
                if (this.mRect != null && !this.mRect.isEmpty()) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        if (oldHeight != 0.0f && oldWidth != 0.0f) {

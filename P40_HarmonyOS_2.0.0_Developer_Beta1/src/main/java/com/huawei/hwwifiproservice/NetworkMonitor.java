...
public class NetworkMonitor {
    ...
    private String getCaptivePortalServerHttpsUrl() {
        return getSettingFromResource(this.mContext, 33685607, 33685622, "captive_portal_https_url");
    }

    private String getCaptivePortalServerHttpsFallbackUrl() {
        return getSettingFromResource(this.mContext, 33685605, 33685621, KEYWORD_HTTPS_FALLBACK_URL);
    }

    public final String getCaptivePortalServerHttpUrl() {
        return getSettingFromResource(this.mContext, 33685604, 33685620, "captive_portal_http_url");
    }

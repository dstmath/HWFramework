...
public class WifiProHistoryRecordManager implements IGetApRecordCount {
    ...
    private static final HomeApSwitchRate[] HOME_AP_SWITCH_RATE_TABLE = {new HomeApSwitchRate(10, 0.5f, 0.7f), new HomeApSwitchRate(20, 0.5f, 0.6f), new HomeApSwitchRate(50, 0.5f, 0.5f), new HomeApSwitchRate(100, 0.6f, 0.4f), new HomeApSwitchRate(WifiProChr.WIFI_2_CELL_SUCC_EXIT_REASION_BASE, 0.6f, 0.3f)};

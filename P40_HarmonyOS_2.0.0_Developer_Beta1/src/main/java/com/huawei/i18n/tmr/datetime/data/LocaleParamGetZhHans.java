...
public class LocaleParamGetZhHans {
    private HashMap<String, String> ampm2Time = new HashMap<String, String>() {
        /* class com.huawei.i18n.tmr.datetime.data.LocaleParamGetZhHans.AnonymousClass2 */
    ...
    public HashMap<String, String> date = new HashMap<String, String>() {
        /* class com.huawei.i18n.tmr.datetime.data.LocaleParamGetZhHans.AnonymousClass1 */
    ...
    public String getAmPm(String content) {
        return this.ampm2Time.get(content.trim());
    }
}

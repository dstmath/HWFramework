...
public class IndexSearchManager implements IIndexSearchManager {
    ...
    private static IndexSearchManager indexSearchManager = null;
    ...
    public static IndexSearchManager getInstance() {
        IndexSearchManager indexSearchManager2;
        synchronized (LOCK) {
            if (indexSearchManager == null) {
                indexSearchManager = new IndexSearchManager();
            }
            indexSearchManager2 = indexSearchManager;
        }
        return indexSearchManager2;
    }
    ...
    private IndexSearchManager() {
        ...
        this.isSupportHwGlobalSearch = "true".equals(SystemProperties.get(FULL_TEXT_SEARCH_CONFIG, "true"));
    }

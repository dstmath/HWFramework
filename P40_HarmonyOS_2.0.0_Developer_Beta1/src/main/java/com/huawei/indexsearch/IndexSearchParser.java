...
public class IndexSearchParser {
    ...
    private static final boolean IS_SUPPORT_FULL_TEXT_SEARCH = "true".equals(SystemProperties.get("ro.config.hw_globalSearch", "true"));
    private static final Object LOCK = new Object();
    private static final String TAG = "IndexSearchParser";
    private static IndexSearchParser instance = null;
    ...
    public static void createIndexSearchParser(String pkgName, String[] tables) {
        ...
        synchronized (LOCK) {
            ...
            if (isHwIndexSearchServiceExist() && instance == null) {
                instance = new IndexSearchParser(pkgName, tables);
            }
        }
    }
    ...
    public static boolean isHwIndexSearchServiceExist() {
        ...
        try {
            ...
            packageInfo = null;
            Log.e(TAG, "HwSearchService packageInfo is null.");
        }
        if (packageInfo != null) {
            return true;
        }
        Log.e(TAG, "HwSearchService not exist.");
        return false;
    }

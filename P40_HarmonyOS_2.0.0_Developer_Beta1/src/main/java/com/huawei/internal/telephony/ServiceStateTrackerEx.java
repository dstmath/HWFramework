...
public class ServiceStateTrackerEx {
    ...
    public void initServiceStateTracker(PhoneExt phoneExt, CommandsInterfaceEx commandsInterfaceEx) {
        ...
        Phone phone = this.mPhone.getPhone();
        if (phone instanceof GsmCdmaPhone) {
            this.mServiceStateTracker = new ServiceStateTracker((GsmCdmaPhone) phone, commandsInterfaceEx.getCommandsInterface());
        }
    }
    ...
    public void registerForDataConnectionAttached(int transport, Handler handler, int what, Object obj) {
        ServiceStateTracker serviceStateTracker = this.mServiceStateTracker;
        if (serviceStateTracker != null) {
            serviceStateTracker.registerForDataConnectionAttached(transport, handler, what, obj);
        }
    }
    ...
    public String getSavedTimeZoneId() {
        ...
        return nitzStateMachine.getSavedTimeZoneId();
    }

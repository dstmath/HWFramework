...
public class SubscriptionControllerEx {
    ...
    private SubscriptionControllerEx() {
    }

    private void setSubscriptionController(SubscriptionController subscriptionController) {
    ...
    public int getSubIdUsingPhoneId(int phoneId) {
        return this.mSubscriptionController.getSubIdUsingPhoneId(phoneId);
    }

    public void sendDefaultChangedBroadcast(int subId) {
        this.mSubscriptionController.sendDefaultChangedBroadcast(subId);
    }

    public void setDataSubId(int subId) {
        this.mSubscriptionController.setDataSubId(subId);
    }

    public int getSlotIndex(int subId) {
        return this.mSubscriptionController.getSlotIndex(subId);
    }
}

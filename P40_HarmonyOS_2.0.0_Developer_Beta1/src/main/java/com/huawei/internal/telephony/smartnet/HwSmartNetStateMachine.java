...
public class HwSmartNetStateMachine extends StateMachineEx {
    ...
    public class DefaultState extends StateEx {
        ...
        public boolean processMessage(Message msg) {
            ...
            HwSmartNetStateMachine hwSmartNetStateMachine3 = HwSmartNetStateMachine.this;
            hwSmartNetStateMachine3.transitionTo(hwSmartNetStateMachine3.mSamplingState);
                ...
                default:
                    switch (i) {
                        case HwSmartNetConstants.EVENT_STATE_EXIT_HOME_OR_COMPANY /* 451 */:
                            ...
                            HwSmartNetStateMachine hwSmartNetStateMachine2 = HwSmartNetStateMachine.this;
                            hwSmartNetStateMachine2.transitionTo(hwSmartNetStateMachine2.mDefaultState);
                            return HwSmartNetStateMachine.HANDLED;
                        ...
                        case HwSmartNetConstants.EVENT_STATE_ENTER_HOME_OR_COMPANY_FOR_TEST /* 453 */:
                            ...
                            if (!HwSmartNetStateMachine.this.mSamplingStrategy.endSampling()) {
                                ...
                                HwSmartNetStateMachine hwSmartNetStateMachine3 = HwSmartNetStateMachine.this;
                                hwSmartNetStateMachine3.transitionTo(hwSmartNetStateMachine3.mDefaultState);
                                return HwSmartNetStateMachine.HANDLED;
                            }
                            HwSmartNetStateMachine hwSmartNetStateMachine4 = HwSmartNetStateMachine.this;
                            hwSmartNetStateMachine4.transitionTo(hwSmartNetStateMachine4.mStudyState);
                            return HwSmartNetStateMachine.HANDLED;
                        default:
                            HwSmartNetStateMachine hwSmartNetStateMachine5 = HwSmartNetStateMachine.this;
                            hwSmartNetStateMachine5.rlogi("SamplingState.processMessage default:" + msg.what);
                            return false;
                    }
            }
        }
    ...
    public class StudyState extends StateEx {
        ...
        public boolean processMessage(Message msg) {
            ...
            HwSmartNetStateMachine hwSmartNetStateMachine3 = HwSmartNetStateMachine.this;
            hwSmartNetStateMachine3.transitionTo(hwSmartNetStateMachine3.mEstimateState);
            return HwSmartNetStateMachine.HANDLED;
        }
    }

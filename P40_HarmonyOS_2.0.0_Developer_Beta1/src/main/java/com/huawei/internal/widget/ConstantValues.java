...
public class ConstantValues {
    ...
    public static final int FREEFORM_RADIUS = 34472614;
    public static final float HALF_DIVIDER = 2.0f;
    public static final String HW_FOLD_DISPLAY_MODE_STR_PREPARE = "hw_fold_display_mode_prepare";
    ...
    public static final int SPLITSCREEN_RADIUS = 34472617;

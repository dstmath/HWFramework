...
public class HwDragBarPopupBubbleLayout extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        this.mFillPaint.setColor(this.mContext.getColor(33882729));
    ...
    public void setContentWidth(int captionWidth) {
        this.mWidthTmpSize = (((float) captionWidth) - (this.mContext.getResources().getDimension(34472323) * 2.0f)) - (2.0f * this.mContext.getResources().getDimension(34472322));

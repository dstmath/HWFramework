...
public class HwMSDPDeviceStatusChangeEvent implements Parcelable {
    public static final Parcelable.Creator<HwMSDPDeviceStatusChangeEvent> CREATOR = new Parcelable.Creator<HwMSDPDeviceStatusChangeEvent>() {
        ...
        public HwMSDPDeviceStatusChangeEvent createFromParcel(Parcel source) {
            ...
            if (!HwMSDPDeviceStatusChangeEvent.checkDeviceEventLen(activityRecognitionEventsLength)) {
                activityRecognitionEventsLength = 0;
            }
            HwMSDPDeviceStatusEvent[] activityRecognitionEvents = new HwMSDPDeviceStatusEvent[activityRecognitionEventsLength];
    ...
    public static boolean checkDeviceEventLen(int len) {
        if (len < 0 || len > 1000) {
            return false;
        }
        return true;

...
public interface IMSDPDeviceStatusService extends IInterface {
    ...
    boolean getCurrentDeviceStatusByParams(String str, String str2, HwMSDPOtherParameters hwMSDPOtherParameters) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IMSDPDeviceStatusService {
            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 7:
                        ...
                        boolean currentDeviceStatusByParams = getCurrentDeviceStatusByParams(_arg0, _arg1, _arg2);
                        reply.writeNoException();
                        reply.writeInt(currentDeviceStatusByParams ? 1 : 0);
                        return true;
                    default:
        ...
        public static class Proxy implements IMSDPDeviceStatusService {
            ...
            @Override // com.huawei.msdp.devicestatus.IMSDPDeviceStatusService
            public boolean getCurrentDeviceStatusByParams(String packageName, String deviceStatus, HwMSDPOtherParameters params) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

...
public interface IUpdatePackageCheckCallBack extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUpdatePackageCheckCallBack {
        ...
        public static IUpdatePackageCheckCallBack asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface == null || !(queryLocalInterface instanceof IUpdatePackageCheckCallBack)) {
                return new Proxy(iBinder);
            }
            return (IUpdatePackageCheckCallBack) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onFinish(parcel.readInt() != 0 ? ObjectContainer.CREATOR.createFromParcel(parcel) : null, parcel.readInt());
        ...
        private static class Proxy implements IUpdatePackageCheckCallBack {
            ...
            public void onFinish(ObjectContainer objectContainer, int i) throws RemoteException {

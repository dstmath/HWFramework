...
public class ZFieldAuthorityGrant extends AManagedObject {
    public static final Parcelable.Creator<ZFieldAuthorityGrant> CREATOR = new Parcelable.Creator<ZFieldAuthorityGrant>() {
        ...
        public ZFieldAuthorityGrant createFromParcel(Parcel parcel) {
            return new ZFieldAuthorityGrant(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public ZFieldAuthorityGrant[] newArray(int i) {
            return new ZFieldAuthorityGrant[i];
        }
    };
    ...
    public ZFieldAuthorityGrant(Parcel parcel) {
        super(parcel);
        Boolean bool;
        boolean z = true;
        String str = null;
    ...
    private ZFieldAuthorityGrant(Long l, Long l2, String str, Long l3, String str2, Long l4, String str3, Integer num, String str4, Boolean bool, String str5) {
        this.id = l;
        this.tableId = l2;
        this.tableName = str;
        this.filedId = l3;

...
public class ZGroup extends AManagedObject {
    public static final Parcelable.Creator<ZGroup> CREATOR = new Parcelable.Creator<ZGroup>() {
        ...
        public ZGroup createFromParcel(Parcel parcel) {
            return new ZGroup(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public ZGroup[] newArray(int i) {
            return new ZGroup[i];
        }
    };
    ...
    private ZGroup(Long l, String str, String str2, String str3, boolean z, String str4, Integer num, String str5) {
        this.id = l;
        this.groupName = str;
        this.tableName = str2;
        this.owner = str3;
    ...
    public String toString() {
        return "ZGroup { id: " + this.id + ", groupName: " + this.groupName + ", tableName: " + this.tableName + ", owner: " + this.owner + ", isGroupIdentifier: " + this.isGroupIdentifier + ", member: " + this.member + ", authority: " + this.authority + ", reserved: " + this.reserved + " }";
    }

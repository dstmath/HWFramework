...
public class ZTupleAuthority extends AManagedObject {
    public static final Parcelable.Creator<ZTupleAuthority> CREATOR = new Parcelable.Creator<ZTupleAuthority>() {
        ...
        public ZTupleAuthority createFromParcel(Parcel parcel) {
            return new ZTupleAuthority(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public ZTupleAuthority[] newArray(int i) {
            return new ZTupleAuthority[i];
        }
    };
    ...
    public ZTupleAuthority(Parcel parcel) {
        super(parcel);
        Boolean bool;
        boolean z = true;
        String str = null;
    ...
    private ZTupleAuthority(Long l, Long l2, String str, Long l3, String str2, Long l4, String str3, Integer num, Boolean bool, String str4) {
        this.id = l;
        this.tableId = l2;
        this.tableName = str;
        this.tupleId = l3;
    ...
    public String toString() {
        return "ZTupleAuthority { id: " + this.id + ", tableId: " + this.tableId + ", tableName: " + this.tableName + ", tupleId: " + this.tupleId + ", tupleName: " + this.tupleName + ", packageUid: " + this.packageUid + ", packageName: " + this.packageName + ", authority: " + this.authority + ", supportGroupAuthority: " + this.supportGroupAuthority + ", reserved: " + this.reserved + " }";
    }

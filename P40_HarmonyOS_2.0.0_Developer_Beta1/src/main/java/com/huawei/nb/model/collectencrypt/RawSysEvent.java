...
public class RawSysEvent extends AManagedObject {
    public static final Parcelable.Creator<RawSysEvent> CREATOR = new Parcelable.Creator<RawSysEvent>() {
        ...
        public RawSysEvent createFromParcel(Parcel parcel) {
            return new RawSysEvent(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public RawSysEvent[] newArray(int i) {
            return new RawSysEvent[i];
        }
    };
    ...
    public RawSysEvent(Parcel parcel) {
        super(parcel);
        String str = null;
    ...
    private RawSysEvent(Integer num, Date date, String str, String str2, Integer num2, String str3) {
        this.mId = num;
    ...
    public String toString() {
        return "RawSysEvent { mId: " + this.mId + ", mTimeStamp: " + this.mTimeStamp + ", mEventName: " + this.mEventName + ", mEventParam: " + this.mEventParam + ", mReservedInt: " + this.mReservedInt + ", mReservedText: " + this.mReservedText + " }";
    }

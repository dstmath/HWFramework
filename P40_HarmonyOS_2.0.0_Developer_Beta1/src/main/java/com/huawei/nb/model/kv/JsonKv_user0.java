...
public class JsonKv_user0 extends AManagedObject {
    public static final Parcelable.Creator<JsonKv_user0> CREATOR = new Parcelable.Creator<JsonKv_user0>() {
        ...
        public JsonKv_user0 createFromParcel(Parcel parcel) {
            return new JsonKv_user0(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public JsonKv_user0[] newArray(int i) {
            return new JsonKv_user0[i];
        }
    };
    ...
    public JsonKv_user0(Parcel parcel) {
        super(parcel);
        String str = null;
    ...
    private JsonKv_user0(Long l, String str, String str2, String str3, String str4, String str5, int i, String str6, String str7, String str8, int i2) {
        this.id = l;
        this.primaryKey = str;
        this.value = str2;
        this.version = str3;
    ...
    public String toString() {
        return "JsonKv_user0 { id: " + this.id + ", primaryKey: " + this.primaryKey + ", value: " + this.value + ", version: " + this.version + ", owner: " + this.owner + ", tag: " + this.tag + ", clone: " + this.clone + ", reserved1: " + this.reserved1 + ", reserved2: " + this.reserved2 + ", reserved3: " + this.reserved3 + ", clearStatus: " + this.clearStatus + " }";
    }

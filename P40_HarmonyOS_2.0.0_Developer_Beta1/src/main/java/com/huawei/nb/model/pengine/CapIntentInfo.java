...
public class CapIntentInfo extends AManagedObject {
    public static final Parcelable.Creator<CapIntentInfo> CREATOR = new Parcelable.Creator<CapIntentInfo>() {
        ...
        public CapIntentInfo createFromParcel(Parcel parcel) {
            return new CapIntentInfo(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public CapIntentInfo[] newArray(int i) {
            return new CapIntentInfo[i];
        }
    };
    ...
    public CapIntentInfo(Parcel parcel) {
        super(parcel);
        String str = null;
        ...
        this.column16 = parcel.readByte() != 0 ? parcel.readString() : str;
    }

    private CapIntentInfo(Integer num, Integer num2, Long l, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17) {
        this.id = num;
        this.dataType = num2;
        this.timestamp = l;
        this.column0 = str;

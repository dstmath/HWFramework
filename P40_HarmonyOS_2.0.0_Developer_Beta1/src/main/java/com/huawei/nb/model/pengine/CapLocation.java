...
public class CapLocation extends AManagedObject {
    public static final Parcelable.Creator<CapLocation> CREATOR = new Parcelable.Creator<CapLocation>() {
        ...
        public CapLocation createFromParcel(Parcel parcel) {
            return new CapLocation(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public CapLocation[] newArray(int i) {
            return new CapLocation[i];
        }
    };
    ...
    public CapLocation(Parcel parcel) {
        super(parcel);
        String str = null;

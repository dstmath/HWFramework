...
public class ClusterLocCache extends AManagedObject {
    public static final Parcelable.Creator<ClusterLocCache> CREATOR = new Parcelable.Creator<ClusterLocCache>() {
        ...
        public ClusterLocCache createFromParcel(Parcel parcel) {
            return new ClusterLocCache(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public ClusterLocCache[] newArray(int i) {
            return new ClusterLocCache[i];
        }
    };
    ...
    public ClusterLocCache(Parcel parcel) {
        super(parcel);
        String str = null;

...
public class CustomUserProfiling extends AManagedObject {
    public static final Parcelable.Creator<CustomUserProfiling> CREATOR = new Parcelable.Creator<CustomUserProfiling>() {
        ...
        public CustomUserProfiling createFromParcel(Parcel parcel) {
            return new CustomUserProfiling(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public CustomUserProfiling[] newArray(int i) {
            return new CustomUserProfiling[i];
        }
    };
    private Integer id;
    ...
    public CustomUserProfiling(Parcel parcel) {
        super(parcel);
        Long l = null;
    ...
    private CustomUserProfiling(Integer num, String str, Integer num2, String str2, String str3, Long l) {
        this.id = num;
        this.parent = str;
        this.level = num2;
        this.uriKey = str2;
    ...
    public String toString() {
        return "CustomUserProfiling { id: " + this.id + ", parent: " + this.parent + ", level: " + this.level + ", uriKey: " + this.uriKey + ", uriValue: " + this.uriValue + ", timestamp: " + this.timestamp + " }";
    }

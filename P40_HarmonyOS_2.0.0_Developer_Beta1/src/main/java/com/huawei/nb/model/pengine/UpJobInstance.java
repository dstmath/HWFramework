...
public class UpJobInstance extends AManagedObject {
    public static final Parcelable.Creator<UpJobInstance> CREATOR = new Parcelable.Creator<UpJobInstance>() {
        ...
        public UpJobInstance createFromParcel(Parcel parcel) {
            return new UpJobInstance(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public UpJobInstance[] newArray(int i) {
            return new UpJobInstance[i];
        }
    };
    ...
    public UpJobInstance(Parcel parcel) {
        super(parcel);
        Long l = null;
    ...
    private UpJobInstance(Integer num, String str, String str2, String str3, String str4, String str5, Long l, Long l2, Long l3) {
        this.id = num;
        this.type = str;
        this.status = str2;
        this.tasks = str3;
    ...
    public String toString() {
        return "UpJobInstance { id: " + this.id + ", type: " + this.type + ", status: " + this.status + ", tasks: " + this.tasks + ", result: " + this.result + ", resultDesc: " + this.resultDesc + ", analyzeTime: " + this.analyzeTime + ", createTime: " + this.createTime + ", lastModifyTime: " + this.lastModifyTime + " }";
    }

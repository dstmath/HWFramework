...
public class UpTaskInstance extends AManagedObject {
    public static final Parcelable.Creator<UpTaskInstance> CREATOR = new Parcelable.Creator<UpTaskInstance>() {
        ...
        public UpTaskInstance createFromParcel(Parcel parcel) {
            return new UpTaskInstance(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public UpTaskInstance[] newArray(int i) {
            return new UpTaskInstance[i];
        }
    };
    ...
    public UpTaskInstance(Parcel parcel) {
        super(parcel);
        String str = null;
    ...
    private UpTaskInstance(Integer num, Long l, String str, String str2, String str3, String str4, Long l2, Long l3, String str5) {
        this.taskId = num;
        this.jobId = l;
        this.taskName = str;
        this.status = str2;
    ...
    public String toString() {
        return "UpTaskInstance { taskId: " + this.taskId + ", jobId: " + this.jobId + ", taskName: " + this.taskName + ", status: " + this.status + ", result: " + this.result + ", resultDesc: " + this.resultDesc + ", createTime: " + this.createTime + ", lastModifyTime: " + this.lastModifyTime + ", attrs: " + this.attrs + " }";
    }

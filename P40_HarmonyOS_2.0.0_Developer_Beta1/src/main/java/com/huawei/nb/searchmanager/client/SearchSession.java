...
public class SearchSession {
    ...
    public int getSearchHitCount(String str) {
        ...
        DSLog.it(TAG, "get search hit count is " + i + ", cost " + (System.currentTimeMillis() - currentTimeMillis), new Object[0]);
        return i;
    }
    ...
    public List<Recommendation> groupSearch(String str, int i) {
        ...
        if (list != null) {
            DSLog.it(TAG, "groupSearch end, size is " + list.size() + ", cost " + (System.currentTimeMillis() - currentTimeMillis), new Object[0]);
        } else {
            DSLog.it(TAG, "groupSearch end, cost " + (System.currentTimeMillis() - currentTimeMillis), new Object[0]);
        }
        return list;
    }
    ...
    public List<Recommendation> groupTimeline(String str, String str2) {
        ...
        DSLog.it(TAG, "groupTimeline end, size is " + arrayList.size() + ", cost " + (System.currentTimeMillis() - currentTimeMillis), new Object[0]);
        return arrayList;
    }
    ...
    public Map<String, List<Recommendation>> coverSearch(String str, List<String> list, int i) {
        ...
        if (map != null) {
            DSLog.it(TAG, "coverSearch end, size is " + map.size() + ", cost " + (System.currentTimeMillis() - currentTimeMillis), new Object[0]);
        } else {
            DSLog.it(TAG, "coverSearch end, cost " + (System.currentTimeMillis() - currentTimeMillis), new Object[0]);
        }
        return map;
    }
}

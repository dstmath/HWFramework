...
public final class BulkCursorToCursorAdaptor extends AbstractWindowedCursor {
    ...
    public void initialize(BulkCursorDescriptorEx ex) {
        this.mBulkCursor = ex.getCursor();
        this.mColumns = ex.getColumnNames();
        this.mWantsAllOnMoveCalls = ex.isWantsAllOnMoveCalls();
        this.mCount = ex.getCount();
        if (ex.getWindow() != null) {
            setWindow(ex.getWindow());
        }

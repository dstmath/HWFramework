...
public interface INcDft extends IInterface {
    ...
    void notifyNcDftBundleEvent(int i, int i2, Bundle bundle) throws RemoteException;

    void notifyNcDftEvent(int i, int i2, List<String> list) throws RemoteException;

    public static class Default implements INcDft {
        @Override // com.huawei.ncdft.INcDft
        public void notifyNcDftEvent(int domain, int eventId, List<String> list) throws RemoteException {
        }

        @Override // com.huawei.ncdft.INcDft
        public void notifyNcDftBundleEvent(int domain, int eventId, Bundle data) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements INcDft {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code == 1) {
                ...
                notifyNcDftEvent(data.readInt(), data.readInt(), data.createStringArrayList());
                return true;
            } else if (code == 2) {
                data.enforceInterface(DESCRIPTOR);
                ...
                notifyNcDftBundleEvent(_arg0, _arg1, _arg2);
                return true;
            } else if (code == 3) {
                data.enforceInterface(DESCRIPTOR);
                String _result = getNcDftParam(data.readInt(), data.createStringArrayList());
                ...
                data.enforceInterface(DESCRIPTOR);
                String _result2 = getConnectivityDftParm(data.readString(), data.readInt());
                reply.writeNoException();
        ...
        public static class Proxy implements INcDft {
            ...
            @Override // com.huawei.ncdft.INcDft
            public void notifyNcDftEvent(int domain, int eventId, List<String> data) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(1, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        ...
                        Stub.getDefaultImpl().notifyNcDftEvent(domain, eventId, data);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void notifyNcDftBundleEvent(int domain, int eventId, Bundle data) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(2, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        ...
                        Stub.getDefaultImpl().notifyNcDftBundleEvent(domain, eventId, data);
                    }
                } finally {
                    _data.recycle();
                }

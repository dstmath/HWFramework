...
public class CreateSocketListenerTransport extends ICreateSocketListener.Stub {
    ...
    public class CreateP2PClientRunable implements Runnable {
        ...
        public void run() {
            ...
            if (!CreateSocketListenerTransport.this.mListenerHandler.sendMessage(newMsg)) {
                HwLog.e(CreateSocketListenerTransport.TAG, "createP2PNearbySocketClient : handler quitting,remove the listener. ");
            }
    ...
    /* access modifiers changed from: package-private */
    public class CreateP2PServerRunable implements Runnable {
        InternalNearbySocket innerSocket;
        int protocol;
        int soTimeout;
        ...
        public void run() {
            ...
            if (hasException) {
                ...
                newMsg.what = 2;
                newMsg.arg1 = NearbyConfig.ERROR_CREATE_THREAD_EXCEPTION;
                if (!CreateSocketListenerTransport.this.mListenerHandler.sendMessage(newMsg)) {
                    HwLog.e(CreateSocketListenerTransport.TAG, "createP2PNearbySocketServer : handler quitting,remove the listener. ");
                }
            }
    ...
    /* access modifiers changed from: package-private */
    public class BRCreateSocketCB implements ICreateSocketCallback {
        BRCreateSocketCB() {
        }
    ...
    static class TCPServerNearbySocket extends TCPNearbySocket {
        ...
        @Override // com.huawei.nearbysdk.TCPNearbySocket, com.huawei.nearbysdk.NearbySocket

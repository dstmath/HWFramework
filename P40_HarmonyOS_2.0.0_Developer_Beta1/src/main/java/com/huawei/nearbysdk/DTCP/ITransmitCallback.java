    ...
    public static abstract class Stub extends Binder implements ITransmitCallback {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    ...
                    onHwIDHeadImageReceive(_arg02, data.createByteArray());
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = NearbyRecvBean.CREATOR.createFromParcel(data);
                    } else {
                        _arg0 = null;
                    }
                    onRecvSuccess(_arg0);
                ...
                case 9:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_onImportStarted /* 10 */:
                    data.enforceInterface(DESCRIPTOR);
                    onImportStarted();
                    reply.writeNoException();
                    return true;
        ...
        public static class Proxy implements ITransmitCallback {
            ...
            public void onImportStarted() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_onImportStarted, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();

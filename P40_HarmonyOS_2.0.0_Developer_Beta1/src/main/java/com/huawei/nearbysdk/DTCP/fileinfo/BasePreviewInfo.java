...
public class BasePreviewInfo implements Parcelable, Serializable, IDTCPSerialize {
    public static final Parcelable.Creator<BasePreviewInfo> CREATOR = new BasePreviewInfoCreator();
    ...
    static class BasePreviewInfoCreator implements Parcelable.Creator<BasePreviewInfo> {

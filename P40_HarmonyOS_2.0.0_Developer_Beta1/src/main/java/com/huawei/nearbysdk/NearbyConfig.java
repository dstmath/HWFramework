...
public class NearbyConfig {
    ...
    public static final int BUSINESSID_WATCH_HOME = 24;
    ...
    public static final int ERROR_BLE_OFF = 2013;
    ...
    public static final int ERROR_MESSAGE_BOND_BONDING = 4005;
    ...
    public static final int ERROR_PEER_DEVICE_HOSTSPOT_ON = 2012;
    public static final int ERROR_PEER_DEVICE_IMPORT_DATA = 2011;
    ...
    public static String toSecureString(String str) {
        String strDevice = String.valueOf(str).replace(":", BuildConfig.FLAVOR);

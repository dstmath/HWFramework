...
public class SocketListenerTransport extends IInternalSocketListener.Stub {
    ...
    public class ChannelCreateRequestImpl implements ChannelCreateRequest {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:26:0x00ce A[SYNTHETIC, Splitter:B:26:0x00ce] */
        ...
        private NearbySocket createTCPNearbySocket(int timeOut) {
            ...
            try {
                ...
                try {
                    ...
                    if (serverSocket2 != null) {
                        try {
                            ...
                            HwLog.e(SocketListenerTransport.TAG, "serverSocket close fail: " + e5);
                        }
                    }
                    ...
                    InternalNearbySocket internalNearbySocket2 = null;
                    internalNearbySocket2 = this.mInnerRequest.getInnerNearbySocket();
                    result = new TCPNearbySocket(nearbyDevice, businessId, businessType, channelId, tag, internalNearbySocket2);
                    result.setSecurityType(this.mInnerRequest.getSecurityType());
                    return getTcpNearbySocket(socket, internalNearbySocket2, result, isSocketExceptionFlag, isNearbySocktExceptionFlag);
                } catch (Throwable th3) {
                    th = th3;
                    serverSocket = serverSocket2;
                    if (serverSocket != null) {
                ...
                InternalNearbySocket internalNearbySocket22 = null;
                internalNearbySocket22 = this.mInnerRequest.getInnerNearbySocket();
                result = new TCPNearbySocket(nearbyDevice, businessId, businessType, channelId, tag, internalNearbySocket22);
                result.setSecurityType(this.mInnerRequest.getSecurityType());
                return getTcpNearbySocket(socket, internalNearbySocket22, result, isSocketExceptionFlag, isNearbySocktExceptionFlag);
                ...
                InternalNearbySocket internalNearbySocket222 = null;
                internalNearbySocket222 = this.mInnerRequest.getInnerNearbySocket();
                result = new TCPNearbySocket(nearbyDevice, businessId, businessType, channelId, tag, internalNearbySocket222);
                result.setSecurityType(this.mInnerRequest.getSecurityType());
                return getTcpNearbySocket(socket, internalNearbySocket222, result, isSocketExceptionFlag, isNearbySocktExceptionFlag);
            }
            InternalNearbySocket internalNearbySocket2222 = null;
            try {
                internalNearbySocket2222 = this.mInnerRequest.getInnerNearbySocket();
                result = new TCPNearbySocket(nearbyDevice, businessId, businessType, channelId, tag, internalNearbySocket2222);
                try {
                    result.setSecurityType(this.mInnerRequest.getSecurityType());
                } catch (RemoteException e12) {
                    e4 = e12;
                    isNearbySocktExceptionFlag = true;
                    HwLog.e(SocketListenerTransport.TAG, "RemoteException: " + e4);
                    return getTcpNearbySocket(socket, internalNearbySocket2222, result, isSocketExceptionFlag, isNearbySocktExceptionFlag);
                }

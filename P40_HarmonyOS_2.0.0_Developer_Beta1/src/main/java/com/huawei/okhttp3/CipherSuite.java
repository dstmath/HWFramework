...
public final class CipherSuite {
    ...
    static final Comparator<String> ORDER_BY_NAME = $$Lambda$CipherSuite$8hAsr6rYx6tj87C71xyWUOkEN4.INSTANCE;
    ...
    public static final CipherSuite TLS_RSA_WITH_SEED_CBC_SHA = init("TLS_RSA_WITH_SEED_CBC_SHA", HwSideTouchManagerEx.VOLUME_FLICK_THRESHOLD_MAX);

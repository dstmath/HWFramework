...
import com.huawei.okhttp3.RequestBase;
...
@Deprecated
public final class Request extends RequestBase {
    @Nullable
    ...
    public static class Builder extends RequestBase.BuilderBase<Builder> {
        @Nullable
        RequestBody body;

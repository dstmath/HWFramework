...
public final class PublicSuffixDatabase {
    ...
    /* JADX INFO: Multiple debug info for r12v1 int: [D('publicSuffixBytesLeft' int), D('low' int)] */
        ...
        while (low2 < high) {
            ...
            if (compareResult < 0) {
                ...
                if (labelBytesLeft < low3) {
                    ...
                    return new String(bytesToSearch, mid2, publicSuffixLength, StandardCharsets.UTF_8);
                } else {
                    low2 = mid2 + end + 1;
                }
            }

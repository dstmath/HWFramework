...
public class HichainAuthManager {
    ...
    private ITrustedDeviceChangeListener mRegisteredListener;
    ...
    public int addDeviceChangeListener(TrustedDeviceChangeListener trustedDeviceChangeListener) {
        ...
        try {
            if (this.mGroupAuthService != null) {
                this.mRegisteredListener = getListenerBinder(trustedDeviceChangeListener);
                ret = this.mGroupAuthService.addDeviceChangeListener(this.mCallerPackageName, this.mRegisteredListener, this.mBinderToken);
            } else {
                LogUtils.e(TAG, "cannot get HwGroupAuthService");
            }
        } catch (RemoteException e) {
    ...
    public int setDeviceExtInfo(String connDeviceId, String groupId, String extInfo) {
        LogUtils.i(TAG, "invoke setDeviceExtInfo");
        if (connDeviceId == null || groupId == null || extInfo == null) {
            LogUtils.e(TAG, "invalid parameter : illegal deviceId");
            return -1;
        }
        connectGroupAuthService();
        try {
            if (this.mGroupAuthService != null) {
                return this.mGroupAuthService.setDeviceExtInfo(this.mCallerPackageName, connDeviceId, groupId, extInfo);
            }
            LogUtils.e(TAG, "cannot get HwGroupAuthService");
            return -1;
        } catch (RemoteException e) {
            LogUtils.e(TAG, "remoteException occurs when call setDeviceExtInfo");
            return -1;
        }
    }

    public String getDeviceExtInfo(String connDeviceId, String groupId) {
        LogUtils.i(TAG, "invoke getDeviceExtInfo");
        if (connDeviceId == null || groupId == null) {
            LogUtils.e(TAG, "invalid parameter : illegal deviceId");
        ...
        try {
            if (this.mGroupAuthService != null) {
                return this.mGroupAuthService.getDeviceExtInfo(this.mCallerPackageName, connDeviceId, groupId);
            }
            LogUtils.e(TAG, "cannot get HwGroupAuthService");
            return BuildConfig.FLAVOR;
        } catch (RemoteException e) {
            LogUtils.e(TAG, "remoteException occurs when call getDeviceExtInfo");
        }
    }
    ...
    private void binderToServiceInterface(IBinder gasBinder) {
        ...
        if (this.mRegisteredListener != null) {
            try {
                LogUtils.i(TAG, "re-register listner");
                this.mGroupAuthService.addDeviceChangeListener(this.mCallerPackageName, this.mRegisteredListener, this.mBinderToken);
            } catch (RemoteException e2) {
                LogUtils.e(TAG, "re-register listner error");
            }
        }

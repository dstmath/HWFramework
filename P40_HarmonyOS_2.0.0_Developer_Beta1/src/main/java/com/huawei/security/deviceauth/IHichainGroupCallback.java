...
public interface IHichainGroupCallback extends IInterface {
    ...
    public static class Default implements IHichainGroupCallback {
    ...
    public static abstract class Stub extends Binder implements IHichainGroupCallback {
        ...
        public static class Proxy implements IHichainGroupCallback {
            public static IHichainGroupCallback sDefaultImpl;
            ...
            public void onFinish(long requestId, int operationCode, String returnData) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onFinish(requestId, operationCode, returnData);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void onError(long requestId, int operationCode, int errorCode, String errorReturn) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onError(requestId, operationCode, errorCode, errorReturn);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public String onRequest(long requestId, int operationCode, String reqParams) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(3, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().onRequest(requestId, operationCode, reqParams);
                    }
                    _reply.readException();
        ...
        public static boolean setDefaultImpl(IHichainGroupCallback impl) {
        ...
        public static IHichainGroupCallback getDefaultImpl() {

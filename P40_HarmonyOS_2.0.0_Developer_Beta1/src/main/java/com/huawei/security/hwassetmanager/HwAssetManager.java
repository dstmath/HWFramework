...
public class HwAssetManager {
    ...
    public static final String BUNDLE_GROUP_ID = String.valueOf((int) HwKeymasterDefs.KM_TAG_ASSETSTORE_GROUP_ID);
    public static final String BUNDLE_GROUP_PERMISSION = String.valueOf((int) HwKeymasterDefs.KM_TAG_ASSETSTORE_GROUP_PERMISSION);
    public static final String BUNDLE_GROUP_PUBKEY = String.valueOf((int) HwKeymasterDefs.KM_TAG_ASSETSTORE_GROUP_PUBKEY);
    public static final String BUNDLE_GROUP_TOKEN = String.valueOf((int) HwKeymasterDefs.KM_TAG_ASSETSTORE_GROUP_TOKEN);
    ...
    public AssetResult assetWrap(Context context, Bundle bundle) {
        ...
        if (bundle.getInt(BUNDLE_KEY_WRAP_TYPE) == 4) {
            try {
                ...
                if (!new HwTrustManager().verifyDeviceCertificateChain(certs)) {
    ...
    private Certificate[] getCertificateChain() {
        try {
            ...
            Certificate[] certificates = ((KeyStore.PrivateKeyEntry) entry).getCertificateChain();
            ...
            Log.e(TAG, "Cannot connect to HwKeystoreService.");
            return null;
        }
    }

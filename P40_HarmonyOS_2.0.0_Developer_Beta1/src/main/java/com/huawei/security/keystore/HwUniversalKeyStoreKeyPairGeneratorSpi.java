...
public class HwUniversalKeyStoreKeyPairGeneratorSpi extends KeyPairGeneratorSpi {
    ...
    private static final int NUM_OF_EC_NAME = 12;
    private static final int RSA_DEFAULT_KEY_SIZE = 2048;
    private static final int RSA_MAX_KEY_SIZE = 4096;
    private static final int RSA_MIN_KEY_SIZE = 512;
    private static final List<String> SUPPORTED_EC_NIST_CURVE_NAMES = new ArrayList(12);
    private static final Map<String, Integer> SUPPORTED_EC_NIST_CURVE_NAME_TO_SIZE = new HashMap(12);
    private static final List<Integer> SUPPORTED_EC_NIST_CURVE_SIZES = new ArrayList(12);
    ...
    static {
        ...
        SUPPORTED_EC_NIST_CURVE_NAME_TO_SIZE.put("sm2-256", 256);
        SUPPORTED_EC_NIST_CURVE_NAME_TO_SIZE.put("sm2p256v1", 256);
    ...
    private void initializeAlgorithmBySpec(HwKeyGenParameterSpec spec) throws InvalidAlgorithmParameterException {
        try {
            ...
            if (spec.getKeystoreAlias() != null) {
                ...
                if (keymasterAlgorithm == 3) {
                    this.mKeymasterEncryptionPaddings = HwKeyProperties.EncryptionPadding.allToKeymasterEC(spec.getEncryptionPaddings());
                    this.mKeymasterSignaturePaddings = HwKeyProperties.SignaturePadding.allToKeymasterEC(spec.getSignaturePaddings());
                } else {
    ...
    public void initialize(AlgorithmParameterSpec params, SecureRandom random) throws InvalidAlgorithmParameterException {
        ...
        if (params != null) {
            initializeAlgorithmBySpec(convertToHwKeyGenParamSpec(params));
            this.mRng = random;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r11v0, resolved type: com.huawei.security.keystore.HwUniversalKeyStoreKeyPairGeneratorSpi */
    ...
    public KeyPair generateKeyPair() {
        ...
        if (((r1 == true ? 1 : 0) & 1) == 0 || hwKeystoreManager.state() == HwKeystoreManager.State.UNLOCKED) {
            ...
            HwKeymasterArguments args = constructKeyGenerationArguments();
            boolean success = false;
            try {
                generateKeystoreKeyPair(privateKeyAlias, args, additionalEntropy, r1 == true ? 1 : 0);
                KeyPair keyPair = loadKeystoreKeyPair(privateKeyAlias);
                if (args.getBoolean(HwKeymasterDefs.KM_TAG_IS_FROM_GM)) {
                    Log.i(TAG, "generateKeyPair SM2 SUCCESS!!!");

package com.huawei.server.hwmultidisplay.airsharing;
...
public class AirSharingManager {
    ...
    private final ServiceConnection mConnAirSharing = new ServiceConnection() {
        /* class com.huawei.server.hwmultidisplay.airsharing.AirSharingManager.AnonymousClass1 */
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            if (AirSharingManager.this.mHandler == null) {
                ...
                AirSharingManager.this.mHandler.postDelayed(new Runnable() {
                    /* class com.huawei.server.hwmultidisplay.airsharing.AirSharingManager.AnonymousClass1.AnonymousClass1 */

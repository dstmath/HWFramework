...
public class BatteryPreheatNotification {
    ...
    public void notification() {
        ...
        notificationBuilder.setContentTitle(this.mContext.getResources().getString(33686212));
        String contentTextString = this.mContext.getResources().getString(33686211);

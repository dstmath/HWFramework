...
public final class AppInfo {
    ...
    public static class MemcgInfo {
        ...
        static /* synthetic */ int access$1808(MemcgInfo x0) {
    ...
    public static class AppInfoBase {
        ...
        public AppInfoBase(int uid2, String appName2) {
            this.uid = uid2;
    ...
    public void setIsFronted(boolean isFronted2) {
    ...
    public void incFreezeTimes() {
        MemcgInfo.access$1808(this.memcgInfo);
    }

...
public class HwSecurityServiceProxy extends DefaultHwSecurityServiceProxy {
    ...
    /* JADX WARN: Type inference failed for: r0v1, types: [com.huawei.server.security.HwSecurityServiceProxy$HwSecurityServiceWrapper, android.os.IBinder] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public void onStart() {
        if (IS_HW_DEBUG) {
            Log.d(TAG, "Start HwSecurityService");
        }
        ServiceManagerEx.addService(SECURITY_SERVICE, (IBinder) new HwSecurityServiceWrapper());
        registerCorePlugins();

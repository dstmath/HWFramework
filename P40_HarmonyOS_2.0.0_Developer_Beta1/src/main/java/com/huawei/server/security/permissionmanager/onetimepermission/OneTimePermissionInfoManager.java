...
public class OneTimePermissionInfoManager {
    ...
    private static final int EVT_ON_INFO_INIT_ANYWAY = 1003;
    ...
    private void initBeforBootCompleted() {
        Message.obtain(this.mHandler, (int) EVT_ON_INFO_INIT_ANYWAY).sendToTarget();
    }
    ...
    private class OneTimePermissionHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case OneTimePermissionInfoManager.EVT_ON_INFO_INIT_ANYWAY /* 1003 */:
                    OneTimePermissionInfoManager.this.mOneTimePermAdapter.initFromLastActiveData();
                    return;
                default:
                    return;
            }

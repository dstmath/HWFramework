...
public interface INearbyService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INearbyService {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            NearDevConfig _arg1;
            NearListenOption _arg12;
            NearAdvertiseOption _arg13;
            NearListenOption _arg24;
            NearAdvertiseOption _arg14;
            switch (code) {
                case 1:
                    ...
                    int _result = startDiscovery(_arg0, _arg14, data.createTypedArrayList(NearServiceFilter.CREATOR), INearDiscoveryCallback.Stub.asInterface(data.readStrongBinder()));
                ...
                case 5:
                    ...
                    if (data.readInt() != 0) {
                        _arg13 = NearAdvertiseOption.CREATOR.createFromParcel(data);
                    } else {
                        _arg13 = null;
                    }
                    int _result5 = publish(_arg03, _arg13, INearConnectionCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                ...
                case 7:
                    ...
                    if (data.readInt() != 0) {
                        _arg12 = NearListenOption.CREATOR.createFromParcel(data);
                    } else {
                        _arg12 = null;
                    }
                    int _result7 = subscribe(_arg04, _arg12, INearDiscoveryCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                ...
                case 9:
                    ...
                    if (data.readInt() != 0) {
                        _arg1 = NearDevConfig.CREATOR.createFromParcel(data);
                    } else {
                        _arg1 = null;
                    }
                    int _result9 = setConfig(_arg05, _arg1);
                    reply.writeNoException();
                    reply.writeInt(_result9);
                    return true;
                case TRANSACTION_connect /* 10 */:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    return true;
                case TRANSACTION_disconnect /* 11 */:
                    data.enforceInterface(DESCRIPTOR);
                    int _result11 = disconnect(data.readString(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result11);
                    return true;
                case TRANSACTION_acceptConnect /* 12 */:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_sendData /* 14 */:
                    ...
                    return true;
                case TRANSACTION_disconnectAll /* 15 */:
                    data.enforceInterface(DESCRIPTOR);
                    int _result15 = disconnectAll(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result15);
                    return true;
                case TRANSACTION_destroy /* 16 */:
                    data.enforceInterface(DESCRIPTOR);
        ...
        private static class Proxy implements INearbyService {
            ...
            public int acceptConnect(String moduleId, String deviceId, NearConnectOption connectOption, INearDataCallback callback) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(callback != null ? callback.asBinder() : null);
                    this.mRemote.transact(Stub.TRANSACTION_acceptConnect, _data, _reply, 0);
                    _reply.readException();
                    return _reply.readInt();
                } finally {
                    _reply.recycle();
            ...
            public int rejectConnect(String moduleId, String deviceId) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(moduleId);
                    _data.writeString(deviceId);
                    this.mRemote.transact(Stub.TRANSACTION_rejectConnect, _data, _reply, 0);
                    _reply.readException();
                    return _reply.readInt();
                } finally {
                    _reply.recycle();

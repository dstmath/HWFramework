...
public class FocusAnimation {
    ...
    public void drawFocusAnimation(Canvas canvas, Path path, Rect pathRect, int pathColor) {
        ...
        if (isValid(canvas, path, pathRect)) {
            ...
            int sc = canvas.saveLayerAlpha((float) (pathRect.left - this.mPadding), (float) (pathRect.top - this.mPadding), (float) (pathRect.right + this.mPadding), (float) (pathRect.bottom + this.mPadding), ConstantValues.MAX_CHANNEL_VALUE);
            int maxHeight = (int) Math.sqrt(Math.pow((double) (((float) pathRect.width()) + (((float) this.mPadding) * 2.0f)), 2.0d) + Math.pow((double) (((float) pathRect.height()) + (((float) this.mPadding) * 2.0f)), 2.0d));
            this.mPaint.setStyle(Paint.Style.STROKE);
            this.mPaint.setColor(pathColor);
            this.mPaint.setShader(null);
            canvas.drawPath(path, this.mPaint);
            this.mPaint.setXfermode(this.mSrcInXferMode);
            canvas.translate((((float) pathRect.width()) / 2.0f) + ((float) pathRect.left), (((float) pathRect.height()) / 2.0f) + ((float) pathRect.top));
            canvas.rotate(this.mAnimatedValue);
            this.mPaint.setStyle(Paint.Style.FILL);
            int red = (RED_MASK & pathColor) >> 16;
            int green = (GREEN_MASK & pathColor) >> 8;
            int blue = pathColor & ConstantValues.MAX_CHANNEL_VALUE;
            int boundaryColor = Color.argb(this.mAlpha, red, green, blue);
            int glowColor = Color.argb(this.mAlphaFadeIn, red, green, blue);
            if (((float) pathRect.width()) / ((float) pathRect.height()) > 2.0f) {
                blurArray = BLUR_ARRAY_DOUBLE;
            } else {
                blurArray = BLUR_ARRAY;
            }
            this.mPaint.setShader(new LinearGradient((float) (-((int) (((float) pathRect.width()) / 2.0f))), 0.0f, (float) ((int) (((float) pathRect.width()) / 2.0f)), 0.0f, new int[]{boundaryColor, boundaryColor, glowColor, glowColor, boundaryColor, boundaryColor}, blurArray, Shader.TileMode.CLAMP));
            int i = this.mPadding;
            canvas.drawRect((float) (-((int) ((((float) maxHeight) / 2.0f) + ((float) i)))), (float) (-((int) ((((float) maxHeight) / 2.0f) + ((float) i)))), (float) ((int) ((((float) maxHeight) / 2.0f) + ((float) i))), (float) ((int) ((((float) maxHeight) / 2.0f) + ((float) i))), this.mPaint);
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (currentTime - FocusAnimation.this.mLastDrawGlowEdgeTime > FocusAnimation.ANIMATION_INTERVAL) {
                    ...
                    if (obj instanceof Float) {
                        FocusAnimation.this.mAnimatedValue = ((Float) obj).floatValue();
                    } else {
                        Log.e(FocusAnimation.TAG, "value (" + obj + ") of degree is wrong");
                    }
    ...
    private void createAlphaAnimator() {
        this.mAlphaAnimator = ValueAnimator.ofInt(25, 150);
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (currentTime - FocusAnimation.this.mLastDrawBoundaryTime > FocusAnimation.ANIMATION_INTERVAL) {
                    ...
                    if (obj instanceof Integer) {
                        FocusAnimation.this.mAlpha = ((Integer) obj).intValue();
                    } else {
                        Log.e(FocusAnimation.TAG, "value (" + obj + ") of alpha is wrong");
                    }
    ...
    private void createFadeInAnimator() {
        this.mFadeInAnimator = ValueAnimator.ofInt(0, ConstantValues.MAX_CHANNEL_VALUE);
        ...
        this.mFadeInAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (currentTime - FocusAnimation.this.mLastFadeInTime > FocusAnimation.ANIMATION_INTERVAL) {
                    Object obj = animation.getAnimatedValue();
                    if (obj instanceof Integer) {
                        FocusAnimation.this.mAlphaFadeIn = ((Integer) obj).intValue();
                    } else {
                        Log.e(FocusAnimation.TAG, "value (" + obj + ") of alpha fade in is wrong");
                    }

...
public class EasyInvokeUtils {
        ...
        for (Method method : methods) {
            ...
            if (annotations != null && annotations.length > 0) {
                ...
                if (target instanceof InvokeMethod) {
                    loadInvokeMethodInfo(method, (InvokeMethod) target);
                } else if (target instanceof GetField) {
                    loadGetFieldInfo(method, (GetField) target);
                } else if (target instanceof SetField) {
                    loadSetFieldInfo(method, (SetField) target);
                } else {
    ...
    private void loadInvokeMethodInfo(Method method, InvokeMethod targetMethodInfo) {
        if (targetMethodInfo != null) {
            Class<?>[] originParams = method.getParameterTypes();
            ...
            try {
                ...
                setMethodObject(method, targetMethod, targetMethodInfo);
    ...
    private void loadGetFieldInfo(Method method, GetField targetFieldInfo) {
        if (targetFieldInfo != null) {
            ...
            try {
                ...
                setFieldObject(method, targetFiled, targetFieldInfo);
            } catch (SecurityException e) {
    ...
    private void loadSetFieldInfo(Method method, SetField targetFieldInfo) {
        if (targetFieldInfo != null) {
            Class<?>[] originParams = method.getParameterTypes();
            if (originParams.length < 1) {
                Log.e(TAG, "no target class");
    ...
    private void setFieldObject(Method method, Field targetField, GetField targetFieldInfo) {
        if (targetFieldInfo != null) {
            String fieldName = targetFieldInfo.fieldObject();
            if (fieldName == null || fieldName.trim().length() == 0) {
                fieldName = targetFieldInfo.fieldName();
            }
            setFieldObject(method, targetField, fieldName);
        }
    }

    private void setFieldObject(Method method, Field targetField, SetField targetFieldInfo) {
        if (targetFieldInfo != null) {
            String fieldName = targetFieldInfo.fieldObject();
            if (fieldName == null || fieldName.trim().length() == 0) {
                fieldName = targetFieldInfo.fieldName();
    ...
    private void setFieldObject(Method method, Field targetFiled, String fieldName) {
    ...
    private void setMethodObject(Method method, Method targetMethod, InvokeMethod targetMethodInfo) {
        try {

...
import vendor.huawei.hardware.biometrics.hwvoiceid.V2_1.IBiometricsVoiceId;
...
public class VoiceHidlAdapter {
    ...
    public static class GetVoiceMessageResultCallbackWrapper {
        public ArrayList<Byte> info = null;
    ...
    public int checkAlgoMatch(int version) {
        IBiometricsVoiceId daemonV1 = getVoiceIdDaemonV1();
        if (daemonV1 == null) {
            return -1;
        }
        try {
            return vendor.huawei.hardware.biometrics.hwvoiceid.V2_1.IBiometricsVoiceId.castFrom((IHwInterface) daemonV1).checkAlgoMatch(version);
        } catch (RemoteException e) {
            Log.e(TAG, "voiceid 2.0 : Failed to checkAlgoMatch");
            return -1;
        }
    }

    public int sendVoiceMessage(ArrayList<Byte> message, ArrayList<Byte> extraMessage) {
        IBiometricsVoiceId daemonV1 = getVoiceIdDaemonV1();
        if (daemonV1 == null) {
            return -1;
        }
        try {
            return vendor.huawei.hardware.biometrics.hwvoiceid.V2_1.IBiometricsVoiceId.castFrom((IHwInterface) daemonV1).sendVoiceMessage(message, extraMessage);
        } catch (RemoteException e) {
            Log.e(TAG, "voiceid 2.0 : Failed to sendVoiceMessage");
            return -1;
        }
    }

    public int share(ArrayList<Byte> hat, ArrayList<Integer> voiceType) {
        IBiometricsVoiceId daemonV1 = getVoiceIdDaemonV1();
        if (daemonV1 == null) {
            return -1;
        }
        try {
            return vendor.huawei.hardware.biometrics.hwvoiceid.V2_1.IBiometricsVoiceId.castFrom((IHwInterface) daemonV1).share(hat, voiceType);
        } catch (RemoteException e) {
            Log.e(TAG, "voiceid 2.0 : Failed to share");
            return -1;
        }
    }

    public void getVoiceMessage(int messageId, GetVoiceMessageResultCallbackWrapper getVoiceMessageResultWrapper) {
        IBiometricsVoiceId daemonV1 = getVoiceIdDaemonV1();
        if (daemonV1 == null) {
            Log.e(TAG, "getVoiceMessage: no voice recognize HAL!");
            return;
        }
        try {
            GetVoiceMessageResultCallback getVoiceMessageResult = new GetVoiceMessageResultCallback();
            vendor.huawei.hardware.biometrics.hwvoiceid.V2_1.IBiometricsVoiceId.castFrom((IHwInterface) daemonV1).getVoiceMessage(messageId, getVoiceMessageResult);
            getVoiceMessageResultWrapper.result = getVoiceMessageResult.result;
            getVoiceMessageResultWrapper.message = getVoiceMessageResult.message;
            getVoiceMessageResultWrapper.info = getVoiceMessageResult.info;
        } catch (RemoteException e) {
            Log.e(TAG, "voiceid 2.0 : Failed to getVoiceMessage");
        }
    }

    private static class GetVoiceMessageResultCallback implements IBiometricsVoiceId.getVoiceMessageCallback {
        public ArrayList<Byte> info;
        public int message;
        public int result;

        private GetVoiceMessageResultCallback() {
            this.result = -1;
            this.message = 0;
            this.info = null;
        }
        ...
        public void onValues(int ret, int paramInt, ArrayList<Byte> paramArrayList) {
            this.result = ret;

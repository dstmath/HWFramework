...
public final class WifiConfigManager extends AsyncTask<WifiParsedResult, Object, Object> {
    ...
    public Object doInBackground(WifiParsedResult... args) {
            ...
            if (this.wifiManager.setWifiEnabled(true)) {
                ...
                while (!this.wifiManager.isWifiEnabled()) {
                    if (count >= 10) {
                        ...
                        SaveConfigurationListener saveConfigurationListener = mListener;
                        if (saveConfigurationListener != null) {
                            saveConfigurationListener.onSaveConfigurationFailed(1);
                        }
                        return null;
                    }
                ...
                SaveConfigurationListener saveConfigurationListener2 = mListener;
                if (saveConfigurationListener2 != null) {
                    saveConfigurationListener2.onSaveConfigurationFailed(0);
                }
                return null;
            }
        }
        try {
            ...
            SaveConfigurationListener saveConfigurationListener3 = mListener;
            if (saveConfigurationListener3 != null) {
                saveConfigurationListener3.onSaveConfigurationFailed(2);
            }
            return null;
        }
    }
    ...
    private static void updateNetwork(WifiManager wifiManager2, WifiConfiguration config) {
        ...
        if (networkId < 0) {
            ...
            SaveConfigurationListener saveConfigurationListener2 = mListener;
            if (saveConfigurationListener2 != null) {
                saveConfigurationListener2.onSaveConfigurationSucceed(config);
            }
        } else {
            SaveConfigurationListener saveConfigurationListener3 = mListener;
            if (saveConfigurationListener3 != null) {
                saveConfigurationListener3.onSaveConfigurationFailed(1);
            }
            String str4 = TAG;

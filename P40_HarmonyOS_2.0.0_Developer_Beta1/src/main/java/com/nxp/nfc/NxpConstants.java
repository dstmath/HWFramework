...
public final class NxpConstants {
    ...
    public static final String ACTION_NFC_SECURE_READER_MODE_RESTART = "com.nxp.nfc_extras.action.NFC_SECURE_READER_MODE_RESTART";
    public static final String ACTION_NFC_SECURE_READER_MODE_START_FAIL = "com.nxp.nfc_extras.action.NFC_SECURE_READER_MODE_START_FAIL";
    public static final String ACTION_NFC_SECURE_READER_MODE_START_SUCCESS = "com.nxp.nfc_extras.action.NFC_SECURE_READER_MODE_START_SUCCESS";
    public static final String ACTION_NFC_SECURE_READER_MODE_STOP_FAIL = "com.nxp.nfc_extras.action.NFC_SECURE_READER_MODE_STOP_FAIL";
    public static final String ACTION_NFC_SECURE_READER_MODE_STOP_SUCCESS = "com.nxp.nfc_extras.action.NFC_SECURE_READER_MODE_STOP_SUCCESS";
    public static final String ACTION_NFC_SECURE_READER_MODE_TARGET_ACTIVATED = "com.nxp.nfc_extras.action.NFC_SECURE_READER_MODE_TARGET_ACTIVATED";
    public static final String ACTION_NFC_SECURE_READER_MODE_TIMEOUT = "com.nxp.nfc_extras.action.NFC_SECURE_READER_MODE_TIMEOUT";
    ...
    public static final int SCR_STATUS_BUSY = 235;
    public static final int SCR_STATUS_FAILED = 3;
    public static final int SCR_STATUS_REJECTED = 1;
    public static final int SCR_STATUS_SUCCESS = 0;

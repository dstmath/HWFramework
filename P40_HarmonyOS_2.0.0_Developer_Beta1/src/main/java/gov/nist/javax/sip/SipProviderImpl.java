        ...
        if (request == null) {
            ...
            if (sipRequest.getTransaction() != null) {
                ...
                try {
                    ...
                    } else if (!request.getMethod().equalsIgnoreCase(Request.CANCEL) || (ct = (SIPClientTransaction) this.sipStack.findCancelTransaction((SIPRequest) request, false)) == null) {
                        if (this.sipStack.isLoggingEnabled()) {
                            StackLogger stackLogger = this.sipStack.getStackLogger();
        ...
        if (this.sipStack.isAlive()) {
            ...
            if (via != null) {
                ...
                if (st == null || st.getState() == TransactionState.TERMINATED || !isAutomaticDialogSupportEnabled()) {
                    ...
                    if (port2 == -1 && (port2 = via.getPort()) == -1) {

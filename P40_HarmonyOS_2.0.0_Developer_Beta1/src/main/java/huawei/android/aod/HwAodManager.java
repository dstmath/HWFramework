...
public class HwAodManager {
    ...
    private static volatile HwAodManager sInstance = null;
    ...
    public static synchronized HwAodManager getInstance() {
        ...
        synchronized (HwAodManager.class) {
            if (sInstance == null) {
                sInstance = new HwAodManager();
            }
            hwAodManager = sInstance;
        }
        return hwAodManager;
    }
    ...
    public void sendCommandToTp(int featureFlag, String cmdStr) {
        ...
        if (service != null) {
            try {
                service.sendCommandToTp(featureFlag, cmdStr);
            } catch (RemoteException ex) {
                Slog.e(TAG, "send command failed!", ex);
            }
        } else {
            Slog.e(TAG, "send command failed due to null service!");
        }
    }
    ...
    public void configTpInApMode(int aodState) {
        ...
        if (service != null) {
            try {
                service.configTpInApMode(aodState);
            } catch (RemoteException ex) {
                Slog.e(TAG, "config TP in ap mode failed!", ex);
            }
        } else {
            Slog.e(TAG, "config TP in ap mode failed due to null service!");
        }
    }
}

...
import android.database.HwDatabaseErrorReporter;
...
import android.view.HwBlurWindowManagerImpl;
import android.view.HwViewGroupImpl;
...
import android.vrsystem.HwVrFactory;
...
import com.huawei.android.view.HwShadowManagerImpl;
...
import com.huawei.rio.HwRioImpl;
import huawei.android.app.HwApiCacheMangerEx;
import huawei.android.app.HwHarmonyServiceManagerImpl;
...
public class HwFrameworkFactoryImpl implements HwFrameworkFactory.Factory {
    ...
    public IHwAppInnerBoost getHwAppInnerBoostImpl() {
        return HwPartIawareFactory.loadFactory("android.common.HwPartIawareFactoryImpl").getHwAppInnerBoostImpl();
    }
    ...
    public HwSysResource getHwResource(int resourceType) {
        return HwDFRFrameworkFactory.getRMSFrameworkFactory().getHwSysResource(resourceType);
    }

    public IZrHung getZrHung(String wpName) {
        return HwDFRFrameworkFactory.getZrHungFrameworkFactory().getIZrHung(wpName);
    }

    public IAppEyeUiProbe getAppEyeUiProbe() {
        return HwDFRFrameworkFactory.getZrHungFrameworkFactory().getAppEyeUiProbe();
    }
    ...
    public IVRSystemServiceManager getVRSystemServiceManager() {
        return HwVrFactory.loadFactory().getHwVrServiceManager();
    }
    ...
    public IHwDatabaseErrorReporter getHwDatabaseErrorReporter() {
        return HwDatabaseErrorReporter.getInstance();
    }
    ...
    public IAwareBitmapCacher getHwIAwareBitmapCacher() {
        return HwPartIawareFactory.loadFactory("android.common.HwPartIawareFactoryImpl").getAwareBitmapCacherImpl();
    }
    ...
    public IHwNotificationEx getHwNotificationEx(Context context) {
        return new HwNotificationEx(context);
    }

    public IBlockMonitor getBlockMonitor() {
        return HwDFRFrameworkFactory.getZrHungFrameworkFactory().getBlockMonitor();
    }
    ...
    public IHwRtgSchedImpl getHwRtgSchedImpl() {
        return HwPartIawareFactory.loadFactory("android.common.HwPartIawareFactoryImpl").getHwRtgSchedImpl();
    }
    ...
    public HwViewGroupImpl getHwViewGroup() {
        return HwViewGroupImpl.getDefault();
    }

    public IHwBlurWindowManager getHwBlurWindowManager() {
        return new HwBlurWindowManagerImpl();
    }

    public IHwRio getHwRio() {
        return HwRioImpl.getDefault();
    }

    public IHwHarmonyServiceManager getHwHarmonyServiceManager() {
        return HwHarmonyServiceManagerImpl.getInstance();
    }

    public IHwShadowManager getHwShadowManager(Context context) {
        if (context == null) {
            return null;
        }
        return HwShadowManagerImpl.getInstance(context);
    }
}

...
public class HwFrameworkMonitorImpl implements HwFrameworkMonitor {
    ...
    private static final int USAGE_COUNT_NUM = 3;
        ...
        if (params != null) {
            switch (sceneId) {
                ...
                case 907034002:
                    ...
                    StringBuilder message = new StringBuilder(params.getString("message", StorageManagerExt.INVALID_KEY_DESC));
                ...
                case 907400031:
                    ...
                    break;
                case 907400032:
                    eventStream.setParam("WORKING_TIME", params.getInt("WORKING_TIME", 0));
                    eventStream.setParam("PACKAGE_NAME", params.getString("PACKAGE_NAME", "unknown"));
                    break;
                case 907400284:
                    for (int i = 0; i < 3; i++) {
                        String typeKey = "TYPE" + (i + 1);
                        String countKey = "COUNT" + (i + 1);
                        eventStream.setParam(typeKey, params.getString(typeKey));
                        eventStream.setParam(countKey, params.getInt(countKey));
                    }
                    break;
                case 942030001:

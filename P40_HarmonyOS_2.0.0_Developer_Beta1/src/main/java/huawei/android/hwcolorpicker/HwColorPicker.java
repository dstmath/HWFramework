...
public class HwColorPicker {
    ...
    public enum ResultType {
        ...
        public String toString() {
            return name() + "[" + this.mClientType + ", " + this.mIndex + ", " + String.format(Locale.ROOT, "0x%08x", Integer.valueOf(this.mFlag)) + "]";
        }
    }
        ...
        public String toString() {
            ...
            if (iArr != null) {
                ...
                for (int i = 0; i < length; i++) {
                    stringBuffer.append(String.format(Locale.ROOT, "0x%08x", Integer.valueOf(this.mColorPickeds[i])));
                    if (i != length - 1) {
                        stringBuffer.append(", ");
                    }
                }

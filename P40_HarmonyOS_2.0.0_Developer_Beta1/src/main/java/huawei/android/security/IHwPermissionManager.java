...
public interface IHwPermissionManager extends IInterface {
    ...
    int verifyHwAuthCertification(String str) throws RemoteException;
    ...
    public static class Default implements IHwPermissionManager {
        ...
        @Override // huawei.android.security.IHwPermissionManager
        public int verifyHwAuthCertification(String packagePath) throws RemoteException {
            return 0;
        }
    ...
    public static abstract class Stub extends Binder implements IHwPermissionManager {
        ...
        static final int TRANSACTION_verifyHwAuthCertification = 12;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 12:
                        data.enforceInterface(DESCRIPTOR);
                        int _result5 = verifyHwAuthCertification(data.readString());
                        reply.writeNoException();
            ...
            public int verifyHwAuthCertification(String packagePath) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(12, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().verifyHwAuthCertification(packagePath);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();

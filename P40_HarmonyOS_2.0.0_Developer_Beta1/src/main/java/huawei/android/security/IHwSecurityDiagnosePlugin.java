...
public interface IHwSecurityDiagnosePlugin extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHwSecurityDiagnosePlugin {
        ...
        static final int TRANSACTION_getRootStatus = 3;
        static final int TRANSACTION_getRootStatusSync = 4;
        static final int TRANSACTION_getStpStatusByCategory = 7;
        static final int TRANSACTION_getSystemStatus = 2;
        static final int TRANSACTION_getSystemStatusSync = 5;
        static final int TRANSACTION_report = 1;
        static final int TRANSACTION_sendThreatenInfo = 6;
        static final int TRANSACTION_startKernelDetection = 10;
        static final int TRANSACTION_stopKernelDetection = 8;
        static final int TRANSACTION_updateKernelDetectionConfig = 9;
            ...
            if (code != 1598968902) {
                switch (code) {
                    case 1:
                        ...
                        int _result = report(_arg0, _arg1);
                    ...
                    case 7:
                        ...
                        int _result6 = getStpStatusByCategory(_arg02, _arg12, _arg2, _arg3, _arg4);
                        reply.writeNoException();

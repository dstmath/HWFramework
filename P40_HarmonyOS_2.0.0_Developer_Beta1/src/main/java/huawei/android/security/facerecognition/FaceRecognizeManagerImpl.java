...
public class FaceRecognizeManagerImpl extends DefaultFaceRecognizeManagerImpl {
    private static final int AUTH_TOKEN_LEN = 69;
    ...
    private IFaceRecognizeServiceReceiver mReceiver = new IFaceRecognizeServiceReceiver.Stub() {
        /* class huawei.android.security.facerecognition.FaceRecognizeManagerImpl.AnonymousClass1 */

        public void onCallback(long reqId, final int type, final int code, final int errorCode) throws RemoteException {
            final int innerReqId = (int) reqId;
            ...
            if (FaceRecognizeManagerImpl.this.mCallback != null) {
                if (type == 2 && code == 1 && errorCode == 0) {
                    long current = System.nanoTime();
                    SlogEx.d("PerformanceTime", "Time 6. Authenticate Success --- " + current);
                }
                FaceRecognizeManagerImpl.sHandler.post(new Runnable() {
                    /* class huawei.android.security.facerecognition.FaceRecognizeManagerImpl.AnonymousClass1.AnonymousClass1 */

                    @Override // java.lang.Runnable
                    public void run() {
                        FaceRecognizeManagerImpl.this.mCallback.onCallbackEvent(innerReqId, type, code, errorCode);
                    }
                });
                return;
            }
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: huawei.android.security.facerecognition.FaceRecognizeManagerImpl$1 */
    ...
    public static class ServiceHolder implements IBinder.DeathRecipient {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private int authenticate(long opId, int flags, IFaceRecognizeServiceReceiver receiver) {
            IFaceRecognizeServiceEx service = getFaceRecognizeService();
            if (service == null) {
                return OP_FAILED;
            }
            try {
                SlogEx.d("auth receiver", receiver.toString());
                service.authenticate(this.mToken, new AuthParam(flags, (int) FaceRecognizeManagerImpl.FACERECOGNITION_OFF, opId, ContextEx.getOpPackageName(this.mContext)), receiver);
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private int cancelAuthentication(long reqId, IFaceRecognizeServiceReceiver receiver) {
            IFaceRecognizeServiceEx service = getFaceRecognizeService();
            if (service == null) {
                return OP_FAILED;
            }
            try {
                service.cancelAuthentication(this.mToken, new AuthParam((int) FaceRecognizeManagerImpl.FACERECOGNITION_OFF, (int) FaceRecognizeManagerImpl.FACERECOGNITION_OFF, reqId, ContextEx.getOpPackageName(this.mContext)), receiver);
                return FaceRecognizeManagerImpl.FACERECOGNITION_OFF;
            } catch (RemoteException e) {
                return OP_FAILED;
            }
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private int enroll(byte[] authToken, int reqId, int flags, Surface preview, IFaceRecognizeServiceReceiver receiver) {
            IFaceRecognizeServiceEx service = getFaceRecognizeService();
            if (service == null) {
                return OP_FAILED;
            }
            try {
                service.enroll(this.mToken, new EnrollParam(authToken, flags, (int) FaceRecognizeManagerImpl.FACERECOGNITION_OFF, (long) reqId, ContextEx.getOpPackageName(this.mContext)), preview, receiver);
                return FaceRecognizeManagerImpl.FACERECOGNITION_OFF;
            } catch (RemoteException e) {
                return OP_FAILED;
            }
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private int cancelEnrollment(int reqId, IFaceRecognizeServiceReceiver receiver) {
            IFaceRecognizeServiceEx service = getFaceRecognizeService();
            if (service == null) {
                return OP_FAILED;
            }
            try {
                service.cancelEnrollment(this.mToken, new EnrollParam(new byte[FaceRecognizeManagerImpl.FACERECOGNITION_OFF], (int) FaceRecognizeManagerImpl.FACERECOGNITION_OFF, (int) FaceRecognizeManagerImpl.FACERECOGNITION_OFF, (long) reqId, ContextEx.getOpPackageName(this.mContext)), receiver);
                return FaceRecognizeManagerImpl.FACERECOGNITION_OFF;
            } catch (RemoteException e) {
                return OP_FAILED;
            }
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private int remove(int faceId, int reqId, IFaceRecognizeServiceReceiver receiver) {
            IFaceRecognizeServiceEx service = getFaceRecognizeService();
            if (service == null) {
                return OP_FAILED;
            }
            try {
                service.remove(this.mToken, new RemoveParam(faceId, (int) FaceRecognizeManagerImpl.FACERECOGNITION_OFF, (long) reqId, ContextEx.getOpPackageName(this.mContext)), receiver);
                return FaceRecognizeManagerImpl.FACERECOGNITION_OFF;
            } catch (RemoteException e) {
                return OP_FAILED;
            }
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private int checkNeedUpgradeFeature(long reqId, IFaceRecognizeServiceReceiver receiver) {
            IFaceRecognizeServiceEx service = getFaceRecognizeService();
            if (service == null) {
                SlogEx.e(FaceRecognizeManagerImpl.TAG, "service is null");
                return OP_FAILED;
            ...
            try {
                service.checkNeedUpgradeFeature(this.mToken, new EnrollParam((byte[]) null, (int) FaceRecognizeManagerImpl.FACERECOGNITION_OFF, (int) FaceRecognizeManagerImpl.FACERECOGNITION_OFF, reqId, ContextEx.getOpPackageName(this.mContext)), receiver);
                return FaceRecognizeManagerImpl.FACERECOGNITION_OFF;
            } catch (RemoteException e) {
                SlogEx.e(FaceRecognizeManagerImpl.TAG, "checkNeedUpgradeFeature failed.");
                return OP_FAILED;
            }
        }
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private int upgradeFeature(long reqId, byte[] authToken, IFaceRecognizeServiceReceiver receiver) {
            if (authToken.length != FaceRecognizeManagerImpl.AUTH_TOKEN_LEN) {
                SlogEx.d(FaceRecognizeManagerImpl.TAG, "invalid auth token length");
                return OP_FAILED;
            }
            IFaceRecognizeServiceEx service = getFaceRecognizeService();
            if (service == null) {
            ...
            try {
                service.upgradeFeature(this.mToken, new EnrollParam(authToken, (int) FaceRecognizeManagerImpl.FACERECOGNITION_OFF, (int) FaceRecognizeManagerImpl.FACERECOGNITION_OFF, reqId, ContextEx.getOpPackageName(this.mContext)), receiver);
                return FaceRecognizeManagerImpl.FACERECOGNITION_OFF;
            } catch (RemoteException e) {
                SlogEx.e(FaceRecognizeManagerImpl.TAG, "upgradeFeature failed.");
                return OP_FAILED;
            }
        }
    ...
    public int authenticate(long opId, int flags, @Nullable Surface preview) {
        ...
        return ServiceHolder.getInstance().authenticate(opId, flags, this.mReceiver);
    }

    public int cancelAuthenticate(long opId) {
        return ServiceHolder.getInstance().cancelAuthentication(opId, this.mReceiver);
    }
    ...
    public int enroll(int reqId, int flags, byte[] token, @Nullable Surface preview) {
        ...
        return ServiceHolder.getInstance().enroll(token, reqId, flags, preview, this.mReceiver);
    }

    public int cancelEnroll(int reqId) {
        return ServiceHolder.getInstance().cancelEnrollment(reqId, this.mReceiver);
    }
    ...
    public int remove(int reqId, int faceId) {
        ...
        return ServiceHolder.getInstance().remove(faceId, reqId, this.mReceiver);
    }
    ...
    public int checkNeedUpgradeFeature(long reqId) {
        return ServiceHolder.getInstance().checkNeedUpgradeFeature(reqId, this.mReceiver);
    }

    public int upgradeFeature(long reqId, @NonNull byte[] authToken) {
        return ServiceHolder.getInstance().upgradeFeature(reqId, authToken, this.mReceiver);
    }

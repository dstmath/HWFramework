...
public interface IVoiceRecognizeService extends IInterface {
    ...
    Bundle checkShareInfo(Bundle bundle) throws RemoteException;
    ...
    Bundle getBiometricsInfo(byte[] bArr, Bundle bundle) throws RemoteException;
    ...
    int sendBiometricsInfo(Bundle bundle) throws RemoteException;
    ...
    int share(int i, byte[] bArr, int[] iArr) throws RemoteException;
    ...
    public static class Default implements IVoiceRecognizeService {
        ...
        @Override // huawei.android.security.voicerecognition.IVoiceRecognizeService
        public Bundle checkShareInfo(Bundle param) throws RemoteException {
            return null;
        }

        @Override // huawei.android.security.voicerecognition.IVoiceRecognizeService
        public int share(int userId, byte[] hat, int[] voiceType) throws RemoteException {
            return 0;
        }

        @Override // huawei.android.security.voicerecognition.IVoiceRecognizeService
        public Bundle getBiometricsInfo(byte[] bytes, Bundle bundle) throws RemoteException {
            return null;
        }

        @Override // huawei.android.security.voicerecognition.IVoiceRecognizeService
        public int sendBiometricsInfo(Bundle message) throws RemoteException {
            return 0;
        }
    ...
    public static abstract class Stub extends Binder implements IVoiceRecognizeService {
        ...
        static final int TRANSACTION_checkShareInfo = 22;
        static final int TRANSACTION_continueEnroll = 16;
        static final int TRANSACTION_enroll = 1;
        static final int TRANSACTION_getBiometricsInfo = 24;
            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 22:
                        ...
                        Bundle _result13 = checkShareInfo(_arg0);
                        reply.writeNoException();
                        if (_result13 != null) {
                            reply.writeInt(1);
                    ...
                    case 23:
                        data.enforceInterface(DESCRIPTOR);
                        int _result14 = share(data.readInt(), data.createByteArray(), data.createIntArray());
                        reply.writeNoException();
                    ...
                    case 24:
                        ...
                        Bundle _result15 = getBiometricsInfo(_arg03, _arg1);
                        reply.writeNoException();
                        if (_result15 != null) {
                            reply.writeInt(1);
                    ...
                    case 25:
                        ...
                        int _result16 = sendBiometricsInfo(_arg02);
                        reply.writeNoException();
        ...
        public static class Proxy implements IVoiceRecognizeService {
            ...
            public Bundle checkShareInfo(Bundle param) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(22, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().checkShareInfo(param);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
            ...
            public int share(int userId, byte[] hat, int[] voiceType) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeIntArray(voiceType);
                    if (!this.mRemote.transact(23, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().share(userId, hat, voiceType);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
            ...
            public Bundle getBiometricsInfo(byte[] bytes, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(24, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getBiometricsInfo(bytes, bundle);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (Bundle) Bundle.CREATOR.createFromParcel(_reply);
            ...
            public int sendBiometricsInfo(Bundle message) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(25, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().sendBiometricsInfo(message);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();

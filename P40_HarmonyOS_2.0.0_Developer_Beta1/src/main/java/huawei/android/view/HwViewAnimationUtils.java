...
public class HwViewAnimationUtils {
    ...
    /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x0021: APUT  (r6v0 float[]), (0 ??[int, short, byte, char]), (r9v0 float) */
    /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x003a: APUT  (r9v3 float[]), (0 ??[int, short, byte, char]), (r13v0 float) */
    /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x0050: APUT  (r13v3 float[]), (0 ??[int, short, byte, char]), (r14v0 float) */
    public static Animator createCircularRevealAnimator(boolean isEnter, final View fab, final View content, final View mask, int maskColor) {
        ...
        if (fab != null) {
            if (content != null) {
                ...
                TimeInterpolator frictionInterpolator = new PathInterpolator(FALOT_CONTROL_X, 0.0f, FALOT_CONTROL_X, 1.0f);
    ...
    /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x0011: APUT  (r0v1 float[]), (0 ??[int, short, byte, char]), (r4v0 float) */

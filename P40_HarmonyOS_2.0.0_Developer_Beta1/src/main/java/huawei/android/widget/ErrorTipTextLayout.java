...
public class ErrorTipTextLayout extends LinearLayout {
    ...
    public ErrorTipTextLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (theme != null) {
            ...
            TypedArray typedArray = theme.obtainStyledAttributes(attrs, themeAttrs, defAttrId, defStyleRes);
            this.mEditTextBgResId = typedArray.getResourceId(ResLoaderUtil.getStyleableId(context, "ErrorTipTextLayout_editTextBg"), 0);
            this.mEditTextBgWhiteResId = typedArray.getResourceId(ResLoaderUtil.getStyleableId(context, "ErrorTipTextLayout_editTextBgWhite"), 0);
            this.mLinearEditBgResId = typedArray.getResourceId(ResLoaderUtil.getStyleableId(context, "ErrorTipTextLayout_linearEditBg"), 0);
            this.mSpaceEditBgResId = typedArray.getResourceId(ResLoaderUtil.getStyleableId(context, "ErrorTipTextLayout_spaceEditBg"), 0);
            this.mErrorResBgId = typedArray.getResourceId(ResLoaderUtil.getStyleableId(context, "ErrorTipTextLayout_errorResBg"), 0);
            this.mErrorResBgWhiteId = typedArray.getResourceId(ResLoaderUtil.getStyleableId(context, "ErrorTipTextLayout_errorResBgWhite"), 0);
            this.mErrorLinearEditBgResId = typedArray.getResourceId(ResLoaderUtil.getStyleableId(context, "ErrorTipTextLayout_errorLiearEditBg"), 0);
            this.mErrorTextAppearance = typedArray.getResourceId(ResLoaderUtil.getStyleableId(context, "ErrorTipTextLayout_errorTextAppearance"), 0);
            boolean isErrorEnabled = typedArray.getBoolean(ResLoaderUtil.getStyleableId(context, "ErrorTipTextLayout_errorEnabled"), true);
            this.mIsSpaceOccupied = typedArray.getBoolean(ResLoaderUtil.getStyleableId(context, "ErrorTipTextLayout_spaceOccupied"), false);
            this.mShapeMode = ShapeMode.values()[typedArray.getInt(ResLoaderUtil.getStyleableId(context, "ErrorTipTextLayout_shape_mode"), ShapeMode.Bubble.getId())];
            typedArray.recycle();
    ...
    private void errorNotEmpty(CharSequence error) {
        ...
        } else if (this.mShapeMode == ShapeMode.Linear || this.mShapeMode == ShapeMode.Space) {
            this.mEditText.setBackgroundResource(this.mErrorLinearEditBgResId);
        } else if (this.mShapeMode == ShapeMode.White) {
            this.mEditText.setBackgroundResource(this.mErrorResBgWhiteId);
        }
    }

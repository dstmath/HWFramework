...
public class HwCard {
    ...
    private static final String ICON_STRING = "icon";
    ...
    private void inflateCardLayout() {
        int layoutId = getIdentifier(this.mContext, "layout", "hwcard_layout_stubs");
        if (layoutId != 0) {
            View view = this.mInflater.inflate(layoutId, (ViewGroup) null);
            if (view instanceof ViewGroup) {
                this.mCardLayout = (ViewGroup) view;
            }
            this.mHeaderStub = (ViewStub) view.findViewById(getIdentifier(this.mContext, "id", "header_stub"));
            this.mContentStub = (ViewStub) view.findViewById(getIdentifier(this.mContext, "id", "content_stub"));
            this.mFooterStub = (ViewStub) view.findViewById(getIdentifier(this.mContext, "id", "footer_stub"));
        }
    }
    ...
    private void adjustContentViewMargin() {
        ...
        if (view != null && this.mHeaderView == null) {
            ViewGroup.LayoutParams paramsTemp = view.getLayoutParams();
            if (paramsTemp instanceof ViewGroup.MarginLayoutParams) {
                ViewGroup.MarginLayoutParams layoutParams = (ViewGroup.MarginLayoutParams) paramsTemp;
                layoutParams.topMargin = ResLoader.getInstance().getResources(this.mContext).getDimensionPixelOffset(getIdentifier(this.mContext, "dimen", "margin_l"));
                this.mContentView.setLayoutParams(layoutParams);
            }
        }
        View view2 = this.mContentView;
        if (view2 != null && this.mFooterView == null) {
            ViewGroup.LayoutParams paramsTemp2 = view2.getLayoutParams();
            if (paramsTemp2 instanceof ViewGroup.MarginLayoutParams) {
                ViewGroup.MarginLayoutParams layoutParams2 = (ViewGroup.MarginLayoutParams) paramsTemp2;
                layoutParams2.bottomMargin = ResLoader.getInstance().getResources(this.mContext).getDimensionPixelOffset(getIdentifier(this.mContext, "dimen", "margin_l"));
    ...
    public void fillCardView(FrameLayout view) {
        if (view != null) {
            ...
            if (view.getLayoutParams() instanceof ViewGroup.MarginLayoutParams) {
                ...
                int margin = ResLoader.getInstance().getResources(this.mContext).getDimensionPixelOffset(getIdentifier(this.mContext, "dimen", "margin_s"));
                layoutParams.setMarginStart(margin);
                layoutParams.setMarginEnd(margin);
                view.setLayoutParams(layoutParams);
            }
            if (this.mCardLayout.getParent() instanceof ViewGroup) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:3:0x0007, code lost:
        r0 = (android.widget.ImageView) r0.findViewById(getIdentifier(r6.mContext, "id", "action_expand"));
     */
    private void initCardExpandable(boolean isExpanded) {
        ...
        if (view != null && expandView != null) {
            ...
            View view2 = this.mContentView;
            if (view2 != null) {
                view2.setVisibility(isExpanded ? 0 : this.mContentMaxHeightDp < 0.0f ? 8 : 4);
            }
    ...
    public static class Builder {
        ...
        private View inflaterHeaderNoButton() {
            int layoutId = getIdentifier("layout", "hwcard_header_no_button");
            if (layoutId == 0) {
                return null;
            }
            View view = this.mInflater.inflate(layoutId, (ViewGroup) null);
            ImageView icon = (ImageView) view.findViewById(getIdentifier("id", HwCard.ICON_STRING));
            ((TextView) view.findViewById(getIdentifier("id", HwCard.TITLE_STRING))).setText(this.mTitle);
            int i = this.mIcon;
            if (i != 0) {
        ...
        private View inflaterHeaderWithOneButton() {
            ...
            View view = this.mInflater.inflate(layoutId, (ViewGroup) null);
            ImageView icon = (ImageView) view.findViewById(getIdentifier("id", HwCard.ICON_STRING));
            ImageView actionMore = (ImageView) view.findViewById(getIdentifier("id", "action_more"));
            ((TextView) view.findViewById(getIdentifier("id", HwCard.TITLE_STRING))).setText(this.mTitle);
            int i = this.mIcon;
            if (i != 0) {
                icon.setImageResource(i);
        ...
        private View inflaterHeaderWithTowButton() {
            ...
            ImageView actionInfo = (ImageView) view.findViewById(getIdentifier("id", "action_info"));
        ...
        private void bindHeaderClickListener(View header) {
            final ImageView expandIcon = (ImageView) header.findViewById(getIdentifier("id", "action_expand"));
        ...
        private void adjustHeaderPadding(View header) {
            header.setPaddingRelative(header.getPaddingStart(), 0, ResLoader.getInstance().getResources(this.mContext).getDimensionPixelOffset(getIdentifier("dimen", "padding_m")), 0);
        }
        ...
        private View inflaterFooterThreeText() {
            ...
            View view = this.mInflater.inflate(layoutId, (ViewGroup) null);
            final TextView positive = (TextView) view.findViewById(getIdentifier("id", "btn_positive"));
            final TextView negative = (TextView) view.findViewById(getIdentifier("id", "btn_negative"));
            final TextView neutral = (TextView) view.findViewById(getIdentifier("id", "btn_neutral"));

...
public class HwCutoutUtil {
    ...
    public static boolean needDoCutoutFit(View view, Context context) {
        ...
        if (view != null) {
            systemUiVisibility = view.getWindowSystemUiVisibility();
        }
        ...
        if (attrs != null) {
            if (((((systemUiVisibility & 1024) != 0) || ((systemUiVisibility & 2048) != 0) || ((systemUiVisibility & 512) != 0)) || (attrs.flags & 67108864) != 0) && attrs.layoutInDisplayCutoutMode == 1 && getDisplayCutoutStatus(context)) {
                return true;
            }
        }
        return false;

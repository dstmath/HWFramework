...
public class HwFastScroller extends FastScrollerEx {
    ...
    public void measureViewToSide(View view, View adjacent, Rect margins, Rect out) {
        ...
        view.measure(View.MeasureSpec.makeMeasureSpec((getMaxWidth(adjacent, containerWidth) - marginLeft2) - marginRight, FloatConsts.SIGN_BIT_MASK), View.MeasureSpec.makeMeasureSpec(0, 0));
        ...
        if (isPreviewImage) {
            ...
            int left2 = (adjacent == null ? container.left : adjacent.getRight()) + marginLeft2;
            right = left2 + width;
            left = left2;
        }
        if (isPreviewImage) {
            ...
            top = top2;
            marginLeft = top2 + height;
        } else {
            top = marginTop;
            marginLeft = marginTop + view.getMeasuredHeight();
        }
        out.set(left, top, right, marginLeft);
    }

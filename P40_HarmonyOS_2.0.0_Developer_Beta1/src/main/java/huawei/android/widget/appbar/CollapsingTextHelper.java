...
public class CollapsingTextHelper {
    ...
    private static final boolean USE_SCALING_TEXTURE = (Build.VERSION.SDK_INT < 18 ? true : DEBUG_DRAW);
    ...
    private float mCollapsedTextTop = 0.0f;
    ...
    private float mExpandedTextWidth = 0.0f;
    ...
    private boolean mIsAppBarMoved = DEBUG_DRAW;
    private boolean mIsAppBarOverScrolled = DEBUG_DRAW;
    private boolean mIsDrawTitle;
    private boolean mIsRtl;
    private boolean mIsSmoothScaleEnabled = DEBUG_DRAW;
    ...
    public void setExpandedTextSize(float textSize) {
        if (!isEquals(textSize, 0.0f) && !isClose(this.mExpandedTextSize, textSize)) {
    ...
    public void onBoundsChanged() {
        this.mIsDrawTitle = (this.mCollapsedBounds.width() <= 0 || this.mCollapsedBounds.height() <= 0 || this.mExpandedBounds.width() <= 0 || this.mExpandedBounds.height() <= 0) ? DEBUG_DRAW : true;
    }
    ...
    public void setCollapsedTextAppearance(int resId) {
        ...
        if (theme != null) {
            ...
            this.mCollapsedShadowDx = a.getFloat(8, 0.0f);
            this.mCollapsedShadowDy = a.getFloat(9, 0.0f);
            this.mCollapsedShadowRadius = a.getFloat(10, 0.0f);
            a.recycle();
    ...
    public void setExpandedTextAppearance(int resId) {
        ...
        if (theme != null) {
            ...
            this.mExpandedShadowDx = a.getFloat(8, 0.0f);
            this.mExpandedShadowDy = a.getFloat(9, 0.0f);
            this.mExpandedShadowRadius = a.getFloat(10, 0.0f);
            a.recycle();
            if (Build.VERSION.SDK_INT >= 16) {
    ...
    public void setExpansionFraction(float fraction) {
        if (!Float.isNaN(fraction)) {
            float realFraction = MathUtils.clamp(fraction, 0.0f, 1.0f);
    ...
    public void setOverScrollParameters(float overScrollFraction, float appBarOverScrollY) {
        this.mIsAppBarOverScrolled = !isEquals(overScrollFraction, 0.0f);
        this.mTargetOverScrollFraction = MathUtils.clamp(overScrollFraction, 0.0f, 1.0f);
    ...
    private boolean isEquals(float value, float targetValue) {
        if (Math.abs(value - targetValue) < FLOAT_COMPARE_VALUE) {
            return true;
        }
        return DEBUG_DRAW;
    }
    ...
    private void setCustomViewOffsetsPadding() {
        float badgeWidth = this.mHwEventBadge != null ? ((float) getBadgeWidth()) + this.mBadgeMargin : 0.0f;
    ...
    private void calculateBaseOffsets() {
        ...
        float subWidth = charSequence2 != null ? this.mSubTextPaint.measureText(charSequence2, 0, charSequence2.length()) : 0.0f;
        CharSequence charSequence3 = this.mEyeTextToDraw;
        float eyebrowWidth = charSequence3 != null ? this.mEyebrowTextPaint.measureText(charSequence3, 0, charSequence3.length()) : 0.0f;
        ...
        float width2 = charSequence4 != null ? this.mTextPaint.measureText(charSequence4, 0, charSequence4.length()) : 0.0f;
        this.mExpandedTextWidth = width2;
        CharSequence charSequence5 = this.mSubTextToDraw;
        float subWidth2 = charSequence5 != null ? this.mSubTextPaint.measureText(charSequence5, 0, charSequence5.length()) : 0.0f;
        CharSequence charSequence6 = this.mEyeTextToDraw;
        float eyebrowWidth2 = charSequence6 != null ? this.mEyebrowTextPaint.measureText(charSequence6, 0, charSequence6.length()) : 0.0f;
    ...
    public void draw(Canvas canvas) {
        ...
        if (((this.mTextToDraw == null && this.mCustomView == null) ? false : true) && this.mIsDrawTitle) {
            ...
            new RectF();
            if (this.mTextToDraw != null && !isEquals(this.mCollapsedTextTop, 0.0f)) {
    ...
    private float getCollapsedTextTop() {
        ...
        this.mTextPaint.getTextPath(this.mTextToDraw.toString(), 0, this.mTextToDraw.length(), 0.0f, 0.0f, textPath);
    ...
    private void drawCustomView(float x, float y) {
        ...
        if (this.mIsRtl) {
            ...
            this.mCustomView.setPivotX(0.0f);
        }
        this.mCustomView.setPivotY(0.0f);
    ...
    private boolean checkAppBarIsActive() {
        if (this.mIsAppBarOverScrolled || this.mIsAppBarMoved) {
            return true;
        }
        return DEBUG_DRAW;
    }
    ...
    private void setInterpolatedTextSize(float textSize) {
        ...
        this.mUseTexture = (!USE_SCALING_TEXTURE || this.mScale == 1.0f) ? DEBUG_DRAW : true;
        if (this.mUseTexture) {
    ...
    private boolean areTypefacesDifferent(Typeface first, Typeface second) {
        if ((first == null || first.equals(second)) && (first != null || second == null)) {
            return DEBUG_DRAW;
        }
        return true;
    }
    ...
    private void calculateUsingTextSize(float textSize) {
        ...
        if (this.mText != null || this.mCustomView != null) {
            ...
            boolean updateDrawText = DEBUG_DRAW;
    ...
    private void adjustTextSizeWhenAppBarOverScroll() {
        CharSequence charSequence;
        if (this.mIsAppBarOverScrolled && this.mExpandedTextWidth > 0.0f && this.mCurrentTextSize > this.mExpandedTextSize && (charSequence = this.mTextToDraw) != null && this.mTextPaint.measureText(charSequence, 0, charSequence.length()) < this.mExpandedTextWidth) {
    ...
    private static boolean isClose(float value, float targetValue) {
        if (Math.abs(value - targetValue) < COMPARE_VALUE) {
            return true;
        }
        return DEBUG_DRAW;
    }
    ...
    public String getBubbleText() {
        ...
        return hwEventBadge.getBadgeText();
    }
    ...
    public void resetTextBaselineY() {
        this.mExpandedTextBaselineY = -1.0f;
    }

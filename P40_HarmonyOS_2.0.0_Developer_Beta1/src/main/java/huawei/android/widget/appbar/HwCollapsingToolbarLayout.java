...
public class HwCollapsingToolbarLayout extends FrameLayout {
    ...
    private int mBubbleDescriptionId;
    ...
    private int mTitleMarginBottomNoSubtitle;
    ...
    public HwCollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (theme != null) {
            TypedArray a = theme.obtainStyledAttributes(attrs, R.styleable.HwCollapsingToolbarLayout, 34668582, 33947777);
    ...
    private void updateDummyView() {
        ...
        if (this.mCollapsingTitleEnabled && this.mToolbar != null) {
            ...
            if (this.mDummyView != null) {
                ...
                this.mTitleView = (TextView) this.mDummyView.findViewById(16908725);
                ...
                this.mSubTitleView = (TextView) this.mDummyView.findViewById(16908724);
                setSubTitleVisible();
            }
        }
    }
    ...
    private void setTitleTextSize() {
        int titleTextSize = this.mContext.getResources().getInteger(ResLoader.getInstance().getIdentifier(this.mContext, "integer", "collapsing_appbar_title_normal_textsize"));
        ...
        if (textView != null) {
            ...
            if (textView2 != null && textView2.getVisibility() != 8) {
                this.mSubTitleView.setTextSize(1, (float) this.mContext.getResources().getInteger(ResLoader.getInstance().getIdentifier(this.mContext, "integer", "collapsing_appbar_subtitle_normal_textsize")));
    ...
    public void setSubTitle(CharSequence subTitle) {
        ...
        setSubTitleVisible();
        this.mCollapsingTextHelper.resetTextBaselineY();
        setExpandedMarginBottom();
        requestLayout();
    }
    ...
    public void resetTextBaselineY() {
        ...
        if (collapsingTextHelper != null) {
            collapsingTextHelper.resetTextBaselineY();
        }
    }

    private void initTitleMarginBottomSize() {
        int titleMarginBottomId = ResLoader.getInstance().getIdentifier(getContext(), ResLoaderUtil.DIMEN, "expaned_appbar_title_margin_bottom");
        int titleMarginBottomNoSubtitleId = ResLoader.getInstance().getIdentifier(getContext(), ResLoaderUtil.DIMEN, "expaned_appbar_title_margin_bottom_no_subtitle");
        this.mTitleMarginBottom = getContext().getResources().getDimensionPixelSize(titleMarginBottomId);
        this.mTitleMarginBottomNoSubtitle = getContext().getResources().getDimensionPixelSize(titleMarginBottomNoSubtitleId);
    }
    ...
    private void setExpandedMarginBottom() {
        if (getSubTitle() != null) {
            this.mExpandedMarginBottom = this.mTitleMarginBottom;
        } else {
            this.mExpandedMarginBottom = this.mTitleMarginBottomNoSubtitle;
        }
    }
    ...
    public String getBubbleText() {
        CollapsingTextHelper collapsingTextHelper = this.mCollapsingTextHelper;
        if (collapsingTextHelper != null) {
            return collapsingTextHelper.getBubbleText();
        }
        return null;
    }

    public void setBubbleDescriptionId(int resId) {
        this.mBubbleDescriptionId = resId;
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (!isCollapsed() && getEyebrowText() != null) {
            builder.append(getEyebrowText());
        }
        if (getTitle() != null) {
            builder.append(getTitle());
        }
        if (getBubbleText() != null) {
            if (this.mBubbleDescriptionId != 0) {
                try {
                    builder.append(String.format(Locale.ROOT, this.mContext.getResources().getString(this.mBubbleDescriptionId), getBubbleText()));
                } catch (Resources.NotFoundException e) {
                    Log.e(TAG, "Resource not found!");
                    builder.append(getBubbleText());
                }
            } else {
                builder.append(getBubbleText());
            }
        ...
        info.setContentDescription(builder.toString());
    }

    private boolean isCollapsed() {
        return isEquals(this.mCollapsingTextHelper.getExpansionFraction(), 1.0f);
    }

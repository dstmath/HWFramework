...
public class HwFullScreenImageText extends LinearLayout {
    ...
    private void setContentTextMovementMethod() {
    ...
    public void setButtonsText(CharSequence... buttonText) {
        ...
        if (linearLayout != null && this.mBtnBtmFirst != null && this.mBtnBtmSecond != null) {
            ...
            if (length > 1) {
                setButtonTextWhenMoreThanOne(buttonText[0], buttonText[1]);
            } else if (length == 1) {
                setButtonTextWhenSingleButton(buttonText[0]);
    ...
    private void setButtonTextWhenSingleButton(CharSequence buttonText) {
        ...
        this.mBtnBtmFirst.setText(buttonText);
    ...
    private void setButtonTextWhenMoreThanOne(CharSequence buttonText1, CharSequence buttonText2) {
        setViewsVisible();
        this.mBtnBtmFirst.setText(buttonText1);
        this.mBtnBtmSecond.setText(buttonText2);
    ...
    public class LinkTouchMovementMethod extends LinkMovementMethod {
        ...
        public boolean onTouchEvent(TextView widget, Spannable buffer, MotionEvent event) {
            ...
            if (action == 1 || action == 0) {
                int eventX = ((int) event.getX()) - widget.getTotalPaddingLeft();
                int eventY = ((int) event.getY()) - widget.getTotalPaddingTop();
                int eventX2 = eventX + widget.getScrollX();
                int eventY2 = eventY + widget.getScrollY();
                Layout layout = widget.getLayout();
                int off = layout.getOffsetForHorizontal(layout.getLineForVertical(eventY2), (float) eventX2);

...
public class HwRefreshLayout extends ViewGroup {
            ...
            if (action != 1) {
                if (action == 2) {
                    ...
                    if (offset >= f) {
                        ...
                        float offsetY = (-offset) * DRAG_RATE;
                        if (offsetY > 0.0f) {
    ...
    private boolean onTouchMove(MotionEvent event) {
        ...
        float distanceY = (eventY - this.mInitMotionY) * DRAG_RATE;
        if (distanceY > 0.0f) {
    ...
    private boolean onTouchUp(MotionEvent event) {
        ...
        if (this.mIsBeingDragged) {
            actionUp((upY - this.mInitMotionY) * DRAG_RATE);
            this.mIsBeingDragged = false;
        }
        this.mActivePointerId = -1;
        return false;
            ...
            public void onAnimationUpdate(ValueAnimator animator) {
                if (animator != null) {
                    ...
                    if (value instanceof Integer) {
                        HwRefreshLayout.this.moveTo(((Integer) value).intValue());
                    }
                }
            }
        });
            ...
            public void onAnimationUpdate(ValueAnimator animator) {
                if (animator != null) {
                    ...
                    if (obj instanceof Integer) {
                        HwRefreshLayout.this.mHeaderView.offsetTopAndBottom(((Integer) obj).intValue() - HwRefreshLayout.this.mHeaderCurrentTop);
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                if (animation != null) {
                    ...
                    if (obj instanceof Integer) {
                        HwRefreshLayout.this.mContentView.offsetTopAndBottom(((Integer) obj).intValue() - HwRefreshLayout.this.mContentCurrentTop);
                        HwRefreshLayout hwRefreshLayout = HwRefreshLayout.this;
            ...
            anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    if (animation != null) {
                        Object obj = animation.getAnimatedValue();
                        if (obj instanceof Float) {
                            DefaultHeaderView.this.mProgressbar.setTranslationX(((Float) obj).floatValue());
                        }
                    }
                }
            });

...
public class BlurUtils {
    ...
    public static Bitmap blurImage(Context ctx, Bitmap input, Bitmap output, int radius) {
        ...
        try {
            ...
            Log.e(TAG, "blurImage tmpIn RSInvalidStateException");
        }
        try {
            tmpOut.destroy();
        } catch (RSInvalidStateException e2) {
            Log.e(TAG, "blurImage tmpOut RSInvalidStateException");
        }
        mRs.destroy();
        return output;
    }
    ...
    public static Bitmap blurMaskImage(Context ctx, Bitmap input, Bitmap output, int radius) {
        ...
        try {
            ...
            Log.e(TAG, "blurMaskImage tmpIn RSInvalidStateException");
        }
        try {
            tmpOut.destroy();
        } catch (RSInvalidStateException e2) {
            Log.e(TAG, "blurMaskImage tmpOut RSInvalidStateException");
        }
        return output;
    }
    ...
    public static Bitmap screenShotBitmap(Context ctx, float scale) {
        ...
        display.getRealMetrics(displayMetrics);
        int[] dims = {(((int) (((float) displayMetrics.widthPixels) * scale)) / 2) * 2, (((int) (((float) displayMetrics.heightPixels) * scale)) / 2) * 2};
        int[] dim2s = {(((int) (((float) displayMetricsBody.widthPixels) * scale)) / 2) * 2, (((int) (((float) displayMetricsBody.heightPixels) * scale)) / 2) * 2};
        Log.e(TAG, "mFingerViewParams,dims[0] =" + dims[0] + ",dims[1] =" + dims[1]);
        Log.e(TAG, "mFingerViewParams,dim2s[0] =" + dim2s[0] + ",dim2s[1] =" + dim2s[1]);
        int rotation = display.getRotation();
        ...
        Bitmap bitmap2 = Bitmap.createBitmap(bitmap, 0, 0, dim2s[0], dim2s[1]);
        if (bitmap2 == null) {
            Log.e(TAG, "screenShotBitmap error bitmap is null");
            return null;
        }

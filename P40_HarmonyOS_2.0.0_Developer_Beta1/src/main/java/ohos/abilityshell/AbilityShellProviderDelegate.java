...
public class AbilityShellProviderDelegate extends AbilityShellDelegate {
    ...
    public void onTrimMemory(int i) {
        ...
        throw new IllegalStateException("ability is uninitialized, onMemoryLevel failed");
    }
    ...
    public boolean reload(Uri uri, Bundle bundle) {
        ...
        if (this.ability != null) {
            ...
            Bytrace.startTrace(2147483648L, "ability reload");
            boolean reload = this.ability.reload(convertToZidaneContentUri, pacMap);
            Bytrace.finishTrace(2147483648L, "ability reload");
            return reload;
        }

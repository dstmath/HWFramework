...
public class SelectAbilityUtils {
    ...
    public static List<AbilityShellData> fetchAbilities(Context context, Intent intent) {
        ...
        ResolveInfo androidComponent = AbilityShellConverterUtils.getAndroidComponent(context, intent);
        if (androidComponent == null || !z) {
        ...
        arrayList.add(AbilityShellConverterUtils.createAbilityShellDataByResolveInfo(androidComponent, true));
        return arrayList;
    }

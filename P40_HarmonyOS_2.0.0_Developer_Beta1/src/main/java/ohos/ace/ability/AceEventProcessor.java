...
public class AceEventProcessor {
    ...
    static {
        ...
        Z2A_KEYMAP.put(Integer.valueOf((int) DeviceParameterConst.VIDEO_MODE_STRING), 22);
        ...
        Z2A_KEYMAP.put(Integer.valueOf((int) DeviceParameterConst.HIWEAR_STRING), 29);
        ...
        Z2A_KEYMAP.put(Integer.valueOf((int) DeviceParameterConst.DEVICE_CARCOLOR_STRING), 141);
        Z2A_KEYMAP.put(Integer.valueOf((int) DeviceParameterConst.DEVICE_CARTYPE_STRING), 142);
    ...
    public static ByteBuffer processTouchEvent(TouchEvent touchEvent, float f, float f2) {
        ...
        if (actionToActionType == 4 || actionToActionType == 6) {
            addTouchEventToBuffer(touchEvent, f, f2, allocateDirect);
        } else {
    ...
    private static void addTouchEventToBuffer(TouchEvent touchEvent, float f, float f2, ByteBuffer byteBuffer) {
        int actionToActionType = actionToActionType(touchEvent.getAction());
        if (actionToActionType != -1) {
            ...
            byteBuffer.putDouble((double) (touchEvent.getPointerPosition(index).getX() - f));
            byteBuffer.putDouble((double) (touchEvent.getPointerPosition(index).getY() - f2));

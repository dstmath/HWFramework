...
public class VectorElement extends Element {
        ...
        public void parseProperties(List<TypedAttribute> list) {
            ...
            for (TypedAttribute typedAttribute : list) {
                ...
                if (name == null) {
                    ...
                    try {
                        float convertValueToFloat = AttrHelper.convertValueToFloat(typedAttribute.getStringValue(), VectorElement.MIN_FLOAT_ALPHA);
    ...
    public class VFullPath extends VPath {
        ...
        public void parseProperties(Node node) {
            ...
            HiLog.debug(VectorElement.TAG, "parseProperty:attr size: %{public}d", new Object[]{Integer.valueOf(typedAttributes.size())});
        ...
        public class FullPathProperty {
            ...
            private void reset() {
                ...
                this.mStrokeWidth = VectorElement.MIN_FLOAT_ALPHA;
                this.mStrokeColor = 0;
                this.mStrokeAlpha = 1.0f;
                this.mFillColor = 0;
                this.mFillAlpha = 1.0f;
                this.mTrimPathStart = VectorElement.MIN_FLOAT_ALPHA;
                this.mTrimPathEnd = 1.0f;
                this.mTrimPathOffset = VectorElement.MIN_FLOAT_ALPHA;
                this.mStrokeLineCap = 0;
                this.mStrokeLineJoin = 0;
                this.mStrokeMiterLimit = VectorElement.MIN_FLOAT_ALPHA;
                this.mFillType = 0;
            }
        }
        ...
        public class GradientProperty {
            ...
            public void reset() {
                ...
                this.mStartX = VectorElement.MIN_FLOAT_ALPHA;
                this.mStartY = VectorElement.MIN_FLOAT_ALPHA;
                this.mEndX = VectorElement.MIN_FLOAT_ALPHA;
                this.mEndY = VectorElement.MIN_FLOAT_ALPHA;
                this.mCenterX = VectorElement.MIN_FLOAT_ALPHA;
                this.mCenterY = VectorElement.MIN_FLOAT_ALPHA;
                this.mGradientRadius = VectorElement.MIN_FLOAT_ALPHA;
        ...
        private void parseProperty(TypedAttribute typedAttribute) {
            ...
            try {
                ...
                if (name != null && stringValue != null) {
                    ...
                    switch (c) {
                        case 0:
                            this.mProperty.mStrokeWidth = AttrHelper.convertValueToFloat(stringValue, VectorElement.MIN_FLOAT_ALPHA);
                            return;
                        case 1:
                        ...
                        case 4:
                            ...
                            return;
                        case 5:
                            this.mProperty.mTrimPathStart = AttrHelper.convertValueToFloat(stringValue, VectorElement.MIN_FLOAT_ALPHA);
                            return;
                        case 6:
                            this.mProperty.mTrimPathEnd = AttrHelper.convertValueToFloat(stringValue, 1.0f);
                            return;
                        case 7:
                            this.mProperty.mTrimPathOffset = AttrHelper.convertValueToFloat(stringValue, VectorElement.MIN_FLOAT_ALPHA);
                            return;
                        case '\b':
                ...
                switch (c) {
                    ...
                    case 1:
                        if (str.equals(REPEAT)) {
                            this.mGradientProperty.mTileMode = Shader.TileMode.REPEAT_TILEMODE;
                            return;
                        } else if (str.equals(MIRROR)) {
                            this.mGradientProperty.mTileMode = Shader.TileMode.MIRROR_TILEMODE;
                            return;
                        } else {
                            this.mGradientProperty.mTileMode = Shader.TileMode.CLAMP_TILEMODE;
                            return;
                        }
                    case 2:
                        this.mGradientProperty.mStartX = AttrHelper.convertValueToFloat(str, VectorElement.MIN_FLOAT_ALPHA);
                        return;
                    case 3:
                        this.mGradientProperty.mStartY = AttrHelper.convertValueToFloat(str, VectorElement.MIN_FLOAT_ALPHA);
                        return;
                    case 4:
                        this.mGradientProperty.mEndX = AttrHelper.convertValueToFloat(str, VectorElement.MIN_FLOAT_ALPHA);
                        return;
                    case 5:
                        this.mGradientProperty.mEndY = AttrHelper.convertValueToFloat(str, VectorElement.MIN_FLOAT_ALPHA);
                        return;
                    case 6:
                        this.mGradientProperty.mCenterX = AttrHelper.convertValueToFloat(str, VectorElement.MIN_FLOAT_ALPHA);
                        return;
                    case 7:
                        this.mGradientProperty.mCenterY = AttrHelper.convertValueToFloat(str, VectorElement.MIN_FLOAT_ALPHA);
                        return;
                    case '\b':
                        this.mGradientProperty.mGradientRadius = AttrHelper.convertValueToFloat(str, VectorElement.MIN_FLOAT_ALPHA);
                        return;
                    default:
                        return;
                }
                ...
                for (TypedAttribute typedAttribute : node.getTypedAttributes(VectorElement.this.mResourceManager)) {
                    ...
                    if (!(name2 == null || str == null)) {
                        if (name2.equals(COLOR)) {
                            ...
                            Vector vector2 = this.mGradientProperty.mShaderStops;
                            vector2.add(Float.valueOf(AttrHelper.convertValueToFloat(str, VectorElement.MIN_FLOAT_ALPHA)));
    ...
    private void parseProperties(List<TypedAttribute> list) {
        ...
        setAlpha((int) (Math.max((float) MIN_FLOAT_ALPHA, Math.min(1.0f, f)) * 255.0f));
        HiLog.debug(TAG, "parseProperty:width: %{public}d height: %{public}d", new Object[]{Integer.valueOf(i3), Integer.valueOf(i4)});
    }

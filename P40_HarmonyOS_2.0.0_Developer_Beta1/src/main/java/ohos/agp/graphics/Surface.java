...
public class Surface implements Sequenceable {
    private static final HiLogLabel LABEL = new HiLogLabel(3, (int) LogDomain.END, "Surface");
    ...
    public Canvas acquireCanvas() {
        ...
        if (this.mNumber == 0) {
            ...
            HiLog.error(LABEL, "LockCanvas mNumber is error.", new Object[0]);
        }
        this.mNumber++;
        return this.mCanvas;
    }

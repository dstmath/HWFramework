...
public class EGL {
    ...
    public static boolean eglGetConfigs(EGLDisplay eGLDisplay, EGLConfig[] eGLConfigArr, int i, int[] iArr) {
        return EGLAdapter.eglGetConfigs(eGLDisplay.getEGLDisplayAdapter(), eGLConfigArr != null ? new EGLConfigAdapter[i] : null, i, iArr);
    }

    public static boolean eglReleaseThread() {
        return EGLAdapter.eglReleaseThread();
    }

    public static String eglQueryString(EGLDisplay eGLDisplay, int i) {
        return eGLDisplay instanceof EGLDisplay ? EGLAdapter.eglQueryString(eGLDisplay.getEGLDisplayAdapter(), i) : "";
    }
    ...
    public static boolean eglQueryContext(EGLDisplay eGLDisplay, EGLContext eGLContext, int i, int[] iArr) {
        ...
        return EGLAdapter.eglQueryContext(eGLDisplay.getEGLDisplayAdapter(), eGLContext.getEGLContextAdapter(), i, iArr);
    }
    ...
    public static boolean eglGetConfigAttrib(EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i, int[] iArr) {
        ...
        return EGLAdapter.eglGetConfigAttrib(eGLDisplay.getEGLDisplayAdapter(), eGLConfig.getEGLConfigAdapter(), i, iArr);
    }

    public static boolean eglBindAPI(int i) {
        return EGLAdapter.eglBindAPI(i);
    }
}

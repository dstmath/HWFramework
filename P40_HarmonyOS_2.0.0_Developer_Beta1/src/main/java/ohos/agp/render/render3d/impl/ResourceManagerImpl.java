    ...
    private List<ResourceManager.ResourceInfo> convertInfos(CoreResourceInfoArray coreResourceInfoArray) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            arrayList.add(new ResourceManager.ResourceInfo() {
                ...
                private final ResourceHandle mHandle = new ResourceHandleImpl(ResourceManagerImpl.this.mEngine, coreResourceInfo.getHandle());
                private final String mName = coreResourceInfo.getName();
                private final String mUri = coreResourceInfo.getUri();
    ...
    private List<ResourceManager.ResourceInfo> convertCreatorInfos(CoreResourceCreatorInfoArray coreResourceCreatorInfoArray) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            arrayList.add(new ResourceManager.ResourceInfo() {
                ...
                private final ResourceHandle mHandle = new ResourceHandleImpl(ResourceManagerImpl.this.mEngine, coreInfo.getHandle());
                private final String mName = coreInfo.getName();
                private final String mUri = coreInfo.getUri();

...
public final class SceneImpl implements Scene {
    ...
    private final Map<String, ComponentManager<? extends Component, ? extends CoreComponentManager>> mComponentManagerMap = new HashMap(10);
    private final EngineImpl mEngine;
    private final MorphingSystemImpl mMorphingSystem;
    ...
    SceneImpl(EngineImpl engineImpl) {
        ...
        this.mMorphingSystem = MorphingSystemImpl.getMorphingSystem(engineImpl).orElse(null);
    ...
    public void destroyNode(SceneNode sceneNode) {
        getNativeSceneNode(sceneNode).ifPresent(new Consumer() {
            /* class ohos.agp.render.render3d.impl.$$Lambda$SceneImpl$KY7LIEabN68kkb1SGCqEyWMiv0 */

            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                SceneImpl.this.lambda$destroyNode$0$SceneImpl((CoreSceneNode) obj);
            }
        });
    }

    public /* synthetic */ void lambda$destroyNode$0$SceneImpl(CoreSceneNode coreSceneNode) {
        this.mNativeNodeSystem.destroyNode(coreSceneNode);
    }

    @Override // ohos.agp.render.render3d.Scene
    public MorphingSystem getMorphingSystem() {
        MorphingSystemImpl morphingSystemImpl = this.mMorphingSystem;
        if (morphingSystemImpl != null) {
            return morphingSystemImpl;
        }

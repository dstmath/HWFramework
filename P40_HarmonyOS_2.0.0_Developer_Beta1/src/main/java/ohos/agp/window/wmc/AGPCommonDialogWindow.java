...
public class AGPCommonDialogWindow extends AGPBaseDialogWindow implements Window.Callback {
    ...
    public void setDefaultLayoutParam() {
        ...
        this.mAndroidParam.width = (int) (((float) point.x) * DEFAULT_SCALE);
        this.mAndroidParam.height = (int) (((float) point.y) * DEFAULT_SCALE);
    }
    ...
    public boolean dispatchKeyEvent(android.view.KeyEvent keyEvent) {
        ...
        MultimodalEvent multimodalEvent = (MultimodalEvent) MultimodalEventFactory.createEvent(keyEvent).orElse(null);
        if (multimodalEvent instanceof KeyEvent) {
            KeyEvent keyEvent2 = (KeyEvent) multimodalEvent;
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent motionEvent) {
        ...
        MultimodalEvent multimodalEvent = (MultimodalEvent) MultimodalEventFactory.createEvent(motionEvent).orElse(null);
        if (multimodalEvent instanceof MouseEvent) {
            HiLog.debug(LABEL, "Dialog dispatch MouseEvent from A GenericMotionEvent", new Object[0]);
            z = dispatchMouseEvent((MouseEvent) multimodalEvent);
        } else if (multimodalEvent instanceof RotationEvent) {
            HiLog.debug(LABEL, "Dialog dispatch RotationEvent from A GenericMotionEvent", new Object[0]);
            z = dispatchRotationEvent((RotationEvent) multimodalEvent);
        } else {

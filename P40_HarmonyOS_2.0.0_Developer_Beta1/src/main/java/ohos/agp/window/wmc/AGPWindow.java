...
public class AGPWindow {
    ...
    public int restoreParams(int i) {
        return (i << 1) | (i >>> 31);
    }
    ...
    public void notifyBarrierFree(AGPWindow aGPWindow) {
        if (this.mFlag != 5) {
            ...
            if (aGPEngineAdapter != null) {
                aGPEngineAdapter.notifyBarrierFree();
            }
        }
    }
    ...
    public boolean dispatchRotationEvent(RotationEvent rotationEvent) {
        ...
        HiLog.debug(LABEL, "dispatchRotationEvent event start, event value =%{public}s", new Object[]{String.valueOf(rotationEvent.getRotationValue())});
        IAGPEngineAdapter iAGPEngineAdapter = this.mEngine;
        if (iAGPEngineAdapter != null) {
    ...
    public void destroy() {
        if (Looper.myLooper() == Looper.getMainLooper()) {
            HiLog.debug(LABEL, "destroyOnUiThread.", new Object[0]);
            destroyOnUiThread();
            return;
        }
        ...
        if (context != null && context.getUITaskDispatcher() != null) {
            this.mContext.getUITaskDispatcher().delayDispatch(new Runnable() {
                ...
                @Override // java.lang.Runnable
                public void run() {
                    HiLog.debug(AGPWindow.LABEL, "destroyOnUiThread delay.", new Object[0]);
    ...
    public void setAttributes(LayoutParams layoutParams) {
        ...
        if (layoutParams.windowAnimations != -1) {
            try {
                ...
                HiLog.debug(LABEL, "setAttributes for window animation finished, A resource id: %{public}d.", new Object[]{Integer.valueOf(attributes.windowAnimations)});
    ...
    public void setStatusBarVisibility(int i) {
        ...
        if (decorView == null) {
            ...
            decorView.setSystemUiVisibility(i * 4);
        }
    }
    ...
    public class TextViewListener implements TextInputConnection.ITextViewListener {
        ...
        public ExtractedText getExtractedText(ExtractedTextRequest extractedTextRequest, int i) {
            if (AGPWindow.this.mViewGroup != null) {
                Component findFocus = AGPWindow.this.mViewGroup.findFocus();
                if (findFocus instanceof Text) {
                    ExtractedText convertToExtractedText = ExtractedTextAdapter.convertToExtractedText(((Text) findFocus).getInputDataChannel().subscribeEditingText(ExtractedTextRequestAdapter.convertToEditingCapability(extractedTextRequest, i)));
    ...
    public class SwipeManager {
        ...
        public void init(android.content.Context context, Context context2) {
            ...
            if (context2 != null && (resourceManager = context2.getResourceManager()) != null) {
                ...
                HiLog.debug(AGPWindow.LABEL, "Swipe manager isLayoutRTL: %{public}s.", new Object[]{String.valueOf(this.isRtl)});
            }
        }

...
public class TextViewListenerWrapper implements TextInputConnection.ITextViewListener {
    ...
    public ExtractedText getExtractedText(ExtractedTextRequest extractedTextRequest, int i) {
        return ExtractedTextAdapter.convertToExtractedText(this.listener.subscribeEditingText(ExtractedTextRequestAdapter.convertToEditingCapability(extractedTextRequest, i)));
    }
    ...
    public static int convertToInputType(int i) {
        int i2 = i != 2 ? i != 3 ? i != 7 ? 0 : 129 : 2 : 1;
        HiLog.debug(LABEL, "the inputType is %{public}d", new Object[]{Integer.valueOf(i2)});
        return i2;
    }

    public static int convertToImeOption(int i) {
        int i2 = i != 1 ? i != 2 ? i != 3 ? 0 : 4 : 2 : 3;
        HiLog.debug(LABEL, "the imeOption is %{public}d", new Object[]{Integer.valueOf(i2)});
        return i2;
    }
}

        ...
        public boolean onRemoteRequest(int i, MessageParcel messageParcel, MessageParcel messageParcel2, MessageOption messageOption) throws RemoteException {
            ...
            if (i == 1) {
                ...
                if (messageParcel.readInt() != 0) {
                    ...
                    initParams.unmarshalling(messageParcel);
                } else {
                    initParams = null;
                }
                boolean init = init(initParams, TtsPluginListener.Stub.asInterface(messageParcel.readRemoteObject()).orElse(null));
                messageParcel2.writeInt(0);
                ...
                messageParcel.readInterfaceToken();
                if (messageParcel.readInt() != 0) {
                    initParams2 = new InitParams();
                    initParams2.unmarshalling(messageParcel);
                } else {
                    initParams2 = null;
                }
                boolean params = setParams(initParams2, TtsPluginListener.Stub.asInterface(messageParcel.readRemoteObject()).orElse(null));
                messageParcel2.writeInt(0);

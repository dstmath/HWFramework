...
public class BatteryAdapter extends CommonEventBaseConverter {
    ...
    public Optional<Intent> convertAospIntentToIntent(android.content.Intent intent) {
        ...
        HiLog.info(DEBUG, "aAction = %{public}s", new Object[]{action});
        ...
        if (ANDROID_BATTERY_ACTION.equals(action)) {
            ...
            intent2.setParam(BatteryInfo.OHOS_BATTERY_PRESENT, intent.getBooleanExtra(EXTRA_PRESENT, false));
            intent2.setParam(BatteryInfo.OHOS_BATTERY_LOW, intent.getBooleanExtra(EXTRA_BATTERY_LOW, false));
            HiLog.info(DEBUG, "soc=%{public}d, vol=%{public}d, temp=%{public}d", new Object[]{Integer.valueOf(intExtra), Integer.valueOf(intExtra2), Integer.valueOf(intExtra3)});
        } else {
    ...
    private int chargerTypeSwitch(int i) {
        ...
        HiLog.info(DEBUG, "charger type switch, aType=%{public}d, zType=%{public}d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)});
        return i2;
    }
    ...
    private int chargingStatusSwitch(int i) {
        ...
        HiLog.info(DEBUG, "charge status switch, aStatus=%{public}d, zStatus=%{public}d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)});
        return i2;
    }
    ...
    private int healthStatusSwitch(int i) {
        ...
        HiLog.info(DEBUG, "health status switch, aStatus=%{public}d, zStatus=%{public}d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)});
        return i2;
    }
}

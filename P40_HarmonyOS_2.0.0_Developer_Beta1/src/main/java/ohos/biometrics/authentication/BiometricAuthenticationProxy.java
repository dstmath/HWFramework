...
public class BiometricAuthenticationProxy {
    ...
    private final DefaultFaceRecognizeManagerImpl.FaceRecognizeCallback mCallback;
    ...
    BiometricAuthenticationProxy(Context context) {
        if (context == null) {
            this.mPkgName = null;
        ...
        this.mPkgName = context2.getOpPackageName();
        AnonymousClass3 r0 = new DefaultFaceRecognizeManagerImpl.FaceRecognizeCallback() {
        ...
        this.mFaceManagerImpl = FaceRecognizeManagerFactory.getInstance().getFaceRecognizeManagerImpl(context2, r0);
        this.mCallback = r0;
    ...
    private int execFaceAuthentication() {
        ...
        if (defaultFaceRecognizeManagerImpl == null || this.mCallback == null) {
            HiLog.error(LABEL, "execFaceAuthentication failed: mFaceManagerImpl or mCallback is null", new Object[0]);
            return 100;
    ...
    private void setAuthenticationTips(int i, int i2) {
        if (this.mFaceManagerImpl != null) {
            if ((i == 3 && FACE_TIPS_CODE_MAP.containsKey(Integer.valueOf(i2))) || (i == 1 && FACE_RESULT_CODE_MAP.containsKey(Integer.valueOf(i2)))) {
                synchronized (this.mAuthenticationTips) {

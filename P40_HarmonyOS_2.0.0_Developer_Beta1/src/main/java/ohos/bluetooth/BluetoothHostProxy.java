...
public class BluetoothHostProxy implements IBluetoothHost {
    ...
    public Optional<String> getLocalAddress() {
        synchronized (this.mRemoteLock) {
            ...
            obtain.writeInterfaceToken("ohos.bluetooth.IBluetoothHost");
            try {
                if (!asObject.sendRequest(13, obtain, obtain2, messageOption)) {
    ...
    public boolean bluetoothFactoryReset() {
        ...
        synchronized (this.mRemoteLock) {
            ...
            obtain.writeInterfaceToken("ohos.bluetooth.IBluetoothHost");
            try {
                if (!asObject.sendRequest(14, obtain, obtain2, messageOption)) {
    ...
    public SequenceUuid[] getlocalSupportedUuids() {
        synchronized (this.mRemoteLock) {
            ...
            obtain.writeInterfaceToken("ohos.bluetooth.IBluetoothHost");
            try {
                if (!asObject.sendRequest(15, obtain, obtain2, messageOption)) {
    ...
    public long getBtDiscoveryEndMillis() {
        synchronized (this.mRemoteLock) {
            ...
            obtain.writeInterfaceToken("ohos.bluetooth.IBluetoothHost");
            try {
                if (!asObject.sendRequest(16, obtain, obtain2, messageOption)) {
    ...
    public int getMaxNumConnectedAudioDevices() {
        synchronized (this.mRemoteLock) {
            ...
            obtain.writeInterfaceToken("ohos.bluetooth.IBluetoothHost");
            try {
                if (!asObject.sendRequest(17, obtain, obtain2, messageOption)) {
    ...
    public int getBtConnectionState() {
        synchronized (this.mRemoteLock) {
            ...
            obtain.writeInterfaceToken("ohos.bluetooth.IBluetoothHost");
            try {
                if (!asObject.sendRequest(20, obtain, obtain2, messageOption)) {

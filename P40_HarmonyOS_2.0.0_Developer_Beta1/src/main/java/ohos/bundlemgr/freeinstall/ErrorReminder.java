...
public class ErrorReminder {
    ...
    private static final int FREE_INSTALL_ERROR_CODE_CONNECT_FAILED = 4;
    ...
    private static final String FREE_INSTALL_ERROR_LABEL_CONNECT_FAILED = "free_install_connect_failed";
    ...
    private String getErrorMsg(int i) {
        ...
        if (i == 1) {
            ...
            str = FREE_INSTALL_ERROR_LABEL_CONNECT_FAILED;
        }

        ...
        while (true) {
            ...
            if (-1 != i2) {
                ...
                switch (i) {
                    ...
                    case -19:
                    case -18:
                    case DMSDPConfig.ERROR_CODE_DEVICE_NOT_SUPPORT /* -17 */:
                    case DMSDPConfig.ERROR_CODE_NOT_SUPPORT_IN_SUPERCLASS /* -16 */:
                    case -15:
                    case DMSDPConfig.ERROR_CODE_ALREADY_DISCONNECTING /* -14 */:
                    case DMSDPConfig.ERROR_CODE_ALREADY_CONNECTING /* -13 */:
                    case DMSDPConfig.ERROR_CODE_SCREEN_OFF /* -12 */:
                    case DMSDPConfig.ERROR_CODE_NO_PERMISSION /* -11 */:
                    case -10:
                    case -9:
                    case -8:
                    case -7:

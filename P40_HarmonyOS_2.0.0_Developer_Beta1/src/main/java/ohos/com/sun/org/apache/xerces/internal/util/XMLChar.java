...
public class XMLChar {
    ...
    static {
        ...
        bArr15[992] = -19;
        bArr15[993] = 33;
        Arrays.fill(bArr15, 994, (int) DeviceParameterConst.HILINK_DEVICE, (byte) -19);
        Arrays.fill(CHARS, (int) DeviceParameterConst.HILINK_DEVICE, 1025, (byte) 33);
        ...
        Arrays.fill(CHARS, (int) GLES1X.GL_FOG_DENSITY, (int) GLES1X.GL_FOG_COLOR, (byte) 33);
        ...
        byte[] bArr121 = CHARS;
        bArr121[4601] = -19;
        Arrays.fill(bArr121, 4602, (int) GLES20.GL_KEEP, (byte) 33);

...
public class URI implements Serializable {
    ...
    private void initialize(URI uri, String str) throws MalformedURIException {
        ...
        if (uri == null && (str == null || str.trim().length() == 0)) {
            ...
            if (indexOf >= 0) {
                ...
                if (!(this.m_scheme == null || uri == null || (!trim.startsWith(PsuedoNames.PSEUDONAME_ROOT) && this.m_scheme.equals(uri.m_scheme) && uri.getSchemeSpecificPart().startsWith(PsuedoNames.PSEUDONAME_ROOT)))) {
                    uri = null;
                }
                length = trim.length();
            } else if (uri == null) {
    ...
    @Override // java.lang.Object
    public int hashCode() {
        return ((((((((((((JLogConstants.JLID_INPUTMETHOD_PRESS_KEY_TIMEOUT + Objects.hashCode(this.m_scheme)) * 59) + Objects.hashCode(this.m_userinfo)) * 59) + Objects.hashCode(this.m_host)) * 59) + this.m_port) * 59) + Objects.hashCode(this.m_path)) * 59) + Objects.hashCode(this.m_queryString)) * 59) + Objects.hashCode(this.m_fragment);
    }

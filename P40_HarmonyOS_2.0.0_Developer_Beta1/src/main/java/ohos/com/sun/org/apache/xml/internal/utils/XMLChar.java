...
public class XMLChar {
    ...
    public static char lowSurrogate(int i) {
        return (char) (((i - 65536) & UCharacterProperty.MAX_SCRIPT) + 56320);
    }

    public static int supplemental(char c, char c2) {
        return ((c - 55296) * 1024) + (c2 - UCharacter.MIN_LOW_SURROGATE) + 65536;
    }
    ...
    static {
        ...
        int[] iArr11 = {48, 57, 1632, 1641, 1776, 1785, 2406, 2415, 2534, 2543, 2662, 2671, 2790, 2799, GLES1X.GL_FOG_COLOR, 2927, 3047, 3055, 3174, 3183, 3302, 3311, 3430, 3439, 3664, 3673, 3792, 3801, 3872, 3881};

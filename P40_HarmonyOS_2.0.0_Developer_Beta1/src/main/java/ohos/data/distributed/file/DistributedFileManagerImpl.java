    ...
    public String getSystemDistributedDir(String str) {
        ...
        try {
            ...
            if (nativeGetSystemDistributedDir == null) {
                HiLog.error(LABEL, "cannot create distributed dir %{private}s", new Object[]{str});
                return "";
            }
            HiLog.info(LABEL, "create distributed dir %{private}s", new Object[]{nativeGetSystemDistributedDir});

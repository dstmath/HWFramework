...
public class SqliteConnection implements Connection {
    ...
    private static native void nativeConfigLocale(long j, String str);
    ...
    private void setLocale() {
        nativeConfigLocale(this.connectionPtr, this.databaseConfig.getLocale().toString());
    }
    ...
    public void configLocale(Locale locale) {
        nativeConfigLocale(this.connectionPtr, locale.toString());
    }
}

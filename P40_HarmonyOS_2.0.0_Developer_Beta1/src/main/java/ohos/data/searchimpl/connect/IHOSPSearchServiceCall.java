...
public interface IHOSPSearchServiceCall extends IInterface {
    ...
    public static final int TRANSACTION_deleteLarge = 22;
    ...
    public static final int TRANSACTION_insertLarge = 20;
    ...
    public static final int TRANSACTION_updateLarge = 21;
    ...
    int deleteLarge(String str, String str2, SharedMemory sharedMemory, SharedMemory sharedMemory2, String str3);
    ...
    int insertLarge(String str, String str2, SharedMemory sharedMemory, SharedMemory sharedMemory2, String str3);
    ...
    int updateLarge(String str, String str2, SharedMemory sharedMemory, SharedMemory sharedMemory2, String str3);
    ...
    public static class Proxy implements IHOSPSearchServiceCall {
        ...
        public ISearchSession beginSearch(String str, String str2, String str3) {
            ...
            try {
                ...
                ISearchSession.Proxy proxy = new ISearchSession.Proxy(readStrongBinder);
                obtain2.recycle();
                obtain.recycle();
                return proxy;
            } catch (RemoteException e) {
        ...
        @Override // ohos.data.searchimpl.connect.IHOSPSearchServiceCall
        public int insertLarge(String str, String str2, SharedMemory sharedMemory, SharedMemory sharedMemory2, String str3) {
            int i;
            Parcel obtain = Parcel.obtain();
            Parcel obtain2 = Parcel.obtain();
            SearchResult.INNER_ERROR.getRetCode();
            try {
                obtain.writeInterfaceToken(IHOSPSearchServiceCall.DESCRIPTOR);
                obtain.writeString(str);
                obtain.writeString(str2);
                ...
                HiLog.error(LABEL, "insert large index remote exception, %{public}s", new Object[]{e.getMessage()});
                i = SearchResult.INNER_ERROR.getRetCode();
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        @Override // ohos.data.searchimpl.connect.IHOSPSearchServiceCall
        public int updateLarge(String str, String str2, SharedMemory sharedMemory, SharedMemory sharedMemory2, String str3) {
            int i;
            Parcel obtain = Parcel.obtain();
            Parcel obtain2 = Parcel.obtain();
            SearchResult.INNER_ERROR.getRetCode();
            try {
                ...
                HiLog.error(LABEL, "update large index remote exception, %{public}s", new Object[]{e.getMessage()});
                i = SearchResult.INNER_ERROR.getRetCode();
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
        ...
        @Override // ohos.data.searchimpl.connect.IHOSPSearchServiceCall
        public int deleteLarge(String str, String str2, SharedMemory sharedMemory, SharedMemory sharedMemory2, String str3) {
            int i;
            Parcel obtain = Parcel.obtain();
            Parcel obtain2 = Parcel.obtain();
            SearchResult.INNER_ERROR.getRetCode();
            try {
                ...
                HiLog.error(LABEL, "delete large index remote exception, %{public}s", new Object[]{e.getMessage()});
                i = SearchResult.INNER_ERROR.getRetCode();
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();

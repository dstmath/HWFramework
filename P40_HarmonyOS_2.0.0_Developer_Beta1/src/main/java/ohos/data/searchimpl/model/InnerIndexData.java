...
public class InnerIndexData implements Parcelable {
    public static final Parcelable.Creator<InnerIndexData> CREATOR = new Parcelable.Creator<InnerIndexData>() {
        /* class ohos.data.searchimpl.model.InnerIndexData.AnonymousClass1 */

        @Override // android.os.Parcelable.Creator
        public InnerIndexData createFromParcel(Parcel parcel) {
            return new InnerIndexData(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public InnerIndexData[] newArray(int i) {
            return new InnerIndexData[i];
        }
    };
    private static final HiLogLabel LABEL = new HiLogLabel(3, 218109504, "InnerIndexData");
    ...
    public InnerIndexData() {
        this.values = new HashMap();
    }

    private InnerIndexData(Parcel parcel) {
        this.values = new HashMap();

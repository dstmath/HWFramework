...
public class DeviceInfo implements Sequenceable {
    ...
    public boolean marshalling(Parcel parcel) {
        String str;
        if (parcel == null || (str = this.mDeviceId) == null || this.mDeviceName == null || this.mDeviceType == null || this.mDeviceState == null || !parcel.writeString(str) || !parcel.writeString(this.mDeviceName) || !parcel.writeInt(this.mDeviceType.mVal) || !parcel.writeInt(this.mDeviceState.ordinal())) {
            return false;
        }
        return true;
    }

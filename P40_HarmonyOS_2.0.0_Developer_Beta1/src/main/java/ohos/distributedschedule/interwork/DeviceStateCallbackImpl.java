...
class DeviceStateCallbackImpl extends RemoteObject implements IRemoteBroker {
    ...
    public static DeviceStateCallbackImpl get(IDeviceStateCallback iDeviceStateCallback) {
        return getCallback(iDeviceStateCallback, false);
    }

    public static DeviceStateCallbackImpl remove(IDeviceStateCallback iDeviceStateCallback) {

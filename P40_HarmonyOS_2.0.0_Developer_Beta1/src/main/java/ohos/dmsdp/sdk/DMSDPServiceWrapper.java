...
public interface DMSDPServiceWrapper {
    int connectDevice(int i, int i2, DMSDPDevice dMSDPDevice, Map<String, Object> map) throws RemoteException;
    ...
    int startDeviceService(int i, DMSDPDeviceService dMSDPDeviceService, int i2, Map<String, Object> map) throws RemoteException;
    ...
    int updateDeviceService(int i, DMSDPDeviceService dMSDPDeviceService, int i2, Map<String, Object> map) throws RemoteException;
}

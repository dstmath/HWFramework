...
public interface IDMSDPAdapterAgent extends IInterface {
    ...
    public static class Default implements IDMSDPAdapterAgent {
        ...
        @Override // ohos.dmsdp.sdk.IDMSDPAdapterAgent
    ...
    public static abstract class Stub extends Binder implements IDMSDPAdapterAgent {
        ...
        static final int TRANSACTION_setVideoSurface = 22;
        ...
        public static IDMSDPAdapterAgent asInterface(IBinder iBinder) {
            ...
            if (queryLocalInterface == null || !(queryLocalInterface instanceof IDMSDPAdapterAgent)) {
                return new Proxy(iBinder);
            }
            return (IDMSDPAdapterAgent) queryLocalInterface;
        }
            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case 16:
                        ...
                        int deviceInfo2 = setDeviceInfo(readInt12, deviceInfo);
                        parcel2.writeNoException();
                    ...
                    case 18:
                        ...
                        int trustDeviceList = getTrustDeviceList(readInt13, createTypedArrayList);
                        parcel2.writeNoException();
                    ...
                    case 22:
                        ...
                        int videoSurface = setVideoSurface(readInt14, surface);
                        parcel2.writeNoException();

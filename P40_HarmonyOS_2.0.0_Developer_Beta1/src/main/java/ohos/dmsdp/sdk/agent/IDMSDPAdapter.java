...
public interface IDMSDPAdapter extends IInterface {
    ...
    public static class Default implements IDMSDPAdapter {
        ...
        @Override // ohos.dmsdp.sdk.agent.IDMSDPAdapter
        public int connectDevice(int i, int i2, DMSDPDevice dMSDPDevice, Map map) throws RemoteException {
            return 0;
        }

        @Override // ohos.dmsdp.sdk.agent.IDMSDPAdapter
        public int deleteTrustDevice(int i, String str) throws RemoteException {
            return 0;
        }
        ...
        @Override // ohos.dmsdp.sdk.agent.IDMSDPAdapter
        public int getTrustDeviceList(int i, List<DMSDPDevice> list) throws RemoteException {
            return 0;
        }
        ...
        @Override // ohos.dmsdp.sdk.agent.IDMSDPAdapter
        public int setDeviceInfo(int i, DeviceInfo deviceInfo) throws RemoteException {
            return 0;
        }

        @Override // ohos.dmsdp.sdk.agent.IDMSDPAdapter
        public void setSecureFileListener(int i, ISecureFileListener iSecureFileListener) throws RemoteException {
        }

        @Override // ohos.dmsdp.sdk.agent.IDMSDPAdapter
        public int setVideoSurface(int i, Surface surface) throws RemoteException {
            return 0;
        }
    ...
    int setVideoSurface(int i, Surface surface) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IDMSDPAdapter {
        ...
        static final int TRANSACTION_setVideoSurface = 24;
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 24) {
                ...
                int videoSurface = setVideoSurface(readInt, surface);
                parcel2.writeNoException();
                parcel2.writeInt(videoSurface);
                if (surface != null) {
                    parcel2.writeInt(1);
                ...
                switch (i) {
                    ...
                    case 5:
                        ...
                        int connectDevice = connectDevice(readInt2, readInt3, dMSDPDevice6, parcel.readHashMap(getClass().getClassLoader()));
                        parcel2.writeNoException();
                    ...
                    case 6:
                        ...
                        int disconnectDevice = disconnectDevice(readInt4, readInt5, dMSDPDevice5);
                        parcel2.writeNoException();
                    ...
                    case 7:
                        ...
                        int requestDeviceService = requestDeviceService(readInt6, dMSDPDevice4, parcel.readInt());
                        parcel2.writeNoException();
                    ...
                    case 8:
                        ...
                        int startDeviceService = startDeviceService(readInt7, dMSDPDeviceService3, parcel.readInt(), parcel.readHashMap(getClass().getClassLoader()));
                        parcel2.writeNoException();
                    ...
                    case 9:
                        ...
                        int stopDeviceService = stopDeviceService(readInt8, dMSDPDeviceService2, parcel.readInt());
                        parcel2.writeNoException();
                    ...
                    case 10:
                        ...
                        int updateDeviceService = updateDeviceService(readInt9, dMSDPDeviceService, parcel.readInt(), parcel.readHashMap(getClass().getClassLoader()));
                        parcel2.writeNoException();
                    ...
                    case 13:
                        ...
                        int registerDataListener = registerDataListener(readInt10, dMSDPDevice3, parcel.readInt(), IDataListener.Stub.asInterface(parcel.readStrongBinder()));
                        parcel2.writeNoException();
                    ...
                    case 14:
                        ...
                        int unRegisterDataListener = unRegisterDataListener(readInt11, dMSDPDevice2, parcel.readInt());
                        parcel2.writeNoException();
                    ...
                    case 15:
                        ...
                        int sendData = sendData(readInt12, dMSDPDevice, parcel.readInt(), parcel.createByteArray());
                        parcel2.writeNoException();
                    ...
                    case 16:
                        ...
                        int deviceInfo2 = setDeviceInfo(readInt13, deviceInfo);
                        parcel2.writeNoException();
                    ...
                    case 18:
                        ...
                        int trustDeviceList = getTrustDeviceList(readInt14, createTypedArrayList);
                        parcel2.writeNoException();
            ...
            public int setVideoSurface(int i, Surface surface) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(24, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setVideoSurface(i, surface);
                    }
                    obtain2.readException();
                    int readInt = obtain2.readInt();
                    if (obtain2.readInt() != 0) {

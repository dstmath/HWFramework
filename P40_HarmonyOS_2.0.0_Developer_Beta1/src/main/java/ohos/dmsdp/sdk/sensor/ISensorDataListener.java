...
public interface ISensorDataListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISensorDataListener {
        ...
        public static ISensorDataListener asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface == null || !(queryLocalInterface instanceof ISensorDataListener)) {
                return new Proxy(iBinder);
            }
            return (ISensorDataListener) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onSensorChanged(parcel.readInt() != 0 ? SensorData.CREATOR.createFromParcel(parcel) : null);
        ...
        private static class Proxy implements ISensorDataListener {
            ...
            public void onSensorChanged(SensorData sensorData) throws RemoteException {
                ...
                try {
                    ...
                    if (sensorData != null) {
                        obtain.writeInt(1);
                        sensorData.writeToParcel(obtain, 0);
                    } else {
                        obtain.writeInt(0);
                    }

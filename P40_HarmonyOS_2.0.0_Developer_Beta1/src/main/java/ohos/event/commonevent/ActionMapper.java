...
public class ActionMapper {
    private static final Map<String, String> ACTION_MAP = Collections.unmodifiableMap(new HashMap<String, String>() {
...

        {
            ...
            put("android.intent.action.ACTION_DEFAULT_VOICE_SUBSCRIPTION_CHANGED", CommonEventSupport.COMMON_EVENT_SIM_CARD_DEFAULT_VOICE_SUBSCRIPTION_CHANGED);
            put("android.intent.action.SIM_STATE_CHANGED", CommonEventSupport.COMMON_EVENT_SIM_STATE_CHANGED);
            put("android.intent.action.AIRPLANE_MODE", CommonEventSupport.COMMON_EVENT_AIRPLANE_MODE_CHANGED);

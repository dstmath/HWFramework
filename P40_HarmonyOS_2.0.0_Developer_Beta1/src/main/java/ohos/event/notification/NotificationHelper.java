...
public class NotificationHelper {
    ...
    public static Set<NotificationRequest> getAllActiveNotifications() throws RemoteException {
        return NotificationManagerProxy.getInstance().getAllActiveNotifications(null);
    }
    ...
    @SystemApi
    public static void setDisturbMode(NotificationConstant.DisturbMode disturbMode) throws RemoteException {
        NotificationManagerProxy.getInstance().setDisturbMode(disturbMode.ordinal());
    }

    @SystemApi
    public static int getDisturbMode() throws RemoteException {
        return NotificationManagerProxy.getInstance().getDisturbMode();
    }

    @SystemApi
    public static Set<NotificationRequest> getAllActiveNotifications(String[] strArr) throws RemoteException {
        return NotificationManagerProxy.getInstance().getAllActiveNotifications(strArr);
    }
}

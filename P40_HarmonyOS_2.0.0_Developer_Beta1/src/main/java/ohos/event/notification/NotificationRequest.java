...
public final class NotificationRequest implements Sequenceable {
    ...
    public NotificationRequest setShowDeliveryTime(boolean z) {
        this.showDeliveryTime = z;
        return this;
    }
    ...
    /* access modifiers changed from: package-private */
    public NotificationRequest setLabel(String str) {
        this.label = str;
        return this;
    }
    ...
    public NotificationRequest setBadgeIconStyle(int i) {
        this.badgeIconStyle = i;
        return this;
    }

    public int getBadgeIconStyle() {
        return this.badgeIconStyle;
    }

    public NotificationRequest setShortcutId(String str) {
        this.shortcutId = str;
        return this;
    }
    ...
    public static final class NotificationContent implements Sequenceable {
        ...
        public String toString() {
            return "NotificationContent[ contentType = " + this.contentType + " content = " + this.content + "]";
        }
    }
    ...
    public static abstract class NotificationBasicContent implements Sequenceable {
        ...
        public String toString() {
            return " title = " + this.title + " text = " + this.text + " additionalText = " + this.additionalText;
        }
    }
    ...
    public static final class NotificationLongTextContent extends NotificationBasicContent {
        ...
        @Override // ohos.event.notification.NotificationRequest.NotificationBasicContent
        public String toString() {
            return "NotificationLongTextContent[" + super.toString() + " longText = " + this.longText + " briefText = " + this.briefText + " expandedTitle = " + this.expandedTitle + "]";
        }
    }
    ...
    public static final class NotificationPictureContent extends NotificationBasicContent {
        ...
        @Override // ohos.event.notification.NotificationRequest.NotificationBasicContent
        public String toString() {
            return "NotificationPictureContent[" + super.toString() + " briefText = " + this.briefText + " expandedTitle = " + this.expandedTitle + "]";
        }
    }
    ...
    public static final class NotificationConversationalContent extends NotificationBasicContent {
        ...
        @Override // ohos.event.notification.NotificationRequest.NotificationBasicContent
        public String toString() {
            return "NotificationConversationalContent[" + super.toString() + " conversationTitle = " + this.conversationTitle + " conversationGroup = " + this.conversationGroup + " user = " + this.user + " messages = " + this.messages + "]";
        }
        ...
        public static final class ConversationalMessage implements Sequenceable {
            ...
            public String toString() {
                return "ConversationalMessage[ text = " + this.text + " timestamp = " + this.timestamp + " mimeType = " + this.mimeType + " uri = " + this.uri + " sender = " + this.sender + "]";
            }
        }
    }
    ...
    public static final class NotificationMultiLineContent extends NotificationBasicContent {
        ...
        @Override // ohos.event.notification.NotificationRequest.NotificationBasicContent
        public String toString() {
            return "NotificationMultiLineContent[" + super.toString() + " briefText = " + this.briefText + " longTitle = " + this.longTitle + " lines = " + this.lines + "]";
        }
    }
    ...
    public static final class NotificationMediaContent extends NotificationBasicContent {
        ...
        @Override // ohos.event.notification.NotificationRequest.NotificationBasicContent
        public String toString() {
            return "NotificationMediaContent[" + super.toString() + " actionsToShow = " + Arrays.toString(this.actionsToShow) + "]";
        }
    }
    ...
    private boolean writeToParcelThird(Parcel parcel) {
        if (!parcel.writeBoolean(this.isStopwatch)) {
            ...
            return false;
        } else if (!parcel.writeBoolean(this.showDeliveryTime)) {
            HiLog.warn(LABEL, "NotificationRequest: marshalling write showDeliveryTime failed.", new Object[0]);
            return false;
    ...
    private boolean readFromParcel(Parcel parcel) {
        ...
        this.showDeliveryTime = parcel.readBoolean();
    ...
    private void copyLighty(NotificationRequest notificationRequest) {
        ...
        this.showDeliveryTime = notificationRequest.showDeliveryTime;
        ...
        this.bigIcon = notificationRequest.bigIcon;
        this.littleIcon = notificationRequest.littleIcon;
        this.label = notificationRequest.label;
        this.badgeIconStyle = notificationRequest.badgeIconStyle;
        this.shortcutId = notificationRequest.shortcutId;
    }
    ...
    public String toString() {
        return "NotificationRequest[ notificationId = " + this.notificationId + " slotId = " + this.slotId + " notificationHashCode = " + this.notificationHashCode + " createTime = " + this.createTime + " deliveryTime = " + this.deliveryTime + " autoDeletedTime = " + this.autoDeletedTime + " settingsText = " + this.settingsText + " creatorBundleName = " + this.creatorBundleName + " ownerBundleName = " + this.ownerBundleName + " groupValue = " + this.groupValue + " statusBarText = " + this.statusBarText + " label = " + this.label + " shortcutId = " + this.shortcutId + " sortingKey = " + this.sortingKey + " groupAlertType = " + this.groupAlertType + " color = " + this.color + " number = " + this.number + " visibleness = " + this.visibleness + " progressValue = " + this.progressValue + " progressMaxValue = " + this.progressMaxValue + " badgeIconStyle = " + this.badgeIconStyle + " showCreateTime = " + this.showCreateTime + " showDeliveryTime = " + this.showDeliveryTime + " tapDismissed = " + this.tapDismissed + " colorEnabled = " + this.colorEnabled + " isAlertOnce = " + this.isAlertOnce + " isStopwatch = " + this.isStopwatch + " isCountDown = " + this.isCountDown + " isOngoing = " + this.isOngoing + " groupOverview = " + this.groupOverview + " isIndeterminate = " + this.isIndeterminate + " isUnremovable = " + this.isUnremovable + " isFloatingIcon = " + this.isFloatingIcon + " onlyLocal = " + this.onlyLocal + " permitSystemGeneratedContextualActionButtons = " + this.permitSystemGeneratedContextualActionButtons + " content = " + this.content + " actionButtons = " + this.actionButtons + " messageUsers = " + this.messageUsers + "]";
    }
}

...
public class NotificationSorting implements Sequenceable {
    ...
    public String toString() {
        return "NotificationSorting[ NotificationSlot = " + this.slot + " hashCode = " + this.hashCode + " ranking = " + this.ranking + " importance = " + this.importance + " groupKeyOverride = " + this.groupKeyOverride + " visiblenessOverride = " + this.visiblenessOverride + " isDisplayBadge = " + this.isDisplayBadge + " isHiddenNotification = " + this.isHiddenNotification + "]";
    }
}

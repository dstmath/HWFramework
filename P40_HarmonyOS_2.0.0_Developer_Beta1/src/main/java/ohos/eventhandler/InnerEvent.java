...
public final class InnerEvent implements Sequenceable {
    ...
    public boolean isPriorityEqual(EventHandler.Priority priority2) {
        return this.priority == priority2;
    }
    ...
    private InnerEvent() {
        ...
        this.priority = EventHandler.Priority.LOW;
        this.task = null;
        this.owner = null;
    ...
    public static InnerEvent copyFrom(InnerEvent innerEvent) throws CloneNotSupportedException {
        ...
        innerEvent2.replyTo = innerEvent.replyTo;
    ...
    public static InnerEvent get(Runnable runnable) {
        if (runnable != null) {
            InnerEvent innerEvent = get();
    ...
    public static InnerEvent get(InnerEvent innerEvent) throws CloneNotSupportedException {
        InnerEvent innerEvent2 = InnerEventPool.getInstance().get();
        innerEvent2.eventId = innerEvent.eventId;
        innerEvent2.task = innerEvent.task;
        innerEvent2.param = innerEvent.param;
    ...
    public String toString() {
        ...
        if (this.owner != null) {
            if (this.task != null) {
                sb.append(" task = ");
                sb.append(this.task.getClass().getName());
            } else {
                sb.append(" eventId = ");
            ...
            if (this.owner.get() != null) {
                sb.append(" owner = ");
                sb.append(this.owner.get().getClass().getName());
            }
        }
        return sb.toString();
    }

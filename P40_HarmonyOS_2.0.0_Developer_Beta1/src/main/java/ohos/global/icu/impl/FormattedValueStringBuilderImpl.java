...
public class FormattedValueStringBuilderImpl {
    ...
    public static boolean nextFieldPosition(FormattedStringBuilder formattedStringBuilder, FieldPosition fieldPosition) {
        NumberFormat.Field fieldAttribute = fieldPosition.getFieldAttribute();
        ...
        if (fieldAttribute instanceof NumberFormat.Field) {
            ...
            constrainedFieldPosition.setState(fieldAttribute, (Object) null, fieldPosition.getBeginIndex(), fieldPosition.getEndIndex());
    ...
    public static boolean nextPosition(FormattedStringBuilder formattedStringBuilder, ConstrainedFieldPosition constrainedFieldPosition, Format.Field field) {
        ...
        while (limit <= formattedStringBuilder.zero + formattedStringBuilder.length) {
            Format.Field field3 = limit < formattedStringBuilder.zero + formattedStringBuilder.length ? formattedStringBuilder.fields[limit] : NullField.END;
            if (field2 == null) {
                if (constrainedFieldPosition.matchesField(NumberFormat.Field.INTEGER, (Object) null) && limit > formattedStringBuilder.zero && limit - formattedStringBuilder.zero > constrainedFieldPosition.getLimit()) {
                    int i2 = limit - 1;
                    if (isIntOrGroup(formattedStringBuilder.fields[i2]) && !isIntOrGroup(field3)) {
                        while (i2 >= formattedStringBuilder.zero && isIntOrGroup(formattedStringBuilder.fields[i2])) {
                            i2--;
                        }
                        constrainedFieldPosition.setState(NumberFormat.Field.INTEGER, (Object) null, (i2 - formattedStringBuilder.zero) + 1, limit - formattedStringBuilder.zero);
                        return true;
                    }
                }
                if (field != null && constrainedFieldPosition.matchesField(field, (Object) null) && limit > formattedStringBuilder.zero && (limit - formattedStringBuilder.zero > constrainedFieldPosition.getLimit() || constrainedFieldPosition.getField() != field)) {
                    int i3 = limit - 1;
                    if (isNumericField(formattedStringBuilder.fields[i3]) && !isNumericField(field3)) {
                        while (i3 >= formattedStringBuilder.zero && isNumericField(formattedStringBuilder.fields[i3])) {
                            i3--;
                        }
                        constrainedFieldPosition.setState(field, (Object) null, (i3 - formattedStringBuilder.zero) + 1, limit - formattedStringBuilder.zero);
                        return true;
                    }
                }
                ...
                if (!(field3 == null || field3 == NullField.END || !constrainedFieldPosition.matchesField(field3, (Object) null))) {
                ...
                if (i4 <= i) {
                    ...
                    constrainedFieldPosition.setState(field2, (Object) null, i, i4);
                    return true;
                }
            } else {
                continue;

...
public class RelativeDateFormat extends DateFormat {
    ...
    public RelativeDateFormat(int i, int i2, ULocale uLocale, Calendar calendar) {
        ...
        if (i3 != -1) {
            SimpleDateFormat dateInstance = DateFormat.getDateInstance(i3 & -129, uLocale);
            if (dateInstance instanceof SimpleDateFormat) {
                this.fDateTimeFormat = dateInstance;
                this.fDatePattern = this.fDateTimeFormat.toPattern();
                int i4 = this.fTimeStyle;
                if (i4 != -1) {
                    SimpleDateFormat timeInstance = DateFormat.getTimeInstance(i4 & -129, uLocale);
            ...
            SimpleDateFormat timeInstance2 = DateFormat.getTimeInstance(this.fTimeStyle & -129, uLocale);
    ...
    public void setContext(DisplayContext displayContext) {
        RelativeDateFormat.super.setContext(displayContext);

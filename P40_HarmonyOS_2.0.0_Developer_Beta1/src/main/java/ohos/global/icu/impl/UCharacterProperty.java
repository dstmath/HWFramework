...
public final class UCharacterProperty {
    ...
    public UnicodeSet addPropertyStarts(UnicodeSet unicodeSet) {
        ...
        unicodeSet.add(134);
        unicodeSet.add(127);
        unicodeSet.add((int) HAIRSP);
        unicodeSet.add(8208);
        unicodeSet.add((int) INHSWAP);
        unicodeSet.add(8304);
        unicodeSet.add((int) ZWNBSP);
        unicodeSet.add(65280);
        unicodeSet.add(160);
        unicodeSet.add(161);
        unicodeSet.add((int) FIGURESP);
        unicodeSet.add(8200);
        unicodeSet.add((int) NNBSP);
        unicodeSet.add(8240);

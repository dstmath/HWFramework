...
public final class CollationRuleParser {
            ...
            while (true) {
                ...
                if (i3 < strArr.length) {
                    if (sb2.equals(strArr[i3])) {
                        sb.append(POS_LEAD);
                        sb.append((char) (i3 + 10240));
                        return i2;
                    }
                    i3++;
                } else if (sb2.equals("top")) {
                    sb.append(POS_LEAD);
                    sb.append((char) (Position.LAST_REGULAR.ordinal() + 10240));
                    return i2;
                } else if (sb2.equals("variable top")) {
                    sb.append(POS_LEAD);
                    sb.append((char) (Position.LAST_VARIABLE.ordinal() + 10240));
                    return i2;
                }
            }
        }
    ...
    private void setParseError(String str, Exception exc) throws ParseException {
        ParseException makeParseException = makeParseException(str + ": " + exc.getMessage());

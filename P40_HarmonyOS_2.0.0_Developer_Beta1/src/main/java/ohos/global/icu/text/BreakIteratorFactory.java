...
final class BreakIteratorFactory extends BreakIterator.BreakIteratorServiceShim {
    ...
    public static BreakIterator createBreakInstance(ULocale uLocale, int i) {
        ...
        ICUResourceBundle bundleInstance = ICUResourceBundle.getBundleInstance("ohos/global/icu/impl/data/icudt66b/brkitr", uLocale, ICUResourceBundle.OpenType.LOCALE_ROOT);

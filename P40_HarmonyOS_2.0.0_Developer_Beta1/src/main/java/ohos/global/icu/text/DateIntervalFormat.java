...
public class DateIntervalFormat extends UFormat {
    ...
    public String getPatterns(Calendar calendar, Calendar calendar2, Output<String> output) {
        ...
        output.value = (T) patternInfo.getSecondPart();
    ...
    private String getConcatenationPattern(ULocale uLocale) {
        ICUResourceBundle iCUResourceBundle = UResourceBundle.getBundleInstance("ohos/global/icu/impl/data/icudt66b", uLocale).getWithFallback("calendar/gregorian/DateTimePatterns").get(8);
    ...
    private void concatSingleDate2TimeInterval(String str, String str2, int i, Map<String, DateIntervalInfo.PatternInfo> map) {
        ...
        if (patternInfo != null) {
            map.put(DateIntervalInfo.CALENDAR_FIELD_TO_PATTERN_LETTER[i], DateIntervalInfo.genPatternInfo(SimpleFormatterImpl.formatRawPattern(str, 2, 2, new CharSequence[]{patternInfo.getFirstPart() + patternInfo.getSecondPart(), str2}), patternInfo.firstDateInPtnIsLaterDate()));
        }
    }

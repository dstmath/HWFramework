...
public class NumberingSystem {
    ...
    static NumberingSystem lookupInstanceByLocale(LocaleLookupData localeLookupData) {
        ...
        String str;
        try {
            ICUResourceBundle withFallback = UResourceBundle.getBundleInstance("ohos/global/icu/impl/data/icudt66b", localeLookupData.locale).getWithFallback("NumberElements");
    ...
    public static NumberingSystem getInstanceByName(String str) {
        return (NumberingSystem) cachedStringData.getInstance(str, (Object) null);
    }

    /* access modifiers changed from: private */
    public static NumberingSystem lookupInstanceByName(String str) {
        try {
            UResourceBundle uResourceBundle = UResourceBundle.getBundleInstance("ohos/global/icu/impl/data/icudt66b", "numberingSystems").get("numberingSystems").get(str);
    ...
    public static String[] getAvailableNames() {
        UResourceBundle uResourceBundle = UResourceBundle.getBundleInstance("ohos/global/icu/impl/data/icudt66b", "numberingSystems").get("numberingSystems");

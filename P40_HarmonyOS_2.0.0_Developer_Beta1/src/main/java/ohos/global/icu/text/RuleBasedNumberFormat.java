...
public class RuleBasedNumberFormat extends NumberFormat {
    ...
    public RuleBasedNumberFormat(ULocale uLocale, int i) {
        ...
        this.capitalizationBrkIter = null;
        this.locale = uLocale;
        ICUResourceBundle bundleInstance = UResourceBundle.getBundleInstance("ohos/global/icu/impl/data/icudt66b/rbnf", uLocale);
    ...
    private void initCapitalizationContextInfo(ULocale uLocale) {
        try {
            int[] intVector = UResourceBundle.getBundleInstance("ohos/global/icu/impl/data/icudt66b", uLocale).getWithFallback("contextTransforms/number-spellout").getIntVector();

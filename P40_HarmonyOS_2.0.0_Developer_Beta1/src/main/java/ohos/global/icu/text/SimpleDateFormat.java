...
public class SimpleDateFormat extends DateFormat {
    ...
    private synchronized void initializeTimeZoneFormat(boolean z) {
        ...
        if (this.numberFormat instanceof DecimalFormat) {
            ...
            str = new String(this.numberFormat.getDigits());
        }
    ...
    private static synchronized String getDefaultPattern() {
        ...
        synchronized (SimpleDateFormat.class) {
            ...
            if (!uLocale.equals(cachedDefaultLocale)) {
                ...
                try {
                    ICUResourceBundle bundleInstance = UResourceBundle.getBundleInstance("ohos/global/icu/impl/data/icudt66b", cachedDefaultLocale);
                    ...
                    if (findWithFallback != null) {
                        if (findWithFallback.getSize() >= 9) {
                            ...
                            cachedDefaultPattern = SimpleFormatterImpl.formatRawPattern(findWithFallback.getString(i), 2, 2, new CharSequence[]{findWithFallback.getString(3), findWithFallback.getString(7)});
                        }
                    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:309:0x0656  */
    /* JADX WARNING: Removed duplicated region for block: B:310:0x0662  */
    /* JADX WARNING: Removed duplicated region for block: B:332:0x06de A[ADDED_TO_REGION] */
    /* JADX WARNING: Removed duplicated region for block: B:342:0x0700  */
    /* JADX WARNING: Removed duplicated region for block: B:344:0x0703  */
    /* JADX WARNING: Removed duplicated region for block: B:350:0x0734  */
        ...
        if (indexFromChar != -1) {
            ...
            switch (indexFromChar) {
                ...
                case 18:
                    ...
                    if (str5 != null && ((str5.compareTo("hebr") == 0 || this.override.indexOf("y=hebr") >= 0) && relatedYear > HEBREW_CAL_CUR_MILLENIUM_START_YEAR && relatedYear < 6000)) {
                        relatedYear -= 5000;
                    }
                    if (i != i5) {
    ...
    private static void safeAppendWithMonthPattern(String[] strArr, int i, StringBuffer stringBuffer, String str) {
        if (strArr != null && i >= 0 && i < strArr.length) {
            if (str == null) {
                ...
                stringBuffer.append(SimpleFormatterImpl.formatRawPattern(str, 1, 1, new CharSequence[]{strArr[i]}));
            }
        }
    }
    ...
    public void parse(String str, Calendar calendar, ParsePosition parsePosition) {
        ...
        if (output3.value != null) {
            ...
            if (calendar2.isSet(10) || calendar2.isSet(11)) {
                ...
                int i21 = midPointForDayPeriod2 - ((double) i20) > 0.0d ? 30 : 0;
                ...
                if (t != TimeZoneFormat.TimeType.UNKNOWN) {
                    ...
                    if (basicTimeZone == null) {
                        ...
                        if ((t == TimeZoneFormat.TimeType.STANDARD && iArr[1] != 0) || (t == TimeZoneFormat.TimeType.DAYLIGHT && iArr[1] == 0)) {
                            timeZone4.getOffset(timeInMillis - WorkStatus.RARE_DELAY_TIME, true, iArr);
                        }
    ...
    private int matchString(String str, int i, int i2, String[] strArr, String str2, Calendar calendar) {
        ...
        for (int i6 = i2 == 7 ? 1 : 0; i6 < length2; i6++) {
            ...
            if (str2 != null && (length = (formatRawPattern = SimpleFormatterImpl.formatRawPattern(str2, 1, 1, new CharSequence[]{strArr[i6]})).length()) > i4 && (regionMatchesWithOptionalDot = regionMatchesWithOptionalDot(str, i, formatRawPattern, length)) >= 0) {
                i5 = 1;
                i3 = i6;
                                        ...
                                        case 26:
                                            if (i2 <= 2 || (number != null && getBooleanAttribute(DateFormat.BooleanAttribute.PARSE_ALLOW_NUMERIC))) {
                                                ...
                                                if (calendar.getType().equals("hebrew") && i5 >= 6) {
                                                    if (!calendar.isSet(r9)) {
                                                        DelayedHebrewMonthCheck = r9;
                                                    } else if (!HebrewCalendar.isLeapYear(calendar.get(r9))) {
                                                        calendar.set(2, i5);
                                                    }
                                                }
                                                return parsePosition.getIndex();

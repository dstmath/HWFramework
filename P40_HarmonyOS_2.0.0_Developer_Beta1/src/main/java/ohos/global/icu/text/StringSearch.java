...
public final class StringSearch extends SearchIterator {
    ...
    private static int getMask(int i) {
        return i != 0 ? i != 1 ? -1 : -256 : PRIMARYORDERMASK;
    }
    ...
    private int getCE(int i) {
        ...
        if (!this.toShift_) {
            return (this.strength_ < 3 || i2 != 0) ? i2 : DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
        }
    ...
    private static int compareCE64s(long j, long j2, SearchIterator.ElementComparisonType elementComparisonType) {
        ...
        long j3 = j >>> 32;
        long j4 = j2 >>> 32;
        int i = (int) (j3 & 4294901760L);
        int i2 = (int) (j4 & 4294901760L);
        if (i == i2) {
            int i3 = (int) (j3 & 65535);
            int i4 = (int) (j4 & 65535);
            if (i3 == i4) {
                int i5 = (int) (j & 4294901760L);
                int i6 = (int) (j2 & 4294901760L);
                ...
                if (!z && (cei2 == null || cei2.ce_ != -1)) {
                    ...
                    if (this.search_.elementComparisonType_ == SearchIterator.ElementComparisonType.STANDARD_ELEMENT_COMPARISON) {
                        ...
                        if (cei.lowIndex_ != cei.highIndex_ || cei.ce_ == -1) {
                            ...
                            z2 = this.breakIterator != null && ((cei.ce_ >>> 32) & 4294901760L) != 0 && i5 >= cei5.highIndex_ && cei.highIndex_ > i5 && (this.nfd_.hasBoundaryBefore(codePointAt(this.targetText, i5)) || this.nfd_.hasBoundaryAfter(codePointBefore(this.targetText, i5)));
                        ...
                        while (true) {
                            ...
                            if (cei.ce_ == -1) {
                                cEBuffer = cEBuffer2;
                                break;
                            } else if (((cei.ce_ >>> 32) & 4294901760L) == 0) {
                                cEBuffer = cEBuffer2;
        ...
        while (true) {
            ...
            if (previous != null) {
                ...
                if (i2 > 0) {
                    ...
                    boolean z3 = this.breakIterator == null && ((previous4.ce_ >>> 32) & 4294901760L) != 0 && i13 >= previous.highIndex_ && previous4.highIndex_ > i13 && (this.nfd_.hasBoundaryBefore(codePointAt(this.targetText, i13)) || this.nfd_.hasBoundaryAfter(codePointBefore(this.targetText, i13)));
    ...
    public static class CollationPCE {
        ...
        private static boolean isContinuation(int i) {
            return (i & CONTINUATION_MARKER) == CONTINUATION_MARKER;
        }
            ...
            while (this.pceBuffer_.empty()) {
                ...
                while (true) {
                    ...
                    if (previous != -1) {
                        ...
                        if ((PRIMARYORDERMASK & previous) != 0 && !isContinuation(previous)) {
                            break;
                        }

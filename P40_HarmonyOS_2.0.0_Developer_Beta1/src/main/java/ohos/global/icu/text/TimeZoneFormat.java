...
public class TimeZoneFormat extends UFormat implements Freezable<TimeZoneFormat>, Serializable {
    ...
    private static final String[] DEFAULT_GMT_DIGITS = {LightEffect.LIGHT_ID_LED, "1", "2", "3", "4", "5", "6", "7", "8", "9"};
    ...
    protected TimeZoneFormat(ULocale uLocale) {
        ...
        String str3 = null;
        try {
            ICUResourceBundle bundleInstance = ICUResourceBundle.getBundleInstance("ohos/global/icu/impl/data/icudt66b/zone", uLocale);
            try {
    ...
    public TimeZone parse(Style style, String str, ParsePosition parsePosition, EnumSet<ParseOption> enumSet, Output<TimeType> output) {
        ...
        if (output2 == null) {
            ...
            output2.value = (T) TimeType.UNKNOWN;
        }
        ...
        if (z3 || z4) {
            ...
            } else if (parsePosition2.getIndex() == length || output3.value.booleanValue()) {
        ...
        switch (style) {
            ...
            case GENERIC_SHORT:
                ...
                if (findBestMatch2 != null && findBestMatch2.matchLength() + index > i3) {
                    output2.value = (T) findBestMatch2.timeType();
            ...
            case SPECIFIC_SHORT:
                ...
                if (find3 != null) {
                    ...
                    if (matchInfo2 != null) {
                        output2.value = (T) getTimeType(matchInfo2.nameType());
                ...
                if (z && style == Style.SPECIFIC_SHORT && (find2 = getTZDBTimeZoneNames().find(str, index, enumSet3)) != null) {
                    ...
                    if (matchInfo3 == null) {
                        ...
                        output2.value = (T) getTimeType(matchInfo3.nameType());
            ...
            case ISO_EXTENDED_LOCAL_FULL:
                ...
                if (parsePosition2.getErrorIndex() == -1 && output4.value.booleanValue()) {
                    parsePosition.setIndex(parsePosition2.getIndex());
                    ...
                    if (!z2) {
                        if (i3 < length) {
                            ...
                            if (i3 < i5) {
                                ...
                                t = (T) getTimeType(matchInfo.nameType());
                                ...
                                if (z || i5 >= length || (Style.SPECIFIC_SHORT.flag & i10) != 0 || (find = getTZDBTimeZoneNames().find(str, index, ALL_SIMPLE_NAME_TYPES)) == null) {
                                    ...
                                    if (i5 < i11) {
                                        ...
                                        t = getTimeType(matchInfo5.nameType());
                                        i5 = i11;
                                        i4 = Integer.MAX_VALUE;
    ...
    private String formatOffsetISO8601(int i, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (i2 < MAX_OFFSET) {
            ...
            int[] iArr = {i2 / MILLIS_PER_HOUR, i3 / 60000, (i3 % 60000) / 1000};
    ...
    private int parseDefaultOffsetFields(String str, int i, char c, int[] iArr) {
        ...
        iArr[0] = i3 - i;
        return (parseOffsetFieldWithLocalizedDigits * MILLIS_PER_HOUR) + (i2 * 60000) + (i4 * 1000);
    }
            ...
            switch (i8) {
                case 1:
                    ...
                    if (i4 > 23 || i3 > 59 || i2 > 59) {
                        ...
                        int i10 = (i4 * MILLIS_PER_HOUR) + (i3 * 60000) + (i2 * 1000);
                        iArr[0] = iArr3[i8 - 1];
                        return i10;
                    }
                    break;
    ...
    private static int parseAsciiOffsetFields(String str, ParsePosition parsePosition, char c, OffsetFields offsetFields, OffsetFields offsetFields2) {
        ...
        if (iArr2[0] == 0) {
            ...
            i2 = (iArr[0] / 10) * MILLIS_PER_HOUR;
            offsetFields3 = OffsetFields.H;
            i = 1;
        } else {
            i2 = iArr[0] * MILLIS_PER_HOUR;
            i = iArr2[0];
            offsetFields3 = OffsetFields.H;
    ...
    private static String parseZoneID(String str, ParsePosition parsePosition) {
        ...
        Iterator it = ZONE_ID_TRIE.get(str, parsePosition.getIndex(), output);
        if (it != null) {
    ...
    private static String parseShortZoneID(String str, ParsePosition parsePosition) {
        ...
        TextTrieMap.Output output = new TextTrieMap.Output();
        Iterator it = SHORT_ZONE_ID_TRIE.get(str, parsePosition.getIndex(), output);
        if (it != null) {
            String str3 = (String) it.next();
            parsePosition.setIndex(parsePosition.getIndex() + output.matchLength);
            return str3;

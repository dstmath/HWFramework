...
public class TransliteratorIDParser {
    ...
    public static SingleID parseSingleID(String str, int[] iArr, int i) {
        ...
        while (true) {
            if (i3 > 2) {
                ...
                iArr[0] = i2;
                return null;
            } else if (!Utility.parseChar(str, iArr, (char) OPEN_REV)) {
                i3++;
            } else if (!Utility.parseChar(str, iArr, (char) CLOSE_REV)) {
                Specs parseFilterID = parseFilterID(str, iArr, true);
                if (parseFilterID == null || !Utility.parseChar(str, iArr, (char) CLOSE_REV)) {
                    iArr[0] = i2;
                    return null;
                }
                z = true;
    ...
    public static UnicodeSet parseGlobalFilter(String str, int[] iArr, int i, int[] iArr2, StringBuffer stringBuffer) {
        ...
        } else if (iArr2[0] == 1 && !Utility.parseChar(str, iArr, (char) OPEN_REV)) {
            iArr[0] = i2;
            return null;
        }
        ...
        try {
            ...
            if (iArr2[0] != 1 || Utility.parseChar(str, iArr, (char) CLOSE_REV)) {

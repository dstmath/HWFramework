...
public class TransliteratorParser {
                    ...
                    if (TransliteratorParser.HALF_ENDERS.indexOf(charAt) < 0) {
                        ...
                        if (UnicodeSet.resemblesPattern(str, i24)) {
                            ...
                            if (unicodeSet.contains(charAt)) {
                                TransliteratorParser.syntaxError("Illegal character '" + charAt + TransliteratorParser.QUOTE, str, i);
                            }
                            if (charAt != '$') {
                                if (charAt != '&') {
                                    if (charAt != '.') {
                                        if (charAt == '^') {
                                            ...
                                            try {
                                                ...
                                                throw new IllegalIcuArgumentException("Failure in rule: " + (i23 < 50 ? str.substring(0, i23) : "..." + str.substring(i23 - 50, i23)) + "$$$" + (i2 - i23 <= 50 ? str.substring(i23, i2) : str.substring(i23, i23 + 50) + "...")).initCause(e);
                                            }
                                        }
                                        z2 = z3;
                                        i22 = i23;
                                ...
                                if (parseFilterID == null || !Utility.parseChar(str, iArr4, (char) TransliteratorParser.SEGMENT_OPEN)) {
                            ...
                            try {
                                if (nextLine.regionMatches(i11, ID_TOKEN, 0, 2)) {
                                    try {
                                        ...
                                        if (iArr[0] == i13 || !Utility.parseChar(nextLine, iArr, ';')) {
                                            int[] iArr2 = {-1};
                                            ...
                                            sb.insert(0, parseSingleID.canonID + ';');
                                        }
                                        i9 = iArr[0];
                                        data2 = null;
                        ...
                        if (z2) {
                            ...
                            try {
                                ...
                                if (i7 == 30) {
                                    ...
                                    illegalIcuArgumentException.initCause(e);
    ...
    private int parsePragma(String str, int i, int i2) {
        ...
        int parsePattern3 = Utility.parsePattern(str, i3, i2, "~nfd rules~;", (int[]) null);
        if (parsePattern3 >= 0) {
            pragmaNormalizeRules(Normalizer.NFD);
            return parsePattern3;
        }
        int parsePattern4 = Utility.parsePattern(str, i3, i2, "~nfc rules~;", (int[]) null);
        if (parsePattern4 < 0) {
            return -1;
        }

...
class UnescapeTransliterator extends Transliterator {
    ...
    static void register() {
        ...
        Transliterator.registerFactory("Hex-Any/Java", new Transliterator.Factory() {
            ...
            @Override // ohos.global.icu.text.Transliterator.Factory
            public Transliterator getInstance(String str) {
                return new UnescapeTransliterator("Hex-Any/Java", new char[]{2, 0, 16, 4, 4, '\\', ULocale.UNICODE_LOCALE_EXTENSION, 65535});
            }
        });
        Transliterator.registerFactory("Hex-Any/C", new Transliterator.Factory() {
            ...
            @Override // ohos.global.icu.text.Transliterator.Factory
            public Transliterator getInstance(String str) {
                return new UnescapeTransliterator("Hex-Any/C", new char[]{2, 0, 16, 4, 4, '\\', ULocale.UNICODE_LOCALE_EXTENSION, 2, 0, 16, '\b', '\b', '\\', 'U', 65535});
            }
        });
        ...
        Transliterator.registerFactory("Hex-Any/Perl", new Transliterator.Factory() {
            ...
            @Override // ohos.global.icu.text.Transliterator.Factory
            public Transliterator getInstance(String str) {
                return new UnescapeTransliterator("Hex-Any/Perl", new char[]{3, 1, 16, 1, 6, '\\', ULocale.PRIVATE_USE_EXTENSION, '{', '}', 65535});
            }
        });
        Transliterator.registerFactory("Hex-Any", new Transliterator.Factory() {
            ...
            @Override // ohos.global.icu.text.Transliterator.Factory
            public Transliterator getInstance(String str) {
                return new UnescapeTransliterator("Hex-Any", new char[]{2, 0, 16, 4, 6, 'U', '+', 2, 0, 16, 4, 4, '\\', ULocale.UNICODE_LOCALE_EXTENSION, 2, 0, 16, '\b', '\b', '\\', 'U', 3, 1, 16, 1, 6, '&', '#', ULocale.PRIVATE_USE_EXTENSION, TelephoneNumberUtils.WAIT, 2, 1, '\n', 1, 7, '&', '#', TelephoneNumberUtils.WAIT, 3, 1, 16, 1, 6, '\\', ULocale.PRIVATE_USE_EXTENSION, '{', '}', 65535});
            }
        });
    }

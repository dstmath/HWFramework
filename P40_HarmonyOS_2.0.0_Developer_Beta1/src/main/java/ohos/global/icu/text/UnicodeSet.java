...
public class UnicodeSet extends UnicodeFilter implements Iterable<String>, Comparable<UnicodeSet>, Freezable<UnicodeSet> {
    ...
    private int nextCapacity(int i) {
        ...
        int i2 = i * 2;
        return i2 > MAX_LENGTH ? MAX_LENGTH : i2;
    }
    ...
    private void applyPattern(RuleCharacterIterator ruleCharacterIterator, SymbolTable symbolTable, Appendable appendable, int i, int i2) {
        ...
        int i19 = 0;
        while (true) {
            if (i16 == i14 || ruleCharacterIterator.atEnd()) {
                break;
            }
            if (resemblesPropertyPattern(ruleCharacterIterator, i13)) {
                obj = obj4;
                i3 = i19;
                unicodeSet = null;
                i7 = 0;
                ...
                i7 = ruleCharacterIterator.next(i13);
                boolean isEscaped = ruleCharacterIterator.isEscaped();
                if (i7 != 91 || isEscaped != 0) {
                    if (!(symbolTable == null || (lookupMatcher = symbolTable.lookupMatcher(i7)) == null)) {
                        try {
                    ...
                    int next = ruleCharacterIterator.next(i13);
                    ...
                    if (i7 == 45) {
                        ...
                        unicodeSet = null;
                        int i21 = i20 == 1 ? 1 : 0;
                        boolean z4 = i20 == 1 ? 1 : 0;
                        boolean z5 = i20 == 1 ? 1 : 0;
                        i6 = i21;
                        i5 = i20;
                    } else {
            ...
            if (i8 != 0) {
                if (i17 == i15) {
                    ...
                    add_unchecked(i18, i18);
                    _appendToPat(sb2, i18, false);
                    c = '-';
                    c3 = 0;
                } else {
                    c = '-';
                ...
                if (i8 != i15) {
                    ...
                    obj3 = obj;
                    c2 = '-';
                    unicodeSet2.applyPattern(ruleCharacterIterator, symbolTable, sb2, i, i22);
                }
                if (i6 == 0) {
                    set(unicodeSet3);
                    i16 = 2;
                ...
                if (i5 == 0) {
                    if (i7 == 36) {
                        ...
                        boolean z6 = next3 == 93 && !ruleCharacterIterator.isEscaped();
                        if (symbolTable == null && !z6) {
                        ...
                        if (i7 == 45) {
                            ...
                            if (c3 == 0) {
                                if (i17 == 0 && str == null) {
                                    add_unchecked(i7, i7);
                                    int next4 = ruleCharacterIterator.next(i13);
                                    boolean isEscaped3 = ruleCharacterIterator.isEscaped();
                                    if (next4 != 93 || isEscaped3) {
                                        i7 = next4;
                                    } else {
                                        sb2.append("-]");
                                        sb3 = sb;
                            ...
                            if (i17 == 0) {
                                ...
                                add_unchecked(i18, i7);
                                _appendToPat(sb2, i18, false);
                                sb2.append(c3);
                                _appendToPat(sb2, i7, false);
                                str2 = str;
                                i17 = 0;
                                c3 = 0;
                                i7 = i18;
                            ...
                            while (true) {
                                ...
                                int next5 = ruleCharacterIterator.next(i13);
                                boolean isEscaped4 = ruleCharacterIterator.isEscaped();
                                if (next5 == 125 && !isEscaped4) {
                                    z2 = true;
                                    break;
                                }
            ...
            if (propertyValueEnum == -1) {
                ...
                if (propertyValueEnum == -1) {
                    ...
                    if (i3 >= 0 && i3 < 65) {
                        ...
                        set(0, Bidi.DIRECTION_DEFAULT_RIGHT_TO_LEFT);
                        return this;
    ...
    private static boolean resemblesPropertyPattern(RuleCharacterIterator ruleCharacterIterator, int i) {
        int i2 = i & -3;
        Object pos = ruleCharacterIterator.getPos((Object) null);
        ...
        if ((i & 6) != 0) {
            ...
            for (int i3 = 0; i3 < rangeCount; i3++) {
                ...
                if (i2 != 0) {
                    ...
                    while (rangeStart <= rangeEnd) {
                        addCaseMapping(unicodeSet, uCaseProps.toFullLower(rangeStart, (UCaseProps.ContextIterator) null, sb, 1), sb);
                        addCaseMapping(unicodeSet, uCaseProps.toFullTitle(rangeStart, (UCaseProps.ContextIterator) null, sb, 1), sb);
                        addCaseMapping(unicodeSet, uCaseProps.toFullUpper(rangeStart, (UCaseProps.ContextIterator) null, sb, 1), sb);
    ...
    public UnicodeSet freeze() {
        if (!isFrozen()) {
            compact();
            if (hasStrings()) {
                this.stringSpan = new UnicodeSetStringSpan(this, new ArrayList(this.strings), (int) Bidi.DIRECTION_DEFAULT_RIGHT_TO_LEFT);
            }
    ...
    public int span(CharSequence charSequence, int i, SpanCondition spanCondition) {
        ...
        if (this.bmpSet != null) {
            return this.bmpSet.span(charSequence, i, spanCondition, (OutputInt) null);
        }
        if (this.stringSpan != null) {

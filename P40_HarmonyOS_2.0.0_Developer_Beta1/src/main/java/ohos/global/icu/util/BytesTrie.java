...
public final class BytesTrie implements Cloneable, Iterable<Entry> {
    ...
    public Result current() {
        ...
        return (this.remainingMatchLength_ >= 0 || (i = this.bytes_[i2] & 255) < 32) ? Result.NO_VALUE : valueResults_[i & 1];
    }
        ...
        while (i != i2) {
            ...
            if (i5 < 0) {
                ...
                while (true) {
                    ...
                    int i8 = bArr2[i4] & 255;
                    if (i8 < 16) {
                        Result branchNext = branchNext(i7, i8, b & 255);
    ...
    public int getNextBytes(Appendable appendable) {
        ...
        if (i4 >= 32) {
            ...
            i3 = skipValue + 1;
            i4 = this.bytes_[skipValue] & 255;
        }
        if (i4 < 16) {
            if (i4 == 0) {
                i = i3 + 1;
                i4 = this.bytes_[i3] & 255;
            } else {
                i = i3;
            }
            int i5 = i4 + 1;
        ...
        append(appendable, this.bytes_[i3] & 255);
        return 1;
    }
    ...
    public static int readValue(byte[] bArr, int i, int i2) {
        ...
        if (i2 < kMinThreeByteValueLead) {
            ...
            i3 = ((i2 - kMinThreeByteValueLead) << 16) | ((bArr[i] & 255) << 8);
            b = bArr[i + 1];
        } else if (i2 == 126) {
            i3 = ((bArr[i] & 255) << 16) | ((bArr[i + 1] & 255) << 8);
            b = bArr[i + 2];
        } else {
            i3 = (bArr[i] << CameraMetadataEx.HUAWEI_EXPOSURE_28) | ((bArr[i + 1] & 255) << 16) | ((bArr[i + 2] & 255) << 8);
            b = bArr[i + 3];
        }
        return i3 | (b & 255);
    }
    ...
    public static int jumpByDelta(byte[] bArr, int i) {
        ...
        if (i3 >= kMinTwoByteDeltaLead) {
            if (i3 < 240) {
                ...
                i3 = (bArr[i2] << CameraMetadataEx.HUAWEI_EXPOSURE_28) | ((bArr[i2 + 1] & 255) << 16) | ((bArr[i2 + 2] & 255) << 8) | (bArr[i2 + 3] & 255);
                i2 += 4;
            }
        }
        return i2 + i3;
            ...
            if (i3 == (bArr2[i] & 255)) {
                ...
                if ((i8 & 1) != 0) {
                    ...
                    if (i10 < kMinTwoByteValueLead) {
                        ...
                        i4 = ((i10 - kMinTwoByteValueLead) << 8) | (bArr2[i9] & 255);
                        i9++;
                    } else if (i10 < 126) {
                        i4 = ((i10 - kMinThreeByteValueLead) << 16) | ((bArr2[i9] & 255) << 8) | (bArr2[i9 + 1] & 255);
                        i9 += 2;
                    } else if (i10 == 126) {
                        i4 = ((bArr2[i9] & 255) << 16) | ((bArr2[i9 + 1] & 255) << 8) | (bArr2[i9 + 2] & 255);
                        i9 += 3;
                    } else {
                        i4 = (bArr2[i9] << CameraMetadataEx.HUAWEI_EXPOSURE_28) | ((bArr2[i9 + 1] & 255) << 16) | ((bArr2[i9 + 2] & 255) << 8) | (bArr2[i9 + 3] & 255);
                        i9 += 4;
                    }
                    i7 = i9 + i4;

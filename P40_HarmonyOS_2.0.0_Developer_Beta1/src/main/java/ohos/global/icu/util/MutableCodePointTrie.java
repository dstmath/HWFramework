...
public final class MutableCodePointTrie extends CodePointMap implements Cloneable {
        ...
        while (i21 < i22) {
            ...
            if (b == 0) {
                ...
                while (true) {
                    ...
                    int i44 = i41 + 1;
                    int i45 = iArr[i41];
                    int i46 = ((i42 & DetectBaseType.BASE_TYPE_TEXT_DETECT) >> 2) | ((i45 & DetectBaseType.BASE_TYPE_TEXT_DETECT) >> 4);
                    int i47 = i43 + 1;
                    cArr[i43] = (char) i45;
                    int i48 = i44 + 1;
                    int i49 = iArr[i44];
                    int i50 = i46 | ((i49 & DetectBaseType.BASE_TYPE_TEXT_DETECT) >> 6);
                    int i51 = i47 + 1;
                    cArr[i47] = (char) i49;
                    int i52 = i48 + 1;
                    int i53 = iArr[i48];
                    int i54 = i50 | ((i53 & DetectBaseType.BASE_TYPE_TEXT_DETECT) >> 8);
                    int i55 = i51 + 1;
                    cArr[i51] = (char) i53;
                    int i56 = i52 + 1;
                    int i57 = iArr[i52];
                    int i58 = i54 | ((i57 & DetectBaseType.BASE_TYPE_TEXT_DETECT) >> 10);
                    int i59 = i55 + 1;
                    cArr[i55] = (char) i57;
                    int i60 = i56 + 1;
                    int i61 = iArr[i56];
                    int i62 = i58 | ((i61 & DetectBaseType.BASE_TYPE_TEXT_DETECT) >> 12);
                    int i63 = i59 + 1;
                    cArr[i59] = (char) i61;
                    int i64 = i60 + 1;
                    int i65 = iArr[i60];
                    int i66 = i62 | ((i65 & DetectBaseType.BASE_TYPE_TEXT_DETECT) >> 14);
                    int i67 = i63 + 1;
                    cArr[i63] = (char) i65;
                    int i68 = i64 + 1;
                    int i69 = iArr[i64];
                    int i70 = i66 | ((i69 & DetectBaseType.BASE_TYPE_TEXT_DETECT) >> 16);
                    int i71 = i67 + 1;
                    cArr[i67] = (char) i69;
                    cArr[i71 - 9] = (char) i70;
                    if (i68 >= i37) {
    ...
    private CodePointTrie build(CodePointTrie.Type type, CodePointTrie.ValueWidth valueWidth) {
        ...
        if (i != 1) {
            if (i == 2) {
                maskValues(DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH);
            } else if (i == 3) {
                maskValues(255);
            } else {

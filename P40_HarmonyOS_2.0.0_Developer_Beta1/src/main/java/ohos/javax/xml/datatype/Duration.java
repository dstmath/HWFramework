...
public abstract class Duration {
    ...
    public String toString() {
        ...
        if (bigInteger2 != null) {
            stringBuffer.append(bigInteger2 + DateFormat.NUM_MONTH);
        }
        ...
        if (!(bigInteger4 == null && bigInteger5 == null && bigDecimal == null)) {
            ...
            if (bigInteger4 != null) {
                stringBuffer.append(bigInteger4 + DateFormat.HOUR24);
            }
            if (bigInteger5 != null) {
                stringBuffer.append(bigInteger5 + DateFormat.NUM_MONTH);
            }
            if (bigDecimal != null) {

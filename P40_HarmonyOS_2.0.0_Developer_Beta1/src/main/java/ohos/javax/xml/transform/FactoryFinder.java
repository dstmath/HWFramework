...
class FactoryFinder {
    ...
    static <T> T newInstance(Class<T> cls, String str, ClassLoader classLoader, boolean z) throws TransformerFactoryConfigurationError {
        boolean z2 = false;
    ...
    private static <T> T findServiceProvider(final Class<T> cls) throws TransformerFactoryConfigurationError {
        try {
            return (T) AccessController.doPrivileged(new PrivilegedAction<T>() {
                /* class ohos.javax.xml.transform.FactoryFinder.AnonymousClass1 */

...
public class AudioManager {
    ...
    public void setAudioDeviceChangeObserver(AudioDeviceChangeObserver audioDeviceChangeObserver) {
        if (audioDeviceChangeObserver != null) {
            this.audioManagerImpl.setAudioDeviceChangeObserver(audioDeviceChangeObserver);
            return;
        }
        throw new IllegalArgumentException("Illegal null AudioDeviceChangeObserver argument");
    }
    ...
    public CallState getCallState() throws AudioRemoteException {
        TRACER.startTrace("AudioManager_getCallState_kits");
        try {
            CallState enumByValue = CallState.getEnumByValue(this.audioManagerImpl.getCallState());
            TRACER.finishTrace("AudioManager_getCallState_kits");
            return enumByValue;
        } catch (AudioManagerImplException e) {
            LOGGER.error("public set getCallState error %{public}s", e.toString());
            throw new AudioRemoteException(e.toString());
        } catch (Throwable th) {
            TRACER.finishTrace("AudioManager_getCallState_kits");
            throw th;
    ...
    public void setCallState(CallState callState) {
        if (callState == null) {
            LOGGER.error("setCallState error: %{public}s", INVALID_PARAM);
            return;
        }
        TRACER.startTrace("AudioManager_setCallState_kits");
        this.audioManagerImpl.setCallState(callState.getValue());
        TRACER.finishTrace("AudioManager_setCallState_kits");
    }
    ...
    public enum CallState {
        ...
        public static CallState getEnumByValue(int i) throws AudioManagerImplException {

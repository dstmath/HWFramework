...
public final class CameraCharacteristicsEx {
    ...
    public static final CameraCharacteristics.Key<Boolean> HUAWEI_AUTO_ZOOM_SUPPORTED = new CameraCharacteristics.Key<>("com.hisilicon.device.capabilities.autoZoom", Boolean.class);
    ...
    public static final CameraCharacteristics.Key<Boolean> HUAWEI_FACE_AE_SUPPORTED = new CameraCharacteristics.Key<>("com.hisilicon.device.capabilities.faceAe", Boolean.class);
    ...
    public static final CameraCharacteristics.Key<byte[]> HUAWEI_VENDOR_CUSTOM_SUPPORTED = new CameraCharacteristics.Key<>("com.hisilicon.device.capabilities.capabilityCustom", byte[].class);

...
public final class CaptureRequestEx {
    ...
    public static final CaptureRequest.Key<Boolean> HUAWEI_AUTO_ZOOM = new CaptureRequest.Key<>("com.hisilicon.capture.metadata.autoZoom", Boolean.class);
    ...
    public static final CaptureRequest.Key<Boolean> HUAWEI_FACE_AE = new CaptureRequest.Key<>("com.hisilicon.capture.metadata.faceAe", Boolean.class);
    ...
    public static final CaptureRequest.Key<byte[]> HUAWEI_VENDOR_CUSTOM = new CaptureRequest.Key<>("com.hisilicon.capture.metadata.requestCustom", byte[].class);

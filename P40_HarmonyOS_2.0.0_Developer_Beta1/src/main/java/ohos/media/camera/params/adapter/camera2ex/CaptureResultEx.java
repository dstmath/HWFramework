...
public final class CaptureResultEx {
    ...
    public static final CaptureResult.Key<Byte> HUAWEI_AUTO_ZOOM_STATE = new CaptureResult.Key<>("com.hisilicon.capture.metadata.autoZoomState", Byte.class);
    ...
    public static final CaptureResult.Key<Byte> HUAWEI_FACE_AE_STATE = new CaptureResult.Key<>("com.hisilicon.capture.metadata.faceAEState", Byte.class);
    ...
    public static final CaptureResult.Key<byte[]> HUAWEI_VENDOR_CUSTOM_RESULT = new CaptureResult.Key<>("com.hisilicon.capture.metadata.resultCustom", byte[].class);

...
public class Codec {
    ...
    private native Surface nativeObtainInputSurface();
    ...
    private native int nativeStopInputSurface();
    ...
    public Surface obtainInputSurface() {
        return nativeObtainInputSurface();
    }
    ...
    public boolean stopInputSurface() {
        int nativeStopInputSurface = nativeStopInputSurface();
        if (nativeStopInputSurface == 0) {
            return true;
        }
        LOGGER.error("StopInputSurface failed, error code is %{public}d", Integer.valueOf(nativeStopInputSurface));
        return false;
    }

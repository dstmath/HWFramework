    ...
    public static final class VideoAbilities {
        ...
        private void setHevcLevelLimits(ProfileLevel[] profileLevelArr) {
            ...
            AnonymousClass5 r3 = new HashMap<Integer, Double>() {
...

                {
                    ...
                    put(Integer.valueOf((int) ProfileLevel.HEVC_HIGH_TIER_LEVEL_6_2), valueOf5);
                }
            };
            AnonymousClass6 r4 = new HashMap<Integer, Integer>() {
...

                {
                    ...
                    put(Integer.valueOf((int) ProfileLevel.HEVC_HIGH_TIER_LEVEL_6_2), 35651584);
                }
            };
            AnonymousClass7 r5 = new HashMap<Integer, Integer>() {
...

                {
                    ...
                    put(8388608, 480000);
                    put(16777216, 240000);
                    put(Integer.valueOf((int) ProfileLevel.HEVC_HIGH_TIER_LEVEL_6_2), 800000);
                }
            };
            int length = profileLevelArr2.length;
            int i = 0;
        ...
        private void setAvcLevelLimits(ProfileLevel[] profileLevelArr) {
            ...
            AnonymousClass12 r1 = new HashMap<Integer, Integer>() {
                /* class ohos.media.codec.CodecDescriptionInternal.VideoAbilities.AnonymousClass12 */
            ...
            AnonymousClass13 r2 = new HashMap<Integer, Integer>() {
                /* class ohos.media.codec.CodecDescriptionInternal.VideoAbilities.AnonymousClass13 */
            ...
            AnonymousClass14 r3 = new HashMap<Integer, Integer>() {
                /* class ohos.media.codec.CodecDescriptionInternal.VideoAbilities.AnonymousClass14 */
            ...
            AnonymousClass15 r4 = new HashMap<Integer, Integer>() {
                /* class ohos.media.codec.CodecDescriptionInternal.VideoAbilities.AnonymousClass15 */

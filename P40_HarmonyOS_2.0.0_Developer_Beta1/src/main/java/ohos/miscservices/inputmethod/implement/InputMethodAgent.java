...
public class InputMethodAgent implements IInputMethodAgent {
    ...
    public void notifyCursorCoordinateChanged(float f, float f2, float f3, float[] fArr) throws RemoteException {
        HiLog.debug(TAG, "notifyCursorCoordinateChanged begin.", new Object[0]);
        this.inputMethodAgentImpl.notifyCursorCoordinateChanged(f, f2, f3, fArr);
    }

    @Override // ohos.miscservices.inputmethod.internal.IInputMethodAgent
    public boolean dispatchMultimodalEvent(MultimodalEvent multimodalEvent) throws RemoteException {
        HiLog.debug(TAG, "dispatchMultimodalEvent begin.", new Object[0]);
        return false;
    }
}

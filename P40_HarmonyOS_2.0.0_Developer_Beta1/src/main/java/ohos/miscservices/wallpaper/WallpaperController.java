...
public class WallpaperController {
    ...
    private WallpaperController(Context context) {
        this.mWallpaperControllerSysAbility = WallpaperControllerProxy.getWallpaperControllerSysAbility(context.getApplicationContext());
    }
    ...
    public Element getDefaultElement(int i, int i2, boolean z, float f, float f2, int i3) {
        try {
            return this.mWallpaperControllerSysAbility.getDefaultElement(i, i2, z, f, f2, i3);
        } catch (RemoteException unused) {
            HiLog.error(TAG, "getDefaultElement failed!", new Object[0]);
            return null;
        }
    }

    public Element getElement() {
        return this.mWallpaperControllerSysAbility.getElement();
    }
}

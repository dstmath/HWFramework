...
public class ReturnCode {
    static final int DISABLED = -15;
    static final int ENABLED = -14;
    static final int ERROR_CODE_ALREADY_REGISTER = -6;
    public static final int ERROR_CODE_BUSY = -5;
    public static final int ERROR_CODE_CAN_NOT_DISABLE = -16;
    static final int ERROR_CODE_CONNECTED = -8;
    static final int ERROR_CODE_DISCONNECTED = -9;
    public static final int ERROR_CODE_FAILED = -1;
    public static final int ERROR_CODE_INVALID_ARGUMENT = -2;
    static final int ERROR_CODE_NOT_IMPLEMENT = -7;
    static final int ERROR_CODE_NOT_REGISTER = -4;
    public static final int ERROR_CODE_NO_PERMISSION = -10;
    static final int ERROR_CODE_NO_SERVICE = -11;
    public static final int ERROR_CODE_REMOTE_EXCEPTION = -3;
    static final int ERROR_CODE_SCREEN_OFF = -12;

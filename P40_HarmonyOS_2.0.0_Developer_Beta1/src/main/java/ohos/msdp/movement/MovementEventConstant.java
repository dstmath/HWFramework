...
public class MovementEventConstant {
    ...
    public static final String MSDP_ENVIRONMENT_HOME = "android.activity_recognition.env_home";
    public static final String MSDP_ENVIRONMENT_OFFICE = "android.activity_recognition.env_office";
    public static final String MSDP_ENVIRONMENT_WAY_HOME = "android.activity_recognition.env_way_home";
    public static final String MSDP_ENVIRONMENT_WAY_OFFICE = "android.activity_recognition.env_way_office";

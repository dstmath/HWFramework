...
public class KeyBoardEventImpl extends KeyBoardEvent implements HostEventAdapter {
    ...
    static {
        ...
        A2Z_KEYMAP.put(16, Integer.valueOf((int) ohos.multimodalinput.event.KeyEvent.KEY_9));
        A2Z_KEYMAP.put(17, Integer.valueOf((int) ohos.multimodalinput.event.KeyEvent.KEY_STAR));
        ...
        A2Z_KEYMAP.put(115, Integer.valueOf((int) ohos.multimodalinput.event.KeyEvent.KEY_CAPS_LOCK));
        A2Z_KEYMAP.put(Integer.valueOf((int) SystemAbilityDefinition.ABILITY_TOOLS_SERVICE_ID), Integer.valueOf((int) ohos.multimodalinput.event.KeyEvent.KEY_SCROLL_LOCK));
        ...
        A2Z_KEYMAP.put(Integer.valueOf((int) Bidi.DIRECTION_DEFAULT_LEFT_TO_RIGHT), Integer.valueOf((int) ohos.multimodalinput.event.KeyEvent.KEY_MEDIA_PLAY));
        A2Z_KEYMAP.put(Integer.valueOf((int) Bidi.DIRECTION_DEFAULT_RIGHT_TO_LEFT), Integer.valueOf((int) ohos.multimodalinput.event.KeyEvent.KEY_MEDIA_PAUSE));
        A2Z_KEYMAP.put(128, Integer.valueOf((int) ohos.multimodalinput.event.KeyEvent.KEY_MEDIA_CLOSE));
        A2Z_KEYMAP.put(Integer.valueOf((int) DateFormat.RELATIVE_LONG), Integer.valueOf((int) ohos.multimodalinput.event.KeyEvent.KEY_MEDIA_EJECT));
        A2Z_KEYMAP.put(130, Integer.valueOf((int) ohos.multimodalinput.event.KeyEvent.KEY_MEDIA_RECORD));
        A2Z_KEYMAP.put(Integer.valueOf((int) DateFormat.RELATIVE_SHORT), Integer.valueOf((int) ohos.multimodalinput.event.KeyEvent.KEY_F1));
        ...
        A2Z_KEYMAP.put(144, Integer.valueOf((int) ohos.multimodalinput.event.KeyEvent.KEY_NUMPAD_0));
    ...
    static boolean isOhosKeyBoardKeyCode(int i) {
    ...
    KeyBoardEventImpl(int i, int i2) {

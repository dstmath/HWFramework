...
public class KeyEventImpl extends KeyEvent implements HostEventAdapter {
    ...
    static {
        ...
        A2Z_KEYMAP.put(Integer.valueOf((int) SCSU.UCHANGE7), 20);
    ...
    KeyEventImpl(int i, int i2) {
        this.androidKeyEvent = new android.view.KeyEvent(i, Z2A_KEYMAP.containsKey(Integer.valueOf(i2)) ? Z2A_KEYMAP.get(Integer.valueOf(i2)).intValue() : 0);
    }

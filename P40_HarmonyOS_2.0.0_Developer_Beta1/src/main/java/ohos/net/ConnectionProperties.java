...
public class ConnectionProperties implements Sequenceable {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder(ConnectionProperties.class.getSimpleName());
        sb.append(": mTcpBufferSizes = ");
        sb.append(this.mTcpBufferSizes);
        sb.append(", mInterfaceName = ");
        sb.append(this.mInterfaceName);
        sb.append(", mPrivateDnsServerName = ");
        sb.append(this.mPrivateDnsServerName);
        sb.append(", mDomains = ");
        sb.append(this.mDomains);
        sb.append(", mIsUsePrivateDns = ");
        sb.append(this.mIsUsePrivateDns);
        sb.append(", mRoutes = ");
        String str = "null";
        sb.append(this.mRoutes == null ? str : "***");
        sb.append(", mDnses = ");

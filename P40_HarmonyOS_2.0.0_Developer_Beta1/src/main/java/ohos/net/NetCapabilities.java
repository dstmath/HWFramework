...
public final class NetCapabilities implements Sequenceable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.networkCap == netCapabilities.networkCap && this.unwantedNetworkCap == netCapabilities.unwantedNetworkCap && this.bearerTypes == netCapabilities.bearerTypes && this.signalStrength == netCapabilities.signalStrength && Objects.equals(this.ssid, netCapabilities.ssid) && Objects.equals(this.dualCellDataEnabled, netCapabilities.dualCellDataEnabled)) {
            return true;
        }
        return false;
    }
    ...
    public NetCapabilities setBearerPrivateIdentifier(BearerPrivateIdentifier bearerPrivateIdentifier2) {
        if (bearerPrivateIdentifier2 != null && Long.bitCount(this.bearerTypes) != 1) {
            return this;
        }
    ...
    public boolean marshalling(Parcel parcel) {
        ...
        parcel.writeLong(this.bearerTypes);
    ...
    public boolean unmarshalling(Parcel parcel) {
        ...
        this.bearerTypes = parcel.readLong();
    ...
    private void set(NetCapabilities netCapabilities) {
        ...
        this.bearerTypes = netCapabilities.bearerTypes;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder(NetCapabilities.class.getSimpleName());
        sb.append(":networkCap = ");
        sb.append(this.networkCap);
        sb.append(":unwantedNetworkCap = ");
        sb.append(this.unwantedNetworkCap);
        sb.append(", bearerTypes = ");
        sb.append(this.bearerTypes);
        sb.append(", linkUpBandwidthKbps = ");
        sb.append(this.linkUpBandwidthKbps);
        sb.append("Kbps");
        sb.append(", linkDownBandwidthKbps = ");
        sb.append(this.linkDownBandwidthKbps);
        sb.append("Kbps");
        sb.append(", transportInfo = ");
        sb.append(this.transportInfo);
        sb.append(", signalStrength = ");
        sb.append(this.signalStrength);
        if (this.uids != null) {
            sb.append(", uids start = ");
            sb.append(this.uids.start);
            sb.append(", uids stop = ");
            sb.append(this.uids.stop);
        }
        sb.append(", ssid = ");
        sb.append(this.ssid == null ? "null" : "***");
        return sb.toString();
    }
}

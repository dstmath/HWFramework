...
public class CategoryBodyAgent extends SensorAgent<CategoryBody, CategoryBodyData, ICategoryBodyDataCallback> {
    ...
    public boolean setSensorDataCallback(ICategoryBodyDataCallback iCategoryBodyDataCallback, CategoryBody categoryBody, long j, long j2) {
        ...
        if (!sensorDataCallback) {
            HiLog.error(LABEL, "setSensorDataCallback set the body sensorData callback failed", new Object[0]);
            return false;
        }
    ...
    public boolean setSensorDataCallback(ICategoryBodyDataCallback iCategoryBodyDataCallback, CategoryBody categoryBody, int i) {
        return setSensorDataCallback(iCategoryBodyDataCallback, categoryBody, i, 0L);
    }

    public boolean setSensorDataCallback(ICategoryBodyDataCallback iCategoryBodyDataCallback, CategoryBody categoryBody, int i, long j) {
        return setSensorDataCallback(iCategoryBodyDataCallback, categoryBody, getInterval(i), j);
    }
    ...
    public boolean releaseSensorDataCallback(ICategoryBodyDataCallback iCategoryBodyDataCallback, CategoryBody categoryBody) {
        if (iCategoryBodyDataCallback == null) {
            ...
            if (!releaseSensorDataCallback) {
                HiLog.error(LABEL, "releaseSensorDataCallback release the body sensorData callback", new Object[0]);
                return false;
            }
            List<Integer> list = CALLBACK_BODY_SENSOR_ID.get(iCategoryBodyDataCallback);
    ...
    public boolean releaseSensorDataCallback(ICategoryBodyDataCallback iCategoryBodyDataCallback) {
        if (iCategoryBodyDataCallback == null) {
            ...
            HiLog.error(LABEL, "releaseSensorDataCallback dispatch release the body sensorData callback is failed", new Object[0]);
            return false;
        }
    }

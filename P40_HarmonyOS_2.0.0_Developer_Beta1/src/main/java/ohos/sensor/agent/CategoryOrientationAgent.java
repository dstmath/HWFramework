...
public class CategoryOrientationAgent extends SensorAgent<CategoryOrientation, CategoryOrientationData, ICategoryOrientationDataCallback> {
    ...
    public boolean setSensorDataCallback(ICategoryOrientationDataCallback iCategoryOrientationDataCallback, CategoryOrientation categoryOrientation, long j, long j2) {
        ...
        if (!sensorDataCallback) {
            HiLog.error(LABEL, "setSensorDataCallback set the orientation sensorData callback failed", new Object[0]);
            return false;
        }
    ...
    public boolean setSensorDataCallback(ICategoryOrientationDataCallback iCategoryOrientationDataCallback, CategoryOrientation categoryOrientation, int i) {
        return setSensorDataCallback(iCategoryOrientationDataCallback, categoryOrientation, i, 0L);
    }

    public boolean setSensorDataCallback(ICategoryOrientationDataCallback iCategoryOrientationDataCallback, CategoryOrientation categoryOrientation, int i, long j) {
        return setSensorDataCallback(iCategoryOrientationDataCallback, categoryOrientation, getInterval(i), j);
    }
    ...
    public boolean releaseSensorDataCallback(ICategoryOrientationDataCallback iCategoryOrientationDataCallback, CategoryOrientation categoryOrientation) {
        if (iCategoryOrientationDataCallback == null) {
            ...
            if (!releaseSensorDataCallback) {
                HiLog.error(LABEL, "releaseSensorDataCallback release the orientation sensorData callback failed", new Object[0]);
                return false;
            }
            List<Integer> list = CALLBACK_ORIENTATION_SENSOR_ID.get(iCategoryOrientationDataCallback);
    ...
    public boolean releaseSensorDataCallback(ICategoryOrientationDataCallback iCategoryOrientationDataCallback) {
        if (iCategoryOrientationDataCallback == null) {
            ...
            HiLog.error(LABEL, "releaseSensorDataCallback dispatch release the orientation sensorData callback failed", new Object[0]);
            return false;
        }
    }

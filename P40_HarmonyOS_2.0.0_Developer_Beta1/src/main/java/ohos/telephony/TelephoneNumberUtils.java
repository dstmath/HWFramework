...
public class TelephoneNumberUtils {
    ...
    public static boolean isDialableDtmfKey(char c) {
        return c == '*' || c == '#' || (c >= '0' && c <= '9');
    }
    ...
    private static int getLastDialableCharIdx(int i, String str) {
    ...
    private static boolean comparePhoneNumbers(String str, String str2, int i) {
        ...
        if (!(str == null || str2 == null || str.length() == 0 || str2.length() == 0)) {
            ...
            while (finalNetworkCharIdx >= 0 && finalNetworkCharIdx2 >= 0 && finalNetworkCharIdx < length && finalNetworkCharIdx2 < length2) {
                finalNetworkCharIdx = getLastDialableCharIdx(finalNetworkCharIdx, str);
                finalNetworkCharIdx2 = getLastDialableCharIdx(finalNetworkCharIdx2, str2);
                if (finalNetworkCharIdx == -1 || finalNetworkCharIdx2 == -1 || ((charAt = str.charAt(finalNetworkCharIdx)) != (charAt2 = str2.charAt(finalNetworkCharIdx2)) && charAt != 'N' && charAt2 != 'N')) {
                    break;
                }
                i2++;
                finalNetworkCharIdx--;
                finalNetworkCharIdx2--;
            }
            if (i2 < i) {
    ...
    public static boolean comparePhoneNumbers(String str, String str2, String str3, String str4) {
        return TelephonyAdapt.comparePhoneNumbers(str, str2, str3, str4);
    }
}

...
public class TelephonyProxy implements ITelephony {
    ...
    public int getPrimarySlotId() {
        ...
        try {
            ...
            HiLog.error(TAG, "Failed to getPrimarySlotId", new Object[0]);
        } catch (Throwable th) {
            obtain2.reclaim();
            obtain.reclaim();
            throw th;
    ...
    public void addObserver(int i, IRadioStateObserver iRadioStateObserver, String str, int i2) {
        if (TelephonyUtils.isValidSlotId(i)) {
            ...
            try {
                ...
                obtain.writeString(str);
                obtain.writeInt(i2);
                getTelephonySrvAbility().sendRequest(TelephonyUtils.MSG_ADD_OBSERVER, obtain, obtain2, messageOption);
    ...
    public void removeObserver(int i, IRadioStateObserver iRadioStateObserver, String str) {
        if (TelephonyUtils.isValidSlotId(i)) {
            ...
            try {
                ...
                obtain.writeRemoteObject(iRadioStateObserver.asObject());
                obtain.writeString(str);
                getTelephonySrvAbility().sendRequest(TelephonyUtils.MSG_REMOVE_OBSERVER, obtain, obtain2, messageOption);
            } catch (RemoteException unused) {
    ...
    public void addObserver(int i, IRemoteObject iRemoteObject, String str, int i2) {
        if (TelephonyUtils.isValidSlotId(i)) {
            ...
            try {
                ...
                obtain.writeString(str);
                obtain.writeInt(i2);
                getTelephonySrvAbility().sendRequest(TelephonyUtils.MSG_ADD_DATA_OBSERVER_ID, obtain, obtain2, messageOption);
            } catch (RemoteException unused) {
                HiLog.error(TAG, "Failed to addObserver", new Object[0]);
            } catch (Throwable th) {
                obtain2.reclaim();
    ...
    public void removeObserver(int i, IRemoteObject iRemoteObject, String str) {
        if (TelephonyUtils.isValidSlotId(i)) {
            ...
            try {
                ...
                obtain.writeRemoteObject(iRemoteObject);
                obtain.writeString(str);
                getTelephonySrvAbility().sendRequest(TelephonyUtils.MSG_DELETE_DATA_OBSERVER_ID, obtain, obtain2, messageOption);
            } catch (RemoteException unused) {
                HiLog.error(TAG, "Failed to removeObserver", new Object[0]);
            } catch (Throwable th) {
                obtain2.reclaim();
    ...
    public int getNetworkSelectionMode(int i) {
        ...
        try {
            obtain.writeInterfaceToken(TELEPHONY_SA_DESCRIPTOR);
            obtain.writeInt(i);
            getTelephonySrvAbility().sendRequest(19, obtain, obtain2, messageOption);
            i2 = obtain2.readInt();
        } catch (RemoteException unused) {
            HiLog.error(TAG, "Failed to getNetworkSelectionMode", new Object[0]);
        } catch (Throwable th) {
            obtain2.reclaim();
            obtain.reclaim();
            throw th;
    ...
    public NetworkSearchResult getNetworkSearchInformation(int i) {
        ...
        try {
            obtain.writeInterfaceToken(TELEPHONY_SA_DESCRIPTOR);
            obtain.writeInt(i);
            getTelephonySrvAbility().sendRequest(20, obtain, obtain2, messageOption);
            ...
            if (readInt > 0) {
                if (readInt <= 100) {
                    ...
                    for (int i2 = 0; i2 < readInt; i2++) {
                        arrayList.add(new NetworkInformation(obtain2.readString(), obtain2.readString(), obtain2.readInt(), obtain2.readString()));
                    }
                    NetworkSearchResult networkSearchResult = new NetworkSearchResult(z, arrayList);
                    obtain2.reclaim();
                    obtain.reclaim();
            ...
            return new NetworkSearchResult(false, new ArrayList(0));
        } catch (RemoteException unused) {
            HiLog.error(TAG, "Failed to getNetworkSearchInformation", new Object[0]);
            return null;
        } finally {
            obtain2.reclaim();
            obtain.reclaim();
    ...
    private boolean setNetworkSelectionModeAuto(int i) {
        MessageParcel obtain = MessageParcel.obtain();
        MessageParcel obtain2 = MessageParcel.obtain();
        MessageOption messageOption = new MessageOption();
        boolean z = false;
        try {
            obtain.writeInterfaceToken(TELEPHONY_SA_DESCRIPTOR);
            obtain.writeInt(i);
            getTelephonySrvAbility().sendRequest(21, obtain, obtain2, messageOption);
            z = obtain2.readBoolean();
        } catch (RemoteException unused) {
            HiLog.error(TAG, "Failed to setNetworkSelectionModeAuto", new Object[0]);
        } catch (Throwable th) {
            obtain2.reclaim();
            obtain.reclaim();
            throw th;
    ...
    private boolean setNetworkSelectionModeManual(int i, NetworkInformation networkInformation, boolean z) {
        MessageParcel obtain = MessageParcel.obtain();
        MessageParcel obtain2 = MessageParcel.obtain();
        MessageOption messageOption = new MessageOption();
        boolean z2 = false;
        try {
            obtain.writeInterfaceToken(TELEPHONY_SA_DESCRIPTOR);
            obtain.writeInt(i);
            marshallingNetworkInformation(networkInformation, obtain);
            obtain.writeBoolean(z);
            getTelephonySrvAbility().sendRequest(22, obtain, obtain2, messageOption);
            z2 = obtain2.readBoolean();
        } catch (RemoteException unused) {
            HiLog.error(TAG, "Failed to setNetworkSelectionModeManual", new Object[0]);
        } catch (Throwable th) {
            obtain2.reclaim();
            obtain.reclaim();
            throw th;
    ...
    public boolean hasOperatorPrivileges(int i) {
        ...
        try {
            obtain.writeInterfaceToken(TELEPHONY_SA_DESCRIPTOR);
            obtain.writeInt(i);
            getTelephonySrvAbility().sendRequest(TelephonyUtils.MSG_HAS_OPERATOR_PRIVILEGES, obtain, obtain2, messageOption);
            z = obtain2.readBoolean();
        } catch (RemoteException unused) {
            HiLog.error(TAG, "Failed to hasOperatorPrivileges", new Object[0]);
        } catch (Throwable th) {
            obtain2.reclaim();
            obtain.reclaim();
            throw th;
    ...
    public void sendUpdateCellLocationRequest() {
        ...
        try {
            obtain.writeInterfaceToken(TELEPHONY_SA_DESCRIPTOR);
            getTelephonySrvAbility().sendRequest(23, obtain, obtain2, messageOption);
        } catch (RemoteException unused) {
            HiLog.error(TAG, "Failed to sendUpdateCellLocationRequest", new Object[0]);
        } catch (Throwable th) {
            obtain2.reclaim();
            obtain.reclaim();
            throw th;

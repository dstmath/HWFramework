...
public final class TelephonyUtils {
    ...
    public static final int MAX_NETWORK_INFO_LIST_SIZE = 100;
    ...
    public static final int MSG_GET_NETWORK_SEARCH_RESULT = 20;
    public static final int MSG_GET_NETWORK_SELECTION_MODE = 19;
    public static final int MSG_GET_NR_OPTION_MODE = 17;
    public static final int MSG_GET_PRIMARY_SLOT_ID = 14;
    ...
    public static final int MSG_HAS_OPERATOR_PRIVILEGES = 1013;
    ...
    public static final int MSG_REQUEST_CELL_LOC_UPDATE = 23;
    ...
    public static final int MSG_SET_NETWORK_SELECTION_MODE_AUTO = 21;
    public static final int MSG_SET_NETWORK_SELECTION_MODE_MANUAL = 22;
    ...
    private static final int SIM_NUM = SimInfoManager.getInstance(null).getMaxSimCount();
    public static final int SIP_PHONE_TYPE = 3;
    public static final String SRC_DESCRIPTOR = "com.android.internal.telephony.IPhoneStateListener";

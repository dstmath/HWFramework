...
public class ThermalConnectionAdapter extends Binder implements IBinder.DeathRecipient {
    ...
    private ThermalConnection thermalConnection;

    public ThermalConnectionAdapter(ThermalConnection thermalConnection2) {
        this.thermalConnection = thermalConnection2;
    }
    ...
    public void binderDied() {
        ...
        this.thermalConnection.thermalServiceDied();
    ...
    private void reportThermalData(int i) {
        ...
        if (this.thermalConnection == null) {
            HiLog.error(LOG_LABEL, "thermalConnection is null!", new Object[0]);
            return;
        }
        ...
        this.thermalConnection.thermalStatusChanged(thermalSeverityLevel);
    }
}

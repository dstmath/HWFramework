    ...
    private Sequenceable.Producer<?> createSequenceableProducer(String str) {
        ...
        if (classByLoaders == null) {
            ...
            try {
                ...
                throw new ParcelException("fail to create sequenceable creator due to " + e.getClass().getSimpleName() + PluralRules.KEYWORD_RULE_SEPARATOR + e.getMessage() + ", class:" + str);
            }
        } else {

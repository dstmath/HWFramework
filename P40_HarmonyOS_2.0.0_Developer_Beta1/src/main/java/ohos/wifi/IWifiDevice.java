...
interface IWifiDevice extends IRemoteBroker {
    ...
    boolean addUntrustedConfig(WifiDeviceConfig wifiDeviceConfig, String str) throws RemoteException;
    ...
    boolean removeUntrustedConfig(WifiDeviceConfig wifiDeviceConfig, String str) throws RemoteException;

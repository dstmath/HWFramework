...
public final class WifiEnhancer {
    ...
    public static WifiEnhancer getInstance(Context context) throws IllegalArgumentException {
        if (sInstance == null) {
            synchronized (ENHANCER_LOCK) {
                if (sInstance == null) {
                    if (context != null) {
                        sInstance = new WifiEnhancer(context.getApplicationContext());
                    } else {
    ...
    @SystemApi
    public static WifiEnhancer getInstance() {
        if (sInstance == null) {
            synchronized (ENHANCER_LOCK) {
                if (sInstance == null) {
                    sInstance = new WifiEnhancer(null);
                }
            }
        }
        return sInstance;

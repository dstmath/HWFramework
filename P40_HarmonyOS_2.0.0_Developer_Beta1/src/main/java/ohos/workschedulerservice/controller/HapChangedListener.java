...
public final class HapChangedListener extends StateListener {
    ...
    private CommonEventSubscribeInfo getInfo() {
        ...
        matchingSkills.addEvent("common.event.ABILITY_ADDED");
        matchingSkills.addEvent("common.event.ABILITY_REMOVED");
        matchingSkills.addEvent("common.event.ABILITY_UPDATED");

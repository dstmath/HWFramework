...
public class SignerInfoGenerator {
    ...
    public SignerInfo generate(ASN1ObjectIdentifier aSN1ObjectIdentifier) throws CMSException {
        ...
        try {
            ...
            return new SignerInfo(this.signerIdentifier, (this.sAttrGen != null || !EdECObjectIdentifiers.id_Ed448.equals(findEncryptionAlgorithm.getAlgorithm())) ? algorithmIdentifier : new AlgorithmIdentifier(NISTObjectIdentifiers.id_shake256), aSN1Set, findEncryptionAlgorithm, new DEROctetString(signature), aSN1Set2);
        } catch (IOException e) {

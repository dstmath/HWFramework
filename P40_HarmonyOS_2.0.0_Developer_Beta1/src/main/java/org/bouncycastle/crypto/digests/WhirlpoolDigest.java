    ...
    public void processBlock() {
        ...
        while (i2 <= 10) {
            ...
            while (i3 < 8) {
                ...
                long[] jArr4 = C0;
                long[] jArr5 = this._K;
                jArr3[i3] = jArr4[((int) (jArr5[(i3 + 0) & 7] >>> 56)) & GF2Field.MASK] ^ j3;
                jArr3[i3] = jArr3[i3] ^ C1[((int) (jArr5[(i3 - 1) & 7] >>> 48)) & GF2Field.MASK];
                jArr3[i3] = jArr3[i3] ^ C2[((int) (jArr5[(i3 - 2) & 7] >>> 40)) & GF2Field.MASK];
                jArr3[i3] = jArr3[i3] ^ C3[((int) (jArr5[(i3 - 3) & 7] >>> 32)) & GF2Field.MASK];
                jArr3[i3] = jArr3[i3] ^ C4[((int) (jArr5[(i3 - 4) & 7] >>> 24)) & GF2Field.MASK];
                jArr3[i3] = jArr3[i3] ^ C5[((int) (jArr5[(i3 - 5) & 7] >>> 16)) & GF2Field.MASK];
                jArr3[i3] = jArr3[i3] ^ C6[((int) (jArr5[(i3 - 6) & 7] >>> 8)) & GF2Field.MASK];
                jArr3[i3] = jArr3[i3] ^ C7[((int) jArr5[(i3 - 7) & 7]) & GF2Field.MASK];
                i3++;
                i2 = i2;
            }
            long[] jArr6 = this._L;
            ...
            for (int i4 = 0; i4 < 8; i4++) {
                ...
                jArr9[i4] = j4 ^ jArr10[((int) (jArr11[(i4 + 0) & 7] >>> 56)) & GF2Field.MASK];
                jArr9[i4] = jArr9[i4] ^ C1[((int) (jArr11[(i4 - 1) & 7] >>> 48)) & GF2Field.MASK];
                jArr9[i4] = jArr9[i4] ^ C2[((int) (jArr11[(i4 - 2) & 7] >>> 40)) & GF2Field.MASK];
                jArr9[i4] = jArr9[i4] ^ C3[((int) (jArr11[(i4 - 3) & 7] >>> 32)) & GF2Field.MASK];
                jArr9[i4] = jArr9[i4] ^ C4[((int) (jArr11[(i4 - 4) & 7] >>> 24)) & GF2Field.MASK];
                jArr9[i4] = jArr9[i4] ^ C5[((int) (jArr11[(i4 - 5) & 7] >>> 16)) & GF2Field.MASK];
                jArr9[i4] = jArr9[i4] ^ C6[((int) (jArr11[(i4 - 6) & 7] >>> 8)) & GF2Field.MASK];
                jArr9[i4] = jArr9[i4] ^ C7[((int) jArr11[(i4 - 7) & 7]) & GF2Field.MASK];
            }
            long[] jArr12 = this._L;

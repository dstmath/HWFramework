                    ...
                    if (!sSHBuffer.hasRemaining()) {
                        ...
                        if (sSHBuffer2.readU32() == sSHBuffer2.readU32()) {
                            ...
                            if ("ssh-ed25519".equals(readString)) {
                                ...
                                if (byName != null) {
                                    X9ECParameters byOID2 = NISTNamedCurves.getByOID(byName);
                                    if (byOID2 != null) {
                                        sSHBuffer2.readBlock();
                                        asymmetricKeyParameter = new ECPrivateKeyParameters(new BigInteger(1, sSHBuffer2.readBlock()), new ECNamedDomainParameters(byName, byOID2.getCurve(), byOID2.getG(), byOID2.getN(), byOID2.getH(), byOID2.getSeed()));
                                    } else {

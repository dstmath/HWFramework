...
public class BCXDHPrivateKey implements XDHPrivateKey {
    ...
    private void populateFromPrivateKeyInfo(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        this.xdhPrivateKey = EdECObjectIdentifiers.id_X448.equals(privateKeyInfo.getPrivateKeyAlgorithm().getAlgorithm()) ? new X448PrivateKeyParameters(ASN1OctetString.getInstance(privateKey).getOctets(), 0) : new X25519PrivateKeyParameters(ASN1OctetString.getInstance(privateKey).getOctets(), 0);
    }

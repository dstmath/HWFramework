...
public class KeyPairGeneratorSpi extends java.security.KeyPairGeneratorSpi {
    ...
    public KeyPair generateKeyPair() {
        if (this.generator != null) {
            ...
            return ((generateKeyPair.getPrivate() instanceof X448PrivateKeyParameters) || (generateKeyPair.getPrivate() instanceof X25519PrivateKeyParameters)) ? new KeyPair(new BCXDHPublicKey(generateKeyPair.getPublic()), new BCXDHPrivateKey(generateKeyPair.getPrivate())) : new KeyPair(new BCEdDSAPublicKey(generateKeyPair.getPublic()), new BCEdDSAPrivateKey(generateKeyPair.getPrivate()));
        }

...
public class BaseBlockCipher extends BaseWrapCipher implements PBE {
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:198:0x0434 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:220:0x048b */
    ...
    /* JADX WARN: Type inference failed for: r5v9, types: [org.bouncycastle.crypto.params.RC5Parameters, org.bouncycastle.crypto.CipherParameters] */
    /* JADX WARN: Type inference failed for: r5v12, types: [org.bouncycastle.crypto.params.RC2Parameters, org.bouncycastle.crypto.CipherParameters] */
    ...
    /* JADX WARN: Type inference failed for: r5v22, types: [org.bouncycastle.crypto.params.AEADParameters] */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:98:0x01ff, code lost:
        if (r7 != false) goto L_0x00ae;
     */
    /* JADX WARNING: Removed duplicated region for block: B:101:0x0207  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:213:0x045a A[ADDED_TO_REGION] */
    /* JADX WARNING: Removed duplicated region for block: B:225:0x0499  */
    /* JADX WARNING: Removed duplicated region for block: B:239:0x04d2 A[Catch:{ IllegalArgumentException -> 0x04be, Exception -> 0x04bc }] */
    /* JADX WARNING: Removed duplicated region for block: B:250:? A[ADDED_TO_REGION, RETURN, SYNTHETIC] */
    ...
    public void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (!(key instanceof SecretKey)) {
                    ...
                    if (!(algorithmParameterSpec instanceof IvParameterSpec)) {
                        if (algorithmParameterSpec instanceof GOST28147ParameterSpec) {
                            ...
                            if (cls == null || !cls.isInstance(algorithmParameterSpec)) {
                                ...
                                r5 = GcmSpecUtil.extractAeadParameters(r5 instanceof ParametersWithIV ? (KeyParameter) ((ParametersWithIV) r5).getParameters() : (KeyParameter) r5, algorithmParameterSpec);
                            } else {
            ...
            parametersWithIV = new ParametersWithIV(r5, bArr22);
            this.ivParam = parametersWithIV;
            parametersWithIV = new ParametersWithRandom(parametersWithIV, secureRandom);
            if (i != 1) {
            }

                            ...
                            if (build.getTargetConstraints() == null || build.getTargetConstraints().match((Certificate) ((X509Certificate) certificates.get(0)))) {
                                ...
                                while (size2 >= 0) {
                                    ...
                                    try {
                                        ...
                                        RFC3280CertPathUtilities.processCertA(certPath, build, provCrlRevocationChecker, size2, publicKey, z, x500Name, x509Certificate);
                                        RFC3280CertPathUtilities.processCertBC(certPath, size2, pKIXNameConstraintValidator, this.isForCRLCheck);
                                        PKIXPolicyNode processCertE = RFC3280CertPathUtilities.processCertE(certPath, size2, RFC3280CertPathUtilities.processCertD(certPath, size2, hashSet4, pKIXPolicyNode2, arrayListArr2, i8, this.isForCRLCheck));
                                        RFC3280CertPathUtilities.processCertF(certPath, size2, processCertE, i7);
                                        if (i9 != size) {
                                            if (x509Certificate3 == null || x509Certificate3.getVersion() != 1) {
                                                RFC3280CertPathUtilities.prepareNextCertA(certPath, size2);
                                                arrayListArr = arrayListArr2;
                                                PKIXPolicyNode prepareCertB = RFC3280CertPathUtilities.prepareCertB(certPath, size2, arrayListArr, processCertE, i2);
                                                RFC3280CertPathUtilities.prepareNextCertG(certPath, size2, pKIXNameConstraintValidator);
                                                int prepareNextCertH1 = RFC3280CertPathUtilities.prepareNextCertH1(certPath, size2, i7);
                                                int prepareNextCertH2 = RFC3280CertPathUtilities.prepareNextCertH2(certPath, size2, i2);
                                            ...
                                            } else if (i9 != 1 || !x509Certificate3.equals(findTrustAnchor.getTrustedCert())) {
                                ...
                                int i10 = size2 + 1;
                                int wrapupCertB = RFC3280CertPathUtilities.wrapupCertB(certPath, i10, RFC3280CertPathUtilities.wrapupCertA(i7, x509Certificate2));

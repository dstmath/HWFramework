...
public class RFC3280CertPathUtilities {
    ...
    private static void checkCRL(PKIXCertRevocationCheckerParameters pKIXCertRevocationCheckerParameters, DistributionPoint distributionPoint, PKIXExtendedParameters pKIXExtendedParameters, X509Certificate x509Certificate, Date date, X509Certificate x509Certificate2, PublicKey publicKey, CertStatus certStatus, ReasonsMask reasonsMask, List list, JcaJceHelper jcaJceHelper) throws AnnotatedException, RecoverableCertPathValidatorException {
        ...
        if (date.getTime() <= date3.getTime()) {
            Iterator it2 = CertPathValidatorUtilities.getCompleteCRLs(pKIXCertRevocationCheckerParameters, distributionPoint, x509Certificate, date3, pKIXExtendedParameters).iterator();
            int i2 = 1;
            int i3 = 0;
                    ...
                    if (!processCRLD.hasNewReasons(reasonsMask3)) {
                        ...
                        try {
                            ...
                            if (pKIXExtendedParameters.isUseDeltasEnabled()) {
                                try {
                                    try {
                                        x509crl = processCRLH(CertPathValidatorUtilities.getDeltaCRLs(date4, x509crl2, pKIXExtendedParameters.getCertStores(), pKIXExtendedParameters.getCRLStores(), jcaJceHelper), processCRLG);
    ...
    protected static void checkCRLs(PKIXCertRevocationCheckerParameters pKIXCertRevocationCheckerParameters, PKIXExtendedParameters pKIXExtendedParameters, X509Certificate x509Certificate, Date date, X509Certificate x509Certificate2, PublicKey publicKey, List list, JcaJceHelper jcaJceHelper) throws AnnotatedException, RecoverableCertPathValidatorException {
        ...
        try {
            ...
            try {
                for (PKIXCRLStore pKIXCRLStore : CertPathValidatorUtilities.getAdditionalStoresFromCRLDistributionPoint(instance, pKIXExtendedParameters.getNamedCRLStoreMap(), date, jcaJceHelper)) {
                        ...
                        if (distributionPoints != null) {
                            ...
                            while (i5 < distributionPoints.length && certStatus4.getCertStatus() == i4 && !reasonsMask.isAllReasons()) {
                                try {
                                    ...
                                    try {
                                        checkCRL(pKIXCertRevocationCheckerParameters, distributionPoints[i5], build, x509Certificate, date, x509Certificate2, publicKey, certStatus4, reasonsMask, list, jcaJceHelper);
                                        z = true;
                                    } catch (AnnotatedException e2) {
                                        e = e2;
                                    }
                            ...
                            if (certStatus.getCertStatus() == i && !reasonsMask.isAllReasons()) {
                                checkCRL(pKIXCertRevocationCheckerParameters, new DistributionPoint(new DistributionPointName(0, new GeneralNames(new GeneralName(4, PrincipalUtils.getIssuerPrincipal(x509Certificate)))), null, null), (PKIXExtendedParameters) pKIXExtendedParameters.clone(), x509Certificate, date, x509Certificate2, publicKey, certStatus, reasonsMask, list, jcaJceHelper);
                                z = true;
                            }
                            if (z) {
    ...
    protected static void processCertA(CertPath certPath, PKIXExtendedParameters pKIXExtendedParameters, PKIXCertRevocationChecker pKIXCertRevocationChecker, int i, PublicKey publicKey, boolean z, X500Name x500Name, X509Certificate x509Certificate) throws CertPathValidatorException {

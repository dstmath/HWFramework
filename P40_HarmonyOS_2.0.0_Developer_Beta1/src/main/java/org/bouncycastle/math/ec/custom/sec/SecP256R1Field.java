...
public class SecP256R1Field {
    ...
    public static void inv(int[] iArr, int[] iArr2) {
        if (isZero(iArr) == 0) {
            ...
            squareN(create4, 16, create5);
            multiply(create5, create4, create5);
            int[] create6 = Nat256.create();
            squareN(create5, 32, create6);
            multiply(create6, create5, create6);
            squareN(create6, 16, create6);
            multiply(create6, create4, create6);
            squareN(create6, 8, create4);
            multiply(create4, create3, create4);
            squareN(create4, 4, create3);
            multiply(create3, create2, create3);
            squareN(create3, 2, create2);
            multiply(create2, create, create2);
            squareN(create5, 32, create5);
            multiply(create5, iArr, create5);
            squareN(create5, 190, create5);
            multiply(create5, create2, create5);
            squareN(create5, 2, create5);
            multiply(iArr, create5, iArr2);
            return;
        }

...
public class SecP384R1Field {
    ...
    public static void inv(int[] iArr, int[] iArr2) {
        if (isZero(iArr) == 0) {
            ...
            squareN(create3, 6, create2);
            multiply(create2, create3, create2);
            int[] create4 = Nat.create(12);
            squareN(create2, 12, create4);
            multiply(create4, create2, create4);
            squareN(create4, 6, create2);
            multiply(create2, create3, create2);
            squareN(create2, 2, create4);
            multiply(create4, create, create4);
            squareN(create4, 30, create);
            multiply(create, create2, create);
            int[] create5 = Nat.create(12);
            squareN(create, 62, create5);
            multiply(create5, create, create5);
            squareN(create5, 124, create);
            multiply(create, create5, create);
            squareN(create, 6, create5);
            multiply(create5, create3, create5);
            square(create5, create3);
            multiply(create3, iArr, create3);
            squareN(create3, 33, create3);
            multiply(create3, create4, create3);
            squareN(create3, 94, create3);
            multiply(create3, create2, create3);

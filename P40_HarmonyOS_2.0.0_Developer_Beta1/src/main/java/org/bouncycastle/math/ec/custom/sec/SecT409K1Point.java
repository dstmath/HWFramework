    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement6.isZero()) {
                return new SecT409K1Point(curve, eCFieldElement6, curve.getB());
            }
        ...
        return new SecT409K1Point(curve, eCFieldElement6, eCFieldElement5, new ECFieldElement[]{eCFieldElement4});
    }

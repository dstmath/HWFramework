...
public interface IBiometricsFaceRecognize extends IBase {
    public static final String kInterfaceName = "vendor.huawei.hardware.biometrics.hwfacerecognize@2.0::IBiometricsFaceRecognize";

    @FunctionalInterface
    public interface getStatusCallback {
        void onValues(int i, int i2, int i3, ArrayList<Byte> arrayList);
    }

    @FunctionalInterface
    public interface getUvtCallback {
        void onValues(int i, int i2, ArrayList<Byte> arrayList, ArrayList<Byte> arrayList2);
    }
    ...
    void getUvt(getUvtCallback getuvtcallback) throws RemoteException;
    ...
    int prepare(ArrayList<Byte> arrayList, ArrayList<Byte> arrayList2, ArrayList<Byte> arrayList3) throws RemoteException;
    ...
    int sendCommand(int i, ArrayList<Byte> arrayList) throws RemoteException;
    ...
    int setFlag(int i) throws RemoteException;
    ...
    int setSecureFaceMode(int i) throws RemoteException;

    @Override // android.hidl.base.V1_0.IBase
    boolean unlinkToDeath(IHwBinder.DeathRecipient deathRecipient) throws RemoteException;

    static IBiometricsFaceRecognize asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static IBiometricsFaceRecognize castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static IBiometricsFaceRecognize getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IBiometricsFaceRecognize getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static IBiometricsFaceRecognize getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static IBiometricsFaceRecognize getService() throws RemoteException {
    ...
    public static final class Proxy implements IBiometricsFaceRecognize {
        ...
        @Override // vendor.huawei.hardware.biometrics.hwfacerecognize.V2_0.IBiometricsFaceRecognize, android.hidl.base.V1_0.IBase
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.biometrics.hwfacerecognize@2.0::IBiometricsFaceRecognize]@Proxy";
            }
        }
        ...
        @Override // vendor.huawei.hardware.biometrics.hwfacerecognize.V2_0.IBiometricsFaceRecognize
        ...
        @Override // vendor.huawei.hardware.biometrics.hwfacerecognize.V2_0.IBiometricsFaceRecognize
        public void getUvt(getUvtCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IBiometricsFaceRecognize.kInterfaceName);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        @Override // vendor.huawei.hardware.biometrics.hwfacerecognize.V2_0.IBiometricsFaceRecognize
        public void getStatus(int statusId, getStatusCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IBiometricsFaceRecognize.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements IBiometricsFaceRecognize {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-123, 66, -99, 22, -95, -69, -92, -123, 17, 119, 48, 112, -74, -97, 20, 71, 35, Byte.MAX_VALUE, -82, -7, -99, -12, 9, 72, 58, 40, -71, 8, -68, 71, -36, -11}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 20:
                    ...
                    _hidl_request.enforceInterface(IBiometricsFaceRecognize.kInterfaceName);
                    getUvt(new getUvtCallback() {
                        /* class vendor.huawei.hardware.biometrics.hwfacerecognize.V2_0.IBiometricsFaceRecognize.Stub.AnonymousClass1 */
                ...
                case 22:
                    ...
                    getStatus(_hidl_request.readInt32(), new getStatusCallback() {
                        /* class vendor.huawei.hardware.biometrics.hwfacerecognize.V2_0.IBiometricsFaceRecognize.Stub.AnonymousClass2 */

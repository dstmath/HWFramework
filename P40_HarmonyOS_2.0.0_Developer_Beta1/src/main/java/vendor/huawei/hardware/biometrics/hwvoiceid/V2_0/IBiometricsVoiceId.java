...
public interface IBiometricsVoiceId extends IBase {
    public static final String kInterfaceName = "vendor.huawei.hardware.biometrics.hwvoiceid@2.0::IBiometricsVoiceId";
    ...
    public static final class Proxy implements IBiometricsVoiceId {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.biometrics.hwvoiceid@2.0::IBiometricsVoiceId]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IBiometricsVoiceId {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-117, -59, 51, -32, 38, -45, -67, 111, 15, 58, 90, -69, -59, -83, -82, 103, -77, 86, -14, 83, -116, 113, 67, -2, -64, -50, -11, -5, -72, 65, -96, -52}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        /* JADX INFO: Multiple debug info for r9v7 byte[]: [D('headsetSn' byte[]), D('_hidl_blob' android.os.HwBlob)] */
        /* JADX INFO: Multiple debug info for r5v11 byte[]: [D('_hidl_blob' android.os.HwBlob), D('headsetAbility' byte[])] */
        /* JADX INFO: Multiple debug info for r6v4 byte[]: [D('_hidl_blob' android.os.HwBlob), D('headsetWordList' byte[])] */
        /* JADX INFO: Multiple debug info for r0v49 byte[]: [D('_hidl_blob' android.os.HwBlob), D('pubKey' byte[])] */
        /* JADX INFO: Multiple debug info for r1v34 byte[]: [D('_hidl_blob' android.os.HwBlob), D('signature' byte[])] */

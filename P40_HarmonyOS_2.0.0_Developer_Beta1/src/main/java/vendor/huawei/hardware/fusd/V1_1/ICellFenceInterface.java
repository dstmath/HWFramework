...
public interface ICellFenceInterface extends IBase {
    public static final String kInterfaceName = "vendor.huawei.hardware.fusd@1.1::ICellFenceInterface";

    void addCellFence(int i, ArrayList<CellFenceDownData> arrayList) throws RemoteException;

    @Override // android.hidl.base.V1_0.IBase
    IHwBinder asBinder();

    boolean cellTrajectorySwitch(int i) throws RemoteException;
    ...
    boolean injectGnssFenceResult(ArrayList<CellFenceStatus> arrayList) throws RemoteException;
    ...
    void operCellFence(int i, CellFenceDownData cellFenceDownData) throws RemoteException;

    @Override // android.hidl.base.V1_0.IBase
    void ping() throws RemoteException;

    void registerCellFenceCallback(ICellFenceCallback iCellFenceCallback) throws RemoteException;

    boolean requestTrajectory() throws RemoteException;
    ...
    public static final class CellFenceSwitchStatus {
    ...
    public static final class CellFenceTransition {
    ...
    public static final class Proxy implements ICellFenceInterface {
        ...
        @Override // vendor.huawei.hardware.fusd.V1_1.ICellFenceInterface, android.hidl.base.V1_0.IBase
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.fusd@1.1::ICellFenceInterface]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ICellFenceInterface {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ICellFenceInterface.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{126, 7, 33, 13, 87, 24, -80, -120, 79, 51, 85, -59, 71, 7, -60, -61, -108, -127, -58, -101, -18, 87, 3, 32, 12, -117, -96, -11, 117, 97, -124, -120}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }

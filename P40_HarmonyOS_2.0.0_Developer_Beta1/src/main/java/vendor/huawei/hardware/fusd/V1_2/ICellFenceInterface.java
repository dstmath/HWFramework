...
public interface ICellFenceInterface extends vendor.huawei.hardware.fusd.V1_1.ICellFenceInterface {
    public static final String kInterfaceName = "vendor.huawei.hardware.fusd@1.2::ICellFenceInterface";

    void addCellFenceV1_2(int i, ArrayList<CellFenceAddData> arrayList) throws RemoteException;
    ...
    public static final class Proxy implements ICellFenceInterface {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.fusd@1.2::ICellFenceInterface]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ICellFenceInterface {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ICellFenceInterface.kInterfaceName, vendor.huawei.hardware.fusd.V1_1.ICellFenceInterface.kInterfaceName, IBase.kInterfaceName));
        }

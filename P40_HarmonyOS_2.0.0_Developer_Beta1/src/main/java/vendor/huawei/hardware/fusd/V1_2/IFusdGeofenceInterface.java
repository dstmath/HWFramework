...
public interface IFusdGeofenceInterface extends IBase {
    public static final String kInterfaceName = "vendor.huawei.hardware.fusd@1.2::IFusdGeofenceInterface";
    ...
    void getCurrentLocation() throws RemoteException;
    ...
    void setGeofenceCallback(IFusdGeofenceCallback iFusdGeofenceCallback) throws RemoteException;
    ...
    public static final class GeofenceRequest {
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (this.geofenceId == other.geofenceId && HidlSupport.deepEquals(this.point, other.point) && this.radius == other.radius && this.accuracy == other.accuracy && this.notificationResponsivenessMs == other.notificationResponsivenessMs && this.unknownTimerMs == other.unknownTimerMs && HidlSupport.deepEquals(Integer.valueOf(this.monitorTransitions), Integer.valueOf(other.monitorTransitions)) && this.lastTransition == other.lastTransition && this.sources_to_use == other.sources_to_use && this.floor == other.floor && this.parentFenceId == other.parentFenceId && this.reportType == other.reportType) {
                return true;
            }
            return false;
        }
        ...
        public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
            ...
            this.floor = _hidl_blob.getInt32(56 + _hidl_offset);
            this.parentFenceId = _hidl_blob.getInt32(60 + _hidl_offset);
            this.reportType = _hidl_blob.getInt32(64 + _hidl_offset);
        }
        ...
        public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
            ...
            _hidl_blob.putInt32(56 + _hidl_offset, this.floor);
            _hidl_blob.putInt32(60 + _hidl_offset, this.parentFenceId);
            _hidl_blob.putInt32(64 + _hidl_offset, this.reportType);
        }
    }
    ...
    public static final class GeofencePolygonRequest {
        ...
        public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
            ...
            this.floor = _hidl_blob.getInt32(_hidl_offset + 48);
            this.parentFenceId = _hidl_blob.getInt32(_hidl_offset + 52);
            this.reportType = _hidl_blob.getInt32(_hidl_offset + 56);
        }
        ...
        public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
            ...
            _hidl_blob.putInt32(48 + _hidl_offset, this.floor);
            _hidl_blob.putInt32(52 + _hidl_offset, this.parentFenceId);
            _hidl_blob.putInt32(56 + _hidl_offset, this.reportType);
        }
    }
    ...
    public static final class Proxy implements IFusdGeofenceInterface {
        ...
        @Override // vendor.huawei.hardware.fusd.V1_2.IFusdGeofenceInterface, android.hidl.base.V1_0.IBase
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.fusd@1.2::IFusdGeofenceInterface]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IFusdGeofenceInterface {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IFusdGeofenceInterface.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-119, -123, -45, -127, 40, 107, -31, -26, 38, 34, -58, -69, 92, -98, -51, -9, -72, 120, -71, -81, 50, 70, -5, 41, -75, -105, 66, 61, 121, -94, -65, -33}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }

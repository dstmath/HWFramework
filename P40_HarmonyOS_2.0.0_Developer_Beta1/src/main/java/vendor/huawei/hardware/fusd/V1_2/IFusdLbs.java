...
public interface IFusdLbs extends vendor.huawei.hardware.fusd.V1_1.IFusdLbs {
    public static final String kInterfaceName = "vendor.huawei.hardware.fusd@1.2::IFusdLbs";

    @Override // vendor.huawei.hardware.fusd.V1_1.IFusdLbs, vendor.huawei.hardware.fusd.V1_0.IFusdLbs, android.hidl.base.V1_0.IBase
    IHwBinder asBinder();

    @Override // vendor.huawei.hardware.fusd.V1_1.IFusdLbs, vendor.huawei.hardware.fusd.V1_0.IFusdLbs, android.hidl.base.V1_0.IBase
    void debug(NativeHandle nativeHandle, ArrayList<String> arrayList) throws RemoteException;

    ICellFenceInterface getCellFenceInterfaceV1_2() throws RemoteException;

    @Override // vendor.huawei.hardware.fusd.V1_1.IFusdLbs, vendor.huawei.hardware.fusd.V1_0.IFusdLbs, android.hidl.base.V1_0.IBase
    DebugInfo getDebugInfo() throws RemoteException;

    IFusdGeofenceInterface getFusdGeofenceInterface() throws RemoteException;

    IFusdGnssInterface getFusdGnssInterface() throws RemoteException;

    @Override // vendor.huawei.hardware.fusd.V1_1.IFusdLbs, vendor.huawei.hardware.fusd.V1_0.IFusdLbs, android.hidl.base.V1_0.IBase
    ArrayList<byte[]> getHashChain() throws RemoteException;

    IMMInterface getMMInterface() throws RemoteException;

    IOfflineDbInterface getOfflineDbInterface() throws RemoteException;

    IWififenceInterface getWififenceInterface() throws RemoteException;

    void injectLocation(int i, GnssLocation gnssLocation) throws RemoteException;
    ...
    void sendLocationSourceStatus(int i, int i2) throws RemoteException;
    ...
    public static final class Proxy implements IFusdLbs {
        ...
        @Override // vendor.huawei.hardware.fusd.V1_2.IFusdLbs, vendor.huawei.hardware.fusd.V1_1.IFusdLbs, vendor.huawei.hardware.fusd.V1_0.IFusdLbs, android.hidl.base.V1_0.IBase
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.fusd@1.2::IFusdLbs]@Proxy";
            }
        }
        ...
        @Override // vendor.huawei.hardware.fusd.V1_2.IFusdLbs
        public ICellFenceInterface getCellFenceInterfaceV1_2() throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IFusdLbs.kInterfaceName);
            HwParcel _hidl_reply = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements IFusdLbs {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IFusdLbs.kInterfaceName, vendor.huawei.hardware.fusd.V1_1.IFusdLbs.kInterfaceName, vendor.huawei.hardware.fusd.V1_0.IFusdLbs.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 25:
                    ...
                    _hidl_request.enforceInterface(IFusdLbs.kInterfaceName);
                    ICellFenceInterface _hidl_out_cfIface2 = getCellFenceInterfaceV1_2();
                    _hidl_reply.writeStatus(0);

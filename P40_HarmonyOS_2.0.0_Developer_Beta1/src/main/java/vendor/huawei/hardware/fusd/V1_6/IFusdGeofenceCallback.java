...
public interface IFusdGeofenceCallback extends vendor.huawei.hardware.fusd.V1_2.IFusdGeofenceCallback {
    public static final String kInterfaceName = "vendor.huawei.hardware.fusd@1.6::IFusdGeofenceCallback";
    ...
    void onGetGeofenceSizeCb(FdGeofenceSize fdGeofenceSize) throws RemoteException;
    ...
    public static final class Proxy implements IFusdGeofenceCallback {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.fusd@1.6::IFusdGeofenceCallback]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IFusdGeofenceCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IFusdGeofenceCallback.kInterfaceName, vendor.huawei.hardware.fusd.V1_2.IFusdGeofenceCallback.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{6, 35, -2, -69, Byte.MIN_VALUE, -3, 71, -41, -37, 84, 74, 8, -35, 22, -107, 49, -127, 6, 117, 88, 121, 80, 10, -70, 7, -49, 104, 63, -97, -100, -31, -109}, new byte[]{-89, 124, 112, -74, -14, 27, 31, -111, -49, -24, -112, 67, 26, -68, 45, 70, 1, -125, -127, 88, 50, -52, -16, 32, 123, -78, -26, -8, 121, -45, -45, 20}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }

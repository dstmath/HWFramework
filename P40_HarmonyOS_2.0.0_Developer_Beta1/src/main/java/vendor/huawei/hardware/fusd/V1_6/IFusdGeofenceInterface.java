...
public interface IFusdGeofenceInterface extends vendor.huawei.hardware.fusd.V1_2.IFusdGeofenceInterface {
    public static final String kInterfaceName = "vendor.huawei.hardware.fusd@1.6::IFusdGeofenceInterface";
    ...
    void getGeofenceSize() throws RemoteException;
    ...
    void setGeofenceCallbackV1_6(IFusdGeofenceCallback iFusdGeofenceCallback) throws RemoteException;
    ...
    public static final class Proxy implements IFusdGeofenceInterface {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.fusd@1.6::IFusdGeofenceInterface]@Proxy";
            }
        }
        ...
        public void setGeofenceCallbackV1_6(IFusdGeofenceCallback callback) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IFusdGeofenceInterface {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IFusdGeofenceInterface.kInterfaceName, vendor.huawei.hardware.fusd.V1_2.IFusdGeofenceInterface.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 9:
                    ...
                    setGeofenceCallbackV1_6(IFusdGeofenceCallback.asInterface(_hidl_request.readStrongBinder()));
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.send();
                    return;
                case 10:

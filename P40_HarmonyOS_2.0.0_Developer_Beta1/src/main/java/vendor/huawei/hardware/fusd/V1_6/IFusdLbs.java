...
public interface IFusdLbs extends vendor.huawei.hardware.fusd.V1_5.IFusdLbs {
    public static final String kInterfaceName = "vendor.huawei.hardware.fusd@1.6::IFusdLbs";

    @Override // vendor.huawei.hardware.fusd.V1_5.IFusdLbs, vendor.huawei.hardware.fusd.V1_4.IFusdLbs, vendor.huawei.hardware.fusd.V1_3.IFusdLbs, vendor.huawei.hardware.fusd.V1_2.IFusdLbs, vendor.huawei.hardware.fusd.V1_1.IFusdLbs, vendor.huawei.hardware.fusd.V1_0.IFusdLbs, android.hidl.base.V1_0.IBase
    IHwBinder asBinder();

    @Override // vendor.huawei.hardware.fusd.V1_5.IFusdLbs, vendor.huawei.hardware.fusd.V1_4.IFusdLbs, vendor.huawei.hardware.fusd.V1_3.IFusdLbs, vendor.huawei.hardware.fusd.V1_2.IFusdLbs, vendor.huawei.hardware.fusd.V1_1.IFusdLbs, vendor.huawei.hardware.fusd.V1_0.IFusdLbs, android.hidl.base.V1_0.IBase
    void debug(NativeHandle nativeHandle, ArrayList<String> arrayList) throws RemoteException;

    ICellFenceInterface getCellFenceInterfaceV1_6() throws RemoteException;

    @Override // vendor.huawei.hardware.fusd.V1_5.IFusdLbs, vendor.huawei.hardware.fusd.V1_4.IFusdLbs, vendor.huawei.hardware.fusd.V1_3.IFusdLbs, vendor.huawei.hardware.fusd.V1_2.IFusdLbs, vendor.huawei.hardware.fusd.V1_1.IFusdLbs, vendor.huawei.hardware.fusd.V1_0.IFusdLbs, android.hidl.base.V1_0.IBase
    DebugInfo getDebugInfo() throws RemoteException;

    IFusdGeofenceInterface getFusdGeofenceInterfaceV1_6() throws RemoteException;

    @Override // vendor.huawei.hardware.fusd.V1_5.IFusdLbs, vendor.huawei.hardware.fusd.V1_4.IFusdLbs, vendor.huawei.hardware.fusd.V1_3.IFusdLbs, vendor.huawei.hardware.fusd.V1_2.IFusdLbs, vendor.huawei.hardware.fusd.V1_1.IFusdLbs, vendor.huawei.hardware.fusd.V1_0.IFusdLbs, android.hidl.base.V1_0.IBase
    ArrayList<byte[]> getHashChain() throws RemoteException;

    IWififenceInterface getWififenceInterfaceV1_6() throws RemoteException;
    ...
    public static final class Proxy implements IFusdLbs {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.fusd@1.6::IFusdLbs]@Proxy";
            }
        }
        ...
        public IFusdGeofenceInterface getFusdGeofenceInterfaceV1_6() throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
        ...
        @Override // vendor.huawei.hardware.fusd.V1_6.IFusdLbs
        public IWififenceInterface getWififenceInterfaceV1_6() throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IFusdLbs.kInterfaceName);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        @Override // vendor.huawei.hardware.fusd.V1_6.IFusdLbs
        public ICellFenceInterface getCellFenceInterfaceV1_6() throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IFusdLbs.kInterfaceName);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 39:
                    ...
                    IFusdGeofenceInterface _hidl_out_gfIface3 = getFusdGeofenceInterfaceV1_6();
                    _hidl_reply.writeStatus(0);
                ...
                case 40:
                    ...
                    _hidl_request.enforceInterface(IFusdLbs.kInterfaceName);
                    IWififenceInterface _hidl_out_wfIface2 = getWififenceInterfaceV1_6();
                    _hidl_reply.writeStatus(0);
                ...
                case 41:
                    ...
                    _hidl_request.enforceInterface(IFusdLbs.kInterfaceName);
                    ICellFenceInterface _hidl_out_cfIface3 = getCellFenceInterfaceV1_6();
                    _hidl_reply.writeStatus(0);

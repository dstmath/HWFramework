...
public final class GpsConfig {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != GpsConfig.class) {
            return false;
        }
        GpsConfig other = (GpsConfig) otherObject;
        if (this.type == other.type && this.cmd == other.cmd && this.interval == other.interval) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.type))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.cmd))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.interval))));
    }

    public final String toString() {
        return "{.type = " + this.type + ", .cmd = " + this.cmd + ", .interval = " + this.interval + "}";
    }
    ...
    public static final ArrayList<GpsConfig> readVectorFromParcel(HwParcel parcel) {
        ArrayList<GpsConfig> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 12), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            GpsConfig _hidl_vec_element = new GpsConfig();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<GpsConfig> _hidl_vec) {

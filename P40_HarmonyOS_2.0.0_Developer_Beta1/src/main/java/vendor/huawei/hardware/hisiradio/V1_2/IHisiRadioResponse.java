...
public interface IHisiRadioResponse extends vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioResponse {
    public static final String kInterfaceName = "vendor.huawei.hardware.hisiradio@1.2::IHisiRadioResponse";

    @Override // vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioResponse, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioResponse, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
    IHwBinder asBinder();

    @Override // vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioResponse, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioResponse, android.internal.hidl.base.V1_0.IBase
    ...
    void getHwCellInfoListResponse_1_2(RadioResponseInfo radioResponseInfo, ArrayList<HwCellInfo_1_2> arrayList) throws RemoteException;

    void getHwDataRegistrationStateResponse13(RadioResponseInfo radioResponseInfo, HwDataRegStateResult13 hwDataRegStateResult13) throws RemoteException;

    void getHwDataRegistrationStateResponse_1_2(RadioResponseInfo radioResponseInfo, HwDataRegStateResult_1_2 hwDataRegStateResult_1_2) throws RemoteException;

    void getHwNrOptionModeResponse(RadioResponseInfo radioResponseInfo, int i) throws RemoteException;

    void getHwVoiceRegistrationStateResponse_1_2(RadioResponseInfo radioResponseInfo, HwVoiceRegStateResult_1_2 hwVoiceRegStateResult_1_2) throws RemoteException;

    void getImsDomainResponseV1_1(RadioResponseInfo radioResponseInfo, int i) throws RemoteException;
    ...
    void sendMutiChipSessionConfigResponse(RadioResponseInfo radioResponseInfo) throws RemoteException;

    void sendVsimDataToModemResponse(RadioResponseInfo radioResponseInfo) throws RemoteException;

    @Override // vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioResponse, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioResponse, android.internal.hidl.base.V1_0.IBase
    void setHALInstrumentation() throws RemoteException;

    void setHwNrOptionModeResponse(RadioResponseInfo radioResponseInfo) throws RemoteException;
    ...
    public static final class Proxy implements IHisiRadioResponse {
        ...
        @Override // vendor.huawei.hardware.hisiradio.V1_2.IHisiRadioResponse, vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioResponse, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioResponse, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.hisiradio@1.2::IHisiRadioResponse]@Proxy";
            }
        }
        ...
        @Override // vendor.huawei.hardware.hisiradio.V1_2.IHisiRadioResponse, vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioResponse, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioResponse, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IHisiRadioResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IHisiRadioResponse.kInterfaceName, vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioResponse.kInterfaceName, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioResponse.kInterfaceName, IBase.kInterfaceName));
        }

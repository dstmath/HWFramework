...
public interface IMtkRadioExIndication extends IBase {
    public static final String kInterfaceName = "vendor.huawei.hardware.mtkradio@1.0::IMtkRadioExIndication";
    ...
    void csconModeIndication(int i, int i2) throws RemoteException;
    ...
    public static final class Proxy implements IMtkRadioExIndication {
        ...
        @Override // vendor.huawei.hardware.mtkradio.V1_0.IMtkRadioExIndication, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.mtkradio@1.0::IMtkRadioExIndication]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IMtkRadioExIndication {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-73, 5, 117, 54, -113, -19, 116, 100, -86, 106, -60, MidiConstants.STATUS_CHANNEL_MASK, 99, -6, 24, -126, 40, -99, -8, -40, -47, BluetoothHidDevice.SUBCLASS1_KEYBOARD, 80, 23, 33, -119, 69, 86, -4, -77, -75, -72}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }

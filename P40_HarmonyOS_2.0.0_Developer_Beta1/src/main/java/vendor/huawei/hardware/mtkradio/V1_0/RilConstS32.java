...
public final class RilConstS32 {
    ...
    public static final int RIL_REQUEST_HW_REPORT_AIRPLANE_MODE = 731;
    public static final int RIL_REQUEST_HW_REPORT_SIM_MODE = 732;
    ...
    public static final String toString(int o) {
        ...
        if (o == 731) {
            return "RIL_REQUEST_HW_REPORT_AIRPLANE_MODE";
        }
        if (o == 732) {
            return "RIL_REQUEST_HW_REPORT_SIM_MODE";
        }
        if (o == 2000) {
    ...
    public static final String dumpBitfield(int o) {
        ...
        if ((o & 731) == 731) {
            list.add("RIL_REQUEST_HW_REPORT_AIRPLANE_MODE");
            flipped |= 731;
        }
        if ((o & 732) == 732) {
            list.add("RIL_REQUEST_HW_REPORT_SIM_MODE");
            flipped |= 732;
        }
        if ((o & 2000) == 2000) {

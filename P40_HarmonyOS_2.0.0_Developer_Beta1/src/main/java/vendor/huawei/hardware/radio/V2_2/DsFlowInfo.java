...
public final class DsFlowInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != DsFlowInfo.class) {
            return false;
        }
        DsFlowInfo other = (DsFlowInfo) otherObject;
    ...
    public static final ArrayList<DsFlowInfo> readVectorFromParcel(HwParcel parcel) {
        ArrayList<DsFlowInfo> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 96), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            DsFlowInfo _hidl_vec_element = new DsFlowInfo();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<DsFlowInfo> _hidl_vec) {

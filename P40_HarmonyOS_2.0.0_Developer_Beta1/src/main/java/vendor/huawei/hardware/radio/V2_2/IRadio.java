...
public interface IRadio extends vendor.huawei.hardware.radio.V2_1.IRadio {
    public static final String kInterfaceName = "vendor.huawei.hardware.radio@2.2::IRadio";
    ...
    void getUeOperationMode(int i) throws RemoteException;
    ...
    void sendVsimNotificationEx(int i, int i2, int i3, int i4, String str) throws RemoteException;
    ...
    public static final class Proxy implements IRadio {
        ...
        @Override // vendor.huawei.hardware.radio.V2_2.IRadio, vendor.huawei.hardware.radio.V2_1.IRadio, vendor.huawei.hardware.radio.V2_0.IRadio, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.radio@2.2::IRadio]@Proxy";
            }
        }
        ...
        public void setHwNrSaState(int serial, int on) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.radio.V2_1.IRadio.kInterfaceName);
            _hidl_request.writeInt32(serial);
        ...
        @Override // vendor.huawei.hardware.radio.V2_2.IRadio
        ...
        @Override // vendor.huawei.hardware.radio.V2_2.IRadio
        public void setUeOperationMode(int serial, int mode) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IRadio.kInterfaceName);
            _hidl_request.writeInt32(serial);
            _hidl_request.writeInt32(mode);
        ...
        @Override // vendor.huawei.hardware.radio.V2_2.IRadio
        public void getUeOperationMode(int serial) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IRadio.kInterfaceName);
            _hidl_request.writeInt32(serial);
            HwParcel _hidl_reply = new HwParcel();
        ...
        @Override // vendor.huawei.hardware.radio.V2_2.IRadio
        public void setApDsFlowReportConfig(int serial, int enableRpt, int threshold, int totaThreshold, int oper) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IRadio.kInterfaceName);
            _hidl_request.writeInt32(serial);
            _hidl_request.writeInt32(enableRpt);
            _hidl_request.writeInt32(threshold);
            _hidl_request.writeInt32(totaThreshold);
        ...
        @Override // vendor.huawei.hardware.radio.V2_2.IRadio
        public void sendVsimNotificationEx(int serial, int transactionId, int eventId, int simType, String challenge) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IRadio.kInterfaceName);
            _hidl_request.writeInt32(serial);
        ...
        @Override // vendor.huawei.hardware.radio.V2_2.IRadio, vendor.huawei.hardware.radio.V2_1.IRadio, vendor.huawei.hardware.radio.V2_0.IRadio, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IRadio {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IRadio.kInterfaceName, vendor.huawei.hardware.radio.V2_1.IRadio.kInterfaceName, vendor.huawei.hardware.radio.V2_0.IRadio.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 29:
                    ...
                    _hidl_request.enforceInterface(vendor.huawei.hardware.radio.V2_1.IRadio.kInterfaceName);
                ...
                case 41:
                    ...
                    _hidl_request.enforceInterface(IRadio.kInterfaceName);
                    getUeOperationMode(_hidl_request.readInt32());
                    return;
                case 42:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                ...
                case 45:
                    ...
                    _hidl_request.enforceInterface(IRadio.kInterfaceName);
                    sendVsimNotificationEx(_hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readString());
                    return;
                default:
                    switch (_hidl_code) {
                        case 256067662:

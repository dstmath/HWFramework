        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 15:
                    ...
                    if (data.readInt() != 0) {
                        _arg1 = (BluetoothHeadsetClientCall) BluetoothHeadsetClientCall.CREATOR.createFromParcel(data);
                    } else {
                        _arg1 = null;
                    }
                    _result = terminateCall(_arg0, _arg1);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 16:
                ...
                case 18:
                    ...
                    BluetoothHeadsetClientCall _result6 = dial(_arg0, data.readString());
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                ...
                case 24:
                    ...
                    setAudioRouteAllowed(_arg0, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 25:
                    data.enforceInterface(DESCRIPTOR);

...
public class CallbackProxies {
    ...
    public static class DeviceCaptureCallbackProxy implements CaptureCallback {
        ...
        public void onCaptureBufferLost(CameraDevice camera, CaptureRequest request, Surface target, long frameNumber) {
            this.mProxy.invoke("onCaptureBufferLost", camera, request, target, Long.valueOf(frameNumber));
        }
    }

...
public final class CallForwardInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        return this.status == other.status && this.reason == other.reason && this.serviceClass == other.serviceClass && this.toa == other.toa && HidlSupport.deepEquals(this.number, other.number) && this.timeSeconds == other.timeSeconds;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.serviceClass = _hidl_blob.getInt32(8 + _hidl_offset);
        this.toa = _hidl_blob.getInt32(12 + _hidl_offset);
        this.number = _hidl_blob.getString(_hidl_offset + 16);
        parcel.readEmbeddedBuffer((long) (this.number.getBytes().length + 1), _hidl_blob.handle(), 0 + (_hidl_offset + 16), false);
        this.timeSeconds = _hidl_blob.getInt32(32 + _hidl_offset);
    }

...
public final class CdmaInformationRecords {
    ...
    public final boolean equals(Object otherObject) {
        ...
        return HidlSupport.deepEquals(this.infoRec, ((CdmaInformationRecords) otherObject).infoRec);
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 120), _hidl_blob.handle(), (0 + _hidl_offset) + 0, true);
        this.infoRec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {

...
public final class CdmaLineControlInfoRecord {
    ...
    public final boolean equals(Object otherObject) {
        ...
        return this.lineCtrlPolarityIncluded == other.lineCtrlPolarityIncluded && this.lineCtrlToggle == other.lineCtrlToggle && this.lineCtrlReverse == other.lineCtrlReverse && this.lineCtrlPowerDenial == other.lineCtrlPowerDenial;
    }

...
public final class CellIdentityCdma {
    ...
    public final boolean equals(Object otherObject) {
        ...
        return this.networkId == other.networkId && this.systemId == other.systemId && this.baseStationId == other.baseStationId && this.longitude == other.longitude && this.latitude == other.latitude;
    }

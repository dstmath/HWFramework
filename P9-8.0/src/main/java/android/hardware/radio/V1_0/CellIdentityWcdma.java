...
public final class CellIdentityWcdma {
    ...
    public final boolean equals(Object otherObject) {
        ...
        return HidlSupport.deepEquals(this.mcc, other.mcc) && HidlSupport.deepEquals(this.mnc, other.mnc) && this.lac == other.lac && this.cid == other.cid && this.psc == other.psc && this.uarfcn == other.uarfcn;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.psc = _hidl_blob.getInt32(40 + _hidl_offset);
        this.uarfcn = _hidl_blob.getInt32(44 + _hidl_offset);
    }

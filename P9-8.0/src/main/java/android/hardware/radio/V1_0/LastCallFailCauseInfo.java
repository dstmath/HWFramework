...
public final class LastCallFailCauseInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        return this.causeCode == other.causeCode && HidlSupport.deepEquals(this.vendorCause, other.vendorCause);
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        parcel.readEmbeddedBuffer((long) (this.vendorCause.getBytes().length + 1), _hidl_blob.handle(), 0 + (_hidl_offset + 8), false);
    }

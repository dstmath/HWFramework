...
public final class LteSignalStrength {
    ...
    public final boolean equals(Object otherObject) {
        ...
        return this.signalStrength == other.signalStrength && this.rsrp == other.rsrp && this.rsrq == other.rsrq && this.rssnr == other.rssnr && this.cqi == other.cqi && this.timingAdvance == other.timingAdvance;
    }

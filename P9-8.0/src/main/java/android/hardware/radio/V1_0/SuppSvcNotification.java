...
public final class SuppSvcNotification {
    ...
    public final boolean equals(Object otherObject) {
        ...
        return this.isMT == other.isMT && this.code == other.code && this.index == other.index && this.type == other.type && HidlSupport.deepEquals(this.number, other.number);
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.index = _hidl_blob.getInt32(8 + _hidl_offset);
        this.type = _hidl_blob.getInt32(12 + _hidl_offset);

...
public final class UusInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        return this.uusType == other.uusType && this.uusDcs == other.uusDcs && HidlSupport.deepEquals(this.uusData, other.uusData);
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.uusDcs = _hidl_blob.getInt32(4 + _hidl_offset);
        this.uusData = _hidl_blob.getString(_hidl_offset + 8);
        parcel.readEmbeddedBuffer((long) (this.uusData.getBytes().length + 1), _hidl_blob.handle(), 0 + (_hidl_offset + 8), false);
    }

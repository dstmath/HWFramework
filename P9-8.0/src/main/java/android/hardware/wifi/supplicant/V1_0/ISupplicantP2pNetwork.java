...
public interface ISupplicantP2pNetwork extends ISupplicantNetwork {
    ...
    public static final class Proxy implements ISupplicantP2pNetwork {
        ...
        public void isCurrent(isCurrentCallback cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ISupplicantP2pNetwork.kInterfaceName);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public void isPersistent(isPersistentCallback cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ISupplicantP2pNetwork.kInterfaceName);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public void isGo(isGoCallback cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ISupplicantP2pNetwork.kInterfaceName);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public void getClientList(getClientListCallback cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ISupplicantP2pNetwork.kInterfaceName);
            HwParcel _hidl_reply = new HwParcel();
            try {
                ...
                cb.onValues(_hidl_out_status, _hidl_out_clients);
            } finally {
                _hidl_reply.release();
            }
        }

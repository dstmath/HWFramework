...
public class LocationProvider {
    ...
    public static boolean propertiesMeetCriteria(String name, ProviderProperties properties, Criteria criteria) {
        ...
        if (criteria.isAltitudeRequired() && (properties.mSupportsAltitude ^ 1) != 0) {
            return false;
        }
        if (criteria.isSpeedRequired() && (properties.mSupportsSpeed ^ 1) != 0) {
            return false;
        }
        if (criteria.isBearingRequired() && (properties.mSupportsBearing ^ 1) != 0) {
            return false;
        }

...
public interface IPlaybackConfigDispatcher extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPlaybackConfigDispatcher {
        ...
        private static class Proxy implements IPlaybackConfigDispatcher {
            ...
            public void dispatchPlaybackConfigChange(List<AudioPlaybackConfiguration> configs) throws RemoteException {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    dispatchPlaybackConfigChange(data.createTypedArrayList(AudioPlaybackConfiguration.CREATOR));
                    return true;
    ...
    void dispatchPlaybackConfigChange(List<AudioPlaybackConfiguration> list) throws RemoteException;
}

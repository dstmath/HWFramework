...
public final class SyncParams {
    ...
    private float mFrameRate = TonemapCurve.LEVEL_BLACK;
    private int mSet = 0;
    private int mSyncSource = 0;
    private float mTolerance = TonemapCurve.LEVEL_BLACK;
    ...
    public SyncParams setTolerance(float tolerance) {
        if (tolerance < TonemapCurve.LEVEL_BLACK || tolerance >= 1.0f) {

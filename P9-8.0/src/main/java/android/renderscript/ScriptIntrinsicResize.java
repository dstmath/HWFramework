...
public final class ScriptIntrinsicResize extends ScriptIntrinsic {
    ...
    public void setInput(Allocation ain) {
        ...
        if (e.isCompatible(Element.U8(this.mRS)) || (e.isCompatible(Element.U8_2(this.mRS)) ^ 1) == 0 || (e.isCompatible(Element.U8_3(this.mRS)) ^ 1) == 0 || (e.isCompatible(Element.U8_4(this.mRS)) ^ 1) == 0 || (e.isCompatible(Element.F32(this.mRS)) ^ 1) == 0 || (e.isCompatible(Element.F32_2(this.mRS)) ^ 1) == 0 || (e.isCompatible(Element.F32_3(this.mRS)) ^ 1) == 0 || (e.isCompatible(Element.F32_4(this.mRS)) ^ 1) == 0) {
            this.mInput = ain;

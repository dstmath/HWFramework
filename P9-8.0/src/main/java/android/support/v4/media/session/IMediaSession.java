        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 41:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg02 = (MediaDescriptionCompat) MediaDescriptionCompat.CREATOR.createFromParcel(data);
                    } else {
                        _arg02 = null;
                    }
                    addQueueItem(_arg02);
                ...
                case 42:
                    ...
                    addQueueItemAt(_arg02, data.readInt());
                    reply.writeNoException();
                    return true;
                case 43:
                    data.enforceInterface(DESCRIPTOR);

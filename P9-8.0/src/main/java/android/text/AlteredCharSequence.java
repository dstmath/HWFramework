...
public class AlteredCharSequence implements CharSequence, GetChars {
    ...
    private static class AlteredSpanned extends AlteredCharSequence implements Spanned {
        ...
        /* synthetic */ AlteredSpanned(CharSequence source, char[] sub, int substart, int subend, AlteredSpanned -this4) {
            this(source, sub, substart, subend);
        }

        private AlteredSpanned(CharSequence source, char[] sub, int substart, int subend) {
            super(source, sub, substart, subend, null);
    ...
    /* synthetic */ AlteredCharSequence(CharSequence source, char[] sub, int substart, int subend, AlteredCharSequence -this4) {
        this(source, sub, substart, subend);
    }

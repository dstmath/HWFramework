...
public class SuggestionSpan extends CharacterStyle implements ParcelableSpan {
    ...
    public SuggestionSpan(Context context, Locale locale, String[] suggestions, int flags, Class<?> notificationTargetClass) {
        ...
        this.mLocaleStringForCompatibility = sourceLocale == null ? LogException.NO_VALUE : sourceLocale.toString();
        this.mLanguageTag = sourceLocale == null ? LogException.NO_VALUE : sourceLocale.toLanguageTag();
        if (context != null) {

        ...
        if (pointComponents[1] == 0.0f && pointComponents[2] == 0.0f && pointComponents[pointComponents.length - 2] == 1.0f && pointComponents[pointComponents.length - 1] == 1.0f) {
            ...
            while (i < numPoints) {
                ...
                if (fraction == prevFraction && x != prevX) {
                    ...
                    Log.e(TAG, "x = " + x + " prevX = " + prevX + " pathData = " + this.mPathData + " thread.id = " + Thread.currentThread().getId() + " thread.name = " + Thread.currentThread().getName());
                    int j = 0;
                    int index = 0;
                    while (j < numPoints) {
                        int index2 = index + 1;
                        index = index2 + 1;
                        index2 = index + 1;
                        Log.e(TAG, "error fraction[" + j + "] = " + pointComponents[index] + " x[" + j + "] = " + pointComponents[index2] + " y[" + j + "]" + pointComponents[index]);
                        j++;
                        index = index2;
                    }

            ...
            if (target != null) {
                if (this.drawablesLoaded) {
                    ...
                    if (!this.isRelative) {
                        ...
                        if (id1 != null) {
                            id1.setBounds(0, 0, this.width, this.height);
                        }
                        if (id2 != null) {
                            id2.setBounds(0, 0, this.width, this.height);
                        }
                        if (id3 != null) {
                            id3.setBounds(0, 0, this.width, this.height);
                        }
                        if (id4 != null) {
                            id4.setBounds(0, 0, this.width, this.height);
                        }
    ...
    private class ViewGroupAction extends Action {
        ...
        ViewGroupAction(Parcel parcel, BitmapCache bitmapCache, ApplicationInfo info, int depth) {
            ...
            if (parcel.readInt() == 0) {
                ...
                this.nestedViews = new RemoteViews(parcel, bitmapCache, info, depth, null);
            }
        }

...
abstract class HwVSimSSTBridge extends ServiceStateTracker {
    ...
    public void updateSpnDisplay() {
        ...
        if (!(showPlmn == this.mCurShowPlmn && showSpn == this.mCurShowSpn && (TextUtils.equals(spn, this.mCurSpn) ^ 1) == 0 && (TextUtils.equals(dataSpn, this.mCurDataSpn) ^ 1) == 0 && (TextUtils.equals(plmn, this.mCurPlmn) ^ 1) == 0)) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:91:0x045d  */
    /* JADX WARNING: Removed duplicated region for block: B:69:0x033f  */
    /* JADX WARNING: Removed duplicated region for block: B:78:0x0379  */
    /* JADX WARNING: Removed duplicated region for block: B:82:0x03fe  */

        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 10:
                    ...
                    _result2 = updateAdnRecordsWithContentValuesInEfBySearchHW(_arg0, _arg1, data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 11:
                    ...
                    _result2 = updateAdnRecordsWithContentValuesInEfBySearchUsingSubIdHW(_arg0, _arg12, _arg2, data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 12:

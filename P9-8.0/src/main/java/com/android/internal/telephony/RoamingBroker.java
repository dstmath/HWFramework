...
public class RoamingBroker {
    ...
    private static class HelperHolder {
        private static RoamingBroker mInstance = new RoamingBroker(huawei.com.android.internal.telephony.RoamingBroker.getDefault(), null);

        private HelperHolder() {
        }
    }

    /* synthetic */ RoamingBroker(huawei.com.android.internal.telephony.RoamingBroker roamingBroker, RoamingBroker -this1) {
        this(roamingBroker);
    }

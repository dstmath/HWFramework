...
public class HwVSimDcSwitchStateMachine extends StateMachine {
    ...
    private AttachedState mAttachedState = new AttachedState(this, null);
    private AttachingState mAttachingState = new AttachingState(this, null);
    private DefaultState mDefaultState = new DefaultState(this, null);
    private DetachingState mDetachingState = new DetachingState(this, null);
    private int mId;
    ...
    private class AttachedState extends State {
        /* synthetic */ AttachedState(HwVSimDcSwitchStateMachine this$0, AttachedState -this1) {
            this();
        }
    ...
    private class AttachingState extends State {
        ...
        /* synthetic */ AttachingState(HwVSimDcSwitchStateMachine this$0, AttachingState -this1) {
            this();
        }
    ...
    private class DefaultState extends State {
        /* synthetic */ DefaultState(HwVSimDcSwitchStateMachine this$0, DefaultState -this1) {
            this();
        }
    ...
    private class DetachingState extends State {
        ...
        /* synthetic */ DetachingState(HwVSimDcSwitchStateMachine this$0, DetachingState -this1) {
            this();
        }
    ...
    private class IdleState extends State {
        /* synthetic */ IdleState(HwVSimDcSwitchStateMachine this$0, IdleState -this1) {
            this();
        }

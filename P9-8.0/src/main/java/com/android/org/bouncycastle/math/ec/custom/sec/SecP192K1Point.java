...
public class SecP192K1Point extends AbstractFp {
    ...
    public ECPoint add(ECPoint b) {
        ...
        SecP192K1FieldElement Z1 = this.zs[0];
        ...
        if (Z1IsOne) {
            ...
            S2 = t3;
            SecP192K1Field.square(Z1.x, t3);
            U2 = t2;
            SecP192K1Field.multiply(t3, X2.x, t2);
            SecP192K1Field.multiply(t3, Z1.x, t3);
            SecP192K1Field.multiply(t3, Y2.x, t3);
        }
        ...
        if (!Nat192.isZero(H)) {
            ...
            if (!Z1IsOne) {
                SecP192K1Field.multiply(secP192K1FieldElement.x, Z1.x, secP192K1FieldElement.x);
            }
            if (!Z2IsOne) {
                SecP192K1Field.multiply(secP192K1FieldElement.x, Z2.x, secP192K1FieldElement.x);
            }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP192K1FieldElement Y1 = this.y;
        if (Y1.isZero()) {
            return curve.getInfinity();
        }
        SecP192K1FieldElement X1 = this.x;
        SecP192K1FieldElement Z1 = this.zs[0];

...
public class SecP224K1Point extends AbstractFp {
    ...
    public ECPoint add(ECPoint b) {
        ...
        SecP224K1FieldElement Z1 = this.zs[0];
        ...
        if (Z1IsOne) {
            ...
            S2 = t3;
            SecP224K1Field.square(Z1.x, t3);
            U2 = t2;
            SecP224K1Field.multiply(t3, X2.x, t2);
            SecP224K1Field.multiply(t3, Z1.x, t3);
            SecP224K1Field.multiply(t3, Y2.x, t3);
        }
        ...
        if (!Nat224.isZero(H)) {
            ...
            if (!Z1IsOne) {
                SecP224K1Field.multiply(secP224K1FieldElement.x, Z1.x, secP224K1FieldElement.x);
            }
            if (!Z2IsOne) {
                SecP224K1Field.multiply(secP224K1FieldElement.x, Z2.x, secP224K1FieldElement.x);
            }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP224K1FieldElement Y1 = this.y;
        if (Y1.isZero()) {
            return curve.getInfinity();
        }
        SecP224K1FieldElement X1 = this.x;
        SecP224K1FieldElement Z1 = this.zs[0];

...
public class HwGpsXtraDownloadReceiver implements IHwGpsXtraDownloadReceiver {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:19:0x0092 A:{Catch:{ all -> 0x00a6 }} */
    /* JADX WARNING: Removed duplicated region for block: B:21:0x009d A:{SYNTHETIC, Splitter: B:21:0x009d} */

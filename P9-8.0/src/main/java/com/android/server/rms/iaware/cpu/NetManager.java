...
public class NetManager {
    ...
    private class AwareToastCallback implements IAwareToastCallback {
        /* synthetic */ AwareToastCallback(NetManager this$0, AwareToastCallback -this1) {
            this();
        }
    ...
    private class AwareVisibleCallback implements IAwareVisibleCallback {
        /* synthetic */ AwareVisibleCallback(NetManager this$0, AwareVisibleCallback -this1) {
            this();
        }
    ...
    private void registerVisibleCallback() {
        if (this.mAwareVisibleCallback == null) {
            this.mAwareVisibleCallback = new AwareVisibleCallback(this, null);
        }
    ...
    private void registerToastCallback() {
        if (this.mAwareToastCallback == null) {
            this.mAwareToastCallback = new AwareToastCallback(this, null);
        }

...
public class HwSecurityDiagnosePlugin extends Stub implements IHwSecurityPlugin {
    ...
    private static class QueueParams {
        ...
        /* synthetic */ QueueParams(int reporter, Object arg, QueueParams -this2) {
            this(reporter, arg);
        }
    ...
    private static class RootCheckTrigger extends Thread {
        /* synthetic */ RootCheckTrigger(RootCheckTrigger -this0) {
            this();
        }
    ...
    /* synthetic */ HwSecurityDiagnosePlugin(Context contxt, HwSecurityDiagnosePlugin -this1) {
        this(contxt);
    }

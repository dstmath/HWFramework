...
public class WifiProHistoryRecordManager implements IGetApRecordCount {
    ...
    class ApInfoProcessHandler extends Handler {
        /* synthetic */ ApInfoProcessHandler(WifiProHistoryRecordManager this$0, Looper looper, ApInfoProcessHandler -this2) {
            this(looper);
        }
    ...
    private void initStatHandler() {
        ...
        thread.start();
        this.mApInfoProcessHandler = new ApInfoProcessHandler(this, thread.getLooper(), null);
    }

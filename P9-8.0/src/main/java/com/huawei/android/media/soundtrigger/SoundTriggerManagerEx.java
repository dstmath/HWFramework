...
public class SoundTriggerManagerEx {
    ...
    public static class Model {
        ...
        /* synthetic */ Model(android.media.soundtrigger.SoundTriggerManager.Model model, Model -this1) {
            this(model);
        }
    ...
    public Model getModel(UUID soundModelId) {
        Log.i(TAG, "getModel");
        return new Model(this.mSoundTriggerManager.getModel(soundModelId), null);
    }

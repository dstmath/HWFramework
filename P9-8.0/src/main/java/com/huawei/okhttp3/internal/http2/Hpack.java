    ...
    static final class Writer {
        ...
        void writeHeaders(List<Header> headerBlock) throws IOException {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (headerIndex != -1) {
                    writeInt(headerIndex, Hpack.PREFIX_7_BITS, AppOpsManagerEx.TYPE_MICROPHONE);
                } else if (headerNameIndex == -1) {
        ...
        void writeInt(int value, int prefixMask, int bits) {
            ...
            while (value >= AppOpsManagerEx.TYPE_MICROPHONE) {
                this.out.writeByte((value & Hpack.PREFIX_7_BITS) | AppOpsManagerEx.TYPE_MICROPHONE);
                value >>>= 7;
            }
        ...
        void writeByteString(ByteString data) throws IOException {
            ...
            writeInt(huffmanBytes.size(), Hpack.PREFIX_7_BITS, AppOpsManagerEx.TYPE_MICROPHONE);

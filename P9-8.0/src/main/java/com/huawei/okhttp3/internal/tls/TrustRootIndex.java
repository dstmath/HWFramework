...
public abstract class TrustRootIndex {
    ...
    static final class AndroidTrustRootIndex extends TrustRootIndex {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.trustManager.equals(that.trustManager)) {
                z = this.findByIssuerAndSignatureMethod.equals(that.findByIssuerAndSignatureMethod);
            }
            return z;
        }
    ...
    static final class BasicTrustRootIndex extends TrustRootIndex {
        ...
        public boolean equals(Object other) {
            ...
            boolean equals;
            if (other instanceof BasicTrustRootIndex) {
                equals = ((BasicTrustRootIndex) other).subjectToCaCerts.equals(this.subjectToCaCerts);
            } else {
                equals = false;
            }
            return equals;

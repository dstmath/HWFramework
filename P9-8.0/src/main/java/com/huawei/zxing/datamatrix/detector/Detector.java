...
public final class Detector {
    ...
    private static final class ResultPointsAndTransitions {
        ...
        /* synthetic */ ResultPointsAndTransitions(ResultPoint from, ResultPoint to, int transitions, ResultPointsAndTransitions -this3) {
            this(from, to, transitions);
        }
    ...
    private static final class ResultPointsAndTransitionsComparator implements Comparator<ResultPointsAndTransitions>, Serializable {
        /* synthetic */ ResultPointsAndTransitionsComparator(ResultPointsAndTransitionsComparator -this0) {
            this();
        }

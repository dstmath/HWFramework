...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(4, JlogConstantsEx.JLID_CONTACT_BIND_EDITOR_FOR_NEW), new ECB(4, JlogConstantsEx.JLID_DIALPAD_AFTER_TEXT_CHANGE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, JlogConstantsEx.JLID_DIALPAD_ADAPTER_GET_VIEW), new ECB(5, JlogConstantsEx.JLID_DEF_CONTACT_ITEM_CLICK));
        ...
        iArr = new int[]{6, 28, 54, 80, MetricConstant.WIFI_METRIC_ID_EX};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, JlogConstantsEx.JLID_DIALPAD_AFTER_TEXT_CHANGE), new ECB(4, JlogConstantsEx.JLID_CONTACT_MULTISELECT_ACTIVITY_ONCREATE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(8, MetricConstant.WIFI_METRIC_ID_EX), new ECB(4, MetricConstant.BLUETOOTH_METRIC_ID_EX));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(10, 114), new ECB(2, JlogConstantsEx.JLID_CONTACT_DETAIL_BIND_VIEW));
        ...
        iArr = new int[]{6, 34, 62, 90, JlogConstantsEx.JLID_CONTACT_MULTISELECT_ACTIVITY_ONCREATE};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(8, JlogConstantsEx.JLID_DEF_CONTACT_ITEM_CLICK), new ECB(4, JlogConstantsEx.JLID_NEW_CONTACT_CLICK));
        ...
        iArr = new int[]{6, 26, 50, 74, 98, JlogConstantsEx.JLID_DEF_CONTACT_ITEM_CLICK};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(3, JlogConstantsEx.JLID_DIALPAD_AFTER_TEXT_CHANGE), new ECB(10, JlogConstantsEx.JLID_CONTACT_MULTISELECT_ACTIVITY_ONCREATE));
        ...
        iArr = new int[]{6, 30, 54, 78, 102, JlogConstantsEx.JLID_NEW_CONTACT_SELECT_ACCOUNT};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(7, JlogConstantsEx.JLID_CONTACT_BIND_EDITOR_FOR_NEW), new ECB(7, JlogConstantsEx.JLID_DIALPAD_AFTER_TEXT_CHANGE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, JlogConstantsEx.JLID_CONTACT_DETAIL_BIND_VIEW), new ECB(10, JlogConstantsEx.JLID_CONTACT_BIND_EDITOR_FOR_NEW));
        ...
        iArr = new int[]{6, 30, 56, 82, MetricConstant.GPS_METRIC_ID_EX, SmsConstantsEx.MAX_USER_DATA_BYTES_WITH_HEADER};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(13, JlogConstantsEx.JLID_CONTACT_DETAIL_BIND_VIEW), new ECB(3, JlogConstantsEx.JLID_CONTACT_BIND_EDITOR_FOR_NEW));
        ...
        iArr = new int[]{6, 34, 60, 86, 112, JlogConstantsEx.JLID_MMS_MESSAGES_DELETE};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, JlogConstantsEx.JLID_CONTACT_DETAIL_BIND_VIEW));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, JlogConstantsEx.JLID_CONTACT_DETAIL_BIND_VIEW), new ECB(1, JlogConstantsEx.JLID_CONTACT_BIND_EDITOR_FOR_NEW));
        ...
        iArr = new int[]{6, 34, 62, 90, JlogConstantsEx.JLID_CONTACT_MULTISELECT_ACTIVITY_ONCREATE, 146};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(13, JlogConstantsEx.JLID_CONTACT_DETAIL_BIND_VIEW), new ECB(6, JlogConstantsEx.JLID_CONTACT_BIND_EDITOR_FOR_NEW));
        ...
        iArr = new int[]{6, 30, 54, 78, 102, JlogConstantsEx.JLID_NEW_CONTACT_SELECT_ACCOUNT, 150};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(12, JlogConstantsEx.JLID_DIALPAD_ADAPTER_GET_VIEW), new ECB(7, JlogConstantsEx.JLID_DEF_CONTACT_ITEM_CLICK));
        ...
        iArr = new int[]{6, 24, 50, 76, 102, AppOpsManagerEx.TYPE_MICROPHONE, 154};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, JlogConstantsEx.JLID_DIALPAD_ADAPTER_GET_VIEW), new ECB(14, JlogConstantsEx.JLID_DEF_CONTACT_ITEM_CLICK));
        ...
        iArr = new int[]{6, 28, 54, 80, MetricConstant.WIFI_METRIC_ID_EX, JlogConstantsEx.JLID_EDIT_CONTACT_END, 158};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, JlogConstantsEx.JLID_DEF_CONTACT_ITEM_CLICK), new ECB(4, JlogConstantsEx.JLID_NEW_CONTACT_CLICK));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, JlogConstantsEx.JLID_DEF_CONTACT_ITEM_CLICK), new ECB(18, JlogConstantsEx.JLID_NEW_CONTACT_CLICK));
        ...
        iArr = new int[]{6, 26, 54, 82, 110, JlogConstantsEx.JLID_MMS_MESSAGES_DELETE, 166};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(20, JlogConstantsEx.JLID_DIALPAD_AFTER_TEXT_CHANGE), new ECB(4, JlogConstantsEx.JLID_CONTACT_MULTISELECT_ACTIVITY_ONCREATE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(19, JlogConstantsEx.JLID_CONTACT_MULTISELECT_ACTIVITY_ONCREATE), new ECB(6, JlogConstantsEx.JLID_CONTACT_MULTISELECT_BIND_VIEW));

...
public class QRCodeMatcher {
    ...
    private static final Pattern WEB_URL_QQ = Pattern.compile("(http:\\/\\/mobile.qq.com|mobile.qq:\\/\\/)");
    private static final Pattern WEB_URL_WEIBO = Pattern.compile("(http:\\/\\/weibo.cn|weibo:\\/\\/)");

...
public final class TLSMessageChannel extends MessageChannel implements SIPMessageListener, Runnable, RawMessageChannel {
    ...
    /* JADX WARNING: Missing block: B:37:0x00c4, code:
            monitor-enter(r14.tlsMessageProcessor);
     */
    /* JADX WARNING: Missing block: B:39:?, code:
            r9 = r14.tlsMessageProcessor;
            r9.nConnections--;
            r14.tlsMessageProcessor.notify();
     */
    ...
    /* JADX WARNING: Missing block: B:43:0x00db, code:
            r14.isRunning = false;
            r14.tlsMessageProcessor.remove(r14);
            r9 = r14.tlsMessageProcessor;
            r9.useCount--;
            r14.myParser.close();
     */
    ...
    /* JADX WARNING: Missing block: B:47:?, code:
            gov.nist.core.InternalErrorHandler.handleException(r3);
     */
    /* JADX WARNING: Missing block: B:50:0x00f7, code:
            r14.isRunning = false;
            r14.tlsMessageProcessor.remove(r14);
            r10 = r14.tlsMessageProcessor;
            r10.useCount--;
            r14.myParser.close();
     */

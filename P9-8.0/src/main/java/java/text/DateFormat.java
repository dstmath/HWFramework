...
public abstract class DateFormat extends Format {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.calendar.getFirstDayOfWeek() == other.calendar.getFirstDayOfWeek() && this.calendar.getMinimalDaysInFirstWeek() == other.calendar.getMinimalDaysInFirstWeek() && this.calendar.isLenient() == other.calendar.isLenient() && this.calendar.getTimeZone().lambda$-java_util_function_Predicate_4628(other.calendar.getTimeZone())) {

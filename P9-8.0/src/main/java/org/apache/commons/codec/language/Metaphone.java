        ...
        while (code.length() < getMaxCodeLen() && n < wdsz) {
            ...
            if (symb == 'C' || !isPreviousChar(local, n, symb)) {
                switch (symb) {
                    ...
                    case 'C':
                        if (!isPreviousChar(local, n, 'S') || (isLastChar(wdsz, n) ^ 1) == 0 || this.frontv.indexOf(local.charAt(n + 1)) < 0) {
                    ...
                    case 'R':
                        ...
                        break;
                    case 'G':
                        if (!(isLastChar(wdsz, n + 1) && isNextChar(local, n, 'H')) && ((isLastChar(wdsz, n + 1) || !isNextChar(local, n, 'H') || (isVowel(local, n + 2) ^ 1) == 0) && (n <= 0 || !(regionMatch(local, n, "GN") || regionMatch(local, n, "GNED"))))) {
                            boolean hard;
                            ...
                            if (!isLastChar(wdsz, n) && this.frontv.indexOf(local.charAt(n + 1)) >= 0 && (hard ^ 1) != 0) {
                                code.append('J');
                                break;
                            }
                            code.append('K');

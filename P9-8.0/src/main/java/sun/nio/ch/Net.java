...
public class Net {
    ...
    static void setSocketOption(FileDescriptor fd, ProtocolFamily family, SocketOption<?> name, Object value) throws IOException {
        ...
        if (type == SocketFlow.class) {
            ...
            throw new AssertionError((Object) "Should not reach here");
        } else if ((name == StandardSocketOptions.SO_RCVBUF || name == StandardSocketOptions.SO_SNDBUF) && ((Integer) value).lambda$-java_util_stream_IntPipeline_14709() < 0) {
            throw new IllegalArgumentException("Invalid send/receive buffer size");
        } else {
            int i;
            if (name == StandardSocketOptions.SO_LINGER) {
                i = ((Integer) value).lambda$-java_util_stream_IntPipeline_14709();
                if (i < 0) {
            ...
            int arg = type == Integer.class ? ((Integer) value).lambda$-java_util_stream_IntPipeline_14709() : ((Boolean) value).booleanValue() ? 1 : 0;

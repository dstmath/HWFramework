...
class UnixFileAttributes implements PosixFileAttributes {
    ...
    public Set<PosixFilePermission> permissions() {
        ...
        if ((UnixConstants.S_IRUSR & bits) > 0) {
            perms.-java_util_stream_DistinctOps$1-mthref-1(PosixFilePermission.OWNER_READ);
        }
        if ((UnixConstants.S_IWUSR & bits) > 0) {
            perms.-java_util_stream_DistinctOps$1-mthref-1(PosixFilePermission.OWNER_WRITE);
        }
        if ((UnixConstants.S_IXUSR & bits) > 0) {
            perms.-java_util_stream_DistinctOps$1-mthref-1(PosixFilePermission.OWNER_EXECUTE);
        }
        if ((UnixConstants.S_IRGRP & bits) > 0) {
            perms.-java_util_stream_DistinctOps$1-mthref-1(PosixFilePermission.GROUP_READ);
        }
        if ((UnixConstants.S_IWGRP & bits) > 0) {
            perms.-java_util_stream_DistinctOps$1-mthref-1(PosixFilePermission.GROUP_WRITE);
        }
        if ((UnixConstants.S_IXGRP & bits) > 0) {
            perms.-java_util_stream_DistinctOps$1-mthref-1(PosixFilePermission.GROUP_EXECUTE);
        }
        if ((UnixConstants.S_IROTH & bits) > 0) {
            perms.-java_util_stream_DistinctOps$1-mthref-1(PosixFilePermission.OTHERS_READ);
        }
        if ((UnixConstants.S_IWOTH & bits) > 0) {
            perms.-java_util_stream_DistinctOps$1-mthref-1(PosixFilePermission.OTHERS_WRITE);
        }
        if ((UnixConstants.S_IXOTH & bits) > 0) {
            perms.-java_util_stream_DistinctOps$1-mthref-1(PosixFilePermission.OTHERS_EXECUTE);
        }
        return perms;
    }

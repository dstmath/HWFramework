...
public class PolicyInformation {
        ...
        if (val.data.available() != 0) {
            ...
            if (opt.tag != (byte) 48) {
                ...
                while (opt.data.available() != 0) {
                    this.policyQualifiers.-java_util_stream_Collectors-mthref-4(new PolicyQualifierInfo(opt.data.getDerValue().toByteArray()));
                }
                return;
            }
        }
    ...
    public String toString() {
        ...
        return s.-java_util_stream_Collectors-mthref-7();
    }

...
public interface IRadio extends android.hardware.radio.V1_0.IRadio {
    ...
    void getCdmaChrInfo(int i) throws RemoteException;
    ...
    void setHwRFChannelSwitch(int i, int i2) throws RemoteException;
    ...
    void setRatCombinePrio(int i, int i2) throws RemoteException;

    void setResponseFunctionsHuawei(IRadioResponse iRadioResponse, IRadioIndication iRadioIndication) throws RemoteException;

    void setRiseCdmaCutoffFreq(int i, boolean z) throws RemoteException;
    ...
    void setVsimTEEDataReady(int i, int i2, int i3, int i4) throws RemoteException;
    ...
    void simlockNwDataWrite(int i, int i2, String str) throws RemoteException;

    void switchImsWaitingOrHoldingAndActiveWithType(int i, int i2) throws RemoteException;

    void testVoiceLoopback(int i, int i2) throws RemoteException;

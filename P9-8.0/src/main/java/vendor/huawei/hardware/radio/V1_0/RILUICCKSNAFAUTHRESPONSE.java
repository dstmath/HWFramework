...
public final class RILUICCKSNAFAUTHRESPONSE {
    ...
    public final boolean equals(Object otherObject) {
        ...
        return this.authStatus == other.authStatus && this.ksLen == other.ksLen && HidlSupport.deepEquals(this.ksNaf, other.ksNaf);
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.ksLen = _hidl_blob.getInt32(4 + _hidl_offset);
        this.ksNaf = _hidl_blob.getString(_hidl_offset + 8);
        parcel.readEmbeddedBuffer((long) (this.ksNaf.getBytes().length + 1), _hidl_blob.handle(), 0 + (_hidl_offset + 8), false);
    }

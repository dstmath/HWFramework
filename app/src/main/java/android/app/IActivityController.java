        ...
        private static class Proxy implements IActivityController {
            ...
            public boolean activityStarting(Intent intent, String pkg) throws RemoteException {
                ...
                try {
                    ...
                    if (intent != null) {
                        _data.writeInt(Stub.TRANSACTION_activityStarting);
                        intent.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
                    _data.writeString(pkg);
                    this.mRemote.transact(Stub.TRANSACTION_activityStarting, _data, _reply, 0);
            ...
            public boolean activityResuming(String pkg) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(pkg);
                    this.mRemote.transact(Stub.TRANSACTION_activityResuming, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean appCrashed(String processName, int pid, String shortMsg, String longMsg, long timeMillis, String stackTrace) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_appCrashed, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public int appEarlyNotResponding(String processName, int pid, String annotation) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_appEarlyNotResponding, _data, _reply, 0);
                    _reply.readException();
            ...
            public int appNotResponding(String processName, int pid, String processStats) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_appNotResponding, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int systemNotResponding(String msg) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_systemNotResponding, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case TRANSACTION_activityStarting /*1*/:
                    ...
                    reply.writeInt(_result ? TRANSACTION_activityStarting : 0);
                    return true;

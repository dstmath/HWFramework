...
public class Presentation extends Dialog {
    ...
    static class AnonymousClass3 extends ContextThemeWrapper {
        ...
        AnonymousClass3(Context $anonymous0, int $anonymous1, WindowManagerImpl val$displayWindowManager) {
            this.val$displayWindowManager = val$displayWindowManager;
            super($anonymous0, $anonymous1);
        }

        public Object getSystemService(String name) {
            if (AppAssociate.ASSOC_WINDOW.equals(name)) {
    ...
    public Presentation(Context outerContext, Display display, int theme) {
        ...
        this.mHandler = new Handler() {
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case Presentation.MSG_CANCEL /*1*/:
        ...
        getWindow().setGravity(BluetoothAssignedNumbers.LAIRD_TECHNOLOGIES);
    ...
    private static Context createPresentationContext(Context outerContext, Display display, int theme) {
        if (outerContext == null) {
            ...
            return new AnonymousClass3(displayContext, theme, ((WindowManagerImpl) outerContext.getSystemService(AppAssociate.ASSOC_WINDOW)).createPresentationWindowManager(displayContext));
        }
    }
}

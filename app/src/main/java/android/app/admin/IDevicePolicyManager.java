        ...
        private static class Proxy implements IDevicePolicyManager {
            ...
            public boolean isProfileActivePasswordSufficientForParent(int userHandle) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(userHandle);
                    this.mRemote.transact(Stub.TRANSACTION_isProfileActivePasswordSufficientForParent, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public long getMaximumTimeToLockForUserAndProfiles(int userHandle) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(userHandle);
                    this.mRemote.transact(Stub.TRANSACTION_getMaximumTimeToLockForUserAndProfiles, _data, _reply, 0);
                    _reply.readException();
                    long _result = _reply.readLong();
                    return _result;
                } finally {
            ...
            public boolean requestBugreport(ComponentName who) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_requestBugreport, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public void forceRemoveActiveAdmin(ComponentName policyReceiver, int userHandle) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(userHandle);
                    this.mRemote.transact(Stub.TRANSACTION_forceRemoveActiveAdmin, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void reportPasswordChanged(int userId) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_reportPasswordChanged, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void reportFailedFingerprintAttempt(int userHandle) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(userHandle);
                    this.mRemote.transact(Stub.TRANSACTION_reportFailedFingerprintAttempt, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void reportSuccessfulFingerprintAttempt(int userHandle) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(userHandle);
                    this.mRemote.transact(Stub.TRANSACTION_reportSuccessfulFingerprintAttempt, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void reportKeyguardDismissed(int userHandle) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(userHandle);
                    this.mRemote.transact(Stub.TRANSACTION_reportKeyguardDismissed, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void reportKeyguardSecured(int userHandle) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(userHandle);
                    this.mRemote.transact(Stub.TRANSACTION_reportKeyguardSecured, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public ComponentName getDeviceOwnerComponent(boolean callingUserOnly) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_getDeviceOwnerComponent, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        componentName = (ComponentName) ComponentName.CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public int getDeviceOwnerUserId() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getDeviceOwnerUserId, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public void setDeviceOwnerLockScreenInfo(ComponentName who, CharSequence deviceOwnerInfo) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setDeviceOwnerLockScreenInfo, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public CharSequence getDeviceOwnerLockScreenInfo() throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getDeviceOwnerLockScreenInfo, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
            ...
            public String[] setPackagesSuspended(ComponentName admin, String[] packageNames, boolean suspended) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setPackagesSuspended, _data, _reply, 0);
                    _reply.readException();
            ...
            public boolean isPackageSuspended(ComponentName admin, String packageName) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(packageName);
                    this.mRemote.transact(Stub.TRANSACTION_isPackageSuspended, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public void uninstallCaCerts(ComponentName admin, String[] aliases) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_uninstallCaCerts, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean approveCaCert(String alias, int userHandle, boolean approval) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_approveCaCert, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean isCaCertApproved(String alias, int userHandle) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(alias);
                    _data.writeInt(userHandle);
                    this.mRemote.transact(Stub.TRANSACTION_isCaCertApproved, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public void choosePrivateKeyAlias(int uid, Uri uri, String alias, IBinder aliasCallback) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_choosePrivateKeyAlias, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setCertInstallerPackage(ComponentName who, String installerPackage) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setCertInstallerPackage, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public String getCertInstallerPackage(ComponentName who) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getCertInstallerPackage, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public boolean setApplicationRestrictionsManagingPackage(ComponentName admin, String packageName) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(packageName);
                    this.mRemote.transact(Stub.TRANSACTION_setApplicationRestrictionsManagingPackage, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public String getApplicationRestrictionsManagingPackage(ComponentName admin) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getApplicationRestrictionsManagingPackage, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public boolean isCallerApplicationRestrictionsManagingPackage() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_isCallerApplicationRestrictionsManagingPackage, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean isAccessibilityServicePermittedByAdmin(ComponentName admin, String packageName, int userId) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(packageName);
                    _data.writeInt(userId);
                    this.mRemote.transact(Stub.TRANSACTION_isAccessibilityServicePermittedByAdmin, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean isInputMethodPermittedByAdmin(ComponentName admin, String packageName, int userId) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(packageName);
                    _data.writeInt(userId);
                    this.mRemote.transact(Stub.TRANSACTION_isInputMethodPermittedByAdmin, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public UserHandle createAndManageUser(ComponentName who, String name, ComponentName profileOwner, PersistableBundle adminExtras, int flags) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(flags);
                    this.mRemote.transact(Stub.TRANSACTION_createAndManageUser, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
            ...
            public void setCrossProfileContactsSearchDisabled(ComponentName who, boolean disabled) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setCrossProfileContactsSearchDisabled, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean getCrossProfileContactsSearchDisabled(ComponentName who) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getCrossProfileContactsSearchDisabled, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean getCrossProfileContactsSearchDisabledForUser(int userId) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(userId);
                    this.mRemote.transact(Stub.TRANSACTION_getCrossProfileContactsSearchDisabledForUser, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public void startManagedQuickContact(String lookupKey, long contactId, boolean isContactIdIgnored, long directoryId, Intent originalIntent) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_startManagedQuickContact, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setBluetoothContactSharingDisabled(ComponentName who, boolean disabled) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setBluetoothContactSharingDisabled, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean getBluetoothContactSharingDisabled(ComponentName who) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getBluetoothContactSharingDisabled, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean getBluetoothContactSharingDisabledForUser(int userId) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(userId);
                    this.mRemote.transact(Stub.TRANSACTION_getBluetoothContactSharingDisabledForUser, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setForceEphemeralUsers(ComponentName who, boolean forceEpehemeralUsers) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setForceEphemeralUsers, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean getForceEphemeralUsers(ComponentName who) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getForceEphemeralUsers, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setSystemUpdatePolicy(ComponentName who, SystemUpdatePolicy policy) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setSystemUpdatePolicy, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public SystemUpdatePolicy getSystemUpdatePolicy() throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getSystemUpdatePolicy, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
            ...
            public boolean setKeyguardDisabled(ComponentName admin, boolean disabled) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setKeyguardDisabled, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean setStatusBarDisabled(ComponentName who, boolean disabled) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setStatusBarDisabled, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean getDoNotAskCredentialsOnBoot() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getDoNotAskCredentialsOnBoot, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public void notifyPendingSystemUpdate(long updateReceivedTime) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_notifyPendingSystemUpdate, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setPermissionPolicy(ComponentName admin, int policy) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setPermissionPolicy, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public int getPermissionPolicy(ComponentName admin) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getPermissionPolicy, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public boolean setPermissionGrantState(ComponentName admin, String packageName, String permission, int grantState) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setPermissionGrantState, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public int getPermissionGrantState(ComponentName admin, String packageName, String permission) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(packageName);
                    _data.writeString(permission);
                    this.mRemote.transact(Stub.TRANSACTION_getPermissionGrantState, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public boolean isProvisioningAllowed(String action) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_isProvisioningAllowed, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setKeepUninstalledPackages(ComponentName admin, List<String> packageList) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setKeepUninstalledPackages, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public List<String> getKeepUninstalledPackages(ComponentName admin) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getKeepUninstalledPackages, _data, _reply, 0);
                    _reply.readException();
                    List<String> _result = _reply.createStringArrayList();
                    return _result;
                } finally {
            ...
            public boolean isSystemOnlyUser(ComponentName admin) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_isSystemOnlyUser, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public String getWifiMacAddress(ComponentName admin) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getWifiMacAddress, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public void setShortSupportMessage(ComponentName admin, CharSequence message) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setShortSupportMessage, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public CharSequence getShortSupportMessage(ComponentName admin) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getShortSupportMessage, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        charSequence = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public void setLongSupportMessage(ComponentName admin, CharSequence message) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setLongSupportMessage, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public CharSequence getLongSupportMessage(ComponentName admin) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getLongSupportMessage, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        charSequence = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public CharSequence getShortSupportMessageForUser(ComponentName admin, int userHandle) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(userHandle);
                    this.mRemote.transact(Stub.TRANSACTION_getShortSupportMessageForUser, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        charSequence = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public CharSequence getLongSupportMessageForUser(ComponentName admin, int userHandle) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(userHandle);
                    this.mRemote.transact(Stub.TRANSACTION_getLongSupportMessageForUser, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        charSequence = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public boolean isSeparateProfileChallengeAllowed(int userHandle) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(userHandle);
                    this.mRemote.transact(Stub.TRANSACTION_isSeparateProfileChallengeAllowed, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setOrganizationColor(ComponentName admin, int color) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setOrganizationColor, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setOrganizationColorForUser(int color, int userId) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(color);
                    _data.writeInt(userId);
                    this.mRemote.transact(Stub.TRANSACTION_setOrganizationColorForUser, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public int getOrganizationColor(ComponentName admin) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getOrganizationColor, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getOrganizationColorForUser(int userHandle) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(userHandle);
                    this.mRemote.transact(Stub.TRANSACTION_getOrganizationColorForUser, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public void setOrganizationName(ComponentName admin, CharSequence title) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setOrganizationName, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public CharSequence getOrganizationName(ComponentName admin) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getOrganizationName, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        charSequence = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public CharSequence getOrganizationNameForUser(int userHandle) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(userHandle);
                    this.mRemote.transact(Stub.TRANSACTION_getOrganizationNameForUser, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        charSequence = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public int getUserProvisioningState() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getUserProvisioningState, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public void setUserProvisioningState(int state, int userHandle) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(userHandle);
                    this.mRemote.transact(Stub.TRANSACTION_setUserProvisioningState, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setAffiliationIds(ComponentName admin, List<String> ids) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setAffiliationIds, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean isAffiliatedUser() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_isAffiliatedUser, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setSecurityLoggingEnabled(ComponentName admin, boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setSecurityLoggingEnabled, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean isSecurityLoggingEnabled(ComponentName admin) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_isSecurityLoggingEnabled, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public ParceledListSlice retrieveSecurityLogs(ComponentName admin) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_retrieveSecurityLogs, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
            ...
            public ParceledListSlice retrievePreRebootSecurityLogs(ComponentName admin) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_retrievePreRebootSecurityLogs, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        parceledListSlice = (ParceledListSlice) ParceledListSlice.CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public boolean isUninstallInQueue(String packageName) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(packageName);
                    this.mRemote.transact(Stub.TRANSACTION_isUninstallInQueue, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public void uninstallPackageWithActiveAdmins(String packageName) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(packageName);
                    this.mRemote.transact(Stub.TRANSACTION_uninstallPackageWithActiveAdmins, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.app.admin.IDevicePolicyManager.Stub.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.app.admin.IDevicePolicyManager.Stub.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean

        ...
        private static class Proxy implements IJobService {
            ...
            public void startJob(JobParameters jobParams) throws RemoteException {
                ...
                try {
                    ...
                    if (jobParams != null) {
                        _data.writeInt(Stub.TRANSACTION_startJob);
                        jobParams.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
                    this.mRemote.transact(Stub.TRANSACTION_startJob, _data, null, Stub.TRANSACTION_startJob);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void stopJob(JobParameters jobParams) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_stopJob, _data, null, Stub.TRANSACTION_startJob);
                } finally {
                    _data.recycle();
                }
            }

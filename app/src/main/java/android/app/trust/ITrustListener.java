    ...
    public static abstract class Stub extends Binder implements ITrustListener {
        ...
        private static class Proxy implements ITrustListener {
            ...
            public void onTrustChanged(boolean enabled, int userId, int flags) throws RemoteException {
                int i = Stub.TRANSACTION_onTrustChanged;
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onTrustChanged, _data, null, Stub.TRANSACTION_onTrustChanged);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onTrustManagedChanged(boolean managed, int userId) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    _data.writeInt(userId);
                    this.mRemote.transact(Stub.TRANSACTION_onTrustManagedChanged, _data, null, Stub.TRANSACTION_onTrustChanged);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_onTrustChanged /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    onTrustChanged(data.readInt() != 0, data.readInt(), data.readInt());
                    return true;
                case TRANSACTION_onTrustManagedChanged /*2*/:
                    data.enforceInterface(DESCRIPTOR);

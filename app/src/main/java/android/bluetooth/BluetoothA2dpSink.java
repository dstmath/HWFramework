        ...
        this.mConnection = new ServiceConnection() {
            public void onServiceConnected(ComponentName className, IBinder service) {
                ...
                if (BluetoothA2dpSink.this.mServiceListener != null) {
                    BluetoothA2dpSink.this.mServiceListener.onServiceConnected(BluetoothA2dpSink.STATE_NOT_PLAYING, BluetoothA2dpSink.this);
                }
            }
            ...
            public void onServiceDisconnected(ComponentName className) {
                ...
                BluetoothA2dpSink.this.mService = null;
                if (BluetoothA2dpSink.this.mServiceListener != null) {
                    BluetoothA2dpSink.this.mServiceListener.onServiceDisconnected(BluetoothA2dpSink.STATE_NOT_PLAYING);
                }
            }
        };

        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_terminateCall /*17*/:
                    ...
                    _result = terminateCall(bluetoothDevice, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? TRANSACTION_connect : 0);
                    return true;
                ...
                case TRANSACTION_redial /*20*/:
                    ...
                    _result = redial(bluetoothDevice);
                    reply.writeNoException();
                    reply.writeInt(_result ? TRANSACTION_connect : 0);
                    return true;
                case TRANSACTION_dial /*21*/:
                    ...
                    _result = dial(bluetoothDevice, data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result ? TRANSACTION_connect : 0);
                    return true;
                case TRANSACTION_dialMemory /*22*/:
                    ...
                    _result = dialMemory(bluetoothDevice, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? TRANSACTION_connect : 0);
                    return true;
                ...
                case TRANSACTION_disconnectAudio /*27*/:
                    ...
                    reply.writeInt(_result ? TRANSACTION_connect : 0);
                    return true;
                case TRANSACTION_setAudioRouteAllowed /*28*/:
                    data.enforceInterface(DESCRIPTOR);
                    setAudioRouteAllowed(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getAudioRouteAllowed /*29*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getAudioRouteAllowed();
                    reply.writeNoException();
                    reply.writeInt(_result ? TRANSACTION_connect : 0);
                    return true;
                case TRANSACTION_getCurrentAgFeatures /*30*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        bluetoothDevice = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {

...
public interface ICoverViewDelegate extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICoverViewDelegate {
        ...
        private static class Proxy implements ICoverViewDelegate {
            ...
            public void addCoverScreenWindow() throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_addCoverScreenWindow, _data, _reply, 0);
            ...
            public void removeCoverScreenWindow() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_removeCoverScreenWindow, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_addCoverScreenWindow /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    addCoverScreenWindow();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_removeCoverScreenWindow /*2*/:
                    data.enforceInterface(DESCRIPTOR);

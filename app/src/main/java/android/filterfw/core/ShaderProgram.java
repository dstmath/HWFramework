...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.filterfw.core.ShaderProgram.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.filterfw.core.ShaderProgram.<clinit>():void
...
*/
    ...
    private static GLEnvironment getGLEnvironment(FilterContext context) {
        GLEnvironment result = null;
        if (context != null) {
            result = context.getGLEnvironment();
        }
        if (result != null) {
            return result;
        }

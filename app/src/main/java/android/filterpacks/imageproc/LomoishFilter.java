...
public class LomoishFilter extends Filter {
    ...
    private void initParameters() {
        if (this.mProgram != null) {
            ...
            this.mProgram.setHostValue("stepsizeX", Float.valueOf(Engine.DEFAULT_VOLUME / ((float) this.mWidth)));
            this.mProgram.setHostValue("stepsizeY", Float.valueOf(Engine.DEFAULT_VOLUME / ((float) this.mHeight)));

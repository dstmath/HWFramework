...
public interface ICameraServiceProxy extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICameraServiceProxy {
        ...
        private static class Proxy implements ICameraServiceProxy {
            ...
            public void pingForUserUpdate() throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_pingForUserUpdate, _data, null, Stub.TRANSACTION_pingForUserUpdate);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void notifyCameraState(String cameraId, int newCameraState) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_notifyCameraState, _data, null, Stub.TRANSACTION_pingForUserUpdate);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_pingForUserUpdate /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    pingForUserUpdate();
                    return true;
                case TRANSACTION_notifyCameraState /*2*/:
                    data.enforceInterface(DESCRIPTOR);

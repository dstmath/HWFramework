...
public class LegacyRequestMapper {
    ...
    public static void convertRequestMetadata(LegacyRequest legacyRequest) {
        ...
        if (antiBandingMode != null) {
            ...
            legacyMode = (String) ListUtils.listSelectFirstFrom(params.getSupportedAntibanding(), new String[]{CalendarCache.TIMEZONE_TYPE_AUTO, Parameters.FLASH_MODE_OFF, Parameters.ANTIBANDING_50HZ, Parameters.ANTIBANDING_60HZ});
        }
        if (legacyMode != null) {
        ...
        if (aeFpsRange != null) {
            ...
            for (int[] range : params.getSupportedPreviewFpsRange()) {
                int intRangeHigh = ((int) Math.ceil(((double) range[1]) / 1000.0d)) * Process.SYSTEM_UID;
                if (legacyFps[0] == ((int) Math.floor(((double) range[0]) / 1000.0d)) * Process.SYSTEM_UID && legacyFps[1] == intRangeHigh) {
                    rangeToApply = range;
                    break;
                }
            }
        ...
        Boolean aeLock = (Boolean) getIfSupported(request, CaptureRequest.CONTROL_AE_LOCK, Boolean.valueOf(DEBUG), params.isAutoExposureLockSupported(), Boolean.valueOf(DEBUG));
        if (aeLock != null) {
        ...
        Integer awbMode = (Integer) getIfSupported(request, CaptureRequest.CONTROL_AWB_MODE, Integer.valueOf(1), params.getSupportedWhiteBalance() != null ? true : DEBUG, Integer.valueOf(1));
        if (awbMode != null) {
            params.setWhiteBalance(convertAwbModeToLegacy(awbMode.intValue()));
        }
        Boolean awbLock = (Boolean) getIfSupported(request, CaptureRequest.CONTROL_AWB_LOCK, Boolean.valueOf(DEBUG), params.isAutoWhiteBalanceLockSupported(), Boolean.valueOf(DEBUG));
        if (awbLock != null) {
        ...
        boolean z = captureIntent != 3 ? captureIntent == 4 ? true : DEBUG : true;
        ...
        if (stabMode != null) {
            params.setVideoStabilization(stabMode.intValue() == 1 ? true : DEBUG);
        }
        ...
        if (params.getSupportedSceneModes() != null) {
            ...
            switch (controlMode) {
                case AudioState.ROUTE_EARPIECE /*1*/:
                    modeToSet = CalendarCache.TIMEZONE_TYPE_AUTO;
                    break;
        ...
        if (params.getSupportedColorEffects() != null) {
            ...
            if (legacyEffectMode != null) {
                ...
                params.setColorEffect(NetworkPolicyManager.FIREWALL_CHAIN_NAME_NONE);
        ...
        params.setJpegQuality(((Byte) ParamsUtils.getOrDefault(request, CaptureRequest.JPEG_QUALITY, Byte.valueOf(DEFAULT_JPEG_QUALITY))).byteValue() & Process.PROC_TERM_MASK);
        params.setJpegThumbnailQuality(((Byte) ParamsUtils.getOrDefault(request, CaptureRequest.JPEG_THUMBNAIL_QUALITY, Byte.valueOf(DEFAULT_JPEG_QUALITY))).byteValue() & Process.PROC_TERM_MASK);
        ...
        if (sizes != null && sizes.size() > 0) {
            ...
            if (s != null) {
                if (!ParameterUtils.containsSize(sizes, s.getWidth(), s.getHeight())) {
                    invalidSize = true;
                    if (invalidSize) {
    ...
    private static boolean checkForCompleteGpsData(Location location) {
        return (location == null || location.getProvider() == null || location.getTime() == 0) ? DEBUG : true;
    }
    ...
    private static void mapAeAndFlashMode(CaptureRequest r, Parameters p) {
        ...
        if (aeMode == 1) {
            ...
            if (ListUtils.listContains(supportedFlashModes, CalendarCache.TIMEZONE_TYPE_AUTO)) {
                flashModeSetting = CalendarCache.TIMEZONE_TYPE_AUTO;
            } else {
    ...
    private static int[] convertAeFpsRangeToLegacy(Range<Integer> fpsRange) {
        return new int[]{((Integer) fpsRange.getLower()).intValue() * Process.SYSTEM_UID, ((Integer) fpsRange.getUpper()).intValue() * Process.SYSTEM_UID};
    }

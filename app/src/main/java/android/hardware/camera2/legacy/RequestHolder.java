...
public class RequestHolder {
    ...
    public static final class Builder {
        ...
        public RequestHolder build(long frameNumber) {
            return new RequestHolder(this.mSubsequenceId, this.mRequest, this.mRepeating, frameNumber, this.mNumJpegTargets, this.mNumPreviewTargets, this.mJpegSurfaceIds, null);
        }
    }

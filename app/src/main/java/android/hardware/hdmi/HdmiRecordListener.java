    ...
    public static class TimerStatusData {
        ...
        static TimerStatusData parseFrom(int result) {
            ...
            if (data.mProgrammed) {
                ...
                data.mDurationHour = bcdByteToInt((byte) ((result >> 16) & Process.PROC_TERM_MASK));
                data.mDurationMinute = bcdByteToInt((byte) ((result >> 8) & Process.PROC_TERM_MASK));
            } else {
                data.mNotProgrammedError = (result >> 24) & 15;
                data.mDurationHour = bcdByteToInt((byte) ((result >> 16) & Process.PROC_TERM_MASK));
                data.mDurationMinute = bcdByteToInt((byte) ((result >> 8) & Process.PROC_TERM_MASK));
            }
            data.mExtraError = result & Process.PROC_TERM_MASK;
            return data;
        }

...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.icu.impl.duration.impl.ResourceBasedPeriodFormatterDataService.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.icu.impl.duration.impl.ResourceBasedPeriodFormatterDataService.<clinit>():void
                ...
                if (ld == null) {
                    ...
                    if (ln != null) {
                        ...
                        try {
                            ...
                            throw new MissingResourceException("Unhandled encoding for resource " + name, name, XmlPullParser.NO_NAMESPACE);
                        } catch (IOException e2) {

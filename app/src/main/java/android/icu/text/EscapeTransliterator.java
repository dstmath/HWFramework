    ...
    static void register() {
        Transliterator.registerFactory("Any-Hex/Unicode", new Factory() {
            public Transliterator getInstance(String ID) {
                return new EscapeTransliterator("Any-Hex/Unicode", "U+", XmlPullParser.NO_NAMESPACE, 16, 4, true, null);
            }
        });
        Transliterator.registerFactory("Any-Hex/Java", new Factory() {
            public Transliterator getInstance(String ID) {
                return new EscapeTransliterator("Any-Hex/Java", "\\u", XmlPullParser.NO_NAMESPACE, 16, 4, false, null);
            }
        });
        Transliterator.registerFactory("Any-Hex/C", new Factory() {
            public Transliterator getInstance(String ID) {
                return new EscapeTransliterator("Any-Hex/C", "\\u", XmlPullParser.NO_NAMESPACE, 16, 4, true, new EscapeTransliterator(XmlPullParser.NO_NAMESPACE, "\\U", XmlPullParser.NO_NAMESPACE, 16, 8, true, null));
            }
        });
        ...
        Transliterator.registerFactory("Any-Hex/Plain", new Factory() {
            public Transliterator getInstance(String ID) {
                return new EscapeTransliterator("Any-Hex/Plain", XmlPullParser.NO_NAMESPACE, XmlPullParser.NO_NAMESPACE, 16, 4, true, null);
            }
        });
        Transliterator.registerFactory("Any-Hex", new Factory() {
            public Transliterator getInstance(String ID) {
                return new EscapeTransliterator("Any-Hex", "\\u", XmlPullParser.NO_NAMESPACE, 16, 4, false, null);
            }
        });
    }

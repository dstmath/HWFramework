...
/*
                Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.icu.text.MessagePatternUtil.MessageContentsNode.Type.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.icu.text.MessagePatternUtil.MessageContentsNode.Type.<clinit>():void
...
*/
    ...
    public static class ComplexArgStyleNode extends Node {
        ...
        /* synthetic */ ComplexArgStyleNode(ArgType argType, ComplexArgStyleNode complexArgStyleNode) {
            this(argType);
        }
    ...
    public static class TextNode extends MessageContentsNode {
        ...
        /* synthetic */ TextNode(String text, TextNode textNode) {
            this(text);
        }
    ...
    public static class VariantNode extends Node {
        ...
        public boolean isSelectorNumeric() {
            return this.numericValue != MessagePattern.NO_NUMERIC_VALUE;
        }
        ...
        private VariantNode() {
            super();
            this.numericValue = MessagePattern.NO_NUMERIC_VALUE;
        }
    }

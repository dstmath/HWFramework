...
class NameUnicodeTransliterator extends Transliterator {
    ...
    public void addSourceTargetSet(UnicodeSet inputFilter, UnicodeSet sourceSet, UnicodeSet targetSet) {
        ...
        if (myFilter.containsAll("\\N{") && myFilter.contains((int) Opcodes.OP_NEG_LONG)) {
            UnicodeSet items = new UnicodeSet().addAll(48, 57).addAll(65, 70).addAll(97, UScript.INSCRIPTIONAL_PAHLAVI).add(60).add(62).add(40).add(41).add(45).add(32).addAll((CharSequence) "\\N{").add((int) Opcodes.OP_NEG_LONG);

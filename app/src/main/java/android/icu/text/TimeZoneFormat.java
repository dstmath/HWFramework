...
public class TimeZoneFormat extends UFormat implements Freezable<TimeZoneFormat>, Serializable {
    ...
    private static class GMTOffsetField {
        ...
        static boolean isValid(char type, int width) {
            return (width == 1 || width == 2) ? true : TimeZoneFormat.-assertionsDisabled;
        }
    }
...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.icu.text.TimeZoneFormat.GMTOffsetPatternType.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.icu.text.TimeZoneFormat.GMTOffsetPatternType.<clinit>():void
...
*/
    ...
    private enum OffsetFields {
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.icu.text.TimeZoneFormat.OffsetFields.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.icu.text.TimeZoneFormat.OffsetFields.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 0073
...
*/
    ...
    public enum ParseOption {
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.icu.text.TimeZoneFormat.ParseOption.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.icu.text.TimeZoneFormat.ParseOption.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 0073
...
*/
    ...
    public enum Style {
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.icu.text.TimeZoneFormat.Style.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.icu.text.TimeZoneFormat.Style.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 0073
...
*/
    ...
    public enum TimeType {
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.icu.text.TimeZoneFormat.TimeType.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.icu.text.TimeZoneFormat.TimeType.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 0073
...
*/
    ...
    private static class TimeZoneFormatCache extends SoftCache<ULocale, TimeZoneFormat, ULocale> {
        ...
        protected /* bridge */ /* synthetic */ Object createInstance(Object key, Object data) {
            return createInstance((ULocale) key, (ULocale) data);
        }
    ...
    static {
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.icu.text.TimeZoneFormat.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	at jadx.core.ProcessClass.processDependencies(ProcessClass.java:59)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.icu.text.TimeZoneFormat.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 7 more
...
*/
    ...
    public final String formatOffsetISO8601Extended(int offset, boolean useUtcIndicator, boolean isShort, boolean ignoreSeconds) {
        return formatOffsetISO8601(offset, -assertionsDisabled, useUtcIndicator, isShort, ignoreSeconds);
    }

    public String formatOffsetLocalizedGMT(int offset) {
        return formatOffsetLocalizedGMT(offset, -assertionsDisabled);
    }
    ...
    public String format(Style style, TimeZone tz, long date, Output<TimeType> timeType) {
        ...
        boolean noOffsetFormatFallback = -assertionsDisabled;
        ...
        if (result == null && !noOffsetFormatFallback) {
            ...
            switch (-getandroid-icu-text-TimeZoneFormat$StyleSwitchesValues()[style.ordinal()]) {
                ...
                case XmlPullParser.CDSECT /*5*/:
                    result = formatOffsetISO8601Basic(offset, true, -assertionsDisabled, true);
                    break;
                case XmlPullParser.ENTITY_REF /*6*/:
                    result = formatOffsetISO8601Basic(offset, true, -assertionsDisabled, -assertionsDisabled);
                    break;
                case XmlPullParser.IGNORABLE_WHITESPACE /*7*/:
                    result = formatOffsetISO8601Basic(offset, -assertionsDisabled, -assertionsDisabled, true);
                    break;
                case NodeFilter.SHOW_CDATA_SECTION /*8*/:
                    result = formatOffsetISO8601Basic(offset, -assertionsDisabled, -assertionsDisabled, -assertionsDisabled);
                    break;
                case XmlPullParser.COMMENT /*9*/:
                    result = formatOffsetISO8601Basic(offset, -assertionsDisabled, true, true);
                    break;
                case XmlPullParser.DOCDECL /*10*/:
                    result = formatOffsetISO8601Basic(offset, true, true, true);
                    break;
                case ICU.U_TRUNCATED_CHAR_FOUND /*11*/:
                    result = formatOffsetISO8601Extended(offset, true, -assertionsDisabled, true);
                    break;
                case ICU.U_ILLEGAL_CHAR_FOUND /*12*/:
                    result = formatOffsetISO8601Extended(offset, true, -assertionsDisabled, -assertionsDisabled);
                    break;
                case Opcodes.OP_MOVE_EXCEPTION /*13*/:
                    result = formatOffsetISO8601Extended(offset, -assertionsDisabled, -assertionsDisabled, true);
                    break;
                case Opcodes.OP_RETURN_VOID /*14*/:
                    result = formatOffsetISO8601Extended(offset, -assertionsDisabled, -assertionsDisabled, -assertionsDisabled);
                    break;
                default:
            ...
            if (timeType != null) {
                if (offsets[1] != 0) {
                    obj = TimeType.DAYLIGHT;
                } else {
                    obj = TimeType.STANDARD;
                }
                timeType.value = obj;
            }
        }
    ...
    public final int parseOffsetISO8601(String text, ParsePosition pos) {
        return parseOffsetISO8601(text, pos, -assertionsDisabled, null);
    }

    public int parseOffsetLocalizedGMT(String text, ParsePosition pos) {
        return parseOffsetLocalizedGMT(text, pos, -assertionsDisabled, null);
    }
    ...
    public TimeZone parse(Style style, String text, ParsePosition pos, EnumSet<ParseOption> options, Output<TimeType> timeType) {
        ...
        boolean fallbackLocalizedGMT = (style == Style.SPECIFIC_LONG || style == Style.GENERIC_LONG || style == Style.GENERIC_LOCATION) ? true : -assertionsDisabled;
        boolean fallbackShortLocalizedGMT = (style == Style.SPECIFIC_SHORT || style == Style.GENERIC_SHORT) ? true : -assertionsDisabled;
        int evaluated = 0;
        ...
        if (fallbackLocalizedGMT || fallbackShortLocalizedGMT) {
            hasDigitOffset = new Output(Boolean.valueOf(-assertionsDisabled));
            offset = parseOffsetLocalizedGMT(text, parsePosition, fallbackShortLocalizedGMT, hasDigitOffset);
            if (parsePosition.getErrorIndex() == -1) {
                if (parsePosition.getIndex() != maxPos) {
                    if (!((Boolean) hasDigitOffset.value).booleanValue()) {
                        parsedOffset = offset;
        ...
        switch (-getandroid-icu-text-TimeZoneFormat$StyleSwitchesValues()[style.ordinal()]) {
            ...
            case Opcodes.OP_RETURN_VOID /*14*/:
                ...
                parsePosition.setErrorIndex(-1);
                hasDigitOffset = new Output(Boolean.valueOf(-assertionsDisabled));
                offset = parseOffsetISO8601(text, parsePosition, -assertionsDisabled, hasDigitOffset);
                if (parsePosition.getErrorIndex() == -1) {
                    if (((Boolean) hasDigitOffset.value).booleanValue()) {
                        pos.setIndex(parsePosition.getIndex());
                        return getTimeZoneForOffset(offset);
            ...
            case Opcodes.OP_CONST_4 /*18*/:
                ...
                if (style == Style.SPECIFIC_LONG) {
                    ...
                    if (!-assertionsDisabled) {
                        if ((style == Style.SPECIFIC_SHORT ? 1 : null) == null) {
                            throw new AssertionError();
                        }
                    }
                ...
                if (parseTZDBAbbrev && style == Style.SPECIFIC_SHORT) {
                    if (!-assertionsDisabled) {
                        if (!nameTypes.contains(NameType.SHORT_STANDARD)) {
                            throw new AssertionError();
                        }
                    }
                    if (!-assertionsDisabled) {
                        if (!nameTypes.contains(NameType.SHORT_DAYLIGHT)) {
                            throw new AssertionError();
                        }
                    }
        ...
        if (!-assertionsDisabled) {
            if ((parsedPos < 0 ? 1 : null) == null) {
                throw new AssertionError();
            }
        }
        if (!-assertionsDisabled) {
            if ((parsedOffset == UNKNOWN_OFFSET ? 1 : null) == null) {
                throw new AssertionError();
            }
        }
                ...
                if (parsePosition.getIndex() != maxPos) {
                    if (!((Boolean) hasDigitOffset.value).booleanValue()) {
                        if (parsedPos < parsePosition.getIndex()) {
                            ...
                            parsedPos = parsePosition.getIndex();
                            if (!-assertionsDisabled) {
                                if ((parsedPos == startIdx + 1 ? 1 : null) == null) {
                                    throw new AssertionError();
                                }
                            }
                        }
        ...
        if (parsedPos < maxPos) {
            if ((Style.LOCALIZED_GMT.flag & evaluated) == 0) {
                parsePosition.setIndex(startIdx);
                parsePosition.setErrorIndex(-1);
                hasDigitOffset = new Output(Boolean.valueOf(-assertionsDisabled));
                offset = parseOffsetLocalizedGMT(text, parsePosition, -assertionsDisabled, hasDigitOffset);
                if (parsePosition.getErrorIndex() == -1) {
                    if (parsePosition.getIndex() != maxPos) {
                        if (!((Boolean) hasDigitOffset.value).booleanValue()) {
                            if (parsedPos < parsePosition.getIndex()) {
        ...
        if (parsedPos < maxPos) {
            if ((Style.LOCALIZED_GMT_SHORT.flag & evaluated) == 0) {
                parsePosition.setIndex(startIdx);
                parsePosition.setErrorIndex(-1);
                hasDigitOffset = new Output(Boolean.valueOf(-assertionsDisabled));
        ...
        if (parseAllStyles) {
            ...
            if (parseTZDBAbbrev && parsedPos < maxPos) {
                if ((Style.SPECIFIC_SHORT.flag & evaluated) == 0) {
            ...
            if (parsedPos < maxPos) {
                if ((Style.ZONE_ID.flag & evaluated) == 0) {
                    parsePosition.setIndex(startIdx);
                    parsePosition.setErrorIndex(-1);
                    id = parseZoneID(text, parsePosition);
            ...
            if (parsedPos < maxPos) {
                if ((Style.ZONE_ID_SHORT.flag & evaluated) == 0) {
                    parsePosition.setIndex(startIdx);
                    parsePosition.setErrorIndex(-1);
                    id = parseShortZoneID(text, parsePosition);
                    if (parsePosition.getErrorIndex() == -1 && parsedPos < parsePosition.getIndex()) {
    ...
    private String formatOffsetLocalizedGMT(int offset, boolean isShort) {
        ...
        if (offsetH > MAX_OFFSET_HOUR || offsetM > MAX_OFFSET_SECOND || offsetS > MAX_OFFSET_SECOND) {
    ...
    private String formatOffsetISO8601(int offset, boolean isBasic, boolean useUtcIndicator, boolean isShort, boolean ignoreSeconds) {
        ...
        int idx;
        fields = new int[3];
        absOffset %= MILLIS_PER_HOUR;
        fields[1] = absOffset / MILLIS_PER_MINUTE;
        fields[2] = (absOffset % MILLIS_PER_MINUTE) / MILLIS_PER_SECOND;
        if (!-assertionsDisabled) {
            obj = (fields[0] < 0 || fields[0] > MAX_OFFSET_HOUR) ? null : 1;
            if (obj == null) {
                throw new AssertionError();
            }
        }
        if (!-assertionsDisabled) {
            obj = (fields[1] < 0 || fields[1] > MAX_OFFSET_SECOND) ? null : 1;
            if (obj == null) {
                throw new AssertionError();
            }
        }
        if (!-assertionsDisabled) {
            obj = (fields[2] < 0 || fields[2] > MAX_OFFSET_SECOND) ? null : 1;
            if (obj == null) {
                throw new AssertionError();
            }
        }
    ...
    private String formatSpecific(TimeZone tz, NameType stdType, NameType dstType, long date, Output<TimeType> timeType) {
        ...
        Object obj = 1;
        if (!-assertionsDisabled) {
            Object obj2 = (stdType == NameType.LONG_STANDARD || stdType == NameType.SHORT_STANDARD) ? 1 : null;
            if (obj2 == null) {
                throw new AssertionError();
            }
        }
        if (!-assertionsDisabled) {
            if (!(dstType == NameType.LONG_DAYLIGHT || dstType == NameType.SHORT_DAYLIGHT)) {
                obj = null;
            }
            if (obj == null) {
                throw new AssertionError();
    ...
    private static String unquote(String s) {
        ...
        boolean isPrevQuote = -assertionsDisabled;
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            if (c == PatternTokenizer.SINGLE_QUOTE) {
                if (isPrevQuote) {
                    buf.append(c);
                    isPrevQuote = -assertionsDisabled;
                } else {
                    isPrevQuote = true;
                }
                if (inQuote) {
    ...
    private void checkAbuttingHoursAndMinutes() {
        this._abuttingOffsetHoursAndMinutes = -assertionsDisabled;
        for (Object[] items : this._gmtOffsetPatternItems) {
            boolean afterH = -assertionsDisabled;
            for (GMTOffsetField item : items) {
    ...
    private static Object[] parseOffsetPattern(String pattern, String letters) {
        ...
        char itemType = '\u0000';
        int itemLength = 1;
        boolean invalidPattern = -assertionsDisabled;
    ...
    private int parseOffsetLocalizedGMT(String text, ParsePosition pos, boolean isShort, Output<Boolean> hasDigitOffset) {
        ...
        if (hasDigitOffset != null) {
            hasDigitOffset.value = Boolean.valueOf(-assertionsDisabled);
        }
    ...
    private int parseOffsetLocalizedGMTPattern(String text, int start, boolean isShort, int[] parsedLen) {
        ...
        int idx2 = start;
        int offset = 0;
        boolean parsed = -assertionsDisabled;
        int len = this._gmtPatternPrefix.length();
        if (len > 0) {
            if (!text.regionMatches(true, start, this._gmtPatternPrefix, 0, len)) {
                idx = idx2;
                if (parsed) {
                    i = 0;
                } else {
        ...
        offset = parseOffsetFields(text, idx, -assertionsDisabled, offsetLen);
        if (offsetLen[0] != 0) {
            idx += offsetLen[0];
    ...
    private int parseOffsetFields(String text, int start, boolean isShort, int[] parsedLen) {
        ...
        int tmpLen;
        int tmpSign;
        GMTOffsetPatternType[] gMTOffsetPatternTypeArr;
        int outLen = 0;
        int sign = 1;
        ...
        for (GMTOffsetPatternType gmtPatType2 : PARSE_GMT_OFFSET_TYPES) {
            Object[] items = this._gmtOffsetPatternItems[gmtPatType2.ordinal()];
            if (!-assertionsDisabled) {
                if ((items != null ? 1 : null) == null) {
                    throw new AssertionError();
                }
            }
            outLen = parseOffsetFieldsWithPattern(text, start, items, -assertionsDisabled, fields);
            Object obj;
            if (outLen > 0) {
                ...
                if (outLen > 0 && this._abuttingOffsetHoursAndMinutes) {
                    ...
                    i = 0;
                    while (i < length) {
                        gmtPatType2 = gMTOffsetPatternTypeArr[i];
                        items = this._gmtOffsetPatternItems[gmtPatType2.ordinal()];
                        if (!-assertionsDisabled) {
                            if (items == null) {
                                obj = 1;
                            } else {
                ...
                if (outLen > 0) {
                    return (((((offsetH * 60) + offsetM) * 60) + offsetS) * MILLIS_PER_SECOND) * sign;
                }
                return 0;
            }
        }
    ...
    private int parseOffsetFieldsWithPattern(String text, int start, Object[] patternItems, boolean forceSingleHourDigit, int[] fields) {
        if (!-assertionsDisabled) {
            Object obj = (fields == null || fields.length < 3) ? null : 1;
            if (obj == null) {
                throw new AssertionError();
            }
        }
        ...
        fields[1] = 0;
        fields[0] = 0;
        boolean failed = -assertionsDisabled;
        int offsetS = 0;
        int offsetM = 0;
        int offsetH = 0;
        int idx = start;
        ...
        while (i < patternItems.length) {
            if (patternItems[i] instanceof String) {
                ...
                if (fieldType == 'H') {
                    offsetH = parseOffsetFieldWithLocalizedDigits(text, idx, 1, forceSingleHourDigit ? 1 : 2, 0, MAX_OFFSET_HOUR, tmpParsedLen);
                } else if (fieldType == 'm') {
                    offsetM = parseOffsetFieldWithLocalizedDigits(text, idx, 2, 2, 0, MAX_OFFSET_SECOND, tmpParsedLen);
                } else if (fieldType == 's') {
    ...
    private int parseDefaultOffsetFields(String text, int start, char separator, int[] parsedLen) {
        ...
        int min = 0;
        int sec = 0;
        int hour = parseOffsetFieldWithLocalizedDigits(text, start, 1, 2, 0, MAX_OFFSET_HOUR, len);
        if (len[0] != 0) {
            idx = start + len[0];
            if (idx + 1 < max && text.charAt(idx) == separator) {
                min = parseOffsetFieldWithLocalizedDigits(text, idx + 1, 2, 2, 0, MAX_OFFSET_SECOND, len);
                if (len[0] != 0) {
                    idx += len[0] + 1;
                    if (idx + 1 < max && text.charAt(idx) == separator) {
        ...
        return ((MILLIS_PER_HOUR * hour) + (MILLIS_PER_MINUTE * min)) + (sec * MILLIS_PER_SECOND);
    }
    ...
    private int parseAbuttingOffsetFields(String text, int start, int[] parsedLen) {
        ...
        while (numDigits > 0) {
            ...
            if (hour > MAX_OFFSET_HOUR || min > MAX_OFFSET_SECOND || sec > MAX_OFFSET_SECOND) {
                numDigits--;
            } else {
                offset = ((MILLIS_PER_HOUR * hour) + (MILLIS_PER_MINUTE * min)) + (sec * MILLIS_PER_SECOND);
    ...
    private static int parseOffsetISO8601(String text, ParsePosition pos, boolean extendedOnly, Output<Boolean> hasDigitOffset) {
        ...
        if (posOffset.getErrorIndex() == -1 && !extendedOnly && posOffset.getIndex() - start <= 3) {
            ...
            int tmpOffset = parseAbuttingAsciiOffsetFields(text, posBasic, OffsetFields.H, OffsetFields.HMS, -assertionsDisabled);
    ...
    private static int parseAbuttingAsciiOffsetFields(String text, ParsePosition pos, OffsetFields minFields, OffsetFields maxFields, boolean fixedHourWidth) {
        ...
        int min = 0;
        int sec = 0;
        boolean bParsed = -assertionsDisabled;
        while (numDigits >= minDigits) {
            ...
            if (hour > MAX_OFFSET_HOUR || min > MAX_OFFSET_SECOND || sec > MAX_OFFSET_SECOND) {
                ...
                return ((((hour * 60) + min) * 60) + sec) * MILLIS_PER_SECOND;
            }
        }
        if (bParsed) {
            pos.setIndex(start + numDigits);
    ...
    private static int parseAsciiOffsetFields(String text, ParsePosition pos, char sep, OffsetFields minFields, OffsetFields maxFields) {
        ...
        if (fieldLen[0] != 0) {
            if (fieldVal[0] > MAX_OFFSET_HOUR) {
                ...
                parsedFields = OffsetFields.H;
                if (fieldLen[1] == 2 && fieldVal[1] <= MAX_OFFSET_SECOND) {
    ...
    private void readObject(ObjectInputStream ois) throws ClassNotFoundException, IOException {
        ...
        if (tmpGmtOffsetPatterns == null) {
            ...
            if (this._gmtOffsetDigits == null) {
                ...
                this._parseAllStyles = fields.get("_parseAllStyles", -assertionsDisabled);
    ...
    public /* bridge */ /* synthetic */ Object m10freeze() {
        return freeze();
    }
    ...
    public /* bridge */ /* synthetic */ Object m9cloneAsThawed() {
        return cloneAsThawed();
    }

    public TimeZoneFormat cloneAsThawed() {
        TimeZoneFormat copy = (TimeZoneFormat) super.clone();
        copy._frozen = -assertionsDisabled;
        return copy;
    }
}

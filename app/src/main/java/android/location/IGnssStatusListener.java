...
public interface IGnssStatusListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGnssStatusListener {
        ...
        private static class Proxy implements IGnssStatusListener {
            ...
            public void onGnssStarted() throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onGnssStarted, _data, null, Stub.TRANSACTION_onGnssStarted);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onGnssStopped() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_onGnssStopped, _data, null, Stub.TRANSACTION_onGnssStarted);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onFirstFix(int ttff) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(ttff);
                    this.mRemote.transact(Stub.TRANSACTION_onFirstFix, _data, null, Stub.TRANSACTION_onGnssStarted);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onSvStatusChanged(int svCount, int[] svidWithFlags, float[] cn0s, float[] elevations, float[] azimuths) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onSvStatusChanged, _data, null, Stub.TRANSACTION_onGnssStarted);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onNmeaReceived(long timestamp, String nmea) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onNmeaReceived, _data, null, Stub.TRANSACTION_onGnssStarted);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_onGnssStarted /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    onGnssStarted();
                    return true;
                case TRANSACTION_onGnssStopped /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    onGnssStopped();
                    return true;

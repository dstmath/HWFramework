...
public class ClosedCaptionRenderer extends Renderer {
    ...
    public boolean supports(MediaFormat format) {
        ...
        return MediaPlayer.MEDIA_MIMETYPE_TEXT_CEA_608.equals(format.getString(MediaFormat.KEY_MIME));
    }

    public SubtitleTrack createTrack(MediaFormat format) {
        if (MediaPlayer.MEDIA_MIMETYPE_TEXT_CEA_608.equals(format.getString(MediaFormat.KEY_MIME))) {

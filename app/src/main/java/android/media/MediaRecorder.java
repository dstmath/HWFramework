...
public class MediaRecorder {
    ...
    private HwMediaPermWrapper mPerm;
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.media.MediaRecorder.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.media.MediaRecorder.<clinit>():void
...
*/
    ...
    public MediaRecorder() {
        this.mPerm = new HwMediaPermWrapper();
    ...
    public static boolean isSystemOnlyAudioSource(int source) {
        switch (source) {
            ...
            case RECORDSTATE_STOPPED /*1*/:
            case AudioState.ROUTE_BLUETOOTH /*2*/:
            case RECORDSTATE_STARTED /*3*/:
    ...
    public void prepare() throws IllegalStateException, IOException {
        if (this.mPath != null) {
            this.mPerm.setOutputFile(this, this.mPath, 0, 0);
        } else if (this.mFd != null) {
            this.mPerm.setOutputFile(this, this.mFd, 0, 0);
        } else {
    ...
    public void start() throws IllegalStateException {
        Log.i(TAG, "start");
        HwFrameworkFactory.getHwMediaRecorder().checkRecordActive();
        native_start();
        HwFrameworkFactory.getHwMediaRecorder().sendStateChangedIntent(RECORDSTATE_STARTED);
    }

    public void stop() throws IllegalStateException {
        Log.i(TAG, "stop");
        native_stop();
        HwFrameworkFactory.getHwMediaRecorder().sendStateChangedIntent(RECORDSTATE_STOPPED);
    }
}

...
public class TvView extends ViewGroup {
    ...
    class AnonymousClass3 extends SurfaceView {
        AnonymousClass3(Context $anonymous0, AttributeSet $anonymous1, int $anonymous2) {
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.media.tv.TvView.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.media.tv.TvView.<clinit>():void
...
*/
    ...
    private void ensurePositionTracking() {
        if (this.mSession != null) {
            this.mSession.timeShiftEnablePositionTracking(this.mTimeShiftPositionCallback != null ? true : DEBUG);
        }
    }
    ...
    private void resetSurfaceView() {
        ...
        this.mSurface = null;
        this.mSurfaceView = new AnonymousClass3(getContext(), this.mAttrs, this.mDefStyleAttr);

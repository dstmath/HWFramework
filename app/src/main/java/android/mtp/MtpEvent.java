...
public class MtpEvent {
    ...
    private MtpEvent() {
        this.mEventCode = EVENT_UNDEFINED;
    }
    ...
    public int getObjectHandle() {
        switch (this.mEventCode) {
            case EVENT_OBJECT_ADDED /*16386*/:
                return this.mParameter1;
            case EVENT_OBJECT_REMOVED /*16387*/:
                return this.mParameter1;
            case EVENT_OBJECT_INFO_CHANGED /*16391*/:
                return this.mParameter1;
            case EVENT_REQUEST_OBJECT_TRANSFER /*16393*/:
                return this.mParameter1;
    ...
    public int getStorageId() {
        switch (this.mEventCode) {
            case EVENT_STORE_ADDED /*16388*/:
                return this.mParameter1;
            case EVENT_STORE_REMOVED /*16389*/:
                return this.mParameter1;
            case EVENT_STORE_FULL /*16394*/:
                return this.mParameter1;
    ...
    public int getDevicePropCode() {
        switch (this.mEventCode) {
            case EVENT_DEVICE_PROP_CHANGED /*16390*/:
                return this.mParameter1;
            default:
    ...
    public int getTransactionId() {
        switch (this.mEventCode) {
            case EVENT_CAPTURE_COMPLETE /*16397*/:
                return this.mParameter1;
            default:

...
public final class AndroidHttpClient implements HttpClient {
    ...
    class AnonymousClass2 extends DefaultHttpClient {
        AnonymousClass2(ClientConnectionManager $anonymous0, HttpParams $anonymous1) {
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.net.http.AndroidHttpClient.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.net.http.AndroidHttpClient.<clinit>():void

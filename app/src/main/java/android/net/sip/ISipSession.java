...
public interface ISipSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISipSession {
        ...
        private static class Proxy implements ISipSession {
            ...
            public String getLocalIp() throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getLocalIp, _data, _reply, 0);
            ...
            public SipProfile getLocalProfile() throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getLocalProfile, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
            ...
            public SipProfile getPeerProfile() throws RemoteException {
                ...
                try {
                    SipProfile sipProfile;
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getPeerProfile, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        sipProfile = (SipProfile) SipProfile.CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public void makeCall(SipProfile callee, String sessionDescription, int timeout) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (callee != null) {
                        _data.writeInt(Stub.TRANSACTION_getLocalIp);
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_makeCall, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            SipProfile _result2;
            switch (code) {
                case TRANSACTION_getLocalIp /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getLocalIp();
                    reply.writeNoException();
                    reply.writeString(_result);
                    return true;
                case TRANSACTION_getLocalProfile /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getLocalProfile();
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(TRANSACTION_getLocalIp);
                        _result2.writeToParcel(reply, TRANSACTION_getLocalIp);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case TRANSACTION_getPeerProfile /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_getState /*4*/:
                    ...
                    return true;
                case TRANSACTION_isInCall /*5*/:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result4 = isInCall();
                    reply.writeNoException();
                    reply.writeInt(_result4 ? TRANSACTION_getLocalIp : 0);
                    return true;
                case TRANSACTION_getCallId /*6*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getCallId();
                    reply.writeNoException();
                    reply.writeString(_result);
                    return true;
                case TRANSACTION_setListener /*7*/:
                    data.enforceInterface(DESCRIPTOR);
                    setListener(android.net.sip.ISipSessionListener.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case TRANSACTION_register /*8*/:
                    data.enforceInterface(DESCRIPTOR);
                    register(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_unregister /*9*/:
                    data.enforceInterface(DESCRIPTOR);
                    unregister();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_makeCall /*10*/:
                    SipProfile sipProfile;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {

        ...
        private static class Proxy implements ISipSessionListener {
            ...
            public void onCalling(ISipSession session) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onCalling, _data, _reply, 0);
            ...
            public void onRinging(ISipSession session, SipProfile caller, String sessionDescription) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(iBinder);
                    if (caller != null) {
                        _data.writeInt(Stub.TRANSACTION_onCalling);
                        caller.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
                    _data.writeString(sessionDescription);
                    this.mRemote.transact(Stub.TRANSACTION_onRinging, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void onRingingBack(ISipSession session) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(iBinder);
                    this.mRemote.transact(Stub.TRANSACTION_onRingingBack, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void onCallEstablished(ISipSession session, String sessionDescription) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(iBinder);
                    _data.writeString(sessionDescription);
                    this.mRemote.transact(Stub.TRANSACTION_onCallEstablished, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void onCallEnded(ISipSession session) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(iBinder);
                    this.mRemote.transact(Stub.TRANSACTION_onCallEnded, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void onCallBusy(ISipSession session) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(iBinder);
                    this.mRemote.transact(Stub.TRANSACTION_onCallBusy, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void onCallTransferring(ISipSession newSession, String sessionDescription) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(iBinder);
                    _data.writeString(sessionDescription);
                    this.mRemote.transact(Stub.TRANSACTION_onCallTransferring, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void onCallChangeFailed(ISipSession session, int errorCode, String errorMessage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(errorCode);
                    _data.writeString(errorMessage);
                    this.mRemote.transact(Stub.TRANSACTION_onCallChangeFailed, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void onRegistering(ISipSession session) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(iBinder);
                    this.mRemote.transact(Stub.TRANSACTION_onRegistering, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();

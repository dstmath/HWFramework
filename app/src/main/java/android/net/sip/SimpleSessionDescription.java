...
public class SimpleSessionDescription {
    ...
    public static class Media extends Fields {
        ...
        public /* bridge */ /* synthetic */ void setAddress(String address) {
            super.setAddress(address);
        }

        public /* bridge */ /* synthetic */ void setAttribute(String name, String value) {
            super.setAttribute(name, value);
        }

        public /* bridge */ /* synthetic */ void setBandwidth(String type, int value) {
            super.setBandwidth(type, value);
        }

        public /* bridge */ /* synthetic */ void setEncryption(String method, String key) {
            super.setEncryption(method, key);
        }
    ...
    public Media newMedia(String type, int port, int portCount, String protocol) {
        Media media = new Media(port, portCount, protocol, null);

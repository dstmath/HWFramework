...
public class WifiP2pManager {
    ...
    public static class Channel {
        ...
        Channel(Context context, Looper looper, ChannelListener l) {
            ...
            this.mListenerKey = WifiP2pManager.WIFI_P2P_OFF;
        ...
        private int putListener(Object listener) {
            if (listener == null) {
                return WifiP2pManager.WIFI_P2P_OFF;
            }
            int key;
    ...
    public void discoverPeers(Channel c, ActionListener listener) {
        ...
        c.mAsyncChannel.sendMessage(DISCOVER_PEERS, WIFI_P2P_OFF, c.putListener(listener));
    }
    ...
    public void stopPeerDiscovery(Channel c, ActionListener listener) {
        ...
        c.mAsyncChannel.sendMessage(STOP_DISCOVERY, WIFI_P2P_OFF, c.putListener(listener));
    }
    ...
    public void connect(Channel c, WifiP2pConfig config, ActionListener listener) {
        ...
        c.mAsyncChannel.sendMessage(CONNECT, WIFI_P2P_OFF, c.putListener(listener), config);
    }

    public void cancelConnect(Channel c, ActionListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(CANCEL_CONNECT, WIFI_P2P_OFF, c.putListener(listener));
    }
    ...
    public void removeGroup(Channel c, ActionListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(REMOVE_GROUP, WIFI_P2P_OFF, c.putListener(listener));
    }

    public void listen(Channel c, boolean enable, ActionListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(enable ? START_LISTEN : STOP_LISTEN, WIFI_P2P_OFF, c.putListener(listener));
    }
    ...
    public void setWifiP2pChannels(Channel c, int lc, int oc, ActionListener listener) {
        ...
        c.mAsyncChannel.sendMessage(SET_CHANNEL, WIFI_P2P_OFF, c.putListener(listener), p2pChannels);
    }

    public void startWps(Channel c, WpsInfo wps, ActionListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(START_WPS, WIFI_P2P_OFF, c.putListener(listener), wps);
    }

    public void addLocalService(Channel c, WifiP2pServiceInfo servInfo, ActionListener listener) {
        checkChannel(c);
        checkServiceInfo(servInfo);
        c.mAsyncChannel.sendMessage(ADD_LOCAL_SERVICE, WIFI_P2P_OFF, c.putListener(listener), servInfo);
    }

    public void removeLocalService(Channel c, WifiP2pServiceInfo servInfo, ActionListener listener) {
        checkChannel(c);
        checkServiceInfo(servInfo);
        c.mAsyncChannel.sendMessage(REMOVE_LOCAL_SERVICE, WIFI_P2P_OFF, c.putListener(listener), servInfo);
    }

    public void clearLocalServices(Channel c, ActionListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(CLEAR_LOCAL_SERVICES, WIFI_P2P_OFF, c.putListener(listener));
    }
    ...
    public void discoverServices(Channel c, ActionListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(DISCOVER_SERVICES, WIFI_P2P_OFF, c.putListener(listener));
    }

    public void addServiceRequest(Channel c, WifiP2pServiceRequest req, ActionListener listener) {
        checkChannel(c);
        checkServiceRequest(req);
        c.mAsyncChannel.sendMessage(ADD_SERVICE_REQUEST, WIFI_P2P_OFF, c.putListener(listener), req);
    }

    public void removeServiceRequest(Channel c, WifiP2pServiceRequest req, ActionListener listener) {
        checkChannel(c);
        checkServiceRequest(req);
        c.mAsyncChannel.sendMessage(REMOVE_SERVICE_REQUEST, WIFI_P2P_OFF, c.putListener(listener), req);
    }

    public void clearServiceRequests(Channel c, ActionListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(CLEAR_SERVICE_REQUESTS, WIFI_P2P_OFF, c.putListener(listener));
    }

    public void requestPeers(Channel c, PeerListListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(REQUEST_PEERS, WIFI_P2P_OFF, c.putListener(listener));
    }

    public void requestConnectionInfo(Channel c, ConnectionInfoListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(REQUEST_CONNECTION_INFO, WIFI_P2P_OFF, c.putListener(listener));
    }

    public void requestGroupInfo(Channel c, GroupInfoListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(REQUEST_GROUP_INFO, WIFI_P2P_OFF, c.putListener(listener));
    }
    ...
    public void setDeviceName(Channel c, String devName, ActionListener listener) {
        ...
        c.mAsyncChannel.sendMessage(SET_DEVICE_NAME, WIFI_P2P_OFF, c.putListener(listener), d);
    }

    public void setWFDInfo(Channel c, WifiP2pWfdInfo wfdInfo, ActionListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(SET_WFD_INFO, WIFI_P2P_OFF, c.putListener(listener), wfdInfo);
    }
    ...
    public void requestPersistentGroupInfo(Channel c, PersistentGroupInfoListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(REQUEST_PERSISTENT_GROUP_INFO, WIFI_P2P_OFF, c.putListener(listener));
    }
    ...
    public void getNfcHandoverRequest(Channel c, HandoverMessageListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(GET_HANDOVER_REQUEST, WIFI_P2P_OFF, c.putListener(listener));
    }

    public void getNfcHandoverSelect(Channel c, HandoverMessageListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(GET_HANDOVER_SELECT, WIFI_P2P_OFF, c.putListener(listener));
    }
    ...
    public void initiatorReportNfcHandover(Channel c, String handoverSelect, ActionListener listener) {
        ...
        c.mAsyncChannel.sendMessage(INITIATOR_REPORT_NFC_HANDOVER, WIFI_P2P_OFF, c.putListener(listener), bundle);
    }
    ...
    public void responderReportNfcHandover(Channel c, String handoverRequest, ActionListener listener) {
        ...
        c.mAsyncChannel.sendMessage(RESPONDER_REPORT_NFC_HANDOVER, WIFI_P2P_OFF, c.putListener(listener), bundle);
    }
}

...
public abstract class HostNfcFService extends Service {
    ...
    final class MsgHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case HostNfcFService.MSG_COMMAND_PACKET /*0*/:
                    Bundle dataBundle = msg.getData();
                    if (dataBundle != null) {
                        if (HostNfcFService.this.mNfcService == null) {
                            HostNfcFService.this.mNfcService = msg.replyTo;
                        }
                        byte[] packet = dataBundle.getByteArray(HostNfcFService.KEY_DATA);
                        if (packet == null) {
                        ...
                        if (responsePacket != null) {
                            if (HostNfcFService.this.mNfcService != null) {
                                Message responseMsg = Message.obtain(null, (int) HostNfcFService.MSG_RESPONSE_PACKET);
                                Bundle responseBundle = new Bundle();
                                responseBundle.putByteArray(HostNfcFService.KEY_DATA, responsePacket);
                    ...
                    return;
                    break;
                case HostNfcFService.MSG_RESPONSE_PACKET /*1*/:
                    if (HostNfcFService.this.mNfcService != null) {
                        try {
                    ...
                    Log.e(HostNfcFService.TAG, "Response not sent; service was deactivated.");
                case HostNfcFService.MSG_DEACTIVATED /*2*/:
    ...
    public final void sendResponsePacket(byte[] responsePacket) {
        Message responseMsg = Message.obtain(null, (int) MSG_RESPONSE_PACKET);

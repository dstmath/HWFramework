...
public interface IAodStateCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAodStateCallback {
        ...
        private static class Proxy implements IAodStateCallback {
            ...
            public void onScreenOn() throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onScreenOn, _data, _reply, 0);
            ...
            public void onScreenOff() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_onScreenOff, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void onTurningOn() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_onTurningOn, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void onWakingUp() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_onWakingUp, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_onScreenOn /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    onScreenOn();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_onScreenOff /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    onScreenOff();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_onTurningOn /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    onTurningOn();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_onWakingUp /*4*/:
                    data.enforceInterface(DESCRIPTOR);
                    onWakingUp();
                    reply.writeNoException();
                    return true;

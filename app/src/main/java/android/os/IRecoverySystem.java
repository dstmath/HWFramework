...
public interface IRecoverySystem extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRecoverySystem {
        ...
        private static class Proxy implements IRecoverySystem {
            ...
            public boolean uncrypt(String packageFile, IRecoverySystemProgressListener listener) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_uncrypt, _data, _reply, 0);
            ...
            public boolean setupBcb(String command) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setupBcb, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean clearBcb() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_clearBcb, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            boolean _result;
            switch (code) {
                case TRANSACTION_uncrypt /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = uncrypt(data.readString(), android.os.IRecoverySystemProgressListener.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    if (_result) {
                        i = TRANSACTION_uncrypt;
                    }
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_setupBcb /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setupBcb(data.readString());
                    reply.writeNoException();
                    if (_result) {
                        i = TRANSACTION_uncrypt;
                    }

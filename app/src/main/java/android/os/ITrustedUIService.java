...
public interface ITrustedUIService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITrustedUIService {
        ...
        private static class Proxy implements ITrustedUIService {
            ...
            public boolean getTrustedUIStatus() throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getTrustedUIStatus, _data, _reply, 0);
            ...
            public void sendTUIExitCmd() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_sendTUIExitCmd, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public int sendTUICmd(int event_type, int value) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_sendTUICmd, _data, _reply, 0);
                    _reply.readException();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_getTrustedUIStatus /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result = getTrustedUIStatus();
                    reply.writeNoException();
                    reply.writeInt(_result ? TRANSACTION_getTrustedUIStatus : 0);
                    return true;
                case TRANSACTION_sendTUIExitCmd /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    sendTUIExitCmd();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_sendTUICmd /*3*/:
                    data.enforceInterface(DESCRIPTOR);

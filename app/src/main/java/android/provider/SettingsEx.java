...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.provider.SettingsEx.Systemex.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.provider.SettingsEx.Systemex.<clinit>():void
...
*/
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: android.provider.SettingsEx.Systemex.<clinit>():void");
        }

        public static String getString(ContentResolver resolver, String name) {
            return HwFrameworkFactory.getHwSettingsManager().getString(resolver, name);
        }

        public static boolean putString(ContentResolver cr, String name, String value) {
            return HwFrameworkFactory.getHwSettingsManager().putString(cr, name, value);
        }

        public static int getInt(ContentResolver cr, String name, int def) {
            return HwFrameworkFactory.getHwSettingsManager().getInt(cr, name, def);
        }

        public static int getInt(ContentResolver cr, String name) throws SettingNotFoundException {
            return HwFrameworkFactory.getHwSettingsManager().getInt(cr, name);
        }
        ...
        public static long getLong(ContentResolver cr, String name, long def) {
            return HwFrameworkFactory.getHwSettingsManager().getLong(cr, name, def);
        }

        public static long getLong(ContentResolver cr, String name) throws SettingNotFoundException {
            return HwFrameworkFactory.getHwSettingsManager().getLong(cr, name);
        }
        ...
        public static float getFloat(ContentResolver cr, String name, float def) {
            return HwFrameworkFactory.getHwSettingsManager().getFloat(cr, name, def);
        }

        public static float getFloat(ContentResolver cr, String name) throws SettingNotFoundException {
            return HwFrameworkFactory.getHwSettingsManager().getFloat(cr, name);
        }

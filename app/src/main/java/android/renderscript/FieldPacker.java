...
public class FieldPacker {
    ...
    public void addI16(short v) {
        ...
        int i = this.mPos;
        this.mPos = i + 1;
        bArr[i] = (byte) (v & Process.PROC_TERM_MASK);
        bArr = this.mData;
        i = this.mPos;
        this.mPos = i + 1;
        bArr[i] = (byte) (v >> 8);
    ...
    public short subI16() {
        ...
        int i = this.mPos - 1;
        this.mPos = i;
        short v = (short) ((bArr[i] & Process.PROC_TERM_MASK) << 8);
        bArr = this.mData;
        i = this.mPos - 1;
        this.mPos = i;
        return (short) (((short) (bArr[i] & Process.PROC_TERM_MASK)) | v);
    }
    ...
    public void addI32(int v) {
        ...
        i = this.mPos;
        this.mPos = i + 1;
        bArr[i] = (byte) ((v >> 8) & Process.PROC_TERM_MASK);
        bArr = this.mData;
        i = this.mPos;
        this.mPos = i + 1;
        bArr[i] = (byte) ((v >> 16) & Process.PROC_TERM_MASK);
        bArr = this.mData;
        i = this.mPos;
        this.mPos = i + 1;
        bArr[i] = (byte) ((v >> 24) & Process.PROC_TERM_MASK);
    }
    ...
    public int subI32() {
        ...
        int i = this.mPos - 1;
        this.mPos = i;
        int v = (bArr[i] & Process.PROC_TERM_MASK) << 24;
        bArr = this.mData;
        i = this.mPos - 1;
        this.mPos = i;
        v |= (bArr[i] & Process.PROC_TERM_MASK) << 16;
        bArr = this.mData;
        i = this.mPos - 1;
        this.mPos = i;
        v |= (bArr[i] & Process.PROC_TERM_MASK) << 8;
        bArr = this.mData;
        i = this.mPos - 1;
        this.mPos = i;
        return v | (bArr[i] & Process.PROC_TERM_MASK);
    }
    ...
    public void addU16(int v) {
        if (v < 0 || v > PowerManager.WAKE_LOCK_LEVEL_MASK) {
    ...
    public void addU32(long v) {
        if (v < 0 || v > KeymasterArguments.UINT32_MAX_VALUE) {

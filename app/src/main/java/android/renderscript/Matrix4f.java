...
public class Matrix4f {
    ...
    public void loadIdentity() {
        this.mMat[0] = Engine.DEFAULT_VOLUME;
        this.mMat[1] = 0.0f;
        this.mMat[2] = 0.0f;
        this.mMat[3] = 0.0f;
        this.mMat[4] = 0.0f;
        this.mMat[5] = Engine.DEFAULT_VOLUME;
        this.mMat[6] = 0.0f;
        this.mMat[7] = 0.0f;
        this.mMat[8] = 0.0f;
        this.mMat[9] = 0.0f;
        this.mMat[10] = Engine.DEFAULT_VOLUME;
        this.mMat[11] = 0.0f;
        this.mMat[12] = 0.0f;
        this.mMat[13] = 0.0f;
        this.mMat[14] = 0.0f;
        this.mMat[15] = Engine.DEFAULT_VOLUME;
    }
    ...
    public void loadRotate(float rot, float x, float y, float z) {
        ...
        if ((len != Engine.DEFAULT_VOLUME ? 1 : null) == null) {
    ...
    public void loadOrthoWindow(int w, int h) {
        loadOrtho(0.0f, (float) w, (float) h, 0.0f, ScaledLayoutParams.SCALE_UNSPECIFIED, Engine.DEFAULT_VOLUME);
    }
    ...
    public void loadFrustum(float l, float r, float b, float t, float n, float f) {
        ...
        this.mMat[11] = ScaledLayoutParams.SCALE_UNSPECIFIED;
    ...
    public void loadProjectionNormalized(int w, int h) {
        ...
        if (w > h) {
            ...
            m1.loadFrustum(-aspect, aspect, ScaledLayoutParams.SCALE_UNSPECIFIED, Engine.DEFAULT_VOLUME, Engine.DEFAULT_VOLUME, SensorManager.LIGHT_CLOUDY);
        } else {
            aspect = ((float) h) / ((float) w);
            m1.loadFrustum(ScaledLayoutParams.SCALE_UNSPECIFIED, Engine.DEFAULT_VOLUME, -aspect, aspect, Engine.DEFAULT_VOLUME, SensorManager.LIGHT_CLOUDY);
        }
        m2.loadRotate(180.0f, 0.0f, Engine.DEFAULT_VOLUME, 0.0f);
        m1.loadMultiply(m1, m2);
        m2.loadScale(-2.0f, 2.0f, Engine.DEFAULT_VOLUME);
        m1.loadMultiply(m1, m2);

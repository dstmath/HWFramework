...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.renderscript.RenderScript.ContextType.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.renderscript.RenderScript.ContextType.<clinit>():void
...
*/
        ...
        public void run() {
            ...
            while (this.mRun) {
                ...
                if (msg == RS_MESSAGE_TO_CLIENT_USER) {
                    ...
                    try {
                        sleep(RenderScript.sMinorVersion, RS_MESSAGE_TO_CLIENT_NONE);
                    } catch (InterruptedException e2) {
                    }
                } else if (this.mRS.nContextGetUserMessage(this.mRS.mContext, rbuf) != RS_MESSAGE_TO_CLIENT_NEW_BUFFER) {
                    throw new RSDriverException("Error processing message from RenderScript.");
                } else {
                    Allocation.sendBufferNotification((((long) rbuf[RS_MESSAGE_TO_CLIENT_EXCEPTION]) << 32) + (((long) rbuf[RS_MESSAGE_TO_CLIENT_NONE]) & KeymasterArguments.UINT32_MAX_VALUE));
                }
            }
        }
    }
    ...
    public enum Priority {
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.renderscript.RenderScript.Priority.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.renderscript.RenderScript.Priority.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 0073
...
*/
    ...
    synchronized void nAllocationData2D(long id, int xoff, int yoff, int mip, int face, int w, int h, Object d, int sizeBytes, DataType dt, int mSize, boolean usePadding) {
        ...
        Object obj = d;
        int i7 = sizeBytes;
        rsnAllocationData2D(this.mContext, j, i, i2, i3, i4, i5, i6, obj, i7, dt.mID, mSize, usePadding);
    }
    ...
    synchronized void nAllocationData3D(long id, int xoff, int yoff, int zoff, int mip, int w, int h, int depth, Object d, int sizeBytes, DataType dt, int mSize, boolean usePadding) {
        ...
        Object obj = d;
        int i8 = sizeBytes;
        rsnAllocationData3D(this.mContext, j, i, i2, i3, i4, i5, i6, i7, obj, i8, dt.mID, mSize, usePadding);
    }
    ...
    synchronized void nAllocationRead2D(long id, int xoff, int yoff, int mip, int face, int w, int h, Object d, int sizeBytes, DataType dt, int mSize, boolean usePadding) {
        ...
        Object obj = d;
        int i7 = sizeBytes;
        rsnAllocationRead2D(this.mContext, j, i, i2, i3, i4, i5, i6, obj, i7, dt.mID, mSize, usePadding);
    }
    ...
    synchronized void nAllocationRead3D(long id, int xoff, int yoff, int zoff, int mip, int w, int h, int depth, Object d, int sizeBytes, DataType dt, int mSize, boolean usePadding) {
        ...
        Object obj = d;
        int i8 = sizeBytes;
        rsnAllocationRead3D(this.mContext, j, i, i2, i3, i4, i5, i6, i7, obj, i8, dt.mID, mSize, usePadding);
    }
    ...
    RenderScript(Context ctx) {
        this.mIsProcessContext = LOG_ENABLED;
        this.mContextFlags = CREATE_FLAG_NONE;
        this.mContextSdkVersion = CREATE_FLAG_NONE;
        this.mDestroyed = LOG_ENABLED;
        ...
        try {
            registerNativeAllocation.invoke(sRuntime, new Object[]{Integer.valueOf(StrictMode.PENALTY_GATHER)});
        } catch (Exception e) {
        ...
        synchronized (RenderScript.class) {
            if (mCachePath == null) {
                ...
                if (RenderScriptCacheDir.mCacheDir == null) {
                    f = new File(RenderScriptCacheDir.mCacheDir, "com.android.renderscript.cache");
    ...
    public static void releaseAllContexts() {
        ...
        for (RenderScript prs : oldList) {
            prs.mIsProcessContext = LOG_ENABLED;
            prs.destroy();
        }
        oldList.clear();
    }
    ...
    private void helpDestroy() {
        boolean shouldDestroy = LOG_ENABLED;
        synchronized (this) {
            if (!this.mDestroyed) {
                shouldDestroy = true;
        ...
        if (shouldDestroy) {
            ...
            boolean hasJoined = LOG_ENABLED;
            boolean interrupted = LOG_ENABLED;
            while (!hasJoined) {
                try {

...
public final class ScriptIntrinsicHistogram extends ScriptIntrinsic {
    ...
    public void setDotCoefficients(float r, float g, float b, float a) {
        ...
        } else if (((r + g) + b) + a > Engine.DEFAULT_VOLUME) {
    ...
    public void setOutput(Allocation aout) {
        ...
        } else if (this.mOut.getType().getX() == TriangleMeshBuilder.TEXTURE_0 && this.mOut.getType().getY() == 0 && !this.mOut.getType().hasMipmaps() && this.mOut.getType().getYuv() == 0) {

    ...
    public static abstract class Stub extends Binder implements IProcessStateChangeObserver {
        ...
        private static class Proxy implements IProcessStateChangeObserver {
            ...
            public void onProcessLauncher(String packageName, String processName, int pid, int uid, boolean started, String launcherMode, String reason) throws RemoteException {
                int i = Stub.TRANSACTION_onProcessLauncher;
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onProcessLauncher, _data, _reply, 0);
            ...
            public void onProcessDiedOverload(Bundle data) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (data != null) {
                        _data.writeInt(Stub.TRANSACTION_onProcessLauncher);
                        data.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
                    this.mRemote.transact(Stub.TRANSACTION_onProcessDiedOverload, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_onProcessLauncher /*1*/:
                    ...
                    return true;
                case TRANSACTION_onProcessDiedOverload /*2*/:
                    Bundle bundle;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {

...
public abstract class AndroidKeyStoreKeyGeneratorSpi extends KeyGeneratorSpi {
    ...
    public static class AES extends AndroidKeyStoreKeyGeneratorSpi {
        public AES() {
            super(32, KeymasterDefs.KM_ALGORITHM_HMAC);
        }

        protected void engineInit(AlgorithmParameterSpec params, SecureRandom random) throws InvalidAlgorithmParameterException {
            super.engineInit(params, random);
            if (this.mKeySizeBits != KeymasterDefs.KM_ALGORITHM_HMAC && this.mKeySizeBits != Impl.STATUS_RUNNING && this.mKeySizeBits != TriangleMeshBuilder.TEXTURE_0) {
    ...
    protected static abstract class HmacBase extends AndroidKeyStoreKeyGeneratorSpi {
        protected HmacBase(int keymasterDigest) {
            super(KeymasterDefs.KM_ALGORITHM_HMAC, keymasterDigest, KeymasterUtils.getDigestOutputSizeBits(keymasterDigest));
        }
    }
    ...
    protected AndroidKeyStoreKeyGeneratorSpi(int keymasterAlgorithm, int keymasterDigest, int defaultKeySizeBits) {
        ...
        } else if (this.mKeymasterAlgorithm == KeymasterDefs.KM_ALGORITHM_HMAC && this.mKeymasterDigest == -1) {
            ...
            try {
                if (params instanceof KeyGenParameterSpec) {
                    ...
                    if (this.mKeySizeBits <= 0) {
                        ...
                        if (this.mKeymasterAlgorithm == KeymasterDefs.KM_ALGORITHM_HMAC) {

        ...
        while (inputLength > 0) {
            ...
            if (opResult == null) {
                ...
                if (opResult.inputConsumed == chunk.length) {
                    ...
                    if (inputLength > 0) {
                        throw new KeyStoreException(Ranking.VISIBILITY_NO_OVERRIDE, "Keystore consumed nothing from max-sized chunk: " + chunk.length + " bytes");
                    }
                    ...
                    throw new KeyStoreException(Ranking.VISIBILITY_NO_OVERRIDE, "Keystore consumed more input than provided. Provided: " + chunk.length + ", consumed: " + opResult.inputConsumed);
                }

...
public class TileService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        ...
        try {
            this.mTile = this.mService.getTile((ComponentName) intent.getParcelableExtra(EXTRA_COMPONENT));
            if (this.mTile != null) {
    ...
    public static final void requestListeningState(Context context, ComponentName component) {
        ...
        intent.putExtra(EXTRA_COMPONENT, (Parcelable) component);
        context.sendBroadcast(intent, permission.BIND_QUICK_SETTINGS_TILE);
    }
}

    ...
    class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case VoiceInteractionService.MSG_LAUNCH_VOICE_ASSIST_FROM_KEYGUARD /*4*/:
    ...
    public VoiceInteractionService() {
        this.mInterface = new Stub() {
            ...
            public void launchVoiceAssistFromKeyguard() throws RemoteException {
                VoiceInteractionService.this.mHandler.sendEmptyMessage(VoiceInteractionService.MSG_LAUNCH_VOICE_ASSIST_FROM_KEYGUARD);
            }
        };

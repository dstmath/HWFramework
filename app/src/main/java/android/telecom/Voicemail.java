...
public class Voicemail implements Parcelable {
    ...
    public static class Builder {
        ...
        public Voicemail build() {
            ...
            return new Voicemail(this.mBuilderNumber, this.mBuilderPhoneAccount, this.mBuilderId, this.mBuilderDuration, this.mBuilderSourcePackage, this.mBuilderSourceData, this.mBuilderUri, this.mBuilderIsRead, Boolean.valueOf(this.mBuilderHasContent), this.mBuilderTranscription, null);
        }
    }
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.telecom.Voicemail.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.telecom.Voicemail.<clinit>():void

...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.telephony.SubscriptionInfo.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.telephony.SubscriptionInfo.<clinit>():void
...
*/
    ...
    public SubscriptionInfo(int id, String iccId, int simSlotIndex, CharSequence displayName, CharSequence carrierName, int nameSource, int iconTint, String number, int roaming, Bitmap icon, int mcc, int mnc, String countryIso, int simProvisioningStatus, int status, int nwMode) {
        this.mId = id;
        this.mIccId = iccId;
        this.mSimSlotIndex = simSlotIndex;
        this.mDisplayName = displayName;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.mSimProvisioningStatus);

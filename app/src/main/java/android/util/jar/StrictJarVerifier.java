...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.util.jar.StrictJarVerifier.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.util.jar.StrictJarVerifier.<clinit>():void
                    ...
                    try {
                        ...
                        if (this.signatureSchemeRollbackProtectionsEnforced) {
                            ...
                            if (apkSignatureSchemeIdList != null) {
                                ...
                                StringTokenizer stringTokenizer = new StringTokenizer(apkSignatureSchemeIdList, PtmLog.PAIRE_DELIMETER);

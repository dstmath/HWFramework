...
public interface WindowManager extends ViewManager {
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams implements Parcelable {
        ...
        public static final int PRIVATE_FLAG_ROG_ENABLE = 1048576;
...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.view.WindowManager.LayoutParams.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.view.WindowManager.LayoutParams.<clinit>():void
...
*/
        ...
        public LayoutParams() {
            ...
            this.blurRadius = 100;
            this.blurAlpha = BRIGHTNESS_OVERRIDE_FULL;
            ...
            this.accessibilityIdOfAnchor = EVERYTHING_CHANGED;
            this.removeTimeoutMilliseconds = -1;
        ...
        public final void setSurfaceInsets(View view, boolean manual, boolean preservePrevious) {
            ...
            if (surfaceInset == 0) {
                this.surfaceInsets.set(SOFT_INPUT_STATE_UNSPECIFIED, SOFT_INPUT_STATE_UNSPECIFIED, SOFT_INPUT_STATE_UNSPECIFIED, SOFT_INPUT_STATE_UNSPECIFIED);
            } else {
        ...
        public void writeToParcel(Parcel out, int parcelableFlags) {
            ...
            if (this.hasManualSurfaceInsets) {
                i = TYPE_BASE_APPLICATION;
            } else {
                i = SOFT_INPUT_STATE_UNSPECIFIED;
            }
            out.writeInt(i);
            if (!this.preservePreviousSurfaceInsets) {
                i2 = SOFT_INPUT_STATE_UNSPECIFIED;
            }
            out.writeInt(i2);
            ...
            out.writeLong(this.removeTimeoutMilliseconds);
        }
        ...
        public LayoutParams(Parcel in) {
            ...
            this.removeTimeoutMilliseconds = in.readLong();
        }
        ...
        public final int copyFrom(LayoutParams o) {
            ...
            if (this.isEmuiStyle != o.isEmuiStyle) {
                ...
                changes |= PRIVATE_FLAG_HIDE_NAVI_BAR;
            }
            ...
            if (this.privateFlags != o.privateFlags) {
                ...
                changes |= PRIVATE_FLAG_FORCE_DRAW_STATUS_BAR_BACKGROUND;
            }
            ...
            if (this.buttonBrightness != o.buttonBrightness) {
                ...
                changes |= PRIVATE_FLAG_PRESERVE_GEOMETRY;
            }
            ...
            if (this.preferredRefreshRate != o.preferredRefreshRate) {
                ...
                changes |= PRIVATE_FLAG_CHILD_WINDOW_IGNORE_PARENT_CLIPRECT;
            }
            ...
            if (this.inputFeatures != o.inputFeatures) {
                ...
                changes |= PRIVATE_FLAG_LAYOUT_CHILD_WINDOW_IN_PARENT_FRAME;
            }
            ...
            if (this.accessibilityIdOfAnchor != o.accessibilityIdOfAnchor) {
                ...
                changes |= FLAG_HARDWARE_ACCELERATED;
            }
            if (!(Objects.equals(this.accessibilityTitle, o.accessibilityTitle) || o.accessibilityTitle == null)) {
                ...
                changes |= FLAG_LAYOUT_IN_OVERSCAN;
            }
            this.removeTimeoutMilliseconds = o.removeTimeoutMilliseconds;
            return changes;
        }

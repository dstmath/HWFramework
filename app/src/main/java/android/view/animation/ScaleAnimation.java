...
public class ScaleAnimation extends Animation {
    ...
    protected void applyTransformation(float interpolatedTime, Transformation t) {
        float sx = LayoutParams.BRIGHTNESS_OVERRIDE_FULL;
        float sy = LayoutParams.BRIGHTNESS_OVERRIDE_FULL;
        float scale = getScaleFactor();
        if (!(this.mFromX == LayoutParams.BRIGHTNESS_OVERRIDE_FULL && this.mToX == LayoutParams.BRIGHTNESS_OVERRIDE_FULL)) {
            sx = this.mFromX + ((this.mToX - this.mFromX) * interpolatedTime);
        }
        if (!(this.mFromY == LayoutParams.BRIGHTNESS_OVERRIDE_FULL && this.mToY == LayoutParams.BRIGHTNESS_OVERRIDE_FULL)) {

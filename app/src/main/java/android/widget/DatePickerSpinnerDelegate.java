...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.widget.DatePickerSpinnerDelegate.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.widget.DatePickerSpinnerDelegate.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.widget.DatePickerSpinnerDelegate.<clinit>():void");
    }
    ...
    DatePickerSpinnerDelegate(DatePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(layoutResourceId, this.mDelegator, (boolean) DEFAULT_SPINNERS_SHOWN);

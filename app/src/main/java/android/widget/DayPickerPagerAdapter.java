...
class DayPickerPagerAdapter extends PagerAdapter {
    ...
    public DayPickerPagerAdapter(Context context, int layoutResId, int calendarViewId) {
        ...
        this.mOnDayClickListener = new OnDayClickListener() {
    ...
    public void setRange(Calendar min, Calendar max) {
        ...
        this.mCount = (((this.mMaxDate.get(1) - this.mMinDate.get(1)) * MONTHS_IN_YEAR) + diffMonth) + 1;
    ...
    private int getMonthForPosition(int position) {
        return (this.mMinDate.get(2) + position) % MONTHS_IN_YEAR;
    }

    private int getYearForPosition(int position) {
        return this.mMinDate.get(1) + ((this.mMinDate.get(2) + position) / MONTHS_IN_YEAR);
    }
    ...
    private int getPositionForDay(Calendar day) {
        ...
        return ((day.get(1) - this.mMinDate.get(1)) * MONTHS_IN_YEAR) + (day.get(2) - this.mMinDate.get(2));
    }

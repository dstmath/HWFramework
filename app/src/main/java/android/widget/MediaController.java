...
public class MediaController extends FrameLayout {
        ...
        this.mShowProgress = new Runnable() {
            public void run() {
                ...
                if (!MediaController.this.mDragging && MediaController.this.mShowing && MediaController.this.mPlayer.isPlaying()) {
                    MediaController.this.postDelayed(MediaController.this.mShowProgress, (long) (1000 - (pos % RILConstants.RIL_UNSOL_RESPONSE_RADIO_STATE_CHANGED)));
                }
            }
        };
    ...
    private void initFloatingWindowLayout() {
        ...
        p.x = 0;
        p.format = -3;
        p.type = RILConstants.RIL_UNSOL_RESPONSE_RADIO_STATE_CHANGED;
        p.flags |= 8519712;
        p.token = null;
    ...
    private void initControllerView(View v) {
        ...
        if (this.mProgress != null) {
            ...
            this.mProgress.setMax(RILConstants.RIL_UNSOL_RESPONSE_RADIO_STATE_CHANGED);
        }
    ...
    private String stringForTime(int timeMs) {
        int totalSeconds = timeMs / RILConstants.RIL_UNSOL_RESPONSE_RADIO_STATE_CHANGED;
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        if (keyCode == 79 || keyCode == 85 || keyCode == 62) {
            ...
            return true;
        } else if (keyCode == 25 || keyCode == 24 || keyCode == LogPower.AUDIO_SESSION_START || keyCode == 27) {

...
class MapBiller {
    private MapPoint lastBilled;
    private Zoom lastBilledZoom;
    private BillingPointListener listener;
    private MapPoint previousBilled;
    private Zoom previousBilledZoom;

    MapBiller() {
        this.lastBilled = null;
        this.lastBilledZoom = null;
        this.listener = null;
        this.previousBilled = null;
        this.previousBilledZoom = null;
    }

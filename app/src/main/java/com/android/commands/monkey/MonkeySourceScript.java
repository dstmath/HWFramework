...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.commands.monkey.MonkeySourceScript.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.commands.monkey.MonkeySourceScript.<clinit>():void
...
*/
    ...
    private void handleEvent(String s, String[] args) {
        ...
        if (s.indexOf(EVENT_KEYWORD_TAP) >= 0) {
            length = args.length;
            if (r0 >= 2) {
                try {
        ...
        if (s.indexOf(EVENT_KEYWORD_PRESSANDHOLD) >= 0) {
            length = args.length;
            if (r0 == 3) {
                try {
                    x = Float.parseFloat(args[0]);
        ...
        if (s.indexOf(EVENT_KEYWORD_DRAG) >= 0) {
            length = args.length;
            if (r0 == 5) {
        ...
        if (s.indexOf(EVENT_KEYWORD_PINCH_ZOOM) >= 0) {
            length = args.length;
            if (r0 == 9) {
        ...
        if (s.indexOf(EVENT_KEYWORD_INSTRUMENTATION) >= 0) {
            length = args.length;
            if (r0 == 2) {
        ...
        if (s.indexOf(EVENT_KEYWORD_WAIT) >= 0) {
            length = args.length;
            if (r0 == 1) {
                try {
        ...
        if (s.indexOf(EVENT_KEYWORD_KEYPRESS) >= 0) {
            length = args.length;
            if (r0 == 1) {
        ...
        if (s.indexOf(EVENT_KEYWORD_RUNCMD) >= 0) {
            length = args.length;
            if (r0 == 1) {
                this.mQ.addLast(new MonkeyCommandEvent(args[0]));
            }
        }
        if (s.indexOf(EVENT_KEYWORD_INPUT_STRING) >= 0) {
            length = args.length;
            if (r0 == 1) {
        ...
        if (s.indexOf(EVENT_KEYWORD_END_FRAMERATE_CAPTURE) >= 0) {
            length = args.length;
            if (r0 == 1) {
        ...
        if (s.indexOf(EVENT_KEYWORD_START_APP_FRAMERATE_CAPTURE) >= 0) {
            length = args.length;
            if (r0 == 1) {
        ...
        if (s.indexOf(EVENT_KEYWORD_END_APP_FRAMERATE_CAPTURE) >= 0) {
            length = args.length;
            if (r0 == 2) {

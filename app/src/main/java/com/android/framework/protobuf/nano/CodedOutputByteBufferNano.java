...
public final class CodedOutputByteBufferNano {
    ...
    public void writeGroup(int fieldNumber, MessageNano value) throws IOException {
        writeTag(fieldNumber, MAX_UTF8_EXPANSION);
    ...
    public void writeStringNoTag(String value) throws IOException {
        try {
            ...
            if (minLengthVarIntSize == computeRawVarint32Size(value.length() * MAX_UTF8_EXPANSION)) {
    ...
    private static int encodedLengthGeneral(CharSequence sequence, int start) {
        ...
        while (i < utf16Length) {
            ...
            if (c < '\u0800') {
                ...
                utf8Length += 2;
                if ('\ud800' <= c && c <= '\udfff') {
                    if (Character.codePointAt(sequence, i) < Protocol.BASE_SYSTEM_RESERVED) {
    ...
    private static void encodeDirect(CharSequence sequence, ByteBuffer byteBuffer) {
        ...
        while (i < utf16Length) {
            ...
            if (c < '\u0080') {
                ...
                byteBuffer.put((byte) ((c & 63) | LogPower.START_CHG_ROTATION));
            } else if (c < '\ud800' || '\udfff' < c) {
                byteBuffer.put((byte) ((c >>> 12) | HwBootFail.PHASE_LOCK_SETTINGS_READY));
                byteBuffer.put((byte) (((c >>> 6) & 63) | LogPower.START_CHG_ROTATION));
                byteBuffer.put((byte) ((c & 63) | LogPower.START_CHG_ROTATION));
            } else {
                if (i + 1 != sequence.length()) {
                    ...
                    if (Character.isSurrogatePair(c, low)) {
                        ...
                        byteBuffer.put((byte) ((codePoint >>> 18) | IndexSearchConstants.INDEX_BUILD_FLAG_MASK));
                        byteBuffer.put((byte) (((codePoint >>> 12) & 63) | LogPower.START_CHG_ROTATION));
                        byteBuffer.put((byte) (((codePoint >>> 6) & 63) | LogPower.START_CHG_ROTATION));
                        byteBuffer.put((byte) ((codePoint & 63) | LogPower.START_CHG_ROTATION));
                    }
                }
    ...
    private static int encode(CharSequence sequence, byte[] bytes, int offset, int length) {
        ...
        while (i < utf16Length) {
            ...
            if (c < '\u0080' && j2 < limit) {
                ...
                j2 = j + 1;
                bytes[j] = (byte) ((c & 63) | LogPower.START_CHG_ROTATION);
                j = j2;
            } else if ((c < '\ud800' || '\udfff' < c) && j2 <= limit - 3) {
                j = j2 + 1;
                bytes[j2] = (byte) ((c >>> 12) | HwBootFail.PHASE_LOCK_SETTINGS_READY);
                j2 = j + 1;
                bytes[j] = (byte) (((c >>> 6) & 63) | LogPower.START_CHG_ROTATION);
                j = j2 + 1;
                bytes[j2] = (byte) ((c & 63) | LogPower.START_CHG_ROTATION);
            } else if (j2 <= limit - 4) {
                if (i + 1 != sequence.length()) {
                    i++;
                    char low = sequence.charAt(i);
                    if (Character.isSurrogatePair(c, low)) {
                        int codePoint = Character.toCodePoint(c, low);
                        j = j2 + 1;
                        bytes[j2] = (byte) ((codePoint >>> 18) | IndexSearchConstants.INDEX_BUILD_FLAG_MASK);
                        j2 = j + 1;
                        bytes[j] = (byte) (((codePoint >>> 12) & 63) | LogPower.START_CHG_ROTATION);
                        j = j2 + 1;
                        bytes[j2] = (byte) (((codePoint >>> 6) & 63) | LogPower.START_CHG_ROTATION);
                        j2 = j + 1;
                        bytes[j] = (byte) ((codePoint & 63) | LogPower.START_CHG_ROTATION);
                        j = j2;
                    }
                }
                throw new IllegalArgumentException("Unpaired surrogate at index " + (i - 1));
    ...
    public void writeRawVarint32(int value) throws IOException {
        while ((value & -128) != 0) {
            writeRawByte((value & LogPower.MIME_TYPE) | LogPower.START_CHG_ROTATION);
            value >>>= 7;
        }
        writeRawByte(value);
    }
    ...
    public void writeRawVarint64(long value) throws IOException {
        while ((-128 & value) != 0) {
            writeRawByte((((int) value) & LogPower.MIME_TYPE) | LogPower.START_CHG_ROTATION);
            value >>>= 7;
        }
    ...
    public void writeRawLittleEndian32(int value) throws IOException {
        if (this.buffer.remaining() < LITTLE_ENDIAN_32_SIZE) {
            throw new OutOfSpaceException(this.buffer.position(), this.buffer.limit());
        }
    ...
    public void writeRawLittleEndian64(long value) throws IOException {
        if (this.buffer.remaining() < LITTLE_ENDIAN_64_SIZE) {
            throw new OutOfSpaceException(this.buffer.position(), this.buffer.limit());
        }

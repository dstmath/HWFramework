...
public class HeavyWeightSwitcherActivity extends Activity {
    ...
    public HeavyWeightSwitcherActivity() {
        this.mSwitchOldListener = new OnClickListener() {
        ...
        this.mSwitchNewListener = new OnClickListener() {
            public void onClick(View v) {
                try {
                ...
                try {
                    if (HeavyWeightSwitcherActivity.this.mHasResult) {
                        HeavyWeightSwitcherActivity.this.startIntentSenderForResult(HeavyWeightSwitcherActivity.this.mStartIntent, -1, null, EditorInfo.IME_FLAG_NO_FULLSCREEN, EditorInfo.IME_FLAG_NO_FULLSCREEN, 0);
                    } else {

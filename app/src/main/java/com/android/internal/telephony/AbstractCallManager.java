...
public abstract class AbstractCallManager {
    CallManagerReference mReference;
    ...
    public interface CallManagerReference {
        ...
        void setCallNotifierDisconnectCallback(disconnectCallback com_android_internal_telephony_AbstractCallManager_disconnectCallback);

        void setConnEncryptCallByNumber(Phone phone, String str, boolean z);

        void setInCallScreenDisconnectCallback(disconnectCallback com_android_internal_telephony_AbstractCallManager_disconnectCallback);
    ...
    public AbstractCallManager() {
        this.mReference = HwTelephonyFactory.getHwPhoneManager().createHwCallManagerReference(this);
    }

...
public interface HwTelephonyProperties {
    ...
    public static final String NOTIFICATION_UNSUPPORT_LTE_ICCID = "persist.radio.sim.iccid";
    ...
    public static final String PROPERTY_HWDS_AUTO_DATA_SWITCH = "ro.hwpp.autodds";
    public static final String PROPERTY_HWDS_AUTO_DDS_SIGNAL_STRENGTH_CFG = "ro.hwpp.autodds_qos";
    public static final String PROPERTY_HWDS_AUTO_DDS_SWITCH_FORBIDDEN_INTERVAL_CONFIG = "ro.hwpp.switch_interval_cfg";
    public static final String PROPERTY_HWDS_AUTO_DDS_WAIT_DS_RECOVER_TIMER = "ro.hwpp.wait_ds_recover_time";

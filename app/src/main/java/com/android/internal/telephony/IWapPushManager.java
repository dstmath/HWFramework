...
public interface IWapPushManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWapPushManager {
        ...
        private static class Proxy implements IWapPushManager {
            ...
            public int processMessage(String app_id, String content_type, Intent intent) throws RemoteException {
                ...
                try {
                    ...
                    if (intent != null) {
                        _data.writeInt(Stub.TRANSACTION_processMessage);
                        intent.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
                    this.mRemote.transact(Stub.TRANSACTION_processMessage, _data, _reply, 0);
            ...
            public boolean addPackage(String x_app_id, String content_type, String package_name, String class_name, int app_type, boolean need_signature, boolean further_processing) throws RemoteException {
                int i = Stub.TRANSACTION_processMessage;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    int i2;
                    ...
                    if (need_signature) {
                        i2 = Stub.TRANSACTION_processMessage;
                    } else {
                        i2 = 0;
                    }
                    _data.writeInt(i2);
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_addPackage, _data, _reply, 0);
                    _reply.readException();
            ...
            public boolean updatePackage(String x_app_id, String content_type, String package_name, String class_name, int app_type, boolean need_signature, boolean further_processing) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_updatePackage, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            boolean _result;
            switch (code) {
                case TRANSACTION_processMessage /*1*/:
                    Intent intent;
                ...
                case TRANSACTION_addPackage /*2*/:
                    ...
                    reply.writeNoException();
                    reply.writeInt(_result ? TRANSACTION_processMessage : 0);
                    return true;
                case TRANSACTION_updatePackage /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(_result ? TRANSACTION_processMessage : 0);
                    return true;
                case TRANSACTION_deletePackage /*4*/:
                    data.enforceInterface(DESCRIPTOR);

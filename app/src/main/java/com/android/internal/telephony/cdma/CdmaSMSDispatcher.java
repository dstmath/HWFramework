...
public abstract class CdmaSMSDispatcher extends SMSDispatcher {
    ...
    protected void sendSmsByPstn(SmsTracker tracker) {
        ...
        if (isIms() || ss == 0) {
            ...
            boolean imsSmsDisabled = ((currentDataNetwork == 14 || (currentDataNetwork == 13 && !this.mPhone.getServiceStateTracker().isConcurrentVoiceAndDataAllowed())) && this.mPhone.getServiceState().getVoiceNetworkType() == 7) ? ((GsmCdmaPhone) this.mPhone).mCT.mState != State.IDLE : false;
    ...
    public void dispatchCTAutoRegSmsPdus(SmsMessageBase smsb) {
        ...
        Intent intent = new Intent(Intents.CT_AUTO_REG_RECV_CONFIRM_ACK);

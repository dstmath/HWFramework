...
public abstract class AbstractImsPhoneCallTracker extends CallTracker {
    ImsPhoneCallTrackerReference mReference;
    ...
    public AbstractImsPhoneCallTracker() {
        this.mReference = HwTelephonyFactory.getHwPhoneManager().createHwImsPhoneCallTrackerReference(this);
    }

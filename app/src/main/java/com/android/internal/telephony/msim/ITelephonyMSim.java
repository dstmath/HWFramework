        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_call /*2*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_showCallScreen /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_supplyPin /*14*/:
                    ...
                    reply.writeInt(_result ? TRANSACTION_dial : 0);
                    return true;
                case TRANSACTION_supplyPuk /*15*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = supplyPuk(data.readString(), data.readString(), 0);
                    reply.writeNoException();
                    reply.writeInt(_result ? TRANSACTION_dial : 0);
                    return true;
                case TRANSACTION_handlePinMmi /*16*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = handlePinMmi(data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? TRANSACTION_dial : 0);
                    return true;
                case TRANSACTION_toggleRadioOnOff /*17*/:
                    data.enforceInterface(DESCRIPTOR);
                    toggleRadioOnOff(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setRadio /*18*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setRadio(data.readInt() != 0, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? TRANSACTION_dial : 0);
                    return true;
                case TRANSACTION_updateServiceLocation /*19*/:
                    data.enforceInterface(DESCRIPTOR);
                    updateServiceLocation(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_enableApnType /*20*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = enableApnType(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_disableApnType /*21*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = disableApnType(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_enableDataConnectivity /*22*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = enableDataConnectivity();
                    reply.writeNoException();
                    reply.writeInt(_result ? TRANSACTION_dial : 0);
                    return true;
                case TRANSACTION_disableDataConnectivity /*23*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_getDataActivity /*26*/:
                    ...
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_getDataState /*27*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getDataState();
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_getActivePhoneType /*28*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getActivePhoneType(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_getCdmaEriIconIndex /*29*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getCdmaEriIconIndex(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_getCdmaEriIconMode /*30*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getCdmaEriIconMode(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_getCdmaEriText /*31*/:
                    data.enforceInterface(DESCRIPTOR);
                    String _result3 = getCdmaEriText(data.readInt());
                    reply.writeNoException();
                    reply.writeString(_result3);
                    return true;
                case TRANSACTION_needsOtaServiceProvisioning /*32*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = needsOtaServiceProvisioning();
                    reply.writeNoException();
                    reply.writeInt(_result ? TRANSACTION_dial : 0);
                    return true;
                case TRANSACTION_getVoiceMessageCount /*33*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_hasIccCard /*35*/:
                    ...
                    reply.writeInt(_result ? TRANSACTION_dial : 0);
                    return true;
                case TRANSACTION_getLteOnCdmaMode /*36*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_getPreferredVoiceSubscription /*39*/:
                    ...
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_getPreferredDataSubscription /*40*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getPreferredDataSubscription();
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_setPreferredDataSubscription /*41*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setPreferredDataSubscription(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? TRANSACTION_dial : 0);
                    return true;
                case TRANSACTION_getDataNetworkType /*42*/:
                    data.enforceInterface(DESCRIPTOR);

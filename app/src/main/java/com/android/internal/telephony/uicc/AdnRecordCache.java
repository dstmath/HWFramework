    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            case EVENT_LOAD_ALL_ADN_LIKE_DONE /*1*/:
                ...
                if (AbstractIccRecords.getEmailAnrSupport() && this.mAdnLikeFiles.get(IccConstants.EF_CSIM_LI) != null) {
                    setAdnCountHW(((ArrayList) this.mAdnLikeFiles.get(IccConstants.EF_CSIM_LI)).size());
                }
                if (AbstractIccRecords.getAdnLongNumberSupport() && this.mAdnLikeFiles.get(IccConstants.EF_CSIM_LI) != null) {
            ...
            case EVENT_UPDATE_ADN_DONE /*2*/:
                ...
                if (ar.exception == null) {
                    if (this.mAdnLikeFiles.get(efid) != null) {
                        if (index < EVENT_LOAD_ALL_ADN_LIKE_DONE || index > ((ArrayList) this.mAdnLikeFiles.get(efid)).size()) {

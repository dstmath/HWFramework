...
public class HwIccFileHandlerReference extends Handler implements IccFileHandlerReference {
    ...
    private Handler efPartReaderHandler;
    private IccFileHandler mFh;
    private Handler vnReaderHandler;
    ...
    private class EfPartReaderHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            try {
                switch (msg.what) {
                    case HwIccFileHandlerReference.RESPONSE_DATA_FILE_TYPE /*6*/:
                        ...
                        if (HwIccFileHandlerReference.TYPE_EF != this.data[HwIccFileHandlerReference.RESPONSE_DATA_FILE_TYPE]) {
                            throw new IccFileTypeMismatch();
                        } else if (HwIccFileHandlerReference.TYPE_MF != this.data[HwIccFileHandlerReference.RESPONSE_DATA_STRUCTURE]) {
                            throw new IccFileTypeMismatch();
                        } else {
                            this.lc.mRecordSize = this.data[HwIccFileHandlerReference.RESPONSE_DATA_RECORD_LENGTH] & HwSubscriptionManager.SUB_INIT_STATE;
                            this.size = ((this.data[HwIccFileHandlerReference.TYPE_DF] & HwSubscriptionManager.SUB_INIT_STATE) << HwIccFileHandlerReference.RESPONSE_DATA_ACCESS_CONDITION_1) + (this.data[HwIccFileHandlerReference.RESPONSE_DATA_FILE_SIZE_2] & HwSubscriptionManager.SUB_INIT_STATE);
                            ...
                            HwIccFileHandlerReference.this.mFh.mCi.iccIOForApp(HwIccFileHandlerReference.COMMAND_READ_RECORD, this.lc.mEfid, HwIccFileHandlerReference.this.mFh.getEFPath(this.lc.mEfid), this.lc.mRecordNum, HwIccFileHandlerReference.TYPE_EF, this.lc.mRecordSize, null, null, HwIccFileHandlerReference.this.mFh.mAid, obtainMessage(HwIccFileHandlerReference.RESPONSE_DATA_RFU_3, this.lc));
                            return;
                        }
                    case HwIccFileHandlerReference.RESPONSE_DATA_RFU_3 /*7*/:
                        this.ar = (AsyncResult) msg.obj;
                        this.lc = (LoadLinearFixedContext) this.ar.userObj;
                        this.result = (IccIoResult) this.ar.result;
                        this.response = this.lc.mOnLoaded;
                        ...
                        if (this.iccException != null) {
                            ...
                            r0 = this.lc;
                            r0.mRecordNum += HwIccFileHandlerReference.TYPE_MF;
                            ...
                            r0 = this.lc;
                            r0.mCount += HwIccFileHandlerReference.TYPE_MF;
                            if (this.lc.mCount < this.lc.mCountLoadrecords) {
                                ...
                                if (this.lc.mRecordNum <= this.lc.mCountRecords) {
                                    ...
                                    HwIccFileHandlerReference.this.mFh.mCi.iccIOForApp(HwIccFileHandlerReference.COMMAND_READ_RECORD, this.lc.mEfid, this.path, this.lc.mRecordNum, HwIccFileHandlerReference.TYPE_EF, this.lc.mRecordSize, null, null, HwIccFileHandlerReference.this.mFh.mAid, obtainMessage(HwIccFileHandlerReference.RESPONSE_DATA_RFU_3, this.lc));
                                    return;
                                }
                                HwIccFileHandlerReference.this.sendResult(this.response, this.lc.results, null);
                                return;
    ...
    static class LoadLinearFixedContext {
        ...
        LoadLinearFixedContext(int efid, String path, Message onLoaded) {
            this.mEfid = efid;
            this.mRecordNum = HwIccFileHandlerReference.TYPE_MF;
            this.mLoadAll = true;
            this.mLoadPart = false;
            this.mOnLoaded = onLoaded;
            this.mPath = path;
        ...
        LoadLinearFixedContext(int efid, ArrayList<Integer> recordNums, String path, Message onLoaded) {
            ...
            if (recordNums != null) {
                this.mRecordNum = ((Integer) recordNums.get(HwIccFileHandlerReference.RESPONSE_DATA_RFU_1)).intValue();
                this.mRecordNums.addAll(recordNums);
                this.mCountLoadrecords = recordNums.size();
            }
            this.mCount = HwIccFileHandlerReference.RESPONSE_DATA_RFU_1;
            this.mOnLoaded = onLoaded;
            this.mPath = path;
        }
        ...
        private void initLCResults(int size) {
            ...
            for (i = HwIccFileHandlerReference.RESPONSE_DATA_RFU_1; i < this.mRecordSize; i += HwIccFileHandlerReference.TYPE_MF) {
                data[i] = (byte) -1;
            }
            for (i = HwIccFileHandlerReference.RESPONSE_DATA_RFU_1; i < size; i += HwIccFileHandlerReference.TYPE_MF) {
            ...
            try {
                switch (msg.what) {
                    case HwIccFileHandlerReference.EVENT_GET_CUSTOM_BINARY_SIZE_DONE /*1200*/:
                        ...
                        if (HwIccFileHandlerReference.TYPE_EF != this.data[HwIccFileHandlerReference.RESPONSE_DATA_FILE_TYPE]) {
                            throw new IccFileTypeMismatch();
                        } else if (this.data[HwIccFileHandlerReference.RESPONSE_DATA_STRUCTURE] != null) {
                            throw new IccFileTypeMismatch();
                        } else {
                            this.size = ((this.data[HwIccFileHandlerReference.TYPE_DF] & HwSubscriptionManager.SUB_INIT_STATE) << HwIccFileHandlerReference.RESPONSE_DATA_ACCESS_CONDITION_1) + (this.data[HwIccFileHandlerReference.RESPONSE_DATA_FILE_SIZE_2] & HwSubscriptionManager.SUB_INIT_STATE);
                            if (isForApp) {
                                Rlog.d(HwIccFileHandlerReference.LOG_TAG, "loadEFTransparent for App");
                                HwIccFileHandlerReference.this.mFh.mCi.iccIOForApp(HwIccFileHandlerReference.COMMAND_READ_BINARY, this.fileid, filePath, HwIccFileHandlerReference.RESPONSE_DATA_RFU_1, HwIccFileHandlerReference.RESPONSE_DATA_RFU_1, this.size, null, null, HwIccFileHandlerReference.this.mFh.mAid, obtainMessage(HwIccFileHandlerReference.EVENT_READ_CUSTOM_BINARY_DONE, this.fileid, HwIccFileHandlerReference.RESPONSE_DATA_RFU_1, this.response));
                                return;
                            }
                            HwIccFileHandlerReference.this.mFh.mCi.iccIO(HwIccFileHandlerReference.COMMAND_READ_BINARY, this.fileid, filePath, HwIccFileHandlerReference.RESPONSE_DATA_RFU_1, HwIccFileHandlerReference.RESPONSE_DATA_RFU_1, this.size, null, null, obtainMessage(HwIccFileHandlerReference.EVENT_READ_CUSTOM_BINARY_DONE, this.fileid, HwIccFileHandlerReference.RESPONSE_DATA_RFU_1, this.response));
                            return;
                        }
    ...
    public HwIccFileHandlerReference(IccFileHandler fileHandler) {
        this.vnReaderHandler = new VnReaderHandler();
        this.efPartReaderHandler = new EfPartReaderHandler();
    ...
    public void loadEFTransparent(String filePath, int fileid, Message onLoaded) {
        Message response = this.vnReaderHandler.obtainMessage(EVENT_GET_CUSTOM_BINARY_SIZE_DONE, fileid, RESPONSE_DATA_RFU_1, onLoaded);
        Bundle data = new Bundle();
        data.putString(CUSTOM_FILE_PATH, filePath);
        response.setData(data);
        this.mFh.mCi.iccIO(COMMAND_GET_RESPONSE, fileid, filePath, RESPONSE_DATA_RFU_1, RESPONSE_DATA_RFU_1, GET_RESPONSE_EF_SIZE_BYTES, null, null, response);
    }
    ...
    public void loadEFTransparent(String filePath, int fileid, Message onLoaded, boolean isForApp) {
        ...
        this.mFh.mCi.iccIOForApp(COMMAND_GET_RESPONSE, fileid, filePath, RESPONSE_DATA_RFU_1, RESPONSE_DATA_RFU_1, GET_RESPONSE_EF_SIZE_BYTES, null, null, this.mFh.mAid, response);
    }
    ...
    public void loadEFLinearFixedPartHW(int fileid, ArrayList<Integer> recordNums, Message onLoaded) {
        ...
        String str = null;
        this.mFh.mCi.iccIOForApp(COMMAND_GET_RESPONSE, i, this.mFh.getEFPath(fileid), RESPONSE_DATA_RFU_1, i2, GET_RESPONSE_EF_SIZE_BYTES, null, str, this.mFh.mAid, this.efPartReaderHandler.obtainMessage(RESPONSE_DATA_FILE_TYPE, new LoadLinearFixedContext(fileid, (ArrayList) recordNums, this.mFh.getEFPath(fileid), onLoaded)));
    }
}

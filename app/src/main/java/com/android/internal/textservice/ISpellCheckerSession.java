    ...
    public static abstract class Stub extends Binder implements ISpellCheckerSession {
        ...
        private static class Proxy implements ISpellCheckerSession {
            ...
            public void onGetSuggestionsMultiple(TextInfo[] textInfos, int suggestionsLimit, boolean multipleWords) throws RemoteException {
                int i = Stub.TRANSACTION_onGetSuggestionsMultiple;
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_onGetSuggestionsMultiple, _data, null, Stub.TRANSACTION_onGetSuggestionsMultiple);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onGetSentenceSuggestionsMultiple(TextInfo[] textInfos, int suggestionsLimit) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeTypedArray(textInfos, 0);
                    _data.writeInt(suggestionsLimit);
                    this.mRemote.transact(Stub.TRANSACTION_onGetSentenceSuggestionsMultiple, _data, null, Stub.TRANSACTION_onGetSuggestionsMultiple);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onCancel() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_onCancel, _data, null, Stub.TRANSACTION_onGetSuggestionsMultiple);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onClose() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_onClose, _data, null, Stub.TRANSACTION_onGetSuggestionsMultiple);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            boolean _arg2 = false;
            switch (code) {
                case TRANSACTION_onGetSuggestionsMultiple /*1*/:
                    ...
                    return true;
                case TRANSACTION_onGetSentenceSuggestionsMultiple /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    onGetSentenceSuggestionsMultiple((TextInfo[]) data.createTypedArray(TextInfo.CREATOR), data.readInt());
                    return true;
                case TRANSACTION_onCancel /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    onCancel();
                    return true;
                case TRANSACTION_onClose /*4*/:
                    data.enforceInterface(DESCRIPTOR);
                    onClose();
                    return true;
                case 1598968902:

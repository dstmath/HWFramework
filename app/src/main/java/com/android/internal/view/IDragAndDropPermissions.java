...
public interface IDragAndDropPermissions extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IDragAndDropPermissions {
        ...
        private static class Proxy implements IDragAndDropPermissions {
            ...
            public void take(IBinder activityToken) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_take, _data, _reply, 0);
            ...
            public void takeTransient(IBinder permissionOwnerToken) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_takeTransient, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_take /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    take(data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_takeTransient /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    takeTransient(data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_release /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    release();
                    reply.writeNoException();
                    return true;

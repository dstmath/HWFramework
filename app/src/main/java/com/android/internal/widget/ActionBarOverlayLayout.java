...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.internal.widget.ActionBarOverlayLayout.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.internal.widget.ActionBarOverlayLayout.<clinit>():void
...
*/
    ...
    public ActionBarOverlayLayout(Context context) {
        ...
        this.ACTION_BAR_ANIMATE_DELAY = HwBootFail.PHASE_THIRD_PARTY_APPS_CAN_START;
    ...
    public void onWindowSystemUiVisibilityChanged(int visible) {
        ...
        boolean stable = (visible & GL10.GL_DEPTH_BUFFER_BIT) != 0;
        ...
        if ((diff & GL10.GL_DEPTH_BUFFER_BIT) != 0 && this.mActionBarVisibilityCallback != null) {
            requestApplyInsets();
        }
    }
    ...
    public WindowInsets onApplyWindowInsets(WindowInsets insets) {
        pullChildren();
        if ((getWindowSystemUiVisibility() & GL10.GL_DEPTH_BUFFER_BIT) != 0) {
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        boolean stable = (getWindowSystemUiVisibility() & GL10.GL_DEPTH_BUFFER_BIT) != 0;
        if (stable) {
    ...
    private boolean shouldHideActionBarOnFling(float velocityX, float velocityY) {
        this.mFlingEstimator.fling(0, 0, 0, (int) velocityY, 0, 0, RtlSpacingHelper.UNDEFINED, HwBootFail.STAGE_BOOT_SUCCESS);

        ...
        private static class Proxy implements IRemoteViewsAdapterConnection {
            ...
            public void onServiceConnected(IBinder service) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onServiceConnected, _data, null, Stub.TRANSACTION_onServiceConnected);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onServiceDisconnected() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_onServiceDisconnected, _data, null, Stub.TRANSACTION_onServiceConnected);
                } finally {
                    _data.recycle();
                }
            }

                ...
                if (!requestCaching.noCache()) {
                    if (!hasConditions(this.request)) {
                        ...
                        if (responseCaching.noCache() || ageMillis + minFreshMillis >= freshMillis + maxStaleMillis) {
                            ...
                            if (this.etag != null) {
                                str = "If-None-Match";
                                conditionalRequestBuilder.header(r17, this.etag);
                            } else if (this.lastModified != null) {
                                str = "If-Modified-Since";
                                conditionalRequestBuilder.header(r17, this.lastModifiedString);
                            } else if (this.servedDate != null) {
                                str = "If-Modified-Since";
                                conditionalRequestBuilder.header(r17, this.servedDateString);
                            }

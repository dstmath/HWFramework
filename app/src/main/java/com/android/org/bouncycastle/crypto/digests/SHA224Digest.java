...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.org.bouncycastle.crypto.digests.SHA224Digest.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.org.bouncycastle.crypto.digests.SHA224Digest.<clinit>():void
...
*/
    ...
    public SHA224Digest(byte[] encodedState) {
        ...
        this.H4 = Pack.bigEndianToInt(encodedState, DIGEST_LENGTH);
    ...
    public byte[] getEncodedState() {
        ...
        Pack.intToBigEndian(this.H4, state, (int) DIGEST_LENGTH);

...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.org.bouncycastle.jcajce.provider.asymmetric.x509.CertificateFactory.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.org.bouncycastle.jcajce.provider.asymmetric.x509.CertificateFactory.<clinit>():void
    ...
    public CRL engineGenerateCRL(InputStream inStream) throws CRLException {
        ...
        try {
            if (this.sCrlData == null) {
                InputStream pis = new PushbackInputStream(inStream);
                int tag = pis.read();
                if (tag == -1) {
                    return null;
                }

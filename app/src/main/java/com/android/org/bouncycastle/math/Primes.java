...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.org.bouncycastle.math.Primes.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.org.bouncycastle.math.Primes.<clinit>():void
    ...
    private static STOutput implSTRandomPrime(Digest d, int length, byte[] primeSeed) {
        ...
        if (length < 33) {
            ...
            do {
                ...
                if (isPrime32(c64)) {
                    return new STOutput(primeSeed, primeGenCounter, null);
                }
        ...
        while (true) {
            ...
            if (implHasAnySmallFactors(c)) {
                ...
                int i = iterations + 1;
                BigInteger a = hashGen(d, primeSeed, r25).mod(c.subtract(THREE)).add(TWO);

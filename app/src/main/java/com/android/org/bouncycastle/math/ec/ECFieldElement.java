...
public abstract class ECFieldElement implements ECConstants {
    ...
    public static class F2m extends ECFieldElement {
        ...
        private F2m(int m, int[] ks, LongArray x) {
            this.m = m;
            this.representation = ks.length == GNB ? TPB : PPB;
            this.ks = ks;
            this.x = x;
        }
        ...
        public ECFieldElement squarePow(int pow) {
            return pow < GNB ? this : new F2m(this.m, this.ks, this.x.modSquareN(pow, this.m, this.ks));
        }
        ...
        public ECFieldElement sqrt() {
            ...
            if (this.q.testBit(0)) {
                ...
                if (this.q.testBit(2)) {
                    ...
                    BigInteger t1 = r0.modPow(r0.shiftRight(3), this.q);
                    BigInteger t2 = modMult(t1, this.x);
                    if (modMult(t2, t1).equals(ECConstants.ONE)) {
                        return checkSqrt(new Fp(this.q, this.r, t2));
                    }
                    bigInteger2 = this.q;
                    BigInteger y = modMult(t2, ECConstants.TWO.modPow(r0.shiftRight(2), this.q));
                ...
                while (true) {
                    ...
                    if (P.compareTo(this.q) < 0) {
                        if (modReduce(P.multiply(P).subtract(fourX)).modPow(legendreExponent, this.q).equals(qMinusOne)) {

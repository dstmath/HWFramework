        ...
        protected boolean satisfiesCurveEquation() {
            ...
            switch (getCurveCoordinateSystem()) {
                ...
                case ExtendedPKIXParameters.CHAIN_VALIDITY_MODEL /*1*/:
                    ...
                    break;
                case com.android.org.bouncycastle.math.ec.ECFieldElement.F2m.TPB /*2*/:
                case com.android.org.bouncycastle.math.ec.ECFieldElement.F2m.PPB /*3*/:
            ...
            switch (curve.getCoordinateSystem()) {
                case ECCurve.COORD_AFFINE /*0*/:
                    ...
                    if (!dx.isZero()) {
                        ...
                        ECFieldElement multiply = X1.subtract(X4).multiply(L2);
                        return new Fp(curve, X4, r19.subtract(Y1), this.withCompression);
                    } else if (dy.isZero()) {
                        return threeTimes();
                    } else {
                        return this;
        ...
        public ECPoint threeTimes() {
            ...
            switch (curve.getCoordinateSystem()) {
                case ECCurve.COORD_AFFINE /*0*/:
                    ...
                    ECFieldElement multiply = X1.subtract(X4).multiply(L2);
                    return new Fp(curve, X4, r17.subtract(Y1), this.withCompression);
                case ECCurve.COORD_JACOBIAN_MODIFIED /*4*/:
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.org.bouncycastle.math.ec.ECPoint.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.org.bouncycastle.math.ec.ECPoint.<clinit>():void
...
*/
    ...
    protected boolean satisfiesCofactor() {
        ...
        if (h == null || h.equals(ECConstants.ONE) || !ECAlgorithms.referenceMultiply(this, h).isInfinity()) {
            return true;
        }
        return false;
    }

...
public final class OpenSSLECPublicKey implements ECPublicKey, OpenSSLKeyHolder {
    ...
    public OpenSSLECPublicKey(ECPublicKeySpec ecKeySpec) throws InvalidKeySpecException {
        try {
            ...
            this.key = new OpenSSLKey(NativeCrypto.EVP_PKEY_new_EC_KEY(this.group.getNativeRef(), OpenSSLECPointContext.getInstance(NativeCrypto.get_EC_GROUP_type(this.group.getNativeRef()), this.group, ecKeySpec.getW()).getNativeRef(), null));
        } catch (Exception e) {
    ...
    public static OpenSSLKey getInstance(ECPublicKey ecPublicKey) throws InvalidKeyException {
        try {
            ...
            return new OpenSSLKey(NativeCrypto.EVP_PKEY_new_EC_KEY(group.getNativeRef(), OpenSSLECPointContext.getInstance(NativeCrypto.get_EC_GROUP_type(group.getNativeRef()), group, ecPublicKey.getW()).getNativeRef(), null));
        } catch (Exception e) {

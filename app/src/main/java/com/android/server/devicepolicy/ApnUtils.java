...
public class ApnUtils {
    ...
    private static final String[] APN_KEYS = null;
    private static final Uri APN_URI = null;
    ...
    private static final Pattern PATTERN_MCC = null;
    private static final Pattern PATTERN_MNC = null;
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.devicepolicy.ApnUtils.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.devicepolicy.ApnUtils.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.devicepolicy.ApnUtils.<clinit>():void");
    }
    ...
    public static void addApn(ContentResolver cr, Map<String, String> apnInfo) {
        if (getApnSelectionArgs(apnInfo).length == 0) {
        ...
        } else if (TextUtils.isEmpty((String) apnInfo.get(KEY_NAME))) {
            ...
            if (((String) apnInfo.get(KEY_TYPE)) == null) {
                contentValues.put(KEY_TYPE, MemoryConstant.MEM_SCENE_DEFAULT);
            }
    ...
    private static String getApnSelection(Map<String, String> apnInfo) {
        String result = AppHibernateCst.INVALID_PKG;

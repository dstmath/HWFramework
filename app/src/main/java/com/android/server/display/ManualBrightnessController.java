...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.display.ManualBrightnessController.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.display.ManualBrightnessController.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.display.ManualBrightnessController.<clinit>():void");
    }
    ...
    public int getMaxBrightnessForSeekbar() {
        return RampAnimator.DEFAULT_MAX_BRIGHTNESS;
    }

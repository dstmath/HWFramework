...
final class OverlayDisplayWindow implements Dump {
    ...
    public OverlayDisplayWindow(Context context, String name, int width, int height, int densityDpi, int gravity, boolean secure, Listener listener) {
        this.INITIAL_SCALE = TaskPositioner.RESIZING_HINT_ALPHA;
        this.MIN_SCALE = 0.3f;
        this.MAX_SCALE = 1.0f;
        this.WINDOW_ALPHA = 0.8f;
        ...
        this.mOnScaleGestureListener = new SimpleOnScaleGestureListener() {
        ...
        resize(width, height, densityDpi, DEBUG);
        createWindow();
    }
    ...
    private void resize(int width, int height, int densityDpi, boolean doLayout) {
        ...
        this.mTitle = this.mContext.getResources().getString(17040625, new Object[]{this.mName, Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight), Integer.valueOf(this.mDensityDpi)});
        if (this.mSecure) {
            this.mTitle += this.mContext.getResources().getString(17040626);
        }
        if (doLayout) {
            relayout();
        }
    ...
    private void createWindow() {
        ...
        this.mTextureView = (TextureView) this.mWindowContent.findViewById(16909248);
        ...
        this.mTitleTextView = (TextView) this.mWindowContent.findViewById(16909249);
        ...
        this.mWindowY = i2;
        this.mWindowScale = TaskPositioner.RESIZING_HINT_ALPHA;
    }
    ...
    private void updateWindowParams() {
        ...
        float offsetScale = ((scale / this.mWindowScale) - 1.0f) * TaskPositioner.RESIZING_HINT_ALPHA;

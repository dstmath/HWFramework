...
public class RampAnimator<T> {
    ...
    private final Runnable mAnimationCallbackForNewPolicy;
    ...
    public boolean mIsValidAutoBrightness;
                ...
                if (scale == 0.0f) {
                    ...
                    if (RampAnimator.this.mIsAutoBrightnessMode && (RampAnimator.this.mIsFirstValidAutoBrightness || RampAnimator.this.mTargetValue < RampAnimator.this.mCurrentValue || RampAnimator.this.mAutoBrightnessIntervened)) {
                        if (RampAnimator.this.mFirstTimeCalculateAmount) {
                            float duration = (RampAnimator.this.mIsFirstValidAutoBrightness || RampAnimator.this.mAutoBrightnessIntervened) ? TaskPositioner.RESIZING_HINT_ALPHA : 3.0f;
                            ...
                            if (RampAnimator.this.mTargetValue < 1254 && RampAnimator.this.mCurrentValue < 1300 && duration == 3.0f) {
                                amount = (((float) Math.abs(RampAnimator.this.mCurrentValue - RampAnimator.this.mTargetValue)) / TaskPositioner.RESIZING_HINT_ALPHA) * timeDelta;
                            }

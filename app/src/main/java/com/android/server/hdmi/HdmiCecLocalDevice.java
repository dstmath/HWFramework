...
abstract class HdmiCecLocalDevice {
    ...
    class AnonymousClass2 implements PendingActionClearedCallback {
        final /* synthetic */ PendingActionClearedCallback val$originalCallback;

        AnonymousClass2(PendingActionClearedCallback val$originalCallback) {
        ...
        public void onCleared(HdmiCecLocalDevice device) {
            ...
            this.val$originalCallback.onCleared(device);
        }
    }
    ...
    protected void disableDevice(boolean initiatedByCec, PendingActionClearedCallback originalCallback) {
        this.mPendingActionClearedCallback = new AnonymousClass2(originalCallback);

...
public class HdmiCecMessageBuilder {
    ...
    static HdmiCecMessage buildFeatureAbortCommand(int src, int dest, int originalOpcode, int reason) {
        return buildCommand(src, dest, 0, new byte[]{(byte) (originalOpcode & RampAnimator.DEFAULT_MAX_BRIGHTNESS), (byte) (reason & RampAnimator.DEFAULT_MAX_BRIGHTNESS)});
    }
    ...
    static HdmiCecMessage buildSetMenuLanguageCommand(int src, String language) {
        ...
        return buildCommand(src, 15, 50, new byte[]{(byte) (normalized.charAt(0) & RampAnimator.DEFAULT_MAX_BRIGHTNESS), (byte) (normalized.charAt(1) & RampAnimator.DEFAULT_MAX_BRIGHTNESS), (byte) (normalized.charAt(2) & RampAnimator.DEFAULT_MAX_BRIGHTNESS)});
    }
    ...
    static HdmiCecMessage buildReportPhysicalAddressCommand(int src, int address, int deviceType) {
        return buildCommand(src, 15, 132, new byte[]{(byte) ((address >> 8) & RampAnimator.DEFAULT_MAX_BRIGHTNESS), (byte) (address & RampAnimator.DEFAULT_MAX_BRIGHTNESS), (byte) (deviceType & RampAnimator.DEFAULT_MAX_BRIGHTNESS)});
    }

    static HdmiCecMessage buildDeviceVendorIdCommand(int src, int vendorId) {
        return buildCommand(src, 15, 135, new byte[]{(byte) ((vendorId >> 16) & RampAnimator.DEFAULT_MAX_BRIGHTNESS), (byte) ((vendorId >> 8) & RampAnimator.DEFAULT_MAX_BRIGHTNESS), (byte) (vendorId & RampAnimator.DEFAULT_MAX_BRIGHTNESS)});
    }

    static HdmiCecMessage buildCecVersion(int src, int dest, int version) {
        return buildCommand(src, dest, 158, new byte[]{(byte) (version & RampAnimator.DEFAULT_MAX_BRIGHTNESS)});
    }
    ...
    static HdmiCecMessage buildRoutingChange(int src, int oldPath, int newPath) {
        return buildCommand(src, 15, DumpState.DUMP_PACKAGES, new byte[]{(byte) ((oldPath >> 8) & RampAnimator.DEFAULT_MAX_BRIGHTNESS), (byte) (oldPath & RampAnimator.DEFAULT_MAX_BRIGHTNESS), (byte) ((newPath >> 8) & RampAnimator.DEFAULT_MAX_BRIGHTNESS), (byte) (newPath & RampAnimator.DEFAULT_MAX_BRIGHTNESS)});
    }
    ...
    static HdmiCecMessage buildReportPowerStatus(int src, int dest, int powerStatus) {
        return buildCommand(src, dest, HdmiCecKeycode.UI_SOUND_PRESENTATION_SELECT_AUDIO_AUTO_REVERBERATION, new byte[]{(byte) (powerStatus & RampAnimator.DEFAULT_MAX_BRIGHTNESS)});
    }

    static HdmiCecMessage buildReportMenuStatus(int src, int dest, int menuStatus) {
        return buildCommand(src, dest, 142, new byte[]{(byte) (menuStatus & RampAnimator.DEFAULT_MAX_BRIGHTNESS)});
    }
    ...
    static HdmiCecMessage buildUserControlPressed(int src, int dest, int uiCommand) {
        return buildUserControlPressed(src, dest, new byte[]{(byte) (uiCommand & RampAnimator.DEFAULT_MAX_BRIGHTNESS)});
    }
    ...
    static HdmiCecMessage buildVendorCommandWithId(int src, int dest, int vendorId, byte[] operands) {
        ...
        params[0] = (byte) ((vendorId >> 16) & RampAnimator.DEFAULT_MAX_BRIGHTNESS);
        params[1] = (byte) ((vendorId >> 8) & RampAnimator.DEFAULT_MAX_BRIGHTNESS);
        params[2] = (byte) (vendorId & RampAnimator.DEFAULT_MAX_BRIGHTNESS);
    ...
    private static byte[] physicalAddressToParam(int physicalAddress) {
        return new byte[]{(byte) ((physicalAddress >> 8) & RampAnimator.DEFAULT_MAX_BRIGHTNESS), (byte) (physicalAddress & RampAnimator.DEFAULT_MAX_BRIGHTNESS)};
    }
}

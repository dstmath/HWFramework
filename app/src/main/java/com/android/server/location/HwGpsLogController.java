...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.location.HwGpsLogController.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.location.HwGpsLogController.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.location.HwGpsLogController.<clinit>():void");
    }
    ...
    private void xmlModify(boolean enable) {
        try {
            ...
            if (doc != null) {
                ...
                if (gllNodes != null) {
                    if (BCM_47531.equals(this.mBcmChipType)) {

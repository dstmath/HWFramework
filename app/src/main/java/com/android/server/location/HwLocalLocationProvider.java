...
public class HwLocalLocationProvider implements LocationProviderInterface, IHwLocalLocationProvider {
    ...
    static {
        C1 = new byte[]{(byte) 98, (byte) 94, (byte) -52, (byte) 117, (byte) -82, (byte) 28, (byte) -44, (byte) 66, (byte) 28, (byte) 61, (byte) -110, (byte) -119, (byte) -75, (byte) 70, (byte) 2, (byte) 85};
        PROPERTIES = new ProviderProperties(true, false, true, false, false, false, false, 1, 2);
    }

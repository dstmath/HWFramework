...
public class ByteConvert {
    ...
    public static byte[] intToBytes(int n) {
        return new byte[]{(byte) (n & Utils.MAXINUM_TEMPERATURE), (byte) ((n >> 8) & Utils.MAXINUM_TEMPERATURE), (byte) ((n >> 16) & Utils.MAXINUM_TEMPERATURE), (byte) ((n >> 24) & Utils.MAXINUM_TEMPERATURE)};
    }

    public static int bytesToInt(byte[] b) {
        return (((b[3] & Utils.MAXINUM_TEMPERATURE) | ((b[2] & Utils.MAXINUM_TEMPERATURE) << 8)) | ((b[1] & Utils.MAXINUM_TEMPERATURE) << 16)) | ((b[0] & Utils.MAXINUM_TEMPERATURE) << 24);
    }

    public static int littleEndianBytesToInt(byte[] b) {
        return (((b[0] & Utils.MAXINUM_TEMPERATURE) | ((b[1] & Utils.MAXINUM_TEMPERATURE) << 8)) | ((b[2] & Utils.MAXINUM_TEMPERATURE) << 16)) | ((b[3] & Utils.MAXINUM_TEMPERATURE) << 24);
    }

    public static byte[] shortToBytes(short n) {
        return new byte[]{(byte) (n & Utils.MAXINUM_TEMPERATURE), (byte) ((n >> 8) & Utils.MAXINUM_TEMPERATURE)};
    }

    public static short bytesToShort(byte[] b) {
        return (short) ((b[1] & Utils.MAXINUM_TEMPERATURE) | ((b[0] & Utils.MAXINUM_TEMPERATURE) << 8));
    }

    public static short littleEndianBytesToShort(byte[] b) {
        return (short) ((b[0] & Utils.MAXINUM_TEMPERATURE) | ((b[1] & Utils.MAXINUM_TEMPERATURE) << 8));
    }
    ...
    public static String convertDecimalToHex(int value) {
        ...
        if (hexValue.equals(AppHibernateCst.INVALID_PKG) || hexValue.length() == 0) {
            return null;
        }
        return "0x" + hexValue;
    }

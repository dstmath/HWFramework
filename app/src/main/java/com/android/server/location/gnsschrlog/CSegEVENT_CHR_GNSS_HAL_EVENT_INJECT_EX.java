...
public class CSegEVENT_CHR_GNSS_HAL_EVENT_INJECT_EX extends ChrLogBaseEventModel {
    ...
    public CSegEVENT_CHR_GNSS_HAL_EVENT_INJECT_EX() {
        ...
        this.enEventId.setValue("CHR_GNSS_HAL_EVENT_INJECT_EX");

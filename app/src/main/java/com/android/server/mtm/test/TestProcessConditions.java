...
import com.android.server.mtm.condition.ProcessConditionMatchor;
import com.android.server.rms.iaware.hiber.constant.AppHibernateCst;
import com.android.server.rms.shrinker.ProcessStopShrinker;
import java.io.PrintWriter;

public final class TestProcessConditions {
    static ProcessConditionMatchor testmatchor;

    static {
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.mtm.test.TestProcessConditions.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.mtm.test.TestProcessConditions.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.mtm.test.TestProcessConditions.<clinit>():void");
    }
    ...
    public static final void test(PrintWriter pw, String[] args) {
        if (args[1] != null && pw != null) {
            ...
            if ("enable_log".equals(cmd)) {
                processConditionMatchor = testmatchor;
                ProcessConditionMatchor.enableDebug();
            } else if ("disable_log".equals(cmd)) {
                processConditionMatchor = testmatchor;
                ProcessConditionMatchor.disableDebug();

...
public abstract class ManagedServices {
    ...
    private ArraySet<String> mRestoredPackages;
    ...
    class AnonymousClass1 implements ServiceConnection {
        ...
        AnonymousClass1(String val$servicesBindingTag, int val$userid, boolean val$isSystem, int val$targetSdkVersion) {
            this.val$servicesBindingTag = val$servicesBindingTag;
            this.val$userid = val$userid;
            this.val$isSystem = val$isSystem;
            this.val$targetSdkVersion = val$targetSdkVersion;
        }
        ...
        public void onServiceConnected(ComponentName name, IBinder binder) {
            ...
            synchronized (ManagedServices.this.mMutex) {
                if (ManagedServices.this.mServicesBinding.contains(this.val$servicesBindingTag)) {
                    ...
                    try {
                        ...
                        managedServiceInfo = ManagedServices.this.newServiceInfo(this.mService, name, this.val$userid, this.val$isSystem, this, this.val$targetSdkVersion);
    ...
    public ManagedServices(Context context, Handler handler, Object mutex, UserProfiles userProfiles) {
        ...
        this.mRestoredPackages = new ArraySet();
    ...
    private void registerServiceLocked(ComponentName name, int userid, boolean isSystem) {
        ...
        try {
            ...
            if (!this.mContext.bindServiceAsUser(intent, new AnonymousClass1(servicesBindingTag, userid, isSystem, targetSdkVersion), 83886081, new UserHandle(userid))) {

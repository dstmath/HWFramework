...
public final class ProcessLoggingHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
        switch (msg.what) {
            case LOG_APP_PROCESS_START_MSG /*1*/:
            ...
            case INVALIDATE_BASE_APK_HASH_MSG /*2*/:
    ...
    private String computeStringHashOfApk(String apkFile) {
        ...
        if (apkHash == null) {
            try {
                ...
                for (int i = 0; i < hash.length; i += LOG_APP_PROCESS_START_MSG) {
                    Object[] objArr = new Object[LOG_APP_PROCESS_START_MSG];
                    objArr[0] = Byte.valueOf(hash[i]);

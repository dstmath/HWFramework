...
final class UserState implements PrintSpoolerCallbacks, PrintServiceCallbacks, RemotePrintServiceRecommendationServiceCallbacks {
    ...
    class AnonymousClass1 extends AsyncTask<Void, Void, Void> {
        ...
        AnonymousClass1(PrintJobInfo val$printJob) {
    ...
    private class PrinterDiscoverySessionMediator {
        ...
        public PrinterDiscoverySessionMediator(Context context) {
            ...
            this.mDiscoveryObservers = new RemoteCallbackList<IPrinterDiscoveryObserver>() {
        ...
        public final void startPrinterDiscoveryLocked(IPrinterDiscoveryObserver observer, List<PrinterId> priorityList) {
            ...
            boolean discoveryStarted = this.mStartedPrinterDiscoveryTokens.isEmpty() ? UserState.DEBUG : true;
        ...
        public void dump(PrintWriter pw, String prefix) {
            ...
            pw.append(prefix).append("printDiscoveryInProgress=").append(String.valueOf(this.mStartedPrinterDiscoveryTokens.isEmpty() ? UserState.DEBUG : true)).println();
            String tab = "  ";
    ...
    class AnonymousClass2 extends PrinterDiscoverySessionMediator {
        final /* synthetic */ UserState this$0;

        AnonymousClass2(UserState this$0, UserState this$0_1, Context $anonymous0) {
            this.this$0 = this$0_1;
            super($anonymous0);
        }

        public void onDestroyed() {
            this.this$0.mPrinterDiscoverySession = null;
        }
    }
    ...
    class AnonymousClass3 extends PrintJobStateChangeListenerRecord {
        final /* synthetic */ UserState this$0;

        AnonymousClass3(UserState this$0, UserState this$0_1, IPrintJobStateChangeListener $anonymous0, int $anonymous1) throws RemoteException {
            this.this$0 = this$0_1;
        ...
        public void onBinderDied() {
            synchronized (this.this$0.mLock) {
                if (this.this$0.mPrintJobStateChangeListenerRecords != null) {
                    this.this$0.mPrintJobStateChangeListenerRecords.remove(this);
                }
            }
        }
    }
    ...
    class AnonymousClass4 extends ListenerRecord<IPrintServicesChangeListener> {
        final /* synthetic */ UserState this$0;

        AnonymousClass4(UserState this$0, UserState this$0_1, IPrintServicesChangeListener $anonymous0) throws RemoteException {
            this.this$0 = this$0_1;
            super($anonymous0);
        }
        ...
        public void onBinderDied() {
            synchronized (this.this$0.mLock) {
                if (this.this$0.mPrintServicesChangeListenerRecords != null) {
                    this.this$0.mPrintServicesChangeListenerRecords.remove(this);
                }
            }
        }
    }

    /* renamed from: com.android.server.print.UserState.5 */
    class AnonymousClass5 extends ListenerRecord<IRecommendationsChangeListener> {
        final /* synthetic */ UserState this$0;

        AnonymousClass5(UserState this$0, UserState this$0_1, IRecommendationsChangeListener $anonymous0) throws RemoteException {
            this.this$0 = this$0_1;
            super($anonymous0);
        }
        ...
        public void onBinderDied() {
            synchronized (this.this$0.mLock) {
                if (this.this$0.mPrintServiceRecommendationsChangeListenerRecords != null) {
                    this.this$0.mPrintServiceRecommendationsChangeListenerRecords.remove(this);
                }
            }
        }
    }

    /* renamed from: com.android.server.print.UserState.6 */
    class AnonymousClass6 implements Runnable {
        final /* synthetic */ ComponentName val$serviceName;

        AnonymousClass6(ComponentName val$serviceName) {
            this.val$serviceName = val$serviceName;
        }
    ...
    private final class PrintJobForAppCache {
        ...
        class AnonymousClass1 implements DeathRecipient {
            ...
            AnonymousClass1(IBinder val$creator, int val$appId) {
                this.val$creator = val$creator;
        ...
        public boolean onPrintJobCreated(IBinder creator, int appId, PrintJobInfo printJob) {
            try {
                creator.linkToDeath(new AnonymousClass1(creator, appId), 0);
                synchronized (UserState.this.mLock) {
    ...
    private final class UserStateHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            switch (message.what) {
                case MSG_DISPATCH_PRINT_JOB_STATE_CHANGED /*1*/:
                    UserState.this.handleDispatchPrintJobStateChanged(message.obj, message.arg1);
                case MSG_DISPATCH_PRINT_SERVICES_CHANGED /*2*/:
                    UserState.this.handleDispatchPrintServicesChanged();
                case MSG_DISPATCH_PRINT_SERVICES_RECOMMENDATIONS_UPDATED /*3*/:
    ...
    public UserState(Context context, int userId, Object lock, boolean lowPriority) {
        ...
        this.mDisabledServices = new ArraySet();
    ...
    public void onPrintJobQueued(PrintJobInfo printJob) {
        ...
        if (service != null) {
            ...
            this.mSpooler.setPrintJobState(printJob.getId(), 6, this.mContext.getString(17040759));
        }
    }
    ...
    public Bundle print(String printJobName, IPrintDocumentAdapter adapter, PrintAttributes attributes, String packageName, int appId) {
        ...
        new AnonymousClass1(printJob).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, (Void[]) null);
    ...
    public void createPrinterDiscoverySession(IPrinterDiscoveryObserver observer) {
        synchronized (this.mLock) {
            ...
            if (this.mPrinterDiscoverySession == null) {
                ...
                this.mPrinterDiscoverySession = new AnonymousClass2(this, this, this.mContext);
    ...
    public void addPrintJobStateChangeListener(IPrintJobStateChangeListener listener, int appId) throws RemoteException {
        synchronized (this.mLock) {
            ...
            this.mPrintJobStateChangeListenerRecords.add(new AnonymousClass3(this, this, listener, appId));
        }
    }
    ...
    public void addPrintServicesChangeListener(IPrintServicesChangeListener listener) throws RemoteException {
        synchronized (this.mLock) {
            ...
            this.mPrintServicesChangeListenerRecords.add(new AnonymousClass4(this, this, listener));
        }
    }
    ...
    public void addPrintServiceRecommendationsChangeListener(IRecommendationsChangeListener listener) throws RemoteException {
        synchronized (this.mLock) {
            ...
            this.mPrintServiceRecommendationsChangeListenerRecords.add(new AnonymousClass5(this, this, listener));
        }
    }
    ...
    private boolean readConfigurationLocked() {
        return readInstalledPrintServicesLocked() | readDisabledPrintServicesLocked();
    }
    ...
    private void failActivePrintJobsForService(ComponentName serviceName) {
        if (Looper.getMainLooper().isCurrentThread()) {
            BackgroundThread.getHandler().post(new AnonymousClass6(serviceName));
        } else {
    ...
    private void failScheduledPrintJobsForServiceInternal(ComponentName serviceName) {
        ...
        if (printJobs != null) {
            ...
            try {
                int printJobCount = printJobs.size();
                for (int i = 0; i < printJobCount; i++) {
                    this.mSpooler.setPrintJobState(((PrintJobInfo) printJobs.get(i)).getId(), 6, this.mContext.getString(17040759));
                }
            } finally {
                Binder.restoreCallingIdentity(identity);
            }
    ...
    private void handleDispatchPrintServicesChanged() {
        synchronized (this.mLock) {
            ...
            for (int i = 0; i < recordCount; i++) {
                try {
                    ((IPrintServicesChangeListener) ((ListenerRecord) records.get(i)).listener).onPrintServicesChanged();
                } catch (RemoteException re) {
    ...
    private void handleDispatchPrintServiceRecommendationsUpdated(List<RecommendationInfo> recommendations) {
        synchronized (this.mLock) {
            ...
            for (int i = 0; i < recordCount; i++) {
                try {
                    ((IRecommendationsChangeListener) ((ListenerRecord) records.get(i)).listener).onRecommendationsChanged();
                } catch (RemoteException re) {

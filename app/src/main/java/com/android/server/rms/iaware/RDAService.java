...
public class RDAService {
    ...
    private static String TARGET_APP_FILE_PATH;
    private ArrayList<String> mFakeForegroundList;
    private final ReentrantReadWriteLock mPreRecogLock;
    private RFeatureManager mRFeatureManager;
    private boolean rdaInitStatus;

    static {
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.rms.iaware.RDAService.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.rms.iaware.RDAService.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.rms.iaware.RDAService.<clinit>():void");
    }
    ...
    public RDAService(Context context, HandlerThread handlerThread) {
        this.mRFeatureManager = null;
        this.rdaInitStatus = false;
        this.mFakeForegroundList = new ArrayList();
        this.mPreRecogLock = new ReentrantReadWriteLock();
    ...
    public int getDumpData(int time, List<DumpData> dumpData) {
        ...
        if (time <= 0 || time > DEFAULT_MAX_TIME) {
            AwareLog.e(TAG, "getDumpData parameter error: use default time!");
            dumpDataTime = DEFAULT_MAX_TIME;
        }
        if (dumpData != null) {

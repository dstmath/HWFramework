...
class CpusetScreenConfig extends CPUCustBaseConfig {
    ...
    private Map<String, String> mItem2PropMapScreenOFF;
    private Map<String, String> mItem2PropMapScreenOn;
    private Map<String, CPUPropInfoItem> mOffInfoMap;
    private Map<String, CPUPropInfoItem> mOnInfoMap;

    public CpusetScreenConfig() {
        this.mItem2PropMapScreenOn = new HashMap();
        this.mItem2PropMapScreenOFF = new HashMap();
        this.mOnInfoMap = new HashMap();
        this.mOffInfoMap = new HashMap();
        init();
    }
    ...
    public void setConfig(CPUFeature feature) {
        ...
        sendScreenConfig(this.mOffInfoMap, mCpusetItemIndex, CPUFeature.MSG_SET_CPUSETCONFIG_SCREENOFF);
    }

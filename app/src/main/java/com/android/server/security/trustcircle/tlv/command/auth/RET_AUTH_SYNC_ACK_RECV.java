...
public class RET_AUTH_SYNC_ACK_RECV extends TLVRootTree {
    ...
    public static final short TAG_RET_AUTH_SYNC_ACK_RECV = (short) 19;
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.security.trustcircle.tlv.command.auth.RET_AUTH_SYNC_ACK_RECV.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.security.trustcircle.tlv.command.auth.RET_AUTH_SYNC_ACK_RECV.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.security.trustcircle.tlv.command.auth.RET_AUTH_SYNC_ACK_RECV.<clinit>():void");
    }
    ...
    public short getTreeTag() {
        return TAG_RET_AUTH_SYNC_ACK_RECV;
    }
}

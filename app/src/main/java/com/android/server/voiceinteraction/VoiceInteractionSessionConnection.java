...
final class VoiceInteractionSessionConnection implements ServiceConnection {
    ...
    ArrayList<AssistDataForActivity> mAssistData;
    final IResultReceiver mAssistReceiver;
    ...
    Bitmap mScreenshot;
    final IAssistScreenshotReceiver mScreenshotReceiver;
    ...
    public VoiceInteractionSessionConnection(Object lock, ComponentName component, int user, Context context, Callback callback, int callingUid, Handler handler) {
        ...
        this.mAssistData = new ArrayList();
        this.mPendingShowCallbacks = new ArrayList();
        this.mShowCallback = new Stub() {
        ...
        this.mFullConnection = new ServiceConnection() {
        ...
        this.mAssistReceiver = new IResultReceiver.Stub() {
        ...
        this.mScreenshotReceiver = new IAssistScreenshotReceiver.Stub() {
        ...
        this.mShowAssistDisclosureRunnable = new Runnable() {
            public void run() {
    ...
    private void deliverSessionDataLocked(AssistDataForActivity assistDataForActivity) {
        Bundle assistData = assistDataForActivity.data.getBundle(SoundModelContract.KEY_DATA);

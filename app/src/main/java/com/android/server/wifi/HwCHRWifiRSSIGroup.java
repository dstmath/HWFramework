...
public class HwCHRWifiRSSIGroup {
    ...
    private int adjacent_area_frequency;
    private int rssi_index;
    private int rtt_lan_duration;
    private int rtt_lan_failures;
    private int rtt_lan_max;
    private int rtt_lan_min;
    private int rtt_lan_succ;
    private int rtt_tcp_duration;
    private int rtt_tcp_packets;
    private int same_area_frequency;
    ...
    public void add_area_freq(boolean isSameArea) {
        if (isSameArea) {
            this.same_area_frequency += RSSI_1;
        } else {
            this.adjacent_area_frequency += RSSI_1;
        }
    }

    public void add_rtt_lan_failures() {
        this.rtt_lan_failures += RSSI_1;
    }

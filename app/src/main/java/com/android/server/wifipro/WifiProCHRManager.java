...
public class WifiProCHRManager {
    ...
    private static Object chrManagerObj;
    private static Method commercialUserMethod;
    private static boolean initialized;
    private static boolean isCommercialUser;
    private static Object logManagerObj;
    private static int printLogLevel;
    private static WifiProCHRManager wsm;

    static {
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.wifipro.WifiProCHRManager.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.server.wifipro.WifiProCHRManager.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.wifipro.WifiProCHRManager.<clinit>():void");
    }
    ...
    private void invokeMethod(boolean betaUserOnly, String methodName, Object... args) {
        if (!((betaUserOnly && isCommercialUser) || chrManagerObj == null || methodName == null)) {
            try {
                Method[] methods = chrManagerObj.getClass().getMethods();
                int length = methods.length;
                for (int i = 0; i < length; i += DBG_LOG_LEVEL) {
    ...
    public void updateWifiException(int ucErrorCode, String ucSubErrorCode) {
        ...
        objArr[0] = Integer.valueOf(ucErrorCode);
        objArr[DBG_LOG_LEVEL] = ucSubErrorCode;
        invokeMethod(false, "updateWifiExceptionByWifipro", objArr);
    }
    ...
    public void updatePortalAutSms(String sms_num, byte[] sms_body, int sms_body_len) {
        ...
        Object[] objArr = new Object[ERROR_LOG_LEVEL];
        objArr[0] = sms_num;
        objArr[DBG_LOG_LEVEL] = sms_body;
        objArr[INFO_LOG_LEVEL] = Integer.valueOf(sms_body_len);
        invokeMethod(false, "updatePortalAutSms", objArr);
    }
    ...
    public void updatePortalKeyLines(byte[] lines) {
        ...
        Object[] objArr = new Object[DBG_LOG_LEVEL];
        objArr[0] = lines;
        invokeMethod(false, "updatePortalKeyLines", objArr);
    }
    ...
    public void updateApRedirectUrl(String url) {
        logd("updateApRedirectUrl call enter.");
        Object[] objArr = new Object[DBG_LOG_LEVEL];
        objArr[0] = url;
        invokeMethod(false, "updateApRedirectUrl", objArr);
    }

    public void updateActiveCheckFail(String ssid, String serverName, int failType) {
        logd("updateActiveCheckFail call enter.");
        Object[] objArr = new Object[ERROR_LOG_LEVEL];
        objArr[0] = ssid;
        objArr[DBG_LOG_LEVEL] = serverName;
        objArr[INFO_LOG_LEVEL] = Integer.valueOf(failType);
        invokeMethod(false, "updateActiveCheckFail", objArr);
    }
    ...
    public void updateWifiproTimeLen(short timeLen) {
        ...
        Object[] objArr = new Object[DBG_LOG_LEVEL];
        objArr[0] = Short.valueOf(timeLen);
        invokeMethod(false, "updateWifiproTimeLen", objArr);
    }

    public void updateSSID(String ssid) {
        Object[] objArr = new Object[DBG_LOG_LEVEL];
        objArr[0] = ssid;
        invokeMethod(false, "updateSSID", objArr);
    }

    public void updateBSSID(String bssid) {
        Object[] objArr = new Object[DBG_LOG_LEVEL];
        objArr[0] = bssid;
        invokeMethod(false, "updateBSSID", objArr);
    }

    public void updateHomeAPJudgeTime(int hours) {
        Object[] objArr = new Object[DBG_LOG_LEVEL];
        objArr[0] = Integer.valueOf(hours);
        invokeMethod(false, "updateHomeAPJudgeTime", objArr);
    }

    public void updateAPSecurityType(int secType) {
        Object[] objArr = new Object[DBG_LOG_LEVEL];
        objArr[0] = Integer.valueOf(secType);
        invokeMethod(false, "updateAPSecurityType", objArr);
    }

    public void updateBG_AC_DiffType(int acDiffType) {
        Object[] objArr = new Object[DBG_LOG_LEVEL];
        objArr[0] = Integer.valueOf(acDiffType);
        invokeMethod(false, "updateBG_AC_DiffType", objArr);
    }

    public void updateAutoOpenWhiteNum(short autoOpenWhiteNum) {
        logd("updateAutoOpenWhiteNum call enter.");
        Object[] objArr = new Object[DBG_LOG_LEVEL];
        objArr[0] = Short.valueOf(autoOpenWhiteNum);
        invokeMethod(false, "updateAutoOpenWhiteNum", objArr);
    }

    public void updateAutoOpenRootCause(short autoOpenRootCause) {
        logd("updateAutoOpenRootCause call enter.");
        Object[] objArr = new Object[DBG_LOG_LEVEL];
        objArr[0] = Short.valueOf(autoOpenRootCause);
        invokeMethod(false, "updateAutoOpenRootCause", objArr);
    }

    public void updateAutoCloseRootCause(short autoCloseRootCause) {
        logd("updateAutoCloseRootCause call enter.");
        Object[] objArr = new Object[DBG_LOG_LEVEL];
        objArr[0] = Short.valueOf(autoCloseRootCause);
        invokeMethod(false, "updateAutoCloseRootCause", objArr);
    }

    public void updateFreeAP1Info(String ssid, String bssid) {
        Object[] objArr = new Object[INFO_LOG_LEVEL];
        objArr[0] = ssid;
        objArr[DBG_LOG_LEVEL] = bssid;
        invokeMethod(false, "updateFreeAP1Info", objArr);
    }
    ...
    public void updateFreeAP2Info(String ssid, String bssid) {
        ...
        objArr[0] = ssid;
        objArr[DBG_LOG_LEVEL] = bssid;
        invokeMethod(false, "updateFreeAP2Info", objArr);
    }
    ...
    public void updateFreeAP3Info(String ssid, String bssid) {
        ...
        objArr[0] = ssid;
        objArr[DBG_LOG_LEVEL] = bssid;
        invokeMethod(false, "updateFreeAP3Info", objArr);
    }

    public void updateFreeAPCellID(String freeAPcellID) {
        Object[] objArr = new Object[DBG_LOG_LEVEL];
        objArr[0] = freeAPcellID;
        invokeMethod(false, "updateFreeAPCellID", objArr);
    }

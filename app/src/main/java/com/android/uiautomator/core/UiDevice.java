...
public class UiDevice {
    ...
    /* renamed from: com.android.uiautomator.core.UiDevice.2 */
    class AnonymousClass2 implements AccessibilityEventFilter {
        final /* synthetic */ String val$packageName;

        AnonymousClass2(String val$packageName) {
        ...
        public boolean accept(AccessibilityEvent t) {
            ...
            return this.val$packageName != null ? this.val$packageName.equals(t.getPackageName()) : true;
        }
    }
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.uiautomator.core.UiDevice.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.android.uiautomator.core.UiDevice.<clinit>():void
...
*/
    ...
    public boolean waitForWindowUpdate(String packageName, long timeout) {
        ...
        try {
            ...
            }, new AnonymousClass2(packageName), timeout);
            return true;

...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.google.android.maps.MapActivity.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.google.android.maps.MapActivity.<clinit>():void
...
*/
    ...
    private void createMap() {
        ...
        MapPoint startPoint = new MapPoint(startingLatLng[0], startingLatLng[MAP_DATA_SOURCE_CHINA]);
    ...
    private void sendStartSession() {
        ...
        if (getIntent() == null || "android.intent.action.MAIN".equals(getIntent().getAction())) {
            ...
            startType = MAP_DATA_SOURCE_CHINA;
        }
        try {

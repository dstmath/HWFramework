        ...
        private static class Proxy implements IMapconService {
            ...
            public int setVoWifiOn(int phoneId) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setVoWifiOn, _data, _reply, 0);
            ...
            public int setVoWifiOff(int phoneId) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(phoneId);
                    this.mRemote.transact(Stub.TRANSACTION_setVoWifiOff, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int setDomain(int phoneId, int domain) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setDomain, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public void notifyWifiOff(IMapconServiceCallback callback) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_notifyWifiOff, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public int notifyImsOn(int phoneId) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(phoneId);
                    this.mRemote.transact(Stub.TRANSACTION_notifyImsOn, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int notifyImsOff(int phoneId, int currentDomain) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_notifyImsOff, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int setVoWifiServiceOn(int phoneId, int type) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(phoneId);
                    _data.writeInt(type);
                    this.mRemote.transact(Stub.TRANSACTION_setVoWifiServiceOn, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int setVoWifiServiceOff(int phoneId, int type) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(phoneId);
                    _data.writeInt(type);
                    this.mRemote.transact(Stub.TRANSACTION_setVoWifiServiceOff, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getVoWifiServiceState(int phoneId, int type) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(phoneId);
                    _data.writeInt(type);
                    this.mRemote.transact(Stub.TRANSACTION_getVoWifiServiceState, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int setVoWifiServiceDomain(int phoneId, int type, int domain) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(type);
                    _data.writeInt(domain);
                    this.mRemote.transact(Stub.TRANSACTION_setVoWifiServiceDomain, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getVoWifiServiceDomain(int phoneId, int type) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(phoneId);
                    _data.writeInt(type);
                    this.mRemote.transact(Stub.TRANSACTION_getVoWifiServiceDomain, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int setupTunnelOverWifi(int phoneId, int serviceType, String apn, ServerAddr serverAddr) throws RemoteException {
                ...
                try {
                    ...
                    if (serverAddr != null) {
                        _data.writeInt(Stub.TRANSACTION_setVoWifiOn);
                        serverAddr.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
                    this.mRemote.transact(Stub.TRANSACTION_setupTunnelOverWifi, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int teardownTunnelOverWifi(int phoneId, int type, String apn, ServerAddr serverAddr) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_teardownTunnelOverWifi, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public String getUtOverWifiApn() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getUtOverWifiApn, _data, _reply, 0);
                    _reply.readException();
            ...
            public void notifyRoaming(int phoneId) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(phoneId);
                    this.mRemote.transact(Stub.TRANSACTION_notifyRoaming, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_setupTunnelOverWifi /*13*/:
                    ...
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_teardownTunnelOverWifi /*14*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt();
                    _arg1 = data.readInt();
                    _arg2 = data.readString();
                    ...
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_getUtOverWifiApn /*15*/:
                    data.enforceInterface(DESCRIPTOR);
                    String _result2 = getUtOverWifiApn();
                    reply.writeNoException();
                    reply.writeString(_result2);
                    return true;
                case TRANSACTION_notifyRoaming /*16*/:
                    data.enforceInterface(DESCRIPTOR);

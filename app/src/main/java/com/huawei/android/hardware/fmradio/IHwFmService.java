        ...
        private static class Proxy implements IHwFmService {
            ...
            public int acquireFd(String path) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_acquireFd, _data, _reply, 0);
            ...
            public int audioControl(int fd, int control, int field) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_audioControl, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int cancelSearch(int fd) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(fd);
                    this.mRemote.transact(Stub.TRANSACTION_cancelSearch, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int closeFd(int fd) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(fd);
                    this.mRemote.transact(Stub.TRANSACTION_closeFd, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getFreq(int fd) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(fd);
                    this.mRemote.transact(Stub.TRANSACTION_getFreq, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int setFreq(int fd, int freq) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(fd);
                    _data.writeInt(freq);
                    this.mRemote.transact(Stub.TRANSACTION_setFreq, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getControl(int fd, int id) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(fd);
                    _data.writeInt(id);
                    this.mRemote.transact(Stub.TRANSACTION_getControl, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int setControl(int fd, int id, int value) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setControl, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int startSearch(int fd, int dir) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(fd);
                    _data.writeInt(dir);
                    this.mRemote.transact(Stub.TRANSACTION_startSearch, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getRawRds(int fd, byte[] buff, int count) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getRawRds, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.readByteArray(buff);
                    return _result;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_getBuffer /*10*/:
                    ...
                    _result = getBuffer(_arg02, bArr, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    reply.writeByteArray(bArr);
                    return true;
                case TRANSACTION_getRSSI /*11*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getRSSI(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_setBand /*12*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setBand(data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_getLowerBand /*13*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getLowerBand(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_getUpperBand /*14*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getUpperBand(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_setMonoStereo /*15*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setMonoStereo(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_getRawRds /*16*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = data.readInt();
                    _arg1_length = data.readInt();
                    if (_arg1_length < 0) {
                    ...
                    _result = getRawRds(_arg02, bArr, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    reply.writeByteArray(bArr);
                    return true;
                case TRANSACTION_setNotchFilter /*17*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = true;
                    }
                    setNotchFilter(_arg0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getAudioQuilty /*18*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getAudioQuilty(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_setFmSnrThresh /*19*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setFmSnrThresh(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_setFmRssiThresh /*20*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setFmRssiThresh(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_setFmDeviceConnectionState /*21*/:
                    data.enforceInterface(DESCRIPTOR);
                    setFmDeviceConnectionState(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_startListner /*22*/:
                    data.enforceInterface(DESCRIPTOR);
                    startListner(data.readInt(), com.huawei.android.hardware.fmradio.IFmEventCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case TRANSACTION_stopListner /*23*/:
                    data.enforceInterface(DESCRIPTOR);
                    stopListner();
                    reply.writeNoException();
                    return true;

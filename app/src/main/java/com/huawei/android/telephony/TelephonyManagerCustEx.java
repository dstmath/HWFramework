...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.huawei.android.telephony.TelephonyManagerCustEx.DataSettingModeTypeEx.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.huawei.android.telephony.TelephonyManagerCustEx.DataSettingModeTypeEx.<clinit>():void
...
*/
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.huawei.android.telephony.TelephonyManagerCustEx.DataSettingModeTypeEx.<clinit>():void");
        }
    }
    ...
    public static void setDataSettingMode(DataSettingModeTypeEx dataMode) {
        ...
        switch (-getcom-huawei-android-telephony-TelephonyManagerCustEx$DataSettingModeTypeExSwitchesValues()[dataMode.ordinal()]) {
            case HuaweiTelephonyManagerCustEx.MODE_ENABLE_VOICELOOPBACK /*1*/:
                tempMode = DataSettingModeType.MODE_ERROR;
                break;
            case ChameleonContract.SYSPROP_NAI /*2*/:
                tempMode = DataSettingModeType.MODE_LTETDD_ONLY;
                break;
            case ChameleonContract.SYSPROP_ESN /*3*/:

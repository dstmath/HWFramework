...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.huawei.device.connectivitychrlog.Base64Coder.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.huawei.device.connectivitychrlog.Base64Coder.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.device.connectivitychrlog.Base64Coder.<clinit>():void");
    }
    ...
    public static String encode(byte[] data) {
        ...
        while (length > 0) {
            ...
            if (i2 == 3) {
                ...
                char_array_4[2] = (byte) (((char_array_3[1] & 15) << 2) + ((char_array_3[2] & PduHeaders.STORE_STATUS_ERROR_TRANSIENT_FAILURE) >> 6));

...
public class CSubTRAFFIC_GROUND extends ChrLogBaseModel {
    ...
    public LogInt iback_recv_bytes;
    public LogInt iback_send_bytes;
    public LogInt ifore_recv_bytes;
    public LogInt ifore_send_bytes;

    public CSubTRAFFIC_GROUND() {
        this.enSubEventId = new ENCSubEventId();
        this.iback_send_bytes = new LogInt();
        this.iback_recv_bytes = new LogInt();
        this.ifore_send_bytes = new LogInt();
        this.ifore_recv_bytes = new LogInt();

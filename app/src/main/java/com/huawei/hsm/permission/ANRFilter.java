...
public class ANRFilter {
    ...
    private static ANRFilter sANRFilterInstance;
    private ArrayList<Integer> mSkipedUidFIFO;

    static {
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.huawei.hsm.permission.ANRFilter.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.huawei.hsm.permission.ANRFilter.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.hsm.permission.ANRFilter.<clinit>():void");
    }

    private ANRFilter() {
        this.mSkipedUidFIFO = new ArrayList();
    }

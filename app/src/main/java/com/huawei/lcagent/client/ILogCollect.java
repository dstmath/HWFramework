...
public interface ILogCollect extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILogCollect {
        ...
        private static class Proxy implements ILogCollect {
            ...
            public int setMetricStoargeHeader(int metricID, byte[] payloadBytes, int payloadLen) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setMetricStoargeHeader, _data, _reply, 0);
            ...
            public int setMetricCommonHeader(int metricID, byte[] payloadBytes, int payloadLen) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeByteArray(payloadBytes);
                    _data.writeInt(payloadLen);
                    this.mRemote.transact(Stub.TRANSACTION_setMetricCommonHeader, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int setMetricStoargeTail(int metricID, byte[] payloadBytes, int payloadLen) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeByteArray(payloadBytes);
                    _data.writeInt(payloadLen);
                    this.mRemote.transact(Stub.TRANSACTION_setMetricStoargeTail, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int submitMetric(int metricID, int level, byte[] payloadBytes, int payloadLen) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeByteArray(payloadBytes);
                    _data.writeInt(payloadLen);
                    this.mRemote.transact(Stub.TRANSACTION_submitMetric, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public boolean shouldSubmitMetric(int metricID, int level) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(metricID);
                    _data.writeInt(level);
                    this.mRemote.transact(Stub.TRANSACTION_shouldSubmitMetric, _data, _reply, 0);
                    _reply.readException();
            ...
            public LogMetricInfo captureLogMetric(int metricID) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(metricID);
                    this.mRemote.transact(Stub.TRANSACTION_captureLogMetric, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
            ...
            public LogMetricInfo captureLogMetricWithParameters(int metricID, String keyValuePairs) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_captureLogMetricWithParameters, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        logMetricInfo = (LogMetricInfo) LogMetricInfo.CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public void clearLogMetric(long id) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeLong(id);
                    this.mRemote.transact(Stub.TRANSACTION_clearLogMetric, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public int feedbackUploadResult(long hashId, int status) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_feedbackUploadResult, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int allowUploadInMobileNetwork(boolean allow) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (allow) {
                        i = Stub.TRANSACTION_setMetricStoargeHeader;
                    }
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_allowUploadInMobileNetwork, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int allowUploadAlways(boolean allow) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_allowUploadAlways, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int configureUserType(int type) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(type);
                    this.mRemote.transact(Stub.TRANSACTION_configureUserType, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getUserType() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getUserType, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int forceUpload() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_forceUpload, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int configure(String strCommand) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_configure, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public LogMetricInfo captureAllLog() throws RemoteException {
                ...
                try {
                    LogMetricInfo logMetricInfo;
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_captureAllLog, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        logMetricInfo = (LogMetricInfo) LogMetricInfo.CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public long getFirstErrorTime() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getFirstErrorTime, _data, _reply, 0);
                    _reply.readException();
            ...
            public int resetFirstErrorTime() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_resetFirstErrorTime, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public String getFirstErrorType() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getFirstErrorType, _data, _reply, 0);
                    _reply.readException();
            ...
            public int configureModemlogcat(int mode, String parameters) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_configureModemlogcat, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int configureBluetoothlogcat(int enable, String parameters) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(parameters);
                    this.mRemote.transact(Stub.TRANSACTION_configureBluetoothlogcat, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int configureLogcat(int enable, String parameters) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(enable);
                    _data.writeString(parameters);
                    this.mRemote.transact(Stub.TRANSACTION_configureLogcat, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int configureAPlogs(int enable) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(enable);
                    this.mRemote.transact(Stub.TRANSACTION_configureAPlogs, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int configureGPS(int enable) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(enable);
                    this.mRemote.transact(Stub.TRANSACTION_configureGPS, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public CompressInfo getCompressInfo() throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getCompressInfo, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
            ...
            public LogMetricInfo captureLogMetricWithModule(int metricID, String module) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_captureLogMetricWithModule, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        logMetricInfo = (LogMetricInfo) LogMetricInfo.CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public int setMetricStoargeHeaderWithMcc(int metricID, byte[] payloadBytes, int payloadLen, String mcc) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setMetricStoargeHeaderWithMcc, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int setMetricCommonHeaderWithMcc(int metricID, byte[] payloadBytes, int payloadLen, String mcc) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(payloadLen);
                    _data.writeString(mcc);
                    this.mRemote.transact(Stub.TRANSACTION_setMetricCommonHeaderWithMcc, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int setMetricStoargeTailWithMcc(int metricID, byte[] payloadBytes, int payloadLen, String mcc) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(payloadLen);
                    _data.writeString(mcc);
                    this.mRemote.transact(Stub.TRANSACTION_setMetricStoargeTailWithMcc, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int submitMetricWithMcc(int metricID, int level, byte[] payloadBytes, int payloadLen, String mcc) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(payloadLen);
                    _data.writeString(mcc);
                    this.mRemote.transact(Stub.TRANSACTION_submitMetricWithMcc, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getUploadType(String mcc) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(mcc);
                    this.mRemote.transact(Stub.TRANSACTION_getUploadType, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            String _result3;
            switch (code) {
                case TRANSACTION_setMetricStoargeHeader /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setMetricStoargeHeader(data.readInt(), data.createByteArray(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_setMetricCommonHeader /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setMetricCommonHeader(data.readInt(), data.createByteArray(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_setMetricStoargeTail /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setMetricStoargeTail(data.readInt(), data.createByteArray(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_submitMetric /*4*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = submitMetric(data.readInt(), data.readInt(), data.createByteArray(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_shouldSubmitMetric /*5*/:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result4 = shouldSubmitMetric(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result4 ? TRANSACTION_setMetricStoargeHeader : 0);
                    return true;
                case TRANSACTION_captureLogMetric /*6*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = captureLogMetric(data.readInt());
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(TRANSACTION_setMetricStoargeHeader);
                        _result2.writeToParcel(reply, TRANSACTION_setMetricStoargeHeader);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case TRANSACTION_captureLogMetricWithParameters /*7*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    return true;
                case TRANSACTION_clearLogMetric /*8*/:
                    data.enforceInterface(DESCRIPTOR);
                    clearLogMetric(data.readLong());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_feedbackUploadResult /*9*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = feedbackUploadResult(data.readLong(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_allowUploadInMobileNetwork /*10*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = allowUploadInMobileNetwork(data.readInt() != 0);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_allowUploadAlways /*11*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = allowUploadAlways(data.readInt() != 0);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_configureUserType /*12*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = configureUserType(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_getUserType /*13*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getUserType();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_forceUpload /*14*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = forceUpload();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_configure /*15*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = configure(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_captureAllLog /*16*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    return true;
                case TRANSACTION_getFirstErrorTime /*17*/:
                    data.enforceInterface(DESCRIPTOR);
                    long _result5 = getFirstErrorTime();
                    reply.writeNoException();
                    reply.writeLong(_result5);
                    return true;
                case TRANSACTION_resetFirstErrorTime /*18*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = resetFirstErrorTime();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_getFirstErrorType /*19*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getFirstErrorType();
                    reply.writeNoException();
                    reply.writeString(_result3);
                    return true;
                case TRANSACTION_configureModemlogcat /*20*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = configureModemlogcat(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_configureBluetoothlogcat /*21*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = configureBluetoothlogcat(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_configureLogcat /*22*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = configureLogcat(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_configureAPlogs /*23*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_configureCoredump /*24*/:
                    ...
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_configureGPS /*25*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_configureWithPara /*26*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getCompressInfo /*27*/:
                    data.enforceInterface(DESCRIPTOR);
                    CompressInfo _result6 = getCompressInfo();
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(TRANSACTION_setMetricStoargeHeader);
                        _result6.writeToParcel(reply, TRANSACTION_setMetricStoargeHeader);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case TRANSACTION_captureLogMetricWithModule /*28*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_doEncrypt /*34*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = doEncrypt(data.readString());
                    reply.writeNoException();
                    reply.writeString(_result3);
                    return true;
                case 1598968902:

...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.huawei.pgmng.log.LogPower.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: com.huawei.pgmng.log.LogPower.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.pgmng.log.LogPower.<clinit>():void");
    }
    ...
    protected static int pushIAware(int tag, String msg) {
        if (tag < FIRST_IAWARE_TAG || tag > LAST_IAWARE_TAG) {
            return -1;
        }
        return Log.print_powerlog_native(6, Integer.toString(tag), msg);
    }

...
import com.huawei.zxing.client.result.ExpandedProductParsedResult;
...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{MotionTypeApps.TYPE_PROXIMITY, 379}, "FR");
            add(new int[]{380}, "BG");
            add(new int[]{383}, "SI");
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            add(new int[]{MotionTypeApps.TYPE_SHAKE, 440}, "DE");
            ...
            add(new int[]{MotionTypeApps.TYPE_TAP, 509}, "GB");
            add(new int[]{520}, "GR");
            ...
            add(new int[]{594}, "RO");
            add(new int[]{599}, "HU");
            add(new int[]{MotionTypeApps.TYPE_TILT_LR, MotionTypeApps.TYPE_TILT_LR_MOVE_WIDGETS}, "ZA");
            add(new int[]{HwTransCodeEx.ADD_TO_ENTRY_STACK_TRANSACTION}, "GH");
            add(new int[]{608}, "BH");
            add(new int[]{609}, "MU");
            add(new int[]{611}, "MA");
            add(new int[]{613}, "DZ");
            ...
            add(new int[]{MotionTypeApps.TYPE_ROTATION, 709}, "NO");
            add(new int[]{729}, "IL");
            ...
            add(new int[]{MotionTypeApps.TYPE_POCKET, 839}, "IT");
            ...
            add(new int[]{896}, "PK");
            add(new int[]{899}, "ID");
            add(new int[]{MotionTypeApps.TYPE_ACTIVITY, 919}, "AT");

...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: gov.nist.javax.sip.SipStackImpl.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: gov.nist.javax.sip.SipStackImpl.<clinit>():void
...
*/
    ...
    public SipStackImpl(Properties configurationProperties) throws PeerUnavailableException {
        ...
        try {
            ...
            StackLogger stackLogger = (StackLogger) Class.forName(stackLoggerClassName).getConstructor(constructorArgs).newInstance(new Object[0]);
            ...
            try {
                ...
                this.serverLogger = (ServerLogger) Class.forName(serverLoggerClassName).getConstructor(constructorArgs).newInstance(new Object[0]);
                ...
                try {
                    ...
                    Constructor<?> cons = Class.forName(routerPath).getConstructor(new Class[]{SipStack.class, String.class});
                    Object[] args = new Object[2];
                    args[0] = this;
                    args[1] = this.outboundProxy;
                    super.setRouter((Router) cons.newInstance(args));
                    ...
                    if (extensionMethods != null) {
                        ...
                        while (stringTokenizer.hasMoreTokens()) {
                            ...
                            if (!em.equalsIgnoreCase(TokenNames.BYE)) {
                                if (!em.equalsIgnoreCase(TokenNames.INVITE)) {
                                    if (!em.equalsIgnoreCase(TokenNames.SUBSCRIBE)) {
                                        if (!em.equalsIgnoreCase(TokenNames.NOTIFY)) {
                                            if (!em.equalsIgnoreCase(TokenNames.ACK)) {
                                                if (!em.equalsIgnoreCase(TokenNames.OPTIONS)) {
                    ...
                    if (forkedSubscriptions != null) {
                        ...
                        while (stringTokenizer.hasMoreTokens()) {
                            String nextEvent = stringTokenizer.nextToken();
                    ...
                    if (configurationProperties.containsKey("gov.nist.javax.sip.NETWORK_LAYER")) {
                        ...
                        try {
                            objArr = new Object[0];
                            this.networkLayer = (NetworkLayer) Class.forName(path).getConstructor(new Class[0]).newInstance(objArr);
                        } catch (Exception e2) {
                    ...
                    if (configurationProperties.containsKey("gov.nist.javax.sip.ADDRESS_RESOLVER")) {
                        ...
                        try {
                            objArr = new Object[0];
                            this.addressResolver = (AddressResolver) Class.forName(path).getConstructor(new Class[0]).newInstance(objArr);
                        } catch (Exception e3) {
                    ...
                    if (maxMsgSize != null) {
                        try {
                            ...
                            if (r0 < 4096) {
                                this.maxMessageSize = HTMLModels.M_INLINE;
                            }
                    ...
                    if (rel != null) {
                        equalsIgnoreCase = "true".equalsIgnoreCase(rel);
                    } else {
                        equalsIgnoreCase = false;
                    }
                    this.reEntrantListener = equalsIgnoreCase;
                    ...
                    if (messageLogFactoryClasspath != null) {
                        try {
                            objArr = new Object[0];
                            this.logRecordFactory = (LogRecordFactory) Class.forName(messageLogFactoryClasspath).getConstructor(new Class[0]).newInstance(objArr);
                        } catch (Exception e5) {
                            if (isLoggingEnabled()) {
                    ...
                    if (tlsClientProtocols != null) {
                        ...
                        while (stringTokenizer.hasMoreTokens()) {
                            int i3 = i2 + 1;
                            protocols[i2] = stringTokenizer.nextToken();
                            i2 = i3;
                        }
    ...
    public synchronized ListeningPoint createListeningPoint(String address, int port, String transport) throws TransportNotSupportedException, InvalidArgumentException {
        ...
        if (transport == null) {
            ...
            if (!(transport.equalsIgnoreCase(ListeningPoint.UDP) || transport.equalsIgnoreCase(ListeningPoint.TLS))) {
                if (!(transport.equalsIgnoreCase(ListeningPoint.TCP) || transport.equalsIgnoreCase(ListeningPoint.SCTP))) {

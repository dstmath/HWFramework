...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: gov.nist.javax.sip.stack.SIPTransaction.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: gov.nist.javax.sip.stack.SIPTransaction.<clinit>():void
...
*/
    ...
    protected SIPTransaction(SIPTransactionStack newParentStack, MessageChannel newEncapsulatedChannel) {
        this.BASE_TIMER_INTERVAL = Response.SERVER_INTERNAL_ERROR;
        ...
        this.semaphore = new Semaphore(TIMER_A, true);
        ...
        if (isReliable()) {
            ...
            messageChannel.useCount += TIMER_A;
    ...
    public void setOriginalRequest(SIPRequest newOriginalRequest) {
        ...
        this.event = (Event) newOriginalRequest.getHeader(EventHeader.NAME);
    ...
    public final boolean isInviteTransaction() {
        return getMethod().equals(TokenNames.INVITE);
    }
    ...
    protected final void enableRetransmissionTimer() {
        enableRetransmissionTimer(TIMER_A);
    }
    ...
    protected final void enableRetransmissionTimer(int tickCount) {
        if (isInviteTransaction() && (this instanceof SIPClientTransaction)) {
            ...
            this.retransmissionTimerTicksLeft = Math.min(tickCount, MAXIMUM_RETRANSMISSION_TICK_COUNT);
        }

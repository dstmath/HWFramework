...
public interface IHwWindowCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHwWindowCallback {
        ...
        private static class Proxy implements IHwWindowCallback {
            ...
            public void handleConfigurationChanged() throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_handleConfigurationChanged, _data, _reply, 0);
            ...
            public long interceptKeyBeforeDispatching(KeyEvent event, int policyFlags) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (event != null) {
                        _data.writeInt(Stub.TRANSACTION_handleConfigurationChanged);
                        event.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
                    _data.writeInt(policyFlags);
                    this.mRemote.transact(Stub.TRANSACTION_interceptKeyBeforeDispatching, _data, _reply, 0);
                    _reply.readException();
            ...
            public void screenTurnedOff() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_screenTurnedOff, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void focusedAppChanged() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_focusedAppChanged, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_handleConfigurationChanged /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    handleConfigurationChanged();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_interceptKeyBeforeDispatching /*2*/:
                    KeyEvent keyEvent;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    return true;
                case TRANSACTION_screenTurnedOff /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    screenTurnedOff();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_focusedAppChanged /*4*/:
                    data.enforceInterface(DESCRIPTOR);
                    focusedAppChanged();
                    reply.writeNoException();
                    return true;

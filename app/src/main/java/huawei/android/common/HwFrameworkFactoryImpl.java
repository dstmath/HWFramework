...
import android.rog.HwRogManager;
...
import android.view.HwPointEventFilter;
...
public class HwFrameworkFactoryImpl implements Factory {
    public static final String ACTION_HW_CHOOSER = "android.intent.action.hwCHOOSER";
    ...
    public String getHuaweiResolverActivityImpl(Context context) {
        return context.getResources().getString(33685524);
    }
    ...
    public IHwPointEventFilter getHwPointEventFilter(String pkgName) {
        return new HwPointEventFilter(pkgName);
    }

    public IHwPointEventFilter getHwPointEventFilter() {
        return new HwPointEventFilter();
    }
    ...
    public IRogManager getRogManager() {
        return HwRogManager.getDefault();
    }

...
public class HwRTBlurUtils {
    ...
    public static class BlurParams {
        ...
        public BlurParams() {
            ...
            this.rx = DEFAULT_BLANKT;
            this.ry = DEFAULT_BLANKT;
            this.alpha = DEFAULT_ALPHA;
            this.blankL = DEFAULT_BLANKT;
            this.blankT = DEFAULT_BLANKT;
            this.blankR = DEFAULT_BLANKT;
            this.blankB = DEFAULT_BLANKT;
        }
        ...
        for (int i = 0; i < Nhwext; i++) {
            ...
            switch (attr) {
                ...
                case HwCfgFilePolicy.CUST /*4*/:
                    params.setAlpha(ahwext.getFloat(attr, LayoutParams.BRIGHTNESS_OVERRIDE_FULL));
                    break;

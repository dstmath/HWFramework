...
public class TabIndicator extends LinearLayout {
    ...
    public void initTabIndicator() {
        ...
        if (this.mTextView != null) {
            HwWidgetFactory.setImmersionStyle(getContext(), this.mTextView, 33882422, 33882421, 0, false);
        }
        if (HwWidgetUtils.isActionbarBackgroundThemed(this.mContext)) {
            setBackgroundResource(33751651);
        } else {
            setBackgroundResource(HwWidgetFactory.getImmersionResource(this.mContext, 33751653, 0, 33751656, false));
        }
        initHeight();
    }

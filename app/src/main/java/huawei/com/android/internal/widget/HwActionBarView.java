...
public class HwActionBarView extends ActionBarView {
    ...
    protected int measureChildView(View child, int availableWidth, int childSpecHeight, int spacing) {
        ...
        if (getUpGoerFive() == null || getUpGoerFive().getChildCount() != 0) {
            ...
            if (title != null) {
                ...
                int titleHeightSpec = MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(childSpecHeight), Integer.MIN_VALUE);
    ...
    protected LinearLayout initTitleLayout() {
        ...
        this.mTitleContainer = (LinearLayout) titleLayout.findViewById(34603081);
    ...
    protected void initTitleIcons(LinearLayout titleLayout) {
        if (titleLayout != null) {
            this.mIcon1View = (ImageView) ((ViewStub) titleLayout.findViewById(34603080)).inflate().findViewById(16908295);
            this.mIcon2View = (ImageView) ((ViewStub) titleLayout.findViewById(34603082)).inflate().findViewById(16908296);
            initIconsColor();
    ...
    private void invalidateTitleLayout() {
        boolean setUp = false;
        if ((getDisplayOptions() & 4) != 0) {
            setUp = true;
        }
        boolean marginNotZero = (setUp || this.mIcon1Visible) ? false : true;
    ...
    private static ColorStateList getImmersionTint(Context context) {
        return context.getColorStateList(HwWidgetFactory.getImmersionResource(context, 33882140, 0, 33882373, true));
    }
    ...
    protected void onFinishInflate() {
        ...
        homeView.setContentDescription(getContext().getResources().getText(17040556));
    ...
    public static void initTitleAppearance(Context context, TextView title, TextView subTitle) {
        if (title != null) {
            HwWidgetFactory.setImmersionStyle(context, title, 33882235, 33882234, 0, false);
        }
        if (subTitle != null) {
            HwWidgetFactory.setImmersionStyle(context, subTitle, 33882235, 33882234, 0, false);
        }
    }
}

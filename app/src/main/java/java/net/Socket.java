...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.net.Socket.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.net.Socket.<clinit>():void
...
*/
    ...
    public Socket(String host, int port) throws UnknownHostException, IOException {
        ...
        if (host != null) {
            ...
            inetSocketAddress = new InetSocketAddress(InetAddress.getByName(null), port);
        }
        this(inetSocketAddress, (SocketAddress) null, true);
    }
    ...
    public Socket(String host, int port, InetAddress localAddr, int localPort) throws IOException {
        ...
        this(inetSocketAddress, new InetSocketAddress(localAddr, localPort), true);
    }
    ...
    public Socket(InetAddress address, int port, InetAddress localAddr, int localPort) throws IOException {
        ...
        this(socketAddress, new InetSocketAddress(localAddr, localPort), true);
    }
    ...
    public Socket(String host, int port, boolean stream) throws IOException {
        ...
        this(inetSocketAddress, (SocketAddress) null, stream);
    }
    ...
    public Socket(InetAddress host, int port, boolean stream) throws IOException {
        ...
        this(socketAddress, new InetSocketAddress(0), stream);
    }
    ...
    public void setSoLinger(boolean on, int linger) throws SocketException {
        if (isClosed()) {
            ...
            getImpl().setOption(Pattern.CANON_EQ, new Boolean(on));
        } else if (linger < 0) {
            ...
            getImpl().setOption(Pattern.CANON_EQ, new Integer(linger));
        }
    }
    ...
    public int getSoLinger() throws SocketException {
        ...
        Object o = getImpl().getOption(Pattern.CANON_EQ);

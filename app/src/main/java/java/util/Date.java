...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.Date.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.Date.<clinit>():void

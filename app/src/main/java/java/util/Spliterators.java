...
public final class Spliterators {
    ...
    static class IteratorSpliterator<T> implements Spliterator<T> {
        ...
        public IteratorSpliterator(Collection<? extends T> collection, int characteristics) {
            ...
            if ((characteristics & Spliterator.CONCURRENT) == 0) {
                characteristics = (characteristics | 64) | Record.maxDataSize;
            }
    ...
    class AnonymousClass1Adapter implements Iterator<T>, Consumer<T> {
        ...
        AnonymousClass1Adapter(Spliterator val$spliterator) {
            this.val$spliterator = val$spliterator;
    ...
    class AnonymousClass2Adapter implements PrimitiveIterator.OfInt, IntConsumer {
        ...
        AnonymousClass2Adapter(OfInt val$spliterator) {
            this.val$spliterator = val$spliterator;
            this.valueReady = false;
        }
    ...
    class AnonymousClass3Adapter implements PrimitiveIterator.OfLong, LongConsumer {
        ...
        AnonymousClass3Adapter(OfLong val$spliterator) {
            this.val$spliterator = val$spliterator;
            this.valueReady = false;
        }
    ...
    class AnonymousClass4Adapter implements PrimitiveIterator.OfDouble, DoubleConsumer {
        ...
        AnonymousClass4Adapter(OfDouble val$spliterator) {
            this.val$spliterator = val$spliterator;
            this.valueReady = false;
        }
    ...
    public static abstract class AbstractDoubleSpliterator implements OfDouble {
        ...
        protected AbstractDoubleSpliterator(long est, int additionalCharacteristics) {
            ...
            if ((additionalCharacteristics & 64) != 0) {
                additionalCharacteristics |= Record.maxDataSize;
            }
    ...
    static final class ArraySpliterator<T> implements Spliterator<T> {
        ...
        public ArraySpliterator(Object[] array, int origin, int fence, int additionalCharacteristics) {
            ...
            this.index = origin;
            this.fence = fence;
            this.characteristics = (additionalCharacteristics | 64) | Record.maxDataSize;
        }
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.Spliterators.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.Spliterators.<clinit>():void

...
public class ConcurrentSkipListMap<K, V> extends AbstractMap<K, V> implements ConcurrentNavigableMap<K, V>, Cloneable, Serializable {
    ...
    static final class EntrySet<K, V> extends AbstractSet<Entry<K, V>> {
        ...
        public Iterator<Entry<K, V>> iterator() {
            ...
            subMap.getClass();
            return new SubMapEntryIterator(subMap);
        }
                            ...
                            if (b != null) {
                                ...
                                if (!(n == null || n.value == null)) {
                                    ...
                                    if (sk != null && ConcurrentSkipListMap.cpr(cmp, sk, ek) > 0 && (f == null || ConcurrentSkipListMap.cpr(cmp, sk, f) < 0)) {
                                        ...
                                        this.row = s;
                                        this.est -= this.est >>> ConcurrentSkipListMap.LT;
...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.concurrent.ConcurrentSkipListMap.Index.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.concurrent.ConcurrentSkipListMap.Index.<clinit>():void
...
*/
    ...
    static final class KeySet<K, V> extends AbstractSet<K> implements NavigableSet<K> {
        ...
        public /* bridge */ /* synthetic */ SortedSet m72subSet(Object fromElement, Object toElement) {
        ...
        public /* bridge */ /* synthetic */ SortedSet m71headSet(Object toElement) {
        ...
        public /* bridge */ /* synthetic */ SortedSet m73tailSet(Object fromElement) {
    ...
    static final class KeySpliterator<K, V> extends CSLMSpliterator<K, V> implements Spliterator<K> {
        ...
        public KeySpliterator<K, V> m74trySplit() {
            Comparator<? super K> cmp = this.comparator;
            K f = this.fence;
            Node<K, V> e = this.current;
            if (e != null) {
    ...
    static final class Node<K, V> {
        ...
        static {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.concurrent.ConcurrentSkipListMap.Node.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.concurrent.ConcurrentSkipListMap.Node.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 6 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e9
...
*/
    ...
    static final class SubMap<K, V> extends AbstractMap<K, V> implements ConcurrentNavigableMap<K, V>, Cloneable, Serializable {
        ...
        abstract class SubMapIter<T> implements Iterator<T>, Spliterator<T> {
            ...
            SubMapIter(SubMap this$1) {
                this.this$1 = this$1;
                Comparator<? super K> cmp = this$1.m.comparator;
                while (true) {
                    V x;
                    this.next = this$1.isDescending ? this$1.hiNode(cmp) : this$1.loNode(cmp);
                    if (this.next != null) {
                        x = this.next.value;
                        if (x != null && x != this.next) {
                            break;
                ...
                if (this$1.inBounds(this.next.key, cmp)) {
                    V vv = x;
                    this.nextValue = x;
                    return;
                }
            ...
            private void ascend() {
                Comparator<? super K> cmp = this.this$1.m.comparator;
                while (true) {
                    V x;
                ...
                if (this.this$1.tooHigh(this.next.key, cmp)) {
                    this.next = null;
                    return;
                }
                V vv = x;
            ...
            private void descend() {
                ...
                while (true) {
                    V x;
                    this.next = this.this$1.m.findNear(this.lastReturned.key, ConcurrentSkipListMap.LT, cmp);
                    if (this.next != null) {
                        x = this.next.value;
                        if (x != null && x != this.next) {
                            break;
                ...
                if (this.this$1.tooLow(this.next.key, cmp)) {
                    this.next = null;
                    return;
                }
                V vv = x;
        ...
        final class SubMapEntryIterator extends SubMapIter<Entry<K, V>> {
            ...
            SubMapEntryIterator(SubMap this$1) {
                this.this$1 = this$1;
                super(this$1);
            }
            ...
            public int characteristics() {
                return ConcurrentSkipListMap.EQ;
            }
        }
        ...
        final class SubMapKeyIterator extends SubMapIter<K> {
            ...
            SubMapKeyIterator(SubMap this$1) {
                this.this$1 = this$1;
                super(this$1);
            }
        ...
        final class SubMapValueIterator extends SubMapIter<V> {
            ...
            SubMapValueIterator(SubMap this$1) {
                this.this$1 = this$1;
                super(this$1);
            }
            ...
            public int characteristics() {
                return ConcurrentSkipListMap.GT;
            }
        }
        ...
        Node<K, V> loNode(Comparator<? super K> cmp) {
            ...
            if (this.loInclusive) {
                return this.m.findNear(this.lo, ConcurrentSkipListMap.EQ, cmp);
            }
            return this.m.findNear(this.lo, ConcurrentSkipListMap.GT, cmp);
        }
        ...
        Node<K, V> hiNode(Comparator<? super K> cmp) {
            ...
            return this.m.findNear(this.hi, ConcurrentSkipListMap.LT, cmp);
        }
        ...
        public int size() {
            ...
            return count >= 2147483647L ? AnnualTimeZoneRule.MAX_YEAR : (int) count;
        }
        ...
        public /* bridge */ /* synthetic */ ConcurrentNavigableMap m83subMap(Object fromKey, boolean fromInclusive, Object toKey, boolean toInclusive) {
            return subMap(fromKey, fromInclusive, toKey, toInclusive);
        }

        public SubMap<K, V> m85subMap(K fromKey, boolean fromInclusive, K toKey, boolean toInclusive) {
        ...
        public /* bridge */ /* synthetic */ ConcurrentNavigableMap m78headMap(Object toKey, boolean inclusive) {
            return headMap(toKey, inclusive);
        }

        public SubMap<K, V> m80headMap(K toKey, boolean inclusive) {
            if (toKey != null) {
        ...
        public /* bridge */ /* synthetic */ ConcurrentNavigableMap m87tailMap(Object fromKey, boolean inclusive) {
            return tailMap(fromKey, inclusive);
        }

        public SubMap<K, V> m89tailMap(K fromKey, boolean inclusive) {
            if (fromKey != null) {
        ...
        public /* bridge */ /* synthetic */ ConcurrentNavigableMap m82subMap(Object fromKey, Object toKey) {
            return subMap(fromKey, toKey);
        }

        public SubMap<K, V> m84subMap(K fromKey, K toKey) {
        ...
        public /* bridge */ /* synthetic */ ConcurrentNavigableMap m77headMap(Object toKey) {
            return headMap(toKey);
        }

        public SubMap<K, V> m79headMap(K toKey) {
        ...
        public /* bridge */ /* synthetic */ ConcurrentNavigableMap m86tailMap(Object fromKey) {
            return tailMap(fromKey);
        }

        public SubMap<K, V> m88tailMap(K fromKey) {
        ...
        public /* bridge */ /* synthetic */ ConcurrentNavigableMap m75descendingMap() {
            return descendingMap();
        }

        public SubMap<K, V> m76descendingMap() {
        ...
        public /* bridge */ /* synthetic */ Set m81keySet() {
            return keySet();
        }
    ...
    static final class ValueSpliterator<K, V> extends CSLMSpliterator<K, V> implements Spliterator<V> {
        ...
        public ValueSpliterator<K, V> m91trySplit() {
            Comparator<? super K> cmp = this.comparator;
            K f = this.fence;
            Node<K, V> e = this.current;
            if (e != null) {
    ...
    static {
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.concurrent.ConcurrentSkipListMap.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	at jadx.api.JadxDecompiler.processClass(JadxDecompiler.java:281)
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: java.util.concurrent.ConcurrentSkipListMap.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 5 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e9
...
*/
    ...
    private void initialize() {
        ...
        this.head = new HeadIndex(new Node(null, BASE_HEADER, null), null, null, EQ);
    }
    ...
    private V doPut(K key, V value, boolean onlyIfAbsent) {
        ...
        if ((-2147483647 & rnd) == 0) {
            ...
            if (level <= max) {
                ...
                int oldLevel;
                level = max + EQ;
                Index<K, V>[] idxs = new Index[(level + EQ)];
                i = EQ;
                idx2 = null;
                while (i <= level) {
    ...
    public ConcurrentSkipListMap<K, V> m62clone() {
        try {
    ...
    public /* bridge */ /* synthetic */ Set m66keySet() {
        return keySet();
    }
    ...
    public ConcurrentNavigableMap<K, V> m63descendingMap() {
    ...
    public ConcurrentNavigableMap<K, V> m68subMap(K fromKey, boolean fromInclusive, K toKey, boolean toInclusive) {
        if (fromKey != null && toKey != null) {
    ...
    public ConcurrentNavigableMap<K, V> m65headMap(K toKey, boolean inclusive) {
        if (toKey != null) {
    ...
    public ConcurrentNavigableMap<K, V> m70tailMap(K fromKey, boolean inclusive) {
        if (fromKey != null) {
    ...
    public ConcurrentNavigableMap<K, V> m67subMap(K fromKey, K toKey) {
        return subMap((Object) fromKey, true, (Object) toKey, false);
    }
    ...
    public ConcurrentNavigableMap<K, V> m64headMap(K toKey) {
        return headMap((Object) toKey, false);
    }
    ...
    public ConcurrentNavigableMap<K, V> m69tailMap(K fromKey) {
        return tailMap((Object) fromKey, true);
    }
    ...
    public K lowerKey(K key) {
        Node<K, V> n = findNear(key, LT, this.comparator);
        if (n == null) {
            return null;
        }
        return n.key;
    ...
    public Entry<K, V> ceilingEntry(K key) {
        return getNear(key, EQ);
    }

    public K ceilingKey(K key) {
        Node<K, V> n = findNear(key, EQ, this.comparator);
        if (n == null) {
            return null;
        }
        return n.key;
    ...
    public K higherKey(K key) {
        Node<K, V> n = findNear(key, GT, this.comparator);
        if (n == null) {
            return null;
        }
        return n.key;
    ...
    final KeySpliterator<K, V> keySpliterator() {
        ...
        return new KeySpliterator(cmp, h, p, null, p == null ? GT : AnnualTimeZoneRule.MAX_YEAR);
    }
    ...
    final ValueSpliterator<K, V> valueSpliterator() {
        ...
        return new ValueSpliterator(cmp, h, p, null, p == null ? GT : AnnualTimeZoneRule.MAX_YEAR);
    }
    ...
    final EntrySpliterator<K, V> entrySpliterator() {
        ...
        return new EntrySpliterator(cmp, h, p, null, p == null ? GT : AnnualTimeZoneRule.MAX_YEAR);
    }
}

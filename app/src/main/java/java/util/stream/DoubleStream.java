...
public interface DoubleStream extends BaseStream<Double, DoubleStream> {
    ...
    static class AnonymousClass1 implements OfDouble {
        ...
        AnonymousClass1(double val$seed, DoubleUnaryOperator val$f) {
    ...
    static DoubleStream iterate(double seed, DoubleUnaryOperator f) {
        ...
        return StreamSupport.doubleStream(Spliterators.spliteratorUnknownSize(new AnonymousClass1(seed, f), 1296), false);
    }

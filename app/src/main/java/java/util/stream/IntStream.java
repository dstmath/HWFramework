...
public interface IntStream extends BaseStream<Integer, IntStream> {
    ...
    static class AnonymousClass1 implements OfInt {
        ...
        AnonymousClass1(int val$seed, IntUnaryOperator val$f) {
    ...
    static IntStream iterate(int seed, IntUnaryOperator f) {
        ...
        return StreamSupport.intStream(Spliterators.spliteratorUnknownSize(new AnonymousClass1(seed, f), 1296), false);
    }

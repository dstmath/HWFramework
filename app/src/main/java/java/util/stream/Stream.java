...
public interface Stream<T> extends BaseStream<T, Stream<T>> {
    ...
    static class AnonymousClass1 implements Iterator<T> {
        ...
        AnonymousClass1(Object val$seed, UnaryOperator val$f) {
    ...
    static <T> Stream<T> iterate(T seed, UnaryOperator<T> f) {
        ...
        return StreamSupport.stream(Spliterators.spliteratorUnknownSize(new AnonymousClass1(seed, f), 1040), false);
    }

        ...
        synchronized (this.lock) {
            ...
            while (true) {
                if (this.serviceIterator.hasNext()) {
                    s = (Service) this.serviceIterator.next();
                    if (JceSecurity.canUseProvider(s.getProvider())) {
                        try {
                            Object inst = s.newInstance(null);
                            if (inst instanceof KeyGeneratorSpi) {
                                spi = (KeyGeneratorSpi) inst;
                                if (reinit) {
                                    if (this.initType != I_SIZE) {
                                        if (this.initType != I_PARAMS) {
                                            if (this.initType != I_RANDOM) {
                                                break;
                                            }
                                            break;
                                        }

...
public final class ServerSession extends ObexSession implements Runnable {
    ...
    private void handleConnectRequest() throws IOException {
        ...
        sendData[6] = (byte) (maxRxLength & ObexHelper.OBEX_OPCODE_ABORT);
        if (head != null) {

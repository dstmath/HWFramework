...
public class SmbTransport extends Transport implements SmbConstants {
    static final byte[] BUF = null;
    static final SmbComNegotiate NEGOTIATE_REQUEST = null;
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: jcifs.smb.SmbTransport.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: jcifs.smb.SmbTransport.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: jcifs.smb.SmbTransport.<clinit>():void");
    }
        ...
        do {
            ...
            switch (this.sbuf[0] & 255) {
                ...
                case SessionServicePacket.NEGATIVE_SESSION_RESPONSE /*131*/:
                    ...
                    switch (errorCode) {
                        case SmbConstants.FLAGS_RESPONSE /*128*/:
                        case SessionServicePacket.POSITIVE_SESSION_RESPONSE /*130*/:
                            this.socket.close();
    ...
    protected void doConnect() throws IOException {
        ...
        if (resp.dialectIndex > 10) {
        ...
        } else if ((this.server.capabilities & SmbConstants.GENERIC_READ) == SmbConstants.GENERIC_READ || this.server.encryptionKeyLength == 8 || LM_COMPATIBILITY != 0) {
            ...
            if ((this.server.capabilities & SmbConstants.GENERIC_READ) == SmbConstants.GENERIC_READ) {
                this.capabilities |= SmbConstants.GENERIC_READ;
            }
    ...
    protected void doRecv(Response response) throws IOException {
        ...
        if ((this.capabilities & SmbConstants.GENERIC_READ) == SmbConstants.GENERIC_READ) {
            z = true;
        }

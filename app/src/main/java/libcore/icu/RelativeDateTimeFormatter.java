...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: libcore.icu.RelativeDateTimeFormatter.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: libcore.icu.RelativeDateTimeFormatter.<clinit>():void
...
*/
    ...
    private static int julianDay(android.icu.util.TimeZone icuTimeZone, long time) {
        return ((int) ((time + ((long) icuTimeZone.getOffset(time))) / DAY_IN_MILLIS)) + EPOCH_JULIAN_DAY;
    }
}

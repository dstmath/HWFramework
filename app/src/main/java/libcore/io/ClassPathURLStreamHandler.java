...
public class ClassPathURLStreamHandler extends Handler {
    ...
    private class ClassPathURLConnection extends JarURLConnection {
        ...
        /* renamed from: libcore.io.ClassPathURLStreamHandler.ClassPathURLConnection.1 */
        class AnonymousClass1 extends FilterInputStream {
            AnonymousClass1(InputStream $anonymous0) {
                super($anonymous0);
            }
        ...
        public InputStream getInputStream() throws IOException {
            ...
            InputStream anonymousClass1 = new AnonymousClass1(ClassPathURLStreamHandler.this.jarFile.getInputStream(this.jarEntry));

...
public abstract class UriCodec {
    ...
    private static URISyntaxException unexpectedCharacterException(String uri, String name, char unexpected, int index) {
        return new URISyntaxException(uri, "Unexpected character" + (name == null ? XmlPullParser.NO_NAMESPACE : " in [" + name + "]") + PluralRules.KEYWORD_RULE_SEPARATOR + unexpected, index);
    }
    ...
    private static char getNextCharacter(String uri, int index, int end, String name) throws URISyntaxException {
        ...
        throw new URISyntaxException(uri, "Unexpected end of string" + (name == null ? XmlPullParser.NO_NAMESPACE : " in [" + name + "]"), index);
    }
        ...
        if (cBuffer.position() != 0) {
            ...
            if (result != CoderResult.UNDERFLOW) {
                ...
                while (byteBuffer.hasRemaining()) {
                    ...
                    builder.append('%');
                    builder.append(intToHexDigit((b & Opcodes.OP_INVOKE_DIRECT_EMPTY) >>> 4));

...
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: libcore.reflect.AnnotationMember.DefaultValues.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: libcore.reflect.AnnotationMember.DefaultValues.<clinit>():void
...
*/
    ...
    static {
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: libcore.reflect.AnnotationMember.<clinit>():void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	at jadx.api.JadxDecompiler.processClass(JadxDecompiler.java:281)
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: libcore.reflect.AnnotationMember.<clinit>():void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 5 more
Caused by: java.lang.IllegalArgumentException: bogus opcode: 0073
...
*/
    ...
    public int hashCode() {
        int hash = this.name.hashCode() * Opcodes.OP_NEG_FLOAT;
        if (this.tag != ARRAY) {
    ...
    public void rethrowError() throws Throwable {
        ...
        if (this.value instanceof TypeNotPresentException) {
            ...
            if (ste == null) {
                i = NodeFilter.SHOW_DOCUMENT_TYPE;
            } else {
                i = (ste.length + 1) * 80;
            }

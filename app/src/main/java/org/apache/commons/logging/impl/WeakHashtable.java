...
public final class WeakHashtable extends Hashtable {
    ...
    class AnonymousClass1 implements Enumeration {
        ...
        AnonymousClass1(Enumeration val$enumer) {
    ...
    private static final class Referenced {
        ...
        private Referenced(Object key, ReferenceQueue queue) {
            this.reference = new WeakKey(queue, this, null);
    ...
    public boolean containsKey(Object key) {
        return super.containsKey(new Referenced(null));
    }
    ...
    public Set entrySet() {
        ...
        for (java.util.Map.Entry entry : referencedEntries) {
            ...
            if (key != null) {
                unreferencedEntries.add(new Entry(value, null));
            }
        }
    ...
    public Object get(Object key) {
        return super.get(new Referenced(null));
    }

    public Enumeration keys() {
        purge();
        return new AnonymousClass1(super.keys());
    }
    ...
    public Object put(Object key, Object value) {
        if (key == null) {
            ...
            return super.put(new Referenced(this.queue, null), value);
        }
    }
    ...
    public Object remove(Object key) {
        ...
        return super.remove(new Referenced(null));
    }

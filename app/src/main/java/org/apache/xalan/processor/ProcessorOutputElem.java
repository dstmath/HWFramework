...
class ProcessorOutputElem extends XSLTElementProcessor {
    ...
    public void setEncoding(String newValue) {
        this.m_outputProperties.setProperty(DOMConstants.S_XSL_OUTPUT_ENCODING, newValue);
    }

    public void setIndent(boolean newValue) {
        this.m_outputProperties.setBooleanProperty(DOMConstants.S_XSL_OUTPUT_INDENT, newValue);
    }
    ...
    public void setOmitXmlDeclaration(boolean newValue) {
        this.m_outputProperties.setBooleanProperty(DOMConstants.S_XSL_OUTPUT_OMIT_XML_DECL, newValue);
    }
    ...
    public void setVersion(String newValue) {
        this.m_outputProperties.setProperty(Constants.ATTRNAME_VERSION, newValue);
    }

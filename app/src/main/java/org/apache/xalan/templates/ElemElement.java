...
public class ElemElement extends ElemUse {
    ...
    public void execute(TransformerImpl transformer) throws TransformerException {
        ...
        String prefix = null;
        String nodeNamespace = SerializerConstants.EMPTYSTRING;
        if (nodeName != null && !this.m_name_avt.isSimple() && !XML11Char.isXML11ValidQName(nodeName)) {
            transformer.getMsgMgr().warn(this, XSLTErrorResources.WG_ILLEGAL_ATTRIBUTE_VALUE, new Object[]{Keywords.FUNC_NAME_STRING, nodeName});
            nodeName = null;
            ...
            if (this.m_namespace_avt != null) {
                ...
                try {
                    ...
                    if (nodeNamespace == null && prefix.length() == 0) {
                        nodeNamespace = SerializerConstants.EMPTYSTRING;

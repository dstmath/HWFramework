    ...
    public void execute(TransformerImpl transformer) throws TransformerException {
        ...
        try {
            ...
            if (this.m_disableOutputEscaping) {
                rth.processingInstruction("javax.xml.transform.disable-output-escaping", SerializerConstants.EMPTYSTRING);
            }
            this.m_selectExpression.getExpression().executeCharsToContentHandler(xctxt, rth);
            if (this.m_disableOutputEscaping) {
                rth.processingInstruction("javax.xml.transform.enable-output-escaping", SerializerConstants.EMPTYSTRING);
            }

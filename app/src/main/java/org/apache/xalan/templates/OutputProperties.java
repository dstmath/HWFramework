...
public class OutputProperties extends ElemTemplateElement implements Cloneable {
    ...
    public OutputProperties() {
        this(SerializerConstants.XML_PREFIX);
    }
    ...
    public void setMethodDefaults(String method) {
        ...
        if (defaultMethod == null || !defaultMethod.equals(method) || defaultMethod.equals(SerializerConstants.XML_PREFIX)) {
    ...
    public static boolean isLegalPropertyKey(String key) {
        if (key.equals(Constants.ATTRNAME_OUTPUT_CDATA_SECTION_ELEMENTS) || key.equals(Constants.ATTRNAME_OUTPUT_DOCTYPE_PUBLIC) || key.equals(Constants.ATTRNAME_OUTPUT_DOCTYPE_SYSTEM) || key.equals(DOMConstants.S_XSL_OUTPUT_ENCODING) || key.equals(DOMConstants.S_XSL_OUTPUT_INDENT) || key.equals(Constants.ATTRNAME_OUTPUT_MEDIATYPE) || key.equals(Constants.ATTRNAME_OUTPUT_METHOD) || key.equals(DOMConstants.S_XSL_OUTPUT_OMIT_XML_DECL) || key.equals(Constants.ATTRNAME_OUTPUT_STANDALONE) || key.equals(Constants.ATTRNAME_VERSION)) {
            return true;
        }

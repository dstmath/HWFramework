...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: org.apache.xml.dtm.ref.DTMDocumentImpl.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: org.apache.xml.dtm.ref.DTMDocumentImpl.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.xml.dtm.ref.DTMDocumentImpl.<clinit>():void");
    }
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException {
        ...
        for (i = nAtts - 1; i >= 0; i--) {
            ...
            if (qName.startsWith(Constants.ATTRNAME_XMLNS) || SerializerConstants.XMLNS_PREFIX.equals(qName)) {
        ...
        for (i = nAtts - 1; i >= 0; i--) {
            qName = atts.getQName(i);
            if (!(!qName.startsWith(Constants.ATTRNAME_XMLNS) ? SerializerConstants.XMLNS_PREFIX.equals(qName) : true)) {
                colon = qName.indexOf(58);
                if (colon > 0) {
                    prefix = qName.substring(0, colon);
                ...
                if (!(!SerializerConstants.XMLNS_PREFIX.equals(prefix) ? SerializerConstants.XMLNS_PREFIX.equals(qName) : true)) {
    ...
    public String getLocalName(int nodeHandle) {
        this.nodes.readSlot(nodeHandle, this.gotslot);
        short type = (short) (this.gotslot[0] & DTMManager.IDENT_NODE_DEFAULT);
        String name = SerializerConstants.EMPTYSTRING;

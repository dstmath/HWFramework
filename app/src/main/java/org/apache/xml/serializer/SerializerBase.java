...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: org.apache.xml.serializer.SerializerBase.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: org.apache.xml.serializer.SerializerBase.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.xml.serializer.SerializerBase.<clinit>():void");
    }
    ...
    public void addAttributes(Attributes atts) throws SAXException {
        ...
        for (int i = 0; i < nAtts; i++) {
            ...
            if (uri == null) {
                uri = SerializerConstants.EMPTYSTRING;
            }
    ...
    public String getEncoding() {
        return getOutputProperty(DOMConstants.S_XSL_OUTPUT_ENCODING);
    }
    ...
    public void setOmitXMLDeclaration(boolean b) {
        setOutputProperty(DOMConstants.S_XSL_OUTPUT_OMIT_XML_DECL, b ? "yes" : "no");
    }
    ...
    public void setVersion(String version) {
        setOutputProperty(Constants.ATTRNAME_VERSION, version);
    }
    ...
    public void setIndent(boolean doIndent) {
        setOutputProperty(DOMConstants.S_XSL_OUTPUT_INDENT, doIndent ? "yes" : "no");
    }
    ...
    public String getNamespaceURI(String qname, boolean isElement) {
        ...
        int col = qname.lastIndexOf(58);
        String prefix = col > 0 ? qname.substring(0, col) : SerializerConstants.EMPTYSTRING;
        if ((!SerializerConstants.EMPTYSTRING.equals(prefix) || isElement) && this.m_prefixMap != null) {
            uri = this.m_prefixMap.lookupNamespace(prefix);
            if (uri == null && !prefix.equals(SerializerConstants.XMLNS_PREFIX)) {
    ...
    private String getElementURI() {
        ...
        if (prefix == null) {
            uri = this.m_prefixMap.lookupNamespace(SerializerConstants.EMPTYSTRING);
        } else {
            uri = this.m_prefixMap.lookupNamespace(prefix);
        }
        if (uri == null) {

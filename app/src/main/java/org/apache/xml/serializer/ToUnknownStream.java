...
public final class ToUnknownStream extends SerializerBase {
    ...
    public void namespaceAfterStartElement(String prefix, String uri) throws SAXException {
        if (this.m_firstTagNotEmitted && this.m_firstElementURI == null && this.m_firstElementName != null && SerializerBase.getPrefixPart(this.m_firstElementName) == null && EMPTYSTRING.equals(prefix)) {
    ...
    private void initStreamOutput() throws SAXException {
        if (isFirstElemHTML()) {
            ...
            this.m_handler = (SerializationHandler) SerializerFactory.getSerializer(OutputPropertiesFactory.getDefaultMethodProperties(Method.HTML));
    ...
    private boolean isFirstElemHTML() {
        boolean isHTML = getLocalNameUnknown(this.m_firstElementName).equalsIgnoreCase(Method.HTML);
        ...
        for (int i = 0; i < max; i++) {
            ...
            if (this.m_firstElementPrefix != null && this.m_firstElementPrefix.equals(prefix) && !EMPTYSTRING.equals(uri)) {
                return false;
            }
        }
        return isHTML;

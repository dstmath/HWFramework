...
public final class Messages {
    ...
    private final String createMsg(ListResourceBundle fResourceBundle, String msgKey, Object[] args) {
        ...
        if (msgKey != null) {
            ...
            msgKey = SerializerConstants.EMPTYSTRING;
        }
        if (msg == null) {
            throwex = true;
            try {
    ...
    private ListResourceBundle loadResourceBundle(String resourceBundle) throws MissingResourceException {
        ...
        try {
            ...
            try {
                ...
                throw new MissingResourceException("Could not load any resource bundles." + this.m_resourceBundleName, this.m_resourceBundleName, SerializerConstants.EMPTYSTRING);
            }
        }

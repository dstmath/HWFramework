...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: org.apache.xpath.compiler.Compiler.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: org.apache.xpath.compiler.Compiler.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.xpath.compiler.Compiler.<clinit>():void");
    }
    ...
    public Expression compile(int opPos) throws TransformerException {
        switch (getOp(opPos)) {
            ...
            case OpCodes.OP_PREDICATE /*29*/:
                return null;
            case OpCodes.OP_MATCHPATTERN /*30*/:
                return matchPattern(opPos + 2);
            case OpCodes.OP_LOCATIONPATHPATTERN /*31*/:
            ...
            case OpCodes.NODENAME /*34*/:
                switch (axesType) {
                    ...
                    case OpCodes.FROM_NAMESPACE /*49*/:
                        return WalkerFactory.BIT_PREDICATE;

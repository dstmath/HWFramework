...
public interface ISmartcardService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISmartcardService {
        ...
        private static class Proxy implements ISmartcardService {
            ...
            public void closeChannel(long hChannel, SmartcardError error) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_closeChannel, _data, _reply, 0);
            ...
            public String[] getReaders(SmartcardError error) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getReaders, _data, _reply, 0);
                    _reply.readException();
            ...
            public boolean isCardPresent(String reader, SmartcardError error) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_isCardPresent, _data, _reply, 0);
                    _reply.readException();
            ...
            public byte[] getSelectResponse(long hChannel, SmartcardError error) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeLong(hChannel);
                    this.mRemote.transact(Stub.TRANSACTION_getSelectResponse, _data, _reply, 0);
                    _reply.readException();
                    byte[] _result = _reply.createByteArray();
                    if (_reply.readInt() != 0) {
                        error.readFromParcel(_reply);
            ...
            public boolean[] isNFCEventAllowed(String reader, byte[] aid, String[] packageNames, ISmartcardServiceCallback callback, SmartcardError error) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(iBinder);
                    this.mRemote.transact(Stub.TRANSACTION_isNFCEventAllowed, _data, _reply, 0);
                    _reply.readException();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case TRANSACTION_closeChannel /*1*/:
                    ...
                    if (_arg1 != null) {
                        reply.writeInt(TRANSACTION_closeChannel);
                        _arg1.writeToParcel(reply, TRANSACTION_closeChannel);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case TRANSACTION_getReaders /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    if (_arg03 != null) {
                        reply.writeInt(TRANSACTION_closeChannel);
                        _arg03.writeToParcel(reply, TRANSACTION_closeChannel);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case TRANSACTION_isCardPresent /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = data.readString();
                    _arg1 = new SmartcardError();
                    boolean _result4 = isCardPresent(_arg02, _arg1);
                    reply.writeNoException();
                    reply.writeInt(_result4 ? TRANSACTION_closeChannel : 0);
                    if (_arg1 != null) {
                        reply.writeInt(TRANSACTION_closeChannel);
                        _arg1.writeToParcel(reply, TRANSACTION_closeChannel);
                    } else {
                ...
                case TRANSACTION_getAtr /*4*/:
                    ...
                    return true;
                case TRANSACTION_openBasicChannel /*5*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = data.readString();
                    ...
                    if (_arg2 != null) {
                        reply.writeInt(TRANSACTION_closeChannel);
                        _arg2.writeToParcel(reply, TRANSACTION_closeChannel);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case TRANSACTION_openBasicChannelAid /*6*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = data.readString();
                    ...
                    if (_arg3 != null) {
                        reply.writeInt(TRANSACTION_closeChannel);
                        _arg3.writeToParcel(reply, TRANSACTION_closeChannel);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case TRANSACTION_openLogicalChannel /*7*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = data.readString();
                    _arg12 = data.createByteArray();
                    _arg22 = org.simalliance.openmobileapi.service.ISmartcardServiceCallback.Stub.asInterface(data.readStrongBinder());
                ...
                case TRANSACTION_transmit /*8*/:
                    ...
                    return true;
                case TRANSACTION_getSelectResponse /*9*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readLong();
                    _arg1 = new SmartcardError();
                ...
                case TRANSACTION_getReader /*10*/:
                    ...
                    return true;
                case TRANSACTION_isNFCEventAllowed /*11*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = data.readString();
                    _arg12 = data.createByteArray();
                    ...
                    if (_arg4 != null) {
                        reply.writeInt(TRANSACTION_closeChannel);
                        _arg4.writeToParcel(reply, TRANSACTION_closeChannel);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;

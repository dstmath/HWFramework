    ...
    public static abstract class Stub extends Binder implements ISmartcardSystemService {
        ...
        private static class Proxy implements ISmartcardSystemService {
            ...
            public String getLastError() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getLastError, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public boolean connectSmartCardService() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_connectSmartCardService, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_isCardPresent /*3*/:
                    ...
                    reply.writeNoException();
                    if (_result2) {
                        i = TRANSACTION_closeChannel;
                    }
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_openBasicChannel /*4*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = openBasicChannel(data.readString());
                    reply.writeNoException();
                    reply.writeLong(_result3);
                    return true;
                case TRANSACTION_openBasicChannelAid /*5*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = openBasicChannelAid(data.readString(), data.readString());
                    reply.writeNoException();
                    reply.writeLong(_result3);
                    return true;
                case TRANSACTION_openLogicalChannel /*6*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = openLogicalChannel(data.readString(), data.readString());
                    reply.writeNoException();
                    reply.writeLong(_result3);
                    return true;
                case TRANSACTION_transmit /*7*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = transmit(data.readLong(), data.readString());
                    reply.writeNoException();
                    reply.writeString(_result);
                    return true;
                case TRANSACTION_getLastError /*8*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getLastError();
                    reply.writeNoException();
                    reply.writeString(_result);
                    return true;
                case TRANSACTION_connectSmartCardService /*9*/:
                    data.enforceInterface(DESCRIPTOR);

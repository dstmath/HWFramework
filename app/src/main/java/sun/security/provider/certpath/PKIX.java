        ...
        private void checkParams(PKIXBuilderParameters params) throws InvalidAlgorithmParameterException {
            if (targetCertConstraints() instanceof X509CertSelector) {
                if (params instanceof SunCertPathBuilderParameters) {
                    this.buildForward = ((SunCertPathBuilderParameters) params).getBuildForward();
                }
                this.params = params;
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: sun.security.provider.certpath.PKIX.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: sun.security.provider.certpath.PKIX.<clinit>():void

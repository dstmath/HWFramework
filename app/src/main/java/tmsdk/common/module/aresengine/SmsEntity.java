...
public class SmsEntity extends TelephonyEntity implements Parcelable {
    public static final Creator<SmsEntity> CREATOR = null;
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: tmsdk.common.module.aresengine.SmsEntity.<clinit>():void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: tmsdk.common.module.aresengine.SmsEntity.<clinit>():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: tmsdk.common.module.aresengine.SmsEntity.<clinit>():void");
    }

    public SmsEntity() {
        this.read = PROTOCOL_TYPE_SMS;
        this.protocolType = PROTOCOL_TYPE_SMS;
    ...
    protected SmsEntity(Parcel parcel) {
        ...
        this.seen = parcel.readInt() == SMS_TYPE_IN;
    ...
    public static byte[] marshall(SmsEntity smsEntity) {
        ...
        smsEntity.writeToParcel(obtain, PROTOCOL_TYPE_SMS);
    ...
    public static SmsEntity unmarshall(byte[] bArr) {
        Parcel obtain = Parcel.obtain();
        obtain.unmarshall(bArr, PROTOCOL_TYPE_SMS, bArr.length);
        obtain.setDataPosition(PROTOCOL_TYPE_SMS);
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeParcelable(this.raw, PROTOCOL_TYPE_SMS);
